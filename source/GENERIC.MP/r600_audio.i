# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_audio.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_audio.c"
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_audio.c"
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_audio.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_audio.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_audio.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_audio.c" 2




static _Bool radeon_dig_encoder(struct drm_encoder *encoder)
{
...
{
 return (rdev->family >= CHIP_R600 && !((rdev->family >= CHIP_ARUBA)))
...
struct r600_audio r600_audio_status(struct radeon_device *rdev)
{
 ...
 value = r100_mm_rreg(rdev, (0x73c0), 0);
 ...
 case 0x4:
  ...
  break;
 default:
  printf("drm:pid%d:%s *ERROR* " "Unknown bits per sample 0x%x, using 16\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , (int)value);
 ...
 value = r100_mm_rreg(rdev, (0x73d8), 0);
...
static void r600_audio_engine_enable(struct radeon_device *rdev, _Bool enable)
{
 u32 value = 0;
 do { } while( 0);
 if (((rdev->family >= CHIP_CEDAR))) {
  ...
  r100_mm_wreg(rdev, (0x5e78), (value), 0);
 } else {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7300), 0); tmp_ &= (~0x81000000); tmp_ |= ((enable ? 0x81000000 : 0x0) & ~(~0x81000000)); r100_mm_wreg(rdev, (0x7300), (tmp_), 0); } while (0);
...
void r600_audio_set_clock(struct drm_encoder *encoder, int clock)
{
 ...
 case 0x13:
 case 0x0F:
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7344), 0); tmp_ &= (~0x301); tmp_ |= ((0) & ~(~0x301)); r100_mm_wreg(rdev, (0x7344), (tmp_), 0); } while (0);
  break;
 case 0x1E:
 case 0x20:
 case 0x21:
 case 0x1F:
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7344), 0); tmp_ &= (~0x301); tmp_ |= ((0x100) & ~(~0x301)); r100_mm_wreg(rdev, (0x7344), (tmp_), 0); } while (0);
  break;
 default:
  printf("drm:pid%d:%s *ERROR* " "Unsupported encoder type 0x%02X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , radeon_encoder->encoder_id);
 ...
 if (((rdev->family >= CHIP_CEDAR))) {
  ...
  r100_mm_wreg(rdev, (0x5b0), (base_rate * 10), 0);
  r100_mm_wreg(rdev, (0x5b4), (clock * 10), 0);
  r100_mm_wreg(rdev, (0x5bc), (0x00000071), 0);


  r100_mm_wreg(rdev, (0x5ac), (radeon_crtc->crtc_id), 0);
 } else {
  switch (dig->dig_encoder) {
  case 0:
   r100_mm_wreg(rdev, (0x0514), (base_rate * 50), 0);
   r100_mm_wreg(rdev, (0x0518), (clock * 100), 0);
   r100_mm_wreg(rdev, (0x0534), (0), 0);
   break;

  case 1:
   r100_mm_wreg(rdev, (0x0524), (base_rate * 50), 0);
   r100_mm_wreg(rdev, (0x0528), (clock * 100), 0);
   r100_mm_wreg(rdev, (0x0534), (1), 0);
   break;
  default:
   printf("drm:pid%d:%s *ERROR* " "Unsupported DIG on encoder 0x%02X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , radeon_encoder->encoder_id);
