# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_benchmark.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_benchmark.c"
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_benchmark.c"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_benchmark.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_benchmark.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_benchmark.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_benchmark.c" 2
        ...
        int flag, int n)
{
 ...
 for (i = 0; i < n; i++) {
  switch (flag) {
  case 0:
   r = (rdev)->asic->copy.dma((rdev), (saddr), (daddr), (size / 4096), (&fence));


   break;
  case 1:
   r = (rdev)->asic->copy.blit((rdev), (saddr), (daddr), (size / 4096), (&fence));
 ...
 end_jiffies = ticks;
 r = (((int64_t)(end_jiffies - start_jiffies)) * 1000 / hz);
      ...
      unsigned sdomain, unsigned ddomain)
{
 ...
 n = 1024;
 r = radeon_bo_create(rdev, size, (1 << 13), 1, sdomain, ((void *)0), &sobj);
 if (r) {
  goto out_cleanup;
 }
 ...
 r = radeon_bo_create(rdev, size, (1 << 13), 1, ddomain, ((void *)0), &dobj);
 if (r) {
  goto out_cleanup;
 }
...
out_cleanup:
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Error while benchmarking BO move.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 }
}
...
void radeon_benchmark(struct radeon_device *rdev, int test_number)
{
 ...
 case 1:
  ...
  radeon_benchmark_move(rdev, 1024*1024, 0x2,
          0x4);
  radeon_benchmark_move(rdev, 1024*1024, 0x4,
          0x2);
  break;
 case 2:
 ...
 case 3:
  ...
  for (i = 1; i <= 16384; i <<= 1)
   radeon_benchmark_move(rdev, i * 4096,
           0x2,
           0x4);
  break;
 case 4:
 ...
 default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown benchmark\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 }
}
