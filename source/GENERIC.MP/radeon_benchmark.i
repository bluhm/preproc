        ...
        struct reservation_object *resv)
{
 ...
 for (i = 0; i < n; i++) {
  switch (flag) {
  case 0:
   fence = (rdev)->asic->copy.dma((rdev), (saddr), (daddr), (size / 4096), (resv));
   break;
  case 1:
   fence = (rdev)->asic->copy.blit((rdev), (saddr), (daddr), (size / 4096), (resv));
   break;
  default:
 ...
 end_jiffies = jiffies;
 return (((uint64_t)(end_jiffies - start_jiffies)) * 1000 / hz);
}
      ...
      unsigned sdomain, unsigned ddomain)
{
 ...
 int time;
 n = 1024;
 r = radeon_bo_create(rdev, size, (1 << 13), 1, sdomain, 0, ((void *)0), ((void *)0), &sobj);
 if (r) {
  goto out_cleanup;
 }
 ...
 r = radeon_bo_create(rdev, size, (1 << 13), 1, ddomain, 0, ((void *)0), ((void *)0), &dobj);
 if (r) {
  goto out_cleanup;
 }
