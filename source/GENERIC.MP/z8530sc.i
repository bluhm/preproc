# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c"
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c"
...
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
# 96 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
# 97 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
# 98 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
# 99 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
# 100 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
# 101 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
# 102 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
# 104 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 105 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530reg.h" 1
# 107 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
# 108 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c" 2
...
# 164 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c"
void
zs_loadchannelregs(struct zs_chanstate *cs)
{
 ...
 if (cs->cs_ctl_chan != ((void *)0))
  v = ((cs->cs_ctl_chan->cs_creg[5] & (0x02 | 0x80)) !=
      (cs->cs_ctl_chan->cs_preg[5] & (0x02 | 0x80)));
 else
  v = 0;

 if (__builtin_memcmp(((void *)cs->cs_preg), ((void *)cs->cs_creg), (16)) == 0 && !v)
  return;


 __builtin_memcpy(((void *)cs->cs_creg), ((void *)cs->cs_preg), (16));
 reg64 = cs->cs_creg;


 zs_write_reg(cs, 1, reg64[1] & ~0x1F);


 zs_write_reg(cs, 4, reg64[4]);


 zs_write_reg(cs, 10, reg64[10]);


 zs_write_reg(cs, 3, reg64[3] & ~0x01);
 zs_write_reg(cs, 5, reg64[5] & ~0x08);


 zs_write_reg(cs, 6, reg64[6]);
 if (reg64[15] & 0x01)
  zs_write_reg(cs, 15, 0);
 zs_write_reg(cs, 7, reg64[7]);
# 226 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c"
 zs_write_reg(cs, 14, reg64[14] & ~0x01);
 ...
 zs_write_reg(cs, 11, reg64[11]);


 zs_write_reg(cs, 12, reg64[12]);
 zs_write_reg(cs, 13, reg64[13]);


 zs_write_reg(cs, 14, reg64[14]);


 zs_write_reg(cs, 15, reg64[15]);
 ...
 zs_write_reg(cs, 3, reg64[3]);
 zs_write_reg(cs, 5, reg64[5]);
 ...
 if (reg64[15] & 0x01)
  zs_write_reg(cs, 7, reg64[16]);


 zs_write_reg(cs, 1, reg64[1]);
}
# 285 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.c"
int
zsc_intr_hard(void *arg)
{
 ...
 for (;;) {
  ...
  if (rr3 & (0x04 | 0x02 | 0x01))
   zs_write_csr(cs1, 0x38);
