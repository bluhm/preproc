# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpathvar.h" 1
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpathvar.h"
struct mpath_group;
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpathvar.h"
struct mpath_path {
 ...
 struct { struct mpath_path *tqe_next; struct mpath_path **tqe_prev; } p_entry;
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath.c" 2
...
struct mpath_paths { struct mpath_path *tqh_first; struct mpath_path **tqh_last; };

struct mpath_group {
 struct { struct mpath_group *tqe_next; struct mpath_group **tqe_prev; } g_entry;
 struct mpath_paths g_paths;
 struct mpath_dev *g_dev;
 u_int g_id;
};
struct mpath_groups { struct mpath_group *tqh_first; struct mpath_group **tqh_last; };
...
mpath_next_path(struct mpath_dev *d)
{
 ...
 p = d->d_next_path;
 if (p != ((void *)0)) {
  d->d_next_path = ((p)->p_entry.tqe_next);
  if (d->d_next_path == ((void *)0) &&
      (g = ((&d->d_groups)->tqh_first)) != ((void *)0))
...
mpath_cmd(struct scsi_xfer *xs)
{
 ...
 if (((xs->flags) & (0x00002))) {
  ...
  __builtin_memcpy((&xs->sense), (&mxs->sense), (sizeof(xs->sense)));
...
mpath_path_attach(struct mpath_path *p, u_int g_id, const struct mpath_ops *ops)
{
 ...
 for (target = 0; target < 256; target++) {
  if ((d = sc->sc_devs[target]) == ((void *)0))
   continue;

  if (( (d->d_id) != ((void *)0) && (link->id) != ((void *)0) && ((d->d_id) == (link->id) || ((d->d_id)->d_type != 0 && (d->d_id)->d_type == (link->id)->d_type && (d->d_id)->d_len == (link->id)->d_len && __builtin_bcmp(((d->d_id) + 1), ((link->id) + 1), ((d->d_id)->d_len)) == 0)) ) && d->d_ops == ops)
   break;
