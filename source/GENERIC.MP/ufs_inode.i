# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c" 2
...
ufs_inactive(void *v)
{
 ...
 if ((((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_nlink : (ip)->dinode_u.ffs2_din->di_nlink) <= 0 && (vp->v_mount->mnt_flag & 0x00000001) == 0) {
  if (getinoquota(ip) == 0)
   (void)ufs_quota_free_inode2(ip, ((struct ucred *)-1), 0);

  error = ((ip)->i_vtbl->iv_truncate)((ip), ((off_t)0), (0), (((struct ucred *)-1)));

  do { if ((ip)->i_ump->um_fstype == 1) (ip)->dinode_u.ffs1_din->di_db[0] = (0); else (ip)->dinode_u.ffs2_din->di_db[0] = (0); } while (0);
  mode = (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_mode : (ip)->dinode_u.ffs2_din->di_mode);
  do { if ((ip)->i_ump->um_fstype == 1) (ip)->dinode_u.ffs1_din->di_mode = (0); else (ip)->dinode_u.ffs2_din->di_mode = (0); } while (0);
  ip->i_flag |= 0x0002 | 0x0004;
# 104 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_inode.c"
 ...
 if (ip->i_flag & (0x0001 | 0x0002 | 0x0008 | 0x0004)) {
...
ufs_reclaim(struct vnode *vp, struct proc *p)
{
 ...
 if (ip->i_ump->um_devvp) {
  vrele(ip->i_ump->um_devvp);
 }
