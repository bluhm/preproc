# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
...
int udf_disklabelspoof(dev_t dev, void (*strat)(struct buf *),
 struct disklabel *lp);
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.h" 1
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.h"
struct vnode;
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c" 2
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
struct uvn_list_struct { struct uvm_vnode *lh_first; };
struct uvn_list_struct uvn_wlist;
...
# 114 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
void
uvn_init(void)
{

 do { ((&uvn_wlist)->lh_first) = ((void *)0); } while (0);

 _rw_init_flags(&uvn_sync_lock, "uvnsync", 0x04, ((void *)0));
}
# 136 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
struct uvm_object *
uvn_attach(struct vnode *vp, vm_prot_t accessprot)
{
 ...
 while (uvn->u_flags & (0x004|0x008|0x010)) {
  uvn->u_flags |= 0x020;
  do { tsleep(uvn, 4|(0 ? 0x100 : 0), "uvn_attach", 0); } while (0);
 }


 if (vp->v_type == VBLK && bdevsw[((int32_t)(((u_int32_t)(vp->v_un.vu_specinfo->si_rdev) >> 8) & 0xff))].d_type != 1) {
  return(((void *)0));
 }
 ...
 if (uvn->u_flags & 0x001) {
  ...
  if ((accessprot & 0x02) != 0 &&
      (uvn->u_flags & 0x200) == 0) {
   do { if (((uvn)->u_wlist.le_next = (&uvn_wlist)->lh_first) != ((void *)0)) (&uvn_wlist)->lh_first->u_wlist.le_prev = &(uvn)->u_wlist.le_next; (&uvn_wlist)->lh_first = (uvn); (uvn)->u_wlist.le_prev = &(&uvn_wlist)->lh_first; } while (0);
...
# 189 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
 uvn->u_flags = 0x004;

 if (vp->v_type == VBLK) {
# 200 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
  result = (*bdevsw[((int32_t)(((u_int32_t)(vp->v_un.vu_specinfo->si_rdev) >> 8) & 0xff))].d_ioctl)(vp->v_un.vu_specinfo->si_rdev,
      ((unsigned long)0x80000000 | ((sizeof(struct partinfo) & 0x1fff) << 16) | ((('d')) << 8) | ((104))), (caddr_t)&pi, 0x0001, (__curcpu->ci_self)->ci_curproc);
  if (result == 0) {

   used_vnode_size = (u_quad_t)pi.disklab->d_secsize *
       (u_quad_t)(((u_int64_t)(pi.part)->p_sizeh << 32) + (pi.part)->p_size);
  }
 } else {
  result = VOP_GETATTR(vp, &vattr, (__curcpu->ci_self)->ci_curproc->p_ucred, (__curcpu->ci_self)->ci_curproc);
  if (result == 0)
   used_vnode_size = vattr.va_size;
 }

 if (result != 0) {
  if (uvn->u_flags & 0x020)
   wakeup(uvn);
  uvn->u_flags = 0;
  return(((void *)0));
 }
# 230 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
 uvm_objinit(&uvn->u_obj, &uvm_vnodeops, 1);
 oldflags = uvn->u_flags;
 uvn->u_flags = 0x001|0x002;
 uvn->u_nio = 0;
...
# 266 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
void
uvn_reference(struct uvm_object *uobj)
{
# 280 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
 uobj->uo_refs++;
}
# 292 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
void
uvn_detach(struct uvm_object *uobj)
{
 ...
 if (uvn->u_flags & 0x002) {

  uvn_flush(uobj, 0, 0, 0x004|0x010);
  vrele(vp);
  return;
 }
 ...
 uvn->u_flags |= 0x008;
# 338 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
 (void) uvn_flush(uobj, 0, 0, 0x001|0x008|0x010);
# 348 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
 uvn->u_flags |= 0x010;

 while (uobj->uo_npages && uvn->u_flags & 0x010) {
  uvn->u_flags |= 0x080;
  do { tsleep(&uvn->u_nio, 4|(0 ? 0x100 : 0), "uvn_term", 0); } while (0);
 }

 if ((uvn->u_flags & 0x010) == 0)
  return;
...
# 404 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
void
uvm_vnp_terminate(struct vnode *vp)
{
 ...
 if ((uvn->u_flags & 0x001) == 0) {
  return;
 }
# 439 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
 if (uvn->u_flags & 0x010)
  uvn->u_flags &= ~0x010;
# 454 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
 uvn->u_flags |= 0x008|0x040;

 (void) uvn_flush(&uvn->u_obj, 0, 0, 0x001|0x008|0x010);
...
# 477 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
  uvn->u_flags |= 0x080;
  do { tsleep(&uvn->u_nio, 4|(0 ? 0x100 : 0), "uvn_term", 0); } while (0);
 }
...
# 577 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
boolean_t
uvn_flush(struct uvm_object *uobj, voff_t start, voff_t stop, int flags)
{
 struct uvm_vnode *uvn = (struct uvm_vnode *) uobj;
 struct vm_page *pp, *ptmp;
 struct vm_page *pps[(64 * 1024) >> 13], **ppsp;
 ...
 if (flags & 0x010) {
  start = 0;
  stop = (((uvn->u_size) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
 } else {
  start = ((start) & ~((1 << 13) - 1));
  stop = ((((((stop) + ((1 << 13) - 1)) & ~((1 << 13) - 1)))<((((uvn->u_size) + ((1 << 13) - 1)) & ~((1 << 13) - 1))))?((((stop) + ((1 << 13) - 1)) & ~((1 << 13) - 1))):((((uvn->u_size) + ((1 << 13) - 1)) & ~((1 << 13) - 1))));
 }
# 608 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
 if ((flags & 0x001) != 0) {
 ...
 for (curoff = start; curoff < stop; curoff += (1 << 13)) {
  if ((pp = uvm_pagelookup(uobj, curoff)) == ((void *)0))
   continue;
# 633 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
  if ((flags & 0x001) == 0 || (pp->pg_flags & 0x00000001) != 0) {
   needs_clean = 0;
   if ((pp->pg_flags & 0x00000001) != 0 &&
       (flags & (0x001|0x002)) ==
                (0x001|0x002))
    need_iosync = 1;
  } else {
   ...
   if ((pp->pg_flags & 0x00000008) != 0 &&
       (flags & 0x008) != 0 &&
       (pp->pg_flags & 0x00040000) != 0)
    pmap_page_protect(pp, 0x00);
   if ((pp->pg_flags & 0x00000008) != 0 &&
       pmap_is_modified(pp))
    atomic_clearbits_int(&pp->pg_flags, 0x00000008);
   atomic_setbits_int(&pp->pg_flags, 0x00000010);

   needs_clean = ((pp->pg_flags & 0x00000008) == 0);
  }
...
# 689 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
  atomic_setbits_int(&pp->pg_flags, 0x00000001);
  ;
  pmap_page_protect(pp, 0x01);

  if ((flags & (0x008|0x002)) == 0x008)
   atomic_setbits_int(&pp->pg_flags, 0x00000020);
ReTry:
  ppsp = pps;
...
# 709 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
  __mtx_enter(&uvm.pageqlock);
  ...
  if (result == 5) {
# 726 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
   if (flags & 0x002)
...
# 748 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
  if (result == 3 && (flags & 0x004) == 0)
   continue;
 ...
 if (need_iosync) {
  while (uvn->u_nio != 0) {
   uvn->u_flags |= 0x080;
   do { tsleep(&uvn->u_nio, 4|(0 ? 0x100 : 0), "uvn_flush", 0); } while (0);
  }
  if (uvn->u_flags & 0x100)
   wakeup(&uvn->u_flags);
  uvn->u_flags &= ~(0x080|0x100);
 }

 return(retval);
}
# 834 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
void
 ...
 *hoffset = *loffset + (64 * 1024);
 if (*hoffset > (((uvn->u_size) + ((1 << 13) - 1)) & ~((1 << 13) - 1)))
  *hoffset = (((uvn->u_size) + ((1 << 13) - 1)) & ~((1 << 13) - 1));

 return;
}
# 863 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
int
...
# 882 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
int
...
# 953 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
  *npagesp = gotpages;
  if (done)
   return(0);
  else
...
# 968 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
 for (lcv = 0, current_offset = offset;
    lcv < *npagesp ; lcv++, current_offset += (1 << 13)) {



  if (pps[lcv] != ((void *)0) || (lcv != centeridx &&
      (flags & 0x010) == 0))
   continue;
# 992 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
  while (pps[lcv] == ((void *)0)) {
   ...
   if ((ptmp->pg_flags & 0x00000001) != 0) {
    ...
    do { tsleep(ptmp, 4|(0 ? 0x100 : 0), "uvn_get", 0); } while (0);
    continue;
   }
...
# 1078 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
...
# 1096 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
int
uvn_io(struct uvm_vnode *uvn, vm_page_t *pps, int npages, int flags, int rw)
{
 ...
 while (uvn->u_flags & 0x080) {
  if (waitf == 0x0002) {
   return(5);
  }
  uvn->u_flags |= 0x100;
  do { tsleep(&uvn->u_flags, 4|(0 ? 0x100 : 0), "uvn_iosync", 0); } while (0);
 }
 ...
 wanted = (size_t)npages << 13;
 if (file_offset + wanted > uvn->u_size)
  wanted = uvn->u_size - file_offset;
 iov.iov_len = wanted;
 uio.uio_iov = &iov;
 uio.uio_iovcnt = 1;
...
# 1174 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
 result = 0;
 ...
 if (result == 0) {
  ...
  if (wanted && got == 0) {
   result = 5;
  } else if (got < (1 << 13) * npages && rw == UIO_READ) {
   __builtin_memset(((void *) (kva + got)), (0), (((size_t)npages << 13) - got));
...
# 1271 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
int
uvm_vnp_uncache(struct vnode *vp)
{
 ...
 if ((uvn->u_flags & 0x001) == 0 ||
   (uvn->u_flags & (0x004|0x008|0x010)) != 0) {
  return(1);
 }
 ...
 vref(vp);
 uvn->u_obj.uo_refs++;
# 1318 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
...
# 1343 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
void
...
# 1374 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
void
uvm_vnp_sync(struct mount *mp)
{
 ...
 _rw_enter_write(&uvn_sync_lock );





 do { (&uvn_sync_q)->sqh_first = ((void *)0); (&uvn_sync_q)->sqh_last = &(&uvn_sync_q)->sqh_first; } while (0);
 for((uvn) = ((&uvn_wlist)->lh_first); (uvn)!= ((void *)0); (uvn) = ((uvn)->u_wlist.le_next)) {
  vp = uvn->u_vnode;
  if (mp && vp->v_mount != mp)
   continue;
# 1404 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_vnode.c"
  if ((uvn->u_flags & (0x004|0x008|0x010)) != 0)
   continue;
  ...
  do { if (((uvn)->u_syncq.sqe_next = (&uvn_sync_q)->sqh_first) == ((void *)0)) (&uvn_sync_q)->sqh_last = &(uvn)->u_syncq.sqe_next; (&uvn_sync_q)->sqh_first = (uvn); } while (0);
 }


 for((uvn) = ((&uvn_sync_q)->sqh_first); (uvn) != ((void *)0); (uvn) = ((uvn)->u_syncq.sqe_next)) {





  uvn_flush(&uvn->u_obj, 0, 0, 0x001|0x010|0x020);
