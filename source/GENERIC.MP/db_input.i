# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c" 2
...
int ddb_sysctl(int *, u_int, void *, size_t *, void *, size_t,
         struct proc *);
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c" 2
...
char db_history[4000];
int db_history_size = 4000;
char * db_history_curr = db_history;
char * db_history_last = db_history;
char * db_history_prev = (char *) 0;
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c"
void
...
db_delete_line(void)
{
 db_delete(db_le - db_lc, 0);
 db_delete(db_lc - db_lbuf_start, 1);
 db_le = db_lc = db_lbuf_start;
}
# 141 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_input.c"
int
db_inputchar(int c)
{
 switch (c) {
  ...
  while (db_lc > db_lbuf_start && db_lc[-1] != ' ')
      db_delete(1, 1);
  break;
     case (('h') & 0x1f):
     case 0177:
  ...
  break;
     ...
     case (('p') & 0x1f):
  do { db_history_curr--; if (db_history_curr < db_history) db_history_curr = db_history + db_history_size - 1; } while (0);
  ...
  if (db_history_curr == db_history_last) {
   do { db_history_curr++; if (db_history_curr > db_history + db_history_size - 1) db_history_curr = db_history; } while (0);
   db_le = db_lc = db_lbuf_start;
  } else {
   char *p;
   do { db_history_curr++; if (db_history_curr > db_history + db_history_size - 1) db_history_curr = db_history; } while (0);
