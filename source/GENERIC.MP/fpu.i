# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c"
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c"
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c" 2
...
# 145 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c"
 ...
 register struct fpstate64 *fs;
{
 ...
 sv.sival_int = p->p_md.md_tf->tf_pc;
 ...
 case 1:
  if ((i = fsr & 0x0000001f) == 0)
   panic("fpu ieee trap, but no exception");
  _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c", 217);
  trapsignal(p, 8, fpu_codes[i - 1], fpu_types[i - 1], sv);
  _kernel_unlock();
  break;
 ...
 case 5:
  log(3, "fpu hardware error (%s[%d])\n",
      p->p_p->ps_comm, p->p_p->ps_pid);
  uprintf("%s[%d]: fpu hardware error\n",
      p->p_p->ps_comm, p->p_p->ps_pid);
  _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c", 243);
  trapsignal(p, 8, -1, 7, sv);
  _kernel_unlock();
  goto out;
 ...
 for (i = 0; i < fs->fs_qsize; i++) {
  ...
  case 1:
   _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c", 268);
   trapsignal(p, 8,
       fpu_codes[(fs->fs_fsr & 0x0000001f) - 1],
       fpu_types[(fs->fs_fsr & 0x0000001f) - 1], sv);
   _kernel_unlock();
   break;

  case 2:
   _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu.c", 276);
   trapsignal(p, 4, 0, 7, sv);
   _kernel_unlock();
   break;
 ...
 union instr instr;
{
 ...
 fs = fe->fe_fpstate;
 fe->fe_fsr = fs->fs_fsr & ~0x0000001f;
 fe->fe_cx = 0;
 ...
 if (instr.i_opf.i_op3 == IOP3_FPop2) {
  switch (opf) {
  case 0x051: case 0x052: case 0x053:
   return (fpu_insn_fcmp(fs, fe, instr, 0));

  case 0x055: case 0x056: case 0x057:
  ...
  case 0x0c1: case 0x0c2: case 0x0c3:
  case 0x101: case 0x102: case 0x103:
  case 0x181: case 0x182: case 0x183:
   return (fpu_insn_fmovcc(p, fs, instr));

  case 0x025: case 0x026: case 0x027:
  case 0x045: case 0x046: case 0x047:
  case 0x065: case 0x066: case 0x067:
  case 0x0a5: case 0x0a6: case 0x0a7:
  case 0x0c5: case 0x0c6: case 0x0c7:
  case 0x0e5: case 0x0e6: case 0x0e7:
 ...
 case 0x0c4: case 0x0c8: case 0x0cc:
  if ((err = fpu_insn_itof(fe, instr, 0, &rd,
      &rdtype, space)) != 0)
   return (err);
  break;

 case 0x084: case 0x088: case 0x08c:
  if ((err = fpu_insn_itof(fe, instr, -1, &rd,
      &rdtype, space)) != 0)
   return (err);
  break;

 case 0x0c9: case 0x0cd:
 case 0x0c6: case 0x0ce:
 case 0x0c7: case 0x0cb:
 ...
 case 0x049: case 0x04a: case 0x04b:
 ...
 if (cx != 0) {
  ...
  if (cx & mask) {
   ...
   fs->fs_fsr = (fsr & ~0x0001c000) |
       (1 << 14) |
       (cx_to_trapx[(cx & mask) - 1] << 0);
   return (1);
  }
  fsr |= (cx << 0) | (cx << 5);
 }
 ...
 u_int *space;
{
 ...
 fpu_explode(fe, &fe->fe_f1, rtype, rs1);
 fpu_explode(fe, &fe->fe_f2, rtype, rs2);
 fp = ((fe)->fe_f2.fp_sign ^= 1, fpu_add(fe));
 fpu_implode(fe, fp, rtype, space);
 *rdp = rd;
 *rdtypep = rtype;
 return (0);
 ...
 union instr instr;
{
 ...
 case 0:
  cond = (fs->fs_fsr >> 10) & 0x03;
  break;
 case 1:
  cond = (fs->fs_fsr >> 32) & 0x03;
  break;
 case 2:
  cond = (fs->fs_fsr >> 34) & 0x03;
  break;
 case 3:
  cond = (fs->fs_fsr >> 36) & 0x03;
  break;
 case 4:
  cond = (p->p_md.md_tf->tf_tstate >> 32) &
      0x00f00000;
  break;
 case 6:
