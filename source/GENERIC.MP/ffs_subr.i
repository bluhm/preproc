# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c" 2
...
ffs_bufatoff(struct inode *ip, off_t offset, char **res, struct buf **bpp)
{
 ...
 vp = ((ip)->i_vnode);
 fs = ip->inode_u.fs;
 lbn = ((offset) >> (fs)->fs_bshift);
 bsize = (((lbn) >= 12 || ((((ip))->i_ump->um_fstype == 1) ? ((ip))->dinode_u.ffs1_din->di_size : ((ip))->dinode_u.ffs2_din->di_size) >= ((lbn) + 1) << (fs)->fs_bshift) ? (u_int64_t)(fs)->fs_bsize : ((((((((((ip))->i_ump->um_fstype == 1) ? ((ip))->dinode_u.ffs1_din->di_size : ((ip))->dinode_u.ffs2_din->di_size)) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask)));
 ...
 *bpp = ((void *)0);
 ...
 buf_adjcnt(bp, bsize);
 if (res)
  *res = (char *)bp->b_data + ((offset) & (fs)->fs_qbmask);
 *bpp = bp;
 return (0);
}
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_subr.c"
void
...
ffs_checkoverlap(struct buf *bp, struct inode *ip)
{
 ...
 start = bp->b_blkno;
 last = start + ((bp->b_bcount) >> 9) - 1;
 for((ep) = ((&bufhead)->lh_first); (ep)!= ((void *)0); (ep) = ((ep)->b_list.le_next)) {
  if (ep == bp || (ep->b_flags & 0x00000800) ||
      ep->b_vp == ((struct vnode *)((void *)0)))
   continue;
  if (VOP_BMAP(ep->b_vp, 0, &vp, ((void *)0), ((void *)0)))
   continue;
  if (vp != ip->i_ump->um_devvp)
   continue;

  if (ep->b_bcount == 0 || ep->b_blkno > last ||
      ep->b_blkno + ((ep->b_bcount) >> 9) <= start)
   continue;
  vprint("Disk overlap", vp);
  (void)printf("\tstart %lld, end %lld overlap start %llu, "
      "end %llu\n", (long long)start, (long long)last,
      (long long)ep->b_blkno,
      (long long)(ep->b_blkno + ((ep->b_bcount) >> 9) - 1));
...
ffs_vinit(struct mount *mntp, struct vnode **vpp)
{
 ...
 switch(vp->v_type = (iftovt_tab[(((((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_mode : (ip)->dinode_u.ffs2_din->di_mode)) & 0170000) >> 12])) {
 case VCHR:
 case VBLK:
  vp->v_op = &ffs_specvops;
  if ((nvp = checkalias(vp, (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_db[0] : (ip)->dinode_u.ffs2_din->di_db[0]), mntp)) != ((void *)0)) {
