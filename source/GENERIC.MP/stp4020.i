# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmciareg.h" 1
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c" 2
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c"
...
stpattach_common(struct stp4020_softc *sc, int clockfreq)
{
 ...
 rev = stp4020_rd_sockctl(&sc->sc_socks[0], 18) &
     0x000f;
 printf(": rev %x\n", rev);
 ...
 int speed;
{
 ...
 h->intrhandler = ((void *)0);
 h->intrarg = ((void *)0);
 h->softint = ((void *)0);
 h->int_enable = h->int_disable = 0;


 stp4020_map_window(h, 0, speed);
 stp4020_map_window(h, 1, speed);
 stp4020_map_window(h, 2, speed);
 ...
 paa.iobase = 0;
 paa.iosize = (1024*1024);

 h->pcmcia = config_found_sm((&h->sc->sc_dev), (&paa), (stp4020print), ((void *)0));

 if (h->pcmcia == ((void *)0))
  return;
# 268 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c"
 stp4020_wr_sockctl(h, 14, 0);
 stp4020_wr_sockctl(h, 12, 0);
 stp4020_wr_sockctl(h, 18, 0x3fff);
 stp4020_wr_sockctl(h, 16, 0x3fff);





 v = ( 0x0800 | 0x0400 | 0x0200 | 0x0100 | 0x0080 | 0x0040 ) | 0x1000;
 stp4020_wr_sockctl(h, 12, v);


 v = stp4020_rd_sockctl(h, 16);
 h->sense = v & (0x0040 | 0x0080);
 if (h->sense != 0) {
  h->flags |= 0x0001;
 ...
 void *arg;
{
 ...
 for (;;) {
  ...
  if ((socket = ffs(sc->events)) == 0) {
   _splx(s);
   (void)tsleep(&sc->events, 32, "stp4020_ev", 0);
   continue;
  }
  socket--;
  sc->events &= ~(1 << socket);
  ...
  if (sense > h->sense) {
   ...
   if (h->flags & 0x0001) {
    h->flags &= ~0x0001;
    pcmcia_card_detach(h->pcmcia, 0x01);
   }
  }
 }
}
...
stp4020_intr_dispatch(void *arg)
{
 ...
 s = _splraise(15);
 stp4020_wr_sockctl(h, 12, h->int_enable);
 _splx(s);
}
 ...
 void *arg;
{
 ...
 for (i = 0 ; i < 2; i++) {
  ...
  v = stp4020_rd_sockctl(h, 16);
  sense = v & (0x0040 | 0x0080);
# 429 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c"
  stp4020_wr_sockctl(h, 16,
      0x7f00);

  if ((v & 0x2000) != 0) {
   r = 1;
# 448 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c"
   if (sense != h->sense)
...
stp4020_map_window(struct stp4020_socket *h, int win, int speed)
{
 ...
 v |= (((0) >> 20) & 0x0003f);
 stp4020_wr_winctl(h, win, 0, v);
 stp4020_wr_winctl(h, win, 2,
     1 << 0);
}
 ...
 int *windowp;
{
 ...
 pcmhp->size = size;
 pcmhp->realsize = (1024*1024) - card_addr;
 *offsetp = 0;
 *windowp = win;
 ...
 int *windowp;
{
 ...
 pcihp->iot = h->wintag;
 bus_space_subregion(h->wintag, h->windows[2].winaddr,
 ...
 pcmcia_chipset_handle_t pch;
{
 ...
 v = 0x0002;
 stp4020_wr_sockctl(h, 14, v);
# 754 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/stp4020.c"
 ...
 stp4020_wr_sockctl(h, 12,
     stp4020_rd_sockctl(h, 12) | 0x0002);
 delay(20);
 stp4020_wr_sockctl(h, 12,
     stp4020_rd_sockctl(h, 12) & ~0x0002);
 ...
 if (pcmcia_card_gettype(h->pcmcia) == 1) {
  v &= ~(0x0008 | 0x0001);
  v |= 0x0001 | 0x0010 |
      0x0000 | 0x0004;
  h->int_enable = v;
  h->int_disable = v & ~0x0010;
  ;
 ...
 char *xname;
{
 ...
 return h->softint != ((void *)0) ? h : ((void *)0);
}
