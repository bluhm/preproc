# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c" 2
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi_util.c"
usbd_status
usbd_get_desc(struct usbd_device *dev, int type, int index, int len, void *desc)
{
 ...
 req.bRequest = 0x06;
 ((req.wValue)[0] = (u_int8_t)(index), (req.wValue)[1] = (u_int8_t)(type));
...
usbd_get_device_status(struct usbd_device *dev, usb_status_t *st)
{
 ...
 ((req.wIndex)[0] = (u_int8_t)(0), (req.wIndex)[1] = (u_int8_t)((0) >> 8));
 ((req.wLength)[0] = (u_int8_t)(sizeof(usb_status_t)), (req.wLength)[1] = (u_int8_t)((sizeof(usb_status_t)) >> 8));
...
usbd_get_hub_status(struct usbd_device *dev, usb_hub_status_t *st)
{
 ...
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0), (req.wIndex)[1] = (u_int8_t)((0) >> 8));
 ((req.wLength)[0] = (u_int8_t)(sizeof(usb_hub_status_t)), (req.wLength)[1] = (u_int8_t)((sizeof(usb_hub_status_t)) >> 8));
 return (usbd_do_request(dev, &req, st));
}
...
{
 usb_device_request_t req;
 uint16_t len = 8 + (nports + 1) / 8;

 req.bmRequestType = (0x80 | 0x20 | 0x00);
 req.bRequest = 0x06;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)(0x29));
 ((req.wIndex)[0] = (u_int8_t)(0), (req.wIndex)[1] = (u_int8_t)((0) >> 8));
 ((req.wLength)[0] = (u_int8_t)(len), (req.wLength)[1] = (u_int8_t)((len) >> 8));
...
{
 usb_device_request_t req;
 uint16_t len = 11 + (nports + 1) / 8;

 req.bmRequestType = (0x80 | 0x20 | 0x00);
 req.bRequest = 0x06;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)(0x2A));
 ((req.wIndex)[0] = (u_int8_t)(0), (req.wIndex)[1] = (u_int8_t)((0) >> 8));
 ((req.wLength)[0] = (u_int8_t)(len), (req.wLength)[1] = (u_int8_t)((len) >> 8));
 return (usbd_do_request(dev, &req, hd));
}
...
usbd_get_port_status(struct usbd_device *dev, int port, usb_port_status_t *ps)
{
 ...
 req.bmRequestType = (0x80 | 0x20 | 0x03);
 req.bRequest = 0x00;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(port), (req.wIndex)[1] = (u_int8_t)((port) >> 8));
 ((req.wLength)[0] = (u_int8_t)(sizeof *ps), (req.wLength)[1] = (u_int8_t)((sizeof *ps) >> 8));
...
usbd_clear_hub_feature(struct usbd_device *dev, int sel)
{
 ...
 req.bmRequestType = (0x00 | 0x20 | 0x00);
 req.bRequest = 0x01;
 ((req.wValue)[0] = (u_int8_t)(sel), (req.wValue)[1] = (u_int8_t)((sel) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0), (req.wIndex)[1] = (u_int8_t)((0) >> 8));
...
usbd_set_hub_depth(struct usbd_device *dev, int depth)
{
 ...
 req.bmRequestType = (0x00 | 0x20 | 0x00);
 req.bRequest = 0x0c;
 ((req.wValue)[0] = (u_int8_t)(depth), (req.wValue)[1] = (u_int8_t)((depth) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0), (req.wIndex)[1] = (u_int8_t)((0) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
 return usbd_do_request(dev, &req, 0);
}
...
usbd_set_idle(struct usbd_device *dev, int ifaceno, int duration, int id)
{
 ...
 req.bRequest = 0x0a;
 ((req.wValue)[0] = (u_int8_t)(id), (req.wValue)[1] = (u_int8_t)(duration));
 ((req.wIndex)[0] = (u_int8_t)(ifaceno), (req.wIndex)[1] = (u_int8_t)((ifaceno) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
 return (usbd_do_request(dev, &req, 0));
}
    ...
    void *data, int len)
{
 ...
 req.bmRequestType = (0x80 | 0x00 | 0x01);
 req.bRequest = 0x06;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)(0x22));
 ((req.wIndex)[0] = (u_int8_t)(ifaceno), (req.wIndex)[1] = (u_int8_t)((ifaceno) >> 8));
 ((req.wLength)[0] = (u_int8_t)(len), (req.wLength)[1] = (u_int8_t)((len) >> 8));
...
usbd_get_hid_descriptor(struct usbd_device *dev, usb_interface_descriptor_t *id)
{
 ...
 end = (char *)cdesc + ((cdesc->wTotalLength)[0] | ((cdesc->wTotalLength)[1] << 8));

 for (; p < end; p += hd->bLength) {
  hd = (struct usb_hid_descriptor *)p;
  if (p + hd->bLength <= end && hd->bDescriptorType == 0x21)
   return (hd);
  if (hd->bDescriptorType == 0x04)
   break;
 }
 return (0);
}
