# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vops.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vops.c"
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vops.c"
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vops.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vops.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vops.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vops.c" 2
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vops.c"
int
VOP_ISLOCKED(struct vnode *vp)
{
 ...
 if (vp->v_op->vop_islocked == ((void *)0))
  return (45);
...
VOP_KQFILTER(struct vnode *vp, struct knote *kn)
{
 ...
 if (vp->v_op->vop_kqfilter == ((void *)0))
  return (45);
...
VOP_INACTIVE(struct vnode *vp, struct proc *p)
{
 ...
 if (vp->v_op->vop_inactive == ((void *)0))
  return (45);
...
VOP_PATHCONF(struct vnode *vp, int name, register_t *retval)
{
 ...
 if (vp->v_op->vop_pathconf == ((void *)0))
  return (45);
...
VOP_STRATEGY(struct buf *bp)
{
 ...
 if ((((bp->b_flags) & (0x02000000))) && (!((bp->b_flags) & (0x04000000))))
  panic("Non dma reachable buffer passed to VOP_STRATEGY");

 if (bp->b_vp->v_op->vop_strategy == ((void *)0))
  return (45);
...
VOP_BWRITE(struct buf *bp)
{
 ...
 if (bp->b_vp->v_op->vop_bwrite == ((void *)0))
  return (45);
