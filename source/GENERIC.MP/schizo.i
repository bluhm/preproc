# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c"
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c"
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
...
void device_register(struct device *, void *);
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2




# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizoreg.h" 1
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizoreg.h"
...
# 257 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizoreg.h"
struct schizo_range {
 u_int32_t cspace;
 u_int32_t child_hi;
 u_int32_t child_lo;
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizovar.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizovar.h"
struct schizo_pbm {
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c" 2
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c"
...
schizo_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_ign = ((ma->ma_upaid << 6)&0x0000007c0LL);
 ...
 bus_space_write_8((sc)->sc_bust, (sc)->sc_ctrlh, (0x10020), (bus_space_read_8((sc)->sc_bust, (sc)->sc_ctrlh, (0x10020)) | 0x8000000000000000UL | 0x4000000000000000UL | 0x2000000000000000UL));
...
schizo_init(struct schizo_softc *sc, int busa)
{
 ...
 if (bus_space_subregion(pbm->sp_regt, sc->sc_ctrlh,
     busa ? __builtin_offsetof(struct schizo_regs, pbm_a) :
     __builtin_offsetof(struct schizo_regs, pbm_b),
 ...
 match = bus_space_read_8((sc)->sc_bust, (sc)->sc_ctrlh, (busa ? 0x00050 : 0x00070));
 ...
 bus_space_write_8((pbm)->sp_regt, (pbm)->sp_regh, (0x01a00), (5));


 bus_space_write_8((pbm)->sp_regt, (pbm)->sp_regh, (0x02000), (bus_space_read_8((pbm)->sp_regt, (pbm)->sp_regh, (0x02000))));
 bus_space_write_8((pbm)->sp_regt, (pbm)->sp_regh, (0x02010), (bus_space_read_8((pbm)->sp_regt, (pbm)->sp_regh, (0x02010))));
 bus_space_write_4((pbm)->sp_cfgt, (pbm)->sp_cfgh, (0x04), (bus_space_read_4((pbm)->sp_cfgt, (pbm)->sp_cfgh, (0x04))));


 reg64 = bus_space_read_8((pbm)->sp_regt, (pbm)->sp_regh, (0x02000));

 reg64 |= (1UL << 17UL) | (1UL << 19UL) | (0x3fUL << 0UL);
 reg64 &= ~(1UL << 18UL);
 bus_space_write_8((pbm)->sp_regt, (pbm)->sp_regh, (0x02000), (reg64));

 reg64 = bus_space_read_8((pbm)->sp_regt, (pbm)->sp_regh, (0x02020));
 reg64 &= ~((1UL << 7UL) | (1UL << 6UL) |
     (1UL << 5UL));
 bus_space_write_8((pbm)->sp_regt, (pbm)->sp_regh, (0x02020), (reg64));

 if (busa)
  schizo_set_intr(sc, pbm, 15, schizo_pci_error,
     pbm, 0x32, "pci_a");
 else
  schizo_set_intr(sc, pbm, 15, schizo_pci_error,
     pbm, 0x33, "pci_b");
 ...
 schizo_set_intr(sc, pbm, 15, schizo_ue, sc, 0x30,
     "ue");
 schizo_set_intr(sc, pbm, 15, schizo_ce, sc, 0x31,
     "ce");
 schizo_set_intr(sc, pbm, 15, schizo_safari_error, sc,
     0x34, "safari");
 ...
 if (sc->sc_tomatillo &&
     ((bus_space_read_8((sc)->sc_bust, (sc)->sc_ctrlh, (0x10000)) >> 20) & 0x7) == 6)
  db_register_xir(schizo_xir, sc);


 config_found_sm((&sc->sc_dv), (&pba), (schizo_print), ((void *)0));
}
...
schizo_pci_error(void *vpbm)
{
 ...
 afsr = bus_space_read_8((sp)->sp_regt, (sp)->sp_regh, (0x02010));
 afar = bus_space_read_8((sp)->sp_regt, (sp)->sp_regh, (0x02018));
 ctrl = bus_space_read_8((sp)->sp_regt, (sp)->sp_regh, (0x02000));
 csr = bus_space_read_4((sp)->sp_cfgt, (sp)->sp_cfgh, (0x04));

 printf("%s: pci bus %c error\n", sc->sc_dv.dv_xname,
     sp->sp_bus_a ? 'A' : 'B');

 printf("PCIAFSR=%llb\n", afsr, "\20\277PMA\276PTA\275PRTRY\274PPERR\273PTTO\272PUNUS\271SMA\270STA\267SRTRY\266SPERR\265STTO\264SUNUS\237BLK\236CFG\235MEM\234IO");
 printf("PCIAFAR=%llx\n", afar);
 printf("PCICTRL=%llb\n", ctrl, "\20\277UNUS\276DTO\275DTO_INT\263ESLCK\246TTO\245RTRY\244MMU\243SBH\242SERR\241SPD\223MMU_INT\222SBH_INT\221EEN\220PARK\210PCIRST");
 printf("PCICSR=%b\n", csr, ("\020\01IO\02MEM\03MASTER\04SPECIAL\05INVALIDATE\06PALETTE\07PARITY" "\010STEPPING\011SERR\012BACKTOBACK\025CAPLIST\026CLK66\027UDF" "\030BACK2BACK_STAT\031PARITY_STAT\032DEVSEL_MEDIUM\033DEVSEL_SLOW" "\034TARGET_TARGET_ABORT\035MASTER_TARGET_ABORT\036MASTER_ABORT" "\037SPECIAL_ERROR\040PARITY_DETECT"));

 if (ctrl & (1UL << 36UL)) {
  u_int64_t ctrl, tfar;

  ctrl = bus_space_read_8((sp)->sp_regt, (sp)->sp_regh, (0x00200));
  ...
  if (sc->sc_tomatillo) {
   tfar = bus_space_read_8((sp)->sp_regt, (sp)->sp_regh, (0x00220));
   printf("IOMMUTFAR=%llx\n", tfar);
  }


  if ((ctrl & (3UL << 25)) == (1UL << 25) ||
      ctrl & (1UL << 27) ||
      ctrl & (1UL << 28)) {
   if (csr & 0x08000000) {
    bus_space_write_8((sp)->sp_regt, (sp)->sp_regh, (0x00200), (ctrl));
    goto clear_error;
   }
  }
 }
 ...
 clear_error:
 bus_space_write_4((sp)->sp_cfgt, (sp)->sp_cfgh, (0x04), (csr));
 bus_space_write_8((sp)->sp_regt, (sp)->sp_regh, (0x02000), (ctrl));
 bus_space_write_8((sp)->sp_regt, (sp)->sp_regh, (0x02010), (afsr));
 return (1);
}
...
schizo_safari_error(void *vsc)
{
 ...
 printf("ERRLOG=%llx\n", bus_space_read_8((sc)->sc_bust, (sc)->sc_ctrlh, (0x10018)));
 printf("UE_AFSR=%llx\n", bus_space_read_8((sc)->sc_bust, (sc)->sc_ctrlh, (0x10030)));
 printf("UE_AFAR=%llx\n", bus_space_read_8((sc)->sc_bust, (sc)->sc_ctrlh, (0x10038)));
 printf("CE_AFSR=%llx\n", bus_space_read_8((sc)->sc_bust, (sc)->sc_ctrlh, (0x10040)));
 printf("CE_AFAR=%llx\n", bus_space_read_8((sc)->sc_bust, (sc)->sc_ctrlh, (0x10048)));
...
schizo_init_iommu(struct schizo_softc *sc, struct schizo_pbm *pbm)
{
 ...
 int *vdma = ((void *)0), nitem, tsbsize = 7;
 u_int32_t iobase = -1;
 vaddr_t va;
 char *name;
 ...
 if (bus_space_subregion(is->is_bustag, pbm->sp_regh,
     __builtin_offsetof(struct schizo_pbm_regs, iommu),
 ...
 if (bus_space_subregion(is->is_bustag, pbm->sp_regh,
     __builtin_offsetof(struct schizo_pbm_regs, strbuf),
     sizeof(struct iommu_strbuf), &is->is_sb[0]->sb_sb)) {
  panic("schizo: unable to create streaming buffer handle");
  is->is_sb[0]->sb_flush = ((void *)0);
 }



 bus_space_write_8(is->is_bustag, is->is_sb[0]->sb_sb,
     (__builtin_offsetof(struct iommu_strbuf, strbuf_ctl)),
     bus_space_read_8(is->is_bustag, is->is_sb[0]->sb_sb,
  (__builtin_offsetof(struct iommu_strbuf, strbuf_ctl))) & ~0x000000000000000001LL);
 is->is_sb[0]->sb_flush = ((void *)0);
 ...
 if (!getprop(sc->sc_node, "virtual-dma", sizeof(vdma), &nitem,
  ...
  switch (vdma[1]) {
   case 1 << ((1) + 23): tsbsize = (1); break; case 1 << ((2) + 23): tsbsize = (2); break; case 1 << ((3) + 23): tsbsize = (3); break;
   case 1 << ((4) + 23): tsbsize = (4); break; case 1 << ((5) + 23): tsbsize = (5); break; case 1 << ((6) + 23): tsbsize = (6); break;
  default:
   printf("bogus tsb size %x, using 7\n", vdma[1]);
   case 1 << ((7) + 23): tsbsize = (7); break;
  }
...
pcireg_t
schizo_conf_read(pci_chipset_tag_t pc, pcitag_t tag, int reg64)
{
...
void
schizo_conf_write(pci_chipset_tag_t pc, pcitag_t tag, int reg64, pcireg_t data)
{
        bus_space_write_4(pc->bustag, pc->bushandle,
     ((tag)&0xffffffff) + reg64, data);
}
...
# 521 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/schizo.c"
 if (pa->pa_intrpin == 0)
  return (-1);
 ...
 *ihp = (pa->pa_intrpin - 1) & 0x000000003LL;
 *ihp |= (dev << 2) & 0x00000000cLL;
 *ihp |= sc->sc_ign;
...
schizo_bus_addr(bus_space_tag_t t, bus_space_tag_t t0, bus_space_handle_t h)
{
 ...
 for (i = 0; i < pbm->sp_nrange; i++) {
  ...
  return (((addr)&0xffffffff) - pbm->sp_range[i].phys_lo);
 }
...
{
 struct schizo_pbm *pbm = t->cookie;
 struct intrhand *ih = ((void *)0);
 volatile u_int64_t *intrmapptr = ((void *)0), *intrclrptr = ((void *)0);
 int ino;
 long vec = ((ihandle)&(0x0000007c0LL|0x00000003fLL));

 vec = ((ihandle)&(0x0000007c0LL|0x00000003fLL));
 ino = ((vec)&0x00000003fLL);
 ...
 if ((flags & 0x0002) == 0) {
  ...
  if (((vec)&0x0000007c0LL) == 0)
   ino |= (*intrmapptr) & 0x0000007c0LL;
  else
   ino |= vec & 0x0000007c0LL;
 }
 ...
 if (intrmapptr != ((void *)0)) {
  ...
  intrmap = *intrmapptr;
  intrmap |= 0x080000000LL;
  *intrmapptr = intrmap;
  intrmap = *intrmapptr;
  ih->ih_number |= intrmap & (0x0000007c0LL|0x00000003fLL);
 }
...
schizo_xir(void *arg, int cpu)
{
 ...
 bus_space_write_8((sc)->sc_bust, (sc)->sc_ctrlh, (0x17010), (0x00000000000000002L));
}
