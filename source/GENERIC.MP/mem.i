# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c"
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c"
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c" 2
...
int bppopen(dev_t, int, int, struct proc *); int bppclose(dev_t, int, int, struct proc *); int bppread(dev_t, struct uio *, int); int bppwrite(dev_t, struct uio *, int); int bppioctl(dev_t, u_long, caddr_t, int, struct proc *); int bppstop(struct tty *, int); struct tty *bpptty(dev_t); int bpppoll(dev_t, int, struct proc *); paddr_t bppmmap(dev_t, off_t, int); int bppkqfilter(dev_t, struct knote *);
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/mem.c" 2
...
mmopen(dev_t dev, int flag, int mode, struct proc *p)
{
 ...
 switch (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))) {
 case 0:
 case 1:
...
{
 static struct rwlock physlock = { 0, "mmrw" };
 vaddr_t o, v;
 size_t c;
 struct iovec *iov;
 int error = 0;
 ...
 if (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) == 0) {
  ...
  error = _rw_enter(&physlock, 0x0001UL | 0x0010UL );
  if (error)
   return (error);
 }
 while (uio->uio_resid > 0 && error == 0) {
  ...
  case 0:
   ...
   prot = uio->uio_rw == UIO_READ ? 0x01 :
       0x02;
   pmap_enter((&kernel_pmap_), (vaddr_t)vmmap,
       ((v) & ~((1 << 13) - 1)), prot, prot|0x00000010);
   ;
   o = uio->uio_offset & ((1 << 13) - 1);
   c = ulmin(uio->uio_resid, (1 << 13) - o);
   error = uiomove((caddr_t)vmmap + o, c, uio);
   pmap_remove((&kernel_pmap_), (vaddr_t)vmmap,
       (vaddr_t)vmmap + (1 << 13));
   ;
   break;
  ...
  case 1:
   v = uio->uio_offset;
   c = ulmin(iov->iov_len, (64 * 1024));
   if (!uvm_kernacc((caddr_t)v, c,
       uio->uio_rw == UIO_READ ? 0x00008000 : 0x00000000))
    return (14);
  ...
  case 12:
   ...
   if (zeropage == ((void *)0))
    zeropage = malloc((1 << 13), 127,
        0x0001 | 0x0008);
   c = ulmin(iov->iov_len, (1 << 13));
