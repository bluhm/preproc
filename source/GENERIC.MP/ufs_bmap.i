# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c" 2
...
ufs_bmap(void *v)
{
 ...
 return (ufs_bmaparray(ap->a_vp, ap->a_bn, ap->a_bnp, ((void *)0), ((void *)0),
     ap->a_runp));
}
# 89 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c"
int
    ...
    int *nump, int *runp)
{
 ...
 num = *nump;
 if (num == 0) {
  *bnp = (((((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_db[bn] : (ip)->dinode_u.ffs2_din->di_db[bn])) << (ump)->um_bptrtodb);
  if (*bnp == 0)
   *bnp = -1;
  else if (runp)
   for (++bn; bn < 12 && *runp < maxrun &&
       (((((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_db[bn] : (ip)->dinode_u.ffs2_din->di_db[bn])) == ((((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_db[bn - 1] : (ip)->dinode_u.ffs2_din->di_db[bn - 1])) + ump->um_seqinc);
 ...
 daddr = (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_ib[xap->in_off] : (ip)->dinode_u.ffs2_din->di_ib[xap->in_off]);
 ...
 for (bp = ((void *)0), ++xap; --num; ++xap) {
  ...
  if (ip->i_ump->um_fstype == 2) {
   ...
   if (num == 1 && daddr && runp)
    for (bn = xap->in_off + 1;
        ...
        ((((int64_t *)bp->b_data)[bn]) == (((int64_t *)bp->b_data)[bn - 1]) + ump->um_seqinc);
  ...
  if (num == 1 && daddr && runp)
   for (bn = xap->in_off + 1;
       bn < ((ump)->um_nindir) && *runp < maxrun &&
       ((((int32_t *)bp->b_data)[bn]) == (((int32_t *)bp->b_data)[bn - 1]) + ump->um_seqinc);
...
# 226 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_bmap.c"
int
ufs_getlbns(struct vnode *vp, daddr_t bn, struct indir *ap, int *nump)
{
 ...
 ump = ((struct ufsmount *)((vp->v_mount)->mnt_data));
 if (nump)
  *nump = 0;
 numlevels = 0;
 realbn = bn;
 ...
 for (blockcnt = 1, i = 3, bn -= 12;; i--, bn -= blockcnt) {
  if (i == 0)
   return (27);
