# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midivar.h" 1
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midivar.h"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midivar.h" 2
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midivar.h"
struct midi_buffer {
 unsigned char data[(1 << 10)];
 unsigned start, used;
};
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midivar.h"
struct midi_softc {
 struct device dev;
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c" 2
...
struct filterops midiwrite_filtops = {
 1, ((void *)0), filt_midiwdetach, filt_midiwrite
};
...
struct filterops midiread_filtops = {
 1, ((void *)0), filt_midirdetach, filt_midiread
};
...
midi_iintr(void *addr, int data)
{
 ...
 do { (mb)->data[(((mb)->start + (mb)->used) & ((1 << 10) - 1))] = (data); (mb)->used++; } while(0);
 if (mb->used == 1) {
  if (sc->rchan) {
   sc->rchan = 0;
   wakeup(&sc->rchan);
...
midiread(dev_t dev, struct uio *uio, int ioflag)
{
 ...
 sc = (struct midi_softc *)device_lookup(&midi_cd, ((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)));
 if (sc == ((void *)0))
  return 6;
 if (!(sc->flags & 0x0001)) {
  error = 6;
 ...
 while (((mb)->used == 0)) {
  ...
  sc->rchan = 1;
  error = msleep(&sc->rchan, &audio_lock, 32 | 0x100, "mid_rd", 0);
...
midi_out_do(struct midi_softc *sc)
{
 ...
 while (mb->used > 0) {
  if (!sc->hw_if->output(sc->hw_hdl, mb->data[mb->start]))
   break;
  do { (mb)->start += (1); (mb)->start &= ((1 << 10) - 1); (mb)->used -= (1); } while(0);
  if (((mb)->used == 0)) {
   if (sc->hw_if->flush != ((void *)0))
...
midiwrite(dev_t dev, struct uio *uio, int ioflag)
{
 ...
 while (uio->uio_resid > 0) {
  ...
  count = (1 << 10) - (((mb)->start + (mb)->used) & ((1 << 10) - 1));
  if (count > ((1 << 10) - (mb)->used))
   count = ((1 << 10) - (mb)->used);
  if (count > uio->uio_resid)
   count = uio->uio_resid;
  __mtx_leave(&audio_lock);
...
midiopen(dev_t dev, int flags, int mode, struct proc *p)
{
 ...
 do { (&sc->inbuf)->start = (&sc->inbuf)->used = 0; } while(0);
...
midiclose(dev_t dev, int fflag, int devtype, struct proc *p)
{
 ...
 __mtx_leave(&audio_lock);
# 511 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/midi.c"
...
midiprobe(struct device *parent, void *match, void *aux)
{
 ...
 return (sa != ((void *)0) && (sa->type == 1) ? 1 : 0);
}
...
midi_attach_mi(struct midi_hw_if *hwif, void *hdl, struct device *dev)
{
 ...
 arg.hwif = hwif;
 arg.hdl = hdl;
 return config_found_sm((dev), (&arg), (midiprint), ((void *)0));
}
