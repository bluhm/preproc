# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
int cd9660_vget_internal(struct mount *, cdino_t, struct vnode **, int,
    struct iso_directory_record *);
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.h" 1
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.h"
typedef struct {
 char type [(1 - 0 + 1)];
 u_char length [(2 - 2 + 1)];
 u_char version [(3 - 3 + 1)];
} ISO_SUSP_HEADER;
...
typedef struct {
 ISO_SUSP_HEADER h;
 char dev_t_high [(11 - 4 + 1)];
 char dev_t_low [(19 - 12 + 1)];
} ISO_RRIP_DEVICE;
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.h"
typedef struct {
 u_char cflag [(1 - 1 + 1)];
 u_char clen [(2 - 2 + 1)];
 u_char name [1];
...
# 109 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.h"
typedef struct {
 ISO_SUSP_HEADER h;
 u_char flags [(4 - 4 + 1)];
 u_char time [(5 - 5 + 1)];
...
typedef struct {
 ISO_SUSP_HEADER h;
 char location [(11 - 4 + 1)];
 char offset [(19 - 12 + 1)];
 char length [(27 - 20 + 1)];
} ISO_RRIP_CONT;
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
...
int cd9660_rrip_offset(struct iso_directory_record *isodir,
      struct iso_mnt *imp);
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_rrip.c" 2
 ...
 ISO_RRIP_ANALYZE *ana;
{
 ...
 cd9660_defattr(isodir, ana->inop, ((void *)0));
}
 ...
 ISO_RRIP_ANALYZE *ana;
{
 ...
 for (; pcomp < pcompe;
     ...
     ((char *)pcomp + 2 + isonum_711(pcomp->clen))) {
  ...
  __builtin_bcopy((inbuf), (outbuf), (wlen));
  outbuf += wlen;
  len += wlen;
 }
 ana->outbuf = outbuf;
 ...
 ISO_RRIP_ANALYZE *ana;
{
 ...
 __builtin_bcopy((inbuf), (ana->outbuf), (wlen));
 ana->outbuf += wlen;
 ...
 *ana->inump = isonum_733(p->dir_loc) << ana->imp->im_bshift;
 ana->fields &= ~(0x0010 | 0x0020);
 return (*p->h.type == 'C' ? 0x0010 : 0x0020);
}
 ...
 ISO_RRIP_ANALYZE *ana;
{
 ...
 if (!(*p->flags & 0x80)) {
  ...
  if (*p->flags & 0x02) {
   ...
   __builtin_bzero((&ana->inop->inode.iso_mtime), (sizeof(struct timespec)));
 ...
 ISO_RRIP_ANALYZE *ana;
{
 ...
 cd9660_deftstamp(isodir, ana->inop, ((void *)0));
}
 ...
 ISO_RRIP_ANALYZE *ana;
{
 ...
 if (high == 0)
  ana->inop->inode.iso_rdev = ((dev_t)((((((int32_t)(((u_int32_t)(low) >> 8) & 0xff))) & 0xff) << 8) | ((((int32_t)((low) & 0xff) | (((low) & 0xffff0000) >> 8))) & 0xff) | (((((int32_t)((low) & 0xff) | (((low) & 0xffff0000) >> 8))) & 0xffff00) << 8)));
 else
  ana->inop->inode.iso_rdev = ((dev_t)((((high) & 0xff) << 8) | ((((int32_t)((low) & 0xff) | (((low) & 0xffff0000) >> 8))) & 0xff) | (((((int32_t)((low) & 0xff) | (((low) & 0xffff0000) >> 8))) & 0xffff00) << 8)));
 ana->fields &= ~0x0002;
 return (0x0002);
}
 ...
 ISO_RRIP_ANALYZE *ana;
{
 ...
 if (isonum_711(p->len_id) != 9 &&
  ...
  return (0);
 if (isonum_711(p->len_id) == 9 &&
     __builtin_bcmp(((char *)p + 8), ("IEEE_1282"), (9)))
  return (0);
 if (isonum_711(p->len_id) == 10 &&
     __builtin_bcmp(((char *)p + 8), ("IEEE_P1282"), (10)) &&
     __builtin_bcmp(((char *)p + 8), ("RRIP_1991A"), (10)))
  return (0);
 ana->fields &= ~0x0200;
 return (0x0200);
}
 ...
 struct iso_mnt *imp;
{
 ...
 analyze.inop = inop;
 analyze.imp = imp;
 analyze.fields = 0x0001 | 0x0080 | 0x0002;
 ...
 struct iso_mnt *imp;
{
 ...
 analyze.inump = inump;
 analyze.imp = imp;
 analyze.fields = 0x0008 | 0x0040 | 0x0010 |
     0x0020;
 *outlen = 0;
...
static RRIP_TABLE rrip_table_getsymname[] = {
 { "SL", cd9660_rrip_slink, 0, 0x0004 },
 { "RR", cd9660_rrip_idflag, 0, 0x0100 },
 { "CE", cd9660_rrip_cont, 0, 0x0400 },
 { "ST", cd9660_rrip_stop, 0, 0x1000 },
 { "", 0, 0, 0 }
};
...
static RRIP_TABLE rrip_table_extref[] = {
 { "ER", cd9660_rrip_extref, 0, 0x0200 },
 { "CE", cd9660_rrip_cont, 0, 0x0400 },
 { "ST", cd9660_rrip_stop, 0, 0x1000 },
 { "", 0, 0, 0 }
};
 ...
 struct iso_mnt *imp;
{
 ...
 if (__builtin_bcmp((p), ("SP\7\1\276\357"), (6))) {
