# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_io.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_io.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_io.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_io.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_io.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/mman.h" 1
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_io.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_io.c" 2
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_io.c"
int
uvm_io(vm_map_t map, struct uio *uio, int flags)
{
 ...
 if (endva >= ((vaddr_t)-1))
  ...
  togo = togo - (endva - ((vaddr_t)-1) + 1);
 pageoffset = baseva & ((1 << 13) - 1);
 baseva = ((baseva) & ~((1 << 13) - 1));
 chunksz = min((((togo + pageoffset) + ((1 << 13) - 1)) & ~((1 << 13) - 1)), (64 * 1024));
 error = 0;
 ...
 for ( ; togo > 0 ; pageoffset = 0) {
  ...
  if (error) {
   ...
   if (error == 12 && chunksz > (1 << 13)) {
    chunksz = ((chunksz / 2) & ~((1 << 13) - 1));
    if (chunksz < (1 << 13))
     chunksz = (1 << 13);
    continue;
   }
  ...
  vm_map_lock_ln(kernel_map, "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_io.c", 117);
  ...
  uvm_unmap_remove(kernel_map, kva, kva+chunksz,
      &dead_entries, 0, 1);
  vm_map_unlock_ln(kernel_map, "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_io.c", 121);
