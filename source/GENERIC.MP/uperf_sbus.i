# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c"
...
struct tty;
struct uio;
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
void device_register(struct device *, void *);
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbusreg.h" 1
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/uperf_sbus.c" 2
...
uperf_sbus_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (bus_space_map(sc->sc_bus_t, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset)), sa->sa_reg[0].sbr_size, 0, &sc->sc_bus_h) != 0) {
 ...
 id = uperf_sbus_read_reg(sc, 0x04);
...
uperf_sbus_read_reg(struct uperf_sbus_softc *sc, bus_size_t r)
{
 ...
 s = _splraise(15);
 bus_space_write_1(sc->sc_bus_t, sc->sc_bus_h, 0x0000, r);
 bus_space_barrier(sc->sc_bus_t, sc->sc_bus_h, 0x0000, 1,
     0x02);



 v = bus_space_read_1(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 0);
 bus_space_barrier(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 0, 1,
     0x01);

 v <<= 8;
 v |= bus_space_read_1(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 1);
 bus_space_barrier(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 1, 1,
     0x01);

 v <<= 8;
 v |= bus_space_read_1(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 2);
 bus_space_barrier(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 2, 1,
     0x01);

 v <<= 8;
 v |= bus_space_read_1(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 3);
 bus_space_barrier(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 3, 1,
     0x01);
...
uperf_sbus_write_reg(struct uperf_sbus_softc *sc, bus_size_t r, u_int32_t v)
{
 ...
 bus_space_write_1(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 0,
     (v >> 24) & 0xff);
 bus_space_barrier(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 0, 1,
     0x02);

 bus_space_write_1(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 1,
     (v >> 16) & 0xff);
 bus_space_barrier(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 1, 1,
     0x02);

 bus_space_write_1(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 2,
     (v >> 8) & 0xff);
 bus_space_barrier(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 2, 1,
     0x02);

 bus_space_write_1(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 3,
     (v >> 0) & 0xff);
 bus_space_barrier(sc->sc_bus_t, sc->sc_bus_h, 0x0004 + 3, 1,
     0x02);
 _splx(s);
...
uperf_sbus_clrcnt(void *vsc, int flags)
{
 ...
 if (flags & 2)
  clr |= 0x00008000;
 if (clr) {
  oldsrc = uperf_sbus_read_reg(sc, 0x20);
  uperf_sbus_write_reg(sc, 0x20, clr | oldsrc);
 }
 return (0);
}
...
uperf_sbus_setcntsrc(void *vsc, int flags, u_int src0, u_int src1)
{
 ...
 src = uperf_sbus_read_reg(sc, 0x20);
 if (flags & 1) {
  src &= ~0x0000000f;
  src |= ((src0 << 0) & 0x0000000f) | 0x00000080;
 }
 if (flags & 2) {
  src &= ~0x00000f00;
  src |= ((src1 << 8) & 0x00000f00) | 0x00008000;
 }
 uperf_sbus_write_reg(sc, 0x20, src);
 return (0);
}
...
uperf_sbus_getcntsrc(void *vsc, int flags, u_int *srcp0, u_int *srcp1)
{
 ...
 src = uperf_sbus_read_reg(sc, 0x20);
 if (flags & 1)
  *srcp0 = (src & 0x0000000f) >> 0;
 if (flags & 2)
  *srcp1 = (src & 0x00000f00) >> 8;
 return (0);
}
...
uperf_sbus_getcnt(void *vsc, int flags, u_int32_t *cntp0, u_int32_t *cntp1)
{
 ...
 c0 = uperf_sbus_read_reg(sc, 0x08);
 c1 = uperf_sbus_read_reg(sc, 0x10);
 if (flags & 1)
  *cntp0 = c0;
 if (flags & 2)
  *cntp1 = c1;
...
uperf_sbus_xir(void *arg, int cpu)
{
 ...
 uperf_sbus_write_reg(sc, 0x00, 0x20000000);
}
