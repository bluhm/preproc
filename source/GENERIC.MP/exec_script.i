# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/exec_script.h" 1
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/exec_script.h"
int exec_script_makecmds(struct proc *, struct exec_package *);
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c" 2
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c"
int
exec_script_makecmds(struct proc *p, struct exec_package *epp)
{
 ...
 if ((epp->ep_flags & 0x0001) != 0 ||
     epp->ep_hdrvalid < 2 ||
     strncmp(hdrstr, "#!", 2))
  return 8;
# 96 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_script.c"
 hdrlinelen = min(epp->ep_hdrvalid, 128);
 for (cp = hdrstr + 2; cp < hdrstr + hdrlinelen;
     cp++) {
  if (*cp == '\n') {
   *cp = '\0';
   break;
...
check_shell:
 ...
 script_sbits = epp->ep_vap->va_mode & (04000 | 02000);
 if (script_sbits != 0) {
 ...
 epp->ep_ndp->ni_dirfd = -100;
 epp->ep_ndp->ni_dirp = shellname;
 epp->ep_ndp->ni_segflg = UIO_SYSSPACE;
 epp->ep_flags |= 0x0001;


 shellargp = mallocarray(4, sizeof(char *), 63, 0x0001);
 tmpsap = shellargp;
 *tmpsap = malloc(shellnamelen + 1, 63, 0x0001);
 strlcpy(*tmpsap++, shellname, shellnamelen + 1);
 if (shellarg != ((void *)0)) {
  *tmpsap = malloc(shellarglen + 1, 63, 0x0001);
  strlcpy(*tmpsap++, shellarg, shellarglen + 1);
 }
 *tmpsap = malloc(1024, 63, 0x0001);
 if ((epp->ep_flags & 0x0002) == 0) {
  error = copyinstr(epp->ep_name, *tmpsap, 1024,
      ((void *)0));
  if (error != 0) {
   *(tmpsap + 1) = ((void *)0);
   goto fail;
  ...
  snprintf(*tmpsap, 1024, "/dev/fd/%d", epp->ep_fd);
 tmpsap++;
 *tmpsap = ((void *)0);
 ...
 if ((error = check_exec(p, epp)) == 0) {
  ...
  if (script_sbits & 04000)
   epp->ep_vap->va_uid = script_uid;
  if (script_sbits & 02000)
