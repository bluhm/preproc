# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c"
...
struct tty;
struct uio;
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
...
void device_register(struct device *, void *);
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c" 2
 ...
 void *aux;
{
 ...
 if (bus_space_map(sa->sa_bustag, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset)), sa->sa_reg[0].sbr_size, 0, &sc->sc_regs) != 0) {
 ...
 if (bus_space_map(sa->sa_bustag, ((((bus_addr_t)sa->sa_reg[1].sbr_slot)<<32)|(sa->sa_reg[1].sbr_offset)), sa->sa_reg[1].sbr_size, 0, &bh) != 0) {
...
# 211 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/qec.c"
 ...
 for (node = firstchild(node); node; node = nextsibling(node)) {
  ...
  (void)config_found_sm((&sc->sc_dev), ((void *)&sa), (qecprint), ((void *)0));
 ...
 bus_space_handle_t *hp;
{
 struct qec_softc *sc = t->cookie;
 int slot = ((addr)>>32);
 bus_addr_t offset = ((addr)&0xffffffff);
 int i;

 for (t = t->parent; t; t = t->parent) {
  if (t->sparc_bus_map != ((void *)0))
   break;
 }
 ...
 for (i = 0; i < sc->sc_nrange; i++) {
  ...
  iospace = sc->sc_range[i].pspace;
                return ((*t->sparc_bus_map)
                    (t, t0, ((((bus_addr_t)iospace)<<32)|(paddr)), size, flags, hp));
 }
 ...
 struct qec_softc *sc;
{
 ...
 bus_space_write_4(t, qr, (0*4), 0x00000001);
 for (i = 0; i < 1000; i++) {
  delay(100);
  v = bus_space_read_4(t, qr, (0*4));
  if ((v & 0x00000001) == 0)
   break;
 }
 ...
 bus_space_write_4(t, qr, (3*4), v);

 v = sc->sc_rsize = sc->sc_bufsiz / (sc->sc_nchannels * 2);
 bus_space_write_4(t, qr, (4*4), v);
 bus_space_write_4(t, qr, (5*4), v);

 psize = sc->sc_nchannels == 1 ? 0x00 : 0;
 bus_space_write_4(t, qr, (2*4), psize);

 if (sc->sc_burst & 0x40)
  burst = 0x00000004;
 else if (sc->sc_burst & 0x20)
  burst = 0x00000002;
 else
  burst = 0x00000000;

 v = bus_space_read_4(t, qr, (0*4));
 v = (v & 0xf0000000) | burst;
 bus_space_write_4(t, qr, (0*4), v);
}
 ...
 unsigned int pktbufsz;
{
 ...
 qr->rb_txddma = dma;
 p += 256 * sizeof(struct qec_xd);
 dma += 256 * sizeof(struct qec_xd);
 ...
 for (i = 0; i < 256; i++) {
  ...
  qr->rb_rxd[i].xd_flags = (i < nrbuf)
   ? 0x80000000 | (pktbufsz & 0x00001fff)
   : 0;
 }
