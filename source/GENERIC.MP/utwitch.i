# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c"
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c"
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c" 2
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/utwitch.c"
...
utwitch_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(utwitch_devs), sizeof (utwitch_devs) / sizeof ((utwitch_devs)[0]), sizeof ((utwitch_devs)[0]), (uha->uaa->vendor), (uha->uaa->product)) != ((void *)0) ?
     13 : 0);
}
...
utwitch_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_sensortask = sensor_task_register(sc, utwitch_refresh, 5);
...
utwitch_intr(struct uhidev *addr, void *ibuf, u_int len)
{
 ...
 case 0x21:
  if (buf[1] == sc->issueing_cmd) {
   ...
   sc->accepted_cmd = 0xf0;
   sc->issueing_cmd = 0xf0;
  }
  break;
 case 0x52:
 case 0x43:
...
utwitch_refresh(void *arg)
{
 ...
 if (!sc->sc_initialized) {
  ...
  sc->sc_sensor_delta.value =
   (1000 * (sc->sc_curval - sc->sc_oldval)) / 5;
...
utwitch_set_mode(struct utwitch_softc *sc, uint8_t val)
{
 ...
 __builtin_memset((req), (0xff), (sizeof(req)));
 req[0] = 0x41;
 req[1] = val;
 req[2] = 0x0d;
...
utwitch_write_value_request(struct utwitch_softc *sc, uint32_t val)
{
 ...
 req[7] = 0xff;
 v = ((__uint32_t)(val));
 __builtin_memcpy((req + 2), (&v), (sizeof(uint32_t)));

 sc->issueing_cmd = 0x53;
 sc->accepted_cmd = 0xf0;
 if (uhidev_set_report(sc->sc_hdev.sc_parent, 0x02,
     sc->sc_hdev.sc_report_id, req, sc->sc_olen) != sc->sc_olen)
  return;
