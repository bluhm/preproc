# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c"
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c"
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c" 2
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c"
int
    ...
    void (*minphys)(struct buf *), struct uio *uio)
{
 ...
 if ((uio->uio_offset % (1 << 9)) != 0)
  return (22);

 error = 0;
 flags &= 0x00008000 | 0x00000000;


 s = _splraise(5);
 bp = pool_get(&bufpool, 0x0001 | 0x0008);
 ...
 for (i = 0; i < uio->uio_iovcnt; i++) {
  ...
  while (iovp->iov_len > 0) {
   void *map = ((void *)0);
# 106 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c"
   ((bp->b_flags) &= ~(0x00000100 | 0x00000400));
   bp->b_flags |= (0x00000010 | 0x00002000 | 0x00004000 | flags);
   ...
   (*minphys)(bp);
   todo = bp->b_bcount;
   ((todo >= 0) ? (void)0 : panic("kernel %sassertion \"%s\" failed: file \"%s\", line %d" " " "minphys broken", "diagnostic ", "todo >= 0", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c", 129));
   ((todo <= (64 * 1024)) ? (void)0 : panic("kernel %sassertion \"%s\" failed: file \"%s\", line %d" " " "minphys broken", "diagnostic ", "todo <= MAXPHYS", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c", 130));
# 139 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c"
   ...
   (*strategy)(bp);
# 162 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c"
   s = _splraise(5);


   while ((bp->b_flags & 0x00000100) == 0)
    tsleep(bp, 16 + 1, "physio", 0);
   ...
   ((done >= 0) ? (void)0 : panic("kernel %sassertion \"%s\" failed: file \"%s\", line %d" " " "strategy broken", "diagnostic ", "done >= 0", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c", 191));
   ((done <= todo) ? (void)0 : panic("kernel %sassertion \"%s\" failed: file \"%s\", line %d" " " "strategy broken", "diagnostic ", "done <= todo", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c", 192));
   iovp->iov_len -= done;
...
# 230 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_physio.c"
void
