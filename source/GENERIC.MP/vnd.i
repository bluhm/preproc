# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c"
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c"
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
int udf_disklabelspoof(dev_t dev, void (*strat)(struct buf *),
 struct disklabel *lp);
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vndioctl.h" 1
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vndioctl.h"
struct vnd_ioctl {
 char *vnd_file;
 size_t vnd_secsize;
 size_t vnd_nsectors;
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c" 2
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c"
struct vnd_softc {
...
# 104 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c"
    ...
    int encrypt)
{
 ...
 for (i = 0; i < size/bsize; i++) {
  ...
  __builtin_memcpy((iv), (&off), (sizeof(off)));
...
vndattach(int num)
{
 ...
 if (num <= 0)
  return;
 mem = mallocarray(num, sizeof(struct vnd_softc), 2,
     0x0002 | 0x0008);
 if (mem == ((void *)0)) {
...
{
 int unit = (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) / 16);
 struct vnd_softc *sc;
 int error = 0, part;
 ...
 if ((flags & 0x0002) && (sc->sc_flags & 0x0004)) {
  error = 30;
  goto bad;
 }

 if ((sc->sc_flags & 0x0001) &&
     (sc->sc_flags & 0x0002) == 0 &&
...
vndgetdisklabel(dev_t dev, struct vnd_softc *sc, struct disklabel *lp,
    int spoofonly)
{
 __builtin_memset((lp), (0), (sizeof(struct disklabel)));
 ...
 do { u_int64_t x = (sc->sc_size); (lp)->d_secperunith = x >> 32; (lp)->d_secperunit = x; } while (0);
 lp->d_flags = 0;
 lp->d_version = 1;
 ...
 return readdisklabel(((((dev_t)(((((((int32_t)(((u_int32_t)(dev) >> 8) & 0xff)))) & 0xff) << 8) | (((((((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) / 16))) * 16) + ((2)))) & 0xff) | ((((((((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) / 16))) * 16) + ((2)))) & 0xffff00) << 8))))), vndstrategy, lp, spoofonly);
}
...
{
 int unit = (((int32_t)((bp->b_dev) & 0xff) | (((bp->b_dev) & 0xffff0000) >> 8)) / 16);
 struct vnd_softc *sc;
 struct partition *p;
 off_t off;
 long origbcount;
...
# 302 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vnd.c"
 origbcount = bp->b_bcount;
 if (sc->sc_keyctx == ((void *)0)) {
  u_int32_t secsize = sc->sc_dk.dk_label->d_secsize;
  bp->b_bcount = ((origbcount + secsize - 1) & ~(secsize - 1));

  if (bp->b_bcount != origbcount) {
   struct process *curpr = (__curcpu->ci_self)->ci_curproc->p_p;
   printf("%s: sloppy %s from proc %d (%s): "
       "blkno %lld bcount %ld\n", sc->sc_dev.dv_xname,
       (bp->b_flags & 0x00008000) ? "read" : "write",
 ...
 off = (((u_int64_t)(p)->p_offseth << 32) + (p)->p_offset) * sc->sc_dk.dk_label->d_secsize +
     (u_int64_t)bp->b_blkno * (1 << 9);

 if (sc->sc_keyctx && !(bp->b_flags & 0x00008000))
 ...
 bp->b_error = vn_rdwr((bp->b_flags & 0x00008000) ? UIO_READ : UIO_WRITE,
     sc->sc_vp, bp->b_data, bp->b_bcount, off, UIO_SYSSPACE, 0x20,
     sc->sc_cred, &bp->b_resid, (__curcpu->ci_self)->ci_curproc);
 if (bp->b_error)
...
{
 return (physio(vndstrategy, dev, 0x00008000, minphys, uio));
}
...
{
 return (physio(vndstrategy, dev, 0x00000000, minphys, uio));
}
...
vndbdevsize(struct vnode *vp, struct proc *p)
{
 ...
 if (bsw->d_ioctl == ((void *)0))
  return (0);
 if (bsw->d_ioctl(dev, ((unsigned long)0x80000000 | ((sizeof(struct partinfo) & 0x1fff) << 16) | ((('d')) << 8) | ((104))), (caddr_t)&pi, 0x0001, p))
  return (0);
 ;

 return ((((u_int64_t)(pi.part)->p_sizeh << 32) + (pi.part)->p_size));
}
...
vndioctl(dev_t dev, u_long cmd, caddr_t addr, int flag, struct proc *p)
{
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct vnd_ioctl) & 0x1fff) << 16) | ((('F')) << 8) | ((0))):
  if (sc->sc_flags & 0x0001)
   return (16);
  ...
  ndinitat(&nd, 0, 0x0040, UIO_USERSPACE, -100, vio->vnd_file, p);
  sc->sc_flags &= ~0x0004;
  error = vn_open(&nd, 0x0001|0x0002, 0);
  if (error == 30) {
   sc->sc_flags |= 0x0004;
   error = vn_open(&nd, 0x0001, 0);
  }
  if (error) {
   disk_unlock(&sc->sc_dk);
   return (error);
  ...
  if (vio->vnd_keylen > 0) {
   ...
   if ((error = copyin(vio->vnd_key, key,
       vio->vnd_keylen)) != 0) {
    (void) vn_close(nd.ni_vp, ((sc)->sc_flags & 0x0004 ? 0x0001 : 0x0001|0x0002),
        p->p_ucred, p);
    disk_unlock(&sc->sc_dk);
    return (error);
   }

   sc->sc_keyctx = malloc(sizeof(*sc->sc_keyctx), 2,
       0x0001);
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct vnd_ioctl) & 0x1fff) << 16) | ((('F')) << 8) | ((1))):
  ...
  if (sc->sc_keyctx) {
   ...
   free(sc->sc_keyctx, 2, sizeof(*sc->sc_keyctx));
  }
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct vnd_user) & 0x1fff) << 16) | ((('F')) << 8) | ((3))):
...
vndsetcred(struct vnd_softc *sc, struct ucred *cred)
{
 ...
 buf = malloc((1 << 9), 127, 0x0001);
 size = ((((1 << 9))<(sc->sc_size * sc->sc_secsize))?((1 << 9)):(sc->sc_size * sc->sc_secsize));


 error = vn_rdwr(UIO_READ, sc->sc_vp, buf, size, 0, UIO_SYSSPACE, 0,
     sc->sc_cred, ((void *)0), (__curcpu->ci_self)->ci_curproc);
...
vndclear(struct vnd_softc *sc)
{
 ...
 (void) vn_close(vp, ((sc)->sc_flags & 0x0004 ? 0x0001 : 0x0001|0x0002), sc->sc_cred, p);
 crfree(sc->sc_cred);
 sc->sc_flags = 0;
 sc->sc_vp = ((void *)0);
 sc->sc_cred = ((void *)0);
 sc->sc_size = 0;
 __builtin_memset((sc->sc_file), (0), (sizeof(sc->sc_file)));
}
