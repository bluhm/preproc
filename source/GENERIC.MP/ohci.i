# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c" 2

struct cfdriver ohci_cd = {
 ((void *)0), "ohci", DV_DULL
};
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
...
# 178 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
...
# 590 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
struct ohci_soft_itd *
...
# 803 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 ctl = OREAD4(sc, 0x04);
 rwc = ctl & 0x00000200;
 fm = OREAD4(sc, 0x34);
 ...
 if (ctl & 0x00000100) {
  ...
  goto reset;
# 823 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 } else {
  ;
 reset:
...
# 861 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 do { bus_space_barrier((sc)->iot, (sc)->ioh, 0, (sc)->sc_size, 0x01|0x02); bus_space_write_4((sc)->iot, (sc)->ioh, (0x18), (((&sc->sc_hccadma)->block->map->dm_segs[0].ds_addr + (&sc->sc_hccadma)->offs + (0)))); } while (0);
 do { bus_space_barrier((sc)->iot, (sc)->ioh, 0, (sc)->sc_size, 0x01|0x02); bus_space_write_4((sc)->iot, (sc)->ioh, (0x20), (sc->sc_ctrl_head->physaddr)); } while (0);
 do { bus_space_barrier((sc)->iot, (sc)->ioh, 0, (sc)->sc_size, 0x01|0x02); bus_space_write_4((sc)->iot, (sc)->ioh, (0x28), (sc->sc_bulk_head->physaddr)); } while (0);
...
# 990 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
...
# 1173 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
void
...
ohci_softintr(void *v)
{
 ...
 ;
# 1244 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
...
# 1328 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
...
# 1522 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 if (OREAD4(sc, 0x0c) & sc->sc_eintrs)
  ohci_intr1(sc);
}
...
ohci_device_request(struct usbd_xfer *xfer)
{
 ...
 stat->len = 0;
 stat->xfer = xfer;
# 1609 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 s = splraise(2);
 sed->ed.ed_tailp = __extension__({ __uint32_t __swap32gen_x = (tail->physaddr); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
 opipe->tail.td = tail;
 do { bus_space_barrier((sc)->iot, (sc)->ioh, 0, (sc)->sc_size, 0x01|0x02); bus_space_write_4((sc)->iot, (sc)->ioh, (0x08), (0x00000002)); } while (0);
 ...
 _splx(s);
# 1634 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 return (USBD_NORMAL_COMPLETION);
...
# 1690 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
void
...
# 1862 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
usbd_status
...
# 1981 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
int
...
ohci_close_pipe(struct usbd_pipe *pipe, struct ohci_soft_ed *head)
{
 ...
 if ((__extension__({ __uint32_t __swap32gen_x = (sed->ed.ed_tailp); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) & 0xfffffffc) !=
  ...
  printf("ohci_close_pipe: pipe not empty sed=%p hd=0x%x "
         ...
         pipe, std);
# 2038 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
...
# 2063 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
void
ohci_abort_xfer(struct usbd_xfer *xfer, usbd_status status)
{
 ...
 _splx(s);
# 2120 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 s = splraise(2);
 p = xfer->hcpriv;
...
# 2136 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
...
ohci_device_bulk_start(struct usbd_xfer *xfer)
{
 ...
 ;
# 2762 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 s = splraise(2);
...
# 2787 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 _splx(s);
...
ohci_device_intr_start(struct usbd_xfer *xfer)
{
 ...
 data->flags = 0x0001 | 0x0002;
 xfer->hcpriv = data;
# 2883 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 s = splraise(2);
 sed->ed.ed_tailp = __extension__({ __uint32_t __swap32gen_x = (tail->physaddr); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
 opipe->tail.td = tail;
 sed->ed.ed_flags &= __extension__({ __uint32_t __swap32gen_x = (~0x00004000); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
# 2902 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 _splx(s);
...
ohci_device_setintr(struct ohci_softc *sc, struct ohci_pipe *opipe, int ival)
{
 ...
 while (npoll > ival)
  npoll /= 2;
 ;
# 2982 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 slow = npoll-1;
 shigh = slow + npoll;
 nslots = 32 / npoll;
...
# 3145 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
 s = splraise(2);
 ...
 sed->ed.ed_flags &= __extension__({ __uint32_t __swap32gen_x = (~0x00004000); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
 _splx(s);
# 3160 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ohci.c"
}
