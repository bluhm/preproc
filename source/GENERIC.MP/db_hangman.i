# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_hangman.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_hangman.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_hangman.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_hangman.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_hangman.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_hangman.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_hangman.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_hangman.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_hangman.c" 2
...
static void db_hang_forall(Elf64_Sym *, char *, char *, int, void *);

static void
db_hang_forall(Elf64_Sym *sym, char *name, char *suff, int pre, void *varg)
{
...
db_hang(int tries, char *word, struct _abc *sabc)
{
 ...
 for (p = word; *p; p++) {
  c = ((*p)|0x20);
  cnputc(('a'<=(c) && (c)<='z') && sabc->abc[(c)-'a']==0 ? '-' : *p);
 }
...
db_hangman(db_expr_t addr, int haddr, db_expr_t count, char *modif)
{
 ...
 for (;;) {
  ...
  if (word == ((void *)0)) {
   __builtin_memset((sabc->abc), (0), (sizeof sabc->abc));
