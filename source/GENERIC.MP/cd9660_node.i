# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
uint64_t SipHash(const SIPHASH_KEY *, int, int, const void *, size_t)
      __attribute__ ((__bounded__ (__buffer__, 4, 5) ));
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
...
int cd9660_vget_internal(struct mount *, cdino_t, struct vnode **, int,
    struct iso_directory_record *);
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c" 2
 ...
 struct vfsconf *vfsp;
{
 ...
 isohashtbl = hashinit(initialvnodes, 57, 0x0001, &isohash);
...
cd9660_isohash(dev_t device, cdino_t inum)
{
 ...
 SipHash_Init((&ctx), (&isohashkey));
 SipHash_Update((&ctx), 2, 4, (&device), (sizeof(device)));
 SipHash_Update((&ctx), 2, 4, (&inum), (sizeof(inum)));
 return (SipHash_End((&ctx), 2, 4) & isohash);
}
...
loop:
       ...
       for (ip = isohashtbl[cd9660_isohash((dev), (inum))]; ip; ip = ip->i_next) {
 ...
 struct iso_node *ip;
{
 ...
 ipp = &isohashtbl[cd9660_isohash((ip->i_dev), (ip->i_number))];
...
cd9660_defattr(isodir, inop, bp)
 ...
 struct buf *bp;
{
 struct buf *bp2 = ((void *)0);
 struct iso_mnt *imp;
 struct iso_extended_attributes *ap = ((void *)0);
 int off;

 if (isonum_711(isodir->flags)&2) {
  inop->inode.iso_mode = 0040000;
  ...
  inop->inode.iso_mode = 0100000;
  inop->inode.iso_links = 1;
 }
 if (!bp
     && ((imp = inop->i_mnt)->im_flags & 0x00000004)
     && (off = isonum_711(isodir->ext_attr_length))) {
  cd9660_bufatoff(inop, (off_t)-(off << imp->im_bshift), ((void *)0),
        &bp2);
  bp = bp2;
 }
 if (bp) {
  ...
  if (isonum_711(ap->version) == 1) {
   if (!(ap->perm[1]&0x10))
    inop->inode.iso_mode |= 0000400;
   if (!(ap->perm[1]&0x40))
    inop->inode.iso_mode |= 0000100;
   if (!(ap->perm[0]&0x01))
    inop->inode.iso_mode |= 0000040;
   if (!(ap->perm[0]&0x04))
    inop->inode.iso_mode |= 0000010;
   if (!(ap->perm[0]&0x10))
    inop->inode.iso_mode |= 0000004;
   if (!(ap->perm[0]&0x40))
    inop->inode.iso_mode |= 0000001;
   inop->inode.iso_uid = isonum_723(ap->owner);
   inop->inode.iso_gid = isonum_723(ap->group);
  } else
   ap = ((void *)0);
 }
 if (!ap) {
  inop->inode.iso_mode |=
      0000400|0000100|0000040|0000010|0000004|0000001;
...
# 378 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.c"
