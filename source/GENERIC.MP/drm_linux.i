    ...
    unsigned int gfp_mask)
{
 ...
 struct idr_entry *id;
 int begin;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_linux.c", 401, "_kernel_lock_held()"));
 if (idr_entry_cache) {
  id = idr_entry_cache;
