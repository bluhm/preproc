# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2



# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/rpcv2.h" 1
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c" 2
...
struct kevq {
 struct { struct kevq *sle_next; } kev_link;
 struct vnode *vp;
 u_int usecount;
 u_int flags;


 struct timespec omtime;
 struct timespec octime;
 nlink_t onlink;
};
struct kevqlist { struct kevq *slh_first; };

struct rwlock nfskevq_lock = { 0, "nfskqlk" };
struct proc *pnfskq;
struct kevqlist kevlist = { ((void *)0) };
# 90 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c"
void
nfs_kqpoll(void *arg)
{
 struct kevq *ke;
 ...
 for(;;) {
  _rw_enter_write(&nfskevq_lock );
  for((ke) = ((&kevlist)->slh_first); (ke) != ((void *)0); (ke) = ((ke)->kev_link.sle_next)) {
   struct nfsnode *np = ((struct nfsnode *)(ke->vp)->v_data);
   ...
   if (nfs_getattrcache(ke->vp, &attr) != 2)
    continue;
   ...
   if (error == 70) {
    ((np)->n_attrstamp = 0);
    do { struct klist *list = (&ke->vp->v_selectinfo.si_note); if ((list) != ((void *)0)) knote((list), ((0x0001))); } while (0);
    goto next;
   }
   ...
   if (attr.va_size != osize) {
    ...
    do { struct klist *list = (&ke->vp->v_selectinfo.si_note); if ((list) != ((void *)0)) knote((list), ((flags))); } while (0);
    ke->omtime = attr.va_mtime;
   } else if (attr.va_mtime.tv_sec != ke->omtime.tv_sec
       || attr.va_mtime.tv_nsec != ke->omtime.tv_nsec) {
    do { struct klist *list = (&ke->vp->v_selectinfo.si_note); if ((list) != ((void *)0)) knote((list), ((0x0002))); } while (0);
    ke->omtime = attr.va_mtime;
   }

   if (attr.va_ctime.tv_sec != ke->octime.tv_sec
       || attr.va_ctime.tv_nsec != ke->octime.tv_nsec) {
    do { struct klist *list = (&ke->vp->v_selectinfo.si_note); if ((list) != ((void *)0)) knote((list), ((0x0008))); } while (0);
    ke->octime = attr.va_ctime;
   }

   if (attr.va_nlink != ke->onlink) {
    do { struct klist *list = (&ke->vp->v_selectinfo.si_note); if ((list) != ((void *)0)) knote((list), ((0x0010))); } while (0);
...
next:
  ...
  tsleep(pnfskq, 24, "nfskqpw", 5 * hz / 2);
 ...
 for((ke) = ((&kevlist)->slh_first); (ke) != ((void *)0); (ke) = ((ke)->kev_link.sle_next)) {
  if (ke->vp == vp) {
   ...
   if (ke->usecount > 1) {
    ...
    do { if ((&kevlist)->slh_first == (ke)) { do { ((&kevlist))->slh_first = ((&kevlist))->slh_first->kev_link.sle_next; } while (0); } else { struct kevq *curelm = (&kevlist)->slh_first; while (curelm->kev_link.sle_next != (ke)) curelm = curelm->kev_link.sle_next; curelm->kev_link.sle_next = curelm->kev_link.sle_next->kev_link.sle_next; } ((ke)->kev_link.sle_next) = ((void *)-1); } while (0);
    free(ke, 137, sizeof(*ke));
   }
   break;
  }
 }
...
filt_nfsread(struct knote *kn, long hint)
{
 ...
 kn->kn_kevent.data = np->n_size - kn->kn_ptr.p_fp->f_offset;
...
static const struct filterops nfsread_filtops =
 { 1, ((void *)0), filt_nfsdetach, filt_nfsread };
static const struct filterops nfsvnode_filtops =
 { 1, ((void *)0), filt_nfsdetach, filt_nfsvnode };
...
nfs_kqfilter(void *v)
{
 ...
 kn->kn_hook = vp;
# 298 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_kq.c"
 ...
 if (!pnfskq) {
  error = kthread_create(nfs_kqpoll, ((void *)0), &pnfskq,
    "nfskqpoll");
  if (error)
   goto out;
 }
 ...
 if (ke) {
  ...
  ke = malloc(sizeof(*ke), 137, 0x0001);
  ke->vp = vp;
  ke->usecount = 1;
  ke->flags = 0;
  ke->omtime = attr.va_mtime;
  ke->octime = attr.va_ctime;
  ke->onlink = attr.va_nlink;
  do { (ke)->kev_link.sle_next = (&kevlist)->slh_first; (&kevlist)->slh_first = (ke); } while (0);
 }
