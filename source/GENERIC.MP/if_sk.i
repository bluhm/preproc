...
sk_setfilt(struct sk_if_softc *sc_if, caddr_t addr, int slot)
{
 ...
 sk_win_write_2(sc_if->sk_softc, (((base) * 2) + 0x2000 + (((sc_if)->sk_port) * (0x3000 - 0x2000))), (__uint16_t)(__builtin_constant_p(*(u_int16_t *)(&addr[0])) ? (__uint16_t)(((__uint16_t)(*(u_int16_t *)(&addr[0])) & 0xffU) << 8 | ((__uint16_t)(*(u_int16_t *)(&addr[0])) & 0xff00U) >> 8) : __swap16md(*(u_int16_t *)(&addr[0]))));
 sk_win_write_2(sc_if->sk_softc, (((base + 2) * 2) + 0x2000 + (((sc_if)->sk_port) * (0x3000 - 0x2000))), (__uint16_t)(__builtin_constant_p(*(u_int16_t *)(&addr[2])) ? (__uint16_t)(((__uint16_t)(*(u_int16_t *)(&addr[2])) & 0xffU) << 8 | ((__uint16_t)(*(u_int16_t *)(&addr[2])) & 0xff00U) >> 8) : __swap16md(*(u_int16_t *)(&addr[2]))));
 sk_win_write_2(sc_if->sk_softc, (((base + 4) * 2) + 0x2000 + (((sc_if)->sk_port) * (0x3000 - 0x2000))), (__uint16_t)(__builtin_constant_p(*(u_int16_t *)(&addr[4])) ? (__uint16_t)(((__uint16_t)(*(u_int16_t *)(&addr[4])) & 0xffU) << 8 | ((__uint16_t)(*(u_int16_t *)(&addr[4])) & 0xff00U) >> 8) : __swap16md(*(u_int16_t *)(&addr[4]))));
}
void
...
sk_encap(struct sk_if_softc *sc_if, struct mbuf *m_head, u_int32_t *txidx)
{
 ...
 sc_if->sk_rdata->sk_tx_ring[cur].sk_ctl |=
  (__uint32_t)(__builtin_constant_p(0x20000000|0x08000000) ? (__uint32_t)(((__uint32_t)(0x20000000|0x08000000) & 0xff) << 24 | ((__uint32_t)(0x20000000|0x08000000) & 0xff00) << 8 | ((__uint32_t)(0x20000000|0x08000000) & 0xff0000) >> 8 | ((__uint32_t)(0x20000000|0x08000000) & 0xff000000) >> 24) : __swap32md(0x20000000|0x08000000));
...
sk_init_xmac(struct sk_if_softc *sc_if)
{
 ...
 sk_win_write_2(sc_if->sk_softc, (((0x0108) * 2) + 0x2000 + (((sc_if)->sk_port) * (0x3000 - 0x2000))), (__uint16_t)(__builtin_constant_p(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[0])) ? (__uint16_t)(((__uint16_t)(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[0])) & 0xffU) << 8 | ((__uint16_t)(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[0])) & 0xff00U) >> 8) : __swap16md(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[0]))));
 sk_win_write_2(sc_if->sk_softc, (((0x010A) * 2) + 0x2000 + (((sc_if)->sk_port) * (0x3000 - 0x2000))), (__uint16_t)(__builtin_constant_p(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[2])) ? (__uint16_t)(((__uint16_t)(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[2])) & 0xffU) << 8 | ((__uint16_t)(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[2])) & 0xff00U) >> 8) : __swap16md(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[2]))));
 sk_win_write_2(sc_if->sk_softc, (((0x010C) * 2) + 0x2000 + (((sc_if)->sk_port) * (0x3000 - 0x2000))), (__uint16_t)(__builtin_constant_p(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[4])) ? (__uint16_t)(((__uint16_t)(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[4])) & 0xffU) << 8 | ((__uint16_t)(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[4])) & 0xff00U) >> 8) : __swap16md(*(u_int16_t *)(&sc_if->arpcom.ac_enaddr[4]))));
