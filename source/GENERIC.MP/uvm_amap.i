# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c" 2
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
struct pool uvm_amap_pool;
struct pool uvm_small_amap_pool[16];
struct pool uvm_amap_chunk_pool;

struct { struct vm_amap *lh_first; } amap_list;

static char amap_small_pool_names[16][9];
...
{
 do { if (((amap)->am_list.le_next = (&amap_list)->lh_first) != ((void *)0)) (&amap_list)->lh_first->am_list.le_prev = &(amap)->am_list.le_next; (&amap_list)->lh_first = (amap); (amap)->am_list.le_prev = &(&amap_list)->lh_first; } while (0);
}

static __inline void
amap_list_remove(struct vm_amap *amap)
{
 do { if ((amap)->am_list.le_next != ((void *)0)) (amap)->am_list.le_next->am_list.le_prev = (amap)->am_list.le_prev; *(amap)->am_list.le_prev = (amap)->am_list.le_next; ((amap)->am_list.le_prev) = ((void *)-1); ((amap)->am_list.le_next) = ((void *)-1); } while (0);
}
...
{
 int bucket = (((slot) / 16) >> (amap)->am_impl.ami_normal.amn_hashshift);
 int baseslot = (((slot) / 16) * 16);
 int n;
 struct vm_amap_chunk *chunk, *newchunk, *pchunk = ((void *)0);

 if (((amap)->am_nslot <= 16))
  return &amap->am_impl.ami_small;

 for (chunk = amap->am_impl.ami_normal.amn_buckets[bucket]; chunk != ((void *)0);
     chunk = ((chunk)->ac_list.tqe_next)) {
  if ((((chunk->ac_baseslot) / 16) >> (amap)->am_impl.ami_normal.amn_hashshift) != bucket)
   break;
 ...
 if (amap->am_nslot - baseslot >= 16)
  n = 16;
 else
  n = amap->am_nslot - baseslot;

 newchunk = pool_get(&uvm_amap_chunk_pool, waitf | 0x0008);
 if (newchunk == ((void *)0))
  return ((void *)0);

 if (pchunk == ((void *)0)) {
  do { (newchunk)->ac_list.tqe_next = ((void *)0); (newchunk)->ac_list.tqe_prev = (&amap->am_impl.ami_normal.amn_chunks)->tqh_last; *(&amap->am_impl.ami_normal.amn_chunks)->tqh_last = (newchunk); (&amap->am_impl.ami_normal.amn_chunks)->tqh_last = &(newchunk)->ac_list.tqe_next; } while (0);
  ((amap->am_impl.ami_normal.amn_buckets[bucket] == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 124, "amap->am_buckets[bucket] == NULL"));
  amap->am_impl.ami_normal.amn_buckets[bucket] = newchunk;
 } else
  do { if (((newchunk)->ac_list.tqe_next = (pchunk)->ac_list.tqe_next) != ((void *)0)) (newchunk)->ac_list.tqe_next->ac_list.tqe_prev = &(newchunk)->ac_list.tqe_next; else (&amap->am_impl.ami_normal.amn_chunks)->tqh_last = &(newchunk)->ac_list.tqe_next; (pchunk)->ac_list.tqe_next = (newchunk); (newchunk)->ac_list.tqe_prev = &(pchunk)->ac_list.tqe_next; } while (0);


 amap->am_impl.ami_normal.amn_ncused++;
...
{
 int bucket = (((chunk->ac_baseslot) / 16) >> (amap)->am_impl.ami_normal.amn_hashshift);
 struct vm_amap_chunk *nchunk;

 if (((amap)->am_nslot <= 16))
  return;

 nchunk = ((chunk)->ac_list.tqe_next);
 do { if (((chunk)->ac_list.tqe_next) != ((void *)0)) (chunk)->ac_list.tqe_next->ac_list.tqe_prev = (chunk)->ac_list.tqe_prev; else (&amap->am_impl.ami_normal.amn_chunks)->tqh_last = (chunk)->ac_list.tqe_prev; *(chunk)->ac_list.tqe_prev = (chunk)->ac_list.tqe_next; ((chunk)->ac_list.tqe_prev) = ((void *)-1); ((chunk)->ac_list.tqe_next) = ((void *)-1); } while (0);
 if (amap->am_impl.ami_normal.amn_buckets[bucket] == chunk) {
  if (nchunk != ((void *)0) &&
      (((nchunk->ac_baseslot) / 16) >> (amap)->am_impl.ami_normal.amn_hashshift) == bucket)
   amap->am_impl.ami_normal.amn_buckets[bucket] = nchunk;
  else
   amap->am_impl.ami_normal.amn_buckets[bucket] = ((void *)0);

 }
 pool_put(&uvm_amap_chunk_pool, chunk);
 amap->am_impl.ami_normal.amn_ncused--;
}
# 193 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
...
amap_init(void)
{
 ...
 pool_init(&uvm_amap_pool, sizeof(struct vm_amap),
     0, 0, 0x0001, "amappl", ((void *)0));
 pool_sethiwat(&uvm_amap_pool, 4096);


 for (i = 0; i < (sizeof((uvm_small_amap_pool)) / sizeof((uvm_small_amap_pool)[0])); i++) {
  snprintf(amap_small_pool_names[i],
      sizeof(amap_small_pool_names[0]), "amappl%d", i + 1);
  size = __builtin_offsetof(struct vm_amap, am_impl.ami_small.ac_anon) +
      (i + 1) * sizeof(struct vm_anon *);
  pool_init(&uvm_small_amap_pool[i], size, 0,
      0, 0, amap_small_pool_names[i], ((void *)0));
 }

 pool_init(&uvm_amap_chunk_pool, sizeof(struct vm_amap_chunk) +
     16 * sizeof(struct vm_anon *),
     0, 0, 0, "amapchunkpl", ((void *)0));
...
amap_alloc1(int slots, int waitf, int lazyalloc)
{
 ...
 int buckets, i, n;
 int pwaitf = (waitf & 0x0001) ? 0x0001 : 0x0002;

 ((slots > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 271, "slots > 0"));





 chunks = (((((unsigned int)slots)+((16)-1))/(16))*(16)) / 16;

 if (lazyalloc) {
# 304 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
 ...
 amap->am_ppref = ((void *)0);

 amap->am_nslot = slots;
 amap->am_nused = 0;

 if (((amap)->am_nslot <= 16)) {
  amap->am_impl.ami_small.ac_nslot = slots;
  return (amap);
 }

 amap->am_impl.ami_normal.amn_ncused = 0;
 do { (&amap->am_impl.ami_normal.amn_chunks)->tqh_first = ((void *)0); (&amap->am_impl.ami_normal.amn_chunks)->tqh_last = &(&amap->am_impl.ami_normal.amn_chunks)->tqh_first; } while (0);
 amap->am_impl.ami_normal.amn_hashshift = hashshift;
 amap->am_impl.ami_normal.amn_buckets = ((void *)0);

 buckets = (((chunks) + ((chunkperbucket) - 1)) / (chunkperbucket));
 amap->am_impl.ami_normal.amn_buckets = mallocarray(buckets, sizeof(*amap->am_impl.ami_normal.amn_buckets),
     98, waitf | (lazyalloc ? 0x0008 : 0));
 if (amap->am_impl.ami_normal.amn_buckets == ((void *)0))
  goto fail1;
 ...
 if (!lazyalloc) {
  for (i = 0; i < buckets; i++) {
   ...
   amap->am_impl.ami_normal.amn_buckets[i] = chunk;
   amap->am_impl.ami_normal.amn_ncused++;
   chunk->ac_baseslot = i * 16;
   chunk->ac_nslot = n;
   do { (chunk)->ac_list.tqe_next = ((void *)0); (chunk)->ac_list.tqe_prev = (&amap->am_impl.ami_normal.amn_chunks)->tqh_last; *(&amap->am_impl.ami_normal.amn_chunks)->tqh_last = (chunk); (&amap->am_impl.ami_normal.amn_chunks)->tqh_last = &(chunk)->ac_list.tqe_next; } while (0);
  }
 }
...
fail1:
 free(amap->am_impl.ami_normal.amn_buckets, 98, buckets * sizeof(*amap->am_impl.ami_normal.amn_buckets));
 for ((chunk) = ((&amap->am_impl.ami_normal.amn_chunks)->tqh_first); (chunk) != ((void *)0) && ((tmp) = ((chunk)->ac_list.tqe_next), 1); (chunk) = (tmp))
  pool_put(&uvm_amap_chunk_pool, chunk);
...
amap_alloc(vaddr_t sz, int waitf, int lazyalloc)
{
 ...
 { ((((sz) & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 390, "((sz) & (PAGE_SIZE - 1)) == 0")); (slots) = (sz) >> 13; };
 if (slots > 0x7fffffff)
  return (((void *)0));
...
amap_free(struct vm_amap *amap)
{
 ...
 ((amap->am_ref == 0 && amap->am_nused == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 412, "amap->am_ref == 0 && amap->am_nused == 0"));
 (((amap->am_flags & 0x4) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 413, "(amap->am_flags & AMAP_SWAPOFF) == 0"));


 if (amap->am_ppref && amap->am_ppref != ((int *) -1))
  free(amap->am_ppref, 98, amap->am_nslot * sizeof(int));
 ...
 if (((amap)->am_nslot <= 16))
  ...
  for ((chunk) = ((&amap->am_impl.ami_normal.amn_chunks)->tqh_first); (chunk) != ((void *)0) && ((tmp) = ((chunk)->ac_list.tqe_next), 1); (chunk) = (tmp))
      pool_put(&uvm_amap_chunk_pool, chunk);
  free(amap->am_impl.ami_normal.amn_buckets, 98, 0);
  pool_put(&uvm_amap_pool, amap);
 }
}
# 437 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
void
amap_wipeout(struct vm_amap *amap)
{
 ...
 ((amap->am_ref == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 444, "amap->am_ref == 0"));

 if (__builtin_expect((((amap->am_flags & 0x4) != 0) != 0), 0)) {

  return;
 }
 amap_list_remove(amap);

 for (chunk = (((amap)->am_nslot <= 16) ? &(amap)->am_impl.ami_small : ((&(amap)->am_impl.ami_normal.amn_chunks)->tqh_first)); (chunk) != ((void *)0); (chunk) = ((chunk)->ac_list.tqe_next)) {
...
# 492 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
void
    ...
    boolean_t canchunk, vaddr_t startva, vaddr_t endva)
{
 ...
 vaddr_t chunksize;
 int i, j, k, n, srcslot;
 struct vm_amap_chunk *chunk = ((void *)0), *srcchunk = ((void *)0);


 if (entry->aref.ar_amap == ((void *)0)) {
# 513 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
  if (((entry->end - entry->start) >> 13) >= 256) {
   if (canchunk) {

    chunksize = 16 << 13;
    startva = (startva / chunksize) * chunksize;
    endva = ((((endva)+((chunksize)-1))/(chunksize))*(chunksize));
    do { (((entry)->end + (entry)->fspace > (startva)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 519, "(entry)->end + (entry)->fspace > (startva)")); if ((entry)->start < (startva)) uvm_map_clip_start((map), (entry), (startva)); } while (0);

    if (endva >= startva)
     do { (((entry)->start < (endva)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 522, "(entry)->start < (endva)")); if ((entry)->end > (endva)) uvm_map_clip_end((map), (entry), (endva)); } while (0);
   } else
    lazyalloc = 1;
  }
 ...
 { ((((entry->end - entry->start) & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 547, "((entry->end - entry->start) & (PAGE_SIZE - 1)) == 0")); (slots) = (entry->end - entry->start) >> 13; };
 if (!((entry->aref.ar_amap)->am_nslot <= 16) &&
     entry->aref.ar_amap->am_impl.ami_normal.amn_hashshift != 0)
  lazyalloc = 1;
 amap = amap_alloc1(slots, waitf, lazyalloc);
 if (amap == ((void *)0))
  return;
 ...
 for (lcv = 0; lcv < slots; lcv += n) {
  ...
  srcchunk = amap_chunk_get(srcamap, srcslot, 0, 0x0002);
  if (srcchunk == ((void *)0))
   continue;

  chunk = amap_chunk_get(amap, lcv, 1, 0x0002);
  if (chunk == ((void *)0)) {
   amap->am_ref = 0;
   amap_wipeout(amap);
   return;
 ...
 srcamap->am_ref--;
 if (srcamap->am_ref == 1 && (srcamap->am_flags & 0x1) != 0)
  srcamap->am_flags &= ~0x1;

 if (srcamap->am_ppref && srcamap->am_ppref != ((int *) -1)) {
  amap_pp_adjref(srcamap, entry->aref.ar_pageoff,
      (entry->end - entry->start) >> 13, -1);
 }
...
# 642 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
void
 ...
 for (chunk = (((amap)->am_nslot <= 16) ? &(amap)->am_impl.ami_small : ((&(amap)->am_impl.ami_normal.amn_chunks)->tqh_first)); (chunk) != ((void *)0); (chunk) = ((chunk)->ac_list.tqe_next)) {
  ...
  for (i = ffs(map); i != 0; i = ffs(map)) {
   ...
   if (pg->pg_flags & 0x00000001) {
    ...
    do { tsleep(pg, 4|(0 ? 0x100 : 0), "cownow", 0); } while (0);
    goto ReStart;
   }
   ...
   nanon = uvm_analloc();
   if (nanon) {
    npg = uvm_pagealloc(((void *)0), 0, nanon, 0);
   } else
    npg = ((void *)0);

   if (nanon == ((void *)0) || npg == ((void *)0)) {
...
amap_splitref(struct vm_aref *origref, struct vm_aref *splitref, vaddr_t offset)
{
 ...
 { ((((offset) & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 740, "((offset) & (PAGE_SIZE - 1)) == 0")); (leftslots) = (offset) >> 13; };
 if (leftslots == 0)
    ...
    int slotoff, int slots)
{
 ...
 startbase = (((slotoff) / 16) * 16);
 endbase = (((slotoff + slots - 1) / 16) * 16);
...
amap_wiperange(struct vm_amap *amap, int slotoff, int slots)
{
 ...
 startbucket = (((slotoff) / 16) >> (amap)->am_impl.ami_normal.amn_hashshift);
 endbucket = (((slotoff + slots - 1) / 16) >> (amap)->am_impl.ami_normal.amn_hashshift);
 ...
 if (((amap)->am_nslot <= 16))
  amap_wiperange_chunk(amap, &amap->am_impl.ami_small, slotoff, slots);
 else if (endbucket + 1 - startbucket >= amap->am_impl.ami_normal.amn_ncused) {
  for ((chunk) = ((&amap->am_impl.ami_normal.amn_chunks)->tqh_first); (chunk) != ((void *)0) && ((nchunk) = ((chunk)->ac_list.tqe_next), 1); (chunk) = (nchunk)) {
  ...
  for (bucket = startbucket; bucket <= endbucket; bucket++) {
   for (chunk = amap->am_impl.ami_normal.amn_buckets[bucket]; chunk != ((void *)0);
    ...
    if ((((chunk->ac_baseslot) / 16) >> (amap)->am_impl.ami_normal.amn_hashshift) !=
        bucket)
     break;
...
# 957 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
boolean_t
amap_swap_off(int startslot, int endslot)
{
 ...
 for (am = ((&amap_list)->lh_first); am != ((void *)0) && !rv; am = am_next) {
  int i, map;
  struct vm_amap_chunk *chunk;

again:
  for (chunk = (((am)->am_nslot <= 16) ? &(am)->am_impl.ami_small : ((&(am)->am_impl.ami_normal.amn_chunks)->tqh_first)); (chunk) != ((void *)0); (chunk) = ((chunk)->ac_list.tqe_next)) {
   map = chunk->ac_usedmap;
...
amap_lookup(struct vm_aref *aref, vaddr_t offset)
{
 ...
 { ((((offset) & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 1015, "((offset) & (PAGE_SIZE - 1)) == 0")); (slot) = (offset) >> 13; };
 slot += aref->ar_pageoff;

 if (slot >= amap->am_nslot)
  panic("amap_lookup: offset out of range");

 chunk = amap_chunk_get(amap, slot, 0, 0x0002);
 if (chunk == ((void *)0))
  return ((void *)0);

 return chunk->ac_anon[((slot) % 16)];
}
    ...
    struct vm_anon **anons, int npages)
{
 int i, lcv, n, slot;
 struct vm_amap *amap = aref->ar_amap;
 struct vm_amap_chunk *chunk = ((void *)0);

 { ((((offset) & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 1041, "((offset) & (PAGE_SIZE - 1)) == 0")); (slot) = (offset) >> 13; };
 slot += aref->ar_pageoff;
 ...
 for (i = 0, lcv = slot; lcv < slot + npages; i += n, lcv += n) {
  ...
  chunk = amap_chunk_get(amap, lcv, 0, 0x0002);
  if (chunk == ((void *)0))
   __builtin_memset((&anons[i]), (0), (n * sizeof(*anons)));
  else
   __builtin_memcpy((&anons[i]), (&chunk->ac_anon[((lcv) % 16)]), (n * sizeof(*anons)));
...
amap_populate(struct vm_aref *aref, vaddr_t offset)
{
 ...
 { ((((offset) & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 1074, "((offset) & (PAGE_SIZE - 1)) == 0")); (slot) = (offset) >> 13; };
 slot += aref->ar_pageoff;

 if (slot >= amap->am_nslot)
  panic("amap_populate: offset out of range");

 chunk = amap_chunk_get(amap, slot, 1, 0x0001);
 ((chunk != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 1081, "chunk != NULL"));
}
    ...
    boolean_t replace)
{
 ...
 { ((((offset) & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 1097, "((offset) & (PAGE_SIZE - 1)) == 0")); (slot) = (offset) >> 13; };
 slot += aref->ar_pageoff;

 if (slot >= amap->am_nslot)
  panic("amap_add: offset out of range");
 chunk = amap_chunk_get(amap, slot, 1, 0x0002);
 if (chunk == ((void *)0))
  return 1;

 slot = ((slot) % 16);
 if (replace) {
  if (chunk->ac_anon[slot] == ((void *)0))
   panic("amap_add: replacing null anon");
  if (chunk->ac_anon[slot]->an_page != ((void *)0) &&
      (amap->am_flags & 0x1) != 0) {
...
amap_unadd(struct vm_aref *aref, vaddr_t offset)
{
 ...
 { ((((offset) & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c", 1140, "((offset) & (PAGE_SIZE - 1)) == 0")); (slot) = (offset) >> 13; };
 slot += aref->ar_pageoff;
...
amap_ref(struct vm_amap *amap, vaddr_t offset, vsize_t len, int flags)
{
 ...
 if (amap->am_ppref == ((void *)0) && (flags & 0x2) == 0 &&
     len != amap->am_nslot)
...
# 1195 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_amap.c"
void
amap_unref(struct vm_amap *amap, vaddr_t offset, vsize_t len, boolean_t all)
{
 ...
 if (amap->am_ref == 1 && (amap->am_flags & 0x1) != 0)
  amap->am_flags &= ~0x1;

 if (amap->am_ppref == ((void *)0) && all == 0 && len != amap->am_nslot)
  amap_pp_establish(amap);
 if (amap->am_ppref && amap->am_ppref != ((int *) -1)) {
  if (all)
   amap_pp_adjref(amap, 0, amap->am_nslot, -1);
