# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c"
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c"
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c" 2
...
int pppoutput(struct ifnet *, struct mbuf *, struct sockaddr *,
     struct rtentry *);
void pppintr(void);
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c" 2
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c"
struct bsd_db {
    int totlen;
    u_int hsize;
    u_char hshift;
...
# 187 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c"
...
# 223 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c"
static int
bsd_check(db)
    struct bsd_db *db;
{
    ...
    int opt_len, decomp;
{
 ...
 return ((void *)0);
    ...
    db = malloc(newlen, 2, 0x0002|0x0008);
    if (!db)
 return ((void *)0);
 ...
 db->lens = mallocarray(maxmaxcode + 1, sizeof(db->lens[0]), 2,
     0x0002);
 if (!db->lens) {
     free(db, 2, newlen);
     return ((void *)0);
    ...
    void *state;
{
    ...
    if (db->lens)
 free(db->lens, 2, (db->maxmaxcode + 1) * sizeof(db->lens[0]));
    free(db, 2, db->totlen);
}
    ...
    int maxolen;
{
    ...
    int olen;
    struct mbuf *m;
# 525 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c"
 ...
 *wptr++ = db->seqno;
 ...
 continue;
    ...
    nomatch:
 { bitno -= n_bits; accm |= ((ent) << bitno); do { { ++olen; if (wptr) { *wptr++ = (accm >> 24); if (wptr >= cp_end) { m->m_hdr.mh_len = wptr - ((u_char *)((m)->m_hdr.mh_data)); m->m_hdr.mh_next = m_get((0x0002), (1)); m = m->m_hdr.mh_next; if (m) { m->m_hdr.mh_len = 0; if (maxolen - olen > (256 - sizeof(struct m_hdr))) (void) m_clget((m), (0x0002), (1 << 11)); wptr = ((u_char *)((m)->m_hdr.mh_data)); cp_end = wptr + m_trailingspace(m); } else wptr = ((void *)0); } } }; accm <<= 8; bitno += 8; } while (bitno <= 24); };
 ...
 ++db->bytes_out;
    ...
    if (bsd_check(db))
 { bitno -= n_bits; accm |= ((256) << bitno); do { { ++olen; if (wptr) { *wptr++ = (accm >> 24); if (wptr >= cp_end) { m->m_hdr.mh_len = wptr - ((u_char *)((m)->m_hdr.mh_data)); m->m_hdr.mh_next = m_get((0x0002), (1)); m = m->m_hdr.mh_next; if (m) { m->m_hdr.mh_len = 0; if (maxolen - olen > (256 - sizeof(struct m_hdr))) (void) m_clget((m), (0x0002), (1 << 11)); wptr = ((u_char *)((m)->m_hdr.mh_data)); cp_end = wptr + m_trailingspace(m); } else wptr = ((void *)0); } } }; accm <<= 8; bitno += 8; } while (bitno <= 24); };
    ...
    if (bitno != 32)
 { ++olen; if (wptr) { *wptr++ = ((accm | (0xff << (bitno-8))) >> 24); if (wptr >= cp_end) { m->m_hdr.mh_len = wptr - ((u_char *)((m)->m_hdr.mh_data)); m->m_hdr.mh_next = m_get((0x0002), (1)); m = m->m_hdr.mh_next; if (m) { m->m_hdr.mh_len = 0; if (maxolen - olen > (256 - sizeof(struct m_hdr))) (void) m_clget((m), (0x0002), (1 << 11)); wptr = ((u_char *)((m)->m_hdr.mh_data)); cp_end = wptr + m_trailingspace(m); } else wptr = ((void *)0); } } };
...
# 814 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c"
int
 ...
 *--p = finchar;
 ...
 if (extra)
     *wptr++ = finchar;
# 1033 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c"
 ...
 printf("bsd_decomp%d: peer should have cleared dictionary\n",
    ...
    *dmpp = mret;
    return 0;
# 1112 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bsd-comp.c"
}
