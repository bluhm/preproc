# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c"
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.h" 1
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.h"
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c" 2
...
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_watch.h" 1
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_watch.h"
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c" 2

int db_run_mode;
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c"
...
db_stop_at_pc(db_regs_t *regs, boolean_t *is_breakpoint)
{
 ...
 old_pc = pc = ((db_addr_t)(regs)->ddb_tf.tf_pc);
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c"
 ...
 if (bkpt) {
  ...
  do { vaddr_t n = (regs)->ddb_tf.tf_npc; (regs)->ddb_tf.tf_pc = n; (regs)->ddb_tf.tf_npc = n + 4; } while(0);
 ...
 *is_breakpoint = 0;
 ...
 if (db_run_mode == 2) {
     ...
     if (!db_inst_trap_return(ins) &&
  (!db_inst_return(ins) || --db_call_depth != 0)) {
  if (db_sstep_print) {
      if (db_inst_call(ins) || db_inst_return(ins)) {
   int i;
...
{
 db_addr_t pc = ((db_addr_t)(regs)->ddb_tf.tf_pc);

 if ((db_run_mode == 6) || (db_run_mode == 2) ||
     (db_run_mode == 3)) {
  db_expr_t ins;
  ...
  if (db_inst_branch(ins) || db_inst_call(ins)) {
   ins = db_get_value(((1) ? (pc) : ddb_regs.ddb_tf.tf_npc),
       sizeof(int), 0);
   db_inst_count++;
  }
...
# 329 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_run.c"
void
db_set_single_step(db_regs_t *regs)
{
 ...
 if (db_inst_branch(inst) || db_inst_call(inst) || db_inst_return(inst)) {
     brpc = db_branch_taken((inst), (pc), (regs));
     if (brpc != pc) {
 ...
 pc = ((0) ? (pc) : ddb_regs.ddb_tf.tf_npc);
