# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
void device_register(struct device *, void *);
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
int bppopen(dev_t, int, int, struct proc *); int bppclose(dev_t, int, int, struct proc *); int bppread(dev_t, struct uio *, int); int bppwrite(dev_t, struct uio *, int); int bppioctl(dev_t, u_long, caddr_t, int, struct proc *); int bppstop(struct tty *, int); struct tty *bpptty(dev_t); int bpppoll(dev_t, int, struct proc *); paddr_t bppmmap(dev_t, off_t, int); int bppkqfilter(dev_t, struct knote *);
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854reg.h" 1
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bppreg.h" 1
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c" 2
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c"
struct hwstate {
 u_int16_t hw_hcr;
 u_int16_t hw_ocr;
 u_int8_t hw_tcr;
...
bppattach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (sa->sa_npromvaddrs != 0) {
  if (bus_space_map(sa->sa_bustag, ((((bus_addr_t)0)<<32)|(sa->sa_promvaddrs[0])), sa->sa_reg[0].sbr_size, 0x0010, &sc->sc_regs) != 0) {


   printf(": cannot map registers\n");
   return;
  }
 } else if (bus_space_map(sa->sa_bustag, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset)), sa->sa_reg[0].sbr_size, 0, &sc->sc_regs) != 0) {
 ...
 dsc->sc_bufsz = 1024;
 dsc->sc_buf = malloc(dsc->sc_bufsz, 2, 0x0002);
 ...
 hw->hw_hcr = bus_space_read_2(sc->sc_bustag, h, 16);
 hw->hw_ocr = bus_space_read_2(sc->sc_bustag, h, 18);
 hw->hw_tcr = bus_space_read_1(sc->sc_bustag, h, 21);
 hw->hw_or = bus_space_read_1(sc->sc_bustag, h, 22);

 ;


 hw->hw_hcr = ((ack_rate<<0)&0x003f)
  | ((ack_rate<<8)&0x7f00);
 hw->hw_ocr |= 0x0100;
    }
}
...
bpp_setparams(struct bpp_softc *sc, struct hwstate *hw)
{
 ...
 bus_space_write_2(t, h, 16, hw->hw_hcr);
 bus_space_write_2(t, h, 18, hw->hw_ocr);
 bus_space_write_1(t, h, 21, hw->hw_tcr);
 bus_space_write_1(t, h, 22, hw->hw_or);


 irq = bus_space_read_2(t, h, 24);
 irq &= ~(0x0002|0x0020|0x0080);
 irq |= (hw->hw_irq & (0x0002|0x0020|0x0080));
 bus_space_write_2(t, h, 24, irq);
 ;
...
bppopen(dev_t dev, int flags, int mode, struct proc *p)
{
 ...
 if (unit >= bpp_cd.cd_ndevs)
  return (6);
 if ((sc = bpp_cd.cd_devs[unit]) == ((void *)0))
  return (6);
 ...
 bus_space_write_2(lsi->sc_bustag, lsi->sc_regs, 24, irq);
 return (0);
}
...
{
 struct bpp_softc *sc = bpp_cd.cd_devs[(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)))];
 struct lsi64854_softc *lsi = &sc->sc_lsi64854;
 u_int16_t irq;


 irq = sc->sc_hwstate.hw_irq | (0x0400|0x0800|0x1000| 0x2000|0x4000|0x8000);
 irq &= ~(0x0001|0x0004| 0x0010|0x0040| 0x0100|0x0200);
 bus_space_write_2(lsi->sc_bustag, lsi->sc_regs, 24, irq);
...
bppwrite(dev_t dev, struct uio *uio, int flags)
{
 ...
 while ((sc->sc_flags & 0x01) != 0) {
  ...
  sc->sc_flags |= 0x02;
  error = tsleep(sc->sc_buf, 22 | 0x100, "bppwrite", 0);
  if (error != 0) {
   _splx(s);
   return (error);
  }
 ...
 while (uio->uio_resid > 0) {
  ...
  while (len > 0) {
   u_int8_t tcr;
   size_t size = len;
   (((lsi)->setup)(lsi, &bp, &len, 0, &size));
# 326 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/bpp.c"
   ...
   s = _splraise(6);
   do { u_int32_t csr = (bus_space_read_4((lsi)->sc_bustag, (lsi)->sc_regs, 0)); csr |= 0x00000200; bus_space_write_4((lsi)->sc_bustag, (lsi)->sc_regs, 0, csr); lsi->sc_active = 1; } while (0);
   error = tsleep(sc, 22 | 0x100, "bppdma", 0);
   _splx(s);
   if (error != 0)
    goto out;
...
bppintr(void *arg)
{
 ...
 irq = bus_space_read_2(lsi->sc_bustag, lsi->sc_regs, 24);

 bus_space_write_2(lsi->sc_bustag, lsi->sc_regs, 24,
     irq | (0x0400|0x0800|0x1000| 0x2000|0x4000|0x8000));

 ;

 if ((irq & (0x0400|0x0800|0x1000| 0x2000|0x4000|0x8000)) == 0)
  return (0);

 if ((sc->sc_flags & 0x01) != 0)
  wakeup(sc);
 else if ((sc->sc_flags & 0x02) != 0) {
  sc->sc_flags &= ~0x02;
  wakeup(sc->sc_buf);
 }
 return (1);
