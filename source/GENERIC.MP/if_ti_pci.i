# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c"
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c"
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
...
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
...
# 83 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
...
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
...
# 87 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tireg.h" 1
# 403 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tireg.h"
typedef struct {
 u_int32_t ti_addr_hi;
 u_int32_t ti_addr_lo;
} ti_hostaddr;
# 429 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tireg.h"
struct ti_rcb {
...
# 451 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tireg.h"
struct ti_producer {
 u_int32_t ti_idx;
 u_int32_t ti_unused;
};
...
# 670 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tireg.h"
struct ti_rx_desc {
 ti_hostaddr ti_addr;
...
# 852 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tireg.h"
struct ti_cmd_desc {
 u_int32_t ti_cmdx;
};
# 940 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tireg.h"
struct ti_event_desc {
 u_int32_t ti_eventx;
 u_int32_t ti_rsvd;
};
# 1003 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tireg.h"
struct ti_jslot {
 caddr_t ti_buf;
 int ti_inuse;
};
...
struct ti_ring_data {
 struct ti_rx_desc ti_rx_std_ring[512];
 struct ti_rx_desc ti_rx_jumbo_ring[256];
 struct ti_rx_desc ti_rx_mini_ring[1024];
 struct ti_rx_desc ti_rx_return_ring[2048];
 struct ti_event_desc ti_event_ring[256];
 struct ti_tx_desc ti_tx_ring[512];
...
# 1057 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tireg.h"
struct ti_txmap_entry {
 bus_dmamap_t dmamap;
 struct { struct ti_txmap_entry *sle_next; } link;
};
...
struct ti_chain_data {
 struct mbuf *ti_tx_chain[512];
 struct mbuf *ti_rx_std_chain[512];
 struct mbuf *ti_rx_jumbo_chain[256];
 struct mbuf *ti_rx_mini_chain[1024];

 struct ti_txmap_entry *ti_tx_map[512];
 bus_dmamap_t ti_rx_std_map[512];
 bus_dmamap_t ti_rx_jumbo_map[256];
 bus_dmamap_t ti_rx_mini_map[1024];


 struct ti_jslot ti_jslots[384];
 void *ti_jumbo_buf;
};
...
struct ti_mc_entry {
 ...
 struct { struct ti_mc_entry *sle_next; } mc_entries;
};
...
struct ti_softc {
 ...
 u_int16_t ti_mini;
 u_int16_t ti_jumbo;
 struct __ti_mchead { struct ti_mc_entry *slh_first; } ti_mc_listhead;
 struct __ti_txmaphead { struct ti_txmap_entry *slh_first; } ti_tx_map_listhead;
...
# 90 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tivar.h" 1
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/tivar.h"
...
int ti_intr(void *);
# 91 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c" 2
...
{
 return (pci_matchbyid(aux, ti_devices, (sizeof((ti_devices)) / sizeof((ti_devices)[0]))));
}
...
ti_pci_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (pci_mapreg_map(pa, 0x10,
     ...
     &sc->ti_btag, &sc->ti_bhandle, ((void *)0), &size, 0)) {
 ...
 sc->ti_intrhand = pci_intr_establish(pc, ih, 6, ti_intr, sc,
     self->dv_xname);
 if (sc->ti_intrhand == ((void *)0)) {
 ...
 printf(": %s", intrstr);
# 160 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_ti_pci.c"
 if ((((pa->pa_id) >> 0) & 0xffff) == 0x12ae &&
     (((pa->pa_id) >> 16) & 0xffff) == 0x0002)
  sc->ti_copper = 1;

 if ((((pa->pa_id) >> 0) & 0xffff) == 0x1385 &&
     (((pa->pa_id) >> 16) & 0xffff) == 0x630a)
  sc->ti_copper = 1;
