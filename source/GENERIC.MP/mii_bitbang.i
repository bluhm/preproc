# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_bitbang.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_bitbang.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_bitbang.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_bitbang.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_bitbang.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_bitbang.c" 2
...
void mii_bitbang_writereg(struct device *, mii_bitbang_ops_t,
     int, int, int);
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_bitbang.c" 2

void mii_bitbang_sync(struct device *, mii_bitbang_ops_t);
void mii_bitbang_sendbits(struct device *, mii_bitbang_ops_t,
     u_int32_t, int);
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_bitbang.c"
void
mii_bitbang_sync(struct device *sc, mii_bitbang_ops_t ops)
{
 ...
 v = ops->mbo_bits[3] | ops->mbo_bits[0];

 do { ops->mbo_write(sc, (v)); delay(1); } while (0);
 for (i = 0; i < 32; i++) {
  do { ops->mbo_write(sc, (v | ops->mbo_bits[2])); delay(1); } while (0);
  do { ops->mbo_write(sc, (v)); delay(1); } while (0);
 }
}
    ...
    int reg64)
{
 ...
 mii_bitbang_sendbits(sc, ops, 0x01, 2);
 mii_bitbang_sendbits(sc, ops, 0x02, 2);
 mii_bitbang_sendbits(sc, ops, phy, 5);
 mii_bitbang_sendbits(sc, ops, reg64, 5);


 do { ops->mbo_write(sc, (ops->mbo_bits[4])); delay(1); } while (0);


 do { ops->mbo_write(sc, (ops->mbo_bits[4] | ops->mbo_bits[2])); delay(1); } while (0);
 do { ops->mbo_write(sc, (ops->mbo_bits[4])); delay(1); } while (0);


 err = ops->mbo_read(sc) & ops->mbo_bits[1];
 ...
 for (i = 0; i < 16; i++) {
  ...
  if (err == 0 && (ops->mbo_read(sc) & ops->mbo_bits[1]) != 0)
   val |= 1;
 ...
 do { ops->mbo_write(sc, (ops->mbo_bits[3])); delay(1); } while (0);
