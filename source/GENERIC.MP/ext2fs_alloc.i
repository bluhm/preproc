# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c" 2
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c"
int
 ...
 *bnp = 0;
 ...
 if (fs->e2fs.e2fs_fbcount == 0)
  goto nospace;
 if (cred->cr_uid != 0 && ((fs)->e2fs.e2fs_fbcount - (fs)->e2fs.e2fs_rbcount) <= 0)
  goto nospace;
 if (bpref >= fs->e2fs.e2fs_bcount)
  bpref = 0;
 if (bpref == 0)
  cg = (((ip->i_number) - 1) / (fs)->e2fs.e2fs_ipg);
 else
  cg = (((bpref) - (fs)->e2fs.e2fs_first_dblock) / (fs)->e2fs.e2fs_fpg);
 bno = ext2fs_hashalloc(ip, cg, bpref, fs->e2fs_bsize, ext2fs_alloccg);
 if (bno > 0) {
  ip->dinode_u.e2fs_din->e2di_nblock += ((fs->e2fs_bsize) >> 9);
...
# 131 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c"
int
 ...
 *vpp = ((void *)0);
 ...
 if ((mode & 0170000) == 0040000)
  ...
  cg = (((pip->i_number) - 1) / (fs)->e2fs.e2fs_ipg);
 ...
 if (ip->dinode_u.e2fs_din->e2di_mode && ip->dinode_u.e2fs_din->e2di_nlink != 0) {
  printf("mode = 0%o, nlinks %u, inum = %u, fs = %s\n",
      ip->dinode_u.e2fs_din->e2di_mode, ip->dinode_u.e2fs_din->e2di_nlink, ip->i_number,
      fs->e2fs_fsmnt);
  panic("ext2fs_valloc: dup alloc");
 }

 __builtin_memset((ip->dinode_u.e2fs_din), (0), (sizeof(struct ext2fs_dinode)));
...
# 190 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c"
static int
...
# 219 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c"
daddr_t
ext2fs_blkpref(struct inode *ip, u_int32_t lbn, int baps, u_int32_t *bap)
{
 ...
 if ( ip->inode_ext.e2fs.ext2fs_last_blk && lbn == ip->inode_ext.e2fs.ext2fs_last_lblk + 1) {
  return ip->inode_ext.e2fs.ext2fs_last_blk + 1;
 }
 ...
 if (bap) {
  for (i = baps; i >= 0 ; i--) {
   if (bap[i]) {
    return __extension__({ __uint32_t __swap32gen_x = (bap[i]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) + 1;
   }
  }
 }
...
# 262 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c"
static u_int32_t
...
ext2fs_alloccg(struct inode *ip, int cg, u_int32_t bpref, int size)
{
 ...
 if (fs->e2fs_gd[cg].ext2bgd_nbfree == 0)
  return (0);
 error = bread(ip->i_ump->um_devvp, ((fs->e2fs_gd[cg].ext2bgd_b_bitmap) << (fs)->e2fs_fsbtodb), (int)fs->e2fs_bsize, &bp);
 ...
 if ((((bpref) - (fs)->e2fs.e2fs_first_dblock) / (fs)->e2fs.e2fs_fpg) != cg)
  bpref = 0;
 if (bpref != 0) {
  bpref = (((bpref) - (fs)->e2fs.e2fs_first_dblock) % (fs)->e2fs.e2fs_fpg);



  if ((((bbp)[(bpref)>>3] & (1<<((bpref)&(8 -1)))) == 0)) {
   bno = bpref;
   goto gotit;
  }
 }
 ...
 if (bpref)
  start = (((bpref) - (fs)->e2fs.e2fs_first_dblock) % (fs)->e2fs.e2fs_fpg) / 8;
 else
  start = 0;
 end = (((fs->e2fs.e2fs_fpg) + ((8) - 1)) / (8)) - start;
...
# 392 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c"
static ufsino_t
ext2fs_nodealloccg(struct inode *ip, int cg, ufsino_t ipref, int mode)
{
 ...
 if (fs->e2fs_gd[cg].ext2bgd_nifree == 0)
  return (0);
 error = bread(ip->i_ump->um_devvp, ((fs->e2fs_gd[cg].ext2bgd_i_bitmap) << (fs)->e2fs_fsbtodb), (int)fs->e2fs_bsize, &bp);
 ...
 if (ipref) {
  ...
  if ((((ibp)[(ipref)>>3] & (1<<((ipref)&(8 -1)))) == 0))
   goto gotit;
 }
 start = ipref / 8;
 len = (((fs->e2fs.e2fs_ipg - ipref) + ((8) - 1)) / (8));
...
ext2fs_blkfree(struct inode *ip, u_int32_t bno)
{
 ...
 fs = ip->inode_u.e2fs;
 cg = (((bno) - (fs)->e2fs.e2fs_first_dblock) / (fs)->e2fs.e2fs_fpg);
 if (bno >= fs->e2fs.e2fs_bcount) {
  printf("bad block %u, ino %u\n", bno, ip->i_number);
  ext2fs_fserr(fs, ip->inode_ext.e2fs.ext2fs_effective_uid, "bad block");
  return;
 }
 error = bread(ip->i_ump->um_devvp,
     ((fs->e2fs_gd[cg].ext2bgd_b_bitmap) << (fs)->e2fs_fsbtodb),
 ...
 bbp = (char *)bp->b_data;
 bno = (((bno) - (fs)->e2fs.e2fs_first_dblock) % (fs)->e2fs.e2fs_fpg);
 if ((((bbp)[(bno)>>3] & (1<<((bno)&(8 -1)))) == 0))
...
ext2fs_inode_free(struct inode *pip, ufsino_t ino, mode_t mode)
{
 ...
 fs = pip->inode_u.e2fs;
 if (ino > fs->e2fs.e2fs_icount || ino < ((ufsino_t)11))
  panic("ifree: range: dev = 0x%x, ino = %u, fs = %s",
      pip->i_dev, ino, fs->e2fs_fsmnt);
 cg = (((ino) - 1) / (fs)->e2fs.e2fs_ipg);
 error = bread(pip->i_ump->um_devvp,
     ((fs->e2fs_gd[cg].ext2bgd_i_bitmap) << (fs)->e2fs_fsbtodb),
     (int)fs->e2fs_bsize, &bp);
 if (error) {
  brelse(bp);
  return;
...
# 545 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_alloc.c"
static u_int32_t
ext2fs_mapsearch(struct m_ext2fs *fs, char *bbp, u_int32_t bpref)
{
 ...
 if (bpref)
  ...
  start = 0;
 len = (((fs->e2fs.e2fs_fpg) + ((8) - 1)) / (8)) - start;
