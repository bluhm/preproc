# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c"
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c"
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.h" 1
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/miidevs.h" 1
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c" 2
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c"
...
dcphy_match(struct device *parent, void *match, void *aux)
{
 ...
 if ((((ma->mii_id1) << 6) | ((ma->mii_id2) >> 10)) == 0x040440 &&
     (((ma->mii_id2) & 0x03f0) >> 4) == 0x0001)
  return (10);
...
dcphy_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x60, 0);
 bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70, 0);
 ...
 case 0xb0bb0e11:
  ...
  sc->mii_capabilities = 0x0008|0x1000|0x0800;
  break;
 default:
  if (dc_sc->dc_pmode == 0x3) {
   sc->mii_capabilities =
       0x0008|0x1000|0x0800;
  } else {
   ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (6) | (0x0000800000000000ULL) | ((uint64_t)(sc->mii_inst) << 56))), (0x4000|0x2000), ((void *)0));


   sc->mii_capabilities =
       0x0008|0x4000|0x2000|
       0x1000|0x0800;
  }
  break;
 }

 if (dc_sc->dc_type == 0xD)
  sc->mii_capabilities = 0x0800;
...
dcphy_service(struct mii_softc *sc, struct mii_data *mii, int cmd)
{
 ...
 case 2:
  ...
  mode = bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x30);
  mode &= ~(0x00000200|0x00040000|
  ...
  case 6:
   ...
   bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70, bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70) & ~0x00000080);
   mode |= 0x00040000|0x00800000|
       0x01000000;
   if ((ife->ifm_media & 0x00ffff0000000000ULL) == 0x0000010000000000ULL)
    mode |= 0x00000200;
   else
    mode &= ~0x00000200;
   bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x30, mode);
   break;
  case 3:
   bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x68, bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x68) & ~0x00000001);
   bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70, bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70) & ~0xFFFF);
   if ((ife->ifm_media & 0x00ffff0000000000ULL) == 0x0000010000000000ULL)
    bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70, bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70) | 0x7F3D);
   else
    bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70, bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70) | 0x7F3F);
   bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x68, bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x68) | 0x00000001);
   bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70, bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70) & ~0x00000080);
   mode &= ~0x00040000;
   mode |= 0x00400000;
 ...
 case 1:
  ...
  reg64 = bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x60);
  if (!(reg64 & 0x00000004) || !(reg64 & 0x00000002)) {
   sc->mii_ticks = 0;
   break;
  }
# 289 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c"
...
dcphy_status(struct mii_softc *sc)
{
 ...
 if (bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70) & 0x00000080) {

  tstat = bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x60);
  if ((tstat & 0x00007000) != 0x00005000) {
   if (((dc_sc->dc_type == 0x1 || dc_sc->dc_type == 0x2 || dc_sc->dc_type == 0x3) || (dc_sc->dc_type == 0x9)) &&
       (tstat & 0x00007000) == 0x00000000)
    goto skip;
   mii->mii_media_active |= 2ULL;
   return;
  }
  ...
  if (tstat & 0x00008000) {
   ...
   if (anlpar & 0x0100 &&
    ...
    mii->mii_media_active |= 2ULL;
   if ((dc_sc->dc_type == 0x4 || dc_sc->dc_type == 0xD))
    bus_space_write_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70, bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x70) & ~0x00000080);

   return;
  }
# 365 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/dcphy.c"
  if (!(reg64 & 0x00000002))
   mii->mii_media_active |= 6|0x0000020000000000ULL;
  else if (!(reg64 & 0x00000004))
   mii->mii_media_active |= 3|0x0000020000000000ULL;
  else
   mii->mii_media_active |= 2ULL;
  if ((dc_sc->dc_type == 0x4 || dc_sc->dc_type == 0xD))
...
skip:
 if (bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x30) & 0x00400000)
  mii->mii_media_active |= 3;
 else
  mii->mii_media_active |= 6;

 if (bus_space_read_4(dc_sc->dc_btag, dc_sc->dc_bhandle, 0x30) & 0x00000200)
...
dcphy_mii_phy_auto(struct mii_softc *mii, int waitfor)
{
 ...
 if ((mii->mii_flags & 0x0008) == 0) {
  ...
  if (mii->mii_capabilities & 0x2000)
   bus_space_write_4(sc->dc_btag, sc->dc_bhandle, 0x70, 0x3FFFF);
  else
   bus_space_write_4(sc->dc_btag, sc->dc_bhandle, 0x70, 0xFFFF);
  bus_space_write_4(sc->dc_btag, sc->dc_bhandle, 0x68, bus_space_read_4(sc->dc_btag, sc->dc_bhandle, 0x68) | 0x00000001);
  bus_space_write_4(sc->dc_btag, sc->dc_bhandle, 0x70, bus_space_read_4(sc->dc_btag, sc->dc_bhandle, 0x70) | 0x00000080);
  bus_space_write_4(sc->dc_btag, sc->dc_bhandle, 0x60, bus_space_read_4(sc->dc_btag, sc->dc_bhandle, 0x60) | 0x00001000);
 }

 if (waitfor) {

  for (i = 0; i < 500; i++) {
   if ((bus_space_read_4(sc->dc_btag, sc->dc_bhandle, 0x60) & 0x00007000)
       == 0x00005000)
    return (0);
   delay(1000);
  }
