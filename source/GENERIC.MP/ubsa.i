# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c"
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c"
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/ioccom.h" 1
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/file.h" 1
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/file.h"
struct proc;
struct uio;
struct knote;
struct stat;
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c" 2
# 142 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ubsa.c"
struct ubsa_softc {
...
ubsa_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(ubsa_devs), sizeof (ubsa_devs) / sizeof ((ubsa_devs)[0]), sizeof ((ubsa_devs)[0]), (uaa->vendor), (uaa->product)) != ((void *)0) ?
     13 : 0);
}
...
ubsa_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 err = usbd_set_config_index(dev, 1, 1);
 if (err) {
 ...
 for (i = 0; i < id->bNumEndpoints; i++) {
  ...
  if (((ed->bEndpointAddress) & 0x80) == 0x80 &&
   ...
   uca.ibufsize = ((ed->wMaxPacketSize)[0] | ((ed->wMaxPacketSize)[1] << 8));
  } else if (((ed->bEndpointAddress) & 0x80) == 0x00 &&
      ((ed->bmAttributes) & 0x03) == 0x02) {
   uca.bulkout = ed->bEndpointAddress;
   uca.obufsize = ((ed->wMaxPacketSize)[0] | ((ed->wMaxPacketSize)[1] << 8));
  }
 }
...
ubsa_dtr(struct ubsa_softc *sc, int onoff)
{
 ...
 ubsa_request(sc, 0x0A, onoff ? 1 : 0);
}
...
ubsa_rts(struct ubsa_softc *sc, int onoff)
{
 ...
 ubsa_request(sc, 0x0B, onoff ? 1 : 0);
}
...
ubsa_break(struct ubsa_softc *sc, int onoff)
{
 ...
 ubsa_request(sc, 0x0C, onoff ? 1 : 0);
}

void
ubsa_set(void *addr, int portno, int reg64, int onoff)
{
...
ubsa_parity(struct ubsa_softc *sc, tcflag_t cflag)
{
 ...
 if (cflag & 0x00001000)
  value = (cflag & 0x00002000) ? 0x02 : 0x01;
 else
  value = 0x00;

 ubsa_request(sc, 0x03, value);
}
...
ubsa_databits(struct ubsa_softc *sc, tcflag_t cflag)
{
 ...
 case 0x00000000: value = 0; break;
 case 0x00000100: value = 1; break;
 case 0x00000200: value = 2; break;
 case 0x00000300: value = 3; break;
 default:
  ;
...
ubsa_stopbits(struct ubsa_softc *sc, tcflag_t cflag)
{
 ...
 value = (cflag & 0x00000400) ? 1 : 0;

 ubsa_request(sc, 0x01, value);
}
...
ubsa_flow(struct ubsa_softc *sc, tcflag_t cflag, tcflag_t iflag)
{
 ...
 if (cflag & 0x00010000)
  value |= 0x0001 | 0x0010;
 if (iflag & (0x00000200|0x00000400))
  value |= 0x0080 | 0x0100;

 ubsa_request(sc, 0x10, value);
}
...
ubsa_intr(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (cdcbuf->bmRequestType == 0xa1) {
  ...
  if (cdcbuf->bNotification == 0x20)
   printf("%s:notify serial state, len=%d, data=0x%02x\n",
       sc->sc_dev.dv_xname,
       ((cdcbuf->wLength)[0] | ((cdcbuf->wLength)[1] << 8)), cdcbuf->data[0]);
 }
