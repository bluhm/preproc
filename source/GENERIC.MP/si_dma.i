...
_Bool si_dma_is_lockup(struct radeon_device *rdev, struct radeon_ring *ring)
{
     ...
     unsigned count)
{
 while (count) {
  ...
  if (bytes > 0xFFFF8)
   bytes = 0xFFFF8;
  ib->ptr[ib->length_dw++] = ((((0x3) & 0xF) << 28) | (((1) & 0x1) << 26) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((bytes) & 0xFFFFF) << 0));
      ...
      uint32_t incr, uint32_t flags)
{
 ...
 while (count) {
  ...
  if (ndw > 0xFFFFE)
   ndw = 0xFFFFE;
  ib->ptr[ib->length_dw++] = ((((0x2) & 0xF) << 28) | (((0) & 0x1) << 26) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((ndw) & 0xFFFFF) << 0));
...
void si_dma_vm_flush(struct radeon_device *rdev, struct radeon_ring *ring,
       unsigned vm_id, uint64_t pd_addr)
{
 radeon_ring_write(ring, ((((0x9) & 0xF) << 28) | (((0) & 0x1) << 26) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((0) & 0xFFFFF) << 0)));
 if (vm_id < 8) {
  radeon_ring_write(ring, (0xf << 16) | ((0x153c + (vm_id << 2)) >> 2));
 } else {
  radeon_ring_write(ring, (0xf << 16) | ((0x1438 + ((vm_id - 8) << 2)) >> 2));
 }
 ...
 radeon_ring_write(ring, ((((0xe) & 0xF) << 28) | (((0) & 0x1) << 26) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((0) & 0xFFFFF) << 0)));
 radeon_ring_write(ring, 0x1478);
     ...
     struct reservation_object *resv)
{
 ...
 num_loops = (((size_in_bytes) + ((0xfffff) - 1)) / (0xfffff));
 ...
 for (i = 0; i < num_loops; i++) {
  ...
  radeon_ring_write(ring, ((((0x3) & 0xF) << 28) | (((1) & 0x1) << 26) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((cur_size_in_bytes) & 0xFFFFF) << 0)));
