# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c"
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c"
...
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
# 83 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 87 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530reg.h" 1
# 89 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
# 90 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
# 92 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
# 93 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
...
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c" 2
# 102 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c"
struct zsms_softc {
...
# 116 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c"
 uint sc_rbget;
 volatile uint sc_rbput;
 uint16_t sc_rbuf[256];
};
...
zsms_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 s = _splraise(12);
 zs_write_reg(cs, 9, channel == 0 ? 0x80 : 0x40);

 ((cs->cs_preg[1]) &= ~(0x10 | 0x01 | 0x02));


 ((cs->cs_preg[4]) &= ~(0x0c | 0x03));
 ((cs->cs_preg[4]) |= (0x0c));
 (void)zs_set_speed(cs, 9600);
...
zsms_rxint(struct zs_chanstate *cs)
{
 ...
 for (;;) {
  ...
  if (sc->sc_base.sc_state != 0) {
   ...
   put_next = (put + 1) & (256 -1);


   if (put_next == sc->sc_rbget) {
    sc->sc_intr_flags |= 0x01;
    break;
   } else {
...
# 349 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/z8530ms.c"
 if (!force && ((rr0) & (0x80))) {
  if (sc->sc_base.sc_state != 0 &&
      ++sc->sc_base.sc_brk > 1) {
   sc->sc_intr_flags |= 0x08;
