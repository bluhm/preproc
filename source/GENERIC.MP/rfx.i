# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/mman.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
void device_register(struct device *, void *);
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
int bppopen(dev_t, int, int, struct proc *); int bppclose(dev_t, int, int, struct proc *); int bppread(dev_t, struct uio *, int); int bppwrite(dev_t, struct uio *, int); int bppioctl(dev_t, u_long, caddr_t, int, struct proc *); int bppstop(struct tty *, int); struct tty *bpptty(dev_t); int bpppoll(dev_t, int, struct proc *); paddr_t bppmmap(dev_t, off_t, int); int bppkqfilter(dev_t, struct knote *);
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
int ifb_ident(void *);
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2



# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/bt463reg.h" 1
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c" 2
...
# 102 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c"
struct rfx_cmap {
 u_int8_t red[256];
 u_int8_t green[256];
 u_int8_t blue[256];
...
rfxattach(struct device *parent, struct device *self, void *args)
{
 ...
 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset + 0x00020000)), 0x00000004, 0x0002, &bh) != 0) {
 ...
 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset + 0x00040000)), 0x000000e0, 0x0002, &bh) != 0) {

  printf("\n%s: couldn't map control registers\n", self->dv_xname);
  return;
 }
 sc->sc_ctrl = (u_int32_t *)bus_space_vaddr(bt, bh);
# 267 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/rfx.c"
 ...
 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset + 0x00100000)), (((sc->sc_sunfb.sf_fbsize) + ((1 << 13) - 1)) & ~((1 << 13) - 1)), 0x0002, &bh) != 0) {
...
rfx_burner(void *v, u_int on, u_int flags)
{
 ...
 if (on) {
  sc->sc_ctrl[0x10] &= ~0x00000002;
  sc->sc_ctrl[0x10] |= 0x00000001;
 } else {
  sc->sc_ctrl[0x10] |= 0x00000002;
  if (flags & 0x0001)
   sc->sc_ctrl[0x10] &= ~0x00000001;
...
rfx_putcmap(struct rfx_cmap *cm, struct wsdisplay_cmap *rcm)
{
 ...
 __builtin_bcopy((red), (cm->red + index), (count));
 __builtin_bcopy((green), (cm->green + index), (count));
 __builtin_bcopy((blue), (cm->blue + index), (count));
...
rfx_loadcmap(struct rfx_softc *sc, int start, int ncolors)
{
 ...
 start += 0x0000;
 sc->sc_ramdac[0x00] = start & 0xff;
 sc->sc_ramdac[0x01] = (start >> 8) & 0xff;
    ...
    struct rfx_config *cf)
{
 ...
 if ((error = bus_space_map(sa->sa_bustag, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset + 0x00018000)), 0x00008000, 0x0002, &bh)) != 0) {
 ...
 data += 0x0000001c / sizeof(u_int32_t);
 cnt = (0x00008000 - 0x0000001c) / sizeof(u_int32_t);
 cnt >>= 1;
 ...
 while (cnt != 0) {
  ...
  if (offset & (1U << 31)) {
   ...
   if (offset < 0x00000004)
    sc->sc_ramdac[offset] = value >> 24;
  } else {
   offset -= 0x00040000;
   if (offset < 0x000000e0)
 ...
 bus_space_unmap(sa->sa_bustag, bh, 0x00008000);
