# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_encoders.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_encoders.c"
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_encoders.c"
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_encoders.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_encoders.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_encoders.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_encoders.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_encoders.c" 2
...
radeon_atom_get_backlight_level_from_reg(struct radeon_device *rdev)
{
 ...
 backlight_level = ((bios_2_scratch & 0x0000FF00L) >>
      8);
           ...
           u8 backlight_level)
{
 ...
 bios_2_scratch &= ~0x0000FF00L;
 bios_2_scratch |= ((backlight_level << 8) &
      0x0000FF00L);
...
atombios_get_backlight_level(struct radeon_encoder *radeon_encoder)
{
 ...
 if (!(rdev->mode_info.firmware_flags & 0x0020))
  return 0;
...
atombios_set_backlight_level(struct radeon_encoder *radeon_encoder, u8 level)
{
 ...
 if ((radeon_encoder->devices & (((0x1L << 0x00000001 ) | (0x1L << 0x00000005 )))) &&
  ...
  case 0x01:
  case 0x0F:
   index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->HW_Misc_Operation)-(char*)0)/sizeof(USHORT));
  ...
  case 0x21:
   if (dig->backlight_level == 0)
    atombios_dig_transmitter_setup(encoder, 2, 0, 0);
   else {
    atombios_dig_transmitter_setup(encoder, 4, 0, 0);
    atombios_dig_transmitter_setup(encoder, 3, 0, 0);
   }
   break;
  default:
   break;
...
# 282 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_encoders.c"
_Bool radeon_atom_get_tv_timings(struct radeon_device *rdev, int index,
    struct drm_display_mode *mode);


static inline _Bool radeon_encoder_is_digital(struct drm_encoder *encoder)
{
...
static _Bool radeon_atom_mode_fixup(struct drm_encoder *encoder,
       const struct drm_display_mode *mode,
       struct drm_display_mode *adjusted_mode)
{
 struct radeon_encoder *radeon_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
...
atombios_dac_setup(struct drm_encoder *encoder, int action)
{
 ...
 args.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
...
atombios_tv_setup(struct drm_encoder *encoder, int action)
{
 ...
 args.sTVEncoder.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
...
atombios_dvo_setup(struct drm_encoder *encoder, int action)
{
 ...
 int index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->DVOEncoderControl)-(char*)0)/sizeof(USHORT));
 uint8_t frev, crev;
 ...
 case 1:
  ...
  case 1:
   ...
   if (radeon_dig_monitor_is_duallink(encoder, radeon_encoder->pixel_clock))
    args.ext_tmds.sXTmdsEncoder.ucMisc |= 0x01;

   args.ext_tmds.sXTmdsEncoder.ucMisc |= 0x00000002;
   break;
  case 2:

   args.dvo.sDVOEncoder.ucAction = action;
   args.dvo.sDVOEncoder.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
  ...
  case 3:
   ...
   args.dvo_v3.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
...
atombios_digital_setup(struct drm_encoder *encoder, int action)
{
 ...
 switch (radeon_encoder->encoder_id) {
 case 0x01:
  index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->MC_SEQ_Control)-(char*)0)/sizeof(USHORT));
  break;
 case 0x02:
 case 0x13:
  index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->PatchMCSetting)-(char*)0)/sizeof(USHORT));
  break;
 case 0x0F:
  if (radeon_encoder->devices & (((0x1L << 0x00000001 ) | (0x1L << 0x00000005 ))))
   index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->MC_SEQ_Control)-(char*)0)/sizeof(USHORT));
 ...
 case 2:
  ...
  case 1:
   ...
   if (hdmi_detected)
    args.v1.ucMisc |= 0x08;
   args.v1.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   if (radeon_encoder->devices & (((0x1L << 0x00000001 ) | (0x1L << 0x00000005 )))) {
    if (dig->lcd_misc & 0x00000001)
     args.v1.ucMisc |= 0x01;
    if (dig->lcd_misc & 0x00000002)
     args.v1.ucMisc |= 0x00000002;
   } else {
    if (dig->linkb)
     args.v1.ucMisc |= 0x04;
    if (radeon_dig_monitor_is_duallink(encoder, radeon_encoder->pixel_clock))
  ...
  case 3:
   ...
   if (hdmi_detected)
    args.v2.ucMisc |= 0x08;
   args.v2.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
...
atombios_get_encoder_mode(struct drm_encoder *encoder)
{
 ...
 if (radeon_encoder_get_dp_bridge_encoder_id(encoder) != 0x00)
  return 0;


 if ((radeon_encoder->encoder_id == 0x0B) ||
     (radeon_encoder->encoder_id == 0x14))
  return 16;
...
# 796 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_encoders.c"
...
atombios_dig_encoder_setup(struct drm_encoder *encoder, int action, int panel_mode)
{
 ...
 case 1:
  ...
  case 1:
   ...
   if ((((args.v1.ucEncoderMode) == 0) || ((args.v1.ucEncoderMode) == 5)))
   ...
   if ((((args.v1.ucEncoderMode) == 0) || ((args.v1.ucEncoderMode) == 5)) && (dp_clock == 270000))
  ...
  case 3:
   ...
   args.v3.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   if (action == 0x10)
    args.v3.ucPanelMode = panel_mode;
   else
    args.v3.ucEncoderMode = atombios_get_encoder_mode(encoder);

   if ((((args.v3.ucEncoderMode) == 0) || ((args.v3.ucEncoderMode) == 5)))
   ...
   if ((((args.v3.ucEncoderMode) == 0) || ((args.v3.ucEncoderMode) == 5)) && (dp_clock == 270000))
    args.v1.ucConfig |= 0x01;
  ...
  case 4:
   ...
   args.v4.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   if (action == 0x10)
    args.v4.ucPanelMode = panel_mode;
   else
    args.v4.ucEncoderMode = atombios_get_encoder_mode(encoder);

   if ((((args.v4.ucEncoderMode) == 0) || ((args.v4.ucEncoderMode) == 5)))
...
atombios_dig_transmitter_setup(struct drm_encoder *encoder, int action, uint8_t lane_num, uint8_t lane_set)
{
 ...
 if ((((atombios_get_encoder_mode(encoder)) == 0) || ((atombios_get_encoder_mode(encoder)) == 5)))
  is_dp = 1;
 ...
 case 1:
  ...
  case 1:
   args.v1.ucAction = action;
   if (action == 7) {
    args.v1.usInitInfo = __extension__({ __uint16_t __swap16gen_x = (connector_object_id); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   } else if (action == 11) {
    args.v1.asMode.ucLaneSel = lane_num;
    args.v1.asMode.ucLaneSet = lane_set;
   } else {
    if (is_dp)
     args.v1.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (dp_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
    else if (radeon_dig_monitor_is_duallink(encoder, radeon_encoder->pixel_clock))
     args.v1.usPixelClock = __extension__({ __uint16_t __swap16gen_x = ((radeon_encoder->pixel_clock / 2) / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
    else
     args.v1.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   }
  ...
  case 2:
   args.v2.ucAction = action;
   if (action == 7) {
    args.v2.usInitInfo = __extension__({ __uint16_t __swap16gen_x = (connector_object_id); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   } else if (action == 11) {
    args.v2.asMode.ucLaneSel = lane_num;
    args.v2.asMode.ucLaneSet = lane_set;
   } else {
    if (is_dp)
     args.v2.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (dp_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
    else if (radeon_dig_monitor_is_duallink(encoder, radeon_encoder->pixel_clock))
     args.v2.usPixelClock = __extension__({ __uint16_t __swap16gen_x = ((radeon_encoder->pixel_clock / 2) / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
    else
     args.v2.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   }
  ...
  case 3:
   args.v3.ucAction = action;
   if (action == 7) {
    args.v3.usInitInfo = __extension__({ __uint16_t __swap16gen_x = (connector_object_id); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   } else if (action == 11) {
    args.v3.asMode.ucLaneSel = lane_num;
    args.v3.asMode.ucLaneSet = lane_set;
   } else {
    if (is_dp)
     args.v3.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (dp_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
    else if (radeon_dig_monitor_is_duallink(encoder, radeon_encoder->pixel_clock))
     args.v3.usPixelClock = __extension__({ __uint16_t __swap16gen_x = ((radeon_encoder->pixel_clock / 2) / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
    else
     args.v3.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   }
  ...
  case 4:
   args.v4.ucAction = action;
   if (action == 7) {
    args.v4.usInitInfo = __extension__({ __uint16_t __swap16gen_x = (connector_object_id); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   } else if (action == 11) {
    args.v4.asMode.ucLaneSel = lane_num;
    args.v4.asMode.ucLaneSet = lane_set;
   } else {
    if (is_dp)
     args.v4.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (dp_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
    else if (radeon_dig_monitor_is_duallink(encoder, radeon_encoder->pixel_clock))
     args.v4.usPixelClock = __extension__({ __uint16_t __swap16gen_x = ((radeon_encoder->pixel_clock / 2) / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
    else
     args.v4.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   }
   ...
   if (is_dp) {
    if (rdev->clock.dp_extclk)
     ...
     args.v4.acConfig.ucRefClkSource = 2;
   } else
  ...
  case 5:
   ...
   if (is_dp)
    args.v5.usSymClock = __extension__({ __uint16_t __swap16gen_x = (dp_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   else
    args.v5.usSymClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   ...
   if (is_dp && rdev->clock.dp_extclk)
    args.v5.asConfig.ucPhyClkSrcId = 3;
   else
...
atombios_set_edp_panel_power(struct drm_connector *connector, int action)
{
 ...
 struct radeon_device *rdev = dev->dev_private;
 union dig_transmitter_control args;
 int index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->DIG1TransmitterControl)-(char*)0)/sizeof(USHORT));
 uint8_t frev, crev;
    ...
    int action)
{
 ...
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_encoder *radeon_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 struct radeon_encoder *ext_radeon_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (ext_encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 union external_encoder_control args;
 struct drm_connector *connector;
 int index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->ExternalEncoderControl)-(char*)0)/sizeof(USHORT));
 u8 frev, crev;
 int dp_clock = 0;
 int dp_lane_count = 0;
 int connector_object_id = 0;
 u32 ext_enum = (ext_radeon_encoder->encoder_enum & 0x0700) >> 0x08;
 ...
 case 2:
  ...
  case 2:
   ...
   args.v1.sDigEncoder.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   args.v1.sDigEncoder.ucEncoderMode = atombios_get_encoder_mode(encoder);

   if ((((args.v1.sDigEncoder.ucEncoderMode) == 0) || ((args.v1.sDigEncoder.ucEncoderMode) == 5))) {
    if (dp_clock == 270000)
     args.v1.sDigEncoder.ucConfig |= 0x01;
  ...
  case 3:
   ...
   if (action == 0x07)
    args.v3.sExtEncoder.usConnectorId = __extension__({ __uint16_t __swap16gen_x = (connector_object_id); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   else
    args.v3.sExtEncoder.usPixelClock = __extension__({ __uint16_t __swap16gen_x = (radeon_encoder->pixel_clock / 10); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   args.v3.sExtEncoder.ucEncoderMode = atombios_get_encoder_mode(encoder);

   if ((((args.v3.sExtEncoder.ucEncoderMode) == 0) || ((args.v3.sExtEncoder.ucEncoderMode) == 5))) {
    if (dp_clock == 270000)
     args.v3.sExtEncoder.ucConfig |= 0x01;
    else if (dp_clock == 540000)
     args.v3.sExtEncoder.ucConfig |= 0x02;
   ...
   switch (ext_enum) {
   case 0x01:
    args.v3.sExtEncoder.ucConfig |= 0x00;
    break;
   case 0x02:
    args.v3.sExtEncoder.ucConfig |= 0x10;
    break;
   case 0x03:
    args.v3.sExtEncoder.ucConfig |= 0x20;
    break;
   }
...
static void
atombios_yuv_setup(struct drm_encoder *encoder, _Bool enable)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_encoder *radeon_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 ...
 int index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->GetDispObjectInfo)-(char*)0)/sizeof(USHORT));
 uint32_t temp, reg64;
 ...
 temp = r100_mm_rreg(rdev, (reg64), 0);
 if (radeon_encoder->active_device & (((0x1L << 0x00000002 ))))
  r100_mm_wreg(rdev, (reg64), ((0x00000004L | (radeon_crtc->crtc_id << 18))), 0);

 else if (radeon_encoder->active_device & ((0x1L << 0x00000008 )))
  r100_mm_wreg(rdev, (reg64), ((0x00000100L | (radeon_crtc->crtc_id << 24))), 0);
 else
  r100_mm_wreg(rdev, (reg64), (0), 0);
 ...
 r100_mm_wreg(rdev, (reg64), (temp), 0);
}
...
radeon_atom_encoder_dpms_avivo(struct drm_encoder *encoder, int mode)
{
 ...
 case 0:
  ...
  if (radeon_encoder->encoder_id == 0x19) {
   u32 reg64 = r100_mm_rreg(rdev, (0x001c), 0);
   r100_mm_wreg(rdev, (0x001c), (reg64 & ~0x00000200L), 0);
   atom_execute_table(rdev->mode_info.atom_context, index, (uint32_t *)&args);
   r100_mm_wreg(rdev, (0x001c), (reg64), 0);
  } else
   atom_execute_table(rdev->mode_info.atom_context, index, (uint32_t *)&args);
  if (radeon_encoder->devices & (((0x1L << 0x00000001 ) | (0x1L << 0x00000005 )))) {
   args.ucAction = (1 +2);
...
radeon_atom_encoder_dpms_dig(struct drm_encoder *encoder, int mode)
{
 ...
 case 0:
  if (((rdev->family >= CHIP_PALM) && (rdev->flags & RADEON_IS_IGP)) || ((rdev->family >= CHIP_BARTS))) {
   ...
   atombios_dig_encoder_setup(encoder, 0x0f, 0);
   ...
   atombios_dig_encoder_setup(encoder, 1, 0);
  ...
  if ((((atombios_get_encoder_mode(encoder)) == 0) || ((atombios_get_encoder_mode(encoder)) == 5)) && connector) {
   if (connector->connector_type == 14) {
   ...
   if (((rdev->family >= CHIP_CEDAR)))
    atombios_dig_encoder_setup(encoder, 0x0d, 0);
  }
  if (radeon_encoder->devices & (((0x1L << 0x00000001 ) | (0x1L << 0x00000005 ))))
   atombios_dig_transmitter_setup(encoder, 3, 0, 0);
  break;
 ...
 case 3:
  if (((rdev->family >= CHIP_PALM) && (rdev->flags & RADEON_IS_IGP)) || ((rdev->family >= CHIP_BARTS))) {
   ...
   atombios_dig_transmitter_setup(encoder, 8, 0, 0);
   atombios_dig_transmitter_setup(encoder, 0, 0, 0);
   atombios_dig_encoder_setup(encoder, 0, 0);
  }
  if ((((atombios_get_encoder_mode(encoder)) == 0) || ((atombios_get_encoder_mode(encoder)) == 5)) && connector) {
   if (((rdev->family >= CHIP_CEDAR)))
    atombios_dig_encoder_setup(encoder, 0x0c, 0);
   if (connector->connector_type == 14) {
    atombios_set_edp_panel_power(connector,
            13);
        ...
        int mode)
{
 ...
 default:
  if (((rdev->family >= CHIP_PALM) && (rdev->flags & RADEON_IS_IGP)) || ((rdev->family >= CHIP_ARUBA) && (rdev->flags & RADEON_IS_IGP))) {
   ...
   atombios_external_encoder_setup(encoder, ext_encoder, 1);
  break;
 case 1:
 case 2:
 case 3:
  if (((rdev->family >= CHIP_PALM) && (rdev->flags & RADEON_IS_IGP)) || ((rdev->family >= CHIP_ARUBA) && (rdev->flags & RADEON_IS_IGP))) {
   ...
   atombios_external_encoder_setup(encoder, ext_encoder, 0);
  break;
 }
}
  ...
  case 2:
   ...
   if (radeon_encoder_get_dp_bridge_encoder_id(encoder) != 0x00) {
    ...
    if (connector->connector_type == 7)
     args.v2.ucEncodeMode = 1;
    else if (connector->connector_type == 1)
     args.v2.ucEncodeMode = 15;
    else
     args.v2.ucEncodeMode = atombios_get_encoder_mode(encoder);
   } else if (radeon_encoder->devices & (((0x1L << 0x00000001 ) | (0x1L << 0x00000005 )))) {
    args.v2.ucEncodeMode = 1;
   } else {
    args.v2.ucEncodeMode = atombios_get_encoder_mode(encoder);
   }
         ...
         struct drm_display_mode *mode)
{
 ...
 if ((dev->pdev->device == 0x71C5) &&
  ...
  if (radeon_encoder->devices & (0x1L << 0x00000001 )) {
   uint32_t lvtma_bit_depth_control = r100_mm_rreg(rdev, (0x7a94), 0);

   lvtma_bit_depth_control &= ~(1 << 0);
   lvtma_bit_depth_control &= ~(1 << 8);

   r100_mm_wreg(rdev, (0x7a94), (lvtma_bit_depth_control), 0);
  }
 }


 if (((rdev->family >= CHIP_RS600)) &&
     (!(radeon_encoder->active_device & (((0x1L << 0x00000002 )))))) {
  if (((rdev->family >= CHIP_CEDAR))) {
   if (mode->flags & (1<<4))
    r100_mm_wreg(rdev, (0x6b00 + radeon_crtc->crtc_offset), ((1 << 0)), 0);

   else
    r100_mm_wreg(rdev, (0x6b00 + radeon_crtc->crtc_offset), (0), 0);
  } else {
   if (mode->flags & (1<<4))
    r100_mm_wreg(rdev, (0x6528 + radeon_crtc->crtc_offset), ((1 << 0)), 0);

   else
    r100_mm_wreg(rdev, (0x6528 + radeon_crtc->crtc_offset), (0), 0);
  }
 }
}
...
static int radeon_atom_pick_dig_encoder(struct drm_encoder *encoder)
{
 ...
 for (test_encoder = ({ __typeof( ((__typeof(*test_encoder) *)0)->head ) *__mptr = ((&dev->mode_config.encoder_list)->next); (__typeof(*test_encoder) *)( (char *)__mptr - __builtin_offsetof(__typeof(*test_encoder), head) );}); &test_encoder->head != (&dev->mode_config.encoder_list); test_encoder = ({ __typeof( ((__typeof(*test_encoder) *)0)->head ) *__mptr = (test_encoder->head.next); (__typeof(*test_encoder) *)( (char *)__mptr - __builtin_offsetof(__typeof(*test_encoder), head) );})) {
  ...
  radeon_test_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (test_encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 ...
 if (radeon_encoder->encoder_id == 0x1F) {
  if (dig_enc_in_use & 0x2)
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "LVDS required digital encoder 2 but it was in use - stealing\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return 1;
 }
 if (!(dig_enc_in_use & 1))
  return 0;
...
radeon_atom_encoder_init(struct radeon_device *rdev)
{
 ...
 for (encoder = ({ __typeof( ((__typeof(*encoder) *)0)->head ) *__mptr = ((&dev->mode_config.encoder_list)->next); (__typeof(*encoder) *)( (char *)__mptr - __builtin_offsetof(__typeof(*encoder), head) );}); &encoder->head != (&dev->mode_config.encoder_list); encoder = ({ __typeof( ((__typeof(*encoder) *)0)->head ) *__mptr = (encoder->head.next); (__typeof(*encoder) *)( (char *)__mptr - __builtin_offsetof(__typeof(*encoder), head) );})) {
  ...
  if (ext_encoder && (((rdev->family >= CHIP_PALM) && (rdev->flags & RADEON_IS_IGP)) || ((rdev->family >= CHIP_ARUBA) && (rdev->flags & RADEON_IS_IGP))))
   atombios_external_encoder_setup(encoder, ext_encoder,
       0x07);
 }
}
...
atombios_dac_load_detect(struct drm_encoder *encoder, struct drm_connector *connector)
{
 ...
 if (radeon_encoder->devices & (((0x1L << 0x00000002 )) |
  ...
  if (radeon_connector->devices & (0x1L << 0x00000000 ))
   args.sDacload.usDeviceID = __extension__({ __uint16_t __swap16gen_x = ((0x1L << 0x00000000 )); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
  else if (radeon_connector->devices & (0x1L << 0x00000004 ))
   args.sDacload.usDeviceID = __extension__({ __uint16_t __swap16gen_x = ((0x1L << 0x00000004 )); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
  else if (radeon_connector->devices & (0x1L << 0x00000008 )) {
   args.sDacload.usDeviceID = __extension__({ __uint16_t __swap16gen_x = ((0x1L << 0x00000008 )); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   if (crev >= 3)
    args.sDacload.ucMisc = 0x01;
  } else if (radeon_connector->devices & (0x1L << 0x00000002 )) {
   args.sDacload.usDeviceID = __extension__({ __uint16_t __swap16gen_x = ((0x1L << 0x00000002 )); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
   if (crev >= 3)
    args.sDacload.ucMisc = 0x01;
  }
...
radeon_atom_dig_detect(struct drm_encoder *encoder, struct drm_connector *connector)
{
 ...
 if ((radeon_connector->devices & ((0x1L << 0x00000000 ) | (0x1L << 0x00000004 ))) == 0)
  return connector_status_unknown;
...
static void radeon_atom_encoder_prepare(struct drm_encoder *encoder)
{
 ...
 if ((radeon_encoder->active_device &
  ...
  if (dig) {
   ...
   if (radeon_encoder->active_device & ((0x1L << 0x00000003 ) | (0x1L << 0x00000007 ) | (0x1L << 0x00000009 ) | (0x1L << 0x0000000A ) | (0x1L << 0x0000000B ) | (0x1L << 0x00000006 ))) {
    if (rdev->family >= CHIP_R600)
...
static _Bool radeon_atom_ext_mode_fixup(struct drm_encoder *encoder,
           const struct drm_display_mode *mode,
           struct drm_display_mode *adjusted_mode)
{
 return 1;
...
radeon_atombios_set_dac_info(struct radeon_encoder *radeon_encoder)
{
 struct drm_device *dev = radeon_encoder->base.dev;
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_encoder_atom_dac *dac = kzalloc(sizeof(struct radeon_encoder_atom_dac), (0x0001 | 0x0004));
...
radeon_atombios_set_dig_info(struct radeon_encoder *radeon_encoder)
{
 ...
 struct radeon_encoder_atom_dig *dig = kzalloc(sizeof(struct radeon_encoder_atom_dig), (0x0001 | 0x0004));
   ...
   u16 caps)
{
 ...
 radeon_encoder->is_ext_encoder = 0;
 ...
 case 0x21:
  if (radeon_encoder->devices & (((0x1L << 0x00000001 ) | (0x1L << 0x00000005 )))) {
   ...
   drm_encoder_init(dev, encoder, &radeon_atom_enc_funcs, 3);
   radeon_encoder->enc_priv = radeon_atombios_get_lvds_info(radeon_encoder);
  } else if (radeon_encoder->devices & (((0x1L << 0x00000000 ) | (0x1L << 0x00000004 )))) {
   drm_encoder_init(dev, encoder, &radeon_atom_enc_funcs, 1);
   radeon_encoder->enc_priv = radeon_atombios_set_dig_info(radeon_encoder);
  } else {
   drm_encoder_init(dev, encoder, &radeon_atom_enc_funcs, 2);
 ...
 case 0x22:
  ...
  radeon_encoder->is_ext_encoder = 1;
  if (radeon_encoder->devices & (((0x1L << 0x00000001 ) | (0x1L << 0x00000005 ))))
   drm_encoder_init(dev, encoder, &radeon_atom_enc_funcs, 3);
  else if (radeon_encoder->devices & (((0x1L << 0x00000000 ) | (0x1L << 0x00000004 ))))
   drm_encoder_init(dev, encoder, &radeon_atom_enc_funcs, 1);
