...
ax88190_media_init(struct dp8390_softc *sc)
{
 ...
 if (((&sc->sc_mii.mii_phys)->lh_first) == ((void *)0)) {
  ifmedia_add(&sc->sc_mii.mii_media, 0x0000000000000100ULL|2ULL, 0,
      ((void *)0));
 ...
 struct device *self;
{
 ...
 return (bus_space_read_1(sc->sc_asict, sc->sc_asich, 0x04));
}
void
...
{
 struct ne2000_softc *sc = (void *)self;
 bus_space_write_1(sc->sc_asict, sc->sc_asich, 0x04, val);
}
int
ax88190_mii_readreg(self, phy, reg64)
 struct device *self;
 int phy, reg64;
{
 return (mii_bitbang_readreg(self, &ax88190_mii_bitbang_ops, phy, reg64));
}
void
ax88190_mii_writereg(self, phy, reg64, val)
 struct device *self;
 int phy, reg64, val;
{
 mii_bitbang_writereg(self, &ax88190_mii_bitbang_ops, phy, reg64, val);
}
void
