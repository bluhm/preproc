# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c"
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 83 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cuereg.h" 1
# 143 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cuereg.h"
struct cue_type {
 u_int16_t cue_vid;
 u_int16_t cue_did;
};
...
struct cue_cdata {
 struct cue_chain cue_tx_chain[1];
 struct cue_chain cue_rx_chain[1];
 int cue_tx_prod;
 int cue_tx_cons;
 int cue_tx_cnt;
 int cue_rx_prod;
...
struct cue_softc {
 ...
 int cue_ed[0x3];
 struct usbd_pipe *cue_ep[0x3];
 u_int8_t cue_mctab[64];
 int cue_if_flags;
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c" 2
# 98 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c"
...
int
cue_csr_read_1(struct cue_softc *sc, int reg64)
{
...
int
cue_csr_read_2(struct cue_softc *sc, int reg64)
{
 usb_device_request_t req;
 usbd_status err;
 uWord val;
...
int
cue_csr_write_1(struct cue_softc *sc, int reg64, int val)
{
 usb_device_request_t req;
 usbd_status err;
 ...
 err = usbd_do_request(sc->cue_udev, &req, ((void *)0));
...
# 276 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c"
int
...
cue_getmac(struct cue_softc *sc, void *buf)
{
 ...
 ((req.wLength)[0] = (u_int8_t)(6), (req.wLength)[1] = (u_int8_t)((6) >> 8));
...
cue_setmulti(struct cue_softc *sc)
{
 ...
 if (ifp->if_flags & 0x2) {
  h = ether_crc32_le(etherbroadcastaddr, 6) &
      ((1 << 9) - 1);
  sc->cue_mctab[h >> 3] |= 1 << (h & 0x7);
 }
...
cue_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(cue_devs), sizeof (cue_devs) / sizeof ((cue_devs)[0]), sizeof ((cue_devs)[0]), (uaa->vendor), (uaa->product)) != ((void *)0) ?
     13 : 0);
}
...
cue_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 ((&sc->cue_tick_task)->fun = (cue_tick_task), (&sc->cue_tick_task)->arg = (sc), (&sc->cue_tick_task)->type = (0), (&sc->cue_tick_task)->state = 0x0);

 ((&sc->cue_stop_task)->fun = ((void (*)(void *))cue_stop), (&sc->cue_stop_task)->arg = (sc), (&sc->cue_stop_task)->type = (0), (&sc->cue_stop_task)->state = 0x0);
 ...
 for (i = 0; i < id->bNumEndpoints; i++) {
  ...
  if (((ed->bEndpointAddress) & 0x80) == 0x80 &&
   ...
   sc->cue_ed[0x0] = ed->bEndpointAddress;
  } else if (((ed->bEndpointAddress) & 0x80) == 0x00 &&
      ((ed->bmAttributes) & 0x03) == 0x02) {
   sc->cue_ed[0x1] = ed->bEndpointAddress;
  } else if (((ed->bEndpointAddress) & 0x80) == 0x80 &&
      ((ed->bmAttributes) & 0x03) == 0x03) {
   sc->cue_ed[0x2] = ed->bEndpointAddress;
  }
 }
# 492 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_cue.c"
 cue_getmac(sc, &eaddr);
 ...
 strlcpy(ifp->if_xname, sc->cue_dev.dv_xname, 16);
...
cue_detach(struct device *self, int flags)
{
 ...
 if (sc->cue_ep[0x1] != ((void *)0) ||
     sc->cue_ep[0x0] != ((void *)0) ||
     sc->cue_ep[0x2] != ((void *)0))
...
cue_rx_list_init(struct cue_softc *sc)
{
 ...
 for (i = 0; i < 1; i++) {
  ...
  c->cue_sc = sc;
  c->cue_idx = i;
  if (cue_newbuf(sc, c, ((void *)0)) == 55)
   return (55);
  if (c->cue_xfer == ((void *)0)) {
   c->cue_xfer = usbd_alloc_xfer(sc->cue_udev);
   if (c->cue_xfer == ((void *)0))
    return (55);
   c->cue_buf = usbd_alloc_buffer(c->cue_xfer, 1536);
   if (c->cue_buf == ((void *)0)) {
...
cue_rxeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (status != USBD_NORMAL_COMPLETION) {
  ...
  if (status == USBD_STALLED)
   usbd_clear_endpoint_stall_async(sc->cue_ep[0x0]);
  goto done;
 }

 usbd_get_xfer_status(xfer, ((void *)0), ((void *)0), &total_len, ((void *)0));

 __builtin_memcpy((((char *)((c->cue_mbuf)->m_hdr.mh_data))), (c->cue_buf), (total_len));

 m = c->cue_mbuf;
 len = ((((u_int8_t *)((m)->m_hdr.mh_data)))[0] | ((((u_int8_t *)((m)->m_hdr.mh_data)))[1] << 8));
 ...
 usbd_setup_xfer(c->cue_xfer, sc->cue_ep[0x0],
     c, c->cue_buf, 1536, 0x04 | 0x01,
     0, cue_rxeof);
...
cue_txeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (status != USBD_NORMAL_COMPLETION) {
  ...
  printf("%s: usb error on tx: %s\n", sc->cue_dev.dv_xname,
      usbd_errstr(status));
  if (status == USBD_STALLED)
   usbd_clear_endpoint_stall_async(sc->cue_ep[0x1]);
  _splx(s);
  return;
 }
...
cue_tick_task(void *xsc)
{
 ...
 ifp->if_data.ifi_collisions += cue_csr_read_2(sc, 0x69);
 ifp->if_data.ifi_collisions += cue_csr_read_2(sc, 0x6B);
 ifp->if_data.ifi_collisions += cue_csr_read_2(sc, 0x6D);

 if (cue_csr_read_2(sc, 0x6F))
  ifp->if_data.ifi_ierrors++;
}
...
cue_send(struct cue_softc *sc, struct mbuf *m, int idx)
{
 ...
 m_copydata(m, 0, m->M_dat.MH.MH_pkthdr.len, c->cue_buf + 2);
 c->cue_mbuf = m;
 ...
 c->cue_buf[0] = (u_int8_t)m->M_dat.MH.MH_pkthdr.len;
 c->cue_buf[1] = (u_int8_t)(m->M_dat.MH.MH_pkthdr.len >> 8);


 usbd_setup_xfer(c->cue_xfer, sc->cue_ep[0x1],
     c, c->cue_buf, total_len, 0x01, 10000, cue_txeof);
...
cue_init(void *xsc)
{
 ...
 cue_csr_write_1(sc, 0x22,
     0x08 | 0x03);

 eaddr = sc->arpcom.ac_enaddr;

 for (i = 0; i < 6; i++)
  cue_csr_write_1(sc, 0x67 - i, eaddr[i]);


 ctl = 0x01 | 0x08;
 if (ifp->if_flags & 0x100)
  ctl |= 0x10;
 cue_csr_write_1(sc, 0x60, ctl);


 if (cue_tx_list_init(sc) == 55) {
 ...
 cue_csr_write_1(sc, 0x24, 1);
 cue_csr_write_1(sc, 0x23, 1);
 ...
 cue_csr_write_1(sc, 0x81, 0x08);

 if (sc->cue_ep[0x0] == ((void *)0)) {
...
cue_open_pipes(struct cue_softc *sc)
{
 ...
 err = usbd_open_pipe(sc->cue_iface, sc->cue_ed[0x0],
     0x01, &sc->cue_ep[0x0]);
 if (err) {
 ...
 err = usbd_open_pipe(sc->cue_iface, sc->cue_ed[0x1],
     0x01, &sc->cue_ep[0x1]);
 if (err) {
...
cue_ioctl(struct ifnet *ifp, u_long command, caddr_t data)
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((16))):
  if (ifp->if_flags & 0x1) {
   if (ifp->if_flags & 0x40 &&
       ifp->if_flags & 0x100 &&
       !(sc->cue_if_flags & 0x100)) {
    cue_csr_write_1(sc, 0x60, cue_csr_read_1(sc, 0x60) | (0x10));
    cue_setmulti(sc);
...
cue_watchdog(struct ifnet *ifp)
{
 ...
 usbd_get_xfer_status(c->cue_xfer, ((void *)0), ((void *)0), ((void *)0), &stat);
...
cue_stop(struct cue_softc *sc)
{
 ...
 cue_csr_write_1(sc, 0x60, 0);
 cue_reset(sc);
 timeout_del(&sc->cue_stat_ch);


 if (sc->cue_ep[0x0] != ((void *)0)) {
  usbd_abort_pipe(sc->cue_ep[0x0]);
  err = usbd_close_pipe(sc->cue_ep[0x0]);
  if (err) {
 ...
 if (sc->cue_ep[0x1] != ((void *)0)) {
  usbd_abort_pipe(sc->cue_ep[0x1]);
  err = usbd_close_pipe(sc->cue_ep[0x1]);
  if (err) {
   printf("%s: close tx pipe failed: %s\n",
       sc->cue_dev.dv_xname, usbd_errstr(err));
  }
  sc->cue_ep[0x1] = ((void *)0);
 }

 if (sc->cue_ep[0x2] != ((void *)0)) {
  usbd_abort_pipe(sc->cue_ep[0x2]);
  err = usbd_close_pipe(sc->cue_ep[0x2]);
  if (err) {
 ...
 for (i = 0; i < 1; i++) {
  if (sc->cue_cdata.cue_rx_chain[i].cue_mbuf != ((void *)0)) {
   m_freem(sc->cue_cdata.cue_rx_chain[i].cue_mbuf);
   sc->cue_cdata.cue_rx_chain[i].cue_mbuf = ((void *)0);
  }
  if (sc->cue_cdata.cue_rx_chain[i].cue_xfer != ((void *)0)) {
   usbd_free_xfer(sc->cue_cdata.cue_rx_chain[i].cue_xfer);
   sc->cue_cdata.cue_rx_chain[i].cue_xfer = ((void *)0);
  }
 }


 for (i = 0; i < 1; i++) {
  if (sc->cue_cdata.cue_tx_chain[i].cue_mbuf != ((void *)0)) {
   m_freem(sc->cue_cdata.cue_tx_chain[i].cue_mbuf);
   sc->cue_cdata.cue_tx_chain[i].cue_mbuf = ((void *)0);
  }
  if (sc->cue_cdata.cue_tx_chain[i].cue_xfer != ((void *)0)) {
   usbd_free_xfer(sc->cue_cdata.cue_tx_chain[i].cue_xfer);
   sc->cue_cdata.cue_tx_chain[i].cue_xfer = ((void *)0);
  }
 }
}
