# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c" 2
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c"
_Bool radeon_read_platform_bios(struct radeon_device *);

_Bool
radeon_read_platform_bios(struct radeon_device *rdev)
{
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c"
 return 0;
}
...
static _Bool igp_read_bios_from_vram(struct radeon_device *rdev)
{
 uint8_t *bios;
 ...
 if (bus_space_map(bst, rdev->fb_aper_offset, size, 0x0002, &bsh) != 0)
  return 0;
 ...
 rdev->bios = kmalloc(size, (0x0001 | 0x0004));
 if (rdev->bios == ((void *)0)) {
  bus_space_unmap(bst, bsh, size);
  return 0;
 }
 __builtin_memcpy((rdev->bios), (bios), (size));
 bus_space_unmap(bst, bsh, size);
 return 1;
}

static _Bool radeon_read_bios(struct radeon_device *rdev)
{
 uint8_t *bios;
 bus_size_t size;
 ...
 address = pci_conf_read(rdev->pc, rdev->pa_tag, 0x30);
 pci_conf_write(rdev->pc, rdev->pa_tag, 0x30, ~0x00000001);
 mask = pci_conf_read(rdev->pc, rdev->pa_tag, 0x30);
 address |= 0x00000001;
 pci_conf_write(rdev->pc, rdev->pa_tag, 0x30, address);

 size = (((mask) & 0xfffff800) & -((mask) & 0xfffff800));
 if (size == 0)
  return 0;
 rc = bus_space_map(rdev->memt, ((address) & 0xfffff800), size,
     0x0002, &romh);
 if (rc != 0) {
...
# 295 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c"
static inline _Bool radeon_atrm_get_bios(struct radeon_device *rdev)
{
 return 0;
}


static _Bool ni_read_disabled_bios(struct radeon_device *rdev)
{
 u32 bus_cntl;
 u32 d1vga_control;
 u32 d2vga_control;
 ...
 bus_cntl = r100_mm_rreg(rdev, (0x5420), 0);
 d1vga_control = r100_mm_rreg(rdev, (0x0330), 0);
 d2vga_control = r100_mm_rreg(rdev, (0x0338), 0);
 vga_render_control = r100_mm_rreg(rdev, (0x0300), 0);
 rom_cntl = r100_mm_rreg(rdev, (0x1600), 0);


 r100_mm_wreg(rdev, (0x5420), ((bus_cntl & ~(1 << 1))), 0);

 r100_mm_wreg(rdev, (0x0330), ((d1vga_control & ~((1<<0) | (1<<8)))), 0);


 r100_mm_wreg(rdev, (0x0338), ((d2vga_control & ~((1<<0) | (1<<8)))), 0);


 r100_mm_wreg(rdev, (0x0300), ((vga_render_control & ~(3 << 16))), 0);

 r100_mm_wreg(rdev, (0x1600), (rom_cntl | (1 << 1)), 0);

 r = radeon_read_bios(rdev);


 r100_mm_wreg(rdev, (0x5420), (bus_cntl), 0);
 r100_mm_wreg(rdev, (0x0330), (d1vga_control), 0);
 r100_mm_wreg(rdev, (0x0338), (d2vga_control), 0);
 r100_mm_wreg(rdev, (0x0300), (vga_render_control), 0);
 r100_mm_wreg(rdev, (0x1600), (rom_cntl), 0);
 return r;
}

static _Bool r700_read_disabled_bios(struct radeon_device *rdev)
{
 ...
 viph_control = r100_mm_rreg(rdev, (0x0c40), 0);
 bus_cntl = r100_mm_rreg(rdev, (0x5420), 0);
 d1vga_control = r100_mm_rreg(rdev, (0x0330), 0);
 d2vga_control = r100_mm_rreg(rdev, (0x0338), 0);
 vga_render_control = r100_mm_rreg(rdev, (0x0300), 0);
 ...
 r100_mm_wreg(rdev, (0x0c40), ((viph_control & ~(1 << 21))), 0);
 ...
 if (rdev->family == CHIP_RV730) {
  cg_spll_func_cntl = r100_mm_rreg(rdev, (0x600), 0);


  r100_mm_wreg(rdev, (0x600), ((cg_spll_func_cntl | (1 << 3))), 0);



  cg_spll_status = 0;
  while (!(cg_spll_status & (1 << 1)))
   cg_spll_status = r100_mm_rreg(rdev, (0x60c), 0);
 ...
 if (rdev->family == CHIP_RV730) {
  r100_mm_wreg(rdev, (0x600), (cg_spll_func_cntl), 0);
 ...
 r100_mm_wreg(rdev, (0x0c40), (viph_control), 0);
 r100_mm_wreg(rdev, (0x5420), (bus_cntl), 0);
 r100_mm_wreg(rdev, (0x0330), (d1vga_control), 0);
 r100_mm_wreg(rdev, (0x0338), (d2vga_control), 0);
 r100_mm_wreg(rdev, (0x0300), (vga_render_control), 0);
...
static _Bool r600_read_disabled_bios(struct radeon_device *rdev)
{
 uint32_t viph_control;
 uint32_t bus_cntl;
 uint32_t d1vga_control;
 ...
 vga_render_control = r100_mm_rreg(rdev, (0x0300), 0);
 rom_cntl = r100_mm_rreg(rdev, (0x1600), 0);
 general_pwrmgt = r100_mm_rreg(rdev, (0x618), 0);
 low_vid_lower_gpio_cntl = r100_mm_rreg(rdev, (0x724), 0);
 medium_vid_lower_gpio_cntl = r100_mm_rreg(rdev, (0x720), 0);
 high_vid_lower_gpio_cntl = r100_mm_rreg(rdev, (0x71c), 0);
 ctxsw_vid_lower_gpio_cntl = r100_mm_rreg(rdev, (0x718), 0);
 lower_gpio_enable = r100_mm_rreg(rdev, (0x710), 0);
 ...
 r100_mm_wreg(rdev, (0x1600), (((rom_cntl & ~(0xf << 28)) | (1 << 28) | (1 << 1))), 0);




 r100_mm_wreg(rdev, (0x618), ((general_pwrmgt & ~(1 << 11))), 0);
 r100_mm_wreg(rdev, (0x724), ((low_vid_lower_gpio_cntl & ~0x400)), 0);

 r100_mm_wreg(rdev, (0x720), ((medium_vid_lower_gpio_cntl & ~0x400)), 0);

 r100_mm_wreg(rdev, (0x71c), ((high_vid_lower_gpio_cntl & ~0x400)), 0);

 r100_mm_wreg(rdev, (0x718), ((ctxsw_vid_lower_gpio_cntl & ~0x400)), 0);

 r100_mm_wreg(rdev, (0x710), ((lower_gpio_enable | 0x400)), 0);
 ...
 r100_mm_wreg(rdev, (0x0300), (vga_render_control), 0);
 r100_mm_wreg(rdev, (0x1600), (rom_cntl), 0);
 r100_mm_wreg(rdev, (0x618), (general_pwrmgt), 0);
 r100_mm_wreg(rdev, (0x724), (low_vid_lower_gpio_cntl), 0);
 r100_mm_wreg(rdev, (0x720), (medium_vid_lower_gpio_cntl), 0);
 r100_mm_wreg(rdev, (0x71c), (high_vid_lower_gpio_cntl), 0);
 r100_mm_wreg(rdev, (0x718), (ctxsw_vid_lower_gpio_cntl), 0);
 r100_mm_wreg(rdev, (0x710), (lower_gpio_enable), 0);
 return r;
}

static _Bool avivo_read_disabled_bios(struct radeon_device *rdev)
{
 ...
 seprom_cntl1 = r100_mm_rreg(rdev, (0x01c0), 0);
 viph_control = r100_mm_rreg(rdev, (0x0c40), 0);
 bus_cntl = r100_mm_rreg(rdev, (0x004c), 0);
 d1vga_control = r100_mm_rreg(rdev, (0x0330), 0);
 d2vga_control = r100_mm_rreg(rdev, (0x0338), 0);
 vga_render_control = r100_mm_rreg(rdev, (0x0300), 0);
 gpiopad_a = r100_mm_rreg(rdev, (0x019c), 0);
 gpiopad_en = r100_mm_rreg(rdev, (0x01a0), 0);
 gpiopad_mask = r100_mm_rreg(rdev, (0x0198), 0);

 r100_mm_wreg(rdev, (0x01c0), (((seprom_cntl1 & ~(0xff << 24)) | (0xc << 24))), 0);


 r100_mm_wreg(rdev, (0x019c), (0), 0);
 r100_mm_wreg(rdev, (0x01a0), (0), 0);
 r100_mm_wreg(rdev, (0x0198), (0), 0);


 r100_mm_wreg(rdev, (0x0c40), ((viph_control & ~(1 << 21))), 0);


 r100_mm_wreg(rdev, (0x004c), ((bus_cntl & ~(1 << 2))), 0);
 ...
 r100_mm_wreg(rdev, (0x01c0), (seprom_cntl1), 0);
 r100_mm_wreg(rdev, (0x0c40), (viph_control), 0);
 r100_mm_wreg(rdev, (0x004c), (bus_cntl), 0);
 r100_mm_wreg(rdev, (0x0330), (d1vga_control), 0);
 r100_mm_wreg(rdev, (0x0338), (d2vga_control), 0);
 r100_mm_wreg(rdev, (0x0300), (vga_render_control), 0);
 r100_mm_wreg(rdev, (0x019c), (gpiopad_a), 0);
 r100_mm_wreg(rdev, (0x01a0), (gpiopad_en), 0);
 r100_mm_wreg(rdev, (0x0198), (gpiopad_mask), 0);
 return r;
}

static _Bool legacy_read_disabled_bios(struct radeon_device *rdev)
{
 uint32_t seprom_cntl1;
 uint32_t viph_control;
 uint32_t bus_cntl;
 ...
 if (rdev->flags & RADEON_IS_PCIE)
  ...
  bus_cntl = r100_mm_rreg(rdev, (0x0030), 0);
 crtc_gen_cntl = r100_mm_rreg(rdev, (0x0050), 0);
 crtc2_gen_cntl = 0;
 ...
 if (rdev->flags & RADEON_IS_PCIE)
  ...
  r100_mm_wreg(rdev, (0x0030), ((bus_cntl & ~(1 << 12))), 0);


 r100_mm_wreg(rdev, (0x0050), (((crtc_gen_cntl & ~(1 << 25)) | ((1 << 26) | (1 << 24)))), 0);



 if (!(rdev->flags & RADEON_SINGLE_CRTC)) {
  r100_mm_wreg(rdev, (0x03f8), (((crtc2_gen_cntl & ~(1 << 25)) | (1 << 26))), 0);


 }

 r100_mm_wreg(rdev, (0x0054), (((crtc_ext_cntl & ~(1 << 15)) | ((1 << 11) | (1 << 10)))), 0);




 if (rdev->ddev->pci_device == 0x5159) {
  r100_mm_wreg(rdev, (0x0288), ((fp2_gen_cntl & ~(1 << 2))), 0);
 }
 ...
 if (rdev->flags & RADEON_IS_PCIE)
  ...
  r100_mm_wreg(rdev, (0x0030), (bus_cntl), 0);
...
static _Bool radeon_read_disabled_bios(struct radeon_device *rdev)
{
 if (rdev->flags & RADEON_IS_IGP)
...
# 704 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_bios.c"
static inline _Bool radeon_acpi_vfct_bios(struct radeon_device *rdev)
{
 return 0;
}
...
_Bool radeon_get_bios(struct radeon_device *rdev)
{
 ...
 if (r == 0 || rdev->bios == ((void *)0)) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unable to locate a BIOS ROM\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  rdev->bios = ((void *)0);
  return 0;
 }
 ...
 tmp = ((rdev->bios[0x18]) | ((rdev->bios[(0x18)+1]) << 8));
 if ((rdev->bios[tmp + 0x14]) != 0x0) {
  do { } while( 0);
  goto free_bios;
 }

 rdev->bios_header_start = ((rdev->bios[0x48]) | ((rdev->bios[(0x48)+1]) << 8));
 if (!rdev->bios_header_start) {
  goto free_bios;
 }
 tmp = rdev->bios_header_start + 4;
 if (!__builtin_memcmp((rdev->bios + tmp), ("ATOM"), (4)) ||
     !__builtin_memcmp((rdev->bios + tmp), ("MOTA"), (4))) {
  rdev->is_atom_bios = 1;
 } else {
  rdev->is_atom_bios = 0;
 }
