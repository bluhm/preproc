# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c" 2
...
umass_scsi_attach(struct umass_softc *sc)
{
 ...
 scbus = malloc(sizeof(*scbus), 2, 0x0001 | 0x0008);
 ...
 scbus->sc_link.adapter_target = 0x00;
 scbus->sc_link.openings = 1;
 scbus->sc_link.quirks = 0x4000 | sc->sc_busquirks;
 scbus->sc_link.pool = &scbus->sc_iopool;
 scbus->sc_link.luns = sc->maxlun + 1;
 scbus->sc_link.flags = 0x0800;
 ...
 sc->sc_refcnt++;
 scbus->sc_child = config_found_sm(((struct device *)sc), (&saa), (scsiprint), ((void *)0));
 if (--sc->sc_refcnt < 0)
...
umass_scsi_detach(struct umass_softc *sc, int flags)
{
 ...
 if (scbus != ((void *)0)) {
  if (scbus->sc_child != ((void *)0))
   rv = config_detach(scbus->sc_child, flags);
  free(scbus, 2, sizeof(*scbus));
  sc->bus = ((void *)0);
 }
...
# 216 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c"
 cmd = xs->cmd;
 cmdlen = xs->cmdlen;
...
umass_scsi_cb(struct umass_softc *sc, void *priv, int residue, int status)
{
 ...
 int cmdlen;
# 292 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_scsi.c"
 ;
 ...
 case 2:
  ...
  sc->sc_sense = 1;
  __builtin_memset((&scbus->sc_sense_cmd), (0), (sizeof(scbus->sc_sense_cmd)));
  scbus->sc_sense_cmd.opcode = 0x03;
  scbus->sc_sense_cmd.byte2 = link->lun << 5;
 ...
 if ((xs->flags & 0x00002) && (xs->error == 0)) {
