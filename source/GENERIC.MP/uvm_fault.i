# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/mman.h" 1
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c" 2
# 145 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
struct uvm_advice {
 int nback;
 int nforw;
};
...
static struct uvm_advice uvmadvice[0x7 + 1];
...
# 173 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
static __inline void
...
uvmfault_init(void)
{
 ...
 npages = ((16384) >> 13);
 if (npages > 0) {
  ((npages <= 16 / 2) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c", 207, "npages <= UVM_MAXRANGE / 2"));
  uvmadvice[0].nforw = npages;
  uvmadvice[0].nback = npages - 1;
 }

 npages = ((32768) >> 13);
 if (npages > 0) {
  ((npages <= 16 / 2) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c", 214, "npages <= UVM_MAXRANGE / 2"));
  uvmadvice[2].nforw = npages - 1;
  uvmadvice[2].nback = npages;
 }
}
...
# 262 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
int
    ...
    struct vm_anon *anon)
{
 ...
 if (anon->an_page)
  (__curcpu->ci_self)->ci_curproc->p_ru.ru_minflt++;
 else
  (__curcpu->ci_self)->ci_curproc->p_ru.ru_majflt++;
 ...
 while (1) {
  ...
  if (pg) {
   ...
   uvmfault_unlockall(ufi, amap, ((void *)0), ((void *)0));
   do { tsleep(pg, 4|(0 ? 0x100 : 0), "anonget2", 0); } while (0);

  } else {

   pg = uvm_pagealloc(((void *)0), 0, anon, 0);

   if (pg == ((void *)0)) {
    uvmfault_unlockall(ufi, amap, ((void *)0), anon);
    uvmexp.fltnoram++;
    uvm_wait("flt_noram1");
    ...
    we_own = 1;
    uvmfault_unlockall(ufi, amap, ((void *)0), anon);
# 326 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
    uvmexp.pageins++;
...
# 351 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
  if (we_own) {
   ...
   atomic_clearbits_int(&pg->pg_flags,
       0x00000002|0x00000001|0x00000040);
   ;
...
uvmfault_update_stats(struct uvm_faultinfo *ufi)
{
 ...
 map = ufi->orig_map;
# 456 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
 if (0)
  return;
...
# 489 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
int
    ...
    vm_prot_t access_type)
{
 ...
 struct vm_anon *anons_store[16], **anons, *anon, *oanon;
 struct vm_page *pages[16], *pg, *uobjpage;
...
ReFault:
 ...
 if (uvmfault_lookup(&ufi, 0) == 0) {
  return (14);
 }


 if ((ufi.map->flags & 0x01) == 0)
...
# 546 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
 enter_prot = ufi.entry->protection;
 wired = ((ufi.entry)->wired_count != 0) || (fault_type == ((vm_fault_t) 0x2));
 if (wired)
  access_type = enter_prot;


 if ((((ufi.entry)->etype & 0x08) != 0)) {
  if ((access_type & 0x02) ||
      (ufi.entry->object.uvm_obj == ((void *)0))) {
 ...
 if (narrow == 0) {
  ...
  nback = min(uvmadvice[ufi.entry->advice].nback,
       (ufi.orig_rvaddr - ufi.entry->start) >> 13);
  startva = ufi.orig_rvaddr - ((vsize_t)nback << 13);
 ...
 if (ufi.entry->advice == 2 && nback != 0) {
  ...
  if (uobj) {
   ...
   (void) uobj->pgops->pgo_flush(uobj, uoff, uoff +
       ((vsize_t)nback << 13), 0x004);
  }


  if (amap)
   anons += nback;
  startva += ((vsize_t)nback << 13);
  npages -= nback;
  centeridx = 0;
 }
 ...
 currva = startva;
 shadowed = 0;
 for (lcv = 0 ; lcv < npages ; lcv++, currva += (1 << 13)) {
  ...
  if (amap == ((void *)0) || anons[lcv] == ((void *)0)) {
   pages[lcv] = ((void *)0);
   continue;
  }
  ...
  if (anon->an_page &&
   ...
   (void) pmap_enter(ufi.orig_map->pmap, currva,
       ...
       (anon->an_ref > 1) ? (enter_prot & ~0x02) :
       enter_prot,
       0x00000020 |
        (((ufi.entry)->wired_count != 0) ? 0x00000010 : 0));
  }
 }
 if (npages > 1)
  ;
# 715 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
 if (uobj && shadowed == 0 && uobj->pgops->pgo_fault != ((void *)0)) {
...
# 737 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
 if (uobj && shadowed == 0) {
  uvmexp.fltlget++;
  gotpages = npages;
  (void) uobj->pgops->pgo_get(uobj, ufi.entry->offset +
    ...
    access_type & ((((ufi.entry)->etype & 0x04) != 0) ? ~0x02 : (0x01 | 0x02 | 0x04)),
    ufi.entry->advice, 0x040);
...
# 765 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
    if (lcv == centeridx) {
     uobjpage = pages[lcv];
     continue;
    }
# 779 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
    __mtx_enter(&uvm.pageqlock);
    ...
    (void) pmap_enter(ufi.orig_map->pmap, currva,
        ((pages[lcv])->phys_addr),
        enter_prot & ((((ufi.entry)->etype & 0x04) != 0) ? ~0x02 : (0x01 | 0x02 | 0x04)),
        0x00000020 |
         (wired ? 0x00000010 : 0));
...
# 826 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
 if (shadowed == 0)
  goto Case2;


 anon = anons[centeridx];
# 840 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
...
# 876 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
 if ((access_type & 0x02) != 0 && anon->an_ref > 1) {
  uvmexp.flt_acow++;
  oanon = anon;
  anon = uvm_analloc();
  if (anon) {
  ...
  atomic_clearbits_int(&pg->pg_flags, 0x00000001|0x00000040);
  ;
 ...
 if (pmap_enter(ufi.orig_map->pmap, ufi.orig_rvaddr, ((pg)->phys_addr),
...
# 1009 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
 if (uobjpage) {
 ...
 if (promote == 0) {
# 1090 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
  uvmexp.flt_obj++;
  if ((((ufi.entry)->etype & 0x04) != 0))
   enter_prot &= ~0x02;
  pg = uobjpage;
  ...
  if (anon) {
   ...
   pg = uvm_pagealloc(((void *)0), 0, anon,
       (uobjpage == ((struct vm_page *) -1L)) ? 0x0002 : 0);
  }
  ...
  if (uobjpage != ((struct vm_page *) -1L)) {
   ...
   if ((((amap)->am_flags) & 0x1) != 0) {
    pmap_page_protect(uobjpage, 0x00);
   }
 ...
 if (fault_type == ((vm_fault_t) 0x2)) {
  ...
  if (pg->pg_flags & 0x00200000) {
   ...
   atomic_clearbits_int(&pg->pg_flags, 0x00000008);
   uao_dropswap(uobj, pg->offset >> 13);
  }
 } else {
...
# 1279 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
int
uvm_fault_wire(vm_map_t map, vaddr_t start, vaddr_t end, vm_prot_t access_type)
{
 ...
 for (va = start ; va < end ; va += (1 << 13)) {
  rv = uvm_fault(map, va, ((vm_fault_t) 0x2), access_type);
  if (rv) {
   if (va != start) {
...
# 1418 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_fault.c"
boolean_t
