# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c" 2
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pcf8584.c"
struct cfdriver pcfiic_cd = {
 ((void *)0), "pcfiic", DV_DULL
};
...
pcfiic_init(struct pcfiic_softc *sc)
{
 ...
 pcfiic_write(sc, 0x01, (1<<7));

 pcfiic_write(sc, 0x00, sc->sc_addr);


 pcfiic_write(sc, 0x01, (1<<7)|(1<<5));
 pcfiic_write(sc, 0x00, sc->sc_clock);

 pcfiic_write(sc, 0x01, ((1<<7) | (1<<6) | (1<<0)));
    ...
    void *scan_arg)
{
 ...
 if (swapregs) {
  sc->sc_regmap[0x01] = 0x00;
  sc->sc_regmap[0x00] = 0x01;
 } else {
  sc->sc_regmap[0x00] = 0x00;
  sc->sc_regmap[0x01] = 0x01;
 }
 sc->sc_clock = clock;
 sc->sc_addr = addr;
 ...
 _rw_init_flags(&sc->sc_lock, "iiclk", 0, ((void *)0));
 ...
 __builtin_bzero((&iba), (sizeof(iba)));
 iba.iba_name = "iic";
 iba.iba_tag = &sc->sc_i2c;
 iba.iba_bus_scan = scan_func;
 iba.iba_bus_scan_arg = scan_arg;
 config_found_sm((&sc->sc_dev), (&iba), (iicbus_print), ((void *)0));
}
...
pcfiic_i2c_acquire_bus(void *arg, int flags)
{
 ...
 if (cold || sc->sc_poll || (flags & 0x08))
  return (0);

 return (_rw_enter(&sc->sc_lock, 0x0001UL | 0x0010UL ));
}
    ...
    size_t len)
{
 ...
 pcfiic_write(sc, 0x00, addr << 1);
 pcfiic_write(sc, 0x01, ((1<<7) | (1<<6) | (1<<2) | (1<<0)));

 for (i = 0; i <= len; i++) {
  if (pcfiic_wait_pin(sc, &r) != 0) {
   pcfiic_write(sc, 0x01, ((1<<7) | (1<<6) | (1<<1) | (1<<0)));
   return (1);
  }
...
pcfiic_recv(struct pcfiic_softc *sc, u_int8_t addr, u_int8_t *buf, size_t len)
{
 ...
 pcfiic_write(sc, 0x00, (addr << 1) | 0x01);
 pcfiic_write(sc, 0x01, ((1<<7) | (1<<6) | (1<<2) | (1<<0)));
 ...
 for (i = 0; i <= len; i++) {
  ...
  if (i == len - 1) {
   pcfiic_write(sc, 0x01, (1<<6));
  } else if (i == len) {
   pcfiic_write(sc, 0x01, ((1<<7) | (1<<6) | (1<<1) | (1<<0)));
  }

  r = pcfiic_read(sc, 0x00);
  if (i > 0)
   buf[i - 1] = r;
 }
 return (err);
...
pcfiic_write(struct pcfiic_softc *sc, bus_size_t r, u_int8_t v)
{
 ...
 bus_space_barrier(sc->sc_iot, sc->sc_ioh, 0, 4,
     0x02 | 0x01);
 bus_space_read_1(sc->sc_iot, sc->sc_ioh, sc->sc_regmap[0x01]);
}
