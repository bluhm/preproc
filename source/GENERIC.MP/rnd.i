# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c"
# 112 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c"
...
# 113 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 114 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 115 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 116 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 119 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 120 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 121 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 122 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 124 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 125 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 126 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 127 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 129 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/chacha_private.h" 1
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/chacha_private.h"
...
{
  x->input[12] = counter == ((void *)0) ? 0 : (((u32)((counter + 0)[0]) ) | ((u32)((counter + 0)[1]) << 8) | ((u32)((counter + 0)[2]) << 16) | ((u32)((counter + 0)[3]) << 24));
  x->input[13] = counter == ((void *)0) ? 0 : (((u32)((counter + 4)[0]) ) | ((u32)((counter + 4)[1]) << 8) | ((u32)((counter + 4)[2]) << 16) | ((u32)((counter + 4)[3]) << 24));
...
# 183 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/chacha_private.h"
...
# 132 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 134 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
# 136 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 137 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c" 2
# 200 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c"
struct mutex entropylock = { ((void *)0), ((((15)) > 0 && ((15)) < 12) ? 12 : ((15))), 0 };
# 218 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c"
struct rand_event {
 u_int re_time;
 u_int re_val;
...
void extract_entropy(u_int8_t *)
    __attribute__((__bounded__(__minbytes__,1,32 + 8)));
...
# 287 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c"
void
...
# 330 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c"
void
add_entropy_words(const u_int32_t *buf, u_int n)
{
 ...
 for (; n--; buf++) {
  ...
  w ^= entropy_pool[(i + 1638) & (2048 - 1)] ^
       entropy_pool[(i + 1231) & (2048 - 1)] ^
       entropy_pool[(i + 819) & (2048 - 1)] ^
       entropy_pool[(i + 411) & (2048 - 1)] ^
       entropy_pool[(i + 1) & (2048 - 1)] ^
       entropy_pool[i];
...
{
 static u_int32_t extract_pool[2048];
 u_char digest[64];
 SHA2_CTX shactx;
# 414 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c"
 __builtin_memcpy((extract_pool), (entropy_pool), (sizeof(extract_pool)));
...
struct mutex rndlock = { ((void *)0), ((((15)) > 0 && ((15)) < 12) ? 12 : ((15))), 0 };
...
_rs_seed(u_char *buf, size_t n)
{
 ...
 rs_have = 0;
 __builtin_memset((rs_buf), (0), ((16*64)));
...
_rs_stir_if_needed(size_t len)
{
 ...
 if (!rs_initialized) {
  __builtin_memcpy((entropy_pool), (entropy_pool0), (sizeof entropy_pool));
  __builtin_memcpy((rs_buf), (rs_buf0), (sizeof rs_buf));
...
_rs_clearseed(const void *p, size_t s)
{
 ...
 while (s > 0) {
  ...
  __builtin_memset((&kd_avoidalias), (0), (sizeof kd_avoidalias));
  kd_avoidalias.kd_prefer = pa;
  kd_avoidalias.kd_waitok = 1;
  rwva = (vaddr_t)km_alloc((1 << 13), &kv_any, &kp_none,
      &kd_avoidalias);
  if (!rwva)
   panic("_rs_clearseed");

  pmap_kenter_pa(rwva, pa, 0x01 | 0x02);
  ;

  len = (((s)<((1 << 13) - off))?(s):((1 << 13) - off));
  explicit_bzero((void *)(rwva + off), len);

  pmap_kremove(rwva, (1 << 13));
  km_free((void *)rwva, (1 << 13), &kv_any, &kp_none);
...
_rs_rekey(u_char *dat, size_t datlen)
{
 ...
 _rs_init(rs_buf, 32 + 8);
 __builtin_memset((rs_buf), (0), (32 + 8));
 rs_have = (16*64) - 32 - 8;
}
...
_rs_random_buf(void *_buf, size_t n)
{
 ...
 while (n > 0) {
  if (rs_have > 0) {
   ...
   __builtin_memcpy((buf), (rs_buf + (16*64) - rs_have), (m));
   __builtin_memset((rs_buf + (16*64) - rs_have), (0), (m));
   buf += m;
   n -= m;
   rs_have -= m;
  }
...
_rs_random_u32(u_int32_t *val)
{
 ...
 if (rs_have < sizeof(*val))
  _rs_rekey(((void *)0), 0);
 __builtin_memcpy((val), (rs_buf + (16*64) - rs_have), (sizeof(*val)));
 __builtin_memset((rs_buf + (16*64) - rs_have), (0), (sizeof(*val)));
 rs_have -= sizeof(*val);
}
...
# 669 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c"
u_int32_t
...
random_start(void)
{
 ...
 arc4_reinit(((void *)0));
 timeout_set(&rnd_timeout, dequeue_randomness, ((void *)0));
}
...
# 761 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rnd.c"
int
randomread(dev_t dev, struct uio *uio, int ioflag)
{
 ...
 buf = malloc((2048*4), 127, 0x0001);
 if (total > 2048) {
  arc4random_buf(lbuf, sizeof(lbuf));
  chacha_keysetup(&lctx, lbuf, 32 * 8);
  chacha_ivsetup(&lctx, lbuf + 32, ((void *)0));
  explicit_bzero(lbuf, sizeof(lbuf));
  myctx = 1;
 }

 while (ret == 0 && uio->uio_resid > 0) {
  size_t n = ulmin((2048*4), uio->uio_resid);
...
{
 struct sys_getentropy_args *uap = v;
 ...
 if (((uap)->nbyte.be.datum) > sizeof(buf))
  return (5);
 arc4random_buf(buf, ((uap)->nbyte.be.datum));
 if ((error = copyout(buf, ((uap)->buf.be.datum), ((uap)->nbyte.be.datum))) != 0)
  return (error);
 explicit_bzero(buf, sizeof(buf));
 retval[0] = 0;
 return (0);
