        ...
        unsigned long pages)
{
 ...
 while (__builtin_expect(!!(iter), 1)) {
  node = ({ const __typeof( ((struct drm_vma_offset_node *)0)->vm_rb ) *__mptr = (iter); (struct drm_vma_offset_node *)( (char *)__mptr - __builtin_offsetof(struct drm_vma_offset_node, vm_rb) );});
       ...
       struct drm_vma_offset_node *node)
{
 ...
 while (__builtin_expect(!!(*iter), 1)) {
  parent = *iter;
  iter_node = ({ const __typeof( ((struct drm_vma_offset_node *)0)->vm_rb ) *__mptr = (*iter); (struct drm_vma_offset_node *)( (char *)__mptr - __builtin_offsetof(struct drm_vma_offset_node, vm_rb) );});
...
int drm_vma_node_allow(struct drm_vma_offset_node *node, struct file *filp)
{
 ...
 while (__builtin_expect(!!(*iter), 1)) {
  parent = *iter;
  entry = ({ const __typeof( ((struct drm_vma_offset_file *)0)->vm_rb ) *__mptr = (*iter); (struct drm_vma_offset_file *)( (char *)__mptr - __builtin_offsetof(struct drm_vma_offset_file, vm_rb) );});
