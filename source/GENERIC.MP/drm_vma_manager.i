# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c" 2
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
void drm_vma_offset_manager_init(struct drm_vma_offset_manager *mgr,
     unsigned long page_offset, unsigned long size)
{
 _rw_init_flags(&mgr->vm_lock, "drmvmo", 0, ((void *)0));
 mgr->vm_addr_space_rb = (struct rb_root) { ((void *)0) };
 drm_mm_init(&mgr->vm_addr_space_mm, page_offset, size);
}
;
# 100 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
void drm_vma_offset_manager_destroy(struct drm_vma_offset_manager *mgr)
{

 _rw_enter_write(&mgr->vm_lock );
 drm_mm_takedown(&mgr->vm_addr_space_mm);
 _rw_exit_write(&mgr->vm_lock );
}
;
# 125 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
struct drm_vma_offset_node *drm_vma_offset_lookup(struct drm_vma_offset_manager *mgr,
        unsigned long start,
        unsigned long pages)
{
...
;
# 152 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
struct drm_vma_offset_node *drm_vma_offset_lookup_locked(struct drm_vma_offset_manager *mgr,
        unsigned long start,
        unsigned long pages)
{
 ...
 while (__builtin_expect(!!(iter), 1)) {
  node = ({ __typeof( ((struct drm_vma_offset_node *)0)->vm_rb ) *__mptr = (iter); (struct drm_vma_offset_node *)( (char *)__mptr - __builtin_offsetof(struct drm_vma_offset_node, vm_rb) );});
  offset = node->vm_node.start;
  if (start >= offset) {
   iter = iter->__entry.rbe_right;
   best = node;
   if (start == offset)
    break;
  } else {
   iter = iter->__entry.rbe_left;
  }
 }
       ...
       struct drm_vma_offset_node *node)
{
 ...
 while (__builtin_expect(!!(*iter), 1)) {
  parent = *iter;
  iter_node = ({ __typeof( ((struct drm_vma_offset_node *)0)->vm_rb ) *__mptr = (*iter); (struct drm_vma_offset_node *)( (char *)__mptr - __builtin_offsetof(struct drm_vma_offset_node, vm_rb) );});
  ...
  if (node->vm_node.start < iter_node->vm_node.start)
   ...
   do { panic("BUG at %s:%d", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c", 204); } while (0);
 }

 rb_link_node(&node->vm_rb, parent, iter);
 linux_root_RB_INSERT_COLOR((struct linux_root *)(&mgr->vm_addr_space_rb), (&node->vm_rb));
}
# 234 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
int drm_vma_offset_add(struct drm_vma_offset_manager *mgr,
         struct drm_vma_offset_node *node, unsigned long pages)
{
 int ret;
...
;
# 270 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
void drm_vma_offset_remove(struct drm_vma_offset_manager *mgr,
      struct drm_vma_offset_node *node)
{
 _rw_enter_write(&mgr->vm_lock );
 ...
 if (drm_mm_node_allocated(&node->vm_node)) {
  linux_root_RB_REMOVE((struct linux_root *)(&mgr->vm_addr_space_rb), (&node->vm_rb));
  drm_mm_remove_node(&node->vm_node);
  __builtin_memset((&node->vm_node), (0), (sizeof(node->vm_node)));
 }

 _rw_exit_write(&mgr->vm_lock );
}
;
# 305 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
int drm_vma_node_allow(struct drm_vma_offset_node *node, struct file *filp)
{
 struct rb_node **iter;
 struct rb_node *parent = ((void *)0);
 ...
 new = kmalloc(sizeof(*entry), (0x0001 | 0x0004));

 _rw_enter_write(&node->vm_lock );

 iter = &node->vm_files.rb_node;

 while (__builtin_expect(!!(*iter), 1)) {
  parent = *iter;
  entry = ({ __typeof( ((struct drm_vma_offset_file *)0)->vm_rb ) *__mptr = (*iter); (struct drm_vma_offset_file *)( (char *)__mptr - __builtin_offsetof(struct drm_vma_offset_file, vm_rb) );});
 ...
 linux_root_RB_INSERT_COLOR((struct linux_root *)(&node->vm_files), (&new->vm_rb));
 new = ((void *)0);

unlock:
 _rw_exit_write(&node->vm_lock );
 kfree(new);
 return ret;
}
;
# 367 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
void drm_vma_node_revoke(struct drm_vma_offset_node *node, struct file *filp)
{
 ...
 while (__builtin_expect(!!(iter), 1)) {
  ...
  if (filp == entry->vm_filp) {
   if (!--entry->vm_count) {
    linux_root_RB_REMOVE((struct linux_root *)(&node->vm_files), (&entry->vm_rb));
    kfree(entry);
   }
   break;
  } else if (filp > entry->vm_filp) {
...
;
# 407 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.c"
_Bool drm_vma_node_is_allowed(struct drm_vma_offset_node *node,
        struct file *filp)
{
 struct drm_vma_offset_file *entry;
