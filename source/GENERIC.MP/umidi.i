# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c"
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c" 2
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c"
    ...
    void *arg)
{
 ...
 mididev->opened = 1;
 mididev->flags = flags;
 if ((mididev->flags & 0x0002) && mididev->out_jack)
  open_out_jack(mididev->out_jack, arg, ointr);
 if ((mididev->flags & 0x0001) && mididev->in_jack)
...
alloc_pipe(struct umidi_endpoint *ep)
{
 ...
 ;
 do { (&ep->intrq)->sqh_first = ((void *)0); (&ep->intrq)->sqh_last = &(&ep->intrq)->sqh_first; } while (0);
 ep->pending = 0;
 ep->busy = 0;
 ep->used = 0;
...
alloc_all_endpoints(struct umidi_softc *sc)
{
 ...
 if (((sc)->sc_quirk && ((sc)->sc_quirk->type_mask & (1<<((1)-1)))))
  err = alloc_all_endpoints_fixed_ep(sc);
 else if (((sc)->sc_quirk && ((sc)->sc_quirk->type_mask & (1<<((2)-1)))))
 ...
 for (i=sc->sc_out_num_endpoints+sc->sc_in_num_endpoints; i>0; i--) {
  ...
  if (err!=USBD_NORMAL_COMPLETION) {
   ...
   free(sc->sc_endpoints, 102, 0);
   sc->sc_endpoints = sc->sc_out_ep = sc->sc_in_ep = ((void *)0);
   break;
  }
  ep++;
 }
...
alloc_all_endpoints_fixed_ep(struct umidi_softc *sc)
{
 ...
 sc->sc_endpoints = mallocarray(sc->sc_out_num_endpoints +
     sc->sc_in_num_endpoints, sizeof(*sc->sc_out_ep), 102,
     0x0001 | 0x0004);
 if (!sc->sc_endpoints)
  return USBD_NOMEM;
 sc->sc_out_ep = sc->sc_out_num_endpoints ? sc->sc_endpoints : ((void *)0);
 sc->sc_in_ep =
     sc->sc_in_num_endpoints ?
  sc->sc_endpoints+sc->sc_out_num_endpoints : ((void *)0);
 ...
 for (i=0; i<sc->sc_in_num_endpoints; i++) {
  ...
  if (((epd->bmAttributes) & 0x03)!=0x02 ||
      ((epd->bEndpointAddress) & 0x80)!=0x80) {
...
alloc_all_endpoints_yamaha(struct umidi_softc *sc)
{
 ...
 desc = ((usb_descriptor_t *)(usbd_get_interface_descriptor(sc->sc_iface)));
 for (i=(int)((usb_interface_descriptor_t *)(desc))->bNumEndpoints-1; i>=0; i--) {
  epd = usbd_interface2endpoint_descriptor(sc->sc_iface, i);
  if (((epd->bmAttributes) & 0x03) == 0x02) {
   dir = ((epd->bEndpointAddress) & 0x80);
   if (dir==0x00 && !out_addr)
    out_addr = epd->bEndpointAddress;
   else if (dir==0x80 && !in_addr) {
    in_addr = epd->bEndpointAddress;
    in_packetsize = ((epd->wMaxPacketSize)[0] | ((epd->wMaxPacketSize)[1] << 8));
   }
  }
 }
 desc = ((usb_descriptor_t *)((caddr_t)(desc)+(desc)->bLength));


 if (!(desc->bDescriptorType==0x24 &&
       desc->bDescriptorSubtype==0x01))
  return USBD_INVAL;
 remain = (size_t)((((struct umidi_cs_interface_descriptor *)(desc))->wTotalLength)[0] | ((((struct umidi_cs_interface_descriptor *)(desc))->wTotalLength)[1] << 8)) -
  (size_t)desc->bLength;
 desc = ((usb_descriptor_t *)((caddr_t)(desc)+(desc)->bLength));
 ...
 while (remain>=sizeof(usb_descriptor_t)) {
  ...
  if (desc->bDescriptorType==0x24 &&
      remain>=5) {
   if (desc->bDescriptorSubtype==0x03)
    sc->sc_out_num_jacks++;
   else if (desc->bDescriptorSubtype==0x02)
    sc->sc_in_num_jacks++;
  }
  desc = ((usb_descriptor_t *)((caddr_t)(desc)+(desc)->bLength));
  remain-=descsize;
 ...
 if (sc->sc_out_num_jacks>16)
  sc->sc_out_num_jacks = 16;
 if (sc->sc_in_num_jacks>16)
  sc->sc_in_num_jacks = 16;
 ...
 if (sc->sc_out_num_endpoints) {
  ...
  sc->sc_out_ep->packetsize = ((epd->wMaxPacketSize)[0] | ((epd->wMaxPacketSize)[1] << 8));
  sc->sc_out_ep->num_jacks = sc->sc_out_num_jacks;
  sc->sc_out_ep->num_open = 0;
  __builtin_memset((sc->sc_out_ep->jacks), (0), (sizeof(sc->sc_out_ep->jacks)));
 } else
  sc->sc_out_ep = ((void *)0);
 ...
 if (sc->sc_in_num_endpoints) {
  ...
  __builtin_memset((sc->sc_in_ep->jacks), (0), (sizeof(sc->sc_in_ep->jacks)));
 } else
  sc->sc_in_ep = ((void *)0);
...
alloc_all_endpoints_genuine(struct umidi_softc *sc)
{
 ...
 sc->sc_endpoints = p = mallocarray(num_ep,
     sizeof(struct umidi_endpoint), 102, 0x0001 | 0x0004);
 if (!p)
  return USBD_NOMEM;
 ...
 remain = (size_t)((config_desc->wTotalLength)[0] | ((config_desc->wTotalLength)[1] << 8));
 while (remain>=sizeof(usb_descriptor_t)) {
  descsize = desc->bLength;
  if (descsize>remain || descsize==0)
   break;
  if (desc->bDescriptorType==0x05 &&
      remain>=7 &&
      ((((usb_endpoint_descriptor_t *)(desc))->bmAttributes) & 0x03) == 0x02) {
   epaddr = ((usb_endpoint_descriptor_t *)(desc))->bEndpointAddress;
   eppacketsize = ((((usb_endpoint_descriptor_t *)(desc))->wMaxPacketSize)[0] | ((((usb_endpoint_descriptor_t *)(desc))->wMaxPacketSize)[1] << 8));
  } else if (desc->bDescriptorType==0x25 &&
      remain>=4 &&
      epaddr!=-1) {
   if (num_ep>0) {
    num_ep--;
    ...
    p->num_jacks = ((struct umidi_cs_endpoint_descriptor *)(desc))->bNumEmbMIDIJack;
    if (((epaddr) & 0x80)==0x00) {
 ...
 while (p<endep) {
  ...
  if (lowest != p) {
   __builtin_memcpy(((void *)&tmpep), ((void *)p), (sizeof(tmpep)));
   __builtin_memcpy(((void *)p), ((void *)lowest), (sizeof(tmpep)));
   __builtin_memcpy(((void *)lowest), ((void *)&tmpep), (sizeof(tmpep)));
  }
  p->num_open = 0;
  p++;
 }
...
alloc_all_jacks(struct umidi_softc *sc)
{
 ...
 sc->sc_jacks = mallocarray(sc->sc_in_num_jacks + sc->sc_out_num_jacks,
     sizeof(*sc->sc_out_jacks), 102, 0x0001 | 0x0004);
 if (!sc->sc_jacks)
  return USBD_NOMEM;
 sc->sc_out_jacks =
     sc->sc_out_num_jacks ? sc->sc_jacks : ((void *)0);
 sc->sc_in_jacks =
     sc->sc_in_num_jacks ? sc->sc_jacks+sc->sc_out_num_jacks : ((void *)0);
...
free_all_jacks(struct umidi_softc *sc)
{
 ...
 s = splraise(2);
 if (sc->sc_out_jacks) {
  free(sc->sc_jacks, 102, jacks * sizeof(*sc->sc_out_jacks));
  sc->sc_jacks = sc->sc_in_jacks = sc->sc_out_jacks = ((void *)0);
 }
 _splx(s);
}
...
unbind_jacks_from_mididev(struct umidi_mididev *mididev)
{
 ...
 mididev->out_jack = mididev->in_jack = ((void *)0);
}
...
assign_all_jacks_automatically(struct umidi_softc *sc)
{
 ...
 for (i=0; i<sc->sc_num_mididevs; i++) {
  out = (i<sc->sc_out_num_jacks) ? &sc->sc_out_jacks[i]:((void *)0);
  in = (i<sc->sc_in_num_jacks) ? &sc->sc_in_jacks[i]:((void *)0);
...
{
 if (sc->sc_mididevs)
  free(sc->sc_mididevs, 102,
      sc->sc_num_mididevs * sizeof(*sc->sc_mididevs));
 sc->sc_mididevs = ((void *)0);
...
# 1050 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c"
...
# 1128 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c"
static int
out_jack_output(struct umidi_jack *j, int d)
{
 ...
 if (ep->busy) {
  if (!j->intr) {
   do { (j)->intrq_entry.sqe_next = ((void *)0); *(&ep->intrq)->sqh_last = (j); (&ep->intrq)->sqh_last = &(j)->intrq_entry.sqe_next; } while (0);
   ep->pending++;
   j->intr = 1;
  }
  _splx(s);
...
in_intr(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 usbd_get_xfer_status(xfer, ((void *)0), ((void *)0), &remain, ((void *)0));
...
# 1255 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umidi.c"
static int
    ...
    uByte data, u_char *obuf)
{
 ...
 if (packet->status >= 0x80) {
  ...
  packet->buf[packet->index++] = data;
  if (packet->index >= (umidi_evlen[((packet->status) >> 4) & 7]))
   goto packetready;
 }
...
packetready:
 ...
 packet->index = 0;
 __builtin_memcpy((obuf), (packet->buf), (4));
 return 1;
}
