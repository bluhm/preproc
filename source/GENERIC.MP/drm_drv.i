...
drm_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (dev->driver->gem_size > 0) {
  ((dev->driver->gem_size >= sizeof(struct drm_gem_object)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_drv.c", 461, "dev->driver->gem_size >= sizeof(struct drm_gem_object)"));
