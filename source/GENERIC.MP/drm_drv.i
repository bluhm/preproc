...
drm_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (dev->driver->gem_size > 0) {
  ((dev->driver->gem_size >= sizeof(struct drm_gem_object)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_drv.c", 462, "dev->driver->gem_size >= sizeof(struct drm_gem_object)"));
 ...
 *out = ((void *)0);
 if (list_empty(&file_priv->event_list))
  goto out;
 e = ({ const __typeof( ((struct drm_pending_event *)0)->link ) *__mptr = ((&file_priv->event_list)->next); (struct drm_pending_event *)( (char *)__mptr - __builtin_offsetof(struct drm_pending_event, link) );});
