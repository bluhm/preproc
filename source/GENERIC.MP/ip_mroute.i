# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c"
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c"
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c" 2
# 98 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c"
struct socket *ip_mrouter[255];
struct rttimer_queue *mrouterq[255];
uint64_t mrt_count[255];
int ip_mrtproto = 0x13;
...
int set_api_config(struct socket *, struct mbuf *);
...
static const u_int32_t mrt_api_support = ((1 << 0) |
       (1 << 8));
    ...
    unsigned int rtableid)
{
 ...
 __builtin_memset((&msin), (0), (sizeof(msin)));
 ...
 do {
  ...
  if (rt->rt_ifidx == ifp->if_index)
   return (rt);
 } while ((rt = rtable_iterate(rt)) != ((void *)0));
...
get_sg_cnt(unsigned int rtableid, struct sioc_sg_req *req)
{
 ...
 rt = mfc_find(((void *)0), &req->src, &req->grp, rtableid);
 if (rt == ((void *)0)) {
...
get_vif_cnt(unsigned int rtableid, struct sioc_vif_req *req)
{
 ...
 if ((ifp = if_lookupbyvif(vifi, rtableid)) == ((void *)0))
  return (22);
...
mrt_sysctl_vif(void *oldp, size_t *oldlenp)
{
 ...
 for((ifp) = ((&ifnet)->tqh_first); (ifp) != ((void *)0); (ifp) = ((ifp)->if_list.tqe_next)) {
  if ((vifp = (struct vif *)ifp->if_mcast) == ((void *)0))
   continue;
...
mrt_rtwalk_mfcsysctl(struct rtentry *rt, void *arg, unsigned int rtableid)
{
 ...
 if ((ifp = if_get(rt->rt_ifidx)) == ((void *)0))
  return (0);
 if ((v = (struct vif *)ifp->if_mcast) == ((void *)0)) {
  if_put(ifp);
  return (0);
 }
 ...
 for (minfo = msa->msa_minfos;
  ...
  if (minfo->mfc_origin.s_addr !=
      ...
      satosin(((rt)->rt_dest))->sin_addr.s_addr) {
  ...
  minfo->mfc_mcastgrp = satosin(((rt)->rt_dest))->sin_addr;
...
mrt_sysctl_mfc(void *oldp, size_t *oldlenp)
{
 ...
 if (oldp != ((void *)0) && *oldlenp > (64 * 1024))
  return (22);

 if (oldp != ((void *)0))
  msa.msa_minfos = malloc(*oldlenp, 127, 0x0001 | 0x0008);
 else
  msa.msa_minfos = ((void *)0);

 msa.msa_len = *oldlenp;
 msa.msa_needed = 0;

 for (rtableid = 0; rtableid < 255; rtableid++)
  rtable_walk(rtableid, 2, mrt_rtwalk_mfcsysctl, &msa);

 if (msa.msa_minfos != ((void *)0) && msa.msa_needed > 0 &&
     (error = copyout(msa.msa_minfos, oldp, msa.msa_needed)) != 0) {
  free(msa.msa_minfos, 127, *oldlenp);
  return (error);
 }
...
ip_mrouter_init(struct socket *so, struct mbuf *m)
{
 ...
 if (ip_mrouter[rtableid] != ((void *)0) ||
     mrouterq[rtableid] != ((void *)0))
  return (48);

 ip_mrouter[rtableid] = so;
 mrouterq[rtableid] = rt_timer_queue_create(30);
...
set_api_config(struct socket *so, struct mbuf *m)
{
 ...
 if (m == ((void *)0) || m->m_hdr.mh_len < sizeof(u_int32_t))
  return (22);

 apival = ((u_int32_t *)((m)->m_hdr.mh_data));
...
static struct sockaddr_in sin = { sizeof(sin), 2 };
...
add_vif(struct socket *so, struct mbuf *m)
{
 ...
 if (vifcp->vifc_vifi >= 32)
  return (22);
 if (((vifcp->vifc_lcl_addr).s_addr == ((u_int32_t) ((__uint32_t)((u_int32_t)(0x00000000))))))
  return (49);
 if (if_lookupbyvif(vifcp->vifc_vifi, rtableid) != ((void *)0))
  return (48);
...

 {
  ...
  satosin(&ifr.ifr_ifru.ifru_addr)->sin_len = sizeof(struct sockaddr_in);
  satosin(&ifr.ifr_ifru.ifru_addr)->sin_family = 2;
  satosin(&ifr.ifr_ifru.ifru_addr)->sin_addr = zeroin_addr;
  error = (*ifp->if_ioctl)(ifp, ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((49))), (caddr_t)&ifr);
  if (error)
   return (error);
 }

 vifp = malloc(sizeof(*vifp), 56, 0x0001 | 0x0008);
...
del_vif(struct socket *so, struct mbuf *m)
{
 ...
 if ((ifp = if_lookupbyvif(*vifip, rtableid)) == ((void *)0))
  return (49);
    ...
    struct sockaddr *group, struct mfcctl2 *mfccp, int wait)
{
 ...
 mfc = malloc(sizeof(*mfc), 56, wait | 0x0008);
 if (mfc == ((void *)0)) {
  do { } while (0);
...
update_mfc_params(struct mfcctl2 *mfccp, int wait, unsigned int rtableid)
{
 ...
 __builtin_memset((&osin), (0), (sizeof(osin)));
 ...
 for (i = 0; i < 32; i++) {
  ...
  if ((ifp = if_lookupbyvif(i, rtableid)) == ((void *)0))
   continue;
 ...
 if ((ifp = if_lookupbyvif(mfccp->mfcc_parent, rtableid)) == ((void *)0)) {
  do { } while (0);
 ...
 if ((rt = mfc_find(ifp, &mfccp->mfcc_origin,
     &mfccp->mfcc_mcastgrp, rtableid)) != ((void *)0)) {
  rtfree(rt);
  return;
 }
    ...
    struct in_addr *group, int vidx, unsigned int rtableid, int wait)
{
 ...
 if (ifp == ((void *)0) ||
     (v = (struct vif *)ifp->if_mcast) == ((void *)0))
  return (65);

 __builtin_memset((&mfcctl), (0), (sizeof(mfcctl)));
 if (mfcctl2 == ((void *)0)) {
  mfcctl.mfcc_origin = *origin;
  mfcctl.mfcc_mcastgrp = *group;
  mfcctl.mfcc_parent = vidx;
 } else
  __builtin_memcpy((&mfcctl), (mfcctl2), (sizeof(mfcctl)));
...
add_mfc(struct socket *so, struct mbuf *m)
{
 ...
 if (mrt_api_config & (((1 << 0)) | (1 << 8) | (1 << 9))) {
  struct mfcctl2 *mp2 = ((struct mfcctl2 *)((m)->m_hdr.mh_data));
  __builtin_memcpy(((caddr_t)&mfcctl2), (mp2), (sizeof(*mp2)));
 } else {
  struct mfcctl *mp = ((struct mfcctl *)((m)->m_hdr.mh_data));
  __builtin_memcpy(((caddr_t)&mfcctl2), (mp), (sizeof(*mp)));
  __builtin_memset(((caddr_t)&mfcctl2 + sizeof(struct mfcctl)), (0), (sizeof(mfcctl2) - sizeof(struct mfcctl)));

 }

 if (mfc_add(&mfcctl2, &mfcctl2.mfcc_origin, &mfcctl2.mfcc_mcastgrp,
     mfcctl2.mfcc_parent, rtableid, 0x0001) == -1)
  return (22);
...
del_mfc(struct socket *so, struct mbuf *m)
{
 ...
 while ((rt = mfc_find(((void *)0), &mfcctl2.mfcc_origin,
     &mfcctl2.mfcc_mcastgrp, rtableid)) != ((void *)0)) {
...
{
 if (s != ((void *)0)) {
  if (sbappendaddr(s, &s->so_rcv, sintosa(src), mm, ((void *)0)) != 0) {
   sorwakeup(s);
   return (0);
  }
 }
...
# 1063 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_mroute.c"
int
ip_mforward(struct mbuf *m, struct ifnet *ifp)
{
 ...
 if (ip->ip_hl < (20 + 12) >> 2 ||
  ...
  if ((srctun++ % 1000) == 0)
   log(3, "ip_mforward: received source-routed "
       "packet from %x\n", ((__uint32_t)(ip->ip_src.s_addr)));
  return (45);
 }
 ...
 if (ip->ip_ttl <= 1 || (((u_int32_t)(ip->ip_dst.s_addr) & ((u_int32_t) ((__uint32_t)((u_int32_t)(0xffffff00))))) == ((u_int32_t) ((__uint32_t)((u_int32_t)(0xe0000000))))))
  return (0);
 ...
 rt = mfc_find(((void *)0), &ip->ip_src, &ip->ip_dst, rtableid);
 ...
 if (rt != ((void *)0)) {
...

  {
   ...
   mm = m_copym(m, 0, hlen, 0x0002);
   if (mm == ((void *)0) ||
       (mm = m_pullup(mm, hlen)) == ((void *)0))
    return (55);
   ...
   if (socket_send(ip_mrouter[rtableid], mm, &sin) < 0) {
    log(4, "ip_mforward: ip_mrouter "
        "socket queue full\n");
    ++mrtstat.mrts_upq_sockfull;
    return (55);
   }

   mfc_add(((void *)0), &ip->ip_src, &ip->ip_dst, v->v_id,
       rtableid, 0x0002);
  }
...
ip_mdq(struct mbuf *m, struct ifnet *ifp0, struct rtentry *rt)
{
 ...
 if (((ip->ip_src).s_addr == (v->v_lcl_addr).s_addr)) {
  v->v_pkt_out++;
  v->v_bytes_out += m->M_dat.MH.MH_pkthdr.len;
 } else {
  v->v_pkt_in++;
  v->v_bytes_in += m->M_dat.MH.MH_pkthdr.len;
 }
 ...
 do {
  ...
  mfc->mfc_pkt_cnt++;
  mfc->mfc_byte_cnt += m->M_dat.MH.MH_pkthdr.len;
  ...
  mc = m_dup_pkt(m, max_linkhdr, 0x0002);
  if (mc == ((void *)0)) {
   if_put(ifp);
   rtfree(rt);
   return (55);
  ...
  imo.imo_ttl = ip->ip_ttl - 1;
  imo.imo_loop = 1;

  ip_output(mc, ((void *)0), ((void *)0), 0x1, &imo, ((void *)0), 0);
  if_put(ifp);
 } while ((rt = rtable_iterate(rt)) != ((void *)0));
...
rt_mcast_add(struct ifnet *ifp, struct sockaddr *origin, struct sockaddr *group)
{
 ...
 rv = rt_ifa_add(ifa, 0x4 | 0x200, group);
 if (rv != 0) {
  do { } while (0);
  return (((void *)0));
 }
 ...
 return (mfc_find(ifp, ((void *)0), &satosin(group)->sin_addr, rtableid));
}
...
rt_mcast_del(struct rtentry *rt, unsigned int rtableid)
{
 ...
 free(rt->rt_llinfo, 56, sizeof(struct mfc));
 rt->rt_llinfo = ((void *)0);
