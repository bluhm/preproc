# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/ascii.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsemul_dumb.c" 2
    ...
    int crow, long defattr)
{
 ...
 edp->defattr = defattr;
 edp->cbcookie = ((void *)0);
 edp->crippled = emulops->cursor == ((void *)0) ||
    ...
    int ccol, int crow, void *cbcookie, long defattr)
{
 ...
 if (console)
  ...
  edp = malloc(sizeof *edp, 2, 0x0001);
...
wsemul_dumb_output(void *cookie, const u_char *data, u_int count, int kernel)
{
 ...
 if (edp->crippled) {
  while (count-- > 0) {
   ...
   if (c == 0x07)
    ...
    do { if ((&edp->abortstate)->skip != 0) { (&edp->abortstate)->skip--; (rc) = 0; } else { (rc) = (*(edp)->emulops->putchar) (edp->emulcookie, 0, 0, c, 0) ; } if ((rc) == 0) (&edp->abortstate)->done++; } while (0);
 ...
 while (count-- > 0) {
  ...
  case 0x09:
   ...
   do { if ((&edp->abortstate)->skip != 0) { (&edp->abortstate)->skip--; (rc) = 0; } else { (rc) = (*(edp)->emulops->erasecols) (edp->emulcookie, edp->crow, edp->ccol, n, edp->defattr) ; } if ((rc) == 0) (&edp->abortstate)->done++; } while (0);
  ...
  case 0x0c:
   do { if ((&edp->abortstate)->skip != 0) { (&edp->abortstate)->skip--; (rc) = 0; } else { (rc) = (*(edp)->emulops->eraserows) (edp->emulcookie, 0, edp->nrows, edp->defattr) ; } if ((rc) == 0) (&edp->abortstate)->done++; } while (0);
  ...
  default:
   do { if ((&edp->abortstate)->skip != 0) { (&edp->abortstate)->skip--; (rc) = 0; } else { (rc) = (*(edp)->emulops->putchar) (edp->emulcookie, edp->crow, edp->ccol, c, edp->defattr) ; } if ((rc) == 0) (&edp->abortstate)->done++; } while (0);
  ...
  case 0x0a:
   ...
   n = 1;
   do { if ((&edp->abortstate)->skip != 0) { (&edp->abortstate)->skip--; (rc) = 0; } else { (rc) = (*(edp)->emulops->copyrows) (edp->emulcookie, n, 0, edp->nrows - n) ; } if ((rc) == 0) (&edp->abortstate)->done++; } while (0);

   if (rc == 0)
    do { if ((&edp->abortstate)->skip != 0) { (&edp->abortstate)->skip--; (rc) = 0; } else { (rc) = (*(edp)->emulops->eraserows) (edp->emulcookie, edp->nrows - n, n, edp->defattr) ; } if ((rc) == 0) (&edp->abortstate)->done++; } while (0);
