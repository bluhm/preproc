# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/xform_ipcomp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/xform_ipcomp.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/xform_ipcomp.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/xform_ipcomp.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/xform_ipcomp.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/xform_ipcomp.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/xform_ipcomp.c" 2
...
deflate_global(u_int8_t *data, u_int32_t size, int decomp, u_int8_t **out)
{
 ...
 __builtin_bzero((&zbuf), (sizeof(z_stream)));
 for (j = 0; j < 10; j++)
  buf[j].flag = 0;
 ...
 buf[i].out = malloc((u_long)size, 108, 0x0002);
 if (buf[i].out == ((void *)0))
  goto bad;
 buf[i].size = size;
 buf[i].flag = 1;
 ...
 error = decomp ?
     inflateInit2_((&zbuf), (window_inflate), "1.2.3", sizeof(z_stream)) :
     deflateInit2_((&zbuf),((-1)),(8),(window_deflate),(8), (0), "1.2.3", sizeof(z_stream));
 ...
 for (;;) {
  ...
  if (error != 0)
   goto bad;
  if (zbuf.avail_out == 0 && i < (10 - 1)) {

   if (size < 32 * 1024)
    size *= 2;
   buf[i].out = malloc((u_long)size, 108,
       0x0002);
   if (buf[i].out == ((void *)0))
    goto bad;
 ...
 *out = malloc((u_long)result, 108, 0x0002);
 if (*out == ((void *)0))
  goto bad;
 if (decomp)
  inflateEnd(&zbuf);
 ...
 for (j = 0; buf[j].flag != 0; j++) {
  if (count > buf[j].size) {
   __builtin_bcopy((buf[j].out), (*out), (buf[j].size));
   *out += buf[j].size;
   free(buf[j].out, 108, 0);
   count -= buf[j].size;
  } else {

   __builtin_bcopy((buf[j].out), (*out), (count));
   *out += count;
   free(buf[j].out, 108, 0);
   count = 0;
  }
