# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c" 2
...
int32_t ixgbe_clock_in_i2c_bit(struct ixgbe_hw *hw, _Bool *data);
int32_t ixgbe_clock_out_i2c_bit(struct ixgbe_hw *hw, _Bool data);
void ixgbe_raise_i2c_clk(struct ixgbe_hw *hw, uint32_t *i2cctl);
void ixgbe_lower_i2c_clk(struct ixgbe_hw *hw, uint32_t *i2cctl);
int32_t ixgbe_set_i2c_data(struct ixgbe_hw *hw, uint32_t *i2cctl, _Bool data);
_Bool ixgbe_get_i2c_data(struct ixgbe_hw *hw, uint32_t *i2cctl);
void ixgbe_i2c_bus_clear(struct ixgbe_hw *hw);
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
...
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
...
# 112 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_read_i2c_combined_generic_int(struct ixgbe_hw *hw, uint8_t addr,
         uint16_t reg64, uint16_t *val,
         _Bool lock)
{
 ...
 if (hw->mac.type >= ixgbe_mac_X550)
  max_retry = 3;
 reg_high = ((reg64 >> 7) & 0xFE) | 1;
 csum = ixgbe_ones_comp_byte_add(reg_high, reg64 & 0xFF);
 csum = ~csum;
 do {
  ...
  if (ixgbe_out_i2c_byte_ack(hw, reg64 & 0xFF))
   goto fail;
...
# 192 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_read_i2c_combined_generic(struct ixgbe_hw *hw, uint8_t addr,
     uint16_t reg64, uint16_t *val)
{
 return ixgbe_read_i2c_combined_generic_int(hw, addr, reg64, val, 1);
}
# 207 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_read_i2c_combined_generic_unlocked(struct ixgbe_hw *hw, uint8_t addr,
       uint16_t reg64, uint16_t *val)
{
 return ixgbe_read_i2c_combined_generic_int(hw, addr, reg64, val, 0);
}
# 223 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_write_i2c_combined_generic_int(struct ixgbe_hw *hw, uint8_t addr,
          uint16_t reg64, uint16_t val, _Bool lock)
{
 uint32_t swfw_mask = hw->phy.phy_semaphore_mask;
 int max_retry = 1;
 int retry = 0;
...
# 287 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_write_i2c_combined_generic(struct ixgbe_hw *hw,
      uint8_t addr, uint16_t reg64, uint16_t val)
{
 return ixgbe_write_i2c_combined_generic_int(hw, addr, reg64, val, 1);
}
# 302 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t
ixgbe_write_i2c_combined_generic_unlocked(struct ixgbe_hw *hw,
       uint8_t addr, uint16_t reg64, uint16_t val)
{
 return ixgbe_write_i2c_combined_generic_int(hw, addr, reg64, val, 0);
}
...
int32_t ixgbe_identify_phy_generic(struct ixgbe_hw *hw)
{
 ...
 if (!hw->phy.phy_semaphore_mask) {
  if (hw->bus.lan_id)
   hw->phy.phy_semaphore_mask = 0x0004;
  else
   hw->phy.phy_semaphore_mask = 0x0002;
 }
...
# 424 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_check_reset_blocked(struct ixgbe_hw *hw)
{
 uint32_t mmngc;
 ...
 mmngc = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x042D0);
 if (mmngc & 0x00000001) {
  ;
...
int32_t ixgbe_get_phy_id(struct ixgbe_hw *hw)
{
 ...
 status = hw->phy.ops.read_reg(hw, 0x2,
          0x1,
          &phy_id_high);

 if (status == 0) {
  hw->phy.id = (uint32_t)(phy_id_high << 16);
  status = hw->phy.ops.read_reg(hw, 0x3,
           0x1,
           &phy_id_low);
  hw->phy.id |= (uint32_t)(phy_id_low & 0xFFFFFFF0);
  hw->phy.revision =
      (uint32_t)(phy_id_low & ~0xFFFFFFF0);
 }
 return status;
}
...
int32_t ixgbe_reset_phy_generic(struct ixgbe_hw *hw)
{
 ...
 if (!hw->phy.reset_if_overtemp &&
     (-26 == hw->phy.ops.check_overtemp(hw)))
  goto out;
...
# 601 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_read_phy_reg_mdi(struct ixgbe_hw *hw, uint32_t reg_addr,
          uint32_t device_type, uint16_t *phy_data)
{
 ...
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x0425C, command);
 ...
 for (i = 0; i < 100; i++) {
  ...
  command = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x0425C);
 ...
 data = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x04260);
 data >>= 16;
 *phy_data = (uint16_t)(data);

 return 0;
}
# 680 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_read_phy_reg_generic(struct ixgbe_hw *hw, uint32_t reg_addr,
       uint32_t device_type, uint16_t *phy_data)
{
 int32_t status;
...
# 707 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_write_phy_reg_mdi(struct ixgbe_hw *hw, uint32_t reg_addr,
    uint32_t device_type, uint16_t phy_data)
{
 uint32_t i, command;
 ...
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x04260, (uint32_t)phy_data);
...
# 781 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_write_phy_reg_generic(struct ixgbe_hw *hw, uint32_t reg_addr,
        uint32_t device_type, uint16_t phy_data)
{
 int32_t status;
...
int32_t ixgbe_setup_phy_link_generic(struct ixgbe_hw *hw)
{
 ...
 if (speed & 0x0080) {
  ...
  hw->phy.ops.read_reg(hw, 0x20,
         0x7,
         &autoneg_reg);

  autoneg_reg &= ~0x1000;
  if (hw->phy.autoneg_advertised & 0x0080)
   autoneg_reg |= 0x1000;

  hw->phy.ops.write_reg(hw, 0x20,
          0x7,
          autoneg_reg);
 }
 ...
 if (speed & 0x0020) {
  ...
  autoneg_reg &= ~0x8000;
  if (hw->phy.autoneg_advertised & 0x0020)
   autoneg_reg |= 0x8000;
 ...
 if (speed & 0x0008) {
  ...
  hw->phy.ops.read_reg(hw, 0x10,
         0x7,
         &autoneg_reg);

  autoneg_reg &= ~(0x0100 |
     0x0080);
  if (hw->phy.autoneg_advertised & 0x0008)
   autoneg_reg |= 0x0100;

  hw->phy.ops.write_reg(hw, 0x10,
          0x7,
          autoneg_reg);
 }
        ...
        _Bool autoneg_wait_to_complete)
{
 ...
 if (speed & 0x0800)
  hw->phy.autoneg_advertised |= 0x0800;

 if (speed & 0x0400)
  hw->phy.autoneg_advertised |= 0x0400;
...
# 964 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_get_copper_speeds_supported(struct ixgbe_hw *hw)
{
 int32_t status;
 uint16_t speed_ability;

 status = hw->phy.ops.read_reg(hw, 0x4,
          0x1,
          &speed_ability);
 if (status)
  return status;

 if (speed_ability & 0x0001)
  hw->phy.speeds_supported |= 0x0080;
 if (speed_ability & 0x0010)
  hw->phy.speeds_supported |= 0x0020;
 if (speed_ability & 0x0020)
  hw->phy.speeds_supported |= 0x0008;

 switch (hw->mac.type) {
 case ixgbe_mac_X550:
  hw->phy.speeds_supported |= 0x0400;
  hw->phy.speeds_supported |= 0x0800;
  break;
...
# 1026 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
        ...
        uint16_t *firmware_version)
{
 ...
 status = hw->phy.ops.read_reg(hw, 0xB,
          0x1E,
          firmware_version);
            ...
            uint16_t *firmware_version)
{
 ...
 status = hw->phy.ops.read_reg(hw, 0x20,
          0x1E,
          firmware_version);
...
int32_t ixgbe_identify_sfp_module_generic(struct ixgbe_hw *hw)
{
 ...
 if (identifier != 0x3) {
  ...
  if (status != 0)
   goto err_read_i2c_eeprom;
# 1426 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
  if (hw->mac.type == ixgbe_mac_82598EB) {
   if (cable_tech & 0x4)
    hw->phy.sfp_type = ixgbe_sfp_type_da_cu;
   else if (comp_codes_10g & 0x10)
    hw->phy.sfp_type = ixgbe_sfp_type_sr;
   else if (comp_codes_10g & 0x20)
    hw->phy.sfp_type = ixgbe_sfp_type_lr;
   else if (comp_codes_10g & 0x80)
    hw->phy.sfp_type = ixgbe_sfp_type_da_cu;
   else
...
int32_t ixgbe_get_supported_phy_sfp_layer_generic(struct ixgbe_hw *hw)
{
 ...
 case ixgbe_phy_sfp_passive_unknown:
 case ixgbe_phy_qsfp_passive_unknown:
  physical_layer = 0x0008;
  break;
 case ixgbe_phy_sfp_ftl_active:
 case ixgbe_phy_sfp_active_unknown:
 case ixgbe_phy_qsfp_active_unknown:
  physical_layer = 0x2000;
  break;
 case ixgbe_phy_sfp_avago:
 case ixgbe_phy_sfp_ftl:
 case ixgbe_phy_sfp_intel:
 case ixgbe_phy_sfp_unknown:
  ...
  hw->phy.ops.read_i2c_eeprom(hw,
        0x3, &comp_codes_10g);
  if (comp_codes_10g & 0x10)
   physical_layer = 0x0040;
  else if (comp_codes_10g & 0x20)
   physical_layer = 0x0010;
  else if (comp_codes_10g &
      (0x4 | 0x80))
   physical_layer = 0x0008;
  else if (comp_codes_10g & 0x8)
   physical_layer = 0x2000;
  else if (comp_codes_1g & 0x8)
   physical_layer = 0x0002;
  else if (comp_codes_1g & 0x1)
   physical_layer = 0x4000;
  else if (comp_codes_1g & 0x2)
   physical_layer = 0x8000;
  break;
 case ixgbe_phy_qsfp_intel:
 case ixgbe_phy_qsfp_unknown:
  hw->phy.ops.read_i2c_eeprom(hw,
...
int32_t ixgbe_identify_qsfp_module_generic(struct ixgbe_hw *hw)
{
 ...
 status = hw->phy.ops.read_i2c_eeprom(hw, 0x0,
          &identifier);
 ...
 status = hw->phy.ops.read_i2c_eeprom(hw, 0x83,
          &comp_codes_10g);

 if (status != 0)
  goto err_read_i2c_eeprom;

 status = hw->phy.ops.read_i2c_eeprom(hw, 0x86,
          &comp_codes_1g);

 if (status != 0)
  goto err_read_i2c_eeprom;

 if (comp_codes_10g & 0x8) {
...
# 1857 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_get_sfp_init_sequence_offsets(struct ixgbe_hw *hw,
         uint16_t *list_offset,
         uint16_t *data_offset)
{
 ...
 if (hw->eeprom.ops.read(hw, 0x002B, list_offset)) {
  ;
 ...
 if (sfp_id == 0xFFFF &&
  ...
  hw->eeprom.ops.read(hw, 0x002B, list_offset);
  (*list_offset) += 2;
  hw->eeprom.ops.read(hw, *list_offset, data_offset);
 } else if (sfp_id == 0xFFFF) {
  ;
  return -19;
 }
...
# 1962 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_read_i2c_eeprom_generic(struct ixgbe_hw *hw, uint8_t byte_offset,
          uint8_t *eeprom_data)
{
 ;;
...
# 1980 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_write_i2c_eeprom_generic(struct ixgbe_hw *hw, uint8_t byte_offset,
           uint8_t eeprom_data)
{
 ;;
...
_Bool ixgbe_is_sfp_probe(struct ixgbe_hw *hw, uint8_t offset, uint8_t addr)
{
 if (addr == 0xA0 &&
     offset == 0x0 &&
     hw->phy.sfp_type == ixgbe_sfp_type_not_present)
...
# 2014 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_read_i2c_byte_generic_int(struct ixgbe_hw *hw, uint8_t byte_offset,
     uint8_t dev_addr, uint8_t *data, _Bool lock)
{
 int32_t status;
...
# 2104 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_read_i2c_byte_generic(struct ixgbe_hw *hw, uint8_t byte_offset,
        uint8_t dev_addr, uint8_t *data)
{
...
# 2120 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_read_i2c_byte_generic_unlocked(struct ixgbe_hw *hw, uint8_t byte_offset,
          uint8_t dev_addr, uint8_t *data)
{
 return ixgbe_read_i2c_byte_generic_int(hw, byte_offset, dev_addr,
...
# 2137 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
...
# 2207 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_write_i2c_byte_generic(struct ixgbe_hw *hw, uint8_t byte_offset,
         uint8_t dev_addr, uint8_t data)
{
...
# 2223 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_write_i2c_byte_generic_unlocked(struct ixgbe_hw *hw, uint8_t byte_offset,
           uint8_t dev_addr, uint8_t data)
{
 return ixgbe_write_i2c_byte_generic_int(hw, byte_offset, dev_addr,
...
# 2237 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
void ixgbe_i2c_start(struct ixgbe_hw *hw)
{
 uint32_t i2cctl;
 ...
 if (hw->mac.type == ixgbe_mac_X550 ||
  ...
  i2cctl = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x15F5C);
  i2cctl |= 0x00000100;
 } else
  i2cctl = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00028);
...
# 2277 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
void ixgbe_i2c_stop(struct ixgbe_hw *hw)
{
 uint32_t i2cctl;
 ...
 if (hw->mac.type == ixgbe_mac_X550 ||
  ...
  i2cctl |= 0x00000800 |
      0x00002000;
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x15F5C, i2cctl);
  bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00008);
 }
}
# 2318 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_clock_in_i2c_byte(struct ixgbe_hw *hw, uint8_t *data)
{
 int32_t i;
 _Bool bit = 0;
...
# 2341 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_clock_out_i2c_byte(struct ixgbe_hw *hw, uint8_t data)
{
 int32_t status = 0;
 int32_t i;
 ...
 if (hw->mac.type == ixgbe_mac_X550 ||
     hw->mac.type == ixgbe_mac_X550EM_x) {
  i2cctl = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x15F5C);
  i2cctl |= 0x00000400 | 0x00000800;
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x15F5C, i2cctl);
 } else {
  i2cctl = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00028);
  i2cctl |= 0x00000008;
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00028, i2cctl);
 }
 bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00008);
...
int32_t ixgbe_get_i2c_ack(struct ixgbe_hw *hw)
{
 ...
 if (hw->mac.type == ixgbe_mac_X550 ||
     hw->mac.type == ixgbe_mac_X550EM_x) {
  i2cctl_reg = 0x15F5C;
  i2cctl = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, i2cctl_reg);
  i2cctl |= 0x00000400 | 0x00000800;
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, i2cctl_reg, i2cctl);
  bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00008);
 } else {
  i2cctl_reg = 0x00028;
  i2cctl = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, i2cctl_reg);
...
# 2437 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_clock_in_i2c_bit(struct ixgbe_hw *hw, _Bool *data)
{
 uint32_t i2cctl, i2cctl_reg;
...
# 2478 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_clock_out_i2c_bit(struct ixgbe_hw *hw, _Bool data)
{
 int32_t status;
 uint32_t i2cctl;
...
# 2521 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
void ixgbe_raise_i2c_clk(struct ixgbe_hw *hw, uint32_t *i2cctl)
{
  ...
  *i2cctl |= 0x00002000;
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, i2cctl_reg, *i2cctl);
  *i2cctl |= 0x00000200;
  i2cctl_clk_in = 0x00004000;
 } else {
  i2cctl_reg = 0x00028;
  *i2cctl |= 0x00000002;
  i2cctl_clk_in = 0x00000001;
 }
 ...
 for (i = 0; i < timeout; i++) {
  ...
  if (bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, i2cctl_reg) & i2cctl_clk_in)
   break;
 }
}
# 2559 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
void ixgbe_lower_i2c_clk(struct ixgbe_hw *hw, uint32_t *i2cctl)
{
 ;;
...
# 2587 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
int32_t ixgbe_set_i2c_data(struct ixgbe_hw *hw, uint32_t *i2cctl, _Bool data)
{
 uint32_t i2cctl_reg;
 int32_t status = 0;
...
# 2645 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
_Bool ixgbe_get_i2c_data(struct ixgbe_hw *hw, uint32_t *i2cctl)
{
 ...
 if (hw->mac.type == ixgbe_mac_X550 ||
     hw->mac.type == ixgbe_mac_X550EM_x) {
  i2cctl_data_in = 0x00001000;
  *i2cctl |= 0x00000800;
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x15F5C, *i2cctl);
  bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00008);
  delay(1);
 } else
  i2cctl_data_in = 0x00000004;
...
# 2677 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_phy.c"
void ixgbe_i2c_bus_clear(struct ixgbe_hw *hw)
{
 uint32_t i2cctl;
 uint32_t i;
...
int32_t ixgbe_tn_check_overtemp(struct ixgbe_hw *hw)
{
 ...
 if (hw->device_id != 0x151C)
  goto out;


 hw->phy.ops.read_reg(hw, 0x9005,
        0x1, &phy_data);
...
int32_t ixgbe_set_copper_phy_power(struct ixgbe_hw *hw, _Bool on)
{
 ...
 status = hw->phy.ops.read_reg(hw, 0x0,
          0x1E,
          &reg64);
 if (status)
  return status;
 ...
 status = hw->phy.ops.write_reg(hw, 0x0,
           0x1E,
           reg64);
 return status;
}
