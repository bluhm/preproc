# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pcf8591_ofw.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pcf8591_ofw.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pcf8591_ofw.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pcf8591_ofw.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pcf8591_ofw.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pcf8591_ofw.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pcf8591_ofw.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pcf8591_ofw.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pcf8591_ofw.c" 2
...
struct pcfadc_softc {
 ...
 u_char sc_xlate[256];
 u_int sc_nchan;
 struct pcfadc_channel sc_channels[4];
...
pcfadc_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 u_char chanuse[4 * 4], desc[4 * 32];
 u_char *cp;
 u_int8_t junk[4 + 1];
 u_int32_t transinfo[4 * 4];
 struct i2c_attach_args *ia = aux;
 ...
 for (i = 0; i < sc->sc_nchan; i++) {
  ...
  cp += strlen(cp) + 1;
# 145 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pcf8591_ofw.c"
  if (chanuse[(i * 4)] > 4 ||
      chanuse[(i * 4) + 1] != 0 ||
      chanuse[(i * 4) + 2] != 1 ||
      transinfo[(i * 4)] != 3 ||
      transinfo[(i * 4) + 2] != 0 ||
      transinfo[(i * 4) + 3] != 0x100) {
 ...
 if (sensor_task_register(sc, pcfadc_refresh, 5) == ((void *)0)) {
