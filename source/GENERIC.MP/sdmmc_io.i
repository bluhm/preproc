# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c"
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c"
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_ioreg.h" 1
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmcchip.h" 1
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmcchip.h"
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmcchip.h" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/scsiconf.h" 2
...
# 282 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmcvar.h" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c" 2
...
struct sdmmc_intr_handler {
 ...
 int (*ih_fun)(void *);
 void *ih_arg;
 struct { struct sdmmc_intr_handler *tqe_next; struct sdmmc_intr_handler **tqe_prev; } entry;
};
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c"
int sdmmc_verbose = 0;
...
sdmmc_io_enable(struct sdmmc_softc *sc)
{
 ...
 ((sc->sc_flags) |= (0x0001|0x0002|0x0004));
 ...
 sc->sc_function_count = (((card_ocr) >> 28) & 0x3);
 ...
 if (sdmmc_io_send_op_cond(sc, host_ocr, ((void *)0)) != 0) {
...
sdmmc_io_scan(struct sdmmc_softc *sc)
{
 ...
 sc->sc_fn0 = sf0;
 do { (sf0)->sf_list.sqe_next = ((void *)0); *(&sc->sf_head)->sqh_last = (sf0); (&sc->sf_head)->sqh_last = &(sf0)->sf_list.sqe_next; } while (0);
...
sdmmc_io_init(struct sdmmc_softc *sc, struct sdmmc_function *sf)
{
 ...
 if (sf->number == 0) {
  ...
  (void)((sc->sct)->bus_clock((sc->sch), (25000), (0)));
...
sdmmc_io_rw_direct(struct sdmmc_softc *sc, struct sdmmc_function *sf,
    int reg64, u_char *datap, int arg)
{
 struct sdmmc_command cmd;
 int error;
...
sdmmc_io_rw_extended(struct sdmmc_softc *sc, struct sdmmc_function *sf,
    int reg64, u_char *datap, int datalen, int arg)
{
 struct sdmmc_command cmd;
 int error;

 rw_assert_wrlock(&sc->sc_lock);
# 405 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_io.c"
 arg |= ((sf == ((void *)0) ? 0 : sf->number) & 0x7) <<
     28;
 arg |= (reg64 & 0x1ffff) <<
     9;
...
u_int8_t
sdmmc_io_read_1(struct sdmmc_function *sf, int reg64)
{
 u_int8_t data = 0;

 rw_assert_wrlock(&sf->sc->sc_lock);

 (void)sdmmc_io_rw_direct(sf->sc, sf, reg64, (u_char *)&data,
     (0<<31));
 return data;
}

void
sdmmc_io_write_1(struct sdmmc_function *sf, int reg64, u_int8_t data)
{
 rw_assert_wrlock(&sf->sc->sc_lock);
...
u_int16_t
sdmmc_io_read_2(struct sdmmc_function *sf, int reg64)
{
 u_int16_t data = 0;

 rw_assert_wrlock(&sf->sc->sc_lock);

 (void)sdmmc_io_rw_extended(sf->sc, sf, reg64, (u_char *)&data, 2,
     (0<<31) | (1<<26));
 return data;
}

void
sdmmc_io_write_2(struct sdmmc_function *sf, int reg64, u_int16_t data)
{
 rw_assert_wrlock(&sf->sc->sc_lock);
...
u_int32_t
sdmmc_io_read_4(struct sdmmc_function *sf, int reg64)
{
 u_int32_t data = 0;

 rw_assert_wrlock(&sf->sc->sc_lock);

 (void)sdmmc_io_rw_extended(sf->sc, sf, reg64, (u_char *)&data, 4,
     (0<<31) | (1<<26));
 return data;
}

void
sdmmc_io_write_4(struct sdmmc_function *sf, int reg64, u_int32_t data)
{
 rw_assert_wrlock(&sf->sc->sc_lock);
...
int
sdmmc_io_read_multi_1(struct sdmmc_function *sf, int reg64, u_char *data,
    int datalen)
{
 int error;
...
int
sdmmc_io_write_multi_1(struct sdmmc_function *sf, int reg64, u_char *data,
    int datalen)
{
 int error;
...
sdmmc_io_xchg(struct sdmmc_softc *sc, struct sdmmc_function *sf,
    int reg64, u_char *datap)
{

 rw_assert_wrlock(&sc->sc_lock);

 return sdmmc_io_rw_direct(sc, sf, reg64, datap,
     (1<<31)|(1<<27));
}
...
sdmmc_io_reset(struct sdmmc_softc *sc)
{
 ...
 if (sdmmc_io_rw_direct(sc, ((void *)0), 0x06, (u_char *)&data,
     (1<<31)) == 0)
  sdmmc_delay(100000);
}
    ...
    void *arg, const char *name)
{
 ...
 if (sc->sct->card_intr_mask == ((void *)0))
  return ((void *)0);

 ih = malloc(sizeof *ih, 2, 0x0001 | 0x0004 | 0x0008);
 if (ih == ((void *)0))
  return ((void *)0);
 ...
 s = _splraise(15);
 if ((((&sc->sc_intrq)->tqh_first) == ((void *)0))) {
  sdmmc_intr_enable(sc->sc_fn0);
  ((sc->sct)->card_intr_mask((sc->sch), (1)));
 }
 do { (ih)->entry.tqe_next = ((void *)0); (ih)->entry.tqe_prev = (&sc->sc_intrq)->tqh_last; *(&sc->sc_intrq)->tqh_last = (ih); (&sc->sc_intrq)->tqh_last = &(ih)->entry.tqe_next; } while (0);
 _splx(s);
 return ih;
}
...
sdmmc_intr_disestablish(void *cookie)
{
 ...
 s = _splraise(15);
 do { if (((ih)->entry.tqe_next) != ((void *)0)) (ih)->entry.tqe_next->entry.tqe_prev = (ih)->entry.tqe_prev; else (&sc->sc_intrq)->tqh_last = (ih)->entry.tqe_prev; *(ih)->entry.tqe_prev = (ih)->entry.tqe_next; ((ih)->entry.tqe_prev) = ((void *)-1); ((ih)->entry.tqe_next) = ((void *)-1); } while (0);
 if ((((&sc->sc_intrq)->tqh_first) == ((void *)0))) {
  ((sc->sct)->card_intr_mask((sc->sch), (0)));
...
sdmmc_intr_task(void *arg)
{
 ...
 s = _splraise(15);
 for((ih) = ((&sc->sc_intrq)->tqh_first); (ih) != ((void *)0); (ih) = ((ih)->entry.tqe_next)) {
  _splx(s);
