# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c"
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhcireg.h" 1
# 248 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhcireg.h"
struct xhci_erseg {
 uint64_t er_addr;
 uint32_t er_size;
 uint32_t er_rsvd;
...
struct xhci_epctx {
  uint32_t info_lo;
# 299 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhcireg.h"
  uint32_t info_hi;
# 314 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhcireg.h"
  uint64_t deqp;
...
struct xhci_trb {
 ...
 uint32_t trb_flags;
# 362 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhcireg.h"
} __attribute__((__packed__));
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhcivar.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhcivar.h"
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c" 2
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/xhci_pci.c"
...
xhci_pci_match(struct device *parent, void *match, void *aux)
{
 ...
 if ((((pa->pa_class) >> 24) & 0xff) == 0x0c &&
     (((pa->pa_class) >> 16) & 0xff) == 0x03 &&
     (((pa->pa_class) >> 8) & 0xff) == 0x30)
  return (1);
...
xhci_pci_port_route(struct xhci_pci_softc *psc)
{
 ...
 val = pci_conf_read(psc->sc_pc, psc->sc_tag, 0xdc);
 ;


 pci_conf_write(psc->sc_pc, psc->sc_tag, 0xd8, val);
 val = pci_conf_read(psc->sc_pc, psc->sc_tag, 0xd8);
 ;
 ...
 val = pci_conf_read(psc->sc_pc, psc->sc_tag, 0xd4);
 ;


 pci_conf_write(psc->sc_pc, psc->sc_tag, 0xd0, val);
 val = pci_conf_read(psc->sc_pc, psc->sc_tag, 0xd0);
 ;
...
xhci_pci_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 reg64 = pci_mapreg_type(pa->pa_pc, pa->pa_tag, 0x10);
 if (pci_mapreg_map(pa, 0x10, reg64, 0, &psc->sc.iot, &psc->sc.ioh,
     ((void *)0), &psc->sc.sc_size, 0)) {
 ...
 switch ((((pa->pa_id) >> 0) & 0xffff)) {
 case 0x1b73:

                if ((((pa->pa_id) >> 16) & 0xffff) == 0x1000 ||
                    (((pa->pa_id) >> 16) & 0xffff) == 0x1400)
   pa->pa_flags &= ~0x20;
  break;
 }
 ...
 psc->sc_ih = pci_intr_establish(pa->pa_pc, ih, 5 | 0x100,
 ...
 if (vendor)
  ...
  snprintf(psc->sc.sc_vendor, sizeof(psc->sc.sc_vendor),
      "vendor 0x%04x", (((pa->pa_id) >> 0) & 0xffff));
 ...
 if ((((psc->sc_id) >> 0) & 0xffff) == 0x8086)
  xhci_pci_port_route(psc);


 config_found_sm((self), (&psc->sc.sc_bus), (usbctlprint), ((void *)0));
...
xhci_pci_takecontroller(struct xhci_pci_softc *psc, int silent)
{
 ...
 cparams = bus_space_read_4((&psc->sc)->iot, (&psc->sc)->ioh, (0x10));
 eec = -1;


 for (xecp = (((cparams) >> 16) & 0xffff) << 2;
     xecp != 0 && (((eec) >> 8) & 0xff);
     xecp += (((eec) >> 8) & 0xff) << 2) {
  eec = bus_space_read_4((&psc->sc)->iot, (&psc->sc)->ioh, (xecp));
  if (((eec) & 0xff) != 0x0001)
   continue;
  bios_sem = bus_space_read_1((&psc->sc)->iot, (&psc->sc)->ioh, (xecp + 0x0002));
  if (bios_sem) {
   bus_space_write_1((&psc->sc)->iot, (&psc->sc)->ioh, (xecp + 0x0003), (1));
   ;
