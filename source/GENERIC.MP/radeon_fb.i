...
{
 struct radeon_bo *rbo = ({ const __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((gobj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
 int ret;
      ...
      struct drm_gem_object **gobj_p)
{
 ...
 rbo = ({ const __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((gobj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
 if (fb_tiled)
  tiling_flags = 0x1;
 switch (bpp) {
 case 32:
...
int radeon_fbdev_total_size(struct radeon_device *rdev)
{
 struct radeon_bo *robj;
 int size = 0;
 robj = ({ const __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((rdev->mode_info.rfbdev->rfb.obj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
 size += radeon_bo_size(robj);
 return size;
}
_Bool radeon_fbdev_robj_is_fb(struct radeon_device *rdev, struct radeon_bo *robj)
{
 if (robj == ({ const __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((rdev->mode_info.rfbdev->rfb.obj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );}))
  return 1;
 return 0;
}
void
