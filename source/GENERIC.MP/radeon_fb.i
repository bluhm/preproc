# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c"
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c"
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c" 2
...
int drm_fb_helper_remove_one_connector(struct drm_fb_helper *fb_helper,
           struct drm_connector *connector);
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c"
void radeondrm_burner_cb(void *);

int radeon_align_pitch(struct radeon_device *rdev, int width, int bpp, _Bool tiled)
{
 int aligned = width;
 int align_large = (((rdev->family >= CHIP_RS600))) || tiled;
 int pitch_mask = 0;
...
{
 struct radeon_bo *rbo = ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((gobj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
 int ret;
      ...
      struct drm_gem_object **gobj_p)
{
 ...
 if (rdev->family >= CHIP_R600)
  height = (((mode_cmd->height)+((8)-1))&(~((8)-1)));
 size = mode_cmd->pitches[0] * height;
 aligned_size = (((size) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
 ...
 rbo = ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((gobj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
 ...
 ret = radeon_bo_pin_restricted(rbo, 0x4,
           ((rdev->family >= CHIP_RS600)) ? 0 : 1 << 27,
           ((void *)0));
 if (ret) {
  radeon_bo_unreserve(rbo);
  goto out_unref;
      ...
      struct drm_fb_helper_surface_size *sizes)
{
 ...
 if ((sizes->surface_bpp == 24) && ((rdev->family >= CHIP_RS600)))
 ...
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "failed to create fbcon object %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ret);
  return ret;
 }
 ...
 info = kzalloc(sizeof(struct fb_info), (0x0001 | 0x0004));
 if (info == ((void *)0)) {
  ret = -12;
  goto out_unref;
 }
 ...
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "failed to initalise framebuffer %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ret);
  goto out_unref;
 }
...
# 295 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c"
 __builtin_memset((rbo->kptr), (0x0), (radeon_bo_size(rbo)));
...
static int radeon_fbdev_destroy(struct drm_device *dev, struct radeon_fbdev *rfbdev)
{
 printf("%s stub\n", __func__);
 return -78;
# 386 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_fb.c"
}
...
int radeon_fbdev_init(struct radeon_device *rdev)
{
 ...
 if (((rdev->pdev->device == 0x515e) || (rdev->pdev->device == 0x5969)) || rdev->mc.real_vram_size <= (32*1024*1024))
  bpp_sel = 8;

 rfbdev = kzalloc(sizeof(struct radeon_fbdev), (0x0001 | 0x0004));
 if (!rfbdev)
  return -12;
...
int radeon_fbdev_total_size(struct radeon_device *rdev)
{
 ...
 robj = ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((rdev->mode_info.rfbdev->rfb.obj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
...
_Bool radeon_fbdev_robj_is_fb(struct radeon_device *rdev, struct radeon_bo *robj)
{
 if (robj == ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((rdev->mode_info.rfbdev->rfb.obj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );}))
  return 1;
 return 0;
}
...
radeondrm_burner(void *v, u_int on, u_int flags)
{
 ...
 if (on)
  rdev->burner_fblank = 0;
 else {
  if (flags & 0x0001)
   rdev->burner_fblank = 3;
  else
   rdev->burner_fblank = 1;
 }
