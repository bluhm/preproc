# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cursor.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cursor.c"
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cursor.c"
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cursor.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cursor.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cursor.c" 2




static void radeon_lock_cursor(struct drm_crtc *crtc, _Bool lock)
{
 ...
 if (((rdev->family >= CHIP_CEDAR))) {
  cur_lock = r100_mm_rreg(rdev, (0x69b8 + radeon_crtc->crtc_offset), 0);
  if (lock)
   cur_lock |= (1 << 16);
  else
   cur_lock &= ~(1 << 16);
  r100_mm_wreg(rdev, (0x69b8 + radeon_crtc->crtc_offset), (cur_lock), 0);
 } else if (((rdev->family >= CHIP_RS600))) {
  cur_lock = r100_mm_rreg(rdev, (0x6424 + radeon_crtc->crtc_offset), 0);
  if (lock)
   cur_lock |= (1 << 16);
  else
   cur_lock &= ~(1 << 16);
  r100_mm_wreg(rdev, (0x6424 + radeon_crtc->crtc_offset), (cur_lock), 0);
 } else {
  cur_lock = r100_mm_rreg(rdev, (0x0260 + radeon_crtc->crtc_offset), 0);
  if (lock)
   cur_lock |= (1 << 31);
  else
   cur_lock &= ~(1 << 31);
  r100_mm_wreg(rdev, (0x0260 + radeon_crtc->crtc_offset), (cur_lock), 0);
 }
}
...
static void radeon_hide_cursor(struct drm_crtc *crtc)
{
 ...
 if (((rdev->family >= CHIP_CEDAR))) {
  r100_mm_wreg(rdev, (0x6998 + radeon_crtc->crtc_offset), ((((2) & 0x3) << 8) | (((4) & 0x7) << 24)), 1);


 } else if (((rdev->family >= CHIP_RS600))) {
  r100_mm_wreg(rdev, (0x6400 + radeon_crtc->crtc_offset), ((2 << 8)), 1);
  ...
  r100_mm_wreg(rdev, (reg64), (r100_mm_rreg(rdev, (reg64), 1) & ~(1 << 16)), 1);
 }
}
...
static void radeon_show_cursor(struct drm_crtc *crtc)
{
 ...
 if (((rdev->family >= CHIP_CEDAR))) {
  r100_mm_wreg(rdev, (0x0000), (0x6998 + radeon_crtc->crtc_offset), 0);
  r100_mm_wreg(rdev, (0x0004), ((1 << 0) | (((2) & 0x3) << 8) | (((4) & 0x7) << 24)), 0);


 } else if (((rdev->family >= CHIP_RS600))) {
  r100_mm_wreg(rdev, (0x0000), (0x6400 + radeon_crtc->crtc_offset), 0);
  r100_mm_wreg(rdev, (0x0004), ((1 << 0) | (2 << 8)), 0);

 } else {
  switch (radeon_crtc->crtc_id) {
  case 0:
   r100_mm_wreg(rdev, (0x0000), (0x0050), 0);
   break;
  case 1:
   r100_mm_wreg(rdev, (0x0000), (0x03f8), 0);
   break;
  default:
   return;
  }

  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x0004), 0); tmp_ &= (~((1 << 16) | (7 << 20))); tmp_ |= ((((1 << 16) | (2 << 20))) & ~(~((1 << 16) | (7 << 20)))); r100_mm_wreg(rdev, (0x0004), (tmp_), 0); } while (0);
         ...
         uint64_t gpu_addr)
{
 ...
 if (((rdev->family >= CHIP_CEDAR))) {
  r100_mm_wreg(rdev, (0x69a4 + radeon_crtc->crtc_offset), (((u32)(((gpu_addr) >> 16) >> 16))), 0);

  r100_mm_wreg(rdev, (0x699c + radeon_crtc->crtc_offset), (gpu_addr & 0xffffffff), 0);

 } else if (((rdev->family >= CHIP_RS600))) {
  if (rdev->family >= CHIP_RV770) {
   if (radeon_crtc->crtc_id)
    r100_mm_wreg(rdev, (0x640c), (((u32)(((gpu_addr) >> 16) >> 16))), 0);
   else
    r100_mm_wreg(rdev, (0x6c0c), (((u32)(((gpu_addr) >> 16) >> 16))), 0);
  }
  r100_mm_wreg(rdev, (0x6408 + radeon_crtc->crtc_offset), (gpu_addr & 0xffffffff), 0);

 } else {
  radeon_crtc->legacy_cursor_offset = gpu_addr - radeon_crtc->legacy_display_base_addr;

  r100_mm_wreg(rdev, (0x0260 + radeon_crtc->crtc_offset), (radeon_crtc->legacy_cursor_offset), 0);
 }
}
      ...
      uint32_t height)
{
 ...
 if ((width > 64) || (height > 64)) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad cursor width or height %d x %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , width, height);
  return -22;
 }

 obj = drm_gem_object_lookup(crtc->dev, file_priv, handle);
 if (!obj) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Cannot find cursor object %x for crtc %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , handle, radeon_crtc->crtc_id);
  return -2;
 }

 robj = ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((obj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
 ret = radeon_bo_reserve(robj, 0);
 if (__builtin_expect(!!(ret != 0), 0))
  goto fail;

 ret = radeon_bo_pin_restricted(robj, 0x4,
...
unpin:
 if (radeon_crtc->cursor_bo) {
  robj = ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((radeon_crtc->cursor_bo)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
  ret = radeon_bo_reserve(robj, 0);
       ...
       int x, int y)
{
 ...
 if (((rdev->family >= CHIP_RS600)) && !((rdev->family >= CHIP_ARUBA))) {
  int i = 0;
  ...
  for (crtc_p = ({ __typeof( ((__typeof(*crtc_p) *)0)->head ) *__mptr = ((&crtc->dev->mode_config.crtc_list)->next); (__typeof(*crtc_p) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtc_p), head) );}); &crtc_p->head != (&crtc->dev->mode_config.crtc_list); crtc_p = ({ __typeof( ((__typeof(*crtc_p) *)0)->head ) *__mptr = (crtc_p->head.next); (__typeof(*crtc_p) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtc_p), head) );})) {
   if (crtc_p->enabled)
    i++;
  }
  if (i > 1) {
   ...
   if (w <= 0) {
    ...
    if (!(cursor_end & 0x7f)) {
     x--;
     ({ static int __warned; int __ret = !!(x < 0); if (__ret && !__warned) { printf("WARNING %s failed at %s:%d\n", "x < 0", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cursor.c", 275); __warned = 1; } __builtin_expect(!!(__ret), 0); });
    }
   }
  }
 }
 ...
 radeon_lock_cursor(crtc, 1);
 if (((rdev->family >= CHIP_CEDAR))) {
  r100_mm_wreg(rdev, (0x69a8 + radeon_crtc->crtc_offset), ((x << 16) | y), 0);
  r100_mm_wreg(rdev, (0x69ac + radeon_crtc->crtc_offset), ((xorigin << 16) | yorigin), 0);
  r100_mm_wreg(rdev, (0x69a0 + radeon_crtc->crtc_offset), (((w - 1) << 16) | (radeon_crtc->cursor_height - 1)), 0);

 } else if (((rdev->family >= CHIP_RS600))) {
  r100_mm_wreg(rdev, (0x6414 + radeon_crtc->crtc_offset), ((x << 16) | y), 0);
  r100_mm_wreg(rdev, (0x6418 + radeon_crtc->crtc_offset), ((xorigin << 16) | yorigin), 0);
  r100_mm_wreg(rdev, (0x6410 + radeon_crtc->crtc_offset), (((w - 1) << 16) | (radeon_crtc->cursor_height - 1)), 0);

 } else {
  if (crtc->mode.flags & (1<<5))
   y *= 2;

  r100_mm_wreg(rdev, (0x0268 + radeon_crtc->crtc_offset), (((1 << 31) | (xorigin << 16) | yorigin)), 0);



  r100_mm_wreg(rdev, (0x0264 + radeon_crtc->crtc_offset), (((1 << 31) | (x << 16) | y)), 0);




  r100_mm_wreg(rdev, (0x0260 + radeon_crtc->crtc_offset), ((radeon_crtc->legacy_cursor_offset + (yorigin * 256))), 0);
