# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_tty.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_tty.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_tty.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_tty.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_tty.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_tty.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_tty.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_tty.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_tty.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_tty.c" 2
...
{
 struct vnode *ttyvp = ((p)->p_p->ps_flags & 0x00000001 ? (p)->p_p->ps_pgrp->pg_session->s_ttyvp : ((void *)0));
 int error;
...
cttyioctl(dev_t dev, u_long cmd, caddr_t addr, int flag, struct proc *p)
{
 ...
 if (ttyvp == ((void *)0))
  return (5);
 if (cmd == ((unsigned long)0x20000000 | ((0 & 0x1fff) << 16) | ((('t')) << 8) | ((97))))
  return (22);
 if (cmd == ((unsigned long)0x20000000 | ((0 & 0x1fff) << 16) | ((('t')) << 8) | ((113)))) {
  if (!((p->p_p)->ps_pgrp->pg_session->s_leader == (p->p_p))) {
   atomic_clearbits_int(&p->p_p->ps_flags, 0x00000001);
   return (0);
  } else
   return (22);
 }
 switch (cmd) {
 case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((28))):
  if ((error = suser(p, 0)))
   return error;
  secs = *(int *)addr;
  if (secs < 1 || secs > 3600)
  ...
  return 0;
 case ((unsigned long)0x20000000 | ((0 & 0x1fff) << 16) | ((('t')) << 8) | ((29))):
  sess = p->p_p->ps_pgrp->pg_session;
  timeout_del(&sess->s_verauthto);
  zapverauth(sess);
  return 0;
 case ((unsigned long)0x20000000 | ((0 & 0x1fff) << 16) | ((('t')) << 8) | ((30))):
 ...
 return (VOP_IOCTL(ttyvp, cmd, addr, flag, ((struct ucred *)-1), p));
}
...
cttypoll(dev_t dev, int events, struct proc *p)
{
 ...
 return (VOP_POLL(ttyvp, 0x0001|0x0002, events, p));
}

int
cttykqfilter(dev_t dev, struct knote *kn)
{
 struct vnode *ttyvp = (((__curcpu->ci_self)->ci_curproc)->p_p->ps_flags & 0x00000001 ? ((__curcpu->ci_self)->ci_curproc)->p_p->ps_pgrp->pg_session->s_ttyvp : ((void *)0));
