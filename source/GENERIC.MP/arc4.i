# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/arc4.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/arc4.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/arc4.c"
...
struct tty;
struct uio;
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/arc4.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/arc4.c" 2
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/arc4.c"
void
rc4_keysetup(struct rc4_ctx *ctx, u_char *key, u_int32_t klen)
{
 ...
 for (i = 0; i < 256; i++)
  ctx->state[i] = i;
 for (i = 0; i < 256; i++) {
  y = (key[x] + ctx->state[i] + y) & (256 - 1);
  do { u_int8_t t = ctx->state[i]; ctx->state[i] = ctx->state[y]; ctx->state[y] = t; } while(0);
  x = (x + 1) % klen;
 }
 ctx->x = ctx->y = 0;
}
    ...
    u_int32_t len)
{
 ...
 for (i = 0; i < len; i++) {
  ctx->x = (ctx->x + 1) & (256 - 1);
  ctx->y = (ctx->state[ctx->x] + ctx->y) & (256 - 1);
  do { u_int8_t t = ctx->state[ctx->x]; ctx->state[ctx->x] = ctx->state[ctx->y]; ctx->state[ctx->y] = t; } while(0);
  dst[i] = src[i] ^ ctx->state[
     (ctx->state[ctx->x] + ctx->state[ctx->y]) & (256 - 1)];
 }
}
