# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c"
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c"
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c" 2
...
struct edid *drm_do_get_edid(struct drm_connector *connector,
 int (*get_edid_block)(void *data, u8 *buf, unsigned int block,
         size_t len),
 void *data);
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c" 2
...
int drm_fb_helper_remove_one_connector(struct drm_fb_helper *fb_helper,
           struct drm_connector *connector);
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c" 2
...
void radeon_connector_hotplug(struct drm_connector *connector)
{
 ...
 if (connector->connector_type == 10) {
  ...
  if (dig_connector->dp_sink_type == 0x13) {
   ...
   if (!(rdev)->asic->hpd.sense((rdev), (radeon_connector->hpd.hpd))) {
...
int radeon_get_monitor_bpc(struct drm_connector *connector)
{
 ...
 case 7:
  if (connector->display_info.bpc)
   bpc = connector->display_info.bpc;
  else if (((rdev->family >= CHIP_PALM) && (rdev->flags & RADEON_IS_IGP)) || ((rdev->family >= CHIP_BARTS))) {
   ...
   if (dig->lcd_misc & 0x10)
    bpc = 6;
   else if (dig->lcd_misc & 0x20)
    bpc = 8;
  }
  break;
 }
...
radeon_connector_update_scratch_regs(struct drm_connector *connector, enum drm_connector_status status)
{
 ...
 for (i = 0; i < 3; i++) {
  ...
  encoder = ({ __typeof( ((struct drm_encoder *)0)->base ) *__mptr = (obj); (struct drm_encoder *)( (char *)__mptr - __builtin_offsetof(struct drm_encoder, base) );});
...
static struct drm_encoder *radeon_find_encoder(struct drm_connector *connector, int encoder_type)
{
 ...
 for (i = 0; i < 3; i++) {
  ...
  obj = drm_mode_object_find(connector->dev, connector->encoder_ids[i], 0xe0e0e0e0);
  if (!obj)
   continue;
...
static struct drm_encoder *radeon_best_single_encoder(struct drm_connector *connector)
{
 ...
 if (enc_id) {
  obj = drm_mode_object_find(connector->dev, enc_id, 0xe0e0e0e0);
  if (!obj)
   return ((void *)0);
  encoder = ({ __typeof( ((struct drm_encoder *)0)->base ) *__mptr = (obj); (struct drm_encoder *)( (char *)__mptr - __builtin_offsetof(struct drm_encoder, base) );});
  return encoder;
            ...
            _Bool priority)
{
 ...
 for (conflict = ({ __typeof( ((__typeof(*conflict) *)0)->head ) *__mptr = ((&dev->mode_config.connector_list)->next); (__typeof(*conflict) *)( (char *)__mptr - __builtin_offsetof(__typeof(*conflict), head) );}); &conflict->head != (&dev->mode_config.connector_list); conflict = ({ __typeof( ((__typeof(*conflict) *)0)->head ) *__mptr = (conflict->head.next); (__typeof(*conflict) *)( (char *)__mptr - __builtin_offsetof(__typeof(*conflict), head) );})) {
  if (conflict == connector)
   continue;

  radeon_conflict = ({ __typeof( ((struct radeon_connector *)0)->base ) *__mptr = (conflict); (struct radeon_connector *)( (char *)__mptr - __builtin_offsetof(struct radeon_connector, base) );});
  for (i = 0; i < 3; i++) {
...
static struct drm_display_mode *radeon_fp_native_mode(struct drm_encoder *encoder)
{
 ...
 if (native_mode->hdisplay != 0 &&
  ...
  mode = drm_cvt_mode(dev, native_mode->hdisplay, native_mode->vdisplay, 60, 1, 0, 0);
  mode->type = (1<<3) | (1<<6);
  do { } while( 0);
 }
 return mode;
      ...
      uint64_t val)
{
 ...
 if (property == rdev->mode_info.coherent_mode_property) {
  ...
  _Bool new_coherent_mode;


  encoder = radeon_find_encoder(connector, 2);
  if (!encoder)
   return 0;
 ...
 if (property == rdev->mode_info.tv_std_property) {
  encoder = radeon_find_encoder(connector, 4);
  if (!encoder) {
   encoder = radeon_find_encoder(connector, 1);
  }
 ...
 for (mode = ({ __typeof( ((__typeof(*mode) *)0)->head ) *__mptr = ((&connector->probed_modes)->next); (__typeof(*mode) *)( (char *)__mptr - __builtin_offsetof(__typeof(*mode), head) );}), t = ({ __typeof( ((__typeof(*mode) *)0)->head ) *__mptr = (mode->head.next); (__typeof(*mode) *)( (char *)__mptr - __builtin_offsetof(__typeof(*mode), head) );}); &mode->head != (&connector->probed_modes); mode = t, t = ({ __typeof( ((__typeof(*t) *)0)->head ) *__mptr = (t->head.next); (__typeof(*t) *)( (char *)__mptr - __builtin_offsetof(__typeof(*t), head) );})) {
  if (mode->type & (1<<3)) {
   if (mode->hdisplay != native_mode->hdisplay ||
    ...
    __builtin_memcpy((native_mode), (mode), (sizeof(*mode)));
  }
 }
 ...
 if (!native_mode->clock) {
  for (mode = ({ __typeof( ((__typeof(*mode) *)0)->head ) *__mptr = ((&connector->probed_modes)->next); (__typeof(*mode) *)( (char *)__mptr - __builtin_offsetof(__typeof(*mode), head) );}), t = ({ __typeof( ((__typeof(*mode) *)0)->head ) *__mptr = (mode->head.next); (__typeof(*mode) *)( (char *)__mptr - __builtin_offsetof(__typeof(*mode), head) );}); &mode->head != (&connector->probed_modes); mode = t, t = ({ __typeof( ((__typeof(*t) *)0)->head ) *__mptr = (t->head.next); (__typeof(*t) *)( (char *)__mptr - __builtin_offsetof(__typeof(*t), head) );})) {
   if (mode->hdisplay == native_mode->hdisplay &&
       mode->vdisplay == native_mode->vdisplay) {
    *native_mode = *mode;
    drm_mode_set_crtcinfo(native_mode, (1 << 0));
    do { } while( 0);
    break;
   }
  }
...
static enum drm_connector_status
radeon_lvds_detect(struct drm_connector *connector, _Bool force)
{
 struct radeon_connector *radeon_connector = ({ __typeof( ((struct radeon_connector *)0)->base ) *__mptr = (connector); (struct radeon_connector *)( (char *)__mptr - __builtin_offsetof(struct radeon_connector, base) );});
 struct drm_encoder *encoder = radeon_best_single_encoder(connector);
        ...
        uint64_t value)
{
 ...
 if (connector->encoder)
  radeon_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (connector->encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 else {
  const struct drm_connector_helper_funcs *connector_funcs = connector->helper_private;
  radeon_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (connector_funcs->best_encoder(connector)); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 }

 switch (value) {
 case 0: rmx_type = RMX_OFF; break;
 case 2: rmx_type = RMX_CENTER; break;
 case 3: rmx_type = RMX_ASPECT; break;
 default:
 case 1: rmx_type = RMX_FULL; break;
 }
...
static enum drm_connector_status
radeon_vga_detect(struct drm_connector *connector, _Bool force)
{
 struct drm_device *dev = connector->dev;
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_connector *radeon_connector = ({ __typeof( ((struct radeon_connector *)0)->base ) *__mptr = (connector); (struct radeon_connector *)( (char *)__mptr - __builtin_offsetof(struct radeon_connector, base) );});
 ...
 if (dret) {
  ...
  if (!radeon_connector->edid) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "%s: probed a monitor but no|invalid EDID\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , connector->name);

   ret = connector_status_connected;
  } else {
   radeon_connector->use_digital = !!(radeon_connector->edid->input & (1 << 7));
...
static enum drm_connector_status
radeon_tv_detect(struct drm_connector *connector, _Bool force)
{
 struct drm_encoder *encoder;
 const struct drm_encoder_helper_funcs *encoder_funcs;
 struct radeon_connector *radeon_connector = ({ __typeof( ((struct radeon_connector *)0)->base ) *__mptr = (connector); (struct radeon_connector *)( (char *)__mptr - __builtin_offsetof(struct radeon_connector, base) );});
...
static _Bool radeon_check_hpd_status_unchanged(struct drm_connector *connector)
{
 struct drm_device *dev = connector->dev;
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_connector *radeon_connector = ({ __typeof( ((struct radeon_connector *)0)->base ) *__mptr = (connector); (struct radeon_connector *)( (char *)__mptr - __builtin_offsetof(struct radeon_connector, base) );});
...
# 934 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_connectors.c"
static enum drm_connector_status
radeon_dvi_detect(struct drm_connector *connector, _Bool force)
{
 struct drm_device *dev = connector->dev;
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_connector *radeon_connector = ({ __typeof( ((struct radeon_connector *)0)->base ) *__mptr = (connector); (struct radeon_connector *)( (char *)__mptr - __builtin_offsetof(struct radeon_connector, base) );});
 ...
 if (dret) {
  ...
  if (!radeon_connector->edid) {
   ...
   if ((rdev->family == CHIP_RS690 || rdev->family == CHIP_RS740) && radeon_connector->base.null_edid_counter) {
    ret = connector_status_disconnected;
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "%s: detected RS690 floating bus bug, stopping ddc detect\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , connector->name);
    radeon_connector->ddc_bus = ((void *)0);
   } else {
    ret = connector_status_connected;
    broken_edid = 1;
   }
   ...
   if (radeon_connector->shared_ddc && (ret == connector_status_connected)) {
    ...
    for (list_connector = ({ __typeof( ((__typeof(*list_connector) *)0)->head ) *__mptr = ((&dev->mode_config.connector_list)->next); (__typeof(*list_connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*list_connector), head) );}); &list_connector->head != (&dev->mode_config.connector_list); list_connector = ({ __typeof( ((__typeof(*list_connector) *)0)->head ) *__mptr = (list_connector->head.next); (__typeof(*list_connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*list_connector), head) );})) {
     if (connector == list_connector)
      continue;
     list_radeon_connector = ({ __typeof( ((struct radeon_connector *)0)->base ) *__mptr = (list_connector); (struct radeon_connector *)( (char *)__mptr - __builtin_offsetof(struct radeon_connector, base) );});
 ...
 if ((ret == connector_status_connected) && (radeon_connector->use_digital == 1))
  goto out;
 ...
 if ((ret == connector_status_connected) && (radeon_connector->use_digital == 0) &&
     encoder) {
  ret = radeon_connector_analog_encoder_conflict_solve(connector, encoder, ret, 1);
 }
      ...
      struct drm_display_mode *mode)
{
 ...
 if (radeon_connector->use_digital && (mode->clock > 165000)) {
  if ((radeon_connector->connector_object_id == 0x02) ||
      (radeon_connector->connector_object_id == 0x04) ||
      (radeon_connector->connector_object_id == 0x0D))
   return MODE_OK;
  else if (radeon_connector->connector_object_id == 0x0C) {
...
_Bool radeon_connector_encoder_is_hbr2(struct drm_connector *connector)
{
 struct drm_mode_object *obj;
 struct drm_encoder *encoder;
 struct radeon_encoder *radeon_encoder;
...
_Bool radeon_connector_is_dp12_capable(struct drm_connector *connector)
{
 struct drm_device *dev = connector->dev;
 struct radeon_device *rdev = dev->dev_private;
...
static enum drm_connector_status
radeon_dp_detect(struct drm_connector *connector, _Bool force)
{
 struct drm_device *dev = connector->dev;
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_connector *radeon_connector = ({ __typeof( ((struct radeon_connector *)0)->base ) *__mptr = (connector); (struct radeon_connector *)( (char *)__mptr - __builtin_offsetof(struct radeon_connector, base) );});
 ...
 if ((connector->connector_type == 14) ||
  ...
  radeon_dig_connector->dp_sink_type = 0x13;
  if (!radeon_dig_connector->edp_on)
   atombios_set_edp_panel_power(connector,
           12);
  ...
  if ((rdev)->asic->hpd.sense((rdev), (radeon_connector->hpd.hpd))) {
   ret = connector_status_connected;
   if (radeon_dig_connector->dp_sink_type == 0x13)
    radeon_dp_getdpcd(radeon_connector);
  } else {
   if (radeon_dig_connector->dp_sink_type == 0x13) {
    if (radeon_dp_getdpcd(radeon_connector))
      ...
      struct drm_display_mode *mode)
{
 ...
 if ((connector->connector_type == 14) ||
  ...
  if ((radeon_dig_connector->dp_sink_type == 0x13) ||
      (radeon_dig_connector->dp_sink_type == 0x14))
     ...
     struct radeon_router *router)
{
 ...
 for (connector = ({ __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = ((&dev->mode_config.connector_list)->next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );}); &connector->head != (&dev->mode_config.connector_list); connector = ({ __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = (connector->head.next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );})) {
  ...
  if (radeon_connector->ddc_bus && i2c_bus->valid) {
   if (radeon_connector->ddc_bus->rec.i2c_id == i2c_bus->i2c_id) {
    radeon_connector->shared_ddc = 1;
    shared_ddc = 1;
   }
   if (radeon_connector->router_bus && router->ddc_valid &&
       (radeon_connector->router.router_id == router->router_id)) {
    radeon_connector->shared_ddc = 0;
    shared_ddc = 0;
   }
  }
 }
 ...
 radeon_connector = kzalloc(sizeof(struct radeon_connector), (0x0001 | 0x0004));
 if (!radeon_connector)
  return;
 ...
 if (router->ddc_valid || router->cd_valid) {
  ...
  if (!radeon_connector->router_bus)
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to assign router i2c bus! Check dmesg for i2c errors.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 }

 if (is_dp_bridge) {
  radeon_dig_connector = kzalloc(sizeof(struct radeon_connector_atom_dig), (0x0001 | 0x0004));
  ...
  if (i2c_bus->valid) {
   ...
   if (radeon_connector->ddc_bus)
    ...
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "DP: Failed to assign ddc bus! Check dmesg for i2c errors.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  }
  ...
  case 1:
   ...
   if (i2c_bus->valid) {
    radeon_connector->ddc_bus = radeon_i2c_lookup(rdev, i2c_bus);
    if (!radeon_connector->ddc_bus)
     printf("error: [" "drm" ":pid%d:%s] *ERROR* " "VGA: Failed to assign ddc bus! Check dmesg for i2c errors.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   }
   radeon_connector->dac_load_detect = 1;
   drm_object_attach_property(&radeon_connector->base.base,
            rdev->mode_info.load_detect_property,
  ...
  case 4:
   ...
   if (i2c_bus->valid) {
    radeon_connector->ddc_bus = radeon_i2c_lookup(rdev, i2c_bus);
    if (!radeon_connector->ddc_bus)
     printf("error: [" "drm" ":pid%d:%s] *ERROR* " "DVIA: Failed to assign ddc bus! Check dmesg for i2c errors.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   }
   radeon_connector->dac_load_detect = 1;
   drm_object_attach_property(&radeon_connector->base.base,
            rdev->mode_info.load_detect_property,
  ...
  case 3:
   ...
   if (i2c_bus->valid) {
    radeon_connector->ddc_bus = radeon_i2c_lookup(rdev, i2c_bus);
    if (!radeon_connector->ddc_bus)
     printf("error: [" "drm" ":pid%d:%s] *ERROR* " "DVI: Failed to assign ddc bus! Check dmesg for i2c errors.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   }
   subpixel_order = SubPixelHorizontalRGB;
   drm_object_attach_property(&radeon_connector->base.base,
  ...
  case 12:
   ...
   if (i2c_bus->valid) {
    radeon_connector->ddc_bus = radeon_i2c_lookup(rdev, i2c_bus);
    if (!radeon_connector->ddc_bus)
     printf("error: [" "drm" ":pid%d:%s] *ERROR* " "HDMI: Failed to assign ddc bus! Check dmesg for i2c errors.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   }
   drm_object_attach_property(&radeon_connector->base.base,
            rdev->mode_info.coherent_mode_property,
            1);
  ...
  case 7:
   ...
   if (i2c_bus->valid) {
    radeon_connector->ddc_bus = radeon_i2c_lookup(rdev, i2c_bus);
    if (!radeon_connector->ddc_bus)
     printf("error: [" "drm" ":pid%d:%s] *ERROR* " "LVDS: Failed to assign ddc bus! Check dmesg for i2c errors.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   }
   drm_object_attach_property(&radeon_connector->base.base,
            dev->mode_config.scaling_mode_property,
            1);
