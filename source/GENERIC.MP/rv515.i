      ...
      _Bool low)
{
 ...
 if ((rdev->family >= CHIP_RV610) &&
  ...
  selected_sclk = rdev->asic->dpm.get_sclk((rdev), (low));
 else
  selected_sclk = rdev->pm.current_sclk;
 a.full = (u32)(((100) << 12));
 sclk.full = (u32)(((selected_sclk) << 12));
     ...
     u32 *d2mode_priority_a_cnt)
{
 ...
 fixed20_12 a, b;
 *d1mode_priority_a_cnt = (1 << 16);
 *d2mode_priority_a_cnt = (1 << 16);
 if (mode0 && mode1) {
...
void rv515_bandwidth_avivo_update(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x654C), (d1mode_priority_b_cnt), 0);
 r100_mm_wreg(rdev, (0x6D48), (d2mode_priority_a_cnt), 0);
 r100_mm_wreg(rdev, (0x6D4C), (d2mode_priority_b_cnt), 0);
}
void rv515_bandwidth_update(struct radeon_device *rdev)
{
 uint32_t tmp;
