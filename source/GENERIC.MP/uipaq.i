# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c"
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c"
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c" 2
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c"
struct uipaq_softc {
...
uipaq_match(struct device *parent, void *match, void *aux)
{
 ...
 return (((struct uipaq_type *)usbd_match_device((const struct usb_devno *)(uipaq_devs), sizeof (uipaq_devs) / sizeof ((uipaq_devs)[0]), sizeof ((uipaq_devs)[0]), (uaa->vendor), (uaa->product))) != ((void *)0) ?
     13 : 0);
}
...
uipaq_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_flags = ((struct uipaq_type *)usbd_match_device((const struct usb_devno *)(uipaq_devs), sizeof (uipaq_devs) / sizeof ((uipaq_devs)[0]), sizeof ((uipaq_devs)[0]), (uaa->vendor), (uaa->product)))->uv_flags;
 ...
 uca.portno = -1;
 uca.info = "Generic";
# 200 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uipaq.c"
...
uipaq_dtr(struct uipaq_softc* sc, int onoff)
{
 ...
 req.bRequest = 0x22;
 sc->sc_lcr = onoff ? sc->sc_lcr | 0x0001 : sc->sc_lcr & ~0x0001;
 ((req.wValue)[0] = (u_int8_t)(sc->sc_lcr), (req.wValue)[1] = (u_int8_t)((sc->sc_lcr) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0x0), (req.wIndex)[1] = (u_int8_t)((0x0) >> 8));
...
uipaq_rts(struct uipaq_softc* sc, int onoff)
{
 ...
 if (onoff && (sc->sc_lcr & 0x0002)) return;
 if (!onoff && !(sc->sc_lcr & 0x0002)) return;

 req.bmRequestType = (0x00 | 0x20 | 0x01);
 req.bRequest = 0x22;
 sc->sc_lcr = onoff ? sc->sc_lcr | 0x0002 : sc->sc_lcr & ~0x0002;
 ((req.wValue)[0] = (u_int8_t)(sc->sc_lcr), (req.wValue)[1] = (u_int8_t)((sc->sc_lcr) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0x0), (req.wIndex)[1] = (u_int8_t)((0x0) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
...
void
uipaq_set(void *addr, int portno, int reg64, int onoff)
{
 ...
 default:
  printf("%s: unhandled set request: reg=%x onoff=%x\n",
      sc->sc_dev.dv_xname, reg64, onoff);
  return;
 }
}
