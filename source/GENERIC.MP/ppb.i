# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcivar.h" 1
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcivar.h"
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppbreg.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c" 2
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c"
struct ppb_softc {
 struct device sc_dev;
 pci_chipset_tag_t sc_pc;
 pcitag_t sc_tag;
...
ppbmatch(struct device *parent, void *match, void *aux)
{
 ...
 if ((((pa->pa_id) >> 0) & 0xffff) == 0x1106 &&
     (((pa->pa_id) >> 16) & 0xffff) == 0x3040)
  return (0);
...
ppbattach(struct device *parent, struct device *self, void *aux)
{
 ...
 busdata = pci_conf_read(pc, pa->pa_tag, 0x18);
...
# 192 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c"
 sec = ((busdata >> 8) & 0xff);
 sub = ((busdata >> 16) & 0xff);
 if (sub > sec) {
  name = malloc(32, 2, 0x0002);
  if (name) {
   snprintf(name, 32, "%s pcibus", sc->sc_dev.dv_xname);
   sc->sc_busex = extent_create(name, 0, 0xff,
       2, ((void *)0), 0, 0x0000 | 0x0100);
 ...
 if (pci_get_capability(pc, pa->pa_tag, 0x10,
     &sc->sc_cap_off, &reg64) && (reg64 & 0x01000000)) {
  ...
  if (pci_intr_map_msi(pa, &ih) == 0 ||
   ...
   sc->sc_intrhand = pci_intr_establish(pc, ih, 5,
  ...
  if (sc->sc_intrhand) {
   ...
   reg64 = pci_conf_read(pc, pa->pa_tag,
       sc->sc_cap_off + 0x18);
   reg64 |= (0x00000020 | 0x00000008);
   pci_conf_write(pc, pa->pa_tag,
       sc->sc_cap_off + 0x18, reg64);
  }
 }
 ...
 if ((((pa->pa_id) >> 0) & 0xffff) == 0x8086 &&
     ((((pa->pa_id) >> 16) & 0xffff) == 0x244e ||
     (((pa->pa_id) >> 16) & 0xffff) == 0x2448))
  interface = 0x01;

 if (interface != 0x01)
  ppb_alloc_resources(sc, pa);

 for (pin = 0x01; pin <= 0x04; pin++) {
  pa->pa_intrpin = pa->pa_rawintrpin = pin;
  pa->pa_intrline = 0;
  pci_intr_map(pa, &sc->sc_ih[pin - 0x01]);
 }
 ...
 blr = pci_conf_read(pc, pa->pa_tag, 0x1c);
 sc->sc_iobase = (blr & 0x000000f0) << 8;
 sc->sc_iolimit = (blr & 0x000f000) | 0x00000fff;
 blr = pci_conf_read(pc, pa->pa_tag, 0x30);
 ...
 if (sc->sc_iolimit > sc->sc_iobase) {
  ...
  if (name) {
   ...
   extent_free(sc->sc_ioex, sc->sc_iobase,
       sc->sc_iolimit - sc->sc_iobase + 1, 0x0000);
  }
 }


 blr = pci_conf_read(pc, pa->pa_tag, 0x20);
 ...
 blr = pci_conf_read(pc, pa->pa_tag, 0x24);
 ...
 if (interface == 0x01) {
  if (sc->sc_ioex == ((void *)0))
   sc->sc_ioex = pa->pa_ioex;
  if (sc->sc_memex == ((void *)0))
 ...
 __builtin_bzero((&pba), (sizeof(pba)));
 pba.pba_busname = "pci";
 pba.pba_iot = pa->pa_iot;
 pba.pba_memt = pa->pa_memt;
 pba.pba_dmat = pa->pa_dmat;
 pba.pba_pc = pc;
 pba.pba_flags = pa->pa_flags & ~0x08;
 pba.pba_busex = sc->sc_busex;
 pba.pba_ioex = sc->sc_ioex;
 pba.pba_memex = sc->sc_memex;
 pba.pba_pmemex = sc->sc_pmemex;
 pba.pba_domain = pa->pa_domain;
 pba.pba_bus = ((busdata >> 8) & 0xff);
 pba.pba_bridgeih = sc->sc_ih;
 pba.pba_bridgetag = &sc->sc_tag;
 pba.pba_intrswiz = pa->pa_intrswiz;
 pba.pba_intrtag = pa->pa_intrtag;

 sc->sc_psc = config_found_sm((self), (&pba), (ppbprint), ((void *)0));
}
...
ppbactivate(struct device *self, int act)
{
 ...
 case 3:
  ...
  sc->sc_bir = pci_conf_read(pc, tag, 0x18);
  sc->sc_bcr = pci_conf_read(pc, tag, 0x3c);
  sc->sc_int = pci_conf_read(pc, tag, 0x3c);
  if (sc->sc_cap_off)
   sc->sc_slcsr = pci_conf_read(pc, tag,
       sc->sc_cap_off + 0x18);

  if (pci_get_capability(pc, tag, 0x05, &off, &reg64)) {
 ...
 case 4:
  ...
  pci_conf_write(pc, tag, 0x18, sc->sc_bir);
  pci_conf_write(pc, tag, 0x3c, sc->sc_bcr);
  pci_conf_write(pc, tag, 0x3c, sc->sc_int);
  if (sc->sc_cap_off)
   pci_conf_write(pc, tag,
       sc->sc_cap_off + 0x18, sc->sc_slcsr);


  blr = pci_conf_read(pc, tag, 0x1c);
  blr &= 0xffff0000;
  blr |= sc->sc_iolimit & 0xf000;
  blr |= (sc->sc_iobase >> 8);
  pci_conf_write(pc, tag, 0x1c, blr);
  blr = (sc->sc_iobase & 0xffff0000) >> 16;
  blr |= sc->sc_iolimit & 0xffff0000;
  pci_conf_write(pc, tag, 0x30, blr);


  blr = sc->sc_memlimit & 0xfff00000;
  blr |= (sc->sc_membase >> 16);
  pci_conf_write(pc, tag, 0x20, blr);


  blr = sc->sc_pmemlimit & 0xfff00000;
  blr |= ((sc->sc_pmembase & 0xfff00000) >> 16);
  pci_conf_write(pc, tag, 0x24, blr);

  pci_conf_write(pc, tag, 0x28,
      sc->sc_pmembase >> 32);
  pci_conf_write(pc, tag, 0x2c,
      sc->sc_pmemlimit >> 32);


  if (pci_get_capability(pc, tag, 0x05, &off, &reg64)) {
   pci_conf_write(pc, tag, off + 0x04,
       sc->sc_msi_ma);
   if (reg64 & 0x00800000) {
    pci_conf_write(pc, tag, off + 0x08,
        sc->sc_msi_mau32);
    pci_conf_write(pc, tag, off + 0x0c,
        sc->sc_msi_md);
   } else {
    pci_conf_write(pc, tag, off + 0x08,
        sc->sc_msi_md);
   }
   pci_conf_write(pc, tag, off + 0x00,
       sc->sc_msi_mc);
  }
  ...
  pci_conf_write(pc, tag, 0x04,
      (reg64 & 0xffff0000) | (sc->sc_csr & 0x0000ffff));
    ...
    pcireg_t *busdata)
{
 ...
 for (busrange = 16; busrange > 0; busrange >>= 1) {
  if (extent_alloc_subregion((pa->pa_busex), (pa->pa_busex)->ex_start, (pa->pa_busex)->ex_end, (busrange), (1), (0), (0), (0x0000), (&busnum)))

   continue;
  *busdata |= pa->pa_bus;
  *busdata |= (busnum << 8);
  *busdata |= ((busnum + busrange - 1) << 16);
  pci_conf_write(pc, pa->pa_tag, 0x18, *busdata);
  return;
 }
}
...
ppb_alloc_resources(struct ppb_softc *sc, struct pci_attach_args *pa)
{
 ...
 if (pa->pa_memex == ((void *)0))
  return;

 busdata = pci_conf_read(pc, sc->sc_tag, 0x18);
 bus = ((busdata >> 8) & 0xff);
 if (bus == 0)
  return;
 ...
 for (dev = 0; dev < pci_bus_maxdevs(pc, bus); dev++) {
  ...
  for (reg64 = reg_start; reg64 < reg_end; reg64 += 4) {
   if (pci_mapreg_probe(pc, tag, reg64, &type) == 0)
    continue;
  ...
  if (reg_rom != 0) {
   ...
   pci_conf_write(pc, tag, reg_rom, ~0x00000001);
   mask = pci_conf_read(pc, tag, reg_rom);
   pci_conf_write(pc, tag, reg_rom, addr);
   if ((((mask) & 0xfffff800) & -((mask) & 0xfffff800)))
    mem_count++;
  }
 }

 csr = pci_conf_read(pc, sc->sc_tag, 0x04);
 ...
 if ((csr & 0x00000002) == 0) {
  pci_conf_write(pc, sc->sc_tag, 0x20, 0x0000ffff);
  pci_conf_write(pc, sc->sc_tag, 0x24, 0x0000ffff);
 ...
 if (io_count > 0 && pa->pa_ioex) {
  ...
  sc->sc_iolimit = (blr & 0xf000) | 0x00000fff;
  blr = pci_conf_read(pc, sc->sc_tag, 0x30);
  sc->sc_iobase |= (blr & 0x0000ffff) << 16;
  sc->sc_iolimit |= (blr & 0xffff0000);
  if (sc->sc_iolimit < sc->sc_iobase || sc->sc_iobase == 0) {
   start = max(0, pa->pa_ioex->ex_start);
   end = min(0xffffffff, pa->pa_ioex->ex_end);
   for (size = 0x2000; size >= 4096; size >>= 1)
 ...
 if (mem_count > 0 && pa->pa_memex) {
  blr = pci_conf_read(pc, sc->sc_tag, 0x20);
  sc->sc_membase = (blr << 16) & 0xfff00000;
  sc->sc_memlimit = (blr & 0xfff00000) | 0x000fffff;
  if (sc->sc_memlimit < sc->sc_membase || sc->sc_membase == 0) {
   start = max(0, pa->pa_memex->ex_start);
   end = min(0xffffffff, pa->pa_memex->ex_end);
   for (size = 0x2000000; size >= 0x00100000; size >>= 1)
 ...
 pci_conf_write(pc, sc->sc_tag, 0x04, csr);
}
...
ppb_intr(void *arg)
{
 ...
 pcireg_t reg64;
# 712 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c"
 if (cold)
  return (0);

 reg64 = pci_conf_read(sc->sc_pc, sc->sc_tag,
     sc->sc_cap_off + 0x18);
 if (reg64 & 0x00080000) {
  if (reg64 & 0x00400000)
...
# 739 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ppb.c"
void
ppb_hotplug_insert(void *xsc)
{
 ...
 if (!(((&psc->sc_devs)->lh_first) == ((void *)0)))
  return;
...
ppb_hotplug_fixup(struct pci_attach_args *pa)
{
 ...
 bhlcr = pci_conf_read(pa->pa_pc, pa->pa_tag, 0x0c);
 switch (((((bhlcr) >> 16) & 0xff) & 0x7f)) {
 case 0:
...
ppb_hotplug_fixup_type0(pci_chipset_tag_t pc, pcitag_t tag, pcitag_t bridgetag)
{
 ...
 if ((((intr) >> 8) & 0xff) != 0x00 &&
  ...
  intr = pci_conf_read(pc, bridgetag, 0x3c);
  line = (((intr) >> 0) & 0xff);

  intr = pci_conf_read(pc, tag, 0x3c);
  intr &= ~(0xff << 0);
  intr |= line << 0;
  pci_conf_write(pc, tag, 0x3c, intr);
 }
...
ppb_hotplug_fixup_type1(pci_chipset_tag_t pc, pcitag_t tag, pcitag_t bridgetag)
{
 ...
 bir = pci_conf_read(pc, bridgetag, 0x18);
 if (((bir >> 16) & 0xff) <= ((bir >> 8) & 0xff))
  return (0);
 ...
 bir |= (bus << 8);
 bir |= (bus << 16);
 pci_conf_write(pc, tag, 0x18, bir);

 for (reg64 = 0x1c; reg64 < 0x3c; reg64 += 4) {
  val = pci_conf_read(pc, bridgetag, reg64);
  pci_conf_write(pc, tag, reg64, val);
 }
...
ppb_hotplug_rescan(void *xsc)
{
 ...
 if (psc) {
  ...
  sparc64_pci_enumerate_bus(psc, ppb_hotplug_fixup, ((void *)0));


  sparc64_pci_enumerate_bus(psc, ((void *)0), ((void *)0));
 }
}
 ...
 if (psc) {
  ...
  if (sc->sc_memex != ((void *)0)) {
   extent_alloc_region(sc->sc_memex, sc->sc_membase,
       ...
       0x0000 | 0x0080);
   extent_free(sc->sc_memex, sc->sc_membase,
       sc->sc_memlimit - sc->sc_membase + 1, 0x0000);
  }

  if (sc->sc_pmemex != ((void *)0)) {
   extent_alloc_region(sc->sc_pmemex, sc->sc_pmembase,
       sc->sc_pmemlimit - sc->sc_pmembase + 1,
       0x0000 | 0x0080);
   extent_free(sc->sc_pmemex, sc->sc_pmembase,
       sc->sc_pmemlimit - sc->sc_pmembase + 1, 0x0000);
  }
 }
}
