# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c"
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c"
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_log.c" 2
...
struct filterops logread_filtops =
 { 1, ((void *)0), filt_logrdetach, filt_logread};
...
initmsgbuf(caddr_t buf, size_t bufsize)
{
 ...
 new_bufs = bufsize - __builtin_offsetof(struct msgbuf, msg_bufc);
 if ((mbp->msg_magic != 0x063061) || (mbp->msg_bufs != new_bufs) ||
...
initconsbuf(void)
{
 ...
 consbufp = malloc((16 * 1024), 127, 0x0002|0x0008);
 if (consbufp) {
  new_bufs = (16 * 1024) - __builtin_offsetof(struct msgbuf, msg_bufc);
  consbufp->msg_magic = 0x063061;
...
logread(dev_t dev, struct uio *uio, int flag)
{
 ...
 while (mbp->msg_bufr == mbp->msg_bufx) {
  ...
  logsoftc.sc_state |= 0x08;
  error = tsleep(mbp, (22 + 1) | 0x100,
          "klog", 0);
  if (error)
   goto out;
 }
...
filt_logrdetach(struct knote *kn)
{
 ...
 s = _splraise(15);
 do { if ((&logsoftc.sc_selp.si_note)->slh_first == (kn)) { do { ((&logsoftc.sc_selp.si_note))->slh_first = ((&logsoftc.sc_selp.si_note))->slh_first->kn_selnext.sle_next; } while (0); } else { struct knote *curelm = (&logsoftc.sc_selp.si_note)->slh_first; while (curelm->kn_selnext.sle_next != (kn)) curelm = curelm->kn_selnext.sle_next; curelm->kn_selnext.sle_next = curelm->kn_selnext.sle_next->kn_selnext.sle_next; } ((kn)->kn_selnext.sle_next) = ((void *)-1); } while (0);
 _splx(s);
}
...
filt_logread(struct knote *kn, long hint)
{
 ...
 s = _splraise(15);
 kn->kn_kevent.data = (int)(p->msg_bufx - p->msg_bufr);
...
logwakeup(void)
{
 ...
 if (logsoftc.sc_state & 0x04)
  csignal(logsoftc.sc_pgid, 23,
      logsoftc.sc_siguid, logsoftc.sc_sigeuid);
 if (logsoftc.sc_state & 0x08) {
  wakeup(msgbufp);
  logsoftc.sc_state &= ~0x08;
 }
}
    ...
    enum uio_seg sflg)
{
 ...
 if (fp)
  ...
  len = (((nbyte)<(sizeof(pri)))?(nbyte):(sizeof(pri)));
  if (sflg == UIO_USERSPACE) {
   if ((error = copyin(buf, pri, len)))
    return (error);
  } else
   __builtin_memcpy((pri), (buf), (len));
  if (0 < len && pri[0] == '<') {
   for (i = 1; i < len; i++) {
    if (pri[i] < '0' || pri[i] > '9')
     break;
 ...
 len = auio.uio_resid;
 if (fp) {
  error = sosend(fp->f_data, ((void *)0), &auio, ((void *)0), ((void *)0), 0);
  if (error == 0)
   len -= auio.uio_resid;
