# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c" 2

int ffs_indirtrunc(struct inode *, daddr_t, daddr_t, daddr_t, int, long *);
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c"
int
ffs_update(struct inode *ip, int waitfor)
{
 ...
 if ((ip->i_flag & 0x0008) == 0 && waitfor == 0)
  return (0);

 ip->i_flag &= ~(0x0008 | 0x0080);
 fs = ip->inode_u.fs;
 ...
 if (fs->fs_magic == 0x011954 && fs->fs_inodefmt < 2) {
  ip->dinode_u.ffs1_din->di_u.oldids[0] = ip->dinode_u.ffs1_din->di_uid;
  ip->dinode_u.ffs1_din->di_u.oldids[1] = ip->dinode_u.ffs1_din->di_gid;
 }

 error = bread(ip->i_ump->um_devvp, ((((daddr_t)(((((daddr_t)(fs)->fs_fpg * (((ip->i_number) / (fs)->fs_ipg))) + (fs)->fs_cgoffset * ((((ip->i_number) / (fs)->fs_ipg)) & ~((fs)->fs_cgmask))) + (fs)->fs_iblkno) + ((((((ip->i_number) % (fs)->fs_ipg) / ((fs)->fs_inopb))) << ((fs))->fs_fragshift))))) << (fs)->fs_fsbtodb),
     (int)fs->fs_bsize, &bp);
 if (error) {
  brelse(bp);
  return (error);
 ...
 else if (ip->i_effnlink != (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_nlink : (ip)->dinode_u.ffs2_din->di_nlink))
 ...
 if (waitfor && !((vp)->v_mount->mnt_flag & 0x00000040)) {
  return (bwrite(bp));
 } else {
  bdwrite(bp);
  return (0);
...
# 128 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c"
int
ffs_truncate(struct inode *oip, off_t length, int flags, struct ucred *cred)
{
 struct vnode *ovp;
 daddr_t lastblock;
 daddr_t bn, lbn, lastiblock[3], indir_lbn[3];
 daddr_t oldblks[12 + 3], newblks[12 + 3];
 struct fs *fs;
 struct buf *bp;
 ...
 if ((((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_size : (oip)->dinode_u.ffs2_din->di_size) == length)
  return (0);

 if (ovp->v_type == VLNK &&
     ((((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_size : (oip)->dinode_u.ffs2_din->di_size) < oip->i_ump->um_maxsymlinklen ||
      (oip->i_ump->um_maxsymlinklen == 0 &&
       oip->dinode_u.ffs1_din->di_blocks == 0))) {

  if (length != 0)
   panic("ffs_truncate: partial truncate of symlink");

  __builtin_memset(((((oip)->i_ump->um_fstype == 1) ? (caddr_t)(oip)->dinode_u.ffs1_din->di_db : (caddr_t)(oip)->dinode_u.ffs2_din->di_db)), (0), ((size_t) (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_size : (oip)->dinode_u.ffs2_din->di_size)));
  do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_size = (0); else (oip)->dinode_u.ffs2_din->di_size = (0); } while (0);
  oip->i_flag |= 0x0002 | 0x0004;
  return (((oip)->i_vtbl->iv_update)((oip), (1)));
 }
 ...
 if (((ovp)->v_mount->mnt_flag & 0x04000000)) {
  if (length > 0 || softdep_slowdown(ovp)) {
# 186 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c"
   if ((error = VOP_FSYNC(ovp, cred, 1,
            (__curcpu->ci_self)->ci_curproc)) != 0)
    return (error);
  } else {
   (void)ufs_quota_free_blocks2(oip, (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_blocks : (oip)->dinode_u.ffs2_din->di_blocks), ((struct ucred *)-1), 0);

   softdep_setup_freeblocks(oip, length);
   (void) vinvalbuf(ovp, 0, cred, (__curcpu->ci_self)->ci_curproc, 0, 0);
   oip->i_flag |= 0x0002 | 0x0004;
   return (((oip)->i_vtbl->iv_update)((oip), (0)));
  }
 }

 fs = oip->inode_u.fs;
 osize = (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_size : (oip)->dinode_u.ffs2_din->di_size);
 ...
 if (osize < length) {
  ...
  if (flags & 0x04)
   aflags |= 0x02;
  error = ((oip)->i_vtbl->iv_buf_alloc)((oip), (length - 1), (1), (cred), (aflags), (&bp));

  if (error)
   return (error);
  do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_size = (length); else (oip)->dinode_u.ffs2_din->di_size = (length); } while (0);
  uvm_vnp_setsize(ovp, length);
 ...
 uvm_vnp_setsize(ovp, length);
# 236 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c"
 offset = ((length) & (fs)->fs_qbmask);
 if (offset == 0) {
  do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_size = (length); else (oip)->dinode_u.ffs2_din->di_size = (length); } while (0);
 } else {
  lbn = ((length) >> (fs)->fs_bshift);
  aflags = 0x01;
  if (flags & 0x04)
   aflags |= 0x02;
  error = ((oip)->i_vtbl->iv_buf_alloc)((oip), (length - 1), (1), (cred), (aflags), (&bp));
  ...
  if (error)
   return (error);
# 256 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c"
  if (((ovp)->v_mount->mnt_flag & 0x04000000) && lbn < 12 &&
      (((((length) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask) < fs->fs_bsize &&
      (error = VOP_FSYNC(ovp, cred, 1, (__curcpu->ci_self)->ci_curproc)) != 0)
   return (error);
  do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_size = (length); else (oip)->dinode_u.ffs2_din->di_size = (length); } while (0);
  size = (((lbn) >= 12 || ((((oip))->i_ump->um_fstype == 1) ? ((oip))->dinode_u.ffs1_din->di_size : ((oip))->dinode_u.ffs2_din->di_size) >= ((lbn) + 1) << (fs)->fs_bshift) ? (u_int64_t)(fs)->fs_bsize : ((((((((((oip))->i_ump->um_fstype == 1) ? ((oip))->dinode_u.ffs1_din->di_size : ((oip))->dinode_u.ffs2_din->di_size)) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask)));
  (void) uvm_vnp_uncache(ovp);
  if (ovp->v_type != VDIR)
 ...
 lastblock = ((length + fs->fs_bsize - 1) >> (fs)->fs_bshift) - 1;
 lastiblock[0] = lastblock - 12;
 lastiblock[1] = lastiblock[0] - ((fs)->fs_nindir);
 lastiblock[2] = lastiblock[1] - ((fs)->fs_nindir) * ((fs)->fs_nindir);
 ...
 for (level = 2; level >= 0; level--) {
  oldblks[12 + level] = (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_ib[level] : (oip)->dinode_u.ffs2_din->di_ib[level]);
  if (lastiblock[level] < 0) {
   do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_ib[level] = (0); else (oip)->dinode_u.ffs2_din->di_ib[level] = (0); } while (0);
   lastiblock[level] = -1;
  }
 }

 for (i = 0; i < 12; i++) {
  oldblks[i] = (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_db[i] : (oip)->dinode_u.ffs2_din->di_db[i]);
  if (i > lastblock)
   do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_db[i] = (0); else (oip)->dinode_u.ffs2_din->di_db[i] = (0); } while (0);
 }

 oip->i_flag |= 0x0002 | 0x0004;
 if ((error = ((oip)->i_vtbl->iv_update)((oip), (1))) != 0)
  allerror = error;
 ...
 for (i = 0; i < 12; i++) {
  newblks[i] = (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_db[i] : (oip)->dinode_u.ffs2_din->di_db[i]);
  do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_db[i] = (oldblks[i]); else (oip)->dinode_u.ffs2_din->di_db[i] = (oldblks[i]); } while (0);
 }

 for (i = 0; i < 3; i++) {
  newblks[12 + i] = (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_ib[i] : (oip)->dinode_u.ffs2_din->di_ib[i]);
  do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_ib[i] = (oldblks[12 + i]); else (oip)->dinode_u.ffs2_din->di_ib[i] = (oldblks[12 + i]); } while (0);
 }

 do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_size = (osize); else (oip)->dinode_u.ffs2_din->di_size = (osize); } while (0);
 ...
 indir_lbn[0] = -12;
 indir_lbn[1] = indir_lbn[0] - ((fs)->fs_nindir) - 1;
 indir_lbn[2] = indir_lbn[1] - ((fs)->fs_nindir) * ((fs)->fs_nindir) - 1;
 for (level = 2; level >= 0; level--) {
  bn = (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_ib[level] : (oip)->dinode_u.ffs2_din->di_ib[level]);
  if (bn != 0) {
   error = ffs_indirtrunc(oip, indir_lbn[level],
       ((bn) << (fs)->fs_fsbtodb), lastiblock[level], level, &count);
   if (error)
    allerror = error;
 ...
 for (i = 12 - 1; i > lastblock; i--) {
  ...
  bn = (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_db[i] : (oip)->dinode_u.ffs2_din->di_db[i]);
  if (bn == 0)
   continue;

  do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_db[i] = (0); else (oip)->dinode_u.ffs2_din->di_db[i] = (0); } while (0);
  bsize = (((i) >= 12 || ((((oip))->i_ump->um_fstype == 1) ? ((oip))->dinode_u.ffs1_din->di_size : ((oip))->dinode_u.ffs2_din->di_size) >= ((i) + 1) << (fs)->fs_bshift) ? (u_int64_t)(fs)->fs_bsize : ((((((((((oip))->i_ump->um_fstype == 1) ? ((oip))->dinode_u.ffs1_din->di_size : ((oip))->dinode_u.ffs2_din->di_size)) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask)));
 ...
 bn = (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_db[lastblock] : (oip)->dinode_u.ffs2_din->di_db[lastblock]);
 if (bn != 0) {
  ...
  oldspace = (((lastblock) >= 12 || ((((oip))->i_ump->um_fstype == 1) ? ((oip))->dinode_u.ffs1_din->di_size : ((oip))->dinode_u.ffs2_din->di_size) >= ((lastblock) + 1) << (fs)->fs_bshift) ? (u_int64_t)(fs)->fs_bsize : ((((((((((oip))->i_ump->um_fstype == 1) ? ((oip))->dinode_u.ffs1_din->di_size : ((oip))->dinode_u.ffs2_din->di_size)) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask)));
  do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_size = (length); else (oip)->dinode_u.ffs2_din->di_size = (length); } while (0);
  newspace = (((lastblock) >= 12 || ((((oip))->i_ump->um_fstype == 1) ? ((oip))->dinode_u.ffs1_din->di_size : ((oip))->dinode_u.ffs2_din->di_size) >= ((lastblock) + 1) << (fs)->fs_bshift) ? (u_int64_t)(fs)->fs_bsize : ((((((((((oip))->i_ump->um_fstype == 1) ? ((oip))->dinode_u.ffs1_din->di_size : ((oip))->dinode_u.ffs2_din->di_size)) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask)));
  if (newspace == 0)
  ...
  if (oldspace - newspace > 0) {
   ...
   bn += ((newspace) >> (fs)->fs_fshift);
   ffs_blkfree(oip, bn, oldspace - newspace);
   blocksreleased += ((oldspace - newspace) >> 9);
  }
 }
done:

 for (level = 0; level <= 2; level++)
  if (newblks[12 + level] != (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_ib[level] : (oip)->dinode_u.ffs2_din->di_ib[level]))
   panic("ffs_truncate1");
 for (i = 0; i < 12; i++)
  if (newblks[i] != (((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_db[i] : (oip)->dinode_u.ffs2_din->di_db[i]))
   panic("ffs_truncate2");
 ...
 do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_size = (length); else (oip)->dinode_u.ffs2_din->di_size = (length); } while (0);
 if ((((oip)->i_ump->um_fstype == 1) ? (oip)->dinode_u.ffs1_din->di_blocks : (oip)->dinode_u.ffs2_din->di_blocks) >= blocksreleased)
  do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_blocks += (-blocksreleased); else (oip)->dinode_u.ffs2_din->di_blocks += (-blocksreleased); } while (0);
 else
  do { if ((oip)->i_ump->um_fstype == 1) (oip)->dinode_u.ffs1_din->di_blocks = (0); else (oip)->dinode_u.ffs2_din->di_blocks = (0); } while (0);
 oip->i_flag |= 0x0002;
 (void)ufs_quota_free_blocks2(oip, blocksreleased, ((struct ucred *)-1), 0);
 return (allerror);
}
# 442 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c"
int
    ...
    daddr_t lastbn, int level, long *countp)
{
 ...
 if (lastbn > 0)
  last /= factor;
 nblocks = ((fs->fs_bsize) >> 9);
# 480 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_inode.c"
 vp = ((ip)->i_vnode);
 ...
 if (lastbn != -1) {
  copy = malloc(fs->fs_bsize, 127, 0x0001);
  __builtin_memcpy((copy), (bp->b_data), (fs->fs_bsize));

  for (i = last + 1; i < ((fs)->fs_nindir); i++)
   do { if ((ip)->i_ump->um_fstype == 2) bap2[i] = (0); else bap1[i] = (0); } while (0);

  if (!((vp)->v_mount->mnt_flag & 0x00000040)) {
   error = bwrite(bp);
   if (error)
    allerror = error;
  } else {
 ...
 for (i = ((fs)->fs_nindir) - 1, nlbn = lbn + 1 - i * factor; i > last;
     i--, nlbn += factor) {
  nb = (((ip)->i_ump->um_fstype == 2) ? bap2[i] : bap1[i]);
  if (nb == 0)
   continue;
  if (level > 0) {
   error = ffs_indirtrunc(ip, nlbn, ((nb) << (fs)->fs_fsbtodb),
            -1, level - 1, &blkcount);
   if (error)
    allerror = error;
