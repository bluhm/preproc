# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_srp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_srp.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_srp.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_srp.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_srp.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_srp.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_srp.c" 2
...
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_srp.c" 2
...
srp_v_referenced(struct srp *srp, void *v)
{
 ...
 for (cii = 0, ci = cpus; ci != ((void *)0); ci = ci->ci_next) {
  for (i = 0; i < (sizeof((ci->ci_srp_hazards)) / sizeof((ci->ci_srp_hazards)[0])); i++) {
...
srp_v_gc_start(struct srp_gc *srp_gc, struct srp *srp, void *v)
{
 ...
 ctx = pool_get(&srp_gc_ctx_pool, 0x0001);
 ctx->srp_gc = srp_gc;
 ctx->hzrd.sh_p = srp;
 ctx->hzrd.sh_v = v;
...
{
 return (_atomic_swap_ptr(&srp->ref, v));
}
...
srp_v(struct srp_hazard *hzrd, struct srp *srp)
{
 ...
 do {
  ...
  hzrd->sh_v = v;
  __asm volatile("membar " "#LoadLoad" ::: "memory");
 } while (__builtin_expect(((v != srp->ref) != 0), 0));
...
srp_referenced(void *v)
{
 ...
 for (cii = 0, ci = cpus; ci != ((void *)0); ci = ci->ci_next) {
  for (i = 0; i < (sizeof((ci->ci_srp_hazards)) / sizeof((ci->ci_srp_hazards)[0])); i++) {
   ...
   if (hzrd->sh_p != ((void *)0) && hzrd->sh_v == v)
    return (1);
  }
 }
