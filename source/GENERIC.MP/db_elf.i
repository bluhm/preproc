# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c"
...
struct tty;
struct uio;
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.h"
typedef struct {
 const char *name;
 char *start;
 char *end;
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_sym.h" 1
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_sym.h"
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c" 2



db_symtab_t db_symtab;

Elf64_Sym *db_elf_sym_lookup(char *);
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c"
int
db_elf_sym_init(int symsize, void *symtab, void *esymtab, const char *name)
{
 ...
 if (((((unsigned long)(symtab)) & (sizeof(long) - 1)) == 0) == 0) {
  db_printf("[ %s symbol table has bad start address %p ]\n",
      name, symtab);
  return (0);
 }

 symtab_start = symtab_end = ((void *)0);
 strtab_start = strtab_end = ((void *)0);
# 96 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c"
...
# 115 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_elf.c"
 shp = (Elf64_Shdr *)((char *)symtab + elf->e_shoff);
 ...
 for (i = 0; i < elf->e_shnum; i++) {
  if (shp[i].sh_type == 2) {
   ...
   if (shp[i].sh_offset == 0)
    continue;
   symtab_start = (Elf64_Sym *)((char *)symtab +
       shp[i].sh_offset);
   symtab_end = (Elf64_Sym *)((char *)symtab +
 ...
 if (symtab_start == ((void *)0) || strtab_start == ((void *)0) ||
     ((((unsigned long)(symtab_start)) & (sizeof(long) - 1)) == 0) == 0 ||
     ((((unsigned long)(strtab_start)) & (sizeof(long) - 1)) == 0) == 0) {
 ...
 db_printf("[ using %lu bytes of %s ELF symbol table ]\n",
     (u_long)((((((char *)esymtab - (char *)symtab))+((sizeof(u_long))-1))/(sizeof(u_long)))*(sizeof(u_long))),
     name);
...
{
 Elf64_Ehdr *elf = ((Elf64_Ehdr *)((stab)->private));
 Elf64_Shdr *shp = ((Elf64_Shdr *)((stab)->private + (elf)->e_shoff));
 char *shstrtab;
 int i;
...
db_elf_sym_lookup(char *symstr)
{
 ...
 symtab_start = ((Elf64_Sym *)((stab)->start));
 symtab_end = ((Elf64_Sym *)((stab)->end));
...
{
 db_symtab_t *stab = &db_symtab;
 Elf64_Sym *rsymp, *symp, *symtab_start, *symtab_end;
...
void
db_symbol_values(Elf64_Sym *sym, char **namep, db_expr_t *valuep)
{
 db_symtab_t *stab = &db_symtab;
 Elf64_Sym *symp = (Elf64_Sym *)sym;
 char *strtab;
...
int
db_elf_line_at_pc(Elf64_Sym *cursym, char **filename,
...
db_elf_sym_forall(db_forall_func_t db_forall_func, void *arg)
{
 ...
 for (symp = symtab_start; symp < symtab_end; symp++)
  if (symp->st_name != 0) {
   suffix[1] = '\0';
   switch ((((unsigned int) symp->st_info) & 0xf)) {
   case 1:
    suffix[0] = '+';
    break;
   case 2:
