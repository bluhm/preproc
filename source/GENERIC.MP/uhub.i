# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c" 2
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c"
struct uhub_softc {
...
uhub_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (dev->depth > 5) {
  printf("%s: hub depth (%d) exceeded, hub ignored\n",
         sc->sc_dev.dv_xname, 5);
  return;
 }
# 153 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c"
 if (dev->depth != 0 && dev->speed == 4) {
 ...
 if (dev->speed == 4) {
  ...
  powerdelay = (hd.ss.bPwrOn2PwrGood * 2);
  if (!err && nports > 7)
   usbd_get_hub_ss_descriptor(dev, &hd.ss, nports);
 } else {
  err = usbd_get_hub_descriptor(dev, &hd.hs, 1);
  nports = hd.hs.bNbrPorts;
  powerdelay = (hd.hs.bPwrOn2PwrGood * 2);
  ttthink = ((hd.hs.wHubCharacteristics)[0] | ((hd.hs.wHubCharacteristics)[1] << 8)) & 0x0060;
  if (!err && nports > 7)
...
# 207 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c"
 if (nports == 0) {
  printf("%s: no ports, hub ignored\n", sc->sc_dev.dv_xname);
  goto bad;
 }

 hub = malloc(sizeof(*hub), 102, 0x0002);
 if (hub == ((void *)0))
  return;
 hub->ports = mallocarray(nports, sizeof(struct usbd_port),
     102, 0x0002);
 if (hub->ports == ((void *)0)) {
  free(hub, 102, sizeof *hub);
  return;
 }
 dev->hub = hub;
 dev->hub->hubsoftc = sc;
 ...
 if (!dev->self_powered && dev->powersrc->parent != ((void *)0) &&
 ...
 sc->sc_statusbuf = malloc(sc->sc_statuslen, 102, 0x0002);
 if (!sc->sc_statusbuf)
  goto bad;

 err = usbd_open_pipe_intr(iface, ed->bEndpointAddress,
    0x04, &sc->sc_ipipe, sc, sc->sc_statusbuf,
    sc->sc_statuslen, uhub_intr, 255);
 if (err) {
...
# 293 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c"
 if ((((sc)->sc_hub->ddesc.bDeviceProtocol) != 0x00)) {
  tts = mallocarray(((((sc)->sc_hub->ddesc.bDeviceProtocol) == 0x01) ? 1 : nports),
      sizeof (struct usbd_tt), 102, 0x0002);
  if (!tts)
   goto bad;
 }
 ...
 for (p = 0; p < nports; p++) {
  ...
  up->reattach = 0;
  if ((((sc)->sc_hub->ddesc.bDeviceProtocol) != 0x00)) {
   up->tt = &tts[(((sc)->sc_hub->ddesc.bDeviceProtocol) == 0x01) ? 0 : p];
   up->tt->hub = hub;
  } else {
   up->tt = ((void *)0);
  }
 ...
 for (port = 1; port <= nports; port++) {
  ...
  err = usbd_set_port_feature(dev, port, 8);
  if (err)
  ...
  sc->sc_status |= (1 << port);
        ...
        if (dev->powersrc->parent != ((void *)0))
  usbd_delay_ms(dev, powerdelay + 20);
 ...
 bad:
 if (sc->sc_statusbuf)
  free(sc->sc_statusbuf, 102, sc->sc_statuslen);
 if (hub) {
  if (hub->ports)
   free(hub->ports, 102, 0);
  free(hub, 102, sizeof *hub);
 }
 dev->hub = ((void *)0);
}
...
uhub_explore(struct usbd_device *dev)
{
 ...
 for (port = 1; port <= sc->sc_hub->hub->nports; port++) {
  ...
  if ((sc->sc_status & (1 << port)) || up->reattach) {
   ...
   status = ((up->status.wPortStatus)[0] | ((up->status.wPortStatus)[1] << 8));
   change = ((up->status.wPortChange)[0] | ((up->status.wPortChange)[1] << 8));
   ;
  ...
  if (up->device != ((void *)0) && up->device->hub != ((void *)0))
...
uhub_detach(struct device *self, int flags)
{
 ...
 if (hub->ports[0].tt)
  free(hub->ports[0].tt, 102, 0);
 if (sc->sc_statusbuf)
  free(sc->sc_statusbuf, 102, sc->sc_statuslen);
 if (hub->ports)
  free(hub->ports, 102, 0);
 free(hub, 102, sizeof *hub);
 sc->sc_hub->hub = ((void *)0);
...
uhub_port_connect(struct uhub_softc *sc, int port, int status, int change)
{
 ...
 usbd_clear_port_feature(sc->sc_hub, port, 16);
# 533 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uhub.c"
 if (up->device != ((void *)0)) {
 ...
 if (usbd_new_device(&sc->sc_dev, sc->sc_hub->bus, sc->sc_hub->depth + 1,
  ...
  printf("%s: device problem, disabling port %d\n", ((sc)->sc_dev.dv_xname),
      port);
  usbd_clear_port_feature(sc->sc_hub, port, 1);
