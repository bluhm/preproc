# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c"
...
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_vfsops.c" 2
...
fusefs_unmount(struct mount *mp, int mntflags, struct proc *p)
{
 ...
 fmp = ((struct fusefs_mnt *)((mp)->mnt_data));

 if (mntflags & 0x00080000)
  flags |= 0x0002;

 if ((error = vflush(mp, ((struct vnode *)((void *)0)), flags)))
  return (error);

 if (fmp->sess_init) {
  fmp->sess_init = 0;
  fbuf = fb_setup(0, 0, 26, p);
...
fusefs_root(struct mount *mp, struct vnode **vpp)
{
 ...
 if ((error = (*(mp)->mnt_op->vfs_vget)(mp, ((ino_t)1), &nvp)) != 0)
  return (error);
...
fusefs_statfs(struct mount *mp, struct statfs *sbp, struct proc *p)
{
 ...
 if (fmp->sess_init) {
  ...
  sbp->f_bavail = fbuf->FD.FD_stat.f_bavail;
  sbp->f_bfree = fbuf->FD.FD_stat.f_bfree;
  sbp->f_blocks = fbuf->FD.FD_stat.f_blocks;
  sbp->f_files = fbuf->FD.FD_stat.f_files;
  sbp->f_ffree = fbuf->FD.FD_stat.f_ffree;
  sbp->f_favail = fbuf->FD.FD_stat.f_favail;
  sbp->f_bsize = fbuf->FD.FD_stat.f_frsize;
  sbp->f_iosize = fbuf->FD.FD_stat.f_bsize;
  sbp->f_namemax = fbuf->FD.FD_stat.f_namemax;
  fb_delete(fbuf);
 } else {
  sbp->f_bavail = 0;
  sbp->f_bfree = 0;
...
retry:
 ...
 if ((*vpp = ufs_ihashget(fmp->dev, ino)) != ((struct vnode *)((void *)0)))
  return (0);
 ...
 ip = malloc(sizeof(*ip), 65, 0x0001 | 0x0008);
 _rrw_init_flags(&ip->ufs_ino.i_lock, "fuseinode", 0, ((void *)0));
 nvp->v_data = ip;
...
{
 pool_init(&fusefs_fbuf_pool, sizeof(struct fusebuf), 0, 0, 0x0001,
     "fmsg", ((void *)0));
