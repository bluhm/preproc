# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c"
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
void device_register(struct device *, void *);
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/hmevar.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/hmevar.h"
struct hme_sxd {
 struct mbuf *sd_mbuf;
 bus_dmamap_t sd_map;
};
...
struct hme_softc {
 ...
 struct hme_sxd sc_txd[256], sc_rxd[256];
...
int hme_intr(void *);
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c" 2
 ...
 void *aux;
{
 ...
 if ((((pa->pa_id) >> 0) & 0xffff) == 0x108e &&
     (((pa->pa_id) >> 16) & 0xffff) == 0x1001)
  return (1);

 return (0);
}
# 105 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c"
static const u_int8_t hme_promhdr[] = { 0x55, 0xaa };
static const u_int8_t hme_promdat[] = {
 'P', 'C', 'I', 'R',
 0x108e & 0xff, 0x108e >> 8,
 0x1001 & 0xff, 0x1001 >> 8
};
...
# 133 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c"
 epa = *hpa;
 epa.pa_tag = pci_make_tag(hpa->pa_pc, hpa->pa_bus, hpa->pa_device, 0);
 cl = pci_conf_read(epa.pa_pc, epa.pa_tag, 0x08);
 id = pci_conf_read(epa.pa_pc, epa.pa_tag, 0x00);

 if ((((cl) >> 24) & 0xff) != 0x06 ||
     (((id) >> 16) & 0xffff) != 0x1000)
  goto fail;

 if (pci_mapreg_map(&epa, 0x10, 0x00000000, 0,
     &romt, &romh, 0, &romsize, 0x20000))
  goto fail;

 bus_space_read_region_1(romt, romh, 0, buf, sizeof(buf));
 if (__builtin_bcmp((buf), (hme_promhdr), (sizeof(hme_promhdr))))
  goto fail;
 ...
 if (__builtin_bcmp((buf), (hme_promdat), (sizeof(hme_promdat))))
  goto fail;
 ...
 length = buf[0x0a] | (buf[0x0a + 1] << 8);
 if (length != 0x18 || buf[0x0c] != 0x00 ||
     buf[0x0e] != 0x00 ||
     buf[0x0f] != 0x02)
  goto fail;
 ...
 void *aux;
{
 ...
 if (pa->pa_iot)
  pa->pa_flags |= 0x01;
 csr = pci_conf_read(pa->pa_pc, pa->pa_tag, 0x04);
 if (pa->pa_memt) {
  type = 0x00000000;
  csr |= 0x00000002;
 ...
 sc->sc_pci = 1;
# 251 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c"
 if (pci_mapreg_map(pa, 0x10, type, 0,
     &hsc->hsc_memt, &hsc->hsc_memh, ((void *)0), &hsc->hsc_memsize, 0) != 0) {
...
# 284 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_hme_pci.c"
 sc->sc_burst = 16;
 ...
 hsc->hsc_ih = pci_intr_establish(pa->pa_pc, ih, 6,
     hme_intr, sc, self->dv_xname);
 if (hsc->hsc_ih == ((void *)0)) {
