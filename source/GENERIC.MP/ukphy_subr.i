# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.h" 1
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/ukphy_subr.c" 2
...
ukphy_status(struct mii_softc *phy)
{
 ...
 bmsr = (*(phy)->mii_pdata->mii_readreg)((phy)->mii_dev.dv_parent, (phy)->mii_phy, (0x01)) | (*(phy)->mii_pdata->mii_readreg)((phy)->mii_dev.dv_parent, (phy)->mii_phy, (0x01));
 if (bmsr & 0x0004)
  mii->mii_media_status |= 0x0000000000000002ULL;

 bmcr = (*(phy)->mii_pdata->mii_readreg)((phy)->mii_dev.dv_parent, (phy)->mii_phy, (0x00));
 if (bmcr & 0x0400) {
 ...
 if (bmcr & 0x1000) {
  ...
  anlpar = (*(phy)->mii_pdata->mii_readreg)((phy)->mii_dev.dv_parent, (phy)->mii_phy, (0x04)) & (*(phy)->mii_pdata->mii_readreg)((phy)->mii_dev.dv_parent, (phy)->mii_phy, (0x05));
  if ((phy->mii_flags & 0x0040) != 0 &&
      (phy->mii_extcapabilities &
       (0x1000|0x2000)) != 0) {
   gtcr = (*(phy)->mii_pdata->mii_readreg)((phy)->mii_dev.dv_parent, (phy)->mii_phy, (0x09));
   gtsr = (*(phy)->mii_pdata->mii_readreg)((phy)->mii_dev.dv_parent, (phy)->mii_phy, (0x0a));
  } else
   gtcr = gtsr = 0;

  if ((gtcr & 0x0200) && (gtsr & 0x0800))
   mii->mii_media_active |= 16|0x0000010000000000ULL;
  else if ((gtcr & 0x0100) &&
    (gtsr & 0x0400))
   mii->mii_media_active |= 16|0x0000020000000000ULL;
  else if (anlpar & 0x0100)
