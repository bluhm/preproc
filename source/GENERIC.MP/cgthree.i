# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
void device_register(struct device *, void *);
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
int ifb_ident(void *);
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/bt458reg.h" 1
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c" 2
...
# 119 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgthree.c"
...
cgthree_mmap(void *v, off_t offset, int prot)
{
 ...
 case 1:
  if (offset >= (0x04000000))
   offset -= (0x04000000);
  else if (offset >= (128 * 1024 + 128 * 1024))
   offset -= (128 * 1024 + 128 * 1024);
  else
   offset = 0;
...
cgthree_loadcmap(struct cgthree_softc *sc, u_int start, u_int ncolors)
{
 ...
 bus_space_write_4((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x00), (((start) & ~3)));
 while (--count >= 0) {
  bus_space_write_4((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x04), (sc->sc_cmap.cm_chip[cstart]));
  cstart++;
 }
}
...
cgthree_reset(struct cgthree_softc *sc)
{
 ...
 sts = bus_space_read_1((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x11));
 ctrl = bus_space_read_1((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x10));
 ...
 for (i = 0; i < (sizeof((cg3_videoctrl)) / sizeof((cg3_videoctrl)[0])); i++) {
  if (cg3_videoctrl[i].sense == 0xff ||
      (cg3_videoctrl[i].sense ==
       (sts & (0x70 | 0x0f)))) {
   for (j = 0; j < 12; j++)
    bus_space_write_1((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x14 + j), (cg3_videoctrl[i].vctrl[j]));

   ctrl &= ~(0x0c | 0x03);
   ctrl |= cg3_videoctrl[i].ctrl |
       0x20;
   bus_space_write_1((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x10), (ctrl));
   break;
  }
 }


 bus_space_write_4((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x00), (0x04));
 bus_space_barrier((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x00), sizeof(u_int32_t), (0x02));
 bus_space_write_4((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x08), (0xff));
 bus_space_barrier((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x08), sizeof(u_int32_t), (0x02));


 bus_space_write_4((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x00), (0x05));
 bus_space_barrier((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x00), sizeof(u_int32_t), (0x02));
 bus_space_write_4((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x08), (0x00));
 bus_space_barrier((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x08), sizeof(u_int32_t), (0x02));
 ...
 bus_space_write_4((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x00), (0x06));
 bus_space_barrier((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x00), sizeof(u_int32_t), (0x02));
 bus_space_write_4((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x08), ((0x00 | 0x40 | 0x30)));

 bus_space_barrier((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x08), sizeof(u_int32_t), (0x02));


 bus_space_write_4((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x00), (0x07));
 bus_space_barrier((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x00), sizeof(u_int32_t), (0x02));
 bus_space_write_4((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x08), (0x00));
 bus_space_barrier((sc)->sc_bustag, (sc)->sc_ctrl_regs, (0x08), sizeof(u_int32_t), (0x02));
}
