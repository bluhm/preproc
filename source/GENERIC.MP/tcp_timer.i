# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_fsm.h" 1
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c" 2
...
tcp_timer_init(void)
{
 ...
 if (tcp_keepidle == 0)
  tcp_keepidle = (120*60*2);

 if (tcp_keepintvl == 0)
  tcp_keepintvl = ( 75*2);

 if (tcp_maxpersistidle == 0)
  tcp_maxpersistidle = (120*60*2);

 if (tcp_delack_ticks == 0)
  tcp_delack_ticks = (hz / 5);
}
...
tcp_timer_rexmt(void *arg)
{
 ...
 if ((tp->t_flags & 0x00400000) && tp->t_inpcb &&
  ...
  tp->t_flags &= ~0x00400000;


  icmp.icmp_hun.ih_pmtu.ipm_nextmtu = tp->t_pmtud_nextmtu;
  icmp.icmp_dun.id_ip.idi_ip.ip_len = tp->t_pmtud_ip_len;
  icmp.icmp_dun.id_ip.idi_ip.ip_hl = tp->t_pmtud_ip_hl;
  icmp.icmp_dun.id_ip.idi_ip.ip_dst = tp->t_inpcb->inp_faddru.iau_a4u.inaddr;
  ...
  __builtin_bzero((&sin), (sizeof(sin)));
  sin.sin_len = sizeof(sin);
  sin.sin_family = 2;
  sin.sin_addr = tp->t_inpcb->inp_faddru.iau_a4u.inaddr;
  in_pcbnotifyall(&tcbtable, sintosa(&sin),
      tp->t_inpcb->inp_rtableid, 40, tcp_mtudisc);
  goto out;
 }
...
# 251 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c"
 if (ip_mtudisc && tp->t_inpcb &&
  ...
  case 2:
   rt = icmp_mtudisc_clone(inp->inp_faddru.iau_a4u.inaddr,
       inp->inp_rtableid);
   break;
  }
  if (rt != ((void *)0)) {

   if ((rt->rt_rmx.rmx_locks & 0x1) == 0) {
    rt->rt_rmx.rmx_locks |= 0x1;
    in_rtchange(inp, 0);
   }
...
# 304 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c"
 if (tp->t_rxtshift > 12 / 4) {
  in_losing(tp->t_inpcb);
  tp->t_rttvar += (tp->t_srtt >> 3);
  tp->t_srtt = 0;
 }
 ...
 if ((tp->t_state == 2 || tp->t_state == 3)
     && tcp_do_ecn && !(tp->t_flags & 0x00040000))
  tp->t_flags |= 0x00040000;
# 354 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c"
 {
...
tcp_timer_keep(void *arg)
{
 ...
 if ((tcp_always_keepalive ||
     tp->t_inpcb->inp_socket->so_options & 0x0008) &&
     tp->t_state <= 7) {
  if ((tcp_maxidle > 0) &&
      ((tcp_now - tp->t_rcvtime) >= tcp_keepidle + tcp_maxidle))
   goto dropit;
# 444 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_timer.c"
