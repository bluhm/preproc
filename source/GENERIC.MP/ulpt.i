# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c" 2
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c"
struct ulpt_softc {
...
# 157 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c"
...
ulpt_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 iend = (usb_interface_descriptor_t *)
     ((char *)cdesc + ((cdesc->wTotalLength)[0] | ((cdesc->wTotalLength)[1] << 8)));
 ...
 for (id = ifcd, altno = 0;
  ...
  if (id->bDescriptorType == 0x04 &&
      id->bInterfaceNumber == ifcd->bInterfaceNumber) {
   if (id->bInterfaceClass == 0x07 &&
       id->bInterfaceSubClass == 1 &&
       (id->bInterfaceProtocol == 2 ))
 ...
 if (usbd_get_quirks(dev)->uq_flags & 0x00002000) {
 ...
 sc->sc_fwdev = ((struct ulpt_fwdev *)usbd_match_device((const struct usb_devno *)(ulpt_fwdevs), sizeof (ulpt_fwdevs) / sizeof ((ulpt_fwdevs)[0]), sizeof ((ulpt_fwdevs)[0]), (uaa->vendor), (uaa->product)));
 if (sc->sc_fwdev)
  config_mountroot(self, ulpt_load_firmware);
# 351 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ulpt.c"
}
...
ulpt_detach(struct device *self, int flags)
{
 ...
 if (sc->sc_out_pipe != ((void *)0))
  usbd_abort_pipe(sc->sc_out_pipe);
 if (sc->sc_in_pipe != ((void *)0))
 ...
 vdevgone(maj, mn | 0x40 , mn | 0x40, VCHR);
...
ulpt_reset(struct ulpt_softc *sc)
{
 ...
 req.bmRequestType = (0x00 | 0x20 | 0x03);
...
{
 u_char flags = (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0xe0);
 struct ulpt_softc *sc;
 usbd_status err;
 int error;

 if ((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x1f) >= ulpt_cd.cd_ndevs)
  return (6);
 sc = ulpt_cd.cd_devs[(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x1f)];
 if (sc == ((void *)0))
  return (6);

 if (sc == ((void *)0) || sc->sc_iface == ((void *)0) || usbd_is_dying(sc->sc_udev))
  return (6);
 ...
 if (ulptusein && sc->sc_in != -1) {
  ...
  if (err) {
   ...
   sc->sc_out_pipe = ((void *)0);
   sc->sc_state = 0;
   goto done;
  }
  sc->sc_in_xfer1 = usbd_alloc_xfer(sc->sc_udev);
  sc->sc_in_xfer2 = usbd_alloc_xfer(sc->sc_udev);
  if (sc->sc_in_xfer1 == ((void *)0) || sc->sc_in_xfer2 == ((void *)0)) {
   error = 12;
   if (sc->sc_in_xfer1 != ((void *)0)) {
    usbd_free_xfer(sc->sc_in_xfer1);
    sc->sc_in_xfer1 = ((void *)0);
   }
   if (sc->sc_in_xfer2 != ((void *)0)) {
    usbd_free_xfer(sc->sc_in_xfer2);
    sc->sc_in_xfer2 = ((void *)0);
   }
   usbd_close_pipe(sc->sc_out_pipe);
   sc->sc_out_pipe = ((void *)0);
   usbd_close_pipe(sc->sc_in_pipe);
   sc->sc_in_pipe = ((void *)0);
   sc->sc_state = 0;
   goto done;
  }
  usbd_setup_xfer(sc->sc_in_xfer1, sc->sc_in_pipe, sc,
      sc->sc_junk, sizeof sc->sc_junk, 0x04,
      0, ulpt_input);
...
ulpt_statusmsg(u_char status, struct ulpt_softc *sc)
{
 ...
 status = (status ^ (0x10|0x08)) & (0x10|0x08|0x20);
 ...
 if (new & 0x10)
  ...
  log(5, "%s: out of paper\n", sc->sc_dev.dv_xname);
 else if (new & 0x08)
  log(5, "%s: output error\n", sc->sc_dev.dv_xname);
...
ulpt_do_write(struct ulpt_softc *sc, struct uio *uio, int flags)
{
 ...
 if (xfer == ((void *)0))
  return (12);
 bufp = usbd_alloc_buffer(xfer, 16384);
 if (bufp == ((void *)0)) {
  usbd_free_xfer(xfer);
  return (12);
 }
 while ((n = ulmin(16384, uio->uio_resid)) != 0) {
...
ulptwrite(dev_t dev, struct uio *uio, int flags)
{
 ...
 if (usbd_is_dying(sc->sc_udev) || (sc->sc_flags & 0x80))
  return (5);
...
ulpt_ucode_loader_hp(struct ulpt_softc *sc)
{
 ...
 remain = ucode_size;
 while (remain > 0) {
  len = min(remain, 16384);
  __builtin_memcpy((bufp), (&ucode[offset]), (len));
