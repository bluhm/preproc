# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r100d.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420d.h" 1
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420_reg_safe.h" 1
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c" 2
...
static void r420_set_reg_safe(struct radeon_device *rdev)
{
 ...
 rdev->config.r300.reg_safe_bm_size = (sizeof((r420_reg_safe_bm)) / sizeof((r420_reg_safe_bm)[0]));
}
...
void r420_pipes_init(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x4274), ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)), 0);
 ...
 r100_mm_wreg(rdev, (0x42c8), ((1 << num_pipes) - 1), 0);

 tmp |= (1 << 4) | (1 << 0);
 r100_mm_wreg(rdev, (0x4018), (tmp), 0);
 if (r100_gui_wait_for_idle(rdev)) {
  printf("" "Failed to wait GUI idle while " "programming pipes. Bad things might happen.\n");
 ...
 r100_mm_wreg(rdev, (0x3428), (r100_mm_rreg(rdev, (0x3428), 0) | (1 << 8) | (1 << 17)), 0);
 ...
 if (rdev->family == CHIP_RV530) {
  tmp = r100_mm_rreg(rdev, (0x4124), 0);
  if ((tmp & 3) == 3)
   rdev->num_z_pipes = 2;
  else
   rdev->num_z_pipes = 1;
...
u32 r420_mc_rreg(struct radeon_device *rdev, u32 reg64)
{
 u32 r;

 r100_mm_wreg(rdev, (0x0001F8), ((((reg64) & 0x7F) << 0)), 0);
 r = r100_mm_rreg(rdev, (0x0001FC), 0);
 return r;
}

void r420_mc_wreg(struct radeon_device *rdev, u32 reg64, u32 v)
{
 r100_mm_wreg(rdev, (0x0001F8), ((((reg64) & 0x7F) << 0) | (((1) & 0x1) << 8)), 0);

 r100_mm_wreg(rdev, (0x0001FC), (v), 0);
}
...
static void r420_clock_resume(struct radeon_device *rdev)
{
 ...
 sclk_cntl = rdev->pll_rreg(rdev, (0x00000D));
 sclk_cntl |= (((1) & 0x1) << 16) | (((1) & 0x1) << 23);
 if (rdev->family == CHIP_R420)
  sclk_cntl |= (((1) & 0x1) << 26) | (((1) & 0x1) << 27);
 rdev->pll_wreg(rdev, (0x00000D), (sclk_cntl));
}
...
static void r420_cp_errata_init(struct radeon_device *rdev)
{
 ...
 radeon_ring_write(ring, (0x00000000 | ((((0x778) >> 2) << 0) & (0x1ffff << 0)) | ((((1)) << 16) & (0x3fff << 16))));
...
# 483 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r420.c"
