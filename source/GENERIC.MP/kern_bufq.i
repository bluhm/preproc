# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c" 2


struct { struct bufq *slh_first; } bufqs = { ((void *)0) };
struct mutex bufqs_mtx = { ((void *)0), ((((0)) > 0 && ((0)) < 12) ? 12 : ((0))), 0 };
int bufqs_stop;
...
const struct bufq_impl bufq_impls[2] = {
 {
  bufq_fifo_create,
  bufq_fifo_destroy,
  bufq_fifo_queue,
...
bufq_switch(struct bufq *bq, int type)
{
 ...
 if (bq->bufq_type != type) {
  ...
  while ((bp = bufq_impls[otype].impl_dequeue(odata)) != ((void *)0))
...
bufq_drain(struct bufq *bq)
{
 ...
 while ((bp = bufq_dequeue(bq)) != ((void *)0)) {
  bp->b_error = 6;
...
bufq_fifo_create(void)
{
 ...
 head = malloc(sizeof(*head), 2, 0x0002 | 0x0008);
 if (head == ((void *)0))
  return (((void *)0));

 do { (head)->sqh_first = ((void *)0); (head)->sqh_last = &(head)->sqh_first; } while (0);
...
bufq_fifo_queue(void *data, struct buf *bp)
{
 ...
 do { (bp)->b_bufq.bufq_data_fifo.bqf_entries.sqe_next = ((void *)0); *(head)->sqh_last = (bp); (head)->sqh_last = &(bp)->b_bufq.bufq_data_fifo.bqf_entries.sqe_next; } while (0);
}
...
bufq_fifo_dequeue(void *data)
{
 ...
 bp = ((head)->sqh_first);
 if (bp != ((void *)0))
  do { if (((head)->sqh_first = (head)->sqh_first->b_bufq.bufq_data_fifo.bqf_entries.sqe_next) == ((void *)0)) (head)->sqh_last = &(head)->sqh_first; } while (0);
...
bufq_fifo_requeue(void *data, struct buf *bp)
{
 ...
 do { if (((bp)->b_bufq.bufq_data_fifo.bqf_entries.sqe_next = (head)->sqh_first) == ((void *)0)) (head)->sqh_last = &(bp)->b_bufq.bufq_data_fifo.bqf_entries.sqe_next; (head)->sqh_first = (bp); } while (0);
}
...
bufq_fifo_peek(void *data)
{
 ...
 return (((head)->sqh_first) != ((void *)0));
}
# 381 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_bufq.c"
...
bufq_simple_nscan(struct bufq_nscan_head *head, struct buf *bp)
{
 ...
 for((cur) = ((head)->sqh_first); (cur) != ((void *)0); (cur) = ((cur)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next)) {
  if (((bp)->b_blkno < (cur)->b_blkno))
   break;
  prev = cur;
 }
 if (prev)
  do { if (((bp)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next = (prev)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next) == ((void *)0)) (head)->sqh_last = &(bp)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next; (prev)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next = (bp); } while (0);
 else
  do { if (((bp)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next = (head)->sqh_first) == ((void *)0)) (head)->sqh_last = &(bp)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next; (head)->sqh_first = (bp); } while (0);
...
bufq_nscan_resort(struct bufq_nscan_data *data)
{
 ...
 for (count = 0; count < segmentsize; count++) {
  ...
  if (!bp)
   break;
  do { if (((fifo)->sqh_first = (fifo)->sqh_first->b_bufq.bufq_data_nscan.bqf_entries.sqe_next) == ((void *)0)) (fifo)->sqh_last = &(fifo)->sqh_first; } while (0);
...
bufq_nscan_create(void)
{
 ...
 data = malloc(sizeof(*data), 2, 0x0002 | 0x0008);
 if (!data)
  return ((void *)0);
 do { (&data->sorted)->sqh_first = ((void *)0); (&data->sorted)->sqh_last = &(&data->sorted)->sqh_first; } while (0);
 do { (&data->fifo)->sqh_first = ((void *)0); (&data->fifo)->sqh_last = &(&data->fifo)->sqh_first; } while (0);
...
bufq_nscan_queue(void *vdata, struct buf *bp)
{
 ...
 if (data->leftoverroom) {
  struct buf *next = ((&data->sorted)->sqh_first);
  if (next && ((next)->b_blkno < (bp)->b_blkno)) {
 ...
 do { (bp)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next = ((void *)0); *(&data->fifo)->sqh_last = (bp); (&data->fifo)->sqh_last = &(bp)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next; } while (0);
...
bufq_nscan_dequeue(void *vdata)
{
 ...
 if (((sorted)->sqh_first) == ((void *)0))
  bufq_nscan_resort(data);

 bp = ((sorted)->sqh_first);
 if (bp != ((void *)0))
  do { if (((sorted)->sqh_first = (sorted)->sqh_first->b_bufq.bufq_data_nscan.bqf_entries.sqe_next) == ((void *)0)) (sorted)->sqh_last = &(sorted)->sqh_first; } while (0);
...
bufq_nscan_requeue(void *vdata, struct buf *bp)
{
 ...
 do { if (((bp)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next = (&data->fifo)->sqh_first) == ((void *)0)) (&data->fifo)->sqh_last = &(bp)->b_bufq.bufq_data_nscan.bqf_entries.sqe_next; (&data->fifo)->sqh_first = (bp); } while (0);
}
...
bufq_nscan_peek(void *vdata)
{
 ...
 return (((&data->sorted)->sqh_first) != ((void *)0)) ||
     (((&data->fifo)->sqh_first) != ((void *)0));
}
