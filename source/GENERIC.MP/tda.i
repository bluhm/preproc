# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c"
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c"
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c" 2
...
void device_register(struct device *, void *);
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c" 2
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/tda.c"
struct tda_softc {
 struct device sc_dev;
 i2c_tag_t sc_tag;
 i2c_addr_t sc_addr;

 u_int16_t sc_cfan_speed;
 u_int16_t sc_sfan_speed;
...
tda_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_cfan_speed = sc->sc_sfan_speed = 0x3f;
 tda_setspeed(sc);


 for (i = 0; ; i++) {
  if (sensordev_get(i, &ksens) == 2)
   break;
 }
 sc->sc_nsensors = i;
 ...
 if (sensor_task_register(sc, tda_adjust, 10) == ((void *)0)) {
...
tda_setspeed(struct tda_softc *sc)
{
 ...
 if (sc->sc_cfan_speed < 0x0c)
  sc->sc_cfan_speed = 0x0c;
 if (sc->sc_sfan_speed < 0x0c)
  sc->sc_sfan_speed = 0x0c;
 if (sc->sc_cfan_speed > 0x3f)
  sc->sc_cfan_speed = 0x3f;
 if (sc->sc_sfan_speed > 0x3f)
  sc->sc_sfan_speed = 0x3f;
 ...
 if (iic_exec(sc->sc_tag, I2C_OP_WRITE_WITH_STOP,
     sc->sc_addr, &cmd, sizeof(cmd), ((void *)0), 0, 0)) {
...
tda_adjust(void *v)
{
 ...
 for (i = 0; i < sc->sc_nsensors; i++) {
  err = sensor_find(i, SENSOR_TEMP, 0, &ks);
  if (err) {
   printf("%s: failed to get external sensor\n",
       ((sc)->sc_dev.dv_xname));
   goto out;
  }
  ctemp = (((ctemp)>(ks->value))?(ctemp):(ks->value));

  err = sensor_find(i, SENSOR_TEMP, 1, &ks);
  if (err) {
   printf("%s: failed to get internal sensors\n",
       ((sc)->sc_dev.dv_xname));
   goto out;
  }
  stemp = (((stemp)>(ks->value))?(stemp):(ks->value));
 }

 if (ctemp < (57 * 1000000 + 273150000))
  sc->sc_cfan_speed = 0x0c;
 else if (ctemp < (67 * 1000000 + 273150000))
  sc->sc_cfan_speed = 0x0c +
   (ctemp - (57 * 1000000 + 273150000)) *
   (0x3f - 0x0c) /
   ((67 * 1000000 + 273150000) - (57 * 1000000 + 273150000));

 if (stemp < (25 * 1000000 + 273150000))
  sc->sc_sfan_speed = 0x0c;
 else if (stemp < (35 * 1000000 + 273150000))
  sc->sc_sfan_speed = 0x0c +
   (stemp - (25 * 1000000 + 273150000)) *
   (0x3f - 0x0c) /
   ((35 * 1000000 + 273150000) - (25 * 1000000 + 273150000));
...
tda_full_blast(void)
{
 ...
 (*(sc->sc_tag)->ic_acquire_bus)((sc->sc_tag)->ic_cookie, (0x08));
 ...
 if (iic_exec(sc->sc_tag, I2C_OP_WRITE_WITH_STOP,
  ...
  printf("%s: cannot write cpu-fan register\n",
      ((sc)->sc_dev.dv_xname));
  (*(sc->sc_tag)->ic_release_bus)((sc->sc_tag)->ic_cookie, (0x08));
  return;
        }
