# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_test.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_test.c"
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_test.c"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_test.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_test.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_test.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_test.c" 2
...
static void radeon_do_test_moves(struct radeon_device *rdev, int flag)
{
 ...
 switch (flag) {
 case 0:
  ring = (rdev)->asic->copy.dma_ring_index;
  break;
 case 1:
  ring = (rdev)->asic->copy.blit_ring_index;
  break;
 default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown copy method\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return;
 }
 ...
 gtt_obj = kzalloc(n * sizeof(*gtt_obj), (0x0001 | 0x0004));
 if (!gtt_obj) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to allocate %d pointers\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , n);
  r = 1;
  goto out_cleanup;
 }

 r = radeon_bo_create(rdev, size, (1 << 13), 1, 0x4,
        ((void *)0), &vram_obj);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to create VRAM object\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 }
 r = radeon_bo_reserve(vram_obj, 0);
 if (__builtin_expect(!!(r != 0), 0))
  goto out_cleanup;
 r = radeon_bo_pin(vram_obj, 0x4, &vram_addr);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to pin VRAM object\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 }
 for (i = 0; i < n; i++) {
  ...
  r = radeon_bo_create(rdev, size, (1 << 13), 1,
         0x2, ((void *)0), gtt_obj + i);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to create GTT object %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i);
   goto out_cleanup;
  }
  ...
  if (__builtin_expect(!!(r != 0), 0))
   goto out_cleanup;
  r = radeon_bo_pin(gtt_obj[i], 0x2, &gtt_addr);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to pin GTT object %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i);
   goto out_cleanup;
  }

  r = radeon_bo_kmap(gtt_obj[i], &gtt_map);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to map GTT object %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i);
   goto out_cleanup;
  }
  ...
  if (ring == 3)
   r = (rdev)->asic->copy.dma((rdev), (gtt_addr), (vram_addr), (size / 4096), (&fence));
  else
   r = (rdev)->asic->copy.blit((rdev), (gtt_addr), (vram_addr), (size / 4096), (&fence));
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed GTT->VRAM copy %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i);
   goto out_cleanup;
  }

  r = radeon_fence_wait(fence, 0);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to wait for GTT->VRAM fence %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i);
   goto out_cleanup;
  }
  ...
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to map VRAM object after copy %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i);
   goto out_cleanup;
  }
  ...
  for (gtt_start = gtt_map, gtt_end = gtt_map + size,
   ...
   if (*vram_start != gtt_start) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Incorrect GTT->VRAM copy %d: Got 0x%p, " "expected 0x%p (GTT/VRAM offset " "0x%16llx/0x%16llx)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i, *vram_start, gtt_start, (unsigned long long) (gtt_addr - rdev->mc.gtt_start + (void*)gtt_start - gtt_map), (unsigned long long) (vram_addr - rdev->mc.vram_start + (void*)gtt_start - gtt_map));
# 163 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_test.c"
  ...
  if (ring == 3)
   r = (rdev)->asic->copy.dma((rdev), (vram_addr), (gtt_addr), (size / 4096), (&fence));
  else
   r = (rdev)->asic->copy.blit((rdev), (vram_addr), (gtt_addr), (size / 4096), (&fence));
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed VRAM->GTT copy %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i);
   goto out_cleanup;
  }

  r = radeon_fence_wait(fence, 0);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to wait for VRAM->GTT fence %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i);
   goto out_cleanup;
  }
  ...
  r = radeon_bo_kmap(gtt_obj[i], &gtt_map);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to map GTT object after copy %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i);
   goto out_cleanup;
  }
  ...
  for (gtt_start = gtt_map, gtt_end = gtt_map + size,
   ...
   if (*gtt_start != vram_start) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Incorrect VRAM->GTT copy %d: Got 0x%p, " "expected 0x%p (VRAM/GTT offset " "0x%16llx/0x%16llx)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i, *gtt_start, vram_start, (unsigned long long) (vram_addr - rdev->mc.vram_start + (void*)vram_start - vram_map), (unsigned long long) (gtt_addr - rdev->mc.gtt_start + (void*)vram_start - vram_map));
# 209 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_test.c"
    radeon_bo_kunmap(gtt_obj[i]);
    goto out_cleanup;
   }
  }
...
out_cleanup:
 ...
 if (r) {
  printf("" "Error while testing BO move.\n");
 }
}
...
void radeon_test_moves(struct radeon_device *rdev)
{
 if (rdev->asic->copy.dma)
  radeon_do_test_moves(rdev, 0);
 if (rdev->asic->copy.blit)
  radeon_do_test_moves(rdev, 1);
}
      ...
      struct radeon_ring *ringB)
{
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to create semaphore\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 }

 r = radeon_ring_lock(rdev, ringA, 64);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to lock ring A %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ringA->idx);
  goto out_cleanup;
 }
 radeon_semaphore_emit_wait(rdev, ringA->idx, semaphore);
 r = radeon_fence_emit(rdev, &fence1, ringA->idx);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to emit fence 1\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to emit fence 2\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  radeon_ring_unlock_undo(rdev, ringA);
  goto out_cleanup;
 }
 ...
 if (radeon_fence_signaled(fence1)) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Fence 1 signaled without waiting for semaphore.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 }

 r = radeon_ring_lock(rdev, ringB, 64);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to lock ring B %p\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ringB);
  goto out_cleanup;
 }
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to wait for sync fence 1\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 }
 ...
 if (radeon_fence_signaled(fence2)) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Fence 2 signaled without waiting for semaphore.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 }
...
out_cleanup:
 ...
 if (r)
  printf("" "Error while testing ring sync (%d).\n", r);
}
       ...
       struct radeon_ring *ringC)
{
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to emit sync fence 1\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  radeon_ring_unlock_undo(rdev, ringA);
  goto out_cleanup;
 }
 radeon_ring_unlock_commit(rdev, ringA);
 ...
 r = radeon_ring_lock(rdev, ringB, 64);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to lock ring B %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ringB->idx);
  goto out_cleanup;
 }
 radeon_semaphore_emit_wait(rdev, ringB->idx, semaphore);
 r = radeon_fence_emit(rdev, &fenceB, ringB->idx);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to create sync fence 2\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 ...
 if (radeon_fence_signaled(fenceA)) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Fence A signaled without waiting for semaphore.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 }
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to lock ring B %p\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ringC);
  goto out_cleanup;
 }
 ...
 if (!sigA && !sigB) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Neither fence A nor B has been signaled\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 } else if (sigA && sigB) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Both fence A and B has been signaled\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 }
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to wait for sync fence A\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 }
 r = radeon_fence_wait(fenceB, 0);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to wait for sync fence B\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto out_cleanup;
 }
