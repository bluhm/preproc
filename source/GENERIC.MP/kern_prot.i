# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c"
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c"
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/tcb.h" 1
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c" 2

inline void
crset(struct ucred *newcr, const struct ucred *cr)
{
 ((cr->cr_ref > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c", 59, "cr->cr_ref > 0"));
 __builtin_memcpy(((char *)newcr + __builtin_offsetof(struct ucred, cr_uid)), ((const char *)cr + __builtin_offsetof(struct ucred, cr_uid)), (sizeof(*cr) - __builtin_offsetof(struct ucred, cr_uid)));
...
{
 struct sys_getpgid_args *uap = v;


 struct process *targpr = curp->p_p;

 if (((uap)->pid.be.datum) == 0 || ((uap)->pid.be.datum) == targpr->ps_pid)
  goto found;
 if ((targpr = prfind(((uap)->pid.be.datum))) == ((void *)0))
  return (3);
 if (targpr->ps_pgrp->pg_session != curp->p_p->ps_pgrp->pg_session)
  return (1);
found:
 *retval = targpr->ps_pgrp->pg_id;
 return (0);
}
...
found:
 ...
 if (targpr->ps_pgrp->pg_session->s_leader == ((void *)0))
  return (3);
...
{
 struct sys_getgroups_args *uap = v;
 ...
 if ((ngrp = ((uap)->gidsetsize.be.datum)) == 0) {
 ...
 if (ngrp < uc->cr_ngroups)
  return (22);
 ngrp = uc->cr_ngroups;
 error = copyout(uc->cr_groups, ((uap)->gidset.be.datum),
     ngrp * sizeof(gid_t));
 if (error)
  return (error);
 *retval = ngrp;
...
# 252 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c"
int
sys_setpgid(struct proc *curp, void *v, register_t *retval)
{
 struct sys_setpgid_args *uap = v;
 ...
 pid = ((uap)->pid.be.datum);
 pgid = ((uap)->pgid.be.datum);
 ...
 if (pid != 0 && pid != curpr->ps_pid) {
  ...
  if (targpr->ps_pgrp->pg_session != curpr->ps_pgrp->pg_session) {
   error = 1;
   goto out;
  }
  if (targpr->ps_flags & 0x00000002) {
   error = 13;
   goto out;
  }
 } else
  targpr = curpr;
 if (((targpr)->ps_pgrp->pg_session->s_leader == (targpr))) {
  error = 1;
  goto out;
 }
 if (pgid == 0)
...
{
 struct sys_getresuid_args *uap = v;
 ...
 ruid = ((uap)->ruid.be.datum);
 euid = ((uap)->euid.be.datum);
 suid = ((uap)->suid.be.datum);
...
{
 struct sys_setresuid_args *uap = v;
 ...
 pr->ps_ucred = newcred;
 atomic_setbits_int(&p->p_p->ps_flags, 0x00000010);
...
{
 struct sys_getresgid_args *uap = v;
 ...
 rgid = ((uap)->rgid.be.datum);
 egid = ((uap)->egid.be.datum);
 sgid = ((uap)->sgid.be.datum);
...
{
 struct sys_setresgid_args *uap = v;
...
{
 struct sys_setregid_args *uap = v;
 ...
 rgid = ((uap)->rgid.be.datum);
 egid = ((uap)->egid.be.datum);
# 543 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c"
 pruc = pr->ps_ucred;
 if ((rgid == (gid_t)-1 || rgid == pruc->cr_rgid) &&
     (egid == (gid_t)-1 || egid == pruc->cr_gid) &&
...
{
 struct sys_setreuid_args *uap = v;
 ...
 ruid = ((uap)->ruid.be.datum);
 euid = ((uap)->euid.be.datum);
# 622 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_prot.c"
 pruc = pr->ps_ucred;
 if ((ruid == (uid_t)-1 || ruid == pruc->cr_ruid) &&
     (euid == (uid_t)-1 || euid == pruc->cr_uid) &&
...
{
 struct sys_setgroups_args *uap = v;
 ...
 if ((error = suser(p, 0)) != 0)
  return (error);
 ngrp = ((uap)->gidsetsize.be.datum);
 if (ngrp > 16)
  return (22);
 error = copyin(((uap)->gidset.be.datum), groups, ngrp * sizeof(gid_t));
 if (error == 0) {
  newcred = crget();
  pruc = pr->ps_ucred;
  crset(newcred, pruc);
  __builtin_memcpy((newcred->cr_groups), (groups), (ngrp * sizeof(gid_t)));
...
crget(void)
{
 ...
 cr = pool_get(&ucred_pool, 0x0001|0x0008);
 cr->cr_ref = 1;
 return (cr);
}
...
{
 if (xcr->cr_ngroups < 0 || xcr->cr_ngroups > 16)
  return (22);
 cr->cr_ref = 1;
 cr->cr_uid = xcr->cr_uid;
 cr->cr_gid = xcr->cr_gid;
 cr->cr_ngroups = xcr->cr_ngroups;
 __builtin_memcpy((cr->cr_groups), (xcr->cr_groups), (sizeof(cr->cr_groups[0]) * xcr->cr_ngroups));
...
{
 struct sys_getlogin_r_args *uap = v;



 size_t namelen = ((uap)->namelen.be.datum);
 struct session *s = p->p_p->ps_pgrp->pg_session;
 int error;

 if (namelen > sizeof(s->s_login))
  namelen = sizeof(s->s_login);
 error = copyoutstr(s->s_login, ((uap)->namebuf.be.datum), namelen, ((void *)0));
 if (error == 63)
  error = 34;
 *retval = error;
 return (0);
...
{
 struct sys_setlogin_args *uap = v;
 ...
 if ((error = suser(p, 0)) != 0)
  return (error);
 error = copyinstr(((uap)->namebuf.be.datum), buf, sizeof(buf), ((void *)0));
 if (error == 0)
...
proc_cansugid(struct proc *p)
{
 ...
 if ((p->p_p->ps_flags & 0x00000200) != 0)
  return (0);
...
{
 *retval = (register_t)((void *)(p)->p_md.md_tf->tf_global[7]);
 return (0);
}
