         ...
         struct radeon_ring *ring)
{
 ...
 (void)r100_mm_rreg(rdev, (reg64), 0);
}
         ...
         struct radeon_ib *ib)
{
 ...
 if (rdev->wb.enabled) {
  ...
  while ((next_rptr & 7) != 4)
   next_rptr++;
  next_rptr += 4;
  radeon_ring_write(ring, ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((2) & 0xFF) << 0)));
 ...
 while ((ring->wptr & 7) != 4)
  radeon_ring_write(ring, ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((0) & 0xFF) << 0)));
 radeon_ring_write(ring, ((((extra_bits) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((4) & 0xFF) << 0)));
 radeon_ring_write(ring, ib->gpu_addr & 0xffffffe0);
 radeon_ring_write(ring, ((u32)(((ib->gpu_addr) >> 16) >> 16)));
      ...
      int ridx)
{
 ...
 if (ridx == 3)
  ...
  ref_and_mask = (1 << 11);
 radeon_ring_write(ring, ((((extra_bits) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((8) & 0xFF) << 0)));
 radeon_ring_write(ring, 0x54E0);
 radeon_ring_write(ring, 0x54DC);
         ...
         struct radeon_fence *fence)
{
 ...
 radeon_ring_write(ring, ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((5) & 0xFF) << 0)));
 radeon_ring_write(ring, ((u32)(addr)));
 radeon_ring_write(ring, ((u32)(((addr) >> 16) >> 16)));
 radeon_ring_write(ring, fence->seq);
 radeon_ring_write(ring, ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((6) & 0xFF) << 0)));
      ...
      _Bool emit_wait)
{
 ...
 u32 extra_bits = emit_wait ? 0 : (1 << 14);
 radeon_ring_write(ring, ((((extra_bits) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((7) & 0xFF) << 0)));
...
static void cik_sdma_gfx_stop(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < 2; i++) {
  if (i == 0)
   ...
   reg_offset = 0x800;
  rb_cntl = r100_mm_rreg(rdev, (0xD200 + reg_offset), 0);
  rb_cntl &= ~(1 << 0);
  r100_mm_wreg(rdev, (0xD200 + reg_offset), (rb_cntl), 0);
  r100_mm_wreg(rdev, (0xD228 + reg_offset), (0), 0);
 }
 rdev->ring[3].ready = 0;
 rdev->ring[4].ready = 0;
 r100_mm_wreg(rdev, (0xE60), ((1 << 20) | (1 << 6)), 0);
 (void)r100_mm_rreg(rdev, (0xE60), 0);
 udelay(50);
...
static void cik_sdma_ctx_switch_enable(struct radeon_device *rdev, _Bool enable)
{
 ...
 for (i = 0; i < 2; i++) {
  if (i == 0)
   ...
   reg_offset = 0x800;
  value = r100_mm_rreg(rdev, (0xD010 + reg_offset), 0);
  if (enable)
   value |= (1 << 18);
  else
   value &= ~(1 << 18);
  r100_mm_wreg(rdev, (0xD010 + reg_offset), (value), 0);
 }
}
void cik_sdma_enable(struct radeon_device *rdev, _Bool enable)
{
 ...
 for (i = 0; i < 2; i++) {
  if (i == 0)
   ...
   reg_offset = 0x800;
  me_cntl = r100_mm_rreg(rdev, (0xD048 + reg_offset), 0);
  if (enable)
   me_cntl &= ~(1 << 0);
  else
   me_cntl |= (1 << 0);
  r100_mm_wreg(rdev, (0xD048 + reg_offset), (me_cntl), 0);
 }
...
static int cik_sdma_gfx_resume(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < 2; i++) {
  ...
  r100_mm_wreg(rdev, (0xD020 + reg_offset), (0), 0);
  r100_mm_wreg(rdev, (0xD024 + reg_offset), (0), 0);
  rb_bufsz = drm_order(ring->ring_size / 4);
  rb_cntl = rb_bufsz << 1;
  rb_cntl |= (1 << 9) | (1 << 13);
  r100_mm_wreg(rdev, (0xD200 + reg_offset), (rb_cntl), 0);
  r100_mm_wreg(rdev, (0xD20C + reg_offset), (0), 0);
  r100_mm_wreg(rdev, (0xD210 + reg_offset), (0), 0);
  r100_mm_wreg(rdev, (0xD220 + reg_offset), (((u32)(((rdev->wb.gpu_addr + wb_offset) >> 16) >> 16)) & 0xFFFFFFFF), 0);
  r100_mm_wreg(rdev, (0xD224 + reg_offset), (((rdev->wb.gpu_addr + wb_offset) & 0xFFFFFFFC)), 0);
  if (rdev->wb.enabled)
   rb_cntl |= (1 << 12);
  r100_mm_wreg(rdev, (0xD204 + reg_offset), (ring->gpu_addr >> 8), 0);
  r100_mm_wreg(rdev, (0xD208 + reg_offset), (ring->gpu_addr >> 40), 0);
  ring->wptr = 0;
  r100_mm_wreg(rdev, (0xD210 + reg_offset), (ring->wptr << 2), 0);
  r100_mm_wreg(rdev, (0xD200 + reg_offset), (rb_cntl | (1 << 0)), 0);
  ib_cntl = (1 << 0);
  ib_cntl |= (1 << 4);
  r100_mm_wreg(rdev, (0xD228 + reg_offset), (ib_cntl), 0);
  ring->ready = 1;
      ...
      struct reservation_object *resv)
{
 ...
 for (i = 0; i < num_loops; i++) {
  ...
  radeon_ring_write(ring, ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((1) & 0xFF) << 0)));
         ...
         struct radeon_ring *ring)
{
 ...
 tmp = 0xCAFEDEAD;
 rdev->wb.wb[index/4] = (__uint32_t)(__builtin_constant_p(tmp) ? (__uint32_t)(((__uint32_t)(tmp) & 0xff) << 24 | ((__uint32_t)(tmp) & 0xff00) << 8 | ((__uint32_t)(tmp) & 0xff0000) >> 8 | ((__uint32_t)(tmp) & 0xff000000) >> 24) : __swap32md(tmp));
 ...
 radeon_ring_write(ring, ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((2) & 0xFF) << 0)));
 radeon_ring_write(ring, ((u32)(gpu_addr)));
 radeon_ring_write(ring, ((u32)(((gpu_addr) >> 16) >> 16)));
 radeon_ring_write(ring, 1);
 radeon_ring_write(ring, 0xDEADBEEF);
 radeon_ring_unlock_commit(rdev, ring, 0);
 for (i = 0; i < rdev->usec_timeout; i++) {
  tmp = (__uint32_t)(__builtin_constant_p(rdev->wb.wb[index/4]) ? (__uint32_t)(((__uint32_t)(rdev->wb.wb[index/4]) & 0xff) << 24 | ((__uint32_t)(rdev->wb.wb[index/4]) & 0xff00) << 8 | ((__uint32_t)(rdev->wb.wb[index/4]) & 0xff0000) >> 8 | ((__uint32_t)(rdev->wb.wb[index/4]) & 0xff000000) >> 24) : __swap32md(rdev->wb.wb[index/4]));
  if (tmp == 0xDEADBEEF)
   break;
  delay(1);
 }
...
int cik_sdma_ib_test(struct radeon_device *rdev, struct radeon_ring *ring)
{
 ...
 ib.ptr[0] = ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((2) & 0xFF) << 0));
       ...
       unsigned count)
{
 while (count) {
  ...
  if (bytes > 0x1FFFF8)
   bytes = 0x1FFFF8;
  ib->ptr[ib->length_dw++] = ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((1) & 0xFF) << 0));
        ...
        uint32_t incr, uint32_t flags)
{
 ...
 while (count) {
  ...
  if (ndw > 0xFFFFE)
   ndw = 0xFFFFE;
  ib->ptr[ib->length_dw++] = ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((2) & 0xFF) << 0));
      ...
      uint32_t incr, uint32_t flags)
{
 ...
 while (count) {
  ...
  if (flags & (1 << 0))
   ...
   value = 0;
  ib->ptr[ib->length_dw++] = ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((12) & 0xFF) << 0));
  ib->ptr[ib->length_dw++] = pe;
  ib->ptr[ib->length_dw++] = ((u32)(((pe) >> 16) >> 16));
...
void cik_sdma_vm_pad_ib(struct radeon_ib *ib)
{
 while (ib->length_dw & 0x7)
  ib->ptr[ib->length_dw++] = ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((0) & 0xFF) << 0));
}
void cik_dma_vm_flush(struct radeon_device *rdev, struct radeon_ring *ring,
        unsigned vm_id, uint64_t pd_addr)
{
 u32 extra_bits = (((0) << 10) |
     ((0) << 12));
 radeon_ring_write(ring, ((((0xf000) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((14) & 0xFF) << 0)));
 if (vm_id < 8) {
  radeon_ring_write(ring, (0x153c + (vm_id << 2)) >> 2);
 } else {
  radeon_ring_write(ring, (0x1438 + ((vm_id - 8) << 2)) >> 2);
 }
 ...
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, ((((0xf000) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((14) & 0xFF) << 0)));
 radeon_ring_write(ring, 0x8C34 >> 2);
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, ((((0xf000) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((14) & 0xFF) << 0)));
 radeon_ring_write(ring, 0x8C2C >> 2);
 radeon_ring_write(ring, 1);
 radeon_ring_write(ring, ((((0xf000) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((14) & 0xFF) << 0)));
 radeon_ring_write(ring, 0x8C30 >> 2);
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, ((((0xf000) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((14) & 0xFF) << 0)));
 radeon_ring_write(ring, 0xE44 >> 2);
