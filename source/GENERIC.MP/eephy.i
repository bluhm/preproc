# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c"
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c"
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.h" 1
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/miidevs.h" 1
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephyreg.h" 1
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c" 2
...
static const struct mii_phydesc eephys[] = {
 { 0x005043, 0x0000,
   "88E1000 1 Gigabit PHY" },
 { 0x005043, 0x0003,
   "88E1000 2 Gigabit PHY" },
 { 0x005043, 0x0005,
   "88E1000 3 Gigabit PHY" },
 { 0x005043, 0x0006,
   "88E1000 4 Gigabit PHY" },
 { 0x005043, 0x0004,
   "88E1000S Gigabit PHY" },
 { 0x005043, 0x0002,
   "88E1011 Gigabit PHY" },
 { 0x005043, 0x000c,
   "88E1111 Gigabit PHY" },
 ...
 { 0x005043, 0x0027,
   "PHYG65G Gigabit PHY" },
 { 0x000ac2, 0x0002,
   "88E1000 5 Gigabit PHY" },
 { 0x000ac2, 0x0003,
   "88E1000 6 Gigabit PHY" },
 { 0x000ac2, 0x0005,
   "88E1000 7 Gigabit PHY" },
 { 0x000ac2, 0x000c,
   "88E1111 Gigabit PHY" },
...
eephy_match(struct device *parent, void *match, void *aux)
{
 ...
 if (mii_phy_match(ma, eephys) != ((void *)0))
  return (10);
...
eephy_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->mii_flags |= 0x0004;
        ...
        (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x16), (0));


 if (sc->mii_model == 0x000c &&
     (sc->mii_flags & 0x0020) == 0) {
# 168 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/eephy.c"
  reg64 = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x1B));
  if ((reg64 & 0x000f) == 0x000b) {
   reg64 |= 0x8000;
   (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x1B), (reg64));
  }
 }


 if (sc->mii_model == 0x0009 &&
     sc->mii_flags & 0x0020) {
  page = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x16));
  (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x16), (2));
  reg64 = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x10));
  reg64 &= ~0x0380;
  reg64 |= 0x0380;
  (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x10), (reg64));
  (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x16), (page));
 }
...
eephy_reset(struct mii_softc *sc)
{
 ...
 reg64 = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x14));
 reg64 |= 0x0070;
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x14), (reg64));


 if (sc->mii_model == 0x0026 &&
     (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x16)) == 0) {
  reg64 = (0x0b << 8) | (0x05 << 4) | 0x04;
  (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x16), (reg64));
 }
 ...
 reg64 = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00));
 reg64 &= ~0x1000;
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00), (reg64 | 0x8000));
}
...
eephy_service(struct mii_softc *sc, struct mii_data *mii, int cmd)
{
 ...
 case 2:
  ...
  if (((ife->ifm_media) & 0x00000000000000ffULL) != 0ULL) {
   bmcr = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00));
   (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00), (bmcr | 0x8000));
  }
  break;
...
eephy_status(struct mii_softc *sc)
{
 ...
 if (((mii->mii_media_active) & 0x00000000000000ffULL) == 16) {
  gsr = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x0A)) | (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x0A));
  if (gsr & 0x4000)
