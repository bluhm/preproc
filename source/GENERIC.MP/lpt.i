# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c"
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c"
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lptreg.h" 1
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lptvar.h" 1
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lptvar.h"
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lptvar.h" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/lpt.h" 1
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c" 2
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c"
...
# 104 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lpt.c"
...
lpt_attach_common(struct lpt_softc *sc)
{
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 2, 0x04);
...
{
 int unit = (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x1f);
 u_int8_t flags = (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0xe0);
 struct lpt_softc *sc;
 u_int8_t control;
 int error;
 int spin;
 ...
 sc->sc_flags = (sc->sc_flags & 0x10) | flags;
 if ((sc->sc_flags & (0x10|0x80)) == 0x10)
  return 6;
 ...
 if ((flags & 0x40) == 0) {
  ...
  bus_space_write_1(sc->sc_iot, sc->sc_ioh, 2, 0x08);
  delay(100);
 }

 control = 0x08 | 0x04;
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 2, control);


 for (spin = 0; lpt_not_ready(bus_space_read_1(sc->sc_iot, sc->sc_ioh, 1), sc); spin += hz/4) {
  if (spin >= hz*16) {
   sc->sc_state = 0;
   return 16;
  }
  ...
  error = tsleep((caddr_t)sc, (22 +8) | 0x100, "lptopen", hz/4);
  if (sc->sc_state == 0)
   return (5);
  if (error != 35) {
   sc->sc_state = 0;
 ...
 sc->sc_inbuf = geteblk(1024);
 sc->sc_count = 0;
 sc->sc_state = 0x01;

 if ((sc->sc_flags & 0x80) == 0)
  lptwakeup(sc);
...
lpt_not_ready(u_int8_t status, struct lpt_softc *sc)
{
 ...
 status = (status ^ (0x10|0x08|0x80|0x40)) & (0x10|0x08|0x80|0x40|0x20);
...
lptwakeup(void *arg)
{
 ...
 if (sc->sc_state != 0)
  timeout_add(&sc->sc_wakeup_tmo, hz/4);
}
...
lptpushbytes(struct lpt_softc *sc)
{
 ...
 if (sc->sc_flags & 0x80) {
  ...
  while (sc->sc_count > 0) {
   ...
   if (sc->sc_state == 0)
    return (5);
   while (((bus_space_read_1(sc->sc_iot, sc->sc_ioh, 1) ^ (0x10|0x08|0x80|0x40)) & (0x10|0x08|0x80|0x40|0x20))) {
    if (++spin < sc->sc_spinmax)
     continue;
    tic = 0;

    sc->sc_spinmax++;
    while (lpt_not_ready(bus_space_read_1(sc->sc_iot, sc->sc_ioh, 1), sc)) {

     tic = tic + tic + 1;
     if (tic > hz*16)
      tic = hz*16;
     error = tsleep((caddr_t)sc,
         (22 +8) | 0x100, "lptpsh", tic);
     if (sc->sc_state == 0)
      error = 5;
     if (error != 35)
      return error;
   ...
   bus_space_write_1(iot, ioh, 0, *sc->sc_cp++);
   bus_space_write_1(iot, ioh, 2,
       control | 0x01);
   sc->sc_count--;
   bus_space_write_1(iot, ioh, 2, control);
  ...
  while (sc->sc_count > 0) {
   ...
   if (sc->sc_state == 0)
    return (5);
   error = tsleep((caddr_t)sc, (22 +8) | 0x100,
       "lptwrite2", 0);
   if (sc->sc_state == 0)
    error = 5;
   if (error)
...
{
 struct lpt_softc *sc = lpt_cd.cd_devs[(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x1f)];
 size_t n;
 int error = 0;
...
lptintr(void *arg)
{
 ...
 if (((sc->sc_state & 0x01) == 0 && sc->sc_count == 0) ||
     (sc->sc_flags & 0x80))
  return 0;


 if (((bus_space_read_1(sc->sc_iot, sc->sc_ioh, 1) ^ (0x10|0x08|0x80|0x40)) & (0x10|0x08|0x80|0x40|0x20)) && lpt_not_ready(bus_space_read_1(sc->sc_iot, sc->sc_ioh, 1), sc))
  return -1;
 ...
 if (sc->sc_count) {
  ...
  bus_space_write_1(iot, ioh, 0, *sc->sc_cp++);
  delay (50);
  bus_space_write_1(iot, ioh, 2, control | 0x01);
  sc->sc_count--;
  bus_space_write_1(iot, ioh, 2, control);
  sc->sc_state |= 0x02;
 } else
...
lpt_activate(struct device *self, int act)
{
 ...
 case 4:
  ...
  if (sc->sc_state) {
   ...
   bus_space_write_1(sc->sc_iot, sc->sc_ioh, 2,
       0x08 | 0x04);
