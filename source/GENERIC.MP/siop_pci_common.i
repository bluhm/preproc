# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c"
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c"
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.h" 1
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.h"
...
struct siop_pci_common_softc {
 ...
 pcitag_t sc_tag;
 void *sc_ih;
 const struct siop_product_desc *sc_pp;
};
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/siop_pci_common.c" 2


const struct siop_product_desc siop_products[] = {
 { 0x0001,
 0x00,
 0x01000000 | 0x00008000,
 4, 8, 3, 250, 0
 },
 { 0x0001,
 0x10,
 0x01000000 | 0x04000000 | 0x00002000 | 0x00008000,
 4, 8, 3, 250, 0
 },
 { 0x0004,
 0x00,
 ...
 { 0x0002,
 0x00,
 0x01000000 | 0x00008000 | 0x00000001,
 4, 8, 3, 250, 0
 },
 { 0x0003,
 0x00,
 0x01000000 | 0x04000000 | 0x00000001,
 4, 8, 3, 250, 0
 },
 { 0x0003,
 0x10,
 0x01000000 | 0x08000000 | 0x10000000 | 0x02000000 |
 ...
 0x02,
 0x01000000 | 0x08000000 | 0x10000000 | 0x02000000 |
 0x00001000 | 0x00002000 | 0x00004000 | 0x00000400 |
 ...
 0x00,
 0x01000000 | 0x08000000 | 0x10000000 | 0x02000000 |
 0x00000200 | 0x00001000 | 0x00002000 | 0x00004000 | 0x00000800 |
 0x00008000 | 0x00010000 |
 0x00000004 | 0x00000001,
 7, 31, 7, 62, 8192
 },
 ...
 0x00,
 0x01000000 | 0x08000000 | 0x10000000 | 0x02000000 |
 0x00000200 | 0x00001000 | 0x00002000 | 0x00004000 |
 0x00008000 | 0x00010000 | 0x00020000 | 0x00000400 |
 0x00080000 |
 ...
 0x01000000 | 0x08000000 | 0x10000000 | 0x02000000 |
 0x00000200 | 0x00001000 | 0x00002000 | 0x00004000 |
 0x00008000 | 0x00010000 | 0x00020000 | 0x00000400 | 0x00040000 |
 0x00080000 |
 0x00000008 | 0x00000001,
 7, 62, 0, 62, 8192
 },
...
siop_lookup_product(u_int32_t id, int rev)
{
 ...
 const struct siop_product_desc *rp = ((void *)0);

 if ((((id) >> 0) & 0xffff) != 0x1000)
  return ((void *)0);

 for (pp = siop_products; pp->product != 0; pp++) {
  if ((((id) >> 16) & 0xffff) == pp->product && pp->revision <= rev)
   if (rp == ((void *)0) || pp->revision > rp->revision)
    rp = pp;
 }
 return rp;
}
    ...
    int (*intr)(void*))
{
 ...
 pci_sc->sc_pp =
     siop_lookup_product(pa->pa_id, (((pa->pa_class) >> 0) & 0xff));
 if (pci_sc->sc_pp == ((void *)0)) {
 ...
 pci_sc->sc_ih = pci_intr_establish(pa->pa_pc, intrhandle, 5,
     intr, siop_sc, siop_sc->sc_dev.dv_xname);
 if (pci_sc->sc_ih != ((void *)0)) {
  printf(": %s",
      intrstr ? intrstr : "?");
 } else {
 ...
 if (siop_sc->features & 0x00004000) {
  int bar;
  switch (memtype) {
  case 0x00000000 | 0x00000000:
   bar = 0x18;
...
siop_pci_reset(struct siop_common_softc *sc)
{
 ...
 dmode = bus_space_read_1(sc->sc_rt, sc->sc_rh, 0x38);
 if (sc->features & 0x01000000)
  dmode |= 0x08;
 if (sc->features & 0x02000000)
  dmode |= 0x04;
 if (sc->features & 0x04000000)
  dmode |= 0x02;
 if (sc->features & 0x08000000)
  bus_space_write_1(sc->sc_rt, sc->sc_rh, 0x3B,
      bus_space_read_1(sc->sc_rt, sc->sc_rh, 0x3B) |
      0x80);
 if (sc->features & 0x10000000)
 ...
 if (sc->maxburst) {
  int ctest5 = bus_space_read_1(sc->sc_rt, sc->sc_rh,
      0x22);
  bus_space_write_1(sc->sc_rt, sc->sc_rh, 0x21,
      bus_space_read_1(sc->sc_rt, sc->sc_rh, 0x21) &
      ~0x80);
  dmode &= ~0xC0;
  dmode |= ((sc->maxburst - 1) << 6) & 0xC0;
  ctest5 &= ~0x40;
  ctest5 |= (sc->maxburst - 1) & 0x40;
  bus_space_write_1(sc->sc_rt, sc->sc_rh, 0x22, ctest5);
 } else {
  bus_space_write_1(sc->sc_rt, sc->sc_rh, 0x21,
      bus_space_read_1(sc->sc_rt, sc->sc_rh, 0x21) |
      0x80);
 }
 bus_space_write_1(sc->sc_rt, sc->sc_rh, 0x38, dmode);
}
