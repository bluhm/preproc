        ...
        struct radeon_ring *ring)
{
 ...
 if (rdev->wb.enabled) {
  ...
  if (ring->idx == 3)
   ...
   reg64 = 0xd008 + 0x800;
  rptr = r100_mm_rreg(rdev, (reg64), 0);
 }
      ...
      struct radeon_ring *ring)
{
 ...
 if (ring->idx == 3)
  ...
  reg64 = 0xd00c + 0x800;
 return (r100_mm_rreg(rdev, (reg64), 0) & 0x3fffc) >> 2;
}
void cayman_dma_set_wptr(struct radeon_device *rdev,
    struct radeon_ring *ring)
{
 ...
 if (ring->idx == 3)
  ...
  reg64 = 0xd00c + 0x800;
 r100_mm_wreg(rdev, (reg64), ((ring->wptr << 2) & 0x3fffc), 0);
}
void cayman_dma_ring_ib_execute(struct radeon_device *rdev,
    struct radeon_ib *ib)
{
 ...
 if (rdev->wb.enabled) {
  ...
  while ((next_rptr & 7) != 5)
   next_rptr++;
  next_rptr += 3;
  radeon_ring_write(ring, ((((0x2) & 0xF) << 28) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((1) & 0xFFFFF) << 0)));
  radeon_ring_write(ring, ring->next_rptr_gpu_addr & 0xfffffffc);
  radeon_ring_write(ring, ((u32)(((ring->next_rptr_gpu_addr) >> 16) >> 16)) & 0xff);
  radeon_ring_write(ring, next_rptr);
 }
 while ((ring->wptr & 7) != 5)
  radeon_ring_write(ring, ((((0xf) & 0xF) << 28) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((0) & 0xFFFFF) << 0)));
 radeon_ring_write(ring, ((((0x4) & 0xF) << 28) | (((vm_id) & 0xF) << 20) | (((0) & 0xFFFFF) << 0)));
 radeon_ring_write(ring, (ib->gpu_addr & 0xFFFFFFE0));
 radeon_ring_write(ring, (ib->length_dw << 12) | (((u32)(((ib->gpu_addr) >> 16) >> 16)) & 0xFF));
}
void cayman_dma_stop(struct radeon_device *rdev)
{
 u32 rb_cntl;
 if ((rdev->asic->copy.copy_ring_index == 3) ||
     (rdev->asic->copy.copy_ring_index == 4))
  radeon_ttm_set_active_vram_size(rdev, rdev->mc.visible_vram_size);
 rb_cntl = r100_mm_rreg(rdev, (0xd000 + 0x0), 0);
 rb_cntl &= ~(1 << 0);
 r100_mm_wreg(rdev, (0xd000 + 0x0), (rb_cntl), 0);
 rb_cntl = r100_mm_rreg(rdev, (0xd000 + 0x800), 0);
 rb_cntl &= ~(1 << 0);
 r100_mm_wreg(rdev, (0xd000 + 0x800), (rb_cntl), 0);
 rdev->ring[3].ready = 0;
 rdev->ring[4].ready = 0;
}
int cayman_dma_resume(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < 2; i++) {
  ...
  r100_mm_wreg(rdev, (0xd044 + reg_offset), (0), 0);
  r100_mm_wreg(rdev, (0xd048 + reg_offset), (0), 0);
  rb_bufsz = drm_order(ring->ring_size / 4);
  rb_cntl = rb_bufsz << 1;
  rb_cntl |= (1 << 9) | (1 << 13);
  r100_mm_wreg(rdev, (0xd000 + reg_offset), (rb_cntl), 0);
  r100_mm_wreg(rdev, (0xd008 + reg_offset), (0), 0);
  r100_mm_wreg(rdev, (0xd00c + reg_offset), (0), 0);
  r100_mm_wreg(rdev, (0xd01c + reg_offset), (((u32)(((rdev->wb.gpu_addr + wb_offset) >> 16) >> 16)) & 0xFF), 0);
  r100_mm_wreg(rdev, (0xd020 + reg_offset), (((rdev->wb.gpu_addr + wb_offset) & 0xFFFFFFFC)), 0);
  if (rdev->wb.enabled)
   rb_cntl |= (1 << 12);
  r100_mm_wreg(rdev, (0xd004 + reg_offset), (ring->gpu_addr >> 8), 0);
  ib_cntl = (1 << 0) | (1 << 31);
  ib_cntl |= (1 << 4);
  r100_mm_wreg(rdev, (0xd024 + reg_offset), (ib_cntl), 0);
  dma_cntl = r100_mm_rreg(rdev, (0xd02c + reg_offset), 0);
  dma_cntl &= ~(1 << 28);
  r100_mm_wreg(rdev, (0xd02c + reg_offset), (dma_cntl), 0);
  ring->wptr = 0;
  r100_mm_wreg(rdev, (0xd00c + reg_offset), (ring->wptr << 2), 0);
  r100_mm_wreg(rdev, (0xd000 + reg_offset), (rb_cntl | (1 << 0)), 0);
  ring->ready = 1;
  r = (rdev)->asic->ring[(ring->idx)]->ring_test((rdev), (ring));
  if (r) {
   ring->ready = 0;
   return r;
  }
...
void cayman_dma_fini(struct radeon_device *rdev)
{
 ...
 radeon_ring_fini(rdev, &rdev->ring[4]);
}
_Bool cayman_dma_is_lockup(struct radeon_device *rdev, struct radeon_ring *ring)
{
         ...
         unsigned count)
{
 ...
 while (count) {
  ...
  if (ndw > 0xFFFFE)
   ndw = 0xFFFFE;
  ib->ptr[ib->length_dw++] = ((((0x3) & 0xF) << 28) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((ndw) & 0xFFFFF) << 0));
  ib->ptr[ib->length_dw++] = ((u32)(pe));
  ib->ptr[ib->length_dw++] = ((u32)(src));
  ib->ptr[ib->length_dw++] = ((u32)(((pe) >> 16) >> 16)) & 0xff;
  ib->ptr[ib->length_dw++] = ((u32)(((src) >> 16) >> 16)) & 0xff;
  pe += ndw * 4;
  src += ndw * 4;
  count -= ndw / 2;
 }
          ...
          uint32_t incr, uint32_t flags)
{
 ...
 while (count) {
  ...
  if (ndw > 0xFFFFE)
   ndw = 0xFFFFE;
  ib->ptr[ib->length_dw++] = ((((0x2) & 0xF) << 28) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((ndw) & 0xFFFFF) << 0));
        ...
        uint32_t incr, uint32_t flags)
{
 ...
 while (count) {
  ...
  if (flags & (1 << 0))
   ...
   value = 0;
  ib->ptr[ib->length_dw++] = ((2 << 28) | (1 << 26) | (1 << 21) | (((ndw) & 0xFFFFF) << 0));
  ib->ptr[ib->length_dw++] = pe;
  ib->ptr[ib->length_dw++] = ((u32)(((pe) >> 16) >> 16)) & 0xff;
...
void cayman_dma_vm_pad_ib(struct radeon_ib *ib)
{
 while (ib->length_dw & 0x7)
  ib->ptr[ib->length_dw++] = ((((0xf) & 0xF) << 28) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((0) & 0xFFFFF) << 0));
}
void cayman_dma_vm_flush(struct radeon_device *rdev, struct radeon_ring *ring,
    unsigned vm_id, uint64_t pd_addr)
{
 radeon_ring_write(ring, ((((0x9) & 0xF) << 28) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((0) & 0xFFFFF) << 0)));
 radeon_ring_write(ring, (0xf << 16) | ((0x153C + (vm_id << 2)) >> 2));
 radeon_ring_write(ring, pd_addr >> 12);
 radeon_ring_write(ring, ((((0x9) & 0xF) << 28) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((0) & 0xFFFFF) << 0)));
 radeon_ring_write(ring, (0xf << 16) | (0x5480 >> 2));
 radeon_ring_write(ring, 1);
 radeon_ring_write(ring, ((((0x9) & 0xF) << 28) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((0) & 0xFFFFF) << 0)));
 radeon_ring_write(ring, (0xf << 16) | (0x1478 >> 2));
 radeon_ring_write(ring, 1 << vm_id);
 radeon_ring_write(ring, ((9 << 28) | (1 << 27)));
 radeon_ring_write(ring, (0xff << 20) | (0x1478 >> 2));
