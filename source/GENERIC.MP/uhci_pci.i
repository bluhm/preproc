# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/uhci_pci.c" 2
...
uhci_pci_activate(struct device *self, int act)
{
 ...
 case 4:
  ...
  bus_space_barrier(sc->sc.iot, sc->sc.ioh, 0, sc->sc.sc_size,
      0x01|0x02);
  bus_space_write_2(sc->sc.iot, sc->sc.ioh, 0x04, 0);
  break;
 }
...
uhci_pci_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (pci_mapreg_map(pa, 0x20, 0x00000001, 0,
 ...
 sc->sc_ih = pci_intr_establish(pc, ih, 5, uhci_intr, sc,
           devname);
 if (sc->sc_ih == ((void *)0)) {
 ...
 pci_conf_write(pc, tag, 0xc0, 0x2000);

 switch(pci_conf_read(pc, tag, 0x60) & 0xff) {
 case 0x00:
  sc->sc.sc_bus.usbrev = 1;
  break;
 case 0x10:
  sc->sc.sc_bus.usbrev = 2;
  break;
 case 0x11:
  sc->sc.sc_bus.usbrev = 3;
  break;
 default:
  sc->sc.sc_bus.usbrev = 0;
  break;
 }
