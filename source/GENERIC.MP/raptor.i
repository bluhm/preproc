# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
...
void device_register(struct device *, void *);
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
...
int ifb_ident(void *);
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c" 2
# 108 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/raptor.c"
...
raptor_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (pci_mapreg_map(pa, 0x20, 0x00000000, 0,
...
raptor_putcmap(struct raptor_softc *sc, struct wsdisplay_cmap *cm)
{
 ...
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x0008, 0xff);
 for (i = 0; i < count; i++) {
...
raptor_setcolor(void *v, u_int index, u_int8_t r, u_int8_t g, u_int8_t b)
{
 ...
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x0008, 0xff);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x0000, index);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x0004, r);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x0004, g);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x0004, b);
}
...
raptor_init(struct raptor_softc *sc)
{
 ...
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4024, 0);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4028, 0);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x402c, 0);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4030, 0);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4038, 0);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4040,
     sc->sc_sunfb.sf_linebytes);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4044,
     sc->sc_sunfb.sf_linebytes);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x403c,
     sc->sc_sunfb.sf_linebytes);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4074, 0);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4098,
     0x00000000);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4078,
     0xffffffff);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x407c, 0);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4080, 0);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4084,
     ((4095 << 16) | (2047)));




 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4004, 3);
}
    ...
    int w, int h)
{
 ...
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4048,
     0x0000000c << 8 | 0x00000001);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4094, dir);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4090,
     ((w << 16) | (h)));
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4088,
     ((sx << 16) | (sy)));

 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x408c,
     ((dx << 16) | (dy)));
...
raptor_fillrect(struct raptor_softc *sc, int x, int y, int w, int h, int color)
{
 ...
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4048,
     0x00000001 << 16 | 0x0000000c << 8 | 0x00000001);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4068, color);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4094, 0);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4090,
     ((w << 16) | (h)));
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4088, 0);
