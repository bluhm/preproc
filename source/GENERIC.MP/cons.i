# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c"
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c"
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c" 2

struct tty *constty = ((void *)0);
struct vnode *cn_devvp = ((struct vnode *)((void *)0));
...
cnopen(dev_t dev, int flag, int mode, struct proc *p)
{
 ...
 if (cn_devvp == ((struct vnode *)((void *)0))) {

  cdevvp(cndev, &cn_devvp);
 }
 return ((*cdevsw[((int32_t)(((u_int32_t)(cndev) >> 8) & 0xff))].d_open)(cndev, flag, mode, p));
}
...
cnclose(dev_t dev, int flag, int mode, struct proc *p)
{
 ...
 if (cn_devvp != ((struct vnode *)((void *)0))) {
  ...
  vrele(cn_devvp);
  cn_devvp = ((struct vnode *)((void *)0));
 }
 if (vfinddev(dev, VCHR, &vp) && vcount(vp))
  return (0);
 return ((*cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_close)(dev, flag, mode, p));
}

int
cnread(dev_t dev, struct uio *uio, int flag)
{
# 118 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cons.c"
 if (constty != ((void *)0))
  return 0;
 else if (cn_tab == ((void *)0))
  return 6;

 dev = cn_tab->cn_dev;
 return ((*cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_read)(dev, uio, flag));
}
...
cnwrite(dev_t dev, struct uio *uio, int flag)
{
 ...
 if (constty != ((void *)0))
  ...
  dev = cn_tab->cn_dev;
 return ((*cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_write)(dev, uio, flag));
}
    ...
    struct proc *p)
{
 ...
 if (constty != ((void *)0))
  ...
  dev = cn_tab->cn_dev;
 return ((*cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_ioctl)(dev, cmd, data, flag, p));
}
...
cnkqfilter(dev_t dev, struct knote *kn)
{
 ...
 if (constty != ((void *)0))
  ...
  dev = cn_tab->cn_dev;
 if (cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_kqfilter)
  return ((*cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_kqfilter)(dev, kn));
 return (6);
}
...
{
 if (cn_tab == ((void *)0) || cn_tab->cn_bell == ((void *)0))
  return;
