# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_kthread.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_kthread.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_kthread.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_kthread.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_kthread.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_kthread.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/wait.h" 1
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_kthread.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_kthread.c" 2
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_kthread.c"
    ...
    struct proc **newpp, const char *name)
{
 ...
 error = fork1(&proc0, 0x00000080|0x00000010|0x00000040|
     0x00000020|0x00000200, func, arg, ((void *)0), &p);
 if (error)
  return (error);
...
kthread_exit(int ecode)
{
 ...
 if (ecode != 0)
  printf("WARNING: thread `%s' (%d) exits with status %d\n",
      (__curcpu->ci_self)->ci_curproc->p_p->ps_comm, (__curcpu->ci_self)->ci_curproc->p_tid, ecode);

 exit1((__curcpu->ci_self)->ci_curproc, ((ecode) << 8 | (0)), 0x00000001);
...
struct kthread_q {
 struct { struct kthread_q *sqe_next; } kq_q;
 void (*kq_func)(void *);
 void *kq_arg;
};

struct { struct kthread_q *sqh_first; struct kthread_q **sqh_last; } kthread_q = { ((void *)0), &(kthread_q).sqh_first };
...
kthread_create_deferred(void (*func)(void *), void *arg)
{
 ...
 kq = malloc(sizeof *kq, 127, 0x0002|0x0008);
 if (kq == ((void *)0))
 ...
 do { (kq)->kq_q.sqe_next = ((void *)0); *(&kthread_q)->sqh_last = (kq); (&kthread_q)->sqh_last = &(kq)->kq_q.sqe_next; } while (0);
}
...
kthread_run_deferred_queue(void)
{
 ...
 while ((kq = ((&kthread_q)->sqh_first)) != ((void *)0)) {
  do { if (((&kthread_q)->sqh_first = (&kthread_q)->sqh_first->kq_q.sqe_next) == ((void *)0)) (&kthread_q)->sqh_last = &(&kthread_q)->sqh_first; } while (0);
  (*kq->kq_func)(kq->kq_arg);
  free(kq, 127, sizeof(*kq));
 }
}
