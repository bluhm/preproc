# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mk48txx.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mk48txx.c"
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mk48txx.c"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mk48txx.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mk48txx.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mk48txx.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mk48txx.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mk48txx.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mk48txx.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mk48txx.c" 2


struct mk48txx {
 bus_space_tag_t mk_bt;
 bus_space_handle_t mk_bh;
 bus_size_t mk_nvramsz;
 bus_size_t mk_clkoffset;
 u_int mk_year0;
...
struct {
 ...
 { "mk48t02", 2048, 0x7f0, 0 },
 { "mk48t08", 8192, 0x1ff0, 0 },
 { "mk48t18", 8192, 0x1ff0, 0 },
 { "mk48t59", 8192, 0x1ff0, 1 },
};
 ...
 int year0;
{
 ...
 sz = (((unsigned long)(sizeof(struct todr_chip_handle)) + 0xf) & ~0xf) + sizeof(struct mk48txx);
 handle = malloc(sz, 2, 0x0002);
 if (handle == ((void *)0)) {
  printf(": failed to allocate memory");
  return ((void *)0);
 }
 mk = (struct mk48txx *)((u_long)handle +
     (((unsigned long)(sizeof(struct todr_chip_handle)) + 0xf) & ~0xf));
 handle->cookie = mk;
 ...
 struct timeval *tv;
{
 ...
 if ((handle)->todr_setwen) ((*(handle)->todr_setwen)(handle, 1));


 csr = bus_space_read_1(bt, bh, clkoff + 8);
 csr |= 0x40;
 bus_space_write_1(bt, bh, clkoff + 8, csr);

 dt.dt_sec = (((bus_space_read_1(bt, bh, clkoff + 9)) >> 4) * 10 + ((bus_space_read_1(bt, bh, clkoff + 9)) & 0xf));
 dt.dt_min = (((bus_space_read_1(bt, bh, clkoff + 10)) >> 4) * 10 + ((bus_space_read_1(bt, bh, clkoff + 10)) & 0xf));
 dt.dt_hour = (((bus_space_read_1(bt, bh, clkoff + 11)) >> 4) * 10 + ((bus_space_read_1(bt, bh, clkoff + 11)) & 0xf));
 dt.dt_day = (((bus_space_read_1(bt, bh, clkoff + 13)) >> 4) * 10 + ((bus_space_read_1(bt, bh, clkoff + 13)) & 0xf));
 dt.dt_wday = (((bus_space_read_1(bt, bh, clkoff + 12)) >> 4) * 10 + ((bus_space_read_1(bt, bh, clkoff + 12)) & 0xf));
 dt.dt_mon = (((bus_space_read_1(bt, bh, clkoff + 14)) >> 4) * 10 + ((bus_space_read_1(bt, bh, clkoff + 14)) & 0xf));
 year = (((bus_space_read_1(bt, bh, clkoff + 15)) >> 4) * 10 + ((bus_space_read_1(bt, bh, clkoff + 15)) & 0xf));
 ...
 csr &= ~0x40;
 bus_space_write_1(bt, bh, clkoff + 8, csr);
 if ((handle)->todr_setwen) ((*(handle)->todr_setwen)(handle, 0));
 ...
 struct timeval *tv;
{
 ...
 bus_space_write_1(bt, bh, clkoff + 9, (((dt.dt_sec) / 10 * 16) + ((dt.dt_sec) % 10)));
 bus_space_write_1(bt, bh, clkoff + 10, (((dt.dt_min) / 10 * 16) + ((dt.dt_min) % 10)));
 bus_space_write_1(bt, bh, clkoff + 11, (((dt.dt_hour) / 10 * 16) + ((dt.dt_hour) % 10)));
 bus_space_write_1(bt, bh, clkoff + 12, (((dt.dt_wday) / 10 * 16) + ((dt.dt_wday) % 10)));
 bus_space_write_1(bt, bh, clkoff + 13, (((dt.dt_day) / 10 * 16) + ((dt.dt_day) % 10)));
 bus_space_write_1(bt, bh, clkoff + 14, (((dt.dt_mon) / 10 * 16) + ((dt.dt_mon) % 10)));
 bus_space_write_1(bt, bh, clkoff + 15, (((year) / 10 * 16) + ((year) % 10)));
