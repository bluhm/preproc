# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_shim.c" 2
...
mpls_shim_pop(struct mbuf *m)
{
 ...
 if (m->m_hdr.mh_len < sizeof(struct shim_hdr))
  if ((m = m_pullup(m, sizeof(struct shim_hdr))) == ((void *)0))
   return (((void *)0));
...
mpls_shim_swap(struct mbuf *m, struct rt_mpls *rt_mpls)
{
 ...
 shim->shim_label &= ~((u_int32_t)((__uint32_t)((u_int32_t)(0xfffff000U))));
 shim->shim_label |= rt_mpls->mpls_label & ((u_int32_t)((__uint32_t)((u_int32_t)(0xfffff000U))));


 {
  u_int32_t t;

  shim->shim_label &= ~((u_int32_t)((__uint32_t)((u_int32_t)(0x00000e00U))));
  t = rt_mpls->mpls_exp << 9;
  shim->shim_label |= ((__uint32_t)(t)) & ((u_int32_t)((__uint32_t)((u_int32_t)(0x00000e00U))));
 }
...
mpls_shim_push(struct mbuf *m, struct rt_mpls *rt_mpls)
{
 ...
 (m) = m_prepend((m), (sizeof(struct shim_hdr)), (0x0002));
 if (m == ((void *)0))
  return (((void *)0));

 shim = ((struct shim_hdr *)((m)->m_hdr.mh_data));
 __builtin_bzero(((caddr_t)shim), (sizeof(*shim)));
