# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c"
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c" 2
# 101 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c"
struct ugl_softc;
...
struct ugl_cdata {
 struct ugl_chain ugl_tx_chain[1];
 struct ugl_chain ugl_rx_chain[1];
 int ugl_tx_prod;
 int ugl_tx_cons;
 int ugl_tx_cnt;
 int ugl_rx_prod;
...
# 158 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_ugl.c"
...
ugl_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(ugl_devs), sizeof (ugl_devs) / sizeof ((ugl_devs)[0]), sizeof ((ugl_devs)[0]), (uaa->vendor), (uaa->product)) != ((void *)0) ?
     8 : 0);
}
...
ugl_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 for (i = 0; i < id->bNumEndpoints; i++) {
  ...
  if (((ed->bEndpointAddress) & 0x80) == 0x80 &&
   ...
   sc->sc_ed[0x0] = ed->bEndpointAddress;
  } else if (((ed->bEndpointAddress) & 0x80) == 0x00 &&
      ((ed->bmAttributes) & 0x03) == 0x02) {
   sc->sc_ed[0x1] = ed->bEndpointAddress;
  } else if (((ed->bEndpointAddress) & 0x80) == 0x80 &&
      ((ed->bmAttributes) & 0x03) == 0x03) {
   sc->sc_ed[0x2] = ed->bEndpointAddress;
  }
 }

 if (sc->sc_ed[0x0] == 0 || sc->sc_ed[0x1] == 0 ||
     sc->sc_ed[0x2] == 0) {
...
ugl_rx_list_init(struct ugl_softc *sc)
{
 ...
 for (i = 0; i < 1; i++) {
  ...
  c->ugl_sc = sc;
  c->ugl_idx = i;
  if (ugl_newbuf(sc, c, ((void *)0)) == 55)
   return (55);
  if (c->ugl_xfer == ((void *)0)) {
   c->ugl_xfer = usbd_alloc_xfer(sc->sc_udev);
   if (c->ugl_xfer == ((void *)0))
    return (55);
   c->ugl_buf = usbd_alloc_buffer(c->ugl_xfer, ((((sizeof(struct ugl_packet))+((64)-1))/(64))*(64)));
   if (c->ugl_buf == ((void *)0)) {
...
ugl_rxeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (status != USBD_NORMAL_COMPLETION) {
  ...
  if (status == USBD_STALLED)
   usbd_clear_endpoint_stall_async(sc->sc_ep[0x0]);
  goto done;
 }
 ...
 if (total_len < __builtin_offsetof(struct ugl_packet, pkt_data)) {
 ...
 packet_count = ((c->ugl_buf->pkt_count)[0] | ((c->ugl_buf->pkt_count)[1] << 8) | ((c->ugl_buf->pkt_count)[2] << 16) | ((c->ugl_buf->pkt_count)[3] << 24));
 if (packet_count != 1) {
 ...
 packet_len = ((c->ugl_buf->pkt_length)[0] | ((c->ugl_buf->pkt_length)[1] << 8) | ((c->ugl_buf->pkt_length)[2] << 16) | ((c->ugl_buf->pkt_length)[3] << 24));
 ...
 m = c->ugl_mbuf;
 __builtin_memcpy((((char *)((c->ugl_mbuf)->m_hdr.mh_data))), (c->ugl_buf->pkt_data), (packet_len));

 m->M_dat.MH.MH_pkthdr.len = m->m_hdr.mh_len = packet_len;
 ml_enqueue(&ml, m);
 ...
 usbd_setup_xfer(c->ugl_xfer, sc->sc_ep[0x0],
     c, c->ugl_buf, ((((sizeof(struct ugl_packet))+((64)-1))/(64))*(64)), 0x04 | 0x01,
     0, ugl_rxeof);
...
ugl_txeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (status != USBD_NORMAL_COMPLETION) {
  ...
  printf("%s: usb error on tx: %s\n", sc->sc_dev.dv_xname,
      usbd_errstr(status));
  if (status == USBD_STALLED)
   usbd_clear_endpoint_stall_async(sc->sc_ep[0x1]);
  _splx(s);
  return;
 }
...
ugl_send(struct ugl_softc *sc, struct mbuf *m, int idx)
{
 ...
 ((c->ugl_buf->pkt_count)[0] = (u_int8_t)(1), (c->ugl_buf->pkt_count)[1] = (u_int8_t)((1) >> 8), (c->ugl_buf->pkt_count)[2] = (u_int8_t)((1) >> 16), (c->ugl_buf->pkt_count)[3] = (u_int8_t)((1) >> 24));
 ((c->ugl_buf->pkt_length)[0] = (u_int8_t)(m->M_dat.MH.MH_pkthdr.len), (c->ugl_buf->pkt_length)[1] = (u_int8_t)((m->M_dat.MH.MH_pkthdr.len) >> 8), (c->ugl_buf->pkt_length)[2] = (u_int8_t)((m->M_dat.MH.MH_pkthdr.len) >> 16), (c->ugl_buf->pkt_length)[3] = (u_int8_t)((m->M_dat.MH.MH_pkthdr.len) >> 24));
 m_copydata(m, 0, m->M_dat.MH.MH_pkthdr.len, c->ugl_buf->pkt_data);
 c->ugl_mbuf = m;

 total_len = __builtin_offsetof(struct ugl_packet, pkt_data[m->M_dat.MH.MH_pkthdr.len]);

 ;


 usbd_setup_xfer(c->ugl_xfer, sc->sc_ep[0x1],
     c, c->ugl_buf, total_len, 0x08 | 0x01,
     5000, ugl_txeof);
...
ugl_init(void *xsc)
{
 ...
 if (ugl_rx_list_init(sc) == 55) {
  printf("%s: rx list init failed\n", sc->sc_dev.dv_xname);
  _splx(s);
  return;
 }

 if (sc->sc_ep[0x0] == ((void *)0)) {
  if (ugl_openpipes(sc)) {
   _splx(s);
   return;
  }
...
ugl_openpipes(struct ugl_softc *sc)
{
 ...
 err = usbd_open_pipe(sc->sc_iface, sc->sc_ed[0x0],
     0x01, &sc->sc_ep[0x0]);
 if (err) {
 ...
 err = usbd_open_pipe(sc->sc_iface, sc->sc_ed[0x1],
     0x01, &sc->sc_ep[0x1]);
 if (err) {
 ...
 err = usbd_open_pipe_intr(sc->sc_iface, sc->sc_ed[0x2],
     0x01, &sc->sc_ep[0x2], sc,
     sc->sc_ibuf, 8, ugl_intr,
     20);
 if (err) {
 ...
 for (i = 0; i < 1; i++) {
  ...
  usbd_setup_xfer(c->ugl_xfer, sc->sc_ep[0x0],
      c, c->ugl_buf, ((((sizeof(struct ugl_packet))+((64)-1))/(64))*(64)),
      0x04 | 0x01, 0,
      ugl_rxeof);
  usbd_transfer(c->ugl_xfer);
 }
...
ugl_stop(struct ugl_softc *sc)
{
 ...
 if (sc->sc_ep[0x0] != ((void *)0)) {
  usbd_abort_pipe(sc->sc_ep[0x0]);
  usbd_close_pipe(sc->sc_ep[0x0]);
  sc->sc_ep[0x0] = ((void *)0);
 }

 if (sc->sc_ep[0x1] != ((void *)0)) {
  usbd_abort_pipe(sc->sc_ep[0x1]);
  usbd_close_pipe(sc->sc_ep[0x1]);
  sc->sc_ep[0x1] = ((void *)0);
 }

 if (sc->sc_ep[0x2] != ((void *)0)) {
  usbd_abort_pipe(sc->sc_ep[0x2]);
  usbd_close_pipe(sc->sc_ep[0x2]);
  sc->sc_ep[0x2] = ((void *)0);
 }


 for (i = 0; i < 1; i++) {
  if (sc->sc_cdata.ugl_rx_chain[i].ugl_mbuf != ((void *)0)) {
   m_freem(sc->sc_cdata.ugl_rx_chain[i].ugl_mbuf);
   sc->sc_cdata.ugl_rx_chain[i].ugl_mbuf = ((void *)0);
  }
  if (sc->sc_cdata.ugl_rx_chain[i].ugl_xfer != ((void *)0)) {
   usbd_free_xfer(sc->sc_cdata.ugl_rx_chain[i].ugl_xfer);
   sc->sc_cdata.ugl_rx_chain[i].ugl_xfer = ((void *)0);
  }
 }


 for (i = 0; i < 1; i++) {
  if (sc->sc_cdata.ugl_tx_chain[i].ugl_mbuf != ((void *)0)) {
   m_freem(sc->sc_cdata.ugl_tx_chain[i].ugl_mbuf);
   sc->sc_cdata.ugl_tx_chain[i].ugl_mbuf = ((void *)0);
  }
  if (sc->sc_cdata.ugl_tx_chain[i].ugl_xfer != ((void *)0)) {
   usbd_free_xfer(sc->sc_cdata.ugl_tx_chain[i].ugl_xfer);
   sc->sc_cdata.ugl_tx_chain[i].ugl_xfer = ((void *)0);
  }
 }
}
