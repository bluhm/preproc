# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c"
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c"
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/radioio.h" 1
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/radioio.h"
struct radio_info {
 int mute;
 int volume;
 int stereo;
 ...
 u_int32_t freq;
 u_int32_t caps;
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/radioio.h"
 u_int32_t info;
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio_if.h" 1
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio_if.h"
struct radio_hw_if {
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radiovar.h" 1
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radiovar.h"
struct radio_softc {
 struct device dev;
 void *hw_hdl;
 struct device *sc_dev;
 struct radio_hw_if *hw_if;
 char sc_dying;
};
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/radio.c" 2
...
radioopen(dev_t dev, int flags, int fmt, struct proc *p)
{
 ...
 if (unit >= radio_cd.cd_ndevs ||
     (sc = radio_cd.cd_devs[unit]) == ((void *)0) ||
      sc->hw_if == ((void *)0))
  return (6);
...
radioclose(dev_t dev, int flags, int fmt, struct proc *p)
{
 ...
 sc = radio_cd.cd_devs[(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)))];
...
radioioctl(dev_t dev, u_long cmd, caddr_t data, int flags, struct proc *p)
{
 ...
 unit = (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)));
 if (unit >= radio_cd.cd_ndevs ||
     (sc = radio_cd.cd_devs[unit]) == ((void *)0) || sc->hw_if == ((void *)0))
  return (6);

 error = 45;
 switch (cmd) {
 case ((unsigned long)0x40000000 | ((sizeof(struct radio_info) & 0x1fff) << 16) | ((('R')) << 8) | ((21))):
  if (sc->hw_if->get_info)
   error = (sc->hw_if->get_info)(sc->hw_hdl,
     (struct radio_info *)data);
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct radio_info) & 0x1fff) << 16) | ((('R')) << 8) | ((22))):
  if (!(flags & 0x0002))
   return (13);
  if (sc->hw_if->set_info)
   error = (sc->hw_if->set_info)(sc->hw_hdl,
    (struct radio_info *)data);
  break;
 case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('R')) << 8) | ((23))):
  if (!(flags & 0x0002))
   return (13);
  if (sc->hw_if->search)
...
radio_attach_mi(struct radio_hw_if *rhwp, void *hdlp, struct device *dev)
{
 ...
 arg.hwif = rhwp;
 arg.hdl = hdlp;
 return (config_found_sm((dev), (&arg), (radioprint), ((void *)0)));
}
