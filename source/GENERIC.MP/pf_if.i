# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/filio.h" 1
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/filio.h"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/ioccom.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/filio.h" 2
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
void pf_send_tcp(const struct pf_rule *, sa_family_t,
       ...
       u_int8_t, u_int16_t, u_int16_t, u_int8_t, int,
       u_int16_t, u_int);
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_if.c" 2


struct pfi_kif *pfi_all = ((void *)0);
...
int pfi_unmask(void *);
 ...
 void pfi_ifhead_RB_INSERT_COLOR(struct pfi_ifhead *, struct pfi_kif *); void pfi_ifhead_RB_REMOVE_COLOR(struct pfi_ifhead *, struct pfi_kif *, struct pfi_kif *); struct pfi_kif *pfi_ifhead_RB_REMOVE(struct pfi_ifhead *, struct pfi_kif *); struct pfi_kif *pfi_ifhead_RB_INSERT(struct pfi_ifhead *, struct pfi_kif *); struct pfi_kif *pfi_ifhead_RB_FIND(struct pfi_ifhead *, struct pfi_kif *); struct pfi_kif *pfi_ifhead_RB_NFIND(struct pfi_ifhead *, struct pfi_kif *); struct pfi_kif *pfi_ifhead_RB_NEXT(struct pfi_kif *); struct pfi_kif *pfi_ifhead_RB_PREV(struct pfi_kif *); struct pfi_kif *pfi_ifhead_RB_MINMAX(struct pfi_ifhead *, int);;
...
pfi_initialize(void)
{
 ...
 pool_init(&pfi_addr_pl, sizeof(struct pfi_dynaddr), 0, 2, 0,
     "pfiaddrpl", ((void *)0));
 pfi_buffer_max = 64;
 pfi_buffer = mallocarray(pfi_buffer_max, sizeof(*pfi_buffer),
     9, 0x0001);

 if ((pfi_all = pfi_kif_get("all")) == ((void *)0))
...
pfi_kif_get(const char *kif_name)
{
 ...
 if ((kif = malloc(sizeof(*kif), 9, 0x0002|0x0008)) == ((void *)0))
  return (((void *)0));

 strlcpy(kif->pfik_name, kif_name, sizeof(kif->pfik_name));
 kif->pfik_tzero = time_second;
 do { (&kif->pfik_dynaddrs)->tqh_first = ((void *)0); (&kif->pfik_dynaddrs)->tqh_last = &(&kif->pfik_dynaddrs)->tqh_first; } while (0);

 if (!strcmp(kif->pfik_name, "any")) {

  kif->pfik_flags |= 0x0200;
  kif->pfik_flags_new |= 0x0200;
 }

 pfi_ifhead_RB_INSERT(&pfi_ifs, kif);
 return (kif);
}
...
pfi_kif_unref(struct pfi_kif *kif, enum pfi_kif_refs what)
{
 ...
 case PFI_KIF_REF_RULE:
  if (kif->pfik_rules <= 0) {
   do { if (pf_status.debug >= (3)) { log(3, "pf: "); addlog("pfi_kif_unref: rules refcount <= 0"); addlog("\n"); } } while (0);
 ...
 if (kif->pfik_ifp != ((void *)0) || kif->pfik_group != ((void *)0) || kif == pfi_all)
  return;

 if (kif->pfik_rules || kif->pfik_states || kif->pfik_routes)
  return;

 pfi_ifhead_RB_REMOVE(&pfi_ifs, kif);
 free(kif, 9, sizeof(*kif));
}
...
pfi_kif_match(struct pfi_kif *rule_kif, struct pfi_kif *packet_kif)
{
 ...
 if (rule_kif->pfik_group != ((void *)0))
  for((p) = ((&packet_kif->pfik_ifp->if_groups)->tqh_first); (p) != ((void *)0); (p) = ((p)->ifgl_next.tqe_next))
   if (p->ifgl_group == rule_kif->pfik_group)
    return (1);

 if (rule_kif->pfik_flags & 0x0200 && packet_kif->pfik_ifp &&
     !(packet_kif->pfik_ifp->if_flags & 0x8))
  return (1);
...
pfi_attach_ifnet(struct ifnet *ifp)
{
 ...
 pfi_initialize();
 pfi_update++;
 if ((kif = pfi_kif_get(ifp->if_xname)) == ((void *)0))
...
pfi_attach_ifgroup(struct ifg_group *ifg)
{
 ...
 pfi_initialize();
 pfi_update++;
 if ((kif = pfi_kif_get(ifg->ifg_group)) == ((void *)0))
  panic("pfi_kif_get failed");
...
pfi_detach_ifgroup(struct ifg_group *ifg)
{
 ...
 if ((kif = (struct pfi_kif *)ifg->ifg_pf_kif) == ((void *)0))
  return;

 pfi_update++;

 kif->pfik_group = ((void *)0);
 ifg->ifg_pf_kif = ((void *)0);
 pfi_kif_unref(kif, PFI_KIF_REF_NONE);
}
...
pfi_group_change(const char *group)
{
 ...
 pfi_update++;
 if ((kif = pfi_kif_get(group)) == ((void *)0))
  panic("pfi_kif_get failed");
...
pfi_dynaddr_setup(struct pf_addr_wrap *aw, sa_family_t af)
{
 ...
 if (aw->type != PF_ADDR_DYNIFTL)
  return (0);
 if ((dyn = pool_get(&pfi_addr_pl, 0x0001 | 0x0004 | 0x0008))
     == ((void *)0))
  return (1);
 ...
 if ((ruleset = pf_find_or_create_ruleset("_pf")) == ((void *)0)) {
  rv = 1;
  goto _bad;
 }

 if ((dyn->pfid_kt = pfr_attach_table(ruleset, tblname, 1)) == ((void *)0)) {
  rv = 1;
  goto _bad;
 }
 ...
 do { (dyn)->entry.tqe_next = ((void *)0); (dyn)->entry.tqe_prev = (&dyn->pfid_kif->pfik_dynaddrs)->tqh_last; *(&dyn->pfid_kif->pfik_dynaddrs)->tqh_last = (dyn); (&dyn->pfid_kif->pfik_dynaddrs)->tqh_last = &(dyn)->entry.tqe_next; } while (0);
 aw->p.dyn = dyn;
...
pfi_kif_update(struct pfi_kif *kif)
{
 ...
 for((p) = ((&kif->pfik_dynaddrs)->tqh_first); (p) != ((void *)0); (p) = ((p)->entry.tqe_next))
  pfi_dynaddr_update(p);


 if (kif->pfik_ifp != ((void *)0))
  for((ifgl) = ((&kif->pfik_ifp->if_groups)->tqh_first); (ifgl) != ((void *)0); (ifgl) = ((ifgl)->ifgl_next.tqe_next))
...
pfi_table_update(struct pfr_ktable *kt, struct pfi_kif *kif, u_int8_t net, int flags)
{
 ...
 else if (kif->pfik_group != ((void *)0))
  for((ifgm) = ((&kif->pfik_group->ifg_members)->tqh_first); (ifgm) != ((void *)0); (ifgm) = ((ifgm)->ifgm_next.tqe_next))
   pfi_instance_add(ifgm->ifgm_ifp, net, flags);

 if ((e = pfr_set_addrs(&kt->pfrkt_ts.pfrts_t, pfi_buffer, pfi_buffer_cnt, &size2,
     ((void *)0), ((void *)0), ((void *)0), 0, 0x0000007F)))
  do { if (pf_status.debug >= (3)) { log(3, "pf: "); addlog("pfi_table_update: cannot set %d new addresses " "into table %s: %d", pfi_buffer_cnt, kt->pfrkt_ts.pfrts_t.pfrt_name, e); addlog("\n"); } } while (0);
...
pfi_instance_add(struct ifnet *ifp, u_int8_t net, int flags)
{
 ...
 for((ifa) = ((&ifp->if_addrlist)->tqh_first); (ifa) != ((void *)0); (ifa) = ((ifa)->ifa_list.tqe_next)) {
  ...
  if ((flags & 0x04) &&
   ...
   continue;
  if ((flags & 0x01) && af == 24 &&
      (((&((struct sockaddr_in6 *)ifa->ifa_addr)->sin6_addr)->__u6_addr.__u6_addr8[0] == 0xfe) && (((&((struct sockaddr_in6 *)ifa->ifa_addr)->sin6_addr)->__u6_addr.__u6_addr8[1] & 0xc0) == 0x80)))
...
pfi_address_add(struct sockaddr *sa, sa_family_t af, u_int8_t net)
{
 ...
 if (pfi_buffer_cnt >= pfi_buffer_max) {
  ...
  if (new_max > 0x10000) {
   do { if (pf_status.debug >= (3)) { log(3, "pf: "); addlog("pfi_address_add: address buffer full (%d/%d)", pfi_buffer_cnt, 0x10000); addlog("\n"); } } while (0);


   return;
  }
  p = mallocarray(new_max, sizeof(*pfi_buffer), 9,
      0x0002);
  if (p == ((void *)0)) {
   do { if (pf_status.debug >= (3)) { log(3, "pf: "); addlog("pfi_address_add: no memory to grow buffer " "(%d/%d)", pfi_buffer_cnt, 0x10000); addlog("\n"); } } while (0);


   return;
  }
  __builtin_memcpy((p), (pfi_buffer), (pfi_buffer_max * sizeof(*pfi_buffer)));

  free(pfi_buffer, 9, pfi_buffer_max * sizeof(*pfi_buffer));
  pfi_buffer = p;
 ...
 if (af == 2)
  ...
  if ((((((&p->pfra_u._pfra_ip6addr)->__u6_addr.__u6_addr8[0] == 0xfe) && (((&p->pfra_u._pfra_ip6addr)->__u6_addr.__u6_addr8[1] & 0xc0) == 0x80))) || ((((&p->pfra_u._pfra_ip6addr)->__u6_addr.__u6_addr8[0] == 0xff) && (((&p->pfra_u._pfra_ip6addr)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x02))) || ((((&p->pfra_u._pfra_ip6addr)->__u6_addr.__u6_addr8[0] == 0xff) && (((&p->pfra_u._pfra_ip6addr)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x01)))))
...
pfi_dynaddr_remove(struct pf_addr_wrap *aw)
{
 ...
 do { if (((aw->p.dyn)->entry.tqe_next) != ((void *)0)) (aw->p.dyn)->entry.tqe_next->entry.tqe_prev = (aw->p.dyn)->entry.tqe_prev; else (&aw->p.dyn->pfid_kif->pfik_dynaddrs)->tqh_last = (aw->p.dyn)->entry.tqe_prev; *(aw->p.dyn)->entry.tqe_prev = (aw->p.dyn)->entry.tqe_next; ((aw->p.dyn)->entry.tqe_prev) = ((void *)-1); ((aw->p.dyn)->entry.tqe_next) = ((void *)-1); } while (0);
...
{
 return (strncmp(p->pfik_name, q->pfik_name, 16));
}
...
pfi_update_status(const char *name, struct pf_status *pfs)
{
 ...
 p = pfi_ifhead_RB_FIND(&pfi_ifs, (struct pfi_kif *)&key);
 if (p == ((void *)0)) {
  return;
 }
...
pfi_get_ifaces(const char *name, struct pfi_kif *buf, int *size)
{
 ...
 for (p = pfi_ifhead_RB_MINMAX(&pfi_ifs, -1); p; p = nextp) {
  nextp = pfi_ifhead_RB_NEXT(p);
...
pfi_skip_if(const char *filter, struct pfi_kif *p)
{
 ...
 if (filter[n-1] >= '0' && filter[n-1] <= '9')
  return (1);
 if (p->pfik_ifp != ((void *)0))
  for((i) = ((&p->pfik_ifp->if_groups)->tqh_first); (i) != ((void *)0); (i) = ((i)->ifgl_next.tqe_next))
   if (!strncmp(i->ifgl_group->ifg_group, filter, 16))
    return (0);
 return (1);
}
