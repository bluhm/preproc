# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c"
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c"
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c" 2
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c"
void endrunattach(int);
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c"
...
endrunopen(dev_t dev, struct tty *tp, struct proc *p)
{
 ...
 error = linesw[0].l_open(dev, tp, p);
 if (error) {
  free(np, 2, sizeof(*np));
  tp->t_sc = ((void *)0);
 } else {
...
endrunclose(struct tty *tp, int flags, struct proc *p)
{
 ...
 if (endrun_count == 0)
  endrun_nxid = 0;
 return linesw[0].l_close(tp, flags, p);
}
...
endruninput(int c, struct tty *tp)
{
 ...
 if (np->sync == 2) {
  ...
  np->gap = gap;
# 217 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c"
  if (tp->t_flags & (0x10000 | 0x20000 |
      0x40000 | 0x80000)) {
...
endrun_scan(struct endrun *np, struct tty *tp)
{
 ...
 for (cs = ((void *)0), n = 0; n < np->pos && cs == ((void *)0); n++) {
  switch (np->cbuf[n]) {
  case '\r':
   np->cbuf[n] = '\0';
   cs = &np->cbuf[n + 1];
...
# 343 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c"
 switch (tfom = fld[0][0]) {
 case '6':
 case '7':
 case '8':
...
# 366 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c"
 if (jumped)
  np->time.status = SENSOR_S_WARN;
 if (np->time.status == SENSOR_S_OK)
  timeout_add_sec(&np->endrun_tout, (10 * 60));
...
# 421 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_endrun.c"
