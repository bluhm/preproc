# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600d.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/avivod.h" 1
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c" 2
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
;
;
;
;
...
void r600_pm_get_dynpm_state(struct radeon_device *rdev)
{
 ...
 if ((rdev->flags & RADEON_IS_IGP) || (rdev->family == CHIP_R600)) {
   ...
   if (rdev->pm.current_power_state_index == min_power_state_index) {
    ...
    if (rdev->pm.active_crtc_count > 1) {
     for (i = 0; i < rdev->pm.num_power_states; i++) {
      if (rdev->pm.power_state[i].flags & (1 << 0))
       continue;
  ...
  default:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Requested mode for not defined action\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return;
  }
 } else {
...
void rs780_pm_init_profile(struct radeon_device *rdev)
{
 if (rdev->pm.num_power_states == 2) {
  ...
  rdev->pm.profiles[1].dpms_off_ps_idx = 0;
  rdev->pm.profiles[1].dpms_on_ps_idx = 0;
  rdev->pm.profiles[1].dpms_off_cm_idx = 0;
  rdev->pm.profiles[1].dpms_on_cm_idx = 0;

  rdev->pm.profiles[2].dpms_off_ps_idx = 0;
  rdev->pm.profiles[2].dpms_on_ps_idx = 0;
  rdev->pm.profiles[2].dpms_off_cm_idx = 0;
  rdev->pm.profiles[2].dpms_on_cm_idx = 0;

  rdev->pm.profiles[3].dpms_off_ps_idx = 0;
  rdev->pm.profiles[3].dpms_on_ps_idx = 1;
  rdev->pm.profiles[3].dpms_off_cm_idx = 0;
  rdev->pm.profiles[3].dpms_on_cm_idx = 0;

  rdev->pm.profiles[4].dpms_off_ps_idx = 0;
  rdev->pm.profiles[4].dpms_on_ps_idx = 0;
  rdev->pm.profiles[4].dpms_off_cm_idx = 0;
  rdev->pm.profiles[4].dpms_on_cm_idx = 0;

  rdev->pm.profiles[5].dpms_off_ps_idx = 0;
  rdev->pm.profiles[5].dpms_on_ps_idx = 0;
  rdev->pm.profiles[5].dpms_off_cm_idx = 0;
  rdev->pm.profiles[5].dpms_on_cm_idx = 0;

  rdev->pm.profiles[6].dpms_off_ps_idx = 0;
  rdev->pm.profiles[6].dpms_on_ps_idx = 1;
  rdev->pm.profiles[6].dpms_off_cm_idx = 0;
  rdev->pm.profiles[6].dpms_on_cm_idx = 0;
  ...
  rdev->pm.profiles[1].dpms_off_ps_idx = 1;
  rdev->pm.profiles[1].dpms_on_ps_idx = 1;
  rdev->pm.profiles[1].dpms_off_cm_idx = 0;
  rdev->pm.profiles[1].dpms_on_cm_idx = 0;

  rdev->pm.profiles[2].dpms_off_ps_idx = 1;
  rdev->pm.profiles[2].dpms_on_ps_idx = 1;
  rdev->pm.profiles[2].dpms_off_cm_idx = 0;
  rdev->pm.profiles[2].dpms_on_cm_idx = 0;

  rdev->pm.profiles[3].dpms_off_ps_idx = 1;
  rdev->pm.profiles[3].dpms_on_ps_idx = 2;
  rdev->pm.profiles[3].dpms_off_cm_idx = 0;
  rdev->pm.profiles[3].dpms_on_cm_idx = 0;

  rdev->pm.profiles[4].dpms_off_ps_idx = 1;
  rdev->pm.profiles[4].dpms_on_ps_idx = 1;
  rdev->pm.profiles[4].dpms_off_cm_idx = 0;
  rdev->pm.profiles[4].dpms_on_cm_idx = 0;

  rdev->pm.profiles[5].dpms_off_ps_idx = 1;
  rdev->pm.profiles[5].dpms_on_ps_idx = 1;
  rdev->pm.profiles[5].dpms_off_cm_idx = 0;
  rdev->pm.profiles[5].dpms_on_cm_idx = 0;

  rdev->pm.profiles[6].dpms_off_ps_idx = 1;
  rdev->pm.profiles[6].dpms_on_ps_idx = 2;
  rdev->pm.profiles[6].dpms_off_cm_idx = 0;
  rdev->pm.profiles[6].dpms_on_cm_idx = 0;
 } else {
  ...
  rdev->pm.profiles[1].dpms_off_ps_idx = 2;
  rdev->pm.profiles[1].dpms_on_ps_idx = 2;
  rdev->pm.profiles[1].dpms_off_cm_idx = 0;
  rdev->pm.profiles[1].dpms_on_cm_idx = 0;

  rdev->pm.profiles[2].dpms_off_ps_idx = 2;
  rdev->pm.profiles[2].dpms_on_ps_idx = 2;
  rdev->pm.profiles[2].dpms_off_cm_idx = 0;
  rdev->pm.profiles[2].dpms_on_cm_idx = 0;

  rdev->pm.profiles[3].dpms_off_ps_idx = 2;
  rdev->pm.profiles[3].dpms_on_ps_idx = 3;
  rdev->pm.profiles[3].dpms_off_cm_idx = 0;
  rdev->pm.profiles[3].dpms_on_cm_idx = 0;

  rdev->pm.profiles[4].dpms_off_ps_idx = 2;
  rdev->pm.profiles[4].dpms_on_ps_idx = 0;
  rdev->pm.profiles[4].dpms_off_cm_idx = 0;
  rdev->pm.profiles[4].dpms_on_cm_idx = 0;

  rdev->pm.profiles[5].dpms_off_ps_idx = 2;
  rdev->pm.profiles[5].dpms_on_ps_idx = 0;
  rdev->pm.profiles[5].dpms_off_cm_idx = 0;
  rdev->pm.profiles[5].dpms_on_cm_idx = 0;

  rdev->pm.profiles[6].dpms_off_ps_idx = 2;
  rdev->pm.profiles[6].dpms_on_ps_idx = 3;
  rdev->pm.profiles[6].dpms_off_cm_idx = 0;
  rdev->pm.profiles[6].dpms_on_cm_idx = 0;
 }
}
...
void r600_pm_init_profile(struct radeon_device *rdev)
{
 ...
 if (rdev->family == CHIP_R600) {
  ...
  rdev->pm.profiles[1].dpms_off_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[1].dpms_on_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[1].dpms_off_cm_idx = 0;
  rdev->pm.profiles[1].dpms_on_cm_idx = 0;

  rdev->pm.profiles[2].dpms_off_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[2].dpms_on_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[2].dpms_off_cm_idx = 0;
  rdev->pm.profiles[2].dpms_on_cm_idx = 0;

  rdev->pm.profiles[3].dpms_off_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[3].dpms_on_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[3].dpms_off_cm_idx = 0;
  rdev->pm.profiles[3].dpms_on_cm_idx = 0;

  rdev->pm.profiles[4].dpms_off_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[4].dpms_on_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[4].dpms_off_cm_idx = 0;
  rdev->pm.profiles[4].dpms_on_cm_idx = 0;

  rdev->pm.profiles[5].dpms_off_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[5].dpms_on_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[5].dpms_off_cm_idx = 0;
  rdev->pm.profiles[5].dpms_on_cm_idx = 0;

  rdev->pm.profiles[6].dpms_off_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[6].dpms_on_ps_idx = rdev->pm.default_power_state_index;
  rdev->pm.profiles[6].dpms_off_cm_idx = 0;
  rdev->pm.profiles[6].dpms_on_cm_idx = 0;
 } else {
  if (rdev->pm.num_power_states < 4) {
   ...
   rdev->pm.profiles[4].dpms_off_ps_idx = 2;
   rdev->pm.profiles[4].dpms_on_ps_idx = 2;
   rdev->pm.profiles[4].dpms_off_cm_idx = 0;
   rdev->pm.profiles[4].dpms_on_cm_idx = 0;

   rdev->pm.profiles[5].dpms_off_ps_idx = 2;
   rdev->pm.profiles[5].dpms_on_ps_idx = 2;
   rdev->pm.profiles[5].dpms_off_cm_idx = 0;
...
_Bool r600_gui_idle(struct radeon_device *rdev)
{
...
_Bool r600_hpd_sense(struct radeon_device *rdev, enum radeon_hpd_id hpd)
{
 ...
 if (((rdev->family >= CHIP_RV620))) {
  switch (hpd) {
  case RADEON_HPD_1:
   if (r100_mm_rreg(rdev, (0x7d00), 0) & (1 << 1))
    connected = 1;
   break;
  case RADEON_HPD_2:
   if (r100_mm_rreg(rdev, (0x7d0c), 0) & (1 << 1))
    connected = 1;
   break;
  case RADEON_HPD_3:
   if (r100_mm_rreg(rdev, (0x7d18), 0) & (1 << 1))
    connected = 1;
   break;
  case RADEON_HPD_4:
   if (r100_mm_rreg(rdev, (0x7d24), 0) & (1 << 1))
    connected = 1;
   break;

  case RADEON_HPD_5:
   if (r100_mm_rreg(rdev, (0x7dc0), 0) & (1 << 1))
    connected = 1;
   break;
  case RADEON_HPD_6:
   if (r100_mm_rreg(rdev, (0x7df4), 0) & (1 << 1))
    connected = 1;
   break;
  default:
   break;
  ...
  switch (hpd) {
  case RADEON_HPD_1:
   if (r100_mm_rreg(rdev, (0x7d04), 0) & (1 << 1))
    connected = 1;
   break;
  case RADEON_HPD_2:
   if (r100_mm_rreg(rdev, (0x7d14), 0) & (1 << 1))
    connected = 1;
   break;
  case RADEON_HPD_3:
   if (r100_mm_rreg(rdev, (0x7d28), 0) & (1 << 1))
    connected = 1;
   break;
  default:
   break;
...
{
 u32 tmp;
 _Bool connected = r600_hpd_sense(rdev, hpd);

 if (((rdev->family >= CHIP_RV620))) {
  switch (hpd) {
  case RADEON_HPD_1:
   tmp = r100_mm_rreg(rdev, (0x7d04), 0);
   if (connected)
    tmp &= ~(1 << 8);
   else
    tmp |= (1 << 8);
   r100_mm_wreg(rdev, (0x7d04), (tmp), 0);
   break;
  case RADEON_HPD_2:
   tmp = r100_mm_rreg(rdev, (0x7d10), 0);
   if (connected)
    tmp &= ~(1 << 8);
   else
    tmp |= (1 << 8);
   r100_mm_wreg(rdev, (0x7d10), (tmp), 0);
   break;
  case RADEON_HPD_3:
   tmp = r100_mm_rreg(rdev, (0x7d1c), 0);
   if (connected)
    tmp &= ~(1 << 8);
   else
    tmp |= (1 << 8);
   r100_mm_wreg(rdev, (0x7d1c), (tmp), 0);
   break;
  case RADEON_HPD_4:
   tmp = r100_mm_rreg(rdev, (0x7d28), 0);
   if (connected)
    tmp &= ~(1 << 8);
   else
    tmp |= (1 << 8);
   r100_mm_wreg(rdev, (0x7d28), (tmp), 0);
   break;
  case RADEON_HPD_5:
  ...
  switch (hpd) {
  case RADEON_HPD_1:
   tmp = r100_mm_rreg(rdev, (0x7d08), 0);
   if (connected)
    tmp &= ~(1 << 8);
   else
    tmp |= (1 << 8);
   r100_mm_wreg(rdev, (0x7d08), (tmp), 0);
   break;
  case RADEON_HPD_2:
   tmp = r100_mm_rreg(rdev, (0x7d18), 0);
   if (connected)
    tmp &= ~(1 << 8);
   else
    tmp |= (1 << 8);
   r100_mm_wreg(rdev, (0x7d18), (tmp), 0);
   break;
  case RADEON_HPD_3:
   tmp = r100_mm_rreg(rdev, (0x7d2c), 0);
   if (connected)
    tmp &= ~(1 << 8);
   else
    tmp |= (1 << 8);
   r100_mm_wreg(rdev, (0x7d2c), (tmp), 0);
   break;
  default:
   break;
  }
 ...
 for (connector = ({ __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = ((&dev->mode_config.connector_list)->next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );}); &connector->head != (&dev->mode_config.connector_list); connector = ({ __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = (connector->head.next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );})) {
  ...
  if (((rdev->family >= CHIP_RV620))) {
   ...
   case RADEON_HPD_1:
    ...
    break;
   case RADEON_HPD_2:
    r100_mm_wreg(rdev, (0x7d14), (tmp), 0);
    break;
   case RADEON_HPD_3:
    r100_mm_wreg(rdev, (0x7d20), (tmp), 0);
    break;
   case RADEON_HPD_4:
    r100_mm_wreg(rdev, (0x7d2c), (tmp), 0);
    break;
   ...
   case RADEON_HPD_5:
    r100_mm_wreg(rdev, (0x7dc8), (tmp), 0);
    break;
   case RADEON_HPD_6:
    r100_mm_wreg(rdev, (0x7dfc), (tmp), 0);
    break;
   default:
    break;
   }
   ...
   switch (radeon_connector->hpd.hpd) {
   case RADEON_HPD_1:
    r100_mm_wreg(rdev, (0x7d00), ((1 << 0)), 0);
    break;
   case RADEON_HPD_2:
    r100_mm_wreg(rdev, (0x7d10), ((1 << 0)), 0);
    break;
   case RADEON_HPD_3:
    r100_mm_wreg(rdev, (0x7d24), ((1 << 0)), 0);
    break;
   default:
    break;
   }
  ...
  (rdev)->asic->hpd.set_polarity((rdev), (radeon_connector->hpd.hpd));
 }
...
void r600_hpd_fini(struct radeon_device *rdev)
{
 ...
 for (connector = ({ __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = ((&dev->mode_config.connector_list)->next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );}); &connector->head != (&dev->mode_config.connector_list); connector = ({ __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = (connector->head.next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );})) {
  ...
  if (((rdev->family >= CHIP_RV620))) {
   switch (radeon_connector->hpd.hpd) {
   case RADEON_HPD_1:
    r100_mm_wreg(rdev, (0x7d08), (0), 0);
    break;
   case RADEON_HPD_2:
    r100_mm_wreg(rdev, (0x7d14), (0), 0);
    break;
   case RADEON_HPD_3:
    r100_mm_wreg(rdev, (0x7d20), (0), 0);
    break;
   case RADEON_HPD_4:
    r100_mm_wreg(rdev, (0x7d2c), (0), 0);
    break;

   case RADEON_HPD_5:
    r100_mm_wreg(rdev, (0x7dc8), (0), 0);
    break;
   case RADEON_HPD_6:
    r100_mm_wreg(rdev, (0x7dfc), (0), 0);
    break;
   default:
    break;
   }
   ...
   switch (radeon_connector->hpd.hpd) {
   case RADEON_HPD_1:
    r100_mm_wreg(rdev, (0x7d00), (0), 0);
    break;
   case RADEON_HPD_2:
    r100_mm_wreg(rdev, (0x7d10), (0), 0);
    break;
   case RADEON_HPD_3:
    r100_mm_wreg(rdev, (0x7d24), (0), 0);
    break;
   default:
    break;
   }
...
void r600_pcie_gart_tlb_flush(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x14B0), ((rdev->mc.gtt_end - 1) >> 12), 0);
 r100_mm_wreg(rdev, (0x1470), ((((1) & 0xf) << 0)), 0);
 for (i = 0; i < rdev->usec_timeout; i++) {

  tmp = r100_mm_rreg(rdev, (0x1470), 0);
  tmp = (tmp & 0x000000F0) >> 4;
  if (tmp == 2) {
   printf("" "[drm] r600 flush TLB failed\n");
   return;
  }
  if (tmp) {
   return;
...
static int r600_pcie_gart_enable(struct radeon_device *rdev)
{
 ...
 tmp = (1 << 0) | (1 << 1) |
  ...
  (((5) & 7) << 12) | (((5) & 7) << 15) |
  (1 << 11);
 r100_mm_wreg(rdev, (0x2200), (tmp), 0);
 r100_mm_wreg(rdev, (0x2214), (tmp), 0);
 r100_mm_wreg(rdev, (0x2204), (tmp | (1 << 2)), 0);
 r100_mm_wreg(rdev, (0x2218), (tmp), 0);
 r100_mm_wreg(rdev, (0x219C), (tmp), 0);
 r100_mm_wreg(rdev, (0x21A4), (tmp), 0);
 r100_mm_wreg(rdev, (0x21A0), (tmp), 0);
 r100_mm_wreg(rdev, (0x21A8), (tmp), 0);
 r100_mm_wreg(rdev, (0x21FC), (tmp), 0);
 ...
 r100_mm_wreg(rdev, (0x15B4), (rdev->mc.gtt_end >> 12), 0);
 r100_mm_wreg(rdev, (0x1574), (rdev->gart.table_addr >> 12), 0);
 r100_mm_wreg(rdev, (0x1410), ((1 << 0) | (((0) & 3) << 1) | (1 << 4)), 0);

 r100_mm_wreg(rdev, (0x1554), ((u32)(rdev->dummy_page.addr >> 12)), 0);

 for (i = 1; i < 7; i++)
  r100_mm_wreg(rdev, (0x1410 + (i * 4)), (0), 0);
...
static void r600_pcie_gart_disable(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x1400), ((1 << 1) | (((7) & 7) << 13)), 0);
 ...
 r100_mm_wreg(rdev, (0x2208), (tmp), 0);
 r100_mm_wreg(rdev, (0x221C), (tmp), 0);
 r100_mm_wreg(rdev, (0x220C), (tmp), 0);
 r100_mm_wreg(rdev, (0x2220), (tmp), 0);
 r100_mm_wreg(rdev, (0x2200), (tmp), 0);
 r100_mm_wreg(rdev, (0x2214), (tmp), 0);
...
int r600_mc_wait_for_idle(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < rdev->usec_timeout; i++) {
  ...
  tmp = r100_mm_rreg(rdev, (0x0E50), 0) & 0x3F00;
  if (!tmp)
   return 0;
  udelay(1);
 }
...
static void r600_mc_program(struct radeon_device *rdev)
{
 ...
 for (i = 0, j = 0; i < 32; i++, j += 0x18) {
  r100_mm_wreg(rdev, ((0x2c14 + j)), (0x00000000), 0);
  r100_mm_wreg(rdev, ((0x2c18 + j)), (0x00000000), 0);
  r100_mm_wreg(rdev, ((0x2c1c + j)), (0x00000000), 0);
  r100_mm_wreg(rdev, ((0x2c20 + j)), (0x00000000), 0);
  r100_mm_wreg(rdev, ((0x2c24 + j)), (0x00000000), 0);
 }
 r100_mm_wreg(rdev, (0x54A0), (0), 0);
 ...
 r100_mm_wreg(rdev, (0x328), ((1 << 4)), 0);

 if (rdev->flags & RADEON_IS_AGP) {
  if (rdev->mc.vram_start < rdev->mc.gtt_start) {

   r100_mm_wreg(rdev, (0x2190), (rdev->mc.vram_start >> 12), 0);

   r100_mm_wreg(rdev, (0x2194), (rdev->mc.gtt_end >> 12), 0);

  } else {

   r100_mm_wreg(rdev, (0x2190), (rdev->mc.gtt_start >> 12), 0);

   r100_mm_wreg(rdev, (0x2194), (rdev->mc.vram_end >> 12), 0);
 ...
 r100_mm_wreg(rdev, (0x2198), (rdev->vram_scratch.gpu_addr >> 12), 0);
 tmp = ((rdev->mc.vram_end >> 24) & 0xFFFF) << 16;
 tmp |= ((rdev->mc.vram_start >> 24) & 0xFFFF);
 r100_mm_wreg(rdev, (0x2180), (tmp), 0);
 r100_mm_wreg(rdev, (0x2C04), ((rdev->mc.vram_start >> 8)), 0);
 r100_mm_wreg(rdev, (0x2C08), ((2 << 7)), 0);
 r100_mm_wreg(rdev, (0x2C0C), (0x3FFFFFFF), 0);
 if (rdev->flags & RADEON_IS_AGP) {
  r100_mm_wreg(rdev, (0x2184), (rdev->mc.gtt_end >> 22), 0);
  r100_mm_wreg(rdev, (0x2188), (rdev->mc.gtt_start >> 22), 0);
  r100_mm_wreg(rdev, (0x218C), (rdev->mc.agp_base >> 22), 0);
 } else {
  r100_mm_wreg(rdev, (0x218C), (0), 0);
  r100_mm_wreg(rdev, (0x2184), (0x0FFFFFFF), 0);
  r100_mm_wreg(rdev, (0x2188), (0x0FFFFFFF), 0);
 }
 if (r600_mc_wait_for_idle(rdev)) {
  printf("drm:pid%d:%s *WARNING* " "Wait for MC idle timedout !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 }
...
# 1113 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
static void r600_vram_gtt_location(struct radeon_device *rdev, struct radeon_mc *mc)
{
 ...
 if (rdev->flags & RADEON_IS_AGP) {
  ...
  if (rdev->flags & RADEON_IS_IGP) {
   base = r100_mm_rreg(rdev, (0x2180), 0) & 0xFFFF;
   base <<= 24;
  }
...
static int r600_mc_init(struct radeon_device *rdev)
{
 ...
 if (tmp & (1 << 10)) {
  chansize = 16;
 } else if (tmp & 0x00000080) {
  chansize = 64;
 } else {
  chansize = 32;
 }
 tmp = r100_mm_rreg(rdev, (0x2004), 0);
 ...
 rdev->mc.mc_vram_size = r100_mm_rreg(rdev, (0x5428), 0);
 rdev->mc.real_vram_size = r100_mm_rreg(rdev, (0x5428), 0);
...
int r600_vram_scratch_init(struct radeon_device *rdev)
{
 ...
 r = radeon_bo_pin(rdev->vram_scratch.robj,
     0x4, &rdev->vram_scratch.gpu_addr);
 if (r) {
...
# 1433 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
_Bool r600_dma_is_lockup(struct radeon_device *rdev, struct radeon_ring *ring)
{
 u32 dma_status_reg;
...
static void r600_gpu_init(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x8000), (((0xff) << 0)), 0);


 tiling_config = 0;
 ramcfg = r100_mm_rreg(rdev, (0x2408), 0);
 ...
 rdev->config.r600.tiling_nbanks = 4 << ((ramcfg & 0x00000001) >> 0);
 tiling_config |= (((ramcfg & 0x00000001) >> 0) << 4);
 tiling_config |= (((ramcfg & 0x00000100) >> 8) << 6);

 tmp = (ramcfg & 0x0000001C) >> 2;
 if (tmp > 3) {
  tiling_config |= ((3) << 8);
  tiling_config |= ((3) << 14);
 } else {
 ...
 r100_mm_wreg(rdev, (0x98F0), (tiling_config), 0);
 r100_mm_wreg(rdev, (0x6CA0), (tiling_config & 0xffff), 0);
 r100_mm_wreg(rdev, (0x2F3C), (tiling_config & 0xffff), 0);
 r100_mm_wreg(rdev, (0x3ec4), (tiling_config & 0xffff), 0);

 tmp = 8 - r600_count_pipe_bits((cc_gc_shader_pipe_config & 0x0000FF00) >> 8);
 r100_mm_wreg(rdev, (0x28C5C), ((tmp * 4) & 0x0000007F), 0);
 r100_mm_wreg(rdev, (0x28C58), (((tmp * 4) - 2) & 0x000000FF), 0);


 r100_mm_wreg(rdev, (0x8760), ((((0x16) << 0) | ((0x2b) << 8))), 0);
 r100_mm_wreg(rdev, (0x8764), ((((0x40) << 16) | ((0x40) << 24))), 0);

 r100_mm_wreg(rdev, (0x9508), (((1 << 1) | (1 << 24) | (1 << 25) | (1 << 26))), 0);


 if (rdev->family == CHIP_RV670)
  r100_mm_wreg(rdev, (0x246C), (0x00000021), 0);

 tmp = r100_mm_rreg(rdev, (0x9054), 0);
 tmp |= (1 << 0);
 if ((rdev->family > CHIP_R600))
  tmp |= (1 << 16);
 r100_mm_wreg(rdev, (0x9054), (tmp), 0);
 ...
 if (((rdev->family) == CHIP_R600) ||
  ...
  r100_mm_wreg(rdev, (0x9830), ((1 << 31)), 0);
 } else {
  r100_mm_wreg(rdev, (0x9830), (0), 0);
 }
 r100_mm_wreg(rdev, (0x9838), ((((4) << 0) | ((16) << 20) | ((16) << 5) | ((4) << 15))), 0);


 r100_mm_wreg(rdev, (0x8B20), (0), 0);
 r100_mm_wreg(rdev, (0x8974), (0), 0);

 r100_mm_wreg(rdev, (0x9100), (((0) << 0)), 0);
 r100_mm_wreg(rdev, (0x913C), (((0) << 0)), 0);

 tmp = r100_mm_rreg(rdev, (0x8CF0), 0);
 ...
 r100_mm_wreg(rdev, (0x8CF0), (tmp), 0);




 sq_config = r100_mm_rreg(rdev, (0x8c00), 0);
 sq_config &= ~(((3) << 24) |
         ((3) << 26) |
         ((3) << 28) |
         ((3) << 30));
 ...
 if ((rdev->family) == CHIP_R600) {
  sq_gpr_resource_mgmt_1 = (((124) << 0) |
       ((124) << 16) |
       ((4) << 28));
  sq_gpr_resource_mgmt_2 = (((0) << 0) |
       ((0) << 16));
  sq_thread_resource_mgmt = (((136) << 0) |
        ((48) << 8) |
        ((4) << 16) |
        ((4) << 24));
  sq_stack_resource_mgmt_1 = (((128) << 0) |
         ((128) << 16));
  sq_stack_resource_mgmt_2 = (((0) << 0) |
         ((0) << 16));
  ...
  sq_gpr_resource_mgmt_1 = (((44) << 0) |
       ((44) << 16) |
       ((2) << 28));
  sq_gpr_resource_mgmt_2 = (((17) << 0) |
       ((17) << 16));
  sq_thread_resource_mgmt = (((79) << 0) |
        ((78) << 8) |
        ((4) << 16) |
        ((31) << 24));
  sq_stack_resource_mgmt_1 = (((40) << 0) |
         ((40) << 16));
  sq_stack_resource_mgmt_2 = (((32) << 0) |
         ((16) << 16));
  ...
  sq_thread_resource_mgmt = (((79) << 0) |
        ...
        ((4) << 16) |
        ((31) << 24));
  sq_stack_resource_mgmt_1 = (((64) << 0) |
         ((64) << 16));
  sq_stack_resource_mgmt_2 = (((64) << 0) |
         ((64) << 16));
 }

 r100_mm_wreg(rdev, (0x8c00), (sq_config), 0);
 r100_mm_wreg(rdev, (0x8c04), (sq_gpr_resource_mgmt_1), 0);
 r100_mm_wreg(rdev, (0x8c08), (sq_gpr_resource_mgmt_2), 0);
 r100_mm_wreg(rdev, (0x8c0c), (sq_thread_resource_mgmt), 0);
 r100_mm_wreg(rdev, (0x8c10), (sq_stack_resource_mgmt_1), 0);
 r100_mm_wreg(rdev, (0x8c14), (sq_stack_resource_mgmt_2), 0);

 if (((rdev->family) == CHIP_RV610) ||
     ((rdev->family) == CHIP_RV620) ||
     ((rdev->family) == CHIP_RS780) ||
     ((rdev->family) == CHIP_RS880)) {
  r100_mm_wreg(rdev, (0x88C4), (((1)<<0)), 0);
 } else {
  r100_mm_wreg(rdev, (0x88C4), (((2)<<0)), 0);
 }


 r100_mm_wreg(rdev, (0x8B40), ((((0xc) << 0) | ((0x4) << 4) | ((0x4) << 8) | ((0xc) << 12))), 0);

 r100_mm_wreg(rdev, (0x8B44), ((((0xe) << 0) | ((0xe) << 4) | ((0x2) << 8) | ((0x2) << 12) | ((0xa) << 16) | ((0x6) << 20) | ((0x6) << 24) | ((0xa) << 28))), 0);



 r100_mm_wreg(rdev, (0x8B48), ((((0xe) << 0) | ((0xb) << 4) | ((0x4) << 8) | ((0xc) << 12) | ((0x1) << 16) | ((0x6) << 20) | ((0xa) << 24) | ((0xe) << 28))), 0);



 r100_mm_wreg(rdev, (0x8B4C), ((((0x6) << 0) | ((0x1) << 4) | ((0x0) << 8) | ((0x0) << 12) | ((0xb) << 16) | ((0x4) << 20) | ((0x7) << 24) | ((0x8) << 28))), 0);




 r100_mm_wreg(rdev, (0x28AB0), (0), 0);
 ...
 r100_mm_wreg(rdev, (0x88CC), (128), 0);
 r100_mm_wreg(rdev, (0x88C8), (tmp), 0);
 r100_mm_wreg(rdev, (0x88E8), (2), 0);
 r100_mm_wreg(rdev, (0x88D4), (16), 0);


 r100_mm_wreg(rdev, (0x8B10), (0), 0);
 r100_mm_wreg(rdev, (0x28AB0), (0), 0);
 r100_mm_wreg(rdev, (0x28350), (0), 0);
 r100_mm_wreg(rdev, (0x28A4C), (0), 0);
 r100_mm_wreg(rdev, (0x28C04), (0), 0);
 r100_mm_wreg(rdev, (0x28A0C), (0), 0);
 r100_mm_wreg(rdev, (0x286D8), (0), 0);
 r100_mm_wreg(rdev, (0x286CC), (((2)<<0)), 0);
 r100_mm_wreg(rdev, (0x280FC), (0), 0);


 r100_mm_wreg(rdev, (0x28040), (0), 0);
 r100_mm_wreg(rdev, (0x28044), (0), 0);
 r100_mm_wreg(rdev, (0x28048), (0), 0);
 r100_mm_wreg(rdev, (0x2804C), (0), 0);
 r100_mm_wreg(rdev, (0x28050), (0), 0);
 r100_mm_wreg(rdev, (0x28054), (0), 0);
 r100_mm_wreg(rdev, (0x28058), (0), 0);
 r100_mm_wreg(rdev, (0x2805C), (0), 0);
 r100_mm_wreg(rdev, (0x280FC), (0), 0);
 ...
 r100_mm_wreg(rdev, (0x9608), (tmp), 0);

 tmp = r100_mm_rreg(rdev, (0x2C00), 0);
 r100_mm_wreg(rdev, (0x2C00), (tmp), 0);

 tmp = r100_mm_rreg(rdev, (0x2418), 0);
 tmp |= (1 << 30);
 r100_mm_wreg(rdev, (0x2418), (tmp), 0);

 r100_mm_wreg(rdev, (0x8B20), (0), 0);
 r100_mm_wreg(rdev, (0x8A14), (((1 << 0) | ((3) << 1))), 0);

 r100_mm_wreg(rdev, (0x8BF0), (((4095) << 0)), 0);
 r100_mm_wreg(rdev, (0x9714), (0), 0);
}
...
int r600_init_microcode(struct radeon_device *rdev)
{
 ...
 do { } while( 0);
# 1970 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
 switch (rdev->family) {
 case CHIP_R600:
  chip_name = "r600";
  rlc_chip_name = "r600";
...
static int r600_cp_load_microcode(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0xC104), ((2 << 16) | (1 << 27) | ((15) << 8) | ((3) << 0)), 0);
 ...
 r100_mm_wreg(rdev, (0x8020), ((1<<0)), 0);
 r100_mm_rreg(rdev, (0x8020), 0);
 mdelay(15);
 r100_mm_wreg(rdev, (0x8020), (0), 0);
 ...
 r100_mm_wreg(rdev, (0xC15C), (0), 0);
 for (i = 0; i < 1792 * 3; i++)
  r100_mm_wreg(rdev, (0xC160), (((__uint32_t)(*fw_data++))), 0);


 fw_data = (const __be32 *)rdev->pfp_fw;
 r100_mm_wreg(rdev, (0xC150), (0), 0);
 for (i = 0; i < 576; i++)
  r100_mm_wreg(rdev, (0xC154), (((__uint32_t)(*fw_data++))), 0);


 r100_mm_wreg(rdev, (0xC150), (0), 0);
 r100_mm_wreg(rdev, (0xC15C), (0), 0);
 r100_mm_wreg(rdev, (0xC158), (0), 0);
 return 0;
}
...
int r600_cp_start(struct radeon_device *rdev)
{
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: cp failed to lock ring (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
...
int r600_cp_resume(struct radeon_device *rdev)
{
 ...
 tmp = (drm_order(4096/8) << 8) | rb_bufsz;

 tmp |= (2 << 16);

 r100_mm_wreg(rdev, (0xC104), (tmp), 0);
 r100_mm_wreg(rdev, (0x85BC), (0x0), 0);


 r100_mm_wreg(rdev, (0x8704), (0), 0);


 r100_mm_wreg(rdev, (0xC104), (tmp | (1 << 31)), 0);
 r100_mm_wreg(rdev, (0xC108), (0), 0);
 ring->wptr = 0;
 r100_mm_wreg(rdev, (0xC114), (ring->wptr), 0);


 r100_mm_wreg(rdev, (0xC10C), (((rdev->wb.gpu_addr + 1024) & 0xFFFFFFFC)), 0);

 r100_mm_wreg(rdev, (0xC110), (((u32)(((rdev->wb.gpu_addr + 1024) >> 16) >> 16)) & 0xFF), 0);
 r100_mm_wreg(rdev, (0x8544), (((rdev->wb.gpu_addr + 0) >> 8) & 0xFFFFFFFF), 0);

 if (rdev->wb.enabled)
  r100_mm_wreg(rdev, (0x8540), (0xff), 0);
 else {
  tmp |= (1 << 27);
  r100_mm_wreg(rdev, (0x8540), (0), 0);
 }
...
void r600_ring_init(struct radeon_device *rdev, struct radeon_ring *ring, unsigned ring_size)
{
 ...
 if (radeon_ring_supports_scratch_reg(rdev, ring)) {
  ...
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "failed to get scratch reg for rptr save (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
...
# 2297 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
void r600_dma_stop(struct radeon_device *rdev)
{
...
# 2317 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
int r600_dma_resume(struct radeon_device *rdev)
{
...
# 2400 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
void r600_dma_fini(struct radeon_device *rdev)
{
 r600_dma_stop(rdev);
...
void r600_scratch_init(struct radeon_device *rdev)
{
 ...
 rdev->scratch.reg_base = 0x8500;
 for (i = 0; i < rdev->scratch.num_reg; i++) {
  rdev->scratch.free[i] = 1;
  rdev->scratch.reg64[i] = rdev->scratch.reg_base + (i * 4);
 }
}
...
int r600_ring_test(struct radeon_device *rdev, struct radeon_ring *ring)
{
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: cp failed to get scratch reg (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 r100_mm_wreg(rdev, (scratch), (0xCAFEDEAD), 0);
 r = radeon_ring_lock(rdev, ring, 3);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: cp failed to lock ring %d (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ring->idx, r);
 ...
 if (i < rdev->usec_timeout) {
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: ring %d test failed (scratch(0x%04X)=0x%08X)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ring->idx, scratch, tmp);
...
# 2471 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
     ...
     struct radeon_fence *fence)
{
 ...
 if (rdev->wb.use_event) {
  ...
  radeon_ring_write(ring, ((3 << 30) | (((0x43) & 0xFF) << 8) | ((3) & 0x3FFF) << 16));
  ...
  radeon_ring_write(ring, 0);
  radeon_ring_write(ring, 10);
  radeon_ring_write(ring, ((3 << 30) | (((0x46) & 0xFF) << 8) | ((0) & 0x3FFF) << 16));
  radeon_ring_write(ring, (((0x16 << 0)) << 0) | ((0) << 8));

  radeon_ring_write(ring, ((3 << 30) | (((0x68) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
  radeon_ring_write(ring, (0x8040 - 0x00008000) >> 2);
  radeon_ring_write(ring, (1 << 15) | (1 << 17));

  radeon_ring_write(ring, ((3 << 30) | (((0x68) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
  radeon_ring_write(ring, ((rdev->fence_drv[fence->ring].scratch_reg - 0x00008000) >> 2));
  radeon_ring_write(ring, fence->seq);

  radeon_ring_write(ring, ((0 << 30) | (((0xc128) >> 2) & 0xFFFF) | ((0) & 0x3FFF) << 16));
         ...
         _Bool emit_wait)
{
 ...
 unsigned sel = emit_wait ? (0x7 << 29) : (0x6 << 29);
...
# 2597 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
void r600_dma_fence_ring_emit(struct radeon_device *rdev,
         struct radeon_fence *fence)
{
 struct radeon_ring *ring = &rdev->ring[fence->ring];
...
# 2623 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
void r600_dma_semaphore_ring_emit(struct radeon_device *rdev,
      struct radeon_ring *ring,
      struct radeon_semaphore *semaphore,
      _Bool emit_wait)
...
# 2668 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
int r600_copy_dma(struct radeon_device *rdev,
    uint64_t src_offset, uint64_t dst_offset,
    unsigned num_gpu_pages,
    struct radeon_fence **fence)
...
static int r600_startup(struct radeon_device *rdev)
{
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: IH init failed (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
...
void r600_vga_set_state(struct radeon_device *rdev, _Bool state)
{
 ...
 temp = r100_mm_rreg(rdev, (0x5424), 0);
 if (state == 0) {
  temp &= ~(1<<0);
  temp |= (1<<1);
 } else {
 ...
 r100_mm_wreg(rdev, (0x5424), (temp), 0);
}
...
int r600_resume(struct radeon_device *rdev)
{
 ...
 r = r600_startup(rdev);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "r600 startup failed on resume\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
...
int r600_init(struct radeon_device *rdev)
{
 ...
 if (r600_debugfs_mc_info_init(rdev)) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to register debugfs file for mc !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 }
...
int r600_ib_test(struct radeon_device *rdev, struct radeon_ring *ring)
{
 ...
 r = radeon_scratch_get(rdev, &scratch);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: failed to get scratch reg (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 r100_mm_wreg(rdev, (scratch), (0xCAFEDEAD), 0);
 ...
 ib.ptr[0] = ((3 << 30) | (((0x68) & 0xFF) << 8) | ((1) & 0x3FFF) << 16);
 ...
 if (i < rdev->usec_timeout) {
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: ib test failed (scratch(0x%04X)=0x%08X)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , scratch, tmp);
...
# 3104 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
int r600_dma_ib_test(struct radeon_device *rdev, struct radeon_ring *ring)
{
 struct radeon_ib ib;
 unsigned i;
...
# 3167 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
void r600_dma_ring_ib_execute(struct radeon_device *rdev, struct radeon_ib *ib)
{
 struct radeon_ring *ring = &rdev->ring[ib->ring];
...
# 3204 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
void r600_ih_ring_init(struct radeon_device *rdev, unsigned ring_size)
{
 u32 rb_bufsz;
...
int r600_ih_ring_alloc(struct radeon_device *rdev)
{
 ...
 if (rdev->ih.ring_obj == ((void *)0)) {
  ...
  if (r) {
   ...
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: failed to pin ih ring buffer (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   return r;
  }
  ...
  radeon_bo_unreserve(rdev->ih.ring_obj);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: failed to map ih ring buffer (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   return r;
  }
 }
 return 0;
...
void r600_rlc_stop(struct radeon_device *rdev)
{
 ...
 if ((rdev->family >= CHIP_RV770) &&
  ...
  r100_mm_wreg(rdev, (0xe60), ((1 << 13)), 0);
  r100_mm_rreg(rdev, (0xe60), 0);
  mdelay(15);
  r100_mm_wreg(rdev, (0xe60), (0), 0);
  r100_mm_rreg(rdev, (0xe60), 0);
...
static int r600_rlc_init(struct radeon_device *rdev)
{
 ...
 if (rdev->family >= CHIP_ARUBA) {
  for (i = 0; i < 1536; i++) {
   ...
   r100_mm_wreg(rdev, (0x3f30), (((__uint32_t)(*fw_data++))), 0);
  }
...
{
 u32 ih_cntl = r100_mm_rreg(rdev, (0x3e18), 0);
 u32 ih_rb_cntl = r100_mm_rreg(rdev, (0x3e00), 0);

 ih_cntl |= (1 << 0);
 ih_rb_cntl |= (1 << 0);
 r100_mm_wreg(rdev, (0x3e18), (ih_cntl), 0);
 r100_mm_wreg(rdev, (0x3e00), (ih_rb_cntl), 0);
 rdev->ih.enabled = 1;
}
...
void r600_disable_interrupts(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x3e08), (0), 0);
 r100_mm_wreg(rdev, (0x3e0c), (0), 0);
 rdev->ih.enabled = 0;
 rdev->ih.rptr = 0;
}
...
static void r600_disable_interrupt_state(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0xc124), ((1 << 19) | (1 << 20)), 0);
 tmp = r100_mm_rreg(rdev, (0xd02c), 0) & ~(1 << 0);
 r100_mm_wreg(rdev, (0xd02c), (tmp), 0);
 r100_mm_wreg(rdev, (0x8060), (0), 0);
 r100_mm_wreg(rdev, (0x6540), (0), 0);
 r100_mm_wreg(rdev, (0x615c), (0), 0);
 r100_mm_wreg(rdev, (0x695c), (0), 0);
 if (((rdev->family >= CHIP_RV620))) {
  r100_mm_wreg(rdev, (0x7038), (0), 0);
  r100_mm_wreg(rdev, (0x7138), (0), 0);
  tmp = r100_mm_rreg(rdev, (0x7d04), 0) & (1 << 8);
  r100_mm_wreg(rdev, (0x7d04), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x7d10), 0) & (1 << 8);
  r100_mm_wreg(rdev, (0x7d10), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x7d1c), 0) & (1 << 8);
  r100_mm_wreg(rdev, (0x7d1c), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x7d28), 0) & (1 << 8);
  r100_mm_wreg(rdev, (0x7d28), (tmp), 0);
  if (((rdev->family >= CHIP_RV730))) {
   tmp = r100_mm_rreg(rdev, (0x7dc4), 0) & (1 << 8);
   r100_mm_wreg(rdev, (0x7dc4), (tmp), 0);
   tmp = r100_mm_rreg(rdev, (0x7df8), 0) & (1 << 8);
   r100_mm_wreg(rdev, (0x7df8), (tmp), 0);
   tmp = r100_mm_rreg(rdev, (0x7604 + (0x7400 - 0x7400)), 0) & ~(1 << 28);
   r100_mm_wreg(rdev, (0x7604 + (0x7400 - 0x7400)), (tmp), 0);
   tmp = r100_mm_rreg(rdev, (0x7604 + (0x7800 - 0x7400)), 0) & ~(1 << 28);
   r100_mm_wreg(rdev, (0x7604 + (0x7800 - 0x7400)), (tmp), 0);
  } else {
   tmp = r100_mm_rreg(rdev, (0x7408), 0) & ~(1 << 28);
   r100_mm_wreg(rdev, (0x7408), (tmp), 0);
   tmp = r100_mm_rreg(rdev, (0x7808), 0) & ~(1 << 28);
   r100_mm_wreg(rdev, (0x7808), (tmp), 0);
  }
 } else {
  r100_mm_wreg(rdev, (0x7838), (0), 0);
  r100_mm_wreg(rdev, (0x7a38), (0), 0);
  tmp = r100_mm_rreg(rdev, (0x7d08), 0) & (1 << 8);
  r100_mm_wreg(rdev, (0x7d08), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x7d18), 0) & (1 << 8);
  r100_mm_wreg(rdev, (0x7d18), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x7d2c), 0) & (1 << 8);
  r100_mm_wreg(rdev, (0x7d2c), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x7408), 0) & ~(1 << 28);
  r100_mm_wreg(rdev, (0x7408), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x7708), 0) & ~(1 << 28);
  r100_mm_wreg(rdev, (0x7708), (tmp), 0);
 }
}
...
int r600_irq_init(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x546c), (rdev->ih.gpu_addr >> 8), 0);
 interrupt_cntl = r100_mm_rreg(rdev, (0x5468), 0);
 ...
 interrupt_cntl &= ~(1 << 3);
 r100_mm_wreg(rdev, (0x5468), (interrupt_cntl), 0);

 r100_mm_wreg(rdev, (0x3e04), (rdev->ih.gpu_addr >> 8), 0);
 ...
 r100_mm_wreg(rdev, (0x3e14), ((rdev->wb.gpu_addr + 2048) & 0xFFFFFFFC), 0);
 r100_mm_wreg(rdev, (0x3e10), (((u32)(((rdev->wb.gpu_addr + 2048) >> 16) >> 16)) & 0xFF), 0);
...
int r600_irq_set(struct radeon_device *rdev)
{
 ...
 if (((rdev->family >= CHIP_RV620))) {
  hpd1 = r100_mm_rreg(rdev, (0x7d04), 0) & ~(1 << 16);
  hpd2 = r100_mm_rreg(rdev, (0x7d10), 0) & ~(1 << 16);
  hpd3 = r100_mm_rreg(rdev, (0x7d1c), 0) & ~(1 << 16);
  hpd4 = r100_mm_rreg(rdev, (0x7d28), 0) & ~(1 << 16);
  if (((rdev->family >= CHIP_RV730))) {
   hpd5 = r100_mm_rreg(rdev, (0x7dc4), 0) & ~(1 << 16);
   hpd6 = r100_mm_rreg(rdev, (0x7df8), 0) & ~(1 << 16);
   hdmi0 = r100_mm_rreg(rdev, (0x7604 + (0x7400 - 0x7400)), 0) & ~(1 << 28);
   hdmi1 = r100_mm_rreg(rdev, (0x7604 + (0x7800 - 0x7400)), 0) & ~(1 << 28);
  } else {
   hdmi0 = r100_mm_rreg(rdev, (0x7408), 0) & ~(1 << 28);
   hdmi1 = r100_mm_rreg(rdev, (0x7808), 0) & ~(1 << 28);
  }
 } else {
  hpd1 = r100_mm_rreg(rdev, (0x7d08), 0) & ~(1 << 16);
  hpd2 = r100_mm_rreg(rdev, (0x7d18), 0) & ~(1 << 16);
  hpd3 = r100_mm_rreg(rdev, (0x7d2c), 0) & ~(1 << 16);
  hdmi0 = r100_mm_rreg(rdev, (0x7408), 0) & ~(1 << 28);
 ...
 if (((rdev->family >= CHIP_RV620))) {
  ...
  r100_mm_wreg(rdev, (0x7d10), (hpd2), 0);
  r100_mm_wreg(rdev, (0x7d1c), (hpd3), 0);
  r100_mm_wreg(rdev, (0x7d28), (hpd4), 0);
  if (((rdev->family >= CHIP_RV730))) {
   r100_mm_wreg(rdev, (0x7dc4), (hpd5), 0);
   r100_mm_wreg(rdev, (0x7df8), (hpd6), 0);
   r100_mm_wreg(rdev, (0x7604 + (0x7400 - 0x7400)), (hdmi0), 0);
   r100_mm_wreg(rdev, (0x7604 + (0x7800 - 0x7400)), (hdmi1), 0);
  } else {
   r100_mm_wreg(rdev, (0x7408), (hdmi0), 0);
   r100_mm_wreg(rdev, (0x7808), (hdmi1), 0);
  }
 } else {
  r100_mm_wreg(rdev, (0x7d08), (hpd1), 0);
  r100_mm_wreg(rdev, (0x7d18), (hpd2), 0);
  r100_mm_wreg(rdev, (0x7d2c), (hpd3), 0);
  r100_mm_wreg(rdev, (0x7408), (hdmi0), 0);
...
static void r600_irq_ack(struct radeon_device *rdev)
{
 ...
 if (((rdev->family >= CHIP_RV620))) {
  rdev->irq.stat_regs.r600.disp_int = r100_mm_rreg(rdev, (0x7ddc), 0);
  rdev->irq.stat_regs.r600.disp_int_cont = r100_mm_rreg(rdev, (0x7de8), 0);
  rdev->irq.stat_regs.r600.disp_int_cont2 = r100_mm_rreg(rdev, (0x7dec), 0);
  if (((rdev->family >= CHIP_RV730))) {
   rdev->irq.stat_regs.r600.hdmi0_status = r100_mm_rreg(rdev, (0x7600 + (0x7400 - 0x7400)), 0);
   rdev->irq.stat_regs.r600.hdmi1_status = r100_mm_rreg(rdev, (0x7600 + (0x7800 - 0x7400)), 0);
  } else {
   rdev->irq.stat_regs.r600.hdmi0_status = r100_mm_rreg(rdev, (0x7404), 0);
   rdev->irq.stat_regs.r600.hdmi1_status = r100_mm_rreg(rdev, (0x7804), 0);
  }
 } else {
  rdev->irq.stat_regs.r600.disp_int = r100_mm_rreg(rdev, (0x7edc), 0);
  rdev->irq.stat_regs.r600.disp_int_cont = r100_mm_rreg(rdev, (0x7ee8), 0);
  rdev->irq.stat_regs.r600.disp_int_cont2 = 0;
  rdev->irq.stat_regs.r600.hdmi0_status = r100_mm_rreg(rdev, (0x7404), 0);
  rdev->irq.stat_regs.r600.hdmi1_status = r100_mm_rreg(rdev, (0x7704), 0);
 }
 rdev->irq.stat_regs.r600.d1grph_int = r100_mm_rreg(rdev, (0x6158), 0);
 rdev->irq.stat_regs.r600.d2grph_int = r100_mm_rreg(rdev, (0x6958), 0);

 if (rdev->irq.stat_regs.r600.d1grph_int & (1 << 0))
  r100_mm_wreg(rdev, (0x6158), ((1 << 8)), 0);
 if (rdev->irq.stat_regs.r600.d2grph_int & (1 << 0))
  r100_mm_wreg(rdev, (0x6958), ((1 << 8)), 0);
 if (rdev->irq.stat_regs.r600.disp_int & (1 << 4))
  r100_mm_wreg(rdev, (0x6534), ((1 << 4)), 0);
 if (rdev->irq.stat_regs.r600.disp_int & (1 << 2))
  r100_mm_wreg(rdev, (0x653c), ((1 << 4)), 0);
 if (rdev->irq.stat_regs.r600.disp_int & (1 << 5))
  r100_mm_wreg(rdev, (0x6d34), ((1 << 4)), 0);
 if (rdev->irq.stat_regs.r600.disp_int & (1 << 3))
  r100_mm_wreg(rdev, (0x6d3c), ((1 << 4)), 0);
 ...
 if (((rdev->family >= CHIP_RV730))) {
  ...
  if (rdev->irq.stat_regs.r600.hdmi0_status & (1 << 28)) {
   tmp = r100_mm_rreg(rdev, (0x7604 + (0x7400 - 0x7400)), 0);
   tmp |= (1 << 29);
   r100_mm_wreg(rdev, (0x7604 + (0x7400 - 0x7400)), (tmp), 0);
  }
  if (rdev->irq.stat_regs.r600.hdmi1_status & (1 << 28)) {
   tmp = r100_mm_rreg(rdev, (0x7604 + (0x7800 - 0x7400)), 0);
   tmp |= (1 << 29);
   r100_mm_wreg(rdev, (0x7604 + (0x7800 - 0x7400)), (tmp), 0);
  }
 } else {
  if (rdev->irq.stat_regs.r600.hdmi0_status & (1 << 28)) {
   tmp = r100_mm_rreg(rdev, (0x7408), 0);
   tmp |= (1 << 29);
   r100_mm_wreg(rdev, (0x7408), (tmp), 0);
  }
  if (rdev->irq.stat_regs.r600.hdmi1_status & (1 << 28)) {
   if (((rdev->family >= CHIP_RV620))) {
    tmp = r100_mm_rreg(rdev, (0x7808), 0);
    tmp |= (1 << 29);
    r100_mm_wreg(rdev, (0x7808), (tmp), 0);
   } else {
    tmp = r100_mm_rreg(rdev, (0x7708), 0);
    tmp |= (1 << 29);
    r100_mm_wreg(rdev, (0x7708), (tmp), 0);
   }
  }
...
static u32 r600_get_ih_wptr(struct radeon_device *rdev)
{
 ...
 if (rdev->wb.enabled)
  wptr = __extension__({ __uint32_t __swap32gen_x = (rdev->wb.wb[2048/4]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
 else
 ...
 if (wptr & (1 << 0)) {
  ...
  tmp |= (1 << 31);
  r100_mm_wreg(rdev, (0x3e00), (tmp), 0);
 }
 return (wptr & rdev->ih.ptr_mask);
}
# 3830 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
int r600_irq_process(struct radeon_device *rdev)
{
 u32 wptr;
 u32 rptr;
...
restart_ih:
 ...
 while (rptr != wptr) {
  ...
  ring_index = rptr / 4;
  src_id = __extension__({ __uint32_t __swap32gen_x = (rdev->ih.ring[ring_index]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) & 0xff;
  src_data = __extension__({ __uint32_t __swap32gen_x = (rdev->ih.ring[ring_index + 1]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) & 0xfffffff;
...
# 4056 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
int r600_debugfs_mc_info_init(struct radeon_device *rdev)
{
...
# 4075 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
...
static void r600_pcie_gen2_enable(struct radeon_device *rdev)
{
 ...
 if ((rdev->family == CHIP_RV670) ||
  ...
  link_width_cntl = rdev->pciep_rreg(rdev, (0xa2));
  if (link_width_cntl & (1 << 9)) {
   lanes = (link_width_cntl & 0x70) >> 4;
   link_width_cntl &= ~(0x7 |
          (1 << 7));
   link_width_cntl |= lanes | (1 << 8) | (1 << 10);
   rdev->pciep_wreg(rdev, (0xa2), (link_width_cntl));
  } else {
   link_width_cntl |= (1 << 13);
   rdev->pciep_wreg(rdev, (0xa2), (link_width_cntl));
 ...
 if ((speed_cntl & (1 << 23)) &&
  ...
  if ((rdev->family == CHIP_RV670) ||
      (rdev->family == CHIP_RV620) ||
      (rdev->family == CHIP_RV635)) {
   r100_mm_wreg(rdev, (0x544c), (0x8), 0);
   link_cntl2 = r100_mm_rreg(rdev, (0x4088), 0);
  ...
  if ((rdev->family == CHIP_RV670) ||
      (rdev->family == CHIP_RV620) ||
      (rdev->family == CHIP_RV635)) {
   training_cntl = rdev->pciep_rreg(rdev, (0xa1));
   training_cntl &= ~(1 << 6);
   rdev->pciep_wreg(rdev, (0xa1), (training_cntl));
  } else {
   speed_cntl = rdev->pciep_rreg(rdev, (0xa4));
   speed_cntl &= ~(1 << 1);
   rdev->pciep_wreg(rdev, (0xa4), (speed_cntl));
...
# 4337 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600.c"
uint64_t r600_get_gpu_clock(struct radeon_device *rdev)
{
 uint64_t clock;

 _rw_enter_write(&rdev->gpu_clock_mutex );
 r100_mm_wreg(rdev, (0x3f40), (1), 0);
 clock = (uint64_t)r100_mm_rreg(rdev, (0x3f38), 0) |
         ((uint64_t)r100_mm_rreg(rdev, (0x3f3c), 0) << 32ULL);
 _rw_exit_write(&rdev->gpu_clock_mutex );
 return clock;
}
