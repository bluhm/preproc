# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c" 2
...
ext2fs_read(void *v)
{
 ...
 if (ip->dinode_u.e2fs_din->e2di_flags & 0x00080000)
    ...
    struct uio *uio)
{
 ...
 if (vp->v_type == VLNK) {
  if (ext2fs_size(ip) < ((12 +3) * sizeof (u_int32_t)))
 ...
 for (error = 0, bp = ((void *)0); uio->uio_resid > 0; bp = ((void *)0)) {
  if ((bytesinfile = ext2fs_size(ip) - uio->uio_offset) <= 0)
   break;
  lbn = ((uio->uio_offset) >> (fs)->e2fs_bshift);
  nextlbn = lbn + 1;
  size = fs->e2fs_bsize;
  blkoffset = ((uio->uio_offset) & (fs)->e2fs_qbmask);
  ...
  if (((nextlbn) << (fs)->e2fs_bshift) >= ext2fs_size(ip))
...
# 140 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_readwrite.c"
  size -= bp->b_resid;
  if (size < xfersize) {
   if (size == 0)
    break;
...
ext4_ext_read(struct vnode *vp, struct inode *ip, struct m_ext2fs *fs, struct uio *uio)
{
 ...
 while (uio->uio_resid > 0) {
  ...
  xfersize = (((xfersize)<(uio->uio_resid))?(xfersize):(uio->uio_resid));
  xfersize = (((xfersize)<(bytesinfile))?(xfersize):(bytesinfile));

  cache_type = ext4_ext_in_cache(ip, lbn, &nex);
  switch (cache_type) {
  case 0:
   ext4_ext_find_extent(fs, ip, lbn, &path);
   if ((ep = path.ep_ext) == ((void *)0))
    return (5);
   ext4_ext_put_cache(ip, ep, 2);

   pos = lbn - ep->e_blk + (((daddr_t) ep->e_start_hi << 32) | ep->e_start_lo);
   if (path.ep_bp != ((void *)0)) {
    brelse(path.ep_bp);
    path.ep_bp = ((void *)0);
   }
   break;
  ...
  error = bread(ip->i_ump->um_devvp, ((pos) << (fs)->e2fs_fsbtodb), size, &bp);
  if (error) {
   brelse(bp);
   return (error);
  }
...
ext2fs_write(void *v)
{
 ...
 case VREG:
  ...
  if ((ip->dinode_u.e2fs_din->e2di_flags & 0x00000020) &&
   uio->uio_offset != ext2fs_size(ip))
   return (1);
 ...
 if (error) {
  if (ioflag & 0x01) {
   (void)ext2fs_truncate(ip, osize,
    ioflag & 0x04, ap->a_cred);
   uio->uio_offset -= resid - uio->uio_resid;
   uio->uio_resid = resid;
  }
 } else if (resid > uio->uio_resid && (ioflag & 0x04)) {
