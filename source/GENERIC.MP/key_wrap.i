# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/key_wrap.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/key_wrap.c"
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/key_wrap.c"
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/key_wrap.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/key_wrap.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/key_wrap.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/key_wrap.c" 2
...
aes_key_wrap(aes_key_wrap_ctx *ctx, const u_int8_t *P, size_t n, u_int8_t *C)
{
 ...
 __builtin_memmove((C + 8), (P), (n * 8));
 A = C;
 __builtin_memcpy((A), (IV), (8));

 for (j = 0, t = 1; j <= 5; j++) {
  R = C + 8;
  for (i = 1; i <= n; i++, t++) {

   __builtin_memcpy((&B[0]), (A), (8));
   __builtin_memcpy((&B[1]), (R), (8));

   AES_Encrypt(&ctx->ctx, (caddr_t)B, (caddr_t)B);

   B[0] ^= ((__uint64_t)(t));

   __builtin_memcpy((A), (&B[0]), (8));

   __builtin_memcpy((R), (&B[1]), (8));
...
aes_key_unwrap(aes_key_wrap_ctx *ctx, const u_int8_t *C, u_int8_t *P, size_t n)
{
 ...
 __builtin_memcpy((A), (C), (8));
 __builtin_memmove((P), (C + 8), (n * 8));
