# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_hdmi.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_hdmi.c"
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_hdmi.c"
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_hdmi.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_hdmi.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_hdmi.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_hdmi.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600d.h" 1
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_hdmi.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_hdmi.c" 2
...
static void r600_hdmi_update_ACR(struct drm_encoder *encoder, uint32_t clock)
{
 ...
 r100_mm_wreg(rdev, (0x74ac + offset), ((((acr.cts_32khz) & 0xfffff) << 12)), 0);
 r100_mm_wreg(rdev, (0x74b0 + offset), (acr.n_32khz), 0);

 r100_mm_wreg(rdev, (0x74b4 + offset), ((((acr.cts_44_1khz) & 0xfffff) << 12)), 0);
 r100_mm_wreg(rdev, (0x74b8 + offset), (acr.n_44_1khz), 0);

 r100_mm_wreg(rdev, (0x74bc + offset), ((((acr.cts_48khz) & 0xfffff) << 12)), 0);
 r100_mm_wreg(rdev, (0x74c0 + offset), (acr.n_48khz), 0);
}
...
)
{
 ...
 r100_mm_wreg(rdev, (0x7460 + offset), (frame[0xC] | (frame[0xD] << 8)), 0);
...
void r600_hdmi_setmode(struct drm_encoder *encoder, struct drm_display_mode *mode)
{
 ...
 r100_mm_wreg(rdev, (0x7410 + offset), ((1 << 0)), 0);


 r100_mm_wreg(rdev, (0x740c + offset), (0x1000), 0);
 ...
 if (((rdev->family >= CHIP_RV730))) {
  ...
  r100_mm_wreg(rdev, (0x7408 + offset), ((1 << 0) | (((1) & 3) << 4) | (((3) & 0x1f) << 16) | (1 << 26)), 0);
 ...
 r100_mm_wreg(rdev, (0x74dc + offset), ((1 << 12) | (1 << 8)), 0);



 r100_mm_wreg(rdev, (0x7410 + offset), ((1 << 0) | (1 << 4) | (1 << 5)), 0);





 r100_mm_wreg(rdev, (0x7414 + offset), ((1 << 0) | (1 << 1) | (1 << 4) | (1 << 5)), 0);





 r100_mm_wreg(rdev, (0x7418 + offset), ((((2) & 0x3f) << 0) | (((2) & 0x3f) << 8)), 0);



 r100_mm_wreg(rdev, (0x7428 + offset), (0), 0);
 ...
 r100_mm_wreg(rdev, (0x74e0 + offset), (0x00FFFFFF), 0);
 r100_mm_wreg(rdev, (0x74e4 + offset), (0x007FFFFF), 0);
 r100_mm_wreg(rdev, (0x74e8 + offset), (0x00000001), 0);
 r100_mm_wreg(rdev, (0x74ec + offset), (0x00000001), 0);
...
void r600_hdmi_update_audio_settings(struct drm_encoder *encoder)
{
 ...
 iec |= (((audio.category_code) & 0xff) << 8);
 ...
 r100_mm_wreg(rdev, (0x74d4 + offset), (iec), 0);
 ...
 if (audio.status_bits & AUDIO_STATUS_V)
  iec |= 0x5 << 16;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x74d8 + offset), 0); tmp_ &= (~0x5000f); tmp_ |= ((iec) & ~(~0x5000f)); r100_mm_wreg(rdev, (0x74d8 + offset), (tmp_), 0); } while (0);
...
void r600_hdmi_enable(struct drm_encoder *encoder)
{
 ...
 if (((rdev->family == CHIP_RS600) || (rdev->family == CHIP_RS690) || (rdev->family == CHIP_RS740) || (rdev->family >= CHIP_R600)) && !((rdev->family >= CHIP_RV620))) {
  hdmi = (1 << 8) | (1 << 0);
  ...
  r100_mm_wreg(rdev, (0x7400 + offset), (hdmi), 0);
 }
...
void r600_hdmi_disable(struct drm_encoder *encoder)
{
 ...
 if (((rdev->family == CHIP_RS600) || (rdev->family == CHIP_RS690) || (rdev->family == CHIP_RS740) || (rdev->family >= CHIP_R600)) && !((rdev->family >= CHIP_RV620))) {
  ...
  r100_mm_wreg(rdev, (0x7400 + offset), ((1 << 8)), 0);
 }
