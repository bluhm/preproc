...
void r600_audio_update_hdmi(struct work_struct *work)
{
 struct radeon_device *rdev = ({ const __typeof( ((struct radeon_device *)0)->audio_work ) *__mptr = (work); (struct radeon_device *)( (char *)__mptr - __builtin_offsetof(struct radeon_device, audio_work) );});
...
void r600_audio_enable(struct radeon_device *rdev,
         ...
         u8 enable_mask)
{
 u32 tmp = r100_mm_rreg(rdev, (0x7300), 0);
 if (!pin)
  return;
 if (enable_mask) {
  tmp |= (1 << 31);
 ...
 r100_mm_wreg(rdev, (0x7300), (tmp), 0);
}
struct r600_audio_pin *r600_audio_get_pin(struct radeon_device *rdev)
{
 ...
 const struct radeon_hdmi_acr *acr)
{
 ...
 uint32_t acr_ctl = ((rdev->family >= CHIP_RV620)) ? 0x740c :
           0x74dc;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (acr_ctl + offset), 0); tmp_ &= (~((1 << 8) | (1 << 12))); tmp_ |= (((1 << 8) | (1 << 12)) & ~(~((1 << 8) | (1 << 12)))); r100_mm_wreg(rdev, (acr_ctl + offset), (tmp_), 0); } while (0);
    ...
    unsigned char *buffer, size_t size)
{
 ...
 r100_mm_wreg(rdev, (0x7454 + offset), (frame[0x0] | (frame[0x1] << 8) | (frame[0x2] << 16) | (frame[0x3] << 24)), 0);
 r100_mm_wreg(rdev, (0x7458 + offset), (frame[0x4] | (frame[0x5] << 8) | (frame[0x6] << 16) | (frame[0x7] << 24)), 0);
 r100_mm_wreg(rdev, (0x745c + offset), (frame[0x8] | (frame[0x9] << 8) | (frame[0xA] << 16) | (frame[0xB] << 24)), 0);
 r100_mm_wreg(rdev, (0x7460 + offset), (frame[0xC] | (frame[0xD] << 8) | (buffer[1] << 24)), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7418 + offset), 0); tmp_ &= (~((((2) & 0x3f) << 0))); tmp_ |= (((((2) & 0x3f) << 0)) & ~(~((((2) & 0x3f) << 0)))); r100_mm_wreg(rdev, (0x7418 + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7414 + offset), 0); tmp_ &= (~((1 << 0) | (1 << 1))); tmp_ |= (((1 << 0) | (1 << 1)) & ~(~((1 << 0) | (1 << 1)))); r100_mm_wreg(rdev, (0x7414 + offset), (tmp_), 0); } while (0);
}
          ...
          const void *buffer, size_t size)
{
 ...
 r100_mm_wreg(rdev, (0x74cc + offset), (frame[0x0] | (frame[0x1] << 8) | (frame[0x2] << 16) | (frame[0x3] << 24)), 0);
 r100_mm_wreg(rdev, (0x74d0 + offset), (frame[0x4] | (frame[0x5] << 8) | (frame[0x6] << 16) | (frame[0x8] << 24)), 0);
}
static _Bool r600_hdmi_is_audio_buffer_filled(struct drm_encoder *encoder)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_encoder *radeon_encoder = ({ const __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 struct radeon_encoder_atom_dig *dig = radeon_encoder->enc_priv;
 uint32_t offset = dig->afmt->offset;
 return (r100_mm_rreg(rdev, (0x7404 + offset), 0) & 0x10) != 0;
}
int r600_hdmi_buffer_status_changed(struct drm_encoder *encoder)
{
 struct radeon_encoder *radeon_encoder = ({ const __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
...
void r600_hdmi_audio_workaround(struct drm_encoder *encoder)
{
 ...
 if (!hdmi_audio_workaround ||
  ...
  value = (1 << 12);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7408 + offset), 0); tmp_ &= (~(1 << 12)); tmp_ |= ((value) & ~(~(1 << 12))); r100_mm_wreg(rdev, (0x7408 + offset), (tmp_), 0); } while (0);
}
    ...
    struct radeon_crtc *crtc, unsigned int clock)
{
 ...
 if (dig->dig_encoder == 0) {
  r100_mm_wreg(rdev, (0x0514), (24000 * 100), 0);
  r100_mm_wreg(rdev, (0x0518), (clock * 100), 0);
  r100_mm_wreg(rdev, (0x0534), (0), 0);
 } else {
  r100_mm_wreg(rdev, (0x0524), (24000 * 100), 0);
...
void r600_set_vbi_packet(struct drm_encoder *encoder, u32 offset)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7410 + offset), 0); tmp_ &= (~((1 << 0) | (1 << 4) | (1 << 5))); tmp_ |= (((1 << 0) | (1 << 4) | (1 << 5)) & ~(~((1 << 0) | (1 << 4) | (1 << 5)))); r100_mm_wreg(rdev, (0x7410 + offset), (tmp_), 0); } while (0);
}
void r600_set_audio_packet(struct drm_encoder *encoder, u32 offset)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7408 + offset), 0); tmp_ &= (~((1 << 0) | (3 << 4) | (0x1f << 16) | (1 << 26))); tmp_ |= (((1 << 0) | (((1) & 3) << 4) | (((3) & 0x1f) << 16) | (1 << 26)) & ~(~((1 << 0) | (3 << 4) | (0x1f << 16) | (1 << 26)))); r100_mm_wreg(rdev, (0x7408 + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7414 + offset), 0); tmp_ &= (~((1 << 4) | (1 << 7))); tmp_ |= (((1 << 4) | (1 << 7)) & ~(~((1 << 4) | (1 << 7)))); r100_mm_wreg(rdev, (0x7414 + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7418 + offset), 0); tmp_ &= (~(0x3f << 8)); tmp_ |= (((((2) & 0x3f) << 8)) & ~(~(0x3f << 8))); r100_mm_wreg(rdev, (0x7418 + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x741c + offset), 0); tmp_ &= (~((1 << 0) | (1 << 1) | (1 << 2) | (1 << 4) | (1 << 5) | (0x3f << 16) | (0x3f << 24))); tmp_ |= ((0) & ~(~((1 << 0) | (1 << 1) | (1 << 2) | (1 << 4) | (1 << 5) | (0x3f << 16) | (0x3f << 24)))); r100_mm_wreg(rdev, (0x741c + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x74d4 + offset), 0); tmp_ &= (~((0xf << 20) | (3 << 28))); tmp_ |= (((((1) & 0xf) << 20)) & ~(~((0xf << 20) | (3 << 28)))); r100_mm_wreg(rdev, (0x74d4 + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x74d8 + offset), 0); tmp_ &= (~(0xf << 20)); tmp_ |= (((((2) & 0xf) << 20)) & ~(~(0xf << 20))); r100_mm_wreg(rdev, (0x74d8 + offset), (tmp_), 0); } while (0);
}
...
void r600_hdmi_update_audio_settings(struct drm_encoder *encoder)
{
 ...
 if (err < 0) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "failed to setup audio infoframe\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return;
 }
 frame.channels = audio.channels;
 err = hdmi_audio_infoframe_pack(&frame, buffer, sizeof(buffer));
 if (err < 0) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "failed to pack audio infoframe\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return;
 }
 value = r100_mm_rreg(rdev, (0x7408 + offset), 0);
 if (value & (1 << 12))
  r100_mm_wreg(rdev, (0x7408 + offset), (value & ~(1 << 12)), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7400 + offset), 0); tmp_ &= (~((1 << 8))); tmp_ |= (((1 << 8)) & ~(~((1 << 8)))); r100_mm_wreg(rdev, (0x7400 + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7414 + offset), 0); tmp_ &= (~(1 << 6)); tmp_ |= ((0) & ~(~(1 << 6))); r100_mm_wreg(rdev, (0x7414 + offset), (tmp_), 0); } while (0);
 r600_hdmi_update_audio_infoframe(encoder, buffer, sizeof(buffer));
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7414 + offset), 0); tmp_ &= (~((1 << 5) | (1 << 7))); tmp_ |= (((1 << 5) | (1 << 7)) & ~(~((1 << 5) | (1 << 7)))); r100_mm_wreg(rdev, (0x7414 + offset), (tmp_), 0); } while (0);
}
void r600_hdmi_enable(struct drm_encoder *encoder, _Bool enable)
{
 ...
 if (!((rdev->family >= CHIP_RV620))) {
  ...
  case 0x13:
   if (enable) {
    do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7880), 0); tmp_ &= (~((1 << 2))); tmp_ |= (((1 << 2)) & ~(~((1 << 2)))); r100_mm_wreg(rdev, (0x7880), (tmp_), 0); } while (0);
    hdmi |= (((0) & 3) << 2);
   } else {
    do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7880), 0); tmp_ &= (~(1 << 2)); tmp_ |= ((0) & ~(~(1 << 2))); r100_mm_wreg(rdev, (0x7880), (tmp_), 0); } while (0);
   }
   break;
  case 0x0F:
   if (enable) {
    do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7a80), 0); tmp_ &= (~((1 << 2))); tmp_ |= (((1 << 2)) & ~(~((1 << 2)))); r100_mm_wreg(rdev, (0x7a80), (tmp_), 0); } while (0);
    hdmi |= (((1) & 3) << 2);
   } else {
    do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7a80), 0); tmp_ &= (~(1 << 2)); tmp_ |= ((0) & ~(~(1 << 2))); r100_mm_wreg(rdev, (0x7a80), (tmp_), 0); } while (0);
   }
   break;
  case 0x19:
   if (enable) {
    do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7200), 0); tmp_ &= (~((1 << 2))); tmp_ |= (((1 << 2)) & ~(~((1 << 2)))); r100_mm_wreg(rdev, (0x7200), (tmp_), 0); } while (0);
    hdmi |= (((3) & 3) << 2);
   } else {
    do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7200), 0); tmp_ &= (~(1 << 2)); tmp_ |= ((0) & ~(~(1 << 2))); r100_mm_wreg(rdev, (0x7200), (tmp_), 0); } while (0);
   }
   break;
  case 0x14:
   if (enable)
   ...
   break;
  default:
   printf("drm:pid%d:%s *ERROR* " "Invalid encoder for HDMI: 0x%X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , radeon_encoder->encoder_id);
   break;
  }
  r100_mm_wreg(rdev, (0x7400 + dig->afmt->offset), (hdmi), 0);
 }
