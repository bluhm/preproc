# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c"
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c"
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/ioctl.h"
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucomvar.h" 1
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucomvar.h"
struct ucom_softc;
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucomvar.h"
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c" 2
# 99 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c"
struct ucycom_softc {
...
ucycom_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(ucycom_devs), sizeof (ucycom_devs) / sizeof ((ucycom_devs)[0]), sizeof ((ucycom_devs)[0]), (uha->uaa->vendor), (uha->uaa->product)) != ((void *)0) ?
     13 : 0);
}
...
ucycom_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 __builtin_bzero((&uca), (sizeof uca));
...
ucycom_open(void *addr, int portno)
{
 ...
 sc->sc_obuf = malloc(sc->sc_olen, 102, 0x0001 | 0x0008);


 sc->sc_ibuf = malloc(sc->sc_ilen, 102, 0x0001);
...
ucycom_close(void *addr, int portno)
{
 ...
 s = splraise(2);
 if (sc->sc_obuf != ((void *)0)) {
  free(sc->sc_obuf, 102, sc->sc_olen);
  sc->sc_obuf = ((void *)0);
 }
 if (sc->sc_ibuf != ((void *)0)) {
  free(sc->sc_ibuf, 102, sc->sc_ilen);
  sc->sc_ibuf = ((void *)0);
 }
 _splx(s);
}
...
ucycom_write(void *addr, int portno, u_char *to, u_char *data, u_int32_t *cnt)
{
 struct ucycom_softc *sc = addr;
 u_int32_t len;
# 337 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c"
 len = sc->sc_olen;
 __builtin_memset((to), (0), (len));
 switch (sc->sc_olen) {
 case 8:
  to[0] = *cnt | sc->sc_mcr;
  __builtin_memcpy((&to[1]), (data), (*cnt));
  ;
 ...
 case 32:
  to[0] = sc->sc_mcr;
  to[1] = *cnt;
  __builtin_memcpy((&to[2]), (data), (*cnt));
  ;

  break;
 }
# 368 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c"
 *cnt = len;
...
ucycom_param(void *addr, int portno, struct termios *t)
{
 ...
 case 38400:
 case 57600:
# 402 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c"
  baud = t->c_ospeed;
  break;
 default:
  return (22);
 ...
 if (t->c_cflag & 0x00000001) {
  ...
  cfg |= ((t->c_cflag) & (0x00000400)) ?
      0x08 : 0x00;
  cfg |= ((t->c_cflag) & (0x00001000)) ?
      0x10 : 0x00;
  cfg |= ((t->c_cflag) & (0x00002000)) ?
      0x20 : 0x00;
 }
 ...
 report[4] = cfg;
 if (uhidev_set_report(sc->sc_hdev.sc_parent, 0x03,
...
# 498 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucycom.c"
 if (n > 0 || st != sc->sc_msr) {
  s = _splraise(6);
  sc->sc_newmsr = st;
  __builtin_bcopy((cp), (sc->sc_ibuf), (n));
  sc->sc_icnt = n;
...
void
ucycom_set(void *addr, int portno, int reg64, int onoff)
{
 struct ucycom_softc *sc = addr;
 int err;
 ...
 __builtin_memset((sc->sc_obuf), (0), (sc->sc_olen));
 sc->sc_obuf[0] = sc->sc_mcr;
