# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c"
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c"
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/hotplug.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/hotplug.h"
struct hotplug_event {
 int he_type;
 enum devclass he_devclass;
 char he_devname[16];
};
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/hotplug.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sensors.c" 2

struct taskq *sensors_taskq;
int sensordev_count;
struct { struct ksensordev *slh_first; } sensordev_list =
    { ((void *)0) };
...
sensordev_install(struct ksensordev *sensdev)
{
 ...
 if (sensordev_count == 0) {
  sensdev->num = 0;
  do { (sensdev)->list.sle_next = (&sensordev_list)->slh_first; (&sensordev_list)->slh_first = (sensdev); } while (0);
 } else {
  for (v = ((&sensordev_list)->slh_first);
      (nv = ((v)->list.sle_next)) != ((void *)0); v = nv)
   if (nv->num - v->num > 1)
    break;
  sensdev->num = v->num + 1;
  do { (sensdev)->list.sle_next = (v)->list.sle_next; (v)->list.sle_next = (sensdev); } while (0);
 }
 sensordev_count++;
 _splx(s);
...
sensor_attach(struct ksensordev *sensdev, struct ksensor *sens)
{
 ...
 if (sensdev->sensors_count == 0) {
  for (i = 0; i < SENSOR_MAX_TYPES; i++)
   sensdev->maxnumt[i] = 0;
  sens->numt = 0;
  do { (sens)->list.sle_next = (sh)->slh_first; (sh)->slh_first = (sens); } while (0);
 } else {
  for (v = ((sh)->slh_first);
      (nv = ((v)->list.sle_next)) != ((void *)0); v = nv)
  ...
  if (v->type == sens->type)
   ...
   sens->numt = 0;
  do { (sens)->list.sle_next = (v)->list.sle_next; (v)->list.sle_next = (sens); } while (0);
 }
...
sensordev_deinstall(struct ksensordev *sensdev)
{
 ...
 s = _splraise(15);
 sensordev_count--;
 do { if ((&sensordev_list)->slh_first == (sensdev)) { do { ((&sensordev_list))->slh_first = ((&sensordev_list))->slh_first->list.sle_next; } while (0); } else { struct ksensordev *curelm = (&sensordev_list)->slh_first; while (curelm->list.sle_next != (sensdev)) curelm = curelm->list.sle_next; curelm->list.sle_next = curelm->list.sle_next->list.sle_next; } ((sensdev)->list.sle_next) = ((void *)-1); } while (0);
 _splx(s);
...
sensor_detach(struct ksensordev *sensdev, struct ksensor *sens)
{
 ...
 sh = &sensdev->sensors_list;
 sensdev->sensors_count--;
 do { if ((sh)->slh_first == (sens)) { do { ((sh))->slh_first = ((sh))->slh_first->list.sle_next; } while (0); } else { struct ksensor *curelm = (sh)->slh_first; while (curelm->list.sle_next != (sens)) curelm = curelm->list.sle_next; curelm->list.sle_next = curelm->list.sle_next->list.sle_next; } ((sens)->list.sle_next) = ((void *)-1); } while (0);
...
sensordev_get(int num, struct ksensordev **sensdev)
{
 ...
 for((sd) = ((&sensordev_list)->slh_first); (sd) != ((void *)0); (sd) = ((sd)->list.sle_next)) {
  if (sd->num == num) {
   *sensdev = sd;
   return (0);
  }
...
sensor_find(int dev, enum sensor_type type, int numt, struct ksensor **ksensorp)
{
 ...
 sh = &sensdev->sensors_list;
 for((s) = ((sh)->slh_first); (s) != ((void *)0); (s) = ((s)->list.sle_next))
...
sensor_task_register(void *arg, void (*func)(void *), unsigned int period)
{
 ...
 if (sensors_taskq == ((void *)0) &&
     (sensors_taskq = taskq_create("sensors", 1, 15, 0)) == ((void *)0))
  sensors_taskq = systq;

 st = malloc(sizeof(*st), 2, 0x0002);
 if (st == ((void *)0))
  return (((void *)0));
 ...
 _rw_init_flags(&st->lock, "sensor", 0, ((void *)0));
...
sensor_task_unregister(struct sensor_task *st)
{
 ...
 _rw_enter_write(&st->lock );
 st->period = 0;
 _rw_exit_write(&st->lock );
}
...
sensor_quiesce(void)
{
 ...
 while (sensors_running > 0)
  tsleep(&sensors_running, 22, "sensorpause", 0);
...
sensor_task_work(void *xst)
{
 ...
 ((void)_atomic_add_int_nv((&sensors_running), 1));
 _rw_enter_write(&st->lock );
 period = st->period;
 if (period > 0 && !sensors_quiesced)
  st->func(st->arg);
 _rw_exit_write(&st->lock );
 if (_atomic_sub_int_nv((&sensors_running), 1) == 0) {
  if (sensors_quiesced)
