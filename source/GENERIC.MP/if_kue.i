# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c"
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 83 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 91 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 92 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
...
# 96 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 97 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kuereg.h" 1
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kuereg.h"
struct kue_ether_desc {
 u_int8_t kue_len;
 u_int8_t kue_rsvd0;
 u_int8_t kue_rsvd1;
 u_int8_t kue_macaddr[6];
 u_int8_t kue_etherstats[4];
 u_int8_t kue_maxseg[2];
 u_int8_t kue_mcastfilt[2];
 u_int8_t kue_rsvd2;
} __attribute__((__packed__));
# 142 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kuereg.h"
struct kue_type {
 u_int16_t kue_vid;
 u_int16_t kue_did;
};
...
struct kue_cdata {
 struct kue_chain kue_tx_chain[1];
 struct kue_chain kue_rx_chain[1];
 int kue_tx_prod;
 int kue_tx_cons;
 int kue_tx_cnt;
 int kue_rx_prod;
...
# 99 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kuevar.h" 1
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kuevar.h"
struct kue_firmware {
 int codeseglen;
 int fixseglen;
 int trigseglen;
...
# 100 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c" 2
# 113 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c"
...
kue_setword(struct kue_softc *sc, u_int8_t breq, u_int16_t word)
{
 ...
 req.bRequest = breq;
 ((req.wValue)[0] = (u_int8_t)(word), (req.wValue)[1] = (u_int8_t)((word) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0), (req.wIndex)[1] = (u_int8_t)((0) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));

 return (usbd_do_request(sc->kue_udev, &req, ((void *)0)));
}
...
kue_load_fw(struct kue_softc *sc)
{
 ...
 ;
# 246 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c"
 if ((dd = usbd_get_device_descriptor(sc->kue_udev)) == ((void *)0))
  return (5);
 ...
 err = kue_ctl(sc, 0x02, 0xFF,
     0, (void *)&fw->data[0], ((__uint32_t)(fw->codeseglen)));
 if (err) {
 ...
 err = kue_ctl(sc, 0x02, 0xFF,
     0, (void *)&fw->data[((__uint32_t)(fw->codeseglen))], ((__uint32_t)(fw->fixseglen)));
 if (err) {
...
# 313 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c"
...
allmulti:
  ifp->if_flags |= 0x200;
  sc->kue_rxfilt |= 0x0002;
  sc->kue_rxfilt &= ~0x0010;
  kue_setword(sc, 0x02, sc->kue_rxfilt);
  return;
 }
 ...
 while (enm != ((void *)0)) {
  if (i == ((((sc)->kue_desc.kue_mcastfilt[1] << 8) | (sc)->kue_desc.kue_mcastfilt[0]) & 0x7FFF))
   goto allmulti;

  __builtin_memcpy(((char *)&(sc->kue_mcfilters[i * 6])), (enm->enm_addrlo), (6));
 ...
 sc->kue_rxfilt |= 0x0010;
 kue_ctl(sc, 0x02, 0x01,
     i, sc->kue_mcfilters, i * 6);
...
kue_reset(struct kue_softc *sc)
{
 ...
 if (usbd_set_config_no(sc->kue_udev, 1, 1) ||
     usbd_device2interface_handle(sc->kue_udev, 0,
      &sc->kue_iface))
...
kue_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(kue_devs), sizeof (kue_devs) / sizeof ((kue_devs)[0]), sizeof ((kue_devs)[0]), (uaa->vendor), (uaa->product)) != ((void *)0) ?
     13 : 0);
}
...
kue_attachhook(struct device *self)
{
 ...
 for (i = 0; i < id->bNumEndpoints; i++) {
  ...
  if (((ed->bEndpointAddress) & 0x80) == 0x80 &&
   ...
   sc->kue_ed[0x0] = ed->bEndpointAddress;
  } else if (((ed->bEndpointAddress) & 0x80) == 0x00 &&
      ((ed->bmAttributes) & 0x03) == 0x02) {
   sc->kue_ed[0x1] = ed->bEndpointAddress;
  } else if (((ed->bEndpointAddress) & 0x80) == 0x80 &&
      ((ed->bmAttributes) & 0x03) == 0x03) {
   sc->kue_ed[0x2] = ed->bEndpointAddress;
  }
 }

 if (sc->kue_ed[0x0] == 0 || sc->kue_ed[0x1] == 0) {
  printf("%s: missing endpoint\n", sc->kue_dev.dv_xname);
  return;
 }


 err = kue_ctl(sc, 0x01, 0x00,
 ...
 sc->kue_mcfilters = mallocarray(((((sc)->kue_desc.kue_mcastfilt[1] << 8) | (sc)->kue_desc.kue_mcastfilt[0]) & 0x7FFF), 6,
     102, 0x0002);
 if (sc->kue_mcfilters == ((void *)0)) {
  printf("%s: no memory for multicast filter buffer\n",
      sc->kue_dev.dv_xname);
  return;
 }
 sc->kue_mcfilterslen = ((((sc)->kue_desc.kue_mcastfilt[1] << 8) | (sc)->kue_desc.kue_mcastfilt[0]) & 0x7FFF);
 ...
 __builtin_bcopy((sc->kue_desc.kue_macaddr), ((char *)&sc->arpcom.ac_enaddr), (6));
 ...
 strlcpy(ifp->if_xname, sc->kue_dev.dv_xname, 16);
...
kue_detach(struct device *self, int flags)
{
 ...
 if (sc->kue_mcfilters != ((void *)0)) {
  free(sc->kue_mcfilters, 102, sc->kue_mcfilterslen);
  sc->kue_mcfilters = ((void *)0);
 }
 ...
 if (sc->kue_ep[0x1] != ((void *)0) ||
     sc->kue_ep[0x0] != ((void *)0) ||
     sc->kue_ep[0x2] != ((void *)0))
...
kue_rx_list_init(struct kue_softc *sc)
{
 ...
 for (i = 0; i < 1; i++) {
  ...
  c->kue_sc = sc;
  c->kue_idx = i;
  if (kue_newbuf(sc, c, ((void *)0)) == 55)
   return (55);
  if (c->kue_xfer == ((void *)0)) {
   c->kue_xfer = usbd_alloc_xfer(sc->kue_udev);
   if (c->kue_xfer == ((void *)0))
    return (55);
   c->kue_buf = usbd_alloc_buffer(c->kue_xfer, 1536);
   if (c->kue_buf == ((void *)0))
    return (55);
  }
 }
...
kue_rxeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (status != USBD_NORMAL_COMPLETION) {
  ...
  if (status == USBD_STALLED)
   usbd_clear_endpoint_stall_async(sc->kue_ep[0x0]);
  goto done;
 }
 ...
 __builtin_memcpy((((char *)((m)->m_hdr.mh_data))), (c->kue_buf), (total_len));


 total_len = ((((u_int8_t *)((m)->m_hdr.mh_data)))[0] | ((((u_int8_t *)((m)->m_hdr.mh_data)))[1] << 8));
 ...
 usbd_setup_xfer(c->kue_xfer, sc->kue_ep[0x0],
     c, c->kue_buf, 1536, 0x04 | 0x01,
     0, kue_rxeof);
...
kue_txeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (status != USBD_NORMAL_COMPLETION) {
  ...
  printf("%s: usb error on tx: %s\n", sc->kue_dev.dv_xname,
      usbd_errstr(status));
  if (status == USBD_STALLED)
   usbd_clear_endpoint_stall_async(sc->kue_ep[0x1]);
  _splx(s);
  return;
 }
...
kue_send(struct kue_softc *sc, struct mbuf *m, int idx)
{
 ...
 m_copydata(m, 0, m->M_dat.MH.MH_pkthdr.len, c->kue_buf + 2);
 c->kue_mbuf = m;
 ...
 c->kue_buf[0] = (u_int8_t)m->M_dat.MH.MH_pkthdr.len;
 c->kue_buf[1] = (u_int8_t)(m->M_dat.MH.MH_pkthdr.len >> 8);

 usbd_setup_xfer(c->kue_xfer, sc->kue_ep[0x1],
     c, c->kue_buf, total_len, 0x01, 5000,
     kue_txeof);
...
kue_init(void *xsc)
{
 ...
 kue_ctl(sc, 0x02, 0x06, 0, eaddr, 6);

 sc->kue_rxfilt = 0x0004 | 0x0008;


 if (ifp->if_flags & 0x100)
  sc->kue_rxfilt |= 0x0001;

 kue_setword(sc, 0x02, sc->kue_rxfilt);
# 919 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_kue.c"
 kue_setword(sc, 0x08, 64);


 if (kue_tx_list_init(sc) == 55) {
...
kue_open_pipes(struct kue_softc *sc)
{
 ...
 err = usbd_open_pipe(sc->kue_iface, sc->kue_ed[0x0],
     0x01, &sc->kue_ep[0x0]);
 if (err) {
 ...
 err = usbd_open_pipe(sc->kue_iface, sc->kue_ed[0x1],
     0x01, &sc->kue_ep[0x1]);
 if (err) {
...
kue_watchdog(struct ifnet *ifp)
{
 ...
 usbd_get_xfer_status(c->kue_xfer, ((void *)0), ((void *)0), ((void *)0), &stat);
...
kue_stop(struct kue_softc *sc)
{
 ...
 if (sc->kue_ep[0x0] != ((void *)0)) {
  usbd_abort_pipe(sc->kue_ep[0x0]);
  err = usbd_close_pipe(sc->kue_ep[0x0]);
  if (err) {
 ...
 if (sc->kue_ep[0x1] != ((void *)0)) {
  usbd_abort_pipe(sc->kue_ep[0x1]);
  err = usbd_close_pipe(sc->kue_ep[0x1]);
  if (err) {
   printf("%s: close tx pipe failed: %s\n",
       sc->kue_dev.dv_xname, usbd_errstr(err));
  }
  sc->kue_ep[0x1] = ((void *)0);
 }

 if (sc->kue_ep[0x2] != ((void *)0)) {
  usbd_abort_pipe(sc->kue_ep[0x2]);
  err = usbd_close_pipe(sc->kue_ep[0x2]);
  if (err) {
 ...
 for (i = 0; i < 1; i++) {
  if (sc->kue_cdata.kue_rx_chain[i].kue_mbuf != ((void *)0)) {
   m_freem(sc->kue_cdata.kue_rx_chain[i].kue_mbuf);
   sc->kue_cdata.kue_rx_chain[i].kue_mbuf = ((void *)0);
  }
  if (sc->kue_cdata.kue_rx_chain[i].kue_xfer != ((void *)0)) {
   usbd_free_xfer(sc->kue_cdata.kue_rx_chain[i].kue_xfer);
   sc->kue_cdata.kue_rx_chain[i].kue_xfer = ((void *)0);
  }
 }


 for (i = 0; i < 1; i++) {
  if (sc->kue_cdata.kue_tx_chain[i].kue_mbuf != ((void *)0)) {
   m_freem(sc->kue_cdata.kue_tx_chain[i].kue_mbuf);
   sc->kue_cdata.kue_tx_chain[i].kue_mbuf = ((void *)0);
  }
  if (sc->kue_cdata.kue_tx_chain[i].kue_xfer != ((void *)0)) {
   usbd_free_xfer(sc->kue_cdata.kue_tx_chain[i].kue_xfer);
   sc->kue_cdata.kue_tx_chain[i].kue_xfer = ((void *)0);
  }
 }
}
