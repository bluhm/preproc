# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c"
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c"
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
void device_register(struct device *, void *);
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mc146818reg.h" 1
# 151 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/mc146818reg.h"
u_int mc146818_read(void *sc, u_int reg64);
void mc146818_write(void *sc, u_int reg64, u_int datum);




typedef u_int mc_todregs[0xa];
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c" 2
# 93 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c"
...
rtc_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (strcmp(model, "bq4802") == 0) {
  ...
  csr = bus_space_read_1(sc->sc_iot, sc->sc_ioh, 0x0e);
  csr |= 0x02;
  bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x0e, csr);
  return;
 }
 ...
 rtc_write_reg(sc, 0xb, 0x04 | 0x02);
...
# 227 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c"
u_int8_t
rtc_read_reg(struct rtc_softc *sc, bus_size_t reg64)
{
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0, reg64);
 return (bus_space_read_1(sc->sc_iot, sc->sc_ioh, 1));
}

void
rtc_write_reg(struct rtc_softc *sc, bus_size_t reg64, u_int8_t val)
{
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0, reg64);
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 1, val);
}
# 249 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/rtc.c"
int
rtc_gettime(todr_chip_handle_t handle, struct timeval *tv)
{
 ...
 csr = rtc_read_reg(sc, 0xb);
 csr |= 0x80;
 rtc_write_reg(sc, 0xb, csr);


 dt.dt_sec = rtc_read_reg(sc, 0x0);
 dt.dt_min = rtc_read_reg(sc, 0x2);
 dt.dt_hour = rtc_read_reg(sc, 0x4);
 dt.dt_day = rtc_read_reg(sc, 0x7);
 dt.dt_wday = rtc_read_reg(sc, 0x6);
 dt.dt_mon = rtc_read_reg(sc, 0x8);
 year = rtc_read_reg(sc, 0x9);
...
rtc_settime(todr_chip_handle_t handle, struct timeval *tv)
{
 ...
 rtc_write_reg(sc, 0x0, dt.dt_sec);
 rtc_write_reg(sc, 0x2, dt.dt_min);
 rtc_write_reg(sc, 0x4, dt.dt_hour);
 rtc_write_reg(sc, 0x6, dt.dt_wday);
 rtc_write_reg(sc, 0x7, dt.dt_day);
 rtc_write_reg(sc, 0x8, dt.dt_mon);
 rtc_write_reg(sc, 0x9, year);
...
rtc_bq4802_gettime(todr_chip_handle_t handle, struct timeval *tv)
{
 ...
 csr = bus_space_read_1(iot, ioh, 0x0e);
 csr |= 0x08;
 bus_space_write_1(iot, ioh, 0x0e, csr);


 dt.dt_sec = (((bus_space_read_1(iot, ioh, 0x00)) >> 4) * 10 + ((bus_space_read_1(iot, ioh, 0x00)) & 0xf));
 dt.dt_min = (((bus_space_read_1(iot, ioh, 0x02)) >> 4) * 10 + ((bus_space_read_1(iot, ioh, 0x02)) & 0xf));
 dt.dt_hour = (((bus_space_read_1(iot, ioh, 0x04)) >> 4) * 10 + ((bus_space_read_1(iot, ioh, 0x04)) & 0xf));
 dt.dt_day = (((bus_space_read_1(iot, ioh, 0x06)) >> 4) * 10 + ((bus_space_read_1(iot, ioh, 0x06)) & 0xf));
 dt.dt_wday = (((bus_space_read_1(iot, ioh, 0x08)) >> 4) * 10 + ((bus_space_read_1(iot, ioh, 0x08)) & 0xf));
 dt.dt_mon = (((bus_space_read_1(iot, ioh, 0x09)) >> 4) * 10 + ((bus_space_read_1(iot, ioh, 0x09)) & 0xf));
 dt.dt_year = (((bus_space_read_1(iot, ioh, 0x0a)) >> 4) * 10 + ((bus_space_read_1(iot, ioh, 0x0a)) & 0xf)) +
     (((bus_space_read_1(iot, ioh, 0x0f)) >> 4) * 10 + ((bus_space_read_1(iot, ioh, 0x0f)) & 0xf)) * 100;
...
rtc_bq4802_settime(todr_chip_handle_t handle, struct timeval *tv)
{
 ...
 bus_space_write_1(iot, ioh, 0x00, (((dt.dt_sec) / 10 * 16) + ((dt.dt_sec) % 10)));
 bus_space_write_1(iot, ioh, 0x02, (((dt.dt_min) / 10 * 16) + ((dt.dt_min) % 10)));
 bus_space_write_1(iot, ioh, 0x04, (((dt.dt_hour) / 10 * 16) + ((dt.dt_hour) % 10)));
 bus_space_write_1(iot, ioh, 0x08, (((dt.dt_wday) / 10 * 16) + ((dt.dt_wday) % 10)));
 bus_space_write_1(iot, ioh, 0x06, (((dt.dt_day) / 10 * 16) + ((dt.dt_day) % 10)));
 bus_space_write_1(iot, ioh, 0x09, (((dt.dt_mon) / 10 * 16) + ((dt.dt_mon) % 10)));
 bus_space_write_1(iot, ioh, 0x0a, (((dt.dt_year % 100) / 10 * 16) + ((dt.dt_year % 100) % 10)));
 bus_space_write_1(iot, ioh, 0x0f, (((dt.dt_year / 100) / 10 * 16) + ((dt.dt_year / 100) % 10)));
