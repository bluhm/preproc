# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c"
# 98 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c"
...
# 99 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
# 100 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
# 101 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
# 102 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
# 103 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
# 104 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
# 105 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
# 106 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
# 107 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
# 109 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 110 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530reg.h" 1
# 112 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/z8530var.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/z8530var.h"
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/z8530var.h" 2
...
# 113 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
...
# 115 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
# 133 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c"
...
u_int zstty_rbuf_size = 2048;


u_int zstty_rbuf_hiwat = (2048 * 1) / 4;
u_int zstty_rbuf_lowat = (2048 * 3) / 4;
...
struct zstty_softc {
 ...
 uint8_t zst_ppsmask;
 uint8_t zst_ppsassert;
 uint8_t zst_ppsclear;
};
...
zstty_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 dev = ((dev_t)((((zs_major) & 0xff) << 8) | ((tty_unit) & 0xff) | (((tty_unit) & 0xffff00) << 8)));

 if (zst->zst_swflags)
  printf(" flags 0x%x", zst->zst_swflags);

 if (((zst->zst_hwflags) & (4)))
  ((zst->zst_swflags) |= (0x01));
 ...
 i = o = ((void *)0);
 if ((zst->zst_hwflags & 1) != 0) {
  i = " input";
  if ((args->hwflags & 32) != 0) {
 ...
 zst->zst_tty = tp;
 zst->zst_rbuf = mallocarray(zstty_rbuf_size, 2, 2, 0x0001);
 ...
 if (((zst->zst_hwflags) & ((1 | 2)))) {
  ...
  ((cs->cs_preg[1]) |= (0x10 | 0x02 | 0x01));

  _splx(s);


  tp->t_termios.c_ospeed = 0;
  (void)zsparam(tp, &t);


  dtr_on = 1;
 } else if (!((zst->zst_hwflags) & (64))) {

  resetbit = (channel == 0) ? 0x80 : 0x40;
 }
...
zstty(dev_t dev)
{
 struct zstty_softc *zst = zs_device_lookup(&zstty_cd, (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x7f));
...
zs_shutdown(struct zstty_softc *zst)
{
 ...
 if (((tp->t_termios.c_cflag) & (0x00004000)) || ((tp->t_state) & (0x00200))) {
  zs_modem(zst, 0);

  (void)tsleep(cs, 25, ttclos, hz);
 }
...
zsopen(dev_t dev, int flags, int mode, struct proc *p)
{
 ...
 zst = zs_device_lookup(&zstty_cd, (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x7f));
 if (zst == ((void *)0))
  return (6);
 ...
 if (!((tp->t_state) & (0x00020))) {
  ...
  t.c_ospeed = cs->cs_defspeed;
  t.c_cflag = cs->cs_defcflag;
  if (((zst->zst_swflags) & (0x02)))
   ((t.c_cflag) |= (0x00008000));
  if (((zst->zst_swflags) & (0x04)))
   ((t.c_cflag) |= (0x00010000));
  if (((zst->zst_swflags) & (0x08)))
   ((t.c_cflag) |= (0x00100000));


  s2 = _splraise(12);
# 529 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c"
  ((cs->cs_preg[1]) |= (0x10 | 0x02 | 0x01));
  ...
  if (!((zst->zst_hwflags) & (16))) {
   ...
   tp->t_termios.c_iflag = 0;
   tp->t_termios.c_oflag = 0;
   tp->t_termios.c_lflag = 0;
  }
  ttychars(tp);
  ttsetwater(tp);

  if ((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x80))
   ((tp->t_state) |= (0x00008));
  else
   ((tp->t_state) &= ~(0x00008));
 ...
 if (((flags) & (0x0004))) {
  if (!(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x80) && cs->cs_cua) {

   error = 16;
  }
 } else
   while (cs->cs_cua ||
     (!((tp->t_termios.c_cflag) & (0x00008000)) && !((tp->t_state) & (0x00008)))) {
  int rr0;
  ...
  if (!(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x80) && !cs->cs_cua) {
# 614 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c"
   s2 = _splraise(12);
  ...
  if ((((tp->t_termios.c_cflag) & (0x00008000)) ||
      ((tp->t_state) & (0x00008))) && !cs->cs_cua)
   break;

  error = ttysleep(tp, (caddr_t)&tp->t_rawq, 25 | 0x100,
      ttopen, 0);

  if (!(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x80) && cs->cs_cua && error == 4) {
   error = 0;
   continue;
  }
...
{
 struct zstty_softc *zst = zs_device_lookup(&zstty_cd, (((int32_t)((tp->t_dev) & 0xff) | (((tp->t_dev) & 0xffff0000) >> 8)) & 0x7f));
 struct zs_chanstate *cs = zst->zst_cs;
 u_char *tba;
 int tbc, rr0;
 int s;
 ...
 s = _splraise(6);
 if (((tp->t_state) & (0x00004 | 0x00080 | 0x00100)))
  goto out;
...
zsparam(struct tty *tp, struct termios *t)
{
 ...
 if (tp->t_termios.c_ospeed == ospeed &&
 ...
 if (error)
  return (error);
# 948 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c"
 s = _splraise(12);
 ...
 tp->t_termios.c_ispeed = 0;
 tp->t_termios.c_ospeed = ospeed;
 tp->t_termios.c_cflag = cflag;
 ...
 if (!((cflag) & ((0x00100000|0x00010000)))) {
  zst->zst_r_hiwat = 0;
  zst->zst_r_lowat = 0;
  if (((zst->zst_rx_flags) & (0x02))) {
   ((zst->zst_rx_flags) &= ~(0x02));
   zst->zst_rx_ready = 1;
   cs->cs_softreq = 1;
  }
  if (((zst->zst_rx_flags) & (0x01|0x04))) {
   ((zst->zst_rx_flags) &= ~(0x01|0x04));
   zs_hwiflow(zst);
  }
 } else {
...
zs_maskintr(struct zstty_softc *zst)
{
 ...
 tmp15 = cs->cs_preg[15];
 if (((cs->cs_rr0_mask) & (0x08)))
  ((tmp15) |= (0x08));
 else
  ((tmp15) &= ~(0x08));
 if (((cs->cs_rr0_mask) & (0x20)))
  ((tmp15) |= (0x20));
 else
  ((tmp15) &= ~(0x20));
 cs->cs_preg[15] = tmp15;
...
zs_modem(struct zstty_softc *zst, int onoff)
{
 ...
 ccs = (cs->cs_ctl_chan != ((void *)0) ? cs->cs_ctl_chan : cs);

 if (onoff)
  ((ccs->cs_preg[5]) |= (cs->cs_wr5_dtr));
 else
  ((ccs->cs_preg[5]) &= ~(cs->cs_wr5_dtr));
...
zshwiflow(struct tty *tp, int block)
{
 ...
 s = _splraise(12);
 if (block) {
  if (!((zst->zst_rx_flags) & (0x01))) {
   ((zst->zst_rx_flags) |= (0x01));
   zs_hwiflow(zst);
  }
 } else {
  if (((zst->zst_rx_flags) & (0x02))) {
...
zs_hwiflow(struct zstty_softc *zst)
{
 ...
 if (((zst->zst_rx_flags) & (0x0f))) {
  ((ccs->cs_preg[5]) &= ~(cs->cs_wr5_rts));
  ((ccs->cs_creg[5]) &= ~(cs->cs_wr5_rts));
 } else {
  ((ccs->cs_preg[5]) |= (cs->cs_wr5_rts));
  ((ccs->cs_creg[5]) |= (cs->cs_wr5_rts));
 }
...
zstty_rxint(struct zs_chanstate *cs)
{
 ...
 while (cc > 0) {
  ...
  if (((rr1) & (0x40 | 0x20 | 0x10))) {

   zs_write_csr(cs, 0x30);
  }
...
int ddb_sysctl(int *, u_int, void *, size_t *, void *, size_t,
         struct proc *);
# 1381 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c" 2
# 1390 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c"
void
zstty_stint(struct zs_chanstate *cs, int force)
{
 ...
 rr0 = zs_read_csr(cs);
 zs_write_csr(cs, 0x10);





 if ((zst->zst_hwflags & 1) &&
     ((rr0) & (0x80)) && db_console)
  zs_abort(cs);
 ...
 ttytstamp(tp, cs->cs_rr0 & 0x20, rr0 & 0x20,
     cs->cs_rr0 & 0x08, rr0 & 0x08);

 cs->cs_rr0 = rr0;

 if (((delta) & (cs->cs_rr0_mask))) {
...
zstty_diag(void *arg)
{
 ...
 log(4, "%s: %d silo overflow%s, %d ibuf flood%s\n",
     zst->zst_dev.dv_xname,
...
zstty_stsoft(struct zstty_softc *zst, struct tty *tp)
{
 ...
 if (((delta) & (cs->cs_rr0_dcd))) {
  ...
  (void)(*linesw[tp->t_line].l_modem)(tp, ((rr0) & (0x08)));
 }
...
# 1612 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530tty.c"
void
