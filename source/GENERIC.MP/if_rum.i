...
rum_rxeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 m->M_dat.MH.MH_pkthdr.len = m->m_hdr.mh_len = ((__builtin_constant_p(desc->flags) ? (__uint32_t)(((__uint32_t)(desc->flags) & 0xff) << 24 | ((__uint32_t)(desc->flags) & 0xff00) << 8 | ((__uint32_t)(desc->flags) & 0xff0000) >> 8 | ((__uint32_t)(desc->flags) & 0xff000000) >> 24) : __swap32md(desc->flags)) >> 16) & 0xfff;
 s = _splraise(6);
    ...
    uint32_t flags, uint16_t xflags, int len, int rate)
{
 ...
 desc->wme = (__builtin_constant_p((0) | ((2) << 4) | ((4) << 8) | ((10) << 12)) ? (__uint16_t)(((__uint16_t)((0) | ((2) << 4) | ((4) << 8) | ((10) << 12)) & 0xffU) << 8 | ((__uint16_t)((0) | ((2) << 4) | ((4) << 8) | ((10) << 12)) & 0xff00U) >> 8) : __swap16md((0) | ((2) << 4) | ((4) << 8) | ((10) << 12)));
...
{
 uint32_t tmp = (__builtin_constant_p(val) ? (__uint32_t)(((__uint32_t)(val) & 0xff) << 24 | ((__uint32_t)(val) & 0xff00) << 8 | ((__uint32_t)(val) & 0xff0000) >> 8 | ((__uint32_t)(val) & 0xff000000) >> 24) : __swap32md(val));
...
rum_read_eeprom(struct rum_softc *sc)
{
 ...
 sc->macbbp_rev = (__builtin_constant_p(val) ? (__uint16_t)(((__uint16_t)(val) & 0xffU) << 8 | ((__uint16_t)(val) & 0xff00U) >> 8) : __swap16md(val));
    ...
    usbd_status status)
{
 ...
 ifp->if_data.ifi_oerrors += (__builtin_constant_p(sc->sta[5]) ? (__uint32_t)(((__uint32_t)(sc->sta[5]) & 0xff) << 24 | ((__uint32_t)(sc->sta[5]) & 0xff00) << 8 | ((__uint32_t)(sc->sta[5]) & 0xff0000) >> 8 | ((__uint32_t)(sc->sta[5]) & 0xff000000) >> 24) : __swap32md(sc->sta[5])) >> 16;
 sc->amn.amn_retrycnt =
     ((__builtin_constant_p(sc->sta[4]) ? (__uint32_t)(((__uint32_t)(sc->sta[4]) & 0xff) << 24 | ((__uint32_t)(sc->sta[4]) & 0xff00) << 8 | ((__uint32_t)(sc->sta[4]) & 0xff0000) >> 8 | ((__uint32_t)(sc->sta[4]) & 0xff000000) >> 24) : __swap32md(sc->sta[4])) >> 16) +
     ((__builtin_constant_p(sc->sta[5]) ? (__uint32_t)(((__uint32_t)(sc->sta[5]) & 0xff) << 24 | ((__uint32_t)(sc->sta[5]) & 0xff00) << 8 | ((__uint32_t)(sc->sta[5]) & 0xff0000) >> 8 | ((__uint32_t)(sc->sta[5]) & 0xff000000) >> 24) : __swap32md(sc->sta[5])) & 0xffff) +
     ((__builtin_constant_p(sc->sta[5]) ? (__uint32_t)(((__uint32_t)(sc->sta[5]) & 0xff) << 24 | ((__uint32_t)(sc->sta[5]) & 0xff00) << 8 | ((__uint32_t)(sc->sta[5]) & 0xff0000) >> 8 | ((__uint32_t)(sc->sta[5]) & 0xff000000) >> 24) : __swap32md(sc->sta[5])) >> 16);
 sc->amn.amn_txcnt =
     sc->amn.amn_retrycnt +
     ((__builtin_constant_p(sc->sta[4]) ? (__uint32_t)(((__uint32_t)(sc->sta[4]) & 0xff) << 24 | ((__uint32_t)(sc->sta[4]) & 0xff00) << 8 | ((__uint32_t)(sc->sta[4]) & 0xff0000) >> 8 | ((__uint32_t)(sc->sta[4]) & 0xff000000) >> 24) : __swap32md(sc->sta[4])) & 0xffff);
