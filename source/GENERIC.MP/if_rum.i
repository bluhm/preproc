    ...
    uint32_t flags, uint16_t xflags, int len, int rate)
{
 ...
 desc->wme = (__uint16_t)(__builtin_constant_p((0) | ((2) << 4) | ((4) << 8) | ((10) << 12)) ? (__uint16_t)(((__uint16_t)((0) | ((2) << 4) | ((4) << 8) | ((10) << 12)) & 0xffU) << 8 | ((__uint16_t)((0) | ((2) << 4) | ((4) << 8) | ((10) << 12)) & 0xff00U) >> 8) : __swap16md((0) | ((2) << 4) | ((4) << 8) | ((10) << 12)));
...
{
 uint32_t tmp = (__uint32_t)(__builtin_constant_p(val) ? (__uint32_t)(((__uint32_t)(val) & 0xff) << 24 | ((__uint32_t)(val) & 0xff00) << 8 | ((__uint32_t)(val) & 0xff0000) >> 8 | ((__uint32_t)(val) & 0xff000000) >> 24) : __swap32md(val));
    ...
    usbd_status status)
{
 ...
 ifp->if_data.ifi_oerrors += (__uint32_t)(__builtin_constant_p(sc->sta[5]) ? (__uint32_t)(((__uint32_t)(sc->sta[5]) & 0xff) << 24 | ((__uint32_t)(sc->sta[5]) & 0xff00) << 8 | ((__uint32_t)(sc->sta[5]) & 0xff0000) >> 8 | ((__uint32_t)(sc->sta[5]) & 0xff000000) >> 24) : __swap32md(sc->sta[5])) >> 16;
 sc->amn.amn_retrycnt =
     ((__uint32_t)(__builtin_constant_p(sc->sta[4]) ? (__uint32_t)(((__uint32_t)(sc->sta[4]) & 0xff) << 24 | ((__uint32_t)(sc->sta[4]) & 0xff00) << 8 | ((__uint32_t)(sc->sta[4]) & 0xff0000) >> 8 | ((__uint32_t)(sc->sta[4]) & 0xff000000) >> 24) : __swap32md(sc->sta[4])) >> 16) +
     ((__uint32_t)(__builtin_constant_p(sc->sta[5]) ? (__uint32_t)(((__uint32_t)(sc->sta[5]) & 0xff) << 24 | ((__uint32_t)(sc->sta[5]) & 0xff00) << 8 | ((__uint32_t)(sc->sta[5]) & 0xff0000) >> 8 | ((__uint32_t)(sc->sta[5]) & 0xff000000) >> 24) : __swap32md(sc->sta[5])) & 0xffff) +
     ((__uint32_t)(__builtin_constant_p(sc->sta[5]) ? (__uint32_t)(((__uint32_t)(sc->sta[5]) & 0xff) << 24 | ((__uint32_t)(sc->sta[5]) & 0xff00) << 8 | ((__uint32_t)(sc->sta[5]) & 0xff0000) >> 8 | ((__uint32_t)(sc->sta[5]) & 0xff000000) >> 24) : __swap32md(sc->sta[5])) >> 16);
 sc->amn.amn_txcnt =
     sc->amn.amn_retrycnt +
     ((__uint32_t)(__builtin_constant_p(sc->sta[4]) ? (__uint32_t)(((__uint32_t)(sc->sta[4]) & 0xff) << 24 | ((__uint32_t)(sc->sta[4]) & 0xff00) << 8 | ((__uint32_t)(sc->sta[4]) & 0xff0000) >> 8 | ((__uint32_t)(sc->sta[4]) & 0xff000000) >> 24) : __swap32md(sc->sta[4])) & 0xffff);
