# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c"
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c"
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c" 2
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c"
...
struct uthum_softc {
 ...
 struct uthum_sensor sc_sensor[2];
...
uthum_match(struct device *parent, void *match, void *aux)
{
 ...
 if (usbd_match_device((const struct usb_devno *)(uthum_devs), sizeof (uthum_devs) / sizeof ((uthum_devs)[0]), sizeof ((uthum_devs)[0]), (uha->uaa->vendor), (uha->uaa->product)) == ((void *)0))
  return 0;
# 187 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c"
 return (13);
}
...
uthum_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 for (i = 0; i < 2; i++) {
  ...
  sc->sc_sensor[i].sensor.flags |= 0x0001;
...
uthum_issue_cmd(struct uthum_softc *sc, uint8_t target_cmd, int delay)
{
 ...
 __builtin_bzero((cmdbuf), (sizeof(cmdbuf)));
 __builtin_memcpy((cmdbuf), (cmd_issue), (sizeof(cmd_issue)));
 actlen = uhidev_set_report(sc->sc_hdev.sc_parent, 0x02,
 ...
 for (i = 0; i < 7; i++) {
  actlen = uhidev_set_report(sc->sc_hdev.sc_parent,
      0x02, sc->sc_hdev.sc_report_id, cmdbuf,
      sc->sc_olen);
  if (actlen != sc->sc_olen)
   return 5;
 }
 ...
 size_t len, int delay)
{
 ...
 __builtin_bzero((cmdbuf), (sizeof(cmdbuf)));
 __builtin_memcpy((cmdbuf), (cmd_query), (sizeof(cmd_query)));
 if (uhidev_set_report(sc->sc_hdev.sc_parent, 0x02,
 ...
 if (uhidev_get_report(sc->sc_hdev.sc_parent, 0x03,
     sc->sc_hdev.sc_report_id, report, sc->sc_flen) != sc->sc_flen)
  return 5;
 __builtin_memcpy((buf), (report), (len));
 return 0;
}
...
uthum_check_device_info(struct uthum_softc *sc)
{
 ...
 while (retry) {
  if (uthum_read_data(sc, 0x52, (void *)&dinfo,
      sizeof(struct uthum_dev_info), 0) != 0) {
   ;
   retry--;
   continue;
  }
  if (dinfo.footer != 0x53) {
 ...
 dev_type = ((__uint16_t)(dinfo.dev_type));
...
uthum_reset_device(struct uthum_softc *sc)
{
 ...
 case 0x5758:
 case 0x575b:
  uthum_issue_cmd(sc, 0x43, 200);
  break;
 case 0x5759:
  uthum_issue_cmd(sc, 0x43, 200);
  uthum_issue_cmd(sc, 0x44, 200);
  break;
 }
}
...
uthum_setup_sensors(struct uthum_softc *sc)
{
 ...
 switch (sc->sc_device_type) {
 case 0x5759:
  sc->sc_sensor[1].dev_type =
      UTHUM_SENSOR_DS75;
  sc->sc_sensor[1].sensor.type =
      SENSOR_TEMP;
  strlcpy(sc->sc_sensor[1].sensor.desc,
      "outer",
      sizeof(sc->sc_sensor[1].sensor.desc));

 case 0x5758:
  sc->sc_sensor[0].dev_type =
      UTHUM_SENSOR_DS75;
  sc->sc_sensor[0].sensor.type =
      SENSOR_TEMP;
  strlcpy(sc->sc_sensor[0].sensor.desc,
      "inner",
      sizeof(sc->sc_sensor[0].sensor.desc));
  break;
 case 0x535a:

  for (i = 0; i < 2; i++)
   sc->sc_sensor[i].dev_type = UTHUM_SENSOR_SHT1X;
  sc->sc_sensor[0].sensor.type = SENSOR_TEMP;
  sc->sc_sensor[1].sensor.type =
      SENSOR_HUMIDITY;
  strlcpy(sc->sc_sensor[1].sensor.desc,
      "RH",
 ...
 case 0x575b:
  ...
  for (i = 0; i < 4; i++)
   uthum_issue_cmd(sc, 0x61, 50);
  sc->sc_sensor[1].cur_state = 0x61;
  if (uthum_ntc_tuning(sc, 1, ((void *)0)))
   ;
  uthum_issue_cmd(sc, 0x69, 100);
  break;
 default:
...
uthum_ntc_getdata(struct uthum_softc *sc, int *val)
{
 ...
 if (uthum_read_data(sc, 0x41, buf, sizeof(buf), 10) != 0) {
  ;
  return 5;
 }
...
uthum_refresh_temperhum(struct uthum_softc *sc)
{
 ...
 if (uthum_read_data(sc, 0x48, buf, sizeof(buf), 1000) != 0) {
  ;
  sc->sc_sensor[0].sensor.flags
      |= 0x0001;
  sc->sc_sensor[1].sensor.flags
      |= 0x0001;
  return;
 }
 ...
 temp += sc->sc_sensor[0].cal_offset;
 rh += sc->sc_sensor[1].cal_offset;

 sc->sc_sensor[0].sensor.value =
     (temp * 10000) + 273150000;
 sc->sc_sensor[0].sensor.flags &= ~0x0001;
 sc->sc_sensor[1].sensor.value = rh;
 sc->sc_sensor[1].sensor.flags &= ~0x0001;
}
...
uthum_refresh_temper(struct uthum_softc *sc, int sensor)
{
 ...
 if (uthum_read_data(sc, cmd, buf, sizeof(buf), 1000) != 0) {
  ;
  sc->sc_sensor[sensor].sensor.flags |= 0x0001;
  return;
 }
...
{
 int nticks;
# 756 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uthum.c"
