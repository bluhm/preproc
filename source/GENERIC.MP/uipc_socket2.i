...
{
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 385, "_kernel_lock_held()"));
 soassertlocked(so);
 selwakeup(&sb->sb_sel);
