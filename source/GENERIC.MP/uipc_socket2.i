# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c" 2





u_long sb_max = (2*1024*1024);

extern struct pool mclpools[];
extern struct pool mbpool;
# 87 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c"
void
...
# 144 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c"
struct socket *
sonewconn(struct socket *head, int connstatus)
{
 ...
 if (head->so_qlen + head->so_q0len > head->so_qlimit * 3)
  return (((void *)0));
 so = pool_get(&socket_pool, 0x0002|0x0008);
 if (so == ((void *)0))
  return (((void *)0));
...
soqinsque(struct socket *head, struct socket *so, int q)
{
 ...
 do { (so)->so_qe.tqe_next = ((void *)0); (so)->so_qe.tqe_prev = (so->so_onq)->tqh_last; *(so->so_onq)->tqh_last = (so); (so->so_onq)->tqh_last = &(so)->so_qe.tqe_next; } while (0);
}
...
soqremque(struct socket *so, int q)
{
 ...
 do { if (((so)->so_qe.tqe_next) != ((void *)0)) (so)->so_qe.tqe_next->so_qe.tqe_prev = (so)->so_qe.tqe_prev; else (so->so_onq)->tqh_last = (so)->so_qe.tqe_prev; *(so)->so_qe.tqe_prev = (so)->so_qe.tqe_next; ((so)->so_qe.tqe_prev) = ((void *)-1); ((so)->so_qe.tqe_next) = ((void *)-1); } while (0);
 so->so_onq = ((void *)0);
 so->so_head = ((void *)0);
 return (1);
}
# 260 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c"
void
...
sbwait(struct socket *so, struct sockbuf *sb)
{
 ...
 sb->sb_flagsintr |= 0x04;
 return (sosleep(so, &sb->sb_cc,
     (sb->sb_flags & 0x40) ? 24 : 24 | 0x100, "netio",
     sb->sb_timeo));
}
...
{
 int error, prio = (sb->sb_flags & 0x40) ? 24 : 24 | 0x100;

 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 345, "_kernel_lock_held()"));
 soassertlocked(so);

 if ((sb->sb_flags & 0x01) == 0) {
  sb->sb_flags |= 0x01;
  return (0);
 }
 if (wait & 0x0002)
...
{
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 368, "_kernel_lock_held()"));
...
sowakeup(struct socket *so, struct sockbuf *sb)
{
 ...
 selwakeup(&sb->sb_sel);
 sb->sb_flagsintr &= ~0x08;
 if (sb->sb_flagsintr & 0x04) {
  sb->sb_flagsintr &= ~0x04;
  wakeup(&sb->sb_cc);
 }
...
# 429 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c"
int
...
{
 ((sb == &so->so_rcv || sb == &so->so_snd) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 460, "sb == &so->so_rcv || sb == &so->so_snd"));
 soassertlocked(so);

 if (cc == 0 || cc > sb_max)
  return (1);
 sb->sb_hiwat = cc;
 sb->sb_mbmax = max(3 * (64 * 1024),
     min(cc * 2, sb_max + (sb_max / (1 << 11)) * 256));
...
# 595 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c"
void
...
{
 ((sb == &so->so_rcv || sb == &so->so_snd) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 636, "sb == &so->so_rcv || sb == &so->so_snd"));
 soassertlocked(so);
 ((void)0);
 ((sb->sb_mb == sb->sb_lastrecord) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 639, "sb->sb_mb == sb->sb_lastrecord"));
...
# 678 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c"
void
sbappendrecord(struct socket *so, struct sockbuf *sb, struct mbuf *m0)
{
 struct mbuf *m;

 ((sb == &so->so_rcv || sb == &so->so_snd) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 683, "sb == &so->so_rcv || sb == &so->so_snd"));
 soassertlocked(so);
 ...
 do { (sb)->sb_cc += (m0)->m_hdr.mh_len; if ((m0)->m_hdr.mh_type != 6 && (m0)->m_hdr.mh_type != 3) (sb)->sb_datacc += (m0)->m_hdr.mh_len; (sb)->sb_mbcnt += 256; if ((m0)->m_hdr.mh_flags & 0x0001) (sb)->sb_mbcnt += (m0)->M_dat.MH.MH_dat.MH_ext.ext_size; } while ( 0);
 ;
...
sbinsertoob(struct sockbuf *sb, struct mbuf *m0)
{
 ...
 for (mp = &sb->sb_mb; (m = *mp) != ((void *)0); mp = &((*mp)->m_hdr.mh_nextpkt)) {
     again:
    ...
    struct mbuf *m0, struct mbuf *control)
{
 ...
 __builtin_memcpy((((caddr_t)((m)->m_hdr.mh_data))), (asa), (asa->sa_len));
 if (n)
  n->m_hdr.mh_next = m0;
 else
  control = m0;
 ...
 for (n = m; n->m_hdr.mh_next != ((void *)0); n = n->m_hdr.mh_next)
  do { (sb)->sb_cc += (n)->m_hdr.mh_len; if ((n)->m_hdr.mh_type != 6 && (n)->m_hdr.mh_type != 3) (sb)->sb_datacc += (n)->m_hdr.mh_len; (sb)->sb_mbcnt += 256; if ((n)->m_hdr.mh_flags & 0x0001) (sb)->sb_mbcnt += (n)->M_dat.MH.MH_dat.MH_ext.ext_size; } while ( 0);
 do { (sb)->sb_cc += (n)->m_hdr.mh_len; if ((n)->m_hdr.mh_type != 6 && (n)->m_hdr.mh_type != 3) (sb)->sb_datacc += (n)->m_hdr.mh_len; (sb)->sb_mbcnt += 256; if ((n)->m_hdr.mh_flags & 0x0001) (sb)->sb_mbcnt += (n)->M_dat.MH.MH_dat.MH_ext.ext_size; } while ( 0);
 nlast = n;
    ...
    struct mbuf *control)
{
 ...
 for (m = control; m->m_hdr.mh_next != ((void *)0); m = m->m_hdr.mh_next)
  do { (sb)->sb_cc += (m)->m_hdr.mh_len; if ((m)->m_hdr.mh_type != 6 && (m)->m_hdr.mh_type != 3) (sb)->sb_datacc += (m)->m_hdr.mh_len; (sb)->sb_mbcnt += 256; if ((m)->m_hdr.mh_flags & 0x0001) (sb)->sb_mbcnt += (m)->M_dat.MH.MH_dat.MH_ext.ext_size; } while ( 0);
 do { (sb)->sb_cc += (m)->m_hdr.mh_len; if ((m)->m_hdr.mh_type != 6 && (m)->m_hdr.mh_type != 3) (sb)->sb_datacc += (m)->m_hdr.mh_len; (sb)->sb_mbcnt += 256; if ((m)->m_hdr.mh_flags & 0x0001) (sb)->sb_mbcnt += (m)->M_dat.MH.MH_dat.MH_ext.ext_size; } while ( 0);
 mlast = m;
...
sbcompress(struct sockbuf *sb, struct mbuf *m, struct mbuf *n)
{
 ...
 while (m) {
  ...
  if (n && (n->m_hdr.mh_flags & 0x0004) == 0 &&
   ...
   __builtin_memcpy((((caddr_t)((n)->m_hdr.mh_data)) + n->m_hdr.mh_len), (((caddr_t)((m)->m_hdr.mh_data))), (m->m_hdr.mh_len));

   n->m_hdr.mh_len += m->m_hdr.mh_len;
   sb->sb_cc += m->m_hdr.mh_len;
   if (m->m_hdr.mh_type != 6 && m->m_hdr.mh_type != 3)
    sb->sb_datacc += m->m_hdr.mh_len;
   m = m_free(m);
   continue;
  }
  if (n)
...
{
 ((sb == &so->so_rcv || sb == &so->so_snd) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 908, "sb == &so->so_rcv || sb == &so->so_snd"));
 (((sb->sb_flags & 0x01) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 909, "(sb->sb_flags & SB_LOCK) == 0"));

 while (sb->sb_mbcnt)
  sbdrop(so, sb, (int)sb->sb_cc);

 ((sb->sb_cc == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 914, "sb->sb_cc == 0"));
 ((sb->sb_datacc == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 915, "sb->sb_datacc == 0"));
 ((sb->sb_mb == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 916, "sb->sb_mb == NULL"));
 ((sb->sb_mbtail == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 917, "sb->sb_mbtail == NULL"));
 ((sb->sb_lastrecord == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 918, "sb->sb_lastrecord == NULL"));
}
...
sbdrop(struct socket *so, struct sockbuf *sb, int len)
{
 ...
 ((sb == &so->so_rcv || sb == &so->so_snd) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_socket2.c", 930, "sb == &so->so_rcv || sb == &so->so_snd"));
 soassertlocked(so);
...
sbcreatecontrol(caddr_t p, int size, int type, int level)
{
 ...
 if (((((unsigned long)(sizeof(struct cmsghdr)) + 0xf) & ~0xf) + (((unsigned long)(size) + 0xf) & ~0xf)) > (1 << 11)) {
  printf("sbcreatecontrol: message too large %d\n", size);
  return ((void *)0);
 }

 if ((m = m_get(0x0002, 6)) == ((void *)0))
  return (((void *)0));
 if (((((unsigned long)(sizeof(struct cmsghdr)) + 0xf) & ~0xf) + (((unsigned long)(size) + 0xf) & ~0xf)) > (256 - sizeof(struct m_hdr))) {
 ...
 __builtin_memset((cp), (0), (((((unsigned long)(sizeof(struct cmsghdr)) + 0xf) & ~0xf) + (((unsigned long)(size) + 0xf) & ~0xf))));
 __builtin_memcpy((((unsigned char *)(cp) + (((unsigned long)(sizeof(struct cmsghdr)) + 0xf) & ~0xf))), (p), (size));
 m->m_hdr.mh_len = ((((unsigned long)(sizeof(struct cmsghdr)) + 0xf) & ~0xf) + (((unsigned long)(size) + 0xf) & ~0xf));
 cp->cmsg_len = ((((unsigned long)(sizeof(struct cmsghdr)) + 0xf) & ~0xf) + (size));
 cp->cmsg_level = level;
 cp->cmsg_type = type;
 return (m);
}
