# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c" 2
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c"
...
static struct pt_softc **pt_softc = ((void *)0);
static int npty = 0;
static int maxptys = 992;

struct rwlock pt_softc_lock = { 0, "ptarrlk" };
...
ptydevname(int minor, struct pt_softc *pti)
{
 ...
 i = minor / (sizeof("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ") - 1);
 j = minor % (sizeof("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ") - 1);
 if (i >= sizeof("pqrstuvwxyzPQRST") - 1) {
  pti->pty_pn[0] = '\0';
  pti->pty_sn[0] = '\0';
  return;
 }
 buf[5] = 'p';
 buf[8] = "pqrstuvwxyzPQRST"[i];
 buf[9] = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"[j];
 __builtin_memcpy((pti->pty_pn), (buf), (sizeof(buf)));
 buf[5] = 't';
 __builtin_memcpy((pti->pty_sn), (buf), (sizeof(buf)));
}
...
ptyarralloc(int nelem)
{
 ...
 pt = mallocarray(nelem, sizeof(struct pt_softc *), 2,
     0x0001|0x0008);
 return pt;
}
...
check_pty(int minor)
{
 ...
 if (minor >= npty) {
  ...
  __builtin_memcpy((newpt), (pt_softc), (npty * sizeof(struct pt_softc *)));
  free(pt_softc, 2, npty * sizeof(struct pt_softc *));
  pt_softc = newpt;
  npty = newnpty;
 }
 ...
 if (!pt_softc[minor]) {
  pti = malloc(sizeof(struct pt_softc), 2,
      0x0001|0x0008);
  pti->pt_tty = ttymalloc(1000000);
  ptydevname(minor, pti);
  pt_softc[minor] = pti;
 }
 _rw_exit_write(&pt_softc_lock );
 return (0);
limit_reached:
 _rw_exit_write(&pt_softc_lock );
 tablefull("pty");
...
ptsopen(dev_t dev, int flag, int devtype, struct proc *p)
{
 ...
 if ((error = check_pty(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)))))
  return (error);

 pti = pt_softc[((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))];
 if (!pti->pt_tty) {
...
{
 struct pt_softc *pti = pt_softc[((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))];
...
{
 struct pt_softc *pti = pt_softc[((int32_t)((tp->t_dev) & 0xff) | (((tp->t_dev) & 0xffff0000) >> 8))];
...
ptcread(dev_t dev, struct uio *uio, int flag)
{
 ...
 for (;;) {
  if (tp->t_state & 0x00020) {
   if (pti->pt_flags & 0x08 && pti->pt_send) {
    error = ureadc((int)pti->pt_send, uio);
    if (error)
     return (error);
    if (pti->pt_send & 0x40) {
     cc = (((uio->uio_resid)<(sizeof(tp->t_termios)))?(uio->uio_resid):(sizeof(tp->t_termios)));
   ...
   if (pti->pt_flags & 0x80 && pti->pt_ucntl) {
   ...
   if (tp->t_outq.c_cc && (tp->t_state & 0x00100) == 0)
    break;
  }
  if ((tp->t_state & 0x00008) == 0)
   return (0);
  if (flag & 0x10)
   return (35);
  error = tsleep(&tp->t_outq.c_cf, 25 | 0x100,
      ttyin, 0);
  if (error)
   return (error);
 }
 if (pti->pt_flags & (0x08|0x80))
  error = ureadc(0, uio);
 while (uio->uio_resid > 0 && error == 0) {
  cc = (((uio->uio_resid)<(100))?(uio->uio_resid):(100));
...
again:
 ...
 if (pti->pt_flags & 0x20) {
  if (tp->t_canq.c_cc)
   goto block;
  while (uio->uio_resid > 0 && tp->t_canq.c_cc < (tp)->t_qlen - 1) {
   if (cc == 0) {
    cc = (((uio->uio_resid)<(100))?(uio->uio_resid):(100));
    cc = min(cc, (tp)->t_qlen - 1 - tp->t_canq.c_cc);
    if (cc > bufcc)
     bufcc = cc;
    cp = buf;
 ...
 do {
  ...
  bufcc = cc;
  while (cc > 0) {
   if ((tp->t_rawq.c_cc + tp->t_canq.c_cc) >= (tp)->t_qlen - 2 &&
      (tp->t_canq.c_cc > 0 || !((tp->t_termios.c_lflag) & (0x00000100)))) {
    wakeup(&tp->t_rawq);
    goto block;
   }
...
block:
 ...
 error = tsleep(&tp->t_rawq.c_cf, 26 | 0x100,
     ttyout, 0);
 if (error == 0)
  goto again;
...
ptcpoll(dev_t dev, int events, struct proc *p)
{
 ...
 if (!((tp->t_state) & (0x00020)) && ((tp->t_state) & (0x00008)))
  goto notopen;
 ...
 if (events & (0x0001 | 0x0040)) {
  ...
  s = _splraise(6);
  if ((tp->t_outq.c_cc && !((tp->t_state) & (0x00100))) ||
      ((pti->pt_flags & 0x08) && pti->pt_send) ||
      ((pti->pt_flags & 0x80) && pti->pt_ucntl))
 ...
 if (!((tp->t_state) & (0x00008))) {
  ...
  if ((pti->pt_flags & 0x20) ?
      (tp->t_canq.c_cc == 0) :
      ((tp->t_rawq.c_cc + tp->t_canq.c_cc < (tp)->t_qlen - 2) ||
      (tp->t_canq.c_cc == 0 && ((tp->t_termios.c_lflag) & (0x00000100)))))
...
filt_ptcrdetach(struct knote *kn)
{
 ...
 s = _splraise(6);
 do { if ((&pti->pt_selr.si_note)->slh_first == (kn)) { do { ((&pti->pt_selr.si_note))->slh_first = ((&pti->pt_selr.si_note))->slh_first->kn_selnext.sle_next; } while (0); } else { struct knote *curelm = (&pti->pt_selr.si_note)->slh_first; while (curelm->kn_selnext.sle_next != (kn)) curelm = curelm->kn_selnext.sle_next; curelm->kn_selnext.sle_next = curelm->kn_selnext.sle_next->kn_selnext.sle_next; } ((kn)->kn_selnext.sle_next) = ((void *)-1); } while (0);
 _splx(s);
}
...
filt_ptcread(struct knote *kn, long hint)
{
 ...
 if (((tp->t_state) & (0x00020))) {
  if (!((tp->t_state) & (0x00100)))
   kn->kn_kevent.data = tp->t_outq.c_cc;
  if (((pti->pt_flags & 0x08) && pti->pt_send) ||
      ((pti->pt_flags & 0x80) && pti->pt_ucntl))
   kn->kn_kevent.data++;
 }
...
filt_ptcwdetach(struct knote *kn)
{
 ...
 s = _splraise(6);
 do { if ((&pti->pt_selw.si_note)->slh_first == (kn)) { do { ((&pti->pt_selw.si_note))->slh_first = ((&pti->pt_selw.si_note))->slh_first->kn_selnext.sle_next; } while (0); } else { struct knote *curelm = (&pti->pt_selw.si_note)->slh_first; while (curelm->kn_selnext.sle_next != (kn)) curelm = curelm->kn_selnext.sle_next; curelm->kn_selnext.sle_next = curelm->kn_selnext.sle_next->kn_selnext.sle_next; } ((kn)->kn_selnext.sle_next) = ((void *)-1); } while (0);
 _splx(s);
}
...
filt_ptcwrite(struct knote *kn, long hint)
{
 ...
 if (((tp->t_state) & (0x00020))) {
  if (((pti->pt_flags) & (0x20))) {
   if (tp->t_canq.c_cc == 0)
    kn->kn_kevent.data = tp->t_canq.c_cn;
  } else if (tp->t_rawq.c_cc + tp->t_canq.c_cc < (tp)->t_qlen-2)
   kn->kn_kevent.data = tp->t_canq.c_cn -
...
struct filterops ptcread_filtops =
 { 1, ((void *)0), filt_ptcrdetach, filt_ptcread };
struct filterops ptcwrite_filtops =
 { 1, ((void *)0), filt_ptcwdetach, filt_ptcwrite };
...
ptyioctl(dev_t dev, u_long cmd, caddr_t data, int flag, struct proc *p)
{
 ...
 if (cmd == ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((96)))) {
  ...
  return(0);
 } else if (cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_open == ptcopen)
  switch (cmd) {
  ...
  case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((112))):
   if (*(int *)data) {
  ...
  case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((105))):
   if (*(int *)data)
    pti->pt_flags |= 0x20;
   else
    pti->pt_flags &= ~0x20;
  ...
  case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((95))):
   if (*(unsigned int *)data >= 33 ||
       *(unsigned int *)data == 0)
    return(22);
   if ((tp->t_termios.c_lflag & 0x80000000) == 0)
    ttyflush(tp, 0x0001|0x0002);
   pgsignal(tp->t_pgrp, *(unsigned int *)data, 1);
   if ((*(unsigned int *)data == 29) &&
       ((tp->t_termios.c_lflag & 0x02000000) == 0))
    ttyinfo(tp);
   return (0);
 ...
 if ((tp->t_termios.c_lflag & 0x00000800) && (pti->pt_flags & 0x08)) {
  switch (cmd) {
  case ((unsigned long)0x80000000 | ((sizeof(struct termios) & 0x1fff) << 16) | ((('t')) << 8) | ((20))):
  case ((unsigned long)0x80000000 | ((sizeof(struct termios) & 0x1fff) << 16) | ((('t')) << 8) | ((21))):
  case ((unsigned long)0x80000000 | ((sizeof(struct termios) & 0x1fff) << 16) | ((('t')) << 8) | ((22))):
 ...
 stop = (tp->t_termios.c_iflag & 0x00000200) && (('s'&037) == cc[13] ? cc[13] != (0377) : 0) &&
     (('q'&037) == cc[12] ? cc[12] != (0377) : 0);
...
pty_isfree_locked(int minor)
{
 ...
 return (pt == ((void *)0) || pt->pt_tty == ((void *)0) ||
     pt->pt_tty->t_oproc == ((void *)0));
}
...
pty_isfree(int minor)
{
 ...
 _rw_enter_read(&pt_softc_lock );
 isfree = pty_isfree_locked(minor);
 _rw_exit_read(&pt_softc_lock );
 return(isfree);
}
...
pty_getfree(void)
{
 ...
 _rw_exit_read(&pt_softc_lock );
 return (((dev_t)((((pts_major) & 0xff) << 8) | ((i) & 0xff) | (((i) & 0xffff00) << 8))));
}
...
ptm_vn_open(struct nameidata *ndp)
{
 ...
 cred = crget();
 error = VOP_OPEN(vp, 0x0001|0x0002, cred, p);
 if (!error) {
...
ptmioctl(dev_t dev, u_long cmd, caddr_t data, int flag, struct proc *p)
{
 ...
 struct file *cfp = ((void *)0), *sfp = ((void *)0);
 int cindx, sindx;
 uid_t uid;
 gid_t gid;
 struct vattr vattr;
...
retry:
  ...
  newdev = pty_getfree();
  if ((error = check_pty(((int32_t)((newdev) & 0xff) | (((newdev) & 0xffff0000) >> 8)))))
   goto bad;
  pti = pt_softc[((int32_t)((newdev) & 0xff) | (((newdev) & 0xffff0000) >> 8))];
  ndinitat(&cnd, 0, 0x0000|0x0004, UIO_SYSSPACE, -100, pti->pty_pn, p);

  cnd.ni_pledge = 0x0000000000000001ULL | 0x0000000000000002ULL;
  if ((error = ptm_vn_open(&cnd)) != 0) {




   if (error == 5 && !pty_isfree(((int32_t)((newdev) & 0xff) | (((newdev) & 0xffff0000) >> 8))))
    goto retry;
   goto bad;
  }
  cfp->f_flag = 0x0001|0x0002;
  cfp->f_type = 1;
  cfp->f_ops = &vnops;
  cfp->f_data = (caddr_t) cnd.ni_vp;
  VOP_UNLOCK(cnd.ni_vp, p);
# 1102 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/tty_pty.c"
  ...
  if ((error = namei(&snd)) != 0)
   goto bad;
  if ((snd.ni_vp->v_mount->mnt_flag & 0x00000001) == 0) {
   gid = tty_gid;
   ...
   vattr.va_uid = uid;
   vattr.va_gid = gid;
   vattr.va_mode = (0000400|0000200|0000020) & (0004000|0002000|0001000|0000700|0000070|0000007);
  ...
  __builtin_memcpy((ptm->sn), (pti->pty_sn), (sizeof(pti->pty_sn)));


  do { (cfp)->f_iflags &= ~0x02; (--(cfp)->f_count == 0 ? fdrop(cfp, p) : 0); } while (0);
  do { (sfp)->f_iflags &= ~0x02; (--(sfp)->f_count == 0 ? fdrop(sfp, p) : 0); } while (0);
