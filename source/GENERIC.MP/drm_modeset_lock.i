# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c"
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c"
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c" 2
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c"
void drm_modeset_lock_all(struct drm_device *dev)
{
 ...
 ctx = kzalloc(sizeof(*ctx), (0x0001 | 0x0004));
 if (({ int __ret = !!(!ctx); if (__ret) printf("WARNING %s failed at %s:%d\n", "!ctx", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 73); __builtin_expect(!!(__ret), 0); }))
  return;

 _rw_enter_write(&config->mutex );
...
retry:
 ...
 ({ int __ret = !!(config->acquire_ctx); if (__ret) printf("WARNING %s failed at %s:%d\n", "config->acquire_ctx", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 88); __builtin_expect(!!(__ret), 0); });
...
void drm_modeset_unlock_all(struct drm_device *dev)
{
 ...
 if (({ int __ret = !!(!ctx); if (__ret) printf("WARNING %s failed at %s:%d\n", "!ctx", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 120); __builtin_expect(!!(__ret), 0); }))
  return;
...
;
# 146 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c"
void drm_modeset_lock_crtc(struct drm_crtc *crtc,
      struct drm_plane *plane)
{
 struct drm_modeset_acquire_ctx *ctx;
 ...
 ctx = kzalloc(sizeof(*ctx), (0x0001 | 0x0004));
 if (({ int __ret = !!(!ctx); if (__ret) printf("WARNING %s failed at %s:%d\n", "!ctx", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 153); __builtin_expect(!!(__ret), 0); }))
  return;
...
retry:
 ...
 ({ int __ret = !!(crtc->acquire_ctx); if (__ret) printf("WARNING %s failed at %s:%d\n", "crtc->acquire_ctx", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 175); __builtin_expect(!!(__ret), 0); });
...
;
# 201 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c"
struct drm_modeset_acquire_ctx *
drm_modeset_legacy_acquire_ctx(struct drm_crtc *crtc)
{
 if (crtc->acquire_ctx)
 ...
 ({ int __ret = !!(!crtc->dev->mode_config.acquire_ctx); if (__ret) printf("WARNING %s failed at %s:%d\n", "!crtc->dev->mode_config.acquire_ctx", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 207); __builtin_expect(!!(__ret), 0); });

 return crtc->dev->mode_config.acquire_ctx;
}
;
# 220 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c"
void drm_modeset_unlock_crtc(struct drm_crtc *crtc)
{
 struct drm_modeset_acquire_ctx *ctx = crtc->acquire_ctx;

 if (({ int __ret = !!(!ctx); if (__ret) printf("WARNING %s failed at %s:%d\n", "!ctx", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 224); __builtin_expect(!!(__ret), 0); }))
  return;

 crtc->acquire_ctx = ((void *)0);
 drm_modeset_drop_locks(ctx);
 drm_modeset_acquire_fini(ctx);
...
void drm_warn_on_modeset_not_all_locked(struct drm_device *dev)
{
 ...
 for (crtc = ({ __typeof( ((__typeof(*crtc) *)0)->head ) *__mptr = ((&(dev)->mode_config.crtc_list)->next); (__typeof(*crtc) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtc), head) );}); &crtc->head != (&(dev)->mode_config.crtc_list); crtc = ({ __typeof( ((__typeof(*crtc) *)0)->head ) *__mptr = (crtc->head.next); (__typeof(*crtc) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtc), head) );}))
  ({ int __ret = !!(!drm_modeset_is_locked(&crtc->mutex)); if (__ret) printf("WARNING %s failed at %s:%d\n", "!drm_modeset_is_locked(&crtc->mutex)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 250); __builtin_expect(!!(__ret), 0); });

 ({ int __ret = !!(!drm_modeset_is_locked(&dev->mode_config.connection_mutex)); if (__ret) printf("WARNING %s failed at %s:%d\n", "!drm_modeset_is_locked(&dev->mode_config.connection_mutex)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 252); __builtin_expect(!!(__ret), 0); });
 ({ int __ret = !!(!(rw_status(&dev->mode_config.mutex) == 0x0001UL)); if (__ret) printf("WARNING %s failed at %s:%d\n", "!(rw_status(&dev->mode_config.mutex) == 0x0001UL)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 253); __builtin_expect(!!(__ret), 0); });
}
;
...
void drm_modeset_drop_locks(struct drm_modeset_acquire_ctx *ctx)
{
 ({ int __ret = !!(ctx->contended); if (__ret) printf("WARNING %s failed at %s:%d\n", "ctx->contended", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 289); __builtin_expect(!!(__ret), 0); });
 while (!list_empty(&ctx->locked)) {
  struct drm_modeset_lock *lock;

  lock = ({ __typeof( ((struct drm_modeset_lock *)0)->head ) *__mptr = ((&ctx->locked)->next); (struct drm_modeset_lock *)( (char *)__mptr - __builtin_offsetof(struct drm_modeset_lock, head) );});
...
static inline int modeset_lock(struct drm_modeset_lock *lock,
  struct drm_modeset_acquire_ctx *ctx,
  _Bool interruptible, _Bool slow)
{
 int ret;

 ({ int __ret = !!(ctx->contended); if (__ret) printf("WARNING %s failed at %s:%d\n", "ctx->contended", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 307); __builtin_expect(!!(__ret), 0); });

 if (ctx->trylock_only) {
  do { (void)(&ctx->ww_ctx); } while(0);
 ...
 if (!ret) {
  ({ int __ret = !!(!list_empty(&lock->head)); if (__ret) printf("WARNING %s failed at %s:%d\n", "!list_empty(&lock->head)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 327); __builtin_expect(!!(__ret), 0); });
  ...
  _Bool interruptible)
{
 ...
 if (({ int __ret = !!(!contended); if (__ret) printf("WARNING %s failed at %s:%d\n", "!contended", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c", 350); __builtin_expect(!!(__ret), 0); }))
  return 0;

 drm_modeset_drop_locks(ctx);

 return modeset_lock(contended, ctx, interruptible, 1);
}
# 366 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c"
void drm_modeset_backoff(struct drm_modeset_acquire_ctx *ctx)
{
 modeset_backoff(ctx, 0);
}
;
...
int drm_modeset_backoff_interruptible(struct drm_modeset_acquire_ctx *ctx)
{
 return modeset_backoff(ctx, 1);
}
;
# 395 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c"
int drm_modeset_lock(struct drm_modeset_lock *lock,
  struct drm_modeset_acquire_ctx *ctx)
{
 if (ctx)
  return modeset_lock(lock, ctx, 0, 0);

 ww_mutex_lock(&lock->mutex, ((void *)0));
 return 0;
}
;
# 413 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modeset_lock.c"
int drm_modeset_lock_interruptible(struct drm_modeset_lock *lock,
  struct drm_modeset_acquire_ctx *ctx)
{
 if (ctx)
  return modeset_lock(lock, ctx, 1, 0);
