         ...
         _Bool return_data)
{
 ...
 for (i = 0; i < dword_len; i++)
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x15800 + ((i) << 2)), (__uint32_t)(__builtin_constant_p(buffer[i]) ? (__uint32_t)(((__uint32_t)(buffer[i]) & 0xff) << 24 | ((__uint32_t)(buffer[i]) & 0xff00) << 8 | ((__uint32_t)(buffer[i]) & 0xff0000) >> 8 | ((__uint32_t)(buffer[i]) & 0xff000000) >> 24) : __swap32md(buffer[i])));
