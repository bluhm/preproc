# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c" 2
...
void drm_rect_rotate_inv(struct drm_rect *r,
    int width, int height,
    unsigned int rotation);
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c" 2
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
_Bool drm_rect_intersect(struct drm_rect *r1, const struct drm_rect *r2)
{
...
;
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
_Bool drm_rect_clip_scaled(struct drm_rect *src, struct drm_rect *dst,
     const struct drm_rect *clip,
     int hscale, int vscale)
{
 ...
 if (diff > 0) {
  ...
  src->x1 = ({ int64_t __min_a = (({ int64_t __max_a = (tmp); int64_t __max_b = ((-0x7fffffff-1)); __max_a > __max_b ? __max_a : __max_b; })); int64_t __min_b = (0x7fffffff); __min_a < __min_b ? __min_a : __min_b; });
 }
 diff = clip->y1 - dst->y1;
 if (diff > 0) {
  int64_t tmp = src->y1 + (int64_t) diff * vscale;
  src->y1 = ({ int64_t __min_a = (({ int64_t __max_a = (tmp); int64_t __max_b = ((-0x7fffffff-1)); __max_a > __max_b ? __max_a : __max_b; })); int64_t __min_b = (0x7fffffff); __min_a < __min_b ? __min_a : __min_b; });
 }
 diff = dst->x2 - clip->x2;
 if (diff > 0) {
  int64_t tmp = src->x2 - (int64_t) diff * hscale;
  src->x2 = ({ int64_t __min_a = (({ int64_t __max_a = (tmp); int64_t __max_b = ((-0x7fffffff-1)); __max_a > __max_b ? __max_a : __max_b; })); int64_t __min_b = (0x7fffffff); __min_a < __min_b ? __min_a : __min_b; });
 }
 diff = dst->y2 - clip->y2;
 if (diff > 0) {
  int64_t tmp = src->y2 - (int64_t) diff * vscale;
  src->y2 = ({ int64_t __min_a = (({ int64_t __max_a = (tmp); int64_t __max_b = ((-0x7fffffff-1)); __max_a > __max_b ? __max_a : __max_b; })); int64_t __min_b = (0x7fffffff); __min_a < __min_b ? __min_a : __min_b; });
 }
...
# 129 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
int drm_rect_calc_hscale(const struct drm_rect *src,
    const struct drm_rect *dst,
    int min_hscale, int max_hscale)
{
...
;
# 160 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
int drm_rect_calc_vscale(const struct drm_rect *src,
    const struct drm_rect *dst,
    int min_vscale, int max_vscale)
{
...
;
# 197 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
int drm_rect_calc_hscale_relaxed(struct drm_rect *src,
     struct drm_rect *dst,
     int min_hscale, int max_hscale)
{
...
;
# 247 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
int drm_rect_calc_vscale_relaxed(struct drm_rect *src,
     struct drm_rect *dst,
     int min_vscale, int max_vscale)
{
...
void drm_rect_debug_print(const struct drm_rect *r, _Bool fixed_point)
{
# 298 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
}
;
# 317 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
void drm_rect_rotate(struct drm_rect *r,
       int width, int height,
       unsigned int rotation)
{
...
;
# 391 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_rect.c"
void drm_rect_rotate_inv(struct drm_rect *r,
    int width, int height,
    unsigned int rotation)
{
