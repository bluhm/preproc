# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunmsvar.h" 1
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunmsvar.h"
struct sunms_softc {
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c" 2
...
sunms_attach(struct sunms_softc *sc, const struct wsmouse_accessops *ao)
{
 ...
 a.accessops = ao;
 a.accesscookie = sc;
 sc->sc_wsmousedev = config_found_sm((&sc->sc_dev), (&a), (wsmousedevprint), ((void *)0));
}
...
sunms_input(struct sunms_softc *sc, int c)
{
 ...
 if (sc->sc_state == 1) {
  microtime(&curtime);
  do { (&curtime)->tv_sec = (&curtime)->tv_sec - (&sc->sc_lastbpschange)->tv_sec; (&curtime)->tv_usec = (&curtime)->tv_usec - (&sc->sc_lastbpschange)->tv_usec; if ((&curtime)->tv_usec < 0) { (&curtime)->tv_sec--; (&curtime)->tv_usec += 1000000; } } while (0);
  if (curtime.tv_sec != 0 ||
...
# 165 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c"
 if (sc->sc_byteno < 0) {
  if (((c) & (0x80)) && !((c) & (0x30)))
   sc->sc_byteno = 0;
  else
 ...
 case 0:
  ...
  if (!((c) & (1 << 0)))
   sc->sc_mb |= 1 << 2;
  sc->sc_byteno++;
# 200 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sun/sunms.c"
 ...
 if (sc->sc_byteno == sc->sc_pktlen) {
  timeout_del(&sc->sc_abort_tmo);
  sc->sc_byteno = -1;
  do { wsmouse_buttons((sc->sc_wsmousedev), (sc->sc_mb)); wsmouse_motion((sc->sc_wsmousedev), (sc->sc_dx), (sc->sc_dy), (0), (0)); wsmouse_input_sync(sc->sc_wsmousedev); } while (0);
