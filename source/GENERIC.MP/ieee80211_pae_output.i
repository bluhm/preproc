# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c"
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_output.c" 2
    ...
    struct ieee80211_node *ni, const struct ieee80211_ptk *ptk)
{
 ...
 __builtin_memcpy((eh->ether_shost), (ic->ic_myaddr), (6));
 __builtin_memcpy((eh->ether_dhost), (ni->ni_macaddr), (6));

 key = (struct ieee80211_eapol_key *)&eh[1];
 key->version = 1;
 key->type = 3;
 key->desc = (ni->ni_rsnprotos == (1 << 0)) ?
     2 : 254;
 ...
 if (ieee80211_is_sha256_akm(ni->ni_rsnakms))
  ...
  info |= 1;
 do { ((u_int8_t *)(key->info))[0] = (info) >> 8; ((u_int8_t *)(key->info))[1] = (info) & 0xff; } while (0);

 len = m->m_hdr.mh_len - sizeof(struct ether_header);
 do { ((u_int8_t *)(key->paylen))[0] = (len - sizeof(*key)) >> 8; ((u_int8_t *)(key->paylen))[1] = (len - sizeof(*key)) & 0xff; } while (0);
 do { ((u_int8_t *)(key->len))[0] = (len - 4) >> 8; ((u_int8_t *)(key->len))[1] = (len - 4) & 0xff; } while (0);
 ...
 if (info & (1 << 12)) {
  ...
  if ((info & 0x7) != 1) {
   ...
   m->M_dat.MH.MH_pkthdr.len = m->m_hdr.mh_len =
       sizeof(*eh) + 4 + ((u_int16_t) ((((const u_int8_t *)(key->len))[0] << 8) | (((const u_int8_t *)(key->len))[1])));
  }
 }
 ...
 *frm = k->k_id & 3;
 ...
 frm++;
 *frm++ = 0;
 __builtin_memcpy((frm), (k->k_key), (k->k_len));
 return frm + k->k_len;
}
 ...
 *frm++ = IEEE80211_KDE_IGTK;
 do { ((u_int8_t *)(frm))[0] = (k->k_id) & 0xff; ((u_int8_t *)(frm))[1] = (k->k_id) >> 8; } while (0); frm += 2;
 do { (frm)[5] = (k->k_tsc) >> 40; (frm)[4] = (k->k_tsc) >> 32; (frm)[3] = (k->k_tsc) >> 24; (frm)[2] = (k->k_tsc) >> 16; (frm)[1] = (k->k_tsc) >> 8; (frm)[0] = (k->k_tsc); } while (0); frm += 6;
 __builtin_memcpy((frm), (k->k_key), (16));
 return frm + 16;
}
...
ieee80211_get_eapol_key(int flags, int type, u_int pktlen)
{
 ...
 pktlen += sizeof(struct ieee80211_frame) + 8 +
 ...
 m->m_hdr.mh_data += sizeof(struct ieee80211_frame) + 8;
 return m;
}
...
ieee80211_send_4way_msg1(struct ieee80211com *ic, struct ieee80211_node *ni)
{
 ...
 if (++ni->ni_rsn_retries > 3) {
  ((*(ic)->ic_send_mgmt)(ic, ni, 0xc0, IEEE80211_REASON_4WAY_TIMEOUT, 0));

  ieee80211_node_leave(ic, ni);
  return 0;
 }
 m = ieee80211_get_eapol_key(0x0002, 1,
     (ni->ni_rsnprotos == (1 << 0)) ? 2 + 20 : 0);
 if (m == ((void *)0))
  return 12;
 ...
 __builtin_memcpy((key->nonce), (ni->ni_nonce), (32));

 keylen = ieee80211_cipher_keylen(ni->ni_rsncipher);
 do { ((u_int8_t *)(key->keylen))[0] = (keylen) >> 8; ((u_int8_t *)(key->keylen))[1] = (keylen) & 0xff; } while (0);
 ...
 m->M_dat.MH.MH_pkthdr.len = m->m_hdr.mh_len = frm - (u_int8_t *)key;
 ...
 ni->ni_replaycnt++;
 do { (key->replaycnt)[0] = (ni->ni_replaycnt) >> 56; (key->replaycnt)[1] = (ni->ni_replaycnt) >> 48; (key->replaycnt)[2] = (ni->ni_replaycnt) >> 40; (key->replaycnt)[3] = (ni->ni_replaycnt) >> 32; (key->replaycnt)[4] = (ni->ni_replaycnt) >> 24; (key->replaycnt)[5] = (ni->ni_replaycnt) >> 16; (key->replaycnt)[6] = (ni->ni_replaycnt) >> 8; (key->replaycnt)[7] = (ni->ni_replaycnt); } while (0);

 return ieee80211_send_eapol_key(ic, m, ni, ((void *)0));
}
    ...
    const u_int8_t *replaycnt, const struct ieee80211_ptk *tptk)
{
 ...
 __builtin_memcpy((key->replaycnt), (replaycnt), (8));


 __builtin_memcpy((key->nonce), (ic->ic_nonce), (32));
...
ieee80211_send_4way_msg3(struct ieee80211com *ic, struct ieee80211_node *ni)
{
 ...
 if (ni->ni_rsnprotos == (1 << 0)) {
  ...
  m = ieee80211_get_eapol_key(0x0002, 1,
      2 + (2 + 4 + 2 + 4 * 2 + 2 + 4 * 4 + 2 + 2 + 16 * 1 + 4) + 2 + 6 + k->k_len + 15 +
      ((ni->ni_flags & 0x0080) ? 2 + 28 : 0));
 } else {
  m = ieee80211_get_eapol_key(0x0002, 1,
      2 + (4 + 2 + 4 + 2 + 4 * 2 + 2 + 4 * 2) +
      ((ni->ni_flags & 0x0080) ? 2 + 28 : 0));
 ...
 if (ni->ni_rsnprotos == (1 << 0)) {
  ...
  do { (key->rsc)[5] = (k->k_tsc) >> 40; (key->rsc)[4] = (k->k_tsc) >> 32; (key->rsc)[3] = (k->k_tsc) >> 24; (key->rsc)[2] = (k->k_tsc) >> 16; (key->rsc)[1] = (k->k_tsc) >> 8; (key->rsc)[0] = (k->k_tsc); } while (0);
...
ieee80211_send_4way_msg4(struct ieee80211com *ic, struct ieee80211_node *ni)
{
 ...
 m = ieee80211_get_eapol_key(0x0002, 1, 0);
 if (m == ((void *)0))
  return 12;
 key = ((struct ieee80211_eapol_key *)((m)->m_hdr.mh_data));
 __builtin_memset((key), (0), (sizeof(*key)));
 ...
 m->M_dat.MH.MH_pkthdr.len = m->m_hdr.mh_len = sizeof(*key);
...
ieee80211_send_group_msg1(struct ieee80211com *ic, struct ieee80211_node *ni)
{
 ...
 if (++ni->ni_rsn_retries > 3) {
  ((*(ic)->ic_send_mgmt)(ic, ni, 0xc0, IEEE80211_REASON_GROUP_TIMEOUT, 0));
 ...
 if (ni->ni_rsnprotos == (1 << 1)) {
  ...
  do { ((u_int8_t *)(key->keylen))[0] = (k->k_len) >> 8; ((u_int8_t *)(key->keylen))[1] = (k->k_len) & 0xff; } while (0);
  __builtin_memcpy((frm), (k->k_key), (k->k_len));
  frm += k->k_len;
  info |= (k->k_id & 0x3) << 4;
  if (ni->ni_rsncipher == IEEE80211_CIPHER_USEGROUP)
    ...
    struct ieee80211_node *ni, u_int16_t info, u_int64_t tsc)
{
 ...
 if (info & (1 << 10))
  do { (key->rsc)[5] = (tsc) >> 40; (key->rsc)[4] = (tsc) >> 32; (key->rsc)[3] = (tsc) >> 24; (key->rsc)[2] = (tsc) >> 16; (key->rsc)[1] = (tsc) >> 8; (key->rsc)[0] = (tsc); } while (0);


 do { (key->replaycnt)[0] = (ni->ni_reqreplaycnt) >> 56; (key->replaycnt)[1] = (ni->ni_reqreplaycnt) >> 48; (key->replaycnt)[2] = (ni->ni_reqreplaycnt) >> 40; (key->replaycnt)[3] = (ni->ni_reqreplaycnt) >> 32; (key->replaycnt)[4] = (ni->ni_reqreplaycnt) >> 24; (key->replaycnt)[5] = (ni->ni_reqreplaycnt) >> 16; (key->replaycnt)[6] = (ni->ni_reqreplaycnt) >> 8; (key->replaycnt)[7] = (ni->ni_reqreplaycnt); } while (0);
 ni->ni_reqreplaycnt++;
