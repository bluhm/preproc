...
static uint32_t radeon_invalid_rreg(struct radeon_device *rdev, uint32_t reg64)
{
 ...
 ((!(1)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_asic.c", 53, "!(1)"));
 return 0;
}
static void radeon_invalid_wreg(struct radeon_device *rdev, uint32_t reg64, uint32_t v)
{
 ...
 ((!(1)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_asic.c", 71, "!(1)"));
}
...
static struct radeon_asic evergreen_asic = {
 ...
 .ring = {
  [0] = &evergreen_gfx_ring,
  [3] = &evergreen_dma_ring,
  [5] = &rv770_uvd_ring,
 },
 .irq = {
