# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c"
...
struct tty;
struct uio;
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
void device_register(struct device *, void *);
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854reg.h" 1
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/ncr53c9xreg.h" 1
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c"
int
lsi64854_attach(sc)
 struct lsi64854_softc *sc;
{
 ...
 if ((rc = bus_dmamap_create(sc->sc_dmatag, (16*1024*1024), 1, (16*1024*1024),
         0, 0x0000, &sc->sc_dmamap)) != 0) {
...
# 209 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c"
void
lsi64854_reset(sc)
 struct lsi64854_softc *sc;
{
 ...
 do { u_int32_t csr; do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 215, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (1) printf("R_PEND"); else panic("R_PEND"); } } while (0); csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)); csr &= ~(0x00000100|0x00000200); csr |= 0x00000020; bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr); } while(0);
 csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0));
 ...
 if (sc->sc_rev == 0xb0000000)
  bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr | 0x08000000);
 ...
 csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0));
 csr |= 0x00000010;
 if (sc->sc_rev > 0x80000000 && sc->sc_channel == 1) {
  if (sc->sc_rev == 0xb0000000)
   csr |= 0x00200000;
  else
   csr |= 0x00400000;
 ...
 if (sc->sc_rev == 0xb0000000) {
  bus_space_write_4(sc->sc_bustag, sc->sc_regs, 4, 0);
  sc->sc_dmactl = csr;
 }
 sc->sc_active = 0;
 ...
 size_t *dmasize;
{
 ...
 do { u_int32_t csr; do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 298, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("R_PEND"); else panic("R_PEND"); } } while (0); csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)); csr &= ~(0x00000100|0x00000200); csr |= 0x00000020; bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr); } while(0);
 ...
 *dmasize = sc->sc_dmasize =
  min(*dmasize, ((16*1024*1024) - (((size_t) *sc->sc_dmaaddr) & ((16*1024*1024)-1))));
 ...
 if (sc->sc_rev == 0xb0000000) {
  ...
  bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, sc->sc_dmactl | 0x00000080);
  bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, sc->sc_dmactl);

  bus_space_write_4(sc->sc_bustag, sc->sc_regs, 8, *dmasize);
 }
 ...
 if (sc->sc_dmasize) {
  ...
  bus_dmamap_sync(sc->sc_dmatag, sc->sc_dmamap, 0, sc->sc_dmasize,
    datain
     ? 0x01
     : 0x04);
  bus_space_write_4(sc->sc_bustag, sc->sc_regs, 4,
      sc->sc_dmamap->dm_segs[0].ds_addr);
 }

 if (sc->sc_rev == 0x40000000) {

  long bcnt = sc->sc_dmasize;
  long eaddr = bcnt + (long)*sc->sc_dmaaddr;
  if ((eaddr & ((1 << 13) - 1)) != 0)
   bcnt = ((((bcnt)+(((1 << 13))-1))/((1 << 13)))*((1 << 13)));
  bus_space_write_4(sc->sc_bustag, sc->sc_regs, 8,
      bcnt);
 }
...
# 379 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c"
int
 ...
 void *arg;
{
 ...
 if (csr & (0x00000002|0x00000040)) {
  snprintf(bits, sizeof(bits), "%b", csr, "\020" "\01INT\02ERR\03DR1\04DR2\05IEN" "\07SLVERR\010RST\011WRITE\012ENDMA" "\016ENCNT\017TC\021DSBL_CSR_DRN" "\022DSBL_SCSI_DRN\026TWOCYCLE" "\027FASTER\030TCIDIS\031ENNXT\032DMAON" "\033ALOADED\034NALOADED");
  printf("%s: error: csr=%s\n", sc->sc_dev.dv_xname, bits);
  csr &= ~0x00000200;

  csr |= 0x00000020|0x00000040;
  bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr);
  return (-1);
 }
 ...
 do { u_int32_t csr; do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 409, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("R_PEND"); else panic("R_PEND"); } } while (0); if (sc->sc_rev != 0xb0000000) { csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)); if (sc->sc_rev == 0x80000000 || sc->sc_rev == 0x00000000) csr |= 0x00000040; else csr |= 0x00000020; bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr); } do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x0000000c) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x0000000c) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 409, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("DRAINING"); else panic("DRAINING"); } } while (0);} while(0);
 ...
 if (!(csr & 0x00000100) &&
     (resid = ((*(nsc)->sc_glue->gl_read_reg)((nsc), (0x07)) & 0x1f)) != 0) {
  ;
  if (nsc->sc_rev == 9 &&
      ((*(nsc)->sc_glue->gl_read_reg)((nsc), (0x0c)) & 0x40))
   resid <<= 1;
 }

 if ((nsc->sc_espstat & 0x10) == 0) {




  resid += ((*(nsc)->sc_glue->gl_read_reg)((nsc), (0x00)) |
     ((*(nsc)->sc_glue->gl_read_reg)((nsc), (0x01)) << 8) |
      ((nsc->sc_cfg2 & 0x40)
    ? ((*(nsc)->sc_glue->gl_read_reg)((nsc), (0x0e)) << 16)
    : 0));
 ...
 if (trans < 0) {
# 469 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c"
  trans = sc->sc_dmasize;
 }
 ...
 *sc->sc_dmalen -= trans;
 *sc->sc_dmaaddr += trans;
# 499 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c"
 return 0;
}
 ...
 void *arg;
{
 ...
 rv = ((csr & 0x00000001) != 0) ? 1 : 0;

 if (csr & (0x00000002|0x00000040)) {
  snprintf(bits, sizeof(bits), "%b", csr, "\020" "\01INT\02ERR\05IEN" "\07SLVERR\010RST\011WRITE\013DRAIN" "\014DSBL_WR_DRN\015DSBL_RD_DRN\020ILACC" "\021DSBL_BUF_WR\022DSBL_WR_INVAL" "\026LOOPTEST\027TP");
  printf("%s: error: csr=%s\n", sc->sc_dev.dv_xname, bits);
  csr &= ~0x00000200;
 ...
 if (dodrain) {
  ...
  csr |= 0x00000400;
  bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr);
  while (i-- > 0 && ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x0000000c))
   delay(1);
 }
 ...
 size_t *dmasize;
{
 ...
 do { u_int32_t csr; do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 556, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("R_PEND"); else panic("R_PEND"); } } while (0); csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)); csr &= ~(0x00000100|0x00000200); csr |= 0x00000020; bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr); } while(0);
 ...
 *dmasize = sc->sc_dmasize =
 ...
 csr |= 0x00000200|0x00000010|0x00002000;
 ...
 void *arg;
{
 ...
 if (csr & (0x00000002|0x00000040)) {
  ...
  printf("%s: pp error: resid %d csr=%b\n", sc->sc_dev.dv_xname,
         resid, csr, "\020" "\01INT\02ERR\05IEN" "\07SLVERR\010RST\011WRITE\012ENDMA" "\016ENCNT\017TC\025DIAG\030TCIDIS" "\031ENNXT\032DMAON\033ALOADED\034NALOADED");
  csr &= ~0x00000200;
 ...
 ret = (csr & 0x00000001) != 0;

 if (sc->sc_active != 0) {
  do { u_int32_t csr; do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 648, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("R_PEND"); else panic("R_PEND"); } } while (0); if (sc->sc_rev != 0xb0000000) { csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)); if (sc->sc_rev == 0x80000000 || sc->sc_rev == 0x00000000) csr |= 0x00000040; else csr |= 0x00000020; bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr); } do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x0000000c) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x0000000c) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 648, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("DRAINING"); else panic("DRAINING"); } } while (0);} while(0);
  resid = bus_space_read_4(sc->sc_bustag, sc->sc_regs,
      8);
 }
