...
{
 u_int32_t csr;
 do { u_int32_t csr; do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 297, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("R_PEND"); else panic("R_PEND"); } } while (0); csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)); csr &= ~(0x00000100|0x00000200); csr |= 0x00000020; bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr); } while(0);
 sc->sc_dmaaddr = addr;
 sc->sc_dmalen = len;
 ...
 void *arg;
{
 ...
 do { u_int32_t csr; do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 408, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("R_PEND"); else panic("R_PEND"); } } while (0); if (sc->sc_rev != 0xb0000000) { csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)); if (sc->sc_rev == 0x80000000 || sc->sc_rev == 0x00000000) csr |= 0x00000040; else csr |= 0x00000020; bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr); } do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x0000000c) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x0000000c) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 408, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("DRAINING"); else panic("DRAINING"); } } while (0);} while(0);
 csr &= ~0x00000200;
 bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr);
 sc->sc_active = 0;
 if (sc->sc_dmasize == 0) {
...
{
 u_int32_t csr;
 do { u_int32_t csr; do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 555, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("R_PEND"); else panic("R_PEND"); } } while (0); csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)); csr &= ~(0x00000100|0x00000200); csr |= 0x00000020; bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr); } while(0);
 sc->sc_dmaaddr = addr;
 sc->sc_dmalen = len;
 ;
 *dmasize = sc->sc_dmasize =
 ...
 void *arg;
{
 ...
 if (sc->sc_active != 0) {
  do { u_int32_t csr; do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x00000400) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 647, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("R_PEND"); else panic("R_PEND"); } } while (0); if (sc->sc_rev != 0xb0000000) { csr = (bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)); if (sc->sc_rev == 0x80000000 || sc->sc_rev == 0x00000000) csr |= 0x00000040; else csr |= 0x00000020; bus_space_write_4((sc)->sc_bustag, (sc)->sc_regs, 0, csr); } do if ((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x0000000c) { int count = 500000; while (((bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0)) & 0x0000000c) && --count > 0) delay(1); if (count == 0) { printf("%s: line %d: CSR = 0x%lx\n", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854.c", 647, (u_long)(bus_space_read_4((sc)->sc_bustag, (sc)->sc_regs, 0))); if (0) printf("DRAINING"); else panic("DRAINING"); } } while (0);} while(0);
  resid = bus_space_read_4(sc->sc_bustag, sc->sc_regs,
      8);
 }
 csr &= ~0x00000200;
