# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_util.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_util.c"
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_util.c"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_util.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_placement.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_util.c" 2
...
int ttm_bo_move_ttm(struct ttm_buffer_object *bo,
      _Bool evict,
      _Bool no_wait_gpu, struct ttm_mem_reg *new_mem)
{
 struct ttm_tt *ttm = bo->ttm;
 struct ttm_mem_reg *old_mem = &bo->mem;
 int ret;

 if (old_mem->mem_type != 0) {
  ttm_tt_unbind(ttm);
  ttm_bo_free_old_node(bo);
  ttm_flag_masked(&old_mem->placement, (1 << 0),
    0x0000FFFF);
  old_mem->mem_type = 0;
 }
...
int ttm_mem_io_lock(struct ttm_mem_type_manager *man, _Bool interruptible)
{
 if (__builtin_expect(!!(man->io_reserve_fastpath), 1))
  return 0;

 if (interruptible)
  return -_rw_enter(&man->io_reserve_mutex, 0x0001UL | 0x0010UL );
...
static int ttm_mem_io_evict(struct ttm_mem_type_manager *man)
{
 ...
 bo = ({ __typeof( ((struct ttm_buffer_object *)0)->io_reserve_lru ) *__mptr = ((&man->io_reserve_lru)->next); (struct ttm_buffer_object *)( (char *)__mptr - __builtin_offsetof(struct ttm_buffer_object, io_reserve_lru) );});
...
{
 uint32_t *dstP =
     (uint32_t *) ((unsigned long)dst + (page << 13));
 uint32_t *srcP =
     (uint32_t *) ((unsigned long)src + (page << 13));

 int i;
 for (i = 0; i < (1 << 13) / sizeof(uint32_t); ++i)
    ...
    pgprot_t prot)
{
 ...
 src = (void *)((unsigned long)src + (page << 13));
    ...
    vm_prot_t prot)
{
 ...
 dst = (void *)((unsigned long)dst + (page << 13));
 if ((prot) != (0))
  src = vmap(&s, 1, 0, prot);
 else
  src = kmap(s);
...
# 428 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_util.c"
      ...
      struct ttm_bo_kmap_obj *map)
{
 ...
 if (num_pages == 1 && (mem->placement & (1 << 16))) {
...
# 663 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_util.c"
