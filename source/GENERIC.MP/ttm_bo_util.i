...
static int ttm_mem_io_evict(struct ttm_mem_type_manager *man)
{
 ...
 if (!man->use_io_reserve_lru || list_empty(&man->io_reserve_lru))
  return -35;
 bo = ({ const __typeof( ((struct ttm_buffer_object *)0)->io_reserve_lru ) *__mptr = ((&man->io_reserve_lru)->next); (struct ttm_buffer_object *)( (char *)__mptr - __builtin_offsetof(struct ttm_buffer_object, io_reserve_lru) );});
