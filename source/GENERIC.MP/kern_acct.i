# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c"
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c"
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c" 2
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c"
...
sys_acct(struct proc *p, void *v, register_t *retval)
{
 ...
 if (acctp != ((void *)0) || savacctp != ((void *)0)) {
  wakeup(&acct_proc);
  error = vn_close((acctp != ((void *)0) ? acctp : savacctp), 0x0002,
      p->p_ucred, p);
  acctp = savacctp = ((void *)0);
 }
 if (((uap)->path.be.datum) == ((void *)0))
  return (0);
 ...
 if ((error = acct_start()) != 0) {
  acctp = ((void *)0);
  (void)vn_close(nd.ni_vp, 0x0002, p->p_ucred, p);
  return (error);
 }
 return (0);
}
...
acct_process(struct proc *p)
{
 ...
 __builtin_memcpy((acct.ac_comm), (pr->ps_comm), (sizeof acct.ac_comm));


 calctsru(&pr->ps_tu, &ut, &st, ((void *)0));
 ...
 getnanotime(&tmp);
 do { (&tmp)->tv_sec = (&tmp)->tv_sec - (&pr->ps_start)->tv_sec; (&tmp)->tv_nsec = (&tmp)->tv_nsec - (&pr->ps_start)->tv_nsec; if ((&tmp)->tv_nsec < 0) { (&tmp)->tv_sec--; (&tmp)->tv_nsec += 1000000000L; } } while (0);
 acct.ac_etime = encode_comp_t(tmp.tv_sec, tmp.tv_nsec);


 r = &p->p_ru;
 do { (&tmp)->tv_sec = (&ut)->tv_sec + (&st)->tv_sec; (&tmp)->tv_nsec = (&ut)->tv_nsec + (&st)->tv_nsec; if ((&tmp)->tv_nsec >= 1000000000L) { (&tmp)->tv_sec++; (&tmp)->tv_nsec -= 1000000000L; } } while (0);
 ...
 error = vn_rdwr(UIO_WRITE, vp, (caddr_t)&acct, sizeof (acct),
     (off_t)0, UIO_SYSSPACE, 0x02|0x01|0x20,
     p->p_ucred, ((void *)0), p);

 return error;
}
# 238 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_acct.c"
comp_t
...
acct_start(void)
{
 ...
 return (kthread_create(acct_thread, ((void *)0), &acct_proc, "acct"));
}
 ...
 for (;;) {
  if (savacctp != ((void *)0)) {
   if (savacctp->v_type == VBAD) {
    (void) vn_close(savacctp, 0x0002, ((struct ucred *)-1), p);
    savacctp = ((void *)0);
    break;
   }
   (void)(*(savacctp->v_mount)->mnt_op->vfs_statfs)(savacctp->v_mount, &sb, ((void *)0));
   if (sb.f_bavail > acctresume * sb.f_blocks / 100) {
    acctp = savacctp;
    savacctp = ((void *)0);
    log(5, "Accounting resumed\n");
   }
  } else if (acctp != ((void *)0)) {
   if (acctp->v_type == VBAD) {
    (void) vn_close(acctp, 0x0002, ((struct ucred *)-1), p);
    acctp = ((void *)0);
    break;
   }
   (void)(*(acctp->v_mount)->mnt_op->vfs_statfs)(acctp->v_mount, &sb, ((void *)0));
   if (sb.f_bavail <= acctsuspend * sb.f_blocks / 100) {
    savacctp = acctp;
    acctp = ((void *)0);
    log(5, "Accounting suspended\n");
   }
  } else {
   break;
  }
  tsleep(&acct_proc, 40, "acct", acctchkfreq *hz);
 }
 acct_proc = ((void *)0);
 kthread_exit(0);
}
...
acct_shutdown(void)
{
 ...
 if (acctp != ((void *)0) || savacctp != ((void *)0)) {
  vn_close((acctp != ((void *)0) ? acctp : savacctp), 0x0002,
      ((struct ucred *)-1), p);
  acctp = savacctp = ((void *)0);
 }
}
