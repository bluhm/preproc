# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/spdmem.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/spdmem.c"
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/spdmem.c"
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/spdmem.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/spdmem.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/spdmem.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/spdmemvar.h" 1
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/spdmemvar.h"
struct spdmem {
 uint8_t sm_len;
 uint8_t sm_size;
 uint8_t sm_type;
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/spdmem.c" 2
# 229 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/spdmem.c"
...
spdmem_read(struct spdmem_softc *sc, uint8_t reg64)
{
 return (*sc->sc_read)(sc, reg64);
}
...
spdmem_sdram_decode(struct spdmem_softc *sc, struct spdmem *s)
{
 ...
 if (s->sm_data[0x1d] == 0x04)
  type = spdmem_superset_types[0x04];
 if (s->sm_data[0x1d] == 0x01)
  type = spdmem_superset_types[0x01];

 num_banks = s->sm_data[0x02];
 per_chip = s->sm_data[0x0e];
 rows = s->sm_data[0x00] & 0x0f;
 cols = s->sm_data[0x01] & 0x0f;
 ...
 if (s->sm_data[0x12] & (1 << 1))
  printf(" registered");

 if (s->sm_data[0x08] < 8)
  printf(" %s",
      spdmem_parity_types[s->sm_data[0x08]]);

 p_clk = 66;
 if (s->sm_len >= 128) {
  switch (spdmem_read(sc, 126)) {
  case 0x64:
  case 0x85:

   if (s->sm_data[0x06] < 0x80)
    p_clk = 133;
   else
    p_clk = 100;
   break;
 ...
 if (s->sm_len < 128)
  return;
 if (spdmem_read(sc, 127) & (1 << 1))
  printf("CL2");
 else if (spdmem_read(sc, 127) & (1 << 2))
  printf("CL3");
}
...
spdmem_rdr_decode(struct spdmem_softc *sc, struct spdmem *s)
{
 ...
 row_bits = s->sm_data[0x01] >> 4;
 col_bits = s->sm_data[0x01] & 0x0f;
 bank_bits = s->sm_data[0x02] & 0x07;
...
spdmem_ddr_decode(struct spdmem_softc *sc, struct spdmem *s)
{
 ...
 if (s->sm_data[0x1d] == 0x02)
  type = spdmem_superset_types[0x02];
 ...
 cycle_time = (s->sm_data[0x06] >> 4) * 100 +
     (s->sm_data[0x06] & 0x0f) * 10;
...
spdmem_ddr2_decode(struct spdmem_softc *sc, struct spdmem *s)
{
 ...
 num_ranks = (s->sm_data[0x02] & 0x7) + 1;
 density = (s->sm_data[0x1c] & 0xf0) |
     ((s->sm_data[0x1c] & 0x0f) << 8);
 ...
 cycle_time = (s->sm_data[0x06] >> 4) * 100 +
     ddr2_cycle_tenths[(s->sm_data[0x06] & 0x0f)];
...
spdmem_fbdimm_decode(struct spdmem_softc *sc, struct spdmem *s)
{
 ...
 cols = (s->sm_data[0x01] & 0x0c) >>
     2;
 rows = (s->sm_data[0x01] & 0xe0) >>
     5;
 ...
 dividend = s->sm_data[0x06];
 divisor = s->sm_data[0x07];
...
spdmem_ddr3_decode(struct spdmem_softc *sc, struct spdmem *s)
{
 ...
 chipsize = s->sm_data[0x01] &
     0x0f;
 datawidth = s->sm_data[0x05] &
     0x07;
 chipwidth = s->sm_data[0x04] &
     0x07;
 physbanks = (s->sm_data[0x04] >>
     3) & 0x07;
 ...
 mtype = s->sm_data[0x00];
 if (mtype == 0x01 || mtype == 0x05)
  printf(" registered");

 if (s->sm_data[0x05] & (1 << 3))
  printf(" ECC");

 dividend = s->sm_data[0x07];
 divisor = s->sm_data[0x08];
 cycle_time = (1000 * dividend + (divisor / 2)) / divisor;
 cycle_time *= s->sm_data[0x09];
