# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/enc.h" 1
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_types.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_enc.c" 2


struct ifnet **enc_ifps;
u_int enc_max_id;
struct ifnet **enc_allifps;
u_int enc_max_unit;
...
enc_clone_create(struct if_clone *ifc, int unit)
{
 ...
 ifp = &sc->sc_if;
 ifp->if_softc = sc;
 ifp->if_data.ifi_type = 0xf4;
 ifp->if_xflags = 0x2;
 ifp->if_start = enc_start;
 ifp->if_output = enc_output;
 ifp->if_ioctl = enc_ioctl;
 ifp->if_data.ifi_hdrlen = 12;
 ...
 if (unit == 0 || unit > enc_max_unit) {
  ...
  if (enc_allifps != ((void *)0)) {
   __builtin_memcpy((new), (enc_allifps), (sizeof(struct ifnet *) * (enc_max_unit + 1)));

   free(enc_allifps, 2, 0);
  }
  enc_allifps = new;
  enc_max_unit = unit;
 }
...
enc_ioctl(struct ifnet *ifp, u_long cmd, caddr_t data)
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((159))):
  if ((error = enc_setif(ifp, ifr->ifr_ifru.ifru_metric)) != 0)
   return (error);
...
enc_getif(u_int id, u_int unit)
{
 ...
 if (unit > 0) {
  ...
  if (ifp == ((void *)0) || ifp->if_data.ifi_rdomain != id)
   return (((void *)0));
  return (ifp);
 }
...
enc_setif(struct ifnet *ifp, u_int id)
{
 ...
 if (id == 0 || id > enc_max_id) {
  ...
  if (enc_ifps != ((void *)0)) {
   __builtin_memcpy((new), (enc_ifps), (sizeof(struct ifnet *) * (enc_max_id + 1)));
...
{
 u_int id = ifp->if_data.ifi_rdomain, i;
 struct ifnet *oifp, *nifp;

 if ((oifp = enc_getif(id, 0)) == ((void *)0) || oifp != ifp)
  return;
 ...
 for (i = 0; i < (enc_max_unit + 1); i++) {
  ...
  if (nifp == ((void *)0) || nifp == ifp || nifp->if_data.ifi_rdomain != id)
   continue;

  enc_ifps[id] = nifp;
  nifp->if_data.ifi_link_state = 4;
  break;
 }
}
