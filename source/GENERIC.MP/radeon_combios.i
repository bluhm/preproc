# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c" 2
      ...
      enum radeon_combios_table_offset table)
{
 ...
 case COMBIOS_ASIC_INIT_3_TABLE:
  ...
  if (check_offset) {
   rev = (rdev->bios[check_offset]);
   if (rev > 0) {
    check_offset = ((rdev->bios[check_offset + 0x3]) | ((rdev->bios[(check_offset + 0x3)+1]) << 8));
    if (check_offset)
     offset = check_offset;
   }
  }
 ...
 case COMBIOS_ASIC_INIT_4_TABLE:
  ...
  if (check_offset) {
   rev = (rdev->bios[check_offset]);
   if (rev > 0) {
    check_offset = ((rdev->bios[check_offset + 0x5]) | ((rdev->bios[(check_offset + 0x5)+1]) << 8));
    if (check_offset)
     offset = check_offset;
   }
  }
 ...
 case COMBIOS_DETECTED_MEM_TABLE:
  ...
  if (check_offset) {
   rev = (rdev->bios[check_offset]);
   if (rev > 0) {
    check_offset = ((rdev->bios[check_offset + 0x7]) | ((rdev->bios[(check_offset + 0x7)+1]) << 8));
    if (check_offset)
     offset = check_offset;
   }
  }
 ...
 case COMBIOS_ASIC_INIT_5_TABLE:
  ...
  if (check_offset) {
   rev = (rdev->bios[check_offset]);
   if (rev == 2) {
    check_offset = ((rdev->bios[check_offset + 0x9]) | ((rdev->bios[(check_offset + 0x9)+1]) << 8));
    if (check_offset)
     offset = check_offset;
   }
  }
 ...
 case COMBIOS_POWERPLAY_INFO_TABLE:
  ...
  if (check_offset) {
   check_offset = ((rdev->bios[check_offset + 0x11]) | ((rdev->bios[(check_offset + 0x11)+1]) << 8));
   if (check_offset)
    offset = check_offset;
  }
  break;
 case COMBIOS_GPIO_INFO_TABLE:
  check_offset =
      combios_get_table_offset(dev, COMBIOS_MOBILE_INFO_TABLE);
  if (check_offset) {
   check_offset = ((rdev->bios[check_offset + 0x13]) | ((rdev->bios[(check_offset + 0x13)+1]) << 8));
   if (check_offset)
    offset = check_offset;
  }
  break;
 case COMBIOS_LCD_DDC_INFO_TABLE:
  check_offset =
      combios_get_table_offset(dev, COMBIOS_MOBILE_INFO_TABLE);
  if (check_offset) {
   check_offset = ((rdev->bios[check_offset + 0x15]) | ((rdev->bios[(check_offset + 0x15)+1]) << 8));
   if (check_offset)
    offset = check_offset;
  }
  break;
 case COMBIOS_TMDS_POWER_TABLE:
  check_offset =
      combios_get_table_offset(dev, COMBIOS_MOBILE_INFO_TABLE);
  if (check_offset) {
   check_offset = ((rdev->bios[check_offset + 0x17]) | ((rdev->bios[(check_offset + 0x17)+1]) << 8));
   if (check_offset)
    offset = check_offset;
  }
  break;
 case COMBIOS_TMDS_POWER_ON_TABLE:
  ...
  if (check_offset) {
   check_offset = ((rdev->bios[check_offset + 0x2]) | ((rdev->bios[(check_offset + 0x2)+1]) << 8));
   if (check_offset)
    offset = check_offset;
  }
  break;
 case COMBIOS_TMDS_POWER_OFF_TABLE:
  check_offset =
      combios_get_table_offset(dev, COMBIOS_TMDS_POWER_TABLE);
  if (check_offset) {
   check_offset = ((rdev->bios[check_offset + 0x4]) | ((rdev->bios[(check_offset + 0x4)+1]) << 8));
   if (check_offset)
    offset = check_offset;
  }
  break;
 ...
 size = (rdev->bios[rdev->bios_header_start + 0x6]);
 if (table < COMBIOS_ASIC_INIT_3_TABLE && check_offset < size)
  offset = ((rdev->bios[rdev->bios_header_start + check_offset]) | ((rdev->bios[(rdev->bios_header_start + check_offset)+1]) << 8));

 return offset;
}

_Bool radeon_combios_check_hardcoded_edid(struct radeon_device *rdev)
{
 int edid_info, size;
 struct edid *edid;
 unsigned char *raw;
 ...
 size = 128 * (raw[0x7e] + 1);
 edid = kmalloc(size, (0x0001 | 0x0004));
 if (edid == ((void *)0))
  return 0;

 __builtin_memcpy(((unsigned char *)edid), (raw), (size));
...
radeon_bios_get_hardcoded_edid(struct radeon_device *rdev)
{
 ...
 if (rdev->mode_info.bios_hardcoded_edid) {
  edid = kmalloc(rdev->mode_info.bios_hardcoded_edid_size, (0x0001 | 0x0004));
  if (edid) {
   __builtin_memcpy(((unsigned char *)edid), ((unsigned char *)rdev->mode_info.bios_hardcoded_edid), (rdev->mode_info.bios_hardcoded_edid_size));
             ...
             u32 data_mask)
{
 ...
 int ddc_line = 0;
# 452 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
 switch (ddc) {
 ...
 if (ddc_line == 0x0198) {
  i2c.mask_clk_reg = 0x0198;
  i2c.mask_data_reg = 0x0198;
  i2c.a_clk_reg = 0x019c;
  i2c.a_data_reg = 0x019c;
  i2c.en_clk_reg = 0x01a0;
  i2c.en_data_reg = 0x01a0;
  i2c.y_clk_reg = 0x01a4;
  i2c.y_data_reg = 0x01a4;
 } else if (ddc_line == 0x01a8) {
  i2c.mask_clk_reg = 0x01a8;
  i2c.mask_data_reg = 0x01a8;
  i2c.a_clk_reg = 0x01ac;
  i2c.a_data_reg = 0x01ac;
  i2c.en_clk_reg = 0x01b0;
  i2c.en_data_reg = 0x01b0;
  i2c.y_clk_reg = 0x01b4;
  i2c.y_data_reg = 0x01b4;
 } else {
 ...
 if (clk_mask && data_mask) {
  ...
  i2c.mask_clk_mask = (1 << 25);
  i2c.mask_data_mask = (1 << 24);
  i2c.a_clk_mask = (1 << 1);
  i2c.a_data_mask = (1 << 0);
  i2c.en_clk_mask = (1 << 17);
  i2c.en_data_mask = (1 << 16);
  i2c.y_clk_mask = (1 << 9);
  i2c.y_data_mask = (1 << 8);
 }
...
static struct radeon_i2c_bus_rec radeon_combios_get_i2c_info_from_table(struct radeon_device *rdev)
{
 ...
 if (offset) {
  blocks = (rdev->bios[offset + 2]);
  for (i = 0; i < blocks; i++) {
   id = (rdev->bios[offset + 3 + (i * 5) + 0]);
   if (id == 136) {
    clk = (rdev->bios[offset + 3 + (i * 5) + 3]);
    data = (rdev->bios[offset + 3 + (i * 5) + 4]);
...
void radeon_combios_i2c_init(struct radeon_device *rdev)
{
 struct drm_device *dev = rdev->ddev;
 struct radeon_i2c_bus_rec i2c;
# 695 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
...
_Bool radeon_combios_get_clock_info(struct drm_device *dev)
{
 struct radeon_device *rdev = dev->dev_private;
 uint16_t pll_info;
 ...
 if (pll_info) {
  rev = (rdev->bios[pll_info]);


  p1pll->reference_freq = ((rdev->bios[pll_info + 0xe]) | ((rdev->bios[(pll_info + 0xe)+1]) << 8));
  p1pll->reference_div = ((rdev->bios[pll_info + 0x10]) | ((rdev->bios[(pll_info + 0x10)+1]) << 8));
  p1pll->pll_out_min = ((((rdev->bios[pll_info + 0x12]) | ((rdev->bios[(pll_info + 0x12)+1]) << 8))) | (((rdev->bios[(pll_info + 0x12)+2]) | ((rdev->bios[((pll_info + 0x12)+2)+1]) << 8)) << 16));
  p1pll->pll_out_max = ((((rdev->bios[pll_info + 0x16]) | ((rdev->bios[(pll_info + 0x16)+1]) << 8))) | (((rdev->bios[(pll_info + 0x16)+2]) | ((rdev->bios[((pll_info + 0x16)+2)+1]) << 8)) << 16));
  p1pll->lcd_pll_out_min = p1pll->pll_out_min;
  p1pll->lcd_pll_out_max = p1pll->pll_out_max;

  if (rev > 9) {
   p1pll->pll_in_min = ((((rdev->bios[pll_info + 0x36]) | ((rdev->bios[(pll_info + 0x36)+1]) << 8))) | (((rdev->bios[(pll_info + 0x36)+2]) | ((rdev->bios[((pll_info + 0x36)+2)+1]) << 8)) << 16));
   p1pll->pll_in_max = ((((rdev->bios[pll_info + 0x3a]) | ((rdev->bios[(pll_info + 0x3a)+1]) << 8))) | (((rdev->bios[(pll_info + 0x3a)+2]) | ((rdev->bios[((pll_info + 0x3a)+2)+1]) << 8)) << 16));
  } else {
   p1pll->pll_in_min = 40;
  ...
  *p2pll = *p1pll;
  ...
  spll->reference_freq = ((rdev->bios[pll_info + 0x1a]) | ((rdev->bios[(pll_info + 0x1a)+1]) << 8));
  spll->reference_div = ((rdev->bios[pll_info + 0x1c]) | ((rdev->bios[(pll_info + 0x1c)+1]) << 8));
  spll->pll_out_min = ((((rdev->bios[pll_info + 0x1e]) | ((rdev->bios[(pll_info + 0x1e)+1]) << 8))) | (((rdev->bios[(pll_info + 0x1e)+2]) | ((rdev->bios[((pll_info + 0x1e)+2)+1]) << 8)) << 16));
  spll->pll_out_max = ((((rdev->bios[pll_info + 0x22]) | ((rdev->bios[(pll_info + 0x22)+1]) << 8))) | (((rdev->bios[(pll_info + 0x22)+2]) | ((rdev->bios[((pll_info + 0x22)+2)+1]) << 8)) << 16));

  if (rev > 10) {
   spll->pll_in_min = ((((rdev->bios[pll_info + 0x48]) | ((rdev->bios[(pll_info + 0x48)+1]) << 8))) | (((rdev->bios[(pll_info + 0x48)+2]) | ((rdev->bios[((pll_info + 0x48)+2)+1]) << 8)) << 16));
   spll->pll_in_max = ((((rdev->bios[pll_info + 0x4c]) | ((rdev->bios[(pll_info + 0x4c)+1]) << 8))) | (((rdev->bios[(pll_info + 0x4c)+2]) | ((rdev->bios[((pll_info + 0x4c)+2)+1]) << 8)) << 16));
  } else {
  ...
  mpll->reference_freq = ((rdev->bios[pll_info + 0x26]) | ((rdev->bios[(pll_info + 0x26)+1]) << 8));
  mpll->reference_div = ((rdev->bios[pll_info + 0x28]) | ((rdev->bios[(pll_info + 0x28)+1]) << 8));
  mpll->pll_out_min = ((((rdev->bios[pll_info + 0x2a]) | ((rdev->bios[(pll_info + 0x2a)+1]) << 8))) | (((rdev->bios[(pll_info + 0x2a)+2]) | ((rdev->bios[((pll_info + 0x2a)+2)+1]) << 8)) << 16));
  mpll->pll_out_max = ((((rdev->bios[pll_info + 0x2e]) | ((rdev->bios[(pll_info + 0x2e)+1]) << 8))) | (((rdev->bios[(pll_info + 0x2e)+2]) | ((rdev->bios[((pll_info + 0x2e)+2)+1]) << 8)) << 16));

  if (rev > 10) {
   mpll->pll_in_min = ((((rdev->bios[pll_info + 0x5a]) | ((rdev->bios[(pll_info + 0x5a)+1]) << 8))) | (((rdev->bios[(pll_info + 0x5a)+2]) | ((rdev->bios[((pll_info + 0x5a)+2)+1]) << 8)) << 16));
   mpll->pll_in_max = ((((rdev->bios[pll_info + 0x5e]) | ((rdev->bios[(pll_info + 0x5e)+1]) << 8))) | (((rdev->bios[(pll_info + 0x5e)+2]) | ((rdev->bios[((pll_info + 0x5e)+2)+1]) << 8)) << 16));
  } else {
  ...
  sclk = ((rdev->bios[pll_info + 0xa]) | ((rdev->bios[(pll_info + 0xa)+1]) << 8));
  mclk = ((rdev->bios[pll_info + 0x8]) | ((rdev->bios[(pll_info + 0x8)+1]) << 8));
  if (sclk == 0)
   sclk = 200 * 100;
  if (mclk == 0)
   mclk = 200 * 100;
  ...
  if (((((rdev->bios[pll_info + 0x16]) | ((rdev->bios[(pll_info + 0x16)+1]) << 8))) | (((rdev->bios[(pll_info + 0x16)+2]) | ((rdev->bios[((pll_info + 0x16)+2)+1]) << 8)) << 16)))
   rdev->clock.max_pixel_clock = ((((rdev->bios[pll_info + 0x16]) | ((rdev->bios[(pll_info + 0x16)+1]) << 8))) | (((rdev->bios[(pll_info + 0x16)+2]) | ((rdev->bios[((pll_info + 0x16)+2)+1]) << 8)) << 16));
  else
...
_Bool radeon_combios_sideport_present(struct radeon_device *rdev)
{
 ...
 if (igp_info) {
  if (((rdev->bios[igp_info + 0x4]) | ((rdev->bios[(igp_info + 0x4)+1]) << 8)))
   return 1;
 }
 return 0;
}
               ...
               *encoder)
{
 ...
 if (dac_info) {
  rev = (rdev->bios[dac_info]) & 0x3;
  if (rev < 2) {
   bg = (rdev->bios[dac_info + 0x2]) & 0xf;
   dac = ((rdev->bios[dac_info + 0x2]) >> 4) & 0xf;
   p_dac->ps2_pdac_adj = (bg << 8) | (dac);
  } else {
   bg = (rdev->bios[dac_info + 0x2]) & 0xf;
   dac = (rdev->bios[dac_info + 0x3]) & 0xf;
   p_dac->ps2_pdac_adj = (bg << 8) | (dac);
  }
...
radeon_combios_get_tv_info(struct radeon_device *rdev)
{
 ...
 if (tv_info) {
  if ((rdev->bios[tv_info + 6]) == 'T') {
   switch ((rdev->bios[tv_info + 7]) & 0xf) {
   case 1:
    tv_std = TV_STD_NTSC;
    do { } while( 0);
    break;
   ...
   switch (((rdev->bios[tv_info + 9]) >> 2) & 0x3) {
   case 0:
    do { } while( 0);
    break;
   case 1:
            ...
            *encoder)
{
 ...
 tv_dac = kzalloc(sizeof(struct radeon_encoder_tv_dac), (0x0001 | 0x0004));
 if (!tv_dac)
  return ((void *)0);
 ...
 if (dac_info) {
  rev = (rdev->bios[dac_info + 0x3]);
  if (rev > 4) {
   bg = (rdev->bios[dac_info + 0xc]) & 0xf;
   dac = (rdev->bios[dac_info + 0xd]) & 0xf;
   tv_dac->ps2_tvdac_adj = (bg << 16) | (dac << 20);

   bg = (rdev->bios[dac_info + 0xe]) & 0xf;
   dac = (rdev->bios[dac_info + 0xf]) & 0xf;
   tv_dac->pal_tvdac_adj = (bg << 16) | (dac << 20);

   bg = (rdev->bios[dac_info + 0x10]) & 0xf;
   dac = (rdev->bios[dac_info + 0x11]) & 0xf;
   ...
   bg = (rdev->bios[dac_info + 0xc]) & 0xf;
   dac = ((rdev->bios[dac_info + 0xc]) >> 4) & 0xf;
   tv_dac->ps2_tvdac_adj = (bg << 16) | (dac << 20);

   bg = (rdev->bios[dac_info + 0xd]) & 0xf;
   dac = ((rdev->bios[dac_info + 0xd]) >> 4) & 0xf;
   tv_dac->pal_tvdac_adj = (bg << 16) | (dac << 20);

   bg = (rdev->bios[dac_info + 0xe]) & 0xf;
   dac = ((rdev->bios[dac_info + 0xe]) >> 4) & 0xf;
   tv_dac->ntsc_tvdac_adj = (bg << 16) | (dac << 20);
 ...
 if (!found) {
  ...
  if (dac_info) {
   rev = (rdev->bios[dac_info]) & 0x3;
   if (rev < 2) {
    bg = (rdev->bios[dac_info + 0x3]) & 0xf;
    dac = ((rdev->bios[dac_info + 0x3]) >> 4) & 0xf;
    ...
    bg = (rdev->bios[dac_info + 0x4]) & 0xf;
    dac = (rdev->bios[dac_info + 0x5]) & 0xf;
    tv_dac->ps2_tvdac_adj =
        (bg << 16) | (dac << 20);
    tv_dac->pal_tvdac_adj = tv_dac->ps2_tvdac_adj;
    tv_dac->ntsc_tvdac_adj = tv_dac->ps2_tvdac_adj;
          ...
          *rdev)
{
 ...
 uint32_t lvds_ss_gen_cntl = r100_mm_rreg(rdev, (0x02ec), 0);

 lvds = kzalloc(sizeof(struct radeon_encoder_lvds), (0x0001 | 0x0004));

 if (!lvds)
  return ((void *)0);

 fp_vert_stretch = r100_mm_rreg(rdev, (0x0290), 0);
 fp_horz_stretch = r100_mm_rreg(rdev, (0x028c), 0);


 lvds->panel_pwr_delay = 200;
 lvds->panel_vcc_delay = 2000;

 lvds->lvds_gen_cntl = r100_mm_rreg(rdev, (0x02d0), 0);
 lvds->panel_digon_delay = (lvds_ss_gen_cntl >> 16) & 0xf;
 lvds->panel_blon_delay = (lvds_ss_gen_cntl >> 20) & 0xf;

 if (fp_vert_stretch & (1 << 25))
  lvds->native_mode.vdisplay =
      ((fp_vert_stretch & (0xfff << 12)) >>
       12) + 1;
 else
  lvds->native_mode.vdisplay =
      (r100_mm_rreg(rdev, (0x0208), 0) >> 16) + 1;

 if (fp_horz_stretch & (1 << 25))
  lvds->native_mode.hdisplay =
      (((fp_horz_stretch & (0x1ff << 16)) >>
        16) + 1) * 8;
 else
  lvds->native_mode.hdisplay =
      ((r100_mm_rreg(rdev, (0x0200), 0) >> 16) + 1) * 8;
 ...
 ppll_div_sel = bus_space_read_1(rdev->memt, rdev->rmmio, (0x0008 + 1)) & 0x3;
 ppll_val = rdev->pll_rreg(rdev, (0x0004 + ppll_div_sel));
 if ((ppll_val & 0x000707ff) == 0x1bb)
  lvds->use_bios_dividers = 0;
 else {
        ...
        *encoder)
{
 ...
 if (lcd_info) {
  ...
  for (i = 0; i < 24; i++)
   stmp[i] = (rdev->bios[lcd_info + i + 1]);
  stmp[24] = 0;

  do { } while( 0);

  lvds->native_mode.hdisplay = ((rdev->bios[lcd_info + 0x19]) | ((rdev->bios[(lcd_info + 0x19)+1]) << 8));
  lvds->native_mode.vdisplay = ((rdev->bios[lcd_info + 0x1b]) | ((rdev->bios[(lcd_info + 0x1b)+1]) << 8));

  do { } while( 0);


  lvds->panel_vcc_delay = ((rdev->bios[lcd_info + 0x2c]) | ((rdev->bios[(lcd_info + 0x2c)+1]) << 8));
  lvds->panel_vcc_delay = ({ u16 __min_a = (lvds->panel_vcc_delay); u16 __min_b = (2000); __min_a < __min_b ? __min_a : __min_b; });

  lvds->panel_pwr_delay = (rdev->bios[lcd_info + 0x24]);
  lvds->panel_digon_delay = ((rdev->bios[lcd_info + 0x38]) | ((rdev->bios[(lcd_info + 0x38)+1]) << 8)) & 0xf;
  lvds->panel_blon_delay = (((rdev->bios[lcd_info + 0x38]) | ((rdev->bios[(lcd_info + 0x38)+1]) << 8)) >> 4) & 0xf;

  lvds->panel_ref_divider = ((rdev->bios[lcd_info + 0x2e]) | ((rdev->bios[(lcd_info + 0x2e)+1]) << 8));
  lvds->panel_post_divider = (rdev->bios[lcd_info + 0x30]);
  lvds->panel_fb_divider = ((rdev->bios[lcd_info + 0x31]) | ((rdev->bios[(lcd_info + 0x31)+1]) << 8));
  if ((lvds->panel_ref_divider != 0) &&
      (lvds->panel_fb_divider > 3))
   lvds->use_bios_dividers = 1;

  panel_setup = ((((rdev->bios[lcd_info + 0x39]) | ((rdev->bios[(lcd_info + 0x39)+1]) << 8))) | (((rdev->bios[(lcd_info + 0x39)+2]) | ((rdev->bios[((lcd_info + 0x39)+2)+1]) << 8)) << 16));
  lvds->lvds_gen_cntl = 0xff00;
  if (panel_setup & 0x1)
   lvds->lvds_gen_cntl |= (1 << 3);

  if ((panel_setup >> 4) & 0x1)
   lvds->lvds_gen_cntl |= (1 << 2);

  switch ((panel_setup >> 8) & 0x7) {
  case 0:
   lvds->lvds_gen_cntl |= (0 << 4);
   break;
  case 1:
   lvds->lvds_gen_cntl |= (1 << 4);
   break;
  case 2:
   lvds->lvds_gen_cntl |= (2 << 4);
   break;
  default:
   break;
  }
  ...
  if ((panel_setup >> 16) & 0x1)
   lvds->lvds_gen_cntl |= (1 << 20);

  if ((panel_setup >> 17) & 0x1)
   lvds->lvds_gen_cntl |= (1 << 21);

  if ((panel_setup >> 18) & 0x1)
   lvds->lvds_gen_cntl |= (1 << 22);

  if ((panel_setup >> 23) & 0x1)
   lvds->lvds_gen_cntl |= (1 << 17);

  lvds->lvds_gen_cntl |= (panel_setup & 0xf0000000);

  for (i = 0; i < 32; i++) {
   tmp = ((rdev->bios[lcd_info + 64 + i * 2]) | ((rdev->bios[(lcd_info + 64 + i * 2)+1]) << 8));
   if (tmp == 0)
    break;

   if ((((rdev->bios[tmp]) | ((rdev->bios[(tmp)+1]) << 8)) == lvds->native_mode.hdisplay) &&
       (((rdev->bios[tmp + 2]) | ((rdev->bios[(tmp + 2)+1]) << 8)) == lvds->native_mode.vdisplay)) {
    lvds->native_mode.htotal = lvds->native_mode.hdisplay +
     (((rdev->bios[tmp + 17]) | ((rdev->bios[(tmp + 17)+1]) << 8)) - ((rdev->bios[tmp + 19]) | ((rdev->bios[(tmp + 19)+1]) << 8))) * 8;
    lvds->native_mode.hsync_start = lvds->native_mode.hdisplay +
     (((rdev->bios[tmp + 21]) | ((rdev->bios[(tmp + 21)+1]) << 8)) - ((rdev->bios[tmp + 19]) | ((rdev->bios[(tmp + 19)+1]) << 8)) - 1) * 8;
    lvds->native_mode.hsync_end = lvds->native_mode.hsync_start +
     ((rdev->bios[tmp + 23]) * 8);

    lvds->native_mode.vtotal = lvds->native_mode.vdisplay +
     (((rdev->bios[tmp + 24]) | ((rdev->bios[(tmp + 24)+1]) << 8)) - ((rdev->bios[tmp + 26]) | ((rdev->bios[(tmp + 26)+1]) << 8)));
    lvds->native_mode.vsync_start = lvds->native_mode.vdisplay +
     ((((rdev->bios[tmp + 28]) | ((rdev->bios[(tmp + 28)+1]) << 8)) & 0x7ff) - ((rdev->bios[tmp + 26]) | ((rdev->bios[(tmp + 26)+1]) << 8)));
    lvds->native_mode.vsync_end = lvds->native_mode.vsync_start +
     ((((rdev->bios[tmp + 28]) | ((rdev->bios[(tmp + 28)+1]) << 8)) & 0xf800) >> 11);

    lvds->native_mode.clock = ((rdev->bios[tmp + 9]) | ((rdev->bios[(tmp + 9)+1]) << 8)) * 10;
...
_Bool radeon_legacy_get_tmds_info_from_table(struct radeon_encoder *encoder,
         struct radeon_encoder_int_tmds *tmds)
{
 struct drm_device *dev = encoder->base.dev;
 struct radeon_device *rdev = dev->dev_private;
...
_Bool radeon_legacy_get_tmds_info_from_combios(struct radeon_encoder *encoder,
           struct radeon_encoder_int_tmds *tmds)
{
 struct drm_device *dev = encoder->base.dev;
 struct radeon_device *rdev = dev->dev_private;
 ...
 if (tmds_info) {
  ver = (rdev->bios[tmds_info]);
  do { } while( 0);
  if (ver == 3) {
   n = (rdev->bios[tmds_info + 5]) + 1;
   if (n > 4)
    n = 4;
   for (i = 0; i < n; i++) {
    tmds->tmds_pll[i].value =
        ((((rdev->bios[tmds_info + i * 10 + 0x08]) | ((rdev->bios[(tmds_info + i * 10 + 0x08)+1]) << 8))) | (((rdev->bios[(tmds_info + i * 10 + 0x08)+2]) | ((rdev->bios[((tmds_info + i * 10 + 0x08)+2)+1]) << 8)) << 16));
    tmds->tmds_pll[i].freq =
        ((rdev->bios[tmds_info + i * 10 + 0x10]) | ((rdev->bios[(tmds_info + i * 10 + 0x10)+1]) << 8));
    do { } while( 0);
   ...
   for (i = 0; i < n; i++) {
    tmds->tmds_pll[i].value =
        ((((rdev->bios[tmds_info + stride + 0x08]) | ((rdev->bios[(tmds_info + stride + 0x08)+1]) << 8))) | (((rdev->bios[(tmds_info + stride + 0x08)+2]) | ((rdev->bios[((tmds_info + stride + 0x08)+2)+1]) << 8)) << 16));
    tmds->tmds_pll[i].freq =
        ((rdev->bios[tmds_info + stride + 0x10]) | ((rdev->bios[(tmds_info + stride + 0x10)+1]) << 8));
    if (i == 0)
     stride += 10;
    else
     stride += 6;
...
_Bool radeon_legacy_get_ext_tmds_info_from_table(struct radeon_encoder *encoder,
      struct radeon_encoder_ext_tmds *tmds)
{
 struct drm_device *dev = encoder->base.dev;
 struct radeon_device *rdev = dev->dev_private;
...
_Bool radeon_legacy_get_ext_tmds_info_from_combios(struct radeon_encoder *encoder,
        struct radeon_encoder_ext_tmds *tmds)
{
 struct drm_device *dev = encoder->base.dev;
 struct radeon_device *rdev = dev->dev_private;
 ...
 if (rdev->flags & RADEON_IS_IGP) {
  ...
  if (offset) {
   ver = (rdev->bios[offset]);
   do { } while( 0);
   tmds->slave_addr = (rdev->bios[offset + 4 + 2]);
   tmds->slave_addr >>= 1;
   gpio = (rdev->bios[offset + 4 + 3]);
   if (gpio == DDC_LCD) {
...
# 1534 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
 ...
 case CT_IBOOK:
  ...
  radeon_add_legacy_encoder(dev,
       radeon_get_encoder_enum(dev,
        ...
        0),
       (0x1L << 0x00000001 ));
  radeon_add_legacy_connector(dev, 0, (0x1L << 0x00000001 ),
         7, &ddc_i2c,
         0x0E,
         &hpd);
  ...
  radeon_add_legacy_encoder(dev,
       radeon_get_encoder_enum(dev,
        ...
        2),
       (0x1L << 0x00000004 ));
  radeon_add_legacy_connector(dev, 1, (0x1L << 0x00000004 ),
         1, &ddc_i2c,
         0x05,
         &hpd);
  ...
  radeon_add_legacy_encoder(dev,
       radeon_get_encoder_enum(dev,
        ...
        2),
       (0x1L << 0x00000002 ));
  radeon_add_legacy_connector(dev, 2, (0x1L << 0x00000002 ),
         6,
         &ddc_i2c,
         0x07,
         &hpd);
 ...
 case CT_POWERBOOK_VGA:
  ...
  radeon_add_legacy_encoder(dev,
       radeon_get_encoder_enum(dev,
        ...
        1),
       (0x1L << 0x00000000 ));
  radeon_add_legacy_connector(dev, 1, (0x1L << 0x00000000 ),
         1, &ddc_i2c,
         0x05,
         &hpd);
 ...
 case CT_MINI_EXTERNAL:
  ...
  radeon_add_legacy_encoder(dev,
       radeon_get_encoder_enum(dev,
        ...
        2),
       (0x1L << 0x00000002 ));
  radeon_add_legacy_connector(dev, 1, (0x1L << 0x00000002 ),
         6,
         &ddc_i2c,
         0x07,
         &hpd);
 ...
 case CT_IMAC_G5_ISIGHT:
  ...
  radeon_add_legacy_encoder(dev,
       radeon_get_encoder_enum(dev,
        ...
        0),
       (0x1L << 0x00000003 ));
  radeon_add_legacy_connector(dev, 0, (0x1L << 0x00000003 ),
         3, &ddc_i2c,
         0x03,
         &hpd);
 ...
 case CT_EMAC:
  ...
  radeon_add_legacy_encoder(dev,
       radeon_get_encoder_enum(dev,
        ...
        1),
       (0x1L << 0x00000000 ));
  radeon_add_legacy_connector(dev, 0, (0x1L << 0x00000000 ),
         1, &ddc_i2c,
         0x05,
         &hpd);
 ...
 case CT_SAM440EP:
  ...
  radeon_add_legacy_encoder(dev,
       radeon_get_encoder_enum(dev,
        ...
        2),
       (0x1L << 0x00000002 ));
  radeon_add_legacy_connector(dev, 3, (0x1L << 0x00000002 ),
         6,
         &ddc_i2c,
         0x07,
         &hpd);
...
static _Bool radeon_apply_legacy_quirks(struct drm_device *dev,
           int bios_index,
           enum radeon_combios_connector
           *legacy_connector,
           struct radeon_i2c_bus_rec *ddc_i2c,
...
static _Bool radeon_apply_legacy_tv_quirks(struct drm_device *dev)
{
...
static uint16_t combios_check_dl_dvi(struct drm_device *dev, int is_dvi_d)
{
 ...
 if (ext_tmds_info) {
  uint8_t rev = (rdev->bios[ext_tmds_info]);
  uint8_t flags = (rdev->bios[ext_tmds_info + 4 + 5]);
  if (rev >= 3) {
   if (is_dvi_d)
    return 0x04;
   else
...
_Bool radeon_get_legacy_connector_info_from_bios(struct drm_device *dev)
{
 ...
 if (conn_info) {
  for (i = 0; i < 4; i++) {
   ...
   if (!((rdev->bios[entry]) | ((rdev->bios[(entry)+1]) << 8)))
    break;

   tmp = ((rdev->bios[entry]) | ((rdev->bios[(entry)+1]) << 8));
   ...
   case CONNECTOR_PROPRIETARY_LEGACY:
    if ((tmp >> 4) & 0x1)
     devices = (0x1L << 0x00000007 );
    else
     devices = (0x1L << 0x00000003 );
    radeon_add_legacy_encoder(dev,
   ...
   case CONNECTOR_STV_LEGACY:
    ...
    break;
   default:
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown connector type: %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , connector);
 ...
 if (rdev->flags & RADEON_IS_MOBILITY || rdev->flags & RADEON_IS_IGP) {
  ...
  if (lcd_info) {
   ...
   if (lcd_ddc_info) {
    ddc_type = (rdev->bios[lcd_ddc_info + 2]);
    switch (ddc_type) {
    case DDC_LCD:
     ddc_i2c =
      combios_setup_i2c_bus(rdev,
              DDC_LCD,
              ((((rdev->bios[lcd_ddc_info + 3]) | ((rdev->bios[(lcd_ddc_info + 3)+1]) << 8))) | (((rdev->bios[(lcd_ddc_info + 3)+2]) | ((rdev->bios[((lcd_ddc_info + 3)+2)+1]) << 8)) << 16)),
              ((((rdev->bios[lcd_ddc_info + 7]) | ((rdev->bios[(lcd_ddc_info + 7)+1]) << 8))) | (((rdev->bios[(lcd_ddc_info + 7)+2]) | ((rdev->bios[((lcd_ddc_info + 7)+2)+1]) << 8)) << 16)));
...
# 2639 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
void radeon_combios_get_power_modes(struct radeon_device *rdev)
{
 struct drm_device *dev = rdev->ddev;
 ...
 rdev->pm.power_state = kzalloc(sizeof(struct radeon_power_state) * 2, (0x0001 | 0x0004));
 if (rdev->pm.power_state) {

  rdev->pm.power_state[0].clock_info =
   kzalloc(sizeof(struct radeon_pm_clock_info) * 1, (0x0001 | 0x0004));
 ...
 if (offset) {
  ...
  rev = (rdev->bios[offset]);

  if (rev == 0) {
   thermal_controller = (rdev->bios[offset + 3]);
   gpio = (rdev->bios[offset + 4]) & 0x3f;
   i2c_addr = (rdev->bios[offset + 5]);
  } else if (rev == 1) {
   thermal_controller = (rdev->bios[offset + 4]);
   gpio = (rdev->bios[offset + 5]) & 0x3f;
   i2c_addr = (rdev->bios[offset + 6]);
  } else if (rev == 2) {
   thermal_controller = (rdev->bios[offset + 4]);
   gpio = (rdev->bios[offset + 5]) & 0x3f;
   i2c_addr = (rdev->bios[offset + 6]);
   clk_bit = (rdev->bios[offset + 0xa]);
   data_bit = (rdev->bios[offset + 0xb]);
  }
...
# 2709 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
  }
 } else {
  ...
  if ((dev->pdev->device == 0x4152) &&
   ...
   i2c_bus = combios_setup_i2c_bus(rdev, DDC_MONID, 0, 0);
   rdev->pm.i2c_bus = radeon_i2c_lookup(rdev, &i2c_bus);
# 2730 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
  }
 }
 ...
 if (rdev->flags & RADEON_IS_MOBILITY) {
  ...
  if (offset) {
   rev = (rdev->bios[offset]);
   blocks = (rdev->bios[offset + 0x2]);

   rdev->pm.power_state[state_index].num_clock_modes = 1;
   rdev->pm.power_state[state_index].clock_info[0].mclk = ((((rdev->bios[offset + 0x5 + 0x2]) | ((rdev->bios[(offset + 0x5 + 0x2)+1]) << 8))) | (((rdev->bios[(offset + 0x5 + 0x2)+2]) | ((rdev->bios[((offset + 0x5 + 0x2)+2)+1]) << 8)) << 16));
   rdev->pm.power_state[state_index].clock_info[0].sclk = ((((rdev->bios[offset + 0x5 + 0x6]) | ((rdev->bios[(offset + 0x5 + 0x6)+1]) << 8))) | (((rdev->bios[(offset + 0x5 + 0x6)+2]) | ((rdev->bios[((offset + 0x5 + 0x6)+2)+1]) << 8)) << 16));
   if ((rdev->pm.power_state[state_index].clock_info[0].mclk == 0) ||
       (rdev->pm.power_state[state_index].clock_info[0].sclk == 0))
    goto default_mode;
   rdev->pm.power_state[state_index].type =
    POWER_STATE_TYPE_BATTERY;
   misc = ((rdev->bios[offset + 0x5 + 0x0]) | ((rdev->bios[(offset + 0x5 + 0x0)+1]) << 8));
   if (rev > 4)
    misc2 = ((rdev->bios[offset + 0x5 + 0xe]) | ((rdev->bios[(offset + 0x5 + 0xe)+1]) << 8));
   ...
   if (misc & 0x4) {
    ...
    if (rev < 6) {
     rdev->pm.power_state[state_index].clock_info[0].voltage.gpio.reg64 =
      ((rdev->bios[offset + 0x5 + 0xb]) | ((rdev->bios[(offset + 0x5 + 0xb)+1]) << 8)) * 4;
     tmp = (rdev->bios[offset + 0x5 + 0xd]);
     rdev->pm.power_state[state_index].clock_info[0].voltage.gpio.mask = (1 << tmp);
    } else {
     u8 entries = (rdev->bios[offset + 0x5 + 0xb]);
     u16 voltage_table_offset = ((rdev->bios[offset + 0x5 + 0xc]) | ((rdev->bios[(offset + 0x5 + 0xc)+1]) << 8));
     if (entries && voltage_table_offset) {
      rdev->pm.power_state[state_index].clock_info[0].voltage.gpio.reg64 =
       ((rdev->bios[voltage_table_offset]) | ((rdev->bios[(voltage_table_offset)+1]) << 8)) * 4;
      tmp = (rdev->bios[voltage_table_offset + 0x2]);
      rdev->pm.power_state[state_index].clock_info[0].voltage.gpio.mask = (1 << tmp);
     } else
   ...
   if (rev > 6)
    rdev->pm.power_state[state_index].pcie_lanes =
     (rdev->bios[offset + 0x5 + 0x10]);
   rdev->pm.power_state[state_index].flags = (1 << 0);
   state_index++;
  } else {
...
void radeon_external_tmds_setup(struct drm_encoder *encoder)
{
 ...
 case DVO_SIL164:
  ...
  break;
 case DVO_SIL1178:
# 2880 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
  break;
 default:
  break;
 }
...
_Bool radeon_combios_external_tmds_setup(struct drm_encoder *encoder)
{
 ...
 uint32_t index, id;
 uint32_t reg64, val, and_mask, or_mask;
 struct radeon_encoder_ext_tmds *tmds = radeon_encoder->enc_priv;
 ...
 if (rdev->flags & RADEON_IS_IGP) {
  ...
  if (offset) {
   rev = (rdev->bios[offset]);
   if (rev > 1) {
    blocks = (rdev->bios[offset + 3]);
    index = offset + 4;
    while (blocks > 0) {
     id = ((rdev->bios[index]) | ((rdev->bios[(index)+1]) << 8));
     index += 2;
     switch (id >> 13) {
     case 0:
      reg64 = (id & 0x1fff) * 4;
      val = ((((rdev->bios[index]) | ((rdev->bios[(index)+1]) << 8))) | (((rdev->bios[(index)+2]) | ((rdev->bios[((index)+2)+1]) << 8)) << 16));
      index += 4;
      r100_mm_wreg(rdev, (reg64), (val), 0);
      break;
     case 2:
      reg64 = (id & 0x1fff) * 4;
      and_mask = ((((rdev->bios[index]) | ((rdev->bios[(index)+1]) << 8))) | (((rdev->bios[(index)+2]) | ((rdev->bios[((index)+2)+1]) << 8)) << 16));
      index += 4;
      or_mask = ((((rdev->bios[index]) | ((rdev->bios[(index)+1]) << 8))) | (((rdev->bios[(index)+2]) | ((rdev->bios[((index)+2)+1]) << 8)) << 16));
      index += 4;
      ...
      break;
     case 3:
      val = ((rdev->bios[index]) | ((rdev->bios[(index)+1]) << 8));
      index += 2;
      udelay(val);
      break;
     case 4:
     ...
     case 6:
      ...
      break;
     default:
      printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown id %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , id >> 13);
      break;
     }
     blocks--;
    }
  ...
  if (offset) {
   ...
   while (id != 0xffff) {
    ...
    case 5:
     ...
     or_mask = ((((rdev->bios[index]) | ((rdev->bios[(index)+1]) << 8))) | (((rdev->bios[(index)+2]) | ((rdev->bios[((index)+2)+1]) << 8)) << 16));
     index += 4;
     val = rdev->pll_rreg(rdev, (reg64));
     val = (val & and_mask) | or_mask;
     rdev->pll_wreg(rdev, (reg64), (val));
     break;
    case 6:
     reg64 = id & 0x1fff;
     val = (rdev->bios[index]);
...
static void combios_parse_mmio_table(struct drm_device *dev, uint16_t offset)
{
 ...
 if (offset) {
  while (((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8))) {
   uint16_t cmd = ((((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8)) & 0xe000) >> 13);
   uint32_t addr = (((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8)) & 0x1fff);
   ...
   switch (cmd) {
   case 0:
    val = ((((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8))) | (((rdev->bios[(offset)+2]) | ((rdev->bios[((offset)+2)+1]) << 8)) << 16));
    offset += 4;
    r100_mm_wreg(rdev, (addr), (val), 0);
    break;
   case 1:
    val = ((((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8))) | (((rdev->bios[(offset)+2]) | ((rdev->bios[((offset)+2)+1]) << 8)) << 16));
    offset += 4;
    ...
    break;
   case 2:
    and_mask = ((((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8))) | (((rdev->bios[(offset)+2]) | ((rdev->bios[((offset)+2)+1]) << 8)) << 16));
    offset += 4;
    or_mask = ((((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8))) | (((rdev->bios[(offset)+2]) | ((rdev->bios[((offset)+2)+1]) << 8)) << 16));
    offset += 4;
    tmp = r100_mm_rreg(rdev, (addr), 0);
    tmp &= and_mask;
    tmp |= or_mask;
    r100_mm_wreg(rdev, (addr), (tmp), 0);
    break;
   case 3:
    and_mask = ((((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8))) | (((rdev->bios[(offset)+2]) | ((rdev->bios[((offset)+2)+1]) << 8)) << 16));
    offset += 4;
    ...
    break;
   case 4:
    val = ((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8));
    offset += 2;
    udelay(val);
    break;
   case 5:
...
static void combios_parse_pll_table(struct drm_device *dev, uint16_t offset)
{
 ...
 if (offset) {
  while ((rdev->bios[offset])) {
   uint8_t cmd = (((rdev->bios[offset]) & 0xc0) >> 6);
   uint8_t addr = ((rdev->bios[offset]) & 0x3f);
   ...
   case 0:
    val = ((((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8))) | (((rdev->bios[(offset)+2]) | ((rdev->bios[((offset)+2)+1]) << 8)) << 16));
    offset += 4;
    rdev->pll_wreg(rdev, (addr), (val));
    break;
   case 1:
    shift = (rdev->bios[offset]) * 8;
    offset++;
    and_mask = (rdev->bios[offset]) << shift;
    and_mask |= ~(0xff << shift);
    offset++;
    or_mask = (rdev->bios[offset]) << shift;
    offset++;
    tmp = rdev->pll_rreg(rdev, (addr));
    tmp &= and_mask;
    tmp |= or_mask;
    rdev->pll_wreg(rdev, (addr), (tmp));
    break;
   case 2:
   case 3:
    tmp = 1000;
    ...
    case 5:
     tmp =
         rdev->pll_rreg(rdev, (0x0014));
     if (tmp & (1 << 24)) {
# 3169 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_combios.c"
      rdev->pll_wreg(rdev, (0x0014), (tmp & ~(1 << 24)));
 ...
 if (offset) {
  ...
  while (val != 0xff) {
   ...
   if (val == 0x0f) {
    ...
    uint32_t or_mask = ((rdev->bios[offset]) | ((rdev->bios[(offset)+1]) << 8));
    offset += 2;

    tmp = r100_mm_rreg(rdev, (0x0158), 0);
    tmp &= 0xffff0000;
    tmp |= or_mask;
    r100_mm_wreg(rdev, (0x0158), (tmp), 0);
       ...
       int mem_addr_mapping)
{
 ...
 mem_cntl = r100_mm_rreg(rdev, (0x0140), 0);
 if (mem_cntl & (1 << 3))
  ram /= 2;
 mem_size = ram;
 mem_cntl &= ~(0xff << 8);
 mem_cntl |= (mem_addr_mapping & 0xff) << 8;
 r100_mm_wreg(rdev, (0x0140), (mem_cntl), 0);
 r100_mm_rreg(rdev, (0x0140), 0);
 ...
 while (ram--) {
  ...
  r100_mm_wreg(rdev, ((addr) | (1 << 31)), (0xdeadbeef), 1);

  if (r100_mm_rreg(rdev, ((addr) | (1 << 31)), 1) != 0xdeadbeef)
   return 0;
 }
...
static void combios_write_ram_size(struct drm_device *dev)
{
 ...
 if (offset) {
  rev = (rdev->bios[offset]);
  if (rev < 3) {
   mem_cntl = ((((rdev->bios[offset + 1]) | ((rdev->bios[(offset + 1)+1]) << 8))) | (((rdev->bios[(offset + 1)+2]) | ((rdev->bios[((offset + 1)+2)+1]) << 8)) << 16));
   mem_size = ((rdev->bios[offset + 5]) | ((rdev->bios[(offset + 5)+1]) << 8));
   if ((rdev->family < CHIP_R200) &&
       !((rdev->pdev->device == 0x515e) || (rdev->pdev->device == 0x5969)))
    r100_mm_wreg(rdev, (0x0140), (mem_cntl), 0);
  }
 }
 ...
 mem_size *= (1024 * 1024);
 r100_mm_wreg(rdev, (0x00f8), (mem_size), 0);
}
...
void radeon_combios_initialize_bios_scratch_regs(struct drm_device *dev)
{
 ...
 bios_0_scratch = r100_mm_rreg(rdev, (0x0010), 0);
 bios_6_scratch = r100_mm_rreg(rdev, (0x0028), 0);
 bios_7_scratch = r100_mm_rreg(rdev, (0x002c), 0);
 ...
 r100_mm_wreg(rdev, (0x0010), (bios_0_scratch), 0);
 r100_mm_wreg(rdev, (0x0028), (bios_6_scratch), 0);
 r100_mm_wreg(rdev, (0x002c), (bios_7_scratch), 0);
}

void radeon_combios_output_lock(struct drm_encoder *encoder, _Bool lock)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
          ...
          _Bool connected)
{
 ...
 struct radeon_connector *radeon_connector =
     ({ __typeof( ((struct radeon_connector *)0)->base ) *__mptr = (connector); (struct radeon_connector *)( (char *)__mptr - __builtin_offsetof(struct radeon_connector, base) );});
 struct radeon_encoder *radeon_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 uint32_t bios_4_scratch = r100_mm_rreg(rdev, (0x0020), 0);
 uint32_t bios_5_scratch = r100_mm_rreg(rdev, (0x0024), 0);

 if ((radeon_encoder->devices & (0x1L << 0x00000002 )) &&
     (radeon_connector->devices & (0x1L << 0x00000002 ))) {
  if (connected) {
   do { } while( 0);
 ...
 if ((radeon_encoder->devices & (0x1L << 0x00000001 )) &&
     (radeon_connector->devices & (0x1L << 0x00000001 ))) {
  if (connected) {
   do { } while( 0);
   bios_4_scratch |= (1 << 2);
   bios_5_scratch |= (1 << 0);
 ...
 if ((radeon_encoder->devices & (0x1L << 0x00000000 )) &&
     (radeon_connector->devices & (0x1L << 0x00000000 ))) {
  if (connected) {
   do { } while( 0);
   bios_4_scratch |= (2 << 0);
   bios_5_scratch |= (1 << 1);
 ...
 if ((radeon_encoder->devices & (0x1L << 0x00000004 )) &&
     (radeon_connector->devices & (0x1L << 0x00000004 ))) {
  if (connected) {
   do { } while( 0);
   bios_4_scratch |= (2 << 8);
   bios_5_scratch |= (1 << 5);
 ...
 if ((radeon_encoder->devices & (0x1L << 0x00000003 )) &&
     (radeon_connector->devices & (0x1L << 0x00000003 ))) {
  if (connected) {
   do { } while( 0);
   bios_4_scratch |= (1 << 3);
   bios_5_scratch |= (1 << 3);
 ...
 if ((radeon_encoder->devices & (0x1L << 0x00000007 )) &&
     (radeon_connector->devices & (0x1L << 0x00000007 ))) {
  if (connected) {
   do { } while( 0);
   bios_4_scratch |= (1 << 11);
   bios_5_scratch |= (1 << 7);
 ...
 r100_mm_wreg(rdev, (0x0020), (bios_4_scratch), 0);
 r100_mm_wreg(rdev, (0x0024), (bios_5_scratch), 0);
}
...
radeon_combios_encoder_crtc_scratch_regs(struct drm_encoder *encoder, int crtc)
{
 ...
 if (radeon_encoder->devices & (0x1L << 0x00000002 )) {
  bios_5_scratch &= ~(1 << 10);
  bios_5_scratch |= (crtc << 10);
 }
 if (radeon_encoder->devices & (0x1L << 0x00000000 )) {
  bios_5_scratch &= ~(1 << 9);
  bios_5_scratch |= (crtc << 9);
 }
 if (radeon_encoder->devices & (0x1L << 0x00000004 )) {
  bios_5_scratch &= ~(1 << 12);
  bios_5_scratch |= (crtc << 12);
 }
 if (radeon_encoder->devices & (0x1L << 0x00000001 )) {
  bios_5_scratch &= ~(1 << 8);
  bios_5_scratch |= (crtc << 8);
 }
 if (radeon_encoder->devices & (0x1L << 0x00000003 )) {
  bios_5_scratch &= ~(1 << 11);
  bios_5_scratch |= (crtc << 11);
 }
 if (radeon_encoder->devices & (0x1L << 0x00000007 )) {
  bios_5_scratch &= ~(1 << 14);
  bios_5_scratch |= (crtc << 14);
 }
 r100_mm_wreg(rdev, (0x0024), (bios_5_scratch), 0);
}
...
radeon_combios_encoder_dpms_scratch_regs(struct drm_encoder *encoder, _Bool on)
{
 ...
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_encoder *radeon_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 uint32_t bios_6_scratch = r100_mm_rreg(rdev, (0x0028), 0);
 ...
 if (radeon_encoder->devices & (((0x1L << 0x00000000 ) | (0x1L << 0x00000004 )))) {
  if (on)
   bios_6_scratch |= (1 << 21);
  else
   bios_6_scratch &= ~(1 << 21);
 ...
 if (radeon_encoder->devices & (((0x1L << 0x00000003 ) | (0x1L << 0x00000007 ) | (0x1L << 0x00000009 ) | (0x1L << 0x0000000A ) | (0x1L << 0x0000000B ) | (0x1L << 0x00000006 )))) {
  if (on)
   bios_6_scratch |= (1 << 23);
  else
   bios_6_scratch &= ~(1 << 23);
