# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c"
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/pf.h" 1
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c" 2
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c" 2
...
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c" 2
...
# 83 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c" 2
...
void pf_send_tcp(const struct pf_rule *, sa_family_t,
       ...
       u_int8_t, u_int16_t, u_int16_t, u_int8_t, int,
       u_int16_t, u_int);
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c" 2
# 130 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pfkeyv2_parsemessage.c"
uint64_t sadb_exts_allowed_in[16 +1] =
{
 ...
 (1LL << 1) | ((1LL << 2) | (1LL << 3) | (1LL << 4)) | ((1LL << 5) | (1LL << 6)) | (1LL << 7) | ((1LL << 8) | (1LL << 9)) | ((1LL << 10) | (1LL << 11)) | ((1LL << 17) | (1LL << 18) | (1LL << 19) | (1LL << 21) | (1LL << 22) | (1LL << 20)) | (1LL << 31) | (1LL << 33) | (1LL << 34),
 ...
 (1LL << 1) | (1LL << 23) | (1LL << 24) | (1LL << 6) | (1LL << 35),
...
uint64_t sadb_exts_allowed_out[16 +1] =
{
 ...
 (1LL << 1) | ((1LL << 2) | (1LL << 3) | (1LL << 4)) | ((1LL << 5) | (1LL << 6)) | (1LL << 7) | ((1LL << 10) | (1LL << 11)) | ((1LL << 17) | (1LL << 18) | (1LL << 19) | (1LL << 21) | (1LL << 22) | (1LL << 20)) | (1LL << 31) | (1LL << 33) | (1LL << 34),
...
pfkeyv2_parsemessage(void *p, int len, void **headers)
{
 ...
 __builtin_bzero((headers), ((35 + 1) * sizeof(void *)));
 ...
 if (sadb_msg->sadb_msg_pid != (__curcpu->ci_self)->ci_curproc->p_p->ps_pid) {
  ;
  return (22);
 }
  ...
  case 24:
  {
   ...
   case 2:
...

    {
     ...
     __builtin_bzero((zero), (sizeof(zero)));

     if (__builtin_bcmp((&((struct sockaddr_in *)sa)->sin_zero), (zero), (sizeof(zero)))) {
      ;
