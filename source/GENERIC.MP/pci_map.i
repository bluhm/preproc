# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c" 2
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c"
...
int
obsd_pci_io_find(pci_chipset_tag_t pc, pcitag_t tag, int reg64, pcireg_t type,
...
# 93 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c"
 s = _splraise(15);
 ...
 if ((((mask) & 0xfffffffe) & -((mask) & 0xfffffffe)) == 0) {
 ...
 if (basep != 0)
  *basep = ((address) & 0xfffffffe);
 if (sizep != 0)
  *sizep = (((mask) & 0xfffffffe) & -((mask) & 0xfffffffe));
 if (flagsp != 0)
  *flagsp = 0;
...
int
obsd_pci_mem_find(pci_chipset_tag_t pc, pcitag_t tag, int reg64, pcireg_t type,
    bus_addr_t *basep, bus_size_t *sizep, int *flagsp)
{
 ...
 is64bit = (((type) & 0x00000006) == 0x00000004);
 ...
 if (is64bit && (reg64 + 4) >= 0x28)
  panic("pci_mem_find: bad 64-bit request");
# 164 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c"
 s = _splraise(15);
 csr = pci_conf_read(pc, tag, 0x04);
 if (csr & 0x00000002)
  pci_conf_write(pc, tag, 0x04,
      csr & ~0x00000002);
 address = pci_conf_read(pc, tag, reg64);
 pci_conf_write(pc, tag, reg64, 0xfffffff0);
 mask = pci_conf_read(pc, tag, reg64);
 pci_conf_write(pc, tag, reg64, address);
 if (is64bit) {
  address1 = pci_conf_read(pc, tag, reg64 + 4);
  pci_conf_write(pc, tag, reg64 + 4, 0xffffffff);
  mask1 = pci_conf_read(pc, tag, reg64 + 4);
  pci_conf_write(pc, tag, reg64 + 4, address1);
 }
 if (csr & 0x00000002)
  pci_conf_write(pc, tag, 0x04, csr);
 _splx(s);

 if (((address) & 0x00000001) != 0x00000000) {
 ...
 if (type != -1 &&
     ((address) & 0x00000006) != ((type) & 0x00000006)) {
 ...
 if ((is64bit && (((wmask) & 0xfffffffffffffff0ULL) & -((wmask) & 0xfffffffffffffff0ULL)) == 0) ||
     (!is64bit && (((mask) & 0xfffffff0) & -((mask) & 0xfffffff0)) == 0)) {
 ...
 if (sizeof(u_int64_t) > sizeof(bus_addr_t)) {
  if (basep != 0)
   *basep = ((address) & 0xfffffff0);
  if (sizep != 0)
   *sizep = (((mask) & 0xfffffff0) & -((mask) & 0xfffffff0));
 } else {
  if (basep != 0)
   *basep = ((waddress) & 0xfffffffffffffff0ULL);
  if (sizep != 0)
   *sizep = (((wmask) & 0xfffffffffffffff0ULL) & -((wmask) & 0xfffffffffffffff0ULL));
 }
 if (flagsp != 0)
  *flagsp =
      (((address) & 0x00000008) != 0) ?
        0x0008 : 0;
...
int
pci_io_find(pci_chipset_tag_t pc, pcitag_t pcitag, int reg64,
    bus_addr_t *iobasep, bus_size_t *iosizep)
{
 return (obsd_pci_io_find(pc, pcitag, reg64, 0, iobasep, iosizep, 0));
}

int
pci_mem_find(pci_chipset_tag_t pc, pcitag_t pcitag, int reg64,
    bus_addr_t *membasep, bus_size_t *memsizep, int *cacheablep)
{
 return (obsd_pci_mem_find(pc, pcitag, reg64, -1, membasep, memsizep,
      cacheablep));
}

pcireg_t
pci_mapreg_type(pci_chipset_tag_t pc, pcitag_t tag, int reg64)
{
 return ((((pci_conf_read(pc, tag, reg64)) & 0x00000001) == 0x00000001 ? pci_conf_read(pc, tag, reg64) & 0x00000001 : pci_conf_read(pc, tag, reg64) & (0x00000001|0x00000006)));
}

int
pci_mapreg_probe(pci_chipset_tag_t pc, pcitag_t tag, int reg64, pcireg_t *typep)
{
 pcireg_t address, mask, csr;
 int s;
 ...
 if (typep)
  *typep = (((address) & 0x00000001) == 0x00000001 ? address & 0x00000001 : address & (0x00000001|0x00000006));
 return (1);
}

int
pci_mapreg_info(pci_chipset_tag_t pc, pcitag_t tag, int reg64, pcireg_t type,
    bus_addr_t *basep, bus_size_t *sizep, int *flagsp)
{

 if (((type) & 0x00000001) == 0x00000001)
  return (obsd_pci_io_find(pc, tag, reg64, type, basep, sizep,
      flagsp));
 else
  return (obsd_pci_mem_find(pc, tag, reg64, type, basep, sizep,
      flagsp));
}

int
pci_mapreg_map(struct pci_attach_args *pa, int reg64, pcireg_t type, int flags,
    ...
    bus_size_t *sizep, bus_size_t maxsize)
{
 ...
 if ((rv = pci_mapreg_info(pa->pa_pc, pa->pa_tag, reg64, type,
     &base, &size, ((void *)0))) != 0)
  return (rv);
# 363 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pci_map.c"
 ...
 csr |= 0x00000004;
 pci_conf_write(pa->pa_pc, pa->pa_tag, 0x04, csr);

 if (((type) & 0x00000001) == 0x00000001) {
  if ((pa->pa_flags & 0x01) == 0)
   return (22);
  tag = pa->pa_iot;
 } else {
  if ((pa->pa_flags & 0x02) == 0)
   return (22);
  tag = pa->pa_memt;
 }
