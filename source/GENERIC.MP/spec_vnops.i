# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
int udf_disklabelspoof(dev_t dev, void (*strat)(struct buf *),
 struct disklabel *lp);
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c" 2
...
spec_open(void *v)
{
 ...
 struct vnode *bvp;
 dev_t bdev;
 dev_t dev = (dev_t)vp->v_un.vu_specinfo->si_rdev;
 int maj = ((int32_t)(((u_int32_t)(dev) >> 8) & 0xff));
 int error;




 if (vp->v_mount && (vp->v_mount->mnt_flag & 0x00000010))
  return (6);
 ...
 case VCHR:
  if ((u_int)maj >= nchrdev)
   return (6);
  if (ap->a_cred != ((struct ucred *)-2) && (ap->a_mode & 0x0002)) {




   if (securelevel >= 2 && cdevsw[maj].d_type == 1)
    return (1);
 ...
 case VBLK:
  ...
  if (securelevel >= 2 && ap->a_cred != ((struct ucred *)-2) &&
      (ap->a_mode & 0x0002) && bdevsw[maj].d_type == 1)
   return (1);
  ...
  if ((error = vfs_mountedon(vp)) != 0)
   return (error);
  return ((*bdevsw[maj].d_open)(dev, ap->a_mode, 0060000, p));
 case VNON:
 case VLNK:
 case VDIR:
 case VREG:
...
spec_read(void *v)
{
 ...
 case VBLK:
  if (uio->uio_offset < 0)
   return (22);
  bsize = (1 << 13);
  if ((majordev = ((int32_t)(((u_int32_t)(vp->v_un.vu_specinfo->si_rdev) >> 8) & 0xff))) < nblkdev &&
      (ioctl = bdevsw[majordev].d_ioctl) != ((void *)0) &&
      (*ioctl)(vp->v_un.vu_specinfo->si_rdev, ((unsigned long)0x80000000 | ((sizeof(struct partinfo) & 0x1fff) << 16) | ((('d')) << 8) | ((104))), (caddr_t)&dpart, 0x0001, p) == 0) {
   u_int32_t frag =
       ((dpart.part->p_fragblock) == 0 ? 0 : (1 << (((dpart.part->p_fragblock) & 0x07) - 1)));
   u_int32_t fsize =
       (((dpart.part->p_fragblock) == 0 ? 0 : (1 << (((dpart.part->p_fragblock) & 0x07) - 1))) == 0 ? 0 : (((dpart.part->p_fragblock) == 0 ? 0 : (1 << (((dpart.part->p_fragblock) >> 3) + 12))) / ((dpart.part->p_fragblock) == 0 ? 0 : (1 << (((dpart.part->p_fragblock) & 0x07) - 1)))));
   if (dpart.part->p_fstype == 7 && frag != 0 &&
       fsize != 0)
    bsize = frag * fsize;
  }
  bscale = ((bsize) >> 9);
  do {
   bn = ((uio->uio_offset) >> 9) & ~(bscale - 1);
   on = uio->uio_offset % bsize;
   n = ulmin((bsize - on), uio->uio_resid);
   if (vp->v_un.vu_specinfo->si_lastr + bscale == bn) {
    nextbn = bn + bscale;
    error = breadn(vp, bn, bsize, &nextbn, &bsize,
        1, &bp);
   } else
    error = bread(vp, bn, bsize, &bp);
   vp->v_un.vu_specinfo->si_lastr = bn;
...
spec_ioctl(void *v)
{
 ...
 dev_t dev = ap->a_vp->v_un.vu_specinfo->si_rdev;
 int maj = ((int32_t)(((u_int32_t)(dev) >> 8) & 0xff));
...
spec_poll(void *v)
{
 ...
 default:
  return (ap->a_events &
      (0x0001 | 0x0004 | 0x0040 | 0x0004));

 case VCHR:
  dev = ap->a_vp->v_un.vu_specinfo->si_rdev;
  return (*cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_poll)(dev, ap->a_events, ap->a_p);
 }
}
int
spec_kqfilter(void *v)
{
 ...
 if (cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_kqfilter)
  return (*cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_kqfilter)(dev, ap->a_kn);
 return (45);
}
...
spec_strategy(void *v)
{
 ...
 int maj = ((int32_t)(((u_int32_t)(bp->b_dev) >> 8) & 0xff));
...
spec_close(void *v)
{
 ...
 case VCHR:
# 498 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c"
  if (vcount(vp) == 2 && p != ((void *)0) && p->p_p->ps_pgrp &&
      vp == p->p_p->ps_pgrp->pg_session->s_ttyvp) {
   vrele(vp);
   p->p_p->ps_pgrp->pg_session->s_ttyvp = ((void *)0);
  }
  if (cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_flags & 0x0001)
  ...
  if (vcount(vp) > 1 && (vp->v_flag & 0x0100) == 0)
   return (0);
  devclose = cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_close;
  mode = 0020000;
  break;
 ...
 case VBLK:
  ...
  if (error)
   return (error);
# 540 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c"
  if (vcount(vp) > 1 && (vp->v_flag & 0x0100) == 0)
   return (0);
  devclose = bdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))].d_close;
  mode = 0060000;
  break;
...
spec_getattr(void *v)
{
 ...
 return (VOP_GETATTR(vp->v_un.vu_specinfo->si_ci.ci_parent, ap->a_vap, ap->a_cred, ap->a_p));
}
...
spec_access(void *v)
{
 ...
 return (VOP_ACCESS(vp->v_un.vu_specinfo->si_ci.ci_parent, ap->a_mode, ap->a_cred, ap->a_p));
}
...
spec_print(void *v)
{
 ...
 printf("tag VT_NON, dev %d, %d\n", ((int32_t)(((u_int32_t)(ap->a_vp->v_un.vu_specinfo->si_rdev) >> 8) & 0xff)),
  ((int32_t)((ap->a_vp->v_un.vu_specinfo->si_rdev) & 0xff) | (((ap->a_vp->v_un.vu_specinfo->si_rdev) & 0xffff0000) >> 8)));
 return 0;
}
...
spec_advlock(void *v)
{
 ...
 return (lf_advlock(&vp->v_un.vu_specinfo->si_lockf, (off_t)0, ap->a_id,
...
# 698 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/spec_vnops.c"
int
spec_open_clone(struct vop_open_args *ap)
{
 ...
 if (((int32_t)((vp->v_un.vu_specinfo->si_rdev) & 0xff) | (((vp->v_un.vu_specinfo->si_rdev) & 0xffff0000) >> 8)) >= (1 << 8))
  return (6);

 for (i = 1; i < 128 * 8; i++)
  if ((((vp->v_un.vu_specinfo->si_ci.ci_bitmap)[(i)>>3] & (1<<((i)&(8 -1)))) == 0)) {
 ...
 error = cdevvp(((dev_t)((((((int32_t)(((u_int32_t)(vp->v_un.vu_specinfo->si_rdev) >> 8) & 0xff))) & 0xff) << 8) | (((i << 8) | ((int32_t)((vp->v_un.vu_specinfo->si_rdev) & 0xff) | (((vp->v_un.vu_specinfo->si_rdev) & 0xffff0000) >> 8))) & 0xff) | ((((i << 8) | ((int32_t)((vp->v_un.vu_specinfo->si_rdev) & 0xff) | (((vp->v_un.vu_specinfo->si_rdev) & 0xffff0000) >> 8))) & 0xffff00) << 8))), &cvp);
 ...
 cip = malloc(sizeof(struct cloneinfo), 127, 0x0001);
 cip->ci_data = vp->v_data;
 cip->ci_vp = cvp;

 cvp->v_un.vu_specinfo->si_ci.ci_parent = vp;
 vp->v_flag |= 0x0400;
 vp->v_data = cip;
...
spec_close_clone(struct vop_close_args *ap)
{
 ...
 error = cdevsw[((int32_t)(((u_int32_t)(vp->v_un.vu_specinfo->si_rdev) >> 8) & 0xff))].d_close(vp->v_un.vu_specinfo->si_rdev, ap->a_fflag,
     0020000, ap->a_p);
 if (error)
  return (error);

 pvp = vp->v_un.vu_specinfo->si_ci.ci_parent;
 ((pvp->v_un.vu_specinfo->si_ci.ci_bitmap)[(((int32_t)((vp->v_un.vu_specinfo->si_rdev) & 0xff) | (((vp->v_un.vu_specinfo->si_rdev) & 0xffff0000) >> 8)) >> 8)>>3] &= ~(1<<((((int32_t)((vp->v_un.vu_specinfo->si_rdev) & 0xff) | (((vp->v_un.vu_specinfo->si_rdev) & 0xffff0000) >> 8)) >> 8)&(8 -1))));
 vrele(pvp);
