# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/futex.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c" 2
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c"
struct futex {
 struct { struct futex *le_next; struct futex **le_prev; } ft_list;
 struct { struct proc *tqh_first; struct proc **tqh_last; } ft_threads;
 uint32_t *ft_uaddr;
 pid_t ft_pid;
 unsigned int ft_refcnt;
};
...
struct rwlock ftlock = { 0, "futex" };
static struct { struct futex *lh_first; } ftlist;
struct pool ftpool;
...
futex_init(void)
{
 pool_init(&ftpool, sizeof(struct futex), 0, 0, 0, "futexpl",
     ((void *)0));
}
...
sys_futex(struct proc *p, void *v, register_t *retval)
{
 ...
 uint32_t *uaddr = ((uap)->f.be.datum);
 int op = ((uap)->op.be.datum);
 uint32_t val = ((uap)->val.be.datum);
 const struct timespec *timeout = ((uap)->timeout.be.datum);
 void *g = ((uap)->g.be.datum);

 switch (op) {
 case 1:
  _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_futex.c", 100);
  _rw_enter_write(&ftlock );
  *retval = futex_wait(uaddr, val, timeout);
  _rw_exit_write(&ftlock );
  _kernel_unlock();
  break;
 case 2:
  _rw_enter_write(&ftlock );
...
futex_wait(uint32_t *uaddr, uint32_t val, const struct timespec *timeout)
{
 ...
 f = futex_get(uaddr, 0x1);
 do { (p)->p_fut_link.tqe_next = ((void *)0); (p)->p_fut_link.tqe_prev = (&f->ft_threads)->tqh_last; *(&f->ft_threads)->tqh_last = (p); (&f->ft_threads)->tqh_last = &(p)->p_fut_link.tqe_next; } while (0);
 p->p_futex = f;
 ...
 if ((f = p->p_futex) != ((void *)0)) {
  p->p_futex = ((void *)0);
  do { if (((p)->p_fut_link.tqe_next) != ((void *)0)) (p)->p_fut_link.tqe_next->p_fut_link.tqe_prev = (p)->p_fut_link.tqe_prev; else (&f->ft_threads)->tqh_last = (p)->p_fut_link.tqe_prev; *(p)->p_fut_link.tqe_prev = (p)->p_fut_link.tqe_next; ((p)->p_fut_link.tqe_prev) = ((void *)-1); ((p)->p_fut_link.tqe_next) = ((void *)-1); } while (0);
  futex_put(f);
 }
...
futex_requeue(uint32_t *uaddr, uint32_t n, uint32_t *uaddr2, uint32_t m)
{
 ...
 while ((p = ((&f->ft_threads)->tqh_first)) != ((void *)0) && (count < (n + m))) {
  p->p_futex = ((void *)0);
  do { if (((p)->p_fut_link.tqe_next) != ((void *)0)) (p)->p_fut_link.tqe_next->p_fut_link.tqe_prev = (p)->p_fut_link.tqe_prev; else (&f->ft_threads)->tqh_last = (p)->p_fut_link.tqe_prev; *(p)->p_fut_link.tqe_prev = (p)->p_fut_link.tqe_next; ((p)->p_fut_link.tqe_prev) = ((void *)-1); ((p)->p_fut_link.tqe_next) = ((void *)-1); } while (0);
  futex_put(f);
  ...
  if (count < n) {
   wakeup_n((p), 1);
  } else if (uaddr2 != ((void *)0)) {
   g = futex_get(uaddr2, 0x1);
   do { (p)->p_fut_link.tqe_next = ((void *)0); (p)->p_fut_link.tqe_prev = (&g->ft_threads)->tqh_last; *(&g->ft_threads)->tqh_last = (p); (&g->ft_threads)->tqh_last = &(p)->p_fut_link.tqe_next; } while (0);
   p->p_futex = g;
  }
  count++;
 }
...
{
 return futex_requeue(uaddr, n, ((void *)0), 0);
}
