# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c"
...
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
int ddb_sysctl(int *, u_int, void *, size_t *, void *, size_t,
         struct proc *);
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
void device_register(struct device *, void *);
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
int bppopen(dev_t, int, int, struct proc *); int bppclose(dev_t, int, int, struct proc *); int bppread(dev_t, struct uio *, int); int bppwrite(dev_t, struct uio *, int); int bppioctl(dev_t, u_long, caddr_t, int, struct proc *); int bppstop(struct tty *, int); struct tty *bpptty(dev_t); int bpppoll(dev_t, int, struct proc *); paddr_t bppmmap(dev_t, off_t, int); int bppkqfilter(dev_t, struct knote *);
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/sparc64.h" 1
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/sparc64.h"
struct mem_region {
 u_int64_t start;
 u_int64_t size;
};
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/clock_subr.h" 1
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/clock_subr.h"
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c" 2

extern todr_chip_handle_t todr_handle;
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/sbbc.c"
...
struct sbbc_sram_toc {
 ...
 uint32_t toc_ntags;
 struct sbbc_sram_tag toc_tag[32];
};
...
sbbc_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (pci_mapreg_info(pa->pa_pc, pa->pa_tag, 0x10,
     0x00000000, &base, &size, ((void *)0))) {
  printf(": can't find register space\n");
  return;
 }

 if (bus_space_map(sc->sc_iot, base + 0x800000,
     0x6230, 0, &sc->sc_regs_ioh)) {
  printf(": can't map register space\n");
  return;
 }

 if (bus_space_map(sc->sc_iot, base + 0x8e0000,
     0x20, 0, &sc->sc_epld_ioh)) {
  printf(": can't map EPLD registers\n");
  goto unmap_regs;
 }

 if (bus_space_map(sc->sc_iot, base + 0x900000,
     0x20000, 0, &sc->sc_sram_ioh)) {
 ...
 if (OF_getprop(chosen, "iosram", &iosram, sizeof(iosram)) <= 0 ||
     (int)(((pa->pa_tag)>>32)&0xffffffff) != iosram)
  return;
 ...
 unmap_sram:
 bus_space_unmap(sc->sc_iot, sc->sc_sram_ioh, 0x20000);
 unmap_epld:
 bus_space_unmap(sc->sc_iot, sc->sc_sram_ioh, 0x20);
 unmap_regs:
 bus_space_unmap(sc->sc_iot, sc->sc_sram_ioh, 0x6230);
}
...
sbbc_attach_tod(struct sbbc_softc *sc, uint32_t offset)
{
 ...
 if (tod->tod_magic != 0x54443100 ||
     tod->tod_version < 1)
  return;

 handle = malloc(sizeof(struct todr_chip_handle), 2, 0x0002);
 if (handle == ((void *)0))
 ...
 handle->bus_cookie = ((void *)0);
 handle->todr_setwen = ((void *)0);
 todr_handle = handle;
}
...
sbbc_attach_cons(struct sbbc_softc *sc, uint32_t offset)
{
 ...
 if (sc->sc_sram_solscie == ((void *)0) || sc->sc_sram_solscir == ((void *)0) ||
     sc->sc_sram_scsolie == ((void *)0) || sc->sc_sram_scsolir == ((void *)0))
  return;

 cons = (struct sbbc_sram_cons *)(sc->sc_sram + offset);
 if (cons->cons_magic != 0x434f4e00 ||
     cons->cons_version < 1)
  return;
 ...
 sc->sc_cons_si = softintr_establish(6, sbbc_softintr_cons, sc);
 if (sc->sc_cons_si == ((void *)0))
  panic("%s: can't establish soft interrupt",
      sc->sc_dv.dv_xname);

 *sc->sc_sram_solscie |= 0x00000002;
 *sc->sc_sram_scsolie |= 0x00000001 | 0x00000004;
 ...
 if (sgcn_is_input || sgcn_is_output) {
  ...
  for (maj = 0; maj < nchrdev; maj++)
   if (cdevsw[maj].d_open == sbbcopen)
    break;
  cn_tab->cn_dev = ((dev_t)((((maj) & 0xff) << 8) | ((sc->sc_dv.dv_unit) & 0xff) | (((sc->sc_dv.dv_unit) & 0xffff00) << 8)));
...
sbbc_intr_cons(struct sbbc_softc *sc, uint32_t reason)
{
 ...
 if ((reason & 0x00000004) && sc == sbbc_cons_input) {
  if (db_console)
   db_enter();
 }


 if ((reason & 0x00000001) && sc->sc_tty)
