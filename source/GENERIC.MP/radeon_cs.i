# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cs.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cs.c"
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cs.c"
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cs.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cs.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cs.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cs.c" 2
...
static int radeon_cs_parser_relocs(struct radeon_cs_parser *p)
{
 ...
 p->relocs_ptr = kcalloc(p->nrelocs, sizeof(void *), (0x0001 | 0x0004));
 if (p->relocs_ptr == ((void *)0)) {
  return -12;
 }
 p->relocs = kcalloc(p->nrelocs, sizeof(struct radeon_cs_reloc), (0x0001 | 0x0004));
 if (p->relocs == ((void *)0)) {
  return -12;
 }
 for (i = 0; i < p->nrelocs; i++) {
  ...
  if (!duplicate) {
   ...
   if (p->relocs[i].gobj == ((void *)0)) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "gem object lookup failed 0x%x\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r->handle);

    return -2;
   }
   p->relocs_ptr[i] = &p->relocs[i];
   p->relocs[i].robj = ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((p->relocs[i].gobj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
...
static int radeon_cs_get_ring(struct radeon_cs_parser *p, u32 ring, s32 priority)
{
 ...
 switch (ring) {
 default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "unknown ring id: %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ring);
  return -22;
 case 0:
  p->ring = 0;
  break;
...
int radeon_cs_parser_init(struct radeon_cs_parser *p, void *data)
{
 ...
 p->idx = 0;
 p->ib.sa_bo = ((void *)0);
 p->ib.semaphore = ((void *)0);
 p->const_ib.sa_bo = ((void *)0);
 p->const_ib.semaphore = ((void *)0);
 p->chunk_ib_idx = -1;
 p->chunk_relocs_idx = -1;
 p->chunk_flags_idx = -1;
 p->chunk_const_ib_idx = -1;
 p->chunks_array = kcalloc(cs->num_chunks, sizeof(uint64_t), (0x0001 | 0x0004));
 if (p->chunks_array == ((void *)0)) {
  return -12;
 }
 chunk_array_ptr = (uint64_t *)(unsigned long)(cs->chunks);
 if (copyin(chunk_array_ptr, p->chunks_array, sizeof(uint64_t)*cs->num_chunks)) {

  return -14;
 }
 p->cs_flags = 0;
 p->nchunks = cs->num_chunks;
 p->chunks = kcalloc(p->nchunks, sizeof(struct radeon_cs_chunk), (0x0001 | 0x0004));
 if (p->chunks == ((void *)0)) {
  return -12;
 }
 for (i = 0; i < p->nchunks; i++) {
  struct drm_radeon_cs_chunk **chunk_ptr = ((void *)0);
  struct drm_radeon_cs_chunk user_chunk;
  uint32_t *cdata;

  chunk_ptr = (void *)(unsigned long)p->chunks_array[i];
  if (copyin(chunk_ptr, &user_chunk, sizeof(struct drm_radeon_cs_chunk))) {

   return -14;
  }
  p->chunks[i].length_dw = user_chunk.length_dw;
  p->chunks[i].kdata = ((void *)0);
  p->chunks[i].chunk_id = user_chunk.chunk_id;

  if (p->chunks[i].chunk_id == 0x01) {
   p->chunk_relocs_idx = i;
  }
  if (p->chunks[i].chunk_id == 0x02) {
   p->chunk_ib_idx = i;

   if (p->chunks[i].length_dw == 0)
    return -22;
  }
  if (p->chunks[i].chunk_id == 0x04) {
   p->chunk_const_ib_idx = i;

   if (p->chunks[i].length_dw == 0)
    return -22;
  }
  if (p->chunks[i].chunk_id == 0x03) {
   p->chunk_flags_idx = i;
  ...
  p->chunks[i].length_dw = user_chunk.length_dw;
  p->chunks[i].user_ptr = (void *)(unsigned long)user_chunk.chunk_data;

  cdata = (uint32_t *)(unsigned long)user_chunk.chunk_data;
  if ((p->chunks[i].chunk_id == 0x01) ||
      (p->chunks[i].chunk_id == 0x03)) {
   size = p->chunks[i].length_dw * sizeof(uint32_t);
   p->chunks[i].kdata = kmalloc(size, (0x0001 | 0x0004));
   if (p->chunks[i].kdata == ((void *)0)) {
    return -12;
   }
   if (copyin(p->chunks[i].user_ptr, p->chunks[i].kdata, size)) {
 ...
 if (p->rdev) {
  if ((p->cs_flags & 0x02) &&
   ...
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "VM not active on asic!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  ...
  if ((p->rdev->family >= CHIP_TAHITI) &&
      ((p->cs_flags & 0x02) == 0)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "VM required on SI+!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
 ...
 if ((p->chunk_ib_idx != -1) &&
     ((p->cs_flags & 0x02) == 0) &&
     (p->chunks[p->chunk_ib_idx].chunk_id == 0x02)) {
  if (p->chunks[p->chunk_ib_idx].length_dw > (16 * 1024)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "cs IB too big: %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , p->chunks[p->chunk_ib_idx].length_dw);

   return -22;
  }
  if (p->rdev && (p->rdev->flags & RADEON_IS_AGP)) {
   p->chunks[p->chunk_ib_idx].kpage[0] = kmalloc((1 << 13), (0x0001 | 0x0004));
   p->chunks[p->chunk_ib_idx].kpage[1] = kmalloc((1 << 13), (0x0001 | 0x0004));
   if (p->chunks[p->chunk_ib_idx].kpage[0] == ((void *)0) ||
       p->chunks[p->chunk_ib_idx].kpage[1] == ((void *)0)) {
    kfree(p->chunks[p->chunk_ib_idx].kpage[0]);
    kfree(p->chunks[p->chunk_ib_idx].kpage[1]);
    p->chunks[p->chunk_ib_idx].kpage[0] = ((void *)0);
    p->chunks[p->chunk_ib_idx].kpage[1] = ((void *)0);
    return -12;
   }
  }
  ...
  p->chunks[p->chunk_ib_idx].last_page_index =
   ((p->chunks[p->chunk_ib_idx].length_dw * 4) - 1) / (1 << 13);
 }

 return 0;
}
# 313 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_cs.c"
         ...
         struct radeon_cs_parser *parser)
{
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to get ib !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return r;
 }
 parser->ib.length_dw = ib_chunk->length_dw;
 r = (rdev)->asic->ring[(parser->ring)].cs_parse((parser));
 if (r || parser->parser_error) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Invalid command stream !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return r;
 }
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to schedule IB !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 }
 return r;
}
       ...
       struct radeon_vm *vm)
{
 ...
 for (lobj = ({ __typeof( ((__typeof(*lobj) *)0)->tv.head ) *__mptr = ((&parser->validated)->next); (__typeof(*lobj) *)( (char *)__mptr - __builtin_offsetof(__typeof(*lobj), tv.head) );}); &lobj->tv.head != (&parser->validated); lobj = ({ __typeof( ((__typeof(*lobj) *)0)->tv.head ) *__mptr = (lobj->tv.head.next); (__typeof(*lobj) *)( (char *)__mptr - __builtin_offsetof(__typeof(*lobj), tv.head) );})) {
  bo = lobj->bo;
     ...
     struct radeon_cs_parser *parser)
{
 ...
 if (parser->chunk_ib_idx == -1)
  return 0;
 if ((parser->cs_flags & 0x02) == 0)
  return 0;

 if ((rdev->family >= CHIP_TAHITI) &&
     (parser->chunk_const_ib_idx != -1)) {
  ib_chunk = &parser->chunks[parser->chunk_const_ib_idx];
  if (ib_chunk->length_dw > (64 << 10)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "cs IB CONST too big: %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ib_chunk->length_dw);
   return -22;
  }
  r = radeon_ib_get(rdev, parser->ring, &parser->const_ib,
       vm, ib_chunk->length_dw * 4);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to get const ib !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return r;
  }
  parser->const_ib.is_const_ib = 1;
  parser->const_ib.length_dw = ib_chunk->length_dw;

  if (copyin(ib_chunk->user_ptr, parser->const_ib.ptr, ib_chunk->length_dw * 4)) {

   return -14;
  }
  r = (rdev)->asic->ring[(parser->ring)].ib_parse((rdev), (&parser->const_ib));
  if (r) {
   return r;
  }
 }
 ...
 if (copyin(ib_chunk->user_ptr, parser->ib.ptr, ib_chunk->length_dw * 4)) {

  return -14;
 }
 r = (rdev)->asic->ring[(parser->ring)].ib_parse((rdev), (&parser->ib));
 if (r) {
  return r;
 }
...
int radeon_cs_ioctl(struct drm_device *dev, void *data, struct drm_file *filp)
{
 ...
 _rw_enter_read(&rdev->exclusive_lock );
 if (!rdev->accel_working) {
  _rw_exit_read(&rdev->exclusive_lock );
  return -16;
 }

 __builtin_memset((&parser), (0), (sizeof(struct radeon_cs_parser)));
 parser.filp = filp;
 parser.rdev = rdev;
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to initialize parser !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 ...
 if (r) {
  if (r != -4)
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to parse relocation %d!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  radeon_cs_parser_fini(&parser, r);
  _rw_exit_read(&rdev->exclusive_lock );
  r = radeon_cs_handle_lockup(rdev, r);
  return r;
...
int radeon_cs_finish_pages(struct radeon_cs_parser *p)
{
 ...
 for (i = ibc->last_copied_page + 1; i <= ibc->last_page_index; i++) {
  if (i == ibc->last_page_index) {
   size = (ibc->length_dw * 4) % (1 << 13);
   if (size == 0)
    size = (1 << 13);
  }

  if (copyin(ibc->user_ptr + (i * (1 << 13)), p->ib.ptr + (i * ((1 << 13)/4)), size))
...
static int radeon_cs_update_pages(struct radeon_cs_parser *p, int pg_idx)
{
 ...
 int i;
 int size = (1 << 13);
 _Bool copy1 = (p->rdev && (p->rdev->flags & RADEON_IS_AGP)) ?
  0 : 1;

 for (i = ibc->last_copied_page + 1; i < pg_idx; i++) {
  if (copyin(ibc->user_ptr + (i * (1 << 13)), p->ib.ptr + (i * ((1 << 13)/4)), (1 << 13))) {
 ...
 if (copy1)
  ibc->kpage[new_page] = p->ib.ptr + (pg_idx * ((1 << 13) / 4));

 if (copyin(ibc->user_ptr + (pg_idx * (1 << 13)), ibc->kpage[new_page], size)) {
 ...
 if (!copy1)
  __builtin_memcpy(((void *)(p->ib.ptr+(pg_idx*((1 << 13)/4)))), (ibc->kpage[new_page]), (size));
