...
static void ttm_mem_zone_kobj_release(struct kobject *kobj)
{
 struct ttm_mem_zone *zone =
  ({ const __typeof( ((struct ttm_mem_zone *)0)->kobj ) *__mptr = (kobj); (struct ttm_mem_zone *)( (char *)__mptr - __builtin_offsetof(struct ttm_mem_zone, kobj) );});
 do { } while(0);
 kfree(zone);
}
...
{
 struct ttm_mem_global *glob =
  ({ const __typeof( ((struct ttm_mem_global *)0)->kobj ) *__mptr = (kobj); (struct ttm_mem_global *)( (char *)__mptr - __builtin_offsetof(struct ttm_mem_global, kobj) );});
 kfree(glob);
}
...
{
 struct ttm_mem_global *glob =
     ({ const __typeof( ((struct ttm_mem_global *)0)->work ) *__mptr = (work); (struct ttm_mem_global *)( (char *)__mptr - __builtin_offsetof(struct ttm_mem_global, work) );});
...
int ttm_mem_global_init(struct ttm_mem_global *glob)
{
 ...
 int i;
 struct ttm_mem_zone *zone;
 do { (void)(((void *)0)); (void)(0); __mtx_init((&glob->lock), ((((6)) > 0 && ((6)) < 12) ? 12 : ((6)))); } while (0);
