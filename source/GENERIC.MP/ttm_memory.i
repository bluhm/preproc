# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c"
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c"
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_page_alloc.h" 1
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_page_alloc.h"
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_page_alloc.h" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c"
static void ttm_mem_zone_kobj_release(struct kobject *kobj)
{
 struct ttm_mem_zone *zone =
  ({ __typeof( ((struct ttm_mem_zone *)0)->kobj ) *__mptr = (kobj); (struct ttm_mem_zone *)( (char *)__mptr - __builtin_offsetof(struct ttm_mem_zone, kobj) );});

 do { } while(0);

 kfree(zone);
}
# 165 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c"
...
{
 struct ttm_mem_global *glob =
  ({ __typeof( ((struct ttm_mem_global *)0)->kobj ) *__mptr = (kobj); (struct ttm_mem_global *)( (char *)__mptr - __builtin_offsetof(struct ttm_mem_global, kobj) );});
...
static _Bool ttm_zones_above_swap_target(struct ttm_mem_global *glob,
     _Bool from_wq, uint64_t extra)
{
 unsigned int i;
 struct ttm_mem_zone *zone;
 uint64_t target;
...
# 217 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c"
static void ttm_shrink(struct ttm_mem_global *glob, _Bool from_wq,
         uint64_t extra)
{
 int ret;
 struct ttm_mem_shrink *shrink;
...
static int ttm_mem_init_kernel_zone(struct ttm_mem_global *glob,
    uint64_t mem)
{
 struct ttm_mem_zone *zone = kzalloc(sizeof(*zone), (0x0001 | 0x0004));
 int ret;

 if (__builtin_expect(!!(!zone), 0))
  return -12;
...
# 306 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c"
...
int ttm_mem_global_init(struct ttm_mem_global *glob)
{
 ...
 __mtx_init((&glob->lock), ((((6)) > 0 && ((6)) < 12) ? 12 : ((6))));
 glob->swap_queue = taskq_create("ttm_swap", 1, 6, 0);
 glob->task_queued = 0;
 ...
 if (__builtin_expect(!!(ret != 0), 0))
  goto out_no_zone;
# 392 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c"
 ttm_page_alloc_init(glob, glob->zone_kernel->max_mem/(2*(1 << 13)));
 ttm_dma_page_alloc_init(glob, glob->zone_kernel->max_mem/(2*(1 << 13)));
 return 0;
out_no_zone:
...
static void ttm_check_swapping(struct ttm_mem_global *glob)
{
 ...
 if (__builtin_expect(!!(needs_swapping), 0))
         ...
         _Bool no_wait, _Bool interruptible)
{
 ...
 while (__builtin_expect(!!(ttm_mem_global_reserve(glob, single_zone, memory, 1) != 0), 0)) {
...
# 561 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_memory.c"
 if (glob->zone_dma32 && (((page)->phys_addr) / (1 << 13)) > 0x00100000UL)
  zone = glob->zone_kernel;

 return ttm_mem_global_alloc_zone(glob, zone, (1 << 13), no_wait,
      interruptible);
}
...
void ttm_mem_global_free_page(struct ttm_mem_global *glob, struct vm_page *page)
{
 ...
 ttm_mem_global_free_zone(glob, zone, (1 << 13));
}
