# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/pf.h" 1
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 87 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_fsm.h" 1
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_fsm.h"
u_char tcp_outflags[11] = {
    0x04|0x10, 0, 0x02, 0x02|0x10,
    0x10, 0x10,
    0x01|0x10, 0x01|0x10, 0x01|0x10, 0x10, 0x10,
};
# 90 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 91 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 92 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 93 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
extern int tcp_debx;
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c" 2
...
# 127 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
struct sackhole *
tcp_sack_output(struct tcpcb *tp)
{
 struct sackhole *p;
 ...
 while (p) {
  ...
  if (p->dups >= tcprexmtthresh && ((int)((p->rxmit)-(p->end)) < 0)) {
# 147 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
...
tcp_output(struct tcpcb *tp)
{
 ...
 struct mbuf *m;
 struct tcphdr *th;
 u_int32_t optbuf[(((40) + ((sizeof(u_int32_t)) - 1)) / (sizeof(u_int32_t)))];
 ...
 if (tp->sack_enable && (tp->t_flags & 0x0400))
  return (22);
# 242 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 idle = (tp->t_flags & 0x00100000) || (tp->snd_max == tp->snd_una);
 ...
 if (idle && ((so)->so_state & 0x2000)) {
  tp->t_flags |= 0x00100000;
  idle = 0;
 } else
  tp->t_flags &= ~0x00100000;
...
# 278 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 win = ulmin(tp->snd_wnd, tp->snd_cwnd);

 flags = tcp_outflags[tp->t_state];
# 290 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 ...
 if (tp->t_force) {
  if (win == 0) {
# 331 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
...
# 356 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 }


 if (len < 0) {
# 370 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
  len = 0;
  if (win == 0) {
...
# 407 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 if (len) {
  if (len == txmaxseg)
   goto send;
  if ((idle || (tp->t_flags & 0x0004)) &&
      len + off >= so->so_snd.sb_cc && !((so)->so_state & 0x2000) &&
      (tp->t_flags & 0x02000000) == 0)
   goto send;
  if (tp->t_force)
   goto send;
...
# 433 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 if (win > 0) {
...
# 501 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
...
send:
# 522 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 optlen = 0;
 ...
 if (flags & 0x02) {
  ...
  if ((tp->t_flags & 0x0008) == 0) {
   ...
   opt[0] = 2;
   opt[1] = 4;
   mss = ((__uint16_t)((u_int16_t) tcp_mss(tp, 0)));
   __builtin_memcpy((opt + 2), (&mss), (sizeof(mss)));
   optlen = 4;
   ...
   if ((tp->t_flags & 0x0020) &&
       ((flags & 0x10) == 0 ||
       (tp->t_flags & 0x0040))) {
    *((u_int32_t *) (opt + optlen)) = ((__uint32_t)(1 << 24 | 3 << 16 | 3 << 8 | tp->request_r_scale));
...
# 635 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 if (tp->sack_enable && tp->t_state == 4 &&
  ...
  for (i = 0; (i < tp->rcv_numsacks && count < maxsack); i++) {
   ...
   if (sack.start == 0 && sack.end == 0)
    continue;
   *lp++ = ((__uint32_t)(sack.start));
   *lp++ = ((__uint32_t)(sack.end));
   count++;
  }
  *olp = ((__uint32_t)((1<<24|1<<16|5<<8)|(8*count+2)));
  optlen += 8*count + 4;
 }
...
# 706 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
  m = m_gethdr((0x0002), (2));
  if (m != ((void *)0) && max_linkhdr + hdrlen > ((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr))) {
  ...
  if (len <= m_trailingspace(m)) {
   ...
   m->m_hdr.mh_next = m_copym(so->so_snd.sb_mb, off, (int) len,
       0x0002);
  ...
  if (so->so_snd.sb_mb->m_hdr.mh_flags & 0x0002)
   m->M_dat.MH.MH_pkthdr.ph_loopcnt =
       so->so_snd.sb_mb->M_dat.MH.MH_pkthdr.ph_loopcnt;
  ...
  if (off + len == so->so_snd.sb_cc && !((so)->so_state & 0x2000))
   flags |= 0x08;
 } else {
  if (tp->t_flags & 0x0001)
 ...
 __builtin_memcpy((((caddr_t)((m)->m_hdr.mh_data))), (((caddr_t)((tp->t_template)->m_hdr.mh_data))), (tp->t_template->m_hdr.mh_len));
 ...
 if ((flags & 0x01) && (tp->t_flags & 0x0010) &&
  ...
  tp->snd_nxt--;
# 805 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 ...
 th->th_ack = ((__uint32_t)(tp->rcv_nxt));
 if (optlen) {
  __builtin_memcpy((th + 1), (opt), (optlen));
 ...
 if (flags & 0x04)
  win = 0;
 th->th_win = ((__uint16_t)((u_int16_t) (win>>tp->rcv_scale)));
 if (((int)((tp->snd_up)-(tp->snd_nxt)) > 0)) {
  u_int32_t urp = tp->snd_up - tp->snd_nxt;
  if (urp > 65535)
   urp = 65535;
  th->th_urp = ((__uint16_t)((u_int16_t)urp));
  th->th_flags |= 0x20;
 } else
 ...
 if (tp->t_flags & 0x0400) {
  ...
  if (tcp_signature(tdb, tp->pf, m, th, iphlen, 0,
      ((caddr_t)((m)->m_hdr.mh_data)) + hdrlen - optlen + sigoff) < 0) {
   m_freem(m);
   return (22);
  }
 }
...
# 995 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 timer:
  ...
  if (len == 0 && so->so_snd.sb_cc &&
      ((&(tp)->t_timer[(0)])->to_flags & 2) == 0 &&
      ((&(tp)->t_timer[(1)])->to_flags & 2) == 0) {
# 1038 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
   tp->t_rxtshift = 0;
   tcp_setpersist(tp);
  }
 } else
 ...
 if (so->so_options & 0x0001)
  tcp_trace(1, tp->t_state, tp, ((caddr_t)((m)->m_hdr.mh_data)), 0,
   len);
# 1066 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/tcp_output.c"
 needect = 0;
 if (tcp_do_ecn && (tp->t_flags & 0x00008000)) {
 ...
 m->M_dat.MH.MH_pkthdr.pf.inp = tp->t_inpcb;
 ...
 case 2:
  {
   ...
   packetlen = m->M_dat.MH.MH_pkthdr.len;
  ...
  error = ip_output(m, tp->t_inpcb->inp_options,
   ...
   (ip_mtudisc ? 0x0800 : 0), ((void *)0), tp->t_inpcb, 0);
  break;
 ...
 case 24:
  {
   ...
   ip6->ip6_ctlun.ip6_un1.ip6_un1_hlim = in6_selecthlim(tp->t_inpcb);

   if (needect)
    ip6->ip6_ctlun.ip6_un1.ip6_un1_flow |= ((__uint32_t)(0x02 << 20));
