# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c"
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c"
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/socketvar.h" 1
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/socketvar.h"
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c" 2
    ...
    int iovcnt, int userspace, off_t *offset, register_t *retval)
{
 ...
 struct uio auio;
 struct iovec *iov;
 struct iovec *needfree = ((void *)0);
 long i, cnt, error = 0;
 u_int iovlen;

 struct iovec *ktriov = ((void *)0);
 ...
 if (userspace) {
  if ((u_int)iovcnt > 8) {
   if ((u_int)iovcnt > 1024) {
    error = 22;
    goto out;
   }
   iov = needfree = malloc(iovlen, 19, 0x0001);
  ...
  if (((p)->p_p->ps_traceflag & (1<<(8)) && ((p)->p_flag & 0x00000001) == 0))
   ktrstruct(p, "iovec", iov, (iovcnt) * sizeof(struct iovec));

 } else {
  iov = (struct iovec *)iovp;
 }
 ...
 for (i = 0; i < iovcnt; i++) {
  ...
  if (iov->iov_len > 0x7fffffffffffffffL || auio.uio_resid > 0x7fffffffffffffffL) {
   error = 22;
   goto done;
  }
  iov++;
 ...
 if (((p)->p_p->ps_traceflag & (1<<(4)) && ((p)->p_flag & 0x00000001) == 0)) {
  ktriov = malloc(iovlen, 127, 0x0001);
  __builtin_memcpy((ktriov), (auio.uio_iov), (iovlen));
 }

 cnt = auio.uio_resid;
 error = (*fp->f_ops->fo_read)(fp, offset, &auio, fp->f_cred);
 if (error)
  if (auio.uio_resid != cnt && (error == -1 ||
      error == 4 || error == 35))
   error = 0;
 cnt -= auio.uio_resid;
 ...
 if (ktriov != ((void *)0)) {
  ...
  free(ktriov, 127, iovlen);
 }

 *retval = cnt;
 done:
 if (needfree)
  free(needfree, 19, iovlen);
 out:
...
sys_ioctl(struct proc *p, void *v, register_t *retval)
{
 ...
 if (size > sizeof (stkbuf)) {
  ...
  data = (caddr_t)stkbuf;
 if (com&(unsigned long)0x80000000) {
  if (size) {
   error = copyin(((uap)->data.be.datum), data, size);
   if (error) {
    goto out;
   }
  } else
   *(caddr_t *)data = ((uap)->data.be.datum);
 } else if ((com&(unsigned long)0x40000000) && size)




  __builtin_memset((data), (0), (size));
 else if (com&(unsigned long)0x20000000)
  *(caddr_t *)data = ((uap)->data.be.datum);
 ...
 case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((124))):
  ...
  error = (*fp->f_ops->fo_ioctl)
      (fp, ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((118))), (caddr_t)&tmp, p);
  break;
 ...
 case ((unsigned long)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((123))):
  ...
  error = (*fp->f_ops->fo_ioctl)(fp, ((unsigned long)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((119))), data, p);
  *(int *)data = -*(int *)data;
  break;
 ...
 if (error == 0 && (com&(unsigned long)0x40000000) && size)
...
sys_select(struct proc *p, void *v, register_t *retval)
{
 ...
 if (((uap)->tv.be.datum) != ((void *)0)) {
  struct timeval tv;
  if ((error = copyin(((uap)->tv.be.datum), &tv, sizeof tv)) != 0)
   return (error);
  if ((error = itimerfix(&tv)) != 0)
   return (error);

  if (((p)->p_p->ps_traceflag & (1<<(8)) && ((p)->p_flag & 0x00000001) == 0))
   ktrstruct((p), "reltimeval", (&tv), sizeof(struct timeval));

  { (&ts)->tv_sec = (&tv)->tv_sec; (&ts)->tv_nsec = (&tv)->tv_usec * 1000; };
  tsp = &ts;
 }

 return (dopselect(p, ((uap)->nd.be.datum), ((uap)->in.be.datum), ((uap)->ou.be.datum),
     ((uap)->ex.be.datum), tsp, ((void *)0), retval));
}

int
sys_pselect(struct proc *p, void *v, register_t *retval)
{
 struct sys_pselect_args *uap = v;
# 581 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_generic.c"
 struct timespec ts, *tsp = ((void *)0);
 sigset_t ss, *ssp = ((void *)0);
 int error;

 if (((uap)->ts.be.datum) != ((void *)0)) {
  if ((error = copyin(((uap)->ts.be.datum), &ts, sizeof ts)) != 0)
   return (error);
 ...
 if (((uap)->mask.be.datum) != ((void *)0)) {
  if ((error = copyin(((uap)->mask.be.datum), &ss, sizeof ss)) != 0)
   return (error);
  ssp = &ss;
 }

 return (dopselect(p, ((uap)->nd.be.datum), ((uap)->in.be.datum), ((uap)->ou.be.datum),
     ((uap)->ex.be.datum), tsp, ssp, retval));
}
    ...
    const struct timespec *tsp, const sigset_t *sigmask, register_t *retval)
{
 ...
 ni = (((nd) + ((((unsigned)(sizeof(__fd_mask) * 8))) - 1)) / (((unsigned)(sizeof(__fd_mask) * 8)))) * sizeof(__fd_mask);
 if (ni > sizeof(bits[0])) {
  caddr_t mbits;

  mbits = mallocarray(6, ni, 127, 0x0001|0x0008);
 ...
 if (in && (error = copyin(in, pibits[0], ni))) goto done;;
 if (ou && (error = copyin(ou, pibits[1], ni))) goto done;;
 if (ex && (error = copyin(ex, pibits[2], ni))) goto done;;


 if (ni > 0 && ((p)->p_p->ps_traceflag & (1<<(8)) && ((p)->p_flag & 0x00000001) == 0)) {
  if (in) ktrstruct((p), "fdset", (pibits[0]), ni);
  if (ou) ktrstruct((p), "fdset", (pibits[1]), ni);
  if (ex) ktrstruct((p), "fdset", (pibits[2]), ni);
 }


 if (tsp) {
  getnanouptime(&rts);
  do { (&ats)->tv_sec = (tsp)->tv_sec + (&rts)->tv_sec; (&ats)->tv_nsec = (tsp)->tv_nsec + (&rts)->tv_nsec; if ((&ats)->tv_nsec >= 1000000000L) { (&ats)->tv_sec++; (&ats)->tv_nsec -= 1000000000L; } } while (0);
 } else {
  ats.tv_sec = 0;
  ats.tv_nsec = 0;
 }
 ...
 if (sigmask)
  dosigsuspend(p, *sigmask &~ ((1U << ((9)-1)) | (1U << ((17)-1))));

retry:
 ncoll = nselcoll;
 atomic_setbits_int(&p->p_flag, 0x00000040);
 error = selscan(p, pibits[0], pobits[0], nd, ni, retval);
 if (error || *retval)
  goto done;
 if (tsp) {
  getnanouptime(&rts);
  if ((((&rts)->tv_sec == (&ats)->tv_sec) ? ((&rts)->tv_nsec >= (&ats)->tv_nsec) : ((&rts)->tv_sec >= (&ats)->tv_sec)))
   goto done;
  do { (&tts)->tv_sec = (&ats)->tv_sec - (&rts)->tv_sec; (&tts)->tv_nsec = (&ats)->tv_nsec - (&rts)->tv_nsec; if ((&tts)->tv_nsec < 0) { (&tts)->tv_sec--; (&tts)->tv_nsec += 1000000000L; } } while (0);
  timo = tts.tv_sec > 24 * 60 * 60 ?
   24 * 60 * 60 * hz : tstohz(&tts);
 }
 s = _splraise(15);
 if ((p->p_flag & 0x00000040) == 0 || nselcoll != ncoll) {
  _splx(s);
  goto retry;
 }
 atomic_clearbits_int(&p->p_flag, 0x00000040);
 error = tsleep(&selwait, 24 | 0x100, "select", timo);
 _splx(s);
 if (error == 0)
  goto retry;
done:
 ...
 if (error == 0) {
  ...
  if (in && (error2 = copyout(pobits[0], in, ni))) error = error2;;
  if (ou && (error2 = copyout(pobits[1], ou, ni))) error = error2;;
  if (ex && (error2 = copyout(pobits[2], ex, ni))) error = error2;;


  if (ni > 0 && ((p)->p_p->ps_traceflag & (1<<(8)) && ((p)->p_flag & 0x00000001) == 0)) {
   if (in) ktrstruct((p), "fdset", (pobits[0]), ni);
   if (ou) ktrstruct((p), "fdset", (pobits[1]), ni);
   if (ex) ktrstruct((p), "fdset", (pobits[2]), ni);
  }

 }

 if (pibits[0] != (fd_set *)&bits[0])
  free(pibits[0], 127, 6 * ni);
 return (error);
}
    ...
    register_t *retval)
{
 ...
 struct file *fp;
 int n = 0;
 static const int flag[3] = { 0x0001, 0x0004|0x1000, 0x0002 };

 for (msk = 0; msk < 3; msk++) {
  fd_set *pibits = (fd_set *)&cibits[msk*ni];
  fd_set *pobits = (fd_set *)&cobits[msk*ni];

  for (i = 0; i < nfd; i += ((unsigned)(sizeof(__fd_mask) * 8))) {
   bits = pibits->fds_bits[i/((unsigned)(sizeof(__fd_mask) * 8))];
...
selwakeup(struct selinfo *sip)
{
 ...
 do { struct klist *list = (&sip->si_note); if ((list) != ((void *)0)) knote((list), (0x01000000)); } while (0);
 if (sip->si_seltid == 0)
  return;
 if (sip->si_flags & 0x0001) {
  nselcoll++;
  sip->si_flags &= ~0x0001;
  wakeup(&selwait);
 }
...
pollscan(struct proc *p, struct pollfd *pl, u_int nfd, register_t *retval)
{
 ...
 for (i = 0; i < nfd; i++, pl++) {
  ...
  if ((fp = fd_getfile(fdp, pl->fd)) == ((void *)0)) {
   pl->revents = 0x0020;
   n++;
   continue;
  }
...
sys_poll(struct proc *p, void *v, register_t *retval)
{
 ...
 return (doppoll(p, ((uap)->fds.be.datum), ((uap)->nfds.be.datum), tsp, ((void *)0),
     retval));
}
...
sys_ppoll(struct proc *p, void *v, register_t *retval)
{
 ...
 return (doppoll(p, ((uap)->fds.be.datum), ((uap)->nfds.be.datum), tsp, ssp,
     retval));
}
    ...
    const struct timespec *tsp, const sigset_t *sigmask, register_t *retval)
{
 ...
 if (nfds > min((int)p->p_p->ps_limit->pl_rlimit[8].rlim_cur, maxfiles))
  return (22);


 if (nfds > (sizeof((pfds)) / sizeof((pfds)[0]))) {
  pl = mallocarray(nfds, sizeof(*pl), 127,
      0x0001 | 0x0004);
  if (pl == ((void *)0))
   return (22);
 }
...
retry:
 ...
 atomic_clearbits_int(&p->p_flag, 0x00000040);
 error = tsleep(&selwait, 24 | 0x100, "poll", timo);
 _splx(s);
 if (error == 0)
  goto retry;
 ...
 if (((p)->p_p->ps_traceflag & (1<<(8)) && ((p)->p_flag & 0x00000001) == 0))
  ktrstruct(p, "pollfd", pl, (nfds) * sizeof(struct pollfd));
...
sys_utrace(struct proc *curp, void *v, register_t *retval)
{
 ...
 struct sys_utrace_args *uap = v;




 return (ktruser(curp, ((uap)->label.be.datum), ((uap)->addr.be.datum),
     ((uap)->len.be.datum)));
