...
pcmcia_cis_read_1(struct pcmcia_tuple *tuple, bus_size_t idx)
{
 if (tuple->flags & 0x01) {
  bus_space_write_1(tuple->memt, tuple->memh,
      tuple->indirect_ptr + 0x02, 0x00);
  idx <<= tuple->addrshift;
  bus_space_write_1(tuple->memt, tuple->memh,
      tuple->indirect_ptr + 0x04 + 0, idx >> 0);
  bus_space_write_1(tuple->memt, tuple->memh,
      tuple->indirect_ptr + 0x04 + 1, idx >> 8);
  bus_space_write_1(tuple->memt, tuple->memh,
      tuple->indirect_ptr + 0x04 + 2, idx >> 16);
  bus_space_write_1(tuple->memt, tuple->memh,
      tuple->indirect_ptr + 0x04 + 3, idx >> 24);
  return bus_space_read_1(tuple->memt, tuple->memh,
      tuple->indirect_ptr + 0x08);
 } else
  return bus_space_read_1(tuple->memt, tuple->memh,
      idx << tuple->addrshift);
}
 ...
 struct pcmcia_softc *sc;
{
 ...
 state.card->manufacturer = 0xffff;
 state.card->product = 0xffff;
 do { (&state.card->pf_head)->sqh_first = ((void *)0); (&state.card->pf_head)->sqh_last = &(&state.card->pf_head)->sqh_first; } while (0);
 state.pf = ((void *)0);
 ...
 void *arg;
{
 ...
 pct = sc->pct;
 pch = sc->pch;
 if (((*(pct)->mem_alloc)((pch), (1024), (&pcmh)))) {
  printf("%s: can't alloc memory to read attributes\n",
      sc->dev.dv_xname);
  return -1;
 }
 if (((*(pct)->mem_map)((pch), (1), (0), (1024), (&pcmh), (&tuple.ptr), (&window)))) {
  ((*(pct)->mem_free)((pch), (&pcmh)));
 ...
 while (1) {
  while (1) {
   ...
   case 0x12:
    ...
    longlink_common = (tuple.code ==
        0x12) ? 1 : 0;
    longlink_addr = ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((0)))))) | ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((0)+1)))))<<8) | ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((0)+2)))))<<16) | ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((0)+3)))))<<24));
    ;
    break;
   case 0x14:
    longlink_present = 0;
   ...
   case 0x10:
    if (tuple.length < 5) {
     ...
     int i;
     *((u_int16_t *) & offset) =
         ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((0)))))) | ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((0)+1)))))<<8));
     length = ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((2)))))) | ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((2)+1)))))<<8));
     cksum = (pcmcia_cis_read_1((&tuple), ((&tuple)->ptr+(2+(4)))));
   ...
   case 0x06:
    ...
    }
    {
     int i, tmp_count;
     tmp_count =
         (pcmcia_cis_read_1((&tuple), ((&tuple)->ptr+(2+(0)))));
     ;
     ...
     for (i = 0; i < mfc_count; i++) {
      mfc[i].common =
          ((pcmcia_cis_read_1((&tuple), ((&tuple)->ptr+(2+(1 + 5 * i))))) ==
          0x01) ?
          1 : 0;
      mfc[i].addr =
          ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((1 + 5 * i + 1)))))) | ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((1 + 5 * i + 1)+1)))))<<8) | ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((1 + 5 * i + 1)+2)))))<<16) | ((pcmcia_cis_read_1(((&tuple)), (((&tuple))->ptr+(2+((1 + 5 * i + 1)+3)))))<<24));
      ;
     }
     ;
    }
  ...
  while (1) {
   ((*(pct)->mem_unmap)((pch), (window)));
   if (indirect_present) {
    ((*(pct)->mem_map)((pch), (2), (0), (0x0a), (&pcmh), (&tuple.indirect_ptr), (&window)));
    ;
    tuple.addrshift = 1;
    tuple.flags |= 0x01;
    tuple.ptr = 0;
    ...
    if (!longlink_common)
     longlink_addr *= 2;
    ((*(pct)->mem_map)((pch), (longlink_common ? 2 : 1), (longlink_addr), (1024), (&pcmh), (&tuple.ptr), (&window)));
    if (!longlink_common)
     tuple.ptr /= 2;
    ;
    ...
    ((*(pct)->mem_map)((pch), (mfc[mfc_index].common ? 2 : 1), (mfc[mfc_index].addr), (1024), (&pcmh), (&tuple.ptr), (&window)));
    if (!mfc[mfc_index].common)
     tuple.ptr /= 2;
    ;
   ...
   if (((pcmcia_cis_read_1((&tuple), ((&tuple)->ptr+(2+(0))))) != 'C') ||
       ((pcmcia_cis_read_1((&tuple), ((&tuple)->ptr+(2+(1))))) != 'I') ||
       ((pcmcia_cis_read_1((&tuple), ((&tuple)->ptr+(2+(2))))) != 'S')) {
    ;
    continue;
   }
   tuple.ptr += 2 + tuple.length;
 ...
 struct pcmcia_softc *sc;
{
 ...
 for((pf) = ((&card->pf_head)->sqh_first); (pf) != ((void *)0); (pf) = ((pf)->pf_list.sqe_next)) {
  ...
  for((cfe) = ((&pf->cfe_head)->sqh_first); (cfe) != ((void *)0); (cfe) = ((cfe)->cfe_list.sqe_next)) {
 ...
 void *arg;
{
 ...
 case 0xFF:
  if (state->gotmfc == 1) {
   ...
   for (pf = ((&state->card->pf_head)->sqh_first);
       pf != ((void *)0); pf = pfnext) {
 ...
 case 0x15:
  if (tuple->length < 6) {
   ...
   state->card->cis1_major = (pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(0)))));
   state->card->cis1_minor = (pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(1)))));
   for (count = 0, start = 0, i = 0;
       (count < 4) && ((i + 4) < 256); i++) {
    ch = (pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(2 + i)))));
    if (ch == 0xff)
     break;
 ...
 case 0x20:
  ...
  state->card->manufacturer = ((pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((0)))))) | ((pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((0)+1)))))<<8));
  state->card->product = ((pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((2)))))) | ((pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((2)+1)))))<<8));
  ;
  break;
 case 0x21:
  if (tuple->length < 2) {
  ...
  if (state->pf) {
   if (state->pf->function == -1) {
   } else {
    state->pf = ((void *)0);
   }
  }
  if (state->pf == ((void *)0)) {
   state->pf = malloc(sizeof(*state->pf), 2,
       0x0002 | 0x0008);
   if (state->pf == ((void *)0))
    panic("pcmcia_parse_cis_tuple");
   state->pf->number = state->count++;
   state->pf->last_config_index = -1;
   do { (&state->pf->cfe_head)->sqh_first = ((void *)0); (&state->pf->cfe_head)->sqh_last = &(&state->pf->cfe_head)->sqh_first; } while (0);
   do { (state->pf)->pf_list.sqe_next = ((void *)0); *(&state->card->pf_head)->sqh_last = (state->pf); (&state->card->pf_head)->sqh_last = &(state->pf)->pf_list.sqe_next; } while (0);
  }
  state->pf->function = (pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(0)))));
  ;
  break;
 case 0x1A:
  if (tuple->length < 3) {
   ...
   u_int reg64, rasz, rmsz, rfsz;
   int i;
   reg64 = (pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(0)))));
   rasz = 1 + ((reg64 & 0x03) >>
       0);
   rmsz = 1 + ((reg64 & 0x3C) >>
       2);
   ...
   state->pf->last_config_index =
       (pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(1)))));
   state->pf->ccr_base = 0;
   for (i = 0; i < rasz; i++)
    state->pf->ccr_base |=
        (((pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(2 + i)))))) <<
        (i * 8));
   state->pf->ccr_mask = 0;
   for (i = 0; i < rmsz; i++)
    state->pf->ccr_mask |=
        (((pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(2 + rasz + i)))))) << (i * 8));
 ...
 case 0x1B:
  if (tuple->length < 2) {
   ...
   struct pcmcia_config_entry *cfe;
   idx = 0;
   reg64 = (pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(idx)))));
   idx++;
   intface = reg64 & 0x80;
   def = reg64 & 0x40;
   num = reg64 & 0x3F;
   if (state->default_cfe == ((void *)0)) {
    ;
    break;
   }
   if (num != state->default_cfe->number) {
    cfe = (struct pcmcia_config_entry *)
        malloc(sizeof(*cfe), 2, 0x0002);
    if (cfe == ((void *)0))
     panic("pcmcia_parse_cis_tuple");
    *cfe = *state->default_cfe;
    do { (cfe)->cfe_list.sqe_next = ((void *)0); *(&state->pf->cfe_head)->sqh_last = (cfe); (&state->pf->cfe_head)->sqh_last = &(cfe)->cfe_list.sqe_next; } while (0);
    cfe->number = num;
    if (def)
   ...
   if (power) {
    for (i = 0; i < power; i++) {
     ...
     for (j = 0; j < 7; j++) {
      if ((reg64 >> j) & 0x01) {
       do {
        reg2 = (pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(idx)))));
        idx++;
       } while (reg2 & 0x80);
      }
     }
   ...
   if (iospace) {
    ...
    if (reg64 & 0x80) {
     ...
     for (i = 0; i < cfe->num_iospace; i++) {
      ...
      case 0x10:
       cfe->iospace[i].start =
        (pcmcia_cis_read_1((tuple), ((tuple)->ptr+(2+(idx)))));
       idx++;
       break;
      case 0x20:
       cfe->iospace[i].start =
        ((pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((idx)))))) | ((pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((idx)+1)))))<<8));
       idx += 2;
       break;
      case 0x30:
       cfe->iospace[i].start =
        ((pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((idx)))))) | ((pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((idx)+1)))))<<8) | ((pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((idx)+2)))))<<16) | ((pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((idx)+3)))))<<24));
       idx += 4;
       break;
      }
      switch (reg64 &
   ...
   if (memspace) {
    ...
    if (memspace == 0x00) {
     ...
     for (i = 0; i < cfe->num_memspace; i++) {
      if (lengthsize) {
       cfe->memspace[i].length =
        256 * (((lengthsize)==1)?(pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((idx)))))) : (((lengthsize)==2)?((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))))))) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+1)))))<<8)) : (((lengthsize)==3)?((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))))))) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+1)))))<<8) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+2)))))<<16)) : ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))))))) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+1)))))<<8) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+2)))))<<16) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+3)))))<<24)))));
       idx += lengthsize;
      } else {
      ...
      if (cardaddrsize) {
       cfe->memspace[i].cardaddr =
        256 * (((cardaddrsize)==1)?(pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((idx)))))) : (((cardaddrsize)==2)?((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))))))) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+1)))))<<8)) : (((cardaddrsize)==3)?((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))))))) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+1)))))<<8) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+2)))))<<16)) : ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))))))) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+1)))))<<8) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+2)))))<<16) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+3)))))<<24)))));
       idx += cardaddrsize;
      } else {
      ...
      if (hostaddrsize) {
       cfe->memspace[i].hostaddr =
        256 * (((hostaddrsize)==1)?(pcmcia_cis_read_1(((tuple)), (((tuple))->ptr+(2+((idx)))))) : (((hostaddrsize)==2)?((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))))))) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+1)))))<<8)) : (((hostaddrsize)==3)?((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))))))) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+1)))))<<8) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+2)))))<<16)) : ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))))))) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+1)))))<<8) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+2)))))<<16) | ((pcmcia_cis_read_1((((tuple))), ((((tuple)))->ptr+(2+(((idx))+3)))))<<24)))));
       idx += hostaddrsize;
      } else {
