# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.h" 1
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/miidevs.h" 1
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephyreg.h" 1
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c" 2
...
rgephymatch(struct device *parent, void *match, void *aux)
{
 ...
 if (mii_phy_match(ma, rgephys) != ((void *)0))
  return (10);
...
setit:
   ...
   if (((ife->ifm_media) & 0x00000000000000ffULL) == 16 &&
       mii->mii_media.ifm_media & 0x0000000000010000ULL)
    gig |= 0x1000|0x0800;
 ...
 case 1:
  ...
  if (strcmp(devname, "re") == 0 || strcmp(devname, "ure") == 0) {
   reg64 = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x006C));
   if (reg64 & 0x02) {
    sc->mii_ticks = 0;
    break;
   }
...
rgephy_status(struct mii_softc *sc)
{
 ...
 if (strcmp(devname, "re") == 0 || strcmp(devname, "ure") == 0) {
  ...
  bmsr = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x11));
  if (((bmsr) & 0xc000) == 0x8000)
   mii->mii_media_active |= 16;
  else if (((bmsr) & 0xc000) == 0x4000)
   mii->mii_media_active |= 6;
  else if (((bmsr) & 0xc000) == 0x0000)
   mii->mii_media_active |= 3;
...
rgephy_mii_phy_auto(struct mii_softc *sc)
{
 ...
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x04), (anar));
 delay(1000);
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x09), (0x0100 | 0x0200));
 delay(1000);
...
rgephy_loop(struct mii_softc *sc)
{
 ...
 if (sc->mii_model != 0x0000 &&
     sc->mii_rev < 2) {
  (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00), (0x0800));
  delay(1000);
 }
...
# 424 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/rgephy.c"
void
rgephy_load_dspcode(struct mii_softc *sc)
{
 ...
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (21), (0x1000));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (24), (0x65C7));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4), (((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4)) & ~(0x0800))));
 val = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4)) & 0xFFF;
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4), (val));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (3), (0x00A1));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (2), (0x0008));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (1), (0x1020));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0), (0x1000));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4), (((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4)) | (0x0800))));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4), (((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4)) & ~(0x0800))));
 val = ((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4)) & 0xFFF) | 0x7000;
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4), (val));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (3), (0xFF41));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (2), (0xDE60));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (1), (0x0140));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0), (0x0077));
 val = ((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4)) & 0xFFF) | 0xA000;
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4), (val));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (3), (0xDF01));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (2), (0xDF20));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (1), (0xFF95));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0), (0xFA00));
 val = ((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4)) & 0xFFF) | 0xB000;
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4), (val));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (3), (0xFF41));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (2), (0xDE20));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (1), (0x0140));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0), (0x00BB));
 val = ((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4)) & 0xFFF) | 0xF000;
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4), (val));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (3), (0xDF01));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (2), (0xDF20));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (1), (0xFF95));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0), (0xBF00));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4), (((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4)) | (0x0800))));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4), (((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (4)) & ~(0x0800))));
