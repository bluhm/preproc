# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/crypto.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/crypto.c"
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/crypto.c"
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/crypto.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/crypto.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/crypto.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/crypto.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/crypto.c" 2

void crypto_init(void);

struct cryptocap *crypto_drivers = ((void *)0);
...
crypto_newsession(u_int64_t *sid, struct cryptoini *cri, int hard)
{
 ...
 s = _splraise(7);
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/crypto.c"
 do {
 ...
 hid = hid2;
# 151 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/crypto.c"
 if (hid == -1) {
  _splx(s);
  return 22;
 }
...
crypto_freesession(u_int64_t sid)
{
 ...
 if ((crypto_drivers[hid].cc_flags & 0x01) &&
...
crypto_get_driverid(u_int8_t flags)
{
 ...
 if (crypto_drivers_num == 0) {
  crypto_drivers_num = 4;
  crypto_drivers = mallocarray(crypto_drivers_num,
      sizeof(struct cryptocap), 108, 0x0002 | 0x0008);
  if (crypto_drivers == ((void *)0)) {
 ...
 for (i = 0; i < crypto_drivers_num; i++) {
  if (crypto_drivers[i].cc_process == ((void *)0) &&
      !(crypto_drivers[i].cc_flags & 0x01) &&
 ...
 if (i == crypto_drivers_num) {
  if (crypto_drivers_num >= 128) {
   _splx(s);
   return -1;
  }

  newdrv = mallocarray(crypto_drivers_num,
      2 * sizeof(struct cryptocap), 108, 0x0002);
  if (newdrv == ((void *)0)) {
   _splx(s);
   return -1;
  }

  __builtin_memcpy((newdrv), (crypto_drivers), (crypto_drivers_num * sizeof(struct cryptocap)));

  __builtin_bzero((&newdrv[crypto_drivers_num]), (crypto_drivers_num * sizeof(struct cryptocap)));


  newdrv[i].cc_sessions = 1;
  newdrv[i].cc_flags = flags;

  free(crypto_drivers, 108,
    ...
    int (*freeses)(u_int64_t), int (*process)(struct cryptop *))
{
 ...
 if (driverid >= crypto_drivers_num || alg == ((void *)0) ||
     crypto_drivers == ((void *)0))
  return 22;
...
crypto_unregister(u_int32_t driverid, int alg)
{
 ...
 if (driverid >= crypto_drivers_num || crypto_drivers == ((void *)0) ||
     ((alg <= 0 || alg > 23) &&
  alg != 23 + 1) ||
 ...
 if (i == 23 + 1 || alg == 23 + 1) {
  ...
  __builtin_bzero((&crypto_drivers[driverid]), (sizeof(struct cryptocap)));
  if (ses != 0) {



   crypto_drivers[driverid].cc_flags |= 0x01;
...
crypto_dispatch(struct cryptop *crp)
{
 ...
 if (hid < crypto_drivers_num) {
  if (crypto_drivers[hid].cc_flags & 0x04)
   tq = crypto_taskq_mpsafe;
 }
 _splx(s);

 if (tq && !(crp->crp_flags & 0x0008)) {
...
crypto_invoke(struct cryptop *crp)
{
 ...
 s = _splraise(7);
 if (crp->crp_ndesc < 1 || crypto_drivers == ((void *)0)) {
  crp->crp_etype = 22;
  crypto_done(crp);
  _splx(s);
  return 0;
 ...
 if (crypto_drivers[hid].cc_process == ((void *)0))
  goto migrate;
 ...
 crp->crp_desc[crp->crp_ndesc].CRD_INI.cri_next = ((void *)0);
...
crypto_getreq(int num)
{
 ...
 crp = pool_get(&cryptop_pool, 0x0002 | 0x0008);
 if (crp == ((void *)0))
  return ((void *)0);
