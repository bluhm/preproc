# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_cis.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_cis.c"
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_cis.c"
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_cis.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_cis.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_cis.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_ioreg.h" 1
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_cis.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmcdevs.h" 1
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_cis.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmcvar.h" 1
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmcvar.h"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmcvar.h" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_cis.c" 2
...
sdmmc_cisptr(struct sdmmc_function *sf)
{
 ...
 reg64 = 0x09 + (sf->number * 0x100);
 cisptr |= sdmmc_io_read_1(sf0, reg64 + 0) << 0;
 cisptr |= sdmmc_io_read_1(sf0, reg64 + 1) << 8;
 cisptr |= sdmmc_io_read_1(sf0, reg64 + 2) << 16;
...
sdmmc_read_cis(struct sdmmc_function *sf, struct sdmmc_cis *cis)
{
 ...
 reg64 = (int)sdmmc_cisptr(sf);
 if (reg64 < 0x01000 ||
     reg64 >= (0x01000 +0x17000 -16)) {
  printf("%s: bad CIS ptr %#x\n", ((sf->sc)->sc_dev.dv_xname), reg64);
  return 1;
 }

 for (;;) {
  tplcode = sdmmc_io_read_1(sf0, reg64++);
  if (tplcode == 0xff)
   break;
  if (tplcode == 0x00)
   continue;

  tpllen = sdmmc_io_read_1(sf0, reg64++);
  if (tpllen == 0) {
   printf("%s: CIS parse error at %d, "
       "tuple code %#x, length %d\n",
       ((sf->sc)->sc_dev.dv_xname), reg64, tplcode, tpllen);
   break;
  }
  ...
  case 0x21:
   if (tpllen < 2) {
    printf("%s: bad CISTPL_FUNCID length\n",
        ((sf->sc)->sc_dev.dv_xname));
    reg64 += tpllen;
    break;
   }
   cis->function = sdmmc_io_read_1(sf0, reg64);
   reg64 += tpllen;
   break;
  case 0x20:
   if (tpllen < 4) {
   ...
   cis->manufacturer = sdmmc_io_read_1(sf0, reg64++);
   cis->manufacturer |= sdmmc_io_read_1(sf0, reg64++) << 8;
   cis->product = sdmmc_io_read_1(sf0, reg64++);
   cis->product |= sdmmc_io_read_1(sf0, reg64++) << 8;
   break;
  case 0x15:
   if (tpllen < 2) {
   ...
   }
   {
    ...
    cis->cis1_major = sdmmc_io_read_1(sf0, reg64++);
    cis->cis1_minor = sdmmc_io_read_1(sf0, reg64++);

    for (count = 0, start = 0, i = 0;
         (count < 4) && ((i + 4) < 256); i++) {
     ch = sdmmc_io_read_1(sf0, reg64 + i);
     if (ch == 0xff)
      break;
...
sdmmc_print_cis(struct sdmmc_function *sf)
{
 ...
 printf("%s: CIS info: ", ((sf->sc)->sc_dev.dv_xname));
 for (i = 0; i < 4; i++) {
  if (cis->cis1_info[i] == ((void *)0))
   break;
  if (i)
   printf(", ");
 ...
 printf("%s: Manufacturer code 0x%x, product 0x%x\n",
     ((sf->sc)->sc_dev.dv_xname), cis->manufacturer, cis->product);

 printf("%s: function %d: ", ((sf->sc)->sc_dev.dv_xname), sf->number);
...
{
 if (sf->cis.manufacturer == 0x02fe &&
     sf->cis.product == 0x2128) {
