...
struct trinity_power_info {
 ...
 u32 min_sclk_did;
 _Bool enable_nbps_policy;
 _Bool voltage_drop_in_dce;
 _Bool override_dynamic_mgpg;
 _Bool enable_gfx_clock_gating;
 _Bool enable_gfx_power_gating;
 _Bool enable_mg_clock_gating;
 _Bool enable_gfx_dynamic_mgpg;
 _Bool enable_auto_thermal_throttling;
 _Bool enable_dpm;
 _Bool enable_sclk_ds;
 _Bool enable_bapm;
...
int trinity_dpm_bapm_enable(struct radeon_device *rdev, _Bool enable);
int trinity_dpm_config(struct radeon_device *rdev, _Bool enable);
...
extern void vce_v1_0_enable_mgcg(struct radeon_device *rdev, _Bool enable);
...
static void trinity_gfx_powergating_initialize(struct radeon_device *rdev)
{
 ...
 if (ret)
  return;
 value = tn_smc_rreg(rdev, (0x1f38c));
 value &= ~((0xff << 8) | (0xff << 0));
 if (sssd)
  value |= ((1) << 8);
 value |= ((dividers.post_div) << 0);
 tn_smc_wreg(rdev, (0x1f38c), (value));
 r600_calculate_u_and_p(500, xclk, 16, &p, &u);
 r100_mm_wreg(rdev, (0x6e0), (((p) << 0) | ((u) << 16)), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6d8), 0); tmp_ &= (~(0xffff << 16)); tmp_ |= ((((p) << 16)) & ~(~(0xffff << 16))); r100_mm_wreg(rdev, (0x6d8), (tmp_), 0); } while (0);
       ...
       _Bool enable)
{
 ...
 u32 local1;
 if (enable) {
  local0 = eg_cg_rreg(rdev, (0x0));
  local1 = eg_cg_rreg(rdev, (0x1));
  eg_cg_wreg(rdev, (0x0), ((0x00380000 & 0xFFFF33FF) | (local0 & ~0xFFFF33FF)));
  eg_cg_wreg(rdev, (0x1), ((0x0E000000 & 0xFFFB0FFE) | (local1 & ~0xFFFB0FFE)));
  r100_mm_wreg(rdev, (0x9150), (0x96944200), 0);
 } else {
  r100_mm_wreg(rdev, (0x9150), (0x00600000), 0);
  local0 = eg_cg_rreg(rdev, (0x0));
  local1 = eg_cg_rreg(rdev, (0x1));
  eg_cg_wreg(rdev, (0x0), (0xFFFF33FF | (local0 & ~0xFFFF33FF)));
  eg_cg_wreg(rdev, (0x1), (0xFFFB0FFE | (local1 & ~0xFFFB0FFE)));
 }
}
static void trinity_mg_clockgating_initialize(struct radeon_device *rdev)
{
 u32 count;
 const u32 *seq = ((void *)0);
...
{
 if (enable) {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x678), 0); tmp_ &= (~(1 << 7)); tmp_ |= (((1 << 7)) & ~(~(1 << 7))); r100_mm_wreg(rdev, (0x678), (tmp_), 0); } while (0);
 } else {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x678), 0); tmp_ &= (~(1 << 7)); tmp_ |= ((0) & ~(~(1 << 7))); r100_mm_wreg(rdev, (0x678), (tmp_), 0); } while (0);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x678), 0); tmp_ &= (~(1 << 8)); tmp_ |= (((1 << 8)) & ~(~(1 << 8))); r100_mm_wreg(rdev, (0x678), (tmp_), 0); } while (0);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x678), 0); tmp_ &= (~(1 << 8)); tmp_ |= ((0) & ~(~(1 << 8))); r100_mm_wreg(rdev, (0x678), (tmp_), 0); } while (0);
         ...
         const u32 *seq, u32 count)
{
 ...
 for (i = 0; i < length; i += 3)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (seq[i]), 0); tmp_ &= (~seq[i+2]); tmp_ |= ((seq[i+1]) & ~(~seq[i+2])); r100_mm_wreg(rdev, (seq[i]), (tmp_), 0); } while (0);
}
          ...
          const u32 *seq, u32 count)
{
 ...
 for (i = 0; i < length; i += 2)
  r100_mm_wreg(rdev, (seq[i]), (seq[i+1]), 0);
}
static void trinity_override_dynamic_mg_powergating(struct radeon_device *rdev)
{
 u32 count;
...
{
 if (enable) {
  if (tn_smc_rreg(rdev, (0xe000101c)) & (3 << 16))
   tn_smc_wreg(rdev, (0xe0003024), ((tn_smc_rreg(rdev, (0xe0003024)) | 0x01)));
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x678), 0); tmp_ &= (~(1 << 2)); tmp_ |= (((1 << 2)) & ~(~(1 << 2))); r100_mm_wreg(rdev, (0x678), (tmp_), 0); } while (0);
 } else {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x678), 0); tmp_ &= (~(1 << 2)); tmp_ |= ((0) & ~(~(1 << 2))); r100_mm_wreg(rdev, (0x678), (tmp_), 0); } while (0);
  r100_mm_rreg(rdev, (0x98f8), 0);
 }
}
         ...
         _Bool enable)
{
 u32 value;
 if (enable) {
  value = tn_smc_rreg(rdev, (0x1f464));
  value &= ~(0xff << 16);
  value |= ((1) << 16);
  tn_smc_wreg(rdev, (0x1f464), (value));
  value = tn_smc_rreg(rdev, (0x1f118));
  value &= ~(0xff << 16);
  value |= ((1) << 16);
  tn_smc_wreg(rdev, (0x1f118), (value));
 } else {
  value = tn_smc_rreg(rdev, (0x1f118));
  value &= ~(0xff << 16);
  tn_smc_wreg(rdev, (0x1f118), (value));
          ...
          u32 index, u32 sclk)
{
 ...
 int ret;
 u32 value;
 u32 ix = index * (0x1f020 - 0x1f000);
        ret = radeon_atom_get_clock_dividers(rdev, 2,
                                             sclk, 0, &dividers);
 if (ret)
  return;
 value = tn_smc_rreg(rdev, (0x1f000 + ix));
 value &= ~(0xff << 8);
 value |= ((dividers.post_div) << 8);
 tn_smc_wreg(rdev, (0x1f000 + ix), (value));
        ret = radeon_atom_get_clock_dividers(rdev, 2,
                                             sclk/2, 0, &dividers);
 if (ret)
  return;
 value = tn_smc_rreg(rdev, (0x1f014 + ix));
 value &= ~(0xff << 16);
 value |= ((dividers.post_div) << 16);
 tn_smc_wreg(rdev, (0x1f014 + ix), (value));
}
        ...
        u32 index, u32 divider)
{
 u32 value;
 u32 ix = index * (0x1f020 - 0x1f000);
 value = tn_smc_rreg(rdev, (0x1f004 + ix));
 value &= ~(0xff << 0);
 value |= ((divider) << 0);
 tn_smc_wreg(rdev, (0x1f004 + ix), (value));
}
           ...
           u32 index, u32 gnb_slow)
{
 u32 value;
 u32 ix = index * (0x1f020 - 0x1f000);
 value = tn_smc_rreg(rdev, (0x1f00c + ix));
 value &= ~(0xff << 0);
 value |= ((gnb_slow) << 0);
 tn_smc_wreg(rdev, (0x1f00c + ix), (value));
}
      ...
      u32 index, u32 at)
{
 u32 value;
 u32 ix = index * (0x1f020 - 0x1f000);
 value = tn_smc_rreg(rdev, (0x1f010 + ix));
 value &= ~(0xff << 0);
 value |= ((at) << 0);
 tn_smc_wreg(rdev, (0x1f010 + ix), (value));
}
...
static _Bool trinity_dpm_enabled(struct radeon_device *rdev)
{
 if (tn_smc_rreg(rdev, (0x1f100)) & ((1) << 0))
  return 1;
 else
  return 0;
}
...
{
 u32 value = tn_smc_rreg(rdev, (0x1f100));
 value &= ~((0xff << 0) | (0xff << 16) | (0xff << 24));
 value |= ((1) << 0) | ((0) << 16) | ((1) << 24);
 tn_smc_wreg(rdev, (0x1f100), (value));
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x670), 0); tmp_ &= (~(1 << 0)); tmp_ |= (((1 << 0)) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x670), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x770), 0); tmp_ &= (~(1 << 9)); tmp_ |= ((0) & ~(~(1 << 9))); r100_mm_wreg(rdev, (0x770), (tmp_), 0); } while (0);
...
static void trinity_wait_for_dpm_enabled(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < rdev->usec_timeout; i++) {
  if (r100_mm_rreg(rdev, (0x678), 0) & (1 << 21))
   break;
  udelay(1);
 }
 for (i = 0; i < rdev->usec_timeout; i++) {
  if ((r100_mm_rreg(rdev, (0x684), 0) & (0xf << 0)) == 0)
   break;
  udelay(1);
 }
 for (i = 0; i < rdev->usec_timeout; i++) {
  if ((r100_mm_rreg(rdev, (0x684), 0) & (0xf << 4)) == 0)
   break;
  udelay(1);
 }
}
...
{
 u32 sclk_dpm_cntl;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x770), 0); tmp_ &= (~(1 << 9)); tmp_ |= (((1 << 9)) & ~(~(1 << 9))); r100_mm_wreg(rdev, (0x770), (tmp_), 0); } while (0);
 sclk_dpm_cntl = tn_smc_rreg(rdev, (0x1f100));
 sclk_dpm_cntl &= ~((0xff << 0) | (0xff << 24));
 tn_smc_wreg(rdev, (0x1f100), (sclk_dpm_cntl));
 trinity_dpm_config(rdev, 0);
}
static void trinity_start_am(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x678), 0); tmp_ &= (~((1 << 5) | (1 << 4))); tmp_ |= ((0) & ~(~((1 << 5) | (1 << 4)))); r100_mm_wreg(rdev, (0x678), (tmp_), 0); } while (0);
}
static void trinity_reset_am(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x678), 0); tmp_ &= (~((1 << 5) | (1 << 4))); tmp_ |= (((1 << 5) | (1 << 4)) & ~(~((1 << 5) | (1 << 4)))); r100_mm_wreg(rdev, (0x678), (tmp_), 0); } while (0);
}
       ...
       struct radeon_ps *rps)
{
 ...
 tn_smc_wreg(rdev, (0x1f1a0), (uvdstates));
}
static void trinity_setup_uvd_dpm_interval(struct radeon_device *rdev,
        u32 interval)
{
 u32 p, u;
 u32 tp = tn_smc_rreg(rdev, (0x1f468));
 u32 val;
 u32 xclk = (rdev)->asic->get_xclk((rdev));
 r600_calculate_u_and_p(interval, xclk, 16, &p, &u);
 val = (p + tp - 1) / tp;
 tn_smc_wreg(rdev, (0x1f1a4), (val));
}
static _Bool trinity_uvd_clocks_zero(struct radeon_ps *rps)
{
...
static _Bool trinity_uvd_clocks_equal(struct radeon_ps *rps1,
 ...
 if (pi->uvd_dpm) {
  if (trinity_uvd_clocks_zero(new_rps) &&
   ...
   if (trinity_uvd_clocks_zero(old_rps)) {
    u32 tmp = r100_mm_rreg(rdev, (0x708), 0);
    tmp &= 0xfffffffd;
    r100_mm_wreg(rdev, (0x708), (tmp), 0);
      ...
      struct radeon_ps *old_rps)
{
 if ((old_rps->evclk != new_rps->evclk) ||
  ...
  (rdev)->asic->pm.set_vce_clocks((rdev), (new_rps->evclk), (new_rps->ecclk));
 }
}
static void trinity_program_ttt(struct radeon_device *rdev)
{
 struct trinity_power_info *pi = trinity_get_pi(rdev);
 u32 value = tn_smc_rreg(rdev, (0x1f10c));
 value &= ~((0xffff << 16) | (0xffff << 0));
 value |= (((pi->thermal_auto_throttling + 49) * 8) << 16);
 value |= (((pi->thermal_auto_throttling + 49 - pi->sys_info.htc_hyst_lmt) * 8) << 0);
 tn_smc_wreg(rdev, (0x1f10c), (value));
}
static void trinity_enable_att(struct radeon_device *rdev)
{
 u32 value = tn_smc_rreg(rdev, (0x1f108));
 value &= ~(0xff << 0);
 value |= ((1) << 0);
 tn_smc_wreg(rdev, (0x1f108), (value));
}
       ...
       int min_temp, int max_temp)
{
 ...
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x738), 0); tmp_ &= (~(0xff << 0)); tmp_ |= ((((49 + (high_temp / 1000)) << 0)) & ~(~(0xff << 0))); r100_mm_wreg(rdev, (0x738), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x738), 0); tmp_ &= (~(0xff << 8)); tmp_ |= ((((49 + (low_temp / 1000)) << 8)) & ~(~(0xff << 8))); r100_mm_wreg(rdev, (0x738), (tmp_), 0); } while (0);
...
int trinity_dpm_late_enable(struct radeon_device *rdev)
{
 ...
 if (rdev->irq.installed &&
  ...
  ret = trinity_set_thermal_temperature_range(rdev, (90 * 1000), (120 * 1000));
  if (ret) {
   trinity_release_mutex(rdev);
   return ret;
  }
...
static void trinity_get_min_sclk_divider(struct radeon_device *rdev)
{
 struct trinity_power_info *pi = trinity_get_pi(rdev);
 pi->min_sclk_did =
  (tn_smc_rreg(rdev, (0xe0001004)) & (0x7f << 2)) >> 2;
}
      ...
      struct radeon_ps *rps)
{
 ...
 if (pi->sys_info.nb_dpm_enable) {
  nbpsconfig = tn_smc_rreg(rdev, (0x1f5f8));
  nbpsconfig &= ~((3 << 0) | (3 << 2) | (3 << 4) | (3 << 6));
  nbpsconfig |= (((new_ps->Dpm0PgNbPsLo) << 0) |
          ((new_ps->Dpm0PgNbPsHi) << 2) |
          ((new_ps->DpmXNbPsLo) << 4) |
          ((new_ps->DpmXNbPsHi) << 6));
  tn_smc_wreg(rdev, (0x1f5f8), (nbpsconfig));
 }
}
int trinity_dpm_force_performance_level(struct radeon_device *rdev,
     enum radeon_dpm_forced_level level)
        ...
        u32 vid_2bit)
{
 ...
 u32 svi_mode = (tn_smc_rreg(rdev, (0x1f428)) & (1 << 29)) ? 1 : 0;
       ...
       u32 lower_limit)
{
 ...
 if (i == pi->sys_info.sclk_voltage_mapping_table.num_max_dpm_entries)
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "engine clock out of range!", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 return 0;
}
           ...
           struct radeon_ps *rps)
{
 ...
 if (i >= 4) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "UVD clock index not found!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  i = 3;
 }
 return i;
}
          ...
          struct radeon_ps *old_rps)
{
 ...
 if ((new_rps->class & (0x4000 | 0x8000)) ||
     ((new_rps->class & 0x0007) == 1))
  ps->bapm_flags |= (1 << 0);
 if (pi->sys_info.nb_dpm_enable) {
  ps->Dpm0PgNbPsLo = 0x1;
  ps->Dpm0PgNbPsHi = 0x0;
  ...
  if ((new_rps->class & (0x4000 | 0x8000)) ||
      ((new_rps->class & 0x0007) == 1)) {
   force_high = ((new_rps->class & 0x4000) ||
...
static int trinity_parse_sys_info_table(struct radeon_device *rdev)
{
 ...
 if (atom_parse_data_header(mode_info->atom_context, index, ((void *)0),
  ...
  pi->sys_info.bootup_sclk = (__uint32_t)(__builtin_constant_p(igp_info->info_7.ulBootUpEngineClock) ? (__uint32_t)(((__uint32_t)(igp_info->info_7.ulBootUpEngineClock) & 0xff) << 24 | ((__uint32_t)(igp_info->info_7.ulBootUpEngineClock) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_7.ulBootUpEngineClock) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_7.ulBootUpEngineClock) & 0xff000000) >> 24) : __swap32md(igp_info->info_7.ulBootUpEngineClock));
  pi->sys_info.min_sclk = (__uint32_t)(__builtin_constant_p(igp_info->info_7.ulMinEngineClock) ? (__uint32_t)(((__uint32_t)(igp_info->info_7.ulMinEngineClock) & 0xff) << 24 | ((__uint32_t)(igp_info->info_7.ulMinEngineClock) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_7.ulMinEngineClock) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_7.ulMinEngineClock) & 0xff000000) >> 24) : __swap32md(igp_info->info_7.ulMinEngineClock));
  pi->sys_info.bootup_uma_clk = (__uint32_t)(__builtin_constant_p(igp_info->info_7.ulBootUpUMAClock) ? (__uint32_t)(((__uint32_t)(igp_info->info_7.ulBootUpUMAClock) & 0xff) << 24 | ((__uint32_t)(igp_info->info_7.ulBootUpUMAClock) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_7.ulBootUpUMAClock) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_7.ulBootUpUMAClock) & 0xff000000) >> 24) : __swap32md(igp_info->info_7.ulBootUpUMAClock));
  pi->sys_info.dentist_vco_freq = (__uint32_t)(__builtin_constant_p(igp_info->info_7.ulDentistVCOFreq) ? (__uint32_t)(((__uint32_t)(igp_info->info_7.ulDentistVCOFreq) & 0xff) << 24 | ((__uint32_t)(igp_info->info_7.ulDentistVCOFreq) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_7.ulDentistVCOFreq) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_7.ulDentistVCOFreq) & 0xff000000) >> 24) : __swap32md(igp_info->info_7.ulDentistVCOFreq));
  pi->sys_info.bootup_nb_voltage_index =
   (__uint16_t)(__builtin_constant_p(igp_info->info_7.usBootUpNBVoltage) ? (__uint16_t)(((__uint16_t)(igp_info->info_7.usBootUpNBVoltage) & 0xffU) << 8 | ((__uint16_t)(igp_info->info_7.usBootUpNBVoltage) & 0xff00U) >> 8) : __swap16md(igp_info->info_7.usBootUpNBVoltage));
  ...
  for (i = 0; i < 4; i++) {
   pi->sys_info.nbp_mclk[i] = (__uint32_t)(__builtin_constant_p(igp_info->info_7.ulNbpStateMemclkFreq[i]) ? (__uint32_t)(((__uint32_t)(igp_info->info_7.ulNbpStateMemclkFreq[i]) & 0xff) << 24 | ((__uint32_t)(igp_info->info_7.ulNbpStateMemclkFreq[i]) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_7.ulNbpStateMemclkFreq[i]) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_7.ulNbpStateMemclkFreq[i]) & 0xff000000) >> 24) : __swap32md(igp_info->info_7.ulNbpStateMemclkFreq[i]));
   pi->sys_info.nbp_nclk[i] = (__uint32_t)(__builtin_constant_p(igp_info->info_7.ulNbpStateNClkFreq[i]) ? (__uint32_t)(((__uint32_t)(igp_info->info_7.ulNbpStateNClkFreq[i]) & 0xff) << 24 | ((__uint32_t)(igp_info->info_7.ulNbpStateNClkFreq[i]) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_7.ulNbpStateNClkFreq[i]) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_7.ulNbpStateNClkFreq[i]) & 0xff000000) >> 24) : __swap32md(igp_info->info_7.ulNbpStateNClkFreq[i]));
  }
  pi->sys_info.nbp_voltage_index[0] = (__uint16_t)(__builtin_constant_p(igp_info->info_7.usNBP0Voltage) ? (__uint16_t)(((__uint16_t)(igp_info->info_7.usNBP0Voltage) & 0xffU) << 8 | ((__uint16_t)(igp_info->info_7.usNBP0Voltage) & 0xff00U) >> 8) : __swap16md(igp_info->info_7.usNBP0Voltage));
  pi->sys_info.nbp_voltage_index[1] = (__uint16_t)(__builtin_constant_p(igp_info->info_7.usNBP1Voltage) ? (__uint16_t)(((__uint16_t)(igp_info->info_7.usNBP1Voltage) & 0xffU) << 8 | ((__uint16_t)(igp_info->info_7.usNBP1Voltage) & 0xff00U) >> 8) : __swap16md(igp_info->info_7.usNBP1Voltage));
  pi->sys_info.nbp_voltage_index[2] = (__uint16_t)(__builtin_constant_p(igp_info->info_7.usNBP2Voltage) ? (__uint16_t)(((__uint16_t)(igp_info->info_7.usNBP2Voltage) & 0xffU) << 8 | ((__uint16_t)(igp_info->info_7.usNBP2Voltage) & 0xff00U) >> 8) : __swap16md(igp_info->info_7.usNBP2Voltage));
  pi->sys_info.nbp_voltage_index[3] = (__uint16_t)(__builtin_constant_p(igp_info->info_7.usNBP3Voltage) ? (__uint16_t)(((__uint16_t)(igp_info->info_7.usNBP3Voltage) & 0xffU) << 8 | ((__uint16_t)(igp_info->info_7.usNBP3Voltage) & 0xff00U) >> 8) : __swap16md(igp_info->info_7.usNBP3Voltage));
  if (!pi->sys_info.nb_dpm_enable) {
   for (i = 1; i < 4; i++) {
...
int trinity_dpm_init(struct radeon_device *rdev)
{
 ...
 int ret, i;
 pi = kzalloc(sizeof(struct trinity_power_info), (0x0001 | 0x0004));
 if (pi == ((void *)0))
  return -12;
 rdev->pm.dpm.priv = pi;
 for (i = 0; i < 5; i++)
        ...
        struct seq_file *m)
{
 ...
 u32 current_index =
  (r100_mm_rreg(rdev, (0x684), 0) & (0xf << 4)) >>
  4;
