# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c"
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c"
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c" 2
...
int semctl1(struct proc *, int, int, int, union semun *, register_t *,
     ...
     int (*)(const void *, void *, size_t));
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c" 2
...
struct { struct sem_undo *slh_first; } semu_list;
...
seminit(void)
{
 ...
 pool_init(&sema_pool, sizeof(struct semid_ds), 0, 0, 0x0001,
     "semapl", ((void *)0));
 pool_init(&semu_pool, (sizeof(struct sem_undo)+sizeof(struct undo)*10), 0, 0, 0x0001, "semupl", ((void *)0));
 sema = mallocarray(seminfo.semmni, sizeof(struct semid_ds *),
     31, 0x0001|0x0008);
 semseqs = mallocarray(seminfo.semmni, sizeof(unsigned short),
     31, 0x0001|0x0008);
 { ((&semu_list)->slh_first) = ((void *)0); };
}
...
semu_alloc(struct process *pr)
{
 ...
 semutot++;
 if ((suptr = pool_get(&semu_pool, 0x0002)) == ((void *)0)) {
  sutmp = pool_get(&semu_pool, 0x0001);
  for((suptr) = ((&semu_list)->slh_first); (suptr) != ((void *)0); (suptr) = ((suptr)->un_next.sle_next)) {
   if (suptr->un_proc == pr) {
 ...
 suptr->un_cnt = 0;
 suptr->un_proc = pr;
 do { (suptr)->un_next.sle_next = (&semu_list)->slh_first; (&semu_list)->slh_first = (suptr); } while (0);
 return (suptr);
}
...
{
 struct sem_undo *suptr = ((&semu_list)->slh_first);
 struct sem_undo *suprev = ((void *)0);
 struct undo *sunptr;
 int i;
 ...
 while (suptr != ((void *)0)) {
  ...
  if (suptr->un_cnt == 0) {
   ...
   if (suptr == ((&semu_list)->slh_first))
    do { (&semu_list)->slh_first = (&semu_list)->slh_first->un_next.sle_next; } while (0);
   else
    do { (suprev)->un_next.sle_next = (suprev)->un_next.sle_next->un_next.sle_next; } while (0);
   suptr = ((suptr)->un_next.sle_next);
   pool_put(&semu_pool, sutmp);
   semutot--;
  } else {
   suprev = suptr;
...
{
 struct sys___semctl_args *uap = v;
 ...
 union semun arg;
 int error = 0, cmd = ((uap)->cmd.be.datum);
 ...
 case 8:
 case 9:
  error = copyin(((uap)->arg.be.datum), &arg, sizeof(arg));
  break;
 }
 if (error == 0) {
  error = semctl1(p, ((uap)->semid.be.datum), ((uap)->semnum.be.datum),
    ...
    int (*ds_copyout)(const void *, void *, size_t))
{
 ...
 if ((semaptr = sema[ix]) == ((void *)0) ||
     semaptr->sem_perm.seq != (((semid) >> 16) & 0xffff))
  return (22);

 switch (cmd) {
 case 0:
  if ((error = ipcperm(cred, &semaptr->sem_perm, 010000)) != 0)
   return (error);
  semaptr->sem_perm.cuid = cred->cr_uid;
  semaptr->sem_perm.uid = cred->cr_uid;
  semtot -= semaptr->sem_nsems;
  free(semaptr->sem_base, 31, 0);
 ...
 case 1:
  if ((error = ipcperm(cred, &semaptr->sem_perm, 010000)))
   return (error);
 ...
 case 2:
  if ((error = ipcperm(cred, &semaptr->sem_perm, 000400)))
   return (error);
 ...
 case 8:
  if ((error = ipcperm(cred, &semaptr->sem_perm, 000200)))
   return (error);
  if (semnum < 0 || semnum >= semaptr->sem_nsems)
   return (22);
...
{
 struct sys_semget_args *uap = v;




 int semid, error;
 int key = ((uap)->key.be.datum);
 int nsems = ((uap)->nsems.be.datum);
 int semflg = ((uap)->semflg.be.datum);
 struct semid_ds *semaptr, *semaptr_new = ((void *)0);
 struct ucred *cred = p->p_ucred;
 ...
 if (key == (key_t)0 || (semflg & 001000)) {
  ...
  semaptr_new = pool_get(&sema_pool, 0x0001);
  semaptr_new->sem_base = mallocarray(nsems, sizeof(struct sem),
      31, 0x0001|0x0008);
 }

 if (key != (key_t)0) {
  for (semid = 0, semaptr = ((void *)0); semid < seminfo.semmni; semid++) {
   if ((semaptr = sema[semid]) != ((void *)0) &&
    ...
    if ((semflg & 001000) && (semflg & 002000)) {
     ;
     error = 17;
     goto error;
    }
    if (semaptr_new != ((void *)0)) {
     free(semaptr_new->sem_base, 31,
...
found:
 *retval = (((sema[semid]->sem_perm.seq) << 16) | (semid & 0xffff));
 return (0);
error:
 if (semaptr_new != ((void *)0)) {
  free(semaptr_new->sem_base, 31, nsems * sizeof(struct sem));
  pool_put(&sema_pool, semaptr_new);
 }
 return (error);
}
...
{
 struct sys_semop_args *uap = v;





 struct sembuf sopbuf[8];
 int semid = ((uap)->semid.be.datum);
 size_t nsops = ((uap)->nsops.be.datum);
 struct sembuf *sops;
 struct semid_ds *semaptr;
 struct sembuf *sopptr = ((void *)0);
 struct sem *semptr = ((void *)0);
 struct sem_undo *suptr = ((void *)0);
 struct ucred *cred = p->p_ucred;
 size_t i, j;
 ...
 if ((semaptr = sema[semid]) == ((void *)0) ||
     semaptr->sem_perm.seq != (((((uap)->semid.be.datum)) >> 16) & 0xffff))
  return (22);
 ...
 if (nsops <= 8)
  ...
  sops = mallocarray(nsops, sizeof(struct sembuf), 31, 0x0001);
 error = copyin(((uap)->sops.be.datum), sops, nsops * sizeof(struct sembuf));
 if (error != 0) {
  ;

  goto done2;
 }
# 565 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c"
 do_undos = 0;
 ...
 for (;;) {
  ...
  ;
  error = tsleep(&sema[semid], 36 | 0x100,
      "semwait", 0);
  ;
 ...
 if (do_undos) {
  for (i = 0; i < nsops; i++) {
   ...
   if (error == 0)
    continue;
# 716 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_sem.c"
   for (j = i; j > 0;) {
    j--;
    if ((sops[j].sem_flg & 010000) == 0)
     continue;
...
done2:
 if (sops != sopbuf)
  free(sops, 31, nsops * sizeof(struct sembuf));
 return (error);
}
...
semexit(struct process *pr)
{
 ...
 supptr = &((&semu_list)->slh_first);
 for((suptr) = ((&semu_list)->slh_first); (suptr) != ((void *)0); (suptr) = ((suptr)->un_next.sle_next)) {
  if (suptr->un_proc == pr)
   break;
  supptr = &((suptr)->un_next.sle_next);
 }
 ...
 void *newp, size_t newlen)
{
 ...
 case 1:
  ...
  sema_new = mallocarray(val, sizeof(struct semid_ds *),
      31, 0x0001|0x0008);
  __builtin_memcpy((sema_new), (sema), (seminfo.semmni * sizeof(struct semid_ds *)));

  newseqs = mallocarray(val, sizeof(unsigned short), 31,
      0x0001|0x0008);
  __builtin_memcpy((newseqs), (semseqs), (seminfo.semmni * sizeof(unsigned short)));
