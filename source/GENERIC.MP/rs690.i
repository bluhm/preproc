...
static void rs690_mc_init(struct radeon_device *rdev)
{
 ...
 h_addr = (((rdev->mc_rreg(rdev, (0x00005F))) >> 0) & 0xFF);
 l_addr = rdev->mc_rreg(rdev, (0x00001E));
         ...
         struct drm_display_mode *mode2)
{
 ...
 if (mode1)
  rdev->mode_info.crtcs[0]->lb_vblank_lead_lines = (((lb_size) + ((mode1->crtc_hdisplay) - 1)) / (mode1->crtc_hdisplay));
 if (mode2)
  rdev->mode_info.crtcs[1]->lb_vblank_lead_lines = (((lb_size) + ((mode2->crtc_hdisplay) - 1)) / (mode2->crtc_hdisplay));
}
      ...
      _Bool low)
{
 ...
 a.full = (u32)(((16) << 12));
 sclk.full = ((u64)((u64)(max_bandwidth).full * (a).full + 2048) >> 12);
 a.full = (u32)(((1000) << 12));
 sclk.full = dfixed_div(a, sclk);
 a.full = (u32)(((256 * 13) << 12));
 chunk_time.full = ((u64)((u64)(sclk).full * (a).full + 2048) >> 12);
 a.full = (u32)(((10) << 12));
     ...
     u32 *d2mode_priority_a_cnt)
{
 ...
 fixed20_12 a, b;
 *d1mode_priority_a_cnt = (((1) & 0x1) << 16);
 *d2mode_priority_a_cnt = (((1) & 0x1) << 16);
 if (mode0 && mode1) {
...
void rs690_bandwidth_update(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x00654C), (d1mode_priority_b_cnt), 0);
 r100_mm_wreg(rdev, (0x006D48), (d2mode_priority_a_cnt), 0);
 r100_mm_wreg(rdev, (0x006D4C), (d2mode_priority_b_cnt), 0);
}
uint32_t rs690_mc_rreg(struct radeon_device *rdev, uint32_t reg64)
{
 unsigned long flags;
