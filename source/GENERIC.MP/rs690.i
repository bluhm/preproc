# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690d.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c" 2
...
int rs690_mc_wait_for_idle(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < rdev->usec_timeout; i++) {
  ...
  tmp = rdev->mc_rreg(rdev, (0x000090));
  if ((((tmp) >> 0) & 0x1))
   return 0;
  udelay(1);
 }
...
void rs690_pm_info(struct radeon_device *rdev)
{
 int index = (((char*)(&((ATOM_MASTER_LIST_OF_DATA_TABLES*)0)->IntegratedSystemInfo)-(char*)0)/sizeof(USHORT));
 union igp_info *info;
 ...
 if (atom_parse_data_header(rdev->mode_info.atom_context, index, ((void *)0),
  ...
  default:
   ...
   rdev->pm.igp_system_mclk.full = (u32)(((200) << 12));
   rdev->pm.igp_ht_link_clk.full = (u32)(((1000) << 12));
   rdev->pm.igp_ht_link_width.full = (u32)(((8) << 12));
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "No integrated system info for your GPU, using safe default\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   break;
  }
 } else {
 ...
 tmp.full = (u32)(((4) << 12));
 rdev->pm.k8_bandwidth.full = ((u64)((u64)(rdev->pm.igp_system_mclk).full * (tmp).full + 2048) >> 12);



 tmp.full = (u32)(((5) << 12));
 rdev->pm.ht_bandwidth.full = ((u64)((u64)(rdev->pm.igp_ht_link_clk).full * (rdev->pm.igp_ht_link_width).full + 2048) >> 12);
 ...
 tmp.full = (u32)(((14) << 12));
 rdev->pm.sideport_bandwidth.full = ((u64)((u64)(rdev->pm.igp_sideport_mclk).full * (tmp).full + 2048) >> 12);
 tmp.full = (u32)(((10) << 12));
...
static void rs690_mc_init(struct radeon_device *rdev)
{
 ...
 rdev->mc.real_vram_size = r100_mm_rreg(rdev, (0x00f8), 0);
 rdev->mc.mc_vram_size = rdev->mc.real_vram_size;
 rdev->mc.aper_base = rdev->fb_aper_offset;
 rdev->mc.aper_size = rdev->fb_aper_size;
 rdev->mc.visible_vram_size = rdev->mc.aper_size;
 base = rdev->mc_rreg(rdev, (0x000100));
 base = (((base) >> 0) & 0xFFFF) << 16;
...
{
 u32 tmp;
# 202 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c"
 tmp = r100_mm_rreg(rdev, (0x006520), 0) & 0xFFFFFFFC;
 tmp &= ~0xFFFFFFFB;
 ...
 r100_mm_wreg(rdev, (0x006520), (tmp), 0);
}
      ...
      struct rs690_watermark *wm)
{
 ...
 if (rdev->mc.igp_sideport_enabled) {
  ...
  read_delay_latency.full = (u32)(((370 * 800) << 12));
  a.full = (u32)(((1000) << 12));
  b.full = dfixed_div(rdev->pm.igp_sideport_mclk, a);
  read_delay_latency.full = dfixed_div(read_delay_latency, b);
  read_delay_latency.full = ((u64)((u64)(read_delay_latency).full * (a).full + 2048) >> 12);
 } else {
  ...
  read_delay_latency.full = (u32)(((5000) << 12));
 }


 a.full = (u32)(((16) << 12));
 rdev->pm.sclk.full = ((u64)((u64)(rdev->pm.max_bandwidth).full * (a).full + 2048) >> 12);
 a.full = (u32)(((1000) << 12));
 ...
 a.full = (u32)(((256 * 13) << 12));
 chunk_time.full = ((u64)((u64)(rdev->pm.sclk).full * (a).full + 2048) >> 12);
 a.full = (u32)(((10) << 12));
 chunk_time.full = dfixed_div(chunk_time, a);
# 357 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c"
...
# 377 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs690.c"
 ...
 if (((estimated_width).full >> 12) > crtc->base.mode.crtc_hdisplay) {
  wm->priority_mark.full = (u32)(((10) << 12));
 } else {
  a.full = (u32)(((16) << 12));
...
void rs690_bandwidth_update(struct radeon_device *rdev)
{
 ...
 u32 tmp;
 u32 d1mode_priority_a_cnt = (((1) & 0x1) << 16);
 u32 d2mode_priority_a_cnt = (((1) & 0x1) << 16);
 ...
 if ((rdev->disp_priority == 2) &&
  ...
  tmp = rdev->mc_rreg(rdev, (0x000104));
  tmp &= 0xFFFFF0FF;
  tmp &= 0xFFFF0FFF;
  if (mode0)
   tmp |= (((1) & 0xF) << 8);
  if (mode1)
   tmp |= (((1) & 0xF) << 12);
  rdev->mc_wreg(rdev, (0x000104), (tmp));
 }
 rs690_line_buffer_adjust(rdev, mode0, mode1);

 if ((rdev->family == CHIP_RS690) || (rdev->family == CHIP_RS740))
  r100_mm_wreg(rdev, (0x006C9C), (0), 0);
 if ((rdev->family == CHIP_RS780) || (rdev->family == CHIP_RS880))
  r100_mm_wreg(rdev, (0x006C9C), (2), 0);
 ...
 r100_mm_wreg(rdev, (0x006D58), (tmp), 0);

 if (mode0 && mode1) {
  if (((wm0.dbpp).full >> 12) > 64)
   a.full = ((u64)((u64)(wm0.dbpp).full * (wm0.num_line_pair).full + 2048) >> 12);
  else
   a.full = wm0.num_line_pair.full;
  if (((wm1.dbpp).full >> 12) > 64)
   b.full = ((u64)((u64)(wm1.dbpp).full * (wm1.num_line_pair).full + 2048) >> 12);
  else
  ...
  if (rdev->disp_priority == 2) {
   d1mode_priority_a_cnt |= (((1) & 0x1) << 20);
   d2mode_priority_a_cnt |= (((1) & 0x1) << 20);
  }
 } else if (mode0) {
  if (((wm0.dbpp).full >> 12) > 64)
   a.full = ((u64)((u64)(wm0.dbpp).full * (wm0.num_line_pair).full + 2048) >> 12);
  ...
  if (((wm1.dbpp).full >> 12) > 64)
   a.full = ((u64)((u64)(wm1.dbpp).full * (wm1.num_line_pair).full + 2048) >> 12);
  else
 ...
 r100_mm_wreg(rdev, (0x006548), (d1mode_priority_a_cnt), 0);
 r100_mm_wreg(rdev, (0x00654C), (d1mode_priority_a_cnt), 0);
 r100_mm_wreg(rdev, (0x006D48), (d2mode_priority_a_cnt), 0);
 r100_mm_wreg(rdev, (0x006D4C), (d2mode_priority_a_cnt), 0);
}
...
uint32_t rs690_mc_rreg(struct radeon_device *rdev, uint32_t reg64)
{
 ...
 r100_mm_wreg(rdev, (0x000078), ((((reg64) & 0x1FF) << 0)), 0);
 r = r100_mm_rreg(rdev, (0x00007C), 0);
 r100_mm_wreg(rdev, (0x000078), (~0xFFFFFE00), 0);
 return r;
}

void rs690_mc_wreg(struct radeon_device *rdev, uint32_t reg64, uint32_t v)
{
 r100_mm_wreg(rdev, (0x000078), ((((reg64) & 0x1FF) << 0) | (((1) & 0x1) << 9)), 0);

 r100_mm_wreg(rdev, (0x00007C), (v), 0);
 r100_mm_wreg(rdev, (0x000078), (0x7F), 0);
}
...
static void rs690_mc_program(struct radeon_device *rdev)
{
 ...
 rdev->mc_wreg(rdev, (0x000100), ((((rdev->mc.vram_start >> 16) & 0xFFFF) << 0) | (((rdev->mc.vram_end >> 16) & 0xFFFF) << 16)));
