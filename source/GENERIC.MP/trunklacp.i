# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c"
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
uint64_t SipHash(const SIPHASH_KEY *, int, int, const void *, size_t)
      __attribute__ ((__bounded__ (__buffer__, 4, 5) ));
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_trunk.h" 1
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_trunk.h"
enum trunk_proto {
 TRUNK_PROTO_NONE = 0,
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_trunk.h"
struct lacp_opreq {
...
# 128 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_trunk.h"
struct trunk_softc;
struct trunk_port {
 struct ifnet *tp_if;
...
# 158 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_trunk.h"
struct trunk_mc {
 union {
...
# 217 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_trunk.h"
struct trunk_lb {
 SIPHASH_KEY lb_key;
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.h"
struct slowprothdr {
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.h"
struct tlv_template {
 u_int8_t tmpl_type;
...
# 156 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.h"
struct markerdu {
...
# 260 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.h"
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c" 2
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c"
const u_int8_t ethermulticastaddr_slowprotocols[6] =
...
# 205 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c"
...
const lacp_timer_func_t lacp_timer_funcs[3] = {
 [0] = lacp_sm_rx_timer,
 [1] = lacp_sm_ptx_timer,
 [2] = lacp_sm_mux_timer,
};
...
{
 struct lacp_port *lp = ((struct lacp_port *)(tp)->tp_psc);
 ...
 if (((__uint16_t)(eh->ether_type)) == 0x8809) {

  if (tp->tp_if->if_bpf)
   bpf_mtap_ether(tp->tp_if->if_bpf, m, 1);


  if (m->M_dat.MH.MH_pkthdr.len < (sizeof(*eh) + sizeof(subtype)))
   return (-1);
 ...
 if ((lp->lp_actor.lip_state & (1<<4)) == 0 ||
     la == ((void *)0) || la != lsc->lsc_active_aggregator) {
  m_freem(m);
  return (-1);
 }
...
lacp_input_process(void *arg)
{
 ...
 for((lp) = ((&lsc->lsc_ports)->lh_first); (lp)!= ((void *)0); (lp) = ((lp)->lp_next.le_next)) {
  while ((m = mq_dequeue(&lp->lp_mq)) != ((void *)0)) {
...
lacp_pdu_input(struct lacp_port *lp, struct mbuf *m)
{
 ...
 if (m->M_dat.MH.MH_pkthdr.len != sizeof(*du))
  goto bad;

 if (m->m_hdr.mh_len < sizeof(*du)) {
  m = m_pullup(m, sizeof(*du));
  if (m == ((void *)0))
   return (12);
 }
 du = ((struct lacpdu *)((m)->m_hdr.mh_data));

 if (__builtin_memcmp((&du->ldu_eh.ether_dhost), (&ethermulticastaddr_slowprotocols), (6)))

  goto bad;
# 332 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c"
...
lacp_fill_actorinfo(struct lacp_port *lp, struct lacp_peerinfo *info)
{
 ...
 info->lip_systemid.lsi_prio = ((__uint16_t)(0x8000));
 __builtin_memcpy((&info->lip_systemid.lsi_mac), (sc->tr_ac.ac_enaddr), (6));

 info->lip_portid.lpi_prio = ((__uint16_t)(0x8000));
 info->lip_portid.lpi_portno = ((__uint16_t)(lp->lp_ifp->if_index));
 info->lip_state = lp->lp_actor.lip_state;
}
...
lacp_fill_markerinfo(struct lacp_port *lp, struct lacp_markerinfo *info)
{
 ...
 info->mi_rq_port = ((__uint16_t)(ifp->if_index));
 __builtin_memcpy((&info->mi_rq_system), (lp->lp_actor.lip_systemid.lsi_mac), (6));
 info->mi_rq_xid = ((__uint32_t)(0));
}
...
lacp_xmit_lacpdu(struct lacp_port *lp)
{
 ...
 if (m == ((void *)0))
  return (12);
 m->m_hdr.mh_len = m->M_dat.MH.MH_pkthdr.len = sizeof(*du);
 m->M_dat.MH.MH_pkthdr.pf.prio = 6;

 du = ((struct lacpdu *)((m)->m_hdr.mh_data));
 __builtin_memset((du), (0), (sizeof(*du)));

 __builtin_memcpy((&du->ldu_eh.ether_dhost), (ethermulticastaddr_slowprotocols), (6));

 __builtin_memcpy((&du->ldu_eh.ether_shost), (tp->tp_lladdr), (6));
 du->ldu_eh.ether_type = ((__uint16_t)(0x8809));

 du->ldu_sph.sph_subtype = 1;
 du->ldu_sph.sph_version = 1;

 do { (&du->ldu_tlv_actor)->tlv_type = (1); (&du->ldu_tlv_actor)->tlv_length = sizeof(*&du->ldu_tlv_actor) + (sizeof(du->ldu_actor)); } while ( 0);
 du->ldu_actor = lp->lp_actor;

 do { (&du->ldu_tlv_partner)->tlv_type = (2); (&du->ldu_tlv_partner)->tlv_length = sizeof(*&du->ldu_tlv_partner) + (sizeof(du->ldu_partner)); } while ( 0);

 du->ldu_partner = lp->lp_partner;

 do { (&du->ldu_tlv_collector)->tlv_type = (3); (&du->ldu_tlv_collector)->tlv_length = sizeof(*&du->ldu_tlv_collector) + (sizeof(du->ldu_collector)); } while ( 0);
...
lacp_xmit_marker(struct lacp_port *lp)
{
 ...
 if (m == ((void *)0))
  return (12);
 m->m_hdr.mh_len = m->M_dat.MH.MH_pkthdr.len = sizeof(*mdu);
 m->M_dat.MH.MH_pkthdr.pf.prio = 6;

 mdu = ((struct markerdu *)((m)->m_hdr.mh_data));
 __builtin_memset((mdu), (0), (sizeof(*mdu)));

 __builtin_memcpy((&mdu->mdu_eh.ether_dhost), (ethermulticastaddr_slowprotocols), (6));

 __builtin_memcpy((&mdu->mdu_eh.ether_shost), (tp->tp_lladdr), (6));
 mdu->mdu_eh.ether_type = ((__uint16_t)(0x8809));

 mdu->mdu_sph.sph_subtype = 2;
 mdu->mdu_sph.sph_version = 1;


 lp->lp_marker.mi_rq_xid = ((__uint32_t)(((__uint32_t)(lp->lp_marker.mi_rq_xid)) + 1));
 do { (&mdu->mdu_tlv)->tlv_type = (0x01); (&mdu->mdu_tlv)->tlv_length = sizeof(*&mdu->mdu_tlv) + (sizeof(mdu->mdu_info)); } while ( 0);
...
lacp_linkstate(struct trunk_port *tp)
{
 ...
 old_state = lp->lp_actor.lip_state;
 old_key = lp->lp_actor.lip_key;





 if (tp->tp_if->if_data.ifi_link_state == 0 ||
     tp->tp_if->if_data.ifi_link_state == 6)
  lacp_port_enable(lp);
 else
  lacp_port_disable(lp);

 lp->lp_actor.lip_key = lacp_compose_key(lp);

 if (old_state != lp->lp_actor.lip_state || old_key != lp->lp_actor.lip_key) {
  ;
...
lacp_tick(void *arg)
{
 ...
 for((lp) = ((&lsc->lsc_ports)->lh_first); (lp)!= ((void *)0); (lp) = ((lp)->lp_next.le_next)) {
  if ((lp->lp_actor.lip_state & (1<<2)) == 0)
   continue;
...
{
 struct trunk_softc *sc = tp->tp_trunk;
 struct lacp_softc *lsc = ((struct lacp_softc *)(sc)->tr_psc);
 struct lacp_port *lp;
 ...
 __builtin_bzero((&ifr), (sizeof(ifr)));
 ifr.ifr_ifru.ifru_addr.sa_family = 0;
 ifr.ifr_ifru.ifru_addr.sa_len = 6;
 __builtin_bcopy((&ethermulticastaddr_slowprotocols), (ifr.ifr_ifru.ifru_addr.sa_data), (6));


 error = ether_addmulti(&ifr, (struct arpcom *)ifp);
 if (error && error != 52) {
  printf("%s: ADDMULTI failed on %s\n", __func__, tp->tp_if->if_xname);
  return (error);
 }
 ...
 mq_init(&lp->lp_mq, 8, 6);

 do { if (((lp)->lp_next.le_next = (&lsc->lsc_ports)->lh_first) != ((void *)0)) (&lsc->lsc_ports)->lh_first->lp_next.le_prev = &(lp)->lp_next.le_next; (&lsc->lsc_ports)->lh_first = (lp); (lp)->lp_next.le_prev = &(&lsc->lsc_ports)->lh_first; } while (0);

 lacp_fill_actorinfo(lp, &lp->lp_actor);
 lacp_fill_markerinfo(lp, &lp->lp_marker);
 lp->lp_actor.lip_state =
     (active ? (1<<0) : 0) |
     (fast ? (1<<1) : 0);
...
lacp_port_destroy(struct trunk_port *tp)
{
 ...
 do { if ((lp)->lp_next.le_next != ((void *)0)) (lp)->lp_next.le_next->lp_next.le_prev = (lp)->lp_next.le_prev; *(lp)->lp_next.le_prev = (lp)->lp_next.le_next; ((lp)->lp_next.le_prev) = ((void *)-1); ((lp)->lp_next.le_next) = ((void *)-1); } while (0);
...
lacp_req(struct trunk_softc *sc, caddr_t data)
{
 ...
 __builtin_bzero((req), (sizeof(struct lacp_opreq)));
 if (la != ((void *)0)) {
  req->actor_prio = ((__uint16_t)(la->la_actor.lip_systemid.lsi_prio));
  __builtin_memcpy((&req->actor_mac), (&la->la_actor.lip_systemid.lsi_mac), (6));

  req->actor_key = ((__uint16_t)(la->la_actor.lip_key));
  req->actor_portprio = ((__uint16_t)(la->la_actor.lip_portid.lpi_prio));
  req->actor_portno = ((__uint16_t)(la->la_actor.lip_portid.lpi_portno));
  req->actor_state = la->la_actor.lip_state;

  req->partner_prio = ((__uint16_t)(la->la_partner.lip_systemid.lsi_prio));
  __builtin_memcpy((&req->partner_mac), (&la->la_partner.lip_systemid.lsi_mac), (6));

  req->partner_key = ((__uint16_t)(la->la_partner.lip_key));
  req->partner_portprio =
      ((__uint16_t)(la->la_partner.lip_portid.lpi_prio));
  req->partner_portno =
      ((__uint16_t)(la->la_partner.lip_portid.lpi_portno));
...
{
 struct lacp_port *lp = ((struct lacp_port *)(lgp)->tp_psc);
 struct lacp_softc *lsc = lp->lp_lsc;
 struct lacp_aggregator *la = lp->lp_aggregator;
 u_int flags = 0;


 if (la != ((void *)0) && la == lsc->lsc_active_aggregator)
  flags |= 0x00000004;

 if (lp->lp_actor.lip_state & (1<<4))
  flags |= 0x00000008;
 if (lp->lp_actor.lip_state & (1<<5))
  flags |= 0x00000010;
...
lacp_portreq(struct trunk_port *tp, caddr_t data)
{
 ...
 req->actor_prio = ((__uint16_t)(lp->lp_actor.lip_systemid.lsi_prio));
 __builtin_memcpy((&req->actor_mac), (&lp->lp_actor.lip_systemid.lsi_mac), (6));

 req->actor_key = ((__uint16_t)(lp->lp_actor.lip_key));
 req->actor_portprio = ((__uint16_t)(lp->lp_actor.lip_portid.lpi_prio));
 req->actor_portno = ((__uint16_t)(lp->lp_actor.lip_portid.lpi_portno));
 req->actor_state = lp->lp_actor.lip_state;

 req->partner_prio = ((__uint16_t)(lp->lp_partner.lip_systemid.lsi_prio));
 __builtin_memcpy((&req->partner_mac), (&lp->lp_partner.lip_systemid.lsi_mac), (6));

 req->partner_key = ((__uint16_t)(lp->lp_partner.lip_key));
 req->partner_portprio = ((__uint16_t)(lp->lp_partner.lip_portid.lpi_prio));
 req->partner_portno = ((__uint16_t)(lp->lp_partner.lip_portid.lpi_portno));
...
lacp_disable_distributing(struct lacp_port *lp)
{
 ...
 if (la == ((void *)0) || (lp->lp_actor.lip_state & (1<<5)) == 0)
  return;

 ((!(((&la->la_ports)->tqh_first) == ((void *)0))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 687, "!TAILQ_EMPTY(&la->la_ports)"));
 ((la->la_nports > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 688, "la->la_nports > 0"));
 ((la->la_refcnt >= la->la_nports) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 689, "la->la_refcnt >= la->la_nports"));
 ...
 do { if (((lp)->lp_dist_q.tqe_next) != ((void *)0)) (lp)->lp_dist_q.tqe_next->lp_dist_q.tqe_prev = (lp)->lp_dist_q.tqe_prev; else (&la->la_ports)->tqh_last = (lp)->lp_dist_q.tqe_prev; *(lp)->lp_dist_q.tqe_prev = (lp)->lp_dist_q.tqe_next; ((lp)->lp_dist_q.tqe_prev) = ((void *)-1); ((lp)->lp_dist_q.tqe_next) = ((void *)-1); } while (0);
 la->la_nports--;
...
lacp_enable_distributing(struct lacp_port *lp)
{
 ...
 if ((lp->lp_actor.lip_state & (1<<5)) != 0)
  return;
 ...
 ((la->la_refcnt > la->la_nports) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 726, "la->la_refcnt > la->la_nports"));
 do { if (((lp)->lp_dist_q.tqe_next = (&la->la_ports)->tqh_first) != ((void *)0)) (&la->la_ports)->tqh_first->lp_dist_q.tqe_prev = &(lp)->lp_dist_q.tqe_next; else (&la->la_ports)->tqh_last = &(lp)->lp_dist_q.tqe_next; (&la->la_ports)->tqh_first = (lp); (lp)->lp_dist_q.tqe_prev = &(&la->la_ports)->tqh_first; } while (0);
 la->la_nports++;
...
lacp_attach(struct trunk_softc *sc)
{
 ...
 do { (&lsc->lsc_aggregators)->tqh_first = ((void *)0); (&lsc->lsc_aggregators)->tqh_last = &(&lsc->lsc_aggregators)->tqh_first; } while (0);
 do { ((&lsc->lsc_ports)->lh_first) = ((void *)0); } while (0);
 ...
 if (sc->tr_ac.ac_if.if_flags & 0x40)
  lacp_init(sc);
...
lacp_detach(struct trunk_softc *sc)
{
 ...
 (((((&lsc->lsc_aggregators)->tqh_first) == ((void *)0))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 783, "TAILQ_EMPTY(&lsc->lsc_aggregators)"));
 ((lsc->lsc_active_aggregator == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 784, "lsc->lsc_active_aggregator == NULL"));

 sc->tr_psc = ((void *)0);
 timeout_del(&lsc->lsc_transit_callout);
 timeout_del(&lsc->lsc_callout);

 free(lsc, 2, sizeof(*lsc));
 return (0);
}
...
lacp_select_tx_port(struct trunk_softc *sc, struct mbuf *m)
{
 ...
 if (__builtin_expect(((lsc->lsc_suppress_distributing) != 0), 0)) {
  ;
  return (((void *)0));
 }
 ...
 (((lp->lp_actor.lip_state & (1<<5)) != 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 834, "(lp->lp_state & LACP_STATE_DISTRIBUTING) != 0"));
...
lacp_suppress_distributing(struct lacp_softc *lsc, struct lacp_aggregator *la)
{
 ...
 for((lp) = ((&lsc->lsc_ports)->lh_first); (lp)!= ((void *)0); (lp) = ((lp)->lp_next.le_next)) {
  lp->lp_flags |= 0x00000002;
  lacp_xmit_marker(lp);
 }


 timeout_add_msec(&lsc->lsc_transit_callout, 3000);
}
...
{
 return (__builtin_memcmp((a), (b), (__builtin_offsetof(struct lacp_peerinfo, lip_state))));
}
...
# 887 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c"
u_int64_t
lacp_aggregator_bandwidth(struct lacp_aggregator *la)
{
 ...
 lp = ((&la->la_ports)->tqh_first);
 if (lp == ((void *)0))
  return (0);

 speed = lp->lp_ifp->if_data.ifi_baudrate;
 speed *= la->la_nports;
 if (speed == 0) {
  ;
...
lacp_select_active_aggregator(struct lacp_softc *lsc)
{
 ...
 struct lacp_aggregator *best_la = ((void *)0);
 ...
 for((la) = ((&lsc->lsc_aggregators)->tqh_first); (la) != ((void *)0); (la) = ((la)->la_q.tqe_next)) {
  u_int64_t speed;
  ...
  ;
# 940 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c"
  if ((best_la != ((void *)0) && (la->la_partner).lip_systemid.lsi_prio <
       (best_la->la_partner).lip_systemid.lsi_prio) ||
      speed > best_speed ||
      (speed == best_speed &&
 ...
 ((best_la == ((void *)0) || best_la->la_nports > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 950, "best_la == NULL || best_la->la_nports > 0"));
 ((best_la == ((void *)0) || !(((&best_la->la_ports)->tqh_first) == ((void *)0))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 951, "best_la == NULL || !TAILQ_EMPTY(&best_la->la_ports)"));
# 966 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c"
...
lacp_update_portmap(struct lacp_softc *lsc)
{
 ...
 la = lsc->lsc_active_aggregator;
 __builtin_bzero((p), (sizeof(struct lacp_portmap)));

 if (la != ((void *)0) && la->la_nports > 0) {
  p->pm_count = la->la_nports;
  i = 0;
  for((lp) = ((&la->la_ports)->tqh_first); (lp) != ((void *)0); (lp) = ((lp)->lp_dist_q.tqe_next))
   p->pm_map[i++] = lp;
  ((i == p->pm_count) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 997, "i == p->pm_count"));
 }
...
lacp_compose_key(struct lacp_port *lp)
{
 ...
 if ((lp->lp_actor.lip_state & (1<<2)) == 0) {
  ...
  if (speed == 0)
   key = 0;
  else if (speed <= ((((1) * 1000ULL) * 1000ULL)))
   key = 1;
  else if (speed <= ((((10) * 1000ULL) * 1000ULL)))
   key = 2;
  else if (speed <= ((((100) * 1000ULL) * 1000ULL)))
   key = 3;
  else if (speed <= ((((((1) * 1000ULL) * 1000ULL) * 1000ULL))))
   key = 4;
  else if (speed <= ((((((10) * 1000ULL) * 1000ULL) * 1000ULL))))
   key = 5;
  else if (speed <= ((((((100) * 1000ULL) * 1000ULL) * 1000ULL))))
   key = 6;
  else
   key = 7;
...
lacp_aggregator_addref(struct lacp_softc *lsc, struct lacp_aggregator *la)
{
 ...
 ((la->la_refcnt > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1069, "la->la_refcnt > 0"));
 la->la_refcnt++;
 ((la->la_refcnt > la->la_nports) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1071, "la->la_refcnt > la->la_nports"));
}
...
lacp_aggregator_delref(struct lacp_softc *lsc, struct lacp_aggregator *la)
{
 ...
 ((la->la_refcnt > la->la_nports) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1087, "la->la_refcnt > la->la_nports"));
 la->la_refcnt--;
 if (la->la_refcnt > 0)
  return;

 ((la->la_refcnt == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1092, "la->la_refcnt == 0"));
 ((lsc->lsc_active_aggregator != la) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1093, "lsc->lsc_active_aggregator != la"));

 do { if (((la)->la_q.tqe_next) != ((void *)0)) (la)->la_q.tqe_next->la_q.tqe_prev = (la)->la_q.tqe_prev; else (&lsc->lsc_aggregators)->tqh_last = (la)->la_q.tqe_prev; *(la)->la_q.tqe_prev = (la)->la_q.tqe_next; ((la)->la_q.tqe_prev) = ((void *)-1); ((la)->la_q.tqe_next) = ((void *)-1); } while (0);
...
lacp_aggregator_get(struct lacp_softc *lsc, struct lacp_port *lp)
{
 ...
 la = malloc(sizeof(*la), 2, 0x0002);
 if (la) {
  la->la_refcnt = 1;
  la->la_nports = 0;
  do { (&la->la_ports)->tqh_first = ((void *)0); (&la->la_ports)->tqh_last = &(&la->la_ports)->tqh_first; } while (0);
  la->la_pending = 0;
  do { (la)->la_q.tqe_next = ((void *)0); (la)->la_q.tqe_prev = (&lsc->lsc_aggregators)->tqh_last; *(&lsc->lsc_aggregators)->tqh_last = (la); (&lsc->lsc_aggregators)->tqh_last = &(la)->la_q.tqe_next; } while (0);
 }
...
lacp_fill_aggregator_id(struct lacp_aggregator *la, const struct lacp_port *lp)
{
 ...
 la->la_actor.lip_state = lp->lp_actor.lip_state & (1<<2);
}
...
{
 __builtin_memset((lpi_aggr), (0), (sizeof(*lpi_aggr)));
...
{
 if (!(lp->lp_actor.lip_state & (1<<2)) ||
     !(lp->lp_partner.lip_state & (1<<2)))
  return (0);

 if (!(la->la_actor.lip_state & (1<<2)))
  return (0);
...
lacp_peerinfo_is_compatible(const struct lacp_peerinfo *a,
    const struct lacp_peerinfo *b)
{
 if (__builtin_memcmp((&a->lip_systemid), (&b->lip_systemid), (sizeof(a->lip_systemid))))

  return (0);

 if (__builtin_memcmp((&a->lip_key), (&b->lip_key), (sizeof(a->lip_key))))
  return (0);
...
lacp_select(struct lacp_port *lp)
{
 ...
 ((!((lp)->lp_timer[(2)] > 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1211, "!LACP_TIMER_ISARMED(lp, LACP_TIMER_WAIT_WHILE)"));
...
lacp_unselect(struct lacp_port *lp)
{
 ...
 ((!((lp)->lp_timer[(2)] > 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1259, "!LACP_TIMER_ISARMED(lp, LACP_TIMER_WAIT_WHILE)"));
...
lacp_sm_mux(struct lacp_port *lp)
{
 ...
 int p_sync =
     (lp->lp_partner.lip_state & (1<<3)) != 0;
 int p_collecting =
     (lp->lp_partner.lip_state & (1<<4)) != 0;
...
re_eval:
 la = lp->lp_aggregator;
 ((lp->lp_mux_state == LACP_MUX_DETACHED || la != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1284, "lp->lp_mux_state == LACP_MUX_DETACHED || la != NULL"));
 ...
 case LACP_MUX_WAITING:
  ((la->la_pending > 0 || !((lp)->lp_timer[(2)] > 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1293, "la->la_pending > 0 || !LACP_TIMER_ISARMED(lp, LACP_TIMER_WAIT_WHILE)"));
...
lacp_set_mux(struct lacp_port *lp, enum lacp_mux_state new_state)
{
 ...
 switch (new_state) {
 case LACP_MUX_DETACHED:
  lp->lp_actor.lip_state &= ~(1<<3);
  lacp_disable_distributing(lp);
  lacp_disable_collecting(lp);
  lacp_sm_assert_ntt(lp);

  if (((lp)->lp_timer[(2)] > 0)) {
   ((la->la_pending > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1342, "la->la_pending > 0"));
   la->la_pending--;
  }
  (lp)->lp_timer[(2)] = 0;
  lacp_unselect(lp);
...
lacp_sm_mux_timer(struct lacp_port *lp)
{
 ...
 ((la->la_pending > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1383, "la->la_pending > 0"));
...
{
 if (((((oldpstate) ^ (lp->lp_partner.lip_state)) & ((1<<1))) == 0))

  return;

 ;
# 1411 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c"
 (lp)->lp_timer[(1)] = 0;


 if ((lp->lp_partner.lip_state & (1<<1)))
  lacp_sm_assert_ntt(lp);
}
...
lacp_sm_ptx_tx_schedule(struct lacp_port *lp)
{
 ...
 if (!(lp->lp_actor.lip_state & (1<<0)) &&
     !(lp->lp_partner.lip_state & (1<<0))) {
 ...
 timeout = (lp->lp_partner.lip_state & (1<<1)) ?
     (1) : (30);

 (lp)->lp_timer[(1)] = (timeout);
}
...
lacp_sm_rx(struct lacp_port *lp, const struct lacpdu *du)
{
 ...
 timeout = (lp->lp_actor.lip_state & (1<<1)) ?
     (3 * (1)) : (3 * (30));
 (lp)->lp_timer[(0)] = (timeout);
...
{
 lp->lp_partner.lip_state &= ~(1<<3);
 lp->lp_partner.lip_state |= (1<<1);
 (lp)->lp_timer[(0)] = ((3 * (1)));
 lp->lp_actor.lip_state |= (1<<7);
}
...
{
 if ((lp->lp_actor.lip_state & (1<<7)) == 0) {
...
lacp_sm_rx_record_pdu(struct lacp_port *lp, const struct lacpdu *du)
{
 ...
 active = (du->ldu_actor.lip_state & (1<<0))
     || ((lp->lp_actor.lip_state & (1<<0)) &&
     (du->ldu_partner.lip_state & (1<<0)));

 lp->lp_partner = du->ldu_actor;
 if (active &&
     ((((((lp->lp_actor.lip_state) ^ (du->ldu_partner.lip_state)) & ((1<<2))) == 0) &&

     !lacp_compare_peerinfo(&lp->lp_actor, &du->ldu_partner))
     || (du->ldu_partner.lip_state & (1<<2)) == 0)) {

 } else
  lp->lp_partner.lip_state &= ~(1<<3);

 lp->lp_actor.lip_state &= ~(1<<6);
...
lacp_sm_rx_update_ntt(struct lacp_port *lp, const struct lacpdu *du)
{
 ...
 if (lacp_compare_peerinfo(&lp->lp_actor, &du->ldu_partner) ||
     !((((lp->lp_actor.lip_state) ^ (du->ldu_partner.lip_state)) & ((1<<0) | (1<<3) | (1<<2))) == 0)) {
    ...
    const struct lacp_peerinfo *info)
{
 ...
 if (lacp_compare_peerinfo(&lp->lp_partner, info) ||
     !((((lp->lp_partner.lip_state) ^ (info->lip_state)) & ((1<<2))) == 0)) {
...
lacp_sm_tx(struct lacp_port *lp)
{
 ...
 if (!(lp->lp_actor.lip_state & (1<<2))
  ...
  lp->lp_flags &= ~0x00000001;
 }

 if (!(lp->lp_flags & 0x00000001))
  return;
...
lacp_run_timers(struct lacp_port *lp)
{
 ...
 for (i = 0; i < 3; i++) {
  ((lp->lp_timer[i] >= 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/trunklacp.c", 1645, "lp->lp_timer[i] >= 0"));
  if (lp->lp_timer[i] == 0)
   continue;
...
lacp_marker_input(struct lacp_port *lp, struct mbuf *m)
{
 ...
 if (m->M_dat.MH.MH_pkthdr.len != sizeof(*mdu))
  goto bad;

 if ((m->m_hdr.mh_flags & 0x0200) == 0)
  goto bad;

 if (m->m_hdr.mh_len < sizeof(*mdu)) {
 ...
 if (__builtin_memcmp((&mdu->mdu_eh.ether_dhost), (&ethermulticastaddr_slowprotocols), (6)))
 ...
 case 0x02:
  ...
  if (__builtin_memcmp((&mdu->mdu_info), (&lp->lp_marker), (sizeof(struct lacp_markerinfo))))
  ...
  if (lsc->lsc_suppress_distributing) {
   ...
   for((lp2) = ((&lsc->lsc_ports)->lh_first); (lp2)!= ((void *)0); (lp2) = ((lp2)->lp_next.le_next)) {
    if (lp2->lp_flags & 0x00000002) {
     pending = 1;
     break;
    }
   }
