# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c"
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c"
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/mman.h" 1
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
void device_register(struct device *, void *);
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
int bppopen(dev_t, int, int, struct proc *); int bppclose(dev_t, int, int, struct proc *); int bppread(dev_t, struct uio *, int); int bppwrite(dev_t, struct uio *, int); int bppioctl(dev_t, u_long, caddr_t, int, struct proc *); int bppstop(struct tty *, int); struct tty *bpptty(dev_t); int bpppoll(dev_t, int, struct proc *); paddr_t bppmmap(dev_t, off_t, int); int bppkqfilter(dev_t, struct knote *);
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
...
int ifb_ident(void *);
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/vgareg.h" 1
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/vgareg.h"
struct reg_vgaattr {
 u_int8_t palette[16];
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/atxxreg.h" 1
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c" 2
# 120 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c"
struct mgx_softc {
...
mgxattach(struct device *parent, struct device *self, void *args)
{
 ...
 if (sa->sa_nreg < 9) {
  printf("\n%s: expected %d registers, got %d\n",
      self->dv_xname, 9, sa->sa_nreg);
  return;
 }

 sc->sc_bustag = bt;
 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[4].sbr_slot)<<32)|(sa->sa_reg[4].sbr_offset)), (1 << 13), 0x0002, &bh) != 0) {
 ...
 sc->sc_bustag = bt;
 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[5].sbr_slot)<<32)|(sa->sa_reg[5].sbr_offset + 0x000b0000)), 0x00000400, 0x0002, &bh) != 0) {
 ...
 chipid = mgx_read_2(sc->sc_xreg, 0x0182);
 if (chipid != 0x6424) {
 ...
 sc->sc_paddr = sbus_bus_addr(bt, sa->sa_reg[8].sbr_slot,
     sa->sa_reg[8].sbr_offset);
 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[8].sbr_slot)<<32)|(sa->sa_reg[8].sbr_offset)), (((sc->sc_sunfb.sf_fbsize) + ((1 << 13) - 1)) & ~((1 << 13) - 1)), 0x0002, &bh) != 0) {
 ...
 __builtin_bzero((sc->sc_cmap), (sizeof(sc->sc_cmap)));
...
# 305 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c"
uint8_t
...
mgx_burner(void *v, u_int on, u_int flags)
{
 struct mgx_softc *sc = v;
 uint mode;
# 433 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c"
 mgx_write_1(sc->sc_vidc, (0x03c0 + 4), 1);
 mode = mgx_read_1(sc->sc_vidc, (0x03c0 + 5));
 if (on)
  mode &= ~0x0020;
 else
  mode |= 0x0020;
 mgx_write_1(sc->sc_vidc, (0x03c0 + 5), mode);
}
...
mgx_loadcmap(struct mgx_softc *sc, int start, int ncolors)
{
 ...
 mgx_write_1(sc->sc_vidc, (0x03c0 + 0x08), start);
 color = sc->sc_cmap + start * 3;
 for (i = ncolors * 3; i != 0; i--)
  mgx_write_1(sc->sc_vidc, (0x03c0 + 0x09), *color++);
}
...
# 532 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/mgx.c"
int
mgx_wait_engine(struct mgx_softc *sc)
{
 ...
 for (i = 10000; i != 0; i--) {
  stat = mgx_read_1(sc->sc_xreg, 0x01fd);
  if (!((stat) & (0x01 | 0x04)))
   break;
 }
...
mgx_wait_fifo(struct mgx_softc *sc, uint nfifo)
{
 ...
 for (i = 10000; i != 0; i--) {
  stat = (mgx_read_1(sc->sc_xreg, 0x01fc) & 0x0f) >>
      0;
  if (stat >= nfifo)
   break;
  mgx_write_1(sc->sc_xreg, 0x01fc, 0);
 }
...
mgx_ras_init(struct mgx_softc *sc, uint chipid)
{
 ...
 mgx_write_1(sc->sc_xreg, 0x0030, 0);

 mgx_write_1(sc->sc_xreg, 0x0047, 0xff);
}
...
mgx_ras_copycols(void *v, int row, int src, int dst, int n)
{
 ...
 mgx_wait_fifo(sc, 5);
 mgx_write_1(sc->sc_xreg, 0x0046, 0xcc);
 mgx_write_4(sc->sc_xreg, 0x0040, dec);
 mgx_write_4(sc->sc_xreg, 0x0050, (((row) << 16) | (src)));
 mgx_write_4(sc->sc_xreg, 0x0054, (((row) << 16) | (dst)));
 mgx_write_4(sc->sc_xreg, 0x0058, (((ri->ri_font->fontheight) << 16) | (n)));
 mgx_wait_engine(sc);
...
mgx_ras_copyrows(void *v, int src, int dst, int n)
{
 ...
 mgx_write_1(sc->sc_xreg, 0x0046, 0xcc);
 mgx_write_4(sc->sc_xreg, 0x0040, dec);
 mgx_write_4(sc->sc_xreg, 0x0050, (((src) << 16) | (ri->ri_xorigin)));
 mgx_write_4(sc->sc_xreg, 0x0054, (((dst) << 16) | (ri->ri_xorigin)));
 mgx_write_4(sc->sc_xreg, 0x0058, (((n) << 16) | (ri->ri_emuwidth)));
 mgx_wait_engine(sc);
...
mgx_ras_erasecols(void *v, int row, int col, int n, long int attr)
{
 ...
 ri->ri_ops.unpack_attr(v, attr, &fg, &bg, ((void *)0));
 bg = ri->ri_devcmap[bg];
 ...
 mgx_wait_fifo(sc, 5);
 mgx_write_1(sc->sc_xreg, 0x0046, 0xcc);
 mgx_write_4(sc->sc_xreg, 0x0060, bg);
 mgx_write_4(sc->sc_xreg, 0x0040, dec);
 mgx_write_4(sc->sc_xreg, 0x0054, (((row) << 16) | (col)));
 mgx_write_4(sc->sc_xreg, 0x0058, (((ri->ri_font->fontheight) << 16) | (n)));
 mgx_wait_engine(sc);
...
mgx_ras_eraserows(void *v, int row, int n, long int attr)
{
 ...
 if (n == ri->ri_rows && ((ri->ri_flg) & (0x0001))) {
  mgx_write_4(sc->sc_xreg, 0x0054, (((0) << 16) | (0)));
  mgx_write_4(sc->sc_xreg, 0x0058,
      (((ri->ri_height) << 16) | (ri->ri_width)));
 } else {
  n *= ri->ri_font->fontheight;
  row *= ri->ri_font->fontheight;
  row += ri->ri_yorigin;

  mgx_write_4(sc->sc_xreg, 0x0054,
      (((row) << 16) | (ri->ri_xorigin)));
  mgx_write_4(sc->sc_xreg, 0x0058, (((n) << 16) | (ri->ri_emuwidth)));
 }
 mgx_wait_engine(sc);
...
mgx_ras_do_cursor(struct rasops_info *ri)
{
 ...
 dec |= (0x01 << 0) |
     (0x01 << 29);
 mgx_wait_fifo(sc, 5);
 mgx_write_1(sc->sc_xreg, 0x0046, (uint8_t)~0xcc);
 mgx_write_4(sc->sc_xreg, 0x0040, dec);
 mgx_write_4(sc->sc_xreg, 0x0050, (((row) << 16) | (col)));
 mgx_write_4(sc->sc_xreg, 0x0054, (((row) << 16) | (col)));
 mgx_write_4(sc->sc_xreg, 0x0058,
     (((ri->ri_font->fontheight) << 16) | (ri->ri_font->fontwidth)));
 mgx_wait_engine(sc);
