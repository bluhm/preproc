# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c" 2
...
int drm_fb_helper_remove_one_connector(struct drm_fb_helper *fb_helper,
           struct drm_connector *connector);
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c" 2
...
struct edid *drm_do_get_edid(struct drm_connector *connector,
 int (*get_edid_block)(void *data, u8 *buf, unsigned int block,
         size_t len),
 void *data);
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c" 2
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
static _Bool drm_kms_helper_poll = 1;
;
...
# 110 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
void drm_kms_helper_poll_enable_locked(struct drm_device *dev)
{
 _Bool poll = 0;
 struct drm_connector *connector;

 ({ int __ret = !!(!(rw_status(&dev->mode_config.mutex) == 0x0001UL)); if (__ret) printf("WARNING %s failed at %s:%d\n", "!(rw_status(&dev->mode_config.mutex) == 0x0001UL)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c", 115); __builtin_expect(!!(__ret), 0); });
 ...
 for (assert_drm_connector_list_read_locked(&(dev)->mode_config), connector = ({ __typeof( ((struct drm_connector *)0)->head ) *__mptr = ((&(dev)->mode_config.connector_list)->next); (struct drm_connector *)( (char *)__mptr - __builtin_offsetof(struct drm_connector, head) );}); &connector->head != (&(dev)->mode_config.connector_list); connector = ({ __typeof( ((typeof(*(connector)) *)0)->head ) *__mptr = (((connector)->head.next)); (typeof(*(connector)) *)( (char *)__mptr - __builtin_offsetof(typeof(*(connector)), head) );})) {
  if (connector->polled & ((1 << 1) |
      (1 << 2)))
   poll = 1;
 }

 if (poll)
  schedule_delayed_work(&dev->mode_config.output_poll_work, (10*hz));
}
;


static int drm_helper_probe_single_connector_modes_merge_bits(struct drm_connector *connector,
             uint32_t maxX, uint32_t maxY, _Bool merge_type_bits)
{
 ...
 int count = 0;
 int mode_flags = 0;
 _Bool verbose_prune = 1;
 enum drm_connector_status old_status;

 ({ int __ret = !!(!(rw_status(&dev->mode_config.mutex) == 0x0001UL)); if (__ret) printf("WARNING %s failed at %s:%d\n", "!(rw_status(&dev->mode_config.mutex) == 0x0001UL)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c", 144); __builtin_expect(!!(__ret), 0); });
 ...
 if (connector->force) {
  ...
  connector->status = connector->funcs->detect(connector, 1);
  ...
  if (old_status != connector->status) {
   do { } while( 0);
# 183 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
   dev->mode_config.delayed_event = 1;
...
prune:
 ...
 for (mode = ({ __typeof( ((__typeof(*mode) *)0)->head ) *__mptr = ((&connector->modes)->next); (__typeof(*mode) *)( (char *)__mptr - __builtin_offsetof(__typeof(*mode), head) );}); &mode->head != (&connector->modes); mode = ({ __typeof( ((__typeof(*mode) *)0)->head ) *__mptr = (mode->head.next); (__typeof(*mode) *)( (char *)__mptr - __builtin_offsetof(__typeof(*mode), head) );})) {
  drm_mode_set_crtcinfo(mode, (1 << 0));
  drm_mode_debug_printmodeline(mode);
 }

 return count;
}
# 287 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
int drm_helper_probe_single_connector_modes(struct drm_connector *connector,
         uint32_t maxX, uint32_t maxY)
{
 return drm_helper_probe_single_connector_modes_merge_bits(connector, maxX, maxY, 1);
}
;
# 303 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
int drm_helper_probe_single_connector_modes_nomerge(struct drm_connector *connector,
         uint32_t maxX, uint32_t maxY)
{
 return drm_helper_probe_single_connector_modes_merge_bits(connector, maxX, maxY, 0);
}
;
# 326 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
...
static void output_poll_execute(struct work_struct *work)
{
 ...
 struct drm_device *dev = ({ __typeof( ((struct drm_device *)0)->mode_config.output_poll_work ) *__mptr = (delayed_work); (struct drm_device *)( (char *)__mptr - __builtin_offsetof(struct drm_device, mode_config.output_poll_work) );});
 struct drm_connector *connector;
 enum drm_connector_status old_status;
 _Bool repoll = 0, changed;


 changed = dev->mode_config.delayed_event;
 dev->mode_config.delayed_event = 0;
 ...
 for (assert_drm_connector_list_read_locked(&(dev)->mode_config), connector = ({ __typeof( ((struct drm_connector *)0)->head ) *__mptr = ((&(dev)->mode_config.connector_list)->next); (struct drm_connector *)( (char *)__mptr - __builtin_offsetof(struct drm_connector, head) );}); &connector->head != (&(dev)->mode_config.connector_list); connector = ({ __typeof( ((typeof(*(connector)) *)0)->head ) *__mptr = (((connector)->head.next)); (typeof(*(connector)) *)( (char *)__mptr - __builtin_offsetof(typeof(*(connector)), head) );})) {
  ...
  if (!connector->polled || connector->polled == (1 << 0))
   continue;
  ...
  if (old_status == connector_status_connected &&
      !(connector->polled & (1 << 2)))
   continue;

  repoll = 1;

  connector->status = connector->funcs->detect(connector, 0);
  if (old_status != connector->status) {
   const char *old, *new;
# 388 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
...
# 426 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
...
;
# 444 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
...
;
# 471 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
...
;
# 513 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_probe_helper.c"
_Bool drm_helper_hpd_irq_event(struct drm_device *dev)
{
 struct drm_connector *connector;
 enum drm_connector_status old_status;
 _Bool changed = 0;
