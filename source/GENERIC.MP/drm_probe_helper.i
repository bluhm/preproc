...
static void output_poll_execute(struct work_struct *work)
{
 ...
 struct drm_device *dev = ({ const __typeof( ((struct drm_device *)0)->mode_config.output_poll_work ) *__mptr = (delayed_work); (struct drm_device *)( (char *)__mptr - __builtin_offsetof(struct drm_device, mode_config.output_poll_work) );});
 struct drm_connector *connector;
 enum drm_connector_status old_status;
