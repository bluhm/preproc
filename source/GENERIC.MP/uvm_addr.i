# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c" 2
...
int uvm_map_fill_vmmap(struct vm_map *, struct kinfo_vmentry *,
      size_t *);
# 450 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_map.h"
...
# 451 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_map.h" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.h" 1
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.h"
struct uvm_addr_state {
 vaddr_t uaddr_minaddr;
 vaddr_t uaddr_maxaddr;
 const struct uvm_addr_functions *uaddr_functions;
};
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.h"
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c" 2
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
...
struct uaddr_pivot_state {
 ...
 struct uaddr_pivot up_pivots[16];
};
...
void uaddr_pivot_print(struct uvm_addr_state *, boolean_t,
       int (*)(const char *, ...));
# 170 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
struct vm_map_entry *
uvm_addr_entrybyspace(struct uaddr_free_rbtree *free, vsize_t sz)
{
 struct vm_map_entry *tmp, *res;

 tmp = uaddr_free_rbtree_RBT_ROOT(free);
 res = ((void *)0);
 while (tmp) {
  if (tmp->fspace >= sz) {
   res = tmp;
   tmp = uaddr_free_rbtree_RBT_LEFT(tmp);
  } else if (tmp->fspace < sz)
   tmp = uaddr_free_rbtree_RBT_RIGHT(tmp);
 }
 return res;
}
...
uvm_addr_align_forward(vaddr_t addr, vaddr_t align, vaddr_t offset)
{
 ...
 ((offset < align || (align == 0 && offset == 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 193, "offset < align || (align == 0 && offset == 0)"));
 (((align & (align - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 194, "(align & (align - 1)) == 0"));
 (((offset & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 195, "(offset & PAGE_MASK) == 0"));
...
uvm_addr_align_backward(vaddr_t addr, vaddr_t align, vaddr_t offset)
{
 ...
 ((offset < align || (align == 0 && offset == 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 208, "offset < align || (align == 0 && offset == 0)"));
 (((align & (align - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 209, "(align & (align - 1)) == 0"));
 (((offset & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 210, "(offset & PAGE_MASK) == 0"));
...
# 326 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
int
    ...
    vsize_t before_gap, vsize_t after_gap)
{
 ...
 ((entry_out != ((void *)0) && addr_out != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 336, "entry_out != NULL && addr_out != NULL"));
 ((direction == -1 || direction == 1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 337, "direction == -1 || direction == 1"));
 (((hint & ((1 << 13) - 1)) == 0 && (high & ((1 << 13) - 1)) == 0 && (low & ((1 << 13) - 1)) == 0 && (before_gap & ((1 << 13) - 1)) == 0 && (after_gap & ((1 << 13) - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 340, "(hint & PAGE_MASK) == 0 && (high & PAGE_MASK) == 0 && (low & PAGE_MASK) == 0 && (before_gap & PAGE_MASK) == 0 && (after_gap & PAGE_MASK) == 0"));


 ((high + sz > high) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 341, "high + sz > high"));
 ...
 for (entry = uvm_map_entrybyaddr(&map->addr,
     hint - (direction == -1 ? 1 : 0)); entry != ((void *)0);
     entry = (direction == 1 ?
  ...
  if (uvm_addr_fitspace(&low_addr, &high_addr,
      (((low)>(((entry)->end + (entry)->guard)))?(low):(((entry)->end + (entry)->guard))),
      (((high)<(((entry)->end + (entry)->guard + (entry)->fspace)))?(high):(((entry)->end + (entry)->guard + (entry)->fspace))),
    ...
    vsize_t sz, vaddr_t align, vaddr_t offset, vm_prot_t prot, vaddr_t hint)
{
 ...
 if (error == 0) {
  ((*entry_out != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 410, "*entry_out != NULL"));
  *last_out = ((void *)0);
    ...
    int (*pr)(const char *, ...))
{
 ...
 (*pr)("- uvm_addr %s: %p (%s 0x%lx-0x%lx)\n", slot, uaddr,
     ...
     uaddr->uaddr_minaddr, uaddr->uaddr_maxaddr);
 if (uaddr->uaddr_functions->uaddr_print == ((void *)0))
  return;
...
# 508 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
...
uaddr_rnd_create(vaddr_t minaddr, vaddr_t maxaddr)
{
 ...
 uaddr = pool_get(&uaddr_rnd_pool, 0x0001);
    ...
    vm_prot_t prot, vaddr_t hint)
{
 ...
 (((map->flags & 0x40) != 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 550, "(map->flags & VM_MAP_ISVMSPACE) != 0"));
 vm = (struct vmspace *)map;


 guard_sz = ((map->flags & 0x20) == 0 ? 0 : (1 << 13));
 ...
 hint = ((((((hint)>(minaddr))?(hint):(minaddr)))<(maxaddr))?((((hint)>(minaddr))?(hint):(minaddr))):(maxaddr));
 ...
 before_gap = 0;
 after_gap = guard_sz;
 hint -= (((hint)<(before_gap))?(hint):(before_gap));
# 593 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
 ...
 while (entry != ((void *)0)) {
  ...
  if (((entry)->end + (entry)->guard + (entry)->fspace) > hint &&
      uvm_map_uaddr_e(map, entry) == uaddr &&
      uvm_addr_fitspace(&low_addr, &high_addr,
      (((uaddr->uaddr_minaddr)>(((entry)->end + (entry)->guard)))?(uaddr->uaddr_minaddr):(((entry)->end + (entry)->guard))),
      (((uaddr->uaddr_maxaddr)<(((entry)->end + (entry)->guard + (entry)->fspace)))?(uaddr->uaddr_maxaddr):(((entry)->end + (entry)->guard + (entry)->fspace))),
      sz, align, offset, before_gap, after_gap) == 0) {
   *entry_out = entry;
   if (hint >= low_addr && hint <= high_addr)
    *addr_out = hint;
  ...
  next = uvm_map_addr_RBT_RIGHT(entry);
  if (next != ((void *)0) &&
      next->fspace_augment >= before_gap + after_gap + sz) {
   entry = next;
   while ((next = uvm_map_addr_RBT_LEFT(entry)) !=
       ((void *)0))
    entry = next;
  } else {
do_parent:
   next = uvm_map_addr_RBT_PARENT(entry);
   if (next == ((void *)0))
    entry = ((void *)0);
   else if (uvm_map_addr_RBT_LEFT(next) == entry)
    entry = next;
   else {
    entry = next;
    goto do_parent;
...
# 718 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
...
# 731 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
int
    ...
    vsize_t sz, vaddr_t align, vaddr_t offset, vm_prot_t prot, vaddr_t hint)
{
 ...
 for ((*entry_out) = uvm_map_addr_RBT_MIN((&map->addr)); (*entry_out) != ((void *)0); (*entry_out) = uvm_map_addr_RBT_NEXT((*entry_out))) {
  if (((*entry_out)->end + (*entry_out)->guard + (*entry_out)->fspace) <= uvm_maxkaddr &&
      uvm_addr_fitspace(addr_out, &tmp,
      ((*entry_out)->end + (*entry_out)->guard), ((*entry_out)->end + (*entry_out)->guard + (*entry_out)->fspace),
...
{
 ((uaddr == (struct uvm_addr_state *)&uaddr_kbootstrap) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 755, "uaddr == (struct uvm_addr_state *)&uaddr_kbootstrap"));
}
...
uaddr_bestfit_create(vaddr_t minaddr, vaddr_t maxaddr)
{
 ...
 uaddr = pool_get(&uaddr_bestfit_pool, 0x0001);
 ...
 uaddr_free_rbtree_RBT_INIT(&uaddr->ubf_free);
    ...
    struct vm_map_entry *entry)
{
 ...
 if ((rb_rv = uaddr_free_rbtree_RBT_INSERT(&uaddr->ubf_free, entry)) !=
     ((void *)0)) {
    ...
    struct vm_map_entry *entry)
{
 ...
 uaddr = (struct uaddr_bestfit_state *)uaddr_p;
 if (uaddr_free_rbtree_RBT_REMOVE(&uaddr->ubf_free, entry) != entry)
    ...
    vm_prot_t prot, vaddr_t hint)
{
 ...
 while (uvm_addr_fitspace(&min, &max,
  ...
  entry = uaddr_free_rbtree_RBT_NEXT(entry);
  if (entry == ((void *)0))
   return 12;
 }
 ...
 *entry_out = entry;
 *addr_out = (min - ((entry)->end + (entry)->guard) <=
     ((entry)->end + (entry)->guard + (entry)->fspace) - guardsz - sz - max ?
     min : max);
 return 0;
}
# 865 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
...
# 886 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
vsize_t
uaddr_pivot_random(void)
{
 int r;
# 899 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
 r = arc4random_uniform(8) + arc4random_uniform(8) -
     (8 - 1);
 if (r < 0)
  r = -r;
 ...
 return (vaddr_t)(1 + r) << 13;
}
# 924 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
int
    ...
    vsize_t before_gap, vsize_t after_gap)
{
 ...
 ((minaddr < maxaddr) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 942, "minaddr < maxaddr"));

 if (minaddr + 2 * (1 << 13) > maxaddr) {
  panic("uaddr_pivot_newpivot: cannot grant random pivot "
      "in area less than 2 pages (size = 0x%lx)",
      maxaddr - minaddr);
 }
# 959 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
 dist = ((((maxaddr - minaddr) / 32)>(2 * (vaddr_t)(1 << 13)))?((maxaddr - minaddr) / 32):(2 * (vaddr_t)(1 << 13)));
 if (dist >> 13 > 0xffffffff) {
  minaddr += (vsize_t)arc4random() << 13;
  maxaddr -= (vsize_t)arc4random() << 13;
 } else {
  minaddr += (vsize_t)arc4random_uniform(dist >> 13) <<
      13;
  maxaddr -= (vsize_t)arc4random_uniform(dist >> 13) <<
      13;
 }
# 984 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
 path = arc4random();
 found = ((void *)0);
 entry = uaddr_free_rbtree_RBT_ROOT(&uaddr->up_free);
 while (entry != ((void *)0)) {
  fit_error = uvm_addr_fitspace(&min, &max,
      (((((entry)->end + (entry)->guard))>(minaddr))?(((entry)->end + (entry)->guard)):(minaddr)),
      (((((entry)->end + (entry)->guard + (entry)->fspace))<(maxaddr))?(((entry)->end + (entry)->guard + (entry)->fspace)):(maxaddr)),
  ...
  if (fit_error != 0)
   entry = uaddr_free_rbtree_RBT_RIGHT(entry);
  else if ((path & 0x1) == 0) {
   path >>= 1;
   entry = uaddr_free_rbtree_RBT_RIGHT(entry);
  } else {
   path >>= 1;
   entry = uaddr_free_rbtree_RBT_LEFT(entry);
  }
 }
 if (found == ((void *)0))
  return 12;
# 1025 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
 if (found_maxaddr == found_minaddr)
  *addr_out = found_minaddr;
 else {
  ((align >= (1 << 13) && (align & (align - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 1028, "align >= PAGE_SIZE && (align & (align - 1)) == 0"));
 ...
 *entry_out = found;
# 1051 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
 pivot->entry = found;
...
# 1095 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
int
    ...
    vm_prot_t prot, vaddr_t hint)
{
 ...
 pivot = &uaddr->up_pivots[
     arc4random_uniform((sizeof((uaddr->up_pivots)) / sizeof((uaddr->up_pivots)[0])))];
 before_gap = uaddr_pivot_random();
 after_gap = uaddr_pivot_random();
 if (pivot->addr == 0 || pivot->entry == ((void *)0) || pivot->expire == 0)
  goto expired;
 ...
 if (pivot->dir > 0) {
  if (uvm_addr_fitspace(&min, &max,
      (((((entry)->end + (entry)->guard))>(pivot->addr))?(((entry)->end + (entry)->guard)):(pivot->addr)),
      ((entry)->end + (entry)->guard + (entry)->fspace), sz, align, offset,
  ...
  if (uvm_addr_fitspace(&min, &max,
      ((entry)->end + (entry)->guard),
      (((((entry)->end + (entry)->guard + (entry)->fspace))<(pivot->addr))?(((entry)->end + (entry)->guard + (entry)->fspace)):(pivot->addr)),
      sz, align, offset, before_gap, after_gap) == 0) {
   *addr_out = max;
   *entry_out = entry;
   pivot->addr = max;
    ...
    struct vm_map_entry *entry)
{
 ...
 uaddr = (struct uaddr_pivot_state *)uaddr_p;
 if ((rb_rv = uaddr_free_rbtree_RBT_INSERT(&uaddr->up_free, entry)) !=
     ((void *)0)) {
  panic("%s: duplicate insertion: state %p "
 ...
 for (p = &uaddr->up_pivots[0];
     p != &uaddr->up_pivots[(sizeof((uaddr->up_pivots)) / sizeof((uaddr->up_pivots)[0]))]; p++) {
  check_addr = p->addr;
  if (check_addr == 0)
   continue;
  if (p->dir < 0)
  ...
  if (start <= check_addr &&
      check_addr < end) {
   ((p->entry == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c", 1212, "p->entry == NULL"));
   p->entry = entry;
  }
 }
}
    ...
    struct vm_map_entry *entry)
{
 ...
 uaddr = (struct uaddr_pivot_state *)uaddr_p;
 if (uaddr_free_rbtree_RBT_REMOVE(&uaddr->up_free, entry) != entry)
  panic("%s: entry was not in tree", __func__);
...
# 1254 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
struct uvm_addr_state *
uaddr_pivot_create(vaddr_t minaddr, vaddr_t maxaddr)
{
 struct uaddr_pivot_state *uaddr;

 uaddr = pool_get(&uaddr_pivot_pool, 0x0001);
 ...
 uaddr_free_rbtree_RBT_INIT(&uaddr->up_free);
 __builtin_memset((uaddr->up_pivots), (0), (sizeof(uaddr->up_pivots)));
    ...
    int (*pr)(const char *, ...))
{
 ...
 if (uaddr_free_rbtree_RBT_EMPTY(&uaddr->up_free))
  (*pr)("\tempty\n");

 for ((entry) = uaddr_free_rbtree_RBT_MIN((&uaddr->up_free)); (entry) != ((void *)0); (entry) = uaddr_free_rbtree_RBT_NEXT((entry))) {
  (*pr)("\t0x%lx - 0x%lx free (0x%lx bytes)\n",
      ((entry)->end + (entry)->guard), ((entry)->end + (entry)->guard + (entry)->fspace),
      ((entry)->end + (entry)->guard + (entry)->fspace) - ((entry)->end + (entry)->guard));
  ...
  for (i = 0; i < 16; i++) {
   ...
   if (((entry)->end + (entry)->guard) <= check_addr &&
       check_addr < ((entry)->end + (entry)->guard + (entry)->fspace)) {
...
# 1343 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
...
uaddr_stack_brk_create(vaddr_t minaddr, vaddr_t maxaddr)
{
 ...
 uaddr = pool_get(&uaddr_pool, 0x0001);
 uaddr->uaddr_minaddr = minaddr;
 uaddr->uaddr_maxaddr = maxaddr;
 uaddr->uaddr_functions = &uaddr_stack_brk_functions;
 return uaddr;
}
# 1429 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_addr.c"
static inline int
...
static int uaddr_free_rbtree_RBT_COMPARE(const void *lptr, const void *rptr) { const struct vm_map_entry *l = lptr, *r = rptr; return uvm_mapent_fspace_cmp(l, r); } static const struct rb_type uaddr_free_rbtree_RBT_INFO = { uaddr_free_rbtree_RBT_COMPARE, ((void *)0), __builtin_offsetof(struct vm_map_entry, dfree.rbtree), }; const struct rb_type *const uaddr_free_rbtree_RBT_TYPE = &uaddr_free_rbtree_RBT_INFO;
