...
xhci_init(struct xhci_softc *sc)
{
 ...
 npage = ((((hcr) >> 16) & 0x3e0) | (((hcr) >> 27) & 0x1f));
 ;
...
xhci_event_dequeue(struct xhci_softc *sc)
{
 ...
 while ((trb = xhci_ring_consume(sc, &sc->sc_evt_ring)) != ((void *)0)) {
  paddr = (__uint64_t)(__builtin_constant_p(trb->trb_paddr) ? (__uint64_t)((((__uint64_t)(trb->trb_paddr) & 0xff) << 56) | ((__uint64_t)(trb->trb_paddr) & 0xff00ULL) << 40 | ((__uint64_t)(trb->trb_paddr) & 0xff0000ULL) << 24 | ((__uint64_t)(trb->trb_paddr) & 0xff000000ULL) << 8 | ((__uint64_t)(trb->trb_paddr) & 0xff00000000ULL) >> 8 | ((__uint64_t)(trb->trb_paddr) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(trb->trb_paddr) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(trb->trb_paddr) & 0xff00000000000000ULL) >> 56) : __swap64md(trb->trb_paddr));
  status = (__uint32_t)(__builtin_constant_p(trb->trb_status) ? (__uint32_t)(((__uint32_t)(trb->trb_status) & 0xff) << 24 | ((__uint32_t)(trb->trb_status) & 0xff00) << 8 | ((__uint32_t)(trb->trb_status) & 0xff0000) >> 8 | ((__uint32_t)(trb->trb_status) & 0xff000000) >> 24) : __swap32md(trb->trb_status));
  flags = (__uint32_t)(__builtin_constant_p(trb->trb_flags) ? (__uint32_t)(((__uint32_t)(trb->trb_flags) & 0xff) << 24 | ((__uint32_t)(trb->trb_flags) & 0xff00) << 8 | ((__uint32_t)(trb->trb_flags) & 0xff0000) >> 8 | ((__uint32_t)(trb->trb_flags) & 0xff000000) >> 24) : __swap32md(trb->trb_flags));
  switch (flags & 0xfc00) {
  case (32 << 10):
...
xhci_event_command(struct xhci_softc *sc, uint64_t paddr)
{
 ...
 case (13 << 10):
 case (23 << 10):
  ((sc->sc_cmd_trb == trb) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 878, "sc->sc_cmd_trb == trb"));
...
xhci_pipe_open(struct usbd_pipe *pipe)
{
 ...
 int error;
 ((xp->slot == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 976, "xp->slot == 0"));
 if (sc->sc_bus.dying)
  return (USBD_IOERROR);
...
xhci_pipe_interval(struct usbd_pipe *pipe)
{
 ...
 ((ival >= 0 && ival <= 15) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 1147, "ival >= 0 && ival <= 15"));
 return ((((ival) & 0xff) << 16));
}
uint32_t
...
{
 usb_endpoint_descriptor_t *ed = pipe->endpoint->edesc;
 uint32_t mps = ((ed->wMaxPacketSize)[0] | ((ed->wMaxPacketSize)[1] << 8));
 uint8_t xfertype = ((ed->bmAttributes) & 0x03);
 uint32_t maxb = 0;
 switch (pipe->device->speed) {
 case 3:
  if (xfertype == 0x01 || xfertype == 0x03)
   maxb = (((mps) >> 11) & 0x3);
  break;
 case 4:
 default:
...
xhci_context_setup(struct xhci_softc *sc, struct usbd_pipe *pipe)
{
 ...
 if ((ed->bEndpointAddress & 0x80) || (xfertype == 0x00))
  xfertype |= 0x4;
 sdev->ep_ctx[xp->dci-1]->info_lo = (__uint32_t)(__builtin_constant_p(xhci_pipe_interval(pipe)) ? (__uint32_t)(((__uint32_t)(xhci_pipe_interval(pipe)) & 0xff) << 24 | ((__uint32_t)(xhci_pipe_interval(pipe)) & 0xff00) << 8 | ((__uint32_t)(xhci_pipe_interval(pipe)) & 0xff0000) >> 8 | ((__uint32_t)(xhci_pipe_interval(pipe)) & 0xff000000) >> 24) : __swap32md(xhci_pipe_interval(pipe)));
 sdev->ep_ctx[xp->dci-1]->info_hi = (__uint32_t)(__builtin_constant_p((((((mps) & 0x7ff)) & 0xffff) << 16) | (((xhci_pipe_maxburst(pipe)) & 0xff) << 8) | (((xfertype) & 0x7) << 3) | (((cerr) & 0x3) << 1)) ? (__uint32_t)(((__uint32_t)((((((mps) & 0x7ff)) & 0xffff) << 16) | (((xhci_pipe_maxburst(pipe)) & 0xff) << 8) | (((xfertype) & 0x7) << 3) | (((cerr) & 0x3) << 1)) & 0xff) << 24 | ((__uint32_t)((((((mps) & 0x7ff)) & 0xffff) << 16) | (((xhci_pipe_maxburst(pipe)) & 0xff) << 8) | (((xfertype) & 0x7) << 3) | (((cerr) & 0x3) << 1)) & 0xff00) << 8 | ((__uint32_t)((((((mps) & 0x7ff)) & 0xffff) << 16) | (((xhci_pipe_maxburst(pipe)) & 0xff) << 8) | (((xfertype) & 0x7) << 3) | (((cerr) & 0x3) << 1)) & 0xff0000) >> 8 | ((__uint32_t)((((((mps) & 0x7ff)) & 0xffff) << 16) | (((xhci_pipe_maxburst(pipe)) & 0xff) << 8) | (((xfertype) & 0x7) << 3) | (((cerr) & 0x3) << 1)) & 0xff000000) >> 24) : __swap32md((((((mps) & 0x7ff)) & 0xffff) << 16) | (((xhci_pipe_maxburst(pipe)) & 0xff) << 8) | (((xfertype) & 0x7) << 3) | (((cerr) & 0x3) << 1)));
 sdev->ep_ctx[xp->dci-1]->txinfo = (__uint32_t)(__builtin_constant_p(xhci_get_txinfo(sc, pipe)) ? (__uint32_t)(((__uint32_t)(xhci_get_txinfo(sc, pipe)) & 0xff) << 24 | ((__uint32_t)(xhci_get_txinfo(sc, pipe)) & 0xff00) << 8 | ((__uint32_t)(xhci_get_txinfo(sc, pipe)) & 0xff0000) >> 8 | ((__uint32_t)(xhci_get_txinfo(sc, pipe)) & 0xff000000) >> 24) : __swap32md(xhci_get_txinfo(sc, pipe)));
 sdev->ep_ctx[xp->dci-1]->deqp = (__uint64_t)(__builtin_constant_p(((xp->ring).dma.paddr + (sizeof(struct xhci_trb) * (xp->ring).index)) | xp->ring.toggle) ? (__uint64_t)((((__uint64_t)(((xp->ring).dma.paddr + (sizeof(struct xhci_trb) * (xp->ring).index)) | xp->ring.toggle) & 0xff) << 56) | ((__uint64_t)(((xp->ring).dma.paddr + (sizeof(struct xhci_trb) * (xp->ring).index)) | xp->ring.toggle) & 0xff00ULL) << 40 | ((__uint64_t)(((xp->ring).dma.paddr + (sizeof(struct xhci_trb) * (xp->ring).index)) | xp->ring.toggle) & 0xff0000ULL) << 24 | ((__uint64_t)(((xp->ring).dma.paddr + (sizeof(struct xhci_trb) * (xp->ring).index)) | xp->ring.toggle) & 0xff000000ULL) << 8 | ((__uint64_t)(((xp->ring).dma.paddr + (sizeof(struct xhci_trb) * (xp->ring).index)) | xp->ring.toggle) & 0xff00000000ULL) >> 8 | ((__uint64_t)(((xp->ring).dma.paddr + (sizeof(struct xhci_trb) * (xp->ring).index)) | xp->ring.toggle) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(((xp->ring).dma.paddr + (sizeof(struct xhci_trb) * (xp->ring).index)) | xp->ring.toggle) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(((xp->ring).dma.paddr + (sizeof(struct xhci_trb) * (xp->ring).index)) | xp->ring.toggle) & 0xff00000000000000ULL) >> 56) : __swap64md(((xp->ring).dma.paddr + (sizeof(struct xhci_trb) * (xp->ring).index)) | xp->ring.toggle));
 sdev->input_ctx->drop_flags = 0;
 sdev->input_ctx->add_flags = (__uint32_t)(__builtin_constant_p((0x1 << (xp->dci))) ? (__uint32_t)(((__uint32_t)((0x1 << (xp->dci))) & 0xff) << 24 | ((__uint32_t)((0x1 << (xp->dci))) & 0xff00) << 8 | ((__uint32_t)((0x1 << (xp->dci))) & 0xff0000) >> 8 | ((__uint32_t)((0x1 << (xp->dci))) & 0xff000000) >> 24) : __swap32md((0x1 << (xp->dci))));
 sdev->slot_ctx->info_lo = (__uint32_t)(__builtin_constant_p((((xp->dci) & 0x1f) << 27) | (((speed) & 0xf) << 20) | ((route) & 0xfffff)) ? (__uint32_t)(((__uint32_t)((((xp->dci) & 0x1f) << 27) | (((speed) & 0xf) << 20) | ((route) & 0xfffff)) & 0xff) << 24 | ((__uint32_t)((((xp->dci) & 0x1f) << 27) | (((speed) & 0xf) << 20) | ((route) & 0xfffff)) & 0xff00) << 8 | ((__uint32_t)((((xp->dci) & 0x1f) << 27) | (((speed) & 0xf) << 20) | ((route) & 0xfffff)) & 0xff0000) >> 8 | ((__uint32_t)((((xp->dci) & 0x1f) << 27) | (((speed) & 0xf) << 20) | ((route) & 0xfffff)) & 0xff000000) >> 24) : __swap32md((((xp->dci) & 0x1f) << 27) | (((speed) & 0xf) << 20) | ((route) & 0xfffff)));
 sdev->slot_ctx->info_hi = (__uint32_t)(__builtin_constant_p((((rhport) & 0xff) << 16)) ? (__uint32_t)(((__uint32_t)((((rhport) & 0xff) << 16)) & 0xff) << 24 | ((__uint32_t)((((rhport) & 0xff) << 16)) & 0xff00) << 8 | ((__uint32_t)((((rhport) & 0xff) << 16)) & 0xff0000) >> 8 | ((__uint32_t)((((rhport) & 0xff) << 16)) & 0xff000000) >> 24) : __swap32md((((rhport) & 0xff) << 16)));
 sdev->slot_ctx->tt = 0;
 sdev->slot_ctx->state = 0;
 if (pipe->device->hub != ((void *)0)) {
  int nports = pipe->device->hub->nports;
  sdev->slot_ctx->info_lo |= (__uint32_t)(__builtin_constant_p((((1) & 0x1) << 26)) ? (__uint32_t)(((__uint32_t)((((1) & 0x1) << 26)) & 0xff) << 24 | ((__uint32_t)((((1) & 0x1) << 26)) & 0xff00) << 8 | ((__uint32_t)((((1) & 0x1) << 26)) & 0xff0000) >> 8 | ((__uint32_t)((((1) & 0x1) << 26)) & 0xff000000) >> 24) : __swap32md((((1) & 0x1) << 26)));
  sdev->slot_ctx->info_hi |= (__uint32_t)(__builtin_constant_p((((nports) & 0xff) << 24)) ? (__uint32_t)(((__uint32_t)((((nports) & 0xff) << 24)) & 0xff) << 24 | ((__uint32_t)((((nports) & 0xff) << 24)) & 0xff00) << 8 | ((__uint32_t)((((nports) & 0xff) << 24)) & 0xff0000) >> 8 | ((__uint32_t)((((nports) & 0xff) << 24)) & 0xff000000) >> 24) : __swap32md((((nports) & 0xff) << 24)));
  if ((pipe->device->ddesc.bDeviceProtocol == 0x02))
   sdev->slot_ctx->info_lo |= (__uint32_t)(__builtin_constant_p((((1) & 0x1) << 25)) ? (__uint32_t)(((__uint32_t)((((1) & 0x1) << 25)) & 0xff) << 24 | ((__uint32_t)((((1) & 0x1) << 25)) & 0xff00) << 8 | ((__uint32_t)((((1) & 0x1) << 25)) & 0xff0000) >> 8 | ((__uint32_t)((((1) & 0x1) << 25)) & 0xff000000) >> 24) : __swap32md((((1) & 0x1) << 25)));
  sdev->slot_ctx->tt |= (__uint32_t)(__builtin_constant_p((((pipe->device->hub->ttthink) & 0x3) << 16)) ? (__uint32_t)(((__uint32_t)((((pipe->device->hub->ttthink) & 0x3) << 16)) & 0xff) << 24 | ((__uint32_t)((((pipe->device->hub->ttthink) & 0x3) << 16)) & 0xff00) << 8 | ((__uint32_t)((((pipe->device->hub->ttthink) & 0x3) << 16)) & 0xff0000) >> 8 | ((__uint32_t)((((pipe->device->hub->ttthink) & 0x3) << 16)) & 0xff000000) >> 24) : __swap32md((((pipe->device->hub->ttthink) & 0x3) << 16)));
 }
 if (speed < 3 && pipe->device->myhsport != ((void *)0)) {
  ...
  if ((hshub->ddesc.bDeviceProtocol == 0x02))
   sdev->slot_ctx->info_lo |= (__uint32_t)(__builtin_constant_p((((1) & 0x1) << 25)) ? (__uint32_t)(((__uint32_t)((((1) & 0x1) << 25)) & 0xff) << 24 | ((__uint32_t)((((1) & 0x1) << 25)) & 0xff00) << 8 | ((__uint32_t)((((1) & 0x1) << 25)) & 0xff0000) >> 8 | ((__uint32_t)((((1) & 0x1) << 25)) & 0xff000000) >> 24) : __swap32md((((1) & 0x1) << 25)));
  sdev->slot_ctx->tt |= (__uint32_t)(__builtin_constant_p(((slot) & 0xff) | (((pipe->device->myhsport->portno) & 0xff) << 8)) ? (__uint32_t)(((__uint32_t)(((slot) & 0xff) | (((pipe->device->myhsport->portno) & 0xff) << 8)) & 0xff) << 24 | ((__uint32_t)(((slot) & 0xff) | (((pipe->device->myhsport->portno) & 0xff) << 8)) & 0xff00) << 8 | ((__uint32_t)(((slot) & 0xff) | (((pipe->device->myhsport->portno) & 0xff) << 8)) & 0xff0000) >> 8 | ((__uint32_t)(((slot) & 0xff) | (((pipe->device->myhsport->portno) & 0xff) << 8)) & 0xff000000) >> 24) : __swap32md(((slot) & 0xff) | (((pipe->device->myhsport->portno) & 0xff) << 8)));
 }
 sdev->input_ctx->add_flags |= (__uint32_t)(__builtin_constant_p((0x1 << (0))) ? (__uint32_t)(((__uint32_t)((0x1 << (0))) & 0xff) << 24 | ((__uint32_t)((0x1 << (0))) & 0xff00) << 8 | ((__uint32_t)((0x1 << (0))) & 0xff0000) >> 8 | ((__uint32_t)((0x1 << (0))) & 0xff000000) >> 24) : __swap32md((0x1 << (0))));
...
xhci_pipe_close(struct usbd_pipe *pipe)
{
 ...
 if (pipe->device->depth == 0)
  return;
 sdev->input_ctx->drop_flags = (__uint32_t)(__builtin_constant_p((0x1 << (xp->dci))) ? (__uint32_t)(((__uint32_t)((0x1 << (xp->dci))) & 0xff) << 24 | ((__uint32_t)((0x1 << (xp->dci))) & 0xff00) << 8 | ((__uint32_t)((0x1 << (xp->dci))) & 0xff0000) >> 8 | ((__uint32_t)((0x1 << (xp->dci))) & 0xff000000) >> 24) : __swap32md((0x1 << (xp->dci))));
 ...
 sdev->slot_ctx->info_lo = (__uint32_t)(__builtin_constant_p((((lxp->dci) & 0x1f) << 27)) ? (__uint32_t)(((__uint32_t)((((lxp->dci) & 0x1f) << 27)) & 0xff) << 24 | ((__uint32_t)((((lxp->dci) & 0x1f) << 27)) & 0xff00) << 8 | ((__uint32_t)((((lxp->dci) & 0x1f) << 27)) & 0xff0000) >> 8 | ((__uint32_t)((((lxp->dci) & 0x1f) << 27)) & 0xff000000) >> 24) : __swap32md((((lxp->dci) & 0x1f) << 27)));
...
xhci_setaddr(struct usbd_device *dev, int addr)
{
 ...
 if (dev->depth == 0)
  return (0);
 ((xp->dci == 1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 1411, "xp->dci == 1"));
...
xhci_scratchpad_alloc(struct xhci_softc *sc, int npage)
{
 ...
 for (i = 0; i < npage; i++) {
  pte[i] = (__uint64_t)(__builtin_constant_p(sc->sc_spad.pages_dma.paddr + (i * sc->sc_pagesize)) ? (__uint64_t)((((__uint64_t)(sc->sc_spad.pages_dma.paddr + (i * sc->sc_pagesize)) & 0xff) << 56) | ((__uint64_t)(sc->sc_spad.pages_dma.paddr + (i * sc->sc_pagesize)) & 0xff00ULL) << 40 | ((__uint64_t)(sc->sc_spad.pages_dma.paddr + (i * sc->sc_pagesize)) & 0xff0000ULL) << 24 | ((__uint64_t)(sc->sc_spad.pages_dma.paddr + (i * sc->sc_pagesize)) & 0xff000000ULL) << 8 | ((__uint64_t)(sc->sc_spad.pages_dma.paddr + (i * sc->sc_pagesize)) & 0xff00000000ULL) >> 8 | ((__uint64_t)(sc->sc_spad.pages_dma.paddr + (i * sc->sc_pagesize)) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(sc->sc_spad.pages_dma.paddr + (i * sc->sc_pagesize)) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(sc->sc_spad.pages_dma.paddr + (i * sc->sc_pagesize)) & 0xff00000000000000ULL) >> 56) : __swap64md(sc->sc_spad.pages_dma.paddr + (i * sc->sc_pagesize)));
 }
 bus_dmamap_sync(sc->sc_spad.table_dma.tag, sc->sc_spad.table_dma.map, 0,
     npage * sizeof(uint64_t), 0x01 |
     0x04);
 sc->sc_dcbaa.segs[0] = (__uint64_t)(__builtin_constant_p(sc->sc_spad.table_dma.paddr) ? (__uint64_t)((((__uint64_t)(sc->sc_spad.table_dma.paddr) & 0xff) << 56) | ((__uint64_t)(sc->sc_spad.table_dma.paddr) & 0xff00ULL) << 40 | ((__uint64_t)(sc->sc_spad.table_dma.paddr) & 0xff0000ULL) << 24 | ((__uint64_t)(sc->sc_spad.table_dma.paddr) & 0xff000000ULL) << 8 | ((__uint64_t)(sc->sc_spad.table_dma.paddr) & 0xff00000000ULL) >> 8 | ((__uint64_t)(sc->sc_spad.table_dma.paddr) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(sc->sc_spad.table_dma.paddr) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(sc->sc_spad.table_dma.paddr) & 0xff00000000000000ULL) >> 56) : __swap64md(sc->sc_spad.table_dma.paddr));
...
xhci_ring_consume(struct xhci_softc *sc, struct xhci_ring *ring)
{
 ...
 ((ring->index < ring->ntrb) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 1563, "ring->index < ring->ntrb"));
...
{
 struct xhci_trb *trb = &ring->trbs[ring->index];
 ((ring->index < ring->ntrb) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 1587, "ring->index < ring->ntrb"));
 bus_dmamap_sync(ring->dma.tag, ring->dma.map, ((char *)(trb) - (char *)((ring)->trbs)),
     sizeof(struct xhci_trb), 0x02 |
     0x08);
 ring->index++;
 if (ring->index == (ring->ntrb - 1)) {
  ...
  bus_dmamap_sync(ring->dma.tag, ring->dma.map, ((char *)(lnk) - (char *)((ring)->trbs)),
      sizeof(struct xhci_trb), 0x02 |
      0x08);
  lnk->trb_flags ^= (__uint32_t)(__builtin_constant_p((1 << 0)) ? (__uint32_t)(((__uint32_t)((1 << 0)) & 0xff) << 24 | ((__uint32_t)((1 << 0)) & 0xff00) << 8 | ((__uint32_t)((1 << 0)) & 0xff0000) >> 8 | ((__uint32_t)((1 << 0)) & 0xff000000) >> 24) : __swap32md((1 << 0)));
  bus_dmamap_sync(ring->dma.tag, ring->dma.map, ((char *)(lnk) - (char *)((ring)->trbs)),
    ...
    uint8_t *togglep, int last)
{
 struct xhci_pipe *xp = (struct xhci_pipe *)xfer->pipe;
 struct xhci_xfer *xx = (struct xhci_xfer *)xfer;
 ((xp->free_trbs >= 1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 1622, "xp->free_trbs >= 1"));
...
xhci_command_submit(struct xhci_softc *sc, struct xhci_trb *trb0, int timeout)
{
 struct xhci_trb *trb;
 int s, error = 0;
 ((timeout == 0 || sc->sc_cmd_trb == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 1641, "timeout == 0 || sc->sc_cmd_trb == NULL"));
 ...
 if (error) {
  ((sc->sc_cmd_trb == trb) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 1672, "sc->sc_cmd_trb == trb"));
  sc->sc_cmd_trb = ((void *)0);
  _splx(s);
  return (error);
 }
 ...
 if (((((__uint32_t)(__builtin_constant_p(trb0->trb_status) ? (__uint32_t)(((__uint32_t)(trb0->trb_status) & 0xff) << 24 | ((__uint32_t)(trb0->trb_status) & 0xff00) << 8 | ((__uint32_t)(trb0->trb_status) & 0xff0000) >> 8 | ((__uint32_t)(trb0->trb_status) & 0xff000000) >> 24) : __swap32md(trb0->trb_status))) >> 24) & 0xff) == 1)
  return (0);
 return (5);
}
int
...
xhci_cmd_configure_ep(struct xhci_softc *sc, uint8_t slot, uint64_t addr)
{
 struct xhci_trb trb;
 ;
 trb.trb_paddr = (__uint64_t)(__builtin_constant_p(addr) ? (__uint64_t)((((__uint64_t)(addr) & 0xff) << 56) | ((__uint64_t)(addr) & 0xff00ULL) << 40 | ((__uint64_t)(addr) & 0xff0000ULL) << 24 | ((__uint64_t)(addr) & 0xff000000ULL) << 8 | ((__uint64_t)(addr) & 0xff00000000ULL) >> 8 | ((__uint64_t)(addr) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(addr) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(addr) & 0xff00000000000000ULL) >> 56) : __swap64md(addr));
 trb.trb_status = 0;
 trb.trb_flags = (__uint32_t)(__builtin_constant_p((((slot) & 0xff) << 24) | (12 << 10)) ? (__uint32_t)(((__uint32_t)((((slot) & 0xff) << 24) | (12 << 10)) & 0xff) << 24 | ((__uint32_t)((((slot) & 0xff) << 24) | (12 << 10)) & 0xff00) << 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (12 << 10)) & 0xff0000) >> 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (12 << 10)) & 0xff000000) >> 24) : __swap32md((((slot) & 0xff) << 24) | (12 << 10)));
...
xhci_cmd_stop_ep(struct xhci_softc *sc, uint8_t slot, uint8_t dci)
{
 ...
 trb.trb_paddr = 0;
 trb.trb_status = 0;
 trb.trb_flags = (__uint32_t)(__builtin_constant_p((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (15 << 10)) ? (__uint32_t)(((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (15 << 10)) & 0xff) << 24 | ((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (15 << 10)) & 0xff00) << 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (15 << 10)) & 0xff0000) >> 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (15 << 10)) & 0xff000000) >> 24) : __swap32md((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (15 << 10)));
 return (xhci_command_submit(sc, &trb, 500));
}
void
xhci_cmd_reset_ep_async(struct xhci_softc *sc, uint8_t slot, uint8_t dci)
{
 ...
 trb.trb_paddr = 0;
 trb.trb_status = 0;
 trb.trb_flags = (__uint32_t)(__builtin_constant_p((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (14 << 10)) ? (__uint32_t)(((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (14 << 10)) & 0xff) << 24 | ((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (14 << 10)) & 0xff00) << 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (14 << 10)) & 0xff0000) >> 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (14 << 10)) & 0xff000000) >> 24) : __swap32md((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (14 << 10)));
   ...
   uint64_t addr)
{
 ...
 trb.trb_paddr = (__uint64_t)(__builtin_constant_p(addr) ? (__uint64_t)((((__uint64_t)(addr) & 0xff) << 56) | ((__uint64_t)(addr) & 0xff00ULL) << 40 | ((__uint64_t)(addr) & 0xff0000ULL) << 24 | ((__uint64_t)(addr) & 0xff000000ULL) << 8 | ((__uint64_t)(addr) & 0xff00000000ULL) >> 8 | ((__uint64_t)(addr) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(addr) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(addr) & 0xff00000000000000ULL) >> 56) : __swap64md(addr));
 trb.trb_status = 0;
 trb.trb_flags = (__uint32_t)(__builtin_constant_p((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (16 << 10)) ? (__uint32_t)(((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (16 << 10)) & 0xff) << 24 | ((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (16 << 10)) & 0xff00) << 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (16 << 10)) & 0xff0000) >> 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (16 << 10)) & 0xff000000) >> 24) : __swap32md((((slot) & 0xff) << 24) | (((dci) & 0x1f) << 16) | (16 << 10)));
 xhci_command_submit(sc, &trb, 0);
}
int
xhci_cmd_slot_control(struct xhci_softc *sc, uint8_t *slotp, int enable)
{
 ...
 trb.trb_status = 0;
 if (enable)
  trb.trb_flags = (__uint32_t)(__builtin_constant_p((9 << 10)) ? (__uint32_t)(((__uint32_t)((9 << 10)) & 0xff) << 24 | ((__uint32_t)((9 << 10)) & 0xff00) << 8 | ((__uint32_t)((9 << 10)) & 0xff0000) >> 8 | ((__uint32_t)((9 << 10)) & 0xff000000) >> 24) : __swap32md((9 << 10)));
 else
  trb.trb_flags = (__uint32_t)(__builtin_constant_p((((*slotp) & 0xff) << 24) | (10 << 10)) ? (__uint32_t)(((__uint32_t)((((*slotp) & 0xff) << 24) | (10 << 10)) & 0xff) << 24 | ((__uint32_t)((((*slotp) & 0xff) << 24) | (10 << 10)) & 0xff00) << 8 | ((__uint32_t)((((*slotp) & 0xff) << 24) | (10 << 10)) & 0xff0000) >> 8 | ((__uint32_t)((((*slotp) & 0xff) << 24) | (10 << 10)) & 0xff000000) >> 24) : __swap32md((((*slotp) & 0xff) << 24) | (10 << 10)));
 if (xhci_command_submit(sc, &trb, 500))
  return (5);
 if (enable)
  *slotp = ((((__uint32_t)(__builtin_constant_p(trb.trb_flags) ? (__uint32_t)(((__uint32_t)(trb.trb_flags) & 0xff) << 24 | ((__uint32_t)(trb.trb_flags) & 0xff00) << 8 | ((__uint32_t)(trb.trb_flags) & 0xff0000) >> 8 | ((__uint32_t)(trb.trb_flags) & 0xff000000) >> 24) : __swap32md(trb.trb_flags))) >> 24) & 0xff);
 return (0);
}
int
    ...
    uint32_t bsr)
{
 ...
 trb.trb_paddr = (__uint64_t)(__builtin_constant_p(addr) ? (__uint64_t)((((__uint64_t)(addr) & 0xff) << 56) | ((__uint64_t)(addr) & 0xff00ULL) << 40 | ((__uint64_t)(addr) & 0xff0000ULL) << 24 | ((__uint64_t)(addr) & 0xff000000ULL) << 8 | ((__uint64_t)(addr) & 0xff00000000ULL) >> 8 | ((__uint64_t)(addr) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(addr) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(addr) & 0xff00000000000000ULL) >> 56) : __swap64md(addr));
 trb.trb_status = 0;
 trb.trb_flags = (__uint32_t)(__builtin_constant_p((((slot) & 0xff) << 24) | (11 << 10) | bsr) ? (__uint32_t)(((__uint32_t)((((slot) & 0xff) << 24) | (11 << 10) | bsr) & 0xff) << 24 | ((__uint32_t)((((slot) & 0xff) << 24) | (11 << 10) | bsr) & 0xff00) << 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (11 << 10) | bsr) & 0xff0000) >> 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (11 << 10) | bsr) & 0xff000000) >> 24) : __swap32md((((slot) & 0xff) << 24) | (11 << 10) | bsr));
 return (xhci_command_submit(sc, &trb, 500));
}
int
xhci_cmd_evaluate_ctx(struct xhci_softc *sc, uint8_t slot, uint64_t addr)
{
 ...
 trb.trb_paddr = (__uint64_t)(__builtin_constant_p(addr) ? (__uint64_t)((((__uint64_t)(addr) & 0xff) << 56) | ((__uint64_t)(addr) & 0xff00ULL) << 40 | ((__uint64_t)(addr) & 0xff0000ULL) << 24 | ((__uint64_t)(addr) & 0xff000000ULL) << 8 | ((__uint64_t)(addr) & 0xff00000000ULL) >> 8 | ((__uint64_t)(addr) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(addr) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(addr) & 0xff00000000000000ULL) >> 56) : __swap64md(addr));
 trb.trb_status = 0;
 trb.trb_flags = (__uint32_t)(__builtin_constant_p((((slot) & 0xff) << 24) | (13 << 10)) ? (__uint32_t)(((__uint32_t)((((slot) & 0xff) << 24) | (13 << 10)) & 0xff) << 24 | ((__uint32_t)((((slot) & 0xff) << 24) | (13 << 10)) & 0xff00) << 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (13 << 10)) & 0xff0000) >> 8 | ((__uint32_t)((((slot) & 0xff) << 24) | (13 << 10)) & 0xff000000) >> 24) : __swap32md((((slot) & 0xff) << 24) | (13 << 10)));
 return (xhci_command_submit(sc, &trb, 500));
}
int
...
xhci_root_ctrl_start(struct usbd_xfer *xfer)
{
 ...
 int port, i;
 uint32_t v;
 ((xfer->rqflags & 0x01) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 2106, "xfer->rqflags & URQ_REQUEST"));
 if (sc->sc_bus.dying)
  return (USBD_IOERROR);
 req = &xfer->request;
 ;
...
xhci_xfer_tdsize(struct usbd_xfer *xfer, uint32_t remain, uint32_t len)
{
 ...
 if (len == 0)
  return (((0) & 0x1f) << 17);
 npkt = (((remain - len) + ((((mps) & 0x7ff)) - 1)) / (((mps) & 0x7ff)));
 if (npkt > 31)
  npkt = 31;
 return (((npkt) & 0x1f) << 17);
}
...
{
 uint32_t mps = ((xfer->pipe->endpoint->edesc->wMaxPacketSize)[0] | ((xfer->pipe->endpoint->edesc->wMaxPacketSize)[1] << 8));
 uint32_t maxb, tdpc, residue, tbc;
 tdpc = (((len) + ((((mps) & 0x7ff)) - 1)) / (((mps) & 0x7ff)));
 if (tdpc == 0)
  tdpc = 1;
 maxb = xhci_pipe_maxburst(xfer->pipe);
 tbc = (((tdpc) + ((maxb + 1) - 1)) / (maxb + 1)) - 1;
 if (xfer->device->speed == 4) {
  residue = tdpc % (maxb + 1);
  if (residue == 0)
   *tlbpc = maxb;
  else
...
xhci_device_ctrl_start(struct usbd_xfer *xfer)
{
 ...
 int s;
 ((xfer->rqflags & 0x01) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 2579, "xfer->rqflags & URQ_REQUEST"));
 ...
 if (len != 0) {
  ...
  if (usbd_xfer_isread(xfer))
   flags |= (1 << 16) | (1 << 2);
  trb->trb_paddr = (__uint64_t)(__builtin_constant_p(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) ? (__uint64_t)((((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff) << 56) | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff00ULL) << 40 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff0000ULL) << 24 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff000000ULL) << 8 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff00000000ULL) >> 8 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff00000000000000ULL) >> 56) : __swap64md(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))));
  trb->trb_status = (__uint32_t)(__builtin_constant_p((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, len, len)) ? (__uint32_t)(((__uint32_t)((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, len, len)) & 0xff) << 24 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, len, len)) & 0xff00) << 8 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, len, len)) & 0xff0000) >> 8 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, len, len)) & 0xff000000) >> 24) : __swap32md((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, len, len)));
  trb->trb_flags = (__uint32_t)(__builtin_constant_p(flags) ? (__uint32_t)(((__uint32_t)(flags) & 0xff) << 24 | ((__uint32_t)(flags) & 0xff00) << 8 | ((__uint32_t)(flags) & 0xff0000) >> 8 | ((__uint32_t)(flags) & 0xff000000) >> 24) : __swap32md(flags));
 ...
 if (len == 0 || !usbd_xfer_isread(xfer))
  flags |= (1 << 16);
 trb->trb_paddr = 0;
 trb->trb_status = (__uint32_t)(__builtin_constant_p((((0) & 0x3ff) << 22)) ? (__uint32_t)(((__uint32_t)((((0) & 0x3ff) << 22)) & 0xff) << 24 | ((__uint32_t)((((0) & 0x3ff) << 22)) & 0xff00) << 8 | ((__uint32_t)((((0) & 0x3ff) << 22)) & 0xff0000) >> 8 | ((__uint32_t)((((0) & 0x3ff) << 22)) & 0xff000000) >> 24) : __swap32md((((0) & 0x3ff) << 22)));
 trb->trb_flags = (__uint32_t)(__builtin_constant_p(flags) ? (__uint32_t)(((__uint32_t)(flags) & 0xff) << 24 | ((__uint32_t)(flags) & 0xff00) << 8 | ((__uint32_t)(flags) & 0xff0000) >> 8 | ((__uint32_t)(flags) & 0xff000000) >> 24) : __swap32md(flags));
 bus_dmamap_sync(xp->ring.dma.tag, xp->ring.dma.map,
     ((char *)(trb) - (char *)((&xp->ring)->trbs)), sizeof(struct xhci_trb),
     0x04);
 ...
 trb0->trb_status = (__uint32_t)(__builtin_constant_p((((0) & 0x3ff) << 22) | ((8) & 0x1ffff)) ? (__uint32_t)(((__uint32_t)((((0) & 0x3ff) << 22) | ((8) & 0x1ffff)) & 0xff) << 24 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((8) & 0x1ffff)) & 0xff00) << 8 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((8) & 0x1ffff)) & 0xff0000) >> 8 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((8) & 0x1ffff)) & 0xff000000) >> 24) : __swap32md((((0) & 0x3ff) << 22) | ((8) & 0x1ffff)));
 trb0->trb_flags = (__uint32_t)(__builtin_constant_p(flags) ? (__uint32_t)(((__uint32_t)(flags) & 0xff) << 24 | ((__uint32_t)(flags) & 0xff00) << 8 | ((__uint32_t)(flags) & 0xff0000) >> 8 | ((__uint32_t)(flags) & 0xff000000) >> 24) : __swap32md(flags));
 bus_dmamap_sync(xp->ring.dma.tag, xp->ring.dma.map,
...
xhci_device_generic_start(struct usbd_xfer *xfer)
{
 ...
 uint32_t len0, mps = ((xfer->pipe->endpoint->edesc->wMaxPacketSize)[0] | ((xfer->pipe->endpoint->edesc->wMaxPacketSize)[1] << 8));
 uint64_t paddr = ((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0));
 uint8_t toggle0, toggle;
 int s, i, ntrb;
 ((!(xfer->rqflags & 0x01)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 2686, "!(xfer->rqflags & URQ_REQUEST)"));
 if (sc->sc_bus.dying || xp->halted)
  return (USBD_IOERROR);
 ...
 for (i = ntrb - 1; i > 0; i--) {
  ...
  if (usbd_xfer_isread(xfer))
   flags |= (1 << 2);
  flags |= (i == 1) ? (1 << 5) : (1 << 4);
  trb->trb_paddr = (__uint64_t)(__builtin_constant_p(paddr) ? (__uint64_t)((((__uint64_t)(paddr) & 0xff) << 56) | ((__uint64_t)(paddr) & 0xff00ULL) << 40 | ((__uint64_t)(paddr) & 0xff0000ULL) << 24 | ((__uint64_t)(paddr) & 0xff000000ULL) << 8 | ((__uint64_t)(paddr) & 0xff00000000ULL) >> 8 | ((__uint64_t)(paddr) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(paddr) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(paddr) & 0xff00000000000000ULL) >> 56) : __swap64md(paddr));
  trb->trb_status = (__uint32_t)(__builtin_constant_p((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, remain, len)) ? (__uint32_t)(((__uint32_t)((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, remain, len)) & 0xff) << 24 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, remain, len)) & 0xff00) << 8 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, remain, len)) & 0xff0000) >> 8 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, remain, len)) & 0xff000000) >> 24) : __swap32md((((0) & 0x3ff) << 22) | ((len) & 0x1ffff) | xhci_xfer_tdsize(xfer, remain, len)));
  trb->trb_flags = (__uint32_t)(__builtin_constant_p(flags) ? (__uint32_t)(((__uint32_t)(flags) & 0xff) << 24 | ((__uint32_t)(flags) & 0xff00) << 8 | ((__uint32_t)(flags) & 0xff0000) >> 8 | ((__uint32_t)(flags) & 0xff000000) >> 24) : __swap32md(flags));
  bus_dmamap_sync(xp->ring.dma.tag, xp->ring.dma.map,
      ((char *)(trb) - (char *)((&xp->ring)->trbs)), sizeof(struct xhci_trb),
      0x04);
 ...
 trb0->trb_paddr = (__uint64_t)(__builtin_constant_p(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) ? (__uint64_t)((((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff) << 56) | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff00ULL) << 40 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff0000ULL) << 24 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff000000ULL) << 8 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff00000000ULL) >> 8 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff00000000000000ULL) >> 56) : __swap64md(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))));
 trb0->trb_status = (__uint32_t)(__builtin_constant_p((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)) ? (__uint32_t)(((__uint32_t)((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)) & 0xff) << 24 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)) & 0xff00) << 8 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)) & 0xff0000) >> 8 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)) & 0xff000000) >> 24) : __swap32md((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)));
 trb0->trb_flags = (__uint32_t)(__builtin_constant_p(flags) ? (__uint32_t)(((__uint32_t)(flags) & 0xff) << 24 | ((__uint32_t)(flags) & 0xff00) << 8 | ((__uint32_t)(flags) & 0xff0000) >> 8 | ((__uint32_t)(flags) & 0xff000000) >> 24) : __swap32md(flags));
 bus_dmamap_sync(xp->ring.dma.tag, xp->ring.dma.map,
     ((char *)(trb0) - (char *)((&xp->ring)->trbs)), sizeof(struct xhci_trb),
     0x04);
...
{
 ((!xfer->pipe->repeat || xfer->pipe->intrxfer == xfer) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 2785, "!xfer->pipe->repeat || xfer->pipe->intrxfer == xfer"));
 xhci_abort_xfer(xfer, USBD_CANCELLED);
}
usbd_status
...
xhci_device_isoc_start(struct usbd_xfer *xfer)
{
 ...
 ((!(xfer->rqflags & 0x01)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/xhci.c", 2815, "!(xfer->rqflags & URQ_REQUEST)"));
 if (sc->sc_bus.dying || xp->halted)
  return (USBD_IOERROR);
 if (sc->sc_bus.use_polling)
  return (USBD_INVAL);
 ...
 flags = (5 << 10) | (1U << 31) | toggle0;
 if (usbd_xfer_isread(xfer))
  flags |= (1 << 2);
 flags |= (ntrb == 1) ? (1 << 5) : (1 << 4);
 tbc = xhci_xfer_tbc(xfer, len0, &tlbpc);
 flags |= (((tbc) & 0x3) << 7) | (((tlbpc) & 0xf) << 16);
 trb0->trb_paddr = (__uint64_t)(__builtin_constant_p(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) ? (__uint64_t)((((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff) << 56) | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff00ULL) << 40 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff0000ULL) << 24 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff000000ULL) << 8 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff00000000ULL) >> 8 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))) & 0xff00000000000000ULL) >> 56) : __swap64md(((&xfer->dmabuf)->block->map->dm_segs[0].ds_addr + (&xfer->dmabuf)->offs + (0))));
 trb0->trb_status = (__uint32_t)(__builtin_constant_p((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)) ? (__uint32_t)(((__uint32_t)((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)) & 0xff) << 24 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)) & 0xff00) << 8 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)) & 0xff0000) >> 8 | ((__uint32_t)((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)) & 0xff000000) >> 24) : __swap32md((((0) & 0x3ff) << 22) | ((len0) & 0x1ffff) | xhci_xfer_tdsize(xfer, xfer->length, len0)));
 trb0->trb_flags = (__uint32_t)(__builtin_constant_p(flags) ? (__uint32_t)(((__uint32_t)(flags) & 0xff) << 24 | ((__uint32_t)(flags) & 0xff00) << 8 | ((__uint32_t)(flags) & 0xff0000) >> 8 | ((__uint32_t)(flags) & 0xff000000) >> 24) : __swap32md(flags));
 bus_dmamap_sync(xp->ring.dma.tag, xp->ring.dma.map,
