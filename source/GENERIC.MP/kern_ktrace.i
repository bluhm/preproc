# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/syscall.h" 1
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c" 2
...
ktrcleartrace(struct process *pr)
{
 ...
 if (pr->ps_tracevp != ((void *)0)) {
  vp = pr->ps_tracevp;
  cred = pr->ps_tracecred;

  pr->ps_traceflag = 0;
  pr->ps_tracevp = ((void *)0);
  pr->ps_tracecred = ((void *)0);
    ...
    struct ucred *newcred)
{
 ...
 ((newvp != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c", 101, "newvp != NULL"));
 ((newcred != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c", 102, "newcred != NULL"));
...
{
 __builtin_memset((kth), (0), (sizeof(struct ktr_header)));
 kth->ktr_type = type;
...
ktrinitheader(struct ktr_header *kth, struct proc *p, int type)
{
 ...
 ktrinitheaderraw(kth, type, pr->ps_pid, p->p_tid + 100000);
 __builtin_memcpy((kth->ktr_comm), (pr->ps_comm), (16));
}
...
ktrstart(struct proc *p, struct vnode *vp, struct ucred *cred)
{
 ...
 ktrinitheaderraw(&kth, ((__uint32_t)(0x4b545200)), -1, -1);
 ktrwriteraw(p, vp, cred, &kth, ((void *)0));
}
...
ktrsyscall(struct proc *p, register_t code, size_t argsize, register_t args[])
{
 ...
 if (code == 202) {
  ...
  if (args[1] > 0)
   nargs = lmin(args[1], 12);
  len += nargs * sizeof(int);
 }
 atomic_setbits_int(&p->p_flag, 0x00000001);
 ktrinitheader(&kth, p, 1);
 ktp = malloc(len, 127, 0x0001);
 ktp->ktr_code = code;
 ...
 if (nargs && copyin((void *)args[0], argp, nargs * sizeof(int)))
  __builtin_memset((argp), (0), (nargs * sizeof(int)));
    ...
    ssize_t len)
{
 ...
 ktrinitheader(&kth, p, 4);
 ktp.ktr_fd = fd;
 ktp.ktr_rw = rw;

 cp = malloc(buflen, 127, 0x0001);
 while (len > 0) {
...
ktrstruct(struct proc *p, const char *name, const void *data, size_t datalen)
{
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c", 297, "_kernel_lock_held()"));
 atomic_setbits_int(&p->p_flag, 0x00000001);
 ktrinitheader(&kth, p, 8);
...
ktruser(struct proc *p, const char *id, const void *addr, size_t len)
{
 ...
 if (!((p)->p_p->ps_traceflag & (1<<(9)) && ((p)->p_flag & 0x00000001) == 0))
  return (0);
 if (len > 2048)
  return (22);

 atomic_setbits_int(&p->p_flag, 0x00000001);
 ktrinitheader(&kth, p, 9);
 __builtin_memset((ktp.ktr_id), (0), (20));
 error = copyinstr(id, ktp.ktr_id, 20, ((void *)0));
 if (error == 0) {
  if (len > sizeof(stkbuf))
   memp = malloc(len, 127, 0x0001);
  else
   memp = stkbuf;
...
ktrexec(struct proc *p, int type, const char *data, ssize_t len)
{
 ...
 ((type == 10 || type == 11) ? (void)0 : __assert("", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c", 348, "type == KTR_EXECARGS || type == KTR_EXECENV"));
 atomic_setbits_int(&p->p_flag, 0x00000001);
    ...
    struct vnode *vp, struct ucred *cred)
{
 ...
 if (ops == 0)
  ...
  pr->ps_traceflag &= ~facs;
  if ((pr->ps_traceflag & 0x00ffffff) == 0) {
    ...
    struct vnode *vp, struct ucred *cred)
{
 ...
 for (;;) {
  ...
  if (!(((&pr->ps_children)->lh_first) == ((void *)0)))
   pr = ((&pr->ps_children)->lh_first);
  else for (;;) {
   if (pr == top)
    return (ret);
   if (((pr)->ps_sibling.le_next) != ((void *)0)) {
    pr = ((pr)->ps_sibling.le_next);
    break;
   }
   pr = pr->ps_pptr;
  }
    ...
    struct ktr_header *kth, struct iovec *data)
{
 ...
 vget(vp, 0x0001UL | 0x2000UL, curp);
 error = VOP_WRITE(vp, &auio, 0x01|0x02, cred);
 if (!error) {
  vput(vp);
  return (0);
 }
 ...
 log(5, "ktrace write failed, errno %d, tracing stopped\n",
     error);
 for((pr) = ((&allprocess)->lh_first); (pr)!= ((void *)0); (pr) = ((pr)->ps_list.le_next))
...
# 649 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_ktrace.c"
int
ktrcanset(struct proc *callp, struct process *targetpr)
{
 ...
 if ((caller->cr_uid == target->cr_ruid &&
     ...
     (targetpr->ps_traceflag & 0x80000000) == 0 &&
     !((targetpr->ps_flags) & (0x00000010))) ||
     caller->cr_uid == 0)
  return (1);
