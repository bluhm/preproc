# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c"
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c"
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_extern.h" 1
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_extern.h"
...
# 83 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_extern.h"
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.h"
typedef struct {
...
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_node.h"
...
int cd9660_vget_internal(struct mount *, cdino_t, struct vnode **, int,
    struct iso_directory_record *);
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/iso_rrip.h" 1
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/iso_rrip.h"
typedef struct {
...
int cd9660_rrip_offset(struct iso_directory_record *isodir,
      struct iso_mnt *imp);
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c" 2

struct nchstats iso_nchstats;
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c"
int
cd9660_lookup(v)
 void *v;
{
 ...
 register struct iso_node *dp;
 register struct iso_mnt *imp;
 struct buf *bp;
 struct iso_directory_record *ep = ((void *)0);
 ...
 *vpp = ((void *)0);
 ...
 if ((flags & 0x008000) && (vdp->v_mount->mnt_flag & 0x00000001) &&
  ...
  return (30);
# 155 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c"
 ...
 assoc = (imp->iso_ftype != ISO_FTYPE_RRIP && *name == '=');
 if (assoc) {
  len--;
  name++;
 }
# 180 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c"
 bmask = imp->im_bmask;
 if (nameiop != 0 || dp->i_diroff == 0 ||
  ...
  if ((entryoffsetinblock = dp->i_offset & bmask) &&
      (error = cd9660_bufatoff(dp, (off_t)dp->i_offset, ((void *)0),
   &bp)))
    return (error);
  numdirpasses = 2;
 ...
 while (dp->i_offset < endsearch) {
  ...
  case ISO_FTYPE_RRIP:
   if (isonum_711(ep->flags)&2)
    ...
    ino = ((bp->b_blkno) << 9) + entryoffsetinblock;
   dp->i_ino = ino;
   altname = malloc(255, 127, 0x0001);
   cd9660_rrip_getname(ep,altname,&namelen,&dp->i_ino,imp);
   if (namelen == cnp->cn_namelen
       && !__builtin_bcmp((name), (altname), (namelen))) {
    free(altname, 127, 0);
    goto found;
   }
   free(altname, 127, 0);
...
foundino:
  ...
  if (saveoffset != dp->i_offset) {
   if (((dp->i_offset) >> (imp)->im_bshift) !=
       ((saveoffset) >> (imp)->im_bshift)) {
    if (bp != ((void *)0))
     brelse(bp);
    if ((error = cd9660_bufatoff(dp,
         (off_t)saveoffset, ((void *)0), &bp)) != 0)
     return (error);
   }
...
# 373 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../isofs/cd9660/cd9660_lookup.c"
 pdp = vdp;
    ...
    struct buf **bpp)
{
 ...
 imp = ip->i_mnt;
 lbn = ((offset) >> (imp)->im_bshift);
 bsize = ((imp)->logical_block_size);
 ...
 if (res)
  *res = (char *)bp->b_data + ((offset) & (imp)->im_bmask);
 *bpp = bp;
 return (0);
}
