# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c"
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c"
...
struct tty;
struct uio;
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_arith.h" 1
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c" 2
# 186 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c"
struct fpn *
fpu_sqrt(fe)
 struct fpemu *fe;
{
 ...
 register int e;
# 208 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c"
 if (((x)->fp_class < 0) || ((x)->fp_class == 0))
  return (x);
 if (x->fp_sign)
  return (fpu_newnan(fe));
 if (((x)->fp_class == 2))
  return (x);
# 239 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c"
 x0 = x->fp_mant[0];
 x1 = x->fp_mant[1];
 x2 = x->fp_mant[2];
 x3 = x->fp_mant[3];
 e = x->fp_exp;
 if (e & 1)
  { asm volatile("addcc %1,%2,%0" : "=r"(x3) : "r"(x3), "r"(x3)); asm volatile("addxcc %1,%2,%0" : "=r"(x2) : "r"(x2), "r"(x2)); asm volatile("addxcc %1,%2,%0" : "=r"(x1) : "r"(x1), "r"(x1)); asm volatile("addx %1,%2,%0" : "=r"(x0) : "r"(x0), "r"(x0)); };

 x->fp_exp = e >> 1;
# 269 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_sqrt.c"
 bit = (1 << ((115 - 1) & 31));
 ;
 ...
 ;
 tt = bit;
 asm volatile("subcc %1,%2,%0" : "=r"(d1) : "r"(x1), "r"(tt));
 asm volatile("subx %1,%2,%0" : "=r"(d0) : "r"(x0), "r"(y0));
 if ((int)d0 >= 0) {
  x0 = d0, x1 = d1;
  q = bit;
  y0 |= 1;
 ...
 ;
 tt = bit;
 asm volatile("subcc %1,%2,%0" : "=r"(d2) : "r"(x2), "r"(tt));
 asm volatile("subxcc %1,%2,%0" : "=r"(d1) : "r"(x1), "r"(y1));
 asm volatile("subx %1,%2,%0" : "=r"(d0) : "r"(x0), "r"(y0));
 if ((int)d0 >= 0) {
  x0 = d0, x1 = d1, x2 = d2;
  q |= bit;
 ...
 ;
 tt = bit;
 asm volatile("subcc %1,%2,%0" : "=r"(d3) : "r"(x3), "r"(tt));
 asm volatile("subxcc %1,%2,%0" : "=r"(d2) : "r"(x2), "r"(y2));
 asm volatile("subxcc %1,%2,%0" : "=r"(d1) : "r"(x1), "r"(y1));
 asm volatile("subx %1,%2,%0" : "=r"(d0) : "r"(x0), "r"(y0));
 if ((int)d0 >= 0) {
