# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c" 2
# 99 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/alipm.c"
struct alipm_softc {
 struct device sc_dev;
...
alipm_match(struct device *parent, void *match, void *aux)
{
 ...
 if ((((pa->pa_id) >> 0) & 0xffff) == 0x10b9 &&
     ((((pa->pa_id) >> 16) & 0xffff) == 0x7101))
  return (1);
 return (0);
}
...
alipm_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 pcireg_t iobase, reg64;
 bus_size_t iosize = 32;


 reg64 = pci_conf_read(pa->pa_pc, pa->pa_tag, 0x04);
 if ((reg64 & 0x00100000) == 0) {

  iobase = pci_conf_read(pa->pa_pc, pa->pa_tag, 0xe0);
  sc->sc_iot = pa->pa_iot;
  if (iobase == 0 ||
  ...
  reg64 = pci_conf_read(pa->pa_pc, pa->pa_tag, 0xd0);
  if ((reg64 & 0x0400) == 0) {
   printf(": SMBus disabled\n");
   goto fail;
  }

  reg64 = pci_conf_read(pa->pa_pc, pa->pa_tag, 0xf0);
  ...
  if (pci_mapreg_map(pa, 0x14, 0x00000001, 0,
      &sc->sc_iot, &sc->sc_ioh, ((void *)0), &iosize, 32)) {
   printf(": can't map i/o space\n");
   return;
  }

  reg64 = pci_conf_read(pa->pa_pc, pa->pa_tag, 0xe0);
  if ((reg64 & 0x00000001) == 0) {
   printf(": SMBus host disabled\n");
   goto fail;
  }
 ...
 _rw_init_flags(&sc->sc_smb_lock, "alipm", 0, ((void *)0));
...
alipm_smb_acquire_bus(void *cookie, int flags)
{
 ...
 return (_rw_enter(&sc->sc_smb_lock, 0x0001UL | 0x0010UL ));
}
    ...
    const void *cmdbuf, size_t cmdlen, void *buf, size_t len, int flags)
{
 ...
 if (!(((int)(op) & 1) != 0) || cmdlen > 1 || len > 2)
  return (45);


 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x00,
     0x10 | 0x80 |
     0x40 | 0x20);
 bus_space_barrier(sc->sc_iot, sc->sc_ioh, 0x00, 1,
     0x01 | 0x02);


 for (retries = 1000; retries > 0; retries--) {
  st = bus_space_read_1(sc->sc_iot, sc->sc_ioh, 0x00);
  bus_space_barrier(sc->sc_iot, sc->sc_ioh, 0x00, 1,
      0x01);
  if (st & (0x04 | 0x80 |
      0x40 | 0x20))
 ...
 if (retries == 0) {
  printf("%s: timeout st 0x%b\n", sc->sc_dev.dv_xname,
      st, "\020\003IDLE\004BUSY\005DONE\006DEVERR\007BUSERR\010FAILED");
  return (60);
 }
 if (st & (0x80 |
     0x40 | 0x20)) {
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x03,
     (((addr) & 0x7f) << 1) |
     ((((int)(op) & 2) == 0) ? (1 << 0) : 0));
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x01, ctl);


 bus_space_barrier(sc->sc_iot, sc->sc_ioh, 0, 32,
     0x02);
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x02, 0xff);
 bus_space_barrier(sc->sc_iot, sc->sc_ioh, 0, 32,
     0x01 | 0x02);
 ...
 if (retries == 0) {
  printf("%s: timeout st 0x%b, resetting\n",
      sc->sc_dev.dv_xname, st, "\020\003IDLE\004BUSY\005DONE\006DEVERR\007BUSERR\010FAILED");
  bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x01,
      0x08);
  bus_space_barrier(sc->sc_iot, sc->sc_ioh, 0, 32,
       0x01 | 0x02);
  st = bus_space_read_1(sc->sc_iot, sc->sc_ioh, 0x00);
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x00, st);
