# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c"
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c"
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c" 2
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_hds.c"
struct hds_vpd {
 struct scsi_vpd_hdr hdr;
 u_int8_t state;
...
hds_match(struct device *parent, void *match, void *aux)
{
 ...
 for (i = 0; i < (sizeof((hds_devices)) / sizeof((hds_devices)[0])); i++) {
  s = &hds_devices[i];
...
hds_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_vpd = dma_alloc(sizeof(*sc->sc_vpd), 0x0001);
...
hds_status(struct scsi_xfer *xs)
{
 ...
 scsi_init_inquiry(xs, 0x01, 0xe0,
...
hds_inquiry(struct scsi_link *link, int *mode)
{
 ...
 if (buf[128] == '\0')
  *mode = 1;
 else if (_4btol(&buf[128]) == 0x44463030)
  *mode = 0;
 else
  error = 6;
...
hds_info(struct hds_softc *sc)
{
 ...
 __builtin_bzero((ldev), (sizeof(ldev)));
 scsi_strvis(ldev, &buf[44], 4);
 ctrl = buf[49];
 port = buf[50];

 if (ctrl >= '0' && ctrl <= '9' && port >= 'A' && port <= 'B') {
  printf("%s: ldev %s, controller %c, port %c, %s\n",
      ((sc)->sc_dev.dv_xname), ldev, ctrl, port,
      sc->sc_mode == 0 ? "symmetric" : "asymmetric");
