# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c"
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c"
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600d.h" 1
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_shaders.h" 1
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_shaders.h"
...
__attribute__((__const__)) uint32_t int2float(uint32_t x);
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c" 2
    ...
    int w, int h, u64 gpu_addr)
{
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28040 - 0x00028000) >> 2);
 radeon_ring_write(ring, gpu_addr >> 8);

 if (rdev->family > CHIP_R600 && rdev->family < CHIP_RV770) {
  radeon_ring_write(ring, ((3 << 30) | (((0x73) & 0xFF) << 8) | ((0) & 0x3FFF) << 16));
  radeon_ring_write(ring, 2 << 0);
 }

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28060 - 0x00028000) >> 2);
 radeon_ring_write(ring, (pitch << 0) | (slice << 10));

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28080 - 0x00028000) >> 2);
 radeon_ring_write(ring, 0);

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x280a0 - 0x00028000) >> 2);
 radeon_ring_write(ring, cb_color_info);

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x280c0 - 0x00028000) >> 2);
 radeon_ring_write(ring, 0);

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x280e0 - 0x00028000) >> 2);
 radeon_ring_write(ring, 0);

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28100 - 0x00028000) >> 2);
 radeon_ring_write(ring, 0);
}
...
set_shaders(struct radeon_device *rdev)
{
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28858 - 0x00028000) >> 2);
 radeon_ring_write(ring, gpu_addr >> 8);

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28868 - 0x00028000) >> 2);
 radeon_ring_write(ring, sq_pgm_resources);

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x288d0 - 0x00028000) >> 2);
 radeon_ring_write(ring, 0);
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28850 - 0x00028000) >> 2);
 radeon_ring_write(ring, sq_pgm_resources | (1 << 28));

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28854 - 0x00028000) >> 2);
 radeon_ring_write(ring, 2);

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x288cc - 0x00028000) >> 2);
 radeon_ring_write(ring, 0);
...
set_vtx_resource(struct radeon_device *rdev, u64 gpu_addr)
{
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x6D) & 0xFF) << 8) | ((7) & 0x3FFF) << 16));
   ...
   u64 gpu_addr, u32 size)
{
 ...
 sq_tex_resource_word0 = (((0x00000001) & 0x7) << 0) |
  (((0x00000002) & 0xF) << 3);
 sq_tex_resource_word0 |= ((((pitch >> 3) - 1) & 0x7FF) << 8) |
  (((w - 1) & 0x1FFF) << 19);

 sq_tex_resource_word1 = (((format) & 0x3F) << 26);
 sq_tex_resource_word1 |= (((h - 1) & 0x1FFF) << 0);

 sq_tex_resource_word4 = (((1) & 0x3) << 14) |
  (((0) & 0x7) << 16) |
  (((1) & 0x7) << 19) |
  (((2) & 0x7) << 22) |
  (((3) & 0x7) << 25);
...
set_default_state(struct radeon_device *rdev)
{
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x68) & 0xFF) << 8) | ((6) & 0x3FFF) << 16));
...
int r600_blit_init(struct radeon_device *rdev)
{
 ...
 if (rdev->family >= CHIP_RV770)
  __builtin_memcpy((ptr + rdev->r600_blit.state_offset), (r7xx_default_state), (rdev->r600_blit.state_len * 4));

 else
  __builtin_memcpy((ptr + rdev->r600_blit.state_offset), (r6xx_default_state), (rdev->r600_blit.state_len * 4));

 if (num_packet2s)
  __builtin_memcpy((ptr + rdev->r600_blit.state_offset + (rdev->r600_blit.state_len * 4)), (packet2s), (num_packet2s * 4));

 for (i = 0; i < r6xx_vs_size; i++)
  *(u32 *)((unsigned long)ptr + rdev->r600_blit.vs_offset + i * 4) = __extension__({ __uint32_t __swap32gen_x = (r6xx_vs[i]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
 for (i = 0; i < r6xx_ps_size; i++)
  *(u32 *)((unsigned long)ptr + rdev->r600_blit.ps_offset + i * 4) = __extension__({ __uint32_t __swap32gen_x = (r6xx_ps[i]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
          ...
          int *width, int *height, int max_dim)
{
 ...
 if (num_gpu_pages == 0) {
  ...
  w = 0;
  pages = 0;
  ({ int __ret = !!(1); if (__ret) printf("WARNING %s failed at %s:%d\n", "1", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c", 595); __builtin_expect(!!(__ret), 0); });
 } else {
  int rect_order = 2;
  h = 32;
  ...
  max_pages = (max_dim * h) / ((4096 / 4 / 32) * 32);
  if (pages > max_pages)
   pages = max_pages;
  w = (pages * (4096 / 4 / 32) * 32) / h;
  w = (w / (4096 / 4 / 32)) * (4096 / 4 / 32);
  pages = (w * h) / ((4096 / 4 / 32) * 32);
  ((!(pages == 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c", 613, "!(pages == 0)"));
 }
      ...
      struct radeon_semaphore **sem)
{
 ...
 while (num_gpu_pages) {
  num_gpu_pages -=
   r600_blit_create_rect(num_gpu_pages, ((void *)0), ((void *)0),
 ...
 if (r) {
  radeon_sa_bo_free(rdev, vb, ((void *)0));
  return r;
 }
 ...
 if (radeon_fence_need_sync(*fence, 0)) {
  radeon_semaphore_sync_rings(rdev, *sem, (*fence)->ring,
         0);
  radeon_fence_note_sync(*fence, 0);
 } else {
  radeon_semaphore_free(rdev, sem, ((void *)0));
 }
   ...
   struct radeon_sa_bo *vb)
{
 ...
 while (num_gpu_pages) {
  ...
  size_in_bytes = pages_per_loop * 4096;
  do { } while( 0);
  ...
  rdev->r600_blit.primitives.set_tex_resource(rdev, 0x1a,
           w, h, w, src_gpu_addr, size_in_bytes);
  rdev->r600_blit.primitives.set_render_target(rdev, 0x1a,
            w, h, dst_gpu_addr);
...
# 767 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r600_blit_kms.c"
__attribute__((__const__)) uint32_t int2float(uint32_t x)
{
 ...
 fraction = ror32(x, (msb - 23) & 0x1f) & ((1 << 23) - 1);
 exponent = (127 + msb) << 23;
