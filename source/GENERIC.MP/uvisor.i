# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c" 2
# 89 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c"
...
# 111 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uvisor.c"
...
static const struct uvisor_type uvisor_devs[] = {
 {{ 0x4766, 0x0001 }, 0x0001 },
 {{ 0x0e67, 0x0002 }, 0x0001 },
 {{ 0x091e, 0x0004 }, 0x0001 },
 {{ 0x082d, 0x0100 }, 0x0002 },
 {{ 0x082d, 0x0200 }, 0x0001 },
 {{ 0x082d, 0x0300 }, 0x0002 },
 {{ 0x0830, 0x0001 }, 0x0001 },
 {{ 0x0830, 0x0002 }, 0x0001 },
 {{ 0x0830, 0x0003 }, 0x0001 },
 {{ 0x0830, 0x0020 }, 0x0001 },
 {{ 0x0830, 0x0040 }, 0x0001 },
 {{ 0x0830, 0x0050 }, 0x0001 },
 {{ 0x0830, 0x0031 }, 0x0001 },
 {{ 0x0830, 0x0060 }, 0x0001 },
 {{ 0x0830, 0x0070 }, 0x0001 },
 {{ 0x0830, 0x0061 }, 0x0001 },
 {{ 0x054c, 0x0066 }, 0x0001 },
 {{ 0x054c, 0x009a }, 0x0001 },
 {{ 0x054c, 0x0095 }, 0x0001 },
 {{ 0x054c, 0x00da }, 0x0001 },
 {{ 0x054c, 0x0169 }, 0x0001 },

 {{ 0x12ef, 0x0100 }, 0x0001 },
};
...
uvisor_match(struct device *parent, void *match, void *aux)
{
 ...
 return (((struct uvisor_type *)usbd_match_device((const struct usb_devno *)(uvisor_devs), sizeof (uvisor_devs) / sizeof ((uvisor_devs)[0]), sizeof ((uvisor_devs)[0]), (uaa->vendor), (uaa->product))) != ((void *)0) ?
  13 : 0);
}
...
uvisor_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_flags = ((struct uvisor_type *)usbd_match_device((const struct usb_devno *)(uvisor_devs), sizeof (uvisor_devs) / sizeof ((uvisor_devs)[0]), sizeof ((uvisor_devs)[0]), (uaa->vendor), (uaa->product)))->uv_flags;
 sc->sc_vendor = uaa->vendor;

 if ((sc->sc_flags & (0x0002 | 0x0001)) == 0) {
 ...
 if (sc->sc_flags & 0x0002) {
  sc->sc_numcon = ((coninfo.num_ports)[0] | ((coninfo.num_ports)[1] << 8));
  if (sc->sc_numcon > 8)
   sc->sc_numcon = 8;
  ...
  for (i = 0; i < sc->sc_numcon; ++i) {
   ...
   uca.portno = port;
   uca.bulkin = port | 0x80;
   uca.bulkout = port | 0x00;
   ...
   for (j = 0; j < id->bNumEndpoints; j++) {
    ...
    if (ed == ((void *)0))
     break;
    if (((ed->bEndpointAddress) & 0x0f) == port &&
  ...
  for (i = 0; i < sc->sc_numcon; ++i) {
   ...
   if (palmconinfo.endpoint_numbers_different) {
    ...
    uca.bulkin = (port >> 4) | 0x80;
    uca.bulkout = (port & 0xf) | 0x00;
   } else {
    ...
    struct uvisor_palm_connection_info *cpi)
{
 ...
 if (sc->sc_flags & 0x0002) {
  ...
  ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
  ((req.wIndex)[0] = (u_int8_t)(0), (req.wIndex)[1] = (u_int8_t)((0) >> 8));
  ((req.wLength)[0] = (u_int8_t)(18), (req.wLength)[1] = (u_int8_t)((18) >> 8));
 ...
 req.bRequest = 0x01;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(5), (req.wIndex)[1] = (u_int8_t)((5) >> 8));
 ((req.wLength)[0] = (u_int8_t)(sizeof avail), (req.wLength)[1] = (u_int8_t)((sizeof avail) >> 8));
