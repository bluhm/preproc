# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c"
...
struct tty;
struct uio;
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c" 2
...
# 137 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c"
...
mbg_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if ((((pa->pa_id) >> 16) & 0xffff) == 0x0105)
  bar += 0x08;

 memtype = pci_mapreg_type(pa->pa_pc, pa->pa_tag, bar);
 if (pci_mapreg_map(pa, bar, memtype, 0, &sc->sc_iot,
     &sc->sc_ioh, ((void *)0), &iosize, 0)) {
  printf(": PCI %s region not found\n",
      memtype == 0x00000001 ? "I/O" : "memory");
  return;
 }

 if ((desc = pci_findproduct(pa->pa_id)) == ((void *)0))
  desc = "Radio clock";
 ...
 case 0x0102:
  ...
  memtype = pci_mapreg_type(pa->pa_pc, pa->pa_tag,
      0x10 + 0x04);
  if (pci_mapreg_map(pa, 0x10 + 0x04, memtype, 0,
      &sc->sc_iot_s5920, &sc->sc_ioh_s5920, ((void *)0), &iosize2, 0)) {
 ...
 default:
  ...
  panic(": unsupported product 0x%04x", (((pa->pa_id) >> 16) & 0xffff));
  break;
 }

 sc->sc_trust = t_trust;

 if (sc->sc_read(sc, 0x00, (char *)&tframe,
     sizeof(struct mbg_time), ((void *)0))) {
  printf(": unknown status");
  sc->sc_signal.status = SENSOR_S_CRIT;
 } else {
  sc->sc_signal.status = SENSOR_S_OK;
  signal = tframe.signal - 55;
  if (signal < 0)
   signal = 0;
  else if (signal > 68)
   signal = 68;
  ...
  if (tframe.status & 0x04)
   printf(": synchronized");
  else
   printf(": not synchronized");
  if (tframe.status & 0x01) {
   sc->sc_signal.status = SENSOR_S_WARN;
   printf(", free running");
  }
  if (tframe.status & 0x40)
   printf(", time set from host");
 }
# 296 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/mbg.c"
 printf("\n");
...
mbg_task(void *arg)
{
 ...
 if (sc->sc_read(sc, 0x00, (char *)&tframe, sizeof(tframe),
     &tstamp)) {
  sc->sc_signal.status = SENSOR_S_CRIT;
  return;
 }
 if (tframe.status & 0x80) {
  sc->sc_signal.status = SENSOR_S_CRIT;
  return;
 }
...
mbg_task_hr(void *arg)
{
 ...
 if (sc->sc_read(sc, 0x03, (char *)&tframe, sizeof(tframe),
     &tstamp)) {
  sc->sc_signal.status = SENSOR_S_CRIT;
  return;
 }
 ...
 mbg_update_sensor(sc, &tstamp, tlocal - trecv, tframe.signal,
     __extension__({ __uint16_t __swap16gen_x = (tframe.status); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }));
}
    ...
    int64_t timedelta, u_int8_t rsignal, u_int16_t status)
{
 ...
 sc->sc_signal.status = status & 0x01 ?
    ...
    struct timespec *tstamp)
{
 ...
 if (tstamp)
  nanotime(tstamp);
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x0c, cmd);
 ...
 if (len) {
  ...
  bus_space_read_4(sc->sc_iot_s5920, sc->sc_ioh_s5920, 0x00);
 return 0;
}
    ...
    struct timespec *tstamp)
{
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x3c + 3, 0x0c);


 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x38 + 3, 0x3c);


 if (tstamp)
  nanotime(tstamp);
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x00, cmd);
 ...
 for (n = 0; n < len; n++) {
  if (bus_space_read_2(sc->sc_iot, sc->sc_ioh, 0x3c)
      & 0x20) {
   return -1;
  }
    ...
    struct timespec *tstamp)
{
 ...
 if (tstamp) {
  s = _splraise(15);
  nanotime(tstamp);
  bus_space_write_4(sc->sc_iot, sc->sc_ioh, 0x18, cmd);
  _splx(s);
 } else
  bus_space_write_4(sc->sc_iot, sc->sc_ioh, 0x18, cmd);
 ...
 do {
  if (cold)
   ...
   tsleep(tstamp, 0, "mbg", 1);
  status = bus_space_read_1(sc->sc_iot, sc->sc_ioh, 0x10);
 } while ((status & 0x01) && timer++ < tmax);
