# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c"
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.h" 1
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/urlphyreg.h" 1
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_urlreg.h" 1
# 121 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_urlreg.h"
typedef uWord url_rxhdr_t;
# 131 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_urlreg.h"
struct url_chain {
...
struct url_cdata {
 struct url_chain url_tx_chain[1];
 struct url_chain url_rx_chain[1];
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c" 2
...
# 143 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c"
...
url_match(struct device *parent, void *match, void *aux)
{
 ...
 return (((struct url_type *)usbd_match_device((const struct usb_devno *)(url_devs), sizeof (url_devs) / sizeof ((url_devs)[0]), sizeof ((url_devs)[0]), (uaa->vendor), (uaa->product))) != ((void *)0) ?
  13 : 0);
}
...
url_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 ((&sc->sc_tick_task)->fun = (url_tick_task), (&sc->sc_tick_task)->arg = (sc), (&sc->sc_tick_task)->type = (0), (&sc->sc_tick_task)->state = 0x0);

 _rw_init_flags(&sc->sc_mii_lock, "urlmii", 0, ((void *)0));
 ((&sc->sc_stop_task)->fun = ((void (*)(void *)) url_stop_task), (&sc->sc_stop_task)->arg = (sc), (&sc->sc_stop_task)->type = (0), (&sc->sc_stop_task)->state = 0x0);
 ...
 sc->sc_flags = ((struct url_type *)usbd_match_device((const struct usb_devno *)(url_devs), sizeof (url_devs) / sizeof ((url_devs)[0]), sizeof ((url_devs)[0]), (uaa->vendor), (uaa->product)))->url_flags;
 ...
 err = url_mem(sc, 1, 0x0120, (void *)eaddr,
        6);
 if (err) {
...
url_mem(struct url_softc *sc, int cmd, int offset, void *buf, int len)
{
 ...
 req.bRequest = 0x05;
 ((req.wValue)[0] = (u_int8_t)(offset), (req.wValue)[1] = (u_int8_t)((offset) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0x0000), (req.wIndex)[1] = (u_int8_t)((0x0000) >> 8));
...
int
url_csr_read_1(struct url_softc *sc, int reg64)
{
 u_int8_t val = 0;
 ...
 return (url_mem(sc, 1, reg64, &val, 1) ? 0 : val);
}


int
url_csr_read_2(struct url_softc *sc, int reg64)
{
 uWord val;
 ...
 ((val)[0] = (u_int8_t)(0), (val)[1] = (u_int8_t)((0) >> 8));
 return (url_mem(sc, 1, reg64, &val, 2) ? 0 : ((val)[0] | ((val)[1] << 8)));
}


int
url_csr_write_1(struct url_softc *sc, int reg64, int aval)
{
 u_int8_t val = aval;
 ...
 return (url_mem(sc, 2, reg64, &val, 1) ? -1 : 0);
}


int
url_csr_write_2(struct url_softc *sc, int reg64, int aval)
{
 uWord val;
 ...
 return (url_mem(sc, 2, reg64, &val, 2) ? -1 : 0);
}


int
url_csr_write_4(struct url_softc *sc, int reg64, int aval)
{
 uDWord val;
 ...
 ((val)[0] = (u_int8_t)(aval), (val)[1] = (u_int8_t)((aval) >> 8), (val)[2] = (u_int8_t)((aval) >> 16), (val)[3] = (u_int8_t)((aval) >> 24));

 return (url_mem(sc, 2, reg64, &val, 4) ? -1 : 0);
}
...
url_init(struct ifnet *ifp)
{
 ...
 for (i = 0; i < 6; i++)
  url_csr_write_1(sc, 0x0120 + i, eaddr[i]);


 url_csr_write_1(sc, 0x012f, url_csr_read_1(sc, 0x012f) & ~((1<<7) | (1<<6) | (1<<4) | (1<<3) | (1<<0)));





 url_csr_write_2(sc, 0x0130, url_csr_read_2(sc, 0x0130) | ((1<<7)));


 if (url_tx_list_init(sc) == 55) {
 ...
 url_csr_write_1(sc, 0x012e, url_csr_read_1(sc, 0x012e) | ((1<<2) | (1<<3)));
...
url_reset(struct url_softc *sc)
{
 ...
 url_csr_write_1(sc, 0x012e, url_csr_read_1(sc, 0x012e) | ((1<<4)));

 for (i = 0; i < 1000; i++) {
  if (!(url_csr_read_1(sc, 0x012e) & (1<<4)))
   break;
  delay(10);
 }
...
url_iff(struct url_softc *sc)
{
 ...
 url_csr_write_4(sc, 0x0126, hashes[0]);
 url_csr_write_4(sc, 0x012a, hashes[1]);
 url_csr_write_2(sc, 0x0130, rcr);
}
...
# 652 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c"
 for (i = 0; i < 1; i++) {
...
url_rx_list_init(struct url_softc *sc)
{
 ...
 for (i = 0; i < 1; i++) {
  ...
  c->url_sc = sc;
  c->url_idx = i;
  if (url_newbuf(sc, c, ((void *)0)) == 55)
   return (55);
  if (c->url_xfer == ((void *)0)) {
   c->url_xfer = usbd_alloc_xfer(sc->sc_udev);
   if (c->url_xfer == ((void *)0))
    return (55);
   c->url_buf = usbd_alloc_buffer(c->url_xfer, 1536);
   if (c->url_buf == ((void *)0)) {
...
url_send(struct url_softc *sc, struct mbuf *m, int idx)
{
 ...
 m_copydata(m, 0, m->M_dat.MH.MH_pkthdr.len, c->url_buf);
 c->url_mbuf = m;
 total_len = m->M_dat.MH.MH_pkthdr.len;

 if (total_len < 60) {
  __builtin_bzero((c->url_buf + total_len), (60 - total_len));
  total_len = 60;
 }
...
url_rxeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 __builtin_memcpy((((char *)((c->url_mbuf)->m_hdr.mh_data))), (c->url_buf), (total_len));
 ...
 __builtin_memcpy((&rxhdr), (c->url_buf + total_len - 4), (sizeof(rxhdr)));
 ...
 usbd_setup_xfer(xfer, sc->sc_pipe_rx, c, c->url_buf, 1536,
   0x04 | 0x01,
   0, url_rxeof);
 sc->sc_refcnt++;
 usbd_transfer(xfer);
...
url_watchdog(struct ifnet *ifp)
{
 ...
 usbd_get_xfer_status(c->url_xfer, ((void *)0), ((void *)0), ((void *)0), &stat);
...
# 1122 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c"
 for (i = 0; i < 1; i++) {
  if (sc->sc_cdata.url_rx_chain[i].url_mbuf != ((void *)0)) {
   m_freem(sc->sc_cdata.url_rx_chain[i].url_mbuf);
   sc->sc_cdata.url_rx_chain[i].url_mbuf = ((void *)0);
  }
  if (sc->sc_cdata.url_rx_chain[i].url_xfer != ((void *)0)) {
   usbd_free_xfer(sc->sc_cdata.url_rx_chain[i].url_xfer);
   sc->sc_cdata.url_rx_chain[i].url_xfer = ((void *)0);
  }
 }


 for (i = 0; i < 1; i++) {
  if (sc->sc_cdata.url_tx_chain[i].url_mbuf != ((void *)0)) {
   m_freem(sc->sc_cdata.url_tx_chain[i].url_mbuf);
   sc->sc_cdata.url_tx_chain[i].url_mbuf = ((void *)0);
  }
  if (sc->sc_cdata.url_tx_chain[i].url_xfer != ((void *)0)) {
   usbd_free_xfer(sc->sc_cdata.url_tx_chain[i].url_xfer);
   sc->sc_cdata.url_tx_chain[i].url_xfer = ((void *)0);
  }
 }
...
url_tick_task(void *xsc)
{
 ...
 mii_tick(mii);
 if (!sc->sc_link && mii->mii_media_status & 0x0000000000000002ULL &&
...
int
url_int_miibus_readreg(struct device *dev, int phy, int reg64)
{
 struct url_softc *sc;
 u_int16_t val;
 ...
 default:
  printf("%s: %s: bad register %04x\n",
         sc->sc_dev.dv_xname, __func__, reg64);
  val = 0;
  goto R_DONE;
  break;
 }
 ...
 if (reg64 == 0x137)
  val = url_csr_read_1(sc, reg64);
 else
  val = url_csr_read_2(sc, reg64);
...
void
url_int_miibus_writereg(struct device *dev, int phy, int reg64, int data)
{
 struct url_softc *sc;
 ...
 if (reg64 == 0x137)
  url_csr_write_1(sc, reg64, data);
 else
  url_csr_write_2(sc, reg64, data);
 W_DONE:
...
{
# 1427 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_url.c"
}
