# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/i8042reg.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/pckbd.h" 1
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2
...
void pckbd_hookup_bell(void (*fn)(void *, u_int, u_int, u_int, int),
     void *);
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c" 2
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c"
struct pckbc_devcmd {
 struct { struct pckbc_devcmd *tqe_next; struct pckbc_devcmd **tqe_prev; } next;
 int flags;
...
struct pckbc_slotdata {
 int polling;
 struct { struct pckbc_devcmd *tqh_first; struct pckbc_devcmd **tqh_last; } cmdqueue;
 struct { struct pckbc_devcmd *tqh_first; struct pckbc_devcmd **tqh_last; } freequeue;

 struct pckbc_devcmd cmds[5];
};
...
# 117 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c"
static inline int
pckbc_wait_output(bus_space_tag_t iot, bus_space_handle_t ioh_c)
{
 ...
 for (i = 100000; i; i--)
  if (!(bus_space_read_1(iot, ioh_c, 0) & 0x02)) {
   delay(8);
   return (1);
  }
 return (0);
...
pckbc_get8042cmd(struct pckbc_internal *t)
{
 ...
 if (!pckbc_send_cmd(iot, ioh_c, 0x20))
  return (0);
 data = pckbc_poll_data1(iot, ioh_d, ioh_c, 0,
    t->t_haveaux);
 if (data == -1)
  return (0);
 t->t_cmdbyte = data;
...
pckbc_put8042cmd(struct pckbc_internal *t)
{
 ...
 if (!pckbc_send_cmd(iot, ioh_c, 0x60))
  return (0);
 if (!pckbc_wait_output(iot, ioh_c))
  return (0);
...
pckbc_send_devcmd(struct pckbc_internal *t, pckbc_slot_t slot, u_char val)
{
 ...
 if (slot == 1) {
  if (!pckbc_send_cmd(iot, ioh_c, 0xd4))
   return (0);
 }
 if (!pckbc_wait_output(iot, ioh_c))
  return (0);
...
pckbc_attach_slot(struct pckbc_softc *sc, pckbc_slot_t slot, int force)
{
 ...
 found = (config_found_sm((struct device *)sc, &pa, pckbcprint,
     force ? pckbc_submatch_locators : pckbc_submatch) != ((void *)0));

 if ((found || slot == 1) && !t->t_slotdata[slot]) {
  t->t_slotdata[slot] = malloc(sizeof(struct pckbc_slotdata),
          2, 0x0002);
  if (t->t_slotdata[slot] == ((void *)0))
   return 0;
  ...
  if (!found && slot == 1) {
   ...
   pckbc_set_inputhandler(t, 1, ((void *)0), sc,
       ((void *)0));
   found = 1;
  }
 }
...
pckbc_attach(struct pckbc_softc *sc, int flags)
{
 ...
 (void) pckbc_poll_data1(iot, ioh_d, ioh_c, 0, 0);
...
# 358 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c"
 if (pckbc_attach_slot(sc, 0, 0)) {
  cmdbits |= 0x01;
  haskbd = 1;
 }
 ...
 if (!pckbc_send_cmd(iot, ioh_c, 0xd3)) {
 ...
 res = pckbc_poll_data1(iot, ioh_d, ioh_c, 1, 1);
 ...
 if (res != -1) {
  ...
  ;
  t->t_haveaux = 1;
  if (pckbc_attach_slot(sc, 1, 0))
   cmdbits |= 0x02;
 }
# 428 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c"
nomouse:
...
{
# 467 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/pckbc.c"
}
...
{
 int i;
 do { (&q->cmdqueue)->tqh_first = ((void *)0); (&q->cmdqueue)->tqh_last = &(&q->cmdqueue)->tqh_first; } while (0);
 do { (&q->freequeue)->tqh_first = ((void *)0); (&q->freequeue)->tqh_last = &(&q->freequeue)->tqh_first; } while (0);

 for (i = 0; i < 5; i++) {
  do { (&(q->cmds[i]))->next.tqe_next = ((void *)0); (&(q->cmds[i]))->next.tqe_prev = (&q->freequeue)->tqh_last; *(&q->freequeue)->tqh_last = (&(q->cmds[i])); (&q->freequeue)->tqh_last = &(&(q->cmds[i]))->next.tqe_next; } while (0);
 }
 q->polling = 0;
}
...
pckbc_poll_data(pckbc_tag_t self, pckbc_slot_t slot)
{
 ...
 c = pckbc_poll_data1(t->t_iot, t->t_ioh_d, t->t_ioh_c,
        slot, t->t_haveaux);
 if (c != -1 && q && (!(((&(q)->cmdqueue)->tqh_first) == ((void *)0)))) {
    ...
    int responselen, u_char *respbuf, int slow)
{
 ...
 __builtin_bzero((&nc), (sizeof(nc)));
 __builtin_memcpy((nc.cmd), (cmd), (len));
 nc.cmdlen = len;
 ...
 if (nc.status == 0 && respbuf)
  __builtin_memcpy((respbuf), (nc.response), (responselen));
...
pckbc_cleanqueue(struct pckbc_slotdata *q)
{
 ...
 while ((cmd = ((&q->cmdqueue)->tqh_first))) {
  do { if (((cmd)->next.tqe_next) != ((void *)0)) (cmd)->next.tqe_next->next.tqe_prev = (cmd)->next.tqe_prev; else (&q->cmdqueue)->tqh_last = (cmd)->next.tqe_prev; *(cmd)->next.tqe_prev = (cmd)->next.tqe_next; ((cmd)->next.tqe_prev) = ((void *)-1); ((cmd)->next.tqe_next) = ((void *)-1); } while (0);
  ...
  do { (cmd)->next.tqe_next = ((void *)0); (cmd)->next.tqe_prev = (&q->freequeue)->tqh_last; *(&q->freequeue)->tqh_last = (cmd); (&q->freequeue)->tqh_last = &(cmd)->next.tqe_next; } while (0);
 }
}
...
{
 if (t->t_slotdata[0])
  pckbc_cleanqueue(t->t_slotdata[0]);
 if (t->t_slotdata[1])
  pckbc_cleanqueue(t->t_slotdata[1]);
}
...
pckbc_cleanup(void *self)
{
 ...
 while (bus_space_read_1(t->t_iot, t->t_ioh_c, 0) & 0x01) {
  delay(8);
...
pckbc_reset(struct pckbc_softc *sc)
{
 ...
 pckbc_poll_data1(iot, ioh_d, ioh_c, 0, 0);

 if (pckbc_send_cmd(iot, ioh_c, 0xaa) == 0)
  return;
 pckbc_poll_data1(iot, ioh_d, ioh_c, 0, 0);
...
{
 struct pckbc_slotdata *q = t->t_slotdata[slot];
 struct pckbc_devcmd *cmd = ((&q->cmdqueue)->tqh_first);
 ...
 if (q->polling) {
  do {
   ...
   if (cmd->flags & 1) {
    wakeup(cmd);
    cmd = ((cmd)->next.tqe_next);
   } else {
    do { if (((cmd)->next.tqe_next) != ((void *)0)) (cmd)->next.tqe_next->next.tqe_prev = (cmd)->next.tqe_prev; else (&q->cmdqueue)->tqh_last = (cmd)->next.tqe_prev; *(cmd)->next.tqe_prev = (cmd)->next.tqe_next; ((cmd)->next.tqe_prev) = ((void *)-1); ((cmd)->next.tqe_next) = ((void *)-1); } while (0);
    timeout_del(&t->t_cleanup);
    do { (cmd)->next.tqe_next = ((void *)0); (cmd)->next.tqe_prev = (&q->freequeue)->tqh_last; *(&q->freequeue)->tqh_last = (cmd); (&q->freequeue)->tqh_last = &(cmd)->next.tqe_next; } while (0);
    cmd = ((&q->cmdqueue)->tqh_first);
   }
  } while (cmd);
  return;
 }
    ...
    int responselen, int sync, u_char *respbuf)
{
 ...
 if ((len > 4) || (responselen > 4))
  return (22);
 s = _splraise(6);
 nc = ((&q->freequeue)->tqh_first);
 if (nc) {
  do { if (((nc)->next.tqe_next) != ((void *)0)) (nc)->next.tqe_next->next.tqe_prev = (nc)->next.tqe_prev; else (&q->freequeue)->tqh_last = (nc)->next.tqe_prev; *(nc)->next.tqe_prev = (nc)->next.tqe_next; ((nc)->next.tqe_prev) = ((void *)-1); ((nc)->next.tqe_next) = ((void *)-1); } while (0);
 }
 _splx(s);
 if (!nc)
  return (12);
 ...
 isactive = (!(((&(q)->cmdqueue)->tqh_first) == ((void *)0)));
 do { (nc)->next.tqe_next = ((void *)0); (nc)->next.tqe_prev = (&q->cmdqueue)->tqh_last; *(&q->cmdqueue)->tqh_last = (nc); (&q->cmdqueue)->tqh_last = &(nc)->next.tqe_next; } while (0);
 if (!isactive)
  pckbc_start(t, slot);
 ...
 if (q->polling)
  ...
  if ((res = tsleep(nc, 0, "kbccmd", 1*hz))) {
   do { if (((nc)->next.tqe_next) != ((void *)0)) (nc)->next.tqe_next->next.tqe_prev = (nc)->next.tqe_prev; else (&q->cmdqueue)->tqh_last = (nc)->next.tqe_prev; *(nc)->next.tqe_prev = (nc)->next.tqe_next; ((nc)->next.tqe_prev) = ((void *)-1); ((nc)->next.tqe_next) = ((void *)-1); } while (0);
   pckbc_cleanup(t);
  } else {
   do { if (((nc)->next.tqe_next) != ((void *)0)) (nc)->next.tqe_next->next.tqe_prev = (nc)->next.tqe_prev; else (&q->cmdqueue)->tqh_last = (nc)->next.tqe_prev; *(nc)->next.tqe_prev = (nc)->next.tqe_next; ((nc)->next.tqe_prev) = ((void *)-1); ((nc)->next.tqe_next) = ((void *)-1); } while (0);
   res = nc->status;
 ...
 if (sync) {
  if (respbuf)
   __builtin_memcpy((respbuf), (nc->response), (responselen));
  do { (nc)->next.tqe_next = ((void *)0); (nc)->next.tqe_prev = (&q->freequeue)->tqh_last; *(&q->freequeue)->tqh_last = (nc); (&q->freequeue)->tqh_last = &(nc)->next.tqe_next; } while (0);
 }
...
pckbcintr_internal(struct pckbc_internal *t, struct pckbc_softc *sc)
{
 ...
 for(;;) {
  ...
  if ((!(((&(q)->cmdqueue)->tqh_first) == ((void *)0))) && pckbc_cmdresponse(t, slot, data))
   continue;
    ...
    int flags)
{
 ...
 if (bus_space_map(iot, addr + 0, 1, 0, &ioh_d))
                return (6);
 ...
 if (res) {
  ...
  pckbc_consdata.t_slotdata[0] = &pckbc_cons_slotdata;
