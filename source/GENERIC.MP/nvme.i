# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c" 2
...
# 100 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c"
...
# 131 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/nvme.c"
...
nvme_read8(struct nvme_softc *sc, bus_size_t r)
{
 ...
 a[1] = bus_space_read_4((sc)->sc_iot, (sc)->sc_ioh, (r));
 a[0] = bus_space_read_4((sc)->sc_iot, (sc)->sc_ioh, (r + 4));
...
nvme_write8(struct nvme_softc *sc, bus_size_t r, u_int64_t v)
{
 ...
 bus_space_write_4((sc)->sc_iot, (sc)->sc_ioh, (r), (a[1]));
 bus_space_write_4((sc)->sc_iot, (sc)->sc_ioh, (r + 4), (a[0]));
...
nvme_dumpregs(struct nvme_softc *sc)
{
 ...
 r8 = nvme_read8(sc, 0x0000);
 printf("%s: cap  0x%016llx\n", ((sc)->sc_dev.dv_xname), nvme_read8(sc, 0x0000));
 printf("%s:  mpsmax %u (%u)\n", ((sc)->sc_dev.dv_xname),
     (u_int)(12 + (((r8) >> 52) & 0xf)), (1 << (12 + (((r8) >> 52) & 0xf))));
 printf("%s:  mpsmin %u (%u)\n", ((sc)->sc_dev.dv_xname),
     (u_int)(12 + (((r8) >> 48) & 0xf)), (1 << (12 + (((r8) >> 48) & 0xf))));
 printf("%s:  css %llu\n", ((sc)->sc_dev.dv_xname), (((r8) >> 37) & 0x7f));
 printf("%s:  nssrs %llu\n", ((sc)->sc_dev.dv_xname), (((r8)) & ((1ULL << 36))));
 printf("%s:  dstrd %u\n", ((sc)->sc_dev.dv_xname), (1 << (2 + (((r8) >> 32) & 0xf))));
 printf("%s:  to %llu msec\n", ((sc)->sc_dev.dv_xname), (500 * (((r8) >> 24) & 0xff)));
 printf("%s:  ams %llu\n", ((sc)->sc_dev.dv_xname), (((r8) >> 17) & 0x3));
 printf("%s:  cqr %llu\n", ((sc)->sc_dev.dv_xname), (((r8)) & ((1 << 16))));
 printf("%s:  mqes %llu\n", ((sc)->sc_dev.dv_xname), (((r8) & 0xffff) + 1));

 printf("%s: vs   0x%04x\n", ((sc)->sc_dev.dv_xname), bus_space_read_4((sc)->sc_iot, (sc)->sc_ioh, (0x0008)));

 r4 = bus_space_read_4((sc)->sc_iot, (sc)->sc_ioh, (0x0014));
 printf("%s: cc   0x%04x\n", ((sc)->sc_dev.dv_xname), r4);
 printf("%s:  iocqes %u\n", ((sc)->sc_dev.dv_xname), (((r4) >> 20) & 0xf));
 printf("%s:  iosqes %u\n", ((sc)->sc_dev.dv_xname), (((r4) >> 16) & 0xf));
 printf("%s:  shn %u\n", ((sc)->sc_dev.dv_xname), (((r4) >> 15) & 0x3));
 printf("%s:  ams %u\n", ((sc)->sc_dev.dv_xname), (((r4) >> 11) & 0xf));
 printf("%s:  mps %u\n", ((sc)->sc_dev.dv_xname), (12 + (((r4) >> 7) & 0xf)));
 printf("%s:  css %u\n", ((sc)->sc_dev.dv_xname), (((r4) >> 4) & 0x7));
 printf("%s:  en %u\n", ((sc)->sc_dev.dv_xname), ((r4) & ((1 << 0))));

 printf("%s: csts 0x%08x\n", ((sc)->sc_dev.dv_xname), bus_space_read_4((sc)->sc_iot, (sc)->sc_ioh, (0x001c)));
 printf("%s: aqa  0x%08x\n", ((sc)->sc_dev.dv_xname), bus_space_read_4((sc)->sc_iot, (sc)->sc_ioh, (0x0024)));
 printf("%s: asq  0x%016llx\n", ((sc)->sc_dev.dv_xname), nvme_read8(sc, 0x0028));
 printf("%s: acq  0x%016llx\n", ((sc)->sc_dev.dv_xname), nvme_read8(sc, 0x0030));
}
...
nvme_ready(struct nvme_softc *sc, u_int32_t rdy)
{
 ...
 while ((bus_space_read_4((sc)->sc_iot, (sc)->sc_ioh, (0x001c)) & (1 << 0)) != rdy) {
  if (i++ > sc->sc_rdy_to)
   return (1);

  delay(1000);
  bus_space_barrier((sc)->sc_iot, (sc)->sc_ioh, (0x001c), (4), (0x01));
 }
...
nvme_enable(struct nvme_softc *sc, u_int mps)
{
 ...
 cc = bus_space_read_4((sc)->sc_iot, (sc)->sc_ioh, (0x0014));
 if (((cc) & ((1 << 0))))
  return (nvme_ready(sc, (1 << 0)));

 bus_space_write_4((sc)->sc_iot, (sc)->sc_ioh, (0x0024), ((((sc->sc_admin_q->q_entries) - 1) << 16) | (((sc->sc_admin_q->q_entries) - 1) << 0)));

 bus_space_barrier((sc)->sc_iot, (sc)->sc_ioh, (0), (sc->sc_ios), (0x02));

 nvme_write8(sc, 0x0028, ((u_int64_t)(sc->sc_admin_q->q_sq_dmamem)->ndm_map->dm_segs[0].ds_addr));
 bus_space_barrier((sc)->sc_iot, (sc)->sc_ioh, (0), (sc->sc_ios), (0x02));
 nvme_write8(sc, 0x0030, ((u_int64_t)(sc->sc_admin_q->q_cq_dmamem)->ndm_map->dm_segs[0].ds_addr));
 bus_space_barrier((sc)->sc_iot, (sc)->sc_ioh, (0), (sc->sc_ios), (0x02));

 ((cc) &= ~((((0xf) & 0xf) << 20) | (((0xf) & 0xf) << 16) | (((0x3) & 0x3) << 14) | (((0x7) & 0x7) << 11) | (0xf << 7) | (((0x7) & 0x7) << 4)));

 ((cc) |= ((((ffs(64) - 1) & 0xf) << 16) | (((ffs(16) - 1) & 0xf) << 20)));
 ((cc) |= ((((0) & 0x3) << 14)));
 ((cc) |= ((((0) & 0x7) << 4)));
 ((cc) |= ((((0) & 0x7) << 11)));
 ((cc) |= (((((mps) - 12) & 0xf) << 7)));
 ...
 bus_space_write_4((sc)->sc_iot, (sc)->sc_ioh, (0x0014), (cc));
 bus_space_barrier((sc)->sc_iot, (sc)->sc_ioh, (0), (sc->sc_ios), (0x01 | 0x02));
...
nvme_disable(struct nvme_softc *sc)
{
 ...
 cc = bus_space_read_4((sc)->sc_iot, (sc)->sc_ioh, (0x0014));
 if (((cc) & ((1 << 0)))) {
  csts = bus_space_read_4((sc)->sc_iot, (sc)->sc_ioh, (0x001c));
  if (!((csts) & ((1 << 1))) &&
      nvme_ready(sc, (1 << 0)) != 0)
   return (1);
 }
...
nvme_attach(struct nvme_softc *sc)
{
 ...
 printf(", NVMe %d.%d\n", (((reg64) & 0xffff0000) >> 16), (((reg64) & 0x0000ff00) >> 8));

 cap = nvme_read8(sc, 0x0000);
 sc->sc_dstrd = (1 << (2 + (((cap) >> 32) & 0xf)));
 if ((12 + (((cap) >> 48) & 0xf)) > 13) {
  printf("%s: NVMe minimum page size %u "
      "is greater than CPU page size %u\n", ((sc)->sc_dev.dv_xname),
      1 << (12 + (((cap) >> 48) & 0xf)), 1 << 13);
  return (1);
 }
 if ((12 + (((cap) >> 52) & 0xf)) < mps)
  mps = (12 + (((cap) >> 52) & 0xf));

 sc->sc_rdy_to = (500 * (((cap) >> 24) & 0xff));
 sc->sc_mps = 1 << mps;
 sc->sc_mps_bits = mps;
 sc->sc_mdts = (64 * 1024);
 sc->sc_max_sgl = 2;
 ...
 sc->sc_admin_q = nvme_q_alloc(sc, 0, 128, sc->sc_dstrd);
 if (sc->sc_admin_q == ((void *)0)) {
 ...
 if (nvme_identify(sc, (12 + (((cap) >> 48) & 0xf))) != 0) {
...
nvme_scsi_probe(struct scsi_link *link)
{
 ...
 sqe.opcode = 0x06;
 __swapm32((&sqe.nsid), (link->target + 1));
 __swapm64((&sqe.entry.prp[0]), (((u_int64_t)(mem)->ndm_map->dm_segs[0].ds_addr)));
 __swapm32((&sqe.cdw10), (0));

 ccb->ccb_done = nvme_empty_done;
 ccb->ccb_cookie = &sqe;

 nvme_dmamem_sync(sc, mem, 0x01);
 rv = nvme_poll(sc, sc->sc_admin_q, ccb, nvme_sqe_fill);
 nvme_dmamem_sync(sc, mem, 0x02);
 ...
 identify = malloc(sizeof(*identify), 2, 0x0001|0x0008);
 __builtin_memcpy((identify), (((void *)(mem)->ndm_kva)), (sizeof(*identify)));
...
nvme_scsi_cmd(struct scsi_xfer *xs)
{
 ...
 case 0xa8:
 case 0x88:
  nvme_scsi_io(xs, 0x00800);
  return;
 case 0x0a:
 case 0x2a:
 case 0xaa:
 case 0x8a:
  nvme_scsi_io(xs, 0x01000);
  return;
...
nvme_scsi_io(struct scsi_xfer *xs, int dir)
{
 ...
 if ((xs->flags & (0x00800|0x01000)) != dir)
  goto stuffup;
 ...
 if (bus_dmamap_load(sc->sc_dmat, dmap,
     xs->data, xs->datalen, ((void *)0), ((xs->flags) & (0x00001)) ?
     0x0001 : 0x0000) != 0)
  goto stuffup;
 ...
 if (dmap->dm_nsegs > 2) {
  for (i = 1; i < dmap->dm_nsegs; i++) {
   __swapm64((&ccb->ccb_prpl[i - 1]), (dmap->dm_segs[i].ds_addr));

  }
  bus_dmamap_sync(sc->sc_dmat,
      ((sc->sc_ccb_prpls)->ndm_map),
      ccb->ccb_prpl_off,
...
nvme_scsi_io_fill(struct nvme_softc *sc, struct nvme_ccb *ccb, void *slot)
{
 ...
 sqe->opcode = ((xs->flags) & (0x00800)) ?
     0x02 : 0x01;
 __swapm32((&sqe->nsid), (link->target + 1));

 __swapm64((&sqe->entry.prp[0]), (dmap->dm_segs[0].ds_addr));
 switch (dmap->dm_nsegs) {
 case 1:
  break;
 case 2:
  __swapm64((&sqe->entry.prp[1]), (dmap->dm_segs[1].ds_addr));
  break;
 default:

  __swapm64((&sqe->entry.prp[1]), (ccb->ccb_prpl_dva));
  break;
 }

 __swapm64((&sqe->slba), (lba));
 __swapm16((&sqe->nlb), (blocks - 1));
}
    ...
    struct nvme_cqe *cqe)
{
 ...
 flags = __mswap16(&cqe->flags);

 xs->error = (((flags) & (0x7f << 1)) == (0x00 << 1)) ?
     0 : 2;
 xs->status = 0x00;
 xs->resid = 0;
 scsi_done(xs);
...
nvme_scsi_inquiry(struct scsi_xfer *xs)
{
 ...
 inq.flags |= 0x02;
 __builtin_memcpy((inq.vendor), ("NVMe    "), (sizeof(inq.vendor)));
 __builtin_memcpy((inq.product), (sc->sc_identify.mn), (sizeof(inq.product)));
 __builtin_memcpy((inq.revision), (sc->sc_identify.fr), (sizeof(inq.revision)));

 __builtin_memcpy((xs->data), (&inq), ((((sizeof(inq))<(xs->datalen))?(sizeof(inq)):(xs->datalen))));
...
nvme_scsi_capacity16(struct scsi_xfer *xs)
{
 ...
 nsze = __mswap64(&ns->nsze) - 1;
 f = &ns->lbaf[((ns->flbas) & 0x0f)];

 __builtin_memset((&rcd), (0), (sizeof(rcd)));
 _lto8b(nsze, rcd.addr);
 _lto4b(1 << f->lbads, rcd.length);
 _lto2b(tpe, rcd.lowest_aligned);

 __builtin_memcpy((xs->data), (&rcd), ((((sizeof(rcd))<(xs->datalen))?(sizeof(rcd)):(xs->datalen))));
...
nvme_scsi_free(struct scsi_link *link)
{
 ...
 sc->sc_namespaces[link->target].ident = ((void *)0);

 free(identify, 2, sizeof(*identify));
}
    ...
    void (*fill)(struct nvme_softc *, struct nvme_ccb *, void *))
{
 ...
 bus_dmamap_sync(sc->sc_dmat, ((q->q_sq_dmamem)->ndm_map),
     sizeof(*sqe) * tail, sizeof(*sqe), 0x08);
 __builtin_memset((sqe), (0), (sizeof(*sqe)));
 (*fill)(sc, ccb, sqe);
 sqe->cid = ccb->ccb_id;
 bus_dmamap_sync(sc->sc_dmat, ((q->q_sq_dmamem)->ndm_map),
...
{
 struct nvme_ccb *ccb;
 struct nvme_cqe *ring = ((void *)(q->q_cq_dmamem)->ndm_kva), *cqe;
 u_int32_t head;
 u_int16_t flags;
 int rv = 0;
...
nvme_q_create(struct nvme_softc *sc, struct nvme_queue *q)
{
 ...
 __builtin_memset((&sqe), (0), (sizeof(sqe)));
 sqe.opcode = 0x05;
 __swapm64((&sqe.prp1), (((u_int64_t)(q->q_cq_dmamem)->ndm_map->dm_segs[0].ds_addr)));
 __swapm16((&sqe.qsize), (q->q_entries - 1));
 __swapm16((&sqe.qid), (q->q_id));
 sqe.qflags = (1 << 1) | (1 << 0);
 ...
 __builtin_memset((&sqe), (0), (sizeof(sqe)));
 sqe.opcode = 0x01;
 __swapm64((&sqe.prp1), (((u_int64_t)(q->q_sq_dmamem)->ndm_map->dm_segs[0].ds_addr)));
 __swapm16((&sqe.qsize), (q->q_entries - 1));
 __swapm16((&sqe.qid), (q->q_id));
 __swapm16((&sqe.cqid), (q->q_id));
 sqe.qflags = (1 << 0);
...
nvme_ccbs_alloc(struct nvme_softc *sc, u_int nccbs)
{
 ...
 sc->sc_ccbs = mallocarray(nccbs, sizeof(*ccb), 2,
     0x0001 | 0x0004);
 ...
 prpl = ((void *)(sc->sc_ccb_prpls)->ndm_kva);
 off = 0;
 ...
 for (i = 0; i < nccbs; i++) {
  ...
  if (bus_dmamap_create(sc->sc_dmat, sc->sc_mdts,
      sc->sc_max_sgl + 1 ,
      sc->sc_mps, sc->sc_mps, 0x0000 | 0x0002,
      &ccb->ccb_dmamap) != 0)
   goto free_maps;
  ...
  ccb->ccb_prpl_dva = ((u_int64_t)(sc->sc_ccb_prpls)->ndm_map->dm_segs[0].ds_addr) + off;

  do { (ccb)->ccb_entry.sqe_next = ((void *)0); *(&sc->sc_ccb_list)->sqh_last = (ccb); (&sc->sc_ccb_list)->sqh_last = &(ccb)->ccb_entry.sqe_next; } while (0);
...
nvme_ccbs_free(struct nvme_softc *sc)
{
 ...
 while ((ccb = ((&sc->sc_ccb_list)->sqh_first)) != ((void *)0)) {
  do { if (((&sc->sc_ccb_list)->sqh_first = (&sc->sc_ccb_list)->sqh_first->ccb_entry.sqe_next) == ((void *)0)) (&sc->sc_ccb_list)->sqh_last = &(&sc->sc_ccb_list)->sqh_first; } while (0);
...
nvme_q_alloc(struct nvme_softc *sc, u_int16_t id, u_int entries, u_int dstrd)
{
 ...
 nvme_dmamem_sync(sc, q->q_sq_dmamem, 0x04);
 nvme_dmamem_sync(sc, q->q_cq_dmamem, 0x01);
...
nvme_q_reset(struct nvme_softc *sc, struct nvme_queue *q)
{
 ...
 q->q_sqtdbl = (0x1000 + (2 * (q->q_id) + 0) * (sc->sc_dstrd));
 q->q_cqhdbl = (0x1000 + (2 * (q->q_id) + 1) * (sc->sc_dstrd));
...
{
 nvme_dmamem_sync(sc, q->q_cq_dmamem, 0x02);
 nvme_dmamem_sync(sc, q->q_sq_dmamem, 0x08);
...
nvme_intr_intx(void *xsc)
{
 ...
 bus_space_write_4((sc)->sc_iot, (sc)->sc_ioh, (0x000c), (1));
 rv = nvme_intr(sc);
 bus_space_write_4((sc)->sc_iot, (sc)->sc_ioh, (0x0010), (1));
...
nvme_dmamem_alloc(struct nvme_softc *sc, size_t size)
{
 ...
 ndm = malloc(sizeof(*ndm), 2, 0x0001 | 0x0008);
 if (ndm == ((void *)0))
  return (((void *)0));
...
{
 bus_dmamap_sync(sc->sc_dmat, ((mem)->ndm_map),
     0, ((mem)->ndm_map->dm_segs[0].ds_len), ops);
}
