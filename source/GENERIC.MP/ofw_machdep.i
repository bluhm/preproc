# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
int udf_disklabelspoof(dev_t dev, void (*strat)(struct buf *),
 struct disklabel *lp);
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c" 2
 ...
 paddr_t mmfsa;
{
 ...
 args.name = (cell_t)("SUNW,set-trap-table");
 if ((cputyp == 5))
  args.nargs = 2;
 else
  args.nargs = 1;
 ...
 vaddr_t vaddr;
{
 ...
 args.nargs = 3;
 args.nreturns = 5;
 args.method = (cell_t)("translate");
 args.ihandle = (cell_t)(u_int)(int)(mmuh);
 args.vaddr = (cell_t)(vaddr);
 if(openfirmware(&args) == -1)
  return -1;
# 180 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
 return (paddr_t)(args.phys_lo);
}
 ...
 int mode;
{
 ...
 args.nargs = 7;
 args.nreturns = 1;
 args.method = (cell_t)("map");
 args.ihandle = (cell_t)(u_int)(int)(mmuh);
 args.mode = mode;
 args.size = size;
 args.vaddr = (cell_t)(vaddr);
 args.phys_hi = (cell_t)(0);
 args.phys_lo = (cell_t)(paddr);
 ...
 int align;
{
 ...
 args.nreturns = 3;
 args.method = (cell_t)("claim");
 args.ihandle = (cell_t)(u_int)(int)(memh);
 args.align = align;
 args.len = len;
 if (openfirmware(&args) != 0)
  return -1;
 ...
 int len;
{
 ...
 args.len = len;
 args.phys_hi = (cell_t)(0);
 args.phys_lo = (cell_t)(phys);
 if (openfirmware(&args) != 0)
  return -1;
 return (paddr_t)(args.rphys_lo);
}
 ...
 int align;
{
 ...
 if (OF_test("test-method") == 0) {
  if (OF_test_method(OF_instance_to_package(memh), "SUNW,retain") == 0) {
   ...
   args.nargs = 5;
   args.nreturns = 3;
   args.method = (cell_t)("SUNW,retain");
   args.id = (cell_t)("msgbuf");
   args.ihandle = (cell_t)(u_int)(int)(memh);
   args.len = len;
   args.align = align;
   args.status = -1;
...
prom_itlb_load(int index, u_int64_t data, vaddr_t vaddr)
{
 ...
 args.nargs = 5;
 args.nreturns = 1;
 args.method = (cell_t)("SUNW,itlb-load");
 args.ihandle = (cell_t)(u_int)(int)(mmuh);
 args.vaddr = (cell_t)(vaddr);
 args.data = data;
 args.index = index;
...
prom_dtlb_load(int index, u_int64_t data, vaddr_t vaddr)
{
 ...
 args.nargs = 5;
 args.nreturns = 1;
 args.method = (cell_t)("SUNW,dtlb-load");
 args.ihandle = (cell_t)(u_int)(int)(mmuh);
 args.vaddr = (cell_t)(vaddr);
 args.data = data;
 args.index = index;
...
prom_start_cpu(int cpu, void *func, long arg)
{
 ...
 args.name = (cell_t)("SUNW,start-cpu");
 args.nargs = 3;
 args.nreturns = 0;
 args.cpu = (cell_t)(u_int)(int)(cpu);
...
prom_start_cpu_by_cpuid(int cpu, void *func, long arg)
{
 ...
 args.name = (cell_t)("SUNW,start-cpu-by-cpuid");
 args.nargs = 3;
 args.nreturns = 1;
 args.cpu = cpu;
 args.func = (cell_t)(func);
...
prom_serengeti_set_console_input(const char *new)
{
 ...
 args.name = (cell_t)("SUNW,set-console-input");
 args.nargs = 1;
 args.nreturns = 1;
 args.new = (cell_t)(new);
    ...
    uint64_t minor, uint64_t *supported_minor)
{
 ...
 args.name = (cell_t)("SUNW,set-sun4v-api-version");
 args.nargs = 3;
 args.nreturns = 2;
...
prom_sun4v_soft_state_supported(void)
{
 ...
 args.name = (cell_t)("SUNW,soft-state-supported");
 args.nargs = 0;
 args.nreturns = 0;

 openfirmware(&args);
}
# 830 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
int
...
# 895 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
int
OF_mapintr(int node, int *interrupt, int validlen, int buflen)
{
 ...
 if (*interrupt & 0x20 || *interrupt & 0x7c0)
  return validlen;
# 928 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
 if ((len = OF_getprop(node, "reg", &reg64, sizeof(reg64))) <= 0) {
 ...
 while (node) {
# 945 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
  if ((interrupt_map_len = OF_getprop(node,
   ...
   reg64[0] = 0;
   OF_getprop(node, "reg", &reg64, sizeof(reg64));
...
# 1009 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
  i = 0;
...
# 1027 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
...
# 1068 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ofw_machdep.c"
