# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/msi.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/msi.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/msi.c"
...
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/msi.c" 2
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/msi.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/msi.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/msi.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/msi.c" 2
...
msi_eq_alloc(bus_dma_tag_t t, int msi_eq_size)
{
 ...
 meq = malloc(sizeof(struct msi_eq), 2, 0x0002);
 if (meq == ((void *)0))
  return ((void *)0);

 size = ((((msi_eq_size * sizeof(struct msi_msg))+(((1 << 13))-1))/((1 << 13)))*((1 << 13)));

 if (bus_dmamap_create(t, size, 1, size, 0,
     0x0001 | 0x0002, &meq->meq_map) != 0)
  return (((void *)0));
 ...
 if (bus_dmamap_load(t, meq->meq_map, va, size, ((void *)0),
     0x0001) != 0)
  goto unmap;
...
msi_eq_free(bus_dma_tag_t t, struct msi_eq *meq)
{
 ...
 size = ((((meq->meq_nentries * sizeof(struct msi_msg))+(((1 << 13))-1))/((1 << 13)))*((1 << 13)));

 bus_dmamap_unload(t, meq->meq_map);
 bus_dmamem_unmap(t, meq->meq_va, size);
 bus_dmamem_free(t, &meq->meq_seg, 1);
 bus_dmamap_destroy(t, meq->meq_map);
 free(meq, 2, sizeof *meq);
}
