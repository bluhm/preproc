# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c"
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewiredevs.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewirereg.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c" 2
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owctr.c"
struct owctr_softc {
...
{
 return (onewire_matchbyfam(aux, owctr_fams, (sizeof((owctr_fams)) / sizeof((owctr_fams)[0]))));
}
...
owctr_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 snprintf(sc->sc_counterA.desc, sizeof(sc->sc_counterA.desc),
  "Counter A sn %012llx", (((oa->oa_rom) >> 8) & 0xffffffffffffULL));
 ...
 snprintf(sc->sc_counterB.desc, sizeof(sc->sc_counterB.desc),
  "Counter B sn %012llx", (((oa->oa_rom) >> 8) & 0xffffffffffffULL));
...
{
 owctr_update_counter(arg, 0x1c0);
 owctr_update_counter(arg, 0x1e0);
}
...
owctr_update_counter(void *arg, int bank)
{
 ...
 onewire_read_block(sc->sc_onewire, &buf[3], 45 -3);

 crc = onewire_crc16(buf, 45 -2);
 crc ^= buf[43]
  | (buf[43 +1] << 8);
 if ( crc != 0xffff) {
