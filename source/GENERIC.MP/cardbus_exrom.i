# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.c"
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.c"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.c" 2
# 98 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.c"
int
    ...
    struct cardbus_rom_image_head *head)
{
 ...
 do {
  val = (bus_space_read_1((romt), (romh), (addr + 0x00)) | (bus_space_read_1((romt), (romh), (addr + 0x00) + 1) << 8));
  if (val != 0xaa55) {
   ;

   return (1);
  }
  dataptr = addr + (bus_space_read_1((romt), (romh), (addr + 0x18)) | (bus_space_read_1((romt), (romh), (addr + 0x18) + 1) << 8));



  image_size = (bus_space_read_1((romt), (romh), (dataptr + 0x10)) | (bus_space_read_1((romt), (romh), (dataptr + 0x10) + 1) << 8));
  ...
  image = malloc(sizeof(*image), 2, 0x0002);
  if (image == ((void *)0)) {
   ;
   return (1);
  }
  ...
  if (bus_space_subregion(romt, romh, addr,
   ...
   ;
   free(image, 2, sizeof(*image));
   return (1);
  }
  do { (image)->next.sqe_next = ((void *)0); *(head)->sqh_last = (image); (head)->sqh_last = &(image)->next.sqe_next; } while (0);
  addr += image_size;
  rom_image++;
