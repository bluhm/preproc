       ...
       struct radeon_fence *fence)
{
 ...
 radeon_ring_write(ring, ((((0x6) & 0xF) << 28) | (((0) & 0xFF) << 20) | (((0) & 0xFFFFF) << 0)));
 radeon_ring_write(ring, addr & 0xfffffffc);
 radeon_ring_write(ring, (((u32)(((addr) >> 16) >> 16)) & 0xff));
 radeon_ring_write(ring, fence->seq);
 radeon_ring_write(ring, ((((0x7) & 0xF) << 28) | (((0) & 0xFF) << 20) | (((0) & 0xFFFFF) << 0)));
 radeon_ring_write(ring, ((((0x9) & 0xF) << 28) | (((0) & 0xFF) << 20) | (((0) & 0xFFFFF) << 0)));
       ...
       struct radeon_ib *ib)
{
 ...
 if (rdev->wb.enabled) {
  ...
  while ((next_rptr & 7) != 5)
   next_rptr++;
  next_rptr += 3;
  radeon_ring_write(ring, ((((0x2) & 0xF) << 28) | (((0) & 0xFF) << 20) | (((1) & 0xFFFFF) << 0)));
  radeon_ring_write(ring, ring->next_rptr_gpu_addr & 0xfffffffc);
  radeon_ring_write(ring, ((u32)(((ring->next_rptr_gpu_addr) >> 16) >> 16)) & 0xff);
  radeon_ring_write(ring, next_rptr);
 }
 while ((ring->wptr & 7) != 5)
  radeon_ring_write(ring, ((((0xf) & 0xF) << 28) | (((0) & 0xFF) << 20) | (((0) & 0xFFFFF) << 0)));
 radeon_ring_write(ring, ((((0x4) & 0xF) << 28) | (((0) & 0xFF) << 20) | (((0) & 0xFFFFF) << 0)));
     ...
     struct reservation_object *resv)
{
 ...
 num_loops = (((size_in_dw) + ((0xfffff) - 1)) / (0xfffff));
 ...
 for (i = 0; i < num_loops; i++) {
  ...
  radeon_ring_write(ring, ((((0x3) & 0xF) << 28) | (((0) & 0xFF) << 20) | (((cur_size_in_dw) & 0xFFFFF) << 0)));
  radeon_ring_write(ring, dst_offset & 0xfffffffc);
  radeon_ring_write(ring, src_offset & 0xfffffffc);
  radeon_ring_write(ring, ((u32)(((dst_offset) >> 16) >> 16)) & 0xff);
  radeon_ring_write(ring, ((u32)(((src_offset) >> 16) >> 16)) & 0xff);
...
_Bool evergreen_dma_is_lockup(struct radeon_device *rdev, struct radeon_ring *ring)
{
