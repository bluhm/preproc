# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c"
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_ioctl.c" 2
    ...
    struct ieee80211_nodereq *nr)
{
 ...
 __builtin_bcopy((ni->ni_tstamp), (nr->nr_tstamp), (sizeof(nr->nr_tstamp)));
 ...
 nr->nr_rsnakms = 0;
 nr->nr_rsnprotos = 0;
 if (ni->ni_supported_rsnprotos & (1 << 0))
  nr->nr_rsnprotos |= 0x02;
 if (ni->ni_supported_rsnprotos & (1 << 1))
  nr->nr_rsnprotos |= 0x01;
 ...
 __builtin_memcpy((nr->nr_rxmcs), (ni->ni_rxmcs), (sizeof(nr->nr_rxmcs)));
    ...
    struct ieee80211_node *ni)
{
 ...
 __builtin_memcpy((ni->ni_macaddr), (nr->nr_macaddr), (6));
 __builtin_memcpy((ni->ni_bssid), (nr->nr_bssid), (6));
 ni->ni_esslen = nr->nr_nwid_len;
 __builtin_bcopy((nr->nr_nwid), (ni->ni_essid), (32));


 ni->ni_rates.rs_nrates = nr->nr_nrates;
 __builtin_bcopy((nr->nr_rates), (ni->ni_rates.rs_rates), (15));
...
ieee80211_disable_wep(struct ieee80211com *ic)
{
 ...
 ic->ic_flags &= ~0x00000100;
}

void
ieee80211_disable_rsn(struct ieee80211com *ic)
{
 ic->ic_flags &= ~(0x00400000 | 0x00200000);
    ...
    const struct ieee80211_nwkey *nwkey)
{
 ...
 if (nwkey->i_defkid < 1 || nwkey->i_defkid > 4)
  return 22;

 for (i = 0; i < 4; i++) {
  if (nwkey->i_key[i].i_keylen == 0 ||
      nwkey->i_key[i].i_keydat == ((void *)0))
   continue;
  if (nwkey->i_key[i].i_keylen > 16)
   return 22;
  ...
  k->k_flags = 0x00000001 | 0x00000002;
  error = copyin(nwkey->i_key[i].i_keydat, k->k_key, k->k_len);
  if (error != 0)
   return error;
  if ((error = (*ic->ic_set_key)(ic, ((void *)0), k)) != 0)
   return error;
 }
    ...
    const struct ieee80211_wpaparams *wpa)
{
 ...
 ic->ic_rsnprotos = 0;
 if (wpa->i_protos & 0x01)
  ic->ic_rsnprotos |= (1 << 1);
 if (wpa->i_protos & 0x02)
  ic->ic_rsnprotos |= (1 << 0);
 if (ic->ic_rsnprotos == 0)
  ic->ic_rsnprotos = (1 << 0);
...
{
 wpa->i_enabled = (ic->ic_flags & 0x00200000) ? 1 : 0;

 wpa->i_protos = 0;
 if (ic->ic_rsnprotos & (1 << 1))
  wpa->i_protos |= 0x01;
 if (ic->ic_rsnprotos & (1 << 0))
  wpa->i_protos |= 0x02;
...
ieee80211_ioctl(struct ifnet *ifp, u_long cmd, caddr_t data)
{
 ...
 static const u_int8_t empty_macaddr[6] = {
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((231))):
  __builtin_memset((&nwid), (0), (sizeof(nwid)));
  switch (ic->ic_state) {
  case IEEE80211_S_INIT:
  case IEEE80211_S_SCAN:
   nwid.i_len = ic->ic_des_esslen;
   __builtin_memcpy((nwid.i_nwid), (ic->ic_des_essid), (nwid.i_len));
   break;
  default:
   nwid.i_len = ic->ic_bss->ni_esslen;
   __builtin_memcpy((nwid.i_nwid), (ic->ic_bss->ni_essid), (nwid.i_len));
   break;
  }
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ieee80211_wpaparams) & 0x1fff) << 16) | ((('i')) << 8) | ((247))):
  ...
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ieee80211_wpaparams) & 0x1fff) << 16) | ((('i')) << 8) | ((248))):
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ieee80211_wpapsk) & 0x1fff) << 16) | ((('i')) << 8) | ((245))):
  ...
  if (psk->i_enabled) {
   ic->ic_flags |= 0x00400000;
   __builtin_memcpy((ic->ic_psk), (psk->i_psk), (sizeof(ic->ic_psk)));
   if (ic->ic_flags & 0x00000100)
    ieee80211_disable_wep(ic);
  } else {
   ic->ic_flags &= ~0x00400000;
   __builtin_memset((ic->ic_psk), (0), (sizeof(ic->ic_psk)));
  }
  error = 52;
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ieee80211_wpapsk) & 0x1fff) << 16) | ((('i')) << 8) | ((246))):
  psk = (struct ieee80211_wpapsk *)data;
  if (ic->ic_flags & 0x00400000) {
   psk->i_enabled = 1;

   if (suser((__curcpu->ci_self)->ci_curproc, 0) != 0) {
    psk->i_enabled = 2;
    __builtin_memset((psk->i_psk), (0), (sizeof(psk->i_psk)));
    break;
   }
   __builtin_memcpy((psk->i_psk), (ic->ic_psk), (sizeof(psk->i_psk)));
  } else
   psk->i_enabled = 0;
  break;
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ieee80211_keyrun) & 0x1fff) << 16) | ((('i')) << 8) | ((252))):
  ...
  if (error == 0 && (ic->ic_flags & 0x00000100))
   ieee80211_disable_wep(ic);
  break;
 case ((unsigned long)0x80000000 | ((sizeof(struct ieee80211_power) & 0x1fff) << 16) | ((('i')) << 8) | ((234))):
  ...
  if (power->i_enabled != 0) {
   if ((ic->ic_caps & 0x00000004) == 0)
    error = 22;
   else if ((ic->ic_flags & 0x00000400) == 0) {
    ic->ic_flags |= 0x00000400;
    error = 52;
   }
  } else {
   if (ic->ic_flags & 0x00000400) {
    ic->ic_flags &= ~0x00000400;
    error = 52;
   }
  }
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ieee80211_power) & 0x1fff) << 16) | ((('i')) << 8) | ((235))):
  power = (struct ieee80211_power *)data;
  power->i_enabled = (ic->ic_flags & 0x00000400) ? 1 : 0;
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ieee80211_bssid) & 0x1fff) << 16) | ((('i')) << 8) | ((240))):
  ...
  if ((__builtin_memcmp((bssid->i_bssid), (empty_macaddr), (6)) == 0))
   ic->ic_flags &= ~0x00000800;
  else {
   ic->ic_flags |= 0x00000800;
   __builtin_memcpy((ic->ic_des_bssid), (bssid->i_bssid), (6));
  }
  ...
  default:
   if ((ic->ic_flags & 0x00000800) &&
       !(__builtin_memcmp((ic->ic_des_bssid), (ic->ic_bss->ni_bssid), (6)) == 0))
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ieee80211_bssid) & 0x1fff) << 16) | ((('i')) << 8) | ((241))):
  ...
  case IEEE80211_S_SCAN:
   ...
   if (ic->ic_opmode == IEEE80211_M_HOSTAP)
    __builtin_memcpy((bssid->i_bssid), (ic->ic_myaddr), (6));

   else

   if (ic->ic_flags & 0x00000800)
    __builtin_memcpy((bssid->i_bssid), (ic->ic_des_bssid), (6));

   else
    __builtin_memset((bssid->i_bssid), (0), (6));
   break;
  default:
   __builtin_memcpy((bssid->i_bssid), (ic->ic_bss->ni_bssid), (6));
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ieee80211chanreq) & 0x1fff) << 16) | ((('i')) << 8) | ((239))):
  ...
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ieee80211_chanreq_all) & 0x1fff) << 16) | ((('i')) << 8) | ((215))):
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((242))):
  ifr = (struct ifreq *)data;
  error = copyout(&ic->ic_stats, ifr->ifr_ifru.ifru_data,
      sizeof(ic->ic_stats));
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((127))):
  ifr = (struct ifreq *)data;
  if (!(32 <= ifr->ifr_ifru.ifru_metric &&
      ifr->ifr_ifru.ifru_metric <= 2290))
   error = 22;
  else
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ieee80211_nodereq) & 0x1fff) << 16) | ((('i')) << 8) | ((213))):
  ...
  if (ni == ((void *)0))
   ...
   if (ni->ni_state == IEEE80211_STA_ASSOC)
    ((*(ic)->ic_send_mgmt)(ic, ni, 0xa0, IEEE80211_REASON_ASSOC_LEAVE, 0));
