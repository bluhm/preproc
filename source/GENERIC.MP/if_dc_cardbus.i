# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c" 2
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_dc_cardbus.c"
...
dc_cardbus_match(struct device *parent, void *match, void *aux)
{
 return (cardbus_matchbyid((struct cardbus_attach_args *)aux,
     dc_cardbus_devices, (sizeof((dc_cardbus_devices)) / sizeof((dc_cardbus_devices)[0]))));
}
...
dc_cardbus_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (cardbus_mapreg_map((ct)->ct_sc, (ct->ct_func), (0x10), (0x00000001), (0), (&sc->dc_btag), (&sc->dc_bhandle), (&addr), (&csc->sc_mapsize)) == 0) {



  csc->sc_actype = 100;
 } else if (cardbus_mapreg_map((ct)->ct_sc, (ct->ct_func), (0x14), (0x00000000|0x00000000), (0), (&sc->dc_btag), (&sc->dc_bhandle), (&addr), (&csc->sc_mapsize)) == 0) {
 ...
 sc->dc_cachesize = pci_conf_read(csc->sc_pc, ca->ca_tag, 0x0C)
     & 0xFF;

 dc_cardbus_setup(csc);


 if (((((ca->ca_id) >> 0) & 0xffff) == 0x115d &&
       (((ca->ca_id) >> 16) & 0xffff) == 0x0003))
  ;
 else
  dc_eeprom_width(sc);

 switch ((((ca->ca_id) >> 0) & 0xffff)) {
 case 0x1011:
  if ((((ca->ca_id) >> 16) & 0xffff) == 0x0019) {
   sc->dc_type = 0x4;
  ...
  break;
 case 0x115d:
  if ((((ca->ca_id) >> 16) & 0xffff) ==
      0x0003) {
   sc->dc_type = 0xB;
   sc->dc_flags |= 0x00000400|0x00000002 |
     0x00010000;
   sc->dc_pmode = 0x1;
  }
  break;
 ...
 case 0x17b3:
 case 0x1414:
  if ((((ca->ca_id) >> 16) & 0xffff) == 0x1985 ||
      (((ca->ca_id) >> 16) & 0xffff) == 0x1216 ||
      (((ca->ca_id) >> 16) & 0xffff) == 0xab02 ||
      (((ca->ca_id) >> 16) & 0xffff) == 0xab08 ||
      (((ca->ca_id) >> 16) & 0xffff) == 0xab03 ||
      (((ca->ca_id) >> 16) & 0xffff) == 0x1561 ||
      (((ca->ca_id) >> 16) & 0xffff) == 0xab08 ||
      (((ca->ca_id) >> 16) & 0xffff) == 0xab09 ||
      (((ca->ca_id) >> 16) & 0xffff) == 0xab08 ||
      (((ca->ca_id) >> 16) & 0xffff) == 0x0001) {
   sc->dc_type = 0x7;
   sc->dc_flags |= 0x00000008|0x00000004 |
     0x00002000;
   sc->dc_pmode = 0x1;
 ...
 reg64 = pci_conf_read(pc, ca->ca_tag, 0x0c);
 if ((((reg64) >> 8) & 0xff) < 0x20) {
  reg64 &= ~(0xff << 8);
  reg64 |= (0x20 << 8);
  pci_conf_write(pc, ca->ca_tag, 0x0c, reg64);
 }

 sc->sc_ih = cardbus_intr_establish(cc, cf, ca->ca_intrline, 6,
 ...
 sc->dc_revision = (((ca->ca_class) >> 0) & 0xff);
 dc_attach(sc);
}
...
dc_cardbus_detach(struct device *self, int flags)
{
 ...
 cardbus_mapreg_unmap((ct)->ct_sc, (ct->ct_func), (csc->sc_actype == 100 ? 0x10 : 0x14), (sc->dc_btag), (sc->dc_bhandle), (csc->sc_mapsize));
...
dc_cardbus_setup(struct dc_cardbus_softc *csc)
{
 ...
 if (reg64 & (0x80000000|0x40000000)) {
  pci_conf_write(pc, csc->sc_tag, 0x40,
      reg64 & ~(0x80000000|0x40000000));
 }

 if (pci_get_capability(csc->sc_pc, csc->sc_tag, 0x01, &r,
     0)) {
 ...
 reg64 = pci_conf_read(csc->sc_pc, csc->sc_tag, 0x04);
 reg64 |= 0x00000001 | 0x00000002 |
     0x00000004;
 pci_conf_write(csc->sc_pc, csc->sc_tag, 0x04, reg64);
 reg64 = pci_conf_read(csc->sc_pc, csc->sc_tag, 0x04);
}
