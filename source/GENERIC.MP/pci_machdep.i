# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c"
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c"
...
struct tty;
struct uio;
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
void device_register(struct device *, void *);
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ofw/ofw_pci.h" 1
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ofw/ofw_pci.h"
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c" 2
 ...
 int f;
{
 ...
 if (pc->busnode[b])
  return (((u_int64_t)(0)<<32)|((b)<<16)|((d)<<11)|((f)<<8));
# 128 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c"
 tag = (((u_int64_t)(-1)<<32)|((b)<<16)|((d)<<11)|((f)<<8));
 node = pc->rootnode;
...
# 148 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c"
...
# 169 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c"
  len = OF_getproplen(node, "reg");
  if (len < sizeof(reg64))
   continue;
  if (OF_getprop(node, "reg", (void *)&reg64, sizeof(reg64)) != len)
   panic("pci_probe_bus: OF_getprop len botch");

  if (b != (((reg64.phys_hi) & 0x00ff0000) >> 16))
   continue;
  if (d != (((reg64.phys_hi) & 0x0000f800) >> 11))
   continue;
  if (f != (((reg64.phys_hi) & 0x00000700) >> 8))
   continue;


  tag = (((u_int64_t)(node)<<32)|((b)<<16)|((d)<<11)|((f)<<8));
 ...
 int *bp, *dp, *fp;
{
 ...
 if (bp != ((void *)0))
  *bp = ((((tag)&0xffffffff)>>16)&0xff);
 if (dp != ((void *)0))
  *dp = ((((tag)&0xffffffff)>>11)&0x1f);
 if (fp != ((void *)0))
  *fp = ((((tag)&0xffffffff)>>8)&0x7);
}
    ...
    int (*match)(struct pci_attach_args *), struct pci_attach_args *pap)
{
 ...
 if (sc->sc_bridgetag)
  node = (int)(((*sc->sc_bridgetag)>>32)&0xffffffff);
 else
  node = pc->rootnode;
 ...
 for (node = OF_child(node); node != 0 && node != -1;
  ...
  if (OF_getprop(node, "class-code", &class, sizeof(class)) !=
      sizeof(class))
   continue;
  if (OF_getprop(node, "reg", &reg64, sizeof(reg64)) < sizeof(reg64))
   panic("pci_enumerate_bus: \"%s\" regs too small", name);

  b = (((reg64.phys_hi) & 0x00ff0000) >> 16);
  d = (((reg64.phys_hi) & 0x0000f800) >> 11);
  f = (((reg64.phys_hi) & 0x00000700) >> 8);
...
# 294 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pci_machdep.c"
  bhlc = pci_conf_read(pc, tag, 0x0c);
  ic = pci_conf_read(pc, tag, 0x3c);

  lt = min((((ic) >> 16) & 0xff) * bus_frequency / 4, 255);
  if (lt == 0 || lt < (((bhlc) >> 8) & 0xff))
   lt = (((bhlc) >> 8) & 0xff);
  ...
  bhlc |= (lt << 8) |
   (cl << 0);
  pci_conf_write(pc, tag, 0x0c, bhlc);

  ret = pci_probe_device(sc, tag, match, pap);
  if (match != ((void *)0) && ret != 0)
   return (ret);
 }
...
pcireg_t
pci_conf_read(pci_chipset_tag_t pc, pcitag_t tag, int reg64)
{
        pcireg_t val = (pcireg_t)~0;

        if ((int)(((tag)>>32)&0xffffffff) != -1)
  val = pc->conf_read(pc, tag, reg64);

        return (val);
}

void
pci_conf_write(pci_chipset_tag_t pc, pcitag_t tag, int reg64, pcireg_t data)
{
        if ((int)(((tag)>>32)&0xffffffff) != -1)
  pc->conf_write(pc, tag, reg64, data);
}
 ...
 pci_intr_handle_t *ihp;
{
 ...
 int len, node = (int)(((tag)>>32)&0xffffffff);
 char devtype[30];
 ...
 if (((((pa->pa_tag)&0xffffffff)>>8)&0x7) < ninterrupts)
  interrupts[0] = interrupts[((((pa->pa_tag)&0xffffffff)>>8)&0x7)];
 ...
 if (OF_getprop(node, "device_type", &devtype, sizeof(devtype)) > 0) {
  for (len = 0; intrmap[len].in_class; len++)
   if (strcmp(intrmap[len].in_class, devtype) == 0) {
    interrupts[0] |= (((intrmap[len].in_lev)&0x0f)<<11);
    break;
   }
 }
...
pci_intr_map_msi(struct pci_attach_args *pa, pci_intr_handle_t *ihp)
{
 ...
 if ((pa->pa_flags & 0x20) == 0 ||
     pci_get_capability(pc, tag, 0x05, ((void *)0), ((void *)0)) == 0)
  return (-1);

 *ihp = ((pa->pa_tag)&0xffffffff) | 0x80000000;
 return (0);
}
 ...
 pci_intr_handle_t ih;
{
 ...
 if (ih & 0x80000000)
  ...
  snprintf(str, sizeof str, "ivec 0x%llx", ((ih)&(0x0000007c0LL|0x00000003fLL)));
 do { } while (0);
...
pci_msi_enable(pci_chipset_tag_t pc, pcitag_t tag, bus_addr_t addr, int vec)
{
 ...
 if (pci_get_capability(pc, tag, 0x05, &off, &reg64) == 0)
  panic("%s: no msi capability", __func__);

 if (reg64 & 0x00800000) {
  pci_conf_write(pc, tag, off + 0x04, addr);
  pci_conf_write(pc, tag, off + 0x08, 0);
  pci_conf_write(pc, tag, off + 0x0c, vec);
 } else {
  pci_conf_write(pc, tag, off + 0x04, addr);
  pci_conf_write(pc, tag, off + 0x08, vec);
 }
 pci_conf_write(pc, tag, off, reg64 | 0x00010000);
}
