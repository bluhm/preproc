# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c"
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c"
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c" 2
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c"
struct umodem_softc {
 ...
 int sc_ctl_notify;
 struct usbd_pipe *sc_notify_pipe;
 struct usb_cdc_notification sc_notify_buf;
 u_char sc_lsr;
 u_char sc_msr;
};
 ...
 while (desc) {
  if (desc->bDescriptorType == 0x04) {
   ...
   if (current_iface_no != ctl_iface_no &&
       id->bInterfaceClass == 0x0a &&
       id->bInterfaceSubClass == 0 &&
       data_iface_no == -1)
    data_iface_no = current_iface_no;
  }
  if (current_iface_no == ctl_iface_no &&
      desc->bDescriptorType == 0x24) {
...
umodem_match(struct device *parent, void *match, void *aux)
{
 ...
 int data_iface_idx, cm_cap, acm_cap, ret = 0;
 ...
 if (id == ((void *)0) || dd == ((void *)0))
  return (ret);

 ret = 0;

 if (((dd->idVendor)[0] | ((dd->idVendor)[1] << 8)) == 0x0482 &&
     ((dd->idProduct)[0] | ((dd->idProduct)[1] << 8)) == 0x0203 &&
     id->bInterfaceNumber == 0)
  ret = 13;

 if (ret == 0 &&
     id->bInterfaceClass == 0x02 &&
...
umodem_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 printf("%s: data interface %d, has %sCM over data, has %sbreak\n",
        ...
        sc->sc_cm_cap & 0x02 ? "" : "no ",
        sc->sc_acm_cap & 0x04 ? "" : "no ");
 ...
 if (usbd_get_quirks(sc->sc_udev)->uq_flags & 0x00001000) {
  sc->sc_cm_over_data = 1;
 } else {
  if (sc->sc_cm_cap & 0x02) {
   if (sc->sc_acm_cap & 0x01)
...
# 357 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umodem.c"
 sc->sc_ctl_notify = -1;
 sc->sc_notify_pipe = ((void *)0);
...
umodem_open(void *addr, int portno)
{
 ...
 if (sc->sc_ctl_notify != -1 && sc->sc_notify_pipe == ((void *)0)) {
  err = usbd_open_pipe_intr(sc->sc_ctl_iface, sc->sc_ctl_notify,
      0x04, &sc->sc_notify_pipe, sc,
...
umodem_intr(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (sc->sc_notify_buf.bmRequestType != 0xa1) {
  ;
 ...
 case 0x20:
  ...
  if (((sc->sc_notify_buf.wLength)[0] | ((sc->sc_notify_buf.wLength)[1] << 8)) != 2) {
   printf("%s: Invalid notification length! (%d)\n",
          sc->sc_dev.dv_xname,
          ((sc->sc_notify_buf.wLength)[0] | ((sc->sc_notify_buf.wLength)[1] << 8)));
   break;
  }
  ;
...
umodem_set_line_state(struct umodem_softc *sc)
{
 ...
 ((req.wIndex)[0] = (u_int8_t)(sc->sc_ctl_iface_no), (req.wIndex)[1] = (u_int8_t)((sc->sc_ctl_iface_no) >> 8));
...
void
umodem_set(void *addr, int portno, int reg64, int onoff)
{
 struct umodem_softc *sc = addr;
...
umodem_set_comm_feature(struct umodem_softc *sc, int feature, int state)
{
 ...
 req.bmRequestType = (0x00 | 0x20 | 0x01);
 req.bRequest = 0x02;
 ((req.wValue)[0] = (u_int8_t)(feature), (req.wValue)[1] = (u_int8_t)((feature) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(sc->sc_ctl_iface_no), (req.wIndex)[1] = (u_int8_t)((sc->sc_ctl_iface_no) >> 8));
 ((req.wLength)[0] = (u_int8_t)(2), (req.wLength)[1] = (u_int8_t)((2) >> 8));
 ((ast.wState)[0] = (u_int8_t)(state), (ast.wState)[1] = (u_int8_t)((state) >> 8));
