# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_memory.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_memory.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_memory.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_memory.c" 2
...
{
 return (malloc(size, 145, 0x0002));
}

void *
drm_calloc(size_t nmemb, size_t size)
{
 if (nmemb == 0 || 0xffffffffffffffffUL / nmemb < size)
  return (((void *)0));
 else
  return mallocarray(size, nmemb, 145, 0x0002 | 0x0008);
}
...
drm_realloc(void *oldpt, size_t oldsize, size_t size)
{
 ...
 pt = malloc(size, 145, 0x0002);
 if (pt == ((void *)0))
  return ((void *)0);
 if (oldpt && oldsize) {
  __builtin_memcpy((pt), (oldpt), (min(oldsize, size)));
  free(oldpt, 145, 0);
 }
 return pt;
}
...
{
# 97 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_memory.c"
 return 0;
...
{
# 115 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_memory.c"
 return 0;
