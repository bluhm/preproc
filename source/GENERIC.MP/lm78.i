# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78var.h" 1
# 128 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78var.h"
struct lm_softc;
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/isa/wbsioreg.h" 1
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c" 2
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c"
...
struct lm_sensor lm78_sensors[] = {
 ...
 { "VCore A", SENSOR_VOLTS_DC, 0, 0x20, lm_refresh_volt, 10000 },
 { "VCore B", SENSOR_VOLTS_DC, 0, 0x21, lm_refresh_volt, 10000 },
 { "+3.3V", SENSOR_VOLTS_DC, 0, 0x22, lm_refresh_volt, 10000 },
 { "+5V", SENSOR_VOLTS_DC, 0, 0x23, lm_refresh_volt, (10000 * ((68) + (100)) / (100)) },
 { "+12V", SENSOR_VOLTS_DC, 0, 0x24, lm_refresh_volt, (10000 * ((30) + (10)) / (10)) },
 { "-12V", SENSOR_VOLTS_DC, 0, 0x25, lm_refresh_volt, (-10000 * (240) / (60)) },
 { "-5V", SENSOR_VOLTS_DC, 0, 0x26, lm_refresh_volt, (-10000 * (100) / (60)) },
...
struct lm_sensor w83627hf_sensors[] = {
 ...
 { "VCore B", SENSOR_VOLTS_DC, 0, 0x21, lm_refresh_volt, 10000 },
 { "+3.3V", SENSOR_VOLTS_DC, 0, 0x22, lm_refresh_volt, 10000 },
 { "+5V", SENSOR_VOLTS_DC, 0, 0x23, lm_refresh_volt, (10000 * ((34) + (50)) / (50)) },
 { "+12V", SENSOR_VOLTS_DC, 0, 0x24, lm_refresh_volt, (10000 * ((28) + (10)) / (10)) },
 { "-12V", SENSOR_VOLTS_DC, 0, 0x25, wb_refresh_nvolt, (10000 * ((232) + (56)) / (56)) },
 { "-5V", SENSOR_VOLTS_DC, 0, 0x26, wb_refresh_nvolt, (10000 * ((120) + (56)) / (56)) },
 { "5VSB", SENSOR_VOLTS_DC, 5, 0x50, lm_refresh_volt, (10000 * ((17) + (33)) / (33)) },
 { "VBAT", SENSOR_VOLTS_DC, 5, 0x51, lm_refresh_volt, 10000 },
...
# 136 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c"
struct lm_sensor w83627ehf_sensors[] = {

 { "VCore", SENSOR_VOLTS_DC, 0, 0x20, lm_refresh_volt, 10000 / 2},
 { "+12V", SENSOR_VOLTS_DC, 0, 0x21, lm_refresh_volt, (10000 * ((56) + (10)) / (10)) / 2 },
 { "+3.3V", SENSOR_VOLTS_DC, 0, 0x22, lm_refresh_volt, (10000 * ((34) + (34)) / (34)) / 2 },
 { "+3.3V", SENSOR_VOLTS_DC, 0, 0x23, lm_refresh_volt, (10000 * ((34) + (34)) / (34)) / 2 },
 { "-12V", SENSOR_VOLTS_DC, 0, 0x24, wb_w83627ehf_refresh_nvolt },
 { "", SENSOR_VOLTS_DC, 0, 0x25, lm_refresh_volt, 10000 / 2 },
 { "", SENSOR_VOLTS_DC, 0, 0x26, lm_refresh_volt, 10000 / 2 },
 { "3.3VSB", SENSOR_VOLTS_DC, 5, 0x50, lm_refresh_volt, (10000 * ((34) + (34)) / (34)) / 2 },
 { "VBAT", SENSOR_VOLTS_DC, 5, 0x51, lm_refresh_volt, 10000 / 2 },
 { "", SENSOR_VOLTS_DC, 5, 0x52, lm_refresh_volt, 10000 / 2 },
...
struct lm_sensor w83637hf_sensors[] = {
 ...
 { "+12V", SENSOR_VOLTS_DC, 0, 0x21, lm_refresh_volt, (10000 * ((28) + (10)) / (10)) },
 { "+3.3V", SENSOR_VOLTS_DC, 0, 0x22, lm_refresh_volt, 10000 },
 { "+5V", SENSOR_VOLTS_DC, 0, 0x23, lm_refresh_volt, (10000 * ((34) + (51)) / (51)) },
 { "-12V", SENSOR_VOLTS_DC, 0, 0x24, wb_refresh_nvolt, (10000 * ((232) + (56)) / (56)) },
 { "5VSB", SENSOR_VOLTS_DC, 5, 0x50, lm_refresh_volt, (10000 * ((34) + (51)) / (51)) },
 { "VBAT", SENSOR_VOLTS_DC, 5, 0x51, lm_refresh_volt, 10000 },
...
struct lm_sensor w83781d_sensors[] = {
 ...
 { "+5V", SENSOR_VOLTS_DC, 0, 0x23, lm_refresh_volt, (10000 * ((34) + (50)) / (50)) },
 { "+12V", SENSOR_VOLTS_DC, 0, 0x24, lm_refresh_volt, (10000 * ((28) + (10)) / (10)) },
 { "-12V", SENSOR_VOLTS_DC, 0, 0x25, lm_refresh_volt, (-10000 * (2100) / (604)) },
 { "-5V", SENSOR_VOLTS_DC, 0, 0x26, lm_refresh_volt, (-10000 * (909) / (604)) },
...
struct lm_sensor w83791d_sensors[] = {
 ...
 { "-12V", SENSOR_VOLTS_DC, 0, 0x25, wb_refresh_nvolt, (10000 * ((232) + (56)) / (56)) },
 { "-5V", SENSOR_VOLTS_DC, 0, 0x26, wb_refresh_nvolt, (10000 * ((120) + (56)) / (56)) },
 { "5VSB", SENSOR_VOLTS_DC, 0, 0xb0, lm_refresh_volt, (10000 * ((17) + (33)) / (33)) },
 { "VBAT", SENSOR_VOLTS_DC, 0, 0xb1, lm_refresh_volt, 10000 },
 { "VINR1", SENSOR_VOLTS_DC, 0, 0xb2, lm_refresh_volt, 10000 },
...
struct lm_sensor w83792d_sensors[] = {
 ...
 { "VCore B", SENSOR_VOLTS_DC, 0, 0x21, lm_refresh_volt, 10000 },
 { "+3.3V", SENSOR_VOLTS_DC, 0, 0x22, lm_refresh_volt, 10000 },
 { "-5V", SENSOR_VOLTS_DC, 0, 0x23, wb_refresh_nvolt, (10000 * ((120) + (56)) / (56)) },
 { "+12V", SENSOR_VOLTS_DC, 0, 0x24, lm_refresh_volt, (10000 * ((28) + (10)) / (10)) },
 { "-12V", SENSOR_VOLTS_DC, 0, 0x25, wb_refresh_nvolt, (10000 * ((232) + (56)) / (56)) },
 { "+5V", SENSOR_VOLTS_DC, 0, 0x26, lm_refresh_volt, (10000 * ((34) + (50)) / (50)) },
 { "5VSB", SENSOR_VOLTS_DC, 0, 0xb0, lm_refresh_volt, (10000 * ((17) + (33)) / (33)) },
 { "VBAT", SENSOR_VOLTS_DC, 0, 0xb1, lm_refresh_volt, 10000 },
...
lm_attach(struct lm_softc *sc)
{
 ...
 config = sc->lm_readreg(sc, 0x40);
 sc->lm_writereg(sc, 0x40, config | 0x01);
...
lm_match(struct lm_softc *sc)
{
 ...
 chipid = sc->lm_readreg(sc, 0x49) & 0xfe;
 switch(chipid) {
 case 0x00:
  printf(": LM78\n");
  break;
...
wb_match(struct lm_softc *sc)
{
 ...
 banksel = sc->lm_readreg(sc, 0x4e);
 sc->lm_writereg(sc, 0x4e, 0x80);
 vendid = sc->lm_readreg(sc, 0x4f) << 8;
 sc->lm_writereg(sc, 0x4e, 0);
 vendid |= sc->lm_readreg(sc, 0x4f);
 sc->lm_writereg(sc, 0x4e, banksel);
 ;
 if (vendid != 0x5ca3 && vendid != 0x12c3)
  return 0;


 sc->lm_writereg(sc, 0x4e, 0x00);
 devid = sc->lm_readreg(sc, 0x49);
 sc->chipid = sc->lm_readreg(sc, 0x58);
 sc->lm_writereg(sc, 0x4e, banksel);
 ;
 switch(sc->chipid) {
 case 0x21:
...
lm_refresh_volt(struct lm_softc *sc, int n)
{
 ...
 data = sc->lm_readreg(sc, sc->lm_sensors[n].reg64);
 sensor->value = (data << 4);
...
lm_refresh_temp(struct lm_softc *sc, int n)
{
 ...
 sdata = sc->lm_readreg(sc, sc->lm_sensors[n].reg64);
...
lm_refresh_fanrpm(struct lm_softc *sc, int n)
{
 struct ksensor *sensor = &sc->sensors[n];
 int data, divisor = 1;
# 678 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c"
 if (sc->lm_sensors[n].reg64 == 0x28 ||
     sc->lm_sensors[n].reg64 == 0x29) {
  data = sc->lm_readreg(sc, 0x47);
  if (sc->lm_sensors[n].reg64 == 0x28)
   divisor = (data >> 4) & 0x03;
  else
   divisor = (data >> 6) & 0x03;
...
wb_refresh_sensor_data(struct lm_softc *sc)
{
 ...
 banksel = bank = sc->lm_readreg(sc, 0x4e);
 for (i = 0; i < sc->numsensors; i++) {
  if (bank != sc->lm_sensors[i].bank) {
   bank = sc->lm_sensors[i].bank;
   sc->lm_writereg(sc, 0x4e, bank);
  }
  sc->lm_sensors[i].refresh(sc, i);
 }
 sc->lm_writereg(sc, 0x4e, banksel);
...
wb_refresh_nvolt(struct lm_softc *sc, int n)
{
 ...
 data = sc->lm_readreg(sc, sc->lm_sensors[n].reg64);
 sensor->value = ((data << 4) - 3600);
 sensor->value *= sc->lm_sensors[n].rfact;
 sensor->value /= 10;
 sensor->value += 3600 * 1000;
}
...
wb_w83627ehf_refresh_nvolt(struct lm_softc *sc, int n)
{
 ...
 data = sc->lm_readreg(sc, sc->lm_sensors[n].reg64);
 sensor->value = ((data << 3) - 2048);
 sensor->value *= (10000 * ((232) + (10)) / (10));
 sensor->value /= 10;
 sensor->value += 2048 * 1000;
}
...
wb_refresh_temp(struct lm_softc *sc, int n)
{
 struct ksensor *sensor = &sc->sensors[n];
 int sdata;
# 776 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lm78.c"
 sdata = sc->lm_readreg(sc, sc->lm_sensors[n].reg64) << 1;
 sdata += sc->lm_readreg(sc, sc->lm_sensors[n].reg64 + 1) >> 7;
...
wb_refresh_fanrpm(struct lm_softc *sc, int n)
{
 ...
 if (sc->lm_sensors[n].reg64 == 0x28 ||
     sc->lm_sensors[n].reg64 == 0x29 ||
     sc->lm_sensors[n].reg64 == 0x2a) {
  data = sc->lm_readreg(sc, 0x5d);
  fan = (sc->lm_sensors[n].reg64 - 0x28);
  if ((data >> 5) & (1 << fan))
   divisor |= 0x04;
 }
 ...
 if (sc->lm_sensors[n].reg64 == 0x28 ||
  ...
  if (sc->lm_sensors[n].reg64 == 0x28)
   ...
   divisor |= (data >> 6) & 0x03;
 } else if (sc->lm_sensors[n].reg64 == 0x2a) {
  data = sc->lm_readreg(sc, 0x4b);
  divisor |= (data >> 6) & 0x03;
 } else if (sc->lm_sensors[n].reg64 == 0xba ||
     sc->lm_sensors[n].reg64 == 0xbb) {
  data = sc->lm_readreg(sc, 0x5c);
  if (sc->lm_sensors[n].reg64 == 0xba)
   divisor |= (data >> 0) & 0x07;
  else
   divisor |= (data >> 4) & 0x07;
 }
...
wb_nct6776f_refresh_fanrpm(struct lm_softc *sc, int n)
{
 ...
 datah = sc->lm_readreg(sc, sc->lm_sensors[n].reg64);
 datal = sc->lm_readreg(sc, sc->lm_sensors[n].reg64 + 1);
...
{
 struct ksensor *sensor = &sc->sensors[n];
 int reg64, shift, data, divisor = 1;

 switch (sc->lm_sensors[n].reg64) {
 case 0x28:
  reg64 = 0x47; shift = 0;
  break;
 case 0x29:
 ...
 if (data == 0xff || data == 0x00) {
  ...
  if (reg64 != 0)
   divisor = (sc->lm_readreg(sc, reg64) >> shift) & 0x7;
  sensor->flags &= ~0x0001;
  sensor->value = 1350000 / (data << divisor);
 }
}
