# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c"
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c"
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c" 2
...
ieee80211_bip_delete_key(struct ieee80211com *ic, struct ieee80211_key *k)
{
 if (k->k_priv != ((void *)0)) {
  ...
  free(k->k_priv, 2, sizeof(struct ieee80211_bip_ctx));
 }
 k->k_priv = ((void *)0);
}
    ...
    struct ieee80211_key *k)
{
 ...
 u_int8_t *mmie, mic[16];
 struct mbuf *m;

 wh = ((struct ieee80211_frame *)((m0)->m_hdr.mh_data));
 (((wh->i_fc[0] & 0x0c) == 0x00) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c", 98, "(wh->i_fc[0] & IEEE80211_FC0_TYPE_MASK) == IEEE80211_FC0_TYPE_MGT"));
 ...
 aad.i_fc[1] = wh->i_fc[1] & ~(0x08 |
     0x10 | 0x20);

 __builtin_memcpy((aad.i_addr1), (wh->i_addr1), (6));
 __builtin_memcpy((aad.i_addr2), (wh->i_addr2), (6));
 __builtin_memcpy((aad.i_addr3), (wh->i_addr3), (6));

 AES_CMAC_Init(&ctx->cmac);
 AES_CMAC_Update(&ctx->cmac, (u_int8_t *)&aad, sizeof aad);
 AES_CMAC_Update(&ctx->cmac, (u_int8_t *)&wh[1],
     m0->m_hdr.mh_len - sizeof(*wh));

 m = m0;

 if (m_trailingspace(m) < 18) {
  m->m_hdr.mh_next = m_get((0x0002), (m->m_hdr.mh_type));
 ...
 mmie = ((u_int8_t *)((m)->m_hdr.mh_data)) + m->m_hdr.mh_len;
 mmie[0] = IEEE80211_ELEMID_MMIE;
 mmie[1] = 16;
 do { ((u_int8_t *)(&mmie[2]))[0] = (k->k_id) & 0xff; ((u_int8_t *)(&mmie[2]))[1] = (k->k_id) >> 8; } while (0);
 do { (&mmie[4])[5] = (k->k_tsc) >> 40; (&mmie[4])[4] = (k->k_tsc) >> 32; (&mmie[4])[3] = (k->k_tsc) >> 24; (&mmie[4])[2] = (k->k_tsc) >> 16; (&mmie[4])[1] = (k->k_tsc) >> 8; (&mmie[4])[0] = (k->k_tsc); } while (0);
 __builtin_memset((&mmie[10]), (0), (8));

 AES_CMAC_Update(&ctx->cmac, mmie, 18);
 AES_CMAC_Final(mic, &ctx->cmac);

 __builtin_memcpy((&mmie[10]), (mic), (8));

 m->m_hdr.mh_len += 18;
 m0->M_dat.MH.MH_pkthdr.len += 18;
    ...
    struct ieee80211_key *k)
{
 ...
 struct ieee80211_frame *wh;
 struct ieee80211_bip_frame aad;
 u_int8_t *mmie, mic0[8], mic[16];
 u_int64_t ipn;

 wh = ((struct ieee80211_frame *)((m0)->m_hdr.mh_data));
 (((wh->i_fc[0] & 0x0c) == 0x00) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c", 163, "(wh->i_fc[0] & IEEE80211_FC0_TYPE_MASK) == IEEE80211_FC0_TYPE_MGT"));
 ...
 ((m0->m_hdr.mh_len >= sizeof(*wh) + 18) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_bip.c", 170, "m0->m_len >= sizeof(*wh) + IEEE80211_MMIE_LEN"));
 mmie = ((u_int8_t *)((m0)->m_hdr.mh_data)) + m0->m_hdr.mh_len - 18;

 ipn = ((u_int64_t)(&mmie[4])[5] << 40 | (u_int64_t)(&mmie[4])[4] << 32 | (u_int64_t)(&mmie[4])[3] << 24 | (u_int64_t)(&mmie[4])[2] << 16 | (u_int64_t)(&mmie[4])[1] << 8 | (u_int64_t)(&mmie[4])[0]);
 if (ipn <= k->k_mgmt_rsc) {
 ...
 __builtin_memcpy((mic0), (&mmie[10]), (8));
 __builtin_memset((&mmie[10]), (0), (8));
