# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c"
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c"
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewirereg.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uowreg.h" 1
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uow.c" 2
...
uow_match(struct device *parent, void *match, void *aux)
{
 ...
 return ((usbd_match_device((const struct usb_devno *)(uow_devs), sizeof (uow_devs) / sizeof ((uow_devs)[0]), sizeof ((uow_devs)[0]), (uaa->vendor), (uaa->product)) != ((void *)0)) ?
     13 : 0);
}
...
uow_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 for (i = 0; i < id->bNumEndpoints; i++) {
  ...
  if (((ed->bEndpointAddress) & 0x80) == 0x00 &&
      ((ed->bmAttributes) & 0x03) == 0x02)
 ...
 if ((error = usbd_open_pipe(sc->sc_iface, ep_ibulk, 0x01,
     &sc->sc_ph_ibulk)) != 0) {
  printf("%s: failed to open bulk-in pipe: %s\n",
      sc->sc_dev.dv_xname, usbd_errstr(error));
  return;
 }
 if ((error = usbd_open_pipe(sc->sc_iface, ep_obulk, 0x01,
     &sc->sc_ph_obulk)) != 0) {
 ...
 if ((sc->sc_xfer_in = usbd_alloc_xfer(sc->sc_udev)) == ((void *)0)) {
  printf("%s: failed to alloc bulk-in xfer\n",
      sc->sc_dev.dv_xname);
  goto fail;
 }
 if ((sc->sc_xfer_out = usbd_alloc_xfer(sc->sc_udev)) == ((void *)0)) {
  printf("%s: failed to alloc bulk-out xfer\n",
      sc->sc_dev.dv_xname);
  goto fail;
 }

 __builtin_memset((sc->sc_fifo), (0xff), (sizeof(sc->sc_fifo)));
 ...
 __builtin_bzero((&oba), (sizeof(oba)));
 oba.oba_bus = &sc->sc_ow_bus;
 sc->sc_ow_dev = config_found_sm((self), (&oba), (onewirebus_print), ((void *)0));

 return;

fail:
 if (sc->sc_ph_ibulk != ((void *)0)) {
  usbd_close_pipe(sc->sc_ph_ibulk);
  sc->sc_ph_ibulk = ((void *)0);
 }
 if (sc->sc_ph_obulk != ((void *)0)) {
  usbd_close_pipe(sc->sc_ph_obulk);
  sc->sc_ph_obulk = ((void *)0);
 }
 if (sc->sc_ph_intr != ((void *)0)) {
  usbd_close_pipe(sc->sc_ph_intr);
  sc->sc_ph_intr = ((void *)0);
 }
 if (sc->sc_xfer_in != ((void *)0)) {
  usbd_free_xfer(sc->sc_xfer_in);
  sc->sc_xfer_in = ((void *)0);
 }
 if (sc->sc_xfer_out != ((void *)0)) {
  usbd_free_xfer(sc->sc_xfer_out);
  sc->sc_xfer_out = ((void *)0);
 }
}
...
uow_ow_reset(void *arg)
{
 ...
 if (uow_cmd((sc), 0x01, (0x0042 | (1 << 0)), (0)) != 0)
  return (1);
...
uow_ow_bit(void *arg, int value)
{
 ...
 if (uow_cmd((sc), 0x01, (0x0020 | (1 << 0) | (value ? (1 << 3) : 0)), (0)) != 0)
...
uow_ow_read_byte(void *arg)
{
 ...
 if (uow_cmd((sc), 0x01, (0x0052 | (1 << 0)), (0xff)) != 0)
  return (-1);
 if (uow_read(sc, &data, 1) != 1)
  return (-1);
...
uow_ow_write_byte(void *arg, int value)
{
 ...
 if (uow_cmd((sc), 0x01, (0x0052 | (1 << 0)), (value)) != 0)
  return;
...
uow_ow_read_block(void *arg, void *buf, int len)
{
 ...
 if (uow_write(sc, sc->sc_fifo, len) != 0)
  return;
 if (uow_cmd((sc), 0x01, (0x0074 | (1 << 0)), (len)) != 0)
  return;
 uow_read(sc, buf, len);
}
...
uow_ow_matchrom(void *arg, u_int64_t rom)
{
 ...
 if (uow_write(sc, data, 8) != 0)
  return;
 if (uow_cmd((sc), 0x01, (0x0064 | (1 << 0)), (0x55)) != 0)
...
uow_ow_search(void *arg, u_int64_t *buf, int size, u_int64_t startrom)
{
 ...
 if (uow_write(sc, data, 8) != 0)
  return (-1);
 if (uow_cmd((sc), 0x01, (0x00f4 | (1 << 0) | (1 << 3) | (1 << 8) | (1 << 11)), (size << 8 | 0xf0)) != 0)
...
uow_cmd(struct uow_softc *sc, int type, int cmd, int param)
{
 ...
 req.bRequest = type;
 ((req.wValue)[0] = (u_int8_t)(cmd), (req.wValue)[1] = (u_int8_t)((cmd) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(param), (req.wIndex)[1] = (u_int8_t)((param) >> 8));
...
again:
 if (tsleep(sc->sc_regs, 16, "uowcmd",
     (1000 * hz) / 1000) != 0) {
...
uow_read(struct uow_softc *sc, void *buf, int len)
{
 ...
 usbd_get_xfer_status(sc->sc_xfer_in, ((void *)0), ((void *)0), &count, &error);
 return (count);
}
...
{
 return (uow_cmd((sc), 0x00, (0x0000), (0)));
}
