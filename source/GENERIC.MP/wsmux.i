# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/wsmux.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/wsdisplay.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/wskbd.h" 1
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/wsmouse.h" 1
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c"
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
void logwakeup(void);
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsksymdef.h" 1
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c" 2
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsmux.c"
...
int nwsmux = 0;
struct wsmux_softc **wsmuxdevs = ((void *)0);
...
wsmux_getmux(int n)
{
 ...
 if (n >= nwsmux) {
  ...
  if (old != ((void *)0))
   __builtin_bcopy((old), (new), (nwsmux * sizeof(*wsmuxdevs)));
  for (i = nwsmux; i < (n + 1); i++)
   new[i] = ((void *)0);
  if (old != ((void *)0))
   free(old, 2, nwsmux * sizeof(*wsmuxdevs));
  wsmuxdevs = new;
  nwsmux = n + 1;
 }
...
wsmux_do_open(struct wsmux_softc *sc, struct wseventvar *evar)
{
 ...
 for((me) = ((&sc->sc_cld)->tqh_first); (me) != ((void *)0); (me) = ((me)->me_next.tqe_next)) {
  ;
...
{
 struct wsmux_softc *sc =
     (struct wsmux_softc *)wsmuxdevs[((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))];
...
{
 struct wsmux_softc *sc = wsmuxdevs[((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))];
 struct wseventvar *evar;
 int error;
...
{
 return wsmux_do_ioctl(&wsmuxdevs[((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))]->sc_base.me_dv, cmd, data, flag, p);
}
    ...
    struct proc *p)
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct wsmux_device) & 0x1fff) << 16) | ((('W')) << 8) | ((97))):
  ...
  switch (((struct wsmux_device *)data)->type) {

  case 1:
   return (wsmouse_add_mux(((struct wsmux_device *)data)->idx, sc));


  case 2:
   return (wskbd_add_mux(((struct wsmux_device *)data)->idx, sc));

  case 3:
   return (wsmux_add_mux(((struct wsmux_device *)data)->idx, sc));
  default:
   return (22);
  }
 case ((unsigned long)0x80000000 | ((sizeof(struct wsmux_device) & 0x1fff) << 16) | ((('W')) << 8) | ((98))):
  ...
  for((me) = ((&sc->sc_cld)->tqh_first); (me) != ((void *)0); (me) = ((me)->me_next.tqe_next)) {
   if (me->me_ops->type == ((struct wsmux_device *)data)->type &&
       me->me_dv.dv_unit == ((struct wsmux_device *)data)->idx) {
    ;
    wsmux_detach_sc(me);
    return (0);
   }
 ...
 case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((124))):
  ...
  if (evar == ((void *)0))
   return (22);
  if (-*(int *)data != evar->io->ps_pgrp->pg_id
 ...
 for((me) = ((&sc->sc_cld)->tqh_first); (me) != ((void *)0); (me) = ((me)->me_next.tqe_next)) {
  ...
  error = ((me)->me_ops->dioctl(&(me)->me_dv, cmd, (caddr_t)data, flag, p));
  ;
...
wsmux_add_mux(int unit, struct wsmux_softc *muxsc)
{
 ...
 for (m = muxsc; m != ((void *)0) ; m = m->sc_base.me_parent)
  if (m == sc)
   return (22);
...
wsmux_create(const char *name, int unit)
{
 ...
 if (sc == ((void *)0))
  return (((void *)0));
 do { (&sc->sc_cld)->tqh_first = ((void *)0); (&sc->sc_cld)->tqh_last = &(&sc->sc_cld)->tqh_first; } while (0);
...
wsmux_attach_sc(struct wsmux_softc *sc, struct wsevsrc *me)
{
 ...
 if (me->me_parent != ((void *)0)) {
  printf("wsmux_attach_sc: busy\n");
  return (16);
 }

 me->me_parent = sc;
 do { (me)->me_next.tqe_next = ((void *)0); (me)->me_next.tqe_prev = (&sc->sc_cld)->tqh_last; *(&sc->sc_cld)->tqh_last = (me); (&sc->sc_cld)->tqh_last = &(me)->me_next.tqe_next; } while (0);
 ...
 if (sc->sc_base.me_dispdv != ((void *)0)) {
  ...
  if (me->me_ops->dsetdisplay != ((void *)0)) {
   error = ((me)->me_ops->dsetdisplay(&(me)->me_dv, sc->sc_base.me_dispdv));
   ...
   if (!error) {
    ...
    (void)((me)->me_ops->dioctl(&(me)->me_dv, ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('W')) << 8) | ((19))), (caddr_t)&sc->sc_rawkbd, 0x0002, 0));
 ...
 if (error) {
  me->me_parent = ((void *)0);
  do { if (((me)->me_next.tqe_next) != ((void *)0)) (me)->me_next.tqe_next->me_next.tqe_prev = (me)->me_next.tqe_prev; else (&sc->sc_cld)->tqh_last = (me)->me_next.tqe_prev; *(me)->me_next.tqe_prev = (me)->me_next.tqe_next; ((me)->me_next.tqe_prev) = ((void *)-1); ((me)->me_next.tqe_next) = ((void *)-1); } while (0);
 }
...
wsmux_detach_sc(struct wsevsrc *me)
{
 ...
 if (sc->sc_base.me_dispdv != ((void *)0)) {
  if (me->me_ops->dsetdisplay != ((void *)0))
   ...
   (void)((me)->me_ops->dsetdisplay(&(me)->me_dv, ((void *)0)));
 } else
    ...
    struct proc *p)
{
 ...
 if (cmd == ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('W')) << 8) | ((19)))) {
  sc->sc_rawkbd = *(int *)data;
  ;
 }
 ...
 for((me) = ((&sc->sc_cld)->tqh_first); (me) != ((void *)0); (me) = ((me)->me_next.tqe_next)) {
  ...
  if (me->me_ops->ddispioctl != ((void *)0)) {
   error = ((me)->me_ops->ddispioctl(&(me)->me_dv, cmd, (caddr_t)data, flag, p));
   ;
...
wsmux_set_display(struct wsmux_softc *sc, struct device *displaydv)
{
 ...
 struct wsevsrc *me;
 struct wsmux_softc *nsc = displaydv ? sc : ((void *)0);
 int error, ok;
 ...
 for((me) = ((&sc->sc_cld)->tqh_first); (me) != ((void *)0); (me) = ((me)->me_next.tqe_next)) {
  ...
  if (me->me_ops->dsetdisplay != ((void *)0)) {
   error = ((me)->me_ops->dsetdisplay(&(me)->me_dv, nsc ? nsc->sc_base.me_dispdv : ((void *)0)));
