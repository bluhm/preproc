# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c"
...
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c" 2
...
struct fusebuf_head { struct fusebuf *sqh_first; struct fusebuf **sqh_last; };
...
struct fuse_d {
 ...
 struct { struct fuse_d *le_next; struct fuse_d **le_prev; } fd_list;
};
...
struct { struct fuse_d *lh_first; } fuse_d_list;
...
# 120 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_device.c"
struct fuse_d *
fuse_lookup(int unit)
{
 struct fuse_d *fd;

 for((fd) = ((&fuse_d_list)->lh_first); (fd)!= ((void *)0); (fd) = ((fd)->fd_list.le_next))
  if (fd->fd_unit == unit)
   return (fd);
 return (((void *)0));
}
...
fuse_create(int unit)
{
 ...
 if ((fd = fuse_lookup(unit)) != ((void *)0))
  return (((void *)0));

 fd = malloc(sizeof(*fd), 2, 0x0001 | 0x0008);
 fd->fd_unit = unit;
 do { (&fd->fd_fbufs_in)->sqh_first = ((void *)0); (&fd->fd_fbufs_in)->sqh_last = &(&fd->fd_fbufs_in)->sqh_first; } while (0);
 do { (&fd->fd_fbufs_wait)->sqh_first = ((void *)0); (&fd->fd_fbufs_wait)->sqh_last = &(&fd->fd_fbufs_wait)->sqh_first; } while (0);
 do { if (((fd)->fd_list.le_next = (&fuse_d_list)->lh_first) != ((void *)0)) (&fuse_d_list)->lh_first->fd_list.le_prev = &(fd)->fd_list.le_next; (&fuse_d_list)->lh_first = (fd); (fd)->fd_list.le_prev = &(&fuse_d_list)->lh_first; } while (0);
 return (fd);
}
...
fuse_device_cleanup(dev_t dev, struct fusebuf *fbuf)
{
 ...
 lprev = ((void *)0);
 for ((f) = ((&fd->fd_fbufs_in)->sqh_first); (f) && ((ftmp) = ((f)->fb_hdr.fh_next.sqe_next), 1); (f) = (ftmp)) {
  if (fbuf == f || fbuf == ((void *)0)) {
   ;
   if (lprev == ((void *)0))
    do { if (((&fd->fd_fbufs_in)->sqh_first = (&fd->fd_fbufs_in)->sqh_first->fb_hdr.fh_next.sqe_next) == ((void *)0)) (&fd->fd_fbufs_in)->sqh_last = &(&fd->fd_fbufs_in)->sqh_first; } while (0);
   else
    do { if (((lprev)->fb_hdr.fh_next.sqe_next = (lprev)->fb_hdr.fh_next.sqe_next->fb_hdr.fh_next.sqe_next) == ((void *)0)) (&fd->fd_fbufs_in)->sqh_last = &(lprev)->fb_hdr.fh_next.sqe_next; } while (0);
 ...
 lprev = ((void *)0);
 for ((f) = ((&fd->fd_fbufs_wait)->sqh_first); (f) && ((ftmp) = ((f)->fb_hdr.fh_next.sqe_next), 1); (f) = (ftmp)) {
  if (fbuf == f || fbuf == ((void *)0)) {
   ;
   if (lprev == ((void *)0))
    do { if (((&fd->fd_fbufs_wait)->sqh_first = (&fd->fd_fbufs_wait)->sqh_first->fb_hdr.fh_next.sqe_next) == ((void *)0)) (&fd->fd_fbufs_wait)->sqh_last = &(&fd->fd_fbufs_wait)->sqh_first; } while (0);

   else
    do { if (((lprev)->fb_hdr.fh_next.sqe_next = (lprev)->fb_hdr.fh_next.sqe_next->fb_hdr.fh_next.sqe_next) == ((void *)0)) (&fd->fd_fbufs_wait)->sqh_last = &(lprev)->fb_hdr.fh_next.sqe_next; } while (0);
...
fuse_device_queue_fbuf(dev_t dev, struct fusebuf *fbuf)
{
 ...
 do { (fbuf)->fb_hdr.fh_next.sqe_next = ((void *)0); *(&fd->fd_fbufs_in)->sqh_last = (fbuf); (&fd->fd_fbufs_in)->sqh_last = &(fbuf)->fb_hdr.fh_next.sqe_next; } while (0);
 stat_fbufs_in++;
...
fuse_device_set_fmp(struct fusefs_mnt *fmp, int set)
{
 ...
 fd = fuse_lookup(((int32_t)((fmp->dev) & 0xff) | (((fmp->dev) & 0xffff0000) >> 8)));
 if (fd == ((void *)0))
  return;

 fd->fd_fmp = set ? fmp : ((void *)0);
}

void
fuseattach(int num)
{
 do { ((&fuse_d_list)->lh_first) = ((void *)0); } while (0);
}
...
fuseopen(dev_t dev, int flags, int fmt, struct proc * p)
{
 ...
 if ((fd = fuse_create(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)))) == ((void *)0))
  return (16);
...
fuseclose(dev_t dev, int flags, int fmt, struct proc *p)
{
 ...
 if (fd->fd_fmp) {
  ...
  if ((vfs_busy(fd->fd_fmp->mp, 0x02|0x04)) != 0)
   goto end;
  error = dounmount(fd->fd_fmp->mp, 0x00080000, (__curcpu->ci_self)->ci_curproc);
  if (error)
...
fuseioctl(dev_t dev, u_long cmd, caddr_t addr, int flags, struct proc *p)
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct fb_ioctl_xch) & 0x1fff) << 16) | ((('F')) << 8) | ((0))):
  ...
  for((fbuf) = ((&fd->fd_fbufs_in)->sqh_first); (fbuf) != ((void *)0); (fbuf) = ((fbuf)->fb_hdr.fh_next.sqe_next)) {
   if (fbuf->fb_hdr.fh_uuid == ioexch->fbxch_uuid)
    break;
  ...
  if (fbuf == ((&fd->fd_fbufs_in)->sqh_first))
   do { if (((&fd->fd_fbufs_in)->sqh_first = (&fd->fd_fbufs_in)->sqh_first->fb_hdr.fh_next.sqe_next) == ((void *)0)) (&fd->fd_fbufs_in)->sqh_last = &(&fd->fd_fbufs_in)->sqh_first; } while (0);
  else
   do { if (((lastfbuf)->fb_hdr.fh_next.sqe_next = (lastfbuf)->fb_hdr.fh_next.sqe_next->fb_hdr.fh_next.sqe_next) == ((void *)0)) (&fd->fd_fbufs_in)->sqh_last = &(lastfbuf)->fb_hdr.fh_next.sqe_next; } while (0);

  stat_fbufs_in--;


  if (fbuf->fb_hdr.fh_len != ioexch->fbxch_len) {
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct fb_ioctl_xch) & 0x1fff) << 16) | ((('F')) << 8) | ((1))):
  ;
  ioexch = (struct fb_ioctl_xch *)addr;


  for((fbuf) = ((&fd->fd_fbufs_wait)->sqh_first); (fbuf) != ((void *)0); (fbuf) = ((fbuf)->fb_hdr.fh_next.sqe_next)) {
   if (fbuf->fb_hdr.fh_uuid == ioexch->fbxch_uuid)
    break;
  ...
  fbuf->fb_dat = malloc(ioexch->fbxch_len, 65,
      0x0001 | 0x0008);
  ...
  if (fbuf == ((&fd->fd_fbufs_wait)->sqh_first))
   do { if (((&fd->fd_fbufs_wait)->sqh_first = (&fd->fd_fbufs_wait)->sqh_first->fb_hdr.fh_next.sqe_next) == ((void *)0)) (&fd->fd_fbufs_wait)->sqh_last = &(&fd->fd_fbufs_wait)->sqh_first; } while (0);
  else
   do { if (((lastfbuf)->fb_hdr.fh_next.sqe_next = (lastfbuf)->fb_hdr.fh_next.sqe_next->fb_hdr.fh_next.sqe_next) == ((void *)0)) (&fd->fd_fbufs_wait)->sqh_last = &(lastfbuf)->fb_hdr.fh_next.sqe_next; } while (0);
...
fuseread(dev_t dev, struct uio *uio, int ioflag)
{
 ...
 if ((((&fd->fd_fbufs_in)->sqh_first) == ((void *)0))) {
  if (ioflag & 0x0004)
   return (35);

  goto end;
 }
 fbuf = ((&fd->fd_fbufs_in)->sqh_first);
 ...
 __builtin_memcpy((&fbuf->fb_hdr.fh_next), (&hdr.fh_next), (sizeof(fbuf->fb_hdr.fh_next)));
 fbuf->fb_dat = tmpaddr;
...
fusewrite(dev_t dev, struct uio *uio, int ioflag)
{
 ...
 for((fbuf) = ((&fd->fd_fbufs_wait)->sqh_first); (fbuf) != ((void *)0); (fbuf) = ((fbuf)->fb_hdr.fh_next.sqe_next)) {
  if (fbuf->fb_hdr.fh_uuid == hdr.fh_uuid)
   break;
 ...
 fbuf->fb_hdr.fh_len = hdr.fh_len;
 fbuf->fb_hdr.fh_err = hdr.fh_err;
 fbuf->fb_hdr.fh_ino = hdr.fh_ino;


 if ((fbuf->fb_hdr.fh_len && fbuf->fb_hdr.fh_err) ||
     (((&fd->fd_fbufs_wait)->sqh_first) == ((void *)0))) {
