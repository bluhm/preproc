# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
...
void pf_send_tcp(const struct pf_rule *, sa_family_t,
       ...
       u_int8_t, u_int16_t, u_int16_t, u_int8_t, int,
       u_int16_t, u_int);
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c" 2
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_ruleset.c"
...
{
 __builtin_memset((ruleset), (0), (sizeof(struct pf_ruleset)));
 do { (&ruleset->rules.queues[0])->tqh_first = ((void *)0); (&ruleset->rules.queues[0])->tqh_last = &(&ruleset->rules.queues[0])->tqh_first; } while (0);
 do { (&ruleset->rules.queues[1])->tqh_first = ((void *)0); (&ruleset->rules.queues[1])->tqh_last = &(&ruleset->rules.queues[1])->tqh_first; } while (0);
...
pf_find_anchor(const char *path)
{
 ...
 key = malloc(sizeof(*key), 127, 0x0001|0x0004|0x0008);
 if (key == ((void *)0))
  return (((void *)0));
...
pf_find_or_create_ruleset(const char *path)
{
 ...
 if (ruleset != ((void *)0))
  return (ruleset);
 p = malloc(1024, 127, 0x0001|0x0004|0x0008);
 if (p == ((void *)0))
  return (((void *)0));
 strlcpy(p, path, 1024);
...
pf_remove_if_empty_ruleset(struct pf_ruleset *ruleset)
{
 ...
 while (ruleset != ((void *)0)) {
  if (ruleset == &pf_main_anchor.ruleset || ruleset->anchor == ((void *)0) ||
      !((&ruleset->anchor->children)->rbh_root == ((void *)0)) ||
      ruleset->anchor->refcnt > 0 || ruleset->tables > 0 ||
      ruleset->topen)
   return;
  if (!(((ruleset->rules.active.ptr)->tqh_first) == ((void *)0)) ||
      !(((ruleset->rules.inactive.ptr)->tqh_first) == ((void *)0)) ||
      ruleset->rules.inactive.open)
   return;
  pf_anchor_global_RB_REMOVE(&pf_anchors, ruleset->anchor);
  if ((parent = ruleset->anchor->parent) != ((void *)0))
   pf_anchor_node_RB_REMOVE(&parent->children, ruleset->anchor);

  free(ruleset->anchor, 127, sizeof(*(ruleset->anchor)));
  if (parent == ((void *)0))
   return;
    ...
    const char *name)
{
 ...
 if (!name[0])
  return (0);
 path = malloc(1024, 127, 0x0001|0x0004|0x0008);
 if (path == ((void *)0))
  return (1);
 if (name[0] == '/')
  strlcpy(path, name + 1, 1024);
 else {
  ...
  if (s->anchor == ((void *)0) || !s->anchor->path[0])
   ...
   strlcpy(path, s->anchor->path, 1024);
  while (name[0] == '.' && name[1] == '.' && name[2] == '/') {
   if (!path[0]) {
    do { if (pf_status.debug >= (5)) { log(5, "pf: "); addlog("pf_anchor_setup: .. beyond root"); addlog("\n"); } } while (0);
 ...
 if (ruleset == ((void *)0) || ruleset->anchor == ((void *)0)) {
  do { if (pf_status.debug >= (5)) { log(5, "pf: "); addlog("pf_anchor_setup: ruleset"); addlog("\n"); } } while (0);
    ...
    struct pfioc_rule *pr)
{
 ...
 if (!r->anchor_relative) {
  ...
  a = malloc(1024, 127, 0x0001|0x0004|0x0008);
  if (a == ((void *)0))
   return (1);
  if (rs->anchor == ((void *)0))
   a[0] = 0;
  else
   strlcpy(a, rs->anchor->path, 1024);
  ...
  if (strncmp(a, r->anchor->path, strlen(a))) {
   do { if (pf_status.debug >= (5)) { log(5, "pf: "); addlog("pf_anchor_copyout: '%s' '%s'", a, r->anchor->path); addlog("\n"); } } while (0);
...
pf_anchor_remove(struct pf_rule *r)
{
 ...
 if (r->anchor->refcnt <= 0) {
  do { if (pf_status.debug >= (5)) { log(5, "pf: "); addlog("pf_anchor_remove: broken refcount"); addlog("\n"); } } while (0);
