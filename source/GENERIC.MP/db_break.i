# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c"
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c" 2


struct db_breakpoint db_break_table[100];
...
db_breakpoint_alloc(void)
{
 ...
 if (db_next_free_breakpoint == &db_break_table[100]) {
...
# 101 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c"
...
db_set_breakpoints(void)
{
 ...
 if (!db_breakpoints_inserted) {
  for (bkpt = db_breakpoint_list; bkpt != 0; bkpt = bkpt->link) {
   bkpt->bkpt_inst =
       db_get_value(bkpt->address, (4), 0);
   db_put_value(bkpt->address, (4),
       (0x91d02001));
  }
...
db_clear_breakpoints(void)
{
 ...
 if (db_breakpoints_inserted) {
  for (bkpt = db_breakpoint_list; bkpt != 0; bkpt = bkpt->link)
   db_put_value(bkpt->address, (4), bkpt->bkpt_inst);
...
{
 db_breakpoint_t bkpt;
# 196 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_break.c"
 bkpt = db_breakpoint_alloc();
 if (bkpt == 0) {
     db_printf("Too many breakpoints.\n");
     return (0);
 ...
 bkpt->bkpt_inst = db_get_value(bkpt->address, (4), 0);
 db_put_value(bkpt->address, (4), (0x91d02001));
 return bkpt;
}
...
db_list_breakpoints(void)
{
 ...
 for (bkpt = db_breakpoint_list; bkpt != 0; bkpt = bkpt->link) {
  ...
  db_printsym(bkpt->address, 2, db_printf);
  db_printf("\n");
 }
}
