# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
void iommu_dvmamem_free(bus_dma_tag_t, bus_dma_tag_t, bus_dma_segment_t *,
     int);
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
void viommu_dvmamem_free(bus_dma_tag_t, bus_dma_tag_t, bus_dma_segment_t *,
     int);
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
void device_register(struct device *, void *);
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c" 2
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
    ...
    u_int32_t iovabase)
{
 ...
 if (iovabase == (u_int32_t)-1) {
  is->is_dvmabase = (u_int)(0xffffffffU << ((is->is_tsbsize)+10+13));
  is->is_dvmaend = 0xffffffffU;
 } else {
  is->is_dvmabase = iovabase;
  is->is_dvmaend = iovabase + (u_int)(1 << ((tsbsize)+10+13)) - 1;
 }

 do { (&mlist)->tqh_first = ((void *)0); (&mlist)->tqh_last = &(&mlist)->tqh_first; } while (0);
 if (uvm_pglistalloc((1 << 13), 0, -1, (1 << 13), 0, &mlist, 1,
     0x0002 | 0x0004) != 0)
  panic("%s: no memory", __func__);
 m = ((&mlist)->tqh_first);
 is->is_scratch = ((m)->phys_addr);
...
{
 u_int64_t tsbid = ((u_int)(((vaddr_t)(va))-(is->is_dvmabase))>>13);
 paddr_t page_list[1], addr;
 u_int64_t attr, nmapped;
 int err;

 ((sb == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c", 158, "sb == NULL"));


 if (va < is->is_dvmabase || (va + ((1 << 13) - 1)) > is->is_dvmaend)
 ...
 page_list[0] = ((pa) & ~((1 << 13) - 1));
 if (!pmap_extract((&kernel_pmap_), (vaddr_t)page_list, &addr))
...
viommu_remove(struct iommu_state *is, struct strbuf_ctl *sb, bus_addr_t va)
{
 ...
 ((sb == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c", 190, "sb == NULL"));
 ...
 if (err != 0 || ndemapped != 1)
  panic("hv_pci_iommu_unmap: err=%d", err);
}
# 217 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
int
    ...
    bus_dmamap_t *dmamap)
{
 ...
 if (t->_parent == ((void *)0)) panic("null bus_dma parent (" "_dmamap_create" ")"); for (t = t->_parent; t->_dmamap_create == ((void *)0); t = t->_parent) if (t->_parent == ((void *)0)) panic("no bus_dma " "_dmamap_create" " located");;
 ...
 ims = viommu_iomap_create((((((size) + ((1 << 13) - 1)) & ~((1 << 13) - 1))) >> 13));
...
viommu_dvmamap_destroy(bus_dma_tag_t t, bus_dma_tag_t t0, bus_dmamap_t map)
{
 ...
 map->_dm_cookie = ((void *)0);

 if (t->_parent == ((void *)0)) panic("null bus_dma parent (" "_dmamap_destroy" ")"); for (t = t->_parent; t->_dmamap_destroy == ((void *)0); t = t->_parent) if (t->_parent == ((void *)0)) panic("no bus_dma " "_dmamap_destroy" " located");;
 (*t->_dmamap_destroy)(t, t0, map);
}
# 276 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
int
    ...
    void *buf, bus_size_t buflen, struct proc *p, int flags)
{
 ...
 align = (((map->dm_segs[0]._ds_align)>((1 << 13)))?(map->dm_segs[0]._ds_align):((1 << 13)));

 pmap = p ? p->p_vmspace->vm_map.pmap : (&kernel_pmap_);
 ...
 iommu_iomap_clear_pages(ims);
 {
  ...
  aend = (((addr + seg_len) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
  for (a = ((addr) & ~((1 << 13) - 1)); a < aend; a += (1 << 13)) {
   paddr_t pa;

   if (pmap_extract(pmap, a, &pa) == 0)
...
# 391 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
 if (err != 0) {
  iommu_iomap_clear_pages(ims);
  return (err);
 }
...

 {
  ...
  for (a = ((addr) & ~((1 << 13) - 1)); a < aend; a += (1 << 13)) {
   ...
   pgstart = pa | ((((a)>(addr))?(a):(addr)) & ((1 << 13) - 1));
   pgend = pa | ((((a + (1 << 13) - 1)<(addr + seg_len - 1))?(a + (1 << 13) - 1):(addr + seg_len - 1)) & ((1 << 13) - 1));
...
# 460 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
int
    ...
    bus_dma_segment_t *segs, int nsegs, bus_size_t size, int flags)
{
 ...
 align = (((segs[0]._ds_align)>((1 << 13)))?(segs[0]._ds_align):((1 << 13)));
 ...
 if (segs[0]._ds_mlist) {
  ...
  struct vm_page *m;
  for (m = ((mlist)->tqh_first); m != ((void *)0);
      m = ((m)->pageq.tqe_next)) {
   err = iommu_iomap_insert_page(ims, ((m)->phys_addr));
...
# 590 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
 map->_dm_dvmastart = dvmaddr;
 map->_dm_dvmasize = sgsize;
...
# 617 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
int
...
# 655 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
 if (i > 0) {
  seg = &map->dm_segs[i - 1];
...
# 682 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
 if (boundary != 0) {
  bd_mask = ~(boundary - 1);
    ...
    bus_size_t size, bus_size_t boundary)
{
 ...
 int left;
 int seg;
# 748 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
 left = size;
 seg = 0;
 for (i = 0; left > 0 && i < nsegs; i++) {
  ...
  for (a = ((addr) & ~((1 << 13) - 1)); a < aend; a += (1 << 13)) {
   ...
   pgstart = (((a)>(addr))?(a):(addr));
   pgend = (((a + (1 << 13) - 1)<(addr + seg_len - 1))?(a + (1 << 13) - 1):(addr + seg_len - 1));
   pglen = pgend - pgstart + 1;
    ...
    bus_size_t size, bus_size_t boundary)
{
 ...
 for (m = ((mlist)->tqh_first); m != ((void *)0); m = ((m)->pageq.tqe_next)) {
  ...
  err = viommu_dvmamap_append_range(t, map, pa,
      ((((1 << 13))<(size))?((1 << 13)):(size)), flags, boundary);
  if (err == 27)
   return (err);
  if (err) {
...
viommu_dvmamap_unload(bus_dma_tag_t t, bus_dma_tag_t t0, bus_dmamap_t map)
{
 ...
 int error;
# 848 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommu.c"
 is = ims->ims_iommu;
    ...
    int nsegs, int *rsegs, int flags)
{
 ...
 if (t->_parent == ((void *)0)) panic("null bus_dma parent (" "_dmamem_alloc" ")"); for (t = t->_parent; t->_dmamem_alloc == ((void *)0); t = t->_parent) if (t->_parent == ((void *)0)) panic("no bus_dma " "_dmamem_alloc" " located");;
 return ((*t->_dmamem_alloc)(t, t0, size, alignment, boundary,
     segs, nsegs, rsegs, flags | 0x0020));
}
    ...
    int nsegs)
{
 ...
 if (t->_parent == ((void *)0)) panic("null bus_dma parent (" "_dmamem_free" ")"); for (t = t->_parent; t->_dmamem_free == ((void *)0); t = t->_parent) if (t->_parent == ((void *)0)) panic("no bus_dma " "_dmamem_free" " located");;
...
viommu_iomap_create(int n)
{
 ...
 do { (&ims->ims_map.ipm_tree)->sph_root = ((void *)0); } while (0);
    ...
    bus_addr_t vmaddr, int flags)
{
 ...
 for (i = 0, e = ipm->ipm_map; i < ipm->ipm_pagecnt; ++i, ++e) {
  e->ipe_va = vmaddr;
  viommu_enter(is, ((void *)0), e->ipe_va, e->ipe_pa, flags);
  vmaddr += (1 << 13);
 }
}
...
viommu_iomap_unload_map(struct iommu_state *is, struct iommu_map_state *ims)
{
 ...
 for (i = 0, e = ipm->ipm_map; i < ipm->ipm_pagecnt; ++i, ++e)
  viommu_remove(is, ((void *)0), e->ipe_va);
}
