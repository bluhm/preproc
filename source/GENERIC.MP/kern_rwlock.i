# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_rwlock.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_rwlock.c"
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_rwlock.c"
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_rwlock.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_rwlock.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_rwlock.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_rwlock.c" 2
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_rwlock.c"
...
void
_rw_enter_read(struct rwlock *rwl )
{
 unsigned long owner = rwl->rwl_owner;

 if (__builtin_expect((((owner & 0x04UL) || (_atomic_cas_ulong((&rwl->rwl_owner), (owner), (owner + (1UL << 3UL))) != owner)) != 0), 0))

  _rw_enter(rwl, 0x0002UL );
 else {
...
void
_rw_enter_write(struct rwlock *rwl )
{
 struct proc *p = (__curcpu->ci_self)->ci_curproc;

 if (__builtin_expect((((_atomic_cas_ulong((&rwl->rwl_owner), (0), ((((long)p) & ~0x07UL) | 0x04UL)) != 0)) != 0), 0))

  _rw_enter(rwl, 0x0001UL );
 else {
  __asm volatile("membar " "#StoreLoad|#StoreStore" ::: "memory");
  (void)0;
...
void
_rw_exit_read(struct rwlock *rwl )
{
 unsigned long owner = rwl->rwl_owner;
 ...
 if (__builtin_expect((((owner & 0x01UL) || (_atomic_cas_ulong((&rwl->rwl_owner), (owner), (owner - (1UL << 3UL))) != owner)) != 0), 0))
...
void
_rw_exit_write(struct rwlock *rwl )
{
 unsigned long owner = rwl->rwl_owner;
 ...
 __asm volatile("membar " "#LoadStore|#StoreStore" ::: "memory");
 if (__builtin_expect((((owner & 0x01UL) || (_atomic_cas_ulong((&rwl->rwl_owner), (owner), (0)) != owner)) != 0), 0))
...
_rw_init_flags(struct rwlock *rwl, const char *name, int flags,
    struct lock_type *type)
{
 _rw_init_flags_witness(rwl, name, ((((flags) & (0x01)) ? 0x00400000 : 0) | (((flags) & (0x02)) ? 0 : 0x00020000) | (((flags) & (0x04)) ? 0x00800000 : 0) | 0x00010000 | 0x00100000 | 0x00200000 | (LO_CLASS_RWLOCK << 24)), type);
}

int
_rw_enter(struct rwlock *rwl, int flags )
{
 const struct rwlock_op *op;
 struct sleep_state sls;
 unsigned long inc, o;
 int error;
# 231 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_rwlock.c"
 op = &rw_ops[(flags & 0x0007UL) - 1];

 inc = op->inc + (((long)(__curcpu->ci_self)->ci_curproc) & ~0x07UL) * op->proc_mult;
retry:
 while (__builtin_expect(((((o = rwl->rwl_owner) & op->check) != 0) != 0), 0)) {
  ...
  if (flags & 0x0010UL)
   sleep_setup_signal(&sls, op->wait_prio | 0x100);

  do_sleep = !(_atomic_cas_ulong((&rwl->rwl_owner), (o), (set)) != o);
 ...
 if (__builtin_expect((((_atomic_cas_ulong((&rwl->rwl_owner), (o), (o + inc)) != o)) != 0), 0))
  goto retry;
 __asm volatile("membar " "#StoreLoad|#StoreStore" ::: "memory");
 ...
 if (__builtin_expect((((o & (0x04UL|0x01UL)) == (0x04UL|0x01UL)) != 0), 0))
...
_rw_exit(struct rwlock *rwl )
{
 ...
 do {
  ...
  if (wrlock)
   ...
   set = (owner - (1UL << 3UL)) &
    ~(0x01UL|0x02UL);
 } while ((_atomic_cas_ulong((&rwl->rwl_owner), (owner), (set)) != owner));
...
_rrw_init_flags(struct rrwlock *rrwl, char *name, int flags,
    struct lock_type *type)
{
 __builtin_memset((rrwl), (0), (sizeof(struct rrwlock)));
 _rw_init_flags_witness(&rrwl->rrwl_lock, name, ((((flags) & (0x01)) ? 0x00400000 : 0) | (((flags) & (0x02)) ? 0 : 0x00020000) | (((flags) & (0x04)) ? 0x00800000 : 0) | 0x00010000 | 0x00080000 | 0x00100000 | 0x00200000 | (LO_CLASS_RRWLOCK << 24)),
     type);
}

int
_rrw_enter(struct rrwlock *rrwl, int flags )
{
 int rv;
 ...
 rv = _rw_enter(&rrwl->rrwl_lock, flags );
 if (rv == 0)
  rrwl->rrwl_wcnt = 1;
