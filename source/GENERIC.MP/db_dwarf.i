# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_dwarf.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_dwarf.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_dwarf.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_dwarf.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_dwarf.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_dwarf.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_dwarf.c" 2
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ddb/db_dwarf.c"
enum {
 DW_LNS_copy = 1,
 DW_LNS_advance_pc = 2,
...
static _Bool
read_leb128(struct dwbuf *d, uint64_t *v, _Bool signextend)
{
...
{
 return (read_leb128(d, (uint64_t *)v, 1));
}

static _Bool
read_uleb128(struct dwbuf *d, uint64_t *v)
{
 return (read_leb128(d, v, 0));
}
...
next:
 ...
 _Bool basic_block = 0, end_sequence = 0;
 _Bool prologue_end = 0, epilogue_begin = 0;
 ...
 while (read_u8(&unit, &opcode)) {
  _Bool emit = 0, reset_basic_block = 0;
  ...
  if (opcode >= opcode_base) {
   ...
   case DW_LNE_set_address:
    ...
    case 8:
     ...
     break;
    default:
     printf("ddb: " "unexpected address length: %zu" "\n", extra.len);
   ...
   default:
    printf("ddb: " "unknown extended opcode: %d" "\n", opcode);
    goto next;
   }
  } else {
   ...
   case DW_LNS_set_epilogue_begin:
    ...
    break;
   default:
    printf("ddb: " "unknown standard opcode: %d" "\n", opcode);
    goto next;
   }
  }
