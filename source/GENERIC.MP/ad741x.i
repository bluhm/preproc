# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/ad741x.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/ad741x.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/ad741x.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/ad741x.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/ad741x.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/ad741x.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/ad741x.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/ad741x.c" 2
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/ad741x.c"
struct adc_softc {
...
adc_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (sc->sc_chip == 7417 || sc->sc_chip == 7418) {
  sc->sc_sensor[1].type = SENSOR_INTEGER;
  nsens++;
 }
 if (sc->sc_chip == 7417 || sc->sc_chip == 7418) {
  sc->sc_sensor[2].type = SENSOR_INTEGER;
  sc->sc_sensor[3].type = SENSOR_INTEGER;
  sc->sc_sensor[4].type = SENSOR_INTEGER;
  nsens += 3;
 }

 if (sensor_task_register(sc, adc_refresh, 5) == ((void *)0)) {
...
adc_refresh(void *arg)
{
 ...
 reg64 = (sc->sc_config & 0xe0) | (0 << 5);
 if (iic_exec(sc->sc_tag, I2C_OP_WRITE_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &reg64, sizeof reg64, 0))
  goto done;
 delay(1000);
 cmd = 0x00;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
 ...
 sc->sc_sensor[0].value = 273150000 +
     (((__uint16_t)(data)) >> 6) * 250000;

 if (sc->sc_chip == 0)
  goto done;

 if (sc->sc_chip == 7418) {
  reg64 = (reg64 & 0xe0) | (4 << 5);
  if (iic_exec(sc->sc_tag, I2C_OP_WRITE_WITH_STOP,
      sc->sc_addr, &cmd, sizeof cmd, &reg64, sizeof reg64, 0))
   goto done;
  delay(1000);
  ...
  if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
      sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0))
   goto done;
  sc->sc_sensor[1].value = ((__uint16_t)(data)) >> 6;
  goto done;
 }

 for (i = 0; i < 4; i++) {
  reg64 = (reg64 & 0xe0) | (i << 5);
  if (iic_exec(sc->sc_tag, I2C_OP_WRITE_WITH_STOP,
      sc->sc_addr, &cmd, sizeof cmd, &reg64, sizeof reg64, 0))
   goto done;
  delay(1000);
  ...
  if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
      sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0))
   goto done;
  sc->sc_sensor[1 + i].value = ((__uint16_t)(data)) >> 6;
 }
