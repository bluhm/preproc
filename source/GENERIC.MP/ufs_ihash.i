# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c" 2
...
uint64_t SipHash(const SIPHASH_KEY *, int, int, const void *, size_t)
      __attribute__ ((__bounded__ (__buffer__, 4, 5) ));
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_ihash.c" 2




struct ihashhead { struct inode *lh_first; } *ihashtbl;
u_long ihash;
...
ufs_ihashinit(void)
{
 ihashtbl = hashinit(initialvnodes, 28, 0x0001, &ihash);
...
ufs_ihashlookup(dev_t dev, ufsino_t inum)
{
 ...
 ipp = ufs_ihash((dev), (inum));
 for((ip) = ((ipp)->lh_first); (ip)!= ((void *)0); (ip) = ((ip)->i_hash.le_next)) {
...
ufs_ihashins(struct inode *ip)
{
 ...
 ipp = ufs_ihash((dev), (inum));
 for((curip) = ((ipp)->lh_first); (curip)!= ((void *)0); (curip) = ((curip)->i_hash.le_next)) {
 ...
 ((ip->i_flag) |= (0x0100));
 do { if (((ip)->i_hash.le_next = (ipp)->lh_first) != ((void *)0)) (ipp)->lh_first->i_hash.le_prev = &(ip)->i_hash.le_next; (ipp)->lh_first = (ip); (ip)->i_hash.le_prev = &(ipp)->lh_first; } while (0);
...
ufs_ihashrem(struct inode *ip)
{
 ...
 if (ip->i_hash.le_prev == ((void *)0))
  return;
 if (((ip->i_flag) & (0x0100))) {
  do { if ((ip)->i_hash.le_next != ((void *)0)) (ip)->i_hash.le_next->i_hash.le_prev = (ip)->i_hash.le_prev; *(ip)->i_hash.le_prev = (ip)->i_hash.le_next; ((ip)->i_hash.le_prev) = ((void *)-1); ((ip)->i_hash.le_next) = ((void *)-1); } while (0);
  ((ip->i_flag) &= ~(0x0100));
 }

 ip->i_hash.le_next = ((void *)0);
 ip->i_hash.le_prev = ((void *)0);
