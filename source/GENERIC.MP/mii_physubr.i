# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.h" 1
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c" 2
...
const struct mii_media mii_media_table[] = {
 ...
 { 0x0000, 0x0001|0x0020, 0 },

 { 0x0000|0x0100, 0x0001|0x0040, 0 },

 { 0x2000, 0x0001|0x0200, 0 },

 { 0x2000, 0x0001|0x0080, 0 },

 { 0x2000|0x0100, 0x0001|0x0100, 0 },

 { 0x0040, 0x0001, 0 },

 { 0x0040|0x0100, 0x0001, 0 },

 { 0x0040, 0x0001, 0x0100 },

 { 0x0040|0x0100, 0x0001, 0x0200 },
};
...
mii_phy_setmedia(struct mii_softc *sc)
{
 ...
 if (((ife->ifm_media) & 0x00000000000000ffULL) == 0ULL) {
  if (((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00)) & 0x1000) == 0 ||
      (sc->mii_flags & 0x0400))
 ...
 if (ife->ifm_media & 0x0000800000000000ULL)
  bmcr |= 0x4000;

 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x04), (anar));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00), (bmcr));
 if (sc->mii_flags & 0x0040)
  (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x09), (gtcr));
}
...
mii_phy_auto(struct mii_softc *sc, int waitfor)
{
 ...
 if ((sc->mii_flags & 0x0008) == 0) {




  if (sc->mii_flags & 0x0080) {
   uint16_t anar = 0;

   if (sc->mii_extcapabilities & 0x8000)
    anar |= 0x0020;
   if (sc->mii_extcapabilities & 0x4000)
    anar |= 0x0040;

   if (sc->mii_flags & 0x0100 &&
       sc->mii_extcapabilities & 0x8000)
    anar |= (3 << 7);
   ...
   anar = (((sc->mii_capabilities) & (0x8000|0x4000|0x2000| 0x1000|0x0800|0x0400|0x0200)) >> 6) |
       0x0001;
   ...
   if (sc->mii_flags & 0x0100) {
    if (sc->mii_capabilities & 0x4000)
     anar |= 0x0400;
    if (sc->mii_extcapabilities & 0x2000)
     anar |= (3 << 10);
   }
   (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x04), (anar));
   if (sc->mii_flags & 0x0040) {
    ...
    if (sc->mii_extcapabilities & 0x2000)
     gtcr |= 0x0200;
    if (sc->mii_extcapabilities & 0x1000)
     gtcr |= 0x0100;
 ...
 if (waitfor) {
  ...
  for (i = 0; i < 500; i++) {
   if ((bmsr = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x01))) & 0x0020)
    return (0);
   delay(1000);
  }
 ...
 if (sc->mii_flags & 0x0010) {
  sc->mii_flags |= 0x0008;
  tsleep(&sc->mii_flags, 22, "miiaut", hz >> 1);
  mii_phy_auto_timeout(sc);
 } else if ((sc->mii_flags & 0x0008) == 0) {
  sc->mii_flags |= 0x0008;
...
mii_phy_auto_timeout(void *arg)
{
 ...
 (void) (*(sc)->mii_funcs->pf_service)((sc), (sc->mii_pdata), (3));
 _splx(s);
}
...
mii_phy_reset(struct mii_softc *sc)
{
 ...
 if (sc->mii_flags & 0x0002)
  reg64 = 0x8000;
 else
  reg64 = 0x8000 | 0x0400;
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00), (reg64));
# 300 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c"
 delay(500);
 ...
 if (sc->mii_inst != 0 && ((sc->mii_flags & 0x0002) == 0))
...
mii_phy_statusmsg(struct mii_softc *sc)
{
 ...
 if (mii->mii_media_status & 0x0000000000000001ULL) {
 ...
 if (link_state != ifp->if_data.ifi_link_state) {
 ...
 if (baudrate != ifp->if_data.ifi_baudrate) {
  ifp->if_data.ifi_baudrate = baudrate;
  announce = 1;
 }
...
mii_phy_add_media(struct mii_softc *sc)
{
 ...
 if ((sc->mii_flags & 0x0002) == 0)
  ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (2ULL) | (0) | ((uint64_t)(sc->mii_inst) << 56))), (0), ((void *)0));


 if (sc->mii_capabilities & 0x0800) {
  ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (3) | (0) | ((uint64_t)(sc->mii_inst) << 56))), (1), ((void *)0));

 }
 if (sc->mii_capabilities & 0x1000) {
  ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (3) | (0x0000010000000000ULL) | ((uint64_t)(sc->mii_inst) << 56))), (2), ((void *)0));

 }
 if (sc->mii_capabilities & 0x2000) {
  ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (6) | (0) | ((uint64_t)(sc->mii_inst) << 56))), (4), ((void *)0));

 }
 if (sc->mii_capabilities & 0x4000) {
  ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (6) | (0x0000010000000000ULL) | ((uint64_t)(sc->mii_inst) << 56))), (5), ((void *)0));

 }
 if (sc->mii_capabilities & 0x8000) {
  ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (8) | (0) | ((uint64_t)(sc->mii_inst) << 56))), (3), ((void *)0));

 }
 if (sc->mii_extcapabilities & (0x8000|0x4000| 0x2000|0x1000)) {
  ...
  if (sc->mii_extcapabilities & 0x4000) {
   sc->mii_anegticks = 10;
   sc->mii_flags |= 0x0080;
   ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (11) | (0) | ((uint64_t)(sc->mii_inst) << 56))), (6), ((void *)0));

  }
  if (sc->mii_extcapabilities & 0x8000) {
   sc->mii_anegticks = 10;
   sc->mii_flags |= 0x0080;
   ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (11) | (0x0000010000000000ULL) | ((uint64_t)(sc->mii_inst) << 56))), (7), ((void *)0));

  }
# 453 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii_physubr.c"
  if (sc->mii_extcapabilities & 0x1000) {
   sc->mii_anegticks = 10;
   sc->mii_flags |= 0x0040;
   mii->mii_media.ifm_mask |= 0x0000000000010000ULL;
   ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (16) | (0) | ((uint64_t)(sc->mii_inst) << 56))), (8), ((void *)0));
  ...
  if (sc->mii_extcapabilities & 0x2000) {
   ...
   sc->mii_flags |= 0x0040;
   mii->mii_media.ifm_mask |= 0x0000000000010000ULL;
   ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (16) | (0x0000010000000000ULL) | ((uint64_t)(sc->mii_inst) << 56))), (9), ((void *)0));

  }
 }

 if (sc->mii_capabilities & 0x0008) {
  ifmedia_add(&mii->mii_media, (((0x0000000000000100ULL) | (0ULL) | (0) | ((uint64_t)(sc->mii_inst) << 56))), (10), ((void *)0));
...
mii_phy_match(const struct mii_attach_args *ma, const struct mii_phydesc *mpd)
{
 ...
 for (; mpd->mpd_name != ((void *)0); mpd++) {
  if ((((ma->mii_id1) << 6) | ((ma->mii_id2) >> 10)) == mpd->mpd_oui &&
      (((ma->mii_id2) & 0x03f0) >> 4) == mpd->mpd_model)
   return (mpd);
 }
 return (((void *)0));
}
...
mii_phy_flowstatus(struct mii_softc *sc)
{
 ...
 if ((sc->mii_flags & 0x0100) == 0)
  return (0);

 anar = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x04));
 anlpar = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x05));
 ...
 default:
  return (0x0000040000000000ULL|0x0000000000020000ULL|0x0000000000040000ULL);
 }
...
mii_anar(uint64_t media)
{
 ...
 switch (media & (0x00000000000000ffULL|0x000000000000ff00ULL|0x0000010000000000ULL)) {
 case 0x0000000000000100ULL|3:
  rv = 0x0020|0x0001;
  break;
 case 0x0000000000000100ULL|3|0x0000010000000000ULL:
  rv = 0x0040|0x0001;
  break;
 case 0x0000000000000100ULL|6:
  rv = 0x0080|0x0001;
  break;
 case 0x0000000000000100ULL|6|0x0000010000000000ULL:
  rv = 0x0100|0x0001;
  break;
 case 0x0000000000000100ULL|8:
  rv = 0x0200|0x0001;
  break;
 default:
  rv = 0;
