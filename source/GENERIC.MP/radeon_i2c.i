# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_i2c.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_i2c.c"
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_i2c.c"
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_i2c.c" 2
...
struct edid *drm_do_get_edid(struct drm_connector *connector,
 int (*get_edid_block)(void *data, u8 *buf, unsigned int block,
         size_t len),
 void *data);
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_i2c.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_i2c.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_mode.h"
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_i2c.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_i2c.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_i2c.c" 2
...
_Bool radeon_ddc_probe(struct radeon_connector *radeon_connector, _Bool use_aux)
{
 u8 out = 0x0;
 u8 buf[8];
 int ret;
...
static int pre_xfer(void *cookie)
{
 ...
 if (rec->hw_capable) {
  if ((rdev->family >= CHIP_R200) && !((rdev->family >= CHIP_RS600))) {
   u32 reg64;
   ...
   _rw_enter_write(&rdev->dc_hw_i2c_mutex );
   if (rec->a_clk_reg == reg64) {
    r100_mm_wreg(rdev, (0x02e0), (((1 << 5) | ((0) << 3))), 0);

   } else {
    r100_mm_wreg(rdev, (0x02e0), (((1 << 5) | ((2) << 3))), 0);

   }
   _rw_exit_write(&rdev->dc_hw_i2c_mutex );
  }
 }


 if (((rdev->family >= CHIP_RV620)) && rec->hw_capable) {
  temp = r100_mm_rreg(rdev, (rec->mask_clk_reg), 0);
  temp &= ~(1 << 16);
  r100_mm_wreg(rdev, (rec->mask_clk_reg), (temp), 0);
 }


 temp = r100_mm_rreg(rdev, (rec->a_clk_reg), 0) & ~rec->a_clk_mask;
 r100_mm_wreg(rdev, (rec->a_clk_reg), (temp), 0);

 temp = r100_mm_rreg(rdev, (rec->a_data_reg), 0) & ~rec->a_data_mask;
 r100_mm_wreg(rdev, (rec->a_data_reg), (temp), 0);


 temp = r100_mm_rreg(rdev, (rec->en_clk_reg), 0) & ~rec->en_clk_mask;
 r100_mm_wreg(rdev, (rec->en_clk_reg), (temp), 0);

 temp = r100_mm_rreg(rdev, (rec->en_data_reg), 0) & ~rec->en_data_mask;
 r100_mm_wreg(rdev, (rec->en_data_reg), (temp), 0);


 temp = r100_mm_rreg(rdev, (rec->mask_clk_reg), 0) | rec->mask_clk_mask;
 r100_mm_wreg(rdev, (rec->mask_clk_reg), (temp), 0);
 temp = r100_mm_rreg(rdev, (rec->mask_clk_reg), 0);

 temp = r100_mm_rreg(rdev, (rec->mask_data_reg), 0) | rec->mask_data_mask;
 r100_mm_wreg(rdev, (rec->mask_data_reg), (temp), 0);
 temp = r100_mm_rreg(rdev, (rec->mask_data_reg), 0);
...
static int get_clock(void *i2c_priv)
{
 ...
 val = r100_mm_rreg(rdev, (rec->y_clk_reg), 0);
 val &= rec->y_clk_mask;
...
static int get_data(void *i2c_priv)
{
 ...
 val = r100_mm_rreg(rdev, (rec->y_data_reg), 0);
 val &= rec->y_data_mask;
...
static void set_clock(void *i2c_priv, int clock)
{
 ...
 val = r100_mm_rreg(rdev, (rec->en_clk_reg), 0) & ~rec->en_clk_mask;
 val |= clock ? 0 : rec->en_clk_mask;
 r100_mm_wreg(rdev, (rec->en_clk_reg), (val), 0);
}
...
static void set_data(void *i2c_priv, int data)
{
 ...
 val = r100_mm_rreg(rdev, (rec->en_data_reg), 0) & ~rec->en_data_mask;
 val |= data ? 0 : rec->en_data_mask;
 r100_mm_wreg(rdev, (rec->en_data_reg), (val), 0);
}
...
{
 set_clock(cookie, bits & (1 << 1));
 set_data(cookie, bits & (1 << 0));
}
...
static u32 radeon_get_i2c_prescale(struct radeon_device *rdev)
{
 ...
 case CHIP_HEMLOCK:
  ...
  break;
 default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "i2c: unhandled radeon chip\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  break;
 }
 return prescale;
}
       ...
       struct i2c_msg *msgs, int num)
{
 ...
 if (rdev->is_atom_bios) {
  tmp = r100_mm_rreg(rdev, (0x0028), 0);
  r100_mm_wreg(rdev, (0x0028), (tmp | 0x00000200L), 0);
 }
 ...
 if (rec->mm_i2c) {
  ...
  case CHIP_RS300:
   ...
   case 0x0064:
    ...
    break;
   default:
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "gpio not supported with hw i2c\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    ret = -22;
    goto done;
   }
   break;
  ...
  case CHIP_RS480:
   ...
   break;
  default:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "unsupported asic\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   ret = -22;
   goto done;
   break;
  }
 ...
 p = &msgs[0];
 if ((num == 1) && (p->len == 0)) {
  r100_mm_wreg(rdev, (i2c_cntl_0), (((1 << 0) | (1 << 1) | (1 << 2) | (1 << 5))), 0);



  r100_mm_wreg(rdev, (i2c_data), ((p->addr << 1) & 0xff), 0);
  r100_mm_wreg(rdev, (i2c_data), (0), 0);
  r100_mm_wreg(rdev, (i2c_cntl_1), (((1 << 0) | (1 << 4) | (1 << 17) | (48 << 24))), 0);



  r100_mm_wreg(rdev, (i2c_cntl_0), (reg64), 0);
  for (k = 0; k < 32; k++) {
   udelay(10);
   tmp = r100_mm_rreg(rdev, (i2c_cntl_0), 0);
   if (tmp & (1 << 12))
    continue;
   tmp = r100_mm_rreg(rdev, (i2c_cntl_0), 0);
   if (tmp & (1 << 0))
    ...
    do { } while( 0);
    r100_mm_wreg(rdev, (i2c_cntl_0), (tmp | (1 << 11)), 0);
    ret = -5;
    goto done;
   }
  }
 ...
 for (i = 0; i < num; i++) {
  ...
  for (j = 0; j < p->len; j++) {
   if (p->flags & 0x0001) {
    ...
    r100_mm_wreg(rdev, (i2c_data), (((p->addr << 1) & 0xff) | 0x1), 0);
    r100_mm_wreg(rdev, (i2c_cntl_1), (((1 << 0) | (1 << 4) | (1 << 17) | (48 << 24))), 0);



    r100_mm_wreg(rdev, (i2c_cntl_0), (reg64 | (1 << 10)), 0);
    for (k = 0; k < 32; k++) {
     udelay(10);
     tmp = r100_mm_rreg(rdev, (i2c_cntl_0), 0);
     if (tmp & (1 << 12))
    ...
    p->buf[j] = r100_mm_rreg(rdev, (i2c_data), 0) & 0xff;
   } else {
    r100_mm_wreg(rdev, (i2c_cntl_0), (((1 << 0) | (1 << 1) | (1 << 2) | (1 << 5))), 0);
    ...
    r100_mm_wreg(rdev, (i2c_data), ((p->addr << 1) & 0xff), 0);
    r100_mm_wreg(rdev, (i2c_data), (p->buf[j]), 0);
    r100_mm_wreg(rdev, (i2c_cntl_1), (((1 << 0) | (1 << 4) | (1 << 17) | (48 << 24))), 0);
 ...
 r100_mm_wreg(rdev, (i2c_cntl_0), (0), 0);
 r100_mm_wreg(rdev, (i2c_cntl_1), (0), 0);
 r100_mm_wreg(rdev, (i2c_cntl_0), (((1 << 0) | (1 << 1) | (1 << 2) | (1 << 5))), 0);
 ...
 if (rdev->is_atom_bios) {
  tmp = r100_mm_rreg(rdev, (0x0028), 0);
  tmp &= ~0x00000200L;
  r100_mm_wreg(rdev, (0x0028), (tmp), 0);
 }
       ...
       struct i2c_msg *msgs, int num)
{
 ...
 tmp = r100_mm_rreg(rdev, (rec->mask_clk_reg), 0);
 tmp &= ~rec->mask_clk_mask;
 r100_mm_wreg(rdev, (rec->mask_clk_reg), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (rec->mask_clk_reg), 0);

 tmp = r100_mm_rreg(rdev, (rec->mask_data_reg), 0);
 tmp &= ~rec->mask_data_mask;
 r100_mm_wreg(rdev, (rec->mask_data_reg), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (rec->mask_data_reg), 0);


 tmp = r100_mm_rreg(rdev, (rec->a_clk_reg), 0);
 tmp &= ~rec->a_clk_mask;
 r100_mm_wreg(rdev, (rec->a_clk_reg), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (rec->a_clk_reg), 0);

 tmp = r100_mm_rreg(rdev, (rec->a_data_reg), 0);
 tmp &= ~rec->a_data_mask;
 r100_mm_wreg(rdev, (rec->a_data_reg), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (rec->a_data_reg), 0);


 tmp = r100_mm_rreg(rdev, (rec->en_clk_reg), 0);
 tmp &= ~rec->en_clk_mask;
 r100_mm_wreg(rdev, (rec->en_clk_reg), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (rec->en_clk_reg), 0);

 tmp = r100_mm_rreg(rdev, (rec->en_data_reg), 0);
 tmp &= ~rec->en_data_mask;
 r100_mm_wreg(rdev, (rec->en_data_reg), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (rec->en_data_reg), 0);


 tmp = r100_mm_rreg(rdev, (0x0028), 0);
 r100_mm_wreg(rdev, (0x0028), (tmp | 0x00000200L), 0);
 saved1 = r100_mm_rreg(rdev, (0x7d38), 0);
 saved2 = r100_mm_rreg(rdev, (0x494), 0);
 r100_mm_wreg(rdev, (0x494), (saved2 | 0x1), 0);

 r100_mm_wreg(rdev, (0x7d50), ((1 << 0)), 0);
 for (i = 0; i < 50; i++) {
  udelay(1);
  if (r100_mm_rreg(rdev, (0x7d50), 0) & (1 << 1))
   break;
 }
 if (i == 50) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "failed to get i2c bus\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  ret = -16;
  goto done;
 }
 ...
 p = &msgs[0];
 if ((num == 1) && (p->len == 0)) {
  r100_mm_wreg(rdev, (0x7d30), (((1 << 0) | (1 << 1) | (1 << 2))), 0);


  r100_mm_wreg(rdev, (0x7d34), ((1 << 0)), 0);
  udelay(1);
  r100_mm_wreg(rdev, (0x7d34), (0), 0);

  r100_mm_wreg(rdev, (0x7d44), ((p->addr << 1) & 0xff), 0);
  r100_mm_wreg(rdev, (0x7d44), (0), 0);

  r100_mm_wreg(rdev, (0x7d40), (((48) << 24)), 0);
  r100_mm_wreg(rdev, (0x7d3c), ((((1) << 0) | ((1) << 8) | (prescale << 16))), 0);


  r100_mm_wreg(rdev, (0x7d38), (reg64), 0);
  r100_mm_wreg(rdev, (0x7d30), ((1 << 3)), 0);
  for (j = 0; j < 200; j++) {
   udelay(50);
   tmp = r100_mm_rreg(rdev, (0x7d30), 0);
   if (tmp & (1 << 3))
    continue;
   tmp = r100_mm_rreg(rdev, (0x7d30), 0);
   if (tmp & (1 << 0))
    ...
    do { } while( 0);
    r100_mm_wreg(rdev, (0x7d34), ((1 << 8)), 0);
    ret = -5;
    goto done;
   }
  }
 ...
 for (i = 0; i < num; i++) {
  ...
  if (p->flags & 0x0001) {
   while (remaining) {
    ...
    r100_mm_wreg(rdev, (0x7d44), (((p->addr << 1) & 0xff) | 0x1), 0);
    r100_mm_wreg(rdev, (0x7d40), (((48) << 24)), 0);
    r100_mm_wreg(rdev, (0x7d3c), ((((1) << 0) | ((current_count) << 8) | (prescale << 16))), 0);


    r100_mm_wreg(rdev, (0x7d38), (reg64 | (1 << 2)), 0);
    r100_mm_wreg(rdev, (0x7d30), ((1 << 3)), 0);
    for (j = 0; j < 200; j++) {
     udelay(50);
     tmp = r100_mm_rreg(rdev, (0x7d30), 0);
    ...
    for (j = 0; j < current_count; j++)
     p->buf[buffer_offset + j] = r100_mm_rreg(rdev, (0x7d44), 0) & 0xff;
   ...
   while (remaining) {
    ...
    r100_mm_wreg(rdev, (0x7d44), ((p->addr << 1) & 0xff), 0);
    for (j = 0; j < current_count; j++)
     r100_mm_wreg(rdev, (0x7d44), (p->buf[buffer_offset + j]), 0);
 ...
 r100_mm_wreg(rdev, (0x7d50), ((1 << 8)), 0);
 r100_mm_wreg(rdev, (0x7d38), (saved1), 0);
 r100_mm_wreg(rdev, (0x494), (saved2), 0);
 tmp = r100_mm_rreg(rdev, (0x0028), 0);
 tmp &= ~0x00000200L;
 r100_mm_wreg(rdev, (0x0028), (tmp), 0);
       ...
       const char *name)
{
 ...
 i2c = kzalloc(sizeof(struct radeon_i2c_chan), (0x0001 | 0x0004));
 if (i2c == ((void *)0))
  return ((void *)0);
 ...
 if (rec->mm_i2c ||
  ...
  ret = 0;
  if (ret) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to register hw i2c %s\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , name);
   goto out_free;
  }
...
# 1060 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_i2c.c"
  ...
  if (ret) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to register bit i2c %s\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , name);
   goto out_free;
  }
 }
