# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c"
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.h" 1
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/miidevs.h" 1
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphyreg.h" 1
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/jmphy.c" 2
...
jmphy_match(struct device *parent, void *match, void *aux)
{
 ...
 if (mii_phy_match(ma, jmphys) != ((void *)0))
  return (10);
...
jmphy_service(struct mii_softc *sc, struct mii_data *mii, int cmd)
{
 ...
 case 2:
  ...
  if ((((ife->ifm_media) & 0xff00000000000000ULL) >> 56) != sc->mii_inst) {
   ...
   (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00), (bmcr | 0x0400));
   return (0);
  }
 ...
 case 1:
  ...
  if ((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x11)) & 0x0400) {
   sc->mii_ticks = 0;
   break;
  }
...
jmphy_status(struct mii_softc *sc)
{
 ...
 ssr = (*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x11));
 if ((ssr & 0x0400) != 0)
 ...
 if ((ssr & 0x2000) != 0)
  mii->mii_media_active |= 0x0000010000000000ULL | mii_phy_flowstatus(sc);
 else
  mii->mii_media_active |= 0x0000020000000000ULL;

 if (((mii->mii_media_active) & 0x00000000000000ffULL) == 16) {
  if (((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x0a)) & 0x4000) != 0)
...
jmphy_reset(struct mii_softc *sc)
{
 ...
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x1A), ((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x1A)) & ~0x1000));

 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00), (0x8000 | 0x1000));

 for (i = 0; i < 1000; i++) {
  delay(1);
  if (((*(sc)->mii_pdata->mii_readreg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00)) & 0x8000) == 0)
   break;
 }
}
...
jmphy_anar(struct ifmedia_entry *ife)
{
 ...
 case 0ULL:
  anar |= 0x0100 | 0x0080 | 0x0040 | 0x0020;
  break;
 case 16:
  break;
 case 6:
...
jmphy_auto(struct mii_softc *sc, struct ifmedia_entry *ife)
{
 ...
 case 3:
  break;
 case 2ULL:
  (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00), (bmcr | 0x0400 | 0x0800));
  return (-2);
 default:
  return (22);
 }

 if ((ife->ifm_media & 0x0000800000000000ULL) != 0)
  bmcr |= 0x4000;
 ...
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x04), (anar | 0x0001));
 (*(sc)->mii_pdata->mii_writereg)((sc)->mii_dev.dv_parent, (sc)->mii_phy, (0x00), (bmcr | 0x1000 | 0x0200));
