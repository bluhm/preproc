# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c"
...
struct tty;
struct uio;
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/scsi_message.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
void device_register(struct device *, void *);
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lsi64854reg.h" 1
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/ncr53c9xreg.h" 1
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c" 2
...
espattach_sbus(struct device *parent, struct device *self, void *aux)
{
 ...
 if (strcmp("SUNW,fas", sa->sa_name) == 0) {
  ...
  lsc = malloc(sizeof (struct lsi64854_softc), 2, 0x0002);
  ...
  __builtin_bcopy((sc->sc_dev.dv_xname), (lsc->sc_dev.dv_xname), (sizeof (lsc->sc_dev.dv_xname)));



  if (bus_space_map(sa->sa_bustag, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset)), sa->sa_reg[0].sbr_size, 0, &lsc->sc_regs) != 0) {


   printf("%s: cannot map dma registers\n", self->dv_xname);
   return;
  }
# 215 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c"
  ...
  if (bus_space_map(sa->sa_bustag, ((((bus_addr_t)sa->sa_reg[1].sbr_slot)<<32)|(sa->sa_reg[1].sbr_offset)), sa->sa_reg[1].sbr_size, 0, &esc->sc_reg) != 0) {
  ...
  esc->sc_pri = sa->sa_intr[0].sbi_pri;
...
# 273 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c"
 ...
 if (esc->sc_dma->sc_rev == 0x40000000)
  (((esc->sc_dma)->reset)(esc->sc_dma));
 ...
 if (sa->sa_npromvaddrs) {
  ...
  if (bus_space_map(sa->sa_bustag, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset)), sa->sa_reg[0].sbr_size, 0, &esc->sc_reg) != 0) {
...
espattach(struct esp_softc *esc, struct ncr53c9x_glue *gluep)
{
 ...
 sc->sc_freq /= 1000000;
# 417 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c"
 sc->sc_cfg1 = sc->sc_id | 0x10;
 sc->sc_cfg2 = 0x08 | 0x02;
 sc->sc_cfg3 = 0x04;
 (*(sc)->sc_glue->gl_write_reg)((sc), (0x0b), (sc->sc_cfg2));

 if (((*(sc)->sc_glue->gl_read_reg)((sc), (0x0b)) & ~0xa0) !=
     (0x08 | 0x02)) {
  sc->sc_rev = 0;
 } else {
  sc->sc_cfg2 = 0x08;
  ...
  sc->sc_cfg3 = (0x04 | 0x01);
  (*(sc)->sc_glue->gl_write_reg)((sc), (0x0c), (sc->sc_cfg3));
  if ((*(sc)->sc_glue->gl_read_reg)((sc), (0x0c)) !=
      (0x04 | 0x01)) {
   sc->sc_rev = 1;
  } else {
   ...
   uid = (*(sc)->sc_glue->gl_read_reg)((sc), (0x0e));
   if (((uid & 0xf8) >> 3) == 0x0a)
    sc->sc_rev = 9;
  }
 }
# 468 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c"
 ...
 case 1:
  ...
  sc->sc_minsync = ((250 * (5)) / (sc)->sc_freq);
  break;
 ...
 icookie = bus_intr_establish(esc->sc_bustag, esc->sc_pri, 5, 0,
...
# 558 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/esp_sbus.c"
u_char
esp_read_reg(struct ncr53c9x_softc *sc, int reg64)
{
 struct esp_softc *esc = (struct esp_softc *)sc;
 u_char v;

 v = bus_space_read_1(esc->sc_bustag, esc->sc_reg, reg64 * 4);
...
void
esp_write_reg(struct ncr53c9x_softc *sc, int reg64, u_char v)
{
 struct esp_softc *esc = (struct esp_softc *)sc;
 ...
 bus_space_write_1(esc->sc_bustag, esc->sc_reg, reg64 * 4, v);
}

u_char
esp_rdreg1(struct ncr53c9x_softc *sc, int reg64)
{
 struct esp_softc *esc = (struct esp_softc *)sc;

 return (bus_space_read_1(esc->sc_bustag, esc->sc_reg, reg64));
}

void
esp_wrreg1(struct ncr53c9x_softc *sc, int reg64, u_char v)
{
 struct esp_softc *esc = (struct esp_softc *)sc;

 bus_space_write_1(esc->sc_bustag, esc->sc_reg, reg64, v);
}
...
esp_dma_isintr(struct ncr53c9x_softc *sc)
{
 ...
 return (((bus_space_read_4((esc->sc_dma)->sc_bustag, (esc->sc_dma)->sc_regs, 0)) & (0x00000001|0x00000002)));
}
...
esp_dma_intr(struct ncr53c9x_softc *sc)
{
 ...
 return ((((esc->sc_dma)->intr)(esc->sc_dma)));
}
    ...
    int datain, size_t *dmasize)
{
 ...
 return ((((esc->sc_dma)->setup)(esc->sc_dma, addr, len, datain, dmasize)));
}
...
esp_dma_go(struct ncr53c9x_softc *sc)
{
 ...
 do { u_int32_t csr = (bus_space_read_4((esc->sc_dma)->sc_bustag, (esc->sc_dma)->sc_regs, 0)); csr |= 0x00000200; bus_space_write_4((esc->sc_dma)->sc_bustag, (esc->sc_dma)->sc_regs, 0, csr); esc->sc_dma->sc_active = 1; } while (0);
}
...
esp_dma_stop(struct ncr53c9x_softc *sc)
{
 ...
 csr = (bus_space_read_4((esc->sc_dma)->sc_bustag, (esc->sc_dma)->sc_regs, 0));
 csr &= ~0x00000200;
 bus_space_write_4((esc->sc_dma)->sc_bustag, (esc->sc_dma)->sc_regs, 0, csr);
}
