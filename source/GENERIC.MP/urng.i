...
urng_match(struct device *parent, void *match, void *aux)
{
 ...
 if (uaa->iface == ((void *)0))
  return (0);
 if (((struct urng_type *)usbd_match_device((const struct usb_devno *)(urng_devs), sizeof (urng_devs) / sizeof ((urng_devs)[0]), sizeof ((urng_devs)[0]), (uaa->vendor), (uaa->product))) != ((void *)0))
  return (13);
 return (0);
}
void
