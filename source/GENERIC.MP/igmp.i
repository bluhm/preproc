# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c"
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c"
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 83 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 87 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 89 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 90 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 91 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 92 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 93 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2
...
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c" 2





int *igmpctl_vars[2] = { ((void *)0) };
...
igmp_init(void)
{
 ...
 router_alert = m_get(0x0002, 1);
 if (router_alert == ((void *)0)) {
  printf("%s: no mbuf\n", __func__);
  return;
 }
# 138 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c"
 ra = ((struct ipoption *)((router_alert)->m_hdr.mh_data));
 ra->ipopt_dst.s_addr = ((u_int32_t) ((__uint32_t)((u_int32_t)(0x00000000))));
 ra->ipopt_list[0] = 148;
 ra->ipopt_list[1] = 0x04;
 ra->ipopt_list[2] = 0x00;
 ra->ipopt_list[3] = 0x00;
 router_alert->m_hdr.mh_len = sizeof(ra->ipopt_dst) + ra->ipopt_list[1];
}
...
rti_fill(struct in_multi *inm)
{
 ...
 for (rti = rti_head; rti != 0; rti = rti->rti_next) {
  if (rti->rti_ifidx == inm->inm_ifma.ifma_ifidx) {
   inm->inm_rti = rti;
   if (rti->rti_type == 1)
    return (0x12);
   else
 ...
 if (rti == ((void *)0))
  return (-1);
 rti->rti_ifidx = inm->inm_ifma.ifma_ifidx;
 rti->rti_type = 2;
...
igmp_input_if(struct ifnet *ifp, struct mbuf **mp, int *offp, int proto, int af)
{
 ...
 igmplen = ((__uint16_t)(ip->ip_len)) - iphlen;
 ...
 minlen = iphlen + 8;
 if ((m->m_hdr.mh_flags & 0x0001 || m->m_hdr.mh_len < minlen) &&
     (m = *mp = m_pullup(m, minlen)) == ((void *)0)) {
  igmpstat_inc(igps_rcv_tooshort);
  return 257;
 }
 ...
 igmp = ((struct igmp *)((m)->m_hdr.mh_data));
 ...
 case 0x11:
  ...
  if (igmp->igmp_code == 0) {
   ...
   if (ip->ip_dst.s_addr != ((u_int32_t) ((__uint32_t)((u_int32_t)(0xe0000001))))) {
   ...
   for((ifma) = ((&ifp->if_maddrlist)->tqh_first); (ifma) != ((void *)0); (ifma) = ((ifma)->ifma_list.tqe_next)) {
    ...
    inm = ifmatoinm(ifma);
    if (inm->inm_timer == 0 &&
        !(((u_int32_t)(inm->inm_sin.sin_addr.s_addr) & ((u_int32_t) ((__uint32_t)((u_int32_t)(0xffffff00))))) == ((u_int32_t) ((__uint32_t)((u_int32_t)(0xe0000000)))))) {
     inm->inm_state = 1;
     inm->inm_timer = (arc4random_uniform(10 * 5) + 1);
   ...
   timer = igmp->igmp_code * 5 / 10;
   if (timer == 0)
    timer = 1;
# 336 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c"
   for((ifma) = ((&ifp->if_maddrlist)->tqh_first); (ifma) != ((void *)0); (ifma) = ((ifma)->ifma_list.tqe_next)) {
    if (ifma->ifma_addr->sa_family != 2)
     continue;
    inm = ifmatoinm(ifma);
    if (!(((u_int32_t)(inm->inm_sin.sin_addr.s_addr) & ((u_int32_t) ((__uint32_t)((u_int32_t)(0xffffff00))))) == ((u_int32_t) ((__uint32_t)((u_int32_t)(0xe0000000))))) &&
        (ip->ip_dst.s_addr == ((u_int32_t) ((__uint32_t)((u_int32_t)(0xe0000001)))) ||
         ip->ip_dst.s_addr == inm->inm_sin.sin_addr.s_addr)) {
 ...
 case 0x12:
  ...
  if (!(((u_int32_t)(igmp->igmp_group.s_addr) & ((u_int32_t) ((__uint32_t)((u_int32_t)(0xf0000000))))) == ((u_int32_t) ((__uint32_t)((u_int32_t)(0xe0000000))))) ||
      igmp->igmp_group.s_addr != ip->ip_dst.s_addr) {
   igmpstat_inc(igps_rcv_badreports);
   m_freem(m);
   return 257;
  }
# 390 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c"
...
# 456 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/igmp.c"
  if ((ip->ip_src.s_addr & ((u_int32_t) ((__uint32_t)((u_int32_t)(0xff000000))))) == 0) {
  ...
  if (!(((u_int32_t)(inm->inm_sin.sin_addr.s_addr) & ((u_int32_t) ((__uint32_t)((u_int32_t)(0xffffff00))))) == ((u_int32_t) ((__uint32_t)((u_int32_t)(0xe0000000))))) &&
   ...
   if (inm->inm_rti->rti_type != 1)
    igmp_sendpkt(ifp, inm,
        0x17,
        ((u_int32_t) ((__uint32_t)((u_int32_t)(0xe0000002)))));
  break;
 case 3:
 case 5:
 case 4:
    ...
    in_addr_t addr)
{
 ...
 m->m_hdr.mh_len = sizeof(struct ip) + 8;
 m->M_dat.MH.MH_pkthdr.len = sizeof(struct ip) + 8;

 ip = ((struct ip *)((m)->m_hdr.mh_data));
 ip->ip_tos = 0;
 ip->ip_len = ((__uint16_t)(sizeof(struct ip) + 8));
 ip->ip_off = 0;
 ip->ip_p = 2;
 ...
 if (addr) {
  ...
  ip->ip_dst = inm->inm_sin.sin_addr;
 }
 ...
 igmp->igmp_type = type;
 igmp->igmp_code = 0;
 igmp->igmp_group = inm->inm_sin.sin_addr;
 igmp->igmp_cksum = 0;
 igmp->igmp_cksum = in_cksum(m, 8);
 m->m_hdr.mh_data -= sizeof(struct ip);
 m->m_hdr.mh_len += sizeof(struct ip);

 m->M_dat.MH.MH_pkthdr.ph_rtableid = ifp->if_data.ifi_rdomain;
 imo.imo_ifidx = inm->inm_ifma.ifma_ifidx;
 imo.imo_ttl = 1;
 ...
 imo.imo_loop = (ip_mrouter[ifp->if_data.ifi_rdomain] != ((void *)0));




 ip_output(m, router_alert, ((void *)0), 0, &imo, ((void *)0), 0);
...
igmp_sysctl_igmpstat(void *oldp, size_t *oldlenp, void *newp)
{
 ...
 extern char _ctassert[(sizeof(igmpstat) == ((sizeof((counters)) / sizeof((counters)[0])) * sizeof(u_long))) ? 1 : -1 ] __attribute__((__unused__));
 __builtin_memset((&igmpstat), (0), (sizeof igmpstat));
 counters_read(igmpcounters, counters, (sizeof((counters)) / sizeof((counters)[0])));
