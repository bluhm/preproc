# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_vm.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_vm.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_vm.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_vm.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_driver.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_driver.h"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/task.h" 1
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/task.h"
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/task.h" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_driver.h" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_api.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_api.h"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_api.h" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.h" 1
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_vm.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_placement.h" 1
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_vm.c" 2




ssize_t ttm_bo_fbdev_io(struct ttm_buffer_object *, const char *,
      char *, size_t, off_t *, _Bool);
    ...
    vm_prot_t access_type, int flags)
{
 ...
 ret = ttm_bo_reserve(bo, 1, 1, 0, 0);
 if (__builtin_expect(!!(ret != 0), 0)) {
  uvmfault_unlockall(ufi, ((void *)0), uobj, ((void *)0));
 ...
 page_offset = ((address - ufi->entry->start) >> 13) +
     drm_vma_node_start(&bo->vma_node) - (ufi->entry->offset >> 13);
 page_last = ((ufi->entry->end - ufi->entry->start) >> 13) +
     drm_vma_node_start(&bo->vma_node) - (ufi->entry->offset >> 13);

 if (__builtin_expect(!!(page_offset >= bo->num_pages), 0)) {
  retval = 4;
  goto out_io_unlock;
 }
# 159 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_vm.c"
 mapprot = ufi->entry->protection;
 if (bo->mem.bus.is_iomem) {
  pmap_flags = ttm_io_prot(bo->mem.placement, 0);
 } else {
  ttm = bo->ttm;
  pmap_flags = (bo->mem.placement & (1 << 16)) ?
 ...
 for (i = 0; i < 16; ++i) {
  if (bo->mem.bus.is_iomem) {
   ...
   if (__builtin_expect(!!(!page && i == 0), 0)) {
    retval = 4;
    goto out_io_unlock;
   } else if (__builtin_expect(!!(!page), 0)) {
    break;
   }
  ...
  ret = pmap_enter(ufi->orig_map->pmap, vaddr,
      paddr | pmap_flags, mapprot, 0x00000020 | mapprot);
  ...
  address += (1 << 13);
  vaddr += (1 << 13);
  if (__builtin_expect(!!(++page_offset >= page_last), 0))
   break;
 }
 ;
out_io_unlock:
...
out_unlock:
 uvmfault_unlockall(ufi, ufi->entry->aref.ar_amap, ((void *)0), ((void *)0));
 ttm_bo_unreserve(bo);
 return retval;
}
...
{
 struct drm_vma_offset_node *node;
 struct ttm_buffer_object *bo = ((void *)0);

 drm_vma_offset_lock_lookup(&bdev->vma_manager);

 node = drm_vma_offset_lookup_locked(&bdev->vma_manager, offset, pages);
 if (__builtin_expect(!!(node), 1)) {
  bo = ({ __typeof( ((struct ttm_buffer_object *)0)->vma_node ) *__mptr = (node); (struct ttm_buffer_object *)( (char *)__mptr - __builtin_offsetof(struct ttm_buffer_object, vma_node) );});
...
ttm_bo_mmap(voff_t off, vsize_t size, struct ttm_bo_device *bdev)
{
 ...
 bo = ttm_bo_vm_lookup(bdev, off >> 13, size >> 13);
 if (__builtin_expect(!!(!bo), 0)) {
   ret = -22;
  return ((void *)0);
 }

 driver = bo->bdev->driver;
 if (__builtin_expect(!!(!driver->verify_access), 0)) {
  ret = -1;
  goto out_unref;
 }
...
# 310 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_vm.c"
 bo->uobj.uo_refs++;
...
;
# 331 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_vm.c"
;


ssize_t ttm_bo_io(struct ttm_bo_device *bdev, struct file *filp,
    const char *wbuf, char *rbuf, size_t count,
    off_t *f_pos, _Bool write)
{
 struct ttm_buffer_object *bo;
 struct ttm_bo_driver *driver;
 struct ttm_bo_kmap_obj map;
 unsigned long dev_offset = (*f_pos >> 13);
 ...
 if (__builtin_expect(!!(kmap_offset >= bo->num_pages), 0)) {
  ret = -27;
  goto out_unref;
 }

 page_offset = *f_pos & ((1 << 13) - 1);
 io_size = bo->num_pages - kmap_offset;
 io_size = (io_size << 13) - page_offset;
 if (count < io_size)
  io_size = count;

 kmap_end = (*f_pos + count - 1) >> 13;
...
ssize_t ttm_bo_fbdev_io(struct ttm_buffer_object *bo, const char *wbuf,
   char *rbuf, size_t count, off_t *f_pos,
   _Bool write)
{
 struct ttm_bo_kmap_obj map;
 unsigned long kmap_offset;
