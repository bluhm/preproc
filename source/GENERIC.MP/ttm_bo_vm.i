        ...
        unsigned long pages)
{
 ...
 if (__builtin_expect(!!(node), 1)) {
  bo = ({ const __typeof( ((struct ttm_buffer_object *)0)->vma_node ) *__mptr = (node); (struct ttm_buffer_object *)( (char *)__mptr - __builtin_offsetof(struct ttm_buffer_object, vma_node) );});
