# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c"
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 89 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 92 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 96 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 98 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 100 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 101 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 102 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
...
# 103 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 104 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mosreg.h" 1
# 138 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mosreg.h"
struct mos_type {
...
struct mos_cdata {
 struct mos_chain mos_tx_chain[1];
 struct mos_chain mos_rx_chain[1];
 int mos_tx_prod;
 int mos_tx_cons;
 int mos_tx_cnt;
 int mos_rx_prod;
...
# 106 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c" 2
# 119 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_mos.c"
const struct mos_type mos_devs[] = {
 { { 0x9710, 0x7730 }, 0x0001 },
 { { 0x9710, 0x7830 }, 0x0002 },
 { { 0x9710, 0x7832 }, 0x0004 },
 { { 0x0df6, 0x0021 }, 0x0002 },
};
...
{
 sc->mos_refcnt++;
 _rw_enter_write(&sc->mos_mii_lock );
}

void
mos_unlock_mii(struct mos_softc *sc)
{
 _rw_exit_write(&sc->mos_mii_lock );
 if (--sc->mos_refcnt < 0)
  usb_detach_wakeup(&sc->mos_dev);
}

int
mos_reg_read_1(struct mos_softc *sc, int reg64)
{
...
int
mos_reg_read_2(struct mos_softc *sc, int reg64)
{
 usb_device_request_t req;
 usbd_status err;
 uWord val;
...
int
mos_reg_write_1(struct mos_softc *sc, int reg64, int aval)
{
 usb_device_request_t req;
 usbd_status err;
 uByte val;
...
int
mos_reg_write_2(struct mos_softc *sc, int reg64, int aval)
{
 usb_device_request_t req;
 usbd_status err;
 uWord val;
...
mos_readmac(struct mos_softc *sc, u_char *mac)
{
 ...
 req.bRequest = 0x0e;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0x0f), (req.wIndex)[1] = (u_int8_t)((0x0f) >> 8));
...
mos_write_mcast(struct mos_softc *sc, u_char *hashtbl)
{
 ...
 req.bRequest = 0x0d;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0x00), (req.wIndex)[1] = (u_int8_t)((0x00) >> 8));
...
int
mos_miibus_readreg(struct device *dev, int phy, int reg64)
{
 ...
 mos_reg_write_2(sc, 0x0a, 0);
 mos_reg_write_1(sc, 0x0c, (phy & 0x1f) |
     0x40);
 mos_reg_write_1(sc, 0x0d, (reg64 & 0x1f) |
     0x80);

 for (i = 0; i < 1000; i++) {
  if (mos_reg_read_1(sc, 0x0d) & 0x40)
   break;
 }
 if (i == 1000) {
...
void
mos_miibus_writereg(struct device *dev, int phy, int reg64, int val)
{
 struct mos_softc *sc = (void *)dev;
 int i;
...
{
 struct mos_softc *sc = (void *)dev;
 struct mii_data *mii = (&(sc)->mos_mii);
 int val, err;

 mos_lock_mii(sc);


 val = mos_reg_read_1(sc, 0x0e);
 val &= ~(0x08 | 0x10);
 mos_reg_write_1(sc, 0x0e, val);


 mos_reg_write_1(sc, 0x15, 0);
 ...
 val |= (0x08 | 0x10);
 err = mos_reg_write_1(sc, 0x0e, val);
 mos_unlock_mii(sc);
...
mos_iff(struct mos_softc *sc)
{
 ...
 if (ifp->if_flags & 0x100 || ac->ac_multirangecnt > 0) {
  ...
  while (enm != ((void *)0)) {
   h = ether_crc32_be(enm->enm_addrlo, 6) >> 26;
 ...
 h = ether_crc32_be(etherbroadcastaddr, 6) >> 26;
 hashtbl[h / 8] |= 1 << (h % 8);

 mos_write_mcast(sc, (void *)&hashtbl);
 mos_reg_write_1(sc, 0x0e, rxmode);
}
...
mos_reset(struct mos_softc *sc)
{
 ...
 ctl = mos_reg_read_1(sc, 0x0e);
 ctl &= ~(0x01 | 0x02 | 0x08 |
     0x10);

 mos_reg_write_1(sc, 0x0e, ctl);
...
mos_chip_init(struct mos_softc *sc)
{
 ...
 if (mos_reg_read_1(sc, 0x16) != -1) {
  for (i=0;i<3;i++)
   mos_reg_write_1(sc, 0x16, 0);
 }
...
mos_match(struct device *parent, void *match, void *aux)
{
 ...
 return (((struct mos_type *)usbd_match_device((const struct usb_devno *)(mos_devs), sizeof (mos_devs) / sizeof ((mos_devs)[0]), sizeof ((mos_devs)[0]), (uaa->vendor), (uaa->product))) != ((void *)0) ?
     13 : 0);
}
...
mos_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 ((&sc->mos_tick_task)->fun = (mos_tick_task), (&sc->mos_tick_task)->arg = (sc), (&sc->mos_tick_task)->type = (0), (&sc->mos_tick_task)->state = 0x0);

 _rw_init_flags(&sc->mos_mii_lock, "mosmii", 0, ((void *)0));
 ((&sc->mos_stop_task)->fun = ((void (*)(void *))mos_stop), (&sc->mos_stop_task)->arg = (sc), (&sc->mos_stop_task)->type = (0), (&sc->mos_stop_task)->state = 0x0);


 err = usbd_device2interface_handle(dev, 0, &sc->mos_iface);
 if (err) {
 ...
 sc->mos_flags = ((struct mos_type *)usbd_match_device((const struct usb_devno *)(mos_devs), sizeof (mos_devs) / sizeof ((mos_devs)[0]), sizeof ((mos_devs)[0]), (uaa->vendor), (uaa->product)))->mos_flags;
 ...
 if (sc->mos_flags & 0x0001)
  printf(" MCS7730");
 else if (sc->mos_flags & 0x0002)
  printf(" MCS7830");
 else if (sc->mos_flags & 0x0004)
  printf(" MCS7832");
 ...
 strlcpy(ifp->if_xname, sc->mos_dev.dv_xname, 16);
...
mos_detach(struct device *self, int flags)
{
 ...
 if (((&sc->mos_stat_ch)->to_flags & 4))
  timeout_del(&sc->mos_stat_ch);

 if (sc->mos_ep[1] != ((void *)0))
  usbd_abort_pipe(sc->mos_ep[1]);
 if (sc->mos_ep[0] != ((void *)0))
  usbd_abort_pipe(sc->mos_ep[0]);
 if (sc->mos_ep[2] != ((void *)0))
  usbd_abort_pipe(sc->mos_ep[2]);
 ...
 mii_detach(&sc->mos_mii, -1, -1);
 ifmedia_delete_instance(&sc->mos_mii.mii_media, ((uint64_t) -1));
...
mos_rxeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (status != USBD_NORMAL_COMPLETION) {
  ...
  if (status == USBD_STALLED)
   usbd_clear_endpoint_stall_async(sc->mos_ep[0]);
  goto done;
 }
 ...
 __builtin_memset((c->mos_buf), (0), (sc->mos_bufsz));


 usbd_setup_xfer(xfer, sc->mos_ep[0],
...
mos_txeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (status != USBD_NORMAL_COMPLETION) {
  ...
  printf("%s: usb error on tx: %s\n", sc->mos_dev.dv_xname,
      usbd_errstr(status));
  if (status == USBD_STALLED)
   usbd_clear_endpoint_stall_async(sc->mos_ep[1]);
  _splx(s);
  return;
 }
...
mos_tick_task(void *xsc)
{
 ...
 mii_tick(mii);
 if (!sc->mos_link && mii->mii_media_status & 0x0000000000000002ULL &&
...
mos_encap(struct mos_softc *sc, struct mbuf *m, int idx)
{
 ...
 m_copydata(m, 0, m->M_dat.MH.MH_pkthdr.len, c->mos_buf);
 length = m->M_dat.MH.MH_pkthdr.len;

 c->mos_mbuf = m;

 usbd_setup_xfer(c->mos_xfer, sc->mos_ep[1],
     c, c->mos_buf, length, 0x08 | 0x01,
     10000, mos_txeof);
...
mos_init(void *xsc)
{
 ...
 sc->mos_ipgs[0] = mos_reg_read_1(sc, 0x08);
 sc->mos_ipgs[1] = mos_reg_read_1(sc, 0x09);
 mos_reg_write_1(sc, 0x08, sc->mos_ipgs[0]);
 mos_reg_write_1(sc, 0x09, sc->mos_ipgs[1]);
 ...
 rxmode = mos_reg_read_1(sc, 0x0e);
 rxmode |= 0x10 | 0x08 | 0x80;
 rxmode &= ~(0x04);
 mos_reg_write_1(sc, 0x0e, rxmode);

 mii_mediachg((&(sc)->mos_mii));


 err = usbd_open_pipe(sc->mos_iface, sc->mos_ed[0],
     0x01, &sc->mos_ep[0]);
 if (err) {
 ...
 err = usbd_open_pipe(sc->mos_iface, sc->mos_ed[1],
     0x01, &sc->mos_ep[1]);
 if (err) {
 ...
 for (i = 0; i < 1; i++) {
  ...
  usbd_setup_xfer(c->mos_xfer, sc->mos_ep[0],
      c, c->mos_buf, sc->mos_bufsz,
      0x04 | 0x01,
      0, mos_rxeof);
...
mos_watchdog(struct ifnet *ifp)
{
 ...
 usbd_get_xfer_status(c->mos_xfer, ((void *)0), ((void *)0), ((void *)0), &stat);
...
mos_stop(struct mos_softc *sc)
{
 ...
 if (sc->mos_ep[0] != ((void *)0)) {
  usbd_abort_pipe(sc->mos_ep[0]);
  err = usbd_close_pipe(sc->mos_ep[0]);
  if (err) {
 ...
 if (sc->mos_ep[1] != ((void *)0)) {
  usbd_abort_pipe(sc->mos_ep[1]);
  err = usbd_close_pipe(sc->mos_ep[1]);
  if (err) {
 ...
 if (sc->mos_ep[2] != ((void *)0)) {
  usbd_abort_pipe(sc->mos_ep[2]);
  err = usbd_close_pipe(sc->mos_ep[2]);
  if (err) {
 ...
 for (i = 0; i < 1; i++) {
  if (sc->mos_cdata.mos_rx_chain[i].mos_mbuf != ((void *)0)) {
   m_freem(sc->mos_cdata.mos_rx_chain[i].mos_mbuf);
   sc->mos_cdata.mos_rx_chain[i].mos_mbuf = ((void *)0);
  }
  if (sc->mos_cdata.mos_rx_chain[i].mos_xfer != ((void *)0)) {
   usbd_free_xfer(sc->mos_cdata.mos_rx_chain[i].mos_xfer);
   sc->mos_cdata.mos_rx_chain[i].mos_xfer = ((void *)0);
  }
 }


 for (i = 0; i < 1; i++) {
  if (sc->mos_cdata.mos_tx_chain[i].mos_mbuf != ((void *)0)) {
   m_freem(sc->mos_cdata.mos_tx_chain[i].mos_mbuf);
   sc->mos_cdata.mos_tx_chain[i].mos_mbuf = ((void *)0);
  }
  if (sc->mos_cdata.mos_tx_chain[i].mos_xfer != ((void *)0)) {
   usbd_free_xfer(sc->mos_cdata.mos_tx_chain[i].mos_xfer);
   sc->mos_cdata.mos_tx_chain[i].mos_xfer = ((void *)0);
  }
 }
