# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs400.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs400.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs400.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs400.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs400.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs400.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs400d.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs400.c" 2
...
void rs400_gart_adjust_size(struct radeon_device *rdev)
{
 ...
 case 2048:
  break;
 default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unable to use IGP GART size %uM\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , (unsigned)(rdev->mc.gtt_size >> 20));

  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Valid GART size for IGP are 32M,64M,128M,256M,512M,1G,2G\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Forcing to 32M GART size\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
...
void rs400_gart_tlb_flush(struct radeon_device *rdev)
{
 ...
 rdev->mc_wreg(rdev, (0x2e), ((1 << 0)));
 do {
  tmp = rdev->mc_rreg(rdev, (0x2e));
  if ((tmp & (1 << 0)) == 0)
   break;
  delay(1);
  timeout--;
 } while (timeout > 0);
 rdev->mc_wreg(rdev, (0x2e), (0));
}
...
int rs400_gart_init(struct radeon_device *rdev)
{
 ...
 if (rdev->gart.ptr) {
  ({ int __ret = !!(1); if (__ret) printf("RS400 GART already initialized\n"); __builtin_expect(!!(__ret), 0); });
  return 0;
 }
 ...
 if (rs400_debugfs_pcie_gart_info_init(rdev))
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to register debugfs file for RS400 GART !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
...
int rs400_gart_enable(struct radeon_device *rdev)
{
 ...
 tmp = rdev->mc_rreg(rdev, (0x3A));
 tmp |= (1 << 1);
 rdev->mc_wreg(rdev, (0x3A), (tmp));
 ...
 if (rdev->family == CHIP_RS690 || (rdev->family == CHIP_RS740)) {
  rdev->mc_wreg(rdev, (0x102), (0xFFFFFFFF));
  rdev->mc_wreg(rdev, (0x103), (0));
 } else {
  r100_mm_wreg(rdev, (0x0170), (0xFFFFFFFF), 0);
  r100_mm_wreg(rdev, (0x0164), (0), 0);
 }
 tmp = (((rdev->mc.gtt_end >> 16) << 16) & 0xFFFF0000);
 tmp |= (((rdev->mc.gtt_start >> 16) << 0) & 0x0000FFFF);
 if ((rdev->family == CHIP_RS690) || (rdev->family == CHIP_RS740)) {
  rdev->mc_wreg(rdev, (0x101), (tmp));
  tmp = r100_mm_rreg(rdev, (0x0030), 0) & ~(1 << 14);
  r100_mm_wreg(rdev, (0x0030), (tmp), 0);
 } else {
  r100_mm_wreg(rdev, (0x014c), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x0030), 0) & ~(1 << 6);
  r100_mm_wreg(rdev, (0x0030), (tmp), 0);
 }

 tmp = (u32)rdev->gart.table_addr & 0xfffff000;
 tmp |= (((u32)(((rdev->gart.table_addr) >> 16) >> 16)) & 0xff) << 4;

 rdev->mc_wreg(rdev, (0x2c), (tmp));

 rdev->mc_wreg(rdev, (0x2b), (((1 << 18) | (1 << 25) | (1 << 30))));



 rdev->mc_wreg(rdev, (0x39), ((1 << 22) | (1 << 24)));




 if ((rdev->family == CHIP_RS690) || (rdev->family == CHIP_RS740)) {
  tmp = rdev->mc_rreg(rdev, (0x18));
  tmp |= (1 << 12) | (1 << 14);
  rdev->mc_wreg(rdev, (0x18), (tmp));
 } else {
  tmp = rdev->mc_rreg(rdev, (0x18));
  tmp |= (1 << 12);
  rdev->mc_wreg(rdev, (0x18), (tmp));
 ...
 rdev->mc_wreg(rdev, (0x38), (((1 << 0) | size_reg)));
...
int rs400_gart_set_page(struct radeon_device *rdev, int i, uint64_t addr)
{
 ...
 entry = (((u32)(addr)) & ~((1 << 13) - 1)) |
  ...
  (1 << 2) | (1 << 3);
 entry = __extension__({ __uint32_t __swap32gen_x = (entry); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
 gtt[i] = entry;
 return 0;
}
...
static void rs400_gpu_init(struct radeon_device *rdev)
{
 ...
 if (rs400_mc_wait_for_idle(rdev)) {
  printf("" "rs400: Failed to wait MC idle while " "programming pipes. Bad things might happen. %08x\n", r100_mm_rreg(rdev, (0x0150), 0));
...
uint32_t rs400_mc_rreg(struct radeon_device *rdev, uint32_t reg64)
{
 ...
 r100_mm_wreg(rdev, (0x168), (reg64 & 0xff), 0);
 r = r100_mm_rreg(rdev, (0x16c), 0);
 r100_mm_wreg(rdev, (0x168), (0xff), 0);
 return r;
}

void rs400_mc_wreg(struct radeon_device *rdev, uint32_t reg64, uint32_t v)
{
 r100_mm_wreg(rdev, (0x168), (((reg64) & 0xff) | (1 << 8)), 0);
 r100_mm_wreg(rdev, (0x16c), ((v)), 0);
 r100_mm_wreg(rdev, (0x168), (0xff), 0);
}
# 366 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs400.c"
static int rs400_debugfs_pcie_gart_info_init(struct radeon_device *rdev)
{
...
static void rs400_mc_program(struct radeon_device *rdev)
{
 ...
 if (rs400_mc_wait_for_idle(rdev))
  printf("drm:pid%d:%s *WARNING* " "rs400: Wait MC idle timeout before updating MC.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
