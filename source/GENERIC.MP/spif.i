# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c"
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c"
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
void device_register(struct device *, void *);
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spifreg.h" 1
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spifvar.h" 1
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spifvar.h"
struct stty_port {
 struct tty *sp_tty;
 struct spif_softc *sp_sc;
 int sp_channel;
 u_char *sp_rbuf;
 u_char *sp_rend;
 u_char *sp_rget;
...
struct spif_softc {
 ...
 bus_space_handle_t sc_stch;
 bus_space_handle_t sc_istch;
 bus_space_handle_t sc_dtrh;
 bus_space_handle_t sc_ppch;
 struct spifregs *sc_regs;
 struct stty_softc *sc_ttys;
 struct sbpp_softc *sc_bpps;
};
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c" 2
...
# 147 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/spif.c"
int
 ...
 void *aux;
{
 ...
 if (bus_space_map(sa->sa_bustag, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset)), sa->sa_reg[0].sbr_size, 0, &sc->sc_regh) != 0) {
 ...
 if (bus_space_subregion(sc->sc_bustag, sc->sc_regh,
     0x400, 0x8, &sc->sc_dtrh) != 0) {
  printf(": can't map dtr regs\n");
  goto fail_unmapregs;
 }

 if (bus_space_subregion(sc->sc_bustag, sc->sc_regh,
     0x800, 0x80, &sc->sc_stch) != 0) {
  printf(": can't map dtr regs\n");
  goto fail_unmapregs;
 }

 if (bus_space_subregion(sc->sc_bustag, sc->sc_regh,
     0xc00, 0x80, &sc->sc_istch) != 0) {
  printf(": can't map dtr regs\n");
  goto fail_unmapregs;
 }

 if (bus_space_subregion(sc->sc_bustag, sc->sc_regh,
     0xe00, 0x200, &sc->sc_ppch) != 0) {
  printf(": can't map dtr regs\n");
  goto fail_unmapregs;
 }

 sc->sc_ppcih = bus_intr_establish(sa->sa_bustag,
     sa->sa_intr[1].sbi_pri, 6, 0, spifppcintr, sc,
     self->dv_xname);
 if (sc->sc_ppcih == ((void *)0)) {
  printf(": failed to establish ppc interrupt\n");
  goto fail_unmapregs;
 }

 sc->sc_stcih = bus_intr_establish(sa->sa_bustag,
     sa->sa_intr[0].sbi_pri, 6, 0, spifstcintr, sc,
     self->dv_xname);
 if (sc->sc_stcih == ((void *)0)) {
  printf(": failed to establish stc interrupt\n");
  goto fail_unmapregs;
 }

 sc->sc_softih = softintr_establish(6, spifsoftintr, sc);
 if (sc->sc_softih == ((void *)0)) {
 ...
 sc->sc_rev2 = bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x6b));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x40), (0));

 stty_write_ccr(sc, 0x80 | 0x01);
 while (bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x40)) != 0xff);
 while (bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x6b)) != sc->sc_rev2);

 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x70), (0xf0));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x71), (0x00));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x61), ((0x80 | 0x75)));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x62), ((0x80 | 0x76)));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x63), ((0x80 | 0x77)));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x40), (0));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x41), (0));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x42), (0));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x43), (0));

 printf(": rev %x chiprev %x osc %sMHz\n",
     sc->sc_rev, sc->sc_rev2, clockfreq(sc->sc_osc));

 (void)config_found_sm((self), (sttymatch), (((void *)0)), ((void *)0));
 (void)config_found_sm((self), (sbppmatch), (((void *)0)), ((void *)0));
 ...
 void *vcf, *aux;
{
 ...
 return (aux == sttymatch && sc->sc_ttys == ((void *)0));
}
 ...
 void *aux;
{
 ...
 for (port = 0; port < sc->sc_nser; port++) {
  ...
  do { sc->sc_ttys->sc_port[(port)].sp_dtr = 0; bus_space_write_1((sc)->sc_bustag, sc->sc_dtrh, port, (0 == 0) ? 1 : 0); } while (0);
  ...
  sp->sp_rbuf = malloc((2 * 512), 2, 0x0002);
  if(sp->sp_rbuf == ((void *)0))
   break;

  sp->sp_rend = sp->sp_rbuf + (2 * 512);
 }
 ...
 struct proc *p;
{
 ...
 int port = (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x07);
 int s;
 ...
 if (!((tp->t_state) & (0x00020))) {
  ...
  if (((sp->sp_openflags) & (0x02)))
   ((tp->t_termios.c_cflag) |= (0x00008000));
  if (((sp->sp_openflags) & (0x04)))
   ((tp->t_termios.c_cflag) |= (0x00010000));
  if (((sp->sp_openflags) & (0x08)))
  ...
  bus_space_write_1((csc)->sc_bustag, (csc)->sc_stch, (0x64), (sp->sp_channel));
  stty_write_ccr(csc, 0x80|0x00);
  bus_space_write_1((csc)->sc_bustag, (csc)->sc_stch, (0x64), (sp->sp_channel));
  ...
  bus_space_write_1((csc)->sc_bustag, (csc)->sc_stch, (0x02), (0x40 | 0x10));

  if (((sp->sp_openflags) & (0x01)) || sp->sp_carrier)
   ((tp->t_state) |= (0x00008));
  else
   ((tp->t_state) &= ~(0x00008));
 }
 ...
 if (!((flags) & (0x0004))) {
  while (!((tp->t_termios.c_cflag) & (0x00008000)) &&
      !((tp->t_state) & (0x00008))) {
   int error;
...
sttyclose(dev, flags, mode, p)
 ...
 struct proc *p;
{
 struct stty_softc *sc = stty_cd.cd_devs[((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) >> 6) & 0x03)];
 struct stty_port *sp = &sc->sc_port[(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x07)];
 ...
 if (((tp->t_termios.c_cflag) & (0x00004000)) || !((tp->t_state) & (0x00020))) {
  stty_modem_control(sp, 0, 0);
  bus_space_write_1((csc)->sc_bustag, (csc)->sc_stch, (0x64), (port));
  bus_space_write_1((csc)->sc_bustag, (csc)->sc_stch, (0x01), (0x80|0x00));
...
sttyioctl(dev, cmd, data, flags, p)
 ...
 struct proc *p;
{
 struct stty_softc *stc = stty_cd.cd_devs[((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) >> 6) & 0x03)];
 struct stty_port *sp = &stc->sc_port[(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x07)];
 ...
 case ((unsigned long)0x20000000 | ((0 & 0x1fff) << 16) | ((('t')) << 8) | ((123))):
  ((sp->sp_flags) |= (0x08));
  bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x64), (sp->sp_channel));
  bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x02), (bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x02)) | 0x04));
 ...
 int bits, how;
{
 ...
 case 3:
  bits = 0001;
  if (((csc)->sc_ttys->sc_port[(sp->sp_channel)].sp_dtr))
   bits |= 0002;
  msvr = bus_space_read_1((csc)->sc_bustag, (csc)->sc_stch, (0x28));
  if (((msvr) & (0x80)))
   bits |= 0400;
  if (((msvr) & (0x40)))
   bits |= 0100;
  ...
  break;
 case 0:
  do { csc->sc_ttys->sc_port[(sp->sp_channel)].sp_dtr = ((bits) & (0002)) ? 1 : 0; bus_space_write_1((csc)->sc_bustag, csc->sc_dtrh, sp->sp_channel, (((bits) & (0002)) ? 1 : 0 == 0) ? 1 : 0); } while (0);
  if (((bits) & (0004)))
   bus_space_write_1((csc)->sc_bustag, (csc)->sc_stch, (0x28), (bus_space_read_1((csc)->sc_bustag, (csc)->sc_stch, (0x28)) & (~0x01)));
 ...
 case 1:
  if (((bits) & (0002)))
   do { csc->sc_ttys->sc_port[(sp->sp_channel)].sp_dtr = 1; bus_space_write_1((csc)->sc_bustag, csc->sc_dtrh, sp->sp_channel, (1 == 0) ? 1 : 0); } while (0);
 ...
 case 2:
  if (((bits) & (0002)))
   do { csc->sc_ttys->sc_port[(sp->sp_channel)].sp_dtr = 0; bus_space_write_1((csc)->sc_bustag, csc->sc_dtrh, sp->sp_channel, (0 == 0) ? 1 : 0); } while (0);
  if (((bits) & (0004)))
   bus_space_write_1((csc)->sc_bustag, (csc)->sc_stch, (0x28), (bus_space_read_1((csc)->sc_bustag, (csc)->sc_stch, (0x28)) | 0x01));
...
stty_param(tp, t)
 ...
 struct termios *t;
{
 struct stty_softc *st = stty_cd.cd_devs[((((int32_t)((tp->t_dev) & 0xff) | (((tp->t_dev) & 0xffff0000) >> 8)) >> 6) & 0x03)];
 struct stty_port *sp = &st->sc_port[(((int32_t)((tp->t_dev) & 0xff) | (((tp->t_dev) & 0xffff0000) >> 8)) & 0x07)];
 struct spif_softc *sc = sp->sp_sc;
 ...
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x03), (opt));
 stty_write_ccr(sc, 0x40|0x02);

 opt = 0x20;
 if (((t->c_cflag) & (0x00010000)))
  opt |= 0x02;
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x04), (opt));
 stty_write_ccr(sc, 0x40|0x04);

 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x05), (4));
 stty_write_ccr(sc, 0x40|0x08);

 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x09), (0x11));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x0a), (0x13));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x0b), (0x11));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x0c), (0x13));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x18), (0x12));

 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x10), (0x40 | 7));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x11), (0x40));
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x12), (0));

 if (t->c_ospeed) {
  bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x39), (tbprh));
  bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x3a), (tbprl));
 }

 if (t->c_ispeed) {
  bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x31), (rbprh));
  bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x32), (rbprl));
 }

 stty_write_ccr(sc, 0x10 |
     0x08 | 0x02);

 sp->sp_carrier = bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x28)) & 0x40;
...
sttystop(tp, flags)
 ...
 int flags;
{
 struct stty_softc *sc = stty_cd.cd_devs[((((int32_t)((tp->t_dev) & 0xff) | (((tp->t_dev) & 0xffff0000) >> 8)) >> 6) & 0x03)];
 struct stty_port *sp = &sc->sc_port[(((int32_t)((tp->t_dev) & 0xff) | (((tp->t_dev) & 0xffff0000) >> 8)) & 0x07)];
 int s;
...
stty_start(tp)
 struct tty *tp;
{
 struct stty_softc *stc = stty_cd.cd_devs[((((int32_t)((tp->t_dev) & 0xff) | (((tp->t_dev) & 0xffff0000) >> 8)) >> 6) & 0x03)];
 struct stty_port *sp = &stc->sc_port[(((int32_t)((tp->t_dev) & 0xff) | (((tp->t_dev) & 0xffff0000) >> 8)) & 0x07)];
 struct spif_softc *sc = sp->sp_sc;
 int s;
 ...
 int *needsoftp;
{
 ...
 channel = (((bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x41))) >> 2) & 7);
 sp = &sc->sc_ttys->sc_port[channel];
 ptr = sp->sp_rput;
 *ptr++ = bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x7a));
 *ptr++ = bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x78));
 if (ptr == sp->sp_rend)
  ptr = sp->sp_rbuf;
 if (ptr == sp->sp_rget) {
  if (ptr == sp->sp_rbuf)
 ...
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x7f), (0));
 *needsoftp = 1;
 sp->sp_rput = ptr;
 return (1);
}
 ...
 int *needsoftp;
{
 ...
 sp = &sc->sc_ttys->sc_port[channel];
 ptr = sp->sp_rput;
 cnt = bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x07));
 for (i = 0; i < cnt; i++) {
  *ptr++ = 0;
  rcsr = bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x7a));
  *ptr++ = bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x78));
  if (ptr == sp->sp_rend)
   ptr = sp->sp_rbuf;
  if (ptr == sp->sp_rget) {
 ...
 int *needsoftp;
{
 ...
 if (!((sp->sp_flags) & (0x20))) {
  if (((sp->sp_flags) & (0x08))) {
   bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x7b), (0));
   bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x7b), (0x81));
   ((sp->sp_flags) &= ~(0x08));
   cnt += 2;
  }
  if (((sp->sp_flags) & (0x10))) {
   bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x7b), (0));
   bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x7b), (0x83));
   ((sp->sp_flags) &= ~(0x10));
   cnt += 2;
  }

  while (sp->sp_txc > 0 && cnt < (8 -1)) {
   ch = *sp->sp_txp;
   sp->sp_txc--;
   sp->sp_txp++;

   if (ch == 0) {
    bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x7b), (ch));
    cnt++;
   }
   bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x7b), (ch));
   cnt++;
 ...
 int *needsoftp;
{
 ...
 channel = (((bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x41))) >> 2) & 7);
 sp = &sc->sc_ttys->sc_port[channel];
 mcr = bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x12));
 if (mcr & 0x40) {
  ((sp->sp_flags) |= (0x01));
  *needsoftp = 1;
 }
 ...
 void *vsc;
{
 ...
 for (i = 0; i < 8; i++) {
  ar = bus_space_read_1((sc)->sc_bustag, (sc)->sc_istch, (0x77)) & 0x07;
  if (ar == 0x03)
 ...
 for (i = 0; i < 8; i++) {
  ar = bus_space_read_1((sc)->sc_bustag, (sc)->sc_istch, (0x76)) & 0x07;
  if (ar == 0x02)
   r |= spifstcintr_tx(sc, &needsoft);
 }

 for (i = 0; i < 8; i++) {
  ar = bus_space_read_1((sc)->sc_bustag, (sc)->sc_istch, (0x75)) & 0x07;
  if (ar == 0x01)
 ...
 void *vsc;
{
 ...
 if (stc != ((void *)0)) {
  for (i = 0; i < stc->sc_nports; i++) {
   ...
   s = _splraise(15);
   flags = sp->sp_flags;
   ((sp->sp_flags) &= ~(0x04 | 0x01 | 0x02));

   _splx(s);

   if (((flags) & (0x01))) {
    s = _splraise(6);
    bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x64), (i));
    msvr = bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x28));
    _splx(s);

    sp->sp_carrier = msvr & 0x40;
 ...
 u_int8_t val;
{
 ...
 while (bus_space_read_1((sc)->sc_bustag, (sc)->sc_stch, (0x01)) && tries--)
           ;
 if (tries == 0)
  printf("%s: ccr timeout\n", sc->sc_dev.dv_xname);
 bus_space_write_1((sc)->sc_bustag, (sc)->sc_stch, (0x01), (val));
}
 ...
 void *vcf, *aux;
{
 ...
 return (aux == sbppmatch && sc->sc_bpps == ((void *)0));
}
