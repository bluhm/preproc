# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c"
...
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
void device_register(struct device *, void *);
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c" 2
...
struct cfdriver vldcp_cd = {
 ((void *)0), "vldcp", DV_DULL
};

int vldcp_tx_intr(void *);
int vldcp_rx_intr(void *);
# 96 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vldcp.c"
int vldc_num_ldoms;
...
vldcp_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_tx_ih = bus_intr_establish(ca->ca_bustag, sc->sc_tx_ino,
     6, 0, vldcp_tx_intr, sc, sc->sc_dv.dv_xname);
 sc->sc_rx_ih = bus_intr_establish(ca->ca_bustag, sc->sc_rx_ino,
     6, 0, vldcp_rx_intr, sc, sc->sc_dv.dv_xname);
 ...
 lc->lc_txq = ldc_queue_alloc(sc->sc_dmatag, 128);
 if (lc->lc_txq == ((void *)0)) {
  printf(", can't allocate tx queue\n");
  return;
 }

 lc->lc_rxq = ldc_queue_alloc(sc->sc_dmatag, 128);
 if (lc->lc_rxq == ((void *)0)) {
 ...
 if (strncmp(ca->ca_name, "ldom-", 5) == 0 &&
     strcmp(ca->ca_name, "ldom-primary") != 0) {
  int minor = 32 + vldc_num_ldoms++;
  if (minor < (sizeof((vldc_svc)) / sizeof((vldc_svc)[0])))
...
{
 struct vldcp_softc *sc = ((void *)0);

 if (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) < (sizeof((vldc_svc)) / sizeof((vldc_svc)[0])))
  sc = vldc_svc[((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))].vs_sc;
...
retry:
 ...
 if (rx_head == rx_tail) {
  cbus_intr_setenabled(sc->sc_bustag, sc->sc_rx_ino,
      1);
  ret = tsleep(lc->lc_rxq, 32 | 0x100, "hvrd", 0);
  if (ret) {
   _splx(s);
   device_unref(&sc->sc_dv);
   return (ret);
...
retry:
 ...
 if (tx_head == next_tx_tail) {
  cbus_intr_setenabled(sc->sc_bustag, sc->sc_tx_ino,
      1);
  ret = tsleep(lc->lc_txq, 32 | 0x100, "hvwr", 0);
  if (ret) {
   _splx(s);
   device_unref(&sc->sc_dv);
   return (ret);
...
vldcpioctl(dev_t dev, u_long cmd, caddr_t data, int flag, struct proc *p)
{
 ...
 switch (cmd) {
 case ((unsigned long)0x80000000 | ((sizeof(struct hv_io) & 0x1fff) << 16) | ((('h')) << 8) | ((0))):
 case ((unsigned long)0x80000000 | ((sizeof(struct hv_io) & 0x1fff) << 16) | ((('h')) << 8) | ((1))):
  break;
 default:
  device_unref(&sc->sc_dv);
  return (25);
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct hv_io) & 0x1fff) << 16) | ((('h')) << 8) | ((0))):
  ...
  while (size > 0) {
   ...
   nbytes = min((1 << 13), size);
   err = hv_ldc_copy(lc->lc_id, 0,
