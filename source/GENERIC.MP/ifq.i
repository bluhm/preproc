# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ifq.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ifq.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ifq.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ifq.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ifq.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ifq.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ifq.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ifq.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ifq.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ifq.c" 2
...
ifq_serialize(struct ifqueue *ifq, struct task *t)
{
 ...
 if (ifq->ifq_serializer == ((void *)0)) {
  ifq->ifq_serializer = (__curcpu->ci_self);

  while ((t = ((&ifq->ifq_task_list)->tqh_first)) != ((void *)0)) {
...
ifq_start_task(void *p)
{
 ...
 if (!((ifp->if_flags) & (0x40)) ||
     (((ifq)->ifq_len) == 0) || ifq_is_oactive(ifq))
  return;
...
ifq_enqueue(struct ifqueue *ifq, struct mbuf *m)
{
 ...
 if (dm != m) {
  ifq->ifq_packets++;
  ifq->ifq_bytes += m->M_dat.MH.MH_pkthdr.len;
...
ifq_deq_begin(struct ifqueue *ifq)
{
 ...
 ifq_deq_enter(ifq);
 if (ifq->ifq_len == 0 ||
     (m = ifq->ifq_ops->ifqop_deq_begin(ifq, &cookie)) == ((void *)0)) {
  ifq_deq_leave(ifq);
  return (((void *)0));
 }

 m->M_dat.MH.MH_pkthdr.ph_cookie = cookie;
...
priq_alloc(unsigned int idx, void *null)
{
 ...
 pq = malloc(sizeof(struct priq), 2, 0x0001);
 for (i = 0; i < 8; i++)
...
priq_enq(struct ifqueue *ifq, struct mbuf *m)
{
 ...
 enqueue:
 pl = &pq->pq_lists[m->M_dat.MH.MH_pkthdr.pf.prio];
 ml_enqueue(pl, m);
...
priq_deq_begin(struct ifqueue *ifq, void **cookiep)
{
 ...
 struct mbuf_list *pl;
 unsigned int prio = (sizeof((pq->pq_lists)) / sizeof((pq->pq_lists)[0]));
 struct mbuf *m;
