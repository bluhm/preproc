# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
void device_register(struct device *, void *);
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c" 2
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c"
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c"
struct vnet_mcast_info {
 struct vio_msg_tag tag;
 uint8_t set;
 uint8_t count;
 uint8_t mcast_addr[7][6];
 uint32_t _reserved;
};
...
# 125 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c"
...
# 156 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vnet.c"
...
vnet_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 pool_init(&sc->sc_pool, 2048, 0, 6, 0, sc->sc_dv.dv_xname, ((void *)0));
 ...
 strlcpy(ifp->if_xname, sc->sc_dv.dv_xname, 16);
 ((&ifp->if_snd)->ifq_maxlen = (31));
...
vnet_rx_vio_desc_data(struct vnet_softc *sc, struct vio_msg_tag *tag)
{
 ...
 switch(tag->stype) {
 case 0x01:
  buf = pool_get(&sc->sc_pool, 0x0002|0x0008);
  if (buf == ((void *)0)) {
   ifp->if_data.ifi_ierrors++;
   goto skip;
  }
  nbytes = ((((dm->nbytes)+((8)-1))/(8))*(8));
 ...
 case 0x02:
  ...
  ((void)_atomic_sub_int_nv((&map->lm_count), 1));

  pool_put(&sc->sc_pool, sc->sc_vsd[cons].vsd_buf);
  sc->sc_vsd[cons].vsd_buf = ((void *)0);
...
vnet_rx_vio_dring_data(struct vnet_softc *sc, struct vio_msg_tag *tag)
{
 ...
 case 0x01:
 {
  ...
  for (;;) {
   ...
   pmap_extract((&kernel_pmap_), (vaddr_t)&desc, &desc_pa);
   err = hv_ldc_copy(lc->lc_id, 0, cookie,
   ...
   if (desc.hdr.dstate != 0x02)
    break;

   if (desc.nbytes > (1518 - 4)) {
    ifp->if_data.ifi_ierrors++;
    goto skip;
   }

   m = m_clget((((void *)0)), (0x0002), (desc.nbytes));
   if (!m)
    break;
   m->m_hdr.mh_len = m->M_dat.MH.MH_pkthdr.len = desc.nbytes;
   nbytes = ((((desc.nbytes + 6)+((8)-1))/(8))*(8));

   pmap_extract((&kernel_pmap_), (vaddr_t)m->m_hdr.mh_data, &pa);
   err = hv_ldc_copy(lc->lc_id, 0,
  ...
  skip:
   desc.hdr.dstate = 0x04;
   nbytes = sc->sc_peer_desc_size;
   err = hv_ldc_copy(lc->lc_id, 1, cookie,
       desc_pa, nbytes, &nbytes);
   if (err != 0)
 ...
 case 0x02:
 {
  ...
  while (sc->sc_vd->vd_desc[cons].hdr.dstate == 0x04) {
   ...
   sc->sc_vd->vd_desc[cons].hdr.dstate = 0x01;
   sc->sc_tx_cons++;
   cons = sc->sc_tx_cons & (sc->sc_vd->vd_nentries - 1);
  }
...
vnet_ldc_reset(struct ldc_conn *lc)
{
 ...
 for (i = 0; i < sc->sc_vd->vd_nentries; i++) {
  if (sc->sc_vsd[i].vsd_buf) {
   ...
   sc->sc_vsd[i].vsd_buf = ((void *)0);
  }
  sc->sc_vd->vd_desc[i].hdr.dstate = 0x01;
 }
}
...
vio_send_rdx(struct vnet_softc *sc)
{
 ...
 tag.type = 0x01;
 tag.stype = 0x01;
 tag.stype_env = 0x0005;
 tag.sid = sc->sc_local_sid;
 vnet_sendmsg(sc, &tag, sizeof(tag));

 sc->sc_vio_state |= 0x0200;
}
...
vnet_send_dring_data(struct vnet_softc *sc, uint32_t start_idx)
{
 ...
 peer_state = _atomic_swap_uint(&sc->sc_peer_state, 0x01);
 if (peer_state == 0x01)
  return;
...
vnet_start(struct ifnet *ifp)
{
 ...
 if (sc->sc_xfer_mode == 0x02) {
  vnet_start_desc(ifp);
  return;
 }

 start = prod = sc->sc_tx_prod & (sc->sc_vd->vd_nentries - 1);
 while (sc->sc_vd->vd_desc[prod].hdr.dstate == 0x01) {
  count = sc->sc_tx_prod - sc->sc_tx_cons;
  if (count >= (sc->sc_vd->vd_nentries - 1) ||
  ...
  m_copydata(m, 0, m->M_dat.MH.MH_pkthdr.len, buf + 6);
  ...
  map->lm_slot[map->lm_next].entry |= 0x0000000000000200ULL;
  ((void)_atomic_add_int_nv((&map->lm_count), 1));

  sc->sc_vd->vd_desc[prod].nbytes = max(m->M_dat.MH.MH_pkthdr.len, 60);
  ...
  sc->sc_vd->vd_desc[prod].hdr.dstate = 0x02;
 ...
 if (start != prod && sc->sc_peer_state != 0x01) {
...
vnet_start_desc(struct ifnet *ifp)
{
 ...
 for (;;) {
  ...
  dm.tag.type = 0x02;
  dm.tag.stype = 0x01;
  dm.tag.stype_env = 0x0041;
  dm.tag.sid = sc->sc_local_sid;
  dm.seq_no = sc->sc_seq_no++;
  dm.desc_handle = sc->sc_tx_prod;
  dm.nbytes = max(m->M_dat.MH.MH_pkthdr.len, 60);
  dm.ncookies = 1;
  dm.cookie[0].addr =
   map->lm_next << 13 | (pa & ((1 << 13) - 1));
...
vnet_init(struct ifnet *ifp)
{
 ...
 if (sc->sc_vd == ((void *)0))
  return;
 sc->sc_vsd = malloc(128 * sizeof(*sc->sc_vsd), 2,
     0x0002|0x0008);
 if (sc->sc_vsd == ((void *)0))
  return;
...
vnet_stop(struct ifnet *ifp)
{
 ...
 free(sc->sc_vsd, 2, 128 * sizeof(*sc->sc_vsd));
...
vnet_dring_alloc(bus_dma_tag_t t, int nentries)
{
 ...
 vd = malloc(sizeof(struct vnet_dring), 2, 0x0002);
 if (vd == ((void *)0))
  return ((void *)0);

 size = ((((nentries * sizeof(struct vnet_desc))+(((1 << 13))-1))/((1 << 13)))*((1 << 13)));
 ...
 __builtin_bzero((vd->vd_desc), (nentries * sizeof(struct vnet_desc)));
