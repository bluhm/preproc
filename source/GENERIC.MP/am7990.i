# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c"
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lancereg.h" 1
# 91 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 92 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 93 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 94 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c" 2
...
# 110 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c"
void
am7990_config(struct am7990_softc *sc)
{
 ...
 for (i = 0; i < sc->lsc.sc_nrbuf; i++, mem += 1536)
  sc->lsc.sc_rbufaddr[i] = mem;
 for (i = 0; i < sc->lsc.sc_ntbuf; i++, mem += 1536)
...
am7990_meminit(struct lance_softc *sc)
{
 ...
 if (ifp->if_flags & 0x100)
  init.init_mode = 0 | 0x8000;
 else
  init.init_mode = 0;
 if (sc->sc_initmodemedia == 1)
  init.init_mode |= 0x0080;





 __builtin_memcpy((sc->sc_enaddr), (sc->sc_arpcom.ac_enaddr), (6));
 myaddr = sc->sc_enaddr;
 ...
 a = sc->sc_addr + (sc->sc_rmdaddr + sizeof(struct lermd) * (0));
 init.init_rdra = a;
 init.init_rlen = (a >> 16) | ((ffs(sc->sc_nrbuf) - 1) << 13);

 a = sc->sc_addr + (sc->sc_tmdaddr + sizeof(struct letmd) * (0));
 init.init_tdra = a;
 init.init_tlen = (a >> 16) | ((ffs(sc->sc_ntbuf) - 1) << 13);

 (*sc->sc_copytodesc)(sc, &init, (sc->sc_initaddr), sizeof(init));




 for (bix = 0; bix < sc->sc_nrbuf; bix++) {
  a = sc->sc_addr + (sc->sc_rbufaddr[bix]);
  rmd.rmd0 = a;
  rmd.rmd1_hadr = a >> 16;
  rmd.rmd1_bits = 0x80;
  rmd.rmd2 = -1536 | 0xf000;
  rmd.rmd3 = 0;
  (*sc->sc_copytodesc)(sc, &rmd, (sc->sc_rmdaddr + sizeof(struct lermd) * (bix)),
      sizeof(rmd));
 }
 ...
 for (bix = 0; bix < sc->sc_ntbuf; bix++) {
  a = sc->sc_addr + (sc->sc_tbufaddr[bix]);
  tmd.tmd0 = a;
  tmd.tmd1_hadr = a >> 16;
  tmd.tmd1_bits = 0;
  tmd.tmd2 = 0 | 0xf000;
  tmd.tmd3 = 0;
  (*sc->sc_copytodesc)(sc, &tmd, (sc->sc_tmdaddr + sizeof(struct letmd) * (bix)),
      sizeof(tmd));
 }
}
...
am7990_rint(struct lance_softc *sc)
{
 ...
 for (;;) {
  rp = (sc->sc_rmdaddr + sizeof(struct lermd) * (bix));
  (*sc->sc_copyfromdesc)(sc, &rmd, rp, sizeof(rmd));

  if (rmd.rmd1_bits & 0x80)
   break;

  if (rmd.rmd1_bits & 0x40) {
   if (rmd.rmd1_bits & 0x01) {
# 244 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c"
   } else {
    if (rmd.rmd1_bits & 0x10)
     printf("%s: overflow\n",
         sc->sc_dev.dv_xname);
   }
   if (rmd.rmd1_bits & 0x04)
    printf("%s: receive buffer error\n",
        sc->sc_dev.dv_xname);
   ifp->if_data.ifi_ierrors++;
  } else if ((rmd.rmd1_bits & (0x02 | 0x01)) !=
      (0x02 | 0x01)) {
   ...
   m = lance_read(sc, (sc->sc_rbufaddr[bix]),
       (int)rmd.rmd3 - 4);
   if (m != ((void *)0))
    ml_enqueue(&ml, m);
  }
...
# 284 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c"
  if (++bix == sc->sc_nrbuf)
   bix = 0;
 }
...
am7990_tint(struct lance_softc *sc)
{
 ...
 for (;;) {
  ...
  (*sc->sc_copyfromdesc)(sc, &tmd, (sc->sc_tmdaddr + sizeof(struct letmd) * (bix)),
      sizeof(tmd));
# 318 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/am7990.c"
  if (tmd.tmd1_bits & 0x80)
   break;

  ifq_clr_oactive(&ifp->if_snd);

  if (tmd.tmd1_bits & 0x40) {
   if (tmd.tmd3 & 0x8000)
    printf("%s: transmit buffer error\n",
        sc->sc_dev.dv_xname);
   else if (tmd.tmd3 & 0x4000)
    printf("%s: underflow\n", sc->sc_dev.dv_xname);
   if (tmd.tmd3 & (0x8000 | 0x4000)) {
    lance_reset(sc);
    return;
   }
   if (tmd.tmd3 & 0x0800) {
   ...
   if (tmd.tmd1_bits & 0x08)
    ifp->if_data.ifi_collisions++;
   else if (tmd.tmd1_bits & 0x10)
...
am7990_intr(void *arg)
{
 ...
 isr = (*sc->sc_rdcsr)(sc, 0x0000) | sc->sc_saved_csr0;
 sc->sc_saved_csr0 = 0;
 ...
 (*sc->sc_wrcsr)(sc, 0x0000, isr & ~0x0040);
 (*sc->sc_wrcsr)(sc, 0x0000, 0x0040);
...
am7990_start(struct ifnet *ifp)
{
 ...
 for (;;) {
  rp = (sc->sc_tmdaddr + sizeof(struct letmd) * (bix));
  ...
  len = lance_put(sc, (sc->sc_tbufaddr[bix]), m);
  ...
  (*sc->sc_wrcsr)(sc, 0x0000, 0x0040 | 0x0008);
