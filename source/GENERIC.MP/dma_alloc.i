# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/dma_alloc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/dma_alloc.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/dma_alloc.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/dma_alloc.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/dma_alloc.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/dma_alloc.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/dma_alloc.c" 2
...
static char dmanames[16 - 4 + 1][10];
struct pool dmapools[16 - 4 + 1];
...
dma_alloc_init(void)
{
 ...
 for (i = 0; i < (sizeof((dmapools)) / sizeof((dmapools)[0])); i++) {
  snprintf(dmanames[i], sizeof(dmanames[0]), "dma%d",
      1 << (i + 4));
  pool_init(&dmapools[i], 1 << (i + 4), 0,
      7, 0, dmanames[i], ((void *)0));
...
dma_alloc_index(size_t sz)
{
 ...
 for (b = 0; b < (sizeof((dmapools)) / sizeof((dmapools)[0])); b++)
  if (sz <= (1 << (b + 4)))
   return (b);
