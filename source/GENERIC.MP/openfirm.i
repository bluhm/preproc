# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openfirm.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openfirm.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openfirm.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openfirm.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openfirm.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openfirm.c" 2
 ...
 int phandle;
{
 ...
 args.name = (cell_t)("peer");
 args.nargs = 1;
 args.nreturns = 1;
 args.phandle = (cell_t)(u_int)(int)(phandle);
 ...
 int ihandle;
{
 ...
 args.name = (cell_t)("instance-to-package");
 args.nargs = 1;
 args.nreturns = 1;
 args.ihandle = (cell_t)(u_int)(int)(ihandle);
 if (openfirmware(&args) == -1)
  return -1;
 return args.phandle;
}
 ...
 char *prop;
{
 ...
 args.name = (cell_t)("getproplen");
 args.nargs = 2;
 args.nreturns = 1;
 args.phandle = (cell_t)(u_int)(int)(handle);
 ...
 void *buf;
{
 ...
 args.name = (cell_t)("nextprop");
 args.nargs = 3;
 args.nreturns = 1;
 args.phandle = (cell_t)(u_int)(int)(handle);
 args.prev = (cell_t)(prop);
 args.buf = (cell_t)(buf);
 if (openfirmware(&args) == -1)
  return -1;
 return args.next;
 ...
 int buflen;
{
 ...
 if (buflen > (1 << 13))
  return -1;
 args.name = (cell_t)("instance-to-path");
 args.nargs = 3;
 args.nreturns = 1;
 args.ihandle = (cell_t)(u_int)(int)(ihandle);
 args.buf = (cell_t)(buf);
 ...
 int buflen;
{
 ...
 if (buflen > (1 << 13))
  return -1;
 args.name = (cell_t)("package-to-path");
 args.nargs = 3;
 args.nreturns = 1;
 args.phandle = (cell_t)(u_int)(int)(phandle);
 args.buf = (cell_t)(buf);
...
OF_call_method(char *method, int ihandle, int nargs, int nreturns, ...)
{
 ...
 if (nargs > 6)
  return -1;
 args.name = (cell_t)("call-method");
 args.nargs = nargs + 2;
 args.nreturns = nreturns + 1;
 args.method = (cell_t)(method);
 args.ihandle = (cell_t)(u_int)(int)(ihandle);
 __builtin_va_start((ap), nreturns);
 for (ip = (long *)(args.args_n_results + (n = nargs)); --n >= 0;)
  *--ip = __builtin_va_arg((ap), unsigned long);
 if (openfirmware(&args) == -1) {
  __builtin_va_end((ap));
  return -1;
 }
  ...
  *__builtin_va_arg((ap), unsigned long *) = *--ip;
 __builtin_va_end((ap));
 return 0;
}
 ...
 char *dname;
{
 ...
 if ((l = strlen(dname)) >= (1 << 13))
  return -1;
 args.name = (cell_t)("open");
 args.nargs = 1;
 args.nreturns = 1;
 ...
 int handle;
{
 ...
 args.name = (cell_t)("close");
 args.nargs = 1;
 args.nreturns = 0;
 args.handle = (cell_t)(u_int)(int)(handle);
 openfirmware(&args);
}
 ...
 char *service;
{
 ...
 args.name = (cell_t)("test");
 args.nargs = 1;
 args.nreturns = 1;
 args.service = (cell_t)(service);
 if (openfirmware(&args) == -1)
  return -1;
 return args.status;
}
 ...
 char *method;
{
 ...
 args.name = (cell_t)("test-method");
 args.nargs = 2;
 args.nreturns = 1;
 args.service = (cell_t)(u_int)(int)(service);
 args.method = (cell_t)(method);
 if (openfirmware(&args) == -1)
  return -1;
 return args.status;
 ...
 int len;
{
 ...
 args.name = (cell_t)("read");
 args.nargs = 3;
 args.nreturns = 1;
 args.ihandle = (cell_t)(u_int)(int)(handle);
 ...
 char *bootspec;
{
 ...
 if ((l = strlen(bootspec)) >= (1 << 13))
  panic("OF_boot");
 args.name = (cell_t)("boot");
 args.nargs = 1;
 args.nreturns = 0;
...
OF_poweroff(void)
{
 ...
 args.name = (cell_t)("SUNW,power-off");
 args.nargs = 0;
 args.nreturns = 0;
 openfirmware(&args);
}
 ...
 void (*newfunc)(void *);
{
 ...
 args.name = (cell_t)("set-callback");
 args.nargs = 1;
 args.nreturns = 1;
 args.newfunc = (cell_t)(newfunc);
 if (openfirmware(&args) == -1)
  return (void *)(long)-1;
 ...
 void (*v2s)(void *);
{
 ...
 args.name = (cell_t)("set-symbol-lookup");
 args.nargs = 2;
 args.nreturns = 0;
 args.sym2val = (cell_t)(s2v);
 args.val2sym = (cell_t)(v2s);
...
OF_interpret(char *cmd, int nreturns, ...)
{
 ...
 args.name = (cell_t)("interpret");
 args.nargs = 1;
 args.nreturns = ++nreturns;
 args.slot[i++] = (cell_t)(cmd);
 __builtin_va_start((ap), nreturns);
 while (i < 1)
  args.slot[i++] = __builtin_va_arg((ap), cell_t);
 if (openfirmware(&args) == -1) {
  __builtin_va_end((ap));
  return (-1);
 }
 status = args.slot[i++];
 while (i < 1 + nreturns)
  *__builtin_va_arg((ap), cell_t *) = args.slot[i++];
 __builtin_va_end((ap));
 return (status);
}
...
# 753 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openfirm.c" 2
...
# 754 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openfirm.c" 2
...
# 755 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openfirm.c" 2
