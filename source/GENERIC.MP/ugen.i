# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c"
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c" 2
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugen.c"
...
struct ugen_softc {
 ...
 char sc_is_open[16];
 struct ugen_endpoint sc_endpoints[16][2];
...
ugen_set_config(struct ugen_softc *sc, int configno)
{
 ...
 for (endptno = 1; endptno < 16; endptno++)
 ...
 if (cdesc == ((void *)0) || cdesc->bConfigurationValue != configno) {
  if (sc->sc_secondary) {
 ...
 __builtin_memset((sc->sc_endpoints), (0), (sizeof sc->sc_endpoints));
 for (ifaceno = 0; ifaceno < cdesc->bNumInterface; ifaceno++) {
  ...
  for (endptno = 0; endptno < id->bNumEndpoints; endptno++) {
   ...
   dir = ((endpt) & 0x80) == 0x80 ? 1 : 0;
   sce = &sc->sc_endpoints[((endpt) & 0x0f)][dir];
   ;
...
{
 struct ugen_softc *sc;
 int unit = ((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) >> 4) & 0xf);
 int endpt = (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0xf);
 usb_endpoint_descriptor_t *edesc;
 struct ugen_endpoint *sce;
 int dir, isize;
 usbd_status err;
 ...
 if (sc == ((void *)0) || usbd_is_dying(sc->sc_udev))
  return (6);
 ...
 for (dir = 0; dir <= 1; dir++) {
  ...
  edesc = sce->edesc;
  switch (edesc->bmAttributes & 0x03) {
  case 0x03:
   if (dir == 0) {
   ...
   if (isize == 0)
    return (22);
   sce->ibuflen = isize;
   sce->ibuf = malloc(sce->ibuflen, 102, 0x0001);
   ;

   clalloc(&sce->q, 1020, 0);
  ...
  case 0x01:
   ...
   if (isize == 0)
    return (22);
   sce->ibuflen = isize * 500;
   sce->ibuf = mallocarray(isize, 500,
    102, 0x0001);
   sce->cur = sce->fill = sce->ibuf;
   sce->limit = sce->ibuf + isize * 500;
   ;
...
{
 struct ugen_softc *sc = ugen_cd.cd_devs[((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) >> 4) & 0xf)];
 int endpt = (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0xf);
 int error;
...
ugen_do_close(struct ugen_softc *sc, int endpt, int flag)
{
 ...
 for (dir = 0; dir <= 1; dir++) {
  if (!(flag & (dir == 0 ? 0x0002 : 0x0001)))
   continue;
  sce = &sc->sc_endpoints[endpt][dir];
  if (sce == ((void *)0) || sce->pipeh == ((void *)0))
   continue;
  ;
  ...
  switch (sce->edesc->bmAttributes & 0x03) {
  case 0x03:
...
{
 struct ugen_endpoint *sce = &sc->sc_endpoints[endpt][1];
 u_int32_t tn;
 size_t n;
 char buf[1024];
 struct usbd_xfer *xfer;
 ...
 case 0x03:
  ...
  while (sce->q.c_cc == 0) {
   ...
   sce->state |= 0x02;
   ;
   error = tsleep(sce, 22 | 0x100, "ugenri",
       (sce->timeout * hz) / 1000);
   sce->state &= ~0x02;
   ;
   if (usbd_is_dying(sc->sc_udev))
 ...
 case 0x02:
  ...
  if (sce->timeout == 0)
   flags |= 0x10;
  while ((n = ulmin(1024, uio->uio_resid)) != 0) {
   ;
   usbd_setup_xfer(xfer, sce->pipeh, 0, buf, n,
       flags, sce->timeout, ((void *)0));
   ...
   usbd_get_xfer_status(xfer, ((void *)0), ((void *)0), &tn, ((void *)0));
   ;
...
ugenread(dev_t dev, struct uio *uio, int flag)
{
 ...
 sc = ugen_cd.cd_devs[((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) >> 4) & 0xf)];
...
{
 struct ugen_endpoint *sce = &sc->sc_endpoints[endpt][0];
 size_t n;
 int flags, error = 0;
 char buf[1024];
 struct usbd_xfer *xfer;
 ...
 case 0x03:
  ...
  if (xfer == 0)
   return (5);
  while ((n = ulmin(((sce->edesc->wMaxPacketSize)[0] | ((sce->edesc->wMaxPacketSize)[1] << 8)),
      uio->uio_resid)) != 0) {
   error = uiomove(buf, n, uio);
   if (error)
    break;
...
ugen_detach(struct device *self, int flags)
{
 ...
 mn = self->dv_unit * 16;
 vdevgone(maj, mn, mn + 16 - 1, VCHR);

 for (endptno = 0; endptno < 16; endptno++) {
  if (sc->sc_is_open[endptno])
   ugen_do_close(sc, endptno, 0x0001|0x0002);
 }
 return (0);
}
...
ugen_isoc_rintr(struct usbd_xfer *xfer, void *addr, usbd_status status)
{
 ...
 isize = ((sce->edesc->wMaxPacketSize)[0] | ((sce->edesc->wMaxPacketSize)[1] << 8));
 for (i = 0; i < 4; i++) {
  ...
  while (actlen > 0) {
   ...
   __builtin_memcpy((sce->fill), (buf), (n));
 ...
 usbd_setup_isoc_xfer(xfer, sce->pipeh, req, req->sizes, 4,
     0x01 | 0x04, ugen_isoc_rintr);
 (void)usbd_transfer(xfer);
    ...
    int flag, struct proc *p)
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((126))):
  ...
  return (0);
 case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('U')) << 8) | ((113))):
  if (endpt == 0)
   return (22);

  sce = &sc->sc_endpoints[endpt][1];
  if (sce == ((void *)0) || sce->pipeh == ((void *)0))
   return (22);
  if (*(int *)addr)
   sce->state |= 0x04;
   ...
   sce->state &= ~0x04;
  return (0);
 case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('U')) << 8) | ((114))):
  sce = &sc->sc_endpoints[endpt][1];
  if (sce == ((void *)0))
   return (22);
  sce->timeout = *(int *)addr;
  sce = &sc->sc_endpoints[endpt][0];
  if (sce == ((void *)0))
   return (22);
  sce->timeout = *(int *)addr;
  return (0);
 ...
 case ((unsigned long)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('U')) << 8) | ((100))):
  err = usbd_get_config(sc->sc_udev, &conf);
  if (err)
   return (5);
  *(int *)addr = conf;
  break;
 case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('U')) << 8) | ((101))):
  if (!(flag & 0x0002))
   return (1);
  ...
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct usb_alt_interface) & 0x1fff) << 16) | ((('U')) << 8) | ((102))):
  ...
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct usb_alt_interface) & 0x1fff) << 16) | ((('U')) << 8) | ((103))):
  if (!(flag & 0x0002))
   return (1);
  ai = (struct usb_alt_interface *)addr;
  err = usbd_device2interface_handle(sc->sc_udev,
  ...
  if (err)
   return (22);
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct usb_alt_interface) & 0x1fff) << 16) | ((('U')) << 8) | ((104))):
  ai = (struct usb_alt_interface *)addr;
  ...
  free(cdesc, 127, 0);
  break;
 case ((unsigned long)0x40000000 | ((sizeof(usb_device_descriptor_t) & 0x1fff) << 16) | ((('U')) << 8) | ((105))):
  *(usb_device_descriptor_t *)addr =
   *usbd_get_device_descriptor(sc->sc_udev);
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct usb_config_desc) & 0x1fff) << 16) | ((('U')) << 8) | ((106))):
  ...
  free(cdesc, 127, 0);
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct usb_interface_desc) & 0x1fff) << 16) | ((('U')) << 8) | ((107))):
  id = (struct usb_interface_desc *)addr;
  cdesc = usbd_get_cdesc(sc->sc_udev, id->uid_config_index, 0);
  if (cdesc == ((void *)0))
   return (22);
  if (id->uid_config_index == (-1) &&
      id->uid_alt_index == (-1))
  ...
  free(cdesc, 127, 0);
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct usb_endpoint_desc) & 0x1fff) << 16) | ((('U')) << 8) | ((108))):
  ed = (struct usb_endpoint_desc *)addr;
  cdesc = usbd_get_cdesc(sc->sc_udev, ed->ued_config_index, 0);
  if (cdesc == ((void *)0))
   return (22);
  if (ed->ued_config_index == (-1) &&
      ed->ued_alt_index == (-1))
  ...
  free(cdesc, 127, 0);
  break;
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct usb_full_desc) & 0x1fff) << 16) | ((('U')) << 8) | ((109))):
 {
  u_int len;
  struct iovec iov;
  struct uio uio;
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct usb_ctl_request) & 0x1fff) << 16) | ((('U')) << 8) | ((111))):
 {
...
ugenpoll(dev_t dev, int events, struct proc *p)
{
 ...
 sce = &sc->sc_endpoints[(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0xf)][1];
 if (sce == ((void *)0))
  return (0x0008);
...
filt_ugenread_isoc(struct knote *kn, long hint)
{
 ...
 if (sce->cur < sce->fill)
  kn->kn_kevent.data = sce->fill - sce->cur;
 else
  kn->kn_kevent.data = (sce->limit - sce->cur) +
      (sce->fill - sce->ibuf);
...
struct filterops ugenread_intr_filtops =
 { 1, ((void *)0), filt_ugenrdetach, filt_ugenread_intr };

struct filterops ugenread_isoc_filtops =
 { 1, ((void *)0), filt_ugenrdetach, filt_ugenread_isoc };

struct filterops ugen_seltrue_filtops =
 { 1, ((void *)0), filt_ugenrdetach, filt_seltrue };
