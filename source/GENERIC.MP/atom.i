     ...
     int *ptr, uint32_t *saved, int print)
{
 ...
 case 0:
  ...
  (*ptr) += 2;
  if (print)
   do if (atom_debug) { printf("" "REG[0x%04X]", idx); } while (0);
  idx += gctx->reg_block;
  switch (gctx->io_mode) {
  case 0:
 ...
 case 1:
  ...
  (*ptr)++;
  val = __mswap32((u32 *)&ctx->ps[idx]);
  if (print)
   do if (atom_debug) { printf("" "PS[0x%02X,0x%04X]", idx, val); } while (0);
  break;
 case 2:
  idx = get_u8(ctx->ctx->bios, (*ptr));
  (*ptr)++;
  if (print)
   do if (atom_debug) { printf("" "WS[0x%02X]", idx); } while (0);
  switch (idx) {
  case 0x40:
   val = gctx->divmul[0];
   break;
 ...
 case 4:
  ...
  if (print) {
   if (gctx->data_block)
    do if (atom_debug) { printf("" "ID[0x%04X+%04X]", idx, gctx->data_block); } while (0);
   else
    do if (atom_debug) { printf("" "ID[0x%04X]", idx); } while (0);
  }
 ...
 case 3:
  ...
  if (print)
   do if (atom_debug) { printf("" "FB[0x%02X]", idx); } while (0);
  break;
 case 5:
  switch (align) {
  case 0:
   ...
   (*ptr) += 4;
   if (print)
    do if (atom_debug) { printf("" "IMM 0x%08X\n", val); } while (0);
   return val;
  case 1:
  case 2:
  case 3:
   ...
   (*ptr) += 2;
   if (print)
    do if (atom_debug) { printf("" "IMM 0x%04X\n", val); } while (0);
   return val;
  case 4:
  case 5:
  case 6:
  case 7:
   ...
   (*ptr)++;
   if (print)
    do if (atom_debug) { printf("" "IMM 0x%02X\n", val); } while (0);
   return val;
  }
  return 0;
 case 6:
  ...
  (*ptr)++;
  if (print)
   do if (atom_debug) { printf("" "PLL[0x%02X]", idx); } while (0);
 ...
 case 7:
  ...
  (*ptr)++;
  if (print)
   do if (atom_debug) { printf("" "MC[0x%02X]", idx); } while (0);
 ...
 if (print)
  switch (align) {
  case 0:
   do if (atom_debug) { printf("" ".[31:0] -> 0x%08X\n", val); } while (0);
   break;
  case 1:
   do if (atom_debug) { printf("" ".[15:0] -> 0x%04X\n", val); } while (0);
   break;
  case 2:
   do if (atom_debug) { printf("" ".[23:8] -> 0x%04X\n", val); } while (0);
   break;
  case 3:
   do if (atom_debug) { printf("" ".[31:16] -> 0x%04X\n", val); } while (0);
   break;
  case 4:
   do if (atom_debug) { printf("" ".[7:0] -> 0x%02X\n", val); } while (0);
   break;
  case 5:
   do if (atom_debug) { printf("" ".[15:8] -> 0x%02X\n", val); } while (0);
   break;
  case 6:
   do if (atom_debug) { printf("" ".[23:16] -> 0x%02X\n", val); } while (0);
   break;
  case 7:
   do if (atom_debug) { printf("" ".[31:24] -> 0x%02X\n", val); } while (0);
   break;
  }
 return val;
}
    ...
    int *ptr, uint32_t val, uint32_t saved)
{
 ...
 case 1:
  idx = get_u8(ctx->ctx->bios, (*ptr));
  (*ptr)++;
  do if (atom_debug) { printf("" "PS[0x%02X]", idx); } while (0);
  ctx->ps[idx] = (__uint32_t)(__builtin_constant_p(val) ? (__uint32_t)(((__uint32_t)(val) & 0xff) << 24 | ((__uint32_t)(val) & 0xff00) << 8 | ((__uint32_t)(val) & 0xff0000) >> 8 | ((__uint32_t)(val) & 0xff000000) >> 24) : __swap32md(val));
  break;
 case 2:
  idx = get_u8(ctx->ctx->bios, (*ptr));
  (*ptr)++;
...
static void atom_op_add(atom_exec_context *ctx, int *ptr, int arg)
{
 ...
 int dptr = *ptr;
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   dst: "); } while (0);
 dst = atom_get_dst(ctx, arg, attr, ptr, &saved, 1);
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   src: "); } while (0);
...
static void atom_op_calltable(atom_exec_context *ctx, int *ptr, int arg)
{
 ...
 int r = 0;
 if (idx < 74)
  do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   table: %d (%s)\n", idx, atom_table_names[idx]); } while (0);
 else
  do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   table: %d\n", idx); } while (0);
...
static void atom_op_compare(atom_exec_context *ctx, int *ptr, int arg)
{
 uint8_t attr = get_u8(ctx->ctx->bios, ((*ptr)++));
 uint32_t dst, src;
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   src1: "); } while (0);
 dst = atom_get_dst(ctx, arg, attr, ptr, ((void *)0), 1);
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   src2: "); } while (0);
 src = atom_get_src(ctx, attr, ptr);
 ctx->ctx->cs_equal = (dst == src);
 ctx->ctx->cs_above = (dst > src);
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   result: %s %s\n", ctx->ctx->cs_equal ? "EQ" : "NE", ctx->ctx->cs_above ? "GT" : "LE"); } while (0);
}
static void atom_op_delay(atom_exec_context *ctx, int *ptr, int arg)
{
 unsigned count = get_u8(ctx->ctx->bios, ((*ptr)++));
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   count: %d\n", count); } while (0);
 if (arg == 0)
  udelay(count);
...
static void atom_op_jump(atom_exec_context *ctx, int *ptr, int arg)
{
 ...
 if (arg != 2)
  do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   taken: %s\n", execute ? "yes" : "no"); } while (0);
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   target: 0x%04X\n", target); } while (0);
 if (execute) {
  if (ctx->last_jump == (ctx->start + target)) {
   cjiffies = jiffies;
   if (((long)(ctx->last_jump_jiffies) - (long)(cjiffies) < 0)) {
    cjiffies -= ctx->last_jump_jiffies;
    if (((((uint64_t)(cjiffies)) * 1000 / hz) > 5000)) {
...
static void atom_op_mask(atom_exec_context *ctx, int *ptr, int arg)
{
 ...
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   mask: 0x%08x", mask); } while (0);
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   src: "); } while (0);
 src = atom_get_src(ctx, attr, ptr);
 dst &= mask;
 dst |= src;
...
static void atom_op_postcard(atom_exec_context *ctx, int *ptr, int arg)
{
 ...
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("POST card output: 0x%02X\n", val); } while (0);
}
...
static void atom_op_setdatablock(atom_exec_context *ctx, int *ptr, int arg)
{
 int idx = get_u8(ctx->ctx->bios, (*ptr));
 (*ptr)++;
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   block: %d\n", idx); } while (0);
 if (!idx)
 ...
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   base: 0x%04X\n", ctx->ctx->data_block); } while (0);
}
static void atom_op_setfbbase(atom_exec_context *ctx, int *ptr, int arg)
{
 uint8_t attr = get_u8(ctx->ctx->bios, ((*ptr)++));
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   fb_base: "); } while (0);
...
static void atom_op_setport(atom_exec_context *ctx, int *ptr, int arg)
{
 ...
 case 0:
  ...
  if (port < 5)
   do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   port: %d (%s)\n", port, atom_io_names[port]); } while (0);
  else
   do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   port: %d\n", port); } while (0);
  if (!port)
   ctx->ctx->io_mode = 0;
  else
...
static void atom_op_shift_left(atom_exec_context *ctx, int *ptr, int arg)
{
 ...
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   shift: %d\n", shift); } while (0);
 dst <<= shift;
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   dst: "); } while (0);
 atom_put_dst(ctx, arg, attr, &dptr, dst, saved);
}
...
static void atom_op_switch(atom_exec_context *ctx, int *ptr, int arg)
{
 ...
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   switch: "); } while (0);
 src = atom_get_src(ctx, attr, ptr);
 while (get_u16(ctx->ctx->bios, (*ptr)) != 0x5A5A)
  if (get_u8(ctx->ctx->bios, (*ptr)) == 0x63) {
   (*ptr)++;
   do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   case: "); } while (0);
   val =
       atom_get_src(ctx, (attr & 0x38) | 5,
      ptr);
   target = get_u16(ctx->ctx->bios, (*ptr));
   if (val == src) {
    do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   target: %04X\n", target); } while (0);
    *ptr = ctx->start + target;
    return;
   }
   (*ptr) += 2;
...
static void atom_op_test(atom_exec_context *ctx, int *ptr, int arg)
{
 ...
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("   result: %s\n", ctx->ctx->cs_equal ? "EQ" : "NE"); } while (0);
}
...
static int atom_execute_table_locked(struct atom_context *ctx, int index, uint32_t * params)
{
 ...
 ptr = base + 6;
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf(">> execute %04X (len %d, WS %d, PS %d)\n", base, len, ws, ps); } while (0);
 ectx.ctx = ctx;
 ectx.ps_shift = ps / 4;
 ectx.start = base;
 ectx.ps = params;
 ...
 while (1) {
  ...
  if (op < 123)
   do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("%s @ 0x%04X\n", atom_op_names[op], ptr - 1); } while (0);
  else
   do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("[%d] @ 0x%04X\n", op, ptr - 1); } while (0);
  if (ectx.abort) {
 ...
 debug_depth--;
 do if (atom_debug) { printf(""); debug_print_spaces(debug_depth); printf("<<\n"); } while (0);
free:
 if (ws)
  kfree(ectx.ws);
 return ret;
...
{
 int r;
 _rw_enter_write(&ctx->scratch_mutex );
 r = atom_execute_table_scratch_unlocked(ctx, index, params);
 _rw_exit_write(&ctx->scratch_mutex );
 return r;
}
...
struct atom_context *atom_parse(struct card_info *card, void *bios)
{
 ...
 str = (((char *)(ctx->bios))+(get_u16(ctx->bios, (base + 0x10))));
 while (*str && ((*str == '\n') || (*str == '\r')))
  str++;
 for (i = 0; i < 511; i++) {
  name[i] = str[i];
...
int atom_asic_init(struct atom_context *ctx)
{
 ...
 ps[0] = (__uint32_t)(__builtin_constant_p(get_u32(ctx->bios, (hwi + 8))) ? (__uint32_t)(((__uint32_t)(get_u32(ctx->bios, (hwi + 8))) & 0xff) << 24 | ((__uint32_t)(get_u32(ctx->bios, (hwi + 8))) & 0xff00) << 8 | ((__uint32_t)(get_u32(ctx->bios, (hwi + 8))) & 0xff0000) >> 8 | ((__uint32_t)(get_u32(ctx->bios, (hwi + 8))) & 0xff000000) >> 24) : __swap32md(get_u32(ctx->bios, (hwi + 8))));
 ps[1] = (__uint32_t)(__builtin_constant_p(get_u32(ctx->bios, (hwi + 0xC))) ? (__uint32_t)(((__uint32_t)(get_u32(ctx->bios, (hwi + 0xC))) & 0xff) << 24 | ((__uint32_t)(get_u32(ctx->bios, (hwi + 0xC))) & 0xff00) << 8 | ((__uint32_t)(get_u32(ctx->bios, (hwi + 0xC))) & 0xff0000) >> 8 | ((__uint32_t)(get_u32(ctx->bios, (hwi + 0xC))) & 0xff000000) >> 24) : __swap32md(get_u32(ctx->bios, (hwi + 0xC))));
 if (!ps[0] || !ps[1])
  return 1;
