# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c"
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c"
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/ohci_cardbus.c" 2
...
ohci_cardbus_match(struct device *parent, void *match, void *aux)
{
 ...
 if ((((ca->ca_class) >> 24) & 0xff) == 0x0c &&
     (((ca->ca_class) >> 16) & 0xff) == 0x03 &&
     (((ca->ca_class) >> 8) & 0xff) == 0x10)
  return (1);
...
ohci_cardbus_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (cardbus_mapreg_map((ct)->ct_sc, (ct->ct_func), (0x10), (0x00000000), (0), (&sc->sc.iot), (&sc->sc.ioh), (((void *)0)), (&sc->sc.sc_size))) {
 ...
 (ct->ct_cf->cardbus_ctrl)(cc, 102);
 (ct->ct_cf->cardbus_ctrl)(cc, 104);


 csr = pci_conf_read(pc, ca->ca_tag,
    0x04);
 pci_conf_write(pc, ca->ca_tag, 0x04,
         csr | 0x00000004
      | 0x00000002);

 sc->sc_ih = cardbus_intr_establish(cc, cf, ca->ca_intrline,
        5, ohci_intr, sc, devname);
 if (sc->sc_ih == ((void *)0)) {
 ...
 sc->sc.sc_id_vendor = (((ca->ca_id) >> 0) & 0xffff);
 if (vendor)
  strlcpy(sc->sc.sc_vendor, vendor, sizeof(sc->sc.sc_vendor));
 else
  snprintf(sc->sc.sc_vendor, sizeof(sc->sc.sc_vendor),
      "vendor 0x%04x", (((ca->ca_id) >> 0) & 0xffff));
...
ohci_cardbus_detach(struct device *self, int flags)
{
 ...
 if (sc->sc.sc_size) {
  cardbus_mapreg_unmap((ct)->ct_sc, (ct->ct_func), (0x10), (sc->sc.iot), (sc->sc.ioh), (sc->sc.sc_size));
