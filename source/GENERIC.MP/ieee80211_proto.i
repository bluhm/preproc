# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c" 2
...
const char * const ieee80211_state_name[(IEEE80211_S_RUN+1)] = {
 "INIT",
 "SCAN",
 "AUTH",
 "ASSOC",
...
ieee80211_proto_attach(struct ifnet *ifp)
{
 ...
 mq_init(&ic->ic_mgtq, 256, 6);
 mq_init(&ic->ic_pwrsaveq, 256, 6);

 ifp->if_data.ifi_hdrlen = sizeof(struct ieee80211_frame);

 ic->ic_rtsthreshold = 512;
...
# 202 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c"
int
    ...
    int flags)
{
 ...
 if ((flags & 0x00000002) && ic->ic_fixed_rate == -1)
  flags &= ~0x00000002;
 ...
 for (i = 0; i < nrs->rs_nrates; ) {
  ...
  r = nrs->rs_rates[i] & 0x7f;
  badrate = r;
  if (flags & 0x00000002) {



   if (r == ((srs->rs_rates[ic->ic_fixed_rate]) & 0x7f))
    fixedrate = r;
  }
  if (flags & 0x00000004) {
   ...
   if (j == srs->rs_nrates) {
# 275 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_proto.c"
...
ieee80211_reset_erp(struct ieee80211com *ic)
{
 ...
 ieee80211_set_shortslottime(ic,
     ...
     (((ic->ic_ibss_chan)->ic_flags & 0x0100) != 0))

     ||
     ((ic->ic_curmode == IEEE80211_MODE_11G ||
     (ic->ic_curmode == IEEE80211_MODE_11N &&
     (((ic->ic_ibss_chan)->ic_flags & 0x0080) != 0))) &&
      ic->ic_opmode == IEEE80211_M_HOSTAP &&
      (ic->ic_caps & 0x00000080))
...
ieee80211_keyrun(struct ieee80211com *ic, u_int8_t *macaddr)
{
 ...
 if ((pmk = ieee80211_pmksa_find(ic, ni, ((void *)0))) == ((void *)0)) {
  ;
...
ieee80211_sa_query_request(struct ieee80211com *ic, struct ieee80211_node *ni)
{
 ...
 ((*(ic)->ic_send_mgmt)(ic, ni, 0xd0, (IEEE80211_CATEG_SA_QUERY) << 16 | (0), 0));
...
ieee80211_ht_negotiate(struct ieee80211com *ic, struct ieee80211_node *ni)
{
 ...
 if (ic->ic_opmode == IEEE80211_M_STA) {
  ...
  for (i = 0; i < 77; i++) {
   if (((ni->ni_basic_mcs)[(i)>>3] & (1<<((i)&(8 -1)))) &&
       !((ic->ic_sup_mcs)[(i)>>3] & (1<<((i)&(8 -1))))) {
    ...
    u_int16_t ssn, u_int8_t tid)
{
 ...
 ba->ba_params =
     (ba->ba_winsize << 6) |
     (tid << 2) | 0x0001;
 if ((ic->ic_htcaps & 0x00000400) == 0)

  ba->ba_params |= 0x0002;

 timeout_add_sec(&ba->ba_to, 1);
 ((*(ic)->ic_send_mgmt)(ic, ni, 0xd0, (IEEE80211_CATEG_BA) << 16 | (0), tid));
    ...
    u_int16_t reason, u_int8_t dir, u_int8_t tid)
{
 ...
 ((*(ic)->ic_send_mgmt)(ic, ni, 0xd0, (IEEE80211_CATEG_BA) << 16 | (2), reason << 16 | dir << 8 | tid));
    ...
    u_int16_t status)
{
 ...
 case IEEE80211_M_IBSS:
  ...
  (((ic)->ic_newstate)((ic), (IEEE80211_S_AUTH), (wh->i_fc[0] & 0xf0)));
 ...
 case IEEE80211_M_STA:
  ...
  if (ic->ic_flags & 0x00200000) {
   ...
   ic->ic_bss->ni_flags &= ~(0x0010 | 0x0008);
  ...
  (((ic)->ic_newstate)((ic), (IEEE80211_S_ASSOC), (wh->i_fc[0] & 0xf0)));
...
ieee80211_set_beacon_miss_threshold(struct ieee80211com *ic)
{
 ...
 int btimeout = (((7 * ic->ic_bss->ni_intval)<(700))?(7 * ic->ic_bss->ni_intval):(700));
 btimeout = (((btimeout)>(2 * ic->ic_bss->ni_intval))?(btimeout):(2 * ic->ic_bss->ni_intval));
 if (ic->ic_bss->ni_intval > 0)
...
justcleanup:
 ...
 case IEEE80211_S_SCAN:
  ...
  __builtin_memcpy((ni->ni_macaddr), (etherbroadcastaddr), (6));
  __builtin_memcpy((ni->ni_bssid), (etherbroadcastaddr), (6));
  ...
  case IEEE80211_S_SCAN:
   ...
   if (ic->ic_flags & 0x00000001) {
    ((*(ic)->ic_send_mgmt)(ic, ni, 0x40, 0, 0));
 ...
 case IEEE80211_S_ASSOC:
  ...
  case IEEE80211_S_AUTH:
   ...
   break;
  case IEEE80211_S_RUN:
   ((*(ic)->ic_send_mgmt)(ic, ni, 0x00, 1, 0));
...
ieee80211_set_link_state(struct ieee80211com *ic, int nstate)
{
 ...
 if (nstate != ifp->if_data.ifi_link_state) {
  ifp->if_data.ifi_link_state = nstate;
