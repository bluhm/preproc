# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c" 2
...
struct vm_physseg vm_physmem[32];
int vm_nphysseg = 0;
# 112 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
...
# 131 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
__inline static void
uvm_pageinsert(struct vm_page *pg)
{
 struct vm_page *dupe;

 (((pg->pg_flags & 0x00000004) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c", 136, "(pg->pg_flags & PG_TABLED) == 0"));
 dupe = uvm_objtree_RBT_INSERT(&pg->uobject->memt, pg);

 ((dupe == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c", 139, "dupe == NULL"));
 atomic_setbits_int(&pg->pg_flags, 0x00000004);
...
{
 ((pg->pg_flags & 0x00000004) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c", 152, "pg->pg_flags & PG_TABLED"));
 uvm_objtree_RBT_REMOVE(&pg->uobject->memt, pg);

 atomic_clearbits_int(&pg->pg_flags, 0x00000004);
 pg->uobject->uo_npages--;
 pg->uobject = ((void *)0);
 pg->pg_version++;
}
...
uvm_page_init(vaddr_t *kvm_startp, vaddr_t *kvm_endp)
{
 ...
 uvm_pmr_init();
# 197 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
 if (vm_nphysseg == 0)
  panic("uvm_page_bootstrap: no memory pre-allocated");
# 208 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
 freepages = 0;
 for (lcv = 0, seg = vm_physmem; lcv < vm_nphysseg ; lcv++, seg++)
  freepages += (seg->end - seg->start);
# 222 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
 pagecount = (((paddr_t)freepages + 1) << 13) /
     ((1 << 13) + sizeof(struct vm_page));
 pagearray = (vm_page_t)uvm_pageboot_alloc(pagecount *
     sizeof(struct vm_page));
 __builtin_memset((pagearray), (0), (pagecount * sizeof(struct vm_page)));
...
{
# 330 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
 static boolean_t initialized = 0;
 vaddr_t addr, vaddr;
 paddr_t paddr;
 ...
 if (initialized == 0) {
  ...
  virtual_space_start = (((virtual_space_start) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
  virtual_space_end = ((virtual_space_end) & ~((1 << 13) - 1));
 ...
 for (vaddr = (((addr) + ((1 << 13) - 1)) & ~((1 << 13) - 1)) ; vaddr < addr + size ;
     vaddr += (1 << 13)) {
  ...
  pmap_kenter_pa(vaddr, paddr, 0x01 | 0x02);
 }
 ;
 return(addr);

}
# 397 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
boolean_t
uvm_page_physget(paddr_t *paddrp)
{
 ...
 {
  if (uvm.page_init_done == 1)
   panic("uvm_page_physget: called _after_ bootstrap");


  if (seg->avail_start == seg->start &&
      seg->avail_start < seg->avail_end) {
   *paddrp = ((paddr_t)(seg->avail_start) << 13);
   seg->avail_start++;
   seg->start++;
  ...
  if (seg->avail_end == seg->end &&
      seg->avail_start < seg->avail_end) {
   *paddrp = ((paddr_t)(seg->avail_end - 1) << 13);
   seg->avail_end--;
   seg->end--;
...
# 497 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
void
    ...
    paddr_t avail_end, int flags)
{
 ...
 if (vm_nphysseg == 32) {
  ...
  printf("\t%d segments allocated, ignoring 0x%llx -> 0x%llx\n",
      32, (long long)start, (long long)end);
 ...
 if (!preload) {
  ...
  pgs = (struct vm_page *)uvm_km_alloc1(kernel_map,npages * sizeof(*pgs),0,1);
...
# 622 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
 ps->start = start;
 ps->end = end;
...
uvm_page_physdump(void)
{
 ...
 case 2: printf("BSEARCH\n"); break;
 case 3: printf("BIGFIRST\n"); break;
...
# 721 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
int
uvm_pglistalloc(psize_t size, paddr_t low, paddr_t high, paddr_t alignment,
    paddr_t boundary, struct pglist *rlist, int nsegs, int flags)
{
 (((alignment & (alignment - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c", 725, "(alignment & (alignment - 1)) == 0"));
 (((boundary & (boundary - 1)) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c", 726, "(boundary & (boundary - 1)) == 0"));
 ((!(flags & 0x0001) ^ !(flags & 0x0002)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c", 727, "!(flags & UVM_PLA_WAITOK) ^ !(flags & UVM_PLA_NOWAIT)"));
...
# 750 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
 again:
 if ((uvmexp.free <= uvmexp.reserve_pagedaemon + size &&
     !(((__curcpu->ci_self)->ci_curproc == uvm.pagedaemon_proc) ||
  ((__curcpu->ci_self)->ci_curproc == syncerproc)))) {
  if (flags & 0x0001) {
 ...
 low = ((((((low)+((alignment)-1))/(alignment))*(alignment))) >> 13);
    ...
    int flags)
{
 ...
 r = uvm_pglistalloc(size, dma_constraint.ucr_low,
     dma_constraint.ucr_high, 0, 0, &plist, (((((size) + ((1 << 13) - 1)) & ~((1 << 13) - 1))) >> 13),
     flags);
 if (r == 0) {
  i = 0;
  while ((pg = ((&plist)->tqh_first)) != ((void *)0)) {
   ...
   (((pg->pg_flags & 0x00000200) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c", 823, "(pg->pg_flags & PG_DEV) == 0"));
   ...
   uvm_pagealloc_pg(pg, obj, off + ((paddr_t)(i++) << 13), ((void *)0));
  }
 }
 return r;
}
    ...
    int flags, struct uvm_constraint_range *where)
{
 ...
 r = uvm_pglistalloc(size, where->ucr_low, where->ucr_high, 0,
     0, &plist, (((((size) + ((1 << 13) - 1)) & ~((1 << 13) - 1))) >> 13), flags);
 if (r == 0) {
  i = 0;
  while((pg = ((&plist)->tqh_first)) != ((void *)0)) {
...
# 877 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
struct vm_page *
    ...
    int flags)
{
 ...
 if ((uvmexp.free - (((buflowpages - bcstats.numbufpages) < 0) ? 0 : buflowpages - bcstats.numbufpages)) < uvmexp.freemin ||
     ...
     (uvmexp.inactive + (((bcstats.numcleanpages - buflowpages) < 0) ? 0 : bcstats.numcleanpages - buflowpages)) < uvmexp.inactarg))
  wakeup(&uvm.pagedaemon);
# 906 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
 use_reserve = (flags & 0x0001) ||
  (obj && ((obj)->uo_refs == (-2)));
 ...
 if (flags & 0x0002)
  ...
  atomic_setbits_int(&pg->pg_flags, 0x00000008);
...
# 968 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
void
uvm_pagefree(struct vm_page *pg)
{
 u_int flags_to_clear = 0;
# 980 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
 ...
 if (pg->pg_flags & 0x00040000) {
  do { if (((pg)->pageq.tqe_next) != ((void *)0)) (pg)->pageq.tqe_next->pageq.tqe_prev = (pg)->pageq.tqe_prev; else (&uvm.page_active)->tqh_last = (pg)->pageq.tqe_prev; *(pg)->pageq.tqe_prev = (pg)->pageq.tqe_next; ((pg)->pageq.tqe_prev) = ((void *)-1); ((pg)->pageq.tqe_next) = ((void *)-1); } while (0);
  flags_to_clear |= 0x00040000;
  uvmexp.active--;
 }
 if (pg->pg_flags & 0x00020000) {
  if (pg->pg_flags & (0x00100000|0x00200000))
   do { if (((pg)->pageq.tqe_next) != ((void *)0)) (pg)->pageq.tqe_next->pageq.tqe_prev = (pg)->pageq.tqe_prev; else (&uvm.page_inactive_swp)->tqh_last = (pg)->pageq.tqe_prev; *(pg)->pageq.tqe_prev = (pg)->pageq.tqe_next; ((pg)->pageq.tqe_prev) = ((void *)-1); ((pg)->pageq.tqe_next) = ((void *)-1); } while (0);
  else
   do { if (((pg)->pageq.tqe_next) != ((void *)0)) (pg)->pageq.tqe_next->pageq.tqe_prev = (pg)->pageq.tqe_prev; else (&uvm.page_inactive_obj)->tqh_last = (pg)->pageq.tqe_prev; *(pg)->pageq.tqe_prev = (pg)->pageq.tqe_next; ((pg)->pageq.tqe_prev) = ((void *)-1); ((pg)->pageq.tqe_next) = ((void *)-1); } while (0);
  flags_to_clear |= 0x00020000;
  uvmexp.inactive--;
 }
 ...
 if (pg->uanon) {
  pg->uanon->an_page = ((void *)0);
  pg->uanon = ((void *)0);
 }


 flags_to_clear |= 0x00100000|0x00200000|0x00400000|0x00000100|0x00000040|0x00000001|
     0x00000020|0x00000008|0x00000010;
 atomic_clearbits_int(&pg->pg_flags, flags_to_clear);
# 1026 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
...
uvm_page_unbusy(struct vm_page **pgs, int npgs)
{
 ...
 for (i = 0; i < npgs; i++) {
  ...
  if (pg == ((void *)0) || pg == ((struct vm_page *) -1L)) {
   continue;
  }
  ...
  if (pg->pg_flags & 0x00000020) {
   ...
   atomic_clearbits_int(&pg->pg_flags, 0x00000002|0x00000001);
   ;
  }
 }
}
# 1118 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
int
vm_physseg_find(paddr_t pframe, int *offp)
{
 ...
 int start, len, try;
# 1140 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
 ...
 return(-1);
# 1177 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
}
...
PHYS_TO_VM_PAGE(paddr_t pa)
{
 ...
 return ((psi == -1) ? ((void *)0) : &vm_physmem[psi].pgs[off]);
}
...
uvm_pagelookup(struct uvm_object *obj, voff_t off)
{
 ...
 pg.offset = off;
 return (uvm_objtree_RBT_FIND(&obj->memt, &pg));
}
...
uvm_pagewire(struct vm_page *pg)
{
 if (pg->wire_count == 0) {
  if (pg->pg_flags & 0x00040000) {
   do { if (((pg)->pageq.tqe_next) != ((void *)0)) (pg)->pageq.tqe_next->pageq.tqe_prev = (pg)->pageq.tqe_prev; else (&uvm.page_active)->tqh_last = (pg)->pageq.tqe_prev; *(pg)->pageq.tqe_prev = (pg)->pageq.tqe_next; ((pg)->pageq.tqe_prev) = ((void *)-1); ((pg)->pageq.tqe_next) = ((void *)-1); } while (0);
   atomic_clearbits_int(&pg->pg_flags, 0x00040000);
   uvmexp.active--;
  }
  if (pg->pg_flags & 0x00020000) {
   if (pg->pg_flags & (0x00100000|0x00200000))
    ...
    do { if (((pg)->pageq.tqe_next) != ((void *)0)) (pg)->pageq.tqe_next->pageq.tqe_prev = (pg)->pageq.tqe_prev; else (&uvm.page_inactive_obj)->tqh_last = (pg)->pageq.tqe_prev; *(pg)->pageq.tqe_prev = (pg)->pageq.tqe_next; ((pg)->pageq.tqe_prev) = ((void *)-1); ((pg)->pageq.tqe_next) = ((void *)-1); } while (0);
   atomic_clearbits_int(&pg->pg_flags, 0x00020000);
   uvmexp.inactive--;
  }
  uvmexp.wired++;
 }
...
uvm_pageunwire(struct vm_page *pg)
{
 pg->wire_count--;
 if (pg->wire_count == 0) {
  do { (pg)->pageq.tqe_next = ((void *)0); (pg)->pageq.tqe_prev = (&uvm.page_active)->tqh_last; *(&uvm.page_active)->tqh_last = (pg); (&uvm.page_active)->tqh_last = &(pg)->pageq.tqe_next; } while (0);
  uvmexp.active++;
  atomic_setbits_int(&pg->pg_flags, 0x00040000);
  uvmexp.wired--;
 }
}
# 1261 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_page.c"
void
uvm_pagedeactivate(struct vm_page *pg)
{
 ...
 if ((pg->pg_flags & 0x00020000) == 0) {
  ...
  if (pg->pg_flags & (0x00100000|0x00200000))
   ...
   do { (pg)->pageq.tqe_next = ((void *)0); (pg)->pageq.tqe_prev = (&uvm.page_inactive_obj)->tqh_last; *(&uvm.page_inactive_obj)->tqh_last = (pg); (&uvm.page_inactive_obj)->tqh_last = &(pg)->pageq.tqe_next; } while (0);
  atomic_setbits_int(&pg->pg_flags, 0x00020000);
  uvmexp.inactive++;
...
{
 atomic_clearbits_int(&dst->pg_flags, 0x00000008);
...
uvm_pagecount(struct uvm_constraint_range* constraint)
{
 ...
 low = ((constraint->ucr_low) >> 13);
 high = ((constraint->ucr_high) >> 13);

 sz = 0;
 for (lcv = 0; lcv < vm_nphysseg; lcv++) {
  ps_low = (((low)>(vm_physmem[lcv].avail_start))?(low):(vm_physmem[lcv].avail_start));
  ps_high = (((high)<(vm_physmem[lcv].avail_end))?(high):(vm_physmem[lcv].avail_end));
  if (ps_low < ps_high)
   sz += ps_high - ps_low;
 }
 return sz;
