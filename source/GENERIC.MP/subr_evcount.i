# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_evcount.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_evcount.c"
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_evcount.c"
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_evcount.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_evcount.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_evcount.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_evcount.c" 2

static struct { struct evcount *tqh_first; struct evcount **tqh_last; } evcount_list = { ((void *)0), &(evcount_list).tqh_first };
...
evcount_attach(struct evcount *ec, const char *name, void *data)
{
 ...
 __builtin_memset((ec), (0), (sizeof(*ec)));
 ec->ec_name = name;
 ec->ec_id = ++nextid;
 ec->ec_data = data;
 do { (ec)->next.tqe_next = ((void *)0); (ec)->next.tqe_prev = (&evcount_list)->tqh_last; *(&evcount_list)->tqh_last = (ec); (&evcount_list)->tqh_last = &(ec)->next.tqe_next; } while (0);
}

void
evcount_detach(struct evcount *ec)
{
 do { if (((ec)->next.tqe_next) != ((void *)0)) (ec)->next.tqe_next->next.tqe_prev = (ec)->next.tqe_prev; else (&evcount_list)->tqh_last = (ec)->next.tqe_prev; *(ec)->next.tqe_prev = (ec)->next.tqe_next; ((ec)->next.tqe_prev) = ((void *)-1); ((ec)->next.tqe_next) = ((void *)-1); } while (0);
}
    ...
    void *newp, size_t newlen)
{
 ...
 nintr = 0;
 for((ec) = ((&evcount_list)->tqh_first); (ec) != ((void *)0); (ec) = ((ec)->next.tqe_next)) {
  if (nintr++ == i)
   break;
 }
 ...
 switch (name[0]) {
 case 1:
  error = sysctl_rdint(oldp, oldlenp, ((void *)0), nintr);
  break;
 case 2:
  if (ec == ((void *)0))
   return (2);
  ...
  count = ec->ec_count;
  _splx(s);
  error = sysctl_rdquad(oldp, oldlenp, ((void *)0), count);
  break;
 case 3:
  if (ec == ((void *)0))
   return (2);
  error = sysctl_rdstring(oldp, oldlenp, ((void *)0), ec->ec_name);
  break;
 case 4:
  if (ec == ((void *)0) || ec->ec_data == ((void *)0))
   return (2);
  error = sysctl_rdint(oldp, oldlenp, ((void *)0),
      *((int *)ec->ec_data));
  break;
 default:
  error = 45;
