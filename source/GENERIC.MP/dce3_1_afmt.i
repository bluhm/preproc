 ...
 u8 *sadb, int sad_count)
{
 ...
 u32 tmp;
 tmp = radeon_audio_endpoint_rreg(rdev, (0), (0x71bc));
 tmp &= ~((1 << 17) | (0x7f << 0));
 tmp |= (1 << 16);
 if (sad_count)
  tmp |= (((sadb[0]) & 0x7f) << 0);
  ...
  tmp |= (((5) & 0x7f) << 0);
 radeon_audio_endpoint_wreg(rdev, (0), (0x71bc), (tmp));
}
 ...
 struct cea_sad *sads, int sad_count)
{
 ...
 static const u16 eld_reg_to_type[][2] = {
  { 0x71c8, HDMI_AUDIO_CODING_TYPE_PCM },
  { 0x71cc, HDMI_AUDIO_CODING_TYPE_AC3 },
  { 0x71d0, HDMI_AUDIO_CODING_TYPE_MPEG1 },
  { 0x71d4, HDMI_AUDIO_CODING_TYPE_MP3 },
  { 0x71d8, HDMI_AUDIO_CODING_TYPE_MPEG2 },
  { 0x71dc, HDMI_AUDIO_CODING_TYPE_AAC_LC },
  { 0x71e0, HDMI_AUDIO_CODING_TYPE_DTS },
  { 0x71e4, HDMI_AUDIO_CODING_TYPE_ATRAC },
  { 0x71ec, HDMI_AUDIO_CODING_TYPE_EAC3 },
  { 0x71f0, HDMI_AUDIO_CODING_TYPE_DTS_HD },
  { 0x71f4, HDMI_AUDIO_CODING_TYPE_MLP },
  { 0x71fc, HDMI_AUDIO_CODING_TYPE_WMA_PRO },
 };
 ...
 struct radeon_crtc *crtc, unsigned int clock)
{
 ...
 if (!crtc)
  return;
 radeon_encoder = ({ const __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (crtc->encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 ...
 if (dig->dig_encoder == 0) {
  dto_cntl = r100_mm_rreg(rdev, (0x0520), 0) & ~7;
  dto_cntl |= (((wallclock_ratio) & 7) << 0);
  r100_mm_wreg(rdev, (0x0520), (dto_cntl), 0);
  r100_mm_wreg(rdev, (0x0514), (dto_phase), 0);
  r100_mm_wreg(rdev, (0x0518), (clock), 0);
  r100_mm_wreg(rdev, (0x0534), (0), 0);
 } else {
  dto_cntl = r100_mm_rreg(rdev, (0x0530), 0) & ~7;
  dto_cntl |= (((wallclock_ratio) & 7) << 0);
  r100_mm_wreg(rdev, (0x0530), (dto_cntl), 0);
  r100_mm_wreg(rdev, (0x0524), (dto_phase), 0);
  r100_mm_wreg(rdev, (0x0528), (clock), 0);
  r100_mm_wreg(rdev, (0x0534), (1), 0);
 }
}
 ...
 const struct radeon_hdmi_acr *acr)
{
 ...
 r100_mm_wreg(rdev, (0x740c + offset), ((1 << 8) | (1 << 12)), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x74ac + offset), 0); tmp_ &= (~(0xfffff << 12)); tmp_ |= (((((acr->cts_32khz) & 0xfffff) << 12)) & ~(~(0xfffff << 12))); r100_mm_wreg(rdev, (0x74ac + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x74b0 + offset), 0); tmp_ &= (~(0xfffff << 0)); tmp_ |= (((((acr->n_32khz) & 0xfffff) << 0)) & ~(~(0xfffff << 0))); r100_mm_wreg(rdev, (0x74b0 + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x74b4 + offset), 0); tmp_ &= (~(0xfffff << 12)); tmp_ |= (((((acr->cts_44_1khz) & 0xfffff) << 12)) & ~(~(0xfffff << 12))); r100_mm_wreg(rdev, (0x74b4 + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x74b8 + offset), 0); tmp_ &= (~(0xfffff << 0)); tmp_ |= (((((acr->n_44_1khz) & 0xfffff) << 0)) & ~(~(0xfffff << 0))); r100_mm_wreg(rdev, (0x74b8 + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x74bc + offset), 0); tmp_ &= (~(0xfffff << 12)); tmp_ |= (((((acr->cts_48khz) & 0xfffff) << 12)) & ~(~(0xfffff << 12))); r100_mm_wreg(rdev, (0x74bc + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x74c0 + offset), 0); tmp_ &= (~(0xfffff << 0)); tmp_ |= (((((acr->n_48khz) & 0xfffff) << 0)) & ~(~(0xfffff << 0))); r100_mm_wreg(rdev, (0x74c0 + offset), (tmp_), 0); } while (0);
}
void dce3_2_set_audio_packet(struct drm_encoder *encoder, u32 offset)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 r100_mm_wreg(rdev, (0x7408 + offset), ((((1) & 3) << 4) | (((3) & 0x1f) << 16)), 0);
 r100_mm_wreg(rdev, (0x7604 + offset), ((1 << 0) | (1 << 26)), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7414 + offset), 0); tmp_ &= (~((1 << 4) | (1 << 5))); tmp_ |= (((1 << 4) | (1 << 5)) & ~(~((1 << 4) | (1 << 5)))); r100_mm_wreg(rdev, (0x7414 + offset), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7418 + offset), 0); tmp_ &= (~((((2) & 0x3f) << 8))); tmp_ |= (((((2) & 0x3f) << 8)) & ~(~((((2) & 0x3f) << 8)))); r100_mm_wreg(rdev, (0x7418 + offset), (tmp_), 0); } while (0);
}
void dce3_2_set_mute(struct drm_encoder *encoder, u32 offset, _Bool mute)
{
 ...
 struct radeon_device *rdev = dev->dev_private;
 if (mute)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7428 + offset), 0); tmp_ &= (~((1 << 0))); tmp_ |= (((1 << 0)) & ~(~((1 << 0)))); r100_mm_wreg(rdev, (0x7428 + offset), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7428 + offset), 0); tmp_ &= (~(1 << 0)); tmp_ |= ((0) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x7428 + offset), (tmp_), 0); } while (0);
}
