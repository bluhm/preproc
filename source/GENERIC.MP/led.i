# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c"
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c"
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c" 2
...
void device_register(struct device *, void *);
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c" 2
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/led.c"
struct led_softc {
 struct device sc_dv;
...
led_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (bus_space_map(ea->ea_iotag, ((((paddr_t)((&ea->ea_regs[0])->hi)) << 32UL) | ((paddr_t)(&ea->ea_regs[0])->lo)), ea->ea_regs[0].size, 0, &sc->sc_ioh) == 0) {
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x41, 0x05);
 delay(10000);
 rev = bus_space_read_1(sc->sc_iot, sc->sc_ioh, 0x40);
 printf(": rev 0x%02x\n", rev);
...
led_blink(void *v, int on)
{
 ...
 sc->sc_on = on;
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x41, 0x06);
...
led_blink_finish(void *v)
{
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x40, reg64);
}
