# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/sparc64/pci_machdep.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ofwi2c.c" 2
...
ofwiic_pci_scan(struct device *self, struct i2cbus_attach_args *iba, void *aux)
{
 ...
 int iba_node = (int)(((tag)>>32)&0xffffffff);
 char name[32];
 int node;
...
ofwiic_scan(struct device *self, struct i2cbus_attach_args *iba, void *aux)
{
 ...
 for (node = OF_child(iba_node); node; node = OF_peer(node)) {
  __builtin_memset((name), (0), (sizeof(name)));
  __builtin_memset((reg64), (0), (sizeof(reg64)));
  ...
  if (OF_getprop(node, "reg", reg64, sizeof(reg64)) == -1)
   continue;

  __builtin_memset((&ia), (0), (sizeof(ia)));
  ia.ia_tag = iba->iba_tag;
  ia.ia_addr = (reg64[0] << 7) | (reg64[1] >> 1);
  ia.ia_name = name;
  ia.ia_cookie = &node;
