    ...
    struct radeon_fence *fence)
{
 ...
 radeon_ring_write(ring, ((0 << 30) | (((0xf6f4) >> 2) & 0xFFFF) | ((0) & 0x3FFF) << 16));
 radeon_ring_write(ring, fence->seq);
 radeon_ring_write(ring, ((0 << 30) | (((0xef10) >> 2) & 0xFFFF) | ((0) & 0x3FFF) << 16));
 radeon_ring_write(ring, ((u32)(addr)));
 radeon_ring_write(ring, ((0 << 30) | (((0xef14) >> 2) & 0xFFFF) | ((0) & 0x3FFF) << 16));
 radeon_ring_write(ring, ((u32)(((addr) >> 16) >> 16)) & 0xff);
 radeon_ring_write(ring, ((0 << 30) | (((0xef0c) >> 2) & 0xFFFF) | ((0) & 0x3FFF) << 16));
        ...
        _Bool emit_wait)
{
 ...
 radeon_ring_write(ring, ((0 << 30) | (((0xef00) >> 2) & 0xFFFF) | ((0) & 0x3FFF) << 16));
 radeon_ring_write(ring, (addr >> 3) & 0x000FFFFF);
 radeon_ring_write(ring, ((0 << 30) | (((0xef04) >> 2) & 0xFFFF) | ((0) & 0x3FFF) << 16));
 radeon_ring_write(ring, (addr >> 23) & 0x000FFFFF);
 radeon_ring_write(ring, ((0 << 30) | (((0xef08) >> 2) & 0xFFFF) | ((0) & 0x3FFF) << 16));
...
int uvd_v2_2_resume(struct radeon_device *rdev)
{
 ...
 size = (((rdev->uvd_fw->size + 4) + (4096 - 1)) & ~(4096 - 1)) >> 3;
 r100_mm_wreg(rdev, (0xf4d8), (addr), 0);
 r100_mm_wreg(rdev, (0xf4dc), (size), 0);
 addr += size;
 size = (1024*1024) >> 3;
 r100_mm_wreg(rdev, (0xf4e0), (addr), 0);
 r100_mm_wreg(rdev, (0xf4e4), (size), 0);
 addr += size;
 size = (1024*1024) >> 3;
 r100_mm_wreg(rdev, (0xf4e8), (addr), 0);
 r100_mm_wreg(rdev, (0xf4ec), (size), 0);
 addr = (rdev->uvd.gpu_addr >> 28) & 0xF;
 r100_mm_wreg(rdev, (0xf594), ((addr << 12) | (addr << 0)), 0);
 addr = (rdev->uvd.gpu_addr >> 32) & 0xFF;
 r100_mm_wreg(rdev, (0xf498), (addr | (0x9 << 16) | (0x1 << 31)), 0);
 switch (rdev->family) {
 default:
  return -22;
 case CHIP_RV710:
 ...
 r100_mm_wreg(rdev, (0xf4d4), (chip_id), 0);
 return 0;
}
