# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/starfire.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/starfire.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/starfire.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/starfire.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/starfire.c" 2
...
starfire_pc_ittrans_init(int upaid)
{
 ...
 pa = (((u_int64_t)(((upaid & 0x3c) << 1) | ((upaid & 0x40) >> 4) | (upaid & 0x3)) << 33) | 0x10000000000ULL) | 0x100f8000000ULL;
 pa |= (0x4000000ULL | 0x000200UL);
 ...
 pa += ((((__builtin_constant_p(0x4a) ? ({ u_int64_t __rldxu_int64_t; if(0x4a == 0x80 || (sizeof(u_int64_t) == 1 && 0x4a == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0)); else __asm volatile("ldxa" " [%1] " "0x4a" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0), 0x4a))) >> 17) & 0x1f) * 0x10;
 (__builtin_constant_p(0x15) ? ({ if((0x15) == 0x80 || (sizeof(u_int32_t) == 1 && (0x15) == 0x88)) *((volatile u_int32_t *)(pa)) = ((((cpu_myid() & 0x3c) << 1) | ((cpu_myid() & 0x40) >> 4) | (cpu_myid() & 0x3))); else __asm volatile("stwa" " %0, [%1] " "(0x15)" : : "r" (((((cpu_myid() & 0x3c) << 1) | ((cpu_myid() & 0x40) >> 4) | (cpu_myid() & 0x3)))), "r" ((volatile u_int32_t *)(pa)) : "memory"); }) : stwa_nc((pa), 0x15, ((((cpu_myid() & 0x3c) << 1) | ((cpu_myid() & 0x40) >> 4) | (cpu_myid() & 0x3)))));
}
