# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ipifuncs.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ipifuncs.c"
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ipifuncs.c"
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ipifuncs.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ipifuncs.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ipifuncs.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ipifuncs.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ipifuncs.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ipifuncs.c" 2
...
sun4u_send_ipi(int itid, void (*func)(void), u_int64_t arg0, u_int64_t arg1)
{
 ...
 (((u_int64_t)func > (1<<11)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/ipifuncs.c", 79, "(u_int64_t)func > MAXINTNUM"));





 if (((getver() & 0x0000ffff00000000ULL) >> 32) == 0x16)
  shift = (itid & 0x3) * 2;

 if ((__builtin_constant_p(0x48) ? ({ u_int64_t __rldxu_int64_t; if(0x48 == 0x80 || (sizeof(u_int64_t) == 1 && 0x48 == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0)); else __asm volatile("ldxa" " [%1] " "0x48" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0), 0x48)) & (0x01 << shift)) {
 ...
 for (i = 0; i < 10000; i++) {
  ...
  (__builtin_constant_p(0x77) ? ({ if((0x77) == 0x80 || (sizeof(u_int64_t) == 1 && (0x77) == 0x88)) *((volatile u_int64_t *)(0x40)) = ((u_int64_t)func); else __asm volatile("stxa" " %0, [%1] " "(0x77)" : : "r" (((u_int64_t)func)), "r" ((volatile u_int64_t *)(0x40)) : "memory"); }) : stxa_nc((0x40), 0x77, ((u_int64_t)func)));
  (__builtin_constant_p(0x77) ? ({ if((0x77) == 0x80 || (sizeof(u_int64_t) == 1 && (0x77) == 0x88)) *((volatile u_int64_t *)(0x50)) = (arg0); else __asm volatile("stxa" " %0, [%1] " "(0x77)" : : "r" ((arg0)), "r" ((volatile u_int64_t *)(0x50)) : "memory"); }) : stxa_nc((0x50), 0x77, (arg0)));
  (__builtin_constant_p(0x77) ? ({ if((0x77) == 0x80 || (sizeof(u_int64_t) == 1 && (0x77) == 0x88)) *((volatile u_int64_t *)(0x60)) = (arg1); else __asm volatile("stxa" " %0, [%1] " "(0x77)" : : "r" ((arg1)), "r" ((volatile u_int64_t *)(0x60)) : "memory"); }) : stxa_nc((0x60), 0x77, (arg1)));
  (__builtin_constant_p(0x77) ? ({ if((0x77) == 0x80 || (sizeof(u_int64_t) == 1 && (0x77) == 0x88)) *((volatile u_int64_t *)(((((u_int64_t)(itid)) << 14) | 0x70))) = (0); else __asm volatile("stxa" " %0, [%1] " "(0x77)" : : "r" ((0)), "r" ((volatile u_int64_t *)(((((u_int64_t)(itid)) << 14) | 0x70))) : "memory"); }) : stxa_nc((((((u_int64_t)(itid)) << 14) | 0x70)), 0x77, (0)));
  __asm volatile("membar " "#Sync" ::: "memory");
  ...
  if (((__builtin_constant_p(0x48) ? ({ u_int64_t __rldxu_int64_t; if(0x48 == 0x80 || (sizeof(u_int64_t) == 1 && 0x48 == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0)); else __asm volatile("ldxa" " [%1] " "0x48" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0), 0x48)) & (0x02 << shift)) == 0)
   return;
 }


 if (db_active || panicstr != ((void *)0))
...
sun4v_send_ipi(int itid, void (*func)(void), u_int64_t arg0, u_int64_t arg1)
{
 ...
 (__builtin_constant_p(0x14) ? ({ if((0x14) == 0x80 || (sizeof(u_int16_t) == 1 && (0x14) == 0x88)) *((volatile u_int16_t *)(ci->ci_cpuset)) = (itid); else __asm volatile("stha" " %0, [%1] " "(0x14)" : : "r" ((itid)), "r" ((volatile u_int16_t *)(ci->ci_cpuset)) : "memory"); }) : stha_nc((ci->ci_cpuset), 0x14, (itid)));
 (__builtin_constant_p(0x14) ? ({ if((0x14) == 0x80 || (sizeof(u_int64_t) == 1 && (0x14) == 0x88)) *((volatile u_int64_t *)(ci->ci_mondo)) = ((vaddr_t)func); else __asm volatile("stxa" " %0, [%1] " "(0x14)" : : "r" (((vaddr_t)func)), "r" ((volatile u_int64_t *)(ci->ci_mondo)) : "memory"); }) : stxa_nc((ci->ci_mondo), 0x14, ((vaddr_t)func)));
 (__builtin_constant_p(0x14) ? ({ if((0x14) == 0x80 || (sizeof(u_int64_t) == 1 && (0x14) == 0x88)) *((volatile u_int64_t *)(ci->ci_mondo + 8)) = (arg0); else __asm volatile("stxa" " %0, [%1] " "(0x14)" : : "r" ((arg0)), "r" ((volatile u_int64_t *)(ci->ci_mondo + 8)) : "memory"); }) : stxa_nc((ci->ci_mondo + 8), 0x14, (arg0)));
 (__builtin_constant_p(0x14) ? ({ if((0x14) == 0x80 || (sizeof(u_int64_t) == 1 && (0x14) == 0x88)) *((volatile u_int64_t *)(ci->ci_mondo + 16)) = (arg1); else __asm volatile("stxa" " %0, [%1] " "(0x14)" : : "r" ((arg1)), "r" ((volatile u_int64_t *)(ci->ci_mondo + 16)) : "memory"); }) : stxa_nc((ci->ci_mondo + 16), 0x14, (arg1)));
...
sun4v_broadcast_ipi(void (*func)(void), u_int64_t arg0, u_int64_t arg1)
{
 ...
 for (ci = cpus; ci != ((void *)0); ci = ci->ci_next) {
  ...
  if ((ci->ci_flags & 0x0001) == 0)
   continue;
  (__builtin_constant_p(0x14) ? ({ if((0x14) == 0x80 || (sizeof(u_int16_t) == 1 && (0x14) == 0x88)) *((volatile u_int16_t *)(cpuset)) = (ci->ci_itid); else __asm volatile("stha" " %0, [%1] " "(0x14)" : : "r" ((ci->ci_itid)), "r" ((volatile u_int16_t *)(cpuset)) : "memory"); }) : stha_nc((cpuset), 0x14, (ci->ci_itid)));
...
{
 if (ci == (__curcpu->ci_self) || db_active || ((ci->ci_flags & 0x0001) == 0))
  return;

 if ((cputyp == 5))
  sun4v_send_ipi(ci->ci_itid, ipi_softint, 1 << 1, 0);
 else
  sun4u_send_ipi(ci->ci_itid, ipi_softint, 1 << 1, 0);
}
