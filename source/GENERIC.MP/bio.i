# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/bio.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/bio.c"
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/bio.c"
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/bio.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/bio.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/bio.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/bio.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/bio.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/bio.c" 2

struct bio_mapping {
 struct { struct bio_mapping *le_next; struct bio_mapping **le_prev; } bm_link;
 struct device *bm_dev;
 int (*bm_ioctl)(struct device *, u_long, caddr_t);
};

struct { struct bio_mapping *lh_first; } bios = { ((void *)0) };
...
bioioctl(dev_t dev, u_long cmd, caddr_t addr, int flag, struct proc *p)
{
 ...
 switch (cmd) {
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct bio_locate) & 0x1fff) << 16) | ((('B')) << 8) | ((0))):
  locate = (struct bio_locate *)addr;
  error = copyinstr(locate->bl_name, name, sizeof name, ((void *)0));
  if (error != 0)
   return (error);
  locate->bl_bio.bio_cookie = bio_lookup(name);
  if (locate->bl_bio.bio_cookie == ((void *)0))
   return (2);
  break;
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct bioc_patrol) & 0x1fff) << 16) | ((('B')) << 8) | ((42))):
  bio = (struct bio *)addr;
...
bio_register(struct device *dev, int (*ioctl)(struct device *, u_long, caddr_t))
{
 ...
 bm = malloc(sizeof *bm, 2, 0x0002);
 if (bm == ((void *)0))
  return (12);
 bm->bm_dev = dev;
 bm->bm_ioctl = ioctl;
 do { if (((bm)->bm_link.le_next = (&bios)->lh_first) != ((void *)0)) (&bios)->lh_first->bm_link.le_prev = &(bm)->bm_link.le_next; (&bios)->lh_first = (bm); (bm)->bm_link.le_prev = &(&bios)->lh_first; } while (0);
 return (0);
}
...
bio_unregister(struct device *dev)
{
 ...
 for (bm = ((&bios)->lh_first); bm != ((void *)0); bm = next) {
  next = ((bm)->bm_link.le_next);

  if (dev == bm->bm_dev) {
   do { if ((bm)->bm_link.le_next != ((void *)0)) (bm)->bm_link.le_next->bm_link.le_prev = (bm)->bm_link.le_prev; *(bm)->bm_link.le_prev = (bm)->bm_link.le_next; ((bm)->bm_link.le_prev) = ((void *)-1); ((bm)->bm_link.le_next) = ((void *)-1); } while (0);
   free(bm, 2, sizeof(*bm));
  }
 }
}
...
bio_lookup(char *name)
{
 ...
 for((bm) = ((&bios)->lh_first); (bm)!= ((void *)0); (bm) = ((bm)->bm_link.le_next))
...
{
 __builtin_bzero((bs), (sizeof(struct bio_status)));
    ...
    va_list *ap)
{
 ...
 vsnprintf(bs->bs_msgs[idx].bm_msg, 128, fmt, *ap);
