# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c"
...
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c" 2
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c" 2
...
void device_register(struct device *, void *);
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c" 2
# 134 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c"
struct lom_cmd {
 uint8_t lc_cmd;
 uint8_t lc_data;

 struct { struct lom_cmd *tqe_next; struct lom_cmd **tqe_prev; } lc_next;
};
...
struct lom_softc {
 ...
 struct ksensor sc_fan[4];
 struct ksensor sc_psu[3];
 struct ksensor sc_temp[8];
 ...
 uint8_t sc_fan_cal[4];
 uint8_t sc_fan_low[4];
 ...
 struct { struct lom_cmd *tqh_first; struct lom_cmd **tqh_last; } sc_queue;
...
lom_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 struct ebus_attach_args *ea = aux;
 uint8_t reg64, fw_rev, config, config2, config3;
 uint8_t cal, low;
 int i;
 ...
 if (lom_read(sc, 0x7e, &reg64) || reg64 != 0x55 ||
     lom_read(sc, 0x7f, &reg64) || reg64 != 0xaa ||
     lom_read(sc, 0x01, &fw_rev) ||
     lom_read(sc, 0x5d, &config))
 {
 ...
 if (sc->sc_type < 2) {
  ...
  lom_read(sc, 0x66, &config2);
  lom_read(sc, 0x67, &config3);

  bus_intr_establish(sc->sc_iot, ea->ea_intrs[0],
      5, 0, lom2_intr, sc, self->dv_xname);
 }

 sc->sc_num_fan = min((config >> 5) & 0x7, 4);
 sc->sc_num_psu = min((config >> 3) & 0x3, 3);
 sc->sc_num_temp = min((config2 >> 4) & 0xf, 8);

 for (i = 0; i < sc->sc_num_fan; i++) {
  if (lom_read(sc, 0x5e + i, &cal) ||
      lom_read(sc, 0x62 + i, &low)) {
 ...
 if (sensor_task_register(sc, lom_refresh, 5) == ((void *)0)) {
  printf(": unable to register update task\n");
  return;
 }

 sensordev_install(&sc->sc_sensordev);
# 349 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c"
 lom_write(sc, 0x32, 126);
 lom_read(sc, 0x31, &sc->sc_wdog_ctl);
 sc->sc_wdog_ctl &= ~0x02;
 sc->sc_wdog_ctl |= 0x01;
 lom_write(sc, 0x31, sc->sc_wdog_ctl);
 timeout_set(&sc->sc_wdog_to, lom_wdog_pat, sc);
 timeout_add_sec(&sc->sc_wdog_to, 126 / 2);

 wdog_register(lom_wdog_cb, sc);

 printf(": %s rev %d.%d\n",
     sc->sc_type < 2 ? "LOMlite" : "LOMlite2",
...
int
lom_read(struct lom_softc *sc, uint8_t reg64, uint8_t *val)
{
 if (sc->sc_type < 2)
  return lom1_read(sc, reg64, val);
 else
  return lom2_read(sc, reg64, val);
}

int
lom_write(struct lom_softc *sc, uint8_t reg64, uint8_t val)
{
 if (sc->sc_type < 2)
  return lom1_write(sc, reg64, val);
 else
  return lom2_write(sc, reg64, val);
}
...
lom1_read(struct lom_softc *sc, uint8_t reg64, uint8_t *val)
{
 ...
 if (cold)
  return lom1_read_polled(sc, reg64, val);

 lc.lc_cmd = reg64;
 lc.lc_data = 0xff;
 lom1_queue_cmd(sc, &lc);

 error = tsleep(&lc, 22, "lomrd", hz);
 if (error)
...
int
lom1_write(struct lom_softc *sc, uint8_t reg64, uint8_t val)
{
 struct lom_cmd lc;
 int error;

 if (cold)
  return lom1_write_polled(sc, reg64, val);

 lc.lc_cmd = reg64 | 0x80;
 lc.lc_data = val;
 lom1_queue_cmd(sc, &lc);

 error = tsleep(&lc, 22, "lomwr", 2 * hz);
 if (error)
  lom_dequeue_cmd(sc, &lc);
...
int
lom1_read_polled(struct lom_softc *sc, uint8_t reg64, uint8_t *val)
{
 uint8_t str;
 int i;
 ...
 for (i = 30; i > 0; i--) {
  str = bus_space_read_1(sc->sc_iot, sc->sc_ioh, 0x00);
  delay(1000);
  if ((str & 0x80) == 0)
   break;
 }
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x00, reg64);
 ...
 *val = bus_space_read_1(sc->sc_iot, sc->sc_ioh, 0x01);
 return (0);
}

int
lom1_write_polled(struct lom_softc *sc, uint8_t reg64, uint8_t val)
{
 uint8_t str;
 int i;
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x01, val);
...
lom1_process_queue_locked(struct lom_softc *sc)
{
 ...
 if (str & 0x80) {
  ...
  bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x01, 0xac);
 ...
 if (sc->sc_state == 1) {
  bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x00, lc->lc_cmd);
  sc->sc_state = 2;
  timeout_add_msec(&sc->sc_state_to, 250);
  return;
 }

 ((sc->sc_state == 2) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c", 590, "sc->sc_state == LOM_STATE_DATA"));
 if ((lc->lc_cmd & 0x80) == 0)
  lc->lc_data = bus_space_read_1(sc->sc_iot, sc->sc_ioh, 0x01);
 else
  bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x01, lc->lc_data);

 do { if (((lc)->lc_next.tqe_next) != ((void *)0)) (lc)->lc_next.tqe_next->lc_next.tqe_prev = (lc)->lc_next.tqe_prev; else (&sc->sc_queue)->tqh_last = (lc)->lc_next.tqe_prev; *(lc)->lc_next.tqe_prev = (lc)->lc_next.tqe_next; ((lc)->lc_next.tqe_prev) = ((void *)-1); ((lc)->lc_next.tqe_next) = ((void *)-1); } while (0);

 wakeup(lc);

 if (!(((&sc->sc_queue)->tqh_first) == ((void *)0))) {
  sc->sc_state = 1;
  timeout_add_msec(&sc->sc_state_to, 1);
  return;
 }
...
int
lom2_read(struct lom_softc *sc, uint8_t reg64, uint8_t *val)
{
 struct lom_cmd lc;
 int error;

 if (cold)
  return lom2_read_polled(sc, reg64, val);

 lc.lc_cmd = reg64;
 lc.lc_data = 0xff;
 lom2_queue_cmd(sc, &lc);

 error = tsleep(&lc, 22, "lom2rd", hz);
 if (error)
  lom_dequeue_cmd(sc, &lc);
...
int
lom2_read_polled(struct lom_softc *sc, uint8_t reg64, uint8_t *val)
{
 uint8_t str;
 int i;
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x01, reg64);
 ...
 *val = bus_space_read_1(sc->sc_iot, sc->sc_ioh, 0x00);
 return (0);
}

int
lom2_write(struct lom_softc *sc, uint8_t reg64, uint8_t val)
{
 struct lom_cmd lc;
 int error;

 if (cold)
  return lom2_write_polled(sc, reg64, val);

 lc.lc_cmd = reg64 | 0x80;
 lc.lc_data = val;
 lom2_queue_cmd(sc, &lc);

 error = tsleep(&lc, 22, "lom2wr", hz);
 if (error)
  lom_dequeue_cmd(sc, &lc);
...
int
lom2_write_polled(struct lom_softc *sc, uint8_t reg64, uint8_t val)
{
 uint8_t str;
 int i;
 ...
 if (sc->sc_space == 0x00 && reg64 != 0x00)
  reg64 |= 0x80;
 ...
 bus_space_read_1(sc->sc_iot, sc->sc_ioh, 0x00);
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 0x00, val);
...
lom_refresh(void *arg)
{
 ...
 for (i = 0; i < sc->sc_num_fan; i++) {
  if (lom_read(sc, 0x04 + i, &val)) {
   sc->sc_fan[i].flags |= 0x0001;
   continue;
  }
 ...
 for (i = 0; i < sc->sc_num_psu; i++) {
  if (lom_read(sc, 0x08 + i, &val) ||
      !((val) & (0x08))) {
   sc->sc_psu[i].flags |= 0x0001;
   continue;
  }
 ...
 for (i = 0; i < sc->sc_num_temp; i++) {
  if (lom_read(sc, 0x18 + i, &val)) {
   sc->sc_temp[i].flags |= 0x0001;
   continue;
  }
...
# 952 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/lom.c"
 if (hostnamelen > 0 &&
...
lom2_write_hostname(struct lom_softc *sc)
{
 ...
 lom_write(sc, 0x38, hostnamelen + 1);
 for (i = 0; i < hostnamelen + 1; i++)
  lom_write(sc, 0x39, hostname[i]);
}
...
lom_wdog_pat(void *arg)
{
 ...
 sc->sc_wdog_pat.lc_cmd = 0x31 | 0x80;
