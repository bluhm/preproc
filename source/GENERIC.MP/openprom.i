# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c"
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c"
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/openpromio.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/openpromio.h"
struct opiocdesc {
 int op_nodeid;
 int op_namelen;
 char *op_name;
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
void device_register(struct device *, void *);
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
int bppopen(dev_t, int, int, struct proc *); int bppclose(dev_t, int, int, struct proc *); int bppread(dev_t, struct uio *, int); int bppwrite(dev_t, struct uio *, int); int bppioctl(dev_t, u_long, caddr_t, int, struct proc *); int bppstop(struct tty *, int); struct tty *bpptty(dev_t); int bpppoll(dev_t, int, struct proc *); paddr_t bppmmap(dev_t, off_t, int); int bppkqfilter(dev_t, struct knote *);
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/openprom.c" 2
 ...
 *cpp = cp = malloc(len + 1, 127, 0x0001);
 ...
 struct proc *p;
{
 ...
 if (cmd == ((unsigned long)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('O')) << 8) | ((4)))) {
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct opiocdesc) & 0x1fff) << 16) | ((('O')) << 8) | ((1))):
  if ((flags & 0x0001) == 0)
   return (9);
  if (node == 0)
   return (22);
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct opiocdesc) & 0x1fff) << 16) | ((('O')) << 8) | ((2))):
  if ((flags & 0x0002) == 0)
   return (9);
  if (node == 0)
   return (22);
  ...
  if (todr_handle)
   if ((todr_handle)->todr_setwen) ((*(todr_handle)->todr_setwen)(todr_handle, 1));
  len = OF_setprop(node, name, value, op->op_buflen + 1);
  if (todr_handle)
   if ((todr_handle)->todr_setwen) ((*(todr_handle)->todr_setwen)(todr_handle, 0));
  _splx(s);
  if (len != op->op_buflen)
   error = 22;
  break;

 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct opiocdesc) & 0x1fff) << 16) | ((('O')) << 8) | ((3))):
  if ((flags & 0x0001) == 0)
   return (9);
  if (node == 0)
   return (22);
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(int) & 0x1fff) << 16) | ((('O')) << 8) | ((5))):
  if ((flags & 0x0001) == 0)
   return (9);
  s = _splraise(15);
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(int) & 0x1fff) << 16) | ((('O')) << 8) | ((6))):
  if ((flags & 0x0001) == 0)
   return (9);
  if (node == 0)
   return (22);
