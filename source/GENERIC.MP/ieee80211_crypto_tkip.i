# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c"
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c"
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/michael.h" 1
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/michael.h"
...
void michael_update(MICHAEL_CTX *, const u_int8_t *, u_int)
     __attribute__((__bounded__(__buffer__, 2, 3)));
void michael_final(u_int8_t [8], MICHAEL_CTX *)
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c" 2

typedef u_int8_t byte;
typedef u_int16_t u16b;
typedef u_int32_t u32b;
...
ieee80211_tkip_set_key(struct ieee80211com *ic, struct ieee80211_key *k)
{
 ...
 ctx = malloc(sizeof(*ctx), 2, 0x0002 | 0x0008);
 if (ctx == ((void *)0))
  return 12;
...
ieee80211_tkip_delete_key(struct ieee80211com *ic, struct ieee80211_key *k)
{
 if (k->k_priv != ((void *)0)) {
  ...
  free(k->k_priv, 2, sizeof(struct ieee80211_tkip_ctx));
 }
 k->k_priv = ((void *)0);
}
    ...
    u_int8_t mic[8])
{
 ...
 case 0x00:
  __builtin_memcpy((wht.i_da), (wh->i_addr1), (6));
  __builtin_memcpy((wht.i_sa), (wh->i_addr2), (6));
  break;
 case 0x01:
  __builtin_memcpy((wht.i_da), (wh->i_addr3), (6));
  __builtin_memcpy((wht.i_sa), (wh->i_addr2), (6));
  break;
 case 0x02:
  __builtin_memcpy((wht.i_da), (wh->i_addr1), (6));
  __builtin_memcpy((wht.i_sa), (wh->i_addr3), (6));
  break;
 case 0x03:
  __builtin_memcpy((wht.i_da), (wh->i_addr3), (6));
  __builtin_memcpy((wht.i_sa), (((const struct ieee80211_frame_addr4 *)wh)->i_addr4), (6));

  break;
 }
 if (ieee80211_has_qos(wh))
  wht.i_pri = ieee80211_get_qos(wh) & 0x000f;
 else
  wht.i_pri = 0;
 ...
 pos = ((caddr_t)((m)->m_hdr.mh_data)) + off;
 len = m->m_hdr.mh_len - off;
 for (;;) {
  michael_update(&ctx, pos, len);
  if ((m = m->m_hdr.mh_next) == ((void *)0))
   break;
  pos = ((caddr_t)((m)->m_hdr.mh_data));
  len = m->m_hdr.mh_len;
 }
    ...
    struct ieee80211_key *k)
{
 ...
 n0 = m_get((0x0002), (m0->m_hdr.mh_type));
 if (n0 == ((void *)0))
  goto nospace;
 if (m_dup_pkthdr(n0, m0, 0x0002))
  goto nospace;
 n0->M_dat.MH.MH_pkthdr.len += 8;
 n0->m_hdr.mh_len = ((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr));
 if (n0->M_dat.MH.MH_pkthdr.len >= (((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr)) + (256 - sizeof(struct m_hdr)) + 1) - (8 + 4)) {
  (void) m_clget((n0), (0x0002), (1 << 11));
  if (n0->m_hdr.mh_flags & 0x0001)
   n0->m_hdr.mh_len = n0->M_dat.MH.MH_dat.MH_ext.ext_size;
 }
 if (n0->m_hdr.mh_len > n0->M_dat.MH.MH_pkthdr.len)
  n0->m_hdr.mh_len = n0->M_dat.MH.MH_pkthdr.len;


 wh = ((struct ieee80211_frame *)((m0)->m_hdr.mh_data));
 hdrlen = ieee80211_get_hdrlen(wh);
 __builtin_memcpy((((caddr_t)((n0)->m_hdr.mh_data))), (wh), (hdrlen));

 k->k_tsc++;


 ivp = ((u_int8_t *)((n0)->m_hdr.mh_data)) + hdrlen;
 ivp[0] = k->k_tsc >> 8;
 ...
 moff = hdrlen;
 noff = hdrlen + 8;
 left = m0->M_dat.MH.MH_pkthdr.len - moff;
 crc = ~0;
 while (left > 0) {
  ...
  if (noff == n->m_hdr.mh_len) {

   n->m_hdr.mh_next = m_get((0x0002), (n->m_hdr.mh_type));
   if (n->m_hdr.mh_next == ((void *)0))
    goto nospace;
   n = n->m_hdr.mh_next;
   n->m_hdr.mh_len = (256 - sizeof(struct m_hdr));
   if (left >= (((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr)) + (256 - sizeof(struct m_hdr)) + 1) - (8 + 4)) {
    (void) m_clget((n), (0x0002), (1 << 11));
    if (n->m_hdr.mh_flags & 0x0001)
     n->m_hdr.mh_len = n->M_dat.MH.MH_dat.MH_ext.ext_size;
   }
   if (n->m_hdr.mh_len > left)
    n->m_hdr.mh_len = left;
   noff = 0;
  }
  len = min(m->m_hdr.mh_len - moff, n->m_hdr.mh_len - noff);

  crc = ether_crc32_le_update(crc, ((caddr_t)((m)->m_hdr.mh_data)) + moff, len);
  rc4_crypt(&ctx->rc4, ((caddr_t)((m)->m_hdr.mh_data)) + moff,
      ((caddr_t)((n)->m_hdr.mh_data)) + noff, len);
 ...
 mic = ((caddr_t)((n)->m_hdr.mh_data)) + n->m_hdr.mh_len;
 ieee80211_tkip_mic(m0, hdrlen, ctx->txmic, mic);
 crc = ether_crc32_le_update(crc, mic, 8);
 rc4_crypt(&ctx->rc4, mic, mic, 8);
 n->m_hdr.mh_len += 8;


 icvp = ((caddr_t)((n)->m_hdr.mh_data)) + n->m_hdr.mh_len;
 crc = ~crc;
 icvp[0] = crc;
 icvp[1] = crc >> 8;
 icvp[2] = crc >> 16;
 icvp[3] = crc >> 24;
 rc4_crypt(&ctx->rc4, icvp, icvp, 4);
 n->m_hdr.mh_len += 4;

 n0->M_dat.MH.MH_pkthdr.len += (8 + 4);
    ...
    struct ieee80211_key *k)
{
 ...
 if (m0->M_dat.MH.MH_pkthdr.len < hdrlen + (8 + (8 + 4))) {
  m_freem(m0);
  return ((void *)0);
 }
 ...
 if (m_dup_pkthdr(n0, m0, 0x0002))
  goto nospace;
 n0->M_dat.MH.MH_pkthdr.len -= (8 + (8 + 4));
 n0->m_hdr.mh_len = ((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr));
 if (n0->M_dat.MH.MH_pkthdr.len >= (((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr)) + (256 - sizeof(struct m_hdr)) + 1)) {
  (void) m_clget((n0), (0x0002), (1 << 11));
  if (n0->m_hdr.mh_flags & 0x0001)
   n0->m_hdr.mh_len = n0->M_dat.MH.MH_dat.MH_ext.ext_size;
 }
 ...
 __builtin_memcpy((((caddr_t)((n0)->m_hdr.mh_data))), (wh), (hdrlen));
 wh = ((struct ieee80211_frame *)((n0)->m_hdr.mh_data));
 wh->i_fc[1] &= ~0x40;
 ...
 moff = hdrlen + 8;
 noff = hdrlen;
 left = n0->M_dat.MH.MH_pkthdr.len - noff;
 crc = ~0;
 while (left > 0) {
  if (moff == m->m_hdr.mh_len) {
  ...
  rc4_crypt(&ctx->rc4, ((caddr_t)((m)->m_hdr.mh_data)) + moff,
      ((caddr_t)((n)->m_hdr.mh_data)) + noff, len);
  crc = ether_crc32_le_update(crc, ((caddr_t)((n)->m_hdr.mh_data)) + noff, len);
 ...
 m_copydata(m, moff, (8 + 4), buf);
 rc4_crypt(&ctx->rc4, buf, buf, (8 + 4));
 ...
 if (timingsafe_bcmp(mic0, mic, 8) != 0) {
  m_freem(m0);
  m_freem(n0);
...
ieee80211_tkip_deauth(void *arg, struct ieee80211_node *ni)
{
 ...
 if (ni->ni_state == IEEE80211_STA_ASSOC &&
  ...
  ((*(ic)->ic_send_mgmt)(ic, ni, 0xc0, IEEE80211_REASON_MIC_FAILURE, 0));
...
ieee80211_michael_mic_failure(struct ieee80211com *ic, u_int64_t tsc)
{
 ...
 log(4, "%s: Michael MIC failure\n", ic->ic_ac.ac_if.if_xname);
# 536 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c"
 ...
 case IEEE80211_M_HOSTAP:
  ...
  log(4, "%s: HostAP will be disabled for %d seconds "
      "as a countermeasure against TKIP key cracking attempts\n",
      ic->ic_ac.ac_if.if_xname, sec);
 ...
 case IEEE80211_M_STA:
  ...
  ((*(ic)->ic_send_mgmt)(ic, ic->ic_bss, 0xc0, IEEE80211_REASON_MIC_FAILURE, 0));



  (void)(((ic)->ic_newstate)((ic), (IEEE80211_S_SCAN), (-1)));
  break;
 default:
  break;
 }
...
# 618 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c"
static const u16b Sbox[256]=
{
...
# 671 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c"
static void
Phase1(u16b *P1K, const byte *TK, const byte *TA, u32b IV32)
{
 ...
 P1K[0] = ((u16b)( (IV32) & 0xFFFF));
 P1K[1] = ((u16b)(((IV32) >>16) & 0xFFFF));
 P1K[2] = ((TA[0]) ^ (((u16b)(TA[1])) << 8));
...
# 715 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_tkip.c"
static void
Phase2(byte *RC4KEY, const byte *TK, const u16b *P1K, u16b IV16)
{
 ...
 PPK[3] += ((((PPK[2]) >> 1) & 0x7FFF) ^ (((PPK[2]) & 1) << 15));
 PPK[4] += ((((PPK[3]) >> 1) & 0x7FFF) ^ (((PPK[3]) & 1) << 15));
 PPK[5] += ((((PPK[4]) >> 1) & 0x7FFF) ^ (((PPK[4]) & 1) << 15));
 ...
 RC4KEY[0] = ((byte)(((IV16) >> 8) & 0x00FF));
 RC4KEY[1] =(((byte)(((IV16) >> 8) & 0x00FF)) | 0x20) & 0x7F;
