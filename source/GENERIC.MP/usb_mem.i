# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c"
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c"
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c" 2
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c"
struct usb_frag_dma {
 struct usb_dma_block *block;
 u_int offs;
 struct { struct usb_frag_dma *le_next; struct usb_frag_dma **le_prev; } next;
};
...
struct { struct usb_dma_block *lh_first; } usb_blk_freelist =
 { ((void *)0) };
int usb_blk_nfree = 0;

struct { struct usb_frag_dma *lh_first; } usb_frag_freelist =
 { ((void *)0) };
    ...
    struct usb_dma_block **dmap)
{
 ...
 for (p = ((&usb_blk_freelist)->lh_first); p; p = ((p)->next.le_next)) {
  if (p->tag == tag && p->size >= size && p->align >= align) {
   do { if ((p)->next.le_next != ((void *)0)) (p)->next.le_next->next.le_prev = (p)->next.le_prev; *(p)->next.le_prev = (p)->next.le_next; ((p)->next.le_prev) = ((void *)-1); ((p)->next.le_next) = ((void *)-1); } while (0);
   usb_blk_nfree--;
   _splx(s);
   *dmap = p;
   ;
 ...
 error = bus_dmamap_load(tag, p->map, p->kaddr, p->size, ((void *)0),
    0x0001);
 if (error)
  goto destroy;
...
# 184 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usb_mem.c"
void
usb_block_freemem(struct usb_dma_block *p)
{
 ...
 ;
 s = splraise(2);
 do { if (((p)->next.le_next = (&usb_blk_freelist)->lh_first) != ((void *)0)) (&usb_blk_freelist)->lh_first->next.le_prev = &(p)->next.le_next; (&usb_blk_freelist)->lh_first = (p); (p)->next.le_prev = &(&usb_blk_freelist)->lh_first; } while (0);
 usb_blk_nfree++;
 _splx(s);
}
...
usb_allocmem(struct usbd_bus *bus, size_t size, size_t align, struct usb_dma *p)
{
 ...
 if (size > 64 || align > 64) {
  ;
  size = (size + (64 * 64) - 1) & ~((64 * 64) - 1);
  err = usb_block_allocmem(tag, size, align, &p->block);
  if (!err) {
   p->block->frags = ((void *)0);
   p->offs = 0;
  }
  return (err);
 }
 ...
 for (f = ((&usb_frag_freelist)->lh_first); f; f = ((f)->next.le_next))
  if (f->block->tag == tag)
   break;
 if (f == ((void *)0)) {
  ;
  err = usb_block_allocmem(tag, (64 * 64), 64,&b);
  if (err) {
   _splx(s);
   return (err);
  }
  b->frags = mallocarray(64, sizeof(*f), 101,
      0x0002);
  if (b->frags == ((void *)0)) {
   _splx(s);
   usb_block_freemem(b);
  ...
  for (i = 0; i < 64; i++) {
   ...
   f->block = b;
   f->offs = 64 * i;
   do { if (((f)->next.le_next = (&usb_frag_freelist)->lh_first) != ((void *)0)) (&usb_frag_freelist)->lh_first->next.le_prev = &(f)->next.le_next; (&usb_frag_freelist)->lh_first = (f); (f)->next.le_prev = &(&usb_frag_freelist)->lh_first; } while (0);
  }
  f = ((&usb_frag_freelist)->lh_first);
 }
 p->block = f->block;
 p->offs = f->offs;
 do { if ((f)->next.le_next != ((void *)0)) (f)->next.le_next->next.le_prev = (f)->next.le_prev; *(f)->next.le_prev = (f)->next.le_next; ((f)->next.le_prev) = ((void *)-1); ((f)->next.le_next) = ((void *)-1); } while (0);
 _splx(s);
 ;
 return (USBD_NORMAL_COMPLETION);
}
...
usb_freemem(struct usbd_bus *bus, struct usb_dma *p)
{
 ...
 if (p->block->frags == ((void *)0)) {
  ;
  usb_block_freemem(p->block);
  return;
 }
 s = splraise(2);
 f = &p->block->frags[p->offs / 64];
 do { if (((f)->next.le_next = (&usb_frag_freelist)->lh_first) != ((void *)0)) (&usb_frag_freelist)->lh_first->next.le_prev = &(f)->next.le_next; (&usb_frag_freelist)->lh_first = (f); (f)->next.le_prev = &(&usb_frag_freelist)->lh_first; } while (0);
 _splx(s);
 ;
}
