# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/mpe.h" 1
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_types.h" 1
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
void pipexintr(void);
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpe.c" 2
...
mpeattach(int nmpe)
{
 do { ((&mpeif_list)->lh_first) = ((void *)0); } while (0);
...
mpe_clone_create(struct if_clone *ifc, int unit)
{
 ...
 ifp->if_data.ifi_type = 0xa6;
 ifp->if_data.ifi_hdrlen = sizeof(struct shim_hdr);
 ...
 mpeif->sc_smpls.smpls_family = 33;

 do { if (((mpeif)->sc_list.le_next = (&mpeif_list)->lh_first) != ((void *)0)) (&mpeif_list)->lh_first->sc_list.le_prev = &(mpeif)->sc_list.le_next; (&mpeif_list)->lh_first = (mpeif); (mpeif)->sc_list.le_prev = &(&mpeif_list)->lh_first; } while (0);
...
mpe_clone_destroy(struct ifnet *ifp)
{
 ...
 do { if ((mpeif)->sc_list.le_next != ((void *)0)) (mpeif)->sc_list.le_next->sc_list.le_prev = (mpeif)->sc_list.le_prev; *(mpeif)->sc_list.le_prev = (mpeif)->sc_list.le_next; ((mpeif)->sc_list.le_prev) = ((void *)-1); ((mpeif)->sc_list.le_next) = ((void *)-1); } while (0);

 if (mpeif->sc_smpls.smpls_label) {
  rt_ifa_del(&mpeif->sc_ifa, 0x100000,
      ((struct sockaddr *)(&mpeif->sc_smpls)));
 }

 if_detach(ifp);
 free(mpeif, 2, sizeof *mpeif);
 return (0);
}
...
mpestart(struct ifnet *ifp0)
{
 ...
 for (;;) {
  do { (m) = ifq_dequeue(&ifp0->if_snd); } while ( 0);
  if (m == ((void *)0))
   return;

  af = *((sa_family_t *)((m)->m_hdr.mh_data));
  m_adj(m, sizeof(af));
  switch (af) {
  case 2:
   __builtin_bzero((sa), (sizeof(struct sockaddr_in)));
   satosin(sa)->sin_family = af;
   satosin(sa)->sin_len = sizeof(struct sockaddr_in);
   __builtin_bcopy((((caddr_t)((m)->m_hdr.mh_data))), (&satosin(sa)->sin_addr), (sizeof(in_addr_t)));
  ...
  if (ifp0->if_bpf) {
   ...
   m->m_hdr.mh_data += sizeof(struct shim_hdr);
   m->m_hdr.mh_len -= sizeof(struct shim_hdr);
   m->M_dat.MH.MH_pkthdr.len -= sizeof(struct shim_hdr);
   bpf_mtap_af(ifp0->if_bpf, af, m, (1<<1));
   m->m_hdr.mh_data -= sizeof(struct shim_hdr);
   m->m_hdr.mh_len += sizeof(struct shim_hdr);
   m->M_dat.MH.MH_pkthdr.len += sizeof(struct shim_hdr);
  }
 ...
 struct rtentry *rt)
{
 ...
 m->M_dat.MH.MH_pkthdr.ph_rtableid = 0;
 ...
 case 2:
  ...
  if (mpls_mapttl_ip) {
   ...
   shim.shim_label |= ((__uint32_t)(ip->ip_ttl)) & ((u_int32_t)((__uint32_t)((u_int32_t)(0x000000ffU))));
  } else
   shim.shim_label |= ((__uint32_t)(mpls_defttl)) & ((u_int32_t)((__uint32_t)((u_int32_t)(0x000000ffU))));
  off = sizeof(sa_family_t) + sizeof(in_addr_t);
  (m) = m_prepend((m), (sizeof(shim) + off), (0x0002));
  if (m == ((void *)0)) {
   error = 55;
   goto out;
  }
 ...
 m_copyback(m, off, sizeof(shim), (caddr_t)&shim, 0x0002);
...
mpeioctl(struct ifnet *ifp, u_long cmd, caddr_t data)
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((127))):
  if (ifr->ifr_ifru.ifru_metric < 256 ||
      ifr->ifr_ifru.ifru_metric > 8192)
   error = 22;
  else
   ifp->if_data.ifi_mtu = ifr->ifr_ifru.ifru_metric;
  break;
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((154))):
  ifm = ifp->if_softc;
  shim.shim_label =
      ((((__uint32_t)(ifm->sc_smpls.smpls_label & ((u_int32_t)((__uint32_t)((u_int32_t)(0xfffff000U))))))) >>
      12);
  error = copyout(&shim, ifr->ifr_ifru.ifru_data, sizeof(shim));
  break;
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((153))):
  ifm = ifp->if_softc;
  if ((error = copyin(ifr->ifr_ifru.ifru_data, &shim, sizeof(shim))))
   break;
  if (shim.shim_label > ((1 << 20) - 1) ||
      shim.shim_label <= 15) {
   error = 22;
   break;
  }
  shim.shim_label = ((__uint32_t)(shim.shim_label << 12));
  if (ifm->sc_smpls.smpls_label == shim.shim_label)
   break;
  for((ifm) = ((&mpeif_list)->lh_first); (ifm)!= ((void *)0); (ifm) = ((ifm)->sc_list.le_next)) {
   if (ifm != ifp->if_softc &&
  ...
  if (ifm->sc_smpls.smpls_label) {
   ...
   rt_ifa_del(&ifm->sc_ifa, 0x100000,
       ((struct sockaddr *)(&ifm->sc_smpls)));
  }

  ifm->sc_smpls.smpls_label = shim.shim_label;
  error = rt_ifa_add(&ifm->sc_ifa, 0x100000,
      ((struct sockaddr *)(&ifm->sc_smpls)));
  if (error) {
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((159))):
  ...
  ifm = ifp->if_softc;
  if (ifr->ifr_ifru.ifru_metric != ifp->if_data.ifi_rdomain) {
   if (ifm->sc_smpls.smpls_label) {
    rt_ifa_add(&ifm->sc_ifa, 0x100000,
        ((struct sockaddr *)(&ifm->sc_smpls)));
   }
  }
