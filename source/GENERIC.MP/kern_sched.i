# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c"
...
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c" 2
...
struct taskq *sbartq;
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c"
void
sched_init_cpu(struct cpu_info *ci)
{
 ...
 for (i = 0; i < 32; i++)
  do { (&spc->spc_qs[i])->tqh_first = ((void *)0); (&spc->spc_qs[i])->tqh_last = &(&spc->spc_qs[i])->tqh_first; } while (0);

 spc->spc_idleproc = ((void *)0);

 kthread_create_deferred(sched_kthreads_create, ci);

 do { ((&spc->spc_deadproc)->lh_first) = ((void *)0); } while (0);
...
sched_kthreads_create(void *v)
{
 ...
 if (fork1(&proc0, 0x00000080|0x00000010|0x00000040|
     0x00000020|0x00000200|0x00000004, sched_idle, ci, ((void *)0),
     &spc->spc_idleproc))
  panic("fork idle");
...
# 200 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c"
void
sched_exit(struct proc *p)
{
 ...
 nanouptime(&ts);
 do { (&ts)->tv_sec = (&ts)->tv_sec - (&spc->spc_runtime)->tv_sec; (&ts)->tv_nsec = (&ts)->tv_nsec - (&spc->spc_runtime)->tv_nsec; if ((&ts)->tv_nsec < 0) { (&ts)->tv_sec--; (&ts)->tv_nsec += 1000000000L; } } while (0);
...
setrunqueue(struct proc *p)
{
 ...
 do { do { if (splassert_ctl > 0) { splassert_check(14, __func__); } } while (0); ((__mp_lock_held(&sched_lock)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c", 244, "__mp_lock_held(&sched_lock)")); } while (0);
...
remrunqueue(struct proc *p)
{
 ...
 do { do { if (splassert_ctl > 0) { splassert_check(14, __func__); } } while (0); ((__mp_lock_held(&sched_lock)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c", 262, "__mp_lock_held(&sched_lock)")); } while (0);
 spc = &p->p_cpu->ci_schedstate;
 spc->spc_nrun--;
 ...
 if ((((&spc->spc_qs[queue])->tqh_first) == ((void *)0))) {
  spc->spc_whichqs &= ~(1 << queue);
...
sched_chooseproc(void)
{
 ...
 do { do { if (splassert_ctl > 0) { splassert_check(14, __func__); } } while (0); ((__mp_lock_held(&sched_lock)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c", 281, "__mp_lock_held(&sched_lock)")); } while (0);


 if (spc->spc_schedflags & 0x0004) {
  if (spc->spc_whichqs) {
   for (queue = 0; queue < 32; queue++) {
    while ((p = ((&spc->spc_qs[queue])->tqh_first))) {
     remrunqueue(p);
...
sched_choosecpu_fork(struct proc *parent, int flags)
{
 ...
 struct cpu_info *choice = ((void *)0);
 fixpt_t load, best_load = ~0;
 int run, best_run = 0x7fffffff;
 struct cpu_info *ci;
 struct cpuset set;
# 369 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c"
 cpuset_complement(&set, &sched_queued_cpus, &sched_idle_cpus);
 cpuset_intersection(&set, &set, &sched_all_cpus);
 if (cpuset_first(&set) == ((void *)0))
...
sched_choosecpu(struct proc *p)
{
 ...
 if (cpuset_isset(&set, p->p_cpu) ||
     (p->p_cpu == (__curcpu->ci_self) && p->p_cpu->ci_schedstate.spc_nrun == 0 &&
     (p->p_cpu->ci_schedstate.spc_schedflags & 0x0004) == 0 &&
 ...
 while ((ci = cpuset_first(&set)) != ((void *)0)) {
  ...
  if (choice == ((void *)0) || cost < last_cost) {
   choice = ci;
   last_cost = cost;
  }
  cpuset_del(&set, ci);
...
sched_steal_proc(struct cpu_info *self)
{
 ...
 while ((ci = cpuset_first(&set)) != ((void *)0)) {
  ...
  queue = ffs(spc->spc_whichqs) - 1;
  for((p) = ((&spc->spc_qs[queue])->tqh_first); (p) != ((void *)0); (p) = ((p)->p_runq.tqe_next)) {
   if (p->p_flag & 0x40000000)
    continue;

   cost = sched_proc_to_cpu_cost(self, p);

   if (best == ((void *)0) || cost < bestcost) {
    best = p;
    bestcost = cost;
   }
  }
...
# 535 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c"
...
sched_proc_to_cpu_cost(struct cpu_info *ci, struct proc *p)
{
 ...
 if (p->p_cpu == ci && p->p_slptime == 0) {
  l2resident =
      log2(((p->p_vmspace->vm_map.pmap)->pm_stats.resident_count));
...
# 713 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_sched.c"
