# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c" 2
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c"
struct uplcom_softc {
...
# 109 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c"
...
uplcom_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(uplcom_devs), sizeof (uplcom_devs) / sizeof ((uplcom_devs)[0]), sizeof ((uplcom_devs)[0]), (uaa->vendor), (uaa->product)) != ((void *)0) ?
  13 : 0);
}
...
uplcom_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (ddesc->bDeviceClass == 0x02)
  ...
  sc->sc_type_hx = 0;
# 267 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c"
 ...
 for (i = 0; i < id->bNumEndpoints; i++) {
  ...
  if (((ed->bEndpointAddress) & 0x80) == 0x80 &&
   ...
   sc->sc_isize = ((ed->wMaxPacketSize)[0] | ((ed->wMaxPacketSize)[1] << 8));
  }
 }
...
# 319 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uplcom.c"
...
uplcom_reset(struct uplcom_softc *sc)
{
 ...
 ((req.wIndex)[0] = (u_int8_t)(sc->sc_iface_number), (req.wIndex)[1] = (u_int8_t)((sc->sc_iface_number) >> 8));
...
uplcom_set_line_state(struct uplcom_softc *sc)
{
 ...
 ls = (sc->sc_dtr ? 0x0001 : 0) |
     (sc->sc_rts ? 0x0002 : 0);

 req.bmRequestType = (0x00 | 0x20 | 0x01);
 req.bRequest = 0x22;
 ((req.wValue)[0] = (u_int8_t)(ls), (req.wValue)[1] = (u_int8_t)((ls) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(sc->sc_iface_number), (req.wIndex)[1] = (u_int8_t)((sc->sc_iface_number) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
...
void
uplcom_set(void *addr, int portno, int reg64, int onoff)
{
...
uplcom_break(struct uplcom_softc *sc, int onoff)
{
 ...
 req.bmRequestType = (0x00 | 0x20 | 0x01);
 req.bRequest = 0x23;
 ((req.wValue)[0] = (u_int8_t)(onoff ? 0xffff : 0x0000), (req.wValue)[1] = (u_int8_t)((onoff ? 0xffff : 0x0000) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(sc->sc_iface_number), (req.wIndex)[1] = (u_int8_t)((sc->sc_iface_number) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
...
uplcom_set_crtscts(struct uplcom_softc *sc)
{
 ...
 req.bRequest = 0x01;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)((sc->sc_type_hx ? 0x61 : 0x41)), (req.wIndex)[1] = (u_int8_t)(((sc->sc_type_hx ? 0x61 : 0x41)) >> 8));
    ...
    struct usb_cdc_line_state *state)
{
 ...
 if (__builtin_memcmp((state), (&sc->sc_line_state), (7)) == 0) {
  ;
  return (USBD_NORMAL_COMPLETION);
 }
 ...
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(sc->sc_iface_number), (req.wIndex)[1] = (u_int8_t)((sc->sc_iface_number) >> 8));
 ((req.wLength)[0] = (u_int8_t)(7), (req.wLength)[1] = (u_int8_t)((7) >> 8));
...
uplcom_param(void *addr, int portno, struct termios *t)
{
 ...
 ((ls.dwDTERate)[0] = (u_int8_t)(t->c_ospeed), (ls.dwDTERate)[1] = (u_int8_t)((t->c_ospeed) >> 8), (ls.dwDTERate)[2] = (u_int8_t)((t->c_ospeed) >> 16), (ls.dwDTERate)[3] = (u_int8_t)((t->c_ospeed) >> 24));
...
uplcom_open(void *addr, int portno)
{
 ...
 if (sc->sc_type_hx == 1) {
  ...
  req.bmRequestType = (0x00 | 0x40 | 0x00);
  req.bRequest = 0x01;
  ((req.wValue)[0] = (u_int8_t)(2), (req.wValue)[1] = (u_int8_t)((2) >> 8));
  ((req.wIndex)[0] = (u_int8_t)(0x44), (req.wIndex)[1] = (u_int8_t)((0x44) >> 8));
  ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
  ...
  req.bmRequestType = (0x00 | 0x40 | 0x00);
  req.bRequest = 0x01;
  ((req.wValue)[0] = (u_int8_t)(9), (req.wValue)[1] = (u_int8_t)((9) >> 8));
  ((req.wIndex)[0] = (u_int8_t)(0), (req.wIndex)[1] = (u_int8_t)((0) >> 8));
  ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
