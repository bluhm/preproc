# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c" 2
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/jmb.c"
...
jmb_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 ctl0 = pci_conf_read(pa->pa_pc, pa->pa_tag, 0x40);
 ctl5 = pci_conf_read(pa->pa_pc, pa->pa_tag, 0x80);


 if (pa->pa_function == (((ctl0) & ((1<<9))) ? 1 : 0)) {
  ctl0 &= ~((1<<8) | (1<<12) |
      (1<<13) | (1<<14) |
      (1<<15));
 ...
 if (pa->pa_function == (((ctl0) & ((1<<1))) ? 1 : 0)) {
  ctl0 &= ~((1<<22) | (1<<23));
  ctl5 &= ~(1<<24);
 ...
 pci_conf_write(pa->pa_pc, pa->pa_tag, 0x40, ctl0);
 pci_conf_write(pa->pa_pc, pa->pa_tag, 0x80, ctl5);
 ...
 if (sata) {
  ...
  jpa.pa_class = (0x01 << 24) |
      (0x06 << 16) |
      (0x01 << 8);
  config_found_sm((self), (&jpa), (jmb_print), ((void *)0));
 }
