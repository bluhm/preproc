# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c"
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c"
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c" 2
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c"
struct art_table {
 struct art_table *at_parent;
 uint32_t at_index;
 uint32_t at_minfringe;
 uint32_t at_level;
 uint8_t at_bits;
 uint8_t at_offset;
...
struct art_table *art_table_gc_list = ((void *)0);
struct mutex art_table_gc_mtx = { ((void *)0), ((((2)) > 0 && ((2)) < 12) ? 12 : ((2))), 0 };
struct task art_table_gc_task =
        {{ ((void *)0), ((void *)0) }, (art_table_gc), (((void *)0)), 0 };

struct art_node *art_node_gc_list = ((void *)0);
struct mutex art_node_gc_mtx = { ((void *)0), ((((2)) > 0 && ((2)) < 12) ? 12 : ((2))), 0 };
struct task art_node_gc_task = {{ ((void *)0), ((void *)0) }, (art_gc), (((void *)0)), 0 };

void
art_init(void)
{
 pool_init(&an_pool, sizeof(struct art_node), 0, 2, 0,
     "art_node", ((void *)0));
 pool_init(&at_pool, sizeof(struct art_table), 0, 2, 0,
     "art_table", ((void *)0));
 pool_init(&at_heap_4_pool, ((1 << ((4) + 1)) * sizeof(void *)), 0, 2, 0,
     "art_heap4", ((void *)0));
 pool_init(&at_heap_8_pool, ((1 << ((8) + 1)) * sizeof(void *)), 0, 2, 0,
...
art_alloc(unsigned int rtableid, unsigned int alen, unsigned int off)
{
 ...
 ar = malloc(sizeof(*ar), 5, 0x0002|0x0008);
 if (ar == ((void *)0))
  return (((void *)0));
 ...
 _rw_init_flags(&ar->ar_lock, "art", 0, ((void *)0));
...
# 183 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c"
int
art_bindex(struct art_table *at, uint8_t *addr, int plen)
{
 ...
 ((bend <= 32) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 208, "bend <= 32"));
...
art_match(struct art_root *ar, void *addr, struct srp_ref *nsr)
{
 ...
 dflt = srp_enter(&dsr, &at->at_heap[1].node);
 ...
 while (1) {
  ...
  if ((((unsigned long)(entry) & 1) == 0))
   break;

  at = ((struct art_table *)((unsigned long)(entry) & ~1));

  ndflt = srp_enter(&ndsr, &at->at_heap[1].node);
  if (ndflt != ((void *)0)) {
   srp_leave(&dsr);
   dsr = ndsr;
   dflt = ndflt;
 ...
 if (entry == ((void *)0)) {
  srp_leave(nsr);
  *nsr = dsr;
  (((((unsigned long)(dflt) & 1) == 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 296, "ISLEAF(dflt)"));
  return (dflt);
 }

 srp_leave(&dsr);
done:
 (((((unsigned long)(entry) & 1) == 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 302, "ISLEAF(entry)"));
 return (entry);
}
...
art_lookup(struct art_root *ar, void *addr, int plen, struct srp_ref *nsr)
{
 ...
 ((plen >= 0 && plen <= ar->ar_alen) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 319, "plen >= 0 && plen <= ar->ar_alen"));
 ...
 if (plen == 0) {
  entry = srp_follow(nsr, &at->at_heap[1].node);
  goto done;
 }
 ...
 if (!(((unsigned long)(entry) & 1) == 0))
  entry = srp_follow(nsr, &((struct art_table *)((unsigned long)(entry) & ~1))->at_heap[1].node);

done:
 (((((unsigned long)(entry) & 1) == 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 359, "ISLEAF(entry)"));
 return (entry);
}
# 370 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c"
struct art_node *
art_insert(struct art_root *ar, struct art_node *an, void *addr, int plen)
{
 ...
 ((plen >= 0 && plen <= ar->ar_alen) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 378, "plen >= 0 && plen <= ar->ar_alen"));

 at = srp_get_locked(&ar->ar_root);
 if (at == ((void *)0)) {
  at = art_table_get(ar, ((void *)0), -1);
  if (at == ((void *)0))
   return (((void *)0));
 ...
 if (plen == 0) {
  node = srp_get_locked(&at->at_heap[1].node);
  if (node != ((void *)0))
   return (node);

  art_table_ref(ar, at);
  srp_swap_locked(&at->at_heap[1].node, an);
  return (an);
 }
 ...
 while (plen > (at->at_offset + at->at_bits)) {
  ...
  if ((((unsigned long)(node) & 1) == 0)) {
   child = art_table_get(ar, at, j);
   if (child == ((void *)0))
    return (((void *)0));

   art_table_ref(ar, at);
   srp_swap_locked(&at->at_heap[j].node, ((struct art_node *)((unsigned long)(child) | 1)));
   at = child;
  } else
   at = ((struct art_table *)((unsigned long)(node) & ~1));
 }
    ...
    struct art_node *an)
{
 ...
 if (!(((unsigned long)(node) & 1) == 0))
  prev = srp_get_locked(&((struct art_table *)((unsigned long)(node) & ~1))->at_heap[1].node);
 else
  prev = node;
 ...
 else if (!(((unsigned long)(node) & 1) == 0))
  srp_swap_locked(&((struct art_table *)((unsigned long)(node) & ~1))->at_heap[1].node, an);
 else
...
art_delete(struct art_root *ar, struct art_node *an, void *addr, int plen)
{
 ...
 rw_assert_wrlock(&ar->ar_lock);
 ((plen >= 0 && plen <= ar->ar_alen) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 482, "plen >= 0 && plen <= ar->ar_alen"));
 ...
 if (plen == 0) {
  node = srp_get_locked(&at->at_heap[1].node);
  srp_swap_locked(&at->at_heap[1].node, ((void *)0));
    ...
    struct art_node *an)
{
 ...
 ((prev == an) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 540, "prev == an"));
 ...
 if (i < at->at_minfringe)
  ...
  srp_swap_locked(&((struct art_table *)((unsigned long)(node) & ~1))->at_heap[1].node, next);
 else
...
art_walk(struct art_root *ar, int (*f)(struct art_node *, void *), void *arg)
{
 ...
 if (at != ((void *)0)) {
  ...
  node = srp_enter(&sr, &at->at_heap[1].node);
  error = art_walk_apply(ar, node, ((void *)0), f, arg);
  srp_leave(&sr);
    ...
    int (*f)(struct art_node *, void *), void *arg)
{
 ...
 for (i = at->at_minfringe; i < maxfringe; i++) {
  ...
  node = srp_enter(&sr, &at->at_heap[i].node);
  if (!(((unsigned long)(node) & 1) == 0)) {
   nat = art_table_ref(ar, ((struct art_table *)((unsigned long)(node) & ~1)));
   node = srp_follow(&sr, &nat->at_heap[1].node);
  } else
   nat = ((void *)0);
...
art_table_get(struct art_root *ar, struct art_table *parent, int j)
{
 ...
 ((j != 0 && j != 1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 728, "j != 0 && j != 1"));
 ((parent != ((void *)0) || j == -1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 729, "parent != NULL || j == -1"));
 ...
 ((lvl < ar->ar_nlvl) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 736, "lvl < ar->ar_nlvl"));

 at = pool_get(&at_pool, 0x0002|0x0008);
 if (at == ((void *)0))
  return (((void *)0));

 switch (((1 << ((ar->ar_bits[lvl]) + 1)) * sizeof(void *))) {
 case ((1 << ((4) + 1)) * sizeof(void *)):
  at_heap = pool_get(&at_heap_4_pool, 0x0002|0x0008);
  break;
 case ((1 << ((8) + 1)) * sizeof(void *)):
  at_heap = pool_get(&at_heap_8_pool, 0x0002|0x0008);
  break;
 default:
 ...
 at->at_heap = at_heap;
 at->at_heap[0].count = 0;

 if (parent != ((void *)0)) {
  node = srp_get_locked(&parent->at_heap[j].node);

  srp_swap_locked(&at->at_heap[1].node, node);
...
art_table_put(struct art_root *ar, struct art_table *at)
{
 ...
 ((at->at_heap[0].count == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 789, "at->at_refcnt == 0"));
 ((j != 0 && j != 1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 790, "j != 0 && j != 1"));

 if (parent != ((void *)0)) {
  ((j != -1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 793, "j != -1"));
  ((at->at_level == parent->at_level + 1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 794, "at->at_level == parent->at_level + 1"));
  ((parent->at_heap[0].count >= 1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 795, "parent->at_refcnt >= 1"));


  node = srp_get_locked(&at->at_heap[1].node);
  srp_swap_locked(&parent->at_heap[j].node, node);
 } else {
  ((j == -1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 801, "j == -1"));
...
art_table_gc(void *null)
{
 ...
 while (at != ((void *)0)) {
  ...
  if (at->at_level == 0)
   ...
   srp_finalize(((struct art_node *)((unsigned long)(at) | 1)), "arttfini");

  switch (((1 << ((at->at_bits) + 1)) * sizeof(void *))) {
  case ((1 << ((4) + 1)) * sizeof(void *)):
...
# 874 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c"
void
    ...
    struct art_node *new)
{
 ...
 ((i < at->at_minfringe) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/art.c", 881, "i < at->at_minfringe"));
...
again:
 ...
 while (1) {
  ...
  if (!(((unsigned long)(node) & 1) == 0)) {
   dflt = srp_get_locked(&((struct art_table *)((unsigned long)(node) & ~1))->at_heap[1].node);
   if (dflt == old) {
    srp_swap_locked(&((struct art_table *)((unsigned long)(node) & ~1))->at_heap[1].node,
        new);
   }
  } else if (node == old) {
...
art_get(void *dst, uint8_t plen)
{
 ...
 an = pool_get(&an_pool, 0x0002 | 0x0008);
 if (an == ((void *)0))
  return (((void *)0));

 an->an_plen = plen;
 srp_init(&(&an->an_pointer.an__rtlist)->sl_head);
