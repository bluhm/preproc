# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c" 2
...
{
 u_int64_t size = ip->dinode_u.e2fs_din->e2di_size;

 if ((ip->dinode_u.e2fs_din->e2di_mode & 0170000) == 0100000)
  size |= (u_int64_t)ip->dinode_u.e2fs_din->e2di_size_hi << 32;
...
{
 struct m_ext2fs *fs = ip->inode_u.e2fs;

 if (size <= fs->e2fs_maxfilesize) {

  if ((ip->dinode_u.e2fs_din->e2di_mode & 0170000) == 0100000 || ip->dinode_u.e2fs_din->e2di_mode == 0)
   ip->dinode_u.e2fs_din->e2di_size_hi = size >> 32;

  ip->dinode_u.e2fs_din->e2di_size = size;
  return (0);
 }
 ...
 if ((fs->e2fs.e2fs_features_rocompat & 0x0002) == 0) {
  fs->e2fs.e2fs_features_rocompat |= 0x0002;
  fs->e2fs_fmod = 1;
 }
 return (27);
}
...
ext2fs_inactive(void *v)
{
 ...
 if (ip->dinode_u.e2fs_din == ((void *)0) || ip->dinode_u.e2fs_din->e2di_mode == 0 || ip->dinode_u.e2fs_din->e2di_dtime)
  goto out;

 error = 0;
 if (ip->dinode_u.e2fs_din->e2di_nlink == 0 && (vp->v_mount->mnt_flag & 0x00000001) == 0) {
  if (ext2fs_size(ip) != 0) {
   error = ext2fs_truncate(ip, (off_t)0, 0, ((struct ucred *)-1));
  }
  getnanotime(&ts);
  ip->dinode_u.e2fs_din->e2di_dtime = ts.tv_sec;
  ip->i_flag |= 0x0002 | 0x0004;
  ext2fs_inode_free(ip, ip->i_number, ip->dinode_u.e2fs_din->e2di_mode);
 }
...
out:
 ...
 if (ip->dinode_u.e2fs_din == ((void *)0) || ip->dinode_u.e2fs_din->e2di_dtime != 0)
  vrecycle(vp, p);
 return (error);
}
# 155 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c"
int
ext2fs_update(struct inode *ip, int waitfor)
{
 ...
 if (((ip)->i_vnode)->v_mount->mnt_flag & 0x00000001)
  return (0);
 ...
 if ((ip->i_flag & 0x0008) == 0)
  return (0);
 ip->i_flag &= ~0x0008;
 fs = ip->inode_u.e2fs;
 error = bread(ip->i_ump->um_devvp,
     ((((fs)->e2fs_gd[(((ip->i_number) - 1) / (fs)->e2fs.e2fs_ipg)].ext2bgd_i_tables + (((ip->i_number)-1) % (fs)->e2fs.e2fs_ipg)/(fs)->e2fs_ipb)) << (fs)->e2fs_fsbtodb),
 ...
 cp = (caddr_t)bp->b_data +
     ((((ip->i_number)-1) % (fs)->e2fs_ipb) * ((fs)->e2fs.e2fs_rev > 0 ? (fs)->e2fs.e2fs_inode_size : 128));
 ...
 ip->dinode_u.e2fs_din->e2di_uid_low = (u_int16_t)ip->inode_ext.e2fs.ext2fs_effective_uid;
 ip->dinode_u.e2fs_din->e2di_gid_low = (u_int16_t)ip->inode_ext.e2fs.ext2fs_effective_gid;
 ip->dinode_u.e2fs_din->e2di_uid_high = ip->inode_ext.e2fs.ext2fs_effective_uid >> 16;
 ip->dinode_u.e2fs_din->e2di_gid_high = ip->inode_ext.e2fs.ext2fs_effective_gid >> 16;

 e2fs_i_bswap((fs), (ip->dinode_u.e2fs_din), ((struct ext2fs_dinode *)cp));
 if (waitfor)
  return (bwrite(bp));
 else {
  bdwrite(bp);
...
# 207 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c"
int
ext2fs_truncate(struct inode *oip, off_t length, int flags, struct ucred *cred)
{
 struct vnode *ovp = ((oip)->i_vnode);
 int32_t lastblock;
 int32_t bn, lbn, lastiblock[3], indir_lbn[3];
 int32_t oldblks[12 + 3], newblks[12 + 3];
 struct m_ext2fs *fs;
 struct buf *bp;
 ...
 if (ovp->v_type == VLNK && ext2fs_size(oip) < ((12 +3) * sizeof (u_int32_t))) {

  if (length != 0)
   panic("ext2fs_truncate: partial truncate of symlink");

  __builtin_memset((&oip->dinode_u.e2fs_din->e2di_blocks), (0), (ext2fs_size(oip)));
  (void)ext2fs_setsize(oip, 0);
  oip->i_flag |= 0x0002 | 0x0004;
 ...
 if (osize < length) {
  ...
  offset = ((length - 1) & (fs)->e2fs_qbmask);
  lbn = ((length - 1) >> (fs)->e2fs_bshift);
  aflags = 0x01;
  if (flags & 0x04)
   aflags |= 0x02;
 ...
 offset = ((length) & (fs)->e2fs_qbmask);
 if (offset == 0) {
  (void)ext2fs_setsize(oip, length);
 } else {
  lbn = ((length) >> (fs)->e2fs_bshift);
  aflags = 0x01;
  if (flags & 0x04)
   aflags |= 0x02;
  ...
  uvm_vnp_setsize(ovp, length);
  uvm_vnp_uncache(ovp);
  __builtin_memset((bp->b_data + offset), (0), (size - offset));
  bp->b_bcount = size;
  if (aflags & 0x02)
   bwrite(bp);
  else
 ...
 lastblock = ((length + fs->e2fs_bsize - 1) >> (fs)->e2fs_bshift) - 1;
 lastiblock[0] = lastblock - 12;
 lastiblock[1] = lastiblock[0] - ((fs)->e2fs_bsize / sizeof(u_int32_t));
 lastiblock[2] = lastiblock[1] - ((fs)->e2fs_bsize / sizeof(u_int32_t)) * ((fs)->e2fs_bsize / sizeof(u_int32_t));
 nblocks = ((fs->e2fs_bsize) >> 9);
 ...
 __builtin_memcpy((oldblks), (&oip->dinode_u.e2fs_din->e2di_blocks[0]), (sizeof(oldblks)));
 for (level = 2; level >= 0; level--)
  if (lastiblock[level] < 0) {
   oip->dinode_u.e2fs_din->e2di_blocks[12 + level] = 0;
   lastiblock[level] = -1;
  }
 ...
 __builtin_memcpy((newblks), (&oip->dinode_u.e2fs_din->e2di_blocks[0]), (sizeof(newblks)));
 __builtin_memcpy((&oip->dinode_u.e2fs_din->e2di_blocks[0]), (oldblks), (sizeof(oldblks)));
 (void)ext2fs_setsize(oip, osize);
 vflags = ((length > 0) ? 0x0001 : 0) | 0x0002;
 allerror = vinvalbuf(ovp, vflags, cred, (__curcpu->ci_self)->ci_curproc, 0, 0);
 ...
 for (level = 2; level >= 0; level--) {
  bn = __extension__({ __uint32_t __swap32gen_x = (oip->dinode_u.e2fs_din->e2di_blocks[12 + level]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
  if (bn != 0) {
 ...
 for (i = 12 - 1; i > lastblock; i--) {
  bn = __extension__({ __uint32_t __swap32gen_x = (oip->dinode_u.e2fs_din->e2di_blocks[i]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
  if (bn == 0)
   continue;
  oip->dinode_u.e2fs_din->e2di_blocks[i] = 0;
  ext2fs_blkfree(oip, bn);
  blocksreleased += ((fs->e2fs_bsize) >> 9);
 }
 ...
 for (level = 0; level <= 2; level++)
  if (newblks[12 + level] !=
      oip->dinode_u.e2fs_din->e2di_blocks[12 + level])
   panic("ext2fs_truncate1");
 for (i = 0; i < 12; i++)
  if (newblks[i] != oip->dinode_u.e2fs_din->e2di_blocks[i])
   panic("ext2fs_truncate2");
 if (length == 0 &&
     (!(((&ovp->v_cleanblkhd)->lh_first) == ((void *)0)) ||
      !(((&ovp->v_dirtyblkhd)->lh_first) == ((void *)0))))
 ...
 (void)ext2fs_setsize(oip, length);
 if (blocksreleased >= oip->dinode_u.e2fs_din->e2di_nblock)
  oip->dinode_u.e2fs_din->e2di_nblock = 0;
 else
  oip->dinode_u.e2fs_din->e2di_nblock -= blocksreleased;
 oip->i_flag |= 0x0002;
 return (allerror);
}
# 417 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c"
static int
ext2fs_indirtrunc(struct inode *ip, int32_t lbn, int32_t dbn, int32_t lastbn, int level, long *countp)
{
 ...
 int32_t *bap;
 struct vnode *vp;
 int32_t *copy = ((void *)0), nb, nlbn, last;
 ...
 factor = 1;
 for (i = 0; i < level; i++)
  factor *= ((fs)->e2fs_bsize / sizeof(u_int32_t));
 last = lastbn;
 if (lastbn > 0)
  last /= factor;
 nblocks = ((fs->e2fs_bsize) >> 9);
# 450 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_inode.c"
 vp = ((ip)->i_vnode);
 ...
 if (lastbn >= 0) {
  copy = malloc(fs->e2fs_bsize, 127, 0x0001);
  __builtin_memcpy((copy), (bap), (fs->e2fs_bsize));
  __builtin_memset((&bap[last + 1]), (0), ((((fs)->e2fs_bsize / sizeof(u_int32_t)) - (last + 1)) * sizeof(u_int32_t)));
 ...
 for (i = ((fs)->e2fs_bsize / sizeof(u_int32_t)) - 1,
  ...
  i--, nlbn += factor) {
  nb = __extension__({ __uint32_t __swap32gen_x = (bap[i]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
  if (nb == 0)
   continue;
  if (level > 0) {
