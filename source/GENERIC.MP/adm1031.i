# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1031.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1031.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1031.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1031.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1031.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1031.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1031.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1031.c" 2
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1031.c"
struct admtt_softc {
...
admtt_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_fanmul = 11250/8 * (1 << (data >> 6)) * 60;


 strlcpy(sc->sc_sensordev.xname, sc->sc_dev.dv_xname,
     sizeof(sc->sc_sensordev.xname));

 sc->sc_sensor[0].type = SENSOR_TEMP;
 strlcpy(sc->sc_sensor[0].desc, "Internal",
     sizeof(sc->sc_sensor[0].desc));

 sc->sc_sensor[1].type = SENSOR_TEMP;
 strlcpy(sc->sc_sensor[1].desc, "External",
     sizeof(sc->sc_sensor[1].desc));

 sc->sc_sensor[2].type = SENSOR_TEMP;
 strlcpy(sc->sc_sensor[2].desc, "External",
     sizeof(sc->sc_sensor[2].desc));

 sc->sc_sensor[3].type = SENSOR_FANRPM;

 sc->sc_sensor[4].type = SENSOR_FANRPM;

 if (sensor_task_register(sc, admtt_refresh, 5) == ((void *)0)) {
...
admtt_refresh(void *arg)
{
 ...
 (*(sc->sc_tag)->ic_acquire_bus)((sc->sc_tag)->ic_cookie, (0));

 cmd = 0x0a;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[0].value = 273150000 + 1000000 * data;

 cmd = 0x0b;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[1].value = 273150000 + 1000000 * data;

 cmd = 0x0c;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[2].value = 273150000 + 1000000 * data;

 cmd = 0x08;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0) {
  if (data == 0)
   sc->sc_sensor[3].flags |= 0x0001;
  else {
   sc->sc_sensor[3].value =
 ...
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0) {
  if (data == 0)
   sc->sc_sensor[4].flags |= 0x0001;
  else {
   sc->sc_sensor[4].value =
       sc->sc_fanmul / (2 * (int)data);
   sc->sc_sensor[4].flags &= ~0x0001;
  }
 }

 (*(sc->sc_tag)->ic_release_bus)((sc->sc_tag)->ic_cookie, (0));
}
