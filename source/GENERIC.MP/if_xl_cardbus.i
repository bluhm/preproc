# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c" 2
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/if_xl_cardbus.c"
...
xl_cardbus_lookup(const struct cardbus_attach_args *ca)
{
 ...
 if ((((ca->ca_id) >> 0) & 0xffff) != 0x10b7)
  return (((void *)0));

 for (ecp = xl_cardbus_products; ecp->ecp_prodid != 0; ecp++)
  if ((((ca->ca_id) >> 16) & 0xffff) == ecp->ecp_prodid)
   return (ecp);
 return (((void *)0));
}
...
xl_cardbus_match(struct device *parent, void *match, void *aux)
{
 ...
 if (xl_cardbus_lookup(ca) != ((void *)0))
  return (1);
...
xl_cardbus_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (cardbus_mapreg_map((ct)->ct_sc, (ct->ct_func), (0x10), (0x00000001), (0), (&sc->xl_btag), (&ioh), (&adr), (&csc->sc_mapsize))) {
 ...
 if (csc->sc_cardtype == 0x0002) {

  if (cardbus_mapreg_map((ct)->ct_sc, (ct->ct_func), (0x18), (0x00000000), (0), (&csc->sc_funct), (&csc->sc_funch), (0), (&csc->sc_funcsize))) {
 ...
 pci_conf_write(ca->ca_pc, ca->ca_tag, 0x04,
     command);




 bhlc = pci_conf_read(ca->ca_pc, ca->ca_tag, 0x0c);
 if ((((bhlc) >> 8) & 0xff) < 0x20) {
  ...
  bhlc &= ~(0xff << 8);
  bhlc |= (0x20 << 8);
  pci_conf_write(ca->ca_pc, ca->ca_tag, 0x0c, bhlc);
 }
...
xl_cardbus_detach(struct device *self, int arg)
{
 ...
 xl_detach(sc);
 if (csc->sc_cardtype == 0x0002)
  cardbus_mapreg_unmap((ct)->ct_sc, (ct->ct_func), (0x18), (csc->sc_funct), (csc->sc_funch), (csc->sc_funcsize));

 cardbus_mapreg_unmap((ct)->ct_sc, (ct->ct_func), (0x10), (sc->xl_btag), (sc->xl_bhandle), (csc->sc_mapsize));
...
xl_cardbus_intr_ack(struct xl_softc *sc)
{
 ...
 bus_space_write_4(csc->sc_funct, csc->sc_funch, 0x0004,
     0x8000);
}
