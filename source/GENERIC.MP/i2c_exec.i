# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_exec.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_exec.c"
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_exec.c"
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_exec.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_exec.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_exec.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_exec.c" 2
...
# 139 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2cvar.h"
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_exec.c" 2
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_exec.c"
int
    ...
    size_t cmdlen, void *vbuf, size_t buflen, int flags)
{
 ...
 if (tag->ic_exec != ((void *)0))
  return ((*tag->ic_exec)(tag->ic_cookie, op, addr, cmd,
     cmdlen, buf, buflen, flags));

 if ((len = cmdlen) != 0) {
  if ((error = (*(tag)->ic_initiate_xfer)((tag)->ic_cookie, (addr), (flags))) != 0)
   goto bad;
  while (len--) {
   if ((error = (*(tag)->ic_write_byte)((tag)->ic_cookie, (*cmd++), (flags))) != 0)
    goto bad;
  }
 }
 ...
 while (len--) {
  ...
  if ((((int)(op) & 2) == 0)) {
   ...
   if ((len + 1) == buflen &&
       (error = (*(tag)->ic_initiate_xfer)((tag)->ic_cookie, (addr), (flags))) != 0)
    goto bad;

   if (len == 0)
    flags |= 0x02;
   if ((error = (*(tag)->ic_read_byte)((tag)->ic_cookie, (buf++), (flags))) != 0)
    goto bad;
  } else {
   ...
   if ((len + 1) == buflen && cmdlen == 0 &&
       (error = (*(tag)->ic_initiate_xfer)((tag)->ic_cookie, (addr), (flags))) != 0)
    goto bad;
   if ((error = (*(tag)->ic_write_byte)((tag)->ic_cookie, (*buf++), (flags))) != 0)
    goto bad;
  }
 }
 ...
 return (0);
 bad:
 (*(tag)->ic_send_stop)((tag)->ic_cookie, (flags));
 return (error);
}
    ...
    int flags)
{
 ...
 return (iic_exec(tag, I2C_OP_READ_WITH_STOP, addr,
     ((void *)0), 0, valp, sizeof (*valp), flags));
}
