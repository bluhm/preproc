# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c" 2
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c"
 ...
 void *val;
{
  ...
  *(int32_t *) val = ((int32_t *)(u_long)&tf->tf_global)[i];
 else
  error = copyin(&((int32_t *)(u_long)tf->tf_out[6])[i - 16], val, sizeof(int32_t));
 ...
 const void *val;
{
 ...
 if (i == 0)
  ...
  ((int32_t *)(u_long)&tf->tf_global)[i] = *(int32_t *) val;
 else

  error = copyout((caddr_t) val, &((int32_t *)(u_long)tf->tf_out[6])[i - 16], sizeof(int32_t));
...
readfpreg(p, i, val)
 ...
 void *val;
{
 *(int32_t *) val = ((int32_t) p->p_md.md_fpstate->fs_regs[i]);
 return 0;
}
...
writefpreg(p, i, val)
 ...
 const void *val;
{
 p->p_md.md_fpstate->fs_regs[i] = (*(const int32_t *) val);
 return 0;
}
...
# 185 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c"
 if (op.bits.div) {
  if (*rs2 == 0) {
 ...
 if (op.bits.cc) {
  ...
  tf->tf_tstate &= ~(0xff00000000LL);

  if (*rd == 0)
   tf->tf_tstate |= (u_int64_t)(0x04L|(0x04L<<4)) << 32;
  else {
   if (op.bits.sgn && *rd < 0)
    tf->tf_tstate |= (u_int64_t)(0x08L|(0x08L<<4)) << 32;
   if (op.bits.div) {
    if (*rd * *rs2 != *rs1)
     tf->tf_tstate |= (u_int64_t)(0x02L|(0x02L<<4)) << 32;
   }
   else {
    if (*rd / *rs2 != *rs1)
     tf->tf_tstate |= (u_int64_t)(0x02L|(0x02L<<4)) << 32;
...
swap_quad(int64_t *p)
{
 ...
 t = __extension__({ __uint64_t __swap64gen_x = (p[0]); (__uint64_t)((__swap64gen_x & 0xff) << 56 | (__swap64gen_x & 0xff00ULL) << 40 | (__swap64gen_x & 0xff0000ULL) << 24 | (__swap64gen_x & 0xff000000ULL) << 8 | (__swap64gen_x & 0xff00000000ULL) >> 8 | (__swap64gen_x & 0xff0000000000ULL) >> 24 | (__swap64gen_x & 0xff000000000000ULL) >> 40 | (__swap64gen_x & 0xff00000000000000ULL) >> 56); });
 p[0] = __extension__({ __uint64_t __swap64gen_x = (p[1]); (__uint64_t)((__swap64gen_x & 0xff) << 56 | (__swap64gen_x & 0xff00ULL) << 40 | (__swap64gen_x & 0xff0000ULL) << 24 | (__swap64gen_x & 0xff000000ULL) << 8 | (__swap64gen_x & 0xff00000000ULL) >> 8 | (__swap64gen_x & 0xff0000000000ULL) >> 24 | (__swap64gen_x & 0xff000000000000ULL) >> 40 | (__swap64gen_x & 0xff00000000000000ULL) >> 56); });
 p[1] = t;
}
...
int
emul_qf(int32_t insv, struct proc *p, union sigval sv, struct trapframe64 *tf)
{
 ...
 if (ins.i_op3.i_op3 == IOP3_STQF || ins.i_op3.i_op3 == IOP3_LDQF)
  ...
  asi = (tf->tf_tstate & 0xff000000LL) >> 24;
 else
  asi = ins.i_asi.i_asi;

 addr = tf->tf_global[ins.i_asi.i_rs1];
 if (ins.i_loadstore.i_i)
  addr += (((int64_t)(ins.i_simm13.i_simm13) << 51) >> 51);
 else
  addr += tf->tf_global[ins.i_asi.i_rs2];

 if (asi < 0x80) {

  _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c", 336);
  trapsignal(p, 4, 0, 5, sv);
  _kernel_unlock();
  return (0);
 }
 if (asi > 0x8b ||
 ...
 if ((freg & 3) != 0) {
  ...
  _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c", 349);
 ...
 if ((addr & 3) != 0) {
  ...
  _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c", 357);
 ...
 if (fs == ((void *)0)) {
  _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c", 365);
 ...
 if (isload) {
  ...
  if (err == 0) {
   if (asi & 8)
    swap_quad(buf);
   __builtin_bcopy((buf), (&fs->fs_regs[freg]), (sizeof(buf)));
  }
 } else {
  __builtin_bcopy((&fs->fs_regs[freg]), (buf), (sizeof(buf)));
  if (asi & 8)
   swap_quad(buf);
...
segv:
 _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/emul.c", 396);
 trapsignal(p, 11, isload ? 0x01 : 0x02,
     1, sv);
 _kernel_unlock();
 return (0);
}
...
int
emul_popc(int32_t insv, struct proc *p, union sigval sv, struct trapframe64 *tf)
{
 u_int64_t val, ret = 0;
 union instr ins;
 ...
 if (ins.i_simm13.i_i == 0)
  ...
  val = (((int64_t)(ins.i_simm13.i_simm13) << 51) >> 51);
