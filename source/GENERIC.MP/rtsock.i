# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c"
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c"
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 91 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c" 2
...
# 160 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c"
void
route_prinit(void)
{
...
route_ctloutput(int op, struct socket *so, int level, int optname,
    struct mbuf *m)
{
 struct routecb *rop = ((struct routecb *)(so)->so_pcb);
 int error = 0;
 unsigned int tid;
 ...
 case 1:
  switch (optname) {
  case 1:
   if (m == ((void *)0) || m->m_hdr.mh_len != sizeof(unsigned int))
    error = 22;
   else
    rop->msgfilter = *((unsigned int *)((m)->m_hdr.mh_data));
   break;
  case 2:
   if (m == ((void *)0) || m->m_hdr.mh_len != sizeof(unsigned int)) {
    error = 22;
   ...
   tid = *((unsigned int *)((m)->m_hdr.mh_data));
   if (tid != 0xffffffff && !rtable_exists(tid))
    error = 2;
   else
    rop->rtableid = tid;
   break;
 ...
 case 0:
  switch (optname) {
  case 1:
   m->m_hdr.mh_len = sizeof(unsigned int);
   *((unsigned int *)((m)->m_hdr.mh_data)) = rop->msgfilter;
   break;
  case 2:
   m->m_hdr.mh_len = sizeof(unsigned int);
   *((unsigned int *)((m)->m_hdr.mh_data)) = rop->rtableid;
   break;
  default:
   error = 42;
   break;
...
route_input(struct mbuf *m0, struct socket *so, sa_family_t sa_family)
{
 ...
 for((rop) = ((&route_cb.rcb)->lh_first); (rop)!= ((void *)0); (rop) = ((rop)->rcb_list.le_next)) {
  ...
  if (!(rp->rcb_socket->so_state & 0x002))
   continue;
  if (rp->rcb_socket->so_state & 0x020)
   continue;

  if (so == rp->rcb_socket && !(so->so_options & 0x0040))
   continue;
  ...
  if (rtm->rtm_type != 0x10 && rop->msgfilter != 0 &&
...
rtm_report(struct rtentry *rt, u_char type, int seq, int tableid)
{
 ...
 len = rtm_msg2(type, 5, &info, ((void *)0), ((void *)0));
 rtm = malloc(len, 5, 0x0001 | 0x0008);

 rtm_msg2(type, 5, &info, (caddr_t)rtm, ((void *)0));
 rtm->rtm_type = type;
 rtm->rtm_index = rt->rt_ifidx;
 rtm->rtm_tableid = tableid;
 rtm->rtm_priority = rt->rt_priority & 0x7f;
 rtm->rtm_flags = rt->rt_flags;
 rtm->rtm_pid = (__curcpu->ci_self)->ci_curproc->p_p->ps_pid;
 rtm->rtm_seq = seq;
    ...
    struct mbuf *control)
{
 ...
 if (m == ((void *)0) || ((m->m_hdr.mh_len < sizeof(int32_t)) &&
     (m = m_pullup(m, sizeof(int32_t))) == 0))
  return (55);
 if ((m->m_hdr.mh_flags & 0x0002) == 0)
  panic("route_output");
 len = m->M_dat.MH.MH_pkthdr.len;
 if (len < __builtin_offsetof(struct rt_msghdr, rtm_type) + 1 ||
     len != ((struct rt_msghdr *)((m)->m_hdr.mh_data))->rtm_msglen) {
  error = 22;
  goto fail;
 }
 vers = ((struct rt_msghdr *)((m)->m_hdr.mh_data))->rtm_version;
 switch (vers) {
 case 5:
 ...
 if ((rtm->rtm_flags & (0x200000|0x400000)) != 0) {
  error = 22;
  goto fail;
 }


 rtm->rtm_priority &= 0x7f;
 rtm->rtm_flags &= ~(0x40|0x10000|0x20000);
 rtm->rtm_fmask &= (0x400 | 0x8000 | 0x4000 | 0x2000 | 0x1000 | 0x8 | 0x800 | 0x100000 | 0x1000000);

 if (rtm->rtm_priority != 0) {
  if (rtm->rtm_priority > 63 ||
      rtm->rtm_priority == 1) {
   error = 22;
   goto fail;
  }
  prio = rtm->rtm_priority;
 } else if (rtm->rtm_type != 0x1)
  prio = 64;
 else if (rtm->rtm_flags & 0x800)
  prio = 0;
 else
  prio = 56;
 ...
 if (rtm->rtm_type != 0x13 &&
    (info.rti_info[0] == ((void *)0) ||
     info.rti_info[0]->sa_family >= 36 ||
     (info.rti_info[1] != ((void *)0) &&
     info.rti_info[1]->sa_family >= 36) ||
     info.rti_info[3] != ((void *)0))) {
  error = 22;
  goto fail;
 }
 ...
 if (info.rti_info[1] != ((void *)0) &&
     info.rti_info[1]->sa_family == 18 &&
     (info.rti_flags & 0x100) == 0) {
  info.rti_flags |= 0x400;
 }
# 682 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c"
 if (rtm->rtm_type == 0x13) {
    ...
    struct rt_addrinfo *info, uint8_t prio, unsigned int tableid)
{
 ...
 case 0x1:
  ...
  rt = rtable_match(tableid, info->rti_info[0], ((void *)0));
  ...
  if ((rt != ((void *)0)) && ((rt->rt_flags) & (0x20000)))
   goto change;
 ...
 case 0x2:
  ...
  if (((rt->rt_flags) & (0x200000|0x400000))) {
   if_put(ifp);
   error = 22;
   break;
  }
 ...
 case 0x8:
  ...
  if ((rt != ((void *)0)) && ((rt->rt_flags) & (0x40000)) &&
      (info->rti_info[1] == ((void *)0))) {
   rtfree(rt);
   rt = ((void *)0);
  }
  ...
  if ((rt == ((void *)0)) && (info->rti_info[1] != ((void *)0)) &&
      (rtm->rtm_type == 0x3)) {
   rt = rtable_lookup(tableid, info->rti_info[0],
       info->rti_info[2], ((void *)0), prio);
  ...
  plen = rtable_satoplen(info->rti_info[0]->sa_family,
      info->rti_info[2]);
  if (((rt)->rt_plen) != plen ) {
   error = 3;
   break;
  ...
  case 0x3:
   if (info->rti_info[1] != ((void *)0))
    if (rt->rt_gateway == ((void *)0) ||
        __builtin_bcmp((rt->rt_gateway), (info->rti_info[1]), (info->rti_info[1]->sa_len))) {
...
change:
   if (info->rti_info[1] != ((void *)0)) {
    ...
    if (!newgate && rt->rt_gateway->sa_family !=
        info->rti_info[1]->sa_family) {
         error = 22;
     break;
    }

    error = rt_setgate(rt,
        info->rti_info[1], tableid);
    if (error)
     break;
   }

   if ((rtm->rtm_flags & 0x100000) &&
   ...
   } else if (newgate || ((rtm->rtm_fmask & 0x100000) &&
...
# 969 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c"
   if (rtm->rtm_fmask)
    rt->rt_flags =
...
# 1031 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c"
int
route_arp_conflict(struct rtentry *rt, struct rt_addrinfo *info)
{

 int proxy = (info->rti_flags & 0x4000);

 if ((info->rti_flags & 0x400) == 0 ||
     (info->rti_info[0]->sa_family != 2))
  return (0);

 if (rt == ((void *)0) || !((rt->rt_flags) & (0x400)))
  return (0);
 ...
 if ((((rt->rt_flags) & (0x4000)) == proxy) ||
     ((rt->rt_flags) & (0x40000)))
  return (17);


 info->rti_flags |= 0x40000;
...
rtm_getmetrics(const struct rt_kmetrics *in, struct rt_metrics *out)
{
 ...
 __builtin_bzero((out), (sizeof(*out)));
...
rtm_xaddrs(caddr_t cp, caddr_t cplim, struct rt_addrinfo *rtinfo)
{
 ...
 __builtin_bzero((rtinfo->rti_info), (sizeof(rtinfo->rti_info)));
 for (i = 0; (i < 15) && (cp < cplim); i++) {
  if ((rtinfo->rti_addrs & (1 << i)) == 0)
   continue;
  rtinfo->rti_info[i] = sa = (struct sockaddr *)cp;
  (cp += (((sa)->sa_len) > 0 ? (1 + ((((sa)->sa_len) - 1) | (sizeof(long) - 1))) : sizeof(long)));
 }
}
...
rtm_msg1(int type, struct rt_addrinfo *rtinfo)
{
 ...
 if (m == ((void *)0))
  return (m);
 m->M_dat.MH.MH_pkthdr.len = m->m_hdr.mh_len = hlen = len;
 m->M_dat.MH.MH_pkthdr.ph_ifidx = 0;
 rtm = ((struct rt_msghdr *)((m)->m_hdr.mh_data));
 __builtin_bzero((rtm), (len));
 for (i = 0; i < 15; i++) {
  if (rtinfo == ((void *)0) || (sa = rtinfo->rti_info[i]) == ((void *)0))
   continue;
  rtinfo->rti_addrs |= (1 << i);
  dlen = ((sa->sa_len) > 0 ? (1 + (((sa->sa_len) - 1) | (sizeof(long) - 1))) : sizeof(long));
  if (m_copyback(m, len, dlen, sa, 0x0002)) {
   m_freem(m);
   return (((void *)0));
  }
  len += dlen;
...
again:
 ...
 for (i = 0; i < 15; i++) {
  ...
  dlen = ((sa->sa_len) > 0 ? (1 + (((sa->sa_len) - 1) | (sizeof(long) - 1))) : sizeof(long));
  if (cp) {
   __builtin_bcopy((sa), (cp), ((size_t)dlen));
   cp += dlen;
  }
  len += dlen;
 }
    ...
    u_int ifidx, int error, u_int tableid)
{
 ...
 rtm->rtm_index = ifidx;
 route_input(m, ((void *)0), sa ? sa->sa_family : 0);
}
...
rtm_ifchg(struct ifnet *ifp)
{
 ...
 if (route_cb.any_count == 0)
  return;
 m = rtm_msg1(0xe, ((void *)0));
 if (m == ((void *)0))
  return;
 ifm = ((struct if_msghdr *)((m)->m_hdr.mh_data));
 ifm->ifm_index = ifp->if_index;
 ifm->ifm_tableid = ifp->if_data.ifi_rdomain;
...
# 1341 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c"
void
rtm_addr(struct rtentry *rt, int cmd, struct ifaddr *ifa)
{
 ...
 ifam->ifam_tableid = ifp->if_data.ifi_rdomain;

 route_input(m, ((void *)0),
...
# 1427 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtsock.c"
int
sysctl_dumpentry(struct rtentry *rt, void *v, unsigned int id)
{
 ...
 if (w->w_op == 2 && !(rt->rt_flags & w->w_arg))
  return 0;
 if (w->w_op == 1 && w->w_arg) {
  u_int8_t prio = w->w_arg & 0x7f;
  if (w->w_arg < 0) {
   prio = (-w->w_arg) & 0x7f;

   if (prio == (rt->rt_priority & 0x7f))
    return 0;
  } else {
   if (prio != (rt->rt_priority & 0x7f) &&
       prio != 64)
 ...
 size = rtm_msg2(0x4, 5, &info, ((void *)0), w);
...
sysctl_ifnames(struct walkarg *w)
{
 ...
 for((ifp) = ((&ifnet)->tqh_first); (ifp) != ((void *)0); (ifp) = ((ifp)->if_list.tqe_next)) {
  ...
  if (w->w_where && w->w_needed <= 0) {
   ...
   __builtin_memset((&ifn), (0), (sizeof(ifn)));
    ...
    size_t newlen)
{
 ...
 if (namelen == 4) {
  ...
  tableid = (__curcpu->ci_self)->ci_curproc->p_p->ps_rtableid;
 ...
 case 5:
  ...
  if (!rtable_exists(tableid))
   return (2);
  __builtin_memset((&tableinfo), (0), (sizeof tableinfo));
...
sysctl_rtable_rtstat(void *oldp, size_t *oldlenp, void *newp)
{
 ...
 extern char _ctassert[(sizeof(rtstat) == ((sizeof((counters)) / sizeof((counters)[0])) * sizeof(uint32_t))) ? 1 : -1 ] __attribute__((__unused__));
 __builtin_memset((&rtstat), (0), (sizeof rtstat));
 counters_read(rtcounters, counters, (sizeof((counters)) / sizeof((counters)[0])));
...
{
 if (info->rti_addrs & ~(0x4 | 0x20 | 0x1000 | 0x2000 |
     0x4000)) {
  return -1;
 }

 if (((info->rti_addrs) & (0x4))) {
  struct sockaddr *sa = info->rti_info[2];
  if (sa == ((void *)0))
   return -1;
  switch (sa->sa_family) {
  case 2:
 ...
 if (((info->rti_addrs) & (0x20))) {
  struct sockaddr *sa = info->rti_info[5];
  if (sa == ((void *)0))
   return -1;
  switch (sa->sa_family) {
  case 2:
 ...
 if (((info->rti_addrs) & (0x1000))) {
  struct sockaddr_rtdns *rtdns =
      (struct sockaddr_rtdns *)info->rti_info[12];
  if (rtdns == ((void *)0))
   return -1;
  if (rtdns->sr_len > sizeof(*rtdns))
   return -1;
  if (rtdns->sr_len <=
      __builtin_offsetof(struct sockaddr_rtdns, sr_dns))
   return -1;
 }

 if (((info->rti_addrs) & (0x2000))) {
  struct sockaddr_rtstatic *rtstatic =
      (struct sockaddr_rtstatic *)info->rti_info[13];
  if (rtstatic == ((void *)0))
   return -1;
  if (rtstatic->sr_len > sizeof(*rtstatic))
   return -1;
  if (rtstatic->sr_len <=
      __builtin_offsetof(struct sockaddr_rtstatic, sr_static))
   return -1;
 }

 if (((info->rti_addrs) & (0x4000))) {
  struct sockaddr_rtsearch *rtsearch =
      (struct sockaddr_rtsearch *)info->rti_info[14];
  if (rtsearch == ((void *)0))
   return -1;
  if (rtsearch->sr_len > sizeof(*rtsearch))
   return -1;
  if (rtsearch->sr_len <=
      __builtin_offsetof(struct sockaddr_rtsearch, sr_search))
   return -1;
 }
