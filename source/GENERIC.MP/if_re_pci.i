# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c"
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c"
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/if_re_pci.c" 2
...
re_pci_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (pci_intr_map_msi(pa, &ih) == 0)
  sc->rl_flags |= 0x00000001;
 else if (pci_intr_map(pa, &ih) != 0) {
  printf(": couldn't map interrupt\n");
  return;
 }
 intrstr = pci_intr_string(pc, ih);
 psc->sc_ih = pci_intr_establish(pc, ih, 6 | 0x100, re_intr,
 ...
 if (pci_get_capability(pc, pa->pa_tag, 0x10,
  ...
  reg64 = pci_conf_read(pc, pa->pa_tag, offset + 0x10);
  reg64 &= ~(0x00000001 | 0x00000002 |
      0x00000100);
  pci_conf_write(pc, pa->pa_tag, offset + 0x10, reg64);
  sc->rl_flags |= 0x00000004;
 }
 ...
 if (!((((pa->pa_id) >> 0) & 0xffff) == 0x10ec &&
  ...
  bus_space_write_1(sc->rl_btag, sc->rl_bhandle, 0x0050, (0x40|0x80));
  cfg = bus_space_read_1(sc->rl_btag, sc->rl_bhandle, 0x0053);
  if (sc->rl_flags & 0x00000001) {
   cfg |= 0x20;
   bus_space_write_1(sc->rl_btag, sc->rl_bhandle, 0x0053, cfg);
  } else {
   if ((cfg & 0x20) != 0) {
    cfg &= ~0x20;
    bus_space_write_1(sc->rl_btag, sc->rl_bhandle, 0x0053, cfg);
 ...
 sc->sc_product = (((pa->pa_id) >> 16) & 0xffff);
