# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
...
struct tty;
struct uio;
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/scsi_tape.h" 1
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/scsi_tape.h"
struct scsi_rw_tape {
 u_int8_t opcode;
 u_int8_t byte2;
...
# 178 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/scsi_tape.h"
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c" 2
# 98 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
struct modes {
 u_int quirks;
 int blksize;
 u_int8_t density;
...
struct st_softc {
 ...
 int blkmin;
 int blkmax;
 const struct quirkdata *quirkdata;

 u_int64_t numblks;
 u_int32_t media_blksize;
 u_int32_t media_density;
 int media_fileno;
 int media_blkno;
 int media_eom;
...
# 288 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
...
st_loadquirks(struct st_softc *st)
{
 ...
 mode2 = &st->modes;
 __builtin_bzero((mode2), (sizeof(struct modes)));
 st->modeflags &= ~(0x08 |
     0x02 | 0x04 |
     0x01);
 if ((mode->quirks | st->drive_quirks) & 0x0001) {
...
stopen(dev_t dev, int flags, int fmt, struct proc *p)
{
 ...
 st = (struct st_softc *)device_lookup(&st_cd, (((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) >> 4) )));
 if (st == ((void *)0))
  return (6);
 link = st->sc_link;
 ...
 if (((flags) & (0x0002)) && ((link->flags) & (0x0004))) {
  error = 13;
  goto done;
 }
...
stclose(dev_t dev, int flags, int mode, struct proc *p)
{
 ...
 if ((st->flags & (0x0004 | 0x0100)) == 0x0004)
  st_write_filemarks(st, 1, 0);

 switch (( ((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x03)) {
 case 0:
  st_unmount(st, 0, 1);
  break;
 case 3:
...
st_mount_tape(dev_t dev, int flags)
{
 ...
 if ((error = st_load(st, 0x01, 0)) != 0)
  goto done;
# 608 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
 scsi_test_unit_ready(link, 5, 0x00020);
...
st_unmount(struct st_softc *st, int eject, int rewind)
{
 ...
 if (!(st->flags & 0x0800))
  return;
 ;
 st_check_eod(st, 0, &nmarks, 0x00040);
 if (rewind)
  st_rewind(st, 0, 0x00040);
 scsi_prevent(link, 0x00,
     0x00100 | 0x00040);
 if (eject)
  st_load(st, 0x00, 0x00040);
 st->flags &= ~0x0800;
 link->flags &= ~0x0002;
}
...
st_decide_mode(struct st_softc *st, int first_read)
{
 ...
 if (first_read &&
     (!(st->quirks & 0x0008) || (st->media_blksize == 0) ||
...
# 799 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
 switch (st->density) {
...
ststrategy(struct buf *bp)
{
 ...
 st = (struct st_softc *)device_lookup(&st_cd, (((((int32_t)((bp->b_dev) & 0xff) | (((bp->b_dev) & 0xffff0000) >> 8)) >> 4) )));
 if (st == ((void *)0)) {
  bp->b_error = 6;
  goto bad;
 }
...
ststart(struct scsi_xfer *xs)
{
 ...
 for (;;) {
  ...
  if (st->flags & 0x0008) {
   ...
   if (st->flags & 0x0010) {
    if ((bp->b_flags & 0x00008000) == 0x00000000) {
  ...
  if (st->flags & (0x0040 | 0x0020)) {
   bp->b_resid = bp->b_bcount;
   if (st->flags & 0x0020) {
    bp->b_error = 5;
    bp->b_flags |= 0x00000400;
   }
   st->flags &= ~(0x0040 | 0x0020);
   s = _splraise(5);
   biodone(bp);
   _splx(s);
   continue;
...
{
 return (physio(ststrategy, dev, 0x00008000, stminphys, uio));
}

int
stwrite(dev_t dev, struct uio *uio, int iomode)
{
 return (physio(ststrategy, dev, 0x00000000, stminphys, uio));
}
...
stioctl(dev_t dev, u_long cmd, caddr_t arg, int flag, struct proc *p)
{
 ...
 case ((unsigned long)0x40000000 | ((sizeof(struct mtget) & 0x1fff) << 16) | ((('m')) << 8) | ((2))): {
  ...
  error = st_mode_sense(st, 0x00020);
  if (error)
   break;

  ;
  __builtin_bzero((g), (sizeof(struct mtget)));
  g->mt_type = 0x7;
  g->mt_blksiz = st->blksize;
  g->mt_density = st->density;
  g->mt_mblksiz = st->modes.blksize;
  g->mt_mdensity = st->modes.density;
  if (st->sc_link->flags & 0x0004)
   g->mt_dsreg |= 0x10;
  if (st->flags & 0x0800)
   g->mt_dsreg |= 0x03;
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct mtop) & 0x1fff) << 16) | ((('m')) << 8) | ((1))): {
  ...
  case 3:
   ...
   if (!error)
    error = st_space(st, number, 0x00, flags);
   break;
  case 5:
  ...
  case 7:
   break;
  case 8:
   error = st_load(st, 0x02, flags);
   if (!error)
    error = st_load(st, 0x01, flags);
   break;
  case 10:
   error = st_check_eod(st, 0, &nmarks, flags);
   if (!error)
    error = st_space(st, 1, 0x03, flags);
   break;
  case 12:
   st->flags &= ~0x1000;
   goto try_new_value;
 ...
 case ((unsigned long)0x20000000 | ((0 & 0x1fff) << 16) | ((('m')) << 8) | ((3))):
 case ((unsigned long)0x20000000 | ((0 & 0x1fff) << 16) | ((('m')) << 8) | ((4))):
  break;
# 1296 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
 default:
...
st_read(struct st_softc *st, char *buf, int size, int flags)
{
 ...
 xs = scsi_xs_get(st->sc_link, flags | 0x00800);
 if (xs == ((void *)0))
  return (12);
 xs->cmdlen = sizeof(*cmd);
 xs->data = buf;
 ...
 if (st->flags & 0x0008) {
  cmd->byte2 |= 0x01;
  _lto3b(size / (st->blksize ? st->blksize : 512),
      cmd->len);
 } else
  _lto3b(size, cmd->len);
...
{
 struct scsi_block_limits_data *block_limits = ((void *)0);
 ...
 block_limits = dma_alloc(sizeof(*block_limits), 0x0002);
 if (block_limits == ((void *)0))
  return (12);
...
# 1433 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
int
st_mode_sense(struct st_softc *st, int flags)
{
 union scsi_mode_sense_buf *data = ((void *)0);
 struct scsi_link *link = st->sc_link;
 ...
 error = scsi_do_mode_sense(link, 0, data, (void **)&page0,
     &density, &block_count, &block_size, 1, flags | 0x00020, &big);
 if (error != 0)
  goto done;
...
{
 union scsi_mode_sense_buf *inbuf = ((void *)0), *outbuf = ((void *)0);
 struct scsi_blk_desc general;
 struct scsi_link *link = st->sc_link;
 u_int8_t *page0 = ((void *)0);
 int error = 0, big, page0_size;

 inbuf = dma_alloc(sizeof(*inbuf), 0x0002);
 if (inbuf == ((void *)0)) {
  error = 12;
  goto done;
 }
 outbuf = dma_alloc(sizeof(*outbuf), 0x0002 | 0x0008);
 if (outbuf == ((void *)0)) {
  error = 12;
  goto done;
 }
 ...
 __builtin_bzero((&general), (sizeof(general)));
 ...
 error = scsi_do_mode_sense(link, 0, inbuf, (void **)&page0, ((void *)0),
     ((void *)0), ((void *)0), 1, flags | 0x00020, &big);
 if (error != 0)
  goto done;
 ...
 if (page0 == ((void *)0)) {
  ...
  __builtin_memcpy((&outbuf->buf[sizeof(outbuf->hdr)+ sizeof(general)]), (page0), (page0_size));
  ...
  __builtin_memcpy((&outbuf->buf[sizeof(outbuf->hdr_big) + sizeof(general)]), (page0), (page0_size));
 ...
 if (big == 0) {
  ...
  if ((st->flags & 0x1000) == 0)
   outbuf->hdr.dev_spec = 0x10;
  outbuf->hdr.blk_desc_len = sizeof(general);
  __builtin_memcpy((&outbuf->buf[sizeof(outbuf->hdr)]), (&general), (sizeof(general)));
 ...
 if ((st->flags & 0x1000) == 0)
  outbuf->hdr_big.dev_spec = 0x10;
 _lto2b(sizeof(general), outbuf->hdr_big.blk_desc_len);
 __builtin_memcpy((&outbuf->buf[sizeof(outbuf->hdr_big)]), (&general), (sizeof(general)));
...
st_space(struct st_softc *st, int number, u_int what, int flags)
{
 ...
 switch (what) {
 case 0x00:
  if (st->flags & (0x0010 | 0x0020 | 0x0040 | 0x0200)) {
   if (number > 0) {
    st->flags &= ~(0x0010 | 0x0020 | 0x0040 | 0x0200);
    return 5;
   } else if (number < 0) {
    if (st->flags & 0x0010) {
...
st_write_filemarks(struct st_softc *st, int number, int flags)
{
 ...
 case 1:
  ...
  break;
 default:
  st->flags &= ~((0x0010 | 0x0020 | 0x0040 | 0x0200) | 0x0004);
  break;
 }
...
# 1830 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
int
st_check_eod(struct st_softc *st, int position, int *nmarks, int flags)
{
 int error;

 switch (st->flags & (0x0004 | 0x0100 | 0x0400)) {
 default:
  *nmarks = 0;
  return 0;
 case 0x0004:
 case 0x0004 | 0x0100 | 0x0400:
  *nmarks = 1;
  break;
 case 0x0004 | 0x0400:
  *nmarks = 2;
 ...
 if (position && !error)
  error = st_space(st, -*nmarks, 0x01, flags);
 return error;
}
...
st_rewind(struct st_softc *st, u_int immediate, int flags)
{
 ...
 if (xs == ((void *)0))
  return (12);
 xs->cmdlen = sizeof(*cmd);
 xs->timeout = immediate ? (30 * 1000) : (4 * 60 * 60 * 1000);
...
st_interpret_sense(struct scsi_xfer *xs)
{
 ...
 switch (skey) {
# 1972 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
 case 0x02:
 ...
 if ((st->flags & 0x0008) && xs->resid == xs->datalen) {
  if (st->flags & 0x0020)
   return 5;
  if (st->flags & 0x0010)
   return 0;
 ...
 if (skey == 0x08) {
  ...
  if ((st->quirks & 0x0002) &&
   ...
   st->blksize -= 512;
  } else if (!(st->flags & (0x0400 | 0x0200))) {
   st->flags |= 0x0200;
   st->flags |= 0x0040;
   xs->resid = xs->datalen;
   return (0);
...
# 2131 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/st.c"
int
st_touch_tape(struct st_softc *st)
{
 ...
 if ((error = st_mode_sense(st, 0)) != 0)
  goto done;
 buf = dma_alloc(maxblksize, 0x0002);
 if (!buf) {
  error = 12;
  goto done;
 }
 ...
 do {
  ...
  if ((error = st_mode_select(st, 0)) != 0)
   goto done;
  st_read(st, buf, readsize, 0x00020);
