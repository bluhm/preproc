# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
void pipe_init(void);
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c" 2
...
struct filterops pipe_rfiltops =
 { 1, ((void *)0), filt_pipedetach, filt_piperead };
struct filterops pipe_wfiltops =
 { 1, ((void *)0), filt_pipedetach, filt_pipewrite };
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c"
int nbigpipe;
...
{
 struct sys_pipe_args *uap = v;



 return (dopipe(p, ((uap)->fdp.be.datum), 0));
}

int
sys_pipe2(struct proc *p, void *v, register_t *retval)
{
 struct sys_pipe2_args *uap = v;




 if (((uap)->flags.be.datum) & ~(0x10000 | 0x0004))
  return (22);

 return (dopipe(p, ((uap)->fdp.be.datum), ((uap)->flags.be.datum)));
}
...
dopipe(struct proc *p, int *ufds, int flags)
{
 ...
 struct file *rf, *wf;
 struct pipe *rpipe, *wpipe = ((void *)0);
 int fds[2], cloexec, error;

 cloexec = (flags & 0x10000) ? 0x01 : 0;

 rpipe = pool_get(&pipe_pool, 0x0001);
 error = pipe_create(rpipe);
 if (error != 0)
  goto free1;
 wpipe = pool_get(&pipe_pool, 0x0001);
 ...
 if (error != 0)
  goto free2;
 rf->f_flag = 0x0001 | 0x0002 | (flags & 0x0004);
 rf->f_type = 3;
 rf->f_data = rpipe;
 rf->f_ops = &pipeops;
 ...
 if (error != 0)
  goto free3;
 wf->f_flag = 0x0001 | 0x0002 | (flags & 0x0004);
 wf->f_type = 3;
 wf->f_data = wpipe;
 wf->f_ops = &pipeops;
 ...
 do { (rf)->f_iflags &= ~0x02; (--(rf)->f_count == 0 ? fdrop(rf, p) : 0); } while (0);
 do { (wf)->f_iflags &= ~0x02; (--(wf)->f_count == 0 ? fdrop(wf, p) : 0); } while (0);
 ...
 else if (((p)->p_p->ps_traceflag & (1<<(8)) && ((p)->p_flag & 0x00000001) == 0))
  ktrstruct(p, "fds", fds, (2) * sizeof(int));
...
pipe_create(struct pipe *cpipe)
{
 ...
 __builtin_memset((&cpipe->pipe_sel), (0), (sizeof(cpipe->pipe_sel)));
 cpipe->pipe_state = 0;
 cpipe->pipe_peer = ((void *)0);
 cpipe->pipe_busy = 0;

 error = pipespace(cpipe, 16384);
 if (error != 0)
  return (error);
...
{
 int error;
 while (cpipe->pipe_state & 0x100) {
  cpipe->pipe_state |= 0x200;
  if ((error = tsleep(cpipe, 16|0x100, "pipelk", 0)))
   return error;
 }
 cpipe->pipe_state |= 0x100;
 return 0;
}
...
{
 if (cpipe->pipe_state & 0x040) {
  cpipe->pipe_state &= ~0x040;
  selwakeup(&cpipe->pipe_sel);
 } else
  do { struct klist *list = (&cpipe->pipe_sel.si_note); if ((list) != ((void *)0)) knote((list), (0)); } while (0);
 if ((cpipe->pipe_state & 0x004) && cpipe->pipe_pgid != (99999 +1))
  gsignal(cpipe->pipe_pgid, 23);
}
...
pipe_read(struct file *fp, off_t *poff, struct uio *uio, struct ucred *cred)
{
 ...
 while (uio->uio_resid) {
  ...
  if (rpipe->pipe_buffer.cnt > 0) {
   ...
   if (rpipe->pipe_state & 0x080)
    break;




   if (rpipe->pipe_state & 0x010) {
    rpipe->pipe_state &= ~0x010;
    wakeup(rpipe);
   }
   ...
   if (fp->f_flag & 0x0004) {
    ...
    rpipe->pipe_state |= 0x008;
    if ((error = tsleep(rpipe, 16|0x100, "piperd", 0)) == 0)
     error = pipelock(rpipe);
   }
   if (error)
    goto unlocked_error;
...
unlocked_error:
 ...
 if ((rpipe->pipe_busy == 0) && (rpipe->pipe_state & 0x020)) {
  rpipe->pipe_state &= ~(0x020|0x010);
  wakeup(rpipe);
 } else if (rpipe->pipe_buffer.cnt < (16384/3)) {
 ...
 if ((rpipe->pipe_buffer.size - rpipe->pipe_buffer.cnt) >= 512)
  pipeselwakeup(rpipe);
...
pipe_write(struct file *fp, off_t *poff, struct uio *uio, struct ucred *cred)
{
 ...
 if ((wpipe == ((void *)0)) || (wpipe->pipe_state & 0x080)) {
  return (32);
 }
 ++wpipe->pipe_busy;
 ...
 if ((uio->uio_resid > 16384) &&
     (nbigpipe < 32) &&
     (wpipe->pipe_buffer.size <= 16384) &&
     (wpipe->pipe_buffer.cnt == 0)) {

  if ((error = pipelock(wpipe)) == 0) {
   if (pipespace(wpipe, (64*1024)) == 0)
    nbigpipe++;
   pipeunlock(wpipe);
  }
 }
 ...
 if (error) {
  ...
  if ((wpipe->pipe_busy == 0) &&
      (wpipe->pipe_state & 0x020)) {
   wpipe->pipe_state &= ~(0x020 | 0x008);
   wakeup(wpipe);
  }
  return (error);
 }
...
retrywrite:
  ...
  if ((space < uio->uio_resid) && (orig_resid <= 512))
   space = 0;
  ...
  if (space > 0) {
   if ((error = pipelock(wpipe)) == 0) {
    size_t size;
    size_t segsize;
# 492 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_pipe.c"
   ...
   if (wpipe->pipe_state & 0x008) {
    wpipe->pipe_state &= ~0x008;
    wakeup(wpipe);
   }
   ...
   wpipe->pipe_state |= 0x010;
   error = tsleep(wpipe, (16 + 1)|0x100,
       "pipewr", 0);
   if (error)
    break;
 ...
 if ((wpipe->pipe_busy == 0) && (wpipe->pipe_state & 0x020)) {
  wpipe->pipe_state &= ~(0x020 | 0x008);
  wakeup(wpipe);
...
pipe_poll(struct file *fp, int events, struct proc *p)
{
 ...
 if ((rpipe->pipe_state & 0x080) ||
     (wpipe == ((void *)0)) ||
     (wpipe->pipe_state & 0x080))
  revents |= 0x0010;
 else if (events & (0x0004 | 0x0004)) {
  if ((wpipe->pipe_buffer.size - wpipe->pipe_buffer.cnt) >= 512)
 ...
 if (revents == 0) {
  if (events & (0x0001 | 0x0040)) {
   ...
   rpipe->pipe_state |= 0x040;
  }
  if (events & (0x0004 | 0x0004)) {
   selrecord(p, &wpipe->pipe_sel);
   wpipe->pipe_state |= 0x040;
  }
 }
 return (revents);
}
...
pipe_free_kmem(struct pipe *cpipe)
{
 if (cpipe->pipe_buffer.buffer != ((void *)0)) {
  if (cpipe->pipe_buffer.size > 16384)
   --nbigpipe;
  amountpipekva -= cpipe->pipe_buffer.size;
...
pipeclose(struct pipe *cpipe)
{
 ...
 if (cpipe) {
  ...
  cpipe->pipe_state |= 0x080;
  while (cpipe->pipe_busy) {
   wakeup(cpipe);
   cpipe->pipe_state |= 0x020;
   tsleep(cpipe, 16, "pipecl", 0);
  }
...
{
 struct pipe *rpipe = kn->kn_ptr.p_fp->f_data;
 struct pipe *wpipe = rpipe->pipe_peer;

 switch (kn->kn_kevent.filter) {
 case (-1):
  kn->kn_fop = &pipe_rfiltops;
  do { (kn)->kn_selnext.sle_next = (&rpipe->pipe_sel.si_note)->slh_first; (&rpipe->pipe_sel.si_note)->slh_first = (kn); } while (0);
  break;
 case (-2):
  if (wpipe == ((void *)0)) {
  ...
  do { (kn)->kn_selnext.sle_next = (&wpipe->pipe_sel.si_note)->slh_first; (&wpipe->pipe_sel.si_note)->slh_first = (kn); } while (0);
  break;
 default:
  return (22);
 }
...
filt_pipedetach(struct knote *kn)
{
 ...
 switch (kn->kn_kevent.filter) {
 case (-1):
  do { if ((&rpipe->pipe_sel.si_note)->slh_first == (kn)) { do { ((&rpipe->pipe_sel.si_note))->slh_first = ((&rpipe->pipe_sel.si_note))->slh_first->kn_selnext.sle_next; } while (0); } else { struct knote *curelm = (&rpipe->pipe_sel.si_note)->slh_first; while (curelm->kn_selnext.sle_next != (kn)) curelm = curelm->kn_selnext.sle_next; curelm->kn_selnext.sle_next = curelm->kn_selnext.sle_next->kn_selnext.sle_next; } ((kn)->kn_selnext.sle_next) = ((void *)-1); } while (0);
  break;
 case (-2):
  if (wpipe == ((void *)0))
   return;
  do { if ((&wpipe->pipe_sel.si_note)->slh_first == (kn)) { do { ((&wpipe->pipe_sel.si_note))->slh_first = ((&wpipe->pipe_sel.si_note))->slh_first->kn_selnext.sle_next; } while (0); } else { struct knote *curelm = (&wpipe->pipe_sel.si_note)->slh_first; while (curelm->kn_selnext.sle_next != (kn)) curelm = curelm->kn_selnext.sle_next; curelm->kn_selnext.sle_next = curelm->kn_selnext.sle_next->kn_selnext.sle_next; } ((kn)->kn_selnext.sle_next) = ((void *)-1); } while (0);
  break;
 }
}
...
filt_piperead(struct knote *kn, long hint)
{
 ...
 kn->kn_kevent.data = rpipe->pipe_buffer.cnt;

 if ((rpipe->pipe_state & 0x080) ||
     (wpipe == ((void *)0)) || (wpipe->pipe_state & 0x080)) {
...
filt_pipewrite(struct knote *kn, long hint)
{
 ...
 kn->kn_kevent.data = wpipe->pipe_buffer.size - wpipe->pipe_buffer.cnt;

 return (kn->kn_kevent.data >= 512);
}

void
pipe_init(void)
{
 pool_init(&pipe_pool, sizeof(struct pipe), 0, 0, 0x0001,
     "pipepl", ((void *)0));
}
