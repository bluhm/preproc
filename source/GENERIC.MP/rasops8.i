# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c" 2
...
static int stamp_mutex;
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c"
void
...
# 112 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c"
...
rasops8_makestamp(struct rasops_info *ri, long attr)
{
 ...
 for (i = 0; i < 16; i++) {
  ...
  if (ri->ri_flg & 0x0004)
   stamp[i] = __extension__({ __uint32_t __swap32gen_x = (stamp[i]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
...
rasops8_putchar8(void *cookie, int row, int col, u_int uc, long attr)
{
 ...
 ri = (struct rasops_info *)cookie;
# 225 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c"
 if (attr != stamp_attr)
 ...
 if (uc == ' ') {
  ...
  while (height--) {
   rp[0] = (*(int32_t *)((caddr_t)stamp + (((1*4-2) >= 0 ? (fr[0])>>(1*4-2):(fr[0])<<-(1*4-2)) & (0xf << 2))));
   rp[1] = (*(int32_t *)((caddr_t)stamp + (((0*4-2) >= 0 ? (fr[0])>>(0*4-2):(fr[0])<<-(0*4-2)) & (0xf << 2))));
...
rasops8_putchar12(void *cookie, int row, int col, u_int uc, long attr)
{
 ...
 ri = (struct rasops_info *)cookie;
# 293 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c"
 if (attr != stamp_attr)
  rasops8_makestamp(ri, attr);
 ...
 if (uc == ' ') {
  ...
  while (height--) {
   rp[0] = (*(int32_t *)((caddr_t)stamp + (((1*4-2) >= 0 ? (fr[0])>>(1*4-2):(fr[0])<<-(1*4-2)) & (0xf << 2))));
   rp[1] = (*(int32_t *)((caddr_t)stamp + (((0*4-2) >= 0 ? (fr[0])>>(0*4-2):(fr[0])<<-(0*4-2)) & (0xf << 2))));
   rp[2] = (*(int32_t *)((caddr_t)stamp + (((1*4-2) >= 0 ? (fr[1])>>(1*4-2):(fr[1])<<-(1*4-2)) & (0xf << 2))));
...
rasops8_putchar16(void *cookie, int row, int col, u_int uc, long attr)
{
 ...
 ri = (struct rasops_info *)cookie;
# 364 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops8.c"
 if (attr != stamp_attr)
  rasops8_makestamp(ri, attr);
 ...
 if (uc == ' ') {
  ...
  while (height--) {
   ...
   rp[1] = (*(int32_t *)((caddr_t)stamp + (((0*4-2) >= 0 ? (fr[0])>>(0*4-2):(fr[0])<<-(0*4-2)) & (0xf << 2))));
   rp[2] = (*(int32_t *)((caddr_t)stamp + (((1*4-2) >= 0 ? (fr[1])>>(1*4-2):(fr[1])<<-(1*4-2)) & (0xf << 2))));
   rp[3] = (*(int32_t *)((caddr_t)stamp + (((0*4-2) >= 0 ? (fr[1])>>(0*4-2):(fr[1])<<-(0*4-2)) & (0xf << 2))));
