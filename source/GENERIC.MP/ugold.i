# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c"
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c"
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c" 2
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ugold.c"
...
ugold_match(struct device *parent, void *match, void *aux)
{
 ...
 if (usbd_match_device((const struct usb_devno *)(ugold_devs), sizeof (ugold_devs) / sizeof ((ugold_devs)[0]), sizeof ((ugold_devs)[0]), (uha->uaa->vendor), (uha->uaa->product)) == ((void *)0))
  return (0);
...
ugold_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 case 0x7401:
  ...
  strlcpy(sc->sc_sensor[0].desc, "inner",
      sizeof(sc->sc_sensor[0].desc));
  sc->sc_sensor[1].type = SENSOR_TEMP;
  strlcpy(sc->sc_sensor[1].desc, "outer",
 ...
 case 0x7402:
  ...
  strlcpy(sc->sc_sensor[0].desc, "inner",
      sizeof(sc->sc_sensor[0].desc));
  sc->sc_sensor[1].type = SENSOR_HUMIDITY;
  strlcpy(sc->sc_sensor[1].desc, "RH",
      sizeof(sc->sc_sensor[1].desc));
  break;
 default:
  printf(", unknown product\n");
...
{
 if (__builtin_memcmp((buf), ("TEMPer1F"), (len)) == 0 ||
     __builtin_memcmp((buf), ("TEMPer2F"), (len)) == 0 ||
     __builtin_memcmp((buf), ("TEMPerF1"), (len)) == 0)
  return;
...
ugold_ds75_intr(struct uhidev *addr, void *ibuf, u_int len)
{
 ...
 case 0x82:
  ...
  sc->sc_num_sensors = min(buf[1], 2) ;

  for (i = 0; i < sc->sc_num_sensors; i++) {
   sc->sc_sensor[i].flags |= 0x0001;
...
ugold_si700x_type(struct ugold_softc *sc, uint8_t *buf, u_int len)
{
 ...
 if (__builtin_memcmp((buf), ("mM12V1.0"), (len)) == 0) {
  sc->sc_type = 1;
...
ugold_si700x_intr(struct uhidev *addr, void *ibuf, u_int len)
{
 ...
 case 0x80:
  ...
  sc->sc_sensor[0].value = (temp * 1000) + 273150000;
  sc->sc_sensor[0].flags &= ~0x0001;
  rhum = ugold_si700x_rhum(sc->sc_type, buf[4], buf[5], temp);
  sc->sc_sensor[1].value = rhum;
  sc->sc_sensor[1].flags &= ~0x0001;
  break;
 default:
  if (!sc->sc_type) {
...
ugold_issue_cmd(struct ugold_softc *sc, uint8_t *cmd, int len)
{
 ...
 actlen = uhidev_set_report_async(sc->sc_hdev.sc_parent,
     0x02, sc->sc_hdev.sc_report_id, cmd, len);
 return (actlen != len);
}
