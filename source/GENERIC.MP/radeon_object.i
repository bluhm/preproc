# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c" 2
...
void radeon_bo_clear_va(struct radeon_bo *bo)
{
 ...
 for (bo_va = ({ __typeof( ((__typeof(*bo_va) *)0)->bo_list ) *__mptr = ((&bo->va)->next); (__typeof(*bo_va) *)( (char *)__mptr - __builtin_offsetof(__typeof(*bo_va), bo_list) );}), tmp = ({ __typeof( ((__typeof(*bo_va) *)0)->bo_list ) *__mptr = (bo_va->bo_list.next); (__typeof(*bo_va) *)( (char *)__mptr - __builtin_offsetof(__typeof(*bo_va), bo_list) );}); &bo_va->bo_list != (&bo->va); bo_va = tmp, tmp = ({ __typeof( ((__typeof(*tmp) *)0)->bo_list ) *__mptr = (tmp->bo_list.next); (__typeof(*tmp) *)( (char *)__mptr - __builtin_offsetof(__typeof(*tmp), bo_list) );})) {
...
static void radeon_ttm_bo_destroy(struct ttm_buffer_object *tbo)
{
 ...
 bo = ({ __typeof( ((struct radeon_bo *)0)->tbo ) *__mptr = (tbo); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, tbo) );});
 _rw_enter_write(&bo->rdev->gem.mutex );
 list_del_init(&bo->list);
 _rw_exit_write(&bo->rdev->gem.mutex );
...
_Bool radeon_ttm_bo_is_radeon_bo(struct ttm_buffer_object *bo)
{
...
void radeon_ttm_placement_from_domain(struct radeon_bo *rbo, u32 domain)
{
 ...
 if (domain & 0x4)
  rbo->placements[c++] = (1 << 18) | (1 << 17) |
     (1 << 2);
 if (domain & 0x2) {
  if (rbo->rdev->flags & RADEON_IS_AGP) {
   rbo->placements[c++] = (1 << 18) | (1 << 1);
  } else {
   rbo->placements[c++] = (1 << 16) | (1 << 1);
  }
 }
 if (domain & 0x1) {
  if (rbo->rdev->flags & RADEON_IS_AGP) {
   rbo->placements[c++] = (1 << 18) | (1 << 0);
  } else {
   rbo->placements[c++] = (1 << 16) | (1 << 0);
  }
 }
 if (!c)
  rbo->placements[c++] = ((1 << 16) | (1 << 17) | (1 << 18)) | (1 << 0);
 rbo->placement.num_placement = c;
 rbo->placement.num_busy_placement = c;
}

int radeon_bo_create(struct radeon_device *rdev,
       unsigned long size, int byte_align, _Bool kernel, u32 domain,
       struct sg_table *sg, struct radeon_bo **bo_ptr)
{
 struct radeon_bo *bo;
 enum ttm_bo_type type;
 unsigned long page_align = ((((byte_align)+(((1 << 13))-1))/((1 << 13)))*((1 << 13))) >> 13;
 size_t acc_size;
 int r;
 ...
 *bo_ptr = ((void *)0);
 ...
 bo = pool_get(&rdev->ddev->objpl, 0x0001 | 0x0008);
 if (bo == ((void *)0))
  return -12;
 ...
 _rw_enter_read(&rdev->pm.mclk_lock );
 r = ttm_bo_init(&rdev->mman.bdev, &bo->tbo, size, type,
   &bo->placement, page_align, !kernel, ((void *)0),
   acc_size, sg, &radeon_ttm_bo_destroy);
 _rw_exit_read(&rdev->pm.mclk_lock );
        ...
        u64 *gpu_addr)
{
 ...
 if (bo->pin_count) {
  ...
  if (max_offset != 0) {
   ...
   ({ static int __warned; int __ret = !!(max_offset < (radeon_bo_gpu_offset(bo) - domain_start)); if (__ret && !__warned) { printf("WARNING %s failed at %s:%d\n", "max_offset < (radeon_bo_gpu_offset(bo) - domain_start)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c", 232); __warned = 1; } __builtin_expect(!!(__ret), 0); });
 ...
 if (domain == 0x4) {
  ...
  bo->placement.lpfn = bo->rdev->mc.visible_vram_size >> 13;
 }
 if (max_offset) {
  u64 lpfn = max_offset >> 13;

  if (!bo->placement.lpfn)
   bo->placement.lpfn = bo->rdev->mc.gtt_size >> 13;

  if (lpfn < bo->placement.lpfn)
   bo->placement.lpfn = lpfn;
 }
 for (i = 0; i < bo->placement.num_placement; i++)
  bo->placements[i] |= (1 << 21);
...
int radeon_bo_unpin(struct radeon_bo *bo)
{
 ...
 if (!bo->pin_count) {
  printf("drm:pid%d:%s *WARNING* " "%p unpin not necessary\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , bo);
  return 0;
 }
 bo->pin_count--;
 if (bo->pin_count)
 ...
 r = ttm_bo_validate(&bo->tbo, &bo->placement, 0, 0);
 if (__builtin_expect(!!(r != 0), 0))
  printf("drm:pid%d:%s *ERROR* " "%p validate failed for unpin\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , bo);
 return r;
}
...
int radeon_bo_evict_vram(struct radeon_device *rdev)
{
 ...
 return ttm_bo_evict_mm(&rdev->mman.bdev, 2);
}
...
void radeon_bo_force_delete(struct radeon_device *rdev)
{
 ...
 for (bo = ({ __typeof( ((__typeof(*bo) *)0)->list ) *__mptr = ((&rdev->gem.objects)->next); (__typeof(*bo) *)( (char *)__mptr - __builtin_offsetof(__typeof(*bo), list) );}), n = ({ __typeof( ((__typeof(*bo) *)0)->list ) *__mptr = (bo->list.next); (__typeof(*bo) *)( (char *)__mptr - __builtin_offsetof(__typeof(*bo), list) );}); &bo->list != (&rdev->gem.objects); bo = n, n = ({ __typeof( ((__typeof(*n) *)0)->list ) *__mptr = (n->list.next); (__typeof(*n) *)( (char *)__mptr - __builtin_offsetof(__typeof(*n), list) );})) {
  ...
  _rw_exit_write(&rdev->ddev->struct_mutex );
 }
}
...
int radeon_bo_init(struct radeon_device *rdev)
{
 ...
 drm_mtrr_add(rdev->mc.aper_base, rdev->mc.aper_size, (1<<1));

 rdev->mc.vram_mtrr = 1;

 start = ((bus_space_mmap(rdev->memt, rdev->mc.aper_base, 0, 0, 0)) >> 13);
 end = start + ((rdev->mc.aper_size) >> 13);
 uvm_page_physload(start, end, start, end, 0x01);
# 343 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c"
...
int radeon_bo_list_validate(struct list_head *head)
{
 ...
 for (lobj = ({ __typeof( ((__typeof(*lobj) *)0)->tv.head ) *__mptr = ((head)->next); (__typeof(*lobj) *)( (char *)__mptr - __builtin_offsetof(__typeof(*lobj), tv.head) );}); &lobj->tv.head != (head); lobj = ({ __typeof( ((__typeof(*lobj) *)0)->tv.head ) *__mptr = (lobj->tv.head.next); (__typeof(*lobj) *)( (char *)__mptr - __builtin_offsetof(__typeof(*lobj), tv.head) );})) {
  bo = lobj->bo;
  if (!bo->pin_count) {
...
# 403 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c"
int radeon_bo_get_surface_reg(struct radeon_bo *bo)
{
 struct radeon_device *rdev = bo->rdev;
 struct radeon_surface_reg *reg64;
 struct radeon_bo *old_object;
 int steal;
 int i;

 ((!(!radeon_bo_is_reserved(bo))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c", 411, "!(!radeon_bo_is_reserved(bo))"));

 if (!bo->tiling_flags)
  return 0;

 if (bo->surface_reg >= 0) {
  reg64 = &rdev->surface_regs[bo->surface_reg];
  i = bo->surface_reg;
  goto out;
 }
...
out:
 ((rdev)->asic->surface.set_reg((rdev), (i), (bo->tiling_flags), (bo->pitch), (bo->tbo.mem.start << 13), (bo->tbo.num_pages << 13)));
...
static void radeon_bo_clear_surface_reg(struct radeon_bo *bo)
{
 ...
 reg64 = &rdev->surface_regs[bo->surface_reg];
 ((rdev)->asic->surface.clear_reg((rdev), (bo->surface_reg)));
    ...
    uint32_t tiling_flags, uint32_t pitch)
{
 ...
 if (rdev->family >= CHIP_CEDAR) {
  ...
  tilesplit = (tiling_flags >> 24) & 0xf;
  stilesplit = (tiling_flags >> 28) & 0xf;
  switch (bankw) {
  case 0:
  case 1:
  case 2:
...
void radeon_bo_get_tiling_flags(struct radeon_bo *bo,
    ...
    uint32_t *pitch)
{
 ((!(!radeon_bo_is_reserved(bo))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c", 537, "!(!radeon_bo_is_reserved(bo))"));
 if (tiling_flags)
...
int radeon_bo_check_tiling(struct radeon_bo *bo, _Bool has_moved,
    _Bool force_drop)
{
 ((!(!radeon_bo_is_reserved(bo) && !force_drop)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c", 547, "!(!radeon_bo_is_reserved(bo) && !force_drop)"));

 if (!(bo->tiling_flags & 0x10))
  return 0;
      ...
      struct ttm_mem_reg *mem)
{
 ...
 if (!radeon_ttm_bo_is_radeon_bo(bo))
  return;
 rbo = ({ __typeof( ((struct radeon_bo *)0)->tbo ) *__mptr = (bo); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, tbo) );});
...
int radeon_bo_fault_reserve_notify(struct ttm_buffer_object *bo)
{
 ...
 rdev = rbo->rdev;
 if (bo->mem.mem_type != 2)
  return 0;

 size = bo->mem.num_pages << 13;
 offset = bo->mem.start << 13;
 if ((offset + size) <= rdev->mc.visible_vram_size)
  return 0;


 radeon_ttm_placement_from_domain(rbo, 0x4);
 rbo->placement.lpfn = rdev->mc.visible_vram_size >> 13;
 r = ttm_bo_validate(bo, &rbo->placement, 0, 0);
 if (__builtin_expect(!!(r == -12), 0)) {
  radeon_ttm_placement_from_domain(rbo, 0x2);
  return ttm_bo_validate(bo, &rbo->placement, 0, 0);
 } else if (__builtin_expect(!!(r != 0), 0)) {
  return r;
 }
...
int radeon_bo_wait(struct radeon_bo *bo, u32 *mem_type, _Bool no_wait)
{
 int r;
 ...
 if (__builtin_expect(!!(r != 0), 0))
  return r;
 __mtx_enter(&bo->tbo.bdev->fence_lock);
 if (mem_type)
  *mem_type = bo->tbo.mem.mem_type;
 if (bo->tbo.sync_obj)
  r = ttm_bo_wait(&bo->tbo, 1, 1, no_wait);
 __mtx_leave(&bo->tbo.bdev->fence_lock);
 ttm_bo_unreserve(&bo->tbo);
 return r;
}
# 649 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.c"
int radeon_bo_reserve(struct radeon_bo *bo, _Bool no_intr)
{
 int r;
