# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c"
...
struct tty;
struct uio;
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
void device_register(struct device *, void *);
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhcreg.h" 1
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhcreg.h"
struct fhc_intr_reg {
 u_int64_t imap;
 u_int64_t unused_0;
 u_int64_t iclr;
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhc.c" 2
...
fhc_attach(struct fhc_softc *sc)
{
 ...
 bus_space_write_4(sc->sc_bt, sc->sc_ireg, 0x00000000, sc->sc_ign);
 sc->sc_ign = bus_space_read_4(sc->sc_bt, sc->sc_ireg, 0x00000000);

 ctrl = bus_space_read_4(sc->sc_bt, sc->sc_preg, 0x00000020);
 if (!sc->sc_is_central)
  ctrl |= 0x00000200;
 ctrl &= ~(0x00001000 | 0x00000800 | 0x00010000);
 bus_space_write_4(sc->sc_bt, sc->sc_preg, 0x00000020, ctrl);
 bus_space_read_4(sc->sc_bt, sc->sc_preg, 0x00000020);


 bus_space_write_4(sc->sc_bt, sc->sc_freg, 0x00000010, 0);
 bus_space_read_4(sc->sc_bt, sc->sc_freg, 0x00000010);
 bus_space_write_4(sc->sc_bt, sc->sc_sreg, 0x00000010, 0);
 bus_space_read_4(sc->sc_bt, sc->sc_sreg, 0x00000010);
 bus_space_write_4(sc->sc_bt, sc->sc_ureg, 0x00000010, 0);
 bus_space_read_4(sc->sc_bt, sc->sc_ureg, 0x00000010);
 bus_space_write_4(sc->sc_bt, sc->sc_treg, 0x00000010, 0);
 bus_space_read_4(sc->sc_bt, sc->sc_treg, 0x00000010);
 ...
 for (node = node0; node; node = nextsibling(node)) {
  ...
  (void)config_found_sm((&sc->sc_dv), ((void *)&fa), (fhc_print), ((void *)0));

  free(fa.fa_name, 2, 0);
  free(fa.fa_reg, 2, 0);
  free(fa.fa_intr, 2, 0);
  free(fa.fa_promvaddrs, 2, 0);
 }
    ...
    int level, int flags, int (*handler)(void *), void *arg, const char *what)
{
 ...
 if ((flags & 0x0002) == 0) {
  ...
  vec = ((sc->sc_ign << 6) & 0x0000007c0LL) |
      ((ihandle)&0x00000003fLL);
 } else
  ...
  *intrmapptr = r;
  r = *intrmapptr;
  ih->ih_number |= r & (0x0000007c0LL|0x00000003fLL);
 }
...
fhc_led_blink(void *vsc, int on)
{
 ...
 s = _splraise(15);
 r = bus_space_read_4(sc->sc_bt, sc->sc_preg, 0x00000020);
 if (on)
  r |= 0x00000010;
 else
  r &= ~0x00000010;
 r &= ~(0x00001000 | 0x00000800 | 0x00010000);
 bus_space_write_4(sc->sc_bt, sc->sc_preg, 0x00000020, r);
 bus_space_read_4(sc->sc_bt, sc->sc_preg, 0x00000020);
 _splx(s);
}
