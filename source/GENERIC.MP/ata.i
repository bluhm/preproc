# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c"
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c"
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/wdcreg.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c" 2
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c"
int
    ...
    struct ataparams *prms)
{
 ...
 if (drvp->drive_flags & 0x0001) {
  wdc_c.r_command = 0xec;
  wdc_c.r_st_bmask = 0x40;
  wdc_c.r_st_pmask = 0;
  wdc_c.timeout = 3000;
 } else if (drvp->drive_flags & 0x0002) {
 ...
 tb = dma_alloc(512, 0x0002 | 0x0008);
 if (tb == ((void *)0))
  return 2;
 wdc_c.flags = 0x0001 | flags;
 wdc_c.data = tb;
 wdc_c.bcount = 512;

 if ((ret = wdc_exec_command(drvp, &wdc_c)) != 0x01) {
  ;
...
# 120 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ata/ata.c"
  do { __size_t __swap16_multi_n = (10); __uint16_t *__swap16_multi_v = ((u_int16_t *)tb); while (__swap16_multi_n) { *__swap16_multi_v = __extension__({ __uint16_t __swap16gen_x = (*__swap16_multi_v); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }); __swap16_multi_v++; __swap16_multi_n--; } } while (0);
  do { __size_t __swap16_multi_n = (3); __uint16_t *__swap16_multi_v = ((u_int16_t *)tb + 20); while (__swap16_multi_n) { *__swap16_multi_v = __extension__({ __uint16_t __swap16gen_x = (*__swap16_multi_v); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }); __swap16_multi_v++; __swap16_multi_n--; } } while (0);
  do { __size_t __swap16_multi_n = (512 / 2 - 47); __uint16_t *__swap16_multi_v = ((u_int16_t *)tb + 47); while (__swap16_multi_n) { *__swap16_multi_v = __extension__({ __uint16_t __swap16gen_x = (*__swap16_multi_v); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); }); __swap16_multi_v++; __swap16_multi_n--; } } while (0);
   ...
   *p = __extension__({ __uint16_t __swap16gen_x = (*p); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
  }
...
ata_dmaerr(struct ata_drive_datas *drvp)
{
 ...
 drvp->n_dmaerrs++;
 if (drvp->n_dmaerrs >= 4 && drvp->n_xfers <= 1000) {
