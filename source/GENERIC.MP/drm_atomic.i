# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c" 2
...
int drm_plane_helper_commit(struct drm_plane *plane,
       ...
       struct drm_framebuffer *old_fb);
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c" 2
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
void drm_atomic_state_default_release(struct drm_atomic_state *state)
{
...
;
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int
drm_atomic_state_init(struct drm_device *dev, struct drm_atomic_state *state)
{
 ...
 state->crtcs = kcalloc(dev->mode_config.num_crtc,
          sizeof(*state->crtcs), (0x0001 | 0x0004));
 if (!state->crtcs)
  goto fail;
 state->crtc_states = kcalloc(dev->mode_config.num_crtc,
         sizeof(*state->crtc_states), (0x0001 | 0x0004));
 if (!state->crtc_states)
  goto fail;
 state->planes = kcalloc(dev->mode_config.num_total_plane,
    sizeof(*state->planes), (0x0001 | 0x0004));
 if (!state->planes)
  goto fail;
 state->plane_states = kcalloc(dev->mode_config.num_total_plane,
          sizeof(*state->plane_states), (0x0001 | 0x0004));
...
drm_atomic_state_alloc(struct drm_device *dev)
{
 ...
 if (!config->funcs->atomic_state_alloc) {
  state = kzalloc(sizeof(*state), (0x0001 | 0x0004));
  if (!state)
   return ((void *)0);
...
;
# 142 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
void drm_atomic_state_default_clear(struct drm_atomic_state *state)
{
 ...
 for (i = 0; i < state->num_connector; i++) {
  ...
  if (!connector || !connector->funcs)
   continue;
# 163 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
  state->connector_states[i]->connector = ((void *)0);
  connector->funcs->atomic_destroy_state(((void *)0),
             state->connector_states[i]);
  state->connectors[i] = ((void *)0);
  state->connector_states[i] = ((void *)0);
 }
 ...
 for (i = 0; i < config->num_crtc; i++) {
  ...
  crtc->funcs->atomic_destroy_state(crtc,
        state->crtc_states[i]);
  state->crtcs[i] = ((void *)0);
  state->crtc_states[i] = ((void *)0);
 }
 ...
 for (i = 0; i < config->num_total_plane; i++) {
  ...
  state->planes[i] = ((void *)0);
  state->plane_states[i] = ((void *)0);
 }
}
;
# 210 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
void drm_atomic_state_clear(struct drm_atomic_state *state)
{
 struct drm_device *dev = state->dev;
 struct drm_mode_config *config = &dev->mode_config;
...
;
# 229 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
void drm_atomic_state_free(struct drm_atomic_state *state)
{
 struct drm_device *dev;
...
;
# 268 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
struct drm_crtc_state *
drm_atomic_get_crtc_state(struct drm_atomic_state *state,
     struct drm_crtc *crtc)
{
...
;
# 310 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
     ...
     struct drm_display_mode *mode)
{
 ...
 if (mode && __builtin_memcmp((&state->mode), (mode), (sizeof(*mode))) == 0)
  return 0;
 ...
 if (mode) {
  ...
  __builtin_memset((&state->mode), (0), (sizeof(state->mode)));
  state->enable = 0;
  do { } while(0);
...
;
# 360 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
...
;
# 409 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int drm_atomic_crtc_set_property(struct drm_crtc *crtc,
  struct drm_crtc_state *state, struct drm_property *property,
  uint64_t val)
{
...
# 472 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
static int drm_atomic_crtc_check(struct drm_crtc *crtc,
  struct drm_crtc_state *state)
{
# 483 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
 ...
 if (drm_core_check_feature(crtc->dev, 0x10000) &&
     ({ int __ret = !!(state->enable && !state->mode_blob); if (__ret) printf("WARNING %s failed at %s:%d\n", "state->enable && !state->mode_blob", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c", 493); __builtin_expect(!!(__ret), 0); })) {
  do { } while(0);
 ...
 if (drm_core_check_feature(crtc->dev, 0x10000) &&
     ({ int __ret = !!(!state->enable && state->mode_blob); if (__ret) printf("WARNING %s failed at %s:%d\n", "!state->enable && state->mode_blob", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c", 500); __builtin_expect(!!(__ret), 0); })) {
  do { } while(0);
...
# 524 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
struct drm_plane_state *
drm_atomic_get_plane_state(struct drm_atomic_state *state,
     struct drm_plane *plane)
{
...
;
# 579 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int drm_atomic_plane_set_property(struct drm_plane *plane,
  struct drm_plane_state *state, struct drm_property *property,
  uint64_t val)
{
...
# 697 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
  ...
  struct drm_plane_state *state)
{
 ...
 if (({ int __ret = !!(state->crtc && !state->fb); if (__ret) printf("WARNING %s failed at %s:%d\n", "state->crtc && !state->fb", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c", 704); __builtin_expect(!!(__ret), 0); })) {
  do { } while(0);
  return -22;
 } else if (({ int __ret = !!(state->fb && !state->crtc); if (__ret) printf("WARNING %s failed at %s:%d\n", "state->fb && !state->crtc", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c", 707); __builtin_expect(!!(__ret), 0); })) {
  do { } while(0);
  return -22;
 }
 ...
 if (state->crtc_w > 0x7fffffff ||
     state->crtc_x > 0x7fffffff - (int32_t) state->crtc_w ||
     state->crtc_h > 0x7fffffff ||
     state->crtc_y > 0x7fffffff - (int32_t) state->crtc_h) {
  do { } while(0);
...
# 782 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
struct drm_connector_state *
drm_atomic_get_connector_state(struct drm_atomic_state *state,
     struct drm_connector *connector)
{
...
# 806 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
 if (index >= state->num_connector) {
  do { } while(0);
  return ERR_PTR(-35);
 }
...
;
# 854 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int drm_atomic_connector_set_property(struct drm_connector *connector,
  struct drm_connector_state *state, struct drm_property *property,
  uint64_t val)
{
...
# 957 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int
drm_atomic_set_crtc_for_plane(struct drm_plane_state *plane_state,
         struct drm_crtc *crtc)
{
 ...
 if (plane_state->crtc) {
  crtc_state = drm_atomic_get_crtc_state(plane_state->state,
             plane_state->crtc);
  if (({ int __ret = !!(IS_ERR(crtc_state)); if (__ret) printf("WARNING %s failed at %s:%d\n", "IS_ERR(crtc_state)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c", 967); __builtin_expect(!!(__ret), 0); }))
...
;
# 1004 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
void
...
;
# 1037 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int
drm_atomic_set_crtc_for_connector(struct drm_connector_state *conn_state,
      struct drm_crtc *crtc)
{
...
;
# 1079 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int
drm_atomic_add_affected_connectors(struct drm_atomic_state *state,
       struct drm_crtc *crtc)
{
...
;
# 1132 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int
drm_atomic_add_affected_planes(struct drm_atomic_state *state,
          struct drm_crtc *crtc)
{
...
;
# 1159 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int
drm_atomic_connectors_for_crtc(struct drm_atomic_state *state,
          struct drm_crtc *crtc)
{
...
;
# 1188 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
void drm_atomic_legacy_backoff(struct drm_atomic_state *state)
{
 int ret;
...
;
# 1217 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int drm_atomic_check_only(struct drm_atomic_state *state)
{
 struct drm_device *dev = state->dev;
 struct drm_mode_config *config = &dev->mode_config;
...
;
# 1280 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int drm_atomic_commit(struct drm_atomic_state *state)
{
 struct drm_mode_config *config = &state->dev->mode_config;
 int ret;
...
;
# 1311 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
int drm_atomic_async_commit(struct drm_atomic_state *state)
{
 struct drm_mode_config *config = &state->dev->mode_config;
 int ret;
...
# 1448 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_atomic.c"
     ...
     void *data, struct drm_file *file_priv)
{
 ...
 uint32_t *objs_ptr = (uint32_t *)(unsigned long)(arg->objs_ptr);
 uint32_t *count_props_ptr = (uint32_t *)(unsigned long)(arg->count_props_ptr);
 uint32_t *props_ptr = (uint32_t *)(unsigned long)(arg->props_ptr);
 uint64_t *prop_values_ptr = (uint64_t *)(unsigned long)(arg->prop_values_ptr);
 ...
 if (arg->flags & ~( 0x01 | 0x02 | 0x0100 | 0x0200 | 0x0400))
  return -22;
 ...
 state->allow_modeset = !!(arg->flags & 0x0400);
...
retry:
 ...
 for (i = 0; i < arg->count_objs; i++) {
  ...
  if (-copyin(objs_ptr + copied_objs, &(obj_id), sizeof(obj_id))) {
   ret = -14;
   goto out;
  }

  obj = drm_mode_object_find(dev, obj_id, 0);
  if (!obj || !obj->properties) {
   ret = -2;
   goto out;
  }

  if (-copyin(count_props_ptr + copied_objs, &(count_props), sizeof(count_props))) {
   ret = -14;
   goto out;
  }
  ...
  for (j = 0; j < count_props; j++) {
   ...
   if (-copyin(props_ptr + copied_props, &(prop_id), sizeof(prop_id))) {
    ret = -14;
    goto out;
   }
