# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c"
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c" 2
...
int udf_disklabelspoof(dev_t dev, void (*strat)(struct buf *),
 struct disklabel *lp);
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c" 2
...
struct sun_disklabel {
 ...
 u_int sl_xpsum;
 u_int sl_xpmag;
 struct sun_dkpart sl_xpart[8];
 u_char sl_types[16];
 u_int8_t sl_fragblock[16];
 u_int16_t sl_cpg[16];
 u_char sl_uid[8];
 char sl_xxx1[292 - sizeof(u_int) - sizeof(u_int) -
       (sizeof(struct sun_dkpart) * 8) -
       sizeof(u_char) * 16 -
       sizeof(u_int8_t) * 16 -
       sizeof(u_int16_t) * 16 -
       sizeof(u_int64_t)];
 ...
 u_short sl_ncylinders;
 u_short sl_acylinders;
 u_short sl_ntracks;
 u_short sl_nsectors;
 char sl_xxx4[4];
 struct sun_dkpart sl_part[8];
 u_short sl_magic;
 u_short sl_cksum;
};
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/cd.h" 1
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c"
int
    ...
    struct disklabel *lp, int spoofonly)
{
 ...
 if ((error = initdisklabel(lp)))
  goto done;
 lp->d_flags |= 0x08;
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c"
 if (strat == cdstrategy) {
 ...
 error = readdisksector(bp, strat, lp, ((0) / ((lp)->d_secsize / (1 << 9))));
 if (error)
  goto done;

 slp = (struct sun_disklabel *)bp->b_data;
 if (slp->sl_magic == 55998) {
  error = disklabel_sun_to_bsd(slp, lp);
  goto done;
 }

 error = checkdisklabel(bp->b_data + 128, lp, 0, (((u_int64_t)(lp)->d_secperunith << 32) + (lp)->d_secperunit));
 if (error == 0)
  goto done;

doslabel:
 error = readdoslabel(bp, strat, lp, ((void *)0), spoofonly);
 if (error == 0)
  goto done;
...
writedisklabel(dev_t dev, void (*strat)(struct buf *), struct disklabel *lp)
{
 ...
 ((bp->b_flags) |= (0x00000010 | 0x00000000 | 0x00004000));
 (*strat)(bp);
 error = biowait(bp);
...
# 178 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c"
static u_char
sun_fstypes[16] = {
 7,
 1,
...
disklabel_sun_to_bsd(struct sun_disklabel *sl, struct disklabel *lp)
{
 ...
 lp->d_flags = 0x08;
 __builtin_memcpy((lp->d_packname), (sl->sl_text), (sizeof(lp->d_packname)));
 ...
 if ((((u_int64_t)(lp)->d_secperunith << 32) + (lp)->d_secperunit) == 0 || (((u_int64_t)(lp)->d_secperunith << 32) + (lp)->d_secperunit) == 0x7fffffffffffLL)
  do { u_int64_t x = ((u_int64_t)secpercyl * sl->sl_ncylinders); (lp)->d_secperunith = x >> 32; (lp)->d_secperunit = x; } while (0);
 lp->d_version = 1;

 __builtin_memcpy((&lp->d_uid), (&sl->sl_uid), (sizeof(lp->d_uid)));
 ...
 for (i = 0; i < 8; i++) {
  ...
  do { u_int64_t x = (spp->sdkp_cyloffset * secpercyl); (npp)->p_offseth = x >> 32; (npp)->p_offset = x; } while (0);
  do { u_int64_t x = (spp->sdkp_nsectors); (npp)->p_sizeh = x >> 32; (npp)->p_size = x; } while (0);
  if ((((u_int64_t)(npp)->p_sizeh << 32) + (npp)->p_size) == 0) {
   npp->p_fstype = 0;
  } else {
   ...
   if (npp->p_fstype == 7) {
    ...
    npp->p_fragblock =
        ((2048) * (8) == 0 ? 0 : (((ffs((2048) * (8)) - 13) << 3) | (ffs(8))));
    npp->p_cpg = 16;
   }
  }
 }
 ...
 for (i = 0; i < 8; i++) {
  ...
  do { u_int64_t x = (0); (npp)->p_sizeh = x >> 32; (npp)->p_size = x; } while (0);
  npp->p_fstype = 0;
 }
# 301 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/disksubr.c"
 if ((sl->sl_xpmag == (0x199d1fe2+8) &&
     sun_extended_sum(sl, &sl->sl_types) == sl->sl_xpsum) ||
     (sl->sl_xpmag == (0x199d1fe2+8 +1) &&
 ...
 return (checkdisklabel(lp, lp, 0, (((u_int64_t)(lp)->d_secperunith << 32) + (lp)->d_secperunit)));
}
...
disklabel_bsd_to_sun(struct disklabel *lp, struct sun_disklabel *sl)
{
 ...
 if (lp->d_secsize != (1 << 9) || lp->d_nsectors == 0 ||
     lp->d_ntracks == 0)
  return (22);


 __builtin_bzero((sl), (sizeof(*sl)));
 __builtin_memcpy((sl->sl_text), (lp->d_packname), (sizeof(lp->d_packname)));
 ...
 __builtin_memcpy((&sl->sl_uid), (&lp->d_uid), (sizeof(lp->d_uid)));
 ...
 for (i = 0; i < 8; i++) {
  ...
  spp->sdkp_nsectors = 0;
  if ((((u_int64_t)(npp)->p_sizeh << 32) + (npp)->p_size)) {
   if ((((u_int64_t)(npp)->p_offseth << 32) + (npp)->p_offset) % secpercyl)
    return (22);
   spp->sdkp_cyloffset = (((u_int64_t)(npp)->p_offseth << 32) + (npp)->p_offset) / secpercyl;
   spp->sdkp_nsectors = (((u_int64_t)(npp)->p_sizeh << 32) + (npp)->p_size);
  }
 }
 sl->sl_magic = 55998;
