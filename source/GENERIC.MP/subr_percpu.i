# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_percpu.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_percpu.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_percpu.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_percpu.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_percpu.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_percpu.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_percpu.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_percpu.c" 2
...
percpu_init(void)
{
 pool_init(&cpumem_pl, sizeof(struct cpumem) * ncpusfound, 0,
     0, 0x0001, "percpumem", &pool_allocator_single);
}
...
cpumem_get(struct pool *pp)
{
 ...
 cm = pool_get(&cpumem_pl, 0x0001);

 for (cpu = 0; cpu < ncpusfound; cpu++)
  cm[cpu].mem = pool_get(pp, 0x0001 | 0x0008);
...
cpumem_malloc(size_t sz, int type)
{
 ...
 for (cpu = 0; cpu < ncpusfound; cpu++)
  cm[cpu].mem = malloc(sz, type, 0x0001 | 0x0008);
...
{
 n++;
 return (cpumem_malloc_ncpus(cm, n * sizeof(uint64_t), 12));
}
...
{
 n++;
 cpumem_free(cm, 12, n * sizeof(uint64_t));
}
...
counters_read(struct cpumem *cm, uint64_t *output, unsigned int n)
{
 ...
 temp = mallocarray(n, sizeof(uint64_t), 127, 0x0001);
 ...
 free(temp, 127, n * sizeof(uint64_t));
}
