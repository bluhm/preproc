# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c"
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c"
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.h" 1
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus_exrom.h"
struct cardbus_rom_image {
 unsigned int rom_image;
 size_t image_size;
 bus_space_tag_t romt;
 bus_space_handle_t romh;
 struct { struct cardbus_rom_image *sqe_next; } next;
};

struct cardbus_rom_image_head { struct cardbus_rom_image *sqh_first; struct cardbus_rom_image **sqh_last; };

int cardbus_read_exrom(bus_space_tag_t, bus_space_handle_t,
     struct cardbus_rom_image_head *);
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c" 2




# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmciareg.h" 1
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c" 2
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c"
 void cardbusattach(struct device *, struct device *, void *);


 int cardbusmatch(struct device *, void *, void *);
 int cardbussubmatch(struct device *, void *, void *);
 int cardbusprint(void *, const char *);

typedef void (*tuple_decode_func)(u_int8_t *, int, void *);

 int decode_tuples(u_int8_t *, int, tuple_decode_func, void *);
 void parse_tuple(u_int8_t *, int, void *);




 int cardbus_read_tuples(struct cardbus_attach_args *,
    pcireg_t, u_int8_t *, size_t);

 void enable_function(struct cardbus_softc *, int, int);
 void disable_function(struct cardbus_softc *, int);
...
cardbusattach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_iot = cba->cba_iot;
 sc->sc_memt = cba->cba_memt;
 sc->sc_dmat = cba->cba_dmat;
 sc->sc_cc = cba->cba_cc;
 sc->sc_pc = cba->cba_pc;
 sc->sc_cf = cba->cba_cf;
    ...
    u_int8_t *tuples, size_t len)
{
 ...
 int i, j;
 int cardbus_space = cis_ptr & 0x07;
 ...
 __builtin_memset((tuples), (0), (len));

 cis_ptr = cis_ptr & 0x0ffffff8;
 ...
 case 0x06:
 case 0x07:
  if (cardbus_space == 0x07) {
   reg64 = 0x30;
   ;

  } else {
   reg64 = 0x10 + (cardbus_space - 1) * 4;
   ;
  ...
  if (cardbus_mapreg_map((ca->ca_ct)->ct_sc, (ca->ca_ct->ct_func), (reg64), (0x00000000 | 0x00000000), (0), (&bar_tag), (&bar_memh), (&bar_addr), (&bar_size))) {
  ...
  if (cardbus_space == 0x07) {
   ...
   exrom = pci_conf_read(pc, tag, reg64);
   pci_conf_write(pc, tag, reg64, exrom | 1);
   ...
   for (p = ((&rom_image)->sqh_first); p;
       p = ((p)->next.sqe_next)) {
    if (p->rom_image ==
        (((cis_ptr) >> 28) & 0xf)) {
     bus_space_read_region_1(p->romt,
         p->romh, (0x0ffffff8 & (cis_ptr)),
         tuples, (((p->image_size)<(len))?(p->image_size):(len)));
     found++;
     break;
    }
   }
  ...
  out:
   while ((p = ((&rom_image)->sqh_first)) != ((void *)0)) {
    do { if (((&rom_image)->sqh_first = (&rom_image)->sqh_first->next.sqe_next) == ((void *)0)) (&rom_image)->sqh_last = &(&rom_image)->sqh_first; } while (0);
    free(p, 2, sizeof(*p));
   }
   exrom = pci_conf_read(pc, tag, reg64);
   pci_conf_write(pc, tag, reg64, exrom & ~1);
  ...
  cardbus_mapreg_unmap((ca->ca_ct)->ct_sc, (ca->ca_ct->ct_func), (reg64), (bar_tag), (bar_memh), (bar_size));
...
parse_tuple(u_int8_t *tuple, int len, void *data)
{
 ...
 case 0x20:
  ...
  break;
 case 0x15:
  __builtin_bcopy((tuple + 2), (cis->cis1_info_buf), (tuple[1]));
  i = 0;
  ...
  case 6:
   if (tuple[1] >= 8 && tuple[2] ==
    ...
    if (tuple[3] >
     ...
     __builtin_bcopy((tuple + 4), (cis->funce.network.netid), (tuple[3]));
...
# 367 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c"
int
cardbus_attach_card(struct cardbus_softc *sc)
{
 ...
 if (0 == (cdstatus = (cf->cardbus_ctrl)(cc, 7))) {
  ;
 ...
 for (i = 0; i < 5; ++i) {
  ...
  if (cold) {
   ...
   if (tsleep((void *)sc, 0x100, "cardbus",
       hz/10) != 35) {
    break;
   }
  }
 ...
 ;
 nfunction = (((((bhlc) >> 16) & 0xff) & 0x80) != 0) ? 8 : 1;

 tuple = malloc(2048, 127, 0x0002);
 if (tuple == ((void *)0))
 ...
 for (function = 0; function < nfunction; function++) {
  ...
  cis_ptr = pci_conf_read(pc, tag, 0x28);
  ...
  pci_conf_write(pc, tag, 0x10, 0);
  pci_conf_write(pc, tag, 0x14, 0);
  pci_conf_write(pc, tag, 0x18, 0);
  pci_conf_write(pc, tag, 0x1C, 0);
  pci_conf_write(pc, tag, 0x20, 0);
  pci_conf_write(pc, tag, 0x24, 0);
  ...
  bhlc &= ~((0xff << 8) |
      (0xff << 0));
  bhlc |= ((sc->sc_cacheline & 0xff) <<
      0);
  bhlc |= ((sc->sc_lattimer & 0xff) <<
      8);
  ...
  if ((csc = config_found_sm((void *)sc, &ca, cardbusprint,
      cardbussubmatch)) == ((void *)0)) {

   disable_function(sc, function);
   sc->sc_funcs[function] = ((void *)0);
   free(ct, 2, sizeof(struct cardbus_devfunc));
  } else {
...
cardbussubmatch(struct device *parent, void *match, void *aux)
{
 ...
 if (cf->cf_loc[0] != -1 &&
  cf->cf_loc[0] != ca->ca_unit) {
  return (0);
 }
 if (cf->cf_loc[1] != -1 &&
     cf->cf_loc[1] != ca->ca_function) {
  return (0);
 }
...
# 599 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c"
void
cardbus_detach_card(struct cardbus_softc *sc)
{
 ...
 for (f = 0; f < 8; f++) {
  ...
  if (config_detach(ct->ct_device, 0) != 0) {
   ...
   sc->sc_funcs[ct->ct_func] = ((void *)0);
   free(ct, 2, sizeof(struct cardbus_devfunc));
  }
 }

 sc->sc_poweron_func = 0;
 sc->sc_cf->cardbus_power(sc->sc_cc, 0x0004 | 0x0040);
}
# 635 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/cardbus.c"
void *
...
enable_function(struct cardbus_softc *sc, int cdstatus, int function)
{
 if (sc->sc_poweron_func == 0) {
  ...
  if (cdstatus & 0x02) {
   sc->sc_cf->cardbus_power(sc->sc_cc, 0x0001);
  } else {

   return;
  }
  (sc->sc_cf->cardbus_ctrl)(sc->sc_cc, 4);
 }
...
disable_function(struct cardbus_softc *sc, int function)
{
 ...
 if (sc->sc_poweron_func == 0) {
  ...
  sc->sc_cf->cardbus_power(sc->sc_cc, 0x0004);
 }
}
...
cardbus_function_enable(struct cardbus_softc *sc, int func)
{
 ...
 enable_function(sc, 0x02, func);



 tag = pci_make_tag(pc, sc->sc_bus, sc->sc_device, func);

 command = pci_conf_read(pc, tag, 0x04);
 command |= (0x00000002 | 0x00000001 |
     0x00000004);

 pci_conf_write(pc, tag, 0x04, command);
    ...
    const struct pci_matchid *ids, int nent)
{
 ...
 for (i = 0, pm = ids; i < nent; i++, pm++)
  if ((((ca->ca_id) >> 0) & 0xffff) == pm->pm_vid &&
      (((ca->ca_id) >> 16) & 0xffff) == pm->pm_pid)
   return (1);
 return (0);
}
...
decode_tuples(u_int8_t *tuple, int buflen, tuple_decode_func func, void *data)
{
 ...
 while ((tp = decode_tuple(tp, tuple + buflen, func, data)) != ((void *)0))
  ;
