...
struct SMC_Evergreen_MCRegisters
{
    uint8_t last;
    uint8_t reserved[3];
    SMC_Evergreen_MCRegisterAddress address[16];
...
struct evergreen_mc_reg_table {
 ...
 u8 num_entries;
 u16 valid_flag;
 struct evergreen_mc_reg_entry mc_reg_table_entry[16];
 SMC_Evergreen_MCRegisterAddress mc_reg_address[16];
};
...
struct evergreen_power_info {
 ...
 _Bool vddci_control;
 _Bool dynamic_ac_timing;
 _Bool abm;
 _Bool mcls;
 _Bool light_sleep;
 _Bool memory_transition;
 _Bool pcie_performance_request;
 _Bool pcie_performance_request_registered;
 _Bool sclk_deep_sleep;
 _Bool dll_default_on;
 _Bool ls_clock_gating;
 _Bool smu_uvd_hs;
 _Bool uvd_enabled;
 u16 acpi_vddci;
 u8 mvdd_high_index;
...
u8 cypress_get_mclk_frequency_ratio(struct radeon_device *rdev,
        u32 memory_clock, _Bool strobe_mode);
...
struct sumo_vid_mapping_table {
 u32 num_entries;
 struct sumo_vid_mapping_entry entries[4];
};
...
struct sumo_sclk_voltage_mapping_table {
 ...
 struct sumo_sclk_voltage_mapping_entry entries[5];
};
struct sumo_sys_info {
 ...
 u32 csr_m3_arb_cntl_default[10];
 u32 csr_m3_arb_cntl_uvd[10];
 u32 csr_m3_arb_cntl_fs3d[10];
...
struct sumo_power_info {
 ...
 _Bool disable_gfx_power_gating_in_uvd;
 _Bool driver_nbps_policy_disable;
 _Bool enable_alt_vddnb;
 _Bool enable_dynamic_m3_arbiter;
 _Bool enable_gfx_clock_gating;
 _Bool enable_gfx_power_gating;
 _Bool enable_mg_clock_gating;
 _Bool enable_sclk_ds;
 _Bool enable_auto_thermal_throttling;
 _Bool enable_dynamic_patch_ps;
 _Bool enable_dpm;
 _Bool enable_boost;
 struct radeon_ps current_rps;
...
void sumo_take_smu_control(struct radeon_device *rdev, _Bool enable);
...
void sumo_smu_notify_alt_vddnb_change(struct radeon_device *rdev,
          _Bool powersaving, _Bool force_nbps1);
void sumo_boost_state_enable(struct radeon_device *rdev, _Bool enable);
void sumo_enable_boost_timer(struct radeon_device *rdev);
u32 sumo_get_running_fw_version(struct radeon_device *rdev);
static const u32 sumo_utc[15] =
{
 0x48,
 0x44,
 0x44,
...
static void sumo_gfx_clockgating_enable(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x644), 0); tmp_ &= (~(1 << 7)); tmp_ |= (((1 << 7)) & ~(~(1 << 7))); r100_mm_wreg(rdev, (0x644), (tmp_), 0); } while (0);
 else {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x644), 0); tmp_ &= (~(1 << 7)); tmp_ |= ((0) & ~(~(1 << 7))); r100_mm_wreg(rdev, (0x644), (tmp_), 0); } while (0);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x644), 0); tmp_ &= (~(1 << 8)); tmp_ |= (((1 << 8)) & ~(~(1 << 8))); r100_mm_wreg(rdev, (0x644), (tmp_), 0); } while (0);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x644), 0); tmp_ &= (~(1 << 8)); tmp_ |= ((0) & ~(~(1 << 8))); r100_mm_wreg(rdev, (0x644), (tmp_), 0); } while (0);
  r100_mm_rreg(rdev, (0x98f8), 0);
 }
}
static void sumo_mg_clockgating_enable(struct radeon_device *rdev, _Bool enable)
{
 u32 local0;
 u32 local1;
 local0 = r100_mm_rreg(rdev, (0x7d0), 0);
 local1 = r100_mm_rreg(rdev, (0x7d4), 0);
 if (enable) {
  r100_mm_wreg(rdev, (0x7d0), ((0 & 0xE5BFFFFF) | (local0 & ~0xE5BFFFFF)), 0);
  r100_mm_wreg(rdev, (0x7d4), ((0 & 0xEFFF07FF) | (local1 & ~0xEFFF07FF)), 0);
 } else {
  r100_mm_wreg(rdev, (0x7d0), ((0xFFFFFFFF & 0xE5BFFFFF) | (local0 & ~0xE5BFFFFF)), 0);
  r100_mm_wreg(rdev, (0x7d4), ((0xFFFFCFFF & 0xEFFF07FF) | (local1 & ~0xEFFF07FF)), 0);
 }
}
static void sumo_program_git(struct radeon_device *rdev)
{
 u32 p, u;
 u32 xclk = (rdev)->asic->get_xclk((rdev));
 r600_calculate_u_and_p(19,
          xclk, 16, &p, &u);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6d8), 0); tmp_ &= (~(0xffff << 0)); tmp_ |= ((((p) << 0)) & ~(~(0xffff << 0))); r100_mm_wreg(rdev, (0x6d8), (tmp_), 0); } while (0);
}
static void sumo_program_grsd(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x68c), (((grs) << 0) | ((p) << 9) | ((u) << 23)), 0);
}
void sumo_gfx_clockgating_initialize(struct radeon_device *rdev)
{
...
static void sumo_gfx_powergating_initialize(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x824), (0x01B60A17), 0);
 r600_calculate_u_and_p(100,
          xclk, 16, &p, &u);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7ac), 0); tmp_ &= (~((0xffff << 8) | (0xf << 24))); tmp_ |= ((((p) << 8) | ((u) << 24)) & ~(~((0xffff << 8) | (0xf << 24)))); r100_mm_wreg(rdev, (0x7ac), (tmp_), 0); } while (0);
 r600_calculate_u_and_p(1,
          xclk, 16, &p, &u);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x770), 0); tmp_ &= (~((0xffff << 8) | (0xf << 24))); tmp_ |= ((((p) << 8) | ((u) << 24)) & ~(~((0xffff << 8) | (0xf << 24)))); r100_mm_wreg(rdev, (0x770), (tmp_), 0); } while (0);
 if (rdev->family == CHIP_PALM) {
  r600_rcu_wreg(rdev, (0x408), (0x10103210));
  r600_rcu_wreg(rdev, (0x40c), (0x10101010));
 } else {
  r600_rcu_wreg(rdev, (0x408), (0x76543210));
  r600_rcu_wreg(rdev, (0x40c), (0xFEDCBA98));
 }
 rcu_pwr_gating_cntl = r600_rcu_rreg(rdev, (0x410));
 rcu_pwr_gating_cntl &=
  ~((0x3 << 1) | (0x1f << 3) | (0xf << 28));
 rcu_pwr_gating_cntl |= ((p_c) << 3) | ((1) << 28) | (1 << 0);
 if (rdev->family == CHIP_PALM) {
  rcu_pwr_gating_cntl &= ~(0xf << 8);
  rcu_pwr_gating_cntl |= ((0x77) << 8);
 }
 r600_rcu_wreg(rdev, (0x410), (rcu_pwr_gating_cntl));
 rcu_pwr_gating_cntl = r600_rcu_rreg(rdev, (0x4a0));
 rcu_pwr_gating_cntl &= ~((0xffff << 0) | (0xffff << 16));
 rcu_pwr_gating_cntl |= ((p_p) << 0) | ((50) << 16);
 r600_rcu_wreg(rdev, (0x4a0), (rcu_pwr_gating_cntl));
 rcu_pwr_gating_cntl = r600_rcu_rreg(rdev, (0x4a4));
 rcu_pwr_gating_cntl &= ~((0xffff << 0) | (0xffff << 16));
 rcu_pwr_gating_cntl |= ((d_p) << 0) | ((50) << 16);
 r600_rcu_wreg(rdev, (0x4a4), (rcu_pwr_gating_cntl));
 rcu_pwr_gating_cntl = r600_rcu_rreg(rdev, (0x4a8));
 rcu_pwr_gating_cntl &= ~((0xffff << 0) | (0xffff << 16));
 rcu_pwr_gating_cntl |= ((r_t) << 0) | ((i_t) << 16);
 r600_rcu_wreg(rdev, (0x4a8), (rcu_pwr_gating_cntl));
 if (rdev->family == CHIP_PALM)
  r600_rcu_wreg(rdev, (0x504), (0xA02));
 sumo_smu_pg_init(rdev);
 rcu_pwr_gating_cntl = r600_rcu_rreg(rdev, (0x410));
 rcu_pwr_gating_cntl &=
  ~((0x3 << 1) | (0x1f << 3) | (0xf << 28));
 rcu_pwr_gating_cntl |= ((p_c) << 3) | ((4) << 28) | (1 << 0);
 if (rdev->family == CHIP_PALM) {
  rcu_pwr_gating_cntl &= ~(0xf << 8);
  rcu_pwr_gating_cntl |= ((0x77) << 8);
 }
 ...
 if (rdev->family == CHIP_PALM) {
  rcu_pwr_gating_cntl = r600_rcu_rreg(rdev, (0x4a0));
  rcu_pwr_gating_cntl &= ~((0xffff << 0) | (0xffff << 16));
  rcu_pwr_gating_cntl |= ((113) << 0) | ((50) << 16);
  r600_rcu_wreg(rdev, (0x4a0), (rcu_pwr_gating_cntl));
  rcu_pwr_gating_cntl = r600_rcu_rreg(rdev, (0x4a4));
  rcu_pwr_gating_cntl &= ~((0xffff << 0) | (0xffff << 16));
  rcu_pwr_gating_cntl |= ((16) << 0) | ((50) << 16);
  r600_rcu_wreg(rdev, (0x4a4), (rcu_pwr_gating_cntl));
 }
 sumo_smu_pg_init(rdev);
 rcu_pwr_gating_cntl = r600_rcu_rreg(rdev, (0x410));
 rcu_pwr_gating_cntl &=
  ~((0x3 << 1) | (0x1f << 3) | (0xf << 28));
 rcu_pwr_gating_cntl |= ((5) << 28) | (1 << 0);
 if (rdev->family == CHIP_PALM) {
  rcu_pwr_gating_cntl |= ((4) << 3);
  rcu_pwr_gating_cntl &= ~(0xf << 8);
  rcu_pwr_gating_cntl |= ((0x77) << 8);
 } else
  rcu_pwr_gating_cntl |= ((11) << 3);
 r600_rcu_wreg(rdev, (0x410), (rcu_pwr_gating_cntl));
 if (rdev->family == CHIP_PALM) {
  rcu_pwr_gating_cntl = r600_rcu_rreg(rdev, (0x4a0));
  rcu_pwr_gating_cntl &= ~((0xffff << 0) | (0xffff << 16));
  ...
  rcu_pwr_gating_cntl = r600_rcu_rreg(rdev, (0x4a4));
  rcu_pwr_gating_cntl &= ~((0xffff << 0) | (0xffff << 16));
  rcu_pwr_gating_cntl |= ((22) << 0) | ((50) << 16);
  r600_rcu_wreg(rdev, (0x4a4), (rcu_pwr_gating_cntl));
 }
 sumo_smu_pg_init(rdev);
}
static void sumo_gfx_powergating_enable(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7ac), 0); tmp_ &= (~(1 << 0)); tmp_ |= (((1 << 0)) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x7ac), (tmp_), 0); } while (0);
 else {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7ac), 0); tmp_ &= (~(1 << 0)); tmp_ |= ((0) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x7ac), (tmp_), 0); } while (0);
  r100_mm_rreg(rdev, (0x98f8), 0);
 }
}
          ...
          u32 high_clk)
{
 ...
 pi->dsp = ((pi->bsp) << 0) | ((pi->bsu) << 16);
 pi->psp = ((pi->pbsp) << 0) | ((pi->pbsu) << 16);
}
static void sumo_init_bsp(struct radeon_device *rdev)
{
 struct sumo_power_info *pi = sumo_get_pi(rdev);
 r100_mm_wreg(rdev, (0x750), (pi->psp), 0);
}
        ...
        struct radeon_ps *rps)
{
 ...
 for (i = 0; i < ps->num_levels - 1; i++)
  r100_mm_wreg(rdev, (0x750 + (i * 4)), (pi->dsp), 0);
 r100_mm_wreg(rdev, (0x750 + (i * 4)), (pi->psp), 0);
 if (ps->flags & (1 << 1))
  r100_mm_wreg(rdev, (0x750 + (7 * 4)), (pi->psp), 0);
}
static void sumo_write_at(struct radeon_device *rdev,
     u32 index, u32 value)
{
 if (index == 0)
  r100_mm_wreg(rdev, (0x728), (value), 0);
 else if (index == 1)
  r100_mm_wreg(rdev, (0x72c), (value), 0);
 else if (index == 2)
  r100_mm_wreg(rdev, (0x730), (value), 0);
 else if (index == 3)
  r100_mm_wreg(rdev, (0x738), (value), 0);
 else if (index == 4)
  r100_mm_wreg(rdev, (0x73c), (value), 0);
 else if (index == 5)
  r100_mm_wreg(rdev, (0x740), (value), 0);
 else if (index == 6)
  r100_mm_wreg(rdev, (0x744), (value), 0);
 else if (index == 7)
  r100_mm_wreg(rdev, (0x748), (value), 0);
}
       ...
       struct radeon_ps *rps)
{
 ...
 for (i = 0; i < ps->num_levels; i++) {
  ...
  a_t = ((m_a * r[i] / 100) << 0) | ((m_a * l[i] / 100) << 16);
  sumo_write_at(rdev, i, a_t);
 }
 if (ps->flags & (1 << 1)) {
  asi = pi->pasi;
  m_a = asi * pi->boost_pl.sclk / 100;
  a_t = ((m_a * r[ps->num_levels - 1] / 100) << 0) |
   ((m_a * l[ps->num_levels - 1] / 100) << 16);
  sumo_write_at(rdev, 7, a_t);
 }
}
static void sumo_program_tp(struct radeon_device *rdev)
{
 ...
 enum r600_td td = 0;
 for (i = 0; i < 15; i++) {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x694 + (i * 4)), 0); tmp_ &= (~(0x3ff << 0)); tmp_ |= ((((sumo_utc[i]) << 0)) & ~(~(0x3ff << 0))); r100_mm_wreg(rdev, (0x694 + (i * 4)), (tmp_), 0); } while (0);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x694 + (i * 4)), 0); tmp_ &= (~(0x3ff << 10)); tmp_ |= ((((sumo_dtc[i]) << 10)) & ~(~(0x3ff << 10))); r100_mm_wreg(rdev, (0x694 + (i * 4)), (tmp_), 0); } while (0);
 }
 if (td == R600_TD_AUTO)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x644), 0); tmp_ &= (~(1 << 5)); tmp_ |= ((0) & ~(~(1 << 5))); r100_mm_wreg(rdev, (0x644), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x644), 0); tmp_ &= (~(1 << 5)); tmp_ |= (((1 << 5)) & ~(~(1 << 5))); r100_mm_wreg(rdev, (0x644), (tmp_), 0); } while (0);
 if (td == R600_TD_UP)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x644), 0); tmp_ &= (~(1 << 6)); tmp_ |= ((0) & ~(~(1 << 6))); r100_mm_wreg(rdev, (0x644), (tmp_), 0); } while (0);
 if (td == R600_TD_DOWN)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x644), 0); tmp_ &= (~(1 << 6)); tmp_ |= (((1 << 6)) & ~(~(1 << 6))); r100_mm_wreg(rdev, (0x644), (tmp_), 0); } while (0);
}
void sumo_program_vc(struct radeon_device *rdev, u32 vrc)
{
 r100_mm_wreg(rdev, (0x690), (vrc), 0);
}
void sumo_clear_vc(struct radeon_device *rdev)
{
 r100_mm_wreg(rdev, (0x690), (0), 0);
}
void sumo_program_sstp(struct radeon_device *rdev)
{
 u32 p, u;
 u32 xclk = (rdev)->asic->get_xclk((rdev));
 r600_calculate_u_and_p(8,
          xclk, 16, &p, &u);
 r100_mm_wreg(rdev, (0x6e8), (((u) << 16) | ((p) << 0)), 0);
}
       ...
       u32 index, u32 divider)
{
 ...
 if (field_index == 0)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x684 + (reg_index * 4)), 0); tmp_ &= (~(0x7f << 0)); tmp_ |= ((((divider) << 0)) & ~(~(0x7f << 0))); r100_mm_wreg(rdev, (0x684 + (reg_index * 4)), (tmp_), 0); } while (0);
 else if (field_index == 1)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x684 + (reg_index * 4)), 0); tmp_ &= (~(0x7f << 8)); tmp_ |= ((((divider) << 8)) & ~(~(0x7f << 8))); r100_mm_wreg(rdev, (0x684 + (reg_index * 4)), (tmp_), 0); } while (0);
 else if (field_index == 2)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x684 + (reg_index * 4)), 0); tmp_ &= (~(0x7f << 16)); tmp_ |= ((((divider) << 16)) & ~(~(0x7f << 16))); r100_mm_wreg(rdev, (0x684 + (reg_index * 4)), (tmp_), 0); } while (0);
 else if (field_index == 3)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x684 + (reg_index * 4)), 0); tmp_ &= (~(0x7f << 24)); tmp_ |= ((((divider) << 24)) & ~(~(0x7f << 24))); r100_mm_wreg(rdev, (0x684 + (reg_index * 4)), (tmp_), 0); } while (0);
}
     ...
     u32 index, u32 divider)
{
 ...
 if (pi->enable_sclk_ds) {
  u32 dpm_ctrl = r100_mm_rreg(rdev, (0x724), 0);
  dpm_ctrl &= ~(0x7 << (index * 3));
  dpm_ctrl |= (divider << (index * 3));
  r100_mm_wreg(rdev, (0x724), (dpm_ctrl), 0);
 }
}
     ...
     u32 index, u32 divider)
{
 struct sumo_power_info *pi = sumo_get_pi(rdev);
 if (pi->enable_sclk_ds) {
  u32 dpm_ctrl = r100_mm_rreg(rdev, (0x830), 0);
  dpm_ctrl &= ~(0x7 << (index * 3));
  dpm_ctrl |= (divider << (index * 3));
  r100_mm_wreg(rdev, (0x830), (dpm_ctrl), 0);
 }
}
static void sumo_set_vid(struct radeon_device *rdev, u32 index, u32 vid)
{
 u32 voltage_cntl = r100_mm_rreg(rdev, (0x788), 0);
 voltage_cntl &= ~((0x3 << 0) << (index * 2));
 voltage_cntl |= (vid << (0 + index * 2));
 r100_mm_wreg(rdev, (0x788), (voltage_cntl), 0);
}
static void sumo_set_allos_gnb_slow(struct radeon_device *rdev, u32 index, u32 gnb_slow)
{
 ...
 if (pi->driver_nbps_policy_disable)
  temp = 1;
 cg_sclk_dpm_ctrl_3 = r100_mm_rreg(rdev, (0x6e0), 0);
 cg_sclk_dpm_ctrl_3 &= ~((1 << 23) << index);
 cg_sclk_dpm_ctrl_3 |= (temp << (23 + index));
 r100_mm_wreg(rdev, (0x6e0), (cg_sclk_dpm_ctrl_3), 0);
}
         ...
         struct sumo_pl *pl, u32 index)
{
 ...
 int ret;
 struct atom_clock_dividers dividers;
 u32 ds_en = r100_mm_rreg(rdev, (0x818), 0) & (1 << 31);
 ...
 if (pl->ss_divider_index == 0 || pl->ds_divider_index == 0) {
  if (ds_en)
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x818), 0); tmp_ &= (~(1 << 31)); tmp_ |= ((0) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x818), (tmp_), 0); } while (0);
 } else {
  sumo_set_ss_dividers(rdev, index, pl->ss_divider_index);
  sumo_set_ds_dividers(rdev, index, pl->ds_divider_index);
  if (!ds_en)
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x818), 0); tmp_ &= (~(1 << 31)); tmp_ |= (((1 << 31)) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x818), (tmp_), 0); } while (0);
 }
 sumo_set_allos_gnb_slow(rdev, index, pl->allow_gnb_slow);
 if (pi->enable_boost)
  sumo_set_tdp_limit(rdev, index, pl->sclk_dpm_tdp_limit);
}
static void sumo_power_level_enable(struct radeon_device *rdev, u32 index, _Bool enable)
{
 u32 reg_index = index / 4;
 u32 field_index = index % 4;
 if (field_index == 0)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x684 + (reg_index * 4)), 0); tmp_ &= (~(1 << 7)); tmp_ |= ((enable ? (1 << 7) : 0) & ~(~(1 << 7))); r100_mm_wreg(rdev, (0x684 + (reg_index * 4)), (tmp_), 0); } while (0);
 else if (field_index == 1)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x684 + (reg_index * 4)), 0); tmp_ &= (~(1 << 15)); tmp_ |= ((enable ? (1 << 15) : 0) & ~(~(1 << 15))); r100_mm_wreg(rdev, (0x684 + (reg_index * 4)), (tmp_), 0); } while (0);
 else if (field_index == 2)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x684 + (reg_index * 4)), 0); tmp_ &= (~(1 << 23)); tmp_ |= ((enable ? (1 << 23) : 0) & ~(~(1 << 23))); r100_mm_wreg(rdev, (0x684 + (reg_index * 4)), (tmp_), 0); } while (0);
 else if (field_index == 3)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x684 + (reg_index * 4)), 0); tmp_ &= (~(1 << 31)); tmp_ |= ((enable ? (1 << 31) : 0) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x684 + (reg_index * 4)), (tmp_), 0); } while (0);
}
static _Bool sumo_dpm_enabled(struct radeon_device *rdev)
{
 if (r100_mm_rreg(rdev, (0x6e0), 0) & (1 << 18))
  return 1;
 else
  return 0;
}
...
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6e0), 0); tmp_ &= (~(1 << 18)); tmp_ |= (((1 << 18)) & ~(~(1 << 18))); r100_mm_wreg(rdev, (0x6e0), (tmp_), 0); } while (0);
}
static void sumo_stop_dpm(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6e0), 0); tmp_ &= (~(1 << 18)); tmp_ |= ((0) & ~(~(1 << 18))); r100_mm_wreg(rdev, (0x6e0), (tmp_), 0); } while (0);
}
static void sumo_set_forced_mode(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6e0), 0); tmp_ &= (~(1 << 3)); tmp_ |= (((1 << 3)) & ~(~(1 << 3))); r100_mm_wreg(rdev, (0x6e0), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6e0), 0); tmp_ &= (~(1 << 3)); tmp_ |= ((0) & ~(~(1 << 3))); r100_mm_wreg(rdev, (0x6e0), (tmp_), 0); } while (0);
}
static void sumo_set_forced_mode_enabled(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < rdev->usec_timeout; i++) {
  if (r100_mm_rreg(rdev, (0x604), 0) & (1 << 2))
   break;
  udelay(1);
 }
}
static void sumo_wait_for_level_0(struct radeon_device *rdev)
{
 int i;
 for (i = 0; i < rdev->usec_timeout; i++) {
  if ((r100_mm_rreg(rdev, (0x66c), 0) & (0x7 << 9)) == 0)
   break;
  udelay(1);
 }
 for (i = 0; i < rdev->usec_timeout; i++) {
  if ((r100_mm_rreg(rdev, (0x66c), 0) & (0x7 << 15)) == 0)
   break;
  udelay(1);
 }
}
          ...
          struct radeon_ps *old_rps)
{
 ...
 u32 nbps1_new = 0;
 if (old_ps != ((void *)0))
  nbps1_old = (old_ps->flags & (1 << 0)) ? 1 : 0;
 nbps1_new = (new_ps->flags & (1 << 0)) ? 1 : 0;
...
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6e0), 0); tmp_ &= (~(0x7 << 0)); tmp_ |= ((((index) << 0)) & ~(~(0x7 << 0))); r100_mm_wreg(rdev, (0x6e0), (tmp_), 0); } while (0);
}
...
{
 struct sumo_ps *new_ps = sumo_get_ps(rps);
 u32 dpm_ctrl4 = r100_mm_rreg(rdev, (0x71c), 0);
 dpm_ctrl4 &= 0xFFFFFF00;
 dpm_ctrl4 |= (1 << (new_ps->num_levels - 1));
 if (new_ps->flags & (1 << 1))
  dpm_ctrl4 |= (1 << 7);
 r100_mm_wreg(rdev, (0x71c), (dpm_ctrl4), 0);
}
          ...
          struct radeon_ps *old_rps)
{
 ...
 if (new_ps->flags & (1 << 1))
  sumo_program_power_level(rdev, &pi->boost_pl, 7);
}
static void sumo_enable_acpi_pm(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x63c), 0); tmp_ &= (~(1 << 1)); tmp_ |= (((1 << 1)) & ~(~(1 << 1))); r100_mm_wreg(rdev, (0x63c), (tmp_), 0); } while (0);
}
static void sumo_program_power_level_enter_state(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x720), 0); tmp_ &= (~(0x7 << 0)); tmp_ |= ((((0) << 0)) & ~(~(0x7 << 0))); r100_mm_wreg(rdev, (0x720), (tmp_), 0); } while (0);
}
static void sumo_program_acpi_power_level(struct radeon_device *rdev)
{
 ...
 if (ret)
  return;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x70c), 0); tmp_ &= (~(0x7f << 0)); tmp_ |= ((((dividers.post_div) << 0)) & ~(~(0x7f << 0))); r100_mm_wreg(rdev, (0x70c), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x780), 0); tmp_ &= (~(1 << 8)); tmp_ |= ((0) & ~(~(1 << 8))); r100_mm_wreg(rdev, (0x780), (tmp_), 0); } while (0);
}
      ...
      struct radeon_ps *old_rps)
{
 ...
 (rdev)->asic->pm.set_uvd_clocks((rdev), (new_rps->vclk), (new_rps->dclk));
 if (pi->enable_gfx_power_gating) {
...
static void sumo_enable_sclk_ds(struct radeon_device *rdev, _Bool enable)
{
 if (enable) {
  u32 deep_sleep_cntl = r100_mm_rreg(rdev, (0x818), 0);
  u32 deep_sleep_cntl2 = r100_mm_rreg(rdev, (0x81c), 0);
  u32 t = 1;
  deep_sleep_cntl &= ~(1 << 3);
  deep_sleep_cntl &= ~(0xfff << 4);
  deep_sleep_cntl |= ((t > 4095 ? 4095 : t) << 4);
  deep_sleep_cntl2 |= (1 << 0);
  deep_sleep_cntl2 &= (0xff << 4);
  deep_sleep_cntl2 |= ((0xf) << 4);
  r100_mm_wreg(rdev, (0x81c), (deep_sleep_cntl2), 0);
  r100_mm_wreg(rdev, (0x818), (deep_sleep_cntl), 0);
 } else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x818), 0); tmp_ &= (~(1 << 31)); tmp_ |= ((0) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x818), (tmp_), 0); } while (0);
}
static void sumo_program_bootup_at(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x728), 0); tmp_ &= (~(0xffff << 0)); tmp_ |= ((((0xffff) << 0)) & ~(~(0xffff << 0))); r100_mm_wreg(rdev, (0x728), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x728), 0); tmp_ &= (~(0xffff << 16)); tmp_ |= ((((0) << 16)) & ~(~(0xffff << 16))); r100_mm_wreg(rdev, (0x728), (tmp_), 0); } while (0);
}
static void sumo_reset_am(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x644), 0); tmp_ &= (~(1 << 4)); tmp_ |= (((1 << 4)) & ~(~(1 << 4))); r100_mm_wreg(rdev, (0x644), (tmp_), 0); } while (0);
}
static void sumo_start_am(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x644), 0); tmp_ &= (~(1 << 4)); tmp_ |= ((0) & ~(~(1 << 4))); r100_mm_wreg(rdev, (0x644), (tmp_), 0); } while (0);
}
static void sumo_program_ttp(struct radeon_device *rdev)
{
 u32 xclk = (rdev)->asic->get_xclk((rdev));
 u32 p, u;
 u32 cg_sclk_dpm_ctrl_5 = r100_mm_rreg(rdev, (0x720), 0);
 r600_calculate_u_and_p(1000,
          xclk, 16, &p, &u);
 cg_sclk_dpm_ctrl_5 &= ~((0xffff << 3) | (0xff << 19));
 cg_sclk_dpm_ctrl_5 |= ((p) << 3) | ((u) << 19);
 r100_mm_wreg(rdev, (0x720), (cg_sclk_dpm_ctrl_5), 0);
}
static void sumo_program_ttt(struct radeon_device *rdev)
{
 u32 cg_sclk_dpm_ctrl_3 = r100_mm_rreg(rdev, (0x6e0), 0);
 struct sumo_power_info *pi = sumo_get_pi(rdev);
 cg_sclk_dpm_ctrl_3 &= ~((0xff << 8) | (1 << 16));
 cg_sclk_dpm_ctrl_3 |= ((pi->thermal_auto_throttling + 49) << 8);
 r100_mm_wreg(rdev, (0x6e0), (cg_sclk_dpm_ctrl_3), 0);
}
static void sumo_enable_voltage_scaling(struct radeon_device *rdev, _Bool enable)
{
 if (enable) {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x788), 0); tmp_ &= (~(1 << 16)); tmp_ |= (((1 << 16)) & ~(~(1 << 16))); r100_mm_wreg(rdev, (0x788), (tmp_), 0); } while (0);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x770), 0); tmp_ &= (~(1 << 3)); tmp_ |= ((0) & ~(~(1 << 3))); r100_mm_wreg(rdev, (0x770), (tmp_), 0); } while (0);
 } else {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x770), 0); tmp_ &= (~(1 << 3)); tmp_ |= (((1 << 3)) & ~(~(1 << 3))); r100_mm_wreg(rdev, (0x770), (tmp_), 0); } while (0);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x788), 0); tmp_ &= (~(1 << 16)); tmp_ |= ((0) & ~(~(1 << 16))); r100_mm_wreg(rdev, (0x788), (tmp_), 0); } while (0);
 }
}
static void sumo_override_cnb_thermal_events(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6e0), 0); tmp_ &= (~(1 << 17)); tmp_ |= (((1 << 17)) & ~(~(1 << 17))); r100_mm_wreg(rdev, (0x6e0), (tmp_), 0); } while (0);
}
static void sumo_program_dc_hto(struct radeon_device *rdev)
{
 u32 cg_sclk_dpm_ctrl_4 = r100_mm_rreg(rdev, (0x71c), 0);
 u32 p, u;
 u32 xclk = (rdev)->asic->get_xclk((rdev));
 r600_calculate_u_and_p(100000,
          xclk, 14, &p, &u);
 cg_sclk_dpm_ctrl_4 &= ~((0x3fff << 14) | (0xf << 28));
 cg_sclk_dpm_ctrl_4 |= ((p) << 14) | ((u) << 28);
 r100_mm_wreg(rdev, (0x71c), (cg_sclk_dpm_ctrl_4), 0);
}
     ...
     struct radeon_ps *rps)
{
 ...
 if (!pi->driver_nbps_policy_disable) {
  if (new_ps->flags & (1 << 0))
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6e0), 0); tmp_ &= (~(1 << 31)); tmp_ |= (((1 << 31)) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x6e0), (tmp_), 0); } while (0);
  else
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6e0), 0); tmp_ &= (~(1 << 31)); tmp_ |= ((0) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x6e0), (tmp_), 0); } while (0);
 }
}
u32 sumo_get_sleep_divider_from_id(u32 id)
{
         ...
         struct sumo_ps *current_ps)
{
 ...
 ps->levels[0].ds_divider_index =
  sumo_get_sleep_divider_id_from_clock(rdev, ps->levels[0].sclk, 800);
       ...
       struct radeon_ps *old_rps)
{
 ...
 if ((new_rps->class & 1) ||
     (new_rps->class & 0x8000) ||
     (new_rps->class & 0x4000))
  ps->flags |= (1 << 0);
 for (i = 0; i < ps->num_levels; i++) {
  ...
  ps->levels[i].ds_divider_index =
   sumo_get_sleep_divider_id_from_clock(rdev, ps->levels[i].sclk, 800);
  ...
  else if ((new_rps->class & 0x0400) ||
    (new_rps->class2 & 0x0004))
           ...
           int min_temp, int max_temp)
{
 ...
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x734), 0); tmp_ &= (~0x0000FF00); tmp_ |= ((((49 + (high_temp / 1000)) << 8)) & ~(~0x0000FF00)); r100_mm_wreg(rdev, (0x734), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x734), 0); tmp_ &= (~0x00FF0000); tmp_ |= ((((49 + (low_temp / 1000)) << 16)) & ~(~0x00FF0000)); r100_mm_wreg(rdev, (0x734), (tmp_), 0); } while (0);
...
int sumo_dpm_late_enable(struct radeon_device *rdev)
{
 ...
 if (rdev->irq.installed &&
  ...
  ret = sumo_set_thermal_temperature_range(rdev, (90 * 1000), (120 * 1000));
  if (ret)
   return ret;
     ...
     union pplib_clock_info *clock_info)
{
 ...
 u32 sclk;
 sclk = (__uint16_t)(__builtin_constant_p(clock_info->sumo.usEngineClockLow) ? (__uint16_t)(((__uint16_t)(clock_info->sumo.usEngineClockLow) & 0xffU) << 8 | ((__uint16_t)(clock_info->sumo.usEngineClockLow) & 0xff00U) >> 8) : __swap16md(clock_info->sumo.usEngineClockLow));
...
static int sumo_parse_power_table(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < state_array->ucNumEntries; i++) {
  ...
  if (!rdev->pm.power_state[i].clock_info)
   return -22;
  ps = kzalloc(sizeof(struct sumo_ps), (0x0001 | 0x0004));
  if (ps == ((void *)0)) {
...
static int sumo_parse_sys_info_table(struct radeon_device *rdev)
{
 ...
 if (atom_parse_data_header(mode_info->atom_context, index, ((void *)0),
  ...
  igp_info = (union igp_info *)(mode_info->atom_context->bios +
           data_offset);
  if (crev != 6) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unsupported IGP table: %d %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , frev, crev);
   return -22;
  }
  pi->sys_info.bootup_sclk = (__uint32_t)(__builtin_constant_p(igp_info->info_6.ulBootUpEngineClock) ? (__uint32_t)(((__uint32_t)(igp_info->info_6.ulBootUpEngineClock) & 0xff) << 24 | ((__uint32_t)(igp_info->info_6.ulBootUpEngineClock) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_6.ulBootUpEngineClock) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_6.ulBootUpEngineClock) & 0xff000000) >> 24) : __swap32md(igp_info->info_6.ulBootUpEngineClock));
  pi->sys_info.min_sclk = (__uint32_t)(__builtin_constant_p(igp_info->info_6.ulMinEngineClock) ? (__uint32_t)(((__uint32_t)(igp_info->info_6.ulMinEngineClock) & 0xff) << 24 | ((__uint32_t)(igp_info->info_6.ulMinEngineClock) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_6.ulMinEngineClock) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_6.ulMinEngineClock) & 0xff000000) >> 24) : __swap32md(igp_info->info_6.ulMinEngineClock));
  pi->sys_info.bootup_uma_clk = (__uint32_t)(__builtin_constant_p(igp_info->info_6.ulBootUpUMAClock) ? (__uint32_t)(((__uint32_t)(igp_info->info_6.ulBootUpUMAClock) & 0xff) << 24 | ((__uint32_t)(igp_info->info_6.ulBootUpUMAClock) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_6.ulBootUpUMAClock) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_6.ulBootUpUMAClock) & 0xff000000) >> 24) : __swap32md(igp_info->info_6.ulBootUpUMAClock));
  pi->sys_info.bootup_nb_voltage_index =
   (__uint16_t)(__builtin_constant_p(igp_info->info_6.usBootUpNBVoltage) ? (__uint16_t)(((__uint16_t)(igp_info->info_6.usBootUpNBVoltage) & 0xffU) << 8 | ((__uint16_t)(igp_info->info_6.usBootUpNBVoltage) & 0xff00U) >> 8) : __swap16md(igp_info->info_6.usBootUpNBVoltage));
  ...
  if (pi->sys_info.htc_tmp_lmt <= pi->sys_info.htc_hyst_lmt) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "The htcTmpLmt should be larger than htcHystLmt.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  }
  for (i = 0; i < 10; i++) {
   pi->sys_info.csr_m3_arb_cntl_default[i] =
    (__uint32_t)(__builtin_constant_p(igp_info->info_6.ulCSR_M3_ARB_CNTL_DEFAULT[i]) ? (__uint32_t)(((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_DEFAULT[i]) & 0xff) << 24 | ((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_DEFAULT[i]) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_DEFAULT[i]) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_DEFAULT[i]) & 0xff000000) >> 24) : __swap32md(igp_info->info_6.ulCSR_M3_ARB_CNTL_DEFAULT[i]));
   pi->sys_info.csr_m3_arb_cntl_uvd[i] =
    (__uint32_t)(__builtin_constant_p(igp_info->info_6.ulCSR_M3_ARB_CNTL_UVD[i]) ? (__uint32_t)(((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_UVD[i]) & 0xff) << 24 | ((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_UVD[i]) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_UVD[i]) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_UVD[i]) & 0xff000000) >> 24) : __swap32md(igp_info->info_6.ulCSR_M3_ARB_CNTL_UVD[i]));
   pi->sys_info.csr_m3_arb_cntl_fs3d[i] =
    (__uint32_t)(__builtin_constant_p(igp_info->info_6.ulCSR_M3_ARB_CNTL_FS3D[i]) ? (__uint32_t)(((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_FS3D[i]) & 0xff) << 24 | ((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_FS3D[i]) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_FS3D[i]) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_6.ulCSR_M3_ARB_CNTL_FS3D[i]) & 0xff000000) >> 24) : __swap32md(igp_info->info_6.ulCSR_M3_ARB_CNTL_FS3D[i]));
  }
  pi->sys_info.sclk_dpm_boost_margin =
   (__uint32_t)(__builtin_constant_p(igp_info->info_6.SclkDpmBoostMargin) ? (__uint32_t)(((__uint32_t)(igp_info->info_6.SclkDpmBoostMargin) & 0xff) << 24 | ((__uint32_t)(igp_info->info_6.SclkDpmBoostMargin) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_6.SclkDpmBoostMargin) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_6.SclkDpmBoostMargin) & 0xff000000) >> 24) : __swap32md(igp_info->info_6.SclkDpmBoostMargin));
  pi->sys_info.sclk_dpm_throttle_margin =
   (__uint32_t)(__builtin_constant_p(igp_info->info_6.SclkDpmThrottleMargin) ? (__uint32_t)(((__uint32_t)(igp_info->info_6.SclkDpmThrottleMargin) & 0xff) << 24 | ((__uint32_t)(igp_info->info_6.SclkDpmThrottleMargin) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_6.SclkDpmThrottleMargin) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_6.SclkDpmThrottleMargin) & 0xff000000) >> 24) : __swap32md(igp_info->info_6.SclkDpmThrottleMargin));
  pi->sys_info.sclk_dpm_tdp_limit_pg =
   (__uint16_t)(__builtin_constant_p(igp_info->info_6.SclkDpmTdpLimitPG) ? (__uint16_t)(((__uint16_t)(igp_info->info_6.SclkDpmTdpLimitPG) & 0xffU) << 8 | ((__uint16_t)(igp_info->info_6.SclkDpmTdpLimitPG) & 0xff00U) >> 8) : __swap16md(igp_info->info_6.SclkDpmTdpLimitPG));
  pi->sys_info.gnb_tdp_limit = (__uint16_t)(__builtin_constant_p(igp_info->info_6.GnbTdpLimit) ? (__uint16_t)(((__uint16_t)(igp_info->info_6.GnbTdpLimit) & 0xffU) << 8 | ((__uint16_t)(igp_info->info_6.GnbTdpLimit) & 0xff00U) >> 8) : __swap16md(igp_info->info_6.GnbTdpLimit));
  pi->sys_info.sclk_dpm_tdp_limit_boost =
   (__uint16_t)(__builtin_constant_p(igp_info->info_6.SclkDpmTdpLimitBoost) ? (__uint16_t)(((__uint16_t)(igp_info->info_6.SclkDpmTdpLimitBoost) & 0xffU) << 8 | ((__uint16_t)(igp_info->info_6.SclkDpmTdpLimitBoost) & 0xff00U) >> 8) : __swap16md(igp_info->info_6.SclkDpmTdpLimitBoost));
  pi->sys_info.boost_sclk = (__uint32_t)(__builtin_constant_p(igp_info->info_6.ulBoostEngineCLock) ? (__uint32_t)(((__uint32_t)(igp_info->info_6.ulBoostEngineCLock) & 0xff) << 24 | ((__uint32_t)(igp_info->info_6.ulBoostEngineCLock) & 0xff00) << 8 | ((__uint32_t)(igp_info->info_6.ulBoostEngineCLock) & 0xff0000) >> 8 | ((__uint32_t)(igp_info->info_6.ulBoostEngineCLock) & 0xff000000) >> 24) : __swap32md(igp_info->info_6.ulBoostEngineCLock));
...
int sumo_dpm_init(struct radeon_device *rdev)
{
 ...
 u32 hw_rev = (r100_mm_rreg(rdev, (0x5564), 0) & (0xf << 28)) >> 28;
 int ret;
 pi = kzalloc(sizeof(struct sumo_power_info), (0x0001 | 0x0004));
 if (pi == ((void *)0))
  return -12;
 rdev->pm.dpm.priv = pi;
            ...
            struct seq_file *m)
{
 ...
 struct sumo_pl *pl;
 u32 current_index =
  (r100_mm_rreg(rdev, (0x66c), 0) & (0x7 << 15)) >>
  15;
 if (current_index == 7) {
  pl = &pi->boost_pl;
