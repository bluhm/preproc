# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c"
...
struct tty;
struct uio;
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmciadevs.h" 1
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmciareg.h" 1
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia_cis_quirks.c" 2
...
static struct pcmcia_cis_quirk pcmcia_cis_quirks[] = {
 { 0x0101, 0x0035, { ((void *)0), ((void *)0), ((void *)0), ((void *)0) },
 ...
 struct pcmcia_softc *sc;
{
 ...
 for (i = 0; i < (sizeof((pcmcia_cis_quirks)) / sizeof((pcmcia_cis_quirks)[0]));
  ...
  if ((sc->card.manufacturer == pcmcia_cis_quirks[i].manufacturer) &&
   ...
   (((sc->card.manufacturer != 0xffff) &&
     (sc->card.product != 0xffff)) ||
    ((sc->card.manufacturer == 0xffff) &&
     (sc->card.product == 0xffff) &&
     sc->card.cis1_info[0] &&
   ...
   if (!wiped) {
    ...
    for (pf = ((&sc->card.pf_head)->sqh_first); pf != ((void *)0);
         pf = pf_next) {
     for (cfe = ((&pf->cfe_head)->sqh_first); cfe != ((void *)0);
          cfe = cfe_next) {
      cfe_next = ((cfe)->cfe_list.sqe_next);
      free(cfe, 2, 0);
     }
     pf_next = ((pf)->pf_list.sqe_next);
     free(pf, 2, 0);
    }

    do { (&sc->card.pf_head)->sqh_first = ((void *)0); (&sc->card.pf_head)->sqh_last = &(&sc->card.pf_head)->sqh_first; } while (0);
    wiped = 1;
   }
