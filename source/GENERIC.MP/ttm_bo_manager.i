# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_manager.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_manager.c"
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_manager.c"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_manager.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_manager.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_placement.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_manager.c" 2
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo_manager.c"
          ...
          struct ttm_mem_reg *mem)
{
 ...
 node = kzalloc(sizeof(*node), (0x0001 | 0x0004));
 if (!node)
  return -12;

 __mtx_enter(&rman->lock);
 ret = drm_mm_insert_node_in_range_generic(mm, node, mem->num_pages,
       mem->page_alignment, 0,
       placement->fpfn, lpfn,
       sflags, aflags);
 __mtx_leave(&rman->lock);
      ...
      unsigned long p_size)
{
 ...
 rman = kzalloc(sizeof(*rman), (0x0001 | 0x0004));
 if (!rman)
  return -12;

 drm_mm_init(&rman->mm, 0, p_size);
 __mtx_init((&rman->lock), ((((0)) > 0 && ((0)) < 12) ? 12 : ((0))));
 man->priv = rman;
 return 0;
}
