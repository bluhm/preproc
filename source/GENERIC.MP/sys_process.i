# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
...
int process_domem(struct proc *_curp, struct process *_tr, struct uio *,
     int _req);
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c" 2
...
sys_ptrace(struct proc *p, void *v, register_t *retval)
{
 ...
 case 9:
  ...
  if (((tr->ps_flags) & (0x00000200)))
   return (16);
# 214 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
 ...
 case (32 + 3):
# 273 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
 case (32 + 4):
 ...
 *retval = 0;
 ...
 case 2:
  ...
  uio.uio_procp = p;
  error = process_domem(p, tr, &uio, write ? 4 :
    1);
  if (write == 0)
   *retval = temp;
  return (error);
 case 11:
  ...
  return (error);
# 439 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
 case 7:
# 452 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
  ...
  if ((int *)addr != (int *)1)
   if ((error = process_set_pc(t, addr)) != 0)
    return error;
# 472 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
  goto sendsig;

 case 10:
# 487 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
  if (pid < 100000 && tr->ps_single)
   t = tr->ps_single;
  ...
  if (data < 0 || data >= 33)
   return (22);
# 504 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
 ...
 case 9:
# 549 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
  atomic_setbits_int(&tr->ps_flags, 0x00000200);
  tr->ps_oppid = tr->ps_pptr->ps_pid;
  if (tr->ps_pptr != p->p_p)
 ...
 case (32 + 2):
  ...
  free(fpregs, 127, sizeof(*fpregs));
  return (error);
# 661 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
 case (32 + 4):
...
# 690 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sys_process.c"
int
...
process_domem(struct proc *curp, struct process *tr, struct uio *uio, int req)
{
 ...
 vm = tr->ps_vmspace;
 if ((tr->ps_flags & 0x00000008) || (vm->vm_refcnt < 1))
  return 14;
 addr = uio->uio_offset;
