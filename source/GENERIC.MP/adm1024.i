# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1024.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1024.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1024.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1024.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1024.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1024.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1024.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1024.c" 2
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1024.c"
struct admlc_softc {
 struct device sc_dev;
 i2c_tag_t sc_tag;
 i2c_addr_t sc_addr;

 struct ksensor sc_sensor[10];
...
admlc_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_sensor[2].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[2].desc, "2.5 V",
     sizeof(sc->sc_sensor[2].desc));

 sc->sc_sensor[3].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[3].desc, "Vccp",
     sizeof(sc->sc_sensor[3].desc));

 sc->sc_sensor[4].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[4].desc, "Vcc",
     sizeof(sc->sc_sensor[4].desc));

 sc->sc_sensor[5].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[5].desc, "5 V",
     sizeof(sc->sc_sensor[5].desc));

 sc->sc_sensor[6].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[6].desc, "12 V",
     sizeof(sc->sc_sensor[6].desc));

 sc->sc_sensor[7].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[7].desc, "Vccp2",
     sizeof(sc->sc_sensor[7].desc));

 sc->sc_sensor[8].type = SENSOR_FANRPM;

 sc->sc_sensor[9].type = SENSOR_FANRPM;


 if (sensor_task_register(sc, admlc_refresh, 5) == ((void *)0)) {
...
admlc_refresh(void *arg)
{
 ...
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
  ...
  sc->sc_sensor[0].value = 273150000 + 1000000 * sdata;

 cmd = 0x26;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &sdata, sizeof sdata, 0) == 0)
  sc->sc_sensor[1].value = 273150000 + 1000000 * sdata;

 cmd = 0x42;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0) {
  if (data & 0x40)
   sc->sc_sensor[1].flags |= 0x0001;
  else
   sc->sc_sensor[1].flags &= ~0x0001;
 }
 ...
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[2].value = 2500000 * data / 192;

 cmd = 0x21;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[4].value = 2249000 * data / 192;

 cmd = 0x22;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[4].value = 3300000 * data / 192;

 cmd = 0x23;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[5].value = 5000000 * data / 192;

 cmd = 0x24;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[6].value = 12000000 * data / 192;

 cmd = 0x25;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[7].value = 2700000 * data / 192;

 cmd = 0x28;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  fanval(&sc->sc_sensor[8], sc->sc_fan1mul, data);

 cmd = 0x29;
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  fanval(&sc->sc_sensor[9], sc->sc_fan2mul, data);
 (*(sc->sc_tag)->ic_release_bus)((sc->sc_tag)->ic_cookie, (0));
}
