# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/wait.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
procinit(void)
{
 ...
 uihashtbl = hashinit(maxprocess / 16, 41, 0x0002, &uihash);
 if (!tidhashtbl || !pidhashtbl || !pgrphashtbl || !uihashtbl)
  panic("procinit: malloc");

 pool_init(&proc_pool, sizeof(struct proc), 0, 0,
     0x0001, "procpl", ((void *)0));
 pool_init(&process_pool, sizeof(struct process), 0, 0,
     0x0001, "processpl", ((void *)0));
 pool_init(&rusage_pool, sizeof(struct rusage), 0, 0,
     0x0001, "zombiepl", ((void *)0));
 pool_init(&ucred_pool, sizeof(struct ucred), 0, 0,
     0x0001, "ucredpl", ((void *)0));
 pool_init(&pgrp_pool, sizeof(struct pgrp), 0, 0,
     0x0001, "pgrppl", ((void *)0));
 pool_init(&session_pool, sizeof(struct session), 0, 0,
     0x0001, "sessionpl", ((void *)0));
}
...
tfind(pid_t tid)
{
 ...
 for((p) = (((&tidhashtbl[(tid) & tidhash]))->lh_first); (p)!= ((void *)0); (p) = ((p)->p_hash.le_next))
  if (p->p_tid == tid)
   return (p);
 return (((void *)0));
}
...
prfind(pid_t pid)
{
 ...
 for((pr) = (((&pidhashtbl[(pid) & pidhash]))->lh_first); (pr)!= ((void *)0); (pr) = ((pr)->ps_hash.le_next))
  if (pr->ps_pid == pid)
   return (pr);
 return (((void *)0));
}
...
pgfind(pid_t pgid)
{
 ...
 for((pgrp) = (((&pgrphashtbl[(pgid) & pgrphash]))->lh_first); (pgrp)!= ((void *)0); (pgrp) = ((pgrp)->pg_hash.le_next))
  if (pgrp->pg_id == pgid)
   return (pgrp);
 return (((void *)0));
}
...
zombiefind(pid_t pid)
{
 ...
 for((pr) = ((&zombprocess)->lh_first); (pr)!= ((void *)0); (pr) = ((pr)->ps_list.le_next))
  if (pr->ps_pid == pid)
   return (pr);
 return (((void *)0));
}
...
leavepgrp(struct process *pr)
{
 ...
 if (pr->ps_pgrp->pg_session->s_verauthppid == pr->ps_pid)
  zapverauth(pr->ps_pgrp->pg_session);
 do { if ((pr)->ps_pglist.le_next != ((void *)0)) (pr)->ps_pglist.le_next->ps_pglist.le_prev = (pr)->ps_pglist.le_prev; *(pr)->ps_pglist.le_prev = (pr)->ps_pglist.le_next; ((pr)->ps_pglist.le_prev) = ((void *)-1); ((pr)->ps_pglist.le_next) = ((void *)-1); } while (0);
 if ((((&pr->ps_pgrp->pg_members)->lh_first) == ((void *)0)))
  pgdelete(pr->ps_pgrp);
 pr->ps_pgrp = 0;
...
pgdelete(struct pgrp *pgrp)
{
 ...
 if (pgrp->pg_session->s_ttyp != ((void *)0) &&
     pgrp->pg_session->s_ttyp->t_pgrp == pgrp)
  pgrp->pg_session->s_ttyp->t_pgrp = ((void *)0);
 do { if ((pgrp)->pg_hash.le_next != ((void *)0)) (pgrp)->pg_hash.le_next->pg_hash.le_prev = (pgrp)->pg_hash.le_prev; *(pgrp)->pg_hash.le_prev = (pgrp)->pg_hash.le_next; ((pgrp)->pg_hash.le_prev) = ((void *)-1); ((pgrp)->pg_hash.le_next) = ((void *)-1); } while (0);
 do { if (--(pgrp->pg_session)->s_count == 0) { timeout_del(&(pgrp->pg_session)->s_verauthto); pool_put(&session_pool, (pgrp->pg_session)); } } while ( 0);
...
# 352 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c"
void
fixjobc(struct process *pr, struct pgrp *pgrp, int entering)
{
 ...
 for((pr) = ((&pr->ps_children)->lh_first); (pr)!= ((void *)0); (pr) = ((pr)->ps_sibling.le_next))
  if ((hispgrp = pr->ps_pgrp) != pgrp &&
      hispgrp->pg_session == mysession &&
      (pr->ps_flags & 0x00040000) == 0) {
   if (entering)
    hispgrp->pg_jobc++;
...
orphanpg(struct pgrp *pg)
{
 ...
 for((pr) = ((&pg->pg_members)->lh_first); (pr)!= ((void *)0); (pr) = ((pr)->ps_pglist.le_next)) {
  if (pr->ps_mainproc->p_stat == 4) {
   for((pr) = ((&pg->pg_members)->lh_first); (pr)!= ((void *)0); (pr) = ((pr)->ps_pglist.le_next)) {
    ptsignal((pr)->ps_mainproc, (1), SPROCESS);
    ptsignal((pr)->ps_mainproc, (19), SPROCESS);
   }
   return;
  }
 }
    ...
    int (*pr)(const char *, ...) __attribute__((__format__(__kprintf__,1,2))))
{
 ...
 (*pr)("    forw=%p, list=%p,%p\n",
     ((p)->p_runq.tqe_next), p->p_list.le_next, p->p_list.le_prev);
...
# 439 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
# 441 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_proc.c" 2
...
db_show_all_procs(db_expr_t addr, int haddr, db_expr_t count, char *modif)
{
 ...
 while (pr != ((void *)0)) {
  ...
  for((p) = ((&pr->ps_threads)->tqh_first); (p) != ((void *)0); (p) = ((p)->p_thr_link.tqe_next)) {
   if (p->p_stat) {
    if (*mode == 'o') {
     if (p->p_stat != 7)
      continue;
     if (p->p_cpu != ((void *)0) && p->p_cpu->
         ci_schedstate.spc_idleproc == p)
      continue;
    }

    if (*mode == 'n') {
     db_printf("%c%5d  ", (p == (__curcpu->ci_self)->ci_curproc ?
         '*' : ' '), pr->ps_pid);
    } else {
     db_printf("%c%6d  ", (p == (__curcpu->ci_self)->ci_curproc ?
         '*' : ' '), p->p_tid);
    }
  ...
  pr = ((pr)->ps_list.le_next);
  if (pr == ((void *)0) && skipzomb == 0) {
   skipzomb = 1;
