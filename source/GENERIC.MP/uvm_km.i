# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
# 132 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
...
# 133 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c" 2
...
# 134 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c" 2
...
# 135 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c" 2
...
# 136 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c" 2





struct vm_map *kernel_map = ((void *)0);
...
# 159 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
void
uvm_km_init(vaddr_t base, vaddr_t start, vaddr_t end)
{

 uao_init();
 uvm.kernel_object = uao_create((((vaddr_t)0x000007ffffffffffL) - ((vaddr_t)0x001000000)), 0x1);
 ...
 kernel_map_store.pmap = (&kernel_pmap_);
 if (base != start && uvm_map(&kernel_map_store, &base, start - base,
     ((void *)0), ((voff_t) -1), 0,
     ((0x01 | 0x02) | ((0x01 | 0x02) << 8) | ((2) << 4) | ((1) << 12) | (0x0010000))) != 0)

  panic("uvm_km_init: could not reserve space for kernel");

 kernel_map = &kernel_map_store;
}
# 198 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
struct vm_map *
uvm_km_suballoc(struct vm_map *map, vaddr_t *min, vaddr_t *max, vsize_t size,
    int flags, boolean_t fixed, struct vm_map *submap)
{
 int mapflags = 0x0040000 | (fixed ? 0x0010000 : 0);

 size = (((size) + ((1 << 13) - 1)) & ~((1 << 13) - 1));


 if (uvm_map(map, min, size, ((void *)0), ((voff_t) -1), 0,
     ((0x01 | 0x02) | ((0x01 | 0x02) << 8) | ((2) << 4) | ((1) << 12) | (mapflags))) != 0) {
...
uvm_km_pgremove(struct uvm_object *uobj, vaddr_t start, vaddr_t end)
{
 ...
 ((uobj->pgops == &aobj_pager) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 247, "uobj->pgops == &aobj_pager"));

 for (curoff = start ; curoff < end ; curoff += (1 << 13)) {
  pp = uvm_pagelookup(uobj, curoff);
  if (pp && pp->pg_flags & 0x00000001) {
   atomic_setbits_int(&pp->pg_flags, 0x00000002);
   do { tsleep(pp, 4|(0 ? 0x100 : 0), "km_pgrm", 0); } while (0);
   curoff -= (1 << 13);
   continue;
  }
...
# 282 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
void
uvm_km_pgremove_intrsafe(vaddr_t start, vaddr_t end)
{
 ...
 for (va = start; va < end; va += (1 << 13)) {
  if (!pmap_extract((&kernel_pmap_), va, &pa))
   continue;
...
# 313 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
vaddr_t
    ...
    paddr_t boundary, int nsegs)
{
 ...
 ((((map)->pmap) == (&kernel_pmap_)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 324, "vm_map_pmap(map) == pmap_kernel()"));

 ((!(flags & 0x2) || !(flags & 0x08)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 327, "!(flags & UVM_KMF_VALLOC) || !(flags & UVM_KMF_ZERO)"));
 ...
 if (__builtin_expect(((uvm_map(map, &kva, size, obj, ((voff_t) -1), valign, ((0x01 | 0x02) | ((0x01 | 0x02) << 8) | ((2) << 4) | ((1) << 12) | ((flags & 0x0100000)))) != 0) != 0), 0)) {
 ...
 if (obj != ((void *)0))
  offset = kva - ((kernel_map)->min_offset);
 else
  offset = 0;
 ...
 pla_flags = 0;
 ((uvmexp.swpgonly <= uvmexp.swpages) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 359, "uvmexp.swpgonly <= uvmexp.swpages"));
 if ((flags & 0x1) ||
     ((flags & 0x4) &&
     uvmexp.swpages - uvmexp.swpgonly <= ((size) >> 13)))
  pla_flags |= 0x0002;
 else
  pla_flags |= 0x0001;
 if (flags & 0x08)
 ...
 while (loopva != kva + size) {
  ...
  if (obj == ((void *)0)) {
   pmap_kenter_pa(loopva, ((pg)->phys_addr),
       0x01 | 0x02);
  } else {
   pmap_enter(map->pmap, loopva, ((pg)->phys_addr),
       0x01 | 0x02,
 ...
 (((((&pgl)->tqh_first) == ((void *)0))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 398, "TAILQ_EMPTY(&pgl)"));
 ;
...
{
 uvm_unmap(map, ((addr) & ~((1 << 13) - 1)), (((addr+size) + ((1 << 13) - 1)) & ~((1 << 13) - 1)));
}
...
uvm_km_free_wakeup(struct vm_map *map, vaddr_t addr, vsize_t size)
{
 ...
 vm_map_lock_ln(map, "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 424);
 do { (&dead_entries)->tqh_first = ((void *)0); (&dead_entries)->tqh_last = &(&dead_entries)->tqh_first; } while (0);
 uvm_unmap_remove(map, ((addr) & ~((1 << 13) - 1)), (((addr+size) + ((1 << 13) - 1)) & ~((1 << 13) - 1)),
      &dead_entries, 0, 1);
 wakeup(map);
 vm_map_unlock_ln(map, "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 429);
...
uvm_km_alloc1(struct vm_map *map, vsize_t size, vsize_t align, boolean_t zeroit)
{
 ...
 ((((map)->pmap) == (&kernel_pmap_)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 446, "vm_map_pmap(map) == pmap_kernel()"));

 size = (((size) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
 kva = ((map)->min_offset);


 if (__builtin_expect(((uvm_map(map, &kva, size, uvm.kernel_object, ((voff_t) -1), align, ((0x01 | 0x02) | ((0x01 | 0x02 | 0x04) << 8) | ((2) << 4) | ((1) << 12) | (0))) != 0) != 0), 0)) {
 ...
 while (size) {
  ...
  pg = uvm_pagealloc(uvm.kernel_object, offset, ((void *)0), 0);
  if (pg) {
   atomic_clearbits_int(&pg->pg_flags, 0x00000001);
   ;
  }
  if (__builtin_expect(((pg == ((void *)0)) != 0), 0)) {
 ...
 if (zeroit)
  __builtin_memset(((caddr_t)kva), (0), (loopva - kva));
...
{
 return(uvm_km_valloc_align(map, size, 0, 0x0100000));
}
...
uvm_km_valloc_align(struct vm_map *map, vsize_t size, vsize_t align, int flags)
{
 ...
 ((((map)->pmap) == (&kernel_pmap_)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 534, "vm_map_pmap(map) == pmap_kernel()"));
 ...
 if (__builtin_expect(((uvm_map(map, &kva, size, uvm.kernel_object, ((voff_t) -1), align, ((0x01 | 0x02) | ((0x01 | 0x02) << 8) | ((2) << 4) | ((1) << 12) | (flags))) != 0) != 0), 0)) {
...
# 558 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
vaddr_t
uvm_km_valloc_prefer_wait(struct vm_map *map, vsize_t size, voff_t prefer)
{
 vaddr_t kva;

 ((((map)->pmap) == (&kernel_pmap_)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 563, "vm_map_pmap(map) == pmap_kernel()"));
 ...
 while (1) {
  ...
  if (__builtin_expect(((uvm_map(map, &kva, size, uvm.kernel_object, prefer, 0, ((0x01 | 0x02) | ((0x01 | 0x02) << 8) | ((2) << 4) | ((1) << 12) | (0))) == 0) != 0), 1)) {
...
{
 return uvm_km_valloc_prefer_wait(map, size, ((voff_t) -1));
}
# 626 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
...
uvm_km_page_init(void)
{
 ...
 if (uvm_km_pages.lowat > (2048))
  uvm_km_pages.lowat = (2048);
 uvm_km_pages.hiwat = 4 * uvm_km_pages.lowat;
 if (uvm_km_pages.hiwat > (4 * (2048)))
  uvm_km_pages.hiwat = (4 * (2048));


 len = 0;
 bulk = uvm_km_pages.hiwat;
 while (len < uvm_km_pages.hiwat && bulk > 0) {
  bulk = (((bulk)<(uvm_km_pages.hiwat - len))?(bulk):(uvm_km_pages.hiwat - len));
  addr = ((kernel_map)->min_offset);
  if (uvm_map(kernel_map, &addr, (vsize_t)bulk << 13,
      ((void *)0), ((voff_t) -1), 0,
      ((0x01 | 0x02) | ((0x01 | 0x02) << 8) | ((2) << 4) | ((1) << 12) | (0x0100000))) != 0) {
  ...
  for (i = len; i < len + bulk; i++, addr += (1 << 13))
   uvm_km_pages.page[i] = addr;
  len += bulk;
 }

 uvm_km_pages.free = len;
 for (i = len; i < (4 * (2048)); i++)
...
{
 kthread_create_deferred(uvm_km_createthread, ((void *)0));
}

void
uvm_km_createthread(void *arg)
{
 kthread_create(uvm_km_thread, ((void *)0), &uvm_km_pages.km_proc, "kmthread");
}
 ...
 for (;;) {
  ...
  if (allocmore) {
   ...
   for (i = 0; i < (sizeof((pg)) / sizeof((pg)[0])); i++) {
    pg[i] = ((kernel_map)->min_offset);
    if (uvm_map(kernel_map, &pg[i], (1 << 13),
        ((void *)0), ((voff_t) -1), 0, flags) != 0) {
     pg[i] = 0;
     break;
    }
    ...
    const struct kmem_pa_mode *kp, const struct kmem_dyn_mode *kd)
{
 ...
 ((sz == (((sz) + ((1 << 13) - 1)) & ~((1 << 13) - 1))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 824, "sz == round_page(sz)"));
 ...
 pla_flags = kd->kd_waitok ? 0x0001 : 0x0002;
 pla_flags |= 0x0008;
 if (kp->kp_zero)
  pla_flags |= 0x0004;
...
# 865 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
alloc_va:
 prot = 0x01 | 0x02;

 if (kp->kp_pageable) {
  ((kp->kp_object) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 869, "kp->kp_object"));
  ((!kv->kv_singlepage) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 870, "!kv->kv_singlepage"));
 } else {
  ((kp->kp_object == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c", 872, "kp->kp_object == NULL"));
 }
 ...
 if (kv->kv_singlepage) {
  ...
  while (uvm_km_pages.free == 0) {
   ...
   msleep(&uvm_km_pages.free, &uvm_km_pages.mtx, 4,
       "getpage", 0);
  }
  va = uvm_km_pages.page[--uvm_km_pages.free];
  if (uvm_km_pages.free < uvm_km_pages.lowat &&
      (__curcpu->ci_self)->ci_curproc != uvm_km_pages.km_proc) {
   if (kd->kd_slowdown)
    *kd->kd_slowdown = 1;
...
try_map:
  ...
  if (uvm_map(map, &va, sz, uobj, kd->kd_prefer,
      kv->kv_align, ((prot) | ((prot) << 8) | ((2) << 4) | ((1) << 12) | (mapflags)))) {

   if (kv->kv_wait && kd->kd_waitok) {
    tsleep(map, 4, "km_allocva", 0);
    goto try_map;
   }
   uvm_pglistfree(&pgl);
   return (((void *)0));
 ...
 for((pg) = ((&pgl)->tqh_first); (pg) != ((void *)0); (pg) = ((pg)->pageq.tqe_next)) {
  if (kp->kp_pageable)
   pmap_enter((&kernel_pmap_), va, ((pg)->phys_addr),
       prot, prot | 0x00000010);
  else
   pmap_kenter_pa(va, ((pg)->phys_addr), prot);
  va += (1 << 13);
 }
 ;
 return ((void *)sva);
    ...
    const struct kmem_pa_mode *kp)
{
 ...
 if (kp->kp_nomem)
  goto free_va;
# 959 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_km.c"
 if (kv->kv_singlepage) {
 ...
 if (kp->kp_pageable) {
  pmap_remove((&kernel_pmap_), sva, eva);
  ;
 } else {
  do { (&pgl)->tqh_first = ((void *)0); (&pgl)->tqh_last = &(&pgl)->tqh_first; } while (0);
  for (va = sva; va < eva; va += (1 << 13)) {
   paddr_t pa;
   ...
   do { (pg)->pageq.tqe_next = ((void *)0); (pg)->pageq.tqe_prev = (&pgl)->tqh_last; *(&pgl)->tqh_last = (pg); (&pgl)->tqh_last = &(pg)->pageq.tqe_next; } while (0);
  }
  pmap_kremove(sva, sz);
  ;
  uvm_pglistfree(&pgl);
