...
{
 struct drm_gem_object *obj =
     ({ const __typeof( ((struct drm_gem_object *)0)->uobj ) *__mptr = (uobj); (struct drm_gem_object *)( (char *)__mptr - __builtin_offsetof(struct drm_gem_object, uobj) );});
...
udv_attach_drm(dev_t device, vm_prot_t accessprot, voff_t off, vsize_t size)
{
 ...
 obj = ({ const __typeof( ((struct drm_gem_object *)0)->vma_node ) *__mptr = (node); (struct drm_gem_object *)( (char *)__mptr - __builtin_offsetof(struct drm_gem_object, vma_node) );});
 drm_gem_object_reference(obj);
 _rw_exit_write(&dev->struct_mutex );
 return &obj->uobj;
}
...
drm_gem_open(struct drm_device *dev, struct drm_file *file_private)
{
 ...
 do { (void)(((void *)0)); (void)(0); __mtx_init((&file_private->table_lock), ((((0)) > 0 && ((0)) < 12) ? 12 : ((0)))); } while (0);
}
static int
