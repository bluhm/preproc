# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_vma_manager.h" 1
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm.h"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c" 2
...
{
 struct drm_gem_object *obj =
     ({ __typeof( ((struct drm_gem_object *)0)->uobj ) *__mptr = (uobj); (struct drm_gem_object *)( (char *)__mptr - __builtin_offsetof(struct drm_gem_object, uobj) );});
    ...
    vm_prot_t access_type, int flags)
{
 ...
 if ((((entry)->etype & 0x04) != 0)) {
  uvmfault_unlockall(ufi, ufi->entry->aref.ar_amap, uobj, ((void *)0));
  return(4);
 }
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
...
udv_attach_drm(dev_t device, vm_prot_t accessprot, voff_t off, vsize_t size)
{
 ...
 if (cdevsw[((int32_t)(((u_int32_t)(device) >> 8) & 0xff))].d_mmap != drmmmap)
  return ((void *)0);
 ...
 priv = drm_find_file_by_minor(dev, ((int32_t)((device) & 0xff) | (((device) & 0xffff0000) >> 8)));
 if (priv == 0) {
  _rw_exit_write(&dev->struct_mutex );
  return ((void *)0);
 }
 ...
 obj = ({ __typeof( ((struct drm_gem_object *)0)->vma_node ) *__mptr = (node); (struct drm_gem_object *)( (char *)__mptr - __builtin_offsetof(struct drm_gem_object, vma_node) );});
 drm_gem_object_reference(obj);

 _rw_exit_write(&dev->struct_mutex );
 return &obj->uobj;
}
# 224 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
int
drm_gem_init(struct drm_device *dev)
{
 struct drm_vma_offset_manager *vma_offset_manager;

 _rw_init_flags(&dev->object_name_lock, "drmonl", 0, ((void *)0));
 idr_init(&dev->object_name_idr);

 vma_offset_manager = kzalloc(sizeof(*vma_offset_manager), (0x0001 | 0x0004));
 if (!vma_offset_manager) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "out of memory\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -12;
 }
...
# 280 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
int drm_gem_object_init(struct drm_device *dev,
   struct drm_gem_object *obj, size_t size)
{
 ...
 __sync_fetch_and_add(&dev->obj_count, 1);
 __sync_fetch_and_add(&dev->obj_memory, obj->size);

 obj->filp = (void *)obj->uao;

 return 0;
}
# 303 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
void drm_gem_private_object_init(struct drm_device *dev,
     struct drm_gem_object *obj, size_t size)
{
 ((!((size & ((1 << 13) - 1)) != 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c", 306, "!((size & ((1 << 13) - 1)) != 0)"));
...
{
# 333 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
}
# 342 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
...
{
 if (({ int __ret = !!(obj->handle_count == 0); if (__ret) printf("WARNING %s failed at %s:%d\n", "obj->handle_count == 0", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c", 367); __builtin_expect(!!(__ret), 0); }))
  return;
 ...
 _rw_enter_write(&obj->dev->object_name_lock );
 if (--obj->handle_count == 0) {
  drm_gem_object_handle_free(obj);
  drm_gem_object_exported_dma_buf_free(obj);
 }
 _rw_exit_write(&obj->dev->object_name_lock );
...
drm_gem_handle_delete(struct drm_file *filp, u32 handle)
{
 struct drm_device *dev;
 struct drm_gem_object *obj;
# 404 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
 __mtx_enter(&filp->table_lock);


 obj = idr_find(&filp->object_idr, handle);
 if (obj == ((void *)0)) {
  __mtx_leave(&filp->table_lock);
  return -22;
 }
 dev = obj->dev;
...
;
# 451 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
int
      ...
      u32 *handlep)
{
 ...
 ({ int __ret = !!(!(rw_status(&dev->object_name_lock) == 0x0001UL)); if (__ret) printf("WARNING %s failed at %s:%d\n", "!(rw_status(&dev->object_name_lock) == 0x0001UL)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c", 459); __builtin_expect(!!(__ret), 0); });





 idr_preload((0x0001 | 0x0004));
 __mtx_enter(&file_priv->table_lock);

 ret = idr_alloc(&file_priv->object_idr, obj, 1, 0, 0x0002);
 drm_gem_object_reference(obj);
 obj->handle_count++;
 __mtx_leave(&file_priv->table_lock);
 ;
 _rw_exit_write(&dev->object_name_lock );
 if (ret < 0)
  goto err_unref;
...
;
# 525 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
void
...
;
# 548 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
int
...
;
# 569 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
int drm_gem_create_mmap_offset(struct drm_gem_object *obj)
{
 return drm_gem_create_mmap_offset_size(obj, obj->size);
}
;
# 683 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
struct drm_gem_object *
      ...
      struct drm_file *file_priv)
{
 ...
 _rw_enter_write(&dev->object_name_lock );
 idr_preload((0x0001 | 0x0004));
 ...
 if (!obj->name) {
  ret = idr_alloc(&dev->object_name_idr, obj, 1, 0, 0x0002);
  if (ret < 0)
   goto err;
...
drm_gem_open(struct drm_device *dev, struct drm_file *file_private)
{
 ...
 __mtx_init((&file_private->table_lock), ((((0)) > 0 && ((0)) < 12) ? 12 : ((0))));
}
...
# 871 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
void
drm_gem_object_release(struct drm_gem_object *obj)
{
 ...
 __sync_fetch_and_sub(&dev->obj_count, 1);
 __sync_fetch_and_sub(&dev->obj_memory, obj->size);
}
# 891 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c"
void
drm_gem_object_free(struct kref *kref)
{
 ...
 ((!(!(rw_status(&dev->struct_mutex) == 0x0001UL))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_gem.c", 897, "!(!(rw_status(&dev->struct_mutex) == 0x0001UL))"));
