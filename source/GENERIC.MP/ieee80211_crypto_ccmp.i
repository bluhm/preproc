# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c"
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c"
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_ccmp.c" 2
...
ieee80211_ccmp_delete_key(struct ieee80211com *ic, struct ieee80211_key *k)
{
 if (k->k_priv != ((void *)0)) {
  ...
  free(k->k_priv, 2, sizeof(struct ieee80211_ccmp_ctx));
 }
 k->k_priv = ((void *)0);
}
 ...
 *aad &= ~(0x08 | 0x10 |
  ...
  *aad &= ~0x80;
 aad++;
 __builtin_memcpy((aad), (wh->i_addr1), (6)); aad += 6;
 __builtin_memcpy((aad), (wh->i_addr2), (6)); aad += 6;
 __builtin_memcpy((aad), (wh->i_addr3), (6)); aad += 6;
 *aad++ = wh->i_seq[0] & ~0xf0;
 *aad++ = 0;
 if (ieee80211_has_addr4(wh)) {
  __builtin_memcpy((aad), (((const struct ieee80211_frame_addr4 *)wh)->i_addr4), (6));
  ...
  *aad++ = tid = ieee80211_get_qos(wh) & 0x000f;
  *aad++ = 0;
 }
 ...
 if ((wh->i_fc[0] & 0x0c) ==
     0x00)
  nonce[0] |= 1 << 4;
 __builtin_memcpy((&nonce[1]), (wh->i_addr2), (6));
 nonce[ 7] = pn >> 40;
 nonce[ 8] = pn >> 32;
 nonce[ 9] = pn >> 24;
 nonce[10] = pn >> 16;
 ...
 auth[0] = la >> 8;
 auth[1] = la & 0xff;
 __builtin_memset((aad), (0), (30 - la));


 b[ 0] = 89;
 __builtin_memcpy((&b[1]), (nonce), (13));
 b[14] = lm >> 8;
 b[15] = lm & 0xff;
 AES_Encrypt(ctx, b, b);
    ...
    struct ieee80211_key *k)
{
 ...
 if (n0->M_dat.MH.MH_pkthdr.len >= (((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr)) + (256 - sizeof(struct m_hdr)) + 1) - 8) {
 ...
 ieee80211_ccmp_phase1(&ctx->aesctx, wh, k->k_tsc,
     m0->M_dat.MH.MH_pkthdr.len - hdrlen, b, a, s0);
 ...
 while (left > 0) {
  ...
  if (noff == n->m_hdr.mh_len) {
   ...
   if (left >= (((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr)) + (256 - sizeof(struct m_hdr)) + 1) - 8) {
  ...
  src = ((u_int8_t *)((m)->m_hdr.mh_data)) + moff;
  dst = ((u_int8_t *)((n)->m_hdr.mh_data)) + noff;
  for (i = 0; i < len; i++) {
 ...
 mic = ((u_int8_t *)((n)->m_hdr.mh_data)) + n->m_hdr.mh_len;
 for (i = 0; i < 8; i++)
  mic[i] = b[i] ^ s0[i];
 n->m_hdr.mh_len += 8;
 n0->M_dat.MH.MH_pkthdr.len += 8;
    ...
    struct ieee80211_key *k)
{
 ...
 if (m0->M_dat.MH.MH_pkthdr.len < hdrlen + 8 +
     8) {
  m_freem(m0);
  return ((void *)0);
 }
 ...
 ieee80211_ccmp_phase1(&ctx->aesctx, wh, pn,
     n0->M_dat.MH.MH_pkthdr.len - hdrlen, b, a, s0);
 ...
 m_copydata(m, moff, 8, mic0);
 if (timingsafe_bcmp(mic0, b, 8) != 0) {
