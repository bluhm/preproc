# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ufs/ufs_vfsops.c" 2
...
ufs_root(struct mount *mp, struct vnode **vpp)
{
 ...
 if ((error = (*(mp)->mnt_op->vfs_vget)(mp, ((ufsino_t)2), &nvp)) != 0)
  return (error);
 *vpp = nvp;
 return (0);
}
...
ufs_fhtovp(struct mount *mp, struct ufid *ufhp, struct vnode **vpp)
{
 ...
 if ((error = (*(mp)->mnt_op->vfs_vget)(mp, ufhp->ufid_ino, &nvp)) != 0) {
  *vpp = ((struct vnode *)((void *)0));
  return (error);
 }
 ip = ((struct inode *)(nvp)->v_data);
 if ((((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_mode : (ip)->dinode_u.ffs2_din->di_mode) == 0 || (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_gen : (ip)->dinode_u.ffs2_din->di_gen) != ufhp->ufid_gen) {
  vput(nvp);
  *vpp = ((struct vnode *)((void *)0));
  return (70);
 }
