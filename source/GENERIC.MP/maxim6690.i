# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/maxim6690.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/maxim6690.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/maxim6690.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/maxim6690.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/maxim6690.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/maxim6690.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/maxim6690.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/maxim6690.c" 2
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/maxim6690.c"
struct maxtmp_softc {
...
maxtmp_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (strcmp(ia->ia_name, "max6642") == 0) {
  sc->sc_temp_invalid[0] = 0xff;
  sc->sc_temp_invalid[1] = 0xff;
  sc->sc_temp2_mask = 0xc0;
 } else if (strcmp(ia->ia_name, "max6690") == 0 ||
     strcmp(ia->ia_name, "max6657") == 0 ||
     strcmp(ia->ia_name, "max6658") == 0 ||
     strcmp(ia->ia_name, "max6659") == 0) {
  sc->sc_temp_invalid[0] = 0x80;
  sc->sc_temp_invalid[1] = 0x7f;
  sc->sc_temp2_mask = 0xe0;
 } else {
  sc->sc_temp_invalid[0] = 0x7f;
  sc->sc_temp_invalid[1] = 0x7f;
  sc->sc_temp2_mask = 0xe0;
 }
 printf(": %s", ia->ia_name);
 ...
 if (sensor_task_register(sc, maxtmp_refresh, 5) == ((void *)0)) {
...
invalid:
 sc->sc_sensor[index].flags |= 0x0001;
}
...
maxtmp_refresh(void *arg)
{
 ...
 maxtmp_readport(sc, 0x00, 0x11, 0);
 maxtmp_readport(sc, 0x01, 0x10, 1);
