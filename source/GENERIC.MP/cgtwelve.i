# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c"
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c"
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
void device_register(struct device *, void *);
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
int bppopen(dev_t, int, int, struct proc *); int bppclose(dev_t, int, int, struct proc *); int bppread(dev_t, struct uio *, int); int bppwrite(dev_t, struct uio *, int); int bppioctl(dev_t, u_long, caddr_t, int, struct proc *); int bppstop(struct tty *, int); struct tty *bpptty(dev_t); int bpppoll(dev_t, int, struct proc *); paddr_t bppmmap(dev_t, off_t, int); int bppkqfilter(dev_t, struct knote *);
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
int ifb_ident(void *);
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2



# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelvereg.h" 1
# 114 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelvereg.h"
struct cgtwelve_dpu {
 u_int32_t r[8];
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c" 2
...
struct cfattach cgtwelve_ca = {
 ...
 ((void *)0), cgtwelveactivate
};

struct cfdriver cgtwelve_cd = {
 ((void *)0), "cgtwelve", DV_DULL
};
...
cgtwelveattach(struct device *parent, struct device *self, void *args)
{
 ...
 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset + 0x040100)), sizeof(struct cgtwelve_dpu), 0x0002, &bh) != 0) {
 ...
 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset + 0x040200)), sizeof(struct cgtwelve_apu), 0x0002, &bh) != 0) {
 ...
 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset + 0x040300)), sizeof(struct cgtwelve_dac), 0x0002, &bh) != 0) {
 ...
 fb_setsize(&sc->sc_sunfb, 1, 1152, 900,
     node, 0);
 ...
 sc->sc_highres = sc->sc_sunfb.sf_width == 1280;




 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset + (sc->sc_highres ? 0xe00000 : 0x700000))), (((sc->sc_highres ? 0x030000 : 0x020000) + ((1 << 13) - 1)) & ~((1 << 13) - 1)), 0x0002, &bh) != 0) {
 ...
 if (bus_space_map(bt, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset + (sc->sc_highres ? 0x800000 : 0xc00000))), (((sc->sc_highres ? 0x600000 : 0x400000) + ((1 << 13) - 1)) & ~((1 << 13) - 1)), 0x0002, &bh) != 0) {
 ...
 sc->sc_paddr = sbus_bus_addr(bt, sa->sa_reg[0].sbr_slot, sa->sa_reg[0].sbr_offset +
     (sc->sc_highres ? 0x800000 : 0xc00000));
 ...
 if (sc->sc_sunfb.sf_depth != depth) {
  if (depth == 1) {
   ...
   sc->sc_apu->hpage = sc->sc_highres ?
       0x00000e00 : 0x00000700;
   sc->sc_apu->haccess = 0x00000020;
   sc->sc_dpu->pln_sl_host = 0x00000016;
   sc->sc_dpu->pln_rd_msk_host = 0xffffffff;
   sc->sc_dpu->pln_wr_msk_host = 0x00400000;

   __builtin_memset(((void *)sc->sc_overlay), (0xff), (sc->sc_highres ? 0x030000 : 0x020000));
   ...
   sc->sc_apu->hpage = sc->sc_highres ?
       0x00000e00 : 0x00000700;
   sc->sc_apu->haccess = 0x00000020;
   sc->sc_dpu->pln_sl_host = 0x00000017;
   sc->sc_dpu->pln_rd_msk_host = 0xffffffff;
   sc->sc_dpu->pln_wr_msk_host = 0x00800000;
   ...
   sc->sc_dpu->pln_rd_msk_host = 0xffffffff;
   sc->sc_dpu->pln_wr_msk_host = 0x00800000;
# 376 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/cgtwelve.c"
   __builtin_bzero(((void *)sc->sc_overlay), (sc->sc_highres ? 0x030000 : 0x020000));
   ...
   sc->sc_apu->hpage = sc->sc_highres ?
       0x00000a00 : 0x00000500;
   sc->sc_apu->haccess = 0x00000025;
   sc->sc_dpu->pln_sl_host = 0x00000000;
   sc->sc_dpu->pln_rd_msk_host = 0x00ffffff;
   sc->sc_dpu->pln_wr_msk_host = 0x00ffffff;

   __builtin_memset(((void *)sc->sc_inten), (0x00ffffff), (sc->sc_highres ? 0x600000 : 0x400000));
