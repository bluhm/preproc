# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c"
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c"
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c" 2
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c"
struct srp *afmap;
uint8_t af2idx[36 +1];
uint8_t af2idx_max;
...
struct srp_gc rtmap_gc = { (rtmap_dtor), (((void *)0)), { .refs = 1 } };
...
rtmap_grow(unsigned int nlimit, sa_family_t af)
{
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c", 119, "_kernel_lock_held()"));

 ((nlimit > rtmap_limit) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c", 121, "nlimit > rtmap_limit"));

 nmap = malloc(sizeof(*nmap), 5, 0x0001);
 nmap->limit = nlimit;
 nmap->tbl = mallocarray(nlimit, sizeof(*nmap[0].tbl), 5,
     0x0001|0x0008);

 map = srp_get_locked(&afmap[af2idx[af]]);
 if (map != ((void *)0)) {
  ((map->limit == rtmap_limit) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c", 130, "map->limit == rtmap_limit"));
...
rtmap_dtor(void *null, void *xmap)
{
 ...
 free(map->tbl, 5, map->limit * sizeof(*map[0].tbl));
 free(map, 5, sizeof(*map));
}
...
rtable_init(void)
{
 ...
 ((sizeof(struct rtmap) == sizeof(struct dommp)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c", 159, "sizeof(struct rtmap) == sizeof(struct dommp)"));


 af2idx_max = 1;
 __builtin_memset((af2idx), (0), (sizeof(af2idx)));
 ...
 afmap = mallocarray(af2idx_max + 1, sizeof(*afmap), 5,
     0x0001|0x0008);
...
rtable_add(unsigned int id)
{
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c", 204, "_kernel_lock_held()"));
...
rtable_get(unsigned int rtableid, sa_family_t af)
{
 ...
 if (af >= (sizeof((af2idx)) / sizeof((af2idx)[0])) || af2idx[af] == 0)
  return (((void *)0));
...
rtable_l2(unsigned int rtableid)
{
 ...
 if (rtableid < dmm->limit)
  rdomain = (dmm->value[rtableid] & 0xff);
 srp_leave(&sr);
...
rtable_l2set(unsigned int rtableid, unsigned int rdomain, unsigned int loifidx)
{
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c", 317, "_kernel_lock_held()"));

 if (!rtable_exists(rtableid) || !rtable_exists(rdomain))
  return;

 value = (rdomain & 0xff) | (loifidx << 8);

 dmm = srp_get_locked(&afmap[0]);
 dmm->value[rtableid] = value;
}
# 480 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c"
...
struct srpl_rc rt_rc = { rtentry_ref, { (rtentry_unref), (((void *)0)), { .refs = 1 } } };
    ...
    struct sockaddr *mask, struct sockaddr *gateway, uint8_t prio)
{
 ...
 for ((rt) = srp_enter((&sr), &(&an->an_pointer.an__rtlist)->sl_head); (rt) != ((void *)0); (rt) = srp_follow((&sr), &(rt)->rt_next.se_next)) {
  if (prio != 64 &&
      (rt->rt_priority & 0x7f) != (prio & 0x7f))
   continue;
  ...
  if (rt->rt_gateway->sa_len == gateway->sa_len &&
      __builtin_memcmp((rt->rt_gateway), (gateway), (gateway->sa_len)) == 0)
   break;
 }
...
rtable_match(unsigned int rtableid, struct sockaddr *dst, uint32_t *src)
{
 ...
 rt = srp_enter((&sr), &(&an->an_pointer.an__rtlist)->sl_head);
 rtref(rt);
 srp_leave((&sr));
...
# 617 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/rtable.c"
  mrt = srp_enter((&sr), &(&an->an_pointer.an__rtlist)->sl_head);
  while (hash > threshold && mrt != ((void *)0)) {
   if (mrt->rt_priority == rt->rt_priority)
    hash -= threshold;
   mrt = srp_follow((&sr), &(mrt)->rt_next.se_next);
  }
    ...
    int (*func)(struct rtentry *, void *, unsigned int), void *arg)
{
 ...
 while ((error = art_walk(ar, rtable_walk_helper, &rwc)) == 35)
  continue;
...
rtable_iterate(struct rtentry *rt0)
{
 ...
 rt = srp_enter((&sr), &(rt0)->rt_next.se_next);
 if (rt != ((void *)0))
  rtref(rt);
 srp_leave((&sr));
    ...
    struct sockaddr *mask, uint8_t prio, struct rtentry *rt)
{
 ...
 if (!an_match(an, dst, plen)) {
  error = 3;
 } else if (srp_get_locked(&(&an->an_pointer.an__rtlist)->sl_head) == rt &&
  srp_get_locked(&(rt)->rt_next.se_next) == ((void *)0)) {
...
an_match(struct art_node *an, struct sockaddr *dst, int plen)
{
 ...
 if (an == ((void *)0) || an->an_plen != plen)
  return (0);

 rt = srp_enter((&sr), &(&an->an_pointer.an__rtlist)->sl_head);
 match = (__builtin_memcmp((rt->rt_dest), (dst), (dst->sa_len)) == 0);
 srp_leave((&sr));
