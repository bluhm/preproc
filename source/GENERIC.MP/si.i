# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/sid.h" 1
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si_blit_shaders.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si_blit_shaders.h"
extern const u32 si_default_state[];

extern const u32 si_default_size;
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c" 2
...
static int si_mc_load_microcode(struct radeon_device *rdev)
{
 ...
 if (running == 0) {
  ...
  for (i = 0; i < ucode_size; i++)
   r100_mm_wreg(rdev, (0x28cc), (((__uint32_t)(*fw_data++))), 0);
...
static int si_init_microcode(struct radeon_device *rdev)
{
 ...
 case CHIP_VERDE:
  ...
  mc_req_size = 7769 * 4;
  break;
 default: do { panic("BUG at %s:%d", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c", 316); } while (0);
 }
 ...
 if (rdev->ce_fw_size != ce_req_size) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "si_cp: Bogus length %zu in firmware \"%s\"\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , rdev->ce_fw_size, fw_name);
 ...
 if (rdev->mc_fw_size != mc_req_size) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "si_mc: Bogus length %zu in firmware \"%s\"\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , rdev->mc_fw_size, fw_name);
...
# 428 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
...
# 1642 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
...
void si_ring_ib_execute(struct radeon_device *rdev, struct radeon_ib *ib)
{
 ...
 if (ib->is_const_ib) {
  ...
  if (ring->rptr_save_reg) {
   ...
   radeon_ring_write(ring, ((u32)(((ring->next_rptr_gpu_addr) >> 16) >> 16)) & 0xffffffff);
   radeon_ring_write(ring, next_rptr);
  }
...
static int si_cp_load_microcode(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < 2144; i++)
  r100_mm_wreg(rdev, (0xC16C), (((__uint32_t)(*fw_data++))), 0);
 r100_mm_wreg(rdev, (0xC168), (0), 0);
...
static int si_cp_resume(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x8020), (((1 << 0) | (1 << 5) | (1 << 14) | (1 << 8) | (1 << 10))), 0);
 ...
 ring->rptr = r100_mm_rreg(rdev, (0x86fc), 0);
 ...
 ring->rptr = r100_mm_rreg(rdev, (0x86f8), 0);
...
_Bool si_gpu_is_lockup(struct radeon_device *rdev, struct radeon_ring *ring)
{
 u32 srbm_status;
 u32 grbm_status, grbm_status2;
 u32 grbm_status_se0, grbm_status_se1;

 srbm_status = r100_mm_rreg(rdev, (0xE50), 0);
 grbm_status = r100_mm_rreg(rdev, (0x8010), 0);
 grbm_status2 = r100_mm_rreg(rdev, (0x8008), 0);
...
static void si_gpu_soft_reset_dma(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x0E60), ((1 << 20) | (1 << 6)), 0);
...
int si_asic_reset(struct radeon_device *rdev)
{
 return si_gpu_soft_reset(rdev, ((1 << 0) |
     (1 << 1) |
     (1 << 2)));
}
...
static int si_pcie_gart_enable(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x2064), ((0xA << 7) | (1 << 0) | (3 << 3) | (1 << 6) | (0 << 5)), 0);
 ...
 r100_mm_wreg(rdev, (0x1400), ((1 << 0) | (1 << 9) | (1 << 10) | (((7) & 7) << 15) | (((1) & 3) << 19)), 0);
 ...
 r100_mm_wreg(rdev, (0x1580), (rdev->vm_manager.max_pfn), 0);
 ...
 for (i = 1; i < 16; i++) {
  if (i < 8)
   r100_mm_wreg(rdev, (0x153c + (i << 2)), (rdev->gart.table_addr >> 12), 0);

  else
   r100_mm_wreg(rdev, (0x1438 + ((i - 8) << 2)), (rdev->gart.table_addr >> 12), 0);
 ...
 r100_mm_wreg(rdev, (0x1414), ((1 << 0) | (((1) & 3) << 1) | (1 << 3) | (1 << 4) | (1 << 6) | (1 << 7) | (1 << 9) | (1 << 10) | (1 << 12) | (1 << 13) | (1 << 15) | (1 << 16) | (1 << 18) | (1 << 19)), 0);
# 2535 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
...
# 2971 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
void si_vm_set_page(struct radeon_device *rdev, uint64_t pe,
      uint64_t addr, unsigned count,
      uint32_t incr, uint32_t flags)
{
 ...
 if (rdev->asic->vm.pt_ring_index == 0) {
  while (count) {
   ndw = 2 + count * 2;
   if (ndw > 0x3FFE)
    ndw = 0x3FFE;

   radeon_ring_write(ring, ((3 << 30) | (((0x37) & 0xFF) << 8) | ((ndw) & 0x3FFF) << 16));
   radeon_ring_write(ring, (((0) << 30) |
       ((1) << 8)));
   radeon_ring_write(ring, pe);
   radeon_ring_write(ring, ((u32)(((pe) >> 16) >> 16)));
   for (; ndw > 2; ndw -= 2, --count, pe += 8) {
    ...
    radeon_ring_write(ring, ((u32)(((value) >> 16) >> 16)));
   }
  }
 } else {
  ...
  if (flags & (1 << 3)) {
   while (count) {
    ...
    radeon_ring_write(ring, ((((0x2) & 0xF) << 28) | (((0) & 0x1) << 26) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((ndw) & 0xFFFFF) << 0)));
    radeon_ring_write(ring, pe);
    radeon_ring_write(ring, ((u32)(((pe) >> 16) >> 16)) & 0xff);
   ...
   while (count) {
    ...
    radeon_ring_write(ring, ((2 << 28) | (1 << 26) | (1 << 21) | (((ndw) & 0xFFFFF) << 0)));
    radeon_ring_write(ring, pe);
    radeon_ring_write(ring, ((u32)(((pe) >> 16) >> 16)) & 0xff);
...
void si_dma_vm_flush(struct radeon_device *rdev, int ridx, struct radeon_vm *vm)
{
 ...
 if (vm->id < 8) {
  radeon_ring_write(ring, (0xf << 16) | ((0x153c + (vm->id << 2)) >> 2));
 } else {
  radeon_ring_write(ring, (0xf << 16) | ((0x1438 + ((vm->id - 8) << 2)) >> 2));
 }
 radeon_ring_write(ring, vm->pd_gpu_addr >> 12);
...
static int si_rlc_resume(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < 2048; i++) {
  ...
  r100_mm_wreg(rdev, (0xC330), (((__uint32_t)(*fw_data++))), 0);
 }
...
static void si_disable_interrupt_state(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0xC1A8), ((1 << 19) | (1 << 20)), 0);
...
# 3716 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
int si_irq_process(struct radeon_device *rdev)
{
 u32 wptr;
 u32 rptr;
...
restart_ih:
 ...
 while (rptr != wptr) {
  ...
  ring_id = __extension__({ __uint32_t __swap32gen_x = (rdev->ih.ring[ring_index + 2]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); }) & 0xff;
...
# 4038 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
int si_copy_dma(struct radeon_device *rdev,
  uint64_t src_offset, uint64_t dst_offset,
  unsigned num_gpu_pages,
  struct radeon_fence **fence)
...
static int si_startup(struct radeon_device *rdev)
{
 ...
 if (r)
  return r;
 si_gpu_init(rdev);
# 4142 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
 r = si_rlc_init(rdev);
 if (r) {
 ...
 r = radeon_ring_init(rdev, ring, ring->ring_size, 1792,
        0xd008 + 0x0,
        0xd00c + 0x0,
        2, 0x3fffc, ((((0xf) & 0xF) << 28) | (((0) & 0x1) << 26) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((0) & 0xFFFFF) << 0)));
 if (r)
  return r;
...
# 4436 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/si.c"
uint64_t si_get_gpu_clock(struct radeon_device *rdev)
{
 uint64_t clock;
