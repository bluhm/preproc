# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c"
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c"
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c" 2
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c"
int
    ...
    bus_space_handle_t *bshp)
{
 ...
 int val;
 u_long result;
 int exflags = 0x0002 | 0x0000 | 0x0010;
 ...
 if (rbt->rb_flags == 0x01 ||
  ...
  if (bus_space_map((rbt)->rb_bt, (result), (size), (flags), (bshp))) {
...
rbus_space_free(rbus_tag_t rbt, bus_space_handle_t bsh, bus_size_t size,
    bus_addr_t *addrp)
{
 int exflags = 0x0002 | 0x0000;
 bus_addr_t addr;
 int status = 1;

 if (rbt->rb_flags == 0x01 ||
     rbt->rb_flags == 0x02) {
  do { *&addr = (rbt)->rb_bt->sparc_bus_addr((rbt)->rb_bt, (rbt)->rb_bt, (bsh)); bus_space_unmap((rbt)->rb_bt, (bsh), (size)); } while (0);
...
# 183 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/cardbus/rbus.c"
rbus_tag_t
    ...
    bus_addr_t start, bus_addr_t end, int flags)
{
 ...
 if ((rb = (rbus_tag_t)malloc(sizeof(struct rbustag), 2,
     0x0002)) == ((void *)0)) {
...
rbus_new_root_delegate(bus_space_tag_t bt, bus_addr_t start, bus_size_t size)
{
 ...
 if ((ex = extent_create("rbus root", start, start + size, 2,
     ((void *)0), 0, 0x0008|0x0000)) == ((void *)0))
  return (((void *)0));
