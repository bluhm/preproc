...
ar9285_swap_rom(struct athn_softc *sc)
{
 ...
 eep->modalHeader.antCtrlChain =
     (__builtin_constant_p(eep->modalHeader.antCtrlChain) ? (__uint32_t)(((__uint32_t)(eep->modalHeader.antCtrlChain) & 0xff) << 24 | ((__uint32_t)(eep->modalHeader.antCtrlChain) & 0xff00) << 8 | ((__uint32_t)(eep->modalHeader.antCtrlChain) & 0xff0000) >> 8 | ((__uint32_t)(eep->modalHeader.antCtrlChain) & 0xff000000) >> 24) : __swap32md(eep->modalHeader.antCtrlChain));
 for (i = 0; i < 5; i++) {
