# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_cksum.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_cksum.c"
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_cksum.c"
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_cksum.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_cksum.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_cksum.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_cksum.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_cksum.c" 2
# 87 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_cksum.c"
int
in6_cksum(struct mbuf *m, u_int8_t nxt, u_int32_t off, u_int32_t len)
{
 ...
 __builtin_bzero((&uph), (sizeof(uph)));
...
skip_phdr:
 ...
 w = (u_int16_t *)(((u_char *)((m)->m_hdr.mh_data)) + off);
 ...
 if ((1 & (long) w) && (mlen > 0)) {
  {l_util.l = sum; sum = l_util.s[0] + l_util.s[1]; (sum > 65535 ? sum -= 65535 : sum);};
  sum <<= 8;
  s_util.c[0] = *(u_char *)w;
 ...
 for (;m && len; m = m->m_hdr.mh_next) {
  if (m->m_hdr.mh_len == 0)
   continue;
  w = ((u_int16_t *)((m)->m_hdr.mh_data));
  if (mlen == -1) {
# 230 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_cksum.c"
   s_util.c[1] = *(char *)w;
   sum += s_util.s;
   w = (u_int16_t *)((char *)w + 1);
