# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.h" 1
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c" 2

int mii_print(void *, const char *);
int mii_submatch(struct device *, void *, void *);
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/mii/mii.c"
void
    ...
    int phyloc, int offloc, int flags)
{
 ...
 if ((mii->mii_flags & 0x0001) == 0) {
  do { ((&mii->mii_phys)->lh_first) = ((void *)0); } while (0);
  mii->mii_flags |= 0x0001;
 }
 ...
 for (ma.mii_phyno = phymin; ma.mii_phyno <= phymax; ma.mii_phyno++) {
  ...
  for (child = ((&mii->mii_phys)->lh_first); child != ((void *)0);
       child = ((child)->mii_list.le_next)) {
  ...
  if (bmsr == 0 || bmsr == 0xffff ||
      (bmsr & ((0x8000|0x4000|0x2000| 0x1000|0x0800|0x0400|0x0200)|0x0100)) == 0) {
  ...
  ma.mii_flags = flags | (mii->mii_flags & (0x0002|0x0004|0x0010));

  if ((child = (struct mii_softc *)config_found_sm(parent, &ma,
      mii_print, mii_submatch)) != ((void *)0)) {



   do { if (((child)->mii_list.le_next = (&mii->mii_phys)->lh_first) != ((void *)0)) (&mii->mii_phys)->lh_first->mii_list.le_prev = &(child)->mii_list.le_next; (&mii->mii_phys)->lh_first = (child); (child)->mii_list.le_prev = &(&mii->mii_phys)->lh_first; } while (0);
...
mii_detach(struct mii_data *mii, int phyloc, int offloc)
{
 ...
 for (child = ((&mii->mii_phys)->lh_first);
      child != ((void *)0); child = nchild) {
  nchild = ((child)->mii_list.le_next);
  if (phyloc != -1 || offloc != -1) {
   if (phyloc != -1 &&
  ...
  do { if ((child)->mii_list.le_next != ((void *)0)) (child)->mii_list.le_next->mii_list.le_prev = (child)->mii_list.le_prev; *(child)->mii_list.le_prev = (child)->mii_list.le_next; ((child)->mii_list.le_prev) = ((void *)-1); ((child)->mii_list.le_next) = ((void *)-1); } while (0);
  (void) config_detach(&child->mii_dev, 0x01);
 }
}
...
mii_mediachg(struct mii_data *mii)
{
 ...
 for (child = ((&mii->mii_phys)->lh_first); child != ((void *)0);
      child = ((child)->mii_list.le_next)) {
  rv = (*(child)->mii_funcs->pf_service)((child), (mii), (2));
  if (rv)
   return (rv);
 }
 return (0);
...
mii_tick(struct mii_data *mii)
{
 ...
 for (child = ((&mii->mii_phys)->lh_first); child != ((void *)0);
      child = ((child)->mii_list.le_next))
  (void) (*(child)->mii_funcs->pf_service)((child), (mii), (1));
}
...
mii_pollstat(struct mii_data *mii)
{
 ...
 for (child = ((&mii->mii_phys)->lh_first); child != ((void *)0);
      child = ((child)->mii_list.le_next))
  (void) (*(child)->mii_funcs->pf_service)((child), (mii), (3));
}
...
mii_down(struct mii_data *mii)
{
 ...
 for (child = ((&mii->mii_phys)->lh_first); child != ((void *)0);
      child = ((child)->mii_list.le_next))
  (void) (*(child)->mii_funcs->pf_service)((child), (mii), (4));
}
