# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c"
...
struct tty;
struct uio;
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmciareg.h" 1
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmciachip.h" 1
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmciachip.h"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmciachip.h" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmciavar.h" 1
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmciavar.h"
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c" 2
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c"
...
struct cfdriver pcmcia_cd = {
 ((void *)0), "pcmcia", DV_DULL
};

struct cfattach pcmcia_ca = {
 sizeof(struct pcmcia_softc), pcmcia_match, pcmcia_attach, ((void *)0),
 pcmcia_activate
};
 ...
 int ccr;
{
 ...
 return (bus_space_read_1(pf->pf_pcmh.memt, pf->pf_pcmh.memh,
 ...
 int val;
{
 ...
 if ((pf->ccr_mask) & (1 << (ccr / 2))) {
  bus_space_write_1(pf->pf_pcmh.memt, pf->pf_pcmh.memh,
...
pcmcia_activate(struct device *self, int act)
{
 ...
 case 6:
 case 4:
  for (pf = ((&sc->card.pf_head)->sqh_first); pf != ((void *)0);
       pf = ((pf)->pf_list.sqe_next)) {
   if (((&pf->cfe_head)->sqh_first) == ((void *)0) ||
       pf->child == ((void *)0))
    continue;
 ...
 struct device *dev;
{
 ...
 ((&sc->card.pf_head)->sqh_first) = ((void *)0);

 ((*(sc->pct)->socket_enable)((sc->pch)));

 pcmcia_read_cis(sc);

 ((*(sc->pct)->socket_disable)((sc->pch)));
 ...
 if (((&sc->card.pf_head)->sqh_first) == ((void *)0)) {
  pf = malloc(sizeof *pf, 2, 0x0002 | 0x0008);
  if (pf == ((void *)0))
 ...
 for (pf = ((&sc->card.pf_head)->sqh_first); pf != ((void *)0);
  ...
  if (pf->child) {
   ...
   if ((pf->pf_flags & (0x0002 | 0x0001)) ==
       0x0001)
    ;
# 250 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c"
  }
 }
 return (attached ? 0 : 1);
}
 ...
 struct device *dev;
{
 ...
 pf = ((&sc->card.pf_head)->sqh_first);
 if (pf == ((void *)0) || (((pf)->pf_list.sqe_next) == ((void *)0) &&
     ((pf->pf_flags & 0x0002) ||
     pf->cfe == ((void *)0) || pf->cfe->iftype == 0)))
  return (0);
 else
  return (1);
}
 ...
 struct pcmcia_function *pf;
{
 ...
 if (pf->sc->sc_enabled_count++ == 0)
  ((*(pf->sc->pct)->socket_enable)((pf->sc->pch)));
 ;
 ...
 for((tmp) = ((&pf->sc->card.pf_head)->sqh_first); (tmp) != ((void *)0); (tmp) = ((tmp)->pf_list.sqe_next)) {
  if ((tmp->pf_flags & 0x0001) &&
      (pf->ccr_base >= (tmp->ccr_base - tmp->pf_ccr_offset)) &&
      ((pf->ccr_base + 0x14) <=
       (tmp->ccr_base - tmp->pf_ccr_offset +
        tmp->pf_pcmh.realsize))) {
   pf->pf_pcmh.memt = tmp->pf_pcmh.memt;
   pf->pf_pcmh.memh = tmp->pf_pcmh.memh;
   pf->pf_pcmh.realsize = tmp->pf_pcmh.realsize;
 ...
 if (tmp == ((void *)0)) {
  if ((((*((pf)->sc->pct)->mem_alloc)(((pf)->sc->pch), ((0x14)), ((&pf->pf_pcmh))))))
   goto bad;

  if ((((*((pf)->sc->pct)->mem_map)(((pf)->sc->pch), ((1)), ((pf->ccr_base)), ((0x14)), ((&pf->pf_pcmh)), ((&pf->pf_ccr_offset)), ((&pf->pf_ccr_window)))))) {


   (((*((pf)->sc->pct)->mem_free)(((pf)->sc->pch), ((&pf->pf_pcmh)))));
   goto bad;
  }
 }

 reg64 = (pf->cfe->number & 0x3F);
 reg64 |= 0x40;
 if ((((&(pf->sc)->card.pf_head)->sqh_first) && ((((&(pf->sc)->card.pf_head)->sqh_first))->pf_list.sqe_next))) {
  reg64 |= 0x01;
  if (pf->ccr_mask & (1 << (0x0A / 2)))
   reg64 |= 0x02;
  if (pf->ih_fct)
   reg64 |= 0x04;
 ...
 if ((pf->cfe->flags & 0x0020) == 0)
  reg64 |= 0x20;
 if (pf->cfe->flags & 0x0800)
  reg64 |= 0x08;
 pcmcia_ccr_write(pf, 0x02, reg64);

 pcmcia_ccr_write(pf, 0x06, 0);

 if ((((&(pf->sc)->card.pf_head)->sqh_first) && ((((&(pf->sc)->card.pf_head)->sqh_first))->pf_list.sqe_next))) {
  pcmcia_ccr_write(pf, 0x0A,
     (pf->pf_mfc_iobase >> 0) & 0xff);
  pcmcia_ccr_write(pf, 0x0C,
     (pf->pf_mfc_iobase >> 8) & 0xff);
  pcmcia_ccr_write(pf, 0x0E,
     (pf->pf_mfc_iobase >> 16) & 0xff);
  pcmcia_ccr_write(pf, 0x10,
     (pf->pf_mfc_iobase >> 24) & 0xff);
  pcmcia_ccr_write(pf, 0x12,
     pf->pf_mfc_iomax - pf->pf_mfc_iobase);
 }
# 535 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c"
 done:
 pf->pf_flags |= 0x0001;
 delay(1000);
 return (0);
 ...
 if (--pf->sc->sc_enabled_count == 0)
  ((*(pf->sc->pct)->socket_disable)((pf->sc->pch)));
 ;
 ...
 struct pcmcia_function *pf;
{
 ...
 for((tmp) = ((&pf->sc->card.pf_head)->sqh_first); (tmp) != ((void *)0); (tmp) = ((tmp)->pf_list.sqe_next)) {
  if ((tmp->pf_flags & 0x0001) &&
      (pf->ccr_base >= (tmp->ccr_base - tmp->pf_ccr_offset)) &&
      ((pf->ccr_base + 0x14) <=
  (tmp->ccr_base - tmp->pf_ccr_offset + tmp->pf_pcmh.realsize)))
   break;
 }


 if (tmp == ((void *)0)) {
  (((*((pf)->sc->pct)->mem_unmap)(((pf)->sc->pch), ((pf->pf_ccr_window)))));
  (((*((pf)->sc->pct)->mem_free)(((pf)->sc->pch), ((&pf->pf_pcmh)))));
 }
 ...
 int *windowp;
{
 ...
 if (((*(pf->sc->pct)->io_map)((pf->sc->pch), (width), (offset), (size), (pcihp), (windowp))))
 ...
 char *xname;
{
 ...
 if ((((&(pf->sc)->card.pf_head)->sqh_first) && ((((&(pf->sc)->card.pf_head)->sqh_first))->pf_list.sqe_next))) {
  ...
  ihcnt = 0;
  for((pf2) = ((&pf->sc->card.pf_head)->sqh_first); (pf2) != ((void *)0); (pf2) = ((pf2)->pf_list.sqe_next)) {
   if (pf2->ih_fct) {
    ;
  ...
  if (ihcnt == 0) {
   ...
   pf->sc->ih = ((*(pf->sc->pct)->intr_establish)((pf->sc->pch), (pf), (ipl), (pcmcia_card_intr), (pf->sc), (xname)));
   ...
   ((*(pf->sc->pct)->intr_disestablish)((pf->sc->pch), (pf->sc->ih)));
  ...
  if (ret != ((void *)0)) {
   ...
   reg64 = pcmcia_ccr_read(pf, 0x02);
   reg64 |= 0x01;
   pcmcia_ccr_write(pf, 0x02, reg64);
  }
 } else
  ret = ((*(pf->sc->pct)->intr_establish)((pf->sc->pch), (pf), (ipl), (ih_fct), (ih_arg), (xname)));
...
# 805 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pcmcia/pcmcia.c"
  if (ihcnt == 0) {
   ...
   pf->sc->ih = ((*(pf->sc->pct)->intr_establish)((pf->sc->pch), (pf), (hiipl), (pcmcia_card_intr), (pf->sc), (((void *)0))));
  ...
  ((*(pf->sc->pct)->intr_disestablish)((pf->sc->pch), (ih)));
}
...
pcmcia_intr_string(pf, ih)
 ...
 void *ih;
{
 return ((*(pf->sc->pct)->intr_string)((pf->sc->pch), (ih)));
}
