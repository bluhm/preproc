# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c" 2
...
void pf_send_tcp(const struct pf_rule *, sa_family_t,
       ...
       u_int8_t, u_int16_t, u_int16_t, u_int8_t, int,
       u_int16_t, u_int);
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c" 2
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c"
struct codel {
 struct mbuf_list q;
...
struct flow {
 ...
 struct { struct flow *sqe_next; } flowentry;
};
struct flowq { struct flow *sqh_first; struct flow **sqh_last; };
    ...
    unsigned int interval, int quantum)
{
 ...
 if (interval > codel_intervals[0]) {
  ...
  cp->target = (((target)>(interval / 5))?(target):(interval / 5));
  ...
  cp->intervals = mallocarray((sizeof((codel_intervals)) / sizeof((codel_intervals)[0])),
      sizeof(codel_intervals[0]), 2, 0x0001 | 0x0008);
  for (i = 0; i < (sizeof((codel_intervals)) / sizeof((codel_intervals)[0])); i++)
   cp->intervals[i] = ((uint64_t)codel_intervals[i] *
       mult) / 1000;
 } else {
  cp->target = (((target)>(codel_target))?(target):(codel_target));
...
codel_freeparams(struct codel_params *cp)
{
 if (cp->intervals != codel_intervals)
  free(cp->intervals, 2, (sizeof((codel_intervals)) / sizeof((codel_intervals)[0])) *
...
{
 m->M_dat.MH.MH_pkthdr.ph_timestamp = now;

 ml_enqueue(&cd->q, m);
 cd->backlog += m->M_dat.MH.MH_pkthdr.len;
}
...
control_law(struct codel *cd, struct codel_params *cp, int64_t rts)
{
 ...
 idx = min(cd->drops, (sizeof((codel_intervals)) / sizeof((codel_intervals)[0])) - 1);
 cd->next = rts + cp->intervals[idx];
}
# 354 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c"
static inline struct mbuf *
 ...
 *drop = 0;
 ...
 m = ((&cd->q)->ml_head);
 if (m == ((void *)0)) {
  ((cd->backlog == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c", 364, "cd->backlog == 0"));

  cd->start = 0;
  return (((void *)0));
 }

 if (now - m->M_dat.MH.MH_pkthdr.ph_timestamp < cp->target ||
    ...
    struct mbuf_list *free_ml, uint64_t *dpkts, uint64_t *dbytes)
{
 ...
 while (!done) {
   ...
   *dpkts += 1;
   *dbytes += m->M_dat.MH.MH_pkthdr.len;

   cd->dropping = 1;
# 449 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c"
 ...
 if (m != ((void *)0))
  cd->delay = now - m->M_dat.MH.MH_pkthdr.ph_timestamp;
...
codel_commit(struct codel *cd, struct mbuf *m)
{
 ...
 n = ml_dequeue(&cd->q);
 if (m)
  ((n == m) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c", 501, "n == m"));
 ((n != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c", 502, "n != NULL"));
 ((cd->backlog >= n->M_dat.MH.MH_pkthdr.len) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c", 503, "cd->backlog >= n->m_pkthdr.len"));
 cd->backlog -= n->M_dat.MH.MH_pkthdr.len;
 return (n);
}
...
classify_flow(struct fqcodel *fqc, struct mbuf *m)
{
 ...
 if (m->M_dat.MH.MH_pkthdr.ph_flowid & 0x8000)
  index = (m->M_dat.MH.MH_pkthdr.ph_flowid & 0x7fff) % fqc->nflows;
 else
...
fqcodel_enq(struct fqcodel *fqc, struct mbuf *m)
{
 ...
 if (!flow->active) {
  do { (flow)->flowentry.sqe_next = ((void *)0); *(&fqc->newq)->sqh_last = (flow); (&fqc->newq)->sqh_last = &(flow)->flowentry.sqe_next; } while (0);
 ...
 if (fqc->qlength >= fqcodel_qlimit) {
  ...
  ((flow != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c", 570, "flow != NULL"));
  m = codel_commit(&flow->cd, ((void *)0));

  fqc->drop_cnt.packets++;
  fqc->drop_cnt.bytes += m->M_dat.MH.MH_pkthdr.len;
...
{
 struct flowq *fq = ((void *)0);

 if (!(((&fqc->newq)->sqh_first) == ((void *)0)))
  fq = &fqc->newq;
 else if (!(((&fqc->oldq)->sqh_first) == ((void *)0)))
  fq = &fqc->oldq;
 return (fq);
}
...
first_flow(struct fqcodel *fqc, struct flowq **fq)
{
 ...
 while ((*fq = select_queue(fqc)) != ((void *)0)) {
  while ((flow = ((*fq)->sqh_first)) != ((void *)0)) {
   if (flow->deficit <= 0) {
    flow->deficit += fqc->quantum;
    do { if (((*fq)->sqh_first = (*fq)->sqh_first->flowentry.sqe_next) == ((void *)0)) (*fq)->sqh_last = &(*fq)->sqh_first; } while (0);
    do { (flow)->flowentry.sqe_next = ((void *)0); *(&fqc->oldq)->sqh_last = (flow); (&fqc->oldq)->sqh_last = &(flow)->flowentry.sqe_next; } while (0);
...
next_flow(struct fqcodel *fqc, struct flow *flow, struct flowq **fq)
{
 ...
 if (*fq == &fqc->newq && !(((&fqc->oldq)->sqh_first) == ((void *)0))) {
    ...
    struct mbuf_list *free_ml)
{
 ...
 if ((fqc->flags & 0x1) == 0)
  fqc->quantum = fqc->ifp->if_data.ifi_mtu + max_linkhdr;
...
fqcodel_pf_alloc(struct ifnet *ifp)
{
 ...
 fqc = malloc(sizeof(struct fqcodel), 2, 0x0001 | 0x0008);

 do { (&fqc->newq)->sqh_first = ((void *)0); (&fqc->newq)->sqh_last = &(&fqc->newq)->sqh_first; } while (0);
 do { (&fqc->oldq)->sqh_first = ((void *)0); (&fqc->oldq)->sqh_last = &(&fqc->oldq)->sqh_first; } while (0);
...
fqcodel_pf_addqueue(void *arg, struct pf_queuespec *qs)
{
 ...
 if (qs->flowqueue.flows == 0 || qs->flowqueue.flows > 0x7fff)
  return (22);
 ...
 if (fqc->quantum > 0)
  ...
  fqc->quantum = ifp->if_data.ifi_mtu + max_linkhdr;
 ...
 fqc->flows = mallocarray(fqc->nflows, sizeof(struct flow),
     2, 0x0001 | 0x0008);
# 775 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/fq_codel.c"
 fqc->ifp = ifp;
...
fqcodel_pf_free(void *arg)
{
 ...
 free(fqc->flows, 2, fqc->nflows * sizeof(struct flow));
 free(fqc, 2, sizeof(struct fqcodel));
}
...
fqcodel_pf_qstats(struct pf_queuespec *qs, void *ubuf, int *nbytes)
{
 ...
 stats.qlength = ((&ifp->if_snd)->ifq_len);
