# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c" 2
# 226 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c"
int
sys_profil(struct proc *p, void *v, register_t *retval)
{
 struct sys_profil_args *uap = v;
 ...
 if (((uap)->scale.be.datum) > (1 << 16))
  return (22);
 if (((uap)->scale.be.datum) == 0) {
  stopprofclock(pr);
  return (0);
 }
 upp = &pr->ps_prof;
 ...
 s = _splraise(14);
 upp->pr_off = ((uap)->offset.be.datum);
 upp->pr_scale = ((uap)->scale.be.datum);
 upp->pr_base = (caddr_t)((uap)->samples.be.datum);
 upp->pr_size = ((uap)->size.be.datum);
 startprofclock(pr);
 _splx(s);

 return (0);
}
# 275 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_prof.c"
void
addupc_intr(struct proc *p, u_long pc)
{
 ...
 prof = &p->p_p->ps_prof;
 if (pc < prof->pr_off || ((int)(((u_quad_t)((pc) - (prof)->pr_off) * (u_quad_t)((prof)->pr_scale)) >> 16) & ~1) >= prof->pr_size)
  return;

 p->p_prof_addr = pc;
 p->p_prof_ticks++;
 atomic_setbits_int(&p->p_flag, 0x00008000);
...
addupc_task(struct proc *p, u_long pc, u_int nticks)
{
 ...
 if ((pr->ps_flags & 0x00000100) == 0 || nticks == 0)
  return;

 prof = &pr->ps_prof;
 if (pc < prof->pr_off ||
     (i = ((int)(((u_quad_t)((pc) - (prof)->pr_off) * (u_quad_t)((prof)->pr_scale)) >> 16) & ~1)) >= prof->pr_size)
  return;
