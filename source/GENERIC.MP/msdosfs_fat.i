# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c" 2
    ...
    uint32_t *bop)
{
 ...
 size = min(pmp->pm_fatblocksec, pmp->pm_FATsecs - bn) * (1 << 9);
...
# 133 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
int
    ...
    int *sp)
{
 ...
 if (bnp == ((void *)0) && cnp == ((void *)0) && sp == ((void *)0))
  return (0);
 ...
 if (cn == 0) {
  if (dep->de_Attributes & 0x10) {
   if (((findcn) << (pmp)->pm_cnshift) >= dep->de_FileSize) {
    if (cnp)
     *cnp = ((pmp->pm_rootdirsize) >> ((pmp)->pm_cnshift - (pmp)->pm_bnshift));
    return (7);
   }
   if (bnp)
    *bnp = pmp->pm_rootdirblk + ((findcn) << ((pmp)->pm_cnshift - (pmp)->pm_bnshift));
   if (cnp)
    *cnp = 0;
   if (sp)
 ...
 for (; i < findcn; i++) {
  ...
  if ((cn | ~pmp->pm_fatmask) >= 0xfffffff6)
   goto hiteof;
  byteoffset = ((cn) * (pmp)->pm_fatmult / (pmp)->pm_fatdiv);
  ...
  if ((pmp->pm_fatmask == 0x0fffffff))
   cn = (((u_int8_t *)(&bp->b_data[bo]))[0] + (((u_int8_t *)(&bp->b_data[bo]))[1] << 8) + (((u_int8_t *)(&bp->b_data[bo]))[2] << 16) + (((u_int8_t *)(&bp->b_data[bo]))[3] << 24));
  else
   cn = (((u_int8_t *)(&bp->b_data[bo]))[0] + (((u_int8_t *)(&bp->b_data[bo]))[1] << 8));
  if ((pmp->pm_fatmask == 0x00000fff) && (prevcn & 1))
   cn >>= 4;
  cn &= pmp->pm_fatmask;
 ...
 if (!((((cn) | ~(pmp)->pm_fatmask) & 0xfffffff8) == 0xfffffff8)) {
  if (bp)
   brelse(bp);
  if (bnp)
   *bnp = ((((cn)-2) << (((pmp))->pm_cnshift - ((pmp))->pm_bnshift)) + (pmp)->pm_firstcluster);
  if (cnp)
   *cnp = cn;
...
hiteof:;
 ...
 (dep)->de_fc[1].fc_frcn = i - 1; (dep)->de_fc[1].fc_fsrcn = prevcn;;
 return (7);
}
...
fc_purge(struct denode *dep, u_int frcn)
{
 ...
 for (i = 0; i < 3; i++, fcp++) {
  if (fcp->fc_frcn >= frcn)
   fcp->fc_frcn = 0xffffffff;
 }
}
# 321 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
void
updatefats(struct msdosfsmount *pmp, struct buf *bp, uint32_t fatbn)
{
 int i;
 struct buf *bpn;
# 334 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
 if (pmp->pm_fsinfo) {
  if (bread(pmp->pm_devvp, pmp->pm_fsinfo, (1024 << ((pmp)->pm_BlkPerSec >> 2)),
      &bpn) != 0) {
   ...
   (((u_int8_t *)(fp->fsinfree))[0] = (pmp->pm_freeclustercount), ((u_int8_t *)(fp->fsinfree))[1] = (pmp->pm_freeclustercount) >> 8, ((u_int8_t *)(fp->fsinfree))[2] = (pmp->pm_freeclustercount) >> 16, ((u_int8_t *)(fp->fsinfree))[3] = (pmp->pm_freeclustercount) >> 24);
   if (pmp->pm_flags & 0x40000000)
    bwrite(bpn);
   else
    bdwrite(bpn);
  }
 ...
 if (pmp->pm_flags & 0x20000000) {
# 364 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
  for (i = 1; i < pmp->pm_bpb.bpbFATs; i++) {
   fatbn += pmp->pm_FATsecs;

   bpn = getblk(pmp->pm_devvp, fatbn, bp->b_bcount, 0, 0);
   __builtin_bcopy((bp->b_data), (bpn->b_data), (bp->b_bcount));
   if (pmp->pm_flags & 0x40000000)
    bwrite(bpn);
   else
    bdwrite(bpn);
...
# 407 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
static __inline void
usemap_alloc(struct msdosfsmount *pmp, uint32_t cn)
{

 pmp->pm_inusemap[cn / (8 * sizeof(u_int))] |= 1 << (cn % (8 * sizeof(u_int)));
...
clusterfree(struct msdosfsmount *pmp, uint32_t cluster, uint32_t *oldcnp)
{
 ...
 error = fatentry((0x0001 | 0x0002), pmp, cluster, &oldcn, 0);
 if (error) {
...
# 464 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
int
    ...
    uint32_t newcontents)
{
 ...
 struct buf *bp;
# 482 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
 if ((function & (0x0002 | 0x0001)) == 0) {
 ...
 if ((function & 0x0001) && oldcontents == ((void *)0)) {
 ...
 if (function & 0x0001) {
  if ((pmp->pm_fatmask == 0x0fffffff))
   readcn = (((u_int8_t *)(&bp->b_data[bo]))[0] + (((u_int8_t *)(&bp->b_data[bo]))[1] << 8) + (((u_int8_t *)(&bp->b_data[bo]))[2] << 16) + (((u_int8_t *)(&bp->b_data[bo]))[3] << 24));
  else
   readcn = (((u_int8_t *)(&bp->b_data[bo]))[0] + (((u_int8_t *)(&bp->b_data[bo]))[1] << 8));
  if ((pmp->pm_fatmask == 0x00000fff) && (cn & 1))
   readcn >>= 4;
  readcn &= pmp->pm_fatmask;

  if ((readcn | ~pmp->pm_fatmask) >= 0xfffffff6)
   readcn |= ~pmp->pm_fatmask;
  *oldcontents = readcn;
 }
 if (function & 0x0002) {
  ...
  case 0x00000fff:
   ...
   (((u_int8_t *)(&bp->b_data[bo]))[0] = (readcn), ((u_int8_t *)(&bp->b_data[bo]))[1] = (readcn) >> 8);
   break;
  case 0x0000ffff:
   (((u_int8_t *)(&bp->b_data[bo]))[0] = (newcontents), ((u_int8_t *)(&bp->b_data[bo]))[1] = (newcontents) >> 8);
   break;
  case 0x0fffffff:
   ...
   readcn = (((u_int8_t *)(&bp->b_data[bo]))[0] + (((u_int8_t *)(&bp->b_data[bo]))[1] << 8) + (((u_int8_t *)(&bp->b_data[bo]))[2] << 16) + (((u_int8_t *)(&bp->b_data[bo]))[3] << 24));
   readcn &= ~0x0fffffff;
   readcn |= newcontents & 0x0fffffff;
   (((u_int8_t *)(&bp->b_data[bo]))[0] = (readcn), ((u_int8_t *)(&bp->b_data[bo]))[1] = (readcn) >> 8, ((u_int8_t *)(&bp->b_data[bo]))[2] = (readcn) >> 16, ((u_int8_t *)(&bp->b_data[bo]))[3] = (readcn) >> 24);
   break;
  }
...
# 567 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
static int
fatchain(struct msdosfsmount *pmp, uint32_t start, uint32_t count, uint32_t fillwith)
{
 ...
 struct buf *bp;
# 581 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
 if (start < 2 || start + count - 1 > pmp->pm_maxcluster)
  return (22);

 while (count > 0) {
  byteoffset = ((start) * (pmp)->pm_fatmult / (pmp)->pm_fatdiv);
  fatblock(pmp, byteoffset, &bn, &bsize, &bo);
  error = bread(pmp->pm_devvp, bn, bsize, &bp);
  if (error) {
   brelse(bp);
  ...
  while (count > 0) {
   ...
   case 0x00000fff:
    ...
    break;
   case 0x0000ffff:
    (((u_int8_t *)(&bp->b_data[bo]))[0] = (newc), ((u_int8_t *)(&bp->b_data[bo]))[1] = (newc) >> 8);
    bo += 2;
    break;
   case 0x0fffffff:
    readcn = (((u_int8_t *)(&bp->b_data[bo]))[0] + (((u_int8_t *)(&bp->b_data[bo]))[1] << 8) + (((u_int8_t *)(&bp->b_data[bo]))[2] << 16) + (((u_int8_t *)(&bp->b_data[bo]))[3] << 24));
...
# 638 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
int
chainlength(struct msdosfsmount *pmp, uint32_t start, uint32_t count)
{
 ...
 max_idx = pmp->pm_maxcluster / (8 * sizeof(u_int));
 idx = start / (8 * sizeof(u_int));
 start %= (8 * sizeof(u_int));
...
# 680 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
int
...
# 713 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
int
    ...
    uint32_t fillwith, uint32_t *retcluster, uint32_t *got)
{
 ...
 for (cn = newst; cn <= pmp->pm_maxcluster;) {
  idx = cn / (8 * sizeof(u_int));
  map = pmp->pm_inusemap[idx];
  map |= (1 << (cn % (8 * sizeof(u_int)))) - 1;
  if (map != (u_int)-1) {
   cn = idx * (8 * sizeof(u_int)) + ffs(map^(u_int)-1) - 1;
  ...
  cn += (8 * sizeof(u_int)) - cn % (8 * sizeof(u_int));
 }
 for (cn = 0; cn < newst;) {
  idx = cn / (8 * sizeof(u_int));
  map = pmp->pm_inusemap[idx];
...
# 799 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
int
freeclusterchain(struct msdosfsmount *pmp, uint32_t cluster)
{
 ...
 while (cluster >= 2 && cluster <= pmp->pm_maxcluster) {
  byteoffset = ((cluster) * (pmp)->pm_fatmult / (pmp)->pm_fatdiv);
  fatblock(pmp, byteoffset, &bn, &bsize, &bo);
  if (lbn != bn) {
   if (bp)
  ...
  case 0x00000fff:
   ...
   break;
  case 0x0000ffff:
   cluster = (((u_int8_t *)(&bp->b_data[bo]))[0] + (((u_int8_t *)(&bp->b_data[bo]))[1] << 8));
   (((u_int8_t *)(&bp->b_data[bo]))[0] = (0), ((u_int8_t *)(&bp->b_data[bo]))[1] = (0) >> 8);
   break;
  case 0x0fffffff:
   cluster = (((u_int8_t *)(&bp->b_data[bo]))[0] + (((u_int8_t *)(&bp->b_data[bo]))[1] << 8) + (((u_int8_t *)(&bp->b_data[bo]))[2] << 16) + (((u_int8_t *)(&bp->b_data[bo]))[3] << 24));
   (((u_int8_t *)(&bp->b_data[bo]))[0] = ((0 & 0x0fffffff) | (cluster & ~0x0fffffff)), ((u_int8_t *)(&bp->b_data[bo]))[1] = ((0 & 0x0fffffff) | (cluster & ~0x0fffffff)) >> 8, ((u_int8_t *)(&bp->b_data[bo]))[2] = ((0 & 0x0fffffff) | (cluster & ~0x0fffffff)) >> 16, ((u_int8_t *)(&bp->b_data[bo]))[3] = ((0 & 0x0fffffff) | (cluster & ~0x0fffffff)) >> 24);

   break;
  }
  cluster &= pmp->pm_fatmask;
  if ((cluster | ~pmp->pm_fatmask) >= 0xfffffff6)
   cluster |= pmp->pm_fatmask;
 }
 if (bp)
  updatefats(pmp, bp, bn);
...
fillinusemap(struct msdosfsmount *pmp)
{
 ...
 for (cn = 0; cn < (((pmp->pm_maxcluster + 1) + (((8 * sizeof(u_int))) - 1)) / ((8 * sizeof(u_int)))); cn++)
 ...
 for (cn = 2; cn <= pmp->pm_maxcluster; cn++) {
  byteoffset = ((cn) * (pmp)->pm_fatmult / (pmp)->pm_fatdiv);
...
# 923 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
int
    ...
    int flags)
{
 ...
 (dep)->de_fc[2].fc_frcn = dep->de_fc[1].fc_frcn; (dep)->de_fc[2].fc_fsrcn = dep->de_fc[1].fc_fsrcn;;


 while (count > 0) {
# 973 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_fat.c"
  if (dep->de_StartCluster == 0)
   cn = 0;
  else
  ...
  if (dep->de_StartCluster == 0) {
   ...
   error = fatentry(0x0002, pmp,
      dep->de_fc[1].fc_fsrcn,
      0, cn);
   if (error) {
    clusterfree(pmp, cn, ((void *)0));
    return (error);
   }
   frcn = dep->de_fc[1].fc_frcn + 1;
  }
  ...
  (dep)->de_fc[1].fc_frcn = frcn + got - 1; (dep)->de_fc[1].fc_fsrcn = cn + got - 1;;
