# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/pf.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
uint64_t SipHash(const SIPHASH_KEY *, int, int, const void *, size_t)
      __attribute__ ((__bounded__ (__buffer__, 4, 5) ));
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c" 2
...
bridgectl_ioctl(struct ifnet *ifp, u_long cmd, caddr_t data)
{
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ifbrparam) & 0x1fff) << 16) | ((('i')) << 8) | ((65))):
  bparam->ifbrp_ifbrpu.ifbrpu_csize = sc->sc_brtmax;
  break;
 case ((unsigned long)0x80000000 | ((sizeof(struct ifbrparam) & 0x1fff) << 16) | ((('i')) << 8) | ((64))):
  sc->sc_brtmax = bparam->ifbrp_ifbrpu.ifbrpu_csize;
  break;
 case ((unsigned long)0x80000000 | ((sizeof(struct ifbrparam) & 0x1fff) << 16) | ((('i')) << 8) | ((69))):
  ...
  sc->sc_brttimeout = bparam->ifbrp_ifbrpu.ifbrpu_ctime;
  if (bparam->ifbrp_ifbrpu.ifbrpu_ctime != 0)
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ifbrparam) & 0x1fff) << 16) | ((('i')) << 8) | ((70))):
  bparam->ifbrp_ifbrpu.ifbrpu_ctime = sc->sc_brttimeout;
  break;
 case ((unsigned long)0x80000000 | ((sizeof(struct ifbrlreq) & 0x1fff) << 16) | ((('i')) << 8) | ((77))):
  ...
  if ((brlreq->ifbr_action != 0x01 &&
      brlreq->ifbr_action != 0x02) ||
      (brlreq->ifbr_flags & (0x08|0x04)) == 0) {
   error = 22;
   break;
  }
  if (brlreq->ifbr_flags & 0x08) {
   error = bridge_addrule(p, brlreq, 0);
   if (error)
    break;
  }
  if (brlreq->ifbr_flags & 0x04) {
    ...
    struct ifnet *ifp, int setflags, u_int8_t flags, struct mbuf *m)
{
 ...
 struct bridge_tunneltag *brtag = ((void *)0);
 u_int32_t h;
 int dir;
 ...
 h = bridge_hash(sc, ea);
 p = ((&sc->sc_rts[h])->lh_first);
 if (p == ((void *)0)) {
  if (sc->sc_brtcnt >= sc->sc_brtmax)
   goto done;
  p = malloc(sizeof(*p), 2, 0x0002);
  if (p == ((void *)0))
   goto done;

  __builtin_bcopy((ea), (&p->brt_addr), (sizeof(p->brt_addr)));
  p->brt_if = ifp;
  p->brt_age = 1;
  ...
  do { if (((p)->brt_next.le_next = (&sc->sc_rts[h])->lh_first) != ((void *)0)) (&sc->sc_rts[h])->lh_first->brt_next.le_prev = &(p)->brt_next.le_next; (&sc->sc_rts[h])->lh_first = (p); (p)->brt_next.le_prev = &(&sc->sc_rts[h])->lh_first; } while (0);
  sc->sc_brtcnt++;
  goto want;
 }
 ...
 do {
  q = p;
  p = ((p)->brt_next.le_next);

  dir = __builtin_memcmp((ea), (&q->brt_addr), (sizeof(q->brt_addr)));
  if (dir == 0) {
   if (setflags) {
    q->brt_if = ifp;
    q->brt_flags = flags;
   } else if (!(q->brt_flags & 0x01))
    q->brt_if = ifp;
  ...
  if (dir > 0) {
   ...
   do { (p)->brt_next.le_prev = (q)->brt_next.le_prev; (p)->brt_next.le_next = (q); *(q)->brt_next.le_prev = (p); (q)->brt_next.le_prev = &(p)->brt_next.le_next; } while (0);
   sc->sc_brtcnt++;
   goto want;
  }
  ...
  if (p == ((void *)0)) {
   ...
   if (setflags)
    ...
    p->brt_flags = 0x00;
   do { if (((p)->brt_next.le_next = (q)->brt_next.le_next) != ((void *)0)) (q)->brt_next.le_next->brt_next.le_prev = &(p)->brt_next.le_next; (q)->brt_next.le_next = (p); (p)->brt_next.le_prev = &(q)->brt_next.le_next; } while (0);
   sc->sc_brtcnt++;
   goto want;
  }
 } while (p != ((void *)0));
...
bridge_rtlookup(struct bridge_softc *sc, struct ether_addr *ea)
{
 ...
 for((p) = ((&sc->sc_rts[h])->lh_first); (p)!= ((void *)0); (p) = ((p)->brt_next.le_next)) {
  dir = __builtin_memcmp((ea), (&p->brt_addr), (sizeof(p->brt_addr)));
  if (dir == 0)
   return (p);
  if (dir > 0)
   goto fail;
...
{
 return SipHash(((SIPHASH_KEY *)sc->sc_hashkey), 2, 4, (addr), (6)) &
     (1024 - 1);
}
...
bridge_rtage(void *vsc)
{
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bridgectl.c", 316, "_kernel_lock_held()"));

 for (i = 0; i < 1024; i++) {
  n = ((&sc->sc_rts[i])->lh_first);
  while (n != ((void *)0)) {
   if ((n->brt_flags & 0x03) == 0x01) {
    n->brt_age = !n->brt_age;
    if (n->brt_age)
     n->brt_age = 0;
    n = ((n)->brt_next.le_next);
   } else if (n->brt_age) {
    n->brt_age = 0;
    n = ((n)->brt_next.le_next);
   } else {
    p = ((n)->brt_next.le_next);
    do { if ((n)->brt_next.le_next != ((void *)0)) (n)->brt_next.le_next->brt_next.le_prev = (n)->brt_next.le_prev; *(n)->brt_next.le_prev = (n)->brt_next.le_next; ((n)->brt_next.le_prev) = ((void *)-1); ((n)->brt_next.le_next) = ((void *)-1); } while (0);
    sc->sc_brtcnt--;
    free(n, 2, sizeof *n);
    n = p;
   }
...
bridge_rtagenode(struct ifnet *ifp, int age)
{
 ...
 if (age == 0)
  ...
  for (i = 0; i < 1024; i++) {
   for((n) = ((&sc->sc_rts[i])->lh_first); (n)!= ((void *)0); (n) = ((n)->brt_next.le_next)) {

    if (n->brt_if == ifp &&
        n->brt_age > time_uptime + age &&
        (n->brt_flags & 0x03) == 0x00)
     n->brt_age = time_uptime + age;
   }
  }
 }
  ...
  for((n) = ((&sc->sc_rts[i])->lh_first); (n)!= ((void *)0); (n) = ((n)->brt_next.le_next)) {
   if (!onlycnt) {
    if (baconf->ifbac_len < sizeof(struct ifbareq))
     goto done;
    __builtin_bcopy((sc->sc_if.if_xname), (bareq.ifba_name), (sizeof(bareq.ifba_name)));

    __builtin_bcopy((n->brt_if->if_xname), (bareq.ifba_ifsname), (sizeof(bareq.ifba_ifsname)));

    __builtin_bcopy((&n->brt_addr), (&bareq.ifba_dst), (sizeof(bareq.ifba_dst)));
    ...
    error = copyout((caddr_t)&bareq,
        (caddr_t)(baconf->ifbac_ifbacu.ifbacu_req + cnt), sizeof(bareq));
    if (error)
     goto done;
...
bridge_update(struct ifnet *ifp, struct ether_addr *ea, int delete)
{
 ...
 if ((bif->bif_flags & 0x0001) &&
  ...
  if (!delete) {
   ...
   bridge_rtupdate(sc, ea, ifp, 0, 0x00, ((void *)0));
  }
 }
}
...
bridge_brlconf(struct bridge_softc *sc, struct ifbrlconf *bc)
{
 ...
 if (ifl == ((void *)0) || ifl->bridge_sc != sc)
  return (3);

 for((n) = ((&ifl->bif_brlin)->sqh_first); (n) != ((void *)0); (n) = ((n)->brl_next.sqe_next)) {
  total++;
 }
 for((n) = ((&ifl->bif_brlout)->sqh_first); (n) != ((void *)0); (n) = ((n)->brl_next.sqe_next)) {
  total++;
 }
 ...
 for((n) = ((&ifl->bif_brlin)->sqh_first); (n) != ((void *)0); (n) = ((n)->brl_next.sqe_next)) {
  ...
  if (bc->ifbrl_len < sizeof(req))
   goto done;
  strlcpy(req.ifbr_name, sc->sc_if.if_xname, 16);
  strlcpy(req.ifbr_ifsname, ifl->ifp->if_xname, 16);
  ...
  error = copyout((caddr_t)&req,
      (caddr_t)(bc->ifbrl_ifbrlu.ifbrlu_buf + (i * sizeof(req))), sizeof(req));
  if (error)
   goto done;
  i++;
...
bridge_addrule(struct bridge_iflist *bif, struct ifbrlreq *req, int out)
{
 ...
 n = malloc(sizeof(*n), 2, 0x0002);
 if (n == ((void *)0))
  return (12);
 __builtin_bcopy((&req->ifbr_src), (&n->brl_src), (sizeof(struct ether_addr)));
 ...
 if (out) {
  n->brl_flags &= ~0x08;
  n->brl_flags |= 0x04;
  do { (n)->brl_next.sqe_next = ((void *)0); *(&bif->bif_brlout)->sqh_last = (n); (&bif->bif_brlout)->sqh_last = &(n)->brl_next.sqe_next; } while (0);
 } else {
  n->brl_flags &= ~0x04;
  n->brl_flags |= 0x08;
  do { (n)->brl_next.sqe_next = ((void *)0); *(&bif->bif_brlin)->sqh_last = (n); (&bif->bif_brlin)->sqh_last = &(n)->brl_next.sqe_next; } while (0);
 }
 return (0);
}
...
bridge_flushrule(struct bridge_iflist *bif)
{
 ...
 while (!(((&bif->bif_brlin)->sqh_first) == ((void *)0))) {
  p = ((&bif->bif_brlin)->sqh_first);
  do { if (((&bif->bif_brlin)->sqh_first = (&bif->bif_brlin)->sqh_first->brl_next.sqe_next) == ((void *)0)) (&bif->bif_brlin)->sqh_last = &(&bif->bif_brlin)->sqh_first; } while (0);

  pf_tag_unref(p->brl_tag);

  free(p, 2, sizeof *p);
 }
 while (!(((&bif->bif_brlout)->sqh_first) == ((void *)0))) {
  p = ((&bif->bif_brlout)->sqh_first);
  do { if (((&bif->bif_brlout)->sqh_first = (&bif->bif_brlout)->sqh_first->brl_next.sqe_next) == ((void *)0)) (&bif->bif_brlout)->sqh_last = &(&bif->bif_brlout)->sqh_first; } while (0);
