...
carp_hmac_prepare(struct carp_softc *sc)
{
 ...
 u_int8_t i;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 275, "_kernel_lock_held()"));
...
carp_proto_input_if(struct ifnet *ifp, struct mbuf **mp, int *offp, int proto)
{
 ...
 case 0xf7:
  break;
 case 0x06:
  if (ismulti || !(srp_get_locked(&(&ifp->if_carp_ptr.carp_s)->sl_head) == ((void *)0)))
   break;
 default:
 ...
 m->m_hdr.mh_data -= iplen;
 _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 511);
...
carp6_proto_input_if(struct ifnet *ifp, struct mbuf **mp, int *offp, int proto)
{
 ...
 m->m_hdr.mh_data -= *offp;
 _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 588);
    ...
    int ismulti, sa_family_t af)
{
 ...
 struct srpl *cif;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 604, "_kernel_lock_held()"));
 if (ifp->if_data.ifi_type == 0xf7) {
  if (ifp->if_carp_ptr.carp_d == ((void *)0)) {
   m_freem(m);
   return;
  }
  cif = &ifp->if_carp_ptr.carp_d->if_carp_ptr.carp_s;
 } else
  cif = &ifp->if_carp_ptr.carp_s;
 for ((sc) = srp_get_locked(&(cif)->sl_head); (sc) != ((void *)0); (sc) = srp_get_locked(&((sc))->sc_list.se_next)) {
  if (af == 2 &&
...
carp_new_vhost(struct carp_softc *sc, int vhid, int advskew)
{
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 865, "_kernel_lock_held()"));
...
{
 struct carp_vhost_entry *vhe;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 912, "_kernel_lock_held()"));
 for ((vhe) = srp_get_locked(&(&sc->carp_vhosts)->sl_head); (vhe) != ((void *)0); (vhe) = srp_get_locked(&((vhe))->vhost_entries.se_next)) {
  timeout_del(&vhe->ad_tmo);
...
carpdetach(void *arg)
{
 ...
 if (ifp0 == ((void *)0))
  return;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 943, "_kernel_lock_held()"));
 cif = &ifp0->if_carp_ptr.carp_s;
 if_ih_remove(ifp0, carp_input, ((void *)0));
 do { struct srp *ref; struct carp_softc *c, *n; ref = &(cif)->sl_head; while ((c = srp_get_locked(ref)) != (sc)) ref = &c->sc_list.se_next; n = srp_get_locked(&(c)->sc_list.se_next); if (n != ((void *)0)) (&carp_sc_rc)->srpl_ref(&(&carp_sc_rc)->srpl_gc.srp_gc_cookie, n); srp_update_locked(&(&carp_sc_rc)->srpl_gc, ref, n); srp_update_locked(&(&carp_sc_rc)->srpl_gc, &c->sc_list.se_next, ((void *)0)); } while (0);
 if ((srp_get_locked(&(cif)->sl_head) == ((void *)0)))
  ifpromisc(ifp0, 0);
...
carp_send_ad_all(void)
{
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1001, "_kernel_lock_held()"));
...
{
 struct carp_vhost_entry *vhe;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1026, "_kernel_lock_held()"));
 for ((vhe) = srp_get_locked(&(&sc->carp_vhosts)->sl_head); (vhe) != ((void *)0); (vhe) = srp_get_locked(&((vhe))->vhost_entries.se_next)) {
  if (vhe->state == MASTER)
   carp_send_ad(vhe);
 }
...
carp_send_ad(struct carp_vhost_entry *vhe)
{
 ...
 if (sc->sc_naddrs) {
  ...
  ((ifa != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1120, "ifa != NULL"));
 ...
 if (sc->sc_naddrs6) {
  ...
  if (ifa == ((void *)0))
   ifa = ifaof_ifpforaddr(&sa, &sc->sc_ac.ac_if);
  ((ifa != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1206, "ifa != NULL"));
...
carp_update_lsmask(struct carp_softc *sc)
{
 ...
 sc->sc_lsmask = 0;
 count = 0;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1318, "_kernel_lock_held()"));
 for ((vhe) = srp_get_locked(&(&sc->carp_vhosts)->sl_head); (vhe) != ((void *)0); (vhe) = srp_get_locked(&((vhe))->vhost_entries.se_next)) {
...
{
 struct srpl *cif = &ifp->if_carp_ptr.carp_s;
 struct carp_softc *vh;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1350, "_kernel_lock_held()"));
 if ((srp_get_locked(&(cif)->sl_head) == ((void *)0)))
  return (0);
 ((ifp->if_data.ifi_type == 0x06) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1355, "ifp->if_type == IFT_ETHER"));
 for ((vh) = srp_get_locked(&(cif)->sl_head); (vh) != ((void *)0); (vh) = srp_get_locked(&((vh))->sc_list.se_next)) {
  struct carp_vhost_entry *vhe;
  if ((vh->sc_ac.ac_if.if_flags & (0x1|0x40)) !=
      (0x1|0x40))
...
carp_input(struct ifnet *ifp0, struct mbuf *m, void *cookie)
{
 ...
 cif = &ifp0->if_carp_ptr.carp_s;
 for ((sc) = srp_enter((&sr), &(cif)->sl_head); (sc) != ((void *)0); (sc) = srp_follow((&sr), &(sc)->sc_list.se_next)) {
   ...
   int drop)
{
 ...
 ((ifp != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1481, "ifp != NULL"));
 sc = ifp->if_softc;
 if (sc->sc_balancing == 0)
  goto done;
...
{
 struct carp_vhost_entry *vhe;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1574, "_kernel_lock_held()"));
 for ((vhe) = srp_get_locked(&(&sc->carp_vhosts)->sl_head); (vhe) != ((void *)0); (vhe) = srp_get_locked(&((vhe))->vhost_entries.se_next)) {
  carp_setrun(vhe, af);
 }
}
...
carp_set_ifp(struct carp_softc *sc, struct ifnet *ifp0)
{
 ...
 ((ifp0 != sc->sc_ac.ac_if.if_carp_ptr.carp_d) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1695, "ifp0 != sc->sc_carpdev"));
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1696, "_kernel_lock_held()"));
 ...
 if ((srp_get_locked(&(cif)->sl_head) == ((void *)0))) {
  if ((error = ifpromisc(ifp0, 1)))
   goto rm_lh;
 } else if (carp_check_dup_vhids(sc, cif, ((void *)0))) {
  error = 22;
  goto rm_lh;
 }
 if (sc->sc_ac.ac_if.if_carp_ptr.carp_d != ((void *)0))
 ...
 for ((vr) = srp_get_locked(&(cif)->sl_head); (vr) != ((void *)0); (vr) = srp_get_locked(&((vr))->sc_list.se_next)) {
 ...
 if (!myself) {
  if (last == ((void *)0)) {
   do { void *head; srp_init(&(sc)->sc_list.se_next); head = srp_get_locked(&(cif)->sl_head); if (head != ((void *)0)) { (&carp_sc_rc)->srpl_ref(&(&carp_sc_rc)->srpl_gc.srp_gc_cookie, head); srp_update_locked(&(&carp_sc_rc)->srpl_gc, &(sc)->sc_list.se_next, head); } (&carp_sc_rc)->srpl_ref(&(&carp_sc_rc)->srpl_gc.srp_gc_cookie, sc); srp_update_locked(&(&carp_sc_rc)->srpl_gc, &(cif)->sl_head, (sc)); } while (0);
 ...
 if (sc->sc_naddrs || sc->sc_naddrs6)
  sc->sc_ac.ac_if.if_flags |= 0x1;
 carp_set_enaddr(sc);
 if_ih_insert(ifp0, carp_input, ((void *)0));
 carp_carpdev_state(ifp0);
 return (0);
rm_lh:
 hook_disestablish(ifp0->if_linkstatehooks, sc->lh_cookie);
...
{
 struct carp_vhost_entry *vhe;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1804, "_kernel_lock_held()"));
 for ((vhe) = srp_get_locked(&(&sc->carp_vhosts)->sl_head); (vhe) != ((void *)0); (vhe) = srp_get_locked(&((vhe))->vhost_entries.se_next))
...
carp_set_addr(struct carp_softc *sc, struct sockaddr_in *sin)
{
 ...
 int error;
 ((sc->sc_ac.ac_if.if_carp_ptr.carp_d != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1894, "sc->sc_carpdev != NULL"));
...
{
 int error;
 ((sc->sc_ac.ac_if.if_carp_ptr.carp_d != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 1939, "sc->sc_carpdev != NULL"));
...
carp_ioctl(struct ifnet *ifp, u_long cmd, caddr_t addr)
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((16))):
  ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 2036, "_kernel_lock_held()"));
  vhe = srp_get_locked(&(&sc->carp_vhosts)->sl_head);
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((245))):
  ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 2057, "_kernel_lock_held()"));
  vhe = srp_get_locked(&(&sc->carp_vhosts)->sl_head);
  if ((error = suser(p)) != 0)
   break;
  ...
  if (vhe->state != INIT && carpr.carpr_state != vhe->state) {
   ...
   case BACKUP:
    ...
    break;
   case MASTER:
    ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 2083, "_kernel_lock_held()"));
    for ((vhe) = srp_get_locked(&(&sc->carp_vhosts)->sl_head); (vhe) != ((void *)0); (vhe) = srp_get_locked(&((vhe))->vhost_entries.se_next))
     carp_master_down(vhe);
    break;
   default:
  ...
  if (__builtin_memcmp((sc->sc_advskews), (carpr.carpr_advskews), (sizeof(sc->sc_advskews)))) {
   i = 0;
   ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 2106, "_kernel_lock_held()"));
   for ((vhe) = srp_get_locked(&(&sc->carp_vhosts)->sl_head); (vhe) != ((void *)0); (vhe) = srp_get_locked(&((vhe))->vhost_entries.se_next))
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((246))):
  ...
  i = 0;
  ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 2137, "_kernel_lock_held()"));
  for ((vhe) = srp_get_locked(&(&sc->carp_vhosts)->sl_head); (vhe) != ((void *)0); (vhe) = srp_get_locked(&((vhe))->vhost_entries.se_next)) {
    ...
    struct carpreq *carpr)
{
 ...
 struct carp_vhost_entry *vhe, *vhe0;
 int i;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 2185, "_kernel_lock_held()"));
 for ((vr) = srp_get_locked(&(cif)->sl_head); (vr) != ((void *)0); (vr) = srp_get_locked(&((vr))->sc_list.se_next)) {
  if (vr == sc)
   continue;
...
carp_vhids_ioctl(struct carp_softc *sc, struct carpreq *carpr)
{
 ...
 for (i = 0; carpr->carpr_vhids[i]; i++) {
  ...
  if (sc->sc_ac.ac_if.if_carp_ptr.carp_d) {
   struct srpl *cif;
   cif = &sc->sc_ac.ac_if.if_carp_ptr.carp_d->if_carp_ptr.carp_s;
...
{
 struct carp_vhost_entry *vhe;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 2380, "_kernel_lock_held()"));
 for ((vhe) = srp_get_locked(&(&sc->carp_vhosts)->sl_head); (vhe) != ((void *)0); (vhe) = srp_get_locked(&((vhe))->vhost_entries.se_next)) {
  if (vhe->state == state)
   continue;
...
carp_set_state(struct carp_vhost_entry *vhe, int state)
{
 ...
 ((vhe->state != state) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 2398, "vhe->state != state"));
 ...
 vhe->state = state;
 carp_update_lsmask(sc);
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 2417, "_kernel_lock_held()"));
...
carp_carpdev_state(void *v)
{
 ...
 if (ifp0->if_data.ifi_type != 0x06)
  return;
 cif = &ifp0->if_carp_ptr.carp_s;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_carp.c", 2499, "_kernel_lock_held()"));
 for ((sc) = srp_get_locked(&(cif)->sl_head); (sc) != ((void *)0); (sc) = srp_get_locked(&((sc))->sc_list.se_next)) {
