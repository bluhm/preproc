# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c"
...
struct tty;
struct uio;
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c" 2
...
void device_register(struct device *, void *);
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c" 2
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c"
struct ppm_softc {
 struct device sc_dv;
...
# 113 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ppm.c"
 if (bus_space_map(sc->sc_iot, ((((paddr_t)((&ea->ea_regs[2])->hi)) << 32UL) | ((paddr_t)(&ea->ea_regs[2])->lo)), ea->ea_regs[2].size, 0, &sc->sc_gpiobankh)) {
 ...
 if (bus_space_map(sc->sc_iot, ((((paddr_t)((&ea->ea_regs[3])->hi)) << 32UL) | ((paddr_t)(&ea->ea_regs[3])->lo)), ea->ea_regs[3].size, 0, &sc->sc_gpioh)) {
 ...
 bus_space_write_1(sc->sc_iot, sc->sc_gpiobankh,
     0x0, 0x22);
 bus_space_read_1(sc->sc_iot, sc->sc_gpiobankh, 0x0);
 reg64 = bus_space_read_1(sc->sc_iot, sc->sc_gpiobankh, 0x1);
 reg64 &= 0x7f;
 bus_space_write_1(sc->sc_iot, sc->sc_gpiobankh,0x0, reg64);
 bus_space_read_1(sc->sc_iot, sc->sc_gpiobankh, 0x0);
...
ppm_led_blink(void *vsc, int on)
{
 ...
 r = bus_space_read_1(sc->sc_iot, sc->sc_gpioh, 0x0);
 if (on)
  r |= 0x2;
 else
  r &= ~0x2;
 bus_space_write_1(sc->sc_iot, sc->sc_gpioh, 0x0, r);
 bus_space_read_1(sc->sc_iot, sc->sc_gpioh, 0x0);
}
