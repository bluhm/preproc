# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/ucom.h" 1
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c" 2
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c"
struct ucom_softc {
 struct device sc_dev;

 struct usbd_device *sc_uparent;
 struct uhidev_softc *sc_uhidev;
...
ucom_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 _rw_init_flags(&sc->sc_lock, "ucomlk", 0, ((void *)0));
}
...
ucom_detach(struct device *self, int flags)
{
 ...
 if (sc->sc_bulkin_pipe != ((void *)0)) {
  usbd_abort_pipe(sc->sc_bulkin_pipe);
  usbd_close_pipe(sc->sc_bulkin_pipe);
  sc->sc_bulkin_pipe = ((void *)0);
 }
 if (sc->sc_bulkout_pipe != ((void *)0)) {
  usbd_abort_pipe(sc->sc_bulkout_pipe);
  usbd_close_pipe(sc->sc_bulkout_pipe);
  sc->sc_bulkout_pipe = ((void *)0);
 }
 ...
 if (--sc->sc_refcnt >= 0) {
  ...
  if (tp != ((void *)0)) {
   ((tp->t_state) &= ~(0x00008));
   ((tp->t_termios.c_cflag) &= ~(0x00008000 | 0x00100000));
 ...
 vdevgone(maj, mn | 0x80, mn | 0x80, VCHR);


 if (tp != ((void *)0)) {
  (*(linesw[(tp)->t_line].l_close))(tp, 0x0004, (__curcpu->ci_self)->ci_curproc);
  s = _splraise(6);
...
ucomopen(dev_t dev, int flag, int mode, struct proc *p)
{
 ...
 if (((sc->sc_dev.dv_flags) & (0x0001)) == 0)
  return (6);
...
{
 struct ucom_softc *sc = ucom_cd.cd_devs[(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x7f)];
 usbd_status err;
 struct tty *tp;
 struct termios t;
 int error, s;
 ...
 if (sc->sc_open == 0) {
  ...
  if (sc->sc_methods->ucom_open != ((void *)0)) {
 ...
 if (!((tp->t_state) & (0x00020))) {
  ...
  s = _splraise(6);
  ttsetwater(tp);
# 462 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c"
  ucom_dtr(sc, 1);
 ...
 if ((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x80)) {
  ...
  if (((flag) & (0x0004))) {
   ...
   while (sc->sc_cua || (!((tp->t_termios.c_cflag) & (0x00008000)) &&
       !((tp->t_state) & (0x00008)))) {
    ((tp->t_state) |= (0x00200));
...
ucomclose(dev_t dev, int flag, int mode, struct proc *p)
{
 ...
 if (sc == ((void *)0) || usbd_is_dying(sc->sc_uparent))
  return (5);
...
ucom_do_close(struct ucom_softc *sc, int flag, int mode, struct proc *p)
{
 ...
 if (sc->sc_methods->ucom_close != ((void *)0))
       ...
       int flag, struct proc *p)
{
 ...
 if (sc->sc_methods->ucom_ioctl != ((void *)0)) {
...
tiocm_to_ucom(struct ucom_softc *sc, u_long how, int ttybits)
{
 ...
 if (how == ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((109))) || ((combits) & (0x01)))
  ucom_dtr(sc, (sc->sc_mcr & 0x01) != 0);
 if (how == ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((109))) || ((combits) & (0x02)))
  ucom_rts(sc, (sc->sc_mcr & 0x02) != 0);
}
...
ucom_break(struct ucom_softc *sc, int onoff)
{
 ...
 if (sc->sc_methods->ucom_set != ((void *)0))
...
ucom_status_change(struct ucom_softc *sc)
{
 ...
 if (sc->sc_methods->ucom_get_status != ((void *)0)) {
  old_msr = sc->sc_msr;
  sc->sc_methods->ucom_get_status(sc->sc_parent, sc->sc_portno,
      &sc->sc_lsr, &sc->sc_msr);

  ttytstamp(tp, old_msr & 0x10, sc->sc_msr & 0x10,
      old_msr & 0x80, sc->sc_msr & 0x80);

  if ((((sc->sc_msr ^ old_msr)) & (0x80)))
...
{
 struct ucom_softc *sc = ucom_cd.cd_devs[(((int32_t)((tp->t_dev) & 0xff) | (((tp->t_dev) & 0xffff0000) >> 8)) & 0x7f)];
 int error;
 ...
 if (tp->t_termios.c_ospeed == t->c_ospeed &&
 ...
 if (sc->sc_methods->ucom_param != ((void *)0)) {
  error = sc->sc_methods->ucom_param(sc->sc_parent, sc->sc_portno,
       t);
  if (error)
   return (error);
 }
# 914 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c"
 ;
 (void) (*(linesw[(tp)->t_line].l_modem))(tp, 1 );
# 927 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c"
 return (0);
}
...
{
 ;
# 954 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c"
}
...
ucomstart(struct tty *tp)
{
 ...
 if (sc->sc_methods->ucom_write != ((void *)0))
  sc->sc_methods->ucom_write(sc->sc_parent, sc->sc_portno,
        sc->sc_obuf, data, &cnt);
 else
  __builtin_memcpy((sc->sc_obuf), (data), (cnt));
...
{
 ;
# 1045 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ucom.c"
 return (0);
}
...
ucomreadcb(struct usbd_xfer *xfer, void *p, usbd_status status)
{
 ...
 usbd_get_xfer_status(xfer, ((void *)0), (void *)&cp, &cc, ((void *)0));
 ;
 if (sc->sc_methods->ucom_read != ((void *)0))
