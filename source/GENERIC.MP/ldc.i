# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldc.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldc.c"
...
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldc.c" 2
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldc.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldc.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldc.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldc.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldcvar.h" 1
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldcvar.h"
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldcvar.h" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldc.c" 2
...
ldc_rx_data(struct ldc_conn *lc, struct ldc_pkt *lp)
{
 ...
 if (lp->env & 0x40) {
  lc->lc_len = (lp->env & 0x3f) + 8;
  ((lc->lc_len <= sizeof(lc->lc_msg)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ldc.c", 224, "lc->lc_len <= sizeof(lc->lc_msg)"));
  __builtin_memcpy(((uint8_t *)lc->lc_msg), (lp), (lc->lc_len));
 } else {
  len = (lp->env & 0x3f);
  ...
  __builtin_memcpy((((uint8_t *)lc->lc_msg) + lc->lc_len), (&lp->major), (len));
  lc->lc_len += len;
 }
...
ldc_send_vers(struct ldc_conn *lc)
{
 ...
 __builtin_bzero((lp), (sizeof(struct ldc_pkt)));
 lp->type = 0x01;
 lp->stype = 0x01;
 lp->ctrl = 0x01;
 lp->major = 1;
...
ldc_send_unreliable(struct ldc_conn *lc, void *msg, size_t len)
{
 ...
 while (len > 0) {
  ...
  if (len <= 56)
   lp->env |= 0x80;
  lp->seqid = lc->lc_tx_seqid++;
  __builtin_bcopy((p), (&lp->major), (min(len, 56)));
...
ldc_queue_alloc(bus_dma_tag_t t, int nentries)
{
 ...
 if (bus_dmamem_alloc(t, size, (1 << 13), 0, &lq->lq_seg, 1,
     &nsegs, 0x0001) != 0)
  goto destroy;
 ...
 if (bus_dmamap_load(t, lq->lq_map, va, size, ((void *)0),
     0x0001) != 0)
  goto unmap;
...
error:
 free(lq, 2, sizeof(struct ldc_queue));
...
ldc_queue_free(bus_dma_tag_t t, struct ldc_queue *lq)
{
 ...
 size = ((((lq->lq_nentries * sizeof(struct ldc_pkt))+(((1 << 13))-1))/((1 << 13)))*((1 << 13)));
...
ldc_map_alloc(bus_dma_tag_t t, int nentries)
{
 ...
 lm = malloc(sizeof(struct ldc_map), 2, 0x0002);
 if (lm == ((void *)0))
  return ((void *)0);

 size = ((((nentries * sizeof(struct ldc_map_slot))+(((1 << 13))-1))/((1 << 13)))*((1 << 13)));

 if (bus_dmamap_create(t, size, 1, size, 0,
     0x0001 | 0x0002, &lm->lm_map) != 0)
  goto error;

 if (bus_dmamem_alloc(t, size, (1 << 13), 0, &lm->lm_seg, 1,
     &nsegs, 0x0001) != 0)
  goto destroy;
 ...
 if (bus_dmamap_load(t, lm->lm_map, va, size, ((void *)0),
     0x0001) != 0)
  goto unmap;

 lm->lm_slot = (struct ldc_map_slot *)va;
 lm->lm_nentries = nentries;
 __builtin_bzero((lm->lm_slot), (nentries * sizeof(struct ldc_map_slot)));
 return (lm);
...
error:
 free(lm, 2, sizeof(struct ldc_map));
