...
static uint32_t radeon_encoder_clones(struct drm_encoder *encoder)
{
 ...
 if (radeon_encoder->devices & (0x1L << 0x00000007 ))
  return index_mask;
 count = -1;
 for (clone_encoder = ({ const __typeof( ((__typeof(*clone_encoder) *)0)->head ) *__mptr = ((&dev->mode_config.encoder_list)->next); (__typeof(*clone_encoder) *)( (char *)__mptr - __builtin_offsetof(__typeof(*clone_encoder), head) );}); &clone_encoder->head != (&dev->mode_config.encoder_list); clone_encoder = ({ const __typeof( ((__typeof(*clone_encoder) *)0)->head ) *__mptr = (clone_encoder->head.next); (__typeof(*clone_encoder) *)( (char *)__mptr - __builtin_offsetof(__typeof(*clone_encoder), head) );})) {
  struct radeon_encoder *radeon_clone = ({ const __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (clone_encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
  count++;
...
u16 radeon_encoder_get_dp_bridge_encoder_id(struct drm_encoder *encoder)
{
 ...
 if (other_encoder) {
  struct radeon_encoder *radeon_encoder = ({ const __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (other_encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
        ...
        u32 pixel_clock)
{
 ...
 case 12:
  if (radeon_connector->use_digital) {
   if (((rdev->family >= CHIP_ARUBA)) && drm_detect_hdmi_monitor(radeon_connector_edid(connector))) {
...
_Bool radeon_encoder_is_digital(struct drm_encoder *encoder)
{
 struct radeon_encoder *radeon_encoder = ({ const __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 switch (radeon_encoder->encoder_id) {
 case 0x01:
