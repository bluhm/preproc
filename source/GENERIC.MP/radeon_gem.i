# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_gem.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_gem.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_gem.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_gem.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_gem.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_gem.c" 2

void radeon_gem_object_free(struct drm_gem_object *gobj)
{
 struct radeon_bo *robj = ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((gobj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
 ...
 *obj = ((void *)0);
 ...
 if (size > max_size) {
  printf("" "%s:%d alloc size %dMb bigger than %ldMb limit\n", __func__, 65, size >> 20, max_size >> 20);

  return -12;
 }

retry:
 r = radeon_bo_create(rdev, size, alignment, kernel, initial_domain, ((void *)0), &robj);
 if (r) {
  if (r != -4) {
   if (initial_domain == 0x4) {
    initial_domain |= 0x2;
    goto retry;
   }
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to allocate GEM object (%d, %d, %u, %d)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , size, initial_domain, alignment, r);
     ...
     uint32_t rdomain, uint32_t wdomain)
{
 ...
 robj = ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((gobj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
 ...
 if (!domain) {
  ...
  printf("" "Set domain without domain !\n");
  return 0;
 }
 if (domain == 0x1) {
...
{
 struct radeon_bo *rbo = ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((obj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
        ...
        struct drm_file *file_priv)
{
 ...
 if (r) {
  printf("drm:pid%d:%s *ERROR* " "leaking bo va because " "we fail to reserve bo (%d)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
     ...
     struct drm_file *filp)
{
 ...
 args->vram_visible = (u64)man->size << 13;
 if (rdev->stollen_vga_memory)
  args->vram_visible -= radeon_bo_size(rdev->stollen_vga_memory);
 args->vram_visible -= radeon_fbdev_total_size(rdev);
 args->gart_size = rdev->mc.gtt_size - 4096 - 16*64*1024;
 for(i = 0; i < 5; ++i)
       ...
       struct drm_file *filp)
{
 ...
 args->size = ((((args->size)+(((1 << 13))-1))/((1 << 13)))*((1 << 13)));
     ...
     struct drm_file *filp)
{
 ...
 if (args->offset < (8 << 20)) {
  printf("drm:pid%d:%s *ERROR* " "offset 0x%lX is in reserved area 0x%X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , (unsigned long)args->offset, (8 << 20));
 ...
 invalid_flags = (1 << 0) | (1 << 3);
 if ((args->flags & invalid_flags)) {
  printf("drm:pid%d:%s *ERROR* " "invalid flags 0x%08X vs 0x%08X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , args->flags, invalid_flags);

  args->operation = 1;
  return -22;
 }
 if (!(args->flags & (1 << 4))) {
  printf("drm:pid%d:%s *ERROR* " "only supported snooped mapping for now\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  args->operation = 1;
  return -22;
 }
 ...
 case 2:
  break;
 default:
  printf("drm:pid%d:%s *ERROR* " "unsupported operation %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , args->operation);
       ...
       struct drm_mode_create_dumb *args)
{
 ...
 args->size = (((args->size) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
