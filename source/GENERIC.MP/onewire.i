# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c"
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c"
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c" 2



# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewirereg.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewirevar.h" 1
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewirevar.h"
struct onewire_bus {
 void * bus_cookie;
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c" 2
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewire.c"
struct onewire_softc {
 ...
 struct { struct onewire_device *tqh_first; struct onewire_device **tqh_last; } sc_devs;

 int sc_dying;
 int sc_flags;
 u_int64_t sc_rombuf[16];
};

struct onewire_device {
 struct { struct onewire_device *tqe_next; struct onewire_device **tqe_prev; } d_list;
 struct device * d_dev;
 u_int64_t d_rom;
 int d_present;
};
...
onewire_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 do { (&sc->sc_devs)->tqh_first = ((void *)0); (&sc->sc_devs)->tqh_last = &(&sc->sc_devs)->tqh_first; } while (0);
...
onewire_detach(struct device *self, int flags)
{
 ...
 sc->sc_dying = 1;
 if (sc->sc_thread != ((void *)0)) {
  wakeup(sc->sc_thread);
  tsleep(&sc->sc_dying, 32, "owdt", 0);
 }
...
onewire_print(void *aux, const char *pnp)
{
 ...
 famname = onewire_famname(((u_char)(oa->oa_rom) & 0x7f));
 if (famname == ((void *)0))
  printf("family 0x%02x", ((u_char)(oa->oa_rom) & 0x7f));
 else
  printf("\"%s\"", famname);
 printf(" sn %012llx", (((oa->oa_rom) >> 8) & 0xffffffffffffULL));
...
onewire_lock(void *arg, int flags)
{
 ...
 return (_rw_enter(&sc->sc_lock, lflags ));
}
...
onewire_matchrom(void *arg, u_int64_t rom)
{
 ...
 if (bus->bus_matchrom != ((void *)0))
  return (bus->bus_matchrom(bus->bus_cookie, rom));

 onewire_write_byte(arg, 0x55);
 for (i = 0; i < 8; i++)
...
onewire_thread(void *arg)
{
 ...
 while (!sc->sc_dying) {
  ...
  if (sc->sc_flags & 0x0002)
   break;
  tsleep(sc->sc_thread, 32, "owidle", 3 * hz);
 }
...
onewire_scan(struct onewire_softc *sc)
{
 ...
 for((d) = ((&sc->sc_devs)->tqh_first); (d) != ((void *)0); (d) = ((d)->d_list.tqe_next))
  d->d_present = 0;
 ...
 if ((rv = onewire_search(sc, sc->sc_rombuf, 16, 0)) == -1)
  return;
 ...
 for (i = 0; i < rv; i++) {
  ...
  if (!present) {
   ...
   __builtin_bzero((&oa), (sizeof(oa)));
   oa.oa_onewire = sc;
   oa.oa_rom = rom;
   dev = config_found_sm((&sc->sc_dev), (&oa), (onewire_print), ((void *)0));

   nd->d_dev = dev;
   nd->d_rom = rom;
   nd->d_present = 1;
   do { (nd)->d_list.tqe_next = ((void *)0); (nd)->d_list.tqe_prev = (&sc->sc_devs)->tqh_last; *(&sc->sc_devs)->tqh_last = (nd); (&sc->sc_devs)->tqh_last = &(nd)->d_list.tqe_next; } while (0);
  }
 }

out:

 for ((d) = ((&sc->sc_devs)->tqh_first); (d) != ((void *)0) && ((next) = ((d)->d_list.tqe_next), 1); (d) = (next)) {
  if (!d->d_present) {
   if (d->d_dev != ((void *)0))
    config_detach(d->d_dev, 0x01);
   do { if (((d)->d_list.tqe_next) != ((void *)0)) (d)->d_list.tqe_next->d_list.tqe_prev = (d)->d_list.tqe_prev; else (&sc->sc_devs)->tqh_last = (d)->d_list.tqe_prev; *(d)->d_list.tqe_prev = (d)->d_list.tqe_next; ((d)->d_list.tqe_prev) = ((void *)-1); ((d)->d_list.tqe_next) = ((void *)-1); } while (0);
   free(d, 2, sizeof *d);
  }
 }
}
