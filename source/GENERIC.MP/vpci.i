# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c"
...
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
...
void device_register(struct device *, void *);
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcivar.h" 1
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcivar.h"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommuvar.h" 1
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/viommuvar.h"
...
void viommu_dvmamem_free(bus_dma_tag_t, bus_dma_tag_t, bus_dma_segment_t *,
     int);
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/msivar.h" 1
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/msivar.h"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c" 2
...
vpci_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 struct vpci_pbm *pbm;
 int *busranges = ((void *)0), nranges;

 sc->sc_dmat = ma->ma_dmatag;
 sc->sc_bust = ma->ma_bustag;
 sc->sc_node = ma->ma_node;

 pbm = malloc(sizeof(*pbm), 2, 0x0002 | 0x0008);
 if (pbm == ((void *)0))
 ...
 config_found_sm((&sc->sc_dv), (&pba), (vpci_print), ((void *)0));
}
...
vpci_init_msi(struct vpci_softc *sc, struct vpci_pbm *pbm)
{
 ...
 err = hv_pci_msiq_setstate(pbm->vp_devhandle, 0, 0);
 if (err != 0) {
...
pcireg_t
vpci_conf_read(pci_chipset_tag_t pc, pcitag_t tag, int reg64)
{
 struct vpci_pbm *pbm = pc->cookie;
 uint64_t error_flag, data;

 hv_pci_config_get(pbm->vp_devhandle, ((tag)&0xffffffff), reg64, 4,
     &error_flag, &data);
...
void
vpci_conf_write(pci_chipset_tag_t pc, pcitag_t tag, int reg64, pcireg_t data)
{
 struct vpci_pbm *pbm = pc->cookie;
 uint64_t error_flag;

 hv_pci_config_put(pbm->vp_devhandle, ((tag)&0xffffffff), reg64, 4,
            data, &error_flag);
}
    ...
    int asi, int sasi)
{
 ...
 bt = malloc(sizeof(*bt), 2, 0x0002 | 0x0008);
 if (bt == ((void *)0))
...
vpci_alloc_dma_tag(struct vpci_pbm *pbm)
{
 ...
 dt = malloc(sizeof(*dt), 2, 0x0002 | 0x0008);
 if (dt == ((void *)0))
...
vpci_alloc_chipset(struct vpci_pbm *pbm, int node, pci_chipset_tag_t pc)
{
 ...
 npc = malloc(sizeof *npc, 2, 0x0002);
 if (npc == ((void *)0))
  panic("vpci: could not allocate pci_chipset_tag_t");
 __builtin_memcpy((npc), (pc), (sizeof *pc));
 npc->cookie = pbm;
 npc->rootnode = node;
 return (npc);
}
# 433 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/vpci.c"
int
    ...
    int level, int flags, int (*handler)(void *), void *arg, const char *what)
{
 ...
 if (ihandle & 0x80000000) {
  ...
  pcitag_t tag = ihandle & ~0x80000000;
  ...
  err = hv_pci_msi_setvalid(pbm->vp_devhandle, msinum, 1);
  if (err != 0) {
   printf("%s: pci_msi_setvalid: err %d\n", __func__, err);
   return (((void *)0));
  }

  err = hv_pci_msi_setstate(pbm->vp_devhandle, msinum, 0);
  if (err != 0) {
