# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c"
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c"
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.c" 2
...
struct sdmmc_ccb {
 ...
 struct { struct sdmmc_ccb *tqe_next; struct sdmmc_ccb **tqe_prev; } ccb_link;
};

struct sdmmc_ccb_list { struct sdmmc_ccb *tqh_first; struct sdmmc_ccb **tqh_last; };
...
sdmmc_scsi_attach(struct sdmmc_softc *sc)
{
 ...
 scbus->sc_child = config_found_sm((&sc->sc_dev), (&saa), (scsiprint), ((void *)0));
...
sdmmc_scsi_detach(struct sdmmc_softc *sc)
{
 ...
 s = _splraise(5);
 for (ccb = ((&scbus->sc_ccb_runq)->tqh_first); ccb != ((void *)0);
      ccb = ((&scbus->sc_ccb_runq)->tqh_first))
  sdmmc_stimeout(ccb);
 _splx(s);

 if (scbus->sc_child != ((void *)0))
  config_detach(scbus->sc_child, 0x01);

 if (scbus->sc_tgt != ((void *)0))
  free(scbus->sc_tgt, 2,
      sizeof(*scbus->sc_tgt) * (0x0f +1));
...
{
 if (scbus->sc_ccbs != ((void *)0)) {
  free(scbus->sc_ccbs, 2,
      scbus->sc_nccbs * sizeof(struct sdmmc_ccb));
  scbus->sc_ccbs = ((void *)0);
 }
}
...
sdmmc_ccb_free(void *xscbus, void *xccb)
{
 ...
 if (ccb->ccb_state == SDMMC_CCB_QUEUED)
  do { if (((ccb)->ccb_link.tqe_next) != ((void *)0)) (ccb)->ccb_link.tqe_next->ccb_link.tqe_prev = (ccb)->ccb_link.tqe_prev; else (&scbus->sc_ccb_runq)->tqh_last = (ccb)->ccb_link.tqe_prev; *(ccb)->ccb_link.tqe_prev = (ccb)->ccb_link.tqe_next; ((ccb)->ccb_link.tqe_prev) = ((void *)-1); ((ccb)->ccb_link.tqe_next) = ((void *)-1); } while (0);
 _splx(s);
    ...
    u_int32_t *blockcntp)
{
  ...
  *blocknop = _3btol(rw->addr) & (0x1F << 16 | 0xffff);
...
sdmmc_scsi_cmd(struct scsi_xfer *xs)
{
 ...
 if (link->target >= scbus->sc_ntargets || tgt->card == ((void *)0) ||
     link->lun != 0) {
  ;
 ...
 case 0x25:
  ...
  __builtin_bcopy((&rcd), (xs->data), ((((xs->datalen)<(sizeof rcd))?(xs->datalen):(sizeof rcd))));
  scsi_done(xs);
  return;
...
sdmmc_inquiry(struct scsi_xfer *xs)
{
 ...
 __builtin_memset((vendor), (0), (sizeof(vendor)));
 __builtin_memset((product), (0), (sizeof(product)));
 __builtin_memset((revision), (0), (sizeof(revision)));
 ...
 __builtin_memcpy((inq.vendor), (vendor), (sizeof(inq.vendor)));
 __builtin_memcpy((inq.product), (product), (sizeof(inq.product)));
 __builtin_memcpy((inq.revision), (revision), (sizeof(inq.revision)));

 __builtin_memcpy((xs->data), (&inq), ((((xs->datalen)<(sizeof(inq)))?(xs->datalen):(sizeof(inq)))));
...
sdmmc_start_xs(struct sdmmc_softc *sc, struct sdmmc_ccb *ccb)
{
 ...
 do { (&ccb->ccb_task)->func = (sdmmc_complete_xs); (&ccb->ccb_task)->arg = (ccb); (&ccb->ccb_task)->onqueue = 0; (&ccb->ccb_task)->sc = ((void *)0); } while (0);

 s = _splraise(5);
 do { (ccb)->ccb_link.tqe_next = ((void *)0); (ccb)->ccb_link.tqe_prev = (&scbus->sc_ccb_runq)->tqh_last; *(&scbus->sc_ccb_runq)->tqh_last = (ccb); (&scbus->sc_ccb_runq)->tqh_last = &(ccb)->ccb_link.tqe_next; } while (0);
...
sdmmc_stimeout(void *arg)
{
 ...
 s = _splraise(5);
 ccb->ccb_flags |= 0x0001;
 if (((&ccb->ccb_task)->onqueue)) {
