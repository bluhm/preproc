# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c" 2
...
# 117 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c"
void
frag6_init(void)
{
...
# 156 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c"
int
frag6_input(struct mbuf **mp, int *offp, int proto, int af)
{
 ...
 do { struct mbuf *t; int tmp; if ((m)->m_hdr.mh_len >= (offset) + (sizeof(*ip6f))) (ip6f) = (struct ip6_frag *)(((caddr_t)(((m))->m_hdr.mh_data)) + (offset)); else { t = m_pulldown((m), (offset), (sizeof(*ip6f)), &tmp); if (t) { if (t->m_hdr.mh_len < tmp + (sizeof(*ip6f))) panic("m_pulldown malfunction"); (ip6f) = (struct ip6_frag *)(((caddr_t)((t)->m_hdr.mh_data)) + tmp); } else { (ip6f) = (struct ip6_frag *)((void *)0); (m) = ((void *)0); } } } while ( 0);
 if (ip6f == ((void *)0))
  return 257;
 ...
 if ((ip6f->ip6f_offlg & 0x0001) &&
     (((((__uint16_t)(ip6->ip6_ctlun.ip6_un1.ip6_un1_plen)) - offset) & 0x7) != 0)) {
  icmp6_error(m, 4, 0,
      __builtin_offsetof(struct ip6_hdr, ip6_ctlun.ip6_un1.ip6_un1_plen));
  return 257;
 }
 ...
 fragoff = ((__uint16_t)(ip6f->ip6f_offlg & 0xfff8));
 if (fragoff == 0 && !(ip6f->ip6f_offlg & 0x0001)) {
 ...
 if (sizeof(struct ip6_hdr) + ((__uint16_t)(ip6->ip6_ctlun.ip6_un1.ip6_un1_plen)) <= offset) {
  m_freem(m);
  return 257;
 }
 ...
 for((q6) = ((&frag6_queue)->tqh_first); (q6) != ((void *)0); (q6) = ((q6)->ip6q_queue.tqe_next))
  if (ip6f->ip6f_ident == q6->ip6q_ident &&
      (__builtin_memcmp((&(&ip6->ip6_src)->__u6_addr.__u6_addr8[0]), (&(&q6->ip6q_src)->__u6_addr.__u6_addr8[0]), (sizeof(struct in6_addr))) == 0) &&
      (__builtin_memcmp((&(&ip6->ip6_dst)->__u6_addr.__u6_addr8[0]), (&(&q6->ip6q_dst)->__u6_addr.__u6_addr8[0]), (sizeof(struct in6_addr))) == 0))
   break;
 ...
 if (q6 == ((void *)0)) {
  ...
  first_frag = 1;
# 246 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/frag6.c"
  ...
  do { ((&q6->ip6q_asfrag)->lh_first) = ((void *)0); } while (0);
 ...
 frgpartlen = sizeof(struct ip6_hdr) + ((__uint16_t)(ip6->ip6_ctlun.ip6_un1.ip6_un1_plen)) - offset;
 if (q6->ip6q_unfrglen >= 0) {

  if (q6->ip6q_unfrglen + fragoff + frgpartlen > 65535) {
   icmp6_error(m, 4, 0,
       offset - sizeof(struct ip6_frag) +
       __builtin_offsetof(struct ip6_frag, ip6f_offlg));
   ip6q_unlock();
   return (257);
  }
 ...
 ip6af->ip6af_mff = ip6f->ip6f_offlg & 0x0001;
 ...
 af6 = ((&q6->ip6q_asfrag)->lh_first);
 ecn = (((__uint32_t)(ip6->ip6_ctlun.ip6_un1.ip6_un1_flow)) >> 20) & 0x03;
 ...
 for (paf6 = ((void *)0), af6 = ((&q6->ip6q_asfrag)->lh_first);
     af6 != ((void *)0);
     paf6 = af6, af6 = ((af6)->ip6af_list.le_next))
 ...
 if (paf6 != ((void *)0))
  do { if (((ip6af)->ip6af_list.le_next = (paf6)->ip6af_list.le_next) != ((void *)0)) (paf6)->ip6af_list.le_next->ip6af_list.le_prev = &(ip6af)->ip6af_list.le_next; (paf6)->ip6af_list.le_next = (ip6af); (ip6af)->ip6af_list.le_prev = &(paf6)->ip6af_list.le_next; } while (0);
 else
  do { if (((ip6af)->ip6af_list.le_next = (&q6->ip6q_asfrag)->lh_first) != ((void *)0)) (&q6->ip6q_asfrag)->lh_first->ip6af_list.le_prev = &(ip6af)->ip6af_list.le_next; (&q6->ip6q_asfrag)->lh_first = (ip6af); (ip6af)->ip6af_list.le_prev = &(&q6->ip6q_asfrag)->lh_first; } while (0);
 frag6_nfrags++;
 q6->ip6q_nfrag++;
...
frag6_deletefraghdr(struct mbuf *m, int offset)
{
 ...
 if (m->m_hdr.mh_len >= offset + sizeof(struct ip6_frag)) {
  __builtin_memmove((((caddr_t)((m)->m_hdr.mh_data)) + sizeof(struct ip6_frag)), (((caddr_t)((m)->m_hdr.mh_data))), (offset));

  m->m_hdr.mh_data += sizeof(struct ip6_frag);
  m->m_hdr.mh_len -= sizeof(struct ip6_frag);
 } else {

  if ((t = m_split(m, offset, 0x0002)) == ((void *)0))
   return (55);
