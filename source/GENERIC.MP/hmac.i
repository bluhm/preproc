# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/hmac.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/hmac.c"
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/hmac.c"
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/hmac.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/hmac.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/hmac.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/hmac.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/hmac.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/hmac.c" 2
...
HMAC_MD5_Init(HMAC_MD5_CTX *ctx, const u_int8_t *key, u_int key_len)
{
 ...
 if (key_len > 64) {
  ...
  __builtin_bcopy((key), (ctx->key), (key_len));
  ctx->key_len = key_len;
 }

 __builtin_bzero((k_ipad), (64));
 __builtin_memcpy((k_ipad), (ctx->key), (ctx->key_len));
 for (i = 0; i < 64; i++)
  k_ipad[i] ^= 0x36;
...
void
HMAC_MD5_Final(u_int8_t digest[16], HMAC_MD5_CTX *ctx)
{
 u_int8_t k_opad[64];
 int i;
 ...
 __builtin_bzero((k_opad), (64));
 __builtin_memcpy((k_opad), (ctx->key), (ctx->key_len));
 for (i = 0; i < 64; i++)
  k_opad[i] ^= 0x5c;

 MD5Init(&ctx->ctx);
 MD5Update(&ctx->ctx, k_opad, 64);
 MD5Update(&ctx->ctx, digest, 16);
 MD5Final(digest, &ctx->ctx);
...
void
HMAC_SHA1_Final(u_int8_t digest[20], HMAC_SHA1_CTX *ctx)
{
 u_int8_t k_opad[64];
 int i;
 ...
 SHA1Init(&ctx->ctx);
 SHA1Update(&ctx->ctx, k_opad, 64);
 SHA1Update(&ctx->ctx, digest, 20);
 SHA1Final(digest, &ctx->ctx);
...
HMAC_SHA256_Init(HMAC_SHA256_CTX *ctx, const u_int8_t *key, u_int key_len)
{
 ...
 SHA256Init(&ctx->ctx);
 SHA256Update(&ctx->ctx, k_ipad, 64);
...
void
HMAC_SHA256_Final(u_int8_t digest[32], HMAC_SHA256_CTX *ctx)
{
 u_int8_t k_opad[64];
 int i;
 ...
 SHA256Init(&ctx->ctx);
 SHA256Update(&ctx->ctx, k_opad, 64);
 SHA256Update(&ctx->ctx, digest, 32);
 SHA256Final(digest, &ctx->ctx);
