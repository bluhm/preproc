# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c" 2
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c"
long numcache;
long numneg;

struct { struct namecache *tqh_first; struct namecache **tqh_last; } nclruhead;
struct { struct namecache *tqh_first; struct namecache **tqh_last; } nclruneghead;
...
namecache_compare(const struct namecache *n1, const struct namecache *n2)
{
 if (n1->nc_nlen == n2->nc_nlen)
  return (__builtin_memcmp((n1->nc_name), (n2->nc_name), (n1->nc_nlen)));
 else
  return (n1->nc_nlen - n2->nc_nlen);
}

extern const struct rb_type *const namecache_rb_cache_RBT_TYPE; __attribute__((__unused__)) static inline void namecache_rb_cache_RBT_INIT(struct namecache_rb_cache *head) { _rb_init(&head->rbh_root); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_INSERT(struct namecache_rb_cache *head, struct namecache *elm) { return _rb_insert(namecache_rb_cache_RBT_TYPE, &head->rbh_root, elm); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_REMOVE(struct namecache_rb_cache *head, struct namecache *elm) { return _rb_remove(namecache_rb_cache_RBT_TYPE, &head->rbh_root, elm); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_FIND(struct namecache_rb_cache *head, const struct namecache *key) { return _rb_find(namecache_rb_cache_RBT_TYPE, &head->rbh_root, key); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_NFIND(struct namecache_rb_cache *head, const struct namecache *key) { return _rb_nfind(namecache_rb_cache_RBT_TYPE, &head->rbh_root, key); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_ROOT(struct namecache_rb_cache *head) { return _rb_root(namecache_rb_cache_RBT_TYPE, &head->rbh_root); } __attribute__((__unused__)) static inline int namecache_rb_cache_RBT_EMPTY(struct namecache_rb_cache *head) { return _rb_empty(&head->rbh_root); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_MIN(struct namecache_rb_cache *head) { return _rb_min(namecache_rb_cache_RBT_TYPE, &head->rbh_root); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_MAX(struct namecache_rb_cache *head) { return _rb_max(namecache_rb_cache_RBT_TYPE, &head->rbh_root); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_NEXT(struct namecache *elm) { return _rb_next(namecache_rb_cache_RBT_TYPE, elm); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_PREV(struct namecache *elm) { return _rb_prev(namecache_rb_cache_RBT_TYPE, elm); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_LEFT(struct namecache *elm) { return _rb_left(namecache_rb_cache_RBT_TYPE, elm); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_RIGHT(struct namecache *elm) { return _rb_right(namecache_rb_cache_RBT_TYPE, elm); } __attribute__((__unused__)) static inline struct namecache * namecache_rb_cache_RBT_PARENT(struct namecache *elm) { return _rb_parent(namecache_rb_cache_RBT_TYPE, elm); } __attribute__((__unused__)) static inline void namecache_rb_cache_RBT_SET_LEFT(struct namecache *elm, struct namecache *left) { return _rb_set_left(namecache_rb_cache_RBT_TYPE, elm, left); } __attribute__((__unused__)) static inline void namecache_rb_cache_RBT_SET_RIGHT(struct namecache *elm, struct namecache *right) { return _rb_set_right(namecache_rb_cache_RBT_TYPE, elm, right); } __attribute__((__unused__)) static inline void namecache_rb_cache_RBT_SET_PARENT(struct namecache *elm, struct namecache *parent) { return _rb_set_parent(namecache_rb_cache_RBT_TYPE, elm, parent); } __attribute__((__unused__)) static inline void namecache_rb_cache_RBT_POISON(struct namecache *elm, unsigned long poison) { return _rb_poison(namecache_rb_cache_RBT_TYPE, elm, poison); } __attribute__((__unused__)) static inline int namecache_rb_cache_RBT_CHECK(struct namecache *elm, unsigned long poison) { return _rb_check(namecache_rb_cache_RBT_TYPE, elm, poison); };
static int namecache_rb_cache_RBT_COMPARE(const void *lptr, const void *rptr) { const struct namecache *l = lptr, *r = rptr; return namecache_compare(l, r); } static const struct rb_type namecache_rb_cache_RBT_INFO = { namecache_rb_cache_RBT_COMPARE, ((void *)0), __builtin_offsetof(struct namecache, n_rbcache), }; const struct rb_type *const namecache_rb_cache_RBT_TYPE = &namecache_rb_cache_RBT_INFO;

void
cache_tree_init(struct namecache_rb_cache *tree)
{
 namecache_rb_cache_RBT_INIT(tree);
}
...
{
 struct vnode *dvp = ((void *)0);

 if (ncp->nc_vp != ((void *)0)) {
  do { if (((ncp)->nc_lru.tqe_next) != ((void *)0)) (ncp)->nc_lru.tqe_next->nc_lru.tqe_prev = (ncp)->nc_lru.tqe_prev; else (&nclruhead)->tqh_last = (ncp)->nc_lru.tqe_prev; *(ncp)->nc_lru.tqe_prev = (ncp)->nc_lru.tqe_next; ((ncp)->nc_lru.tqe_prev) = ((void *)-1); ((ncp)->nc_lru.tqe_next) = ((void *)-1); } while (0);
  numcache--;
 } else {
  do { if (((ncp)->nc_neg.tqe_next) != ((void *)0)) (ncp)->nc_neg.tqe_next->nc_neg.tqe_prev = (ncp)->nc_neg.tqe_prev; else (&nclruneghead)->tqh_last = (ncp)->nc_neg.tqe_prev; *(ncp)->nc_neg.tqe_prev = (ncp)->nc_neg.tqe_next; ((ncp)->nc_neg.tqe_prev) = ((void *)-1); ((ncp)->nc_neg.tqe_next) = ((void *)-1); } while (0);
  numneg--;
 }
 if (ncp->nc_dvp) {
  namecache_rb_cache_RBT_REMOVE(&ncp->nc_dvp->v_nc_tree, ncp);
  if (namecache_rb_cache_RBT_EMPTY(&ncp->nc_dvp->v_nc_tree))
   dvp = ncp->nc_dvp;
 }
 if (ncp->nc_vp && (ncp->nc_vpid == ncp->nc_vp->v_id)) {
  if (ncp->nc_vp != ncp->nc_dvp &&
   ...
   (ncp->nc_nlen > 0 &&
       ncp->nc_name[0] != '.'))) {
   do { if (((ncp)->nc_me.tqe_next) != ((void *)0)) (ncp)->nc_me.tqe_next->nc_me.tqe_prev = (ncp)->nc_me.tqe_prev; else (&ncp->nc_vp->v_cache_dst)->tqh_last = (ncp)->nc_me.tqe_prev; *(ncp)->nc_me.tqe_prev = (ncp)->nc_me.tqe_next; ((ncp)->nc_me.tqe_prev) = ((void *)-1); ((ncp)->nc_me.tqe_next) = ((void *)-1); } while (0);
  }
 }
...
# 141 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c"
int
 ...
 *vpp = ((void *)0);
 ...
 __builtin_memcpy((n.nc_name), (cnp->cn_nameptr), (n.nc_nlen));
 ncp = namecache_rb_cache_RBT_FIND(&dvp->v_nc_tree, &n);

 if (ncp == ((void *)0)) {
  nchstats.ncs_miss++;
  return (-1);
 }
 if ((cnp->cn_flags & 0x004000) == 0) {
  nchstats.ncs_badhits++;
  goto remove;
 } else if (ncp->nc_vp == ((void *)0)) {
  if (cnp->cn_nameiop != 1 ||
      (cnp->cn_flags & 0x008000) == 0) {
   nchstats.ncs_neghits++;



   if (((ncp)->nc_neg.tqe_next) != ((void *)0)) {
    do { if (((ncp)->nc_neg.tqe_next) != ((void *)0)) (ncp)->nc_neg.tqe_next->nc_neg.tqe_prev = (ncp)->nc_neg.tqe_prev; else (&nclruneghead)->tqh_last = (ncp)->nc_neg.tqe_prev; *(ncp)->nc_neg.tqe_prev = (ncp)->nc_neg.tqe_next; ((ncp)->nc_neg.tqe_prev) = ((void *)-1); ((ncp)->nc_neg.tqe_next) = ((void *)-1); } while (0);
    do { (ncp)->nc_neg.tqe_next = ((void *)0); (ncp)->nc_neg.tqe_prev = (&nclruneghead)->tqh_last; *(&nclruneghead)->tqh_last = (ncp); (&nclruneghead)->tqh_last = &(ncp)->nc_neg.tqe_next; } while (0);
 ...
 if (((ncp)->nc_lru.tqe_next) != ((void *)0)) {
  do { if (((ncp)->nc_lru.tqe_next) != ((void *)0)) (ncp)->nc_lru.tqe_next->nc_lru.tqe_prev = (ncp)->nc_lru.tqe_prev; else (&nclruhead)->tqh_last = (ncp)->nc_lru.tqe_prev; *(ncp)->nc_lru.tqe_prev = (ncp)->nc_lru.tqe_next; ((ncp)->nc_lru.tqe_prev) = ((void *)-1); ((ncp)->nc_lru.tqe_next) = ((void *)-1); } while (0);
  do { (ncp)->nc_lru.tqe_next = ((void *)0); (ncp)->nc_lru.tqe_prev = (&nclruhead)->tqh_last; *(&nclruhead)->tqh_last = (ncp); (&nclruhead)->tqh_last = &(ncp)->nc_lru.tqe_next; } while (0);
 }
...
# 291 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c"
int
cache_revlookup(struct vnode *vp, struct vnode **dvpp, char **bpp, char *bufp)
{
 ...
 if (!doingcache)
  goto out;
 for((ncp) = ((&vp->v_cache_dst)->tqh_first); (ncp) != ((void *)0); (ncp) = ((ncp)->nc_me.tqe_next)) {
  dvp = ncp->nc_dvp;
...
found:
 ...
 if (bufp != ((void *)0)) {
  ...
  __builtin_memcpy((bp), (ncp->nc_name), (ncp->nc_nlen));
  *bpp = bp;
 }
...
cache_enter(struct vnode *dvp, struct vnode *vp, struct componentname *cnp)
{
 ...
 if (!doingcache || cnp->cn_namelen > 31)
  return;
 ...
 if (numcache >= initialvnodes) {
  if ((ncp = ((&nclruhead)->tqh_first)) != ((void *)0))
   cache_zap(ncp);
  else if ((ncp = ((&nclruneghead)->tqh_first)) != ((void *)0))
   cache_zap(ncp);
  else
   panic("wtf? leak?");
 }
 ncp = pool_get(&nch_pool, 0x0001|0x0008);
 ...
 __builtin_memcpy((ncp->nc_name), (cnp->cn_nameptr), (ncp->nc_nlen));
 if (namecache_rb_cache_RBT_EMPTY(&dvp->v_nc_tree)) {
  vhold(dvp);
 }
 if ((lncp = namecache_rb_cache_RBT_INSERT(&dvp->v_nc_tree, ncp))
     != ((void *)0)) {
 ...
 if (vp) {
  ...
  if (vp != dvp && vp->v_type == VDIR &&
   ...
   (ncp->nc_nlen > 0 &&
       ncp->nc_name[0] != '.')))
   do { (ncp)->nc_me.tqe_next = ((void *)0); (ncp)->nc_me.tqe_prev = (&vp->v_cache_dst)->tqh_last; *(&vp->v_cache_dst)->tqh_last = (ncp); (&vp->v_cache_dst)->tqh_last = &(ncp)->nc_me.tqe_next; } while (0);
...
nchinit(void)
{
 do { (&nclruhead)->tqh_first = ((void *)0); (&nclruhead)->tqh_last = &(&nclruhead)->tqh_first; } while (0);
 do { (&nclruneghead)->tqh_first = ((void *)0); (&nclruneghead)->tqh_last = &(&nclruneghead)->tqh_first; } while (0);
 pool_init(&nch_pool, sizeof(struct namecache), 0, 0, 0x0001,
     "nchpl", ((void *)0));
}
...
cache_purge(struct vnode *vp)
{
 ...
 ((vp->v_type == VDIR || (((&vp->v_cache_dst)->tqh_first) == ((void *)0))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_cache.c", 441, "vp->v_type == VDIR || TAILQ_EMPTY(&vp->v_cache_dst)"));

 while ((ncp = ((&vp->v_cache_dst)->tqh_first)))
  cache_zap(ncp);
 while ((ncp = namecache_rb_cache_RBT_ROOT(&vp->v_nc_tree)))
  cache_zap(ncp);
...
cache_purgevfs(struct mount *mp)
{
 ...
 for ((ncp) = ((&nclruhead)->tqh_first); (ncp) != ((void *)0) && ((nxtcp) = ((ncp)->nc_lru.tqe_next), 1); (ncp) = (nxtcp)) {
  if (ncp->nc_dvp == ((void *)0) || ncp->nc_dvp->v_mount != mp)
   continue;

  cache_zap(ncp);
 }

 for ((ncp) = ((&nclruneghead)->tqh_first); (ncp) != ((void *)0) && ((nxtcp) = ((ncp)->nc_neg.tqe_next), 1); (ncp) = (nxtcp)) {
  if (ncp->nc_dvp == ((void *)0) || ncp->nc_dvp->v_mount != mp)
   continue;
