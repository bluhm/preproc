...
struct bpf_d {
 struct { struct srp se_next; } bd_next;
 struct mutex bd_mtx;
 caddr_t bd_sbuf;
 caddr_t bd_hbuf;
 caddr_t bd_fbuf;
 ...
 u_long bd_rtout;
 u_long bd_rdStart;
 struct srp bd_rfilter;
 struct srp bd_wfilter;
 u_long bd_rcount;
 u_long bd_dcount;
 u_char bd_promisc;
 u_char bd_state;
 ...
 int bd_unit;
 struct { struct bpf_d *le_next; struct bpf_d **le_prev; } bd_list;
 struct task bd_wake_task;
};
struct bpf_if {
 struct bpf_if *bif_next;
 struct srpl bif_dlist;
...
extern int ticks;
int bpf_bufsize = 32768;
int bpf_maxbufsize = (2 * 1024 * 1024);
...
struct srpl_rc bpf_d_rc = { bpf_d_ref, { (bpf_d_unref), (((void *)0)), { .refs = 1 } } };
void bpf_insn_dtor(void *, void *);
struct srp_gc bpf_insn_gc = { (bpf_insn_dtor), (((void *)0)), { .refs = 1 } };
struct rwlock bpf_sysctl_lk = { 0, "bpfsz" };
int
 ...
 *mp = m;
 ...
 if (hlen != 0) {
  if (linktype == 12) {
   u_int32_t af;
   ((hlen == sizeof(u_int32_t)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 244, "hlen == sizeof(u_int32_t)"));
   __builtin_memcpy((&af), (m->m_hdr.mh_data), (hlen));
   sockp->sa_family = ((__uint32_t)(af));
  } else
   __builtin_memcpy((sockp->sa_data), (m->m_hdr.mh_data), (hlen));
  m->m_hdr.mh_len -= hlen;
  m->m_hdr.mh_data += hlen;
 }
 mtag = m_tag_get(0x0100, sizeof(u_int), 0x0001);
...
{
 do { if (((&d->bd_mtx)->mtx_owner != (__curcpu->ci_self)) && !(panicstr || db_active)) panic("mutex %p not held in %s", (&d->bd_mtx), __func__); } while (0);
 d->bd_bif = bp;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 282, "_kernel_lock_held()"));
 do { void *head; srp_init(&(d)->bd_next.se_next); head = srp_get_locked(&(&bp->bif_dlist)->sl_head); if (head != ((void *)0)) { (&bpf_d_rc)->srpl_ref(&(&bpf_d_rc)->srpl_gc.srp_gc_cookie, head); srp_update_locked(&(&bpf_d_rc)->srpl_gc, &(d)->bd_next.se_next, head); } (&bpf_d_rc)->srpl_ref(&(&bpf_d_rc)->srpl_gc.srp_gc_cookie, d); srp_update_locked(&(&bpf_d_rc)->srpl_gc, &(&bp->bif_dlist)->sl_head, (d)); } while (0);
 *bp->bif_driverp = bp;
}
void
bpf_detachd(struct bpf_d *d)
{
 ...
 if (bp == ((void *)0))
  return;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 304, "_kernel_lock_held()"));
 do { struct srp *ref; struct bpf_d *c, *n; ref = &(&bp->bif_dlist)->sl_head; while ((c = srp_get_locked(ref)) != (d)) ref = &c->bd_next.se_next; n = srp_get_locked(&(c)->bd_next.se_next); if (n != ((void *)0)) (&bpf_d_rc)->srpl_ref(&(&bpf_d_rc)->srpl_gc.srp_gc_cookie, n); srp_update_locked(&(&bpf_d_rc)->srpl_gc, ref, n); srp_update_locked(&(&bpf_d_rc)->srpl_gc, &c->bd_next.se_next, ((void *)0)); } while (0);
 if ((srp_get_locked(&(&bp->bif_dlist)->sl_head) == ((void *)0))) {
...
{
 do { ((&bpf_d_list)->lh_first) = ((void *)0); } while (0);
}
int
bpfopen(dev_t dev, int flag, int mode, struct proc *p)
{
 ...
 if (unit & ((1 << 8) - 1))
  return (6);
 ((bpfilter_lookup(unit) == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 364, "bpfilter_lookup(unit) == NULL"));
 ...
 if (flag & 0x0004)
  bd->bd_rtout = -1;
 bpf_get(bd);
 do { if (((bd)->bd_list.le_next = (&bpf_d_list)->lh_first) != ((void *)0)) (&bpf_d_list)->lh_first->bd_list.le_prev = &(bd)->bd_list.le_next; (&bpf_d_list)->lh_first = (bd); (bd)->bd_list.le_prev = &(&bpf_d_list)->lh_first; } while (0);
 return (0);
}
int
...
bpfread(dev_t dev, struct uio *uio, int ioflag)
{
 ...
 caddr_t hbuf;
 int hlen, error;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 429, "_kernel_lock_held()"));
 d = bpfilter_lookup(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)));
 if (d->bd_bif == ((void *)0))
  return (6);
 bpf_get(d);
 ...
 while (d->bd_hbuf == ((void *)0)) {
  if (d->bd_bif == ((void *)0)) {
   ...
   ((d->bd_in_uiomove == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 468, "d->bd_in_uiomove == 0")); do { if (((&d->bd_mtx)->mtx_owner != (__curcpu->ci_self)) && !(panicstr || db_active)) panic("mutex %p not held in %s", (&d->bd_mtx), __func__); } while (0); (d)->bd_hbuf = (d)->bd_sbuf; (d)->bd_hlen = (d)->bd_slen; (d)->bd_sbuf = (d)->bd_fbuf; (d)->bd_slen = 0; (d)->bd_fbuf = ((void *)0);;
   break;
  }
  if (d->bd_immediate && d->bd_slen != 0) {
   ((d->bd_in_uiomove == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 477, "d->bd_in_uiomove == 0")); do { if (((&d->bd_mtx)->mtx_owner != (__curcpu->ci_self)) && !(panicstr || db_active)) panic("mutex %p not held in %s", (&d->bd_mtx), __func__); } while (0); (d)->bd_hbuf = (d)->bd_sbuf; (d)->bd_hlen = (d)->bd_slen; (d)->bd_sbuf = (d)->bd_fbuf; (d)->bd_slen = 0; (d)->bd_fbuf = ((void *)0);;
   break;
  }
  if (d->bd_rtout == -1) {
   error = 35;
  ...
  if (error == 35) {
   ...
   ((d->bd_in_uiomove == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 510, "d->bd_in_uiomove == 0")); do { if (((&d->bd_mtx)->mtx_owner != (__curcpu->ci_self)) && !(panicstr || db_active)) panic("mutex %p not held in %s", (&d->bd_mtx), __func__); } while (0); (d)->bd_hbuf = (d)->bd_sbuf; (d)->bd_hlen = (d)->bd_slen; (d)->bd_sbuf = (d)->bd_fbuf; (d)->bd_slen = 0; (d)->bd_fbuf = ((void *)0);;
   break;
  }
 }
 hbuf = d->bd_hbuf;
 ...
 __mtx_enter(&d->bd_mtx );
 ((d->bd_fbuf == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 534, "d->bd_fbuf == NULL"));
 ((d->bd_hbuf == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 535, "d->bd_hbuf == NULL"));
 d->bd_fbuf = hbuf;
 d->bd_in_uiomove = 0;
out:
 __mtx_leave(&d->bd_mtx );
...
{
 struct bpf_d *d = xd;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 569, "_kernel_lock_held()"));
 wakeup(d);
...
bpfwrite(dev_t dev, struct uio *uio, int ioflag)
{
 ...
 u_int dlt;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 591, "_kernel_lock_held()"));
 d = bpfilter_lookup(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)));
 if (d->bd_bif == ((void *)0))
  return (6);
 bpf_get(d);
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 610, "_kernel_lock_held()"));
...
{
 do { if (((&d->bd_mtx)->mtx_owner != (__curcpu->ci_self)) && !(panicstr || db_active)) panic("mutex %p not held in %s", (&d->bd_mtx), __func__); } while (0);
 ((d->bd_in_uiomove == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 650, "d->bd_in_uiomove == 0"));
 if (d->bd_hbuf != ((void *)0)) {
  d->bd_fbuf = d->bd_hbuf;
  d->bd_hbuf = ((void *)0);
 }
...
bpfioctl(dev_t dev, u_long cmd, caddr_t addr, int flag, struct proc *p)
{
 ...
 if (d->bd_locked && suser(p) != 0) {
  ...
  case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct bpf_dltlist) & 0x1fff) << 16) | ((('B')) << 8) | ((123))):
  ...
  case ((unsigned long)0x40000000 | ((sizeof(u_int) & 0x1fff) << 16) | ((('B')) << 8) | ((124))):
   break;
  default:
   return (1);
  }
 ...
 case ((unsigned long)0x20000000 | ((0 & 0x1fff) << 16) | ((('B')) << 8) | ((105))):
  if (d->bd_bif == ((void *)0)) {
   ...
   if (d->bd_promisc == 0) {
    do { if (((&d->bd_mtx)->mtx_owner == (__curcpu->ci_self)) && !(panicstr || db_active)) panic("mutex %p held in %s", (&d->bd_mtx), __func__); } while (0);
    do { _rw_enter_write(&netlock ); } while (0);
 ...
 case ((unsigned long)0x40000000 | ((sizeof(u_int) & 0x1fff) << 16) | ((('B')) << 8) | ((106))):
  ...
  break;
 case ((unsigned long)0x80000000 | ((sizeof(u_int) & 0x1fff) << 16) | ((('B')) << 8) | ((122))):
  if (d->bd_bif == ((void *)0))
   error = 22;
  else {
   __mtx_enter(&d->bd_mtx );
 ...
 case ((unsigned long)0x20000000 | ((0 & 0x1fff) << 16) | ((('B')) << 8) | ((118))):
  d->bd_locked = 1;
  break;
 case ((unsigned long)0x40000000 | ((sizeof(u_int) & 0x1fff) << 16) | ((('B')) << 8) | ((120))):
  *(u_int *)addr = d->bd_fildrop;
  break;
 case ((unsigned long)0x80000000 | ((sizeof(u_int) & 0x1fff) << 16) | ((('B')) << 8) | ((121))):
  d->bd_fildrop = *(u_int *)addr ? 1 : 0;
  break;
 case ((unsigned long)0x40000000 | ((sizeof(u_int) & 0x1fff) << 16) | ((('B')) << 8) | ((124))):
  *(u_int *)addr = d->bd_dirfilt;
  break;
 case ((unsigned long)0x80000000 | ((sizeof(u_int) & 0x1fff) << 16) | ((('B')) << 8) | ((125))):
...
bpf_setf(struct bpf_d *d, struct bpf_program *fp, int wf)
{
 ...
 u_int flen, size;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1003, "_kernel_lock_held()"));
 ...
 if (flen > 512)
  return (22);
 fcode = mallocarray(flen, sizeof(*fp->bf_insns), 2,
     0x0001 | 0x0004);
 if (fcode == ((void *)0))
  return (12);
...
bpfpoll(dev_t dev, int events, struct proc *p)
{
 struct bpf_d *d;
 int revents;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1110, "_kernel_lock_held()"));
 d = bpfilter_lookup(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)));
 if (d == ((void *)0))
  return (0x0008);
...
struct filterops bpfread_filtops =
 { 1, ((void *)0), filt_bpfrdetach, filt_bpfread };
int
bpfkqfilter(dev_t dev, struct knote *kn)
{
 struct bpf_d *d;
 struct klist *klist;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1157, "_kernel_lock_held()"));
 d = bpfilter_lookup(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)));
...
filt_bpfrdetach(struct knote *kn)
{
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1187, "_kernel_lock_held()"));
...
{
 struct bpf_d *d = kn->kn_hook;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1198, "_kernel_lock_held()"));
 __mtx_enter(&d->bd_mtx );
...
bpf_mcopy(const void *src_arg, void *dst_arg, size_t len)
{
 ...
 while (len > 0) {
  ...
  __builtin_bcopy((((caddr_t)((m)->m_hdr.mh_data))), ((caddr_t)dst), (count));
  m = m->m_hdr.mh_next;
  dst += count;
  len -= count;
 }
    ...
    void (*cpfn)(const void *, void *, size_t))
{
 ...
 for ((d) = srp_enter((&sr), &(&bp->bif_dlist)->sl_head); (d) != ((void *)0); (d) = srp_follow((&sr), &(d)->bd_next.se_next)) {
  ((void)_atomic_add_long_nv((&d->bd_rcount), 1));
...
bpf_mtap_ether(caddr_t arg, const struct mbuf *m, u_int direction)
{
 ...
 ((m->m_hdr.mh_len >= ((6 * 2) + 2)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1417, "m->m_len >= ETHER_HDR_LEN"));
 prio = m->M_dat.MH.MH_pkthdr.pf.prio;
 if (prio <= 1)
  prio = !prio;
 __builtin_memcpy((&evh), (((char *)((m)->m_hdr.mh_data))), (((6 * 2) + 2)));
 evh.evl_proto = evh.evl_encap_proto;
 evh.evl_encap_proto = ((__uint16_t)(0x8100));
 evh.evl_tag = ((__uint16_t)(m->M_dat.MH.MH_pkthdr.ether_vtag | (prio << 13)));
 mh.mh_flags = 0;
 mh.mh_data = m->m_hdr.mh_data + ((6 * 2) + 2);
 mh.mh_len = m->m_hdr.mh_len - ((6 * 2) + 2);
 mh.mh_next = m->m_hdr.mh_next;
 return bpf_mtap_hdr(arg, (caddr_t)&evh, sizeof(evh),
     (struct mbuf *)&mh, direction, ((void *)0));
}
void
    ...
    void (*cpfn)(const void *, void *, size_t), struct timeval *tv)
{
 ...
 if (totlen > d->bd_bufsize)
  totlen = d->bd_bufsize;
 curlen = (((d->bd_slen) + (sizeof(u_int32_t) - 1)) & ~(sizeof(u_int32_t) - 1));
 if (curlen + totlen > d->bd_bufsize) {
  if (d->bd_fbuf == ((void *)0)) {
   ++d->bd_dcount;
   return;
  }
  ((d->bd_in_uiomove == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1489, "d->bd_in_uiomove == 0")); do { if (((&d->bd_mtx)->mtx_owner != (__curcpu->ci_self)) && !(panicstr || db_active)) panic("mutex %p not held in %s", (&d->bd_mtx), __func__); } while (0); (d)->bd_hbuf = (d)->bd_sbuf; (d)->bd_hlen = (d)->bd_slen; (d)->bd_sbuf = (d)->bd_fbuf; (d)->bd_slen = 0; (d)->bd_fbuf = ((void *)0);;
  do_wakeup = 1;
  curlen = 0;
 }
 ...
 if (d->bd_rdStart && (d->bd_rtout + d->bd_rdStart < ticks)) {
  if (d->bd_fbuf != ((void *)0)) {
   d->bd_rdStart = 0;
   ((d->bd_in_uiomove == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1524, "d->bd_in_uiomove == 0")); do { if (((&d->bd_mtx)->mtx_owner != (__curcpu->ci_self)) && !(panicstr || db_active)) panic("mutex %p not held in %s", (&d->bd_mtx), __func__); } while (0); (d)->bd_hbuf = (d)->bd_sbuf; (d)->bd_hlen = (d)->bd_slen; (d)->bd_sbuf = (d)->bd_fbuf; (d)->bd_slen = 0; (d)->bd_fbuf = ((void *)0);;
   do_wakeup = 1;
  }
 }
 if (do_wakeup)
...
{
 do { if (((&d->bd_mtx)->mtx_owner != (__curcpu->ci_self)) && !(panicstr || db_active)) panic("mutex %p not held in %s", (&d->bd_mtx), __func__); } while (0);
 d->bd_fbuf = malloc(d->bd_bufsize, 2, 0x0002);
 if (d->bd_fbuf == ((void *)0))
  return (12);
 d->bd_sbuf = malloc(d->bd_bufsize, 2, 0x0002);
 if (d->bd_sbuf == ((void *)0)) {
  free(d->bd_fbuf, 2, d->bd_bufsize);
  return (12);
 }
 d->bd_slen = 0;
 d->bd_hlen = 0;
...
{
 ((void)_atomic_add_int_nv((&bd->bd_ref), 1));
}
void
bpf_put(struct bpf_d *bd)
{
 if (_atomic_sub_int_nv((&bd->bd_ref), 1) > 0)
  return;
 free(bd->bd_sbuf, 2, 0);
 free(bd->bd_hbuf, 2, 0);
 free(bd->bd_fbuf, 2, 0);
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1576, "_kernel_lock_held()"));
...
bpfdetach(struct ifnet *ifp)
{
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1627, "_kernel_lock_held()"));
    ...
    void *newp, size_t newlen)
{
 ...
 case 1:
  ...
  if (error)
   return (error);
  if (newval < 32 || newval > bpf_maxbufsize)
   return (22);
  bpf_bufsize = newval;
  break;
 case 2:
    ...
    size_t newlen)
{
 ...
 if (namelen != 1)
  return (20);
 flags |= (newp == ((void *)0)) ? 0x0002UL : 0x0001UL;
 error = _rw_enter(&bpf_sysctl_lk, flags );
 if (error != 0)
  return (error);
 error = bpf_sysctl_locked(name, namelen, oldp, oldlenp, newp, newlen);
 _rw_exit(&bpf_sysctl_lk );
 return (error);
}
struct bpf_d *
...
{
 struct bpf_d *bd;
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/bpf.c", 1719, "_kernel_lock_held()"));
...
bpf_insn_dtor(void *null, void *f)
{
 ...
 free(insns, 2, bf->bf_len * sizeof(*insns));
 free(bf, 2, sizeof(*bf));
}
...
bpf_mbuf_copy(const struct mbuf *m, u_int32_t off, void *buf, u_int32_t len)
{
 ...
 for (;;) {
  ...
  __builtin_memcpy((cp), (m->m_hdr.mh_data + off), (count));
  len -= count;
  if (len == 0)
   return (0);
  m = m->m_hdr.mh_next;
