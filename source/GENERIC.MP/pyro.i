# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c"
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c"
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
...
void device_register(struct device *, void *);
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyrovar.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyrovar.h"
struct pyro_msi_msg {
 uint8_t mm_type;
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c" 2
# 98 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c"
...
pyro_init(struct pyro_softc *sc, int busa)
{
 ...
 config_found_sm((&sc->sc_dv), (&pba), (pyro_print), ((void *)0));
}
...
pyro_init_msi(struct pyro_softc *sc, struct pyro_pbm *pbm)
{
 ...
 pbm->pp_msi = mallocarray(msis, sizeof(*pbm->pp_msi), 2,
     0x0002 | 0x0008);
 if (pbm->pp_msi == ((void *)0))
  return;

 msi_eq_size = getpropint(sc->sc_node, "msi-eq-size", 256);
 pbm->pp_meq = msi_eq_alloc(pbm->pp_dmat, msi_eq_size);
 if (pbm->pp_meq == ((void *)0))
  goto free_table;

 __builtin_bzero((pbm->pp_meq->meq_va), (pbm->pp_meq->meq_nentries * sizeof(struct pyro_msi_msg)));


 bus_space_write_8(sc->sc_bust, sc->sc_csrh, 0x10000,
 ...
 bus_space_write_8(sc->sc_bust, sc->sc_csrh, 0x34000,
     pbm->pp_msiaddr);

 bus_space_write_8(sc->sc_bust, sc->sc_csrh, 0x11800, 0);
 bus_space_write_8(sc->sc_bust, sc->sc_csrh, 0x11600, 0);
 ...
 if (pyro_intr_establish(pbm->pp_memt, sc->sc_bust, ihandle,
     15, 0, pyro_msi_eq_intr, pbm, sc->sc_dv.dv_xname) == ((void *)0))
  goto free_table;


 bus_space_write_8(sc->sc_bust, sc->sc_csrh, 0x11000,
...
pcireg_t
pyro_conf_read(pci_chipset_tag_t pc, pcitag_t tag, int reg64)
{
...
void
pyro_conf_write(pci_chipset_tag_t pc, pcitag_t tag, int reg64, pcireg_t data)
{
        bus_space_write_4(pc->bustag, pc->bushandle,
     (((tag)&0xffffffff) << 4) + reg64, data);
}
...
# 417 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/pyro.c"
 if (pa->pa_intrpin == 0)
  return (-1);
    ...
    int level, int flags, int (*handler)(void *), void *arg, const char *what)
{
 ...
 if (ihandle & 0x80000000) {
  ...
  reg64 = bus_space_read_8(sc->sc_bust, sc->sc_csrh,
      0x20000 + msinum * 8);
  reg64 &= ~0x000000000000003fUL;
  bus_space_write_8(sc->sc_bust, sc->sc_csrh,
      0x20000 + msinum * 8, reg64);

  bus_space_write_8(sc->sc_bust, sc->sc_csrh,
      0x28000 + msinum * 8, 0x4000000000000000UL);

  reg64 = bus_space_read_8(sc->sc_bust, sc->sc_csrh,
      0x20000 + msinum * 8);
  reg64 |= 0x8000000000000000UL;
  bus_space_write_8(sc->sc_bust, sc->sc_csrh,
      0x20000 + msinum * 8, reg64);
 ...
 ino = ((ihandle)&0x00000003fLL);

 if (level == 0)
  level = (((ihandle)>>11)&0x0f);
 if (level == 0) {
 ...
 if ((flags & 0x0002) == 0) {
  ...
  intrmapptr = &imap[ino];
  intrclrptr = &iclr[ino];
  ino |= ((ihandle)&(0x0000007c0LL|0x00000003fLL));
 }
 ...
 if (intrmapptr != ((void *)0)) {
  ...
  if (sc->sc_oberon) {
   intrmap &= ~0x7fe00000;
   intrmap |= (((__builtin_constant_p(0x4a) ? ({ u_int64_t __rldxu_int64_t; if(0x4a == 0x80 || (sizeof(u_int64_t) == 1 && 0x4a == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0)); else __asm volatile("ldxa" " [%1] " "0x4a" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0), 0x4a))) & 0x3ff) <<
       21;
  } else {
   intrmap &= ~0x7c000000;
   intrmap |= ((((__builtin_constant_p(0x4a) ? ({ u_int64_t __rldxu_int64_t; if(0x4a == 0x80 || (sizeof(u_int64_t) == 1 && 0x4a == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0)); else __asm volatile("ldxa" " [%1] " "0x4a" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0), 0x4a))) >> 17) & 0x1f) << 26;
  }
...
pyro_msi_eq_intr(void *arg)
{
 ...
 head = bus_space_read_8(sc->sc_bust, sc->sc_csrh, 0x11800);
 tail = bus_space_read_8(sc->sc_bust, sc->sc_csrh, 0x11600);
 ...
 bus_space_write_8(sc->sc_bust, sc->sc_csrh, 0x11800, head);
...
pyro_xir(void *arg, int cpu)
{
 ...
 bus_space_write_8(sc->sc_bust, sc->sc_xbch, 0x7010,
