# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/cdio.h" 1
# 12 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/cdio.h"
union msf_lba {
 struct {
  u_char unused;
  u_char minute;
...
# 223 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/cdio.h"
struct ioc_play_msf {
 u_char start_m;
 u_char start_s;
 u_char start_f;
...
# 261 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/cdio.h"
struct dvd_layer {
...
# 355 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/cdio.h"
...
# 392 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/cdio.h"
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c" 2
...
vn_open(struct nameidata *ndp, int fmode, int cmode)
{
 ...
 if ((fmode & (0x0001|0x0002)) == 0)
  return (22);
 if ((fmode & (0x0400 | 0x0002)) == 0x0400)
  return (22);
 if (fmode & 0x0200) {
  ndp->ni_cnd.cn_nameiop = 1;
  ndp->ni_cnd.cn_flags = 0x0008 | 0x0004;
  if ((fmode & 0x0800) == 0 && (fmode & 0x0100) == 0)
   ndp->ni_cnd.cn_flags |= 0x0040;
  ...
  ndp->ni_cnd.cn_flags =
      ((fmode & 0x0100) ? 0x0000 : 0x0040) | 0x0004;
  if ((error = namei(ndp)) != 0)
   return (error);
  vp = ndp->ni_vp;
 }
 ...
 if ((fmode & 0x20000) && vp->v_type != VDIR) {
  error = 20;
  goto bad;
 }
 if ((fmode & 0x0200) == 0) {
  if (fmode & 0x0001) {
   if ((error = VOP_ACCESS(vp, 00400, cred, p)) != 0)
    goto bad;
  }
  if (fmode & 0x0002) {
   if (vp->v_type == VDIR) {
   ...
   if ((error = vn_writechk(vp)) != 0 ||
       (error = VOP_ACCESS(vp, 00200, cred, p)) != 0)
    goto bad;
  }
 }
 if ((fmode & 0x0400) && vp->v_type == VREG) {
  vattr_null(&va);
  va.va_size = 0;
...
# 233 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_vnops.c"
int
 ...
 *overrun = 0;
 if (vp->v_type == VREG && p != ((void *)0) && !(ioflag & 0x20)) {
  rlim_t limit = p->p_p->ps_limit->pl_rlimit[1].rlim_cur;
...
vn_ioctl(struct file *fp, u_long com, caddr_t data, struct proc *p)
{
 ...
 case VREG:
 case VDIR:
  if (com == ((unsigned long)0x40000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((127)))) {
  ...
  if (com == ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((126))) || com == ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('f')) << 8) | ((125))))
   return (0);
 ...
 case VBLK:
  ...
  if (error == 0 && com == ((unsigned long)0x20000000 | ((0 & 0x1fff) << 16) | ((('t')) << 8) | ((97)))) {
...
vn_closefile(struct file *fp, struct proc *p)
{
 ...
 if ((fp->f_iflags & 0x01)) {
  ...
  lf.l_len = 0;
  lf.l_type = 2;
  (void) VOP_ADVLOCK(vp, (caddr_t)fp, 2, &lf, 0x020);
 }
...
vn_isunder(struct vnode *lvp, struct vnode *rvp, struct proc *p)
{
 ...
 error = vfs_getcwd_common(lvp, rvp, ((void *)0), ((void *)0), 1024/2, 0, p);
