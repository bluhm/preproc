# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c"
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c"
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c" 2
      ...
      struct drm_display_mode *mode)
{
 ...
 r100_mm_wreg(rdev, (0x0230 + radeon_crtc->crtc_offset), (0), 0);
 r100_mm_wreg(rdev, (0x0234 + radeon_crtc->crtc_offset), (0), 0);
 r100_mm_wreg(rdev, (0x0238 + radeon_crtc->crtc_offset), (0), 0);
}
           ...
           struct drm_display_mode *mode)
{
 ...
 case RMX_ASPECT:
  if (!hscale)
   ...
   inc = (fp_horz_stretch & (1 << 31)) ? 1 : 0;
   scale = ((xres + inc) * 4096)
    / native_mode->hdisplay + 1;
   fp_horz_stretch |= (((scale) & 0xffff) |
     (1 << 26) |
     (1 << 25) |
  ...
  if (!vscale)
   ...
   inc = (fp_vert_stretch & (1 << 31)) ? 1 : 0;
   scale = ((yres + inc) * 4096)
    / native_mode->vdisplay + 1;
   fp_vert_stretch |= (((scale) & 0xfff) |
     (1 << 25) |
     (1 << 26) |
 ...
 r100_mm_wreg(rdev, (0x028c), (fp_horz_stretch), 0);
 r100_mm_wreg(rdev, (0x0290), (fp_vert_stretch), 0);
 r100_mm_wreg(rdev, (0x27c), (crtc_more_cntl), 0);
 r100_mm_wreg(rdev, (0x0278), (fp_horz_vert_active), 0);
 r100_mm_wreg(rdev, (0x02c4), (fp_h_sync_strt_wid), 0);
 r100_mm_wreg(rdev, (0x02c8), (fp_v_sync_strt_wid), 0);
 r100_mm_wreg(rdev, (0x0250), (fp_crtc_h_total_disp), 0);
 r100_mm_wreg(rdev, (0x0254), (fp_crtc_v_total_disp), 0);
}
...
static void radeon_pll_wait_for_read_update_complete(struct drm_device *dev)
{
 ...
 for (i = 0;
      (i < 10000 &&
       rdev->pll_rreg(rdev, (0x0003)) & (1 << 15));
      i++);
}
...
static void radeon_pll_write_update(struct drm_device *dev)
{
 ...
 while (rdev->pll_rreg(rdev, (0x0003)) & (1 << 15));

 do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x0003)); tmp_ &= (~((1 << 15))); tmp_ |= (((1 << 15)) & ~(~((1 << 15)))); rdev->pll_wreg(rdev, (0x0003), (tmp_)); } while (0);
...
static void radeon_pll2_wait_for_read_update_complete(struct drm_device *dev)
{
 ...
 for (i = 0;
      (i < 10000 &&
       rdev->pll_rreg(rdev, (0x002B)) & (1 << 15));
      i++);
}
...
static void radeon_pll2_write_update(struct drm_device *dev)
{
 ...
 while (rdev->pll_rreg(rdev, (0x002B)) & (1 << 15));

 do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x002B)); tmp_ &= (~((1 << 15))); tmp_ |= (((1 << 15)) & ~(~((1 << 15)))); rdev->pll_wreg(rdev, (0x002B), (tmp_)); } while (0);
...
static void radeon_crtc_dpms(struct drm_crtc *crtc, int mode)
{
 ...
 if (radeon_crtc->crtc_id)
  ...
  mask = ((1 << 10) |
   (1 << 9) |
   (1 << 8));
# 319 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c"
 ...
 case 0:
  ...
  if (radeon_crtc->crtc_id)
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x03f8), 0); tmp_ &= (~((1 << 25) | mask)); tmp_ |= (((1 << 25)) & ~(~((1 << 25) | mask))); r100_mm_wreg(rdev, (0x03f8), (tmp_), 0); } while (0);
  else {
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x0050), 0); tmp_ &= (~((1 << 25) | (1 << 26))); tmp_ |= (((1 << 25)) & ~(~((1 << 25) | (1 << 26)))); r100_mm_wreg(rdev, (0x0050), (tmp_), 0); } while (0);

   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x0054), 0); tmp_ &= (~(mask | crtc_ext_cntl)); tmp_ |= ((crtc_ext_cntl) & ~(~(mask | crtc_ext_cntl))); r100_mm_wreg(rdev, (0x0054), (tmp_), 0); } while (0);
  }
 ...
 case 3:
  ...
  if (radeon_crtc->crtc_id)
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x03f8), 0); tmp_ &= (~((1 << 25) | mask)); tmp_ |= ((mask) & ~(~((1 << 25) | mask))); r100_mm_wreg(rdev, (0x03f8), (tmp_), 0); } while (0);
  else {
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x0050), 0); tmp_ &= (~((1 << 25) | (1 << 26))); tmp_ |= (((1 << 26)) & ~(~((1 << 25) | (1 << 26)))); r100_mm_wreg(rdev, (0x0050), (tmp_), 0); } while (0);

   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x0054), 0); tmp_ &= (~(mask | crtc_ext_cntl)); tmp_ |= ((mask) & ~(~(mask | crtc_ext_cntl))); r100_mm_wreg(rdev, (0x0054), (tmp_), 0); } while (0);
  }
...
retry:
 ...
 r = radeon_bo_pin_restricted(rbo, 0x4, 1 << 27,
         &base);
 if (__builtin_expect(!!(r != 0), 0)) {
  radeon_bo_unreserve(rbo);
# 448 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c"
  if (!atomic && fb && fb != crtc->primary->fb) {
   struct radeon_bo *old_rbo;
   unsigned long nsize, osize;

   old_rbo = ({ __typeof( ((struct radeon_bo *)0)->gem_base ) *__mptr = ((({ __typeof( ((struct radeon_framebuffer *)0)->base ) *__mptr = (fb); (struct radeon_framebuffer *)( (char *)__mptr - __builtin_offsetof(struct radeon_framebuffer, base) );})->obj)); (struct radeon_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_bo, gem_base) );});
 ...
 radeon_bo_unreserve(rbo);
 if (tiling_flags & 0x2)
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "trying to scanout microtiled buffer\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 ...
 if (tiling_flags & 0x1) {
  if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480)))
   crtc_offset_cntl |= ((1 << 9) |
          (3 << 10) |
          (1 << 15));
  else
   crtc_offset_cntl |= (1 << 15);
 } else {
  if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480)))
   crtc_offset_cntl &= ~((1 << 9) |
           (3 << 10) |
 ...
 gen_cntl_val = r100_mm_rreg(rdev, (gen_cntl_reg), 0);
 gen_cntl_val &= ~(0xf << 8);
 gen_cntl_val |= (format << 8);
 gen_cntl_val &= ~(3 << 17);
 r100_mm_wreg(rdev, (gen_cntl_reg), (gen_cntl_val), 0);

 crtc_offset = (u32)base;

 r100_mm_wreg(rdev, (0x23c + radeon_crtc->crtc_offset), (radeon_crtc->legacy_display_base_addr), 0);

 if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480))) {
  if (radeon_crtc->crtc_id)
   r100_mm_wreg(rdev, (0x0358), (crtc_tile_x0_y0), 0);
  else
   r100_mm_wreg(rdev, (0x0350), (crtc_tile_x0_y0), 0);
 }
 r100_mm_wreg(rdev, (0x0228 + radeon_crtc->crtc_offset), (crtc_offset_cntl), 0);
 r100_mm_wreg(rdev, (0x0224 + radeon_crtc->crtc_offset), (crtc_offset), 0);
 r100_mm_wreg(rdev, (0x022c + radeon_crtc->crtc_offset), (crtc_pitch), 0);
...
static _Bool radeon_set_crtc_timing(struct drm_crtc *crtc, struct drm_display_mode *mode)
{
 struct drm_device *dev = crtc->dev;
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_crtc *radeon_crtc = ({ __typeof( ((struct radeon_crtc *)0)->base ) *__mptr = (crtc); (struct radeon_crtc *)( (char *)__mptr - __builtin_offsetof(struct radeon_crtc, base) );});
 ...
 if (radeon_crtc->crtc_id) {
  ...
  crtc2_gen_cntl = r100_mm_rreg(rdev, (0x03f8), 0) & 0x00718080;
  ...
  disp2_merge_cntl = r100_mm_rreg(rdev, (0x0d68), 0);
  disp2_merge_cntl &= ~(1 << 8);

  r100_mm_wreg(rdev, (0x0d68), (disp2_merge_cntl), 0);
  r100_mm_wreg(rdev, (0x03f8), (crtc2_gen_cntl), 0);

  r100_mm_wreg(rdev, (0x03c4), (crtc_h_sync_strt_wid), 0);
  r100_mm_wreg(rdev, (0x03c8), (crtc_v_sync_strt_wid), 0);
 } else {
  uint32_t crtc_gen_cntl;
  uint32_t crtc_ext_cntl;
  uint32_t disp_merge_cntl;

  crtc_gen_cntl = r100_mm_rreg(rdev, (0x0050), 0) & 0x00718000;
  crtc_gen_cntl |= ((1 << 24)
     | (format << 8)
     | (1 << 26)
     | ((mode->flags & (1<<5))
  ...
  r100_mm_wreg(rdev, (0x0050), (crtc_gen_cntl), 0);
 ...
 r100_mm_wreg(rdev, (0x0200 + radeon_crtc->crtc_offset), (crtc_h_total_disp), 0);
 r100_mm_wreg(rdev, (0x0204 + radeon_crtc->crtc_offset), (crtc_h_sync_strt_wid), 0);
 r100_mm_wreg(rdev, (0x0208 + radeon_crtc->crtc_offset), (crtc_v_total_disp), 0);
 r100_mm_wreg(rdev, (0x020c + radeon_crtc->crtc_offset), (crtc_v_sync_strt_wid), 0);
...
static void radeon_set_pll(struct drm_crtc *crtc, struct drm_display_mode *mode)
{
 ...
 if (radeon_crtc->crtc_id) {
  uint32_t pixclks_cntl = ((rdev->pll_rreg(rdev, (0x002d)) &
       ~(0x03)) |
      0x03);
  ...
  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x002d)); tmp_ &= (~(0x03)); tmp_ |= ((0x00) & ~(~(0x03))); rdev->pll_wreg(rdev, (0x002d), (tmp_)); } while (0);



  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x002a)); tmp_ &= (~((1 << 0) | (1 << 16) | (7 << 11))); tmp_ |= (((1 << 0) | (1 << 16) | ((uint32_t)pll_gain << 11)) & ~(~((1 << 0) | (1 << 16) | (7 << 11)))); rdev->pll_wreg(rdev, (0x002a), (tmp_)); } while (0);
  ...
  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x002B)); tmp_ &= (~0x03ff); tmp_ |= ((pll_ref_div) & ~(~0x03ff)); rdev->pll_wreg(rdev, (0x002B), (tmp_)); } while (0);



  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x002c)); tmp_ &= (~0x07ff); tmp_ |= ((pll_fb_post_div) & ~(~0x07ff)); rdev->pll_wreg(rdev, (0x002c), (tmp_)); } while (0);



  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x002c)); tmp_ &= (~0x00070000); tmp_ |= ((pll_fb_post_div) & ~(~0x00070000)); rdev->pll_wreg(rdev, (0x002c), (tmp_)); } while (0);
  ...
  rdev->pll_wreg(rdev, (0x002e), (htotal_cntl));

  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x002a)); tmp_ &= (~((1 << 0) | (1 << 1) | (1 << 16))); tmp_ |= ((0) & ~(~((1 << 0) | (1 << 1) | (1 << 16)))); rdev->pll_wreg(rdev, (0x002a), (tmp_)); } while (0);
  ...
  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x002d)); tmp_ &= (~(0x03)); tmp_ |= ((0x03) & ~(~(0x03))); rdev->pll_wreg(rdev, (0x002d), (tmp_)); } while (0);
  ...
  if (rdev->flags & RADEON_IS_MOBILITY) {
   ...
   if ((pll_ref_div == (rdev->pll_rreg(rdev, (0x0003)) & 0x03ff)) &&
       (pll_fb_post_div == (rdev->pll_rreg(rdev, (0x0007)) &
       (0x00070000 | 0x07ff)))) {
    do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x0008), 0); tmp_ &= (~((3 << 8))); tmp_ |= (((3 << 8)) & ~(~((3 << 8)))); r100_mm_wreg(rdev, (0x0008), (tmp_), 0); } while (0);
  ...
  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x0008)); tmp_ &= (~(0x03)); tmp_ |= ((0x00) & ~(~(0x03))); rdev->pll_wreg(rdev, (0x0008), (tmp_)); } while (0);


  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x0002)); tmp_ &= (~((1 << 0) | (1 << 16) | (1 << 17) | (7 << 11))); tmp_ |= (((1 << 0) | (1 << 16) | (1 << 17) | ((uint32_t)pll_gain << 11)) & ~(~((1 << 0) | (1 << 16) | (1 << 17) | (7 << 11)))); rdev->pll_wreg(rdev, (0x0002), (tmp_)); } while (0);
# 962 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_crtc.c"
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x0008), 0); tmp_ &= (~((3 << 8))); tmp_ |= (((3 << 8)) & ~(~((3 << 8)))); r100_mm_wreg(rdev, (0x0008), (tmp_), 0); } while (0);
  ...
  if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480)) ||
   ...
   if (pll_ref_div & (0x3ff << 18)) {



    do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x0003)); tmp_ &= (0); tmp_ |= ((pll_ref_div) & ~(0)); rdev->pll_wreg(rdev, (0x0003), (tmp_)); } while (0);


   } else {

    do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x0003)); tmp_ &= (~(0x3ff << 18)); tmp_ |= (((pll_ref_div << 18)) & ~(~(0x3ff << 18))); rdev->pll_wreg(rdev, (0x0003), (tmp_)); } while (0);


   }
  } else
   do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x0003)); tmp_ &= (~0x03ff); tmp_ |= ((pll_ref_div) & ~(~0x03ff)); rdev->pll_wreg(rdev, (0x0003), (tmp_)); } while (0);



  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x0007)); tmp_ &= (~0x07ff); tmp_ |= ((pll_fb_post_div) & ~(~0x07ff)); rdev->pll_wreg(rdev, (0x0007), (tmp_)); } while (0);



  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x0007)); tmp_ &= (~0x00070000); tmp_ |= ((pll_fb_post_div) & ~(~0x00070000)); rdev->pll_wreg(rdev, (0x0007), (tmp_)); } while (0);
  ...
  rdev->pll_wreg(rdev, (0x0009), (htotal_cntl));

  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x0002)); tmp_ &= (~((1 << 0) | (1 << 1) | (1 << 16) | (1 << 17))); tmp_ |= ((0) & ~(~((1 << 0) | (1 << 1) | (1 << 16) | (1 << 17)))); rdev->pll_wreg(rdev, (0x0002), (tmp_)); } while (0);
  ...
  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x0008)); tmp_ &= (~(0x03)); tmp_ |= ((0x03) & ~(~(0x03))); rdev->pll_wreg(rdev, (0x0008), (tmp_)); } while (0);
...
static _Bool radeon_crtc_mode_fixup(struct drm_crtc *crtc,
       const struct drm_display_mode *mode,
       struct drm_display_mode *adjusted_mode)
{
     ...
     int x, int y, struct drm_framebuffer *old_fb)
{
 ...
 if (radeon_crtc->crtc_id == 0) {
  ...
  if (radeon_crtc->rmx_type != RMX_OFF) {
   ...
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Mode need scaling but only first crtc can do that.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  }
 }
 return 0;
}
...
static void radeon_crtc_prepare(struct drm_crtc *crtc)
{
 ...
 for (crtci = ({ __typeof( ((__typeof(*crtci) *)0)->head ) *__mptr = ((&dev->mode_config.crtc_list)->next); (__typeof(*crtci) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtci), head) );}); &crtci->head != (&dev->mode_config.crtc_list); crtci = ({ __typeof( ((__typeof(*crtci) *)0)->head ) *__mptr = (crtci->head.next); (__typeof(*crtci) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtci), head) );}))
  radeon_crtc_dpms(crtci, 3);
}
...
{
 if (radeon_crtc->crtc_id == 1)
  radeon_crtc->crtc_offset = 0x0300 - 0x0200;
