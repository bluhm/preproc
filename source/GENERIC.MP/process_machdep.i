# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c"
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c"
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c" 2
...
int process_domem(struct proc *_curp, struct process *_tr, struct uio *,
     int _req);
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c" 2
 ...
 struct reg64 *regs;
{
 ...
 if (!((__curcpu->ci_self)->ci_curproc->p_flag & 0)) {
 ...
 regp->r_psr = (((tf->tf_tstate)&0xff00000000LL)>>(32 -19));
 regp->r_pc = tf->tf_pc;
 ...
 struct fpreg64 *regs;
{
 ...
 if (!((__curcpu->ci_self)->ci_curproc->p_flag & 0)) {
  ...
  __builtin_bcopy((statep), (regs), (sizeof(struct fpreg64)));
  return 0;
 }
 ...
 struct reg64 *regs;
{
 ...
 if (!((__curcpu->ci_self)->ci_curproc->p_flag & 0)) {
  ...
  tf->tf_tstate = (tf->tf_tstate & ~0xff00000000LL) |
   (regs->r_tstate & 0xff00000000LL);
  return (0);
 }
 ...
 tf->tf_tstate = (int64_t)(tf->tf_tstate & ~0xff00000000LL) |
  (((int64_t)(regp->r_psr)&0x00f00000)<<(32 -19));
 return (0);
}
# 195 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/process_machdep.c"
int
 ...
 struct fpreg64 *regs;
{
 ...
 if (!((__curcpu->ci_self)->ci_curproc->p_flag & 0)) {
  ...
  __builtin_bcopy((regs), (p->p_md.md_fpstate), (sizeof(struct fpreg64)));
