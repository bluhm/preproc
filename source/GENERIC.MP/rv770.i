...
int rv770_set_uvd_clocks(struct radeon_device *rdev, u32 vclk, u32 dclk)
{
 ...
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x71c), 0); tmp_ &= (~(0x01F00000 | 0x3E000000)); tmp_ |= ((((1) << 20) | ((1) << 25)) & ~(~(0x01F00000 | 0x3E000000))); r100_mm_wreg(rdev, (0x71c), (tmp_), 0); } while (0);
 if (!vclk || !dclk) {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x00000002); tmp_ |= ((0x00000002) & ~(~0x00000002)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
  return 0;
 }
 ...
 vclk_div -= 1;
 dclk_div -= 1;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x720), 0); tmp_ &= (~0x01FFFFFF); tmp_ |= ((((0x50000) << 0)) & ~(~0x01FFFFFF)); r100_mm_wreg(rdev, (0x720), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~(0x00000001 | 0x00000002)); tmp_ |= ((0) & ~(~(0x00000001 | 0x00000002))); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x00000004); tmp_ |= ((0x00000004) & ~(~0x00000004)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x720), 0); tmp_ &= (~((1) << 0)); tmp_ |= ((((1) << 0)) & ~(~((1) << 0))); r100_mm_wreg(rdev, (0x720), (tmp_), 0); } while (0);
 r = radeon_uvd_send_upll_ctlreq(rdev, 0x718);
 if (r)
  return r;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x00000001); tmp_ |= ((0x00000001) & ~(~0x00000001)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x003F0000); tmp_ |= ((((1) << 16)) & ~(~0x003F0000)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x71c), 0); tmp_ &= (~0x0000FFFF); tmp_ |= ((((vclk_div >> 1) << 0) | (((vclk_div >> 1) + (vclk_div & 1)) << 4) | ((dclk_div >> 1) << 8) | (((dclk_div >> 1) + (dclk_div & 1)) << 12)) & ~(~0x0000FFFF)); r100_mm_wreg(rdev, (0x71c), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x720), 0); tmp_ &= (~0x01FFFFFF); tmp_ |= ((((fb_div) << 0)) & ~(~0x01FFFFFF)); r100_mm_wreg(rdev, (0x720), (tmp_), 0); } while (0);
 mdelay(15);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x00000001); tmp_ |= ((0) & ~(~0x00000001)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 mdelay(15);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x00000004); tmp_ |= ((0) & ~(~0x00000004)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x720), 0); tmp_ &= (~((1) << 0)); tmp_ |= ((0) & ~(~((1) << 0))); r100_mm_wreg(rdev, (0x720), (tmp_), 0); } while (0);
 r = radeon_uvd_send_upll_ctlreq(rdev, 0x718);
 if (r)
  return r;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x71c), 0); tmp_ &= (~(0x01F00000 | 0x3E000000)); tmp_ |= ((((2) << 20) | ((2) << 25)) & ~(~(0x01F00000 | 0x3E000000))); r100_mm_wreg(rdev, (0x71c), (tmp_), 0); } while (0);
 mdelay(100);
 return 0;
}
...
static void rv770_init_golden_registers(struct radeon_device *rdev)
{
 ...
 case CHIP_RV770:
  radeon_program_register_sequence(rdev,
       ...
       (const u32)(sizeof((r7xx_golden_registers)) / sizeof((r7xx_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       r7xx_golden_dyn_gpr_registers,
       (const u32)(sizeof((r7xx_golden_dyn_gpr_registers)) / sizeof((r7xx_golden_dyn_gpr_registers)[0])));
  if (rdev->pdev->device == 0x994e)
   radeon_program_register_sequence(rdev,
        rv770ce_golden_registers,
        (const u32)(sizeof((rv770ce_golden_registers)) / sizeof((rv770ce_golden_registers)[0])));
  else
   radeon_program_register_sequence(rdev,
        rv770_golden_registers,
        (const u32)(sizeof((rv770_golden_registers)) / sizeof((rv770_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       rv770_mgcg_init,
       (const u32)(sizeof((rv770_mgcg_init)) / sizeof((rv770_mgcg_init)[0])));
  break;
 case CHIP_RV730:
  radeon_program_register_sequence(rdev,
       r7xx_golden_registers,
  ...
  radeon_program_register_sequence(rdev,
       ...
       (const u32)(sizeof((rv730_golden_registers)) / sizeof((rv730_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       rv730_mgcg_init,
       (const u32)(sizeof((rv730_mgcg_init)) / sizeof((rv730_mgcg_init)[0])));
  break;
 case CHIP_RV710:
  radeon_program_register_sequence(rdev,
       r7xx_golden_registers,
  ...
  radeon_program_register_sequence(rdev,
       ...
       (const u32)(sizeof((rv710_golden_registers)) / sizeof((rv710_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       rv710_mgcg_init,
       (const u32)(sizeof((rv710_mgcg_init)) / sizeof((rv710_mgcg_init)[0])));
  break;
 case CHIP_RV740:
  radeon_program_register_sequence(rdev,
       rv740_golden_registers,
       (const u32)(sizeof((rv740_golden_registers)) / sizeof((rv740_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       rv740_mgcg_init,
       (const u32)(sizeof((rv740_mgcg_init)) / sizeof((rv740_mgcg_init)[0])));
  break;
 default:
  break;
 }
...
u32 rv770_get_xclk(struct radeon_device *rdev)
{
 ...
 u32 tmp = r100_mm_rreg(rdev, (0x660), 0);
 if (tmp & (1 << 8))
  return (10000 / 10);
 if (tmp & (1 << 9))
...
void rv770_page_flip(struct radeon_device *rdev, int crtc_id, u64 crtc_base)
{
 ...
 u32 tmp = r100_mm_rreg(rdev, (0x6144 + radeon_crtc->crtc_offset), 0);
 int i;
 tmp |= (1 << 16);
 r100_mm_wreg(rdev, (0x6144 + radeon_crtc->crtc_offset), (tmp), 0);
 if (radeon_crtc->crtc_id) {
  r100_mm_wreg(rdev, (0x611c), (((u32)(((crtc_base) >> 16) >> 16))), 0);
  r100_mm_wreg(rdev, (0x6114), (((u32)(((crtc_base) >> 16) >> 16))), 0);
 } else {
  r100_mm_wreg(rdev, (0x691c), (((u32)(((crtc_base) >> 16) >> 16))), 0);
  r100_mm_wreg(rdev, (0x6914), (((u32)(((crtc_base) >> 16) >> 16))), 0);
 }
 r100_mm_wreg(rdev, (0x6118 + radeon_crtc->crtc_offset), ((u32)crtc_base), 0);
 r100_mm_wreg(rdev, (0x6110 + radeon_crtc->crtc_offset), ((u32)crtc_base), 0);
 for (i = 0; i < rdev->usec_timeout; i++) {
  if (r100_mm_rreg(rdev, (0x6144 + radeon_crtc->crtc_offset), 0) & (1 << 2))
   break;
  udelay(1);
 }
 do { } while( 0);
...
_Bool rv770_page_flip_pending(struct radeon_device *rdev, int crtc_id)
{
 struct radeon_crtc *radeon_crtc = rdev->mode_info.crtcs[crtc_id];
 return !!(r100_mm_rreg(rdev, (0x6144 + radeon_crtc->crtc_offset), 0) &
  (1 << 2));
}
int rv770_get_temp(struct radeon_device *rdev)
{
 u32 temp = (r100_mm_rreg(rdev, (0x740), 0) & 0x3FF0000) >>
  16;
 int actual_temp;
 if (temp & 0x400)
  actual_temp = -256;
...
static int rv770_pcie_gart_enable(struct radeon_device *rdev)
{
 ...
 if (r)
  return r;
 r100_mm_wreg(rdev, (0x1400), ((1 << 0) | (1 << 1) | (1 << 9) | (((7) & 7) << 14)), 0);
 r100_mm_wreg(rdev, (0x1404), (0), 0);
 r100_mm_wreg(rdev, (0x1408), (((0) << 0) | ((2) << 6)), 0);
 tmp = (1 << 0) | (1 << 1) |
  (3 << 3) |
  (0 << 5) |
  ((5)<<15) | ((5)<<18);
 r100_mm_wreg(rdev, (0x2654), (tmp), 0);
 r100_mm_wreg(rdev, (0x2658), (tmp), 0);
 r100_mm_wreg(rdev, (0x265C), (tmp), 0);
 if (rdev->family == CHIP_RV740)
  r100_mm_wreg(rdev, (0x2698), (tmp), 0);
 r100_mm_wreg(rdev, (0x2234), (tmp), 0);
 r100_mm_wreg(rdev, (0x2238), (tmp), 0);
 r100_mm_wreg(rdev, (0x223C), (tmp), 0);
 r100_mm_wreg(rdev, (0x2240), (tmp), 0);
 r100_mm_wreg(rdev, (0x155C), (rdev->mc.gtt_start >> 12), 0);
 r100_mm_wreg(rdev, (0x157C), (rdev->mc.gtt_end >> 12), 0);
 r100_mm_wreg(rdev, (0x153C), (rdev->gart.table_addr >> 12), 0);
 r100_mm_wreg(rdev, (0x1410), ((1 << 0) | (((0) & 3) << 1) | (1 << 4)), 0);
 r100_mm_wreg(rdev, (0x1518), ((u32)(rdev->dummy_page.addr >> 12)), 0);
 for (i = 1; i < 7; i++)
...
static void rv770_pcie_gart_disable(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < 7; i++)
  r100_mm_wreg(rdev, (0x1410 + (i * 4)), (0), 0);
 r100_mm_wreg(rdev, (0x1400), ((1 << 1) | (((7) & 7) << 14)), 0);
 r100_mm_wreg(rdev, (0x1404), (0), 0);
 r100_mm_wreg(rdev, (0x1408), (((0) << 0) | ((2) << 6)), 0);
 tmp = ((5)<<15) | ((5)<<18);
 r100_mm_wreg(rdev, (0x2654), (tmp), 0);
...
static void rv770_mc_program(struct radeon_device *rdev)
{
 ...
 tmp = r100_mm_rreg(rdev, (0x2F34), 0);
 ...
 if (rdev->flags & RADEON_IS_AGP) {
  if (rdev->mc.vram_start < rdev->mc.gtt_start) {
   r100_mm_wreg(rdev, (0x2034), (rdev->mc.vram_start >> 12), 0);
   r100_mm_wreg(rdev, (0x2038), (rdev->mc.gtt_end >> 12), 0);
  } else {
   r100_mm_wreg(rdev, (0x2034), (rdev->mc.gtt_start >> 12), 0);
   r100_mm_wreg(rdev, (0x2038), (rdev->mc.vram_end >> 12), 0);
  }
 } else {
  r100_mm_wreg(rdev, (0x2034), (rdev->mc.vram_start >> 12), 0);
  r100_mm_wreg(rdev, (0x2038), (rdev->mc.vram_end >> 12), 0);
 }
 r100_mm_wreg(rdev, (0x203C), (rdev->vram_scratch.gpu_addr >> 12), 0);
 tmp = ((rdev->mc.vram_end >> 24) & 0xFFFF) << 16;
 tmp |= ((rdev->mc.vram_start >> 24) & 0xFFFF);
 r100_mm_wreg(rdev, (0x2024), (tmp), 0);
 r100_mm_wreg(rdev, (0x2C04), ((rdev->mc.vram_start >> 8)), 0);
 r100_mm_wreg(rdev, (0x2C08), ((2 << 7)), 0);
 r100_mm_wreg(rdev, (0x2C0C), (0x3FFFFFFF), 0);
 if (rdev->flags & RADEON_IS_AGP) {
  r100_mm_wreg(rdev, (0x2028), (rdev->mc.gtt_end >> 16), 0);
  r100_mm_wreg(rdev, (0x202C), (rdev->mc.gtt_start >> 16), 0);
  r100_mm_wreg(rdev, (0x2030), (rdev->mc.agp_base >> 22), 0);
 } else {
  r100_mm_wreg(rdev, (0x2030), (0), 0);
  r100_mm_wreg(rdev, (0x2028), (0x0FFFFFFF), 0);
  r100_mm_wreg(rdev, (0x202C), (0x0FFFFFFF), 0);
 }
 if (r600_mc_wait_for_idle(rdev)) {
  printf("drm:pid%d:%s *WARNING* " "Wait for MC idle timedout !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 }
...
void r700_cp_stop(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x86D8), (((1 << 28) | (1 << 26))), 0);
...
void rv770_set_clk_bypass_mode(struct radeon_device *rdev)
{
 ...
 if (rdev->flags & RADEON_IS_IGP)
  return;
 tmp = r100_mm_rreg(rdev, (0x604), 0);
 tmp &= (0x1ff << 0);
 tmp |= ((1) << 0) | (1 << 26);
 r100_mm_wreg(rdev, (0x604), (tmp), 0);
 for (i = 0; i < rdev->usec_timeout; i++) {
  if (r100_mm_rreg(rdev, (0x60c), 0) & (1 << 1))
   break;
  udelay(1);
 }
 tmp &= ~(1 << 26);
 r100_mm_wreg(rdev, (0x604), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x61c), 0);
 if ((rdev->family == CHIP_RV710) || (rdev->family == CHIP_RV730))
  tmp &= ~(1 << 25);
 else
  tmp &= ~(1 << 11);
 r100_mm_wreg(rdev, (0x61c), (tmp), 0);
}
static void rv770_gpu_init(struct radeon_device *rdev)
{
 ...
 mc_arb_ramcfg = r100_mm_rreg(rdev, (0x2760), 0);
 shader_pipe_config = r100_mm_rreg(rdev, (0x8950), 0);
 inactive_pipes = (shader_pipe_config & 0x0000FF00) >> 8;
 for (i = 0, tmp = 1, active_number = 0; i < 8; i++) {
 ...
 if (active_number == 1) {
  r100_mm_wreg(rdev, (0x9100), ((1 << 5)), 0);
 } else {
  r100_mm_wreg(rdev, (0x9100), (0), 0);
 }
 cc_gc_shader_pipe_config = r100_mm_rreg(rdev, (0x8950), 0) & 0xffffff00;
 tmp = rdev->config.rv770.max_simds -
  r600_count_pipe_bits((cc_gc_shader_pipe_config >> 16) & 0xffff);
 rdev->config.rv770.active_simds = tmp;
 switch (rdev->config.rv770.max_tile_pipes) {
 case 1:
 default:
  gb_tiling_config = ((0) << 1);
  break;
 case 2:
  gb_tiling_config = ((1) << 1);
  break;
 case 4:
  gb_tiling_config = ((2) << 1);
  break;
 case 8:
  gb_tiling_config = ((3) << 1);
  break;
 }
 ...
 tmp = (gb_tiling_config & 0x0000000e) >> 1;
 tmp = r6xx_remap_render_backend(rdev, tmp, rdev->config.rv770.max_backends,
     8, disabled_rb_mask);
 gb_tiling_config |= tmp << 16;
 rdev->config.rv770.backend_map = tmp;
 if (rdev->family == CHIP_RV770)
  gb_tiling_config |= ((1) << 4);
 else {
  if ((mc_arb_ramcfg & 0x00000003) >> 0)
   gb_tiling_config |= ((1) << 4);
  else
   gb_tiling_config |= ((0) << 4);
 }
 rdev->config.rv770.tiling_nbanks = 4 << ((gb_tiling_config >> 4) & 0x3);
 gb_tiling_config |= (((mc_arb_ramcfg & 0x00000200) >> 9) << 6);
 if (((mc_arb_ramcfg & 0x00000038) >> 3) > 3) {
  gb_tiling_config |= ((3) << 8);
  gb_tiling_config |= ((3) << 14);
 } else {
  gb_tiling_config |=
   ((((mc_arb_ramcfg & 0x00000038) >> 3)) << 8);
  gb_tiling_config |=
   ((((mc_arb_ramcfg & 0x00000038) >> 3)) << 14);
 }
 gb_tiling_config |= ((1) << 11);
 rdev->config.rv770.tile_config = gb_tiling_config;
 r100_mm_wreg(rdev, (0x98F0), (gb_tiling_config), 0);
 r100_mm_wreg(rdev, (0x6CA0), ((gb_tiling_config & 0xffff)), 0);
 r100_mm_wreg(rdev, (0x2F3C), ((gb_tiling_config & 0xffff)), 0);
 r100_mm_wreg(rdev, (0x3ec8), ((gb_tiling_config & 0xffff)), 0);
 r100_mm_wreg(rdev, (0xd0b8), ((gb_tiling_config & 0xffff)), 0);
 if (rdev->family == CHIP_RV730) {
  r100_mm_wreg(rdev, (0xef44), ((gb_tiling_config & 0xffff)), 0);
  r100_mm_wreg(rdev, (0xef48), ((gb_tiling_config & 0xffff)), 0);
  r100_mm_wreg(rdev, (0xef40), ((gb_tiling_config & 0xffff)), 0);
 }
 r100_mm_wreg(rdev, (0x3F90), (0), 0);
 r100_mm_wreg(rdev, (0x9148), (0), 0);
 r100_mm_wreg(rdev, (0x3F94), (0), 0);
 r100_mm_wreg(rdev, (0x914C), (0), 0);
 num_qd_pipes = 8 - r600_count_pipe_bits((cc_gc_shader_pipe_config & 0x0000FF00) >> 8);
 r100_mm_wreg(rdev, (0x28C5C), ((num_qd_pipes * 4) & 0x0000007F), 0);
 r100_mm_wreg(rdev, (0x28C58), (((num_qd_pipes * 4) - 2) & 0x000000FF), 0);
 r100_mm_wreg(rdev, (0x8760), ((((0x16) << 0) | ((0x2b) << 8))), 0);
 r100_mm_wreg(rdev, (0x8764), (((0x30) << 0)), 0);
 ta_aux_cntl = r100_mm_rreg(rdev, (0x9508), 0);
 r100_mm_wreg(rdev, (0x9508), (ta_aux_cntl | (1 << 1)), 0);
 sx_debug_1 = r100_mm_rreg(rdev, (0x9058), 0);
 sx_debug_1 |= (1 << 16);
 r100_mm_wreg(rdev, (0x9058), (sx_debug_1), 0);
 smx_dc_ctl0 = r100_mm_rreg(rdev, (0xA020), 0);
 smx_dc_ctl0 &= ~((0x1ff) << 1);
 smx_dc_ctl0 |= (((rdev->config.rv770.sx_num_of_sets * 64) - 1) << 1);
 r100_mm_wreg(rdev, (0xA020), (smx_dc_ctl0), 0);
 if (rdev->family != CHIP_RV740)
  r100_mm_wreg(rdev, (0xA02C), ((((4) << 0) | ((4) << 3) | ((3) << 6) | (1 << 8))), 0);
 if (rdev->family != CHIP_RV770)
  r100_mm_wreg(rdev, (0xA008), (0x00003f3f), 0);
 db_debug3 = r100_mm_rreg(rdev, (0x98B0), 0);
 db_debug3 &= ~((0x1f) << 11);
 switch (rdev->family) {
 case CHIP_RV770:
 case CHIP_RV740:
 ...
 r100_mm_wreg(rdev, (0x98B0), (db_debug3), 0);
 if (rdev->family != CHIP_RV770) {
  db_debug4 = r100_mm_rreg(rdev, (0x9B8C), 0);
  db_debug4 |= (1 << 6);
  r100_mm_wreg(rdev, (0x9B8C), (db_debug4), 0);
 }
 r100_mm_wreg(rdev, (0x900C), (((((rdev->config.rv770.sx_max_export_size / 4) - 1) << 0) | (((rdev->config.rv770.sx_max_export_pos_size / 4) - 1) << 8) | (((rdev->config.rv770.sx_max_export_smx_size / 4) - 1) << 16))), 0);
 r100_mm_wreg(rdev, (0x8BCC), ((((rdev->config.rv770.sc_prim_fifo_size) << 0) | ((rdev->config.rv770.sc_hiz_tile_fifo_size) << 12) | ((rdev->config.rv770.sc_earlyz_tile_fifo_fize) << 20))), 0);
 r100_mm_wreg(rdev, (0x8B20), (0), 0);
 r100_mm_wreg(rdev, (0x8974), (1), 0);
 r100_mm_wreg(rdev, (0x913C), (((4) << 0)), 0);
 r100_mm_wreg(rdev, (0x87FC), (0), 0);
 sq_ms_fifo_sizes = (((16 * rdev->config.rv770.sq_num_cf_insts) << 0) |
       ((0xe0) << 16) |
       ((0x8) << 24));
 switch (rdev->family) {
 case CHIP_RV770:
 case CHIP_RV730:
 case CHIP_RV710:
  sq_ms_fifo_sizes |= ((0x1) << 8);
  break;
 case CHIP_RV740:
 default:
  sq_ms_fifo_sizes |= ((0x4) << 8);
  break;
 }
 r100_mm_wreg(rdev, (0x8CF0), (sq_ms_fifo_sizes), 0);
 ...
 r100_mm_wreg(rdev, (0x8C04), (((((rdev->config.rv770.max_gprs * 24)/64) << 0) | (((rdev->config.rv770.max_gprs * 24)/64) << 16) | ((((rdev->config.rv770.max_gprs * 24)/64)/2) << 28))), 0);
 r100_mm_wreg(rdev, (0x8C08), (((((rdev->config.rv770.max_gprs * 7)/64) << 0) | (((rdev->config.rv770.max_gprs * 7)/64) << 16))), 0);
 sq_thread_resource_mgmt = ((((rdev->config.rv770.max_threads * 4)/8) << 0) |
       (((rdev->config.rv770.max_threads * 2)/8) << 8) |
       (((rdev->config.rv770.max_threads * 1)/8) << 24));
 if (((rdev->config.rv770.max_threads * 1) / 8) > rdev->config.rv770.max_gs_threads)
  sq_thread_resource_mgmt |= ((rdev->config.rv770.max_gs_threads) << 16);
 else
  sq_thread_resource_mgmt |= (((rdev->config.rv770.max_gs_threads * 1)/8) << 16);
 r100_mm_wreg(rdev, (0x8C0C), (sq_thread_resource_mgmt), 0);
 r100_mm_wreg(rdev, (0x8C10), (((((rdev->config.rv770.max_stack_entries * 1)/4) << 0) | (((rdev->config.rv770.max_stack_entries * 1)/4) << 16))), 0);
 r100_mm_wreg(rdev, (0x8C14), (((((rdev->config.rv770.max_stack_entries * 1)/4) << 0) | (((rdev->config.rv770.max_stack_entries * 1)/4) << 16))), 0);
 sq_dyn_gpr_size_simd_ab_0 = ((((rdev->config.rv770.max_gprs * 38)/64)<<0) |
         (((rdev->config.rv770.max_gprs * 38)/64)<<8) |
         (((rdev->config.rv770.max_gprs * 38)/64)<<16) |
         (((rdev->config.rv770.max_gprs * 38)/64)<<24));
 r100_mm_wreg(rdev, (0x8DB0), (sq_dyn_gpr_size_simd_ab_0), 0);
 r100_mm_wreg(rdev, (0x8DB4), (sq_dyn_gpr_size_simd_ab_0), 0);
 r100_mm_wreg(rdev, (0x8DB8), (sq_dyn_gpr_size_simd_ab_0), 0);
 r100_mm_wreg(rdev, (0x8DBC), (sq_dyn_gpr_size_simd_ab_0), 0);
 r100_mm_wreg(rdev, (0x8DC0), (sq_dyn_gpr_size_simd_ab_0), 0);
 r100_mm_wreg(rdev, (0x8DC4), (sq_dyn_gpr_size_simd_ab_0), 0);
 r100_mm_wreg(rdev, (0x8DC8), (sq_dyn_gpr_size_simd_ab_0), 0);
 r100_mm_wreg(rdev, (0x8DCC), (sq_dyn_gpr_size_simd_ab_0), 0);
 r100_mm_wreg(rdev, (0x8B24), ((((4095)<<0) | ((255)<<16))), 0);
 if (rdev->family == CHIP_RV710)
  r100_mm_wreg(rdev, (0x88C4), ((((1)<<0) | ((3) << 6))), 0);
 else
  r100_mm_wreg(rdev, (0x88C4), ((((2)<<0) | ((3) << 6))), 0);
 switch (rdev->family) {
 case CHIP_RV770:
 case CHIP_RV730:
 case CHIP_RV740:
 ...
 r100_mm_wreg(rdev, (0x88C8), (vgt_gs_per_es), 0);
 ...
 r100_mm_wreg(rdev, (0x28230), (0xaaaaaaaa), 0);
 r100_mm_wreg(rdev, (0x28C04), (0), 0);
 r100_mm_wreg(rdev, (0x2820C), (0xffff), 0);
 ...
 r100_mm_wreg(rdev, (0x9610), (0), 0);
 hdp_host_path_cntl = r100_mm_rreg(rdev, (0x2C00), 0);
 r100_mm_wreg(rdev, (0x2C00), (hdp_host_path_cntl), 0);
 r100_mm_wreg(rdev, (0x8B20), (0), 0);
...
static int rv770_mc_init(struct radeon_device *rdev)
{
 ...
 tmp = r100_mm_rreg(rdev, (0x2760), 0);
 if (tmp & (1 << 11)) {
  chansize = 16;
...
static int rv770_startup(struct radeon_device *rdev)
{
 ...
 if (!r) {
  r = radeon_fence_driver_start_ring(rdev,
         5);
  if (r)
   printf("drm:pid%d:%s *ERROR* " "UVD fences init error (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
 }
 if (r)
 ...
 r = radeon_ring_init(rdev, ring, ring->ring_size, 1792,
        ((((0xf) & 0xF) << 28) | (((0) & 0x1) << 23) | (((0) & 0x1) << 22) | (((0) & 0xFFFF) << 0)));
 if (r)
  return r;
...
int rv770_init(struct radeon_device *rdev)
{
 ...
 if (!r) {
  ...
  r600_ring_init(rdev, &rdev->ring[5],
          4096);
 }
