# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c"
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c"
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
...
void device_register(struct device *, void *);
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
...
int bppopen(dev_t, int, int, struct proc *); int bppclose(dev_t, int, int, struct proc *); int bppread(dev_t, struct uio *, int); int bppwrite(dev_t, struct uio *, int); int bppioctl(dev_t, u_long, caddr_t, int, struct proc *); int bppstop(struct tty *, int); struct tty *bpptty(dev_t); int bpppoll(dev_t, int, struct proc *); paddr_t bppmmap(dev_t, off_t, int); int bppkqfilter(dev_t, struct knote *);
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
...
int ifb_ident(void *);
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/wsdisplay.h" 1
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c" 2
# 103 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c"
    ...
    int node, int unused)
{
 ...
 def_linebytes =
     ((((sf->sf_width)+((sf->sf_depth)-1))/(sf->sf_depth))*(sf->sf_depth)) * sf->sf_depth / 8;
...
fb_updatecursor(struct rasops_info *ri)
{
 ...
 if (sf->sf_crowp != ((void *)0))
  *sf->sf_crowp = ri->ri_crow;
 if (sf->sf_ccolp != ((void *)0))
...
# 223 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c"
 if (isconsole) {
  ...
  if (wt == 0 ) {
   ri->ri_flg |= 0x0040;
# 250 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c"
   ri->ri_flg |= 0x0020;
  }
 ...
 if (ri->ri_bits == ((void *)0))
  ri->ri_flg &= ~(0x0010 | 0x0020);
 ...
 if (sf->sf_depth == 8) {
  ...
  ri->ri_devcmap[7] = ri->ri_devcmap[7 + 8];
 }
}
...
fbwscons_console_init(struct sunfb *sf, int row)
{
 ...
 if (romgetcursoraddr(&sf->sf_crowp, &sf->sf_ccolp))
  sf->sf_ccolp = sf->sf_crowp = ((void *)0);
 if (sf->sf_ccolp != ((void *)0))
  ri->ri_ccol = *sf->sf_ccolp;

 if (ri->ri_flg & 0x0010) {
# 330 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fb.c"
  sf->sf_crowp = sf->sf_ccolp = ((void *)0);
  row = 0;
 }
    ...
    void (*setcolor)(void *, u_int, u_int8_t, u_int8_t, u_int8_t))
{
 ...
 if (sf->sf_depth <= 8 && setcolor != ((void *)0)) {
  for (i = 0; i < 16; i++) {
  ...
  setcolor(sf, 0, 0xff, 0xff, 0xff);
  setcolor(sf, 0xff ^ 0, 0, 0, 0);
  setcolor(sf, 7, 0, 0, 0);
  setcolor(sf, 0xff ^ (7), 0xff, 0xff, 0xff);
 }
}
...
fbwscons_attach(struct sunfb *sf, struct wsdisplay_accessops *op, int isconsole)
{
 ...
 config_found_sm((&sf->sf_dev), (&waa), (wsemuldisplaydevprint), ((void *)0));
}
