# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/vlan.h" 1
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_types.h" 1
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_mpw.c" 2
...
mpw_clone_create(struct if_clone *ifc, int unit)
{
 ...
 sc->sc_smpls.smpls_family = 33;

 if_ih_insert(ifp, mpw_input, ((void *)0));
...
mpw_clone_destroy(struct ifnet *ifp)
{
 ...
 if (sc->sc_smpls.smpls_label) {
  rt_ifa_del(&sc->sc_ifa, 0x100000,
      ((struct sockaddr *)(&sc->sc_smpls)));
 }

 if_ih_remove(ifp, mpw_input, ((void *)0));
...
mpw_ioctl(struct ifnet *ifp, u_long cmd, caddr_t data)
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((173))):
  ...
  if (sin->sin_addr.s_addr == 0) {
   if (rt_ifa_del(&sc->sc_ifa, 0x100000,
       ((struct sockaddr *)(&sc->sc_smpls))) == 0)
    sc->sc_smpls.smpls_label = 0;

   __builtin_memset((&sc->sc_rshim), (0), (sizeof(sc->sc_rshim)));
   __builtin_memset((&sc->sc_nexthop), (0), (sizeof(sc->sc_nexthop)));
   sc->sc_flags = 0;
   sc->sc_type = 0;
   break;
  }
  ...
  if (sin->sin_family != 2 ||
      imr.imr_lshim.shim_label > ((1 << 20) - 1) ||
      imr.imr_lshim.shim_label <= 15 ||
      imr.imr_rshim.shim_label > ((1 << 20) - 1) ||
      imr.imr_rshim.shim_label <= 15) {
   error = 22;
   break;
  }
  ...
  imr.imr_lshim.shim_label =
      ((__uint32_t)(imr.imr_lshim.shim_label << 12));
  imr.imr_rshim.shim_label =
      ((__uint32_t)(imr.imr_rshim.shim_label << 12));
  ...
  if (sc->sc_smpls.smpls_label != imr.imr_lshim.shim_label) {
   ...
   error = rt_ifa_add(&sc->sc_ifa, 0x100000,
       ((struct sockaddr *)(&sc->sc_smpls)));
   if (error != 0) {
    sc->sc_smpls.smpls_label = 0;
    break;
  ...
  sc->sc_rshim.shim_label |= ((u_int32_t)((__uint32_t)((u_int32_t)(0x00000100U))));
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((174))):
  imr.imr_flags = sc->sc_flags;
  imr.imr_type = sc->sc_type;
  imr.imr_lshim.shim_label =
      ((((__uint32_t)(sc->sc_smpls.smpls_label & ((u_int32_t)((__uint32_t)((u_int32_t)(0xfffff000U))))))) >>
   12);
  imr.imr_rshim.shim_label =
      ((((__uint32_t)(sc->sc_rshim.shim_label & ((u_int32_t)((__uint32_t)((u_int32_t)(0xfffff000U))))))) >>
   12);
  __builtin_memcpy((&imr.imr_nexthop), (&sc->sc_nexthop), (sizeof(imr.imr_nexthop)));


  error = copyout(&imr, ifr->ifr_ifru.ifru_data, sizeof(imr));
  break;
    ...
    struct rtentry *rt)
{
 ...
 if (sc->sc_flags & 0x1) {
  ...
  if (shim->shim_label & ((u_int32_t)((__uint32_t)((u_int32_t)(0xf0000000U))))) {
  ...
  if (shim->shim_label & ((u_int32_t)((__uint32_t)((u_int32_t)(0x00300000U))))) {
   ifp->if_data.ifi_ierrors++;
   m_freem(m);
   return (22);
  }
 ...
 if (sc->sc_type == 2) {
  ...
  if (((__uint16_t)(ehc.ether_type)) != 0x88A8) {
   ifp->if_data.ifi_ierrors++;
   m_freem(m);
   return (22);
  }
  ...
  if (((*((uint16_t *)((m)->m_hdr.mh_data))) & 0xFFF) == 0) {
   m_adj(m, 4);
   ehc.ether_type = ((__uint16_t)(0x8100));
  }
  ...
  __builtin_memcpy((eh), (&ehc), (sizeof(*eh)));
 }
...
mpw_vlan_handle(struct mbuf *m, struct mpw_softc *sc)
{
 ...
 uint16_t type = 0x88A8;
 uint16_t tag = 0;

 ifp = if_get(m->M_dat.MH.MH_pkthdr.ph_ifidx);
 if (ifp != ((void *)0) && ifp->if_qstart == vlan_start &&
     ((ifp->if_flags) & (0x40))) {
  ifv = ifp->if_softc;
  type = ifv->ifv_mib.ifvm_type;
  tag = ifv->ifv_mib.ifvm_tag;
 }
 if_put(ifp);
...
mpw_start(struct ifnet *ifp)
{
 ...
 rt = rtalloc(sstosa(&sc->sc_nexthop), 1, ifp->if_data.ifi_rdomain);
 if (!rtisvalid(rt)) {
  do { (void)ifq_purge(&ifp->if_snd); } while ( 0);
  goto rtfree;
 }
 ...
 __builtin_memcpy((&ss), (&sc->sc_nexthop), (sizeof(sc->sc_nexthop)));
 ss.ss_family = 33;
 ...
 while ((m = ifq_dequeue(&ifp->if_snd)) != ((void *)0)) {
  ...
  if (sc->sc_flags & 0x1) {
   (m) = m_prepend((m), (sizeof(*shim)), (0x0002));
   if (m == ((void *)0))
    continue;

   shim = ((struct shim_hdr *)((m)->m_hdr.mh_data));
   __builtin_memset((shim), (0), (sizeof(*shim)));
  }
