# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c"
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udavreg.h" 1
# 148 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udavreg.h"
struct udav_chain {
...
struct udav_cdata {
 struct udav_chain udav_tx_chain[1];
 struct udav_chain udav_rx_chain[1];
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c" 2
...
# 142 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c"
...
udav_match(struct device *parent, void *match, void *aux)
{
 ...
 return (((struct udav_type *)usbd_match_device((const struct usb_devno *)(udav_devs), sizeof (udav_devs) / sizeof ((udav_devs)[0]), sizeof ((udav_devs)[0]), (uaa->vendor), (uaa->product))) != ((void *)0) ?
  8 : 0);
}
...
udav_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 ((&sc->sc_tick_task)->fun = (udav_tick_task), (&sc->sc_tick_task)->arg = (sc), (&sc->sc_tick_task)->type = (0), (&sc->sc_tick_task)->state = 0x0);

 _rw_init_flags(&sc->sc_mii_lock, "udavmii", 0, ((void *)0));
 ((&sc->sc_stop_task)->fun = ((void (*)(void *)) udav_stop_task), (&sc->sc_stop_task)->arg = (sc), (&sc->sc_stop_task)->type = (0), (&sc->sc_stop_task)->state = 0x0);


 sc->sc_ctl_iface = iface;
 sc->sc_flags = ((struct udav_type *)usbd_match_device((const struct usb_devno *)(udav_devs), sizeof (udav_devs) / sizeof ((udav_devs)[0]), sizeof ((udav_devs)[0]), (uaa->vendor), (uaa->product)))->udav_flags;
 ...
 err = udav_csr_read(sc, 0x10, (void *)eaddr, 6);
 if (err) {
 ...
 printf("address %s\n", ether_sprintf(eaddr));
        ...
        __builtin_bcopy((eaddr), ((char *)&sc->sc_ac.ac_enaddr), (6));
 ...
 if (sc->sc_flags & 0x0002) {
  ...
  if (((&mii->mii_phys)->lh_first) == ((void *)0)) {
   ifmedia_add(&mii->mii_media, 0x0000000000000100ULL | 2ULL,
        0, ((void *)0));
   ifmedia_set(&mii->mii_media, 0x0000000000000100ULL | 2ULL);
  } else
...
# 464 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c"
int
udav_csr_read(struct udav_softc *sc, int offset, void *buf, int len)
{
 ...
 req.bRequest = 0x00;
 ((req.wValue)[0] = (u_int8_t)(0x0000), (req.wValue)[1] = (u_int8_t)((0x0000) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(offset), (req.wIndex)[1] = (u_int8_t)((offset) >> 8));
...
udav_csr_write1(struct udav_softc *sc, int offset, unsigned char ch)
{
 ...
 req.bmRequestType = (0x00 | 0x40 | 0x00);
 req.bRequest = 0x03;
 ((req.wValue)[0] = (u_int8_t)(ch), (req.wValue)[1] = (u_int8_t)((ch) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(offset), (req.wIndex)[1] = (u_int8_t)((offset) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0x0000), (req.wLength)[1] = (u_int8_t)((0x0000) >> 8));
...
udav_init(struct ifnet *ifp)
{
 ...
 udav_csr_write(sc, 0x10, eaddr, 6);



 udav_csr_write1(sc, 0x00, udav_csr_read1(sc, 0x00) & ~((1<<1) | (1<<2)));


 udav_csr_write1(sc, 0x05, udav_csr_read1(sc, 0x05) | ((1<<5) | (1<<4)));


 if (udav_tx_list_init(sc) == 55) {
 ...
 udav_csr_write1(sc, 0x05, udav_csr_read1(sc, 0x05) | ((1<<0)));


 udav_csr_write1(sc, 0x1e, udav_csr_read1(sc, 0x1e) | ((1<<0)));
 udav_csr_write1(sc, 0x1f, udav_csr_read1(sc, 0x1f) & ~((1<<0)));

 if (!(sc->sc_flags & 0x0002))
  mii_mediachg(mii);

 if (sc->sc_pipe_tx == ((void *)0) || sc->sc_pipe_rx == ((void *)0)) {
...
udav_reset(struct udav_softc *sc)
{
 ...
 udav_csr_write1(sc, 0x00, udav_csr_read1(sc, 0x00) & ~((1<<7)));
# 681 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c"
 udav_csr_write1(sc, 0x00, udav_csr_read1(sc, 0x00) | ((1<<0)));

 for (i = 0; i < 1000; i++) {
  if (!(udav_csr_read1(sc, 0x00) & (1<<0)))
   break;
  delay(10);
 }
 delay(10000);
...
udav_iff(struct udav_softc *sc)
{
 ...
 udav_csr_write1(sc, 0x05, udav_csr_read1(sc, 0x05) & ~((1<<3) | (1<<1)));
 __builtin_memset((hashes), (0x00), (sizeof(hashes)));
 ifp->if_flags &= ~0x200;

 if (ifp->if_flags & 0x100 || ac->ac_multirangecnt > 0) {
  ifp->if_flags |= 0x200;
  udav_csr_write1(sc, 0x05, udav_csr_read1(sc, 0x05) | ((1<<3)));
  if (ifp->if_flags & 0x100)
   udav_csr_write1(sc, 0x05, udav_csr_read1(sc, 0x05) | ((1<<1)));
 } else {
  hashes[7] |= 0x80;
 ...
 udav_csr_write(sc, 0x16, hashes, sizeof(hashes));
}
...
# 785 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c"
 for (i = 0; i < 1; i++) {
  c = &sc->sc_cdata.udav_rx_chain[i];
  usbd_setup_xfer(c->udav_xfer, sc->sc_pipe_rx,
    c, c->udav_buf, 1522 + sizeof(struct udav_rx_hdr),
    0x04 | 0x01,
    0, udav_rxeof);
...
udav_rx_list_init(struct udav_softc *sc)
{
 ...
 for (i = 0; i < 1; i++) {
  ...
  c->udav_sc = sc;
  c->udav_idx = i;
  if (udav_newbuf(sc, c, ((void *)0)) == 55)
   return (55);
  if (c->udav_xfer == ((void *)0)) {
   c->udav_xfer = usbd_alloc_xfer(sc->sc_udev);
   if (c->udav_xfer == ((void *)0))
    return (55);
   c->udav_buf = usbd_alloc_buffer(c->udav_xfer, 1522 + sizeof(struct udav_rx_hdr));
   if (c->udav_buf == ((void *)0)) {
...
udav_send(struct udav_softc *sc, struct mbuf *m, int idx)
{
 ...
 m_copydata(m, 0, m->M_dat.MH.MH_pkthdr.len, c->udav_buf + 2);
 c->udav_mbuf = m;
 total_len = m->M_dat.MH.MH_pkthdr.len;
 if (total_len < 60) {
  __builtin_memset((c->udav_buf + 2 + total_len), (0), (60 - total_len));
...
udav_rxeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 if (total_len < sizeof(struct udav_rx_hdr)) {
  ifp->if_data.ifi_ierrors++;
  goto done;
 }

 h = (struct udav_rx_hdr *)c->udav_buf;
 total_len = ((h->length)[0] | ((h->length)[1] << 8)) - 4;
 ...
 if (total_len < sizeof(struct ether_header) ||
     h->pktstat & ((1<<7) | (1<<5) | (1<<4) | (1<<3) | (1<<2) | (1<<1) | (1<<0)) ||
     total_len > 1522 + sizeof(struct udav_rx_hdr) ) {
  ifp->if_data.ifi_ierrors++;
  goto done;
 }
 ...
 m = c->udav_mbuf;
 __builtin_memcpy((((char *)((m)->m_hdr.mh_data))), (c->udav_buf + sizeof(struct udav_rx_hdr)), (total_len));
 ...
 usbd_setup_xfer(xfer, sc->sc_pipe_rx, c, c->udav_buf, 1522 + sizeof(struct udav_rx_hdr),
   0x04 | 0x01,
   0, udav_rxeof);
 sc->sc_refcnt++;
 usbd_transfer(xfer);
...
udav_watchdog(struct ifnet *ifp)
{
 ...
 usbd_get_xfer_status(c->udav_xfer, ((void *)0), ((void *)0), ((void *)0), &stat);
 ...
 if (sc->sc_pipe_tx != ((void *)0)) {
  ...
  if (err)
   printf("%s: close tx pipe failed: %s\n",
          sc->sc_dev.dv_xname, usbd_errstr(err));
  sc->sc_pipe_tx = ((void *)0);
 }
# 1261 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c"
 for (i = 0; i < 1; i++) {
  if (sc->sc_cdata.udav_rx_chain[i].udav_mbuf != ((void *)0)) {
   m_freem(sc->sc_cdata.udav_rx_chain[i].udav_mbuf);
   sc->sc_cdata.udav_rx_chain[i].udav_mbuf = ((void *)0);
  }
  if (sc->sc_cdata.udav_rx_chain[i].udav_xfer != ((void *)0)) {
   usbd_free_xfer(sc->sc_cdata.udav_rx_chain[i].udav_xfer);
   sc->sc_cdata.udav_rx_chain[i].udav_xfer = ((void *)0);
  }
 }


 for (i = 0; i < 1; i++) {
  if (sc->sc_cdata.udav_tx_chain[i].udav_mbuf != ((void *)0)) {
   m_freem(sc->sc_cdata.udav_tx_chain[i].udav_mbuf);
   sc->sc_cdata.udav_tx_chain[i].udav_mbuf = ((void *)0);
  }
  if (sc->sc_cdata.udav_tx_chain[i].udav_xfer != ((void *)0)) {
   usbd_free_xfer(sc->sc_cdata.udav_tx_chain[i].udav_xfer);
   sc->sc_cdata.udav_tx_chain[i].udav_xfer = ((void *)0);
  }
 }
...
udav_ifmedia_status(struct ifnet *ifp, struct ifmediareq *ifmr)
{
 ...
 if ((ifp->if_flags & 0x40) == 0) {
  ifmr->ifm_active = 0x0000000000000100ULL | 2ULL;
  ifmr->ifm_status = 0;
  return;
 }
 ...
 if (sc->sc_flags & 0x0002) {
  ...
  if (sc->sc_link) ifmr->ifm_status |= 0x0000000000000002ULL;
  return;
 }
...
udav_tick_task(void *xsc)
{
 ...
 if (sc->sc_flags & 0x0002) {
  sts = udav_csr_read1(sc, 0x01) & (1<<6);
  if (!sts)
   sc->sc_link = 0;
 } else {
  mii_tick(mii);
  sts = (mii->mii_media_status & 0x0000000000000002ULL &&
         ((mii->mii_media_active) & 0x00000000000000ffULL) != 2ULL) ? 1 : 0;
 }
...
udav_lock_mii(struct udav_softc *sc)
{
 ...
 sc->sc_refcnt++;
 _rw_enter_write(&sc->sc_mii_lock );
}
...
udav_unlock_mii(struct udav_softc *sc)
{
 ...
 _rw_exit_write(&sc->sc_mii_lock );
 if (--sc->sc_refcnt < 0)
  usb_detach_wakeup(&sc->sc_dev);
}

int
udav_miibus_readreg(struct device *dev, int phy, int reg64)
{
 ...
 udav_csr_write1(sc, 0x0c,
   (1<<6) | (reg64 & (0x1f)));


 udav_csr_write1(sc, 0x0b, (1<<3) | (1<<2));




 udav_csr_write1(sc, 0x0b, udav_csr_read1(sc, 0x0b) & ~((1<<2)));


 udav_csr_read(sc, 0x0d, val, 2);
...
void
udav_miibus_writereg(struct device *dev, int phy, int reg64, int data)
{
 struct udav_softc *sc;
 u_int8_t val[2];
 ...
 val[0] = data & 0xff;
 val[1] = (data >> 8) & 0xff;
 udav_csr_write(sc, 0x0d, val, 2);


 udav_csr_write1(sc, 0x0b, (1<<3) | (1<<1));




 udav_csr_write1(sc, 0x0b, udav_csr_read1(sc, 0x0b) & ~((1<<1)));
...
{
# 1552 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_udav.c"
}
