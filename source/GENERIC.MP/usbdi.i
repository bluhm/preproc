# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c" 2
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c"
...
{
 while (dev->ref_cnt > 0)
  tsleep(&dev->ref_cnt, 32, "usbref", hz * 60);
}
...
# 175 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdi.c"
usbd_status
    ...
    u_int8_t flags, struct usbd_pipe **pipe, int ival)
{
 ...
 found:
 if ((flags & 0x01) && ep->refcnt != 0)
  return (USBD_IN_USE);
 err = usbd_setup_pipe(iface->device, iface, ep, ival, &p);
 if (err)
  return (err);
 do { if (((p)->next.le_next = (&iface->pipes)->lh_first) != ((void *)0)) (&iface->pipes)->lh_first->next.le_prev = &(p)->next.le_next; (&iface->pipes)->lh_first = (p); (p)->next.le_prev = &(&iface->pipes)->lh_first; } while (0);
 *pipe = p;
    ...
    void *buffer, u_int32_t len, usbd_callback cb, int ival)
{
 ...
 err = usbd_open_pipe_ival(iface, address, 0x01, &ipipe,
     ival);
 if (err)
  return (err);
...
usbd_close_pipe(struct usbd_pipe *pipe)
{
 ...
 if (!(((&pipe->queue)->sqh_first) == ((void *)0)))
  usbd_abort_pipe(pipe);


 if (pipe->iface != ((void *)0))
  do { if ((pipe)->next.le_next != ((void *)0)) (pipe)->next.le_next->next.le_prev = (pipe)->next.le_prev; *(pipe)->next.le_prev = (pipe)->next.le_next; ((pipe)->next.le_prev) = ((void *)-1); ((pipe)->next.le_next) = ((void *)-1); } while (0);
 pipe->endpoint->refcnt--;
 pipe->methods->close(pipe);
 if (pipe->intrxfer != ((void *)0))
  usbd_free_xfer(pipe->intrxfer);
 free(pipe, 101, pipe->pipe_size);
 return (USBD_NORMAL_COMPLETION);
}
...
usbd_transfer(struct usbd_xfer *xfer)
{
 ...
 if (!usbd_xfer_isread(xfer)) {
  if ((xfer->flags & 0x01) == 0)
   __builtin_memcpy((((void *)((char *)((&xfer->dmabuf)->block->kaddr + (&xfer->dmabuf)->offs) + (0)))), (xfer->buffer), (xfer->length));
 ...
 if (polling) {
  ...
  while (!xfer->done) {
   flags = 16|(xfer->flags & 0x10 ? 0x100 : 0);
...
usbd_alloc_buffer(struct usbd_xfer *xfer, u_int32_t size)
{
 ...
 if (err)
  return (((void *)0));
 xfer->rqflags |= 0x20;
 return (((void *)((char *)((&xfer->dmabuf)->block->kaddr + (&xfer->dmabuf)->offs) + (0))));
}
...
usbd_alloc_xfer(struct usbd_device *dev)
{
 ...
 xfer->device = dev;
 timeout_set(&xfer->timeout_handle, ((void *)0), ((void *)0));
 ;
 return (xfer);
}
...
usbd_abort_pipe(struct usbd_pipe *pipe)
{
 ...
 pipe->repeat = 0;
 pipe->aborting = 1;
 while ((xfer = ((&pipe->queue)->sqh_first)) != ((void *)0)) {
  ;
...
usbd_clear_endpoint_stall(struct usbd_pipe *pipe)
{
 ...
 req.bmRequestType = (0x00 | 0x00 | 0x02);
 req.bRequest = 0x01;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(pipe->endpoint->edesc->bEndpointAddress), (req.wIndex)[1] = (u_int8_t)((pipe->endpoint->edesc->bEndpointAddress) >> 8));
...
usbd_clear_endpoint_stall_async(struct usbd_pipe *pipe)
{
 ...
 err = usbd_request_async(xfer, &req, ((void *)0), ((void *)0));
 return (err);
}
...
{
 if (pipe->methods->cleartoggle != ((void *)0))
...
usbd_set_interface(struct usbd_interface *iface, int altidx)
{
 ...
 req.bmRequestType = (0x00 | 0x00 | 0x01);
 req.bRequest = 0x0b;
 ((req.wValue)[0] = (u_int8_t)(iface->idesc->bAlternateSetting), (req.wValue)[1] = (u_int8_t)((iface->idesc->bAlternateSetting) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(iface->idesc->bInterfaceNumber), (req.wIndex)[1] = (u_int8_t)((iface->idesc->bInterfaceNumber) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
...
{
 char *p = (char *)cdesc;
 char *end = p + ((cdesc->wTotalLength)[0] | ((cdesc->wTotalLength)[1] << 8));
 ...
 if (xfer->actlen != 0) {
  if (usbd_xfer_isread(xfer)) {
   usb_syncmem(&xfer->dmabuf, 0, xfer->actlen,
       0x02);
   if (!(xfer->flags & 0x01))
    __builtin_memcpy((xfer->buffer), (((void *)((char *)((&xfer->dmabuf)->block->kaddr + (&xfer->dmabuf)->offs) + (0)))), (xfer->actlen));
...
usb_insert_transfer(struct usbd_xfer *xfer)
{
 ...
 xfer->busy_free = 0x4f4e5155;

 s = splraise(2);
 do { (xfer)->next.sqe_next = ((void *)0); *(&pipe->queue)->sqh_last = (xfer); (&pipe->queue)->sqh_last = &(xfer)->next.sqe_next; } while (0);
 if (pipe->running)
...
usbd_start_next(struct usbd_pipe *pipe)
{
 ...
 if (pipe->methods == ((void *)0) || pipe->methods->start == ((void *)0)) {
    ...
    void *data, uint16_t flags, int *actlen, uint32_t timeout)
{
 ...
 usbd_setup_default_xfer(xfer, dev, 0, timeout, req, data,
     ((req->wLength)[0] | ((req->wLength)[1] << 8)), flags | 0x02, 0);
 err = usbd_transfer(xfer);
 if (actlen != ((void *)0))
  *actlen = xfer->actlen;
 if (err == USBD_STALLED) {
  ...
  treq.bmRequestType = (0x80 | 0x00 | 0x02);
  treq.bRequest = 0x00;
  ((treq.wValue)[0] = (u_int8_t)(0), (treq.wValue)[1] = (u_int8_t)((0) >> 8));
  ((treq.wIndex)[0] = (u_int8_t)(0), (treq.wIndex)[1] = (u_int8_t)((0) >> 8));
  ((treq.wLength)[0] = (u_int8_t)(sizeof(usb_status_t)), (treq.wLength)[1] = (u_int8_t)((sizeof(usb_status_t)) >> 8));
  usbd_setup_default_xfer(xfer, dev, 0, 5000,
      &treq, &status, sizeof(usb_status_t), 0x02, 0);
  nerr = usbd_transfer(xfer);
  if (nerr)
   goto bad;
  s = ((status.wStatus)[0] | ((status.wStatus)[1] << 8));
  ;
  if (!(s & 0x0001))
   goto bad;
  treq.bmRequestType = (0x00 | 0x00 | 0x02);
  treq.bRequest = 0x01;
  ((treq.wValue)[0] = (u_int8_t)(0), (treq.wValue)[1] = (u_int8_t)((0) >> 8));
  ((treq.wIndex)[0] = (u_int8_t)(0), (treq.wIndex)[1] = (u_int8_t)((0) >> 8));
  ((treq.wLength)[0] = (u_int8_t)(0), (treq.wLength)[1] = (u_int8_t)((0) >> 8));
  usbd_setup_default_xfer(xfer, dev, 0, 5000,
      &treq, &status, 0, 0x02, 0);
  nerr = usbd_transfer(xfer);
  if (nerr)
   goto bad;
 }
    ...
    void *priv, usbd_callback callback)
{
 ...
 usbd_setup_default_xfer(xfer, xfer->device, priv,
     5000, req, ((void *)0), ((req->wLength)[0] | ((req->wLength)[1] << 8)),
     0x01, callback);
 err = usbd_transfer(xfer);
 if (err != USBD_IN_PROGRESS) {
  usbd_free_xfer(xfer);
...
{
 static struct timeval errinterval = { 0, 250000 };
    ...
    u_int16_t vendor, u_int16_t product)
{
 while (nentries-- > 0) {
  ...
  if (tbl->ud_vendor == vendor &&
      (tproduct == product || tproduct == 0xffff))
   return (tbl);
...
usbd_desc_iter_init(struct usbd_device *dev, struct usbd_desc_iter *iter)
{
 ...
 iter->end = (const uByte *)cd + ((cd->wTotalLength)[0] | ((cd->wTotalLength)[1] << 8));
}
...
usbd_str(usb_string_descriptor_t *p, int l, const char *s)
{
 ...
 for (i = 0; s[i] && l > 1; i++, l -= 2)
  ((p->bString[i])[0] = (u_int8_t)(s[i]), (p->bString[i])[1] = (u_int8_t)(0));
 return (2 * i + 2);
}
