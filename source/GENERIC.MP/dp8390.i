# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
# 17 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
void
...
dp8390_config(struct dp8390_softc *sc)
{
 ...
 sc->tx_page_start = sc->mem_start >> 8;
 sc->rec_page_start = sc->tx_page_start + sc->txb_cnt * 6;
 sc->rec_page_stop = sc->tx_page_start + (sc->mem_size >> 8);
...
dp8390_stop(struct dp8390_softc *sc)
{
 ...
 bus_space_barrier(regt, regh, 0, 0x10, 0x01 | 0x02);
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x00]), (sc->cr_proto | 0x00 | 0x01));
 ...
 while (((bus_space_read_1(regt, regh, ((sc)->sc_reg_map[0x07])) & 0x80) == 0) && --n)

  delay(1);

 if (sc->stop_card != ((void *)0))
  (*sc->stop_card)(sc);
}
...
dp8390_init(struct dp8390_softc *sc)
{
 ...
 u_int8_t mcaf[8];
 int i;
# 247 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
 ifp->if_timer = 0;
 ...
 if (sc->dcr_reg & 0x08) {
  bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x0e]), (sc->dcr_reg));
 } else {




  bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x0e]), (0x40 | 0x08));
 }


 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x0a]), (0));
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x0b]), (0));


 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x0c]), (0x20 | sc->rcr_proto));


 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x0d]), (0x02));


 if (sc->is790)
  bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x09]), (0));


 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x03]), (sc->rec_page_start));
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x01]), (sc->rec_page_start));
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x02]), (sc->rec_page_stop));
 ...
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x0f]), (0x01 | 0x02 | 0x04 | 0x08 | 0x10));
 ...
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x07]), (0xff));


 bus_space_barrier(regt, regh, 0, 0x10, 0x01 | 0x02);
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x00]), (sc->cr_proto | (0x40) | 0x01));

 bus_space_barrier(regt, regh, 0, 0x10, 0x01 | 0x02);


 for (i = 0; i < 6; ++i)
  bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x01 + i]), (sc->sc_arpcom.ac_enaddr[i]));



 dp8390_getmcaf(&sc->sc_arpcom, mcaf);
 for (i = 0; i < 8; i++)
  bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x08 + i]), (mcaf[i]));
 ...
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x07]), (sc->next_packet));
 ...
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x0c]), (i));


 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x0d]), (0));
 ...
 bus_space_barrier(regt, regh, 0, 0x10, 0x01 | 0x02);
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x00]), (sc->cr_proto | 0x00 | 0x02));
...
dp8390_xmit(struct dp8390_softc *sc)
{
 ...
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x04]), (sc->tx_page_start + sc->txb_next_tx * 6));



 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x05]), (len));
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x06]), (len >> 8));


 bus_space_barrier(regt, regh, 0, 0x10, 0x01 | 0x02);
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x00]), (sc->cr_proto | 0x00 | 0x04 | 0x02));
...
# 422 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
void
...
outloop:
 ...
 m_freem(m0);
 sc->txb_len[sc->txb_new] = max(len, 64 - 4);
...
loop:
 ...
 bus_space_barrier(regt, regh, 0, 0x10, 0x01 | 0x02);
 bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x00]), (sc->cr_proto | (0x40) | 0x02));

 bus_space_barrier(regt, regh, 0, 0x10, 0x01 | 0x02);
# 510 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
 current = bus_space_read_1(regt, regh, ((sc)->sc_reg_map[0x07]));
 ...
 do {
  ...
  packet_ptr = sc->mem_ring +
      ((sc->next_packet - sc->rec_page_start) << 8);
...
# 539 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
  ...
  --nlen;
  if ((len & 255) + sizeof(packet_hdr) > 256)
   --nlen;
  len = (len & 255) | (nlen << 8);
...
# 568 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
  if (len <= (1 << 11) &&
  ...
  bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x03]), (boundary));
...
dp8390_intr(void *arg)
{
 ...
 isr = bus_space_read_1(regt, regh, ((sc)->sc_reg_map[0x07]));
 if (!isr)
  return (0);
 ...
 for (;;) {
  ...
  bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x07]), (isr));


  if ((sc->sc_flags & 0x0020) != 0)
   while ((bus_space_read_1(regt, regh, ((sc)->sc_reg_map[0x07])) & isr) != 0) {
    bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x07]), (0));
    bus_space_write_1(regt, regh, ((sc)->sc_reg_map[0x07]), (isr));
   }
# 656 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
  if (isr & (0x02 | 0x08) &&
      sc->txb_inuse != 0) {
   u_char collisions =
       bus_space_read_1(regt, regh, ((sc)->sc_reg_map[0x05])) & 0x0f;
# 670 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
   if (isr & 0x08) {



    if ((bus_space_read_1(regt, regh, ((sc)->sc_reg_map[0x04]))
        & 0x08) && (collisions == 0)) {
    ...
    (void)bus_space_read_1(regt, regh, ((sc)->sc_reg_map[0x04]));
   }
   ...
   ifp->if_data.ifi_collisions += collisions;
# 714 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
   if (--sc->txb_inuse != 0)
    dp8390_xmit(sc);
  }


  if (isr & (0x01 | 0x04 | 0x10)) {
# 729 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
   if (isr & 0x10) {
    ++ifp->if_data.ifi_ierrors;
    ...
    if (isr & 0x04) {
     ++ifp->if_data.ifi_ierrors;
# 754 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
    }
# 763 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
    if (sc->recv_int)
     (*sc->recv_int)(sc);
    else
     dp8390_rint(sc);
  ...
  if (isr & 0x20) {
   (void)bus_space_read_1(regt, regh, ((sc)->sc_reg_map[0x0d]));
   (void)bus_space_read_1(regt, regh, ((sc)->sc_reg_map[0x0e]));
   (void)bus_space_read_1(regt, regh, ((sc)->sc_reg_map[0x0f]));
  }
...
# 870 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
void
...
# 887 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
 ...
 while (enm != ((void *)0)) {
  ...
  crc = ether_crc32_be(enm->enm_addrlo, 6) >> 26;
...
# 915 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
struct mbuf *
dp8390_get(struct dp8390_softc *sc, int src, u_short total_len)
{
 ...
 if (m0 == ((void *)0))
  return (0);
 m0->M_dat.MH.MH_pkthdr.len = total_len;
 len = ((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr));
 m = m0;

 while (total_len > 0) {
  if (total_len >= (((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr)) + (256 - sizeof(struct m_hdr)) + 1)) {
  ...
  if (m == m0) {
   caddr_t newdata = (caddr_t)
       (((unsigned long)(m->m_hdr.mh_data + sizeof(struct ether_header)) + 0xf) & ~0xf) -
       sizeof(struct ether_header);
   len -= newdata - m->m_hdr.mh_data;
   m->m_hdr.mh_data = newdata;
  }

  m->m_hdr.mh_len = len = min(total_len, len);
  if (sc->ring_copy)
   src = (*sc->ring_copy)(sc, src, ((caddr_t)((m)->m_hdr.mh_data)), len);
  else
   src = dp8390_ring_copy(sc, src, ((caddr_t)((m)->m_hdr.mh_data)), len);
...
# 979 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/dp8390.c"
static int
...
dp8390_enable(struct dp8390_softc *sc)
{
 ...
 if (sc->sc_enabled == 0 && sc->sc_enable != ((void *)0)) {
...
{
 if (sc->sc_enabled != 0 && sc->sc_disable != ((void *)0)) {
  (*sc->sc_disable)(sc);
  sc->sc_enabled = 0;
 }
}
