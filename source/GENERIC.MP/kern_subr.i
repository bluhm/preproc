# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_subr.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_subr.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_subr.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_subr.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_subr.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_subr.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_subr.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_subr.c" 2
...
uiomove(void *cp, size_t n, struct uio *uio)
{
 ...
 while (n > 0) {
  ...
  cnt = iov->iov_len;
  if (cnt == 0) {
   ((uio->uio_iovcnt > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_subr.c", 69, "uio->uio_iovcnt > 0"));
   uio->uio_iov++;
   uio->uio_iovcnt--;
   continue;
  }
...
struct hook_desc_head startuphook_list =
    { ((void *)0), &(startuphook_list).tqh_first };
    ...
    void *arg)
{
 ...
 hdp = malloc(sizeof(*hdp), 2, 0x0002);
 if (hdp == ((void *)0))
  return (((void *)0));
 ...
 hdp->hd_arg = arg;
 if (tail)
  do { (hdp)->hd_list.tqe_next = ((void *)0); (hdp)->hd_list.tqe_prev = (head)->tqh_last; *(head)->tqh_last = (hdp); (head)->tqh_last = &(hdp)->hd_list.tqe_next; } while (0);
 else
  do { if (((hdp)->hd_list.tqe_next = (head)->tqh_first) != ((void *)0)) (head)->tqh_first->hd_list.tqe_prev = &(hdp)->hd_list.tqe_next; else (head)->tqh_last = &(hdp)->hd_list.tqe_next; (head)->tqh_first = (hdp); (hdp)->hd_list.tqe_prev = &(head)->tqh_first; } while (0);
...
hook_disestablish(struct hook_desc_head *head, void *vhook)
{
 ...
 for (hdp = ((head)->tqh_first); hdp != ((void *)0);
 ...
 hdp = vhook;
 do { if (((hdp)->hd_list.tqe_next) != ((void *)0)) (hdp)->hd_list.tqe_next->hd_list.tqe_prev = (hdp)->hd_list.tqe_prev; else (head)->tqh_last = (hdp)->hd_list.tqe_prev; *(hdp)->hd_list.tqe_prev = (hdp)->hd_list.tqe_next; ((hdp)->hd_list.tqe_prev) = ((void *)-1); ((hdp)->hd_list.tqe_next) = ((void *)-1); } while (0);
 free(hdp, 2, sizeof(*hdp));
}
...
dohooks(struct hook_desc_head *head, int flags)
{
 ...
 if ((flags & 0x01) == 0) {
  for ((hdp) = ((head)->tqh_first); (hdp) != ((void *)0) && ((hdp_temp) = ((hdp)->hd_list.tqe_next), 1); (hdp) = (hdp_temp)) {
   (*hdp->hd_fn)(hdp->hd_arg);
  }
 } else {
  while ((hdp = ((head)->tqh_first)) != ((void *)0)) {
   do { if (((hdp)->hd_list.tqe_next) != ((void *)0)) (hdp)->hd_list.tqe_next->hd_list.tqe_prev = (hdp)->hd_list.tqe_prev; else (head)->tqh_last = (hdp)->hd_list.tqe_prev; *(hdp)->hd_list.tqe_prev = (hdp)->hd_list.tqe_next; ((hdp)->hd_list.tqe_prev) = ((void *)-1); ((hdp)->hd_list.tqe_next) = ((void *)-1); } while (0);
   (*hdp->hd_fn)(hdp->hd_arg);
   if ((flags & 0x02) != 0)
    free(hdp, 2, sizeof(*hdp));
