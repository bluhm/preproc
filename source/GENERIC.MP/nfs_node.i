# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c"
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c"
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2



# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/rpcv2.h" 1
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
int nfs_fsinfo(struct nfsmount *, struct vnode *, struct ucred *,
     struct proc *);
void nfs_init(void);
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c" 2
...
nfsnode_cmp(const struct nfsnode *a, const struct nfsnode *b)
{
 ...
 return (__builtin_memcmp((a->n_fhp), (b->n_fhp), (a->n_fhsize)));
}

extern const struct rb_type *const nfs_nodetree_RBT_TYPE; __attribute__((__unused__)) static inline void nfs_nodetree_RBT_INIT(struct nfs_nodetree *head) { _rb_init(&head->rbh_root); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_INSERT(struct nfs_nodetree *head, struct nfsnode *elm) { return _rb_insert(nfs_nodetree_RBT_TYPE, &head->rbh_root, elm); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_REMOVE(struct nfs_nodetree *head, struct nfsnode *elm) { return _rb_remove(nfs_nodetree_RBT_TYPE, &head->rbh_root, elm); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_FIND(struct nfs_nodetree *head, const struct nfsnode *key) { return _rb_find(nfs_nodetree_RBT_TYPE, &head->rbh_root, key); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_NFIND(struct nfs_nodetree *head, const struct nfsnode *key) { return _rb_nfind(nfs_nodetree_RBT_TYPE, &head->rbh_root, key); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_ROOT(struct nfs_nodetree *head) { return _rb_root(nfs_nodetree_RBT_TYPE, &head->rbh_root); } __attribute__((__unused__)) static inline int nfs_nodetree_RBT_EMPTY(struct nfs_nodetree *head) { return _rb_empty(&head->rbh_root); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_MIN(struct nfs_nodetree *head) { return _rb_min(nfs_nodetree_RBT_TYPE, &head->rbh_root); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_MAX(struct nfs_nodetree *head) { return _rb_max(nfs_nodetree_RBT_TYPE, &head->rbh_root); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_NEXT(struct nfsnode *elm) { return _rb_next(nfs_nodetree_RBT_TYPE, elm); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_PREV(struct nfsnode *elm) { return _rb_prev(nfs_nodetree_RBT_TYPE, elm); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_LEFT(struct nfsnode *elm) { return _rb_left(nfs_nodetree_RBT_TYPE, elm); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_RIGHT(struct nfsnode *elm) { return _rb_right(nfs_nodetree_RBT_TYPE, elm); } __attribute__((__unused__)) static inline struct nfsnode * nfs_nodetree_RBT_PARENT(struct nfsnode *elm) { return _rb_parent(nfs_nodetree_RBT_TYPE, elm); } __attribute__((__unused__)) static inline void nfs_nodetree_RBT_SET_LEFT(struct nfsnode *elm, struct nfsnode *left) { return _rb_set_left(nfs_nodetree_RBT_TYPE, elm, left); } __attribute__((__unused__)) static inline void nfs_nodetree_RBT_SET_RIGHT(struct nfsnode *elm, struct nfsnode *right) { return _rb_set_right(nfs_nodetree_RBT_TYPE, elm, right); } __attribute__((__unused__)) static inline void nfs_nodetree_RBT_SET_PARENT(struct nfsnode *elm, struct nfsnode *parent) { return _rb_set_parent(nfs_nodetree_RBT_TYPE, elm, parent); } __attribute__((__unused__)) static inline void nfs_nodetree_RBT_POISON(struct nfsnode *elm, unsigned long poison) { return _rb_poison(nfs_nodetree_RBT_TYPE, elm, poison); } __attribute__((__unused__)) static inline int nfs_nodetree_RBT_CHECK(struct nfsnode *elm, unsigned long poison) { return _rb_check(nfs_nodetree_RBT_TYPE, elm, poison); };
static int nfs_nodetree_RBT_COMPARE(const void *lptr, const void *rptr) { const struct nfsnode *l = lptr, *r = rptr; return nfsnode_cmp(l, r); } static const struct rb_type nfs_nodetree_RBT_INFO = { nfs_nodetree_RBT_COMPARE, ((void *)0), __builtin_offsetof(struct nfsnode, n_entry), }; const struct rb_type *const nfs_nodetree_RBT_TYPE = &nfs_nodetree_RBT_INFO;

void
nfs_ninit(struct nfsmount *nmp)
{
 nfs_nodetree_RBT_INIT(&nmp->nm_ntree);
}
...
# 123 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/nfs_node.c"
 _rw_exit_write(&nfs_hashlock );
...
nfs_inactive(void *v)
{
 ...
 if (ap->a_vp->v_data == ((void *)0))
  panic("NULL v_data (no nfsnode set up?) in vnode %p",
      ap->a_vp);

 np = ((struct nfsnode *)(ap->a_vp)->v_data);
