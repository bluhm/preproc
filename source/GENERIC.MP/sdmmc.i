# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c"
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.h" 1
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc_scsi.h"
struct sdmmc_softc;

void sdmmc_scsi_attach(struct sdmmc_softc *);
void sdmmc_scsi_detach(struct sdmmc_softc *);
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmcvar.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmcvar.h"
struct sdmmc_csd {
 int csdver;
 int mmcver;
 int capacity;
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c" 2
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c"
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c"
...
sdmmc_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 do { (&sc->sf_head)->sqh_first = ((void *)0); (&sc->sf_head)->sqh_last = &(&sc->sf_head)->sqh_first; } while (0);
 do { (&sc->sc_tskq)->tqh_first = ((void *)0); (&sc->sc_tskq)->tqh_last = &(&sc->sc_tskq)->tqh_first; } while (0);
 do { (&sc->sc_intrq)->tqh_first = ((void *)0); (&sc->sc_intrq)->tqh_last = &(&sc->sc_intrq)->tqh_first; } while (0);
 do { (&sc->sc_discover_task)->func = (sdmmc_discover_task); (&sc->sc_discover_task)->arg = (sc); (&sc->sc_discover_task)->onqueue = 0; (&sc->sc_discover_task)->sc = ((void *)0); } while (0);
 do { (&sc->sc_intr_task)->func = (sdmmc_intr_task); (&sc->sc_intr_task)->arg = (sc); (&sc->sc_intr_task)->onqueue = 0; (&sc->sc_intr_task)->sc = ((void *)0); } while (0);
 _rw_init_flags(&sc->sc_lock, ((sc)->sc_dev.dv_xname), 0, ((void *)0));
# 148 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sdmmc/sdmmc.c"
 ((sc->sc_flags) |= (0x0080));
 config_pending_incr();
...
sdmmc_detach(struct device *self, int flags)
{
 ...
 sc->sc_dying = 1;
 while (sc->sc_task_thread != ((void *)0)) {
  wakeup(&sc->sc_tskq);
  tsleep(sc, 32, "mmcdie", 0);
 }
...
restart:
 ...
 s = _splraise(5);
 while (!sc->sc_dying) {
  for (task = ((&sc->sc_tskq)->tqh_first); task != ((void *)0);
       task = ((&sc->sc_tskq)->tqh_first)) {
   _splx(s);
   sdmmc_del_task(task);
   task->func(task->arg);
   s = _splraise(5);
  }
  tsleep(&sc->sc_tskq, 32, "mmctsk", 0);
 }
 _splx(s);

 if (((sc->sc_flags) & (0x0010))) {
  _rw_enter_write(&sc->sc_lock );
  sdmmc_card_detach(sc, 0x01);
  _rw_exit(&sc->sc_lock );
 }
...
sdmmc_add_task(struct sdmmc_softc *sc, struct sdmmc_task *task)
{
 ...
 s = _splraise(5);
 do { (task)->next.tqe_next = ((void *)0); (task)->next.tqe_prev = (&sc->sc_tskq)->tqh_last; *(&sc->sc_tskq)->tqh_last = (task); (&sc->sc_tskq)->tqh_last = &(task)->next.tqe_next; } while (0);
 task->onqueue = 1;
 task->sc = sc;
 wakeup(&sc->sc_tskq);
 _splx(s);
...
sdmmc_del_task(struct sdmmc_task *task)
{
 ...
 task->sc = ((void *)0);
 task->onqueue = 0;
 do { if (((task)->next.tqe_next) != ((void *)0)) (task)->next.tqe_next->next.tqe_prev = (task)->next.tqe_prev; else (&sc->sc_tskq)->tqh_last = (task)->next.tqe_prev; *(task)->next.tqe_prev = (task)->next.tqe_next; ((task)->next.tqe_prev) = ((void *)-1); ((task)->next.tqe_next) = ((void *)-1); } while (0);
 _splx(s);
}
...
sdmmc_needs_discover(struct device *self)
{
 ...
 if (!((&sc->sc_discover_task)->onqueue))
...
sdmmc_card_detach(struct sdmmc_softc *sc, int flags)
{
 ...
 for (sf = ((&sc->sf_head)->sqh_first); sf != ((void *)0); sf = sfnext) {
  sfnext = ((sf)->sf_list.sqe_next);
...
sdmmc_enable(struct sdmmc_softc *sc)
{
 ...
 error = ((sc->sct)->bus_power((sc->sch), (host_ocr)));
 if (error != 0) {
 ...
 error = ((sc->sct)->bus_clock((sc->sch), (400), (0)));
...
sdmmc_disable(struct sdmmc_softc *sc)
{
 ...
 (void)sdmmc_select_card(sc, ((void *)0));


 (void)((sc->sct)->bus_clock((sc->sch), (0), (0)));

 (void)((sc->sct)->bus_power((sc->sch), (0)));
}
    ...
    u_int32_t card_ocr)
{
 ...
 if (host_ocr == 0 ||
     ((sc->sct)->bus_power((sc->sch), (host_ocr))) != 0)
  return 1;
 return 0;
}
...
sdmmc_function_alloc(struct sdmmc_softc *sc)
{
 ...
 sf = (struct sdmmc_function *)malloc(sizeof *sf, 2,
     0x0001 | 0x0008);
 sf->sc = sc;
 sf->number = -1;
...
sdmmc_scan(struct sdmmc_softc *sc)
{
 ...
 if ((((&sc->sf_head)->sqh_first) == ((void *)0))) {
...
sdmmc_delay(u_int usecs)
{
 ...
 if (!cold && nticks > 0)
  tsleep(&sdmmc_delay, 32, "mmcdly", nticks);
 else
  delay(usecs);
}
...
sdmmc_app_command(struct sdmmc_softc *sc, struct sdmmc_command *cmd)
{
 ...
 __builtin_bzero((&acmd), (sizeof acmd));
 acmd.c_opcode = 55;
 acmd.c_arg = 0;
 if (sc->sc_card != ((void *)0)) {
  acmd.c_arg = sc->sc_card->rca << 16;
 }
 acmd.c_flags = 0x0000 | (0x1000|0x0400|0x0800);
...
sdmmc_mmc_command(struct sdmmc_softc *sc, struct sdmmc_command *cmd)
{
 ...
 ((sc->sct)->exec_command((sc->sch), (cmd)));
...
sdmmc_send_if_cond(struct sdmmc_softc *sc, uint32_t card_ocr)
{
 ...
 cmd.c_opcode = 8;
 cmd.c_arg = ((card_ocr & 0xFF8000) != 0) << 8 | pat;
 cmd.c_flags = 0x0030 | (0x1000|0x0400|0x0800);
...
sdmmc_select_card(struct sdmmc_softc *sc, struct sdmmc_function *sf)
{
 ...
 __builtin_bzero((&cmd), (sizeof cmd));
 cmd.c_opcode = 7;
 cmd.c_arg = sf == ((void *)0) ? 0 : ((sf->rca) << 16);
 cmd.c_flags = 0x0000 | (sf == ((void *)0) ? 0 : (0x1000|0x0400|0x0800));
 error = sdmmc_mmc_command(sc, &cmd);
 if (error == 0 || sf == ((void *)0))
  sc->sc_card = sf;
 return error;
}
