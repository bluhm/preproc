# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/mpe.h" 1
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_types.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
void pipexintr(void);
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c" 2
...
# 87 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c"
...
do_v6:
 ...
 if (rt_mpls == ((void *)0) || (rt->rt_flags & 0x100000) == 0) {
 ...
 case 0x1:
  ...
  if (ifp->if_data.ifi_type == 0xa6) {
   smpls = ((struct sockaddr_mpls *)(((rt)->rt_dest)));
 ...
 shim = ((struct shim_hdr *)((m)->m_hdr.mh_data));
 shim->shim_label = (shim->shim_label & ~((u_int32_t)((__uint32_t)((u_int32_t)(0x000000ffU))))) | ((__uint32_t)(ttl));
...
# 266 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netmpls/mpls_input.c"
 if (!((ifp->if_xflags) & (0x8))) {
 ...
 (*ifp->if_ll_output)(ifp, m, ((struct sockaddr *)(smpls)), rt);
done:
 if_put(ifp);
 rtfree(rt);
}
...
mpls_do_error(struct mbuf *m, int type, int code, int destmtu)
{
 ...
 for (nstk = 0; nstk < 16; nstk++) {
  ...
  m_adj(m, sizeof(*shim));
  if ((((stack[nstk].shim_label) & ((u_int32_t)((__uint32_t)((u_int32_t)(0x00000100U))))) == ((u_int32_t)((__uint32_t)((u_int32_t)(0x00000100U))))))
   break;
 }
 shim = &stack[0];
 ...
 case 4:
  ...
  rt = rtalloc(((struct sockaddr *)(smpls)), 1, 0);
  if (rt == ((void *)0)) {

   m_freem(m);
   return (((void *)0));
  }
  if (rt->rt_ifa->ifa_addr->sa_family == 2)
  ...
  error = icmp_reflect(m, ((void *)0), ia);
  rtfree(rt);
  if (error)
   return (((void *)0));
  ...
  icp = (struct icmp *)(((caddr_t)((m)->m_hdr.mh_data)) + sizeof(*ip));
  icp->icmp_cksum = 0;
  icp->icmp_cksum = in4_cksum(m, 0, sizeof(*ip),
      ((__uint16_t)(ip->ip_len)) - sizeof(*ip));
 ...
 (m) = m_prepend((m), ((nstk + 1) * sizeof(*shim)), (0x0002));
 if (m == ((void *)0))
  return (((void *)0));
 m_copyback(m, 0, (nstk + 1) * sizeof(*shim), stack, 0x0002);


 shim = ((struct shim_hdr *)((m)->m_hdr.mh_data));
 shim->shim_label =
     (shim->shim_label & ~((u_int32_t)((__uint32_t)((u_int32_t)(0x000000ffU))))) | ((__uint32_t)(mpls_defttl));
