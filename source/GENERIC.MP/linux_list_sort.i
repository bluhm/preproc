# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/linux_list_sort.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/linux_list_sort.c"
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/linux_list_sort.c"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/linux_list_sort.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/linux_list_sort.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/linux_list_sort.c" 2
   ...
   int (*compare)(void *, struct list_head *, struct list_head *))
{
 ...
 extern char _ctassert[((8 * sizeof(struct list_head *)) <= 64) ? 1 : -1 ] __attribute__((__unused__));

 for (logn = 0; logn < (sizeof((accum)) / sizeof((accum)[0])); logn++)
  accum[logn] = ((void *)0);

 for (sorted = (list)->next, next = (sorted)->next; sorted != list; sorted = next, next = sorted->next) {

  sorted->next = ((void *)0);


  for (logn = 0; accum[logn] != ((void *)0); logn++) {
   ...
   accum[logn] = ((void *)0);
   (((logn + 1) < (sizeof((accum)) / sizeof((accum)[0]))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/linux_list_sort.c", 86, "(logn + 1) < nitems(accum)"));
  }
       ...
       struct list_head *), void *arg)
{
 ...
 struct list_head *tail = (a == ((void *)0)? b : a);
 while (tail != ((void *)0)) {
  prev->next = tail;
  tail->prev = prev;
  prev = prev->next;
