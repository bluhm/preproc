# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c"
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c"
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_object.h"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon.h" 1
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atom-bits.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atom-bits.h"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c" 2
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c"
void radeon_atom_copy_swap(u8 *dst, u8 *src, u8 num_bytes, _Bool to_le)
{
 ...
 __builtin_memcpy((src_tmp), (src), (num_bytes));
 src32 = (u32 *)src_tmp;
 dst32 = (u32 *)dst_tmp;
 if (to_le) {
  for (i = 0; i < ((num_bytes + 3) / 4); i++)
   dst32[i] = __extension__({ __uint32_t __swap32gen_x = (src32[i]); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
     ...
     u8 delay, u8 *ack)
{
 ...
 int index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->ProcessAuxChannelTransaction)-(char*)0)/sizeof(USHORT));
 unsigned char *base;
 int recv_bytes;
 int r = 0;
 ...
 args.v1.lpAuxRequest = __extension__({ __uint16_t __swap16gen_x = ((u16)(0 + 4)); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
 args.v1.lpDataOut = __extension__({ __uint16_t __swap16gen_x = ((u16)(16 + 4)); (__uint16_t)((__swap16gen_x & 0xff) << 8 | (__swap16gen_x & 0xff00) >> 8); });
 ...
 *ack = args.v1.ucReplyStatus;
 ...
 if (recv && recv_size)
  radeon_atom_copy_swap(recv, base + 16, recv_bytes, 0);
...
radeon_dp_aux_transfer_atom(struct drm_dp_aux *aux, struct drm_dp_aux_msg *msg)
{
 struct radeon_i2c_chan *chan =
  ({ __typeof( ((struct radeon_i2c_chan *)0)->aux ) *__mptr = (aux); (struct radeon_i2c_chan *)( (char *)__mptr - __builtin_offsetof(struct radeon_i2c_chan, aux) );});
 int ret;
 u8 tx_buf[20];
 size_t tx_size;
 u8 ack, delay = 0;

 if (({ int __ret = !!(msg->size > 16); if (__ret) printf("WARNING %s failed at %s:%d\n", "msg->size > 16", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c", 166); __builtin_expect(!!(__ret), 0); }))
  return -7;
 ...
 case 0x2:
  ...
  if (({ static int __warned; int __ret = !!(msg->size > 12); if (__ret && !__warned) { printf("WARNING %s failed at %s:%d\n", "msg->size > 12", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/atombios_dp.c", 184); __warned = 1; } __builtin_expect(!!(__ret), 0); }))
   return -7;



  tx_size = (3 + 1) + msg->size;
  if (msg->size == 0)
   tx_buf[3] |= 3 << 4;
  else
   tx_buf[3] |= tx_size << 4;
  __builtin_memcpy((tx_buf + (3 + 1)), (msg->buffer), (msg->size));
  ret = radeon_process_aux_ch(chan,
         tx_buf, tx_size, ((void *)0), 0, delay, &ack);
  if (ret >= 0)
...
void radeon_dp_aux_init(struct radeon_connector *radeon_connector)
{
 ...
 ({ int __ret = !!(ret); if (__ret) printf("drm_dp_aux_register() failed with error %d\n", ret); __builtin_expect(!!(__ret), 0); });
}
...
static void dp_get_adjust_train(const u8 link_status[6],
    int lane_count,
    u8 train_set[4])
{
 u8 v = 0;
     ...
     unsigned *dp_lanes, unsigned *dp_rate)
{
 ...
 if (radeon_connector_encoder_get_dp_bridge_encoder_id(connector) ==
  ...
  for (i = 0; i < (sizeof((link_rates)) / sizeof((link_rates)[0])) && link_rates[i] <= max_link_rate; i++) {
   for (lane_num = 1; lane_num <= max_lane_num; lane_num <<= 1) {
        ...
        u8 ucconfig, u8 lane_num)
{
 ...
 int index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->DPEncoderService)-(char*)0)/sizeof(USHORT));
...
u8 radeon_dp_getsinktype(struct radeon_connector *radeon_connector)
{
 ...
 return radeon_dp_encoder_service(rdev, 0x01, 0,
...
static void radeon_dp_probe_oui(struct radeon_connector *radeon_connector)
{
 ...
 if (!(dig_connector->dpcd[0x007] & (1 << 7)))
  return;

 if (drm_dp_dpcd_read(&radeon_connector->ddc_bus->aux, 0x400, buf, 3) == 3)
  do { } while( 0);


 if (drm_dp_dpcd_read(&radeon_connector->ddc_bus->aux, 0x500, buf, 3) == 3)
  do { } while( 0);

}

_Bool radeon_dp_getdpcd(struct radeon_connector *radeon_connector)
{
 struct radeon_connector_atom_dig *dig_connector = radeon_connector->con_priv;
 u8 msg[0xf];
 int ret, i;
 ...
 for (i = 0; i < 7; i++) {
  ret = drm_dp_dpcd_read(&radeon_connector->ddc_bus->aux, 0x000, msg,
           0xf);
  if (ret == 0xf) {
   __builtin_memcpy((dig_connector->dpcd), (msg), (0xf));
        ...
        struct drm_connector *connector)
{
 ...
 struct radeon_device *rdev = dev->dev_private;
 struct radeon_connector *radeon_connector = ({ __typeof( ((struct radeon_connector *)0)->base ) *__mptr = (connector); (struct radeon_connector *)( (char *)__mptr - __builtin_offsetof(struct radeon_connector, base) );});
 ...
 if (dp_bridge != 0x00) {
  ...
  if (drm_dp_dpcd_readb(&radeon_connector->ddc_bus->aux,
   ...
   if (tmp & 1)
    panel_mode = 0x01;
   else if ((dp_bridge == 0x22) ||
     (dp_bridge == 0x23))
    panel_mode = 0x11;
   else
    panel_mode = 0x00;
  }
 } else if (connector->connector_type == 14) {
...
_Bool radeon_dp_needs_link_train(struct radeon_connector *radeon_connector)
{
 u8 link_status[6];
...
static void radeon_dp_update_vs_emph(struct radeon_dp_link_train_info *dp_info)
{
 ...
 drm_dp_dpcd_write(dp_info->aux, 0x103,
...
static void radeon_dp_set_tp(struct radeon_dp_link_train_info *dp_info, int tp)
{
 ...
 if (((dp_info->rdev->family >= CHIP_CEDAR)) || !dp_info->use_dpencoder) {
  switch (tp) {
  case 1:
   rtp = 0x09;
   break;
  ...
  radeon_dp_encoder_service(dp_info->rdev, 0x04,
       dp_info->dp_clock, dp_info->enc_id, rtp);
 }


 drm_dp_dpcd_writeb(dp_info->aux, 0x102, tp);
}

static int radeon_dp_link_train_init(struct radeon_dp_link_train_info *dp_info)
{
 struct radeon_encoder *radeon_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (dp_info->encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
 struct radeon_encoder_atom_dig *dig = radeon_encoder->enc_priv;
 u8 tmp;


 radeon_dp_set_rx_power_state(dp_info->connector, 0x1);
 ...
 if (dig->panel_mode == 0x01)
  drm_dp_dpcd_writeb(dp_info->aux, 0x10a, 1);


 tmp = dp_info->dp_lane_count;
 if (drm_dp_enhanced_frame_cap(dp_info->dpcd))
  tmp |= (1 << 7);
 drm_dp_dpcd_writeb(dp_info->aux, 0x101, tmp);


 tmp = drm_dp_link_rate_to_bw_code(dp_info->dp_clock);
 drm_dp_dpcd_writeb(dp_info->aux, 0x100, tmp);
 ...
 if (((dp_info->rdev->family >= CHIP_CEDAR)) || !dp_info->use_dpencoder)
  ...
  radeon_dp_encoder_service(dp_info->rdev, 0x02,
...
static int radeon_dp_link_train_finish(struct radeon_dp_link_train_info *dp_info)
{
 ...
 if (((dp_info->rdev->family >= CHIP_CEDAR)) || !dp_info->use_dpencoder)
  ...
  radeon_dp_encoder_service(dp_info->rdev, 0x03,
       dp_info->dp_clock, dp_info->enc_id, 0);
...
{
 _Bool clock_recovery;
  u8 voltage;
 int i;

 radeon_dp_set_tp(dp_info, 1);
 __builtin_memset((dp_info->train_set), (0), (4));
 ...
 while (1) {
  ...
  if (drm_dp_dpcd_read_link_status(dp_info->aux,
   ...
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "displayport link status failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   break;
  }
  ...
  for (i = 0; i < dp_info->dp_lane_count; i++) {
   if ((dp_info->train_set[i] & (1 << 2)) == 0)
    break;
  }
  if (i == dp_info->dp_lane_count) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "clock recovery reached max voltage\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   break;
  }

  if ((dp_info->train_set[0] & 0x3) == voltage) {
   ++dp_info->tries;
   if (dp_info->tries == 5) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "clock recovery tried 5 times\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    break;
   }
  } else
   dp_info->tries = 0;

  voltage = dp_info->train_set[0] & 0x3;
 ...
 if (!clock_recovery) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "clock recovery failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -1;
 } else {
  do { } while( 0);
...
static int radeon_dp_link_train_ce(struct radeon_dp_link_train_info *dp_info)
{
 ...
 if (dp_info->tp3_supported)
  radeon_dp_set_tp(dp_info, 3);
 else
  radeon_dp_set_tp(dp_info, 2);
 ...
 while (1) {
  ...
  if (dp_info->tries > 5) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "channel eq failed: 5 tries\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   break;
  }
 ...
 if (!channel_eq) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "channel eq failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -1;
 } else {
  do { } while( 0);
     ...
     struct drm_connector *connector)
{
 ...
 index = (((char*)(&((ATOM_MASTER_LIST_OF_COMMAND_TABLES*)0)->DPEncoderService)-(char*)0)/sizeof(USHORT));
 ...
 if (drm_dp_dpcd_readb(&radeon_connector->ddc_bus->aux, 0x002, &tmp)
     == 1) {
  if (((rdev->family >= CHIP_BARTS)) && (tmp & (1 << 6)))
 ...
 __builtin_memcpy((dp_info.dpcd), (dig_connector->dpcd), (0xf));
 dp_info.rdev = rdev;
