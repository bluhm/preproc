# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_dp_auxch.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_dp_auxch.c"
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_dp_auxch.c"
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_dp_auxch.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_dp_auxch.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_dp_auxch.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/nid.h" 1
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_dp_auxch.c" 2
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_dp_auxch.c"
...
radeon_dp_aux_transfer_native(struct drm_dp_aux *aux, struct drm_dp_aux_msg *msg)
{
 ...
 if (({ int __ret = !!(msg->size > 16); if (__ret) printf("WARNING %s failed at %s:%d\n", "msg->size > 16", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_dp_auxch.c", 71); __builtin_expect(!!(__ret), 0); }))
  return -7;
 ...
 _rw_enter_write(&chan->mutex );


 tmp = r100_mm_rreg(rdev, (chan->rec.mask_clk_reg), 0);
 tmp |= (1 << 16);
 r100_mm_wreg(rdev, (chan->rec.mask_clk_reg), (tmp), 0);


 tmp = r100_mm_rreg(rdev, (0x6200 + aux_offset[instance]), 0);

 tmp &= (((0x7) & 0x7) << 20);
 tmp |= (((chan->rec.hpd) & 0x7) << 20);
 tmp |= (1 << 0) | (1 << 8);

 r100_mm_wreg(rdev, (0x6200 + aux_offset[instance]), (tmp), 0);


 r100_mm_wreg(rdev, (0x6204 + aux_offset[instance]), ((((bytes) & 0x1f) << 16)), 0);
 ...
 r100_mm_wreg(rdev, (0x6218 + aux_offset[instance]), ((((byte) & 0xff) << 8) | (1 << 31)), 0);


 byte = (msg->address >> 8) & 0xff;
 r100_mm_wreg(rdev, (0x6218 + aux_offset[instance]), ((((byte) & 0xff) << 8)), 0);
 ...
 if (is_write) {
  for (i = 0; i < msg->size; i++) {
   r100_mm_wreg(rdev, (0x6218 + aux_offset[instance]), ((((buf[i]) & 0xff) << 8)), 0);

  }
 }


 r100_mm_wreg(rdev, (0x620c + aux_offset[instance]), ((1 << 1)), 0);


 r100_mm_wreg(rdev, (0x6204 + aux_offset[instance]), ((((bytes) & 0x1f) << 16) | (1 << 0)), 0);



 do {
  tmp = r100_mm_rreg(rdev, (0x6210 + aux_offset[instance]), 0);
  if (tmp & (1 << 0)) {
   break;
  }
 ...
 if (retry_count >= 1000) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "auxch hw never signalled completion, error %08x\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , tmp);
  ret = -5;
  goto done;
 }
 ...
 if (tmp & ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 17) | (1 << 18) | (1 << 19) | (1 << 20) | (1 << 22) | (1 << 23))) {
  do { } while( 0);
  ret = -5;
  goto done;
 }
 ...
 bytes = (((tmp) >> 24) & 0x1f);
 if (bytes) {
  r100_mm_wreg(rdev, (0x6218 + aux_offset[instance]), ((1 << 0) | (1 << 31)), 0);


  tmp = r100_mm_rreg(rdev, (0x6218 + aux_offset[instance]), 0);
  ack = (tmp >> 8) & 0xff;
