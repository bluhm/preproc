...
ip_init(void)
{
 ...
 do { ((&ipq)->lh_first) = ((void *)0); } while (0);
 if (ip_mtudisc != 0)
 ...
 while (nxt != 257) {
  ...
  if (af == 24 &&
   ...
   if ((*mp)->m_hdr.mh_len >= sizeof(struct ip6_hdr)) {
    icmp6_error(*mp, 1,
     3,
     __builtin_offsetof(struct ip6_hdr, ip6_dst));
    *mp = ((void *)0);
   }
   goto bad;
  }
...
ip_reass(struct ipqent *ipqe, struct ipq *fp)
{
 ...
 if (fp == ((void *)0)) {
  ...
  if (fp == ((void *)0))
   goto dropfrag;
  do { if (((fp)->ipq_q.le_next = (&ipq)->lh_first) != ((void *)0)) (&ipq)->lh_first->ipq_q.le_prev = &(fp)->ipq_q.le_next; (&ipq)->lh_first = (fp); (fp)->ipq_q.le_prev = &(&ipq)->lh_first; } while (0);
  fp->ipq_ttl = 60;
  fp->ipq_p = ipqe->ipqe_ip->ip_p;
  fp->ipq_id = ipqe->ipqe_ip->ip_id;
  do { ((&fp->ipq_fragq)->lh_first) = ((void *)0); } while (0);
 ...
 if (ecn == 0x03) {
  if (ecn0 == 0x00)
   goto dropfrag;
  if (ecn0 != 0x03)
   ((&fp->ipq_fragq)->lh_first)->ipqe_ip->ip_tos |=
       0x03;
 }
 ...
 if (p != ((void *)0)) {
  ...
  if (i > 0) {
   if (i >= ((__uint16_t)(ipqe->ipqe_ip->ip_len)))
    goto dropfrag;
   m_adj(ipqe->ipqe_m, i);
   ipqe->ipqe_ip->ip_off =
       ((__uint16_t)(((__uint16_t)(ipqe->ipqe_ip->ip_off)) + i));
   ipqe->ipqe_ip->ip_len =
 ...
 for (; q != ((void *)0) &&
  ...
  i = (((__uint16_t)(ipqe->ipqe_ip->ip_off)) +
      ((__uint16_t)(ipqe->ipqe_ip->ip_len))) - ((__uint16_t)(q->ipqe_ip->ip_off));
  if (i < ((__uint16_t)(q->ipqe_ip->ip_len))) {
   q->ipqe_ip->ip_len =
       ((__uint16_t)(((__uint16_t)(q->ipqe_ip->ip_len)) - i));
   q->ipqe_ip->ip_off =
       ((__uint16_t)(((__uint16_t)(q->ipqe_ip->ip_off)) + i));
   m_adj(q->ipqe_m, i);
   break;
  }
  nq = ((q)->ipqe_q.le_next);
...
insert:
 ...
 if (p == ((void *)0)) {
  ...
  do { if (((ipqe)->ipqe_q.le_next = (p)->ipqe_q.le_next) != ((void *)0)) (p)->ipqe_q.le_next->ipqe_q.le_prev = &(ipqe)->ipqe_q.le_next; (p)->ipqe_q.le_next = (ipqe); (ipqe)->ipqe_q.le_prev = &(p)->ipqe_q.le_next; } while (0);
 }
 next = 0;
 for (p = ((void *)0), q = ((&fp->ipq_fragq)->lh_first); q != ((void *)0);
     p = q, q = ((q)->ipqe_q.le_next)) {
  if (((__uint16_t)(q->ipqe_ip->ip_off)) != next)
   return (0);
  next += ((__uint16_t)(q->ipqe_ip->ip_len));
 }
 if (p->ipqe_mff)
  return (0);
...
{
 struct ip *ip = ((struct ip *)((m)->m_hdr.mh_data));
 unsigned int rtableid = m->M_dat.MH.MH_pkthdr.ph_rtableid;
 struct rtentry *rt;
...
# 1120 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_input.c"
  ...
  case 68:
   ...
   if (optlen < sizeof(struct ip_timestamp))
    goto bad;
   __builtin_memcpy((&ipt), (cp), (sizeof(struct ip_timestamp)));
   ...
   case 3:
    ...
    if (ifa_ifwithaddr(sintosa(&ipaddr),
        m->M_dat.MH.MH_pkthdr.ph_rtableid) == ((void *)0))
     continue;
    ipt.ipt_ptr += sizeof(struct in_addr);
    break;
   ...
   ntime = iptime();
   __builtin_memcpy((cp + ipt.ipt_ptr - 1), (&ntime), (sizeof(u_int32_t)));
   ipt.ipt_ptr += sizeof(u_int32_t);
  }
 }
 _kernel_unlock();
 if (forward && ipforwarding) {
  ip_forward(m, ifp, ((void *)0), 1);
  return (1);
 }
 return (0);
bad:
...
ip_stripoptions(struct mbuf *m)
{
 ...
 __builtin_memmove((opts), (opts + olen), (i));
 m->m_hdr.mh_len -= olen;
 if (m->m_hdr.mh_flags & 0x0002)
...
{
 struct mbuf mfake, *mcopy = ((void *)0);
 struct ip *ip = ((struct ip *)((m)->m_hdr.mh_data));
 struct sockaddr_in *sin;
 struct route ro;
...
# 1477 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_input.c"
 ...
 if (m_dup_pkthdr(&mfake, m, 0x0002) == 0) {
  mfake.m_hdr.mh_data = mfake.M_dat.MH.MH_dat.MH_databuf;
...
# 1502 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_input.c"
 if ((rt->rt_ifidx == ifp->if_index) &&
     ...
     !arpproxy(satosin(((rt)->rt_dest))->sin_addr, m->M_dat.MH.MH_pkthdr.ph_rtableid)) {
    ...
    size_t newlen)
{
 ...
 case 27:
  ...
  if (ip_mtudisc != 0 && ip_mtudisc_timeout_q == ((void *)0)) {
   ip_mtudisc_timeout_q =
       rt_timer_queue_create(ip_mtudisc_timeout);
  } else if (ip_mtudisc == 0 && ip_mtudisc_timeout_q != ((void *)0)) {
...
# 1748 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/ip_input.c"
 if (inp->inp_flags & 0x080) {
  ...
  if (ifp == ((void *)0) || ifp->if_sadl == ((void *)0)) {
   ...
   sdl.sdl_len = __builtin_offsetof(struct sockaddr_dl, sdl_data[0]);
   sdl.sdl_family = 18;
   sdl.sdl_index = ifp != ((void *)0) ? ifp->if_index : 0;
   sdl.sdl_nlen = sdl.sdl_alen = sdl.sdl_slen = 0;
   *mp = sbcreatecontrol((caddr_t) &sdl, sdl.sdl_len,
       30, 0);
  } else {
   *mp = sbcreatecontrol((caddr_t) ifp->if_sadl,
       ifp->if_sadl->sdl_len, 30, 0);
  }
  if (*mp)
   mp = &(*mp)->m_hdr.mh_next;
  if_put(ifp);
 }
 if (inp->inp_flags & 0x040) {
  *mp = sbcreatecontrol((caddr_t) &ip->ip_ttl,
      sizeof(u_int8_t), 31, 0);
  if (*mp)
   mp = &(*mp)->m_hdr.mh_next;
 }
