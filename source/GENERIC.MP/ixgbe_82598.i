# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c" 2
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
...
int32_t ixgbe_check_mac_link_82598(struct ixgbe_hw *hw,
       ixgbe_link_speed *speed, _Bool *link_up,
       _Bool link_up_wait_to_complete);
...
int32_t ixgbe_read_analog_reg8_82598(struct ixgbe_hw *hw, uint32_t reg64, uint8_t *val);
int32_t ixgbe_write_analog_reg8_82598(struct ixgbe_hw *hw, uint32_t reg64, uint8_t val);
...
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
void ixgbe_set_pcie_completion_timeout(struct ixgbe_hw *hw)
{
 uint32_t gcr = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x11000);
 ...
 pcie_devctl2 = ixgbe_read_pci_cfg(hw, 0xC8);
 pcie_devctl2 |= 0x0005;
 ixgbe_write_pci_cfg(hw, 0xC8, pcie_devctl2);
out:

 gcr &= ~0x00010000;
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x11000, gcr);
}
# 134 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_init_ops_82598(struct ixgbe_hw *hw)
{
...
# 197 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_init_phy_ops_82598(struct ixgbe_hw *hw)
{
 struct ixgbe_mac_info *mac = &hw->mac;
 struct ixgbe_phy_info *phy = &hw->phy;
...
# 260 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_start_hw_82598(struct ixgbe_hw *hw)
{
 uint32_t regval;
 uint32_t i;
 ...
 for (i = 0; ((i < hw->mac.max_tx_queues) &&
      (i < 16)); i++) {
  regval = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x07200 + ((i) * 4)));
  regval &= ~(1 << 11);
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x07200 + ((i) * 4)), regval);
 }

 for (i = 0; ((i < hw->mac.max_rx_queues) &&
      (i < 16)); i++) {
  regval = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (((i) <= 15) ? (0x02200 + ((i) * 4)) : (((i) < 64) ? (0x0100C + ((i) * 0x40)) : (0x0D00C + (((i) - 64) * 0x40)))));
  regval &= ~((1 << 13) |
       (1 << 15));
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (((i) <= 15) ? (0x02200 + ((i) * 4)) : (((i) < 64) ? (0x0100C + ((i) * 0x40)) : (0x0D00C + (((i) - 64) * 0x40)))), regval);
 }
...
# 302 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_get_link_capabilities_82598(struct ixgbe_hw *hw,
       ixgbe_link_speed *speed,
       _Bool *autoneg)
{
...
int32_t ixgbe_fc_enable_82598(struct ixgbe_hw *hw)
{
 ...
 fctrl_reg = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x05080);
 fctrl_reg &= ~(0x00008000 | 0x00004000);

 rmcs_reg = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x03D00);
 rmcs_reg &= ~(0x00000010 | 0x00000008);
# 486 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
 ...
 case ixgbe_fc_none:
  ...
  break;
 case ixgbe_fc_rx_pause:
# 502 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
  fctrl_reg |= 0x00008000;
  break;
 ...
 fctrl_reg |= 0x00002000;
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x05080, fctrl_reg);
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x03D00, rmcs_reg);


 for (i = 0; i < 8; i++) {
  if ((hw->fc.current_mode & ixgbe_fc_tx_pause) &&
      hw->fc.high_water[i]) {
   fcrtl = (hw->fc.low_water[i] << 10) | 0x80000000;
   fcrth = (hw->fc.high_water[i] << 10) | 0x80000000;
   bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x03220 + ((i) * 8)), fcrtl);
   bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x03260 + ((i) * 8)), fcrth);
  } else {
   bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x03220 + ((i) * 8)), 0);
   bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x03260 + ((i) * 8)), 0);
  }

 }


 reg64 = hw->fc.pause_time * 0x00010001;
 for (i = 0; i < (8 / 2); i++)
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x03200 + ((i) * 4)), reg64);


 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x032A0, hw->fc.pause_time / 2);

out:
 return ret_val;
}
# 562 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_start_mac_link_82598(struct ixgbe_hw *hw,
       _Bool autoneg_wait_to_complete)
{
 uint32_t autoc_reg;
...
# 610 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_validate_link_ready(struct ixgbe_hw *hw)
{
 uint32_t timeout;
 uint16_t an_reg;

 if (hw->device_id != 0x150B)
  return 0;

 for (timeout = 0;
      timeout < 50; timeout++) {
  hw->phy.ops.read_reg(hw, 0x1,
         0x7, &an_reg);
...
# 647 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_check_mac_link_82598(struct ixgbe_hw *hw,
       ixgbe_link_speed *speed, _Bool *link_up,
       _Bool link_up_wait_to_complete)
{
 ...
 if (hw->phy.type == ixgbe_phy_nl) {
  hw->phy.ops.read_reg(hw, 0xC79F, 1, &link_reg);
  hw->phy.ops.read_reg(hw, 0xC79F, 1, &link_reg);
  hw->phy.ops.read_reg(hw, 0xC00C, 1,
         &adapt_comp_reg);
 ...
 if (links_reg & 0x20000000)
  *speed = 0x0080;
 else
  *speed = 0x0020;

 if ((hw->device_id == 0x150B) && (*link_up == 1) &&
...
# 736 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_setup_mac_link_82598(struct ixgbe_hw *hw,
       ixgbe_link_speed speed,
       _Bool autoneg_wait_to_complete)
{
 ...
 uint32_t curr_autoc = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x042A0);
 uint32_t autoc = curr_autoc;
 uint32_t link_mode = autoc & (0x7 << 13);
...
# 790 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_setup_copper_link_82598(struct ixgbe_hw *hw,
          ixgbe_link_speed speed,
          _Bool autoneg_wait_to_complete)
{
...
# 815 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_reset_hw_82598(struct ixgbe_hw *hw)
{
 int32_t status = 0;
 int32_t phy_status = 0;
 uint32_t ctrl;
 uint32_t gheccr;
 uint32_t i;
 uint32_t autoc;
 ...
 hw->mac.ops.read_analog_reg8(hw, 0x24, &analog_val);
 if (analog_val & 0x10) {

  hw->mac.ops.read_analog_reg8(hw, 0x24,
          &analog_val);
  analog_val &= ~0x10;
  hw->mac.ops.write_analog_reg8(hw, 0x24,
           analog_val);

  hw->mac.ops.read_analog_reg8(hw, 0xB,
          &analog_val);
  analog_val &= ~0xF0;
  hw->mac.ops.write_analog_reg8(hw, 0xB,
           analog_val);

  hw->mac.ops.read_analog_reg8(hw, 0xC,
          &analog_val);
  analog_val &= ~0xF0;
  hw->mac.ops.write_analog_reg8(hw, 0xC,
           analog_val);

  hw->mac.ops.read_analog_reg8(hw, 0xD,
          &analog_val);
  analog_val &= ~0xF0;
  hw->mac.ops.write_analog_reg8(hw, 0xD,
           analog_val);
 }
...
mac_reset_top:
 ...
 ctrl = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00000) | 0x04000000;
 ...
 gheccr = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x110B0);
 gheccr &= ~((1 << 21) | (1 << 18) | (1 << 9) | (1 << 6));
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x110B0, gheccr);
 ...
 if (hw->mac.orig_link_settings_stored == 0) {
  ...
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x042A0, hw->mac.orig_autoc);
 }
...
int32_t ixgbe_set_vmdq_82598(struct ixgbe_hw *hw, uint32_t rar, uint32_t vmdq)
{
 ...
 rar_high = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (((rar) <= 15) ? (0x05404 + ((rar) * 8)) : (0x0A204 + ((rar) * 8))));
 rar_high &= ~0x003C0000;
 rar_high |= ((vmdq << 18) & 0x003C0000);
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (((rar) <= 15) ? (0x05404 + ((rar) * 8)) : (0x0A204 + ((rar) * 8))), rar_high);
 return 0;
}
...
# 1006 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
        ...
        _Bool vlan_on)
{
 ...
 bits = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x0A200 + ((vftabyte) * 0x200) + ((regindex) * 4)));
 bits &= (~(0x0F << bitindex));
 bits |= (vind << bitindex);
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x0A200 + ((vftabyte) * 0x200) + ((regindex) * 4)), bits);


 bitindex = vlan & 0x1F;

 bits = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x0A000 + ((regindex) * 4)));
 if (vlan_on)
  ...
  bits &= ~(1 << bitindex);
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x0A000 + ((regindex) * 4)), bits);
...
int32_t ixgbe_clear_vfta_82598(struct ixgbe_hw *hw)
{
 ...
 for (offset = 0; offset < hw->mac.vft_size; offset++)
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x0A000 + ((offset) * 4)), 0);

 for (vlanbyte = 0; vlanbyte < 4; vlanbyte++)
  for (offset = 0; offset < hw->mac.vft_size; offset++)
   bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x0A200 + ((vlanbyte) * 0x200) + ((offset) * 4)), 0);


 return 0;
}
# 1079 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_read_analog_reg8_82598(struct ixgbe_hw *hw, uint32_t reg64, uint8_t *val)
{
 uint32_t atlas_ctl;
 ...
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x04800, 0x00010000 | (reg64 << 8));

 bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00008);
 delay(10);
 atlas_ctl = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x04800);
 *val = (uint8_t)atlas_ctl;

 return 0;
}
# 1103 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_write_analog_reg8_82598(struct ixgbe_hw *hw, uint32_t reg64, uint8_t val)
{
 uint32_t atlas_ctl;
 ...
 atlas_ctl = (reg64 << 8) | val;
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x04800, atlas_ctl);
 bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00008);
 delay(10);

 return 0;
}
# 1126 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_read_i2c_phy_82598(struct ixgbe_hw *hw, uint8_t dev_addr,
     uint8_t byte_offset, uint8_t *eeprom_data)
{
 int32_t status = 0;
 ...
 if (bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00008) & 0x00000004)
  gssr = 0x0004;
 else
  gssr = 0x0002;
 ...
 if (hw->phy.type == ixgbe_phy_nl) {
  ...
  hw->phy.ops.read_reg_mdi(hw, 0xC30B,
     0x1, &sfp_data);
...
# 1199 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_read_i2c_eeprom_82598(struct ixgbe_hw *hw, uint8_t byte_offset,
        uint8_t *eeprom_data)
{
 return ixgbe_read_i2c_phy_82598(hw, 0xA0,
...
uint32_t ixgbe_get_supported_physical_layer_82598(struct ixgbe_hw *hw)
{
 ...
 uint32_t pma_pmd_10g = autoc & 0x00000180;
 ...
 case (0x0 << 13):
  if (pma_pmd_1g == (0x1 << 9))
   ...
   physical_layer = 0x0400;
  break;
 case (0x1 << 13):
  if (pma_pmd_10g == (0x2 << 7))
   physical_layer = 0x0100;
  else if (pma_pmd_10g == (0x1 << 7))
...
# 1322 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
void ixgbe_set_lan_id_multi_port_pcie_82598(struct ixgbe_hw *hw)
{
 ...
 hw->eeprom.ops.read(hw, 0x06, &pci_gen);
 if ((pci_gen != 0) && (pci_gen != 0xFFFF)) {

  hw->eeprom.ops.read(hw, pci_gen + 0x5, &pci_ctrl2);
...
# 1355 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_82598.c"
int32_t ixgbe_enable_rx_dma_82598(struct ixgbe_hw *hw, uint32_t regval)
{
 ;;

 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x03000, regval);
