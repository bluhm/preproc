# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.c"
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.c"
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.h" 1
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.h"
enum vactype { VAC_NONE, VAC_WRITETHROUGH, VAC_WRITEBACK };

extern enum vactype vactype;
# 138 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.h"
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.c" 2
 ...
 paddr_t pa;
{
 ...
 register char *p;
 register int *kp;
# 112 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.c"
 if (!cacheinfo.c_enabled) return 0;

 cachestats.cs_npgflush++;
 p = (char *)(u_long)pa;
 ls = cacheinfo.c_linesize;
 i = (1 << 13) >> cacheinfo.dc_l2linesize;

 kp = (int *)(u_long)((pa & (cacheinfo.ec_totalsize - 1)) + 0x001000000);
 j = 0;
 for (; --i >= 0; p += ls) {
  flush(p);
  j += kp[i];
...
# 140 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cache.c"
int
 ...
 size_t len;
{
 ...
 baseoff = (vaddr_t)base & ((1 << 13) - 1);
 i = (baseoff + len + ((1 << 13) - 1)) >> 13;

 cachestats.cs_nraflush++;

 i = min(i,(cacheinfo.ec_totalsize / (1 << 13)));

 p = (char *)((vaddr_t)base & ~baseoff);
 ls = cacheinfo.dc_linesize;
 i >>= cacheinfo.dc_l2linesize;

 kp = (int *)(((vaddr_t)p & (cacheinfo.ec_totalsize - 1)) + 0x001000000);
 j = 0;
 for (; --i >= 0; p += ls) {
  flush(p);
  j += kp[i];
