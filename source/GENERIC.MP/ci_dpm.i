...
extern const u32 r600_utc[15];
extern const u32 r600_dtc[15];
...
_Bool r600_is_uvd_state(u32 class, u32 class2);
void r600_calculate_u_and_p(u32 i, u32 r_c, u32 p_b,
       u32 *p, u32 *u);
int r600_calculate_at(u32 t, u32 h, u32 fh, u32 fl, u32 *tl, u32 *th);
void r600_gfx_clockgating_enable(struct radeon_device *rdev, _Bool enable);
void r600_dynamicpm_enable(struct radeon_device *rdev, _Bool enable);
void r600_enable_thermal_protection(struct radeon_device *rdev, _Bool enable);
void r600_enable_acpi_pm(struct radeon_device *rdev);
void r600_enable_dynamic_pcie_gen2(struct radeon_device *rdev, _Bool enable);
_Bool r600_dynamicpm_enabled(struct radeon_device *rdev);
void r600_enable_sclk_control(struct radeon_device *rdev, _Bool enable);
void r600_enable_mclk_control(struct radeon_device *rdev, _Bool enable);
void r600_enable_spll_bypass(struct radeon_device *rdev, _Bool enable);
...
void r600_power_level_enable(struct radeon_device *rdev,
        enum r600_power_level index, _Bool enable);
...
void r600_power_level_set_pcie_gen2(struct radeon_device *rdev,
        enum r600_power_level index, _Bool compatible);
...
_Bool r600_is_internal_thermal_sensor(enum radeon_int_thermal_type sensor);
...
{
    SMU7_Discrete_MCArbDramTimingTableEntry entries[8][6];
};
...
struct SMU7_Discrete_DpmTable
{
    ...
    SMU7_Discrete_VoltageLevel VddcLevel [8];
    SMU7_Discrete_VoltageLevel VddciLevel [4];
    SMU7_Discrete_VoltageLevel MvddLevel [4];
    ...
    uint32_t Reserved[5];
    SMU7_Discrete_GraphicsLevel GraphicsLevel [8];
    SMU7_Discrete_MemoryLevel MemoryACPILevel;
    SMU7_Discrete_MemoryLevel MemoryLevel [6];
    SMU7_Discrete_LinkLevel LinkLevel [8];
    SMU7_Discrete_ACPILevel ACPILevel;
    SMU7_Discrete_UvdLevel UvdLevel [8];
    SMU7_Discrete_ExtClkLevel VceLevel [8];
    SMU7_Discrete_ExtClkLevel AcpLevel [8];
    SMU7_Discrete_ExtClkLevel SamuLevel [8];
    ...
    uint16_t FpsHighT;
    uint16_t FpsLowT;
    uint16_t BAPMTI_R [5][3][1];
    uint16_t BAPMTI_RC [5][3][1];
...
struct SMU7_Discrete_MCRegisters
{
    uint8_t last;
    uint8_t reserved[3];
    SMU7_Discrete_MCRegisterAddress address[16];
    SMU7_Discrete_MCRegisterSet data[6];
};
...
struct ci_ps {
 ...
 _Bool dc_compatible;
 u32 sclk_t;
 struct ci_pl performance_levels[2];
};
struct ci_dpm_level {
 _Bool enabled;
 u32 value;
...
struct ci_single_dpm_table {
 u32 count;
 struct ci_dpm_level dpm_levels[8];
};
struct ci_dpm_table {
...
struct ci_mc_reg_table {
 ...
 u8 num_entries;
 u16 valid_flag;
 struct ci_mc_reg_entry mc_reg_table_entry[16];
 SMU7_Discrete_MCRegisterAddress mc_reg_address[16];
};
struct ci_ulv_parm
{
 _Bool supported;
...
struct ci_power_info {
 ...
 u32 activity_target[8];
 u32 mclk_activity_target;
 u32 low_sclk_interrupt_t;
 u32 last_mclk_dpm_enable_mask;
 u32 sys_pcie_mask;
 _Bool caps_power_containment;
 _Bool caps_cac;
 _Bool caps_sq_ramping;
 _Bool caps_db_ramping;
 _Bool caps_td_ramping;
 _Bool caps_tcp_ramping;
 _Bool caps_fps;
 _Bool caps_sclk_ds;
 _Bool caps_sclk_ss_support;
 _Bool caps_mclk_ss_support;
 _Bool caps_uvd_dpm;
 _Bool caps_vce_dpm;
 _Bool caps_samu_dpm;
 _Bool caps_acp_dpm;
 _Bool caps_automatic_dc_transition;
 _Bool caps_sclk_throttle_low_notification;
 _Bool caps_dynamic_ac_timing;
 _Bool caps_od_fuzzy_fan_control_support;
 _Bool thermal_protection;
 _Bool pcie_performance_request;
 _Bool dynamic_ss;
 _Bool dll_default_on;
 _Bool cac_enabled;
 _Bool uvd_enabled;
 _Bool battery_state;
 _Bool pspp_notify_required;
 _Bool mem_gddr5;
 _Bool enable_bapm_feature;
 _Bool enable_tdc_limit_feature;
 _Bool enable_pkg_pwr_tracking_feature;
 _Bool use_pcie_performance_levels;
 _Bool use_pcie_powersaving_levels;
 _Bool uvd_power_gated;
 struct radeon_ps current_rps;
 struct ci_ps current_ps;
 struct radeon_ps requested_rps;
 struct ci_ps requested_ps;
 _Bool fan_ctrl_is_in_default_mode;
 _Bool fan_is_controlled_by_smc;
 u32 t_min;
...
_Bool ci_is_smc_running(struct radeon_device *rdev);
...
extern u8 si_get_mclk_frequency_ratio(u32 memory_clock, _Bool strobe_mode);
...
static int ci_set_overdrive_target_tdp(struct radeon_device *rdev,
           u32 target_tdp);
static int ci_update_uvd_dpm(struct radeon_device *rdev, _Bool gate);
...
static int ci_populate_bapm_vddc_vid_sidd(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < rdev->pm.dpm.dyn_state.cac_leakage_table.count; i++) {
  if (rdev->pm.dpm.platform_caps & 0x00800000) {
...
static int ci_populate_tdc_limit(struct radeon_device *rdev)
{
 ...
 pi->smc_powertune_table.TDC_VDDC_PkgLimit = ((__uint16_t)(tdc_limit));
...
static int ci_populate_dw8(struct radeon_device *rdev)
{
 ...
 ret = ci_read_smc_sram_dword(rdev,
         0x20000 +
         __builtin_offsetof(SMU7_Firmware_Header, PmFuseTable) +
         __builtin_offsetof(SMU7_Discrete_PmFuses, TdcWaterfallCtl),
...
static int ci_populate_fuzzy_fan(struct radeon_device *rdev)
{
 ...
 pi->smc_powertune_table.FuzzyFan_PwmSetDelta =
  ((__uint16_t)(rdev->pm.dpm.fan.fan_output_sensitivity));
 return 0;
}
...
static int ci_populate_bapm_vddc_base_leakage_sidd(struct radeon_device *rdev)
{
 ...
 pi->smc_powertune_table.BapmVddCBaseLeakageHiSidd = ((__uint16_t)(hi_sidd));
 pi->smc_powertune_table.BapmVddCBaseLeakageLoSidd = ((__uint16_t)(lo_sidd));
 return 0;
}
static int ci_populate_bapm_parameters_in_dpm_table(struct radeon_device *rdev)
{
 ...
 if (ppm) {
  dpm_table->PPM_PkgPwrLimit = ((__uint16_t)((u16)ppm->dgpu_tdp * 256 / 1000));
  dpm_table->PPM_TemperatureLimit = ((__uint16_t)((u16)ppm->tj_max * 256));
 } else {
  dpm_table->PPM_PkgPwrLimit = ((__uint16_t)(0));
  dpm_table->PPM_TemperatureLimit = ((__uint16_t)(0));
 }
 dpm_table->BAPM_TEMP_GRADIENT = ((__uint32_t)(pt_defaults->bapm_temp_gradient));
 def1 = pt_defaults->bapmti_r;
 def2 = pt_defaults->bapmti_rc;
 for (i = 0; i < 5; i++) {
  for (j = 0; j < 3; j++) {
   for (k = 0; k < 1; k++) {
    dpm_table->BAPMTI_R[i][j][k] = ((__uint16_t)(*def1));
    dpm_table->BAPMTI_RC[i][j][k] = ((__uint16_t)(*def2));
    def1++;
    def2++;
   }
  }
...
static void ci_do_enable_didt(struct radeon_device *rdev, const _Bool enable)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 u32 data;
 if (pi->caps_sq_ramping) {
  data = cik_didt_rreg(rdev, (0x0));
  if (enable)
   data |= (1 << 0);
  else
   data &= ~(1 << 0);
  cik_didt_wreg(rdev, (0x0), (data));
 }
 if (pi->caps_db_ramping) {
  data = cik_didt_rreg(rdev, (0x20));
  if (enable)
   data |= (1 << 0);
  else
   data &= ~(1 << 0);
  cik_didt_wreg(rdev, (0x20), (data));
 }
 if (pi->caps_td_ramping) {
  data = cik_didt_rreg(rdev, (0x40));
  if (enable)
   data |= (1 << 0);
  else
   data &= ~(1 << 0);
  cik_didt_wreg(rdev, (0x40), (data));
 }
 if (pi->caps_tcp_ramping) {
  data = cik_didt_rreg(rdev, (0x60));
  if (enable)
   data |= (1 << 0);
  else
   data &= ~(1 << 0);
  cik_didt_wreg(rdev, (0x60), (data));
 }
}
 ...
 while (config_regs->offset != 0xFFFFFFFF) {
  if (config_regs->type == CISLANDS_CONFIGREG_CACHE) {
   ...
   case CISLANDS_CONFIGREG_SMC_IND:
    data = tn_smc_rreg(rdev, (config_regs->offset));
    break;
   case CISLANDS_CONFIGREG_DIDT_IND:
    data = cik_didt_rreg(rdev, (config_regs->offset));
    break;
   default:
    data = r100_mm_rreg(rdev, (config_regs->offset << 2), 0);
    break;
   }
   ...
   switch (config_regs->type) {
   case CISLANDS_CONFIGREG_SMC_IND:
    tn_smc_wreg(rdev, (config_regs->offset), (data));
    break;
   case CISLANDS_CONFIGREG_DIDT_IND:
    cik_didt_wreg(rdev, (config_regs->offset), (data));
    break;
   default:
    r100_mm_wreg(rdev, (config_regs->offset << 2), (data), 0);
    break;
   }
   cache = 0;
  }
...
static int ci_enable_didt(struct radeon_device *rdev, _Bool enable)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 int ret;
...
static int ci_enable_power_containment(struct radeon_device *rdev, _Bool enable)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 ...
 if (enable) {
  ...
  if (pi->caps_power_containment) {
   if (pi->enable_bapm_feature) {
    smc_result = ci_send_msg_to_smc(rdev, ((uint8_t)0x87));
    if (smc_result != ((uint8_t)0x01))
     ret = -22;
    else
     pi->power_containment_features |= 0x00000001;
   }
   if (pi->enable_tdc_limit_feature) {
    smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x169));
    if (smc_result != ((uint8_t)0x01))
     ret = -22;
    else
     pi->power_containment_features |= 0x00000002;
   }
   if (pi->enable_pkg_pwr_tracking_feature) {
    smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x185));
    if (smc_result != ((uint8_t)0x01)) {
     ret = -22;
    } else {
     struct radeon_cac_tdp_table *cac_tdp_table =
     ...
     pi->power_containment_features |= 0x00000004;
  ...
  if (pi->caps_power_containment && pi->power_containment_features) {
   if (pi->power_containment_features & 0x00000002)
    ci_send_msg_to_smc(rdev, ((uint16_t) 0x16a));
   if (pi->power_containment_features & 0x00000001)
    ci_send_msg_to_smc(rdev, ((uint8_t)0x88));
   if (pi->power_containment_features & 0x00000004)
    ci_send_msg_to_smc(rdev, ((uint16_t) 0x186));
   pi->power_containment_features = 0;
  }
 }
 return ret;
}
static int ci_enable_smc_cac(struct radeon_device *rdev, _Bool enable)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 PPSMC_Result smc_result;
 int ret = 0;
 if (pi->caps_cac) {
  if (enable) {
   smc_result = ci_send_msg_to_smc(rdev, ((uint8_t)0x53));
   if (smc_result != ((uint8_t)0x01)) {
    ret = -22;
    pi->cac_enabled = 0;
   } else {
   ...
   ci_send_msg_to_smc(rdev, ((uint8_t)0x54));
   pi->cac_enabled = 0;
  }
 }
 return ret;
...
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 PPSMC_Result smc_result = ((uint8_t)0x01);
 if (pi->thermal_sclk_dpm_enabled) {
  if (enable)
   smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x19C));
  else
   smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x19D));
 }
 if (smc_result == ((uint8_t)0x01))
  return 0;
 else
         ...
         int min_temp, int max_temp)
{
 ...
 if (high_temp < low_temp) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "invalid thermal range: %d - %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , low_temp, high_temp);
  return -22;
 }
 tmp = tn_smc_rreg(rdev, (0xC030000C));
 tmp &= ~(0x0000FF00 | 0x00FF0000);
 tmp |= ((high_temp / 1000) << 8) |
  ((low_temp / 1000) << 16);
 tn_smc_wreg(rdev, (0xC030000C), (tmp));
...
static int ci_thermal_enable_alert(struct radeon_device *rdev,
       _Bool enable)
{
 u32 thermal_int = tn_smc_rreg(rdev, (0xC030000C));
 PPSMC_Result result;
 if (enable) {
  thermal_int &= ~((1 << 24) | (1 << 25));
  tn_smc_wreg(rdev, (0xC030000C), (thermal_int));
  rdev->irq.dpm_thermal = 0;
  result = ci_send_msg_to_smc(rdev, ((uint32_t) 0x10a));
  if (result != ((uint8_t)0x01)) {
   do { } while( 0);
   return -22;
  }
 } else {
  ...
  result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x133));
  if (result != ((uint8_t)0x01)) {
   do { } while( 0);
   return -22;
  }
...
static void ci_fan_ctrl_set_static_mode(struct radeon_device *rdev, u32 mode)
{
 ...
 if (pi->fan_ctrl_is_in_default_mode) {
  tmp = (tn_smc_rreg(rdev, (0xC030006C)) & (7 << 11)) >> 11;
  pi->fan_ctrl_default_mode = tmp;
  tmp = (tn_smc_rreg(rdev, (0xC030006C)) & 0x000000FF) >> 0;
  pi->t_min = tmp;
  pi->fan_ctrl_is_in_default_mode = 0;
 }
 tmp = tn_smc_rreg(rdev, (0xC030006C)) & ~0x000000FF;
 tmp |= ((0) << 0);
 tn_smc_wreg(rdev, (0xC030006C), (tmp));
 tmp = tn_smc_rreg(rdev, (0xC030006C)) & ~(7 << 11);
 tmp |= ((mode) << 11);
 tn_smc_wreg(rdev, (0xC030006C), (tmp));
}
...
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 SMU7_Discrete_FanTable fan_table = { 0 };
 u32 duty100;
 ...
 duty100 = (tn_smc_rreg(rdev, (0xC0300068)) & 0x000000FF) >> 0;
 if (duty100 == 0) {
  rdev->pm.dpm.fan.ucode_fan_control = 0;
  return 0;
 }
 tmp64 = (u64)rdev->pm.dpm.fan.pwm_min * duty100;
 ({ uint32_t __base = (10000); uint32_t __rem = ((uint64_t)(tmp64)) % __base; (tmp64) = ((uint64_t)(tmp64)) / __base; __rem; });
 fdo_min = (u16)tmp64;
 ...
 fan_table.TempMin = ((__uint16_t)((50 + rdev->pm.dpm.fan.t_min) / 100));
 fan_table.TempMed = ((__uint16_t)((50 + rdev->pm.dpm.fan.t_med) / 100));
 fan_table.TempMax = ((__uint16_t)((50 + rdev->pm.dpm.fan.t_max) / 100));
 fan_table.Slope1 = ((__uint16_t)(slope1));
 fan_table.Slope2 = ((__uint16_t)(slope2));
 fan_table.FdoMin = ((__uint16_t)(fdo_min));
 fan_table.HystDown = ((__uint16_t)(rdev->pm.dpm.fan.t_hyst));
 fan_table.HystUp = ((__uint16_t)(1));
 fan_table.HystSlope = ((__uint16_t)(1));
 fan_table.TempRespLim = ((__uint16_t)(5));
 reference_clock = (rdev)->asic->get_xclk((rdev));
 fan_table.RefreshPeriod = ((__uint32_t)((rdev->pm.dpm.fan.cycle_delay * reference_clock) / 1600));
 fan_table.FdoMax = ((__uint16_t)((u16)duty100));
 tmp = (tn_smc_rreg(rdev, (0xC0300010)) & (0xff << 20)) >> 20;
 ...
 ret = ci_copy_bytes_to_smc(rdev,
       ...
       pi->sram_end);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to load fan table to the SMC.", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  rdev->pm.dpm.fan.ucode_fan_control = 0;
 }
 return 0;
}
...
static int ci_fan_ctrl_stop_smc_fan_control(struct radeon_device *rdev)
{
 PPSMC_Result ret;
 struct ci_power_info *pi = ci_get_pi(rdev);
 ret = ci_send_msg_to_smc(rdev, ((uint8_t)0x5C));
 if (ret == ((uint8_t)0x01)) {
          ...
          u32 *speed)
{
 ...
 if (rdev->pm.no_fan)
  return -2;
 duty100 = (tn_smc_rreg(rdev, (0xC0300068)) & 0x000000FF) >> 0;
 duty = (tn_smc_rreg(rdev, (0xC0300008)) & (0xff << 9)) >> 9;
 if (duty100 == 0)
  return -22;
 tmp64 = (u64)duty * 100;
 ({ uint32_t __base = (duty100); uint32_t __rem = ((uint64_t)(tmp64)) % __base; (tmp64) = ((uint64_t)(tmp64)) / __base; __rem; });
 *speed = (u32)tmp64;
 if (*speed > 100)
  *speed = 100;
 return 0;
          ...
          u32 speed)
{
 ...
 ({ uint32_t __base = (100); uint32_t __rem = ((uint64_t)(tmp64)) % __base; (tmp64) = ((uint64_t)(tmp64)) / __base; __rem; });
 duty = (u32)tmp64;
 tmp = tn_smc_rreg(rdev, (0xC0300064)) & ~0x000000FF;
 tmp |= ((duty) << 0);
 tn_smc_wreg(rdev, (0xC0300064), (tmp));
 return 0;
}
void ci_fan_ctrl_set_mode(struct radeon_device *rdev, u32 mode)
{
...
static void ci_fan_ctrl_set_default_mode(struct radeon_device *rdev)
{
 ...
 if (!pi->fan_ctrl_is_in_default_mode) {
  tmp = tn_smc_rreg(rdev, (0xC030006C)) & ~(7 << 11);
  tmp |= ((pi->fan_ctrl_default_mode) << 11);
  tn_smc_wreg(rdev, (0xC030006C), (tmp));
  tmp = tn_smc_rreg(rdev, (0xC030006C)) & ~0x000000FF;
  tmp |= ((pi->t_min) << 0);
  tn_smc_wreg(rdev, (0xC030006C), (tmp));
...
static void ci_thermal_start_smc_fan_control(struct radeon_device *rdev)
{
 if (rdev->pm.dpm.fan.ucode_fan_control) {
  ...
  ci_fan_ctrl_set_static_mode(rdev, 1);
 }
}
static void ci_thermal_initialize(struct radeon_device *rdev)
{
 ...
 if (rdev->pm.fan_pulses_per_revolution) {
  tmp = tn_smc_rreg(rdev, (0xC0300070)) & ~(0x7 << 0);
  tmp |= ((rdev->pm.fan_pulses_per_revolution -1) << 0);
  tn_smc_wreg(rdev, (0xC0300070), (tmp));
 }
 tmp = tn_smc_rreg(rdev, (0xC030006C)) & ~(0x7f << 25);
 tmp |= ((0x28) << 25);
 tn_smc_wreg(rdev, (0xC030006C), (tmp));
}
static int ci_thermal_start_thermal_controller(struct radeon_device *rdev)
{
 ...
 ret = ci_thermal_set_temperature_range(rdev, (90 * 1000), (120 * 1000));
 if (ret)
  return ret;
...
static void ci_init_fps_limits(struct radeon_device *rdev)
{
 ...
 if (pi->caps_fps) {
  u16 tmp;
  tmp = 45;
  table->FpsHighT = ((__uint16_t)(tmp));
  tmp = 30;
  table->FpsLowT = ((__uint16_t)(tmp));
 }
}
static int ci_update_sclk_t(struct radeon_device *rdev)
{
 ...
 if (pi->caps_sclk_throttle_low_notification) {
  low_sclk_interrupt_t = ((__uint32_t)(pi->low_sclk_interrupt_t));
  ret = ci_copy_bytes_to_smc(rdev,
        pi->dpm_table_start +
        __builtin_offsetof(SMU7_Discrete_DpmTable, LowSclkInterruptT),
...
static void ci_set_dpm_event_sources(struct radeon_device *rdev, u32 sources)
{
 ...
 if (want_thermal_protection) {
  tmp = tn_smc_rreg(rdev, (0xC0200000));
  if (pi->thermal_protection)
   tmp &= ~(1 << 2);
  else
   tmp |= (1 << 2);
  tn_smc_wreg(rdev, (0xC0200000), (tmp));
 } else {
  tmp = tn_smc_rreg(rdev, (0xC0200000));
  tmp |= (1 << 2);
  tn_smc_wreg(rdev, (0xC0200000), (tmp));
...
{
 if (rdev->pm.dpm.platform_caps & 0x00010000)
  ci_send_msg_to_smc(rdev, ((uint16_t) 0x14a));
}
static int ci_unfreeze_sclk_mclk_dpm(struct radeon_device *rdev)
{
 ...
 if ((!pi->sclk_dpm_key_disabled) &&
     (pi->need_update_smu7_dpm_table & (0x00000001 | 0x00000004))) {
  smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x18A));
  if (smc_result != ((uint8_t)0x01))
   return -22;
 }
 if ((!pi->mclk_dpm_key_disabled) &&
     (pi->need_update_smu7_dpm_table & 0x00000002)) {
  smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x18C));
  if (smc_result != ((uint8_t)0x01))
   return -22;
 }
...
static int ci_enable_sclk_mclk_dpm(struct radeon_device *rdev, _Bool enable)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 PPSMC_Result smc_result;
 if (enable) {
  if (!pi->sclk_dpm_key_disabled) {
   smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x14e));
   if (smc_result != ((uint8_t)0x01))
    return -22;
  }
  if (!pi->mclk_dpm_key_disabled) {
   smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x150));
   if (smc_result != ((uint8_t)0x01))
    return -22;
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3600), 0); tmp_ &= (~(1 << 31)); tmp_ |= (((1 << 31)) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x3600), (tmp_), 0); } while (0);
   tn_smc_wreg(rdev, (0xC0400D30), (0x05));
   tn_smc_wreg(rdev, (0xC0400D3C), (0x05));
   tn_smc_wreg(rdev, (0xC0400D80), (0x100005));
   udelay(10);
   tn_smc_wreg(rdev, (0xC0400D30), (0x400005));
   tn_smc_wreg(rdev, (0xC0400D3C), (0x400005));
   tn_smc_wreg(rdev, (0xC0400D80), (0x500005));
  }
 } else {
  if (!pi->sclk_dpm_key_disabled) {
   smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x14f));
   if (smc_result != ((uint8_t)0x01))
    return -22;
  }
  if (!pi->mclk_dpm_key_disabled) {
   smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x151));
   if (smc_result != ((uint8_t)0x01))
    return -22;
  }
 }
...
static int ci_start_dpm(struct radeon_device *rdev)
{
 ...
 tmp |= (1 << 0);
 tn_smc_wreg(rdev, (0xC0200000), (tmp));
 tmp = tn_smc_rreg(rdev, (0xC0200008));
 tmp |= (1 << 21);
 tn_smc_wreg(rdev, (0xC0200008), (tmp));
 ci_write_smc_soft_register(rdev, __builtin_offsetof(SMU7_SoftRegisters, VoltageChangeTimeout), 0x1000);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x5220), 0); tmp_ &= (~(1 << 0)); tmp_ |= ((0) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x5220), (tmp_), 0); } while (0);
 smc_result = ci_send_msg_to_smc(rdev, ((uint32_t) 0x109));
 if (smc_result != ((uint8_t)0x01))
  return -22;
 ...
 if (!pi->pcie_dpm_key_disabled) {
  smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x136));
  if (smc_result != ((uint8_t)0x01))
   return -22;
 }
 return 0;
...
static int ci_freeze_sclk_mclk_dpm(struct radeon_device *rdev)
{
 ...
 if ((!pi->sclk_dpm_key_disabled) &&
     (pi->need_update_smu7_dpm_table & (0x00000001 | 0x00000004))) {
  smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x189));
  if (smc_result != ((uint8_t)0x01))
   return -22;
 }
 if ((!pi->mclk_dpm_key_disabled) &&
     (pi->need_update_smu7_dpm_table & 0x00000002)) {
  smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x18B));
  if (smc_result != ((uint8_t)0x01))
   return -22;
 }
 return 0;
...
static int ci_stop_dpm(struct radeon_device *rdev)
{
 ...
 tn_smc_wreg(rdev, (0xC0200008), (tmp));
 if (!pi->pcie_dpm_key_disabled) {
  smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x13d));
  if (smc_result != ((uint8_t)0x01))
   return -22;
 }
 ...
 if (ret)
  return ret;
 smc_result = ci_send_msg_to_smc(rdev, ((uint16_t) 0x135));
 if (smc_result != ((uint8_t)0x01))
  return -22;
 return 0;
}
static void ci_enable_sclk_control(struct radeon_device *rdev, _Bool enable)
{
 u32 tmp = tn_smc_rreg(rdev, (0xC0200008));
 if (enable)
  tmp &= ~(1 << 0);
 else
  tmp |= (1 << 0);
...
static PPSMC_Result ci_send_msg_to_smc_with_parameter(struct radeon_device *rdev,
            PPSMC_Msg msg, u32 parameter)
{
 r100_mm_wreg(rdev, (0x290), (parameter), 0);
       ...
       PPSMC_Msg msg, u32 *parameter)
{
 ...
 if ((smc_result == ((uint8_t)0x01)) && parameter)
  *parameter = r100_mm_rreg(rdev, (0x290), 0);
 return smc_result;
}
static int ci_dpm_force_state_sclk(struct radeon_device *rdev, u32 n)
{
 ...
 if (!pi->sclk_dpm_key_disabled) {
  PPSMC_Result smc_result =
   ci_send_msg_to_smc_with_parameter(rdev, ((uint16_t) 0x145), 1 << n);
  if (smc_result != ((uint8_t)0x01))
   return -22;
 }
 return 0;
...
static int ci_dpm_force_state_mclk(struct radeon_device *rdev, u32 n)
{
 ...
 if (!pi->mclk_dpm_key_disabled) {
  PPSMC_Result smc_result =
   ci_send_msg_to_smc_with_parameter(rdev, ((uint16_t) 0x146), 1 << n);
  if (smc_result != ((uint8_t)0x01))
   return -22;
 }
 return 0;
...
static int ci_dpm_force_state_pcie(struct radeon_device *rdev, u32 n)
{
 ...
 if (!pi->pcie_dpm_key_disabled) {
  PPSMC_Result smc_result =
   ci_send_msg_to_smc_with_parameter(rdev, ((uint16_t) 0x147), n);
  if (smc_result != ((uint8_t)0x01))
   return -22;
 }
 return 0;
...
static int ci_set_power_limit(struct radeon_device *rdev, u32 n)
{
 ...
 if (pi->power_containment_features & 0x00000004) {
  PPSMC_Result smc_result =
   ci_send_msg_to_smc_with_parameter(rdev, ((uint16_t) 0x187), n);
  if (smc_result != ((uint8_t)0x01))
   return -22;
 }
 return 0;
...
{
 PPSMC_Result smc_result =
  ci_send_msg_to_smc_with_parameter(rdev, ((uint16_t) 0x188), target_tdp);
 if (smc_result != ((uint8_t)0x01))
  return -22;
 return 0;
}
...
static void ci_dpm_start_smc(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < rdev->usec_timeout; i++) {
  if (tn_smc_rreg(rdev, (0x3F800)) & (1 << 0))
   break;
 }
}
...
static int ci_process_firmware_header(struct radeon_device *rdev)
{
 ...
 ret = ci_read_smc_sram_dword(rdev,
         0x20000 +
         __builtin_offsetof(SMU7_Firmware_Header, DpmTable),
         &tmp, pi->sram_end);
 if (ret)
  return ret;
 ...
 ret = ci_read_smc_sram_dword(rdev,
         0x20000 +
         __builtin_offsetof(SMU7_Firmware_Header, SoftRegisters),
         &tmp, pi->sram_end);
 if (ret)
  return ret;
 ...
 ret = ci_read_smc_sram_dword(rdev,
         0x20000 +
         __builtin_offsetof(SMU7_Firmware_Header, mcRegisterTable),
         &tmp, pi->sram_end);
 if (ret)
  return ret;
 ...
 ret = ci_read_smc_sram_dword(rdev,
         0x20000 +
         __builtin_offsetof(SMU7_Firmware_Header, FanTable),
         &tmp, pi->sram_end);
 if (ret)
  return ret;
 ...
 ret = ci_read_smc_sram_dword(rdev,
         0x20000 +
         __builtin_offsetof(SMU7_Firmware_Header, mcArbDramTimingTable),
         &tmp, pi->sram_end);
 if (ret)
  return ret;
...
static void ci_read_clock_registers(struct radeon_device *rdev)
{
 ...
 pi->clock_registers.cg_spll_func_cntl =
  tn_smc_rreg(rdev, (0xC0500140));
 pi->clock_registers.cg_spll_func_cntl_2 =
  tn_smc_rreg(rdev, (0xC0500144));
 pi->clock_registers.cg_spll_func_cntl_3 =
  tn_smc_rreg(rdev, (0xC0500148));
 pi->clock_registers.cg_spll_func_cntl_4 =
  tn_smc_rreg(rdev, (0xC050014C));
 pi->clock_registers.cg_spll_spread_spectrum =
  tn_smc_rreg(rdev, (0xC0500164));
 pi->clock_registers.cg_spll_spread_spectrum_2 =
  tn_smc_rreg(rdev, (0xC0500168));
 pi->clock_registers.dll_cntl = r100_mm_rreg(rdev, (0x2ba4), 0);
 pi->clock_registers.mclk_pwrmgt_cntl = r100_mm_rreg(rdev, (0x2ba0), 0);
 pi->clock_registers.mpll_ad_func_cntl = r100_mm_rreg(rdev, (0x2bc0), 0);
 pi->clock_registers.mpll_dq_func_cntl = r100_mm_rreg(rdev, (0x2bc4), 0);
 pi->clock_registers.mpll_func_cntl = r100_mm_rreg(rdev, (0x2bb4), 0);
 pi->clock_registers.mpll_func_cntl_1 = r100_mm_rreg(rdev, (0x2bb8), 0);
 pi->clock_registers.mpll_func_cntl_2 = r100_mm_rreg(rdev, (0x2bbc), 0);
 pi->clock_registers.mpll_ss1 = r100_mm_rreg(rdev, (0x2bcc), 0);
 pi->clock_registers.mpll_ss2 = r100_mm_rreg(rdev, (0x2bd0), 0);
}
...
static void ci_enable_thermal_protection(struct radeon_device *rdev,
      _Bool enable)
{
 u32 tmp = tn_smc_rreg(rdev, (0xC0200000));
 if (enable)
  tmp &= ~(1 << 2);
 else
  tmp |= (1 << 2);
...
static int ci_notify_smc_display_change(struct radeon_device *rdev,
     _Bool has_display)
{
 PPSMC_Msg msg = has_display ? ((uint8_t)0x5E) : ((uint8_t)0x5D);
 return (ci_send_msg_to_smc(rdev, msg) == ((uint8_t)0x01)) ? 0 : -22;
}
          ...
          _Bool enable)
{
 ...
 if (enable) {
  if (pi->caps_sclk_ds) {
   if (ci_send_msg_to_smc(rdev, ((uint16_t) 0x18F)) != ((uint8_t)0x01))
    return -22;
  } else {
   if (ci_send_msg_to_smc(rdev, ((uint16_t) 0x190)) != ((uint8_t)0x01))
    return -22;
  }
 } else {
  if (pi->caps_sclk_ds) {
...
{
 u32 tmp = tn_smc_rreg(rdev, (0xC0200060));
 ...
 if (rdev->pm.dpm.new_active_crtc_count > 0)
  tmp |= ((R600_PM_DISPLAY_GAP_VBLANK_OR_WM) << 0);
 else
  tmp |= ((R600_PM_DISPLAY_GAP_IGNORE) << 0);
 tn_smc_wreg(rdev, (0xC0200060), (tmp));
 if (refresh_rate == 0)
  refresh_rate = 60;
 ...
 tn_smc_wreg(rdev, (0xC0200230), (tmp));
 ci_write_smc_soft_register(rdev, __builtin_offsetof(SMU7_SoftRegisters, PreVBlankGap), 0x64);
 ci_write_smc_soft_register(rdev, __builtin_offsetof(SMU7_SoftRegisters, VBlankTimeout), (frame_time_in_us - pre_vbi_time_in_us));
 ci_notify_smc_display_change(rdev, (rdev->pm.dpm.new_active_crtc_count == 1));
}
static void ci_enable_spread_spectrum(struct radeon_device *rdev, _Bool enable)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 u32 tmp;
 if (enable) {
  ...
  tmp = tn_smc_rreg(rdev, (0xC0500164));
  tmp &= ~(1 << 0);
  tn_smc_wreg(rdev, (0xC0500164), (tmp));
  tmp = tn_smc_rreg(rdev, (0xC0200000));
  tmp &= ~(1 << 23);
  tn_smc_wreg(rdev, (0xC0200000), (tmp));
 }
...
{
 tn_smc_wreg(rdev, (0xC0200044), ((((0) << 16) | ((0x00C8) << 0))));
}
...
static void ci_program_vc(struct radeon_device *rdev)
{
 ...
 tmp &= ~((1 << 5) | (1 << 4));
 tn_smc_wreg(rdev, (0xC0200008), (tmp));
 tn_smc_wreg(rdev, (0xC02001A8), (0x3FFFC000));
 tn_smc_wreg(rdev, (0xC02001AC), (0x000400));
 tn_smc_wreg(rdev, (0xC02001B0), (0xC00080));
 tn_smc_wreg(rdev, (0xC02001B4), (0xC00200));
 tn_smc_wreg(rdev, (0xC02001B8), (0xC01680));
 tn_smc_wreg(rdev, (0xC02001BC), (0xC00033));
 tn_smc_wreg(rdev, (0xC02001C0), (0xC00033));
 tn_smc_wreg(rdev, (0xC02001C4), (0x3FFFC000));
}
static void ci_clear_vc(struct radeon_device *rdev)
{
 ...
 tmp |= ((1 << 5) | (1 << 4));
 tn_smc_wreg(rdev, (0xC0200008), (tmp));
 tn_smc_wreg(rdev, (0xC02001A8), (0));
 tn_smc_wreg(rdev, (0xC02001AC), (0));
 tn_smc_wreg(rdev, (0xC02001B0), (0));
 tn_smc_wreg(rdev, (0xC02001B4), (0));
 tn_smc_wreg(rdev, (0xC02001B8), (0));
 tn_smc_wreg(rdev, (0xC02001BC), (0));
 tn_smc_wreg(rdev, (0xC02001C0), (0));
 tn_smc_wreg(rdev, (0xC02001C4), (0));
}
static int ci_upload_firmware(struct radeon_device *rdev)
{
 ...
 int i, ret;
 for (i = 0; i < rdev->usec_timeout; i++) {
  if (tn_smc_rreg(rdev, (0xC0000004)) & (1 << 7))
   break;
 }
 tn_smc_wreg(rdev, (0x80000010), (1));
 ci_stop_smc_clock(rdev);
 ci_reset_smc(rdev);
...
static int ci_construct_voltage_tables(struct radeon_device *rdev)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 int ret;
 if (pi->voltage_control == 0x1) {
  ret = radeon_atom_get_voltage_table(rdev, 1,
          0,
          &pi->vddc_voltage_table);
  if (ret)
   return ret;
 } else if (pi->voltage_control == 0x2) {
 ...
 if (pi->vddc_voltage_table.count > 8)
  si_trim_voltage_table_to_fit_state_table(rdev, 8,
        &pi->vddc_voltage_table);
 if (pi->vddci_control == 0x1) {
  ret = radeon_atom_get_voltage_table(rdev, 4,
          0,
          &pi->vddci_voltage_table);
  if (ret)
   return ret;
 } else if (pi->vddci_control == 0x2) {
  ret = ci_get_svi2_voltage_table(rdev,
 ...
 if (pi->vddci_voltage_table.count > 4)
  si_trim_voltage_table_to_fit_state_table(rdev, 4,
        &pi->vddci_voltage_table);
 if (pi->mvdd_control == 0x1) {
  ret = radeon_atom_get_voltage_table(rdev, 2,
          0,
          &pi->mvdd_voltage_table);
  if (ret)
   return ret;
 } else if (pi->mvdd_control == 0x2) {
  ret = ci_get_svi2_voltage_table(rdev,
 ...
 if (pi->mvdd_voltage_table.count > 4)
  si_trim_voltage_table_to_fit_state_table(rdev, 4,
        &pi->mvdd_voltage_table);
 return 0;
}
       ...
       SMU7_Discrete_VoltageLevel *smc_voltage_table)
{
 ...
 if (ret) {
  smc_voltage_table->StdVoltageHiSidd = voltage_table->value * 4;
  smc_voltage_table->StdVoltageLoSidd = voltage_table->value * 4;
 }
 smc_voltage_table->Voltage = ((__uint16_t)(voltage_table->value * 4));
 smc_voltage_table->StdVoltageHiSidd =
  ((__uint16_t)(smc_voltage_table->StdVoltageHiSidd));
 smc_voltage_table->StdVoltageLoSidd =
  ((__uint16_t)(smc_voltage_table->StdVoltageLoSidd));
}
          ...
          SMU7_Discrete_DpmTable *table)
{
 ...
 table->VddcLevelCount = ((__uint32_t)(table->VddcLevelCount));
 return 0;
}
           ...
           SMU7_Discrete_DpmTable *table)
{
 ...
 table->VddciLevelCount = ((__uint32_t)(table->VddciLevelCount));
 return 0;
}
          ...
          SMU7_Discrete_DpmTable *table)
{
 ...
 table->MvddLevelCount = ((__uint32_t)(table->MvddLevelCount));
 return 0;
}
...
{
 u16 v_index, idx;
 _Bool voltage_found = 0;
 *std_voltage_hi_sidd = voltage_table->value * 4;
 *std_voltage_lo_sidd = voltage_table->value * 4;
 ...
 if (rdev->pm.dpm.dyn_state.cac_leakage_table.entries) {
  for (v_index = 0; (u32)v_index < rdev->pm.dpm.dyn_state.vddc_dependency_on_sclk.count; v_index++) {
    ...
    *std_voltage_lo_sidd =
     rdev->pm.dpm.dyn_state.cac_leakage_table.entries[idx].vddc * 4;
    *std_voltage_hi_sidd =
     rdev->pm.dpm.dyn_state.cac_leakage_table.entries[idx].leakage * 4;
    break;
   }
  }
  if (!voltage_found) {
...
{
 return ni_copy_and_switch_arb_sets(rdev, 0x0a, 0x0b);
}
static int ci_reset_to_default(struct radeon_device *rdev)
{
 return (ci_send_msg_to_smc(rdev, ((uint8_t)0x84)) == ((uint8_t)0x01)) ?
  0 : -22;
}
static int ci_force_switch_to_arb_f0(struct radeon_device *rdev)
{
 u32 tmp;
 tmp = (tn_smc_rreg(rdev, (0x80000424)) & 0x0000ff00) >> 8;
 if (tmp == 0x0a)
  return 0;
 return ni_copy_and_switch_arb_sets(rdev, tmp, 0x0a);
}
     ...
     u32 *dram_timimg2)
{
 _Bool patch;
 u32 tmp, tmp2;
 tmp = r100_mm_rreg(rdev, (0x2a00), 0);
      ...
      SMU7_Discrete_MCArbDramTimingTableEntry *arb_regs)
{
 ...
 dram_timing = r100_mm_rreg(rdev, (0x2774), 0);
 dram_timing2 = r100_mm_rreg(rdev, (0x2778), 0);
 burst_time = r100_mm_rreg(rdev, (0x2808), 0) & (0x1f << 0);
 ci_register_patching_mc_arb(rdev, sclk, mclk, &dram_timing2);
 arb_regs->McArbDramTiming = ((__uint32_t)(dram_timing));
 arb_regs->McArbDramTiming2 = ((__uint32_t)(dram_timing2));
...
static int ci_do_program_memory_timing_parameters(struct radeon_device *rdev)
{
 ...
 u32 i, j;
 int ret = 0;
 __builtin_memset((&arb_regs), (0), (sizeof(SMU7_Discrete_MCArbDramTimingTable)));
           ...
           SMU7_Discrete_DpmTable *table)
{
 ...
 for (i = 0; i < dpm_table->pcie_speed_table.count; i++) {
  ...
  table->LinkLevel[i].DownT = ((__uint32_t)(5));
  table->LinkLevel[i].UpT = ((__uint32_t)(30));
 }
         ...
         SMU7_Discrete_DpmTable *table)
{
 ...
 for (count = 0; count < table->UvdLevelCount; count++) {
  ...
  table->UvdLevel[count].MinVddc =
   rdev->pm.dpm.dyn_state.uvd_clock_voltage_dependency_table.entries[count].v * 4;
  table->UvdLevel[count].MinVddcPhases = 1;
  ret = radeon_atom_get_clock_dividers(rdev,
           0x00,
           table->UvdLevel[count].VclkFrequency, 0, &dividers);
  if (ret)
   return ret;
  table->UvdLevel[count].VclkDivider = (u8)dividers.post_divider;
  ret = radeon_atom_get_clock_dividers(rdev,
           0x00,
           table->UvdLevel[count].DclkFrequency, 0, &dividers);
  if (ret)
   return ret;
  table->UvdLevel[count].DclkDivider = (u8)dividers.post_divider;
  table->UvdLevel[count].VclkFrequency = ((__uint32_t)(table->UvdLevel[count].VclkFrequency));
  table->UvdLevel[count].DclkFrequency = ((__uint32_t)(table->UvdLevel[count].DclkFrequency));
  table->UvdLevel[count].MinVddc = ((__uint16_t)(table->UvdLevel[count].MinVddc));
 }
 return ret;
}
         ...
         SMU7_Discrete_DpmTable *table)
{
 ...
 for (count = 0; count < table->VceLevelCount; count++) {
  ...
  table->VceLevel[count].MinVoltage =
   (u16)rdev->pm.dpm.dyn_state.vce_clock_voltage_dependency_table.entries[count].v * 4;
  table->VceLevel[count].MinPhases = 1;
  ret = radeon_atom_get_clock_dividers(rdev,
           0x00,
           table->VceLevel[count].Frequency, 0, &dividers);
  if (ret)
   return ret;
  table->VceLevel[count].Divider = (u8)dividers.post_divider;
  table->VceLevel[count].Frequency = ((__uint32_t)(table->VceLevel[count].Frequency));
  table->VceLevel[count].MinVoltage = ((__uint16_t)(table->VceLevel[count].MinVoltage));
 }
 return ret;
}
         ...
         SMU7_Discrete_DpmTable *table)
{
 ...
 for (count = 0; count < table->AcpLevelCount; count++) {
  ...
  table->AcpLevel[count].Frequency = ((__uint32_t)(table->AcpLevel[count].Frequency));
  table->AcpLevel[count].MinVoltage = ((__uint16_t)(table->AcpLevel[count].MinVoltage));
 }
 return ret;
}
          ...
          SMU7_Discrete_DpmTable *table)
{
 ...
 for (count = 0; count < table->SamuLevelCount; count++) {
  ...
  table->SamuLevel[count].MinVoltage =
   rdev->pm.dpm.dyn_state.samu_clock_voltage_dependency_table.entries[count].v * 4;
  ...
  table->SamuLevel[count].Frequency = ((__uint32_t)(table->SamuLevel[count].Frequency));
  table->SamuLevel[count].MinVoltage = ((__uint16_t)(table->SamuLevel[count].MinVoltage));
 }
 return ret;
}
        ...
        _Bool dll_state_on)
{
 ...
 if (ret)
  return ret;
 mpll_func_cntl &= ~(0xff << 20);
 mpll_func_cntl |= ((mpll_param.bwcntl) << 20);
 mpll_func_cntl_1 &= ~((0xfff << 16) | (0xfff << 4) | (3 << 0));
 mpll_func_cntl_1 |= ((mpll_param.clkf) << 16) |
  ((mpll_param.clkfrac) << 4) | ((mpll_param.vco_mode) << 0);
 mpll_ad_func_cntl &= ~(7 << 0);
 mpll_ad_func_cntl |= ((mpll_param.post_div) << 0);
 if (pi->mem_gddr5) {
  mpll_dq_func_cntl &= ~((1 << 4) | (7 << 0));
  mpll_dq_func_cntl |= ((mpll_param.yclk_sel) << 4) |
   ((mpll_param.post_div) << 0);
 }
 if (pi->caps_mclk_ss_support) {
  ...
  if (radeon_atombios_get_asic_ss_info(rdev, &ss,
   ...
   mpll_ss1 &= ~(0x3ffffff << 0);
   mpll_ss1 |= ((clkv) << 0);
   mpll_ss2 &= ~(0xfff << 0);
   mpll_ss2 |= ((clks) << 0);
  }
 }
 mclk_pwrmgt_cntl &= ~(0x1f << 0);
 mclk_pwrmgt_cntl |= ((mpll_param.dll_speed) << 0);
 if (dll_state_on)
  mclk_pwrmgt_cntl |= (1 << 8) | (1 << 9);
 else
  mclk_pwrmgt_cntl &= ~((1 << 8) | (1 << 9));
        ...
        SMU7_Discrete_MemoryLevel *memory_level)
{
 ...
 memory_level->DisplayWatermark = 0;
 if (pi->mclk_stutter_mode_threshold &&
     (memory_clock <= pi->mclk_stutter_mode_threshold) &&
     (pi->uvd_enabled == 0) &&
     (r100_mm_rreg(rdev, (0x6cd4), 0) & (1 << 0)) &&
 ...
 if (pi->mem_gddr5) {
  ...
  if (memory_level->StrobeEnable) {
   if (si_get_mclk_frequency_ratio(memory_clock, 1) >=
       ((r100_mm_rreg(rdev, (0x2a64), 0) >> 16) & 0xf))
    dll_state_on = ((r100_mm_rreg(rdev, (0x2a54), 0) >> 1) & 0x1) ? 1 : 0;
   else
    dll_state_on = ((r100_mm_rreg(rdev, (0x2a58), 0) >> 1) & 0x1) ? 1 : 0;
  } else {
 ...
 if (ret)
  return ret;
 memory_level->MinVddc = ((__uint32_t)(memory_level->MinVddc * 4));
 memory_level->MinVddcPhases = ((__uint32_t)(memory_level->MinVddcPhases));
        memory_level->MinVddci = ((__uint32_t)(memory_level->MinVddci * 4));
        memory_level->MinMvdd = ((__uint32_t)(memory_level->MinMvdd * 4));
 memory_level->MclkFrequency = ((__uint32_t)(memory_level->MclkFrequency));
 memory_level->ActivityLevel = ((__uint16_t)(memory_level->ActivityLevel));
 memory_level->MpllFuncCntl = ((__uint32_t)(memory_level->MpllFuncCntl));
 memory_level->MpllFuncCntl_1 = ((__uint32_t)(memory_level->MpllFuncCntl_1));
 memory_level->MpllFuncCntl_2 = ((__uint32_t)(memory_level->MpllFuncCntl_2));
 memory_level->MpllAdFuncCntl = ((__uint32_t)(memory_level->MpllAdFuncCntl));
 memory_level->MpllDqFuncCntl = ((__uint32_t)(memory_level->MpllDqFuncCntl));
 memory_level->MclkPwrmgtCntl = ((__uint32_t)(memory_level->MclkPwrmgtCntl));
 memory_level->DllCntl = ((__uint32_t)(memory_level->DllCntl));
 memory_level->MpllSs1 = ((__uint32_t)(memory_level->MpllSs1));
 memory_level->MpllSs2 = ((__uint32_t)(memory_level->MpllSs2));
 return 0;
}
          ...
          SMU7_Discrete_DpmTable *table)
{
 ...
 u32 mclk_pwrmgt_cntl = pi->clock_registers.mclk_pwrmgt_cntl;
 int ret;
 table->ACPILevel.Flags &= ~0x01;
 if (pi->acpi_vddc)
  table->ACPILevel.MinVddc = ((__uint32_t)(pi->acpi_vddc * 4));
 else
  table->ACPILevel.MinVddc = ((__uint32_t)(pi->min_vddc_in_pp_table * 4));
 table->ACPILevel.MinVddcPhases = pi->vddc_phase_shed_control ? 0 : 1;
 table->ACPILevel.SclkFrequency = rdev->clock.spll.reference_freq;
 ret = radeon_atom_get_clock_dividers(rdev,
          0x01,
          table->ACPILevel.SclkFrequency, 0, &dividers);
 if (ret)
  return ret;
 table->ACPILevel.SclkDid = (u8)dividers.post_divider;
 table->ACPILevel.DisplayWatermark = 0;
 table->ACPILevel.DeepSleepDivId = 0;
 spll_func_cntl &= ~(1 << 1);
 spll_func_cntl |= (1 << 0);
 spll_func_cntl_2 &= ~(0x1ff << 0);
 spll_func_cntl_2 |= ((4) << 0);
 ...
 table->ACPILevel.Flags = ((__uint32_t)(table->ACPILevel.Flags));
 table->ACPILevel.MinVddcPhases = ((__uint32_t)(table->ACPILevel.MinVddcPhases));
 table->ACPILevel.SclkFrequency = ((__uint32_t)(table->ACPILevel.SclkFrequency));
 table->ACPILevel.CgSpllFuncCntl = ((__uint32_t)(table->ACPILevel.CgSpllFuncCntl));
 table->ACPILevel.CgSpllFuncCntl2 = ((__uint32_t)(table->ACPILevel.CgSpllFuncCntl2));
 table->ACPILevel.CgSpllFuncCntl3 = ((__uint32_t)(table->ACPILevel.CgSpllFuncCntl3));
 table->ACPILevel.CgSpllFuncCntl4 = ((__uint32_t)(table->ACPILevel.CgSpllFuncCntl4));
 table->ACPILevel.SpllSpreadSpectrum = ((__uint32_t)(table->ACPILevel.SpllSpreadSpectrum));
 table->ACPILevel.SpllSpreadSpectrum2 = ((__uint32_t)(table->ACPILevel.SpllSpreadSpectrum2));
 table->ACPILevel.CcPwrDynRm = ((__uint32_t)(table->ACPILevel.CcPwrDynRm));
 table->ACPILevel.CcPwrDynRm1 = ((__uint32_t)(table->ACPILevel.CcPwrDynRm1));
 table->MemoryACPILevel.MinVddc = table->ACPILevel.MinVddc;
 table->MemoryACPILevel.MinVddcPhases = table->ACPILevel.MinVddcPhases;
 if (pi->vddci_control != 0x0) {
  if (pi->acpi_vddci)
   table->MemoryACPILevel.MinVddci =
    ((__uint32_t)(pi->acpi_vddci * 4));
  else
   table->MemoryACPILevel.MinVddci =
    ((__uint32_t)(pi->min_vddci_in_pp_table * 4));
 }
 if (ci_populate_mvdd_value(rdev, 0, &voltage_level))
  table->MemoryACPILevel.MinMvdd = 0;
 else
  table->MemoryACPILevel.MinMvdd =
   ((__uint32_t)(voltage_level.Voltage * 4));
 mclk_pwrmgt_cntl |= (1 << 16) | (1 << 17);
 mclk_pwrmgt_cntl &= ~((1 << 8) | (1 << 9));
 dll_cntl &= ~((1 << 24) | (1 << 25));
 table->MemoryACPILevel.DllCntl = ((__uint32_t)(dll_cntl));
 table->MemoryACPILevel.MclkPwrmgtCntl = ((__uint32_t)(mclk_pwrmgt_cntl));
 table->MemoryACPILevel.MpllAdFuncCntl =
  ((__uint32_t)(pi->clock_registers.mpll_ad_func_cntl));
 table->MemoryACPILevel.MpllDqFuncCntl =
  ((__uint32_t)(pi->clock_registers.mpll_dq_func_cntl));
 table->MemoryACPILevel.MpllFuncCntl =
  ((__uint32_t)(pi->clock_registers.mpll_func_cntl));
 table->MemoryACPILevel.MpllFuncCntl_1 =
  ((__uint32_t)(pi->clock_registers.mpll_func_cntl_1));
 table->MemoryACPILevel.MpllFuncCntl_2 =
  ((__uint32_t)(pi->clock_registers.mpll_func_cntl_2));
 table->MemoryACPILevel.MpllSs1 = ((__uint32_t)(pi->clock_registers.mpll_ss1));
 table->MemoryACPILevel.MpllSs2 = ((__uint32_t)(pi->clock_registers.mpll_ss2));
 ...
 table->MemoryACPILevel.ActivityLevel =
  ((__uint16_t)((u16)pi->mclk_activity_target));
...
static int ci_enable_ulv(struct radeon_device *rdev, _Bool enable)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 struct ci_ulv_parm *ulv = &pi->ulv;
 if (ulv->supported) {
  if (enable)
   return (ci_send_msg_to_smc(rdev, ((uint8_t)0x62)) == ((uint8_t)0x01)) ?
    0 : -22;
  else
   return (ci_send_msg_to_smc(rdev, ((uint8_t)0x63)) == ((uint8_t)0x01)) ?
    0 : -22;
 }
 return 0;
}
     ...
     SMU7_Discrete_Ulv *state)
{
 ...
 state->CcPwrDynRm = ((__uint32_t)(state->CcPwrDynRm));
 state->CcPwrDynRm1 = ((__uint32_t)(state->CcPwrDynRm1));
 state->VddcOffset = ((__uint16_t)(state->VddcOffset));
 return 0;
}
        ...
        SMU7_Discrete_GraphicsLevel *sclk)
{
 ...
 spll_func_cntl_3 &= ~(0x3ffffff << 0);
 spll_func_cntl_3 |= ((fbdiv) << 0);
        spll_func_cntl_3 |= (1 << 28);
 if (pi->caps_sclk_ss_support) {
  struct radeon_atom_ss ss;
  ...
  if (radeon_atombios_get_asic_ss_info(rdev, &ss,
   ...
   cg_spll_spread_spectrum &= ~(0xfff << 4);
   cg_spll_spread_spectrum |= ((clk_s) << 4);
   cg_spll_spread_spectrum |= (1 << 0);
   cg_spll_spread_spectrum_2 &= ~(0x3ffffff << 0);
   cg_spll_spread_spectrum_2 |= ((clk_v) << 0);
  }
 }
         ...
         SMU7_Discrete_GraphicsLevel *graphic_level)
{
 ...
 if (pi->caps_sclk_ds)
  graphic_level->DeepSleepDivId = ci_get_sleep_divider_id_from_clock(rdev,
             engine_clock,
             800);
 graphic_level->DisplayWatermark = 0;
 graphic_level->Flags = ((__uint32_t)(graphic_level->Flags));
        graphic_level->MinVddc = ((__uint32_t)(graphic_level->MinVddc * 4));
 graphic_level->MinVddcPhases = ((__uint32_t)(graphic_level->MinVddcPhases));
 graphic_level->SclkFrequency = ((__uint32_t)(graphic_level->SclkFrequency));
 graphic_level->ActivityLevel = ((__uint16_t)(graphic_level->ActivityLevel));
 graphic_level->CgSpllFuncCntl3 = ((__uint32_t)(graphic_level->CgSpllFuncCntl3));
 graphic_level->CgSpllFuncCntl4 = ((__uint32_t)(graphic_level->CgSpllFuncCntl4));
 graphic_level->SpllSpreadSpectrum = ((__uint32_t)(graphic_level->SpllSpreadSpectrum));
 graphic_level->SpllSpreadSpectrum2 = ((__uint32_t)(graphic_level->SpllSpreadSpectrum2));
 graphic_level->CcPwrDynRm = ((__uint32_t)(graphic_level->CcPwrDynRm));
 graphic_level->CcPwrDynRm1 = ((__uint32_t)(graphic_level->CcPwrDynRm1));
 return 0;
}
static int ci_populate_all_graphic_levels(struct radeon_device *rdev)
{
 ...
 u32 level_array_address = pi->dpm_table_start +
  __builtin_offsetof(SMU7_Discrete_DpmTable, GraphicsLevel);
 u32 level_array_size = sizeof(SMU7_Discrete_GraphicsLevel) *
  8;
 SMU7_Discrete_GraphicsLevel *levels = pi->smc_state_table.GraphicsLevel;
 u32 i, ret;
 __builtin_memset((levels), (0), (level_array_size));
...
static int ci_populate_all_memory_levels(struct radeon_device *rdev)
{
 ...
 struct ci_dpm_table *dpm_table = &pi->dpm_table;
 u32 level_array_address = pi->dpm_table_start +
  __builtin_offsetof(SMU7_Discrete_DpmTable, MemoryLevel);
 ...
 pi->smc_state_table.MemoryLevel[0].ActivityLevel = ((__uint16_t)(0x1F));
...
static int ci_setup_default_dpm_tables(struct radeon_device *rdev)
{
 ...
 if (allowed_sclk_vddc_table->count < 1)
  return -22;
 if (allowed_mclk_table == ((void *)0))
  return -22;
 if (allowed_mclk_table->count < 1)
  return -22;
 __builtin_memset((&pi->dpm_table), (0), (sizeof(struct ci_dpm_table)));
 ci_reset_single_dpm_table(rdev,
...
static int ci_init_smc_table(struct radeon_device *rdev)
{
 ...
 if (ret)
  return ret;
 if (pi->voltage_control != 0x0)
  ci_populate_smc_voltage_tables(rdev, table);
 ci_init_fps_limits(rdev);
 if (rdev->pm.dpm.platform_caps & 32)
  table->SystemFlags |= 0x01;
 if (rdev->pm.dpm.platform_caps & 128)
  table->SystemFlags |= 0x02;
 if (pi->mem_gddr5)
  table->SystemFlags |= 0x04;
 if (ulv->supported) {
  ret = ci_populate_ulv_state(rdev, &pi->smc_state_table.Ulv);
  if (ret)
   return ret;
  tn_smc_wreg(rdev, (0xC0200158), (ulv->cg_ulv_parameter));
 }
 ...
 table->SystemFlags = ((__uint32_t)(table->SystemFlags));
 table->SmioMaskVddcVid = ((__uint32_t)(table->SmioMaskVddcVid));
 table->SmioMaskVddcPhase = ((__uint32_t)(table->SmioMaskVddcPhase));
 table->SmioMaskVddciVid = ((__uint32_t)(table->SmioMaskVddciVid));
 table->SmioMaskMvddVid = ((__uint32_t)(table->SmioMaskMvddVid));
 table->SclkStepSize = ((__uint32_t)(table->SclkStepSize));
 table->TemperatureLimitHigh = ((__uint16_t)(table->TemperatureLimitHigh));
 table->TemperatureLimitLow = ((__uint16_t)(table->TemperatureLimitLow));
 table->VddcVddciDelta = ((__uint16_t)(table->VddcVddciDelta));
 table->VoltageResponseTime = ((__uint16_t)(table->VoltageResponseTime));
 table->PhaseResponseTime = ((__uint16_t)(table->PhaseResponseTime));
 table->BootVddc = ((__uint16_t)(table->BootVddc * 4));
 table->BootVddci = ((__uint16_t)(table->BootVddci * 4));
 table->BootMVdd = ((__uint16_t)(table->BootMVdd * 4));
 ret = ci_copy_bytes_to_smc(rdev,
       pi->dpm_table_start +
       __builtin_offsetof(SMU7_Discrete_DpmTable, SystemFlags),
 ...
 for (i = 0; i < vddc_table->count; i++) {
  if (requested_voltage <= vddc_table->entries[i].v) {
   ...
   return (ci_send_msg_to_smc_with_parameter(rdev,
          ((uint16_t) 0x15f),
          requested_voltage * 4) == ((uint8_t)0x01)) ?
    0 : -22;
  }
 }
 return -22;
         ...
         struct radeon_ps *radeon_state)
{
 ...
 if (i >= sclk_table->count) {
  pi->need_update_smu7_dpm_table |= 0x00000001;
 } else {
  if (800 != 800)
   pi->need_update_smu7_dpm_table |= 0x00000004;
 }
 ...
 if (rdev->pm.dpm.current_active_crtc_count !=
  ...
  pi->need_update_smu7_dpm_table |= 0x00000008;
}
             ...
             struct radeon_ps *radeon_state)
{
 ...
 if (!pi->need_update_smu7_dpm_table)
  return 0;
 if (pi->need_update_smu7_dpm_table & 0x00000001)
  dpm_table->sclk_table.dpm_levels[dpm_table->sclk_table.count-1].value = sclk;
 if (pi->need_update_smu7_dpm_table & 0x00000002)
  dpm_table->mclk_table.dpm_levels[dpm_table->mclk_table.count-1].value = mclk;
 if (pi->need_update_smu7_dpm_table & (0x00000001 | 0x00000004)) {
  ret = ci_populate_all_graphic_levels(rdev);
  if (ret)
   return ret;
 }
 if (pi->need_update_smu7_dpm_table & (0x00000002 | 0x00000008)) {
  ret = ci_populate_all_memory_levels(rdev);
  if (ret)
   return ret;
 }
...
static int ci_enable_uvd_dpm(struct radeon_device *rdev, _Bool enable)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 ...
 return (ci_send_msg_to_smc(rdev, enable ?
       ((uint16_t) 0x154) : ((uint16_t) 0x155)) == ((uint8_t)0x01)) ?
  0 : -22;
}
static int ci_enable_vce_dpm(struct radeon_device *rdev, _Bool enable)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 const struct radeon_clock_and_voltage_limits *max_limits;
 int i;
 ...
 return (ci_send_msg_to_smc(rdev, enable ?
       ((uint16_t) 0x15a) : ((uint16_t) 0x15b)) == ((uint8_t)0x01)) ?
  0 : -22;
}
static int ci_update_uvd_dpm(struct radeon_device *rdev, _Bool gate)
{
 ...
 if (!gate) {
  ...
  tmp = tn_smc_rreg(rdev, (0x3F768));
  tmp &= ~0xff000000;
  tmp |= ((pi->smc_state_table.UvdBootLevel) << 24);
  tn_smc_wreg(rdev, (0x3F768), (tmp));
 }
        ...
        struct radeon_ps *radeon_current_state)
{
 ...
 if (radeon_current_state->evclk != radeon_new_state->evclk) {
  if (radeon_new_state->evclk) {
   cik_update_cg(rdev, (1 << 4), 0);
   pi->smc_state_table.VceBootLevel = ci_get_vce_boot_level(rdev);
   tmp = tn_smc_rreg(rdev, (0x3F768));
   tmp &= ~0x00ff0000;
   tmp |= ((pi->smc_state_table.VceBootLevel) << 16);
   tn_smc_wreg(rdev, (0x3F768), (tmp));
   ret = ci_enable_vce_dpm(rdev, 1);
  } else {
   cik_update_cg(rdev, (1 << 4), 1);
  ...
  if ((!pi->pcie_dpm_key_disabled) &&
   ...
   if (levels) {
    ...
    if (ret)
     return ret;
    for (i = 0; i < rdev->usec_timeout; i++) {
     tmp = (tn_smc_rreg(rdev, (0xC02000F0)) &
            (0xf << 24)) >> 24;
     if (tmp == levels)
      break;
     udelay(1);
  ...
  if ((!pi->sclk_dpm_key_disabled) &&
   ...
   if (levels) {
    ...
    if (ret)
     return ret;
    for (i = 0; i < rdev->usec_timeout; i++) {
     tmp = (tn_smc_rreg(rdev, (0xC0200014)) &
            (0x1f << 16)) >> 16;
     if (tmp == levels)
      break;
     udelay(1);
           ...
           struct ci_mc_reg_table *table)
{
 ...
 for (i = 0, j = table->last; i < table->last; i++) {
  ...
  case 0x2a04:
   temp_reg = r100_mm_rreg(rdev, (0x2a0c), 0);
   table->mc_reg_address[j].s1 = 0x2a0c >> 2;
   table->mc_reg_address[j].s0 = 0x2a84 >> 2;
   ...
   if (j >= 16)
    return -22;
   temp_reg = r100_mm_rreg(rdev, (0x2aac), 0);
   table->mc_reg_address[j].s1 = 0x2aac >> 2;
   table->mc_reg_address[j].s0 = 0x2a88 >> 2;
   for (k = 0; k < table->num_entries; k++) {
    table->mc_reg_table_entry[k].mc_data[j] =
   ...
   if (j > 16)
    return -22;
   if (!pi->mem_gddr5) {
    table->mc_reg_address[j].s1 = 0x28d0 >> 2;
    table->mc_reg_address[j].s0 = 0x28d0 >> 2;
    for (k = 0; k < table->num_entries; k++) {
     table->mc_reg_table_entry[k].mc_data[j] =
   ...
   break;
  case 0x2a08:
   temp_reg = r100_mm_rreg(rdev, (0x2b44), 0);
   table->mc_reg_address[j].s1 = 0x2b44 >> 2;
   table->mc_reg_address[j].s0 = 0x2b48 >> 2;
   for (k = 0; k < table->num_entries; k++) {
    table->mc_reg_table_entry[k].mc_data[j] =
     (temp_reg & 0xffff0000) | (table->mc_reg_table_entry[k].mc_data[i] & 0x0000ffff);
   }
...
static _Bool ci_check_s0_mc_reg_index(u16 in_reg, u16 *out_reg)
{
 _Bool result = 1;
 switch(in_reg) {
 case 0x28a0 >> 2:
           ...
           struct ci_mc_reg_table *table)
{
 ...
 if (patch &&
  ...
  r100_mm_wreg(rdev, (0x2a44), (3), 0);
  tmp = r100_mm_rreg(rdev, (0x2a48), 0);
  tmp = (tmp & 0xFFF8FFFF) | (1 << 16);
  r100_mm_wreg(rdev, (0x2a44), (3), 0);
  r100_mm_wreg(rdev, (0x2a48), (tmp), 0);
 }
 return 0;
}
static int ci_initialize_mc_reg_table(struct radeon_device *rdev)
{
 ...
 int ret;
 table = kzalloc(sizeof(struct atom_mc_reg_table), (0x0001 | 0x0004));
 if (!table)
  return -12;
 r100_mm_wreg(rdev, (0x2a6c), (r100_mm_rreg(rdev, (0x28a0), 0)), 0);
 r100_mm_wreg(rdev, (0x2a70), (r100_mm_rreg(rdev, (0x28a4), 0)), 0);
 r100_mm_wreg(rdev, (0x363c), (r100_mm_rreg(rdev, (0x3638), 0)), 0);
 r100_mm_wreg(rdev, (0x3610), (r100_mm_rreg(rdev, (0x360c), 0)), 0);
 r100_mm_wreg(rdev, (0x3618), (r100_mm_rreg(rdev, (0x3614), 0)), 0);
 r100_mm_wreg(rdev, (0x3608), (r100_mm_rreg(rdev, (0x3604), 0)), 0);
 r100_mm_wreg(rdev, (0x3634), (r100_mm_rreg(rdev, (0x3630), 0)), 0);
 r100_mm_wreg(rdev, (0x362c), (r100_mm_rreg(rdev, (0x3628), 0)), 0);
 r100_mm_wreg(rdev, (0x2a74), (r100_mm_rreg(rdev, (0x28a8), 0)), 0);
 r100_mm_wreg(rdev, (0x2a78), (r100_mm_rreg(rdev, (0x28ac), 0)), 0);
 r100_mm_wreg(rdev, (0x2a84), (r100_mm_rreg(rdev, (0x2a0c), 0)), 0);
 r100_mm_wreg(rdev, (0x2a88), (r100_mm_rreg(rdev, (0x2aac), 0)), 0);
 r100_mm_wreg(rdev, (0x2b48), (r100_mm_rreg(rdev, (0x2b44), 0)), 0);
 r100_mm_wreg(rdev, (0x2a7c), (r100_mm_rreg(rdev, (0x28bc), 0)), 0);
 r100_mm_wreg(rdev, (0x2a80), (r100_mm_rreg(rdev, (0x28c0), 0)), 0);
 r100_mm_wreg(rdev, (0x2b1c), (r100_mm_rreg(rdev, (0x28b4), 0)), 0);
 r100_mm_wreg(rdev, (0x2b20), (r100_mm_rreg(rdev, (0x28b8), 0)), 0);
 r100_mm_wreg(rdev, (0x2b4c), (r100_mm_rreg(rdev, (0x28b0), 0)), 0);
 r100_mm_wreg(rdev, (0x2b60), (r100_mm_rreg(rdev, (0x2b5c), 0)), 0);
 r100_mm_wreg(rdev, (0x2b58), (r100_mm_rreg(rdev, (0x2b54), 0)), 0);
     ...
     SMU7_Discrete_MCRegisters *mc_reg_table)
{
 ...
 for (i = 0, j = 0; j < pi->mc_reg_table.last; j++) {
  if (pi->mc_reg_table.valid_flag & (1 << j)) {
   if (i >= 16)
    return -22;
   mc_reg_table->address[i].s0 = ((__uint16_t)(pi->mc_reg_table.mc_reg_address[j].s0));
   mc_reg_table->address[i].s1 = ((__uint16_t)(pi->mc_reg_table.mc_reg_address[j].s1));
   i++;
  }
 }
        ...
        u32 num_entries, u32 valid_flag)
{
 ...
 for (i = 0, j = 0; j < num_entries; j++) {
  if (valid_flag & (1 << j)) {
   data->value[i] = ((__uint32_t)(entry->mc_data[j]));
   i++;
  }
 }
}
...
static int ci_populate_initial_mc_reg_table(struct radeon_device *rdev)
{
 struct ci_power_info *pi = ci_get_pi(rdev);
 int ret;
 __builtin_memset((&pi->smc_mc_reg_table), (0), (sizeof(SMU7_Discrete_MCRegisters)));
...
static int ci_update_and_upload_mc_reg_table(struct radeon_device *rdev)
{
 ...
 return ci_copy_bytes_to_smc(rdev,
        pi->mc_reg_table_start +
        __builtin_offsetof(SMU7_Discrete_MCRegisters, data[0]),
...
{
 u32 speed_cntl = 0;
 speed_cntl = rdev->pciep_rreg(rdev, (0x100100A4)) & (0x3 << 13);
 speed_cntl >>= 13;
...
{
 u32 link_width = 0;
 link_width = rdev->pciep_rreg(rdev, (0x100100A2)) & 0x70;
 link_width >>= 4;
 switch (link_width) {
 case 1:
  return 1;
...
void ci_dpm_setup_asic(struct radeon_device *rdev)
{
 ...
 if (r)
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to load MC firmware!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
...
int ci_dpm_enable(struct radeon_device *rdev)
{
 ...
 if (pi->voltage_control != 0x0) {
  ...
  if (ret) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_construct_voltage_tables failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return ret;
  }
 }
 ...
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_upload_firmware failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_process_firmware_header(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_process_firmware_header failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_initial_switch_from_arb_f0_to_f1(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_initial_switch_from_arb_f0_to_f1 failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_init_smc_table(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_init_smc_table failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_init_arb_table_index(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_init_arb_table_index failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 if (pi->caps_dynamic_ac_timing) {
  ret = ci_populate_initial_mc_reg_table(rdev);
  if (ret) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_populate_initial_mc_reg_table failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return ret;
  }
 }
 ret = ci_populate_pm_base(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_populate_pm_base failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ...
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_notify_smc_display_change failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ci_enable_sclk_control(rdev, 1);
 ret = ci_enable_ulv(rdev, 1);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_enable_ulv failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_enable_ds_master_switch(rdev, 1);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_enable_ds_master_switch failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_start_dpm(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_start_dpm failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_enable_didt(rdev, 1);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_enable_didt failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_enable_smc_cac(rdev, 1);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_enable_smc_cac failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_enable_power_containment(rdev, 1);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_enable_power_containment failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_power_control_set_level(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_power_control_set_level failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ci_enable_auto_throttle_source(rdev, RADEON_DPM_AUTO_THROTTLE_SRC_THERMAL, 1);
 ret = ci_enable_thermal_based_sclk_dpm(rdev, 1);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_enable_thermal_based_sclk_dpm failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
...
int ci_dpm_set_power_state(struct radeon_device *rdev)
{
 ...
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_freeze_sclk_mclk_dpm failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_populate_and_upload_sclk_mclk_dpm_levels(rdev, new_ps);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_populate_and_upload_sclk_mclk_dpm_levels failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_generate_dpm_level_enable_mask(rdev, new_ps);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_generate_dpm_level_enable_mask failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_update_vce_dpm(rdev, new_ps, old_ps);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_update_vce_dpm failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_update_sclk_t(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_update_sclk_t failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 if (pi->caps_dynamic_ac_timing) {
  ret = ci_update_and_upload_mc_reg_table(rdev);
  if (ret) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_update_and_upload_mc_reg_table failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return ret;
  }
 }
 ret = ci_program_memory_timing_parameters(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_program_memory_timing_parameters failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_unfreeze_sclk_mclk_dpm(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_unfreeze_sclk_mclk_dpm failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 ret = ci_upload_dpm_level_enable_mask(rdev);
 if (ret) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "ci_upload_dpm_level_enable_mask failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return ret;
 }
 if (pi->pcie_performance_request)
...
static void ci_parse_pplib_non_clock_info(struct radeon_device *rdev,
       ...
       u8 table_rev)
{
 rps->caps = (__uint32_t)(__builtin_constant_p(non_clock_info->ulCapsAndSettings) ? (__uint32_t)(((__uint32_t)(non_clock_info->ulCapsAndSettings) & 0xff) << 24 | ((__uint32_t)(non_clock_info->ulCapsAndSettings) & 0xff00) << 8 | ((__uint32_t)(non_clock_info->ulCapsAndSettings) & 0xff0000) >> 8 | ((__uint32_t)(non_clock_info->ulCapsAndSettings) & 0xff000000) >> 24) : __swap32md(non_clock_info->ulCapsAndSettings));
 rps->class = (__uint16_t)(__builtin_constant_p(non_clock_info->usClassification) ? (__uint16_t)(((__uint16_t)(non_clock_info->usClassification) & 0xffU) << 8 | ((__uint16_t)(non_clock_info->usClassification) & 0xff00U) >> 8) : __swap16md(non_clock_info->usClassification));
 rps->class2 = (__uint16_t)(__builtin_constant_p(non_clock_info->usClassification2) ? (__uint16_t)(((__uint16_t)(non_clock_info->usClassification2) & 0xffU) << 8 | ((__uint16_t)(non_clock_info->usClassification2) & 0xff00U) >> 8) : __swap16md(non_clock_info->usClassification2));
 if (12 < table_rev) {
  rps->vclk = (__uint32_t)(__builtin_constant_p(non_clock_info->ulVCLK) ? (__uint32_t)(((__uint32_t)(non_clock_info->ulVCLK) & 0xff) << 24 | ((__uint32_t)(non_clock_info->ulVCLK) & 0xff00) << 8 | ((__uint32_t)(non_clock_info->ulVCLK) & 0xff0000) >> 8 | ((__uint32_t)(non_clock_info->ulVCLK) & 0xff000000) >> 24) : __swap32md(non_clock_info->ulVCLK));
  rps->dclk = (__uint32_t)(__builtin_constant_p(non_clock_info->ulDCLK) ? (__uint32_t)(((__uint32_t)(non_clock_info->ulDCLK) & 0xff) << 24 | ((__uint32_t)(non_clock_info->ulDCLK) & 0xff00) << 8 | ((__uint32_t)(non_clock_info->ulDCLK) & 0xff0000) >> 8 | ((__uint32_t)(non_clock_info->ulDCLK) & 0xff000000) >> 24) : __swap32md(non_clock_info->ulDCLK));
 } else {
  rps->vclk = 0;
  rps->dclk = 0;
 }
          ...
          union pplib_clock_info *clock_info)
{
 ...
 pl->sclk = (__uint16_t)(__builtin_constant_p(clock_info->ci.usEngineClockLow) ? (__uint16_t)(((__uint16_t)(clock_info->ci.usEngineClockLow) & 0xffU) << 8 | ((__uint16_t)(clock_info->ci.usEngineClockLow) & 0xff00U) >> 8) : __swap16md(clock_info->ci.usEngineClockLow));
 pl->sclk |= clock_info->ci.ucEngineClockHigh << 16;
 pl->mclk = (__uint16_t)(__builtin_constant_p(clock_info->ci.usMemoryClockLow) ? (__uint16_t)(((__uint16_t)(clock_info->ci.usMemoryClockLow) & 0xffU) << 8 | ((__uint16_t)(clock_info->ci.usMemoryClockLow) & 0xff00U) >> 8) : __swap16md(clock_info->ci.usMemoryClockLow));
 ...
 pl->pcie_lane = r600_get_pcie_lane_support(rdev,
         ...
         (__uint16_t)(__builtin_constant_p(clock_info->ci.usPCIELane) ? (__uint16_t)(((__uint16_t)(clock_info->ci.usPCIELane) & 0xffU) << 8 | ((__uint16_t)(clock_info->ci.usPCIELane) & 0xff00U) >> 8) : __swap16md(clock_info->ci.usPCIELane)));
 if (rps->class & 0x1000) {
  pi->acpi_pcie_gen = pl->pcie_gen;
 }
 if (rps->class2 & 0x0002) {
  pi->ulv.supported = 1;
  pi->ulv.pl = *pl;
  pi->ulv.cg_ulv_parameter = 0x00040035;
 }
 if (rps->class & 0x0008) {
...
static int ci_parse_power_table(struct radeon_device *rdev)
{
 ...
 int index = (((char*)(&((ATOM_MASTER_LIST_OF_DATA_TABLES*)0)->PowerPlayInfo)-(char*)0)/sizeof(USHORT));
        u16 data_offset;
 u8 frev, crev;
 ...
 state_array = (struct _StateArray *)
  (mode_info->atom_context->bios + data_offset +
   (__uint16_t)(__builtin_constant_p(power_info->pplib.usStateArrayOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib.usStateArrayOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib.usStateArrayOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib.usStateArrayOffset)));
 clock_info_array = (struct _ClockInfoArray *)
  (mode_info->atom_context->bios + data_offset +
   (__uint16_t)(__builtin_constant_p(power_info->pplib.usClockInfoArrayOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib.usClockInfoArrayOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib.usClockInfoArrayOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib.usClockInfoArrayOffset)));
 non_clock_info_array = (struct _NonClockInfoArray *)
  (mode_info->atom_context->bios + data_offset +
   (__uint16_t)(__builtin_constant_p(power_info->pplib.usNonClockInfoArrayOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib.usNonClockInfoArrayOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib.usNonClockInfoArrayOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib.usNonClockInfoArrayOffset)));
 rdev->pm.dpm.ps = kzalloc(sizeof(struct radeon_ps) *
      state_array->ucNumEntries, (0x0001 | 0x0004));
 if (!rdev->pm.dpm.ps)
  return -12;
 ...
 for (i = 0; i < state_array->ucNumEntries; i++) {
  ...
  if (!rdev->pm.power_state[i].clock_info)
   return -22;
  ps = kzalloc(sizeof(struct ci_ps), (0x0001 | 0x0004));
  if (ps == ((void *)0)) {
 ...
 for (i = 0; i < 6; i++) {
  ...
  sclk = (__uint16_t)(__builtin_constant_p(clock_info->ci.usEngineClockLow) ? (__uint16_t)(((__uint16_t)(clock_info->ci.usEngineClockLow) & 0xffU) << 8 | ((__uint16_t)(clock_info->ci.usEngineClockLow) & 0xff00U) >> 8) : __swap16md(clock_info->ci.usEngineClockLow));
  sclk |= clock_info->ci.ucEngineClockHigh << 16;
  mclk = (__uint16_t)(__builtin_constant_p(clock_info->ci.usMemoryClockLow) ? (__uint16_t)(((__uint16_t)(clock_info->ci.usMemoryClockLow) & 0xffU) << 8 | ((__uint16_t)(clock_info->ci.usMemoryClockLow) & 0xff00U) >> 8) : __swap16md(clock_info->ci.usMemoryClockLow));
...
{
 struct radeon_mode_info *mode_info = &rdev->mode_info;
 int index = (((char*)(&((ATOM_MASTER_LIST_OF_DATA_TABLES*)0)->FirmwareInfo)-(char*)0)/sizeof(USHORT));
 ...
 if (atom_parse_data_header(mode_info->atom_context, index, ((void *)0),
  ...
  firmware_info =
   (ATOM_FIRMWARE_INFO_V2_2 *)(mode_info->atom_context->bios +
          data_offset);
  boot_state->mvdd_bootup_value = (__uint16_t)(__builtin_constant_p(firmware_info->usBootUpMVDDCVoltage) ? (__uint16_t)(((__uint16_t)(firmware_info->usBootUpMVDDCVoltage) & 0xffU) << 8 | ((__uint16_t)(firmware_info->usBootUpMVDDCVoltage) & 0xff00U) >> 8) : __swap16md(firmware_info->usBootUpMVDDCVoltage));
  boot_state->vddc_bootup_value = (__uint16_t)(__builtin_constant_p(firmware_info->usBootUpVDDCVoltage) ? (__uint16_t)(((__uint16_t)(firmware_info->usBootUpVDDCVoltage) & 0xffU) << 8 | ((__uint16_t)(firmware_info->usBootUpVDDCVoltage) & 0xff00U) >> 8) : __swap16md(firmware_info->usBootUpVDDCVoltage));
  boot_state->vddci_bootup_value = (__uint16_t)(__builtin_constant_p(firmware_info->usBootUpVDDCIVoltage) ? (__uint16_t)(((__uint16_t)(firmware_info->usBootUpVDDCIVoltage) & 0xffU) << 8 | ((__uint16_t)(firmware_info->usBootUpVDDCIVoltage) & 0xff00U) >> 8) : __swap16md(firmware_info->usBootUpVDDCIVoltage));
  ...
  boot_state->sclk_bootup_value = (__uint32_t)(__builtin_constant_p(firmware_info->ulDefaultEngineClock) ? (__uint32_t)(((__uint32_t)(firmware_info->ulDefaultEngineClock) & 0xff) << 24 | ((__uint32_t)(firmware_info->ulDefaultEngineClock) & 0xff00) << 8 | ((__uint32_t)(firmware_info->ulDefaultEngineClock) & 0xff0000) >> 8 | ((__uint32_t)(firmware_info->ulDefaultEngineClock) & 0xff000000) >> 24) : __swap32md(firmware_info->ulDefaultEngineClock));
  boot_state->mclk_bootup_value = (__uint32_t)(__builtin_constant_p(firmware_info->ulDefaultMemoryClock) ? (__uint32_t)(((__uint32_t)(firmware_info->ulDefaultMemoryClock) & 0xff) << 24 | ((__uint32_t)(firmware_info->ulDefaultMemoryClock) & 0xff00) << 8 | ((__uint32_t)(firmware_info->ulDefaultMemoryClock) & 0xff0000) >> 8 | ((__uint32_t)(firmware_info->ulDefaultMemoryClock) & 0xff000000) >> 24) : __swap32md(firmware_info->ulDefaultMemoryClock));
  return 0;
 }
 return -22;
}
...
int ci_dpm_init(struct radeon_device *rdev)
{
 int index = (((char*)(&((ATOM_MASTER_LIST_OF_DATA_TABLES*)0)->ASIC_InternalSS_Info)-(char*)0)/sizeof(USHORT));
 ...
 int ret;
 u32 mask;
 pi = kzalloc(sizeof(struct ci_power_info), (0x0001 | 0x0004));
 if (pi == ((void *)0))
  return -12;
 rdev->pm.dpm.priv = pi;
 ...
 if (ret) {
  ...
  return ret;
        ...
        pi->dll_default_on = 0;
        pi->sram_end = 0x40000;
 pi->activity_target[0] = 30;
 pi->activity_target[1] = 30;
 pi->activity_target[2] = 30;
 pi->activity_target[3] = 30;
 pi->activity_target[4] = 30;
 pi->activity_target[5] = 30;
 pi->activity_target[6] = 30;
 pi->activity_target[7] = 30;
 pi->mclk_activity_target = 10;
 pi->sclk_dpm_key_disabled = 0;
 pi->mclk_dpm_key_disabled = 0;
 pi->pcie_dpm_key_disabled = 0;
 pi->thermal_sclk_dpm_enabled = 0;
 if ((rdev->pdev->device == 0x6658) &&
     (rdev->mc_fw->size == (7866 * 4))) {
 ...
 rdev->pm.dpm.dyn_state.vddc_dependency_on_dispclk.entries =
  kzalloc(4 * sizeof(struct radeon_clock_voltage_dependency_entry), (0x0001 | 0x0004));
 ...
 rdev->pm.dpm.dyn_state.valid_sclk_values.values = ((void *)0);
 ...
 gpio = radeon_atombios_lookup_gpio(rdev, 61);
 if (gpio.valid) {
  dpm_table->VRHotGpio = gpio.shift;
  rdev->pm.dpm.platform_caps |= 0x00010000;
 } else {
  dpm_table->VRHotGpio = 0x7F;
  rdev->pm.dpm.platform_caps &= ~0x00010000;
 }
 gpio = radeon_atombios_lookup_gpio(rdev, 60);
 if (gpio.valid) {
  dpm_table->AcDcGpio = gpio.shift;
  rdev->pm.dpm.platform_caps |= 32;
 } else {
  dpm_table->AcDcGpio = 0x7F;
  rdev->pm.dpm.platform_caps &= ~32;
 }
 gpio = radeon_atombios_lookup_gpio(rdev, 62);
 if (gpio.valid) {
  u32 tmp = tn_smc_rreg(rdev, (0xC0200004));
  switch (gpio.shift) {
  case 0:
   tmp &= ~(3 << 0);
   tmp |= ((1) << 0);
  ...
  tn_smc_wreg(rdev, (0xC0200004), (tmp));
 }
 pi->voltage_control = 0x0;
 pi->vddci_control = 0x0;
 pi->mvdd_control = 0x0;
 if (radeon_atom_is_voltage_gpio(rdev, 1, 0))
  pi->voltage_control = 0x1;
 else if (radeon_atom_is_voltage_gpio(rdev, 1, 7))
  pi->voltage_control = 0x2;
 if (rdev->pm.dpm.platform_caps & 0x8000) {
  if (radeon_atom_is_voltage_gpio(rdev, 4, 0))
   pi->vddci_control = 0x1;
  else if (radeon_atom_is_voltage_gpio(rdev, 4, 7))
   pi->vddci_control = 0x2;
  else
   rdev->pm.dpm.platform_caps &= ~0x8000;
        }
 if (rdev->pm.dpm.platform_caps & 4096) {
  if (radeon_atom_is_voltage_gpio(rdev, 2, 0))
   pi->mvdd_control = 0x1;
  else if (radeon_atom_is_voltage_gpio(rdev, 2, 7))
   pi->mvdd_control = 0x2;
  else
   rdev->pm.dpm.platform_caps &= ~4096;
 }
 pi->vddc_phase_shed_control = 1;
 pi->pcie_performance_request = 0;
         ...
         struct radeon_ps *rps)
{
 ...
 printf("\tuvd    vclk: %d dclk: %d\n", rps->vclk, rps->dclk);
 for (i = 0; i < ps->performance_level_count; i++) {
  pl = &ps->performance_levels[i];
  printf("\t\tpower level %d    sclk: %u mclk: %u pcie gen: %u pcie lanes: %u\n", i, pl->sclk, pl->mclk, pl->pcie_gen + 1, pl->pcie_lane);
 }
