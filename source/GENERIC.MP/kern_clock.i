# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c" 2
# 96 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c"
int stathz;
int schedhz;
int profhz;
int profprocs;
...
initclocks(void)
{
 ...
 softclock_si = softintr_establish(1, softclock, ((void *)0));
...
# 153 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c"
void
hardclock(struct clockframe *frame)
{
 ...
 if (p && ((p->p_flag & (0x00000200 | 0x00002000)) == 0)) {
  struct process *pr = p->p_p;




  if ((((frame)->t.tf_tstate & (0x004<<8)) == 0) &&
      ((&pr->ps_timer[1].it_value)->tv_sec || (&pr->ps_timer[1].it_value)->tv_usec) &&
      itimerdecr(&pr->ps_timer[1], tick) == 0) {
   atomic_setbits_int(&p->p_flag, 0x00000004);
   ((p)->p_md.md_astpending = 1);
  }
  if (((&pr->ps_timer[2].it_value)->tv_sec || (&pr->ps_timer[2].it_value)->tv_usec) &&
      itimerdecr(&pr->ps_timer[2], tick) == 0) {
   atomic_setbits_int(&p->p_flag, 0x00000002);
   ((p)->p_md.md_astpending = 1);
  }
 }
...
tvtohz(const struct timeval *tv)
{
 ...
 time_t sec;
 long usec;
# 237 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c"
 sec = tv->tv_sec;
 usec = tv->tv_usec;
 if (sec < 0 || (sec == 0 && usec <= 0))
  nticks = 0;
 else if (sec <= 0x7fffffffffffffffL / 1000000)
  nticks = (sec * 1000000 + (unsigned long)usec + (tick - 1))
      / tick + 1;
 else if (sec <= 0x7fffffffffffffffL / hz)
  nticks = sec * hz
      + ((unsigned long)usec + (tick - 1)) / tick + 1;
 else
  nticks = 0x7fffffffffffffffL;
 if (nticks > 0x7fffffff)
  nticks = 0x7fffffff;
 return ((int)nticks);
}
...
startprofclock(struct process *pr)
{
 ...
 if ((pr->ps_flags & 0x00000100) == 0) {
  atomic_setbits_int(&pr->ps_flags, 0x00000100);
...
stopprofclock(struct process *pr)
{
 ...
 if (pr->ps_flags & 0x00000100) {
  atomic_clearbits_int(&pr->ps_flags, 0x00000100);
...
# 373 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c"
  if (p != ((void *)0) && p->p_p->ps_flags & 0x00000100)
   addupc_intr(p, ((p)->p_md.md_tf->tf_pc));

  if (--spc->spc_pscnt > 0)
   return;
# 390 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_clock.c"
 ...
 if (p != ((void *)0)) {
  ...
  if (schedhz == 0) {
   if ((++(__curcpu->ci_self)->ci_schedstate.spc_schedticks & 3) ==
       0)
    schedclock(p);
  }
 }
...
sysctl_clockrate(char *where, size_t *sizep, void *newp)
{
 ...
 __builtin_memset((&clkinfo), (0), (sizeof clkinfo));
 clkinfo.tick = tick;
