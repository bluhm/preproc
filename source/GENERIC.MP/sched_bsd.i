# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c" 2
...
roundrobin(struct cpu_info *ci)
{
 ...
 if (ci->ci_curproc != ((void *)0)) {
  if (spc->spc_schedflags & 0x0001) {
...
# 181 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c"
fixpt_t ccpu = 0.95122942450071400909 * (1<<11);
# 200 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c"
void
schedcpu(void *arg)
{
 ...
 ((phz) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c", 217, "phz"));
 ...
 for((p) = ((&allproc)->lh_first); (p)!= ((void *)0); (p) = ((p)->p_list.le_next)) {
  ...
  p->p_cpticks = 0;
  newcpu = (u_int) (((loadfac) * (p->p_estcpu)) / ((loadfac) + (1<<11)));
  p->p_estcpu = newcpu;
  resetpriority(p);
  if (p->p_priority >= 50) {
   if (p->p_stat == 2 &&
...
updatepri(struct proc *p)
{
 ...
 if (p->p_slptime > 5 * loadfac)
  ...
  while (newcpu && --p->p_slptime)
   newcpu = (int) (((loadfac) * (newcpu)) / ((loadfac) + (1<<11)));
  p->p_estcpu = newcpu;
 }
 resetpriority(p);
}
...
mi_switch(void)
{
 ...
 nanouptime(&ts);
 if ((((&ts)->tv_sec == (&spc->spc_runtime)->tv_sec) ? ((&ts)->tv_nsec < (&spc->spc_runtime)->tv_nsec) : ((&ts)->tv_sec < (&spc->spc_runtime)->tv_sec))) {
 ...
 atomic_clearbits_int(&spc->spc_schedflags, (0x0001|0x0002));
...
# 426 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c"
...
{
 struct cpu_info *ci;
# 470 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c"
 ci = (p->p_cpu != ((void *)0)) ? p->p_cpu : (__curcpu->ci_self);
...
setrunnable(struct proc *p)
{
 ...
 case 4:
  ...
  if ((p->p_p->ps_flags & 0x00000200) != 0 && p->p_xstat != 0)
   atomic_setbits_int(&p->p_siglist, (1U << ((p->p_xstat)-1)));
 case 3:
  unsleep(p);
  break;
 }
...
# 546 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c"
void
...
# 572 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sched_bsd.c" 2

void setperf_auto(void *);
struct timeout setperf_to = { { ((void *)0), ((void *)0) }, (setperf_auto), (((void *)0)), 0, 4 };
...
setperf_auto(void *v)
{
 ...
 for (cii = 0, ci = cpus; ci != ((void *)0); ci = ci->ci_next) {
  ...
  total -= totalticks[j];
  idle = ci->ci_schedstate.spc_cp_time[4] - idleticks[j];
  if (idle < total / 3)
   speedup = 1;
  alltotal += total;
  allidle += idle;
