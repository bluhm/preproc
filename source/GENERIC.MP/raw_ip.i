# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c"
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c"
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 83 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 87 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
# 89 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2
...
void pf_send_tcp(const struct pf_rule *, sa_family_t,
       ...
       u_int8_t, u_int16_t, u_int16_t, u_int8_t, int,
       u_int16_t, u_int);
# 91 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/pf.h" 1
# 93 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c" 2

struct inpcbtable rawcbtable;
# 109 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c"
void
rip_init(void)
{
...
struct sockaddr_in ripsrc = { sizeof(ripsrc), 2 };
 ...
 divert_reply:
  ...
  if (last) {
   ...
   if ((n = m_copym(m, 0, 1000000000, 0x0002)) != ((void *)0)) {
    if (last->inp_flags & (0x001|0x002|0x004| 0x010|0x020|0x080|0x040|0x200| 0x400) ||
        last->inp_socket->so_options & 0x0800)
    ...
    struct mbuf *control)
{
 ...
 if ((inp->inp_flags & 0x008) == 0) {
  ...
  ip->ip_tos = inp->inp_hu.hu_ip.ip_tos;
  ip->ip_off = ((__uint16_t)(0));
  ...
  ip->ip_ttl = inp->inp_hu.hu_ip.ip_ttl ? inp->inp_hu.hu_ip.ip_ttl : 255;
 } else {
  ...
  if ((ip->ip_hl != (sizeof (*ip) >> 2) && inp->inp_options) ||
      ((__uint16_t)(ip->ip_len)) > m->M_dat.MH.MH_pkthdr.len ||
      ((__uint16_t)(ip->ip_len)) < ip->ip_hl << 2) {
   m_freem(m);
   return (22);
  }
  if (ip->ip_id == 0) {
...
# 278 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/raw_ip.c"
 m->M_dat.MH.MH_pkthdr.ph_rtableid = inp->inp_rtableid;


 if (inp->inp_socket->so_state & 0x002 &&
     ip->ip_p != 1)
  m->M_dat.MH.MH_pkthdr.pf.inp = inp;


 error = ip_output(m, inp->inp_options, &inp->inp_ru.ru_route, flags,
     inp->inp_mou.mou_mo, inp, 0);
 if (error == 13)
  error = 65;
 return (error);
}
...
u_long rip_sendspace = 8192;
u_long rip_recvspace = 8192;
