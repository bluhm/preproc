# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_mbuf2.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_mbuf2.c"
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_mbuf2.c"
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_mbuf2.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_mbuf2.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_mbuf2.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_mbuf2.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_mbuf2.c" 2

extern struct pool mtagpool;


static struct mbuf *m_dup1(struct mbuf *, int, int, int);
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/uipc_mbuf2.c"
struct mbuf *
m_pulldown(struct mbuf *m, int off, int len, int *offp)
{
 ...
 if ((n = m_getptr(m, off, &off)) == ((void *)0)) {
  m_freem(m);
  return (((void *)0));
 }
 ...
 if (len <= n->m_hdr.mh_len - off) {
  ...
  o = m_dup1(n, off, n->m_hdr.mh_len - off, 0x0002);
  if (o == ((void *)0)) {
   m_freem(m);
   return (((void *)0));
  }
  for (mlast = o; mlast->m_hdr.mh_next != ((void *)0); mlast = mlast->m_hdr.mh_next)
   ;
  n->m_hdr.mh_len = off;
  mlast->m_hdr.mh_next = n->m_hdr.mh_next;
  n->m_hdr.mh_next = o;
  n = o;
  off = 0;
  goto ok;
 ...
 olen = 0;
 for (o = n->m_hdr.mh_next; o != ((void *)0); o = o->m_hdr.mh_next)
  olen += o->m_hdr.mh_len;
 if (hlen + olen < len) {
  m_freem(m);
  return (((void *)0));
 ...
 if ((off == 0 || offp) && m_leadingspace(n->m_hdr.mh_next) >= hlen &&
     !sharedcluster && n->m_hdr.mh_next->m_hdr.mh_len >= tlen) {
  n->m_hdr.mh_next->m_hdr.mh_data -= hlen;
  n->m_hdr.mh_next->m_hdr.mh_len += hlen;
  __builtin_memmove((((caddr_t)((n->m_hdr.mh_next)->m_hdr.mh_data))), (((caddr_t)((n)->m_hdr.mh_data)) + off), (hlen));
  n->m_hdr.mh_len -= hlen;
  n = n->m_hdr.mh_next;
  off = 0;
  goto ok;
 ...
 o = m_get((0x0002), (m->m_hdr.mh_type));
 if (o && len > (256 - sizeof(struct m_hdr))) {
  m_clget((o), (0x0002), (len));
 ...
 o->m_hdr.mh_len = hlen;
 __builtin_memmove((((caddr_t)((o)->m_hdr.mh_data))), (((caddr_t)((n)->m_hdr.mh_data)) + off), (hlen));
 n->m_hdr.mh_len -= hlen;
...
m_tag_get(int type, int len, int wait)
{
 ...
 t = pool_get(&mtagpool, wait == 0x0001 ? 0x0001 : 0x0002);
 if (t == ((void *)0))
  return (((void *)0));
 t->m_tag_id = type;
 t->m_tag_len = len;
...
{
 do { (t)->m_tag_link.sle_next = (&m->M_dat.MH.MH_pkthdr.ph_tags)->slh_first; (&m->M_dat.MH.MH_pkthdr.ph_tags)->slh_first = (t); } while (0);
 m->M_dat.MH.MH_pkthdr.ph_tagsset |= t->m_tag_id;
}
...
m_tag_delete(struct mbuf *m, struct m_tag *t)
{
 ...
 do { if ((&m->M_dat.MH.MH_pkthdr.ph_tags)->slh_first == (t)) { do { ((&m->M_dat.MH.MH_pkthdr.ph_tags))->slh_first = ((&m->M_dat.MH.MH_pkthdr.ph_tags))->slh_first->m_tag_link.sle_next; } while (0); } else { struct m_tag *curelm = (&m->M_dat.MH.MH_pkthdr.ph_tags)->slh_first; while (curelm->m_tag_link.sle_next != (t)) curelm = curelm->m_tag_link.sle_next; curelm->m_tag_link.sle_next = curelm->m_tag_link.sle_next->m_tag_link.sle_next; } ((t)->m_tag_link.sle_next) = ((void *)-1); } while (0);
 pool_put(&mtagpool, t);

 for((p) = ((&m->M_dat.MH.MH_pkthdr.ph_tags)->slh_first); (p) != ((void *)0); (p) = ((p)->m_tag_link.sle_next))
  ph_tagsset |= p->m_tag_id;
 m->M_dat.MH.MH_pkthdr.ph_tagsset = ph_tagsset;
...
m_tag_delete_chain(struct mbuf *m)
{
 ...
 while ((p = ((&m->M_dat.MH.MH_pkthdr.ph_tags)->slh_first)) != ((void *)0)) {
  do { (&m->M_dat.MH.MH_pkthdr.ph_tags)->slh_first = (&m->M_dat.MH.MH_pkthdr.ph_tags)->slh_first->m_tag_link.sle_next; } while (0);
  pool_put(&mtagpool, p);
 }
 m->M_dat.MH.MH_pkthdr.ph_tagsset = 0;
}
...
m_tag_find(struct mbuf *m, int type, struct m_tag *t)
{
 ...
 if (!(m->M_dat.MH.MH_pkthdr.ph_tagsset & type))
  return (((void *)0));

 if (t == ((void *)0))
  p = ((&m->M_dat.MH.MH_pkthdr.ph_tags)->slh_first);
 else
...
m_tag_copy(struct m_tag *t, int wait)
{
 ...
 if (p == ((void *)0))
  return (((void *)0));
 __builtin_memcpy((p + 1), (t + 1), (t->m_tag_len));
 return (p);
}
...
{
 struct m_tag *p, *t, *tprev = ((void *)0);

 m_tag_delete_chain(to);
 for((p) = ((&from->M_dat.MH.MH_pkthdr.ph_tags)->slh_first); (p) != ((void *)0); (p) = ((p)->m_tag_link.sle_next)) {
  t = m_tag_copy(p, wait);
  if (t == ((void *)0)) {
   m_tag_delete_chain(to);
   return (55);
  ...
  if (tprev == ((void *)0))
   do { (t)->m_tag_link.sle_next = (&to->M_dat.MH.MH_pkthdr.ph_tags)->slh_first; (&to->M_dat.MH.MH_pkthdr.ph_tags)->slh_first = (t); } while (0);
  else
   do { (t)->m_tag_link.sle_next = (tprev)->m_tag_link.sle_next; (tprev)->m_tag_link.sle_next = (t); } while (0);
  tprev = t;
  to->M_dat.MH.MH_pkthdr.ph_tagsset |= t->m_tag_id;
 }
 return (0);
}
...
{
 return (((&m->M_dat.MH.MH_pkthdr.ph_tags)->slh_first));
}
