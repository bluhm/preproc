# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c"
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c"
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacerreg.h" 1
# 147 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacerreg.h"
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c" 2
...
struct auacer_cdata {
 struct auacer_dmalist ic_dmalist_pcmo[32];
};
...
# 138 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/auacer.c"
struct cfdriver auacer_cd = {
        ((void *)0), "auacer", DV_DULL
};
...
struct cfattach auacer_ca = {
        sizeof(struct auacer_softc), auacer_match, auacer_attach, ((void *)0),
 auacer_activate
};
...
auacer_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (pci_mapreg_map(pa, 0x10, 0x00000001, 0,
  &sc->iot, &sc->aud_ioh, ((void *)0), &aud_size, 0)) {
...
auacer_ready_codec(struct auacer_softc *sc, int mask)
{
 ...
 for (count = 0; count < 0x7f; count++) {
  int val = bus_space_read_1(sc->iot, sc->aud_ioh, 0x38);
  if (val & mask)
   return 0;
 }
...
auacer_sema_codec(struct auacer_softc *sc)
{
 ...
 while (ttime-- && (bus_space_read_4(sc->iot, sc->aud_ioh, 0x3c) & 0x80000000))
  delay(1);
 if (!ttime)
  printf("auacer_sema_codec: timeout\n");
 return auacer_ready_codec(sc, 0x08);
}

int
auacer_read_codec(void *v, u_int8_t reg64, u_int16_t *val)
{
 ...
 bus_space_write_2(sc->iot, sc->aud_ioh, 0x22, reg64);
 if (auacer_ready_codec(sc, 0x02))
  return 5;
 *val = bus_space_read_2(sc->iot, sc->aud_ioh, 0x24);
...
int
auacer_write_codec(void *v, u_int8_t reg64, u_int16_t val)
{
 struct auacer_softc *sc = v;
 ...
 if (auacer_sema_codec(sc))
  return 5;
 bus_space_write_2(sc->iot, sc->aud_ioh, 0x20, val);




 bus_space_write_2(sc->iot, sc->aud_ioh, 0x22, reg64);
 auacer_ready_codec(sc, 0x01);
 return 0;
}
...
auacer_reset_codec(void *v)
{
 ...
 reg64 = bus_space_read_4(sc->iot, sc->aud_ioh, 0x00);
 if ((reg64 & 2) == 0)
  reg64 |= 2;
 else
  reg64 |= 1;
 reg64 &= ~0x80000000;
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x00, reg64);

 while (i < 10) {
  if ((bus_space_read_4(sc->iot, sc->aud_ioh, 0x18) & (1<<1)) == 0)
   break;
  delay(50000);
  i++;
 }
 ...
 for (i = 0; i < 10; i++) {
  reg64 = bus_space_read_4(sc->iot, sc->aud_ioh, 0x34);
  if (reg64 & 0x80)
   break;
  bus_space_write_4(sc->iot, sc->aud_ioh, 0x34, reg64 | 0x80);
  delay(50000);
 }
}
...
{
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x00, (1<<31));
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x0c, 0x83838383);
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x1c, 0x83838383);
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x2c, 0x83838383);
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x10, (1<<1));
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x14, 0x00000000);
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x18, 0x00000000);
}
    ...
    struct audio_params *rec)
{
 ...
 for (mode = 0x02; mode != -1;
  ...
  if (!((sc->codec_if)->vtbl->get_caps(sc->codec_if) & 0x0001))
   p->sample_rate = 48000;
  else if (auacer_set_rate(sc, mode, p->sample_rate))
   return 22;

  if (mode == 0x01) {
   control = bus_space_read_4(sc->iot, sc->aud_ioh, 0x00);
   control &= ~((1<<8) | (2<<8));
    if (p->channels == 4)
    control |= (1<<8);
   else if (p->channels == 6)
    control |= (2<<8);
   bus_space_write_4(sc->iot, sc->aud_ioh, 0x00, control);
  }
 }
...
auacer_halt(struct auacer_softc *sc, struct auacer_chan *chan)
{
 ...
 val = bus_space_read_4(sc->iot, sc->aud_ioh, 0x08);
 val |= 1 << (slot+16);
 val &= ~(1 << slot);
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x08, val);
 bus_space_write_1(sc->iot, sc->aud_ioh, port + 0x0b, 0);
 while (bus_space_read_1(sc->iot, sc->aud_ioh, port + 0x0b))
  ;

 bus_space_write_1(sc->iot, sc->aud_ioh, port + 0x0b, 0x02);

 bus_space_write_1(sc->iot, sc->aud_ioh, port + 0x06, bus_space_read_1(sc->iot, sc->aud_ioh, port+0x06) | ((1<<2) | (1<<3) | (1<<4) | (1<<1)));
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x18, ((((port) - 0x40) / 0x10) + 16));
}
...
auacer_allocm(void *v, int direction, size_t size, int pool, int flags)
{
 ...
 p = malloc(sizeof(*p), pool, flags | 0x0008);
 if (p == ((void *)0))
  return (((void *)0));

 error = auacer_allocmem(sc, size, (1 << 13), p);
 if (error) {
  free(p, pool, 0);
  return (((void *)0));
 }
...
auacer_add_entry(struct auacer_chan *chan)
{
 ...
 q->base = __extension__({ __uint32_t __swap32gen_x = (chan->p); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
 q->len = __extension__({ __uint32_t __swap32gen_x = ((chan->blksize / 2) | 0x80000000); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
 chan->p += chan->blksize;
 if (chan->p >= chan->end)
  chan->p = chan->start;
...
auacer_upd_chan(struct auacer_softc *sc, struct auacer_chan *chan)
{
 ...
 sts = bus_space_read_2(sc->iot, sc->aud_ioh, chan->port + 0x06);

 bus_space_write_2(sc->iot, sc->aud_ioh, chan->port + 0x06, sts & ((1<<2) | (1<<3) | (1<<4) | (1<<1)));
 bus_space_write_4(sc->iot, sc->aud_ioh, 0x18, ((((chan->port) - 0x40) / 0x10) + 16));
 ...
 civ = bus_space_read_1(sc->iot, sc->aud_ioh, chan->port + 0x04);
 ...
 bus_space_write_1(sc->iot, sc->aud_ioh, chan->port + 0x05, (chan->ptr - 1) & 0x1f);
    ...
    void *arg)
{
 ...
 bus_space_write_1(sc->iot, sc->aud_ioh, port + 0x04, 0);
 bus_space_write_1(sc->iot, sc->aud_ioh, port + 0x05, (chan->ptr - 1) & 0x1f);
 offs = (char *)chan->dmalist - (char *)sc->sc_cdata;
 bus_space_write_4(sc->iot, sc->aud_ioh, port + 0x00, sc->sc_cddmamap->dm_segs[0].ds_addr + offs);
 bus_space_write_1(sc->iot, sc->aud_ioh, port + 0x0b, 0x10 | 0x08 | 0x04 | 0x01);
    ...
    struct auacer_dma *p)
{
 ...
 error = bus_dmamem_alloc(sc->dmat, p->size, align, 0, p->segs,
     (sizeof((p->segs)) / sizeof((p->segs)[0])), &p->nsegs, 0x0001);
 if (error)
  return (error);

 error = bus_dmamem_map(sc->dmat, p->segs, p->nsegs, p->size, &p->addr,
     0x0001 | sc->sc_dmamap_flags);
 if (error)
  goto free;
 ...
 error = bus_dmamap_load(sc->dmat, p->map, p->addr, p->size, ((void *)0),
     0x0001);
 if (error)
  goto destroy;
 return (0);
...
auacer_alloc_cdata(struct auacer_softc *sc)
{
 ...
 if ((error = bus_dmamap_load(sc->dmat, sc->sc_cddmamap, sc->sc_cdata,
     sizeof(struct auacer_cdata), ((void *)0), 0)) != 0) {
