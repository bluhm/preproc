# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c"
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c"
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c" 2
    ...
    int flags, struct buf **bpp)
{
 ...
 struct vnode *vp;
 struct proc *p;
 struct indir indirs[3 + 2];
 int32_t *bap;
 int deallocated, osize, nsize, num, i, error;
 int32_t *allocib, *blkp, *allocblk, allociblk[3 +1];
 int unwindidx = -1;

 vp = ((ip)->i_vnode);
 fs = ip->inode_u.fs;
 p = (__curcpu->ci_self)->ci_curproc;
 lbn = ((startoffset) >> (fs)->fs_bshift);
 size = ((startoffset) & (fs)->fs_qbmask) + size;
 if (size > fs->fs_bsize)
 ...
 nb = ((ip->dinode_u.ffs1_din->di_size) >> (fs)->fs_bshift);
 if (nb < 12 && nb < lbn) {
  osize = (((nb) >= 12 || ((((ip))->i_ump->um_fstype == 1) ? ((ip))->dinode_u.ffs1_din->di_size : ((ip))->dinode_u.ffs2_din->di_size) >= ((nb) + 1) << (fs)->fs_bshift) ? (u_int64_t)(fs)->fs_bsize : ((((((((((ip))->i_ump->um_fstype == 1) ? ((ip))->dinode_u.ffs1_din->di_size : ((ip))->dinode_u.ffs2_din->di_size)) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask)));
  if (osize < fs->fs_bsize && osize > 0) {
   error = ffs_realloccg(ip, nb,
       ffs1_blkpref(ip, nb, (int)nb, &ip->dinode_u.ffs1_din->di_db[0]),
       osize, (int)fs->fs_bsize, cred, bpp, &newb);
   if (error)
    return (error);
   if (((vp)->v_mount->mnt_flag & 0x04000000))
    softdep_setup_allocdirect(ip, nb, newb,
        ip->dinode_u.ffs1_din->di_db[nb], fs->fs_bsize, osize,
        bpp ? *bpp : ((void *)0));

   ip->dinode_u.ffs1_din->di_size = ((off_t)(nb + 1) << (fs)->fs_bshift);
   uvm_vnp_setsize(vp, ip->dinode_u.ffs1_din->di_size);
   ip->dinode_u.ffs1_din->di_db[nb] = newb;
 ...
 if (lbn < 12) {
  nb = ip->dinode_u.ffs1_din->di_db[lbn];
  if (nb != 0 && ip->dinode_u.ffs1_din->di_size >= ((off_t)(lbn + 1) << (fs)->fs_bshift)) {
  ...
  if (nb != 0) {
   ...
   osize = (((((ip->dinode_u.ffs1_din->di_size) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask);
   nsize = (((size) + (fs)->fs_qfmask) & (fs)->fs_fmask);
   if (nsize <= osize) {
   ...
   if (ip->dinode_u.ffs1_din->di_size < ((off_t)(lbn + 1) << (fs)->fs_bshift))
    nsize = (((size) + (fs)->fs_qfmask) & (fs)->fs_fmask);
   else
    nsize = fs->fs_bsize;
   error = ffs_alloc(ip, lbn,
       ffs1_blkpref(ip, lbn, (int)lbn, &ip->dinode_u.ffs1_din->di_db[0]),
       nsize, cred, &newb);
   if (error)
    return (error);
   if (bpp != ((void *)0)) {
    *bpp = getblk(vp, lbn, fs->fs_bsize, 0, 0);
    if (nsize < fs->fs_bsize)
     (*bpp)->b_bcount = nsize;
    (*bpp)->b_blkno = ((newb) << (fs)->fs_fsbtodb);
    if (flags & 0x01)
     { __builtin_bzero(((*bpp)->b_data), ((u_int)(*bpp)->b_bcount)); (*bpp)->b_resid = 0; };
   }
   if (((vp)->v_mount->mnt_flag & 0x04000000))
    softdep_setup_allocdirect(ip, lbn, newb, 0,
        nsize, 0, bpp ? *bpp : ((void *)0));
  }
  ip->dinode_u.ffs1_din->di_db[lbn] = newb;
  ip->i_flag |= 0x0002 | 0x0004;
  return (0);
 }
 ...
 --num;
 nb = ip->dinode_u.ffs1_din->di_ib[indirs[0].in_off];

 allocib = ((void *)0);
 allocblk = allociblk;
 if (nb == 0) {
  pref = ffs1_blkpref(ip, lbn, -indirs[0].in_off - 1, ((void *)0));
  ...
  *allocblk++ = nb;
  ...
  bp->b_blkno = ((nb) << (fs)->fs_fsbtodb);
  { __builtin_bzero(((bp)->b_data), ((u_int)(bp)->b_bcount)); (bp)->b_resid = 0; };

  if (((vp)->v_mount->mnt_flag & 0x04000000)) {
   softdep_setup_allocdirect(ip, 12 + indirs[0].in_off,
  ...
  allocib = &ip->dinode_u.ffs1_din->di_ib[indirs[0].in_off];
  *allocib = nb;
  ip->i_flag |= 0x0002 | 0x0004;
 }
 ...
 for (i = 1;;) {
  ...
  if (pref == 0)
   pref = ffs1_blkpref(ip, lbn, i - num - 1, ((void *)0));
  ...
  *allocblk++ = nb;
  ...
  nbp->b_blkno = ((nb) << (fs)->fs_fsbtodb);
  { __builtin_bzero(((nbp)->b_data), ((u_int)(nbp)->b_bcount)); (nbp)->b_resid = 0; };
  ...
  *allocblk++ = nb;
  ...
  if (((vp)->v_mount->mnt_flag & 0x04000000))
   softdep_setup_allocindir_page(ip, lbn, bp,
       indirs[i].in_off, nb, 0, bpp ? *bpp : ((void *)0));
...
fail:
 ...
 if (allocblk == allociblk && allocib == ((void *)0) && unwindidx == -1)
  return (error);
# 394 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c"
 VOP_FSYNC(vp, p->p_ucred, 1, p);
 ...
 if (deallocated) {
  ...
  (void)ufs_quota_free_blocks2(ip, ((deallocated) >> 9), cred, 0);

  ip->dinode_u.ffs1_din->di_blocks -= ((deallocated) >> 9);
  ip->i_flag |= 0x0002 | 0x0004;
 }
 VOP_FSYNC(vp, p->p_ucred, 1, p);
 return (error);
    ...
    int flags, struct buf **bpp)
{
 ...
 daddr_t pref, *allocblk, allociblk[3 + 1];
 daddr_t *bap, *allocib;
 ...
 lbn = ((off) >> (fs)->fs_bshift);
 size = ((off) & (fs)->fs_qbmask) + size;
 ...
 lastlbn = ((ip->dinode_u.ffs2_din->di_size) >> (fs)->fs_bshift);
 if (lastlbn < 12 && lastlbn < lbn) {
  nb = lastlbn;
  osize = (((nb) >= 12 || ((((ip))->i_ump->um_fstype == 1) ? ((ip))->dinode_u.ffs1_din->di_size : ((ip))->dinode_u.ffs2_din->di_size) >= ((nb) + 1) << (fs)->fs_bshift) ? (u_int64_t)(fs)->fs_bsize : ((((((((((ip))->i_ump->um_fstype == 1) ? ((ip))->dinode_u.ffs1_din->di_size : ((ip))->dinode_u.ffs2_din->di_size)) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask)));
  if (osize < fs->fs_bsize && osize > 0) {
   error = ffs_realloccg(ip, nb, ffs2_blkpref(ip,
       lastlbn, nb, &ip->dinode_u.ffs2_din->di_db[0]), osize,
   ...
   if (((vp)->v_mount->mnt_flag & 0x04000000))
    softdep_setup_allocdirect(ip, nb, newb,
        ip->dinode_u.ffs2_din->di_db[nb], fs->fs_bsize, osize,
        bpp ? *bpp : ((void *)0));

   ip->dinode_u.ffs2_din->di_size = ((off_t)(nb + 1) << (fs)->fs_bshift);
   uvm_vnp_setsize(vp, ip->dinode_u.ffs2_din->di_size);
   ip->dinode_u.ffs2_din->di_db[nb] = newb;
   ip->i_flag |= 0x0002 | 0x0004;
 ...
 if (lbn < 12) {
  ...
  nb = ip->dinode_u.ffs2_din->di_db[lbn];

  if (nb != 0 && ip->dinode_u.ffs2_din->di_size >= ((off_t)(lbn + 1) << (fs)->fs_bshift)) {
  ...
  if (nb != 0) {
   ...
   osize = (((((ip->dinode_u.ffs2_din->di_size) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask);
   nsize = (((size) + (fs)->fs_qfmask) & (fs)->fs_fmask);
   ...
   if (nsize <= osize) {
    ...
    error = ffs_realloccg(ip, lbn,
        ...
        &ip->dinode_u.ffs2_din->di_db[0]), osize, nsize, cred,
        bpp, &newb);
    if (error)
     return (error);
   ...
   if (ip->dinode_u.ffs2_din->di_size < ((off_t)(lbn + 1) << (fs)->fs_bshift))
    nsize = (((size) + (fs)->fs_qfmask) & (fs)->fs_fmask);
   else
    nsize = fs->fs_bsize;

   error = ffs_alloc(ip, lbn, ffs2_blkpref(ip, lbn,
       (int) lbn, &ip->dinode_u.ffs2_din->di_db[0]), nsize, cred, &newb);
   if (error)
    return (error);
  ...
  ip->dinode_u.ffs2_din->di_db[lbn] = newb;
  ip->i_flag |= 0x0002 | 0x0004;
 ...
 --num;
 nb = ip->dinode_u.ffs2_din->di_ib[indirs[0].in_off];
 allocib = ((void *)0);
 allocblk = allociblk;

 if (nb == 0) {
  pref = ffs2_blkpref(ip, lbn, -indirs[0].in_off - 1, ((void *)0));
  error = ffs_alloc(ip, lbn, pref, (int) fs->fs_bsize, cred,
      &newb);
  if (error)
   goto fail;
  ...
  *allocblk++ = nb;
  ...
  unwindidx = 0;
  allocib = &ip->dinode_u.ffs2_din->di_ib[indirs[0].in_off];
  *allocib = nb;
  ip->i_flag |= 0x0002 | 0x0004;
 }
 ...
 for (i = 1;;) {
  ...
  if (pref == 0)
   pref = ffs2_blkpref(ip, lbn, i - num - 1, ((void *)0));
  ...
  *allocblk++ = nb;
  ...
  if (((vp)->v_mount->mnt_flag & 0x04000000))
   softdep_setup_allocindir_page(ip, lbn, bp,
       indirs[num].in_off, nb, 0, bpp ? *bpp : ((void *)0));
...
fail:
 ...
 if (allocblk == allociblk && allocib == ((void *)0) && unwindidx == -1)
  return (error);
# 801 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_balloc.c"
 VOP_FSYNC(vp, p->p_ucred, 1, p);
 if (unwindidx >= 0) {
   ...
   if (bp->b_flags & 0x00000080) {
    nb = ((((((daddr_t)(fs)->fs_fpg * (((((bp->b_blkno) >> (fs)->fs_fsbtodb)) / (fs)->fs_fpg))) + (fs)->fs_cgoffset * ((((((bp->b_blkno) >> (fs)->fs_fsbtodb)) / (fs)->fs_fpg)) & ~((fs)->fs_cgmask))) + (fs)->fs_cblkno)) << (fs)->fs_fsbtodb);

    bwrite(bp);
    bp = getblk(ip->i_ump->um_devvp, nb,
  ...
  if (((vp)->v_mount->mnt_flag & 0x04000000) && unwindidx == 0) {
   ip->i_flag |= 0x0002 | 0x0004;
   ffs_update(ip, 1);
  }
 ...
 if (deallocated) {
  ...
  ip->dinode_u.ffs2_din->di_blocks -= ((deallocated) >> 9);
  ip->i_flag |= 0x0002 | 0x0004;
 }
 VOP_FSYNC(vp, p->p_ucred, 1, p);
 return (error);
    ...
    int flags, struct buf **bpp)
{
 ...
 if (ip->inode_u.fs->fs_magic == 0x19540119)
