# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
void device_register(struct device *, void *);
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrdreg.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrdvar.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrdvar.h"
struct clkbrd_softc {
 struct device sc_dv;
 bus_space_tag_t sc_bt;
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/clkbrd.c" 2
...
clkbrd_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (bus_space_map(sc->sc_bt, ((((bus_addr_t)fa->fa_reg[1].fbr_slot)<<32)|(fa->fa_reg[1].fbr_offset)), fa->fa_reg[1].fbr_size, 0, &sc->sc_creg)) {
 ...
 if (fa->fa_nreg > 2) {
  if (bus_space_map(sc->sc_bt, ((((bus_addr_t)fa->fa_reg[2].fbr_slot)<<32)|(fa->fa_reg[2].fbr_offset)), fa->fa_reg[2].fbr_size, 0, &sc->sc_vreg)) {
 ...
 slots = 4;
 r = bus_space_read_1(sc->sc_bt, sc->sc_creg, 0x10);
 switch (r & 0xc0) {
 case 0x40:
  slots = 16;
  break;
 ...
 if (sensor_task_register(sc, clkbrd_refresh, 5) == ((void *)0)) {
...
clkbrd_led_blink(void *vsc, int on)
{
 ...
 s = _splraise(15);
 r = bus_space_read_1(sc->sc_bt, sc->sc_creg, 0x00);
 if (on)
  r |= 0x01;
 else
  r &= ~0x01;
 bus_space_write_1(sc->sc_bt, sc->sc_creg, 0x00, r);
 bus_space_read_1(sc->sc_bt, sc->sc_creg, 0x00);
 _splx(s);
}
...
clkbrd_refresh(void *arg)
{
 ...
 val = bus_space_read_1(sc->sc_bt, sc->sc_creg, 0x50);
 if (val == 0xff) {
