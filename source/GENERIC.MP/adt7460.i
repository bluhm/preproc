# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adt7460.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adt7460.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adt7460.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adt7460.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adt7460.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adt7460.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adt7460.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adt7460.c" 2
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adt7460.c"
struct adt_chip {
 const char *name;
 short ratio[7];
 int type;
...
adt_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_sensor[0].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[0].desc, "+2.5Vin",
     sizeof(sc->sc_sensor[0].desc));

 if (sc->chip->type == 5017)
  strlcpy(sc->sc_sensor[0].desc, "+5VTR",
      sizeof(sc->sc_sensor[0].desc));
 if (sc->chip->type == 5027)
  strlcpy(sc->sc_sensor[0].desc, "+5V",
      sizeof(sc->sc_sensor[0].desc));

 sc->sc_sensor[1].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[1].desc, "Vccp",
     sizeof(sc->sc_sensor[1].desc));

 sc->sc_sensor[2].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[2].desc, "Vcc",
     sizeof(sc->sc_sensor[2].desc));

 sc->sc_sensor[3].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[3].desc, "+5V",
     sizeof(sc->sc_sensor[3].desc));

 sc->sc_sensor[4].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[4].desc, "+12V",
     sizeof(sc->sc_sensor[4].desc));

 sc->sc_sensor[5].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[5].desc, "+Vtr",
     sizeof(sc->sc_sensor[5].desc));

 sc->sc_sensor[6].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[6].desc, "+Vbat",
     sizeof(sc->sc_sensor[6].desc));

 sc->sc_sensor[7].type = SENSOR_TEMP;
 strlcpy(sc->sc_sensor[7].desc, "Remote",
     sizeof(sc->sc_sensor[7].desc));

 sc->sc_sensor[8].type = SENSOR_TEMP;
 strlcpy(sc->sc_sensor[8].desc, "Internal",
     sizeof(sc->sc_sensor[8].desc));

 sc->sc_sensor[9].type = SENSOR_TEMP;
 strlcpy(sc->sc_sensor[9].desc, "Remote",
     sizeof(sc->sc_sensor[9].desc));

 sc->sc_sensor[10].type = SENSOR_FANRPM;
 sc->sc_sensor[11].type = SENSOR_FANRPM;
 sc->sc_sensor[12].type = SENSOR_FANRPM;
 sc->sc_sensor[13].type = SENSOR_FANRPM;
 sc->sc_sensor[14].type = SENSOR_FANRPM;
 sc->sc_sensor[15].type = SENSOR_FANRPM;

 if (sensor_task_register(sc, adt_refresh, 5) == ((void *)0)) {
...
adt_refresh(void *arg)
{
 ...
 for (i = 0; i < sizeof worklist / sizeof(worklist[0]); i++) {
  ...
  case 2:
   if (sc->chip->vcc && (sc->sc_conf & 0x80))
    ratio = sc->chip->vcc;
