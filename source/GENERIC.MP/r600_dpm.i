...
u32 r600_dpm_get_vblank_time(struct radeon_device *rdev)
{
 ...
 if (rdev->num_crtc && rdev->mode_info.mode_config_initialized) {
  for (crtc = ({ const __typeof( ((__typeof(*crtc) *)0)->head ) *__mptr = ((&dev->mode_config.crtc_list)->next); (__typeof(*crtc) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtc), head) );}); &crtc->head != (&dev->mode_config.crtc_list); crtc = ({ const __typeof( ((__typeof(*crtc) *)0)->head ) *__mptr = (crtc->head.next); (__typeof(*crtc) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtc), head) );})) {
   radeon_crtc = ({ const __typeof( ((struct radeon_crtc *)0)->base ) *__mptr = (crtc); (struct radeon_crtc *)( (char *)__mptr - __builtin_offsetof(struct radeon_crtc, base) );});
...
void r600_gfx_clockgating_enable(struct radeon_device *rdev, _Bool enable)
{
 int i;
 if (enable) {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x620), 0); tmp_ &= (~(1 << 10)); tmp_ |= (((1 << 10)) & ~(~(1 << 10))); r100_mm_wreg(rdev, (0x620), (tmp_), 0); } while (0);
 } else {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x620), 0); tmp_ &= (~(1 << 10)); tmp_ |= ((0) & ~(~(1 << 10))); r100_mm_wreg(rdev, (0x620), (tmp_), 0); } while (0);
  r100_mm_wreg(rdev, (0x7c4), (0x2), 0);
  for (i = 0; i < rdev->usec_timeout; i++) {
   if (((r100_mm_rreg(rdev, (0x7c4), 0) & 0xf0) >> 4) == 1)
    break;
   udelay(1);
  }
  r100_mm_wreg(rdev, (0x7c4), (0x0), 0);
  r100_mm_wreg(rdev, (0x800c), (0x1), 0);
  r100_mm_rreg(rdev, (0x800c), 0);
 }
}
void r600_dynamicpm_enable(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x618), 0); tmp_ &= (~(1 << 0)); tmp_ |= (((1 << 0)) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x618), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x618), 0); tmp_ &= (~(1 << 0)); tmp_ |= ((0) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x618), (tmp_), 0); } while (0);
}
void r600_enable_thermal_protection(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x618), 0); tmp_ &= (~(1 << 3)); tmp_ |= ((0) & ~(~(1 << 3))); r100_mm_wreg(rdev, (0x618), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x618), 0); tmp_ &= (~(1 << 3)); tmp_ |= (((1 << 3)) & ~(~(1 << 3))); r100_mm_wreg(rdev, (0x618), (tmp_), 0); } while (0);
}
void r600_enable_acpi_pm(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x618), 0); tmp_ &= (~(1 << 1)); tmp_ |= (((1 << 1)) & ~(~(1 << 1))); r100_mm_wreg(rdev, (0x618), (tmp_), 0); } while (0);
}
void r600_enable_dynamic_pcie_gen2(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x618), 0); tmp_ &= (~(1 << 5)); tmp_ |= (((1 << 5)) & ~(~(1 << 5))); r100_mm_wreg(rdev, (0x618), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x618), 0); tmp_ &= (~(1 << 5)); tmp_ |= ((0) & ~(~(1 << 5))); r100_mm_wreg(rdev, (0x618), (tmp_), 0); } while (0);
}
_Bool r600_dynamicpm_enabled(struct radeon_device *rdev)
{
 if (r100_mm_rreg(rdev, (0x618), 0) & (1 << 0))
  return 1;
 else
  return 0;
}
...
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x620), 0); tmp_ &= (~(1 << 0)); tmp_ |= ((0) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x620), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x620), 0); tmp_ &= (~(1 << 0)); tmp_ |= (((1 << 0)) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x620), (tmp_), 0); } while (0);
}
void r600_enable_mclk_control(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x624), 0); tmp_ &= (~(1 << 0)); tmp_ |= ((0) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x624), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x624), 0); tmp_ &= (~(1 << 0)); tmp_ |= (((1 << 0)) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x624), (tmp_), 0); } while (0);
}
void r600_enable_spll_bypass(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x600), 0); tmp_ &= (~(1 << 25)); tmp_ |= (((1 << 25)) & ~(~(1 << 25))); r100_mm_wreg(rdev, (0x600), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x600), 0); tmp_ &= (~(1 << 25)); tmp_ |= ((0) & ~(~(1 << 25))); r100_mm_wreg(rdev, (0x600), (tmp_), 0); } while (0);
}
void r600_wait_for_spll_change(struct radeon_device *rdev)
{
 int i;
 for (i = 0; i < rdev->usec_timeout; i++) {
  if (r100_mm_rreg(rdev, (0x600), 0) & (1 << 29))
   break;
  udelay(1);
 }
}
void r600_set_bsp(struct radeon_device *rdev, u32 u, u32 p)
{
 r100_mm_wreg(rdev, (0x78c), (((p) << 0) | ((u) << 16)), 0);
}
void r600_set_at(struct radeon_device *rdev,
   u32 l_to_m, u32 m_to_h,
   u32 h_to_m, u32 m_to_l)
{
 r100_mm_wreg(rdev, (0x790), (((l_to_m) << 0) | ((m_to_h) << 16)), 0);
 r100_mm_wreg(rdev, (0x794), (((h_to_m) << 0) | ((m_to_l) << 16)), 0);
}
void r600_set_tc(struct radeon_device *rdev,
   u32 index, u32 u_t, u32 d_t)
{
 r100_mm_wreg(rdev, (0x750 + (index * 4)), (((u_t) << 0) | ((d_t) << 10)), 0);
}
void r600_select_td(struct radeon_device *rdev,
      enum r600_td td)
{
 if (td == R600_TD_AUTO)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x620), 0); tmp_ &= (~(1 << 8)); tmp_ |= ((0) & ~(~(1 << 8))); r100_mm_wreg(rdev, (0x620), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x620), 0); tmp_ &= (~(1 << 8)); tmp_ |= (((1 << 8)) & ~(~(1 << 8))); r100_mm_wreg(rdev, (0x620), (tmp_), 0); } while (0);
 if (td == R600_TD_UP)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x620), 0); tmp_ &= (~(1 << 9)); tmp_ |= ((0) & ~(~(1 << 9))); r100_mm_wreg(rdev, (0x620), (tmp_), 0); } while (0);
 if (td == R600_TD_DOWN)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x620), 0); tmp_ &= (~(1 << 9)); tmp_ |= (((1 << 9)) & ~(~(1 << 9))); r100_mm_wreg(rdev, (0x620), (tmp_), 0); } while (0);
}
void r600_set_vrc(struct radeon_device *rdev, u32 vrv)
{
 r100_mm_wreg(rdev, (0x74c), (vrv), 0);
}
void r600_set_tpu(struct radeon_device *rdev, u32 u)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x61c), 0); tmp_ &= (~(0x1f << 23)); tmp_ |= ((((u) << 23)) & ~(~(0x1f << 23))); r100_mm_wreg(rdev, (0x61c), (tmp_), 0); } while (0);
}
void r600_set_tpc(struct radeon_device *rdev, u32 c)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x61c), 0); tmp_ &= (~(0x7fffff << 0)); tmp_ |= ((((c) << 0)) & ~(~(0x7fffff << 0))); r100_mm_wreg(rdev, (0x61c), (tmp_), 0); } while (0);
}
void r600_set_sstu(struct radeon_device *rdev, u32 u)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7a8), 0); tmp_ &= (~(0xf << 16)); tmp_ |= ((((u) << 16)) & ~(~(0xf << 16))); r100_mm_wreg(rdev, (0x7a8), (tmp_), 0); } while (0);
}
void r600_set_sst(struct radeon_device *rdev, u32 t)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7a8), 0); tmp_ &= (~(0xffff << 0)); tmp_ |= ((((t) << 0)) & ~(~(0xffff << 0))); r100_mm_wreg(rdev, (0x7a8), (tmp_), 0); } while (0);
}
void r600_set_git(struct radeon_device *rdev, u32 t)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x798), 0); tmp_ &= (~(0xffff << 0)); tmp_ |= ((((t) << 0)) & ~(~(0xffff << 0))); r100_mm_wreg(rdev, (0x798), (tmp_), 0); } while (0);
}
void r600_set_fctu(struct radeon_device *rdev, u32 u)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7cc), 0); tmp_ &= (~(0x1f << 16)); tmp_ |= ((((u) << 16)) & ~(~(0x1f << 16))); r100_mm_wreg(rdev, (0x7cc), (tmp_), 0); } while (0);
}
void r600_set_fct(struct radeon_device *rdev, u32 t)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7cc), 0); tmp_ &= (~(0xffff << 0)); tmp_ |= ((((t) << 0)) & ~(~(0xffff << 0))); r100_mm_wreg(rdev, (0x7cc), (tmp_), 0); } while (0);
}
void r600_set_ctxcgtt3d_rphc(struct radeon_device *rdev, u32 p)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x744), 0); tmp_ &= (~(0x1ff << 0)); tmp_ |= ((((p) << 0)) & ~(~(0x1ff << 0))); r100_mm_wreg(rdev, (0x744), (tmp_), 0); } while (0);
}
void r600_set_ctxcgtt3d_rsdc(struct radeon_device *rdev, u32 s)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x744), 0); tmp_ &= (~(0x3fff << 9)); tmp_ |= ((((s) << 9)) & ~(~(0x3fff << 9))); r100_mm_wreg(rdev, (0x744), (tmp_), 0); } while (0);
}
void r600_set_vddc3d_oorsu(struct radeon_device *rdev, u32 u)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x748), 0); tmp_ &= (~(0xf << 23)); tmp_ |= ((((u) << 23)) & ~(~(0xf << 23))); r100_mm_wreg(rdev, (0x748), (tmp_), 0); } while (0);
}
void r600_set_vddc3d_oorphc(struct radeon_device *rdev, u32 p)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x748), 0); tmp_ &= (~(0x1ff << 0)); tmp_ |= ((((p) << 0)) & ~(~(0x1ff << 0))); r100_mm_wreg(rdev, (0x748), (tmp_), 0); } while (0);
}
void r600_set_vddc3d_oorsdc(struct radeon_device *rdev, u32 s)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x748), 0); tmp_ &= (~(0x3fff << 9)); tmp_ |= ((((s) << 9)) & ~(~(0x3fff << 9))); r100_mm_wreg(rdev, (0x748), (tmp_), 0); } while (0);
}
void r600_set_mpll_lock_time(struct radeon_device *rdev, u32 lock_time)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x634), 0); tmp_ &= (~(0xffff << 0)); tmp_ |= ((((lock_time) << 0)) & ~(~(0xffff << 0))); r100_mm_wreg(rdev, (0x634), (tmp_), 0); } while (0);
}
void r600_set_mpll_reset_time(struct radeon_device *rdev, u32 reset_time)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x634), 0); tmp_ &= (~(0xffff << 16)); tmp_ |= ((((reset_time) << 16)) & ~(~(0xffff << 16))); r100_mm_wreg(rdev, (0x634), (tmp_), 0); } while (0);
}
void r600_engine_clock_entry_enable(struct radeon_device *rdev,
        u32 index, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x64c + (index * 4 * 2)), 0); tmp_ &= (~(1 << 31)); tmp_ |= (((1 << 31)) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x64c + (index * 4 * 2)), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x64c + (index * 4 * 2)), 0); tmp_ &= (~(1 << 31)); tmp_ |= ((0) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x64c + (index * 4 * 2)), (tmp_), 0); } while (0);
}
void r600_engine_clock_entry_enable_pulse_skipping(struct radeon_device *rdev,
         u32 index, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x64c + (index * 4 * 2)), 0); tmp_ &= (~(1 << 30)); tmp_ |= (((1 << 30)) & ~(~(1 << 30))); r100_mm_wreg(rdev, (0x64c + (index * 4 * 2)), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x64c + (index * 4 * 2)), 0); tmp_ &= (~(1 << 30)); tmp_ |= ((0) & ~(~(1 << 30))); r100_mm_wreg(rdev, (0x64c + (index * 4 * 2)), (tmp_), 0); } while (0);
}
void r600_engine_clock_entry_enable_post_divider(struct radeon_device *rdev,
       u32 index, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x64c + (index * 4 * 2)), 0); tmp_ &= (~(1 << 9)); tmp_ |= (((1 << 9)) & ~(~(1 << 9))); r100_mm_wreg(rdev, (0x64c + (index * 4 * 2)), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x64c + (index * 4 * 2)), 0); tmp_ &= (~(1 << 9)); tmp_ |= ((0) & ~(~(1 << 9))); r100_mm_wreg(rdev, (0x64c + (index * 4 * 2)), (tmp_), 0); } while (0);
}
void r600_engine_clock_entry_set_post_divider(struct radeon_device *rdev,
           u32 index, u32 divider)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x648 + (index * 4 * 2)), 0); tmp_ &= (~(0xff << 0)); tmp_ |= ((((divider) << 0)) & ~(~(0xff << 0))); r100_mm_wreg(rdev, (0x648 + (index * 4 * 2)), (tmp_), 0); } while (0);
}
void r600_engine_clock_entry_set_reference_divider(struct radeon_device *rdev,
         u32 index, u32 divider)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x648 + (index * 4 * 2)), 0); tmp_ &= (~(7 << 16)); tmp_ |= ((((divider) << 16)) & ~(~(7 << 16))); r100_mm_wreg(rdev, (0x648 + (index * 4 * 2)), (tmp_), 0); } while (0);
}
void r600_engine_clock_entry_set_feedback_divider(struct radeon_device *rdev,
        u32 index, u32 divider)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x648 + (index * 4 * 2)), 0); tmp_ &= (~(0xff << 8)); tmp_ |= ((((divider) << 8)) & ~(~(0xff << 8))); r100_mm_wreg(rdev, (0x648 + (index * 4 * 2)), (tmp_), 0); } while (0);
}
void r600_engine_clock_entry_set_step_time(struct radeon_device *rdev,
        u32 index, u32 step_time)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x648 + (index * 4 * 2)), 0); tmp_ &= (~(0x1fff << 19)); tmp_ |= ((((step_time) << 19)) & ~(~(0x1fff << 19))); r100_mm_wreg(rdev, (0x648 + (index * 4 * 2)), (tmp_), 0); } while (0);
}
void r600_vid_rt_set_ssu(struct radeon_device *rdev, u32 u)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6f8), 0); tmp_ &= (~(7 << 16)); tmp_ |= ((((u) << 16)) & ~(~(7 << 16))); r100_mm_wreg(rdev, (0x6f8), (tmp_), 0); } while (0);
}
void r600_vid_rt_set_vru(struct radeon_device *rdev, u32 u)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6f8), 0); tmp_ &= (~(7 << 13)); tmp_ |= ((((u) << 13)) & ~(~(7 << 13))); r100_mm_wreg(rdev, (0x6f8), (tmp_), 0); } while (0);
}
void r600_vid_rt_set_vrt(struct radeon_device *rdev, u32 rt)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6f8), 0); tmp_ &= (~(0x1fff << 0)); tmp_ |= ((((rt) << 0)) & ~(~(0x1fff << 0))); r100_mm_wreg(rdev, (0x6f8), (tmp_), 0); } while (0);
}
void r600_voltage_control_enable_pins(struct radeon_device *rdev,
          u64 mask)
{
 r100_mm_wreg(rdev, (0x710), (mask & 0xffffffff), 0);
 r100_mm_wreg(rdev, (0x714), (((u32)(((mask) >> 16) >> 16))), 0);
}
void r600_voltage_control_program_voltages(struct radeon_device *rdev,
        enum r600_power_level index, u64 pins)
{
 u32 tmp, mask;
 u32 ix = 3 - (3 & index);
 r100_mm_wreg(rdev, (0x718 + (ix * 4)), (pins & 0xffffffff), 0);
 mask = 7 << (3 * ix);
 tmp = r100_mm_rreg(rdev, (0x740), 0);
 tmp = (tmp & ~mask) | ((pins >> (32 - (3 * ix))) & mask);
 r100_mm_wreg(rdev, (0x740), (tmp), 0);
}
void r600_voltage_control_deactivate_static_control(struct radeon_device *rdev,
          u64 mask)
{
 u32 gpio;
 gpio = r100_mm_rreg(rdev, (0x1798), 0);
 gpio &= ~mask;
 r100_mm_wreg(rdev, (0x1798), (gpio), 0);
 gpio = r100_mm_rreg(rdev, (0x17a0), 0);
 gpio &= ~mask;
 r100_mm_wreg(rdev, (0x17a0), (gpio), 0);
 gpio = r100_mm_rreg(rdev, (0x179c), 0);
 gpio &= ~mask;
 r100_mm_wreg(rdev, (0x179c), (gpio), 0);
}
void r600_power_level_enable(struct radeon_device *rdev,
        enum r600_power_level index, _Bool enable)
{
 u32 ix = 3 - (3 & index);
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6fc + (ix * 4)), 0); tmp_ &= (~(1 << 10)); tmp_ |= (((1 << 10)) & ~(~(1 << 10))); r100_mm_wreg(rdev, (0x6fc + (ix * 4)), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6fc + (ix * 4)), 0); tmp_ &= (~(1 << 10)); tmp_ |= ((0) & ~(~(1 << 10))); r100_mm_wreg(rdev, (0x6fc + (ix * 4)), (tmp_), 0); } while (0);
}
void r600_power_level_set_voltage_index(struct radeon_device *rdev,
     enum r600_power_level index, u32 voltage_index)
{
 u32 ix = 3 - (3 & index);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6fc + (ix * 4)), 0); tmp_ &= (~(3 << 0)); tmp_ |= ((((voltage_index) << 0)) & ~(~(3 << 0))); r100_mm_wreg(rdev, (0x6fc + (ix * 4)), (tmp_), 0); } while (0);
}
void r600_power_level_set_mem_clock_index(struct radeon_device *rdev,
       enum r600_power_level index, u32 mem_clock_index)
{
 u32 ix = 3 - (3 & index);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6fc + (ix * 4)), 0); tmp_ &= (~(3 << 2)); tmp_ |= ((((mem_clock_index) << 2)) & ~(~(3 << 2))); r100_mm_wreg(rdev, (0x6fc + (ix * 4)), (tmp_), 0); } while (0);
}
void r600_power_level_set_eng_clock_index(struct radeon_device *rdev,
       enum r600_power_level index, u32 eng_clock_index)
{
 u32 ix = 3 - (3 & index);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6fc + (ix * 4)), 0); tmp_ &= (~(0x1f << 4)); tmp_ |= ((((eng_clock_index) << 4)) & ~(~(0x1f << 4))); r100_mm_wreg(rdev, (0x6fc + (ix * 4)), (tmp_), 0); } while (0);
}
void r600_power_level_set_watermark_id(struct radeon_device *rdev,
           enum r600_power_level index,
           enum r600_display_watermark watermark_id)
{
 ...
 if (watermark_id == R600_DISPLAY_WATERMARK_HIGH)
  tmp = (1 << 11);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6fc + (ix * 4)), 0); tmp_ &= (~(1 << 11)); tmp_ |= ((tmp) & ~(~(1 << 11))); r100_mm_wreg(rdev, (0x6fc + (ix * 4)), (tmp_), 0); } while (0);
}
void r600_power_level_set_pcie_gen2(struct radeon_device *rdev,
        enum r600_power_level index, _Bool compatible)
{
 ...
 if (compatible)
  tmp = (1 << 12);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x6fc + (ix * 4)), 0); tmp_ &= (~(1 << 12)); tmp_ |= ((tmp) & ~(~(1 << 12))); r100_mm_wreg(rdev, (0x6fc + (ix * 4)), (tmp_), 0); } while (0);
}
enum r600_power_level r600_power_level_get_current_index(struct radeon_device *rdev)
{
 u32 tmp;
 tmp = r100_mm_rreg(rdev, (0x70c), 0) & (3 << 2);
 tmp >>= 2;
 return tmp;
}
enum r600_power_level r600_power_level_get_target_index(struct radeon_device *rdev)
{
 u32 tmp;
 tmp = r100_mm_rreg(rdev, (0x70c), 0) & (3 << 0);
 tmp >>= 0;
 return tmp;
}
void r600_power_level_set_enter_index(struct radeon_device *rdev,
          enum r600_power_level index)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x70c), 0); tmp_ &= (~(3 << 4)); tmp_ |= ((((index) << 4)) & ~(~(3 << 4))); r100_mm_wreg(rdev, (0x70c), (tmp_), 0); } while (0);
}
void r600_wait_for_power_level_unequal(struct radeon_device *rdev,
           enum r600_power_level index)
{
...
void r600_start_dpm(struct radeon_device *rdev)
{
 ...
 (rdev)->asic->display.wait_for_vblank((rdev), (0));
 (rdev)->asic->display.wait_for_vblank((rdev), (1));
           ...
           int min_temp, int max_temp)
{
 ...
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7F8), 0); tmp_ &= (~0x0000FF00); tmp_ |= ((((high_temp / 1000) << 8)) & ~(~0x0000FF00)); r100_mm_wreg(rdev, (0x7F8), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7F8), 0); tmp_ &= (~0x00FF0000); tmp_ |= ((((low_temp / 1000) << 16)) & ~(~0x00FF0000)); r100_mm_wreg(rdev, (0x7F8), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x7F0), 0); tmp_ &= (~0x000FF000); tmp_ |= ((((high_temp / 1000) << 12)) & ~(~0x000FF000)); r100_mm_wreg(rdev, (0x7F0), (tmp_), 0); } while (0);
...
int r600_dpm_late_enable(struct radeon_device *rdev)
{
 ...
 if (rdev->irq.installed &&
  ...
  ret = r600_set_thermal_temperature_range(rdev, (90 * 1000), (120 * 1000));
  if (ret)
   return ret;
  rdev->irq.dpm_thermal = 1;
  (rdev)->asic->irq.set((rdev));
 }
 return 0;
}
union power_info {
         ...
         ATOM_PPLIB_Clock_Voltage_Dependency_Table *atom_table)
{
 ...
 radeon_table->entries = kzalloc(size, (0x0001 | 0x0004));
 if (!radeon_table->entries)
  return -12;
 entry = &atom_table->entries[0];
 for (i = 0; i < atom_table->ucNumEntries; i++) {
  radeon_table->entries[i].clk = (__uint16_t)(__builtin_constant_p(entry->usClockLow) ? (__uint16_t)(((__uint16_t)(entry->usClockLow) & 0xffU) << 8 | ((__uint16_t)(entry->usClockLow) & 0xff00U) >> 8) : __swap16md(entry->usClockLow)) |
   (entry->ucClockHigh << 16);
  radeon_table->entries[i].v = (__uint16_t)(__builtin_constant_p(entry->usVoltage) ? (__uint16_t)(((__uint16_t)(entry->usVoltage) & 0xffU) << 8 | ((__uint16_t)(entry->usVoltage) & 0xff00U) >> 8) : __swap16md(entry->usVoltage));
...
int r600_get_platform_caps(struct radeon_device *rdev)
{
 ...
 rdev->pm.dpm.platform_caps = (__uint32_t)(__builtin_constant_p(power_info->pplib.ulPlatformCaps) ? (__uint32_t)(((__uint32_t)(power_info->pplib.ulPlatformCaps) & 0xff) << 24 | ((__uint32_t)(power_info->pplib.ulPlatformCaps) & 0xff00) << 8 | ((__uint32_t)(power_info->pplib.ulPlatformCaps) & 0xff0000) >> 8 | ((__uint32_t)(power_info->pplib.ulPlatformCaps) & 0xff000000) >> 24) : __swap32md(power_info->pplib.ulPlatformCaps));
 rdev->pm.dpm.backbias_response_time = (__uint16_t)(__builtin_constant_p(power_info->pplib.usBackbiasTime) ? (__uint16_t)(((__uint16_t)(power_info->pplib.usBackbiasTime) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib.usBackbiasTime) & 0xff00U) >> 8) : __swap16md(power_info->pplib.usBackbiasTime));
 rdev->pm.dpm.voltage_response_time = (__uint16_t)(__builtin_constant_p(power_info->pplib.usVoltageTime) ? (__uint16_t)(((__uint16_t)(power_info->pplib.usVoltageTime) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib.usVoltageTime) & 0xff00U) >> 8) : __swap16md(power_info->pplib.usVoltageTime));
 return 0;
}
int r600_parse_extended_power_table(struct radeon_device *rdev)
{
 ...
 if (!atom_parse_data_header(mode_info->atom_context, index, ((void *)0),
  ...
  return -22;
 power_info = (union power_info *)(mode_info->atom_context->bios + data_offset);
 if ((__uint16_t)(__builtin_constant_p(power_info->pplib.usTableSize) ? (__uint16_t)(((__uint16_t)(power_info->pplib.usTableSize) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib.usTableSize) & 0xff00U) >> 8) : __swap16md(power_info->pplib.usTableSize)) >=
     sizeof(struct _ATOM_PPLIB_POWERPLAYTABLE3)) {
  if (power_info->pplib3.usFanTableOffset) {
   fan_info = (union fan_info *)(mode_info->atom_context->bios + data_offset +
            (__uint16_t)(__builtin_constant_p(power_info->pplib3.usFanTableOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib3.usFanTableOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib3.usFanTableOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib3.usFanTableOffset)));
   rdev->pm.dpm.fan.t_hyst = fan_info->fan.ucTHyst;
   rdev->pm.dpm.fan.t_min = (__uint16_t)(__builtin_constant_p(fan_info->fan.usTMin) ? (__uint16_t)(((__uint16_t)(fan_info->fan.usTMin) & 0xffU) << 8 | ((__uint16_t)(fan_info->fan.usTMin) & 0xff00U) >> 8) : __swap16md(fan_info->fan.usTMin));
   rdev->pm.dpm.fan.t_med = (__uint16_t)(__builtin_constant_p(fan_info->fan.usTMed) ? (__uint16_t)(((__uint16_t)(fan_info->fan.usTMed) & 0xffU) << 8 | ((__uint16_t)(fan_info->fan.usTMed) & 0xff00U) >> 8) : __swap16md(fan_info->fan.usTMed));
   rdev->pm.dpm.fan.t_high = (__uint16_t)(__builtin_constant_p(fan_info->fan.usTHigh) ? (__uint16_t)(((__uint16_t)(fan_info->fan.usTHigh) & 0xffU) << 8 | ((__uint16_t)(fan_info->fan.usTHigh) & 0xff00U) >> 8) : __swap16md(fan_info->fan.usTHigh));
   rdev->pm.dpm.fan.pwm_min = (__uint16_t)(__builtin_constant_p(fan_info->fan.usPWMMin) ? (__uint16_t)(((__uint16_t)(fan_info->fan.usPWMMin) & 0xffU) << 8 | ((__uint16_t)(fan_info->fan.usPWMMin) & 0xff00U) >> 8) : __swap16md(fan_info->fan.usPWMMin));
   rdev->pm.dpm.fan.pwm_med = (__uint16_t)(__builtin_constant_p(fan_info->fan.usPWMMed) ? (__uint16_t)(((__uint16_t)(fan_info->fan.usPWMMed) & 0xffU) << 8 | ((__uint16_t)(fan_info->fan.usPWMMed) & 0xff00U) >> 8) : __swap16md(fan_info->fan.usPWMMed));
   rdev->pm.dpm.fan.pwm_high = (__uint16_t)(__builtin_constant_p(fan_info->fan.usPWMHigh) ? (__uint16_t)(((__uint16_t)(fan_info->fan.usPWMHigh) & 0xffU) << 8 | ((__uint16_t)(fan_info->fan.usPWMHigh) & 0xff00U) >> 8) : __swap16md(fan_info->fan.usPWMHigh));
   if (fan_info->fan.ucFanTableFormat >= 2)
    rdev->pm.dpm.fan.t_max = (__uint16_t)(__builtin_constant_p(fan_info->fan2.usTMax) ? (__uint16_t)(((__uint16_t)(fan_info->fan2.usTMax) & 0xffU) << 8 | ((__uint16_t)(fan_info->fan2.usTMax) & 0xff00U) >> 8) : __swap16md(fan_info->fan2.usTMax));
   else
   ...
   if (fan_info->fan.ucFanTableFormat >= 3) {
    ...
    rdev->pm.dpm.fan.default_max_fan_pwm =
     (__uint16_t)(__builtin_constant_p(fan_info->fan3.usFanPWMMax) ? (__uint16_t)(((__uint16_t)(fan_info->fan3.usFanPWMMax) & 0xffU) << 8 | ((__uint16_t)(fan_info->fan3.usFanPWMMax) & 0xff00U) >> 8) : __swap16md(fan_info->fan3.usFanPWMMax));
    rdev->pm.dpm.fan.default_fan_output_sensitivity = 4836;
    rdev->pm.dpm.fan.fan_output_sensitivity =
     (__uint16_t)(__builtin_constant_p(fan_info->fan3.usFanOutputSensitivity) ? (__uint16_t)(((__uint16_t)(fan_info->fan3.usFanOutputSensitivity) & 0xffU) << 8 | ((__uint16_t)(fan_info->fan3.usFanOutputSensitivity) & 0xff00U) >> 8) : __swap16md(fan_info->fan3.usFanOutputSensitivity));
   }
 ...
 if ((__uint16_t)(__builtin_constant_p(power_info->pplib.usTableSize) ? (__uint16_t)(((__uint16_t)(power_info->pplib.usTableSize) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib.usTableSize) & 0xff00U) >> 8) : __swap16md(power_info->pplib.usTableSize)) >=
  ...
  if (power_info->pplib4.usVddcDependencyOnSCLKOffset) {
   dep_table = (ATOM_PPLIB_Clock_Voltage_Dependency_Table *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(power_info->pplib4.usVddcDependencyOnSCLKOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib4.usVddcDependencyOnSCLKOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib4.usVddcDependencyOnSCLKOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib4.usVddcDependencyOnSCLKOffset)));
  ...
  if (power_info->pplib4.usVddciDependencyOnMCLKOffset) {
   dep_table = (ATOM_PPLIB_Clock_Voltage_Dependency_Table *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(power_info->pplib4.usVddciDependencyOnMCLKOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib4.usVddciDependencyOnMCLKOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib4.usVddciDependencyOnMCLKOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib4.usVddciDependencyOnMCLKOffset)));
  ...
  if (power_info->pplib4.usVddcDependencyOnMCLKOffset) {
   dep_table = (ATOM_PPLIB_Clock_Voltage_Dependency_Table *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(power_info->pplib4.usVddcDependencyOnMCLKOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib4.usVddcDependencyOnMCLKOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib4.usVddcDependencyOnMCLKOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib4.usVddcDependencyOnMCLKOffset)));
  ...
  if (power_info->pplib4.usMvddDependencyOnMCLKOffset) {
   dep_table = (ATOM_PPLIB_Clock_Voltage_Dependency_Table *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(power_info->pplib4.usMvddDependencyOnMCLKOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib4.usMvddDependencyOnMCLKOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib4.usMvddDependencyOnMCLKOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib4.usMvddDependencyOnMCLKOffset)));
  ...
  if (power_info->pplib4.usMaxClockVoltageOnDCOffset) {
   ATOM_PPLIB_Clock_Voltage_Limit_Table *clk_v =
    (ATOM_PPLIB_Clock_Voltage_Limit_Table *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(power_info->pplib4.usMaxClockVoltageOnDCOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib4.usMaxClockVoltageOnDCOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib4.usMaxClockVoltageOnDCOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib4.usMaxClockVoltageOnDCOffset)));
   if (clk_v->ucNumEntries) {
    rdev->pm.dpm.dyn_state.max_clock_voltage_on_dc.sclk =
     (__uint16_t)(__builtin_constant_p(clk_v->entries[0].usSclkLow) ? (__uint16_t)(((__uint16_t)(clk_v->entries[0].usSclkLow) & 0xffU) << 8 | ((__uint16_t)(clk_v->entries[0].usSclkLow) & 0xff00U) >> 8) : __swap16md(clk_v->entries[0].usSclkLow)) |
     (clk_v->entries[0].ucSclkHigh << 16);
    rdev->pm.dpm.dyn_state.max_clock_voltage_on_dc.mclk =
     (__uint16_t)(__builtin_constant_p(clk_v->entries[0].usMclkLow) ? (__uint16_t)(((__uint16_t)(clk_v->entries[0].usMclkLow) & 0xffU) << 8 | ((__uint16_t)(clk_v->entries[0].usMclkLow) & 0xff00U) >> 8) : __swap16md(clk_v->entries[0].usMclkLow)) |
     (clk_v->entries[0].ucMclkHigh << 16);
    rdev->pm.dpm.dyn_state.max_clock_voltage_on_dc.vddc =
     (__uint16_t)(__builtin_constant_p(clk_v->entries[0].usVddc) ? (__uint16_t)(((__uint16_t)(clk_v->entries[0].usVddc) & 0xffU) << 8 | ((__uint16_t)(clk_v->entries[0].usVddc) & 0xff00U) >> 8) : __swap16md(clk_v->entries[0].usVddc));
    rdev->pm.dpm.dyn_state.max_clock_voltage_on_dc.vddci =
     (__uint16_t)(__builtin_constant_p(clk_v->entries[0].usVddci) ? (__uint16_t)(((__uint16_t)(clk_v->entries[0].usVddci) & 0xffU) << 8 | ((__uint16_t)(clk_v->entries[0].usVddci) & 0xff00U) >> 8) : __swap16md(clk_v->entries[0].usVddci));
   }
  }
  if (power_info->pplib4.usVddcPhaseShedLimitsTableOffset) {
   ATOM_PPLIB_PhaseSheddingLimits_Table *psl =
    (ATOM_PPLIB_PhaseSheddingLimits_Table *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(power_info->pplib4.usVddcPhaseShedLimitsTableOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib4.usVddcPhaseShedLimitsTableOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib4.usVddcPhaseShedLimitsTableOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib4.usVddcPhaseShedLimitsTableOffset)));
   ...
   for (i = 0; i < psl->ucNumEntries; i++) {
    rdev->pm.dpm.dyn_state.phase_shedding_limits_table.entries[i].sclk =
     (__uint16_t)(__builtin_constant_p(entry->usSclkLow) ? (__uint16_t)(((__uint16_t)(entry->usSclkLow) & 0xffU) << 8 | ((__uint16_t)(entry->usSclkLow) & 0xff00U) >> 8) : __swap16md(entry->usSclkLow)) | (entry->ucSclkHigh << 16);
    rdev->pm.dpm.dyn_state.phase_shedding_limits_table.entries[i].mclk =
     (__uint16_t)(__builtin_constant_p(entry->usMclkLow) ? (__uint16_t)(((__uint16_t)(entry->usMclkLow) & 0xffU) << 8 | ((__uint16_t)(entry->usMclkLow) & 0xff00U) >> 8) : __swap16md(entry->usMclkLow)) | (entry->ucMclkHigh << 16);
    rdev->pm.dpm.dyn_state.phase_shedding_limits_table.entries[i].voltage =
     (__uint16_t)(__builtin_constant_p(entry->usVoltage) ? (__uint16_t)(((__uint16_t)(entry->usVoltage) & 0xffU) << 8 | ((__uint16_t)(entry->usVoltage) & 0xff00U) >> 8) : __swap16md(entry->usVoltage));
 ...
 if ((__uint16_t)(__builtin_constant_p(power_info->pplib.usTableSize) ? (__uint16_t)(((__uint16_t)(power_info->pplib.usTableSize) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib.usTableSize) & 0xff00U) >> 8) : __swap16md(power_info->pplib.usTableSize)) >=
  ...
  rdev->pm.dpm.tdp_limit = (__uint32_t)(__builtin_constant_p(power_info->pplib5.ulTDPLimit) ? (__uint32_t)(((__uint32_t)(power_info->pplib5.ulTDPLimit) & 0xff) << 24 | ((__uint32_t)(power_info->pplib5.ulTDPLimit) & 0xff00) << 8 | ((__uint32_t)(power_info->pplib5.ulTDPLimit) & 0xff0000) >> 8 | ((__uint32_t)(power_info->pplib5.ulTDPLimit) & 0xff000000) >> 24) : __swap32md(power_info->pplib5.ulTDPLimit));
  rdev->pm.dpm.near_tdp_limit = (__uint32_t)(__builtin_constant_p(power_info->pplib5.ulNearTDPLimit) ? (__uint32_t)(((__uint32_t)(power_info->pplib5.ulNearTDPLimit) & 0xff) << 24 | ((__uint32_t)(power_info->pplib5.ulNearTDPLimit) & 0xff00) << 8 | ((__uint32_t)(power_info->pplib5.ulNearTDPLimit) & 0xff0000) >> 8 | ((__uint32_t)(power_info->pplib5.ulNearTDPLimit) & 0xff000000) >> 24) : __swap32md(power_info->pplib5.ulNearTDPLimit));
  rdev->pm.dpm.near_tdp_limit_adjusted = rdev->pm.dpm.near_tdp_limit;
  rdev->pm.dpm.tdp_od_limit = (__uint16_t)(__builtin_constant_p(power_info->pplib5.usTDPODLimit) ? (__uint16_t)(((__uint16_t)(power_info->pplib5.usTDPODLimit) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib5.usTDPODLimit) & 0xff00U) >> 8) : __swap16md(power_info->pplib5.usTDPODLimit));
  if (rdev->pm.dpm.tdp_od_limit)
   rdev->pm.dpm.power_control = 1;
  else
   rdev->pm.dpm.power_control = 0;
  rdev->pm.dpm.tdp_adjustment = 0;
  rdev->pm.dpm.sq_ramping_threshold = (__uint32_t)(__builtin_constant_p(power_info->pplib5.ulSQRampingThreshold) ? (__uint32_t)(((__uint32_t)(power_info->pplib5.ulSQRampingThreshold) & 0xff) << 24 | ((__uint32_t)(power_info->pplib5.ulSQRampingThreshold) & 0xff00) << 8 | ((__uint32_t)(power_info->pplib5.ulSQRampingThreshold) & 0xff0000) >> 8 | ((__uint32_t)(power_info->pplib5.ulSQRampingThreshold) & 0xff000000) >> 24) : __swap32md(power_info->pplib5.ulSQRampingThreshold));
  rdev->pm.dpm.cac_leakage = (__uint32_t)(__builtin_constant_p(power_info->pplib5.ulCACLeakage) ? (__uint32_t)(((__uint32_t)(power_info->pplib5.ulCACLeakage) & 0xff) << 24 | ((__uint32_t)(power_info->pplib5.ulCACLeakage) & 0xff00) << 8 | ((__uint32_t)(power_info->pplib5.ulCACLeakage) & 0xff0000) >> 8 | ((__uint32_t)(power_info->pplib5.ulCACLeakage) & 0xff000000) >> 24) : __swap32md(power_info->pplib5.ulCACLeakage));
  rdev->pm.dpm.load_line_slope = (__uint16_t)(__builtin_constant_p(power_info->pplib5.usLoadLineSlope) ? (__uint16_t)(((__uint16_t)(power_info->pplib5.usLoadLineSlope) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib5.usLoadLineSlope) & 0xff00U) >> 8) : __swap16md(power_info->pplib5.usLoadLineSlope));
  if (power_info->pplib5.usCACLeakageTableOffset) {
   ATOM_PPLIB_CAC_Leakage_Table *cac_table =
    (ATOM_PPLIB_CAC_Leakage_Table *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(power_info->pplib5.usCACLeakageTableOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib5.usCACLeakageTableOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib5.usCACLeakageTableOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib5.usCACLeakageTableOffset)));
   ATOM_PPLIB_CAC_Leakage_Record *entry;
   u32 size = cac_table->ucNumEntries * sizeof(struct radeon_cac_leakage_table);
   rdev->pm.dpm.dyn_state.cac_leakage_table.entries = kzalloc(size, (0x0001 | 0x0004));
   ...
   for (i = 0; i < cac_table->ucNumEntries; i++) {
    if (rdev->pm.dpm.platform_caps & 0x00800000) {
     rdev->pm.dpm.dyn_state.cac_leakage_table.entries[i].vddc1 =
      (__uint16_t)(__builtin_constant_p(entry->usVddc1) ? (__uint16_t)(((__uint16_t)(entry->usVddc1) & 0xffU) << 8 | ((__uint16_t)(entry->usVddc1) & 0xff00U) >> 8) : __swap16md(entry->usVddc1));
     rdev->pm.dpm.dyn_state.cac_leakage_table.entries[i].vddc2 =
      (__uint16_t)(__builtin_constant_p(entry->usVddc2) ? (__uint16_t)(((__uint16_t)(entry->usVddc2) & 0xffU) << 8 | ((__uint16_t)(entry->usVddc2) & 0xff00U) >> 8) : __swap16md(entry->usVddc2));
     rdev->pm.dpm.dyn_state.cac_leakage_table.entries[i].vddc3 =
      (__uint16_t)(__builtin_constant_p(entry->usVddc3) ? (__uint16_t)(((__uint16_t)(entry->usVddc3) & 0xffU) << 8 | ((__uint16_t)(entry->usVddc3) & 0xff00U) >> 8) : __swap16md(entry->usVddc3));
    } else {
     rdev->pm.dpm.dyn_state.cac_leakage_table.entries[i].vddc =
      (__uint16_t)(__builtin_constant_p(entry->usVddc) ? (__uint16_t)(((__uint16_t)(entry->usVddc) & 0xffU) << 8 | ((__uint16_t)(entry->usVddc) & 0xff00U) >> 8) : __swap16md(entry->usVddc));
     rdev->pm.dpm.dyn_state.cac_leakage_table.entries[i].leakage =
      (__uint32_t)(__builtin_constant_p(entry->ulLeakageValue) ? (__uint32_t)(((__uint32_t)(entry->ulLeakageValue) & 0xff) << 24 | ((__uint32_t)(entry->ulLeakageValue) & 0xff00) << 8 | ((__uint32_t)(entry->ulLeakageValue) & 0xff0000) >> 8 | ((__uint32_t)(entry->ulLeakageValue) & 0xff000000) >> 24) : __swap32md(entry->ulLeakageValue));
    }
 ...
 if ((__uint16_t)(__builtin_constant_p(power_info->pplib.usTableSize) ? (__uint16_t)(((__uint16_t)(power_info->pplib.usTableSize) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib.usTableSize) & 0xff00U) >> 8) : __swap16md(power_info->pplib.usTableSize)) >=
  ...
  ATOM_PPLIB_EXTENDEDHEADER *ext_hdr = (ATOM_PPLIB_EXTENDEDHEADER *)
   (mode_info->atom_context->bios + data_offset +
    (__uint16_t)(__builtin_constant_p(power_info->pplib3.usExtendendedHeaderOffset) ? (__uint16_t)(((__uint16_t)(power_info->pplib3.usExtendendedHeaderOffset) & 0xffU) << 8 | ((__uint16_t)(power_info->pplib3.usExtendendedHeaderOffset) & 0xff00U) >> 8) : __swap16md(power_info->pplib3.usExtendendedHeaderOffset)));
  if (((__uint16_t)(__builtin_constant_p(ext_hdr->usSize) ? (__uint16_t)(((__uint16_t)(ext_hdr->usSize) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usSize) & 0xff00U) >> 8) : __swap16md(ext_hdr->usSize)) >= 12) &&
   ext_hdr->usVCETableOffset) {
   VCEClockInfoArray *array = (VCEClockInfoArray *)
    (mode_info->atom_context->bios + data_offset +
                                 (__uint16_t)(__builtin_constant_p(ext_hdr->usVCETableOffset) ? (__uint16_t)(((__uint16_t)(ext_hdr->usVCETableOffset) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usVCETableOffset) & 0xff00U) >> 8) : __swap16md(ext_hdr->usVCETableOffset)) + 1);
   ...
   for (i = 0; i < limits->numEntries; i++) {
    ...
    rdev->pm.dpm.dyn_state.vce_clock_voltage_dependency_table.entries[i].evclk =
     (__uint16_t)(__builtin_constant_p(vce_clk->usEVClkLow) ? (__uint16_t)(((__uint16_t)(vce_clk->usEVClkLow) & 0xffU) << 8 | ((__uint16_t)(vce_clk->usEVClkLow) & 0xff00U) >> 8) : __swap16md(vce_clk->usEVClkLow)) | (vce_clk->ucEVClkHigh << 16);
    rdev->pm.dpm.dyn_state.vce_clock_voltage_dependency_table.entries[i].ecclk =
     (__uint16_t)(__builtin_constant_p(vce_clk->usECClkLow) ? (__uint16_t)(((__uint16_t)(vce_clk->usECClkLow) & 0xffU) << 8 | ((__uint16_t)(vce_clk->usECClkLow) & 0xff00U) >> 8) : __swap16md(vce_clk->usECClkLow)) | (vce_clk->ucECClkHigh << 16);
  ...
  if (((__uint16_t)(__builtin_constant_p(ext_hdr->usSize) ? (__uint16_t)(((__uint16_t)(ext_hdr->usSize) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usSize) & 0xff00U) >> 8) : __swap16md(ext_hdr->usSize)) >= 14) &&
   ext_hdr->usUVDTableOffset) {
   UVDClockInfoArray *array = (UVDClockInfoArray *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(ext_hdr->usUVDTableOffset) ? (__uint16_t)(((__uint16_t)(ext_hdr->usUVDTableOffset) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usUVDTableOffset) & 0xff00U) >> 8) : __swap16md(ext_hdr->usUVDTableOffset)) + 1);
   ...
   for (i = 0; i < limits->numEntries; i++) {
    ...
    rdev->pm.dpm.dyn_state.uvd_clock_voltage_dependency_table.entries[i].vclk =
     (__uint16_t)(__builtin_constant_p(uvd_clk->usVClkLow) ? (__uint16_t)(((__uint16_t)(uvd_clk->usVClkLow) & 0xffU) << 8 | ((__uint16_t)(uvd_clk->usVClkLow) & 0xff00U) >> 8) : __swap16md(uvd_clk->usVClkLow)) | (uvd_clk->ucVClkHigh << 16);
    rdev->pm.dpm.dyn_state.uvd_clock_voltage_dependency_table.entries[i].dclk =
     (__uint16_t)(__builtin_constant_p(uvd_clk->usDClkLow) ? (__uint16_t)(((__uint16_t)(uvd_clk->usDClkLow) & 0xffU) << 8 | ((__uint16_t)(uvd_clk->usDClkLow) & 0xff00U) >> 8) : __swap16md(uvd_clk->usDClkLow)) | (uvd_clk->ucDClkHigh << 16);
  ...
  if (((__uint16_t)(__builtin_constant_p(ext_hdr->usSize) ? (__uint16_t)(((__uint16_t)(ext_hdr->usSize) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usSize) & 0xff00U) >> 8) : __swap16md(ext_hdr->usSize)) >= 16) &&
   ext_hdr->usSAMUTableOffset) {
   ATOM_PPLIB_SAMClk_Voltage_Limit_Table *limits =
    (ATOM_PPLIB_SAMClk_Voltage_Limit_Table *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(ext_hdr->usSAMUTableOffset) ? (__uint16_t)(((__uint16_t)(ext_hdr->usSAMUTableOffset) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usSAMUTableOffset) & 0xff00U) >> 8) : __swap16md(ext_hdr->usSAMUTableOffset)) + 1);
   ...
   for (i = 0; i < limits->numEntries; i++) {
    rdev->pm.dpm.dyn_state.samu_clock_voltage_dependency_table.entries[i].clk =
     (__uint16_t)(__builtin_constant_p(entry->usSAMClockLow) ? (__uint16_t)(((__uint16_t)(entry->usSAMClockLow) & 0xffU) << 8 | ((__uint16_t)(entry->usSAMClockLow) & 0xff00U) >> 8) : __swap16md(entry->usSAMClockLow)) | (entry->ucSAMClockHigh << 16);
  ...
  if (((__uint16_t)(__builtin_constant_p(ext_hdr->usSize) ? (__uint16_t)(((__uint16_t)(ext_hdr->usSize) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usSize) & 0xff00U) >> 8) : __swap16md(ext_hdr->usSize)) >= 18) &&
      ext_hdr->usPPMTableOffset) {
   ATOM_PPLIB_PPM_Table *ppm = (ATOM_PPLIB_PPM_Table *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(ext_hdr->usPPMTableOffset) ? (__uint16_t)(((__uint16_t)(ext_hdr->usPPMTableOffset) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usPPMTableOffset) & 0xff00U) >> 8) : __swap16md(ext_hdr->usPPMTableOffset)));
   rdev->pm.dpm.dyn_state.ppm_table =
    kzalloc(sizeof(struct radeon_ppm_table), (0x0001 | 0x0004));
   ...
   rdev->pm.dpm.dyn_state.ppm_table->cpu_core_number =
    (__uint16_t)(__builtin_constant_p(ppm->usCpuCoreNumber) ? (__uint16_t)(((__uint16_t)(ppm->usCpuCoreNumber) & 0xffU) << 8 | ((__uint16_t)(ppm->usCpuCoreNumber) & 0xff00U) >> 8) : __swap16md(ppm->usCpuCoreNumber));
   rdev->pm.dpm.dyn_state.ppm_table->platform_tdp =
    (__uint32_t)(__builtin_constant_p(ppm->ulPlatformTDP) ? (__uint32_t)(((__uint32_t)(ppm->ulPlatformTDP) & 0xff) << 24 | ((__uint32_t)(ppm->ulPlatformTDP) & 0xff00) << 8 | ((__uint32_t)(ppm->ulPlatformTDP) & 0xff0000) >> 8 | ((__uint32_t)(ppm->ulPlatformTDP) & 0xff000000) >> 24) : __swap32md(ppm->ulPlatformTDP));
   rdev->pm.dpm.dyn_state.ppm_table->small_ac_platform_tdp =
    (__uint32_t)(__builtin_constant_p(ppm->ulSmallACPlatformTDP) ? (__uint32_t)(((__uint32_t)(ppm->ulSmallACPlatformTDP) & 0xff) << 24 | ((__uint32_t)(ppm->ulSmallACPlatformTDP) & 0xff00) << 8 | ((__uint32_t)(ppm->ulSmallACPlatformTDP) & 0xff0000) >> 8 | ((__uint32_t)(ppm->ulSmallACPlatformTDP) & 0xff000000) >> 24) : __swap32md(ppm->ulSmallACPlatformTDP));
   rdev->pm.dpm.dyn_state.ppm_table->platform_tdc =
    (__uint32_t)(__builtin_constant_p(ppm->ulPlatformTDC) ? (__uint32_t)(((__uint32_t)(ppm->ulPlatformTDC) & 0xff) << 24 | ((__uint32_t)(ppm->ulPlatformTDC) & 0xff00) << 8 | ((__uint32_t)(ppm->ulPlatformTDC) & 0xff0000) >> 8 | ((__uint32_t)(ppm->ulPlatformTDC) & 0xff000000) >> 24) : __swap32md(ppm->ulPlatformTDC));
   rdev->pm.dpm.dyn_state.ppm_table->small_ac_platform_tdc =
    (__uint32_t)(__builtin_constant_p(ppm->ulSmallACPlatformTDC) ? (__uint32_t)(((__uint32_t)(ppm->ulSmallACPlatformTDC) & 0xff) << 24 | ((__uint32_t)(ppm->ulSmallACPlatformTDC) & 0xff00) << 8 | ((__uint32_t)(ppm->ulSmallACPlatformTDC) & 0xff0000) >> 8 | ((__uint32_t)(ppm->ulSmallACPlatformTDC) & 0xff000000) >> 24) : __swap32md(ppm->ulSmallACPlatformTDC));
   rdev->pm.dpm.dyn_state.ppm_table->apu_tdp =
    (__uint32_t)(__builtin_constant_p(ppm->ulApuTDP) ? (__uint32_t)(((__uint32_t)(ppm->ulApuTDP) & 0xff) << 24 | ((__uint32_t)(ppm->ulApuTDP) & 0xff00) << 8 | ((__uint32_t)(ppm->ulApuTDP) & 0xff0000) >> 8 | ((__uint32_t)(ppm->ulApuTDP) & 0xff000000) >> 24) : __swap32md(ppm->ulApuTDP));
   rdev->pm.dpm.dyn_state.ppm_table->dgpu_tdp =
    (__uint32_t)(__builtin_constant_p(ppm->ulDGpuTDP) ? (__uint32_t)(((__uint32_t)(ppm->ulDGpuTDP) & 0xff) << 24 | ((__uint32_t)(ppm->ulDGpuTDP) & 0xff00) << 8 | ((__uint32_t)(ppm->ulDGpuTDP) & 0xff0000) >> 8 | ((__uint32_t)(ppm->ulDGpuTDP) & 0xff000000) >> 24) : __swap32md(ppm->ulDGpuTDP));
   rdev->pm.dpm.dyn_state.ppm_table->dgpu_ulv_power =
    (__uint32_t)(__builtin_constant_p(ppm->ulDGpuUlvPower) ? (__uint32_t)(((__uint32_t)(ppm->ulDGpuUlvPower) & 0xff) << 24 | ((__uint32_t)(ppm->ulDGpuUlvPower) & 0xff00) << 8 | ((__uint32_t)(ppm->ulDGpuUlvPower) & 0xff0000) >> 8 | ((__uint32_t)(ppm->ulDGpuUlvPower) & 0xff000000) >> 24) : __swap32md(ppm->ulDGpuUlvPower));
   rdev->pm.dpm.dyn_state.ppm_table->tj_max =
    (__uint32_t)(__builtin_constant_p(ppm->ulTjmax) ? (__uint32_t)(((__uint32_t)(ppm->ulTjmax) & 0xff) << 24 | ((__uint32_t)(ppm->ulTjmax) & 0xff00) << 8 | ((__uint32_t)(ppm->ulTjmax) & 0xff0000) >> 8 | ((__uint32_t)(ppm->ulTjmax) & 0xff000000) >> 24) : __swap32md(ppm->ulTjmax));
  }
  if (((__uint16_t)(__builtin_constant_p(ext_hdr->usSize) ? (__uint16_t)(((__uint16_t)(ext_hdr->usSize) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usSize) & 0xff00U) >> 8) : __swap16md(ext_hdr->usSize)) >= 20) &&
   ext_hdr->usACPTableOffset) {
   ATOM_PPLIB_ACPClk_Voltage_Limit_Table *limits =
    (ATOM_PPLIB_ACPClk_Voltage_Limit_Table *)
    (mode_info->atom_context->bios + data_offset +
     (__uint16_t)(__builtin_constant_p(ext_hdr->usACPTableOffset) ? (__uint16_t)(((__uint16_t)(ext_hdr->usACPTableOffset) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usACPTableOffset) & 0xff00U) >> 8) : __swap16md(ext_hdr->usACPTableOffset)) + 1);
   ...
   for (i = 0; i < limits->numEntries; i++) {
    rdev->pm.dpm.dyn_state.acp_clock_voltage_dependency_table.entries[i].clk =
     (__uint16_t)(__builtin_constant_p(entry->usACPClockLow) ? (__uint16_t)(((__uint16_t)(entry->usACPClockLow) & 0xffU) << 8 | ((__uint16_t)(entry->usACPClockLow) & 0xff00U) >> 8) : __swap16md(entry->usACPClockLow)) | (entry->ucACPClockHigh << 16);
  ...
  if (((__uint16_t)(__builtin_constant_p(ext_hdr->usSize) ? (__uint16_t)(((__uint16_t)(ext_hdr->usSize) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usSize) & 0xff00U) >> 8) : __swap16md(ext_hdr->usSize)) >= 22) &&
   ext_hdr->usPowerTuneTableOffset) {
   u8 rev = *(u8 *)(mode_info->atom_context->bios + data_offset +
      (__uint16_t)(__builtin_constant_p(ext_hdr->usPowerTuneTableOffset) ? (__uint16_t)(((__uint16_t)(ext_hdr->usPowerTuneTableOffset) & 0xffU) << 8 | ((__uint16_t)(ext_hdr->usPowerTuneTableOffset) & 0xff00U) >> 8) : __swap16md(ext_hdr->usPowerTuneTableOffset)));
   ATOM_PowerTune_Table *pt;
   rdev->pm.dpm.dyn_state.cac_tdp_table =
    kzalloc(sizeof(struct radeon_cac_tdp_table), (0x0001 | 0x0004));
   ...
   if (rev > 0) {
    ...
    rdev->pm.dpm.dyn_state.cac_tdp_table->maximum_power_delivery_limit =
     (__uint16_t)(__builtin_constant_p(ppt->usMaximumPowerDeliveryLimit) ? (__uint16_t)(((__uint16_t)(ppt->usMaximumPowerDeliveryLimit) & 0xffU) << 8 | ((__uint16_t)(ppt->usMaximumPowerDeliveryLimit) & 0xff00U) >> 8) : __swap16md(ppt->usMaximumPowerDeliveryLimit));
   ...
   rdev->pm.dpm.dyn_state.cac_tdp_table->tdp = (__uint16_t)(__builtin_constant_p(pt->usTDP) ? (__uint16_t)(((__uint16_t)(pt->usTDP) & 0xffU) << 8 | ((__uint16_t)(pt->usTDP) & 0xff00U) >> 8) : __swap16md(pt->usTDP));
   rdev->pm.dpm.dyn_state.cac_tdp_table->configurable_tdp =
    (__uint16_t)(__builtin_constant_p(pt->usConfigurableTDP) ? (__uint16_t)(((__uint16_t)(pt->usConfigurableTDP) & 0xffU) << 8 | ((__uint16_t)(pt->usConfigurableTDP) & 0xff00U) >> 8) : __swap16md(pt->usConfigurableTDP));
   rdev->pm.dpm.dyn_state.cac_tdp_table->tdc = (__uint16_t)(__builtin_constant_p(pt->usTDC) ? (__uint16_t)(((__uint16_t)(pt->usTDC) & 0xffU) << 8 | ((__uint16_t)(pt->usTDC) & 0xff00U) >> 8) : __swap16md(pt->usTDC));
   rdev->pm.dpm.dyn_state.cac_tdp_table->battery_power_limit =
    (__uint16_t)(__builtin_constant_p(pt->usBatteryPowerLimit) ? (__uint16_t)(((__uint16_t)(pt->usBatteryPowerLimit) & 0xffU) << 8 | ((__uint16_t)(pt->usBatteryPowerLimit) & 0xff00U) >> 8) : __swap16md(pt->usBatteryPowerLimit));
   rdev->pm.dpm.dyn_state.cac_tdp_table->small_power_limit =
    (__uint16_t)(__builtin_constant_p(pt->usSmallPowerLimit) ? (__uint16_t)(((__uint16_t)(pt->usSmallPowerLimit) & 0xffU) << 8 | ((__uint16_t)(pt->usSmallPowerLimit) & 0xff00U) >> 8) : __swap16md(pt->usSmallPowerLimit));
   rdev->pm.dpm.dyn_state.cac_tdp_table->low_cac_leakage =
    (__uint16_t)(__builtin_constant_p(pt->usLowCACLeakage) ? (__uint16_t)(((__uint16_t)(pt->usLowCACLeakage) & 0xffU) << 8 | ((__uint16_t)(pt->usLowCACLeakage) & 0xff00U) >> 8) : __swap16md(pt->usLowCACLeakage));
   rdev->pm.dpm.dyn_state.cac_tdp_table->high_cac_leakage =
    (__uint16_t)(__builtin_constant_p(pt->usHighCACLeakage) ? (__uint16_t)(((__uint16_t)(pt->usHighCACLeakage) & 0xffU) << 8 | ((__uint16_t)(pt->usHighCACLeakage) & 0xff00U) >> 8) : __swap16md(pt->usHighCACLeakage));
  }
 }
 return 0;
}
            ...
            enum radeon_pcie_gen default_gen)
{
 ...
 default:
  if ((sys_mask & 4) && (default_gen == RADEON_PCIE_GEN3))
   return RADEON_PCIE_GEN3;
  else if ((sys_mask & 2) && (default_gen == RADEON_PCIE_GEN2))
   return RADEON_PCIE_GEN2;
  else
   return RADEON_PCIE_GEN1;
 }
