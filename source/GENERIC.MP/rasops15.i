# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c"
void
...
# 125 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c"
...
rasops15_putchar8(void *cookie, int row, int col, u_int uc, long attr)
{
 ...
 ri = (struct rasops_info *)cookie;
# 236 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c"
 if (attr != stamp_attr)
 ...
 if (uc == (u_int)-1) {
  ...
  while (height--) {
   so = ((1*4-3) >= 0 ? (fr[0])>>(1*4-3):(fr[0])<<-(1*4-3)) & (15 << 3);
   rp[0] = (*(int32_t *)((caddr_t)stamp + (so)));
   rp[1] = (*(int32_t *)((caddr_t)stamp + (so + 4)));

   so = ((0*4-3) >= 0 ? (fr[0])>>(0*4-3):(fr[0])<<-(0*4-3)) & (15 << 3);
   rp[2] = (*(int32_t *)((caddr_t)stamp + (so)));
   rp[3] = (*(int32_t *)((caddr_t)stamp + (so + 4)));
 ...
 if ((attr & 1) != 0) {
  int32_t c = (*(int32_t *)((caddr_t)stamp + (28)));
...
rasops15_putchar12(void *cookie, int row, int col, u_int uc, long attr)
{
 ...
 ri = (struct rasops_info *)cookie;
# 312 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c"
 if (attr != stamp_attr)
  rasops15_makestamp(ri, attr);
 ...
 if (uc == (u_int)-1) {
  ...
  while (height--) {
   ...
   so = ((1*4-3) >= 0 ? (fr[1])>>(1*4-3):(fr[1])<<-(1*4-3)) & (15 << 3);
   rp[4] = (*(int32_t *)((caddr_t)stamp + (so)));
   rp[5] = (*(int32_t *)((caddr_t)stamp + (so + 4)));
...
rasops15_putchar16(void *cookie, int row, int col, u_int uc, long attr)
{
 ...
 ri = (struct rasops_info *)cookie;
# 392 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops15.c"
 if (attr != stamp_attr)
  rasops15_makestamp(ri, attr);
 ...
 if (uc == (u_int)-1) {
  ...
  while (height--) {
   ...
   so = ((0*4-3) >= 0 ? (fr[1])>>(0*4-3):(fr[1])<<-(0*4-3)) & (15 << 3);
   rp[6] = (*(int32_t *)((caddr_t)stamp + (so)));
   rp[7] = (*(int32_t *)((caddr_t)stamp + (so + 4)));
