...
struct igp_power_info {
 _Bool invert_pwm_required;
 _Bool pwm_voltage_control;
 _Bool voltage_control;
 _Bool gfx_clock_gating;
 u32 system_config;
 u32 bootup_uma_clk;
 u16 max_voltage;
 u16 min_voltage;
...
static void rs780_voltage_scaling_enable(struct radeon_device *rdev, _Bool enable);
         ...
         struct radeon_ps *boot_ps)
{
 ...
 int i, ret;
 ret = radeon_atom_get_clock_dividers(rdev, 2,
 ...
 r600_engine_clock_entry_set_step_time(rdev, 0, 0x00C8);
        ...
        struct radeon_ps *boot_ps)
{
 int ret = 0;
 int i;
 r600_set_bsp(rdev, 0x2, 0x41EB);
 r600_set_at(rdev, 0, 0, 0, 0);
 r600_set_git(rdev, 0x200);
 for (i = 0; i < 15; i++)
  r600_set_tc(rdev, i, 0, 0);
 r600_select_td(rdev, 0);
 r600_set_vrc(rdev, 0);
 r600_set_tpu(rdev, 0);
 r600_set_tpc(rdev, 0x200);
 r600_set_sstu(rdev, 0);
 r600_set_sst(rdev, 0x00C8);
 r600_set_fctu(rdev, 0);
 r600_set_fct(rdev, 0x0400);
 r600_set_vddc3d_oorsu(rdev, 0);
 r600_set_vddc3d_oorphc(rdev, 0x100);
 r600_set_vddc3d_oorsdc(rdev, 0x7);
 r600_set_ctxcgtt3d_rphc(rdev, 0x20);
 r600_set_ctxcgtt3d_rsdc(rdev, 0x40);
 r600_vid_rt_set_vru(rdev, 0x3);
 r600_vid_rt_set_vrt(rdev, 1000);
 r600_vid_rt_set_ssu(rdev, 0x3);
...
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x30ac), 0); tmp_ &= (~(1 << 12)); tmp_ |= (((1 << 12)) & ~(~(1 << 12))); r100_mm_wreg(rdev, (0x30ac), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x30ac), 0); tmp_ &= (~0xfff); tmp_ |= ((((110) << 0)) & ~(~0xfff)); r100_mm_wreg(rdev, (0x30ac), (tmp_), 0); } while (0);
}
static void rs780_preset_starting_fbdiv(struct radeon_device *rdev)
{
 u32 fbdiv = (r100_mm_rreg(rdev, (0x600), 0) & (0xff << 2)) >> 2;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3044), 0); tmp_ &= (~(0xfff << 12)); tmp_ |= ((((fbdiv) << 12)) & ~(~(0xfff << 12))); r100_mm_wreg(rdev, (0x3044), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3048), 0); tmp_ &= (~0xfff); tmp_ |= ((((fbdiv) << 0)) & ~(~0xfff)); r100_mm_wreg(rdev, (0x3048), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3044), 0); tmp_ &= (~(1 << 24)); tmp_ |= (((1 << 24)) & ~(~(1 << 24))); r100_mm_wreg(rdev, (0x3044), (tmp_), 0); } while (0);
}
static void rs780_voltage_scaling_init(struct radeon_device *rdev)
{
 ...
 if (dev->pdev->device == 0x9614) {
  fv_throt_pwm_fb_div_range[0] = 0x8b;
  fv_throt_pwm_fb_div_range[1] = 0x8c;
  fv_throt_pwm_fb_div_range[2] = 0xb5;
 } else if ((dev->pdev->device == 0x9714) ||
     (dev->pdev->device == 0x9715)) {
  fv_throt_pwm_fb_div_range[0] = 0x8d;
  fv_throt_pwm_fb_div_range[1] = 0x8e;
  fv_throt_pwm_fb_div_range[2] = 0xBa;
 } else {
  fv_throt_pwm_fb_div_range[0] = 0x37;
  fv_throt_pwm_fb_div_range[1] = 0x4b;
  fv_throt_pwm_fb_div_range[2] = 0x8b;
 }
 ...
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x305c), 0); tmp_ &= (~0xfff); tmp_ |= ((((pi->max_voltage) << 0)) & ~(~0xfff)); r100_mm_wreg(rdev, (0x305c), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x305c), 0); tmp_ &= (~(0xfff << 12)); tmp_ |= ((((pi->num_of_cycles_in_period) << 12)) & ~(~(0xfff << 12))); r100_mm_wreg(rdev, (0x305c), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x305c), 0); tmp_ &= (~(1 << 24)); tmp_ |= (((1 << 24)) & ~(~(1 << 24))); r100_mm_wreg(rdev, (0x305c), (tmp_), 0); } while (0);
 if (pi->invert_pwm_required)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x305c), 0); tmp_ &= (~(1 << 25)); tmp_ |= (((1 << 25)) & ~(~(1 << 25))); r100_mm_wreg(rdev, (0x305c), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x305c), 0); tmp_ &= (~(1 << 25)); tmp_ |= ((0) & ~(~(1 << 25))); r100_mm_wreg(rdev, (0x305c), (tmp_), 0); } while (0);
 rs780_voltage_scaling_enable(rdev, 1);
 r100_mm_wreg(rdev, (0x3060), ((((pi->min_voltage) << 0) | ((pi->max_voltage) << 12))), 0);
 r100_mm_wreg(rdev, (0x3064), (0x00002001), 0);
 r100_mm_wreg(rdev, (0x3068), (0x00004003), 0);
 r100_mm_wreg(rdev, (0x306c), (0x00002001), 0);
 r100_mm_wreg(rdev, (0x3070), (0x00004003), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x308c), 0); tmp_ &= (~0xfff); tmp_ |= ((((fv_throt_pwm_fb_div_range[0]) << 0)) & ~(~0xfff)); r100_mm_wreg(rdev, (0x308c), (tmp_), 0); } while (0);
 r100_mm_wreg(rdev, (0x3090), ((((fv_throt_pwm_fb_div_range[1]) << 0) | ((fv_throt_pwm_fb_div_range[2]) << 12))), 0);
 r100_mm_wreg(rdev, (0x3094), ((((fv_throt_pwm_range[1]) << 0) | ((fv_throt_pwm_range[2]) << 12))), 0);
 r100_mm_wreg(rdev, (0x3098), ((((fv_throt_pwm_range[1]) << 0) | ((fv_throt_pwm_range[2]) << 12))), 0);
}
static void rs780_clk_scaling_enable(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3000), 0); tmp_ &= (~((1 << 27) | (1 << 28))); tmp_ |= (((1 << 27) | (1 << 28)) & ~(~((1 << 27) | (1 << 28)))); r100_mm_wreg(rdev, (0x3000), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3000), 0); tmp_ &= (~((1 << 27) | (1 << 28))); tmp_ |= ((0) & ~(~((1 << 27) | (1 << 28)))); r100_mm_wreg(rdev, (0x3000), (tmp_), 0); } while (0);
}
static void rs780_voltage_scaling_enable(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3000), 0); tmp_ &= (~(1 << 31)); tmp_ |= (((1 << 31)) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x3000), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3000), 0); tmp_ &= (~(1 << 31)); tmp_ |= ((0) & ~(~(1 << 31))); r100_mm_wreg(rdev, (0x3000), (tmp_), 0); } while (0);
}
static void rs780_set_engine_clock_wfc(struct radeon_device *rdev)
{
 r100_mm_wreg(rdev, (0x3018), (0x04010040), 0);
 r100_mm_wreg(rdev, (0x301c), (0x04010040), 0);
 r100_mm_wreg(rdev, (0x3020), (0x04010040), 0);
 r100_mm_wreg(rdev, (0x3024), (0x04010040), 0);
 r100_mm_wreg(rdev, (0x3028), (0x04010040), 0);
 r100_mm_wreg(rdev, (0x302c), (0x04010040), 0);
 r100_mm_wreg(rdev, (0x3030), (0x04010040), 0);
 r100_mm_wreg(rdev, (0x3034), (0x04010040), 0);
 r100_mm_wreg(rdev, (0x3038), (0x04010040), 0);
 r100_mm_wreg(rdev, (0x303c), (0x04010040), 0);
}
static void rs780_set_engine_clock_sc(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3048), 0); tmp_ &= (~(0xffff << 12)); tmp_ |= ((((0x2710) << 12)) & ~(~(0xffff << 12))); r100_mm_wreg(rdev, (0x3048), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3000), 0); tmp_ &= (~((0x3 << 25) | 0x1fffffe)); tmp_ |= ((((0) << 25) | ((0xf) << 1)) & ~(~((0x3 << 25) | 0x1fffffe))); r100_mm_wreg(rdev, (0x3000), (tmp_), 0); } while (0);
}
static void rs780_set_engine_clock_tdc(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3000), 0); tmp_ &= (~((1 << 30) | (1 << 29))); tmp_ |= ((0) & ~(~((1 << 30) | (1 << 29)))); r100_mm_wreg(rdev, (0x3000), (tmp_), 0); } while (0);
}
static void rs780_set_engine_clock_ssc(struct radeon_device *rdev)
{
 r100_mm_wreg(rdev, (0x304c), (0x00001001), 0);
 r100_mm_wreg(rdev, (0x3050), (0x00002002), 0);
 r100_mm_wreg(rdev, (0x3054), (0x00004001), 0);
 r100_mm_wreg(rdev, (0x3058), (0x00020010), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3044), 0); tmp_ &= (~0xfff); tmp_ |= ((((1) << 0)) & ~(~0xfff)); r100_mm_wreg(rdev, (0x3044), (tmp_), 0); } while (0);
}
static void rs780_program_at(struct radeon_device *rdev)
{
 struct igp_power_info *pi = rs780_get_pi(rdev);
 r100_mm_wreg(rdev, (0x3004), (30000000 / pi->refresh_rate), 0);
 r100_mm_wreg(rdev, (0x3008), (1000000 * 5 / pi->refresh_rate), 0);
 r100_mm_wreg(rdev, (0x300c), (1000000 * 10 / pi->refresh_rate), 0);
 r100_mm_wreg(rdev, (0x3010), (1000000 * 30 / pi->refresh_rate), 0);
 r100_mm_wreg(rdev, (0x3014), (1000000 * 50 / pi->refresh_rate), 0);
}
static void rs780_disable_vbios_powersaving(struct radeon_device *rdev)
{
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3080), 0); tmp_ &= (~0xFFF00000); tmp_ |= ((0) & ~(~0xFFF00000)); r100_mm_wreg(rdev, (0x3080), (tmp_), 0); } while (0);
}
static void rs780_force_voltage(struct radeon_device *rdev, u16 voltage)
{
 ...
 if ((current_state->max_voltage == RS780_VDDC_LEVEL_HIGH) &&
  ...
  return;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x30c0), 0); tmp_ &= (~(1 << 0)); tmp_ |= (((1 << 0)) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x30c0), (tmp_), 0); } while (0);
 udelay(1);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x305c), 0); tmp_ &= (~0xfff); tmp_ |= ((((voltage) << 0)) & ~(~0xfff)); r100_mm_wreg(rdev, (0x305c), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x305c), 0); tmp_ &= (~(1 << 24)); tmp_ |= (((1 << 24)) & ~(~(1 << 24))); r100_mm_wreg(rdev, (0x305c), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x308c), 0); tmp_ &= (~(1 << 12)); tmp_ |= ((0) & ~(~(1 << 12))); r100_mm_wreg(rdev, (0x308c), (tmp_), 0); } while (0);
 udelay(1);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x30c0), 0); tmp_ &= (~(1 << 0)); tmp_ |= ((0) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x30c0), (tmp_), 0); } while (0);
}
static void rs780_force_fbdiv(struct radeon_device *rdev, u32 fb_div)
{
 ...
 if (current_state->sclk_low == current_state->sclk_high)
  return;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x30c0), 0); tmp_ &= (~(1 << 0)); tmp_ |= (((1 << 0)) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x30c0), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3048), 0); tmp_ &= (~0xfff); tmp_ |= ((((fb_div) << 0)) & ~(~0xfff)); r100_mm_wreg(rdev, (0x3048), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3044), 0); tmp_ &= (~(0xfff << 12)); tmp_ |= ((((fb_div) << 12)) & ~(~(0xfff << 12))); r100_mm_wreg(rdev, (0x3044), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3044), 0); tmp_ &= (~(1 << 24)); tmp_ |= (((1 << 24)) & ~(~(1 << 24))); r100_mm_wreg(rdev, (0x3044), (tmp_), 0); } while (0);
 udelay(100);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x30c0), 0); tmp_ &= (~(1 << 0)); tmp_ |= ((0) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x30c0), (tmp_), 0); } while (0);
}
       ...
       struct radeon_ps *old_ps)
{
 ...
 if (max_dividers.fb_div > min_dividers.fb_div) {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3040), 0); tmp_ &= (~(0xfff | (0xfff << 12))); tmp_ |= ((((min_dividers.fb_div) << 0) | ((max_dividers.fb_div) << 12)) & ~(~(0xfff | (0xfff << 12)))); r100_mm_wreg(rdev, (0x3040), (tmp_), 0); } while (0);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3044), 0); tmp_ &= (~(1 << 24)); tmp_ |= ((0) & ~(~(1 << 24))); r100_mm_wreg(rdev, (0x3044), (tmp_), 0); } while (0);
 }
 return 0;
}
           ...
           struct radeon_ps *old_ps)
{
 ...
 if ((new_state->sclk_high == old_state->sclk_high) &&
  ...
  return;
 if (pi->crtc_id == 0)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3080), 0); tmp_ &= (~(1 << 9)); tmp_ |= ((0) & ~(~(1 << 9))); r100_mm_wreg(rdev, (0x3080), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x3080), 0); tmp_ &= (~(1 << 9)); tmp_ |= (((1 << 9)) & ~(~(1 << 9))); r100_mm_wreg(rdev, (0x3080), (tmp_), 0); } while (0);
}
      ...
      struct radeon_ps *new_ps)
{
 ...
 if (vddc_high > vddc_low) {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x308c), 0); tmp_ &= (~(1 << 12)); tmp_ |= (((1 << 12)) & ~(~(1 << 12))); r100_mm_wreg(rdev, (0x308c), (tmp_), 0); } while (0);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x305c), 0); tmp_ &= (~(1 << 24)); tmp_ |= ((0) & ~(~(1 << 24))); r100_mm_wreg(rdev, (0x305c), (tmp_), 0); } while (0);
 } else if (vddc_high == vddc_low) {
  if (pi->max_voltage != vddc_high) {
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x305c), 0); tmp_ &= (~0xfff); tmp_ |= ((((vddc_high) << 0)) & ~(~0xfff)); r100_mm_wreg(rdev, (0x305c), (tmp_), 0); } while (0);
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x305c), 0); tmp_ &= (~(1 << 24)); tmp_ |= (((1 << 24)) & ~(~(1 << 24))); r100_mm_wreg(rdev, (0x305c), (tmp_), 0); } while (0);
  }
 }
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x30c0), 0); tmp_ &= (~(1 << 0)); tmp_ |= ((0) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x30c0), (tmp_), 0); } while (0);
           ...
           struct radeon_ps *old_ps)
{
 ...
 if (new_state->sclk_high >= current_state->sclk_high)
  return;
 (rdev)->asic->pm.set_uvd_clocks((rdev), (new_ps->vclk), (new_ps->dclk));
}
      ...
      union pplib_clock_info *clock_info)
{
 ...
 u32 sclk;
 sclk = (__uint16_t)(__builtin_constant_p(clock_info->rs780.usLowEngineClockLow) ? (__uint16_t)(((__uint16_t)(clock_info->rs780.usLowEngineClockLow) & 0xffU) << 8 | ((__uint16_t)(clock_info->rs780.usLowEngineClockLow) & 0xff00U) >> 8) : __swap16md(clock_info->rs780.usLowEngineClockLow));
 sclk |= clock_info->rs780.ucLowEngineClockHigh << 16;
 ps->sclk_low = sclk;
 sclk = (__uint16_t)(__builtin_constant_p(clock_info->rs780.usHighEngineClockLow) ? (__uint16_t)(((__uint16_t)(clock_info->rs780.usHighEngineClockLow) & 0xffU) << 8 | ((__uint16_t)(clock_info->rs780.usHighEngineClockLow) & 0xff00U) >> 8) : __swap16md(clock_info->rs780.usHighEngineClockLow));
 sclk |= clock_info->rs780.ucHighEngineClockHigh << 16;
 ps->sclk_high = sclk;
 switch ((__uint16_t)(__builtin_constant_p(clock_info->rs780.usVDDC) ? (__uint16_t)(((__uint16_t)(clock_info->rs780.usVDDC) & 0xffU) << 8 | ((__uint16_t)(clock_info->rs780.usVDDC) & 0xff00U) >> 8) : __swap16md(clock_info->rs780.usVDDC))) {
 case 0:
 default:
 ...
 ps->flags = (__uint32_t)(__builtin_constant_p(clock_info->rs780.ulFlags) ? (__uint32_t)(((__uint32_t)(clock_info->rs780.ulFlags) & 0xff) << 24 | ((__uint32_t)(clock_info->rs780.ulFlags) & 0xff00) << 8 | ((__uint32_t)(clock_info->rs780.ulFlags) & 0xff0000) >> 8 | ((__uint32_t)(clock_info->rs780.ulFlags) & 0xff000000) >> 24) : __swap32md(clock_info->rs780.ulFlags));
 if (rps->class & 0x0008) {
...
static int rs780_parse_power_table(struct radeon_device *rdev)
{
 ...
 rdev->pm.dpm.ps = kzalloc(sizeof(struct radeon_ps) *
      power_info->pplib.ucNumStates, (0x0001 | 0x0004));
 if (!rdev->pm.dpm.ps)
  return -12;
 for (i = 0; i < power_info->pplib.ucNumStates; i++) {
  ...
  if (power_info->pplib.ucStateEntrySize - 1) {
   ...
   ps = kzalloc(sizeof(struct igp_ps), (0x0001 | 0x0004));
   if (ps == ((void *)0)) {
...
int rs780_dpm_init(struct radeon_device *rdev)
{
 ...
 u8 frev, crev;
 int ret;
 pi = kzalloc(sizeof(struct igp_power_info), (0x0001 | 0x0004));
 if (pi == ((void *)0))
  return -12;
 rdev->pm.dpm.priv = pi;
 ...
 if (atom_parse_data_header(rdev->mode_info.atom_context, index, ((void *)0),
  ...
  case 1:
   ...
   pi->inter_voltage_low =
    (__uint16_t)(__builtin_constant_p(info->info.usInterNBVoltageLow) ? (__uint16_t)(((__uint16_t)(info->info.usInterNBVoltageLow) & 0xffU) << 8 | ((__uint16_t)(info->info.usInterNBVoltageLow) & 0xff00U) >> 8) : __swap16md(info->info.usInterNBVoltageLow));
   pi->inter_voltage_high =
    (__uint16_t)(__builtin_constant_p(info->info.usInterNBVoltageHigh) ? (__uint16_t)(((__uint16_t)(info->info.usInterNBVoltageHigh) & 0xffU) << 8 | ((__uint16_t)(info->info.usInterNBVoltageHigh) & 0xff00U) >> 8) : __swap16md(info->info.usInterNBVoltageHigh));
   pi->voltage_control = 1;
   pi->bootup_uma_clk = info->info.usK8MemoryClock * 100;
   break;
  case 2:
   pi->num_of_cycles_in_period =
    (__uint16_t)(__builtin_constant_p(info->info_2.usNumberOfCyclesInPeriod) ? (__uint16_t)(((__uint16_t)(info->info_2.usNumberOfCyclesInPeriod) & 0xffU) << 8 | ((__uint16_t)(info->info_2.usNumberOfCyclesInPeriod) & 0xff00U) >> 8) : __swap16md(info->info_2.usNumberOfCyclesInPeriod));
   pi->invert_pwm_required =
    (pi->num_of_cycles_in_period & 0x8000) ? 1 : 0;
   pi->boot_voltage =
    (__uint16_t)(__builtin_constant_p(info->info_2.usBootUpNBVoltage) ? (__uint16_t)(((__uint16_t)(info->info_2.usBootUpNBVoltage) & 0xffU) << 8 | ((__uint16_t)(info->info_2.usBootUpNBVoltage) & 0xff00U) >> 8) : __swap16md(info->info_2.usBootUpNBVoltage));
   pi->max_voltage =
    (__uint16_t)(__builtin_constant_p(info->info_2.usMaxNBVoltage) ? (__uint16_t)(((__uint16_t)(info->info_2.usMaxNBVoltage) & 0xffU) << 8 | ((__uint16_t)(info->info_2.usMaxNBVoltage) & 0xff00U) >> 8) : __swap16md(info->info_2.usMaxNBVoltage));
   pi->min_voltage =
    (__uint16_t)(__builtin_constant_p(info->info_2.usMinNBVoltage) ? (__uint16_t)(((__uint16_t)(info->info_2.usMinNBVoltage) & 0xffU) << 8 | ((__uint16_t)(info->info_2.usMinNBVoltage) & 0xff00U) >> 8) : __swap16md(info->info_2.usMinNBVoltage));
   pi->system_config =
    (__uint32_t)(__builtin_constant_p(info->info_2.ulSystemConfig) ? (__uint32_t)(((__uint32_t)(info->info_2.ulSystemConfig) & 0xff) << 24 | ((__uint32_t)(info->info_2.ulSystemConfig) & 0xff00) << 8 | ((__uint32_t)(info->info_2.ulSystemConfig) & 0xff0000) >> 8 | ((__uint32_t)(info->info_2.ulSystemConfig) & 0xff000000) >> 24) : __swap32md(info->info_2.ulSystemConfig));
   pi->pwm_voltage_control =
    (pi->system_config & 0x4) ? 1 : 0;
   pi->voltage_control = 1;
   pi->bootup_uma_clk = (__uint32_t)(__builtin_constant_p(info->info_2.ulBootUpUMAClock) ? (__uint32_t)(((__uint32_t)(info->info_2.ulBootUpUMAClock) & 0xff) << 24 | ((__uint32_t)(info->info_2.ulBootUpUMAClock) & 0xff00) << 8 | ((__uint32_t)(info->info_2.ulBootUpUMAClock) & 0xff0000) >> 8 | ((__uint32_t)(info->info_2.ulBootUpUMAClock) & 0xff000000) >> 24) : __swap32md(info->info_2.ulBootUpUMAClock));
   break;
  default:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "No integrated system info for your GPU\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
     ...
     struct radeon_ps *rps)
{
 ...
 printf("\t\tpower level 0    sclk: %u vddc_index: %d\n", ps->sclk_low, ps->min_voltage);
 printf("\t\tpower level 1    sclk: %u vddc_index: %d\n", ps->sclk_high, ps->max_voltage);
             ...
             struct seq_file *m)
{
 ...
 struct igp_ps *ps = rs780_get_ps(rps);
 u32 current_fb_div = r100_mm_rreg(rdev, (0x3074), 0) & 0xfff;
 u32 func_cntl = r100_mm_rreg(rdev, (0x600), 0);
 u32 ref_div = ((func_cntl & (7 << 2)) >> 2) + 1;
 u32 post_div = ((func_cntl & (0xf << 16)) >> 16) + 1 +
  ((func_cntl & (0xf << 20)) >> 20) + 1;
