# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c"
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c"
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbdvar.h" 1
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbdvar.h"
int ukbd_cnattach(void);
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsksymdef.h" 1
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hid/hidkbdsc.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hid/hidkbdsc.h"
...
struct hidkbd {
 ...
 char sc_console_keyboard;

 char sc_debounce;
 struct timeout sc_delay;
 struct hidkbd_data sc_data;
 ...
 int sc_polling;
 int sc_npollchar;
 u_int16_t sc_pollchars[(128 +2*6)];
};
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c" 2
# 89 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c"
const kbd_t ukbd_countrylayout[1 + 0x23] = {
 (kbd_t)-1,
 (kbd_t)-1,
 0x0d00,
 (kbd_t)-1,
...
ukbd_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (uha->uaa->vendor == 0x05ac &&
     uha->uaa->product == 0x1000)
  console = 0;

 quirks = usbd_get_quirks(sc->sc_hdev.sc_udev)->uq_flags;
 if (quirks & 0x00000080)
  qflags |= 0x001;
 ...
 if (uha->uaa->vendor == 0x05ac) {
  if (hid_locate(desc, dlen, (((0x00ff) << 16) | 0x0003),
 ...
 if (uha->uaa->vendor == 0x0853 &&
     uha->uaa->product == 0x0100) {
...
ukbd_set_leds(void *v, int leds)
{
 ...
 if (sc->sc_hdev.sc_osize && hidkbd_set_leds(kbd, leds, &res) != 0)
  uhidev_set_report_async(sc->sc_hdev.sc_parent,
      0x02, sc->sc_hdev.sc_report_id, &res, 1);
}
...
ukbd_ioctl(void *v, u_long cmd, caddr_t data, int flag, struct proc *p)
{
 ...
 switch (cmd) {
 case ((unsigned long)0x40000000 | ((sizeof(u_int) & 0x1fff) << 16) | ((('W')) << 8) | ((0))):
  *(int *)data = 5;
  return (0);
 case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('W')) << 8) | ((11))):
...
ukbd_cnattach(void)
{
 ...
 if (!cold) {
  ...
  for (i = 0; i < ukbd_cd.cd_ndevs; i++) {
   if ((sc = ukbd_cd.cd_devs[i]) != ((void *)0)) {
...
ukbd_apple_munge(void *vsc, uint8_t *ibuf, u_int ilen)
{
 ...
 static const struct ukbd_translation apple_fn_trans[] = {
  { 40, 73 },
  { 42, 76 },
# 564 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c"
  { 67, 127 },
  { 68, 129 },
  { 69, 128 },
 ...
 ukbd_apple_translate(vsc, ibuf, ilen, apple_fn_trans,
     (sizeof((apple_fn_trans)) / sizeof((apple_fn_trans)[0])));
}
...
ukbd_apple_mba_munge(void *vsc, uint8_t *ibuf, u_int ilen)
{
 ...
 static const struct ukbd_translation apple_fn_trans[] = {
  { 40, 73 },
  { 42, 76 },
# 599 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/ukbd.c"
  { 66, 127 },
  { 67, 129 },
  { 68, 128 },
...
ukbd_apple_iso_munge(void *vsc, uint8_t *ibuf, u_int ilen)
{
 ...
 ukbd_apple_translate(vsc, ibuf, ilen, apple_iso_trans,
     (sizeof((apple_iso_trans)) / sizeof((apple_iso_trans)[0])));
