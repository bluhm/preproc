...
cas_meminit(struct cas_softc *sc)
{
 ...
 for (i = 0; i < 128; i++)
  do { struct cas_rxsoft *__rxs = &sc->sc_rxsoft[(i)]; struct cas_desc *__rxd = &sc->sc_control_data->ccd_rxdescs[(i)]; __rxd->cd_addr = (__uint64_t)(__builtin_constant_p(__rxs->rxs_dmamap->dm_segs[0].ds_addr) ? (__uint64_t)((((__uint64_t)(__rxs->rxs_dmamap->dm_segs[0].ds_addr) & 0xff) << 56) | ((__uint64_t)(__rxs->rxs_dmamap->dm_segs[0].ds_addr) & 0xff00ULL) << 40 | ((__uint64_t)(__rxs->rxs_dmamap->dm_segs[0].ds_addr) & 0xff0000ULL) << 24 | ((__uint64_t)(__rxs->rxs_dmamap->dm_segs[0].ds_addr) & 0xff000000ULL) << 8 | ((__uint64_t)(__rxs->rxs_dmamap->dm_segs[0].ds_addr) & 0xff00000000ULL) >> 8 | ((__uint64_t)(__rxs->rxs_dmamap->dm_segs[0].ds_addr) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(__rxs->rxs_dmamap->dm_segs[0].ds_addr) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(__rxs->rxs_dmamap->dm_segs[0].ds_addr) & 0xff00000000000000ULL) >> 56) : __swap64md(__rxs->rxs_dmamap->dm_segs[0].ds_addr)); __rxd->cd_flags = (__uint64_t)(__builtin_constant_p((i)) ? (__uint64_t)((((__uint64_t)((i)) & 0xff) << 56) | ((__uint64_t)((i)) & 0xff00ULL) << 40 | ((__uint64_t)((i)) & 0xff0000ULL) << 24 | ((__uint64_t)((i)) & 0xff000000ULL) << 8 | ((__uint64_t)((i)) & 0xff00000000ULL) >> 8 | ((__uint64_t)((i)) & 0xff0000000000ULL) >> 24 | ((__uint64_t)((i)) & 0xff000000000000ULL) >> 40 | ((__uint64_t)((i)) & 0xff00000000000000ULL) >> 56) : __swap64md((i))); bus_dmamap_sync(((sc))->sc_dmatag, ((sc))->sc_cddmamap, __builtin_offsetof(struct cas_control_data, ccd_rxdescs[(((i)))]), sizeof(struct cas_desc), (0x01|0x04)); } while (0);
 sc->sc_rxdptr = 0;
 sc->sc_rxptr = 0;
 for (i = 0; i < 256; i++) {
  ...
  sc->sc_control_data->ccd_rxcomps[i].cc_word[3] = (__uint64_t)(__builtin_constant_p(0x0000080000000000ULL) ? (__uint64_t)((((__uint64_t)(0x0000080000000000ULL) & 0xff) << 56) | ((__uint64_t)(0x0000080000000000ULL) & 0xff00ULL) << 40 | ((__uint64_t)(0x0000080000000000ULL) & 0xff0000ULL) << 24 | ((__uint64_t)(0x0000080000000000ULL) & 0xff000000ULL) << 8 | ((__uint64_t)(0x0000080000000000ULL) & 0xff00000000ULL) >> 8 | ((__uint64_t)(0x0000080000000000ULL) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(0x0000080000000000ULL) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(0x0000080000000000ULL) & 0xff00000000000000ULL) >> 56) : __swap64md(0x0000080000000000ULL));
...
cas_rint(struct cas_softc *sc)
{
 ...
 for (i = sc->sc_rxptr;; i = ((i + skip + 1) & (256 - 1))) {
  ...
  word[0] = (__uint64_t)(__builtin_constant_p(sc->sc_control_data->ccd_rxcomps[i].cc_word[0]) ? (__uint64_t)((((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[0]) & 0xff) << 56) | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[0]) & 0xff00ULL) << 40 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[0]) & 0xff0000ULL) << 24 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[0]) & 0xff000000ULL) << 8 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[0]) & 0xff00000000ULL) >> 8 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[0]) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[0]) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[0]) & 0xff00000000000000ULL) >> 56) : __swap64md(sc->sc_control_data->ccd_rxcomps[i].cc_word[0]));
  word[1] = (__uint64_t)(__builtin_constant_p(sc->sc_control_data->ccd_rxcomps[i].cc_word[1]) ? (__uint64_t)((((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[1]) & 0xff) << 56) | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[1]) & 0xff00ULL) << 40 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[1]) & 0xff0000ULL) << 24 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[1]) & 0xff000000ULL) << 8 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[1]) & 0xff00000000ULL) >> 8 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[1]) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[1]) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[1]) & 0xff00000000000000ULL) >> 56) : __swap64md(sc->sc_control_data->ccd_rxcomps[i].cc_word[1]));
  word[2] = (__uint64_t)(__builtin_constant_p(sc->sc_control_data->ccd_rxcomps[i].cc_word[2]) ? (__uint64_t)((((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[2]) & 0xff) << 56) | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[2]) & 0xff00ULL) << 40 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[2]) & 0xff0000ULL) << 24 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[2]) & 0xff000000ULL) << 8 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[2]) & 0xff00000000ULL) >> 8 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[2]) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[2]) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[2]) & 0xff00000000000000ULL) >> 56) : __swap64md(sc->sc_control_data->ccd_rxcomps[i].cc_word[2]));
  word[3] = (__uint64_t)(__builtin_constant_p(sc->sc_control_data->ccd_rxcomps[i].cc_word[3]) ? (__uint64_t)((((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[3]) & 0xff) << 56) | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[3]) & 0xff00ULL) << 40 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[3]) & 0xff0000ULL) << 24 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[3]) & 0xff000000ULL) << 8 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[3]) & 0xff00000000ULL) >> 8 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[3]) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[3]) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(sc->sc_control_data->ccd_rxcomps[i].cc_word[3]) & 0xff00000000000000ULL) >> 56) : __swap64md(sc->sc_control_data->ccd_rxcomps[i].cc_word[3]));
 ...
 while (sc->sc_rxptr != i) {
  ...
  sc->sc_control_data->ccd_rxcomps[sc->sc_rxptr].cc_word[3] =
      (__uint64_t)(__builtin_constant_p(0x0000080000000000ULL) ? (__uint64_t)((((__uint64_t)(0x0000080000000000ULL) & 0xff) << 56) | ((__uint64_t)(0x0000080000000000ULL) & 0xff00ULL) << 40 | ((__uint64_t)(0x0000080000000000ULL) & 0xff0000ULL) << 24 | ((__uint64_t)(0x0000080000000000ULL) & 0xff000000ULL) << 8 | ((__uint64_t)(0x0000080000000000ULL) & 0xff00000000ULL) >> 8 | ((__uint64_t)(0x0000080000000000ULL) & 0xff0000000000ULL) >> 24 | ((__uint64_t)(0x0000080000000000ULL) & 0xff000000000000ULL) >> 40 | ((__uint64_t)(0x0000080000000000ULL) & 0xff00000000000000ULL) >> 56) : __swap64md(0x0000080000000000ULL));
