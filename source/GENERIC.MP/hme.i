...
hme_config(struct hme_softc *sc)
{
 ...
 hme_stop(sc, 0);
 for (i = 0; i < 64; i++) {
  if (bus_dmamap_create(sc->sc_dmatag, (1 << 11), 16,
      (1 << 11), 0, 0x0001 | 0x0002,
      &sc->sc_txd[i].sd_map) != 0) {
   sc->sc_txd[i].sd_map = ((void *)0);
   goto fail;
  }
 }
 for (i = 0; i < 64; i++) {
  if (bus_dmamap_create(sc->sc_dmatag, (1 << 11), 1,
      (1 << 11), 0, 0x0001 | 0x0002,
      &sc->sc_rxd[i].sd_map) != 0) {
   sc->sc_rxd[i].sd_map = ((void *)0);
   goto fail;
  }
 }
 if (bus_dmamap_create(sc->sc_dmatag, (1 << 11), 1, (1 << 11), 0,
     0x0001 | 0x0002, &sc->sc_rxmap_spare) != 0) {
  sc->sc_rxmap_spare = ((void *)0);
  goto fail;
 }
 size = (8 * 256) +
     (8 * 256);
 ...
 if ((error = bus_dmamap_load(dmatag, sc->sc_dmamap,
     sc->sc_rb.rb_membase, size, ((void *)0),
     0x0001|0x0004)) != 0) {
 ...
 ifmedia_init(&mii->mii_media, 0xff00000000000000ULL,
...
hme_tick(void *arg)
{
 ...
 ifp->if_data.ifi_collisions +=
     bus_space_read_4(t, mac, (144*4)) +
     bus_space_read_4(t, mac, (145*4)) +
     bus_space_read_4(t, mac, (146*4)) +
     bus_space_read_4(t, mac, (147*4));
 bus_space_write_4(t, mac, (144*4), 0);
 bus_space_write_4(t, mac, (145*4), 0);
 bus_space_write_4(t, mac, (146*4), 0);
 bus_space_write_4(t, mac, (147*4), 0);
...
hme_stop(struct hme_softc *sc, int softonly)
{
 ...
 if (!softonly) {
  mii_down(&sc->sc_mii);
  bus_space_write_4(t, seb, (65*4), 0xffffffff);
  bus_space_write_4(t, seb, (0*4),
      (0x00000001 | 0x00000002));
  for (n = 0; n < 20; n++) {
   u_int32_t v = bus_space_read_4(t, seb, (0*4));
   if ((v & (0x00000001 | 0x00000002)) == 0)
    break;
   delay(20);
  }
  if (n >= 20)
 ...
 for (n = 0; n < 64; n++) {
  if (sc->sc_txd[n].sd_mbuf != ((void *)0)) {
   ...
   sc->sc_txd[n].sd_mbuf = ((void *)0);
  }
 }
 sc->sc_tx_prod = sc->sc_tx_cons = sc->sc_tx_cnt = 0;
 for (n = 0; n < 64; n++) {
  if (sc->sc_rxd[n].sd_mbuf != ((void *)0)) {
...
hme_meminit(struct hme_softc *sc)
{
 ...
 p = (caddr_t)(((((u_long)p)+((2048)-1))/(2048))*(2048));
 for (i = 0; i < 64; i++) {
  do { *((u_int32_t *)((hr->rb_txd) + ((i) * 8) + 4)) = ((sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(0) ? (__uint32_t)(((__uint32_t)(0) & 0xff) << 24 | ((__uint32_t)(0) & 0xff00) << 8 | ((__uint32_t)(0) & 0xff0000) >> 8 | ((__uint32_t)(0) & 0xff000000) >> 24) : __swap32md(0)) : (0)); } while(0);
  do { *((u_int32_t *)((hr->rb_txd) + ((i) * 8) + 0)) = ((sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(0) ? (__uint32_t)(((__uint32_t)(0) & 0xff) << 24 | ((__uint32_t)(0) & 0xff00) << 8 | ((__uint32_t)(0) & 0xff0000) >> 8 | ((__uint32_t)(0) & 0xff000000) >> 24) : __swap32md(0)) : (0)); } while(0);
  sc->sc_txd[i].sd_mbuf = ((void *)0);
 }
 for (i = 0; i < 64; i++) {
  do { *((u_int32_t *)((hr->rb_rxd) + ((i) * 8) + 4)) = ((sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(0) ? (__uint32_t)(((__uint32_t)(0) & 0xff) << 24 | ((__uint32_t)(0) & 0xff00) << 8 | ((__uint32_t)(0) & 0xff0000) >> 8 | ((__uint32_t)(0) & 0xff000000) >> 24) : __swap32md(0)) : (0)); } while(0);
  do { *((u_int32_t *)((hr->rb_rxd) + ((i) * 8) + 0)) = ((sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(0) ? (__uint32_t)(((__uint32_t)(0) & 0xff) << 24 | ((__uint32_t)(0) & 0xff00) << 8 | ((__uint32_t)(0) & 0xff0000) >> 8 | ((__uint32_t)(0) & 0xff000000) >> 24) : __swap32md(0)) : (0)); } while(0);
...
hme_init(struct hme_softc *sc)
{
 ...
 bus_space_write_4(t, mac, (146*4), 0);
 bus_space_write_4(t, mac, (147*4), 0);
 bus_space_write_4(t, mac, (140*4), 1518 + 4);
 ea = sc->sc_arpcom.ac_enaddr;
 bus_space_write_4(t, mac, (200*4), (ea[0] << 8) | ea[1]);
 bus_space_write_4(t, mac, (199*4), (ea[2] << 8) | ea[3]);
 bus_space_write_4(t, mac, (198*4), (ea[4] << 8) | ea[5]);
 v = ((ea[4] << 8) | ea[5]) & 0x3fff;
 bus_space_write_4(t, mac, (148*4), v);
 hme_iff(sc);
 bus_space_write_4(t, etx, (2*4), sc->sc_rb.rb_txddma);
 bus_space_write_4(t, etx, (11*4), 64);
 bus_space_write_4(t, erx, (1*4), sc->sc_rb.rb_rxddma);
 bus_space_write_4(t, mac, (196*4), 1518 + 4);
 bus_space_write_4(t, seb, (65*4),
     ~(0x01000000 | 0x00010000 |
       0x02000000 | 0x10000000 |
       0x00000002 | (0x80000000 | 0x40000000 | 0x20000000 | 0x10000000 | 0x08000000 | 0x04000000 | 0x00400000 | 0x00200000 | 0x00100000 | 0x00080000 | 0x00040000 | 0x00020000 | 0x00008000 | 0x00004000 | 0x00002000 | 0x00001000 | 0x00000800 | 0x00000400| 0x00000200| 0x00000080 | 0x00000040 | 0x00000010 | 0x00000008| 0x00000004)));
 switch (sc->sc_burst) {
 default:
  v = 0;
  break;
 ...
 bus_space_write_4(t, seb, (1*4), v);
 v = bus_space_read_4(t, etx, (1*4));
 v |= 0x00000001;
 bus_space_write_4(t, etx, (1*4), v);
 bus_space_write_4(t, etx, (11*4), 64 / 16 - 1);
 v = bus_space_read_4(t, erx, (0*4));
 v &= ~0x00000600;
 v |= 0x00000200;
 v |= 0x00000001 | (2 << 3);
 bus_space_write_4(t, erx, (0*4), v);
 v = bus_space_read_4(t, mac, (0*4));
 v |= 0x00000001;
 bus_space_write_4(t, mac, (0*4), v);
 v = bus_space_read_4(t, mac, (195*4));
 v |= 0x00000001;
 bus_space_write_4(t, mac, (195*4), v);
 v = bus_space_read_4(t, mac, (131*4));
 v |= (0x00000001 | 0x00000400);
 bus_space_write_4(t, mac, (131*4), v);
...
hme_start(struct ifnet *ifp)
{
 ...
 if (!(ifp->if_flags & 0x40) || ifq_is_oactive(&ifp->if_snd))
  return;
 while (sc->sc_txd[sc->sc_tx_prod].sd_mbuf == ((void *)0)) {
  ...
  if ((64 - (sc->sc_tx_cnt + map->dm_nsegs)) < 5) {
  ...
  for (i = 0; i < map->dm_nsegs; i++) {
   flags = (((map->dm_segs[i].ds_len) << 0) & 0x00003fff);
   if (i == 0)
    flags |= 0x40000000;
   else
    flags |= 0x80000000;
   do { *((u_int32_t *)((hr->rb_txd) + ((frag) * 8) + 4)) = ((sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(map->dm_segs[i].ds_addr) ? (__uint32_t)(((__uint32_t)(map->dm_segs[i].ds_addr) & 0xff) << 24 | ((__uint32_t)(map->dm_segs[i].ds_addr) & 0xff00) << 8 | ((__uint32_t)(map->dm_segs[i].ds_addr) & 0xff0000) >> 8 | ((__uint32_t)(map->dm_segs[i].ds_addr) & 0xff000000) >> 24) : __swap32md(map->dm_segs[i].ds_addr)) : (map->dm_segs[i].ds_addr)); } while(0);
   do { *((u_int32_t *)((hr->rb_txd) + ((frag) * 8) + 0)) = ((sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(flags) ? (__uint32_t)(((__uint32_t)(flags) & 0xff) << 24 | ((__uint32_t)(flags) & 0xff00) << 8 | ((__uint32_t)(flags) & 0xff0000) >> 8 | ((__uint32_t)(flags) & 0xff000000) >> 24) : __swap32md(flags)) : (flags)); } while(0);
   cur = frag;
   if (++frag == 64)
    frag = 0;
  }
  flags = (sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(*((u_int32_t *)((hr->rb_txd) + ((cur) * 8) + 0))) ? (__uint32_t)(((__uint32_t)(*((u_int32_t *)((hr->rb_txd) + ((cur) * 8) + 0))) & 0xff) << 24 | ((__uint32_t)(*((u_int32_t *)((hr->rb_txd) + ((cur) * 8) + 0))) & 0xff00) << 8 | ((__uint32_t)(*((u_int32_t *)((hr->rb_txd) + ((cur) * 8) + 0))) & 0xff0000) >> 8 | ((__uint32_t)(*((u_int32_t *)((hr->rb_txd) + ((cur) * 8) + 0))) & 0xff000000) >> 24) : __swap32md(*((u_int32_t *)((hr->rb_txd) + ((cur) * 8) + 0)))) : (*((u_int32_t *)((hr->rb_txd) + ((cur) * 8) + 0)));
  flags |= 0x20000000;
  do { *((u_int32_t *)((hr->rb_txd) + ((cur) * 8) + 0)) = ((sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(flags) ? (__uint32_t)(((__uint32_t)(flags) & 0xff) << 24 | ((__uint32_t)(flags) & 0xff00) << 8 | ((__uint32_t)(flags) & 0xff0000) >> 8 | ((__uint32_t)(flags) & 0xff000000) >> 24) : __swap32md(flags)) : (flags)); } while(0);
  sc->sc_tx_cnt += map->dm_nsegs;
  sc->sc_txd[sc->sc_tx_prod].sd_map = sc->sc_txd[cur].sd_map;
  sc->sc_txd[cur].sd_map = map;
  sc->sc_txd[cur].sd_mbuf = m;
  flags = (sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(*((u_int32_t *)((hr->rb_txd) + ((sc->sc_tx_prod) * 8) + 0))) ? (__uint32_t)(((__uint32_t)(*((u_int32_t *)((hr->rb_txd) + ((sc->sc_tx_prod) * 8) + 0))) & 0xff) << 24 | ((__uint32_t)(*((u_int32_t *)((hr->rb_txd) + ((sc->sc_tx_prod) * 8) + 0))) & 0xff00) << 8 | ((__uint32_t)(*((u_int32_t *)((hr->rb_txd) + ((sc->sc_tx_prod) * 8) + 0))) & 0xff0000) >> 8 | ((__uint32_t)(*((u_int32_t *)((hr->rb_txd) + ((sc->sc_tx_prod) * 8) + 0))) & 0xff000000) >> 24) : __swap32md(*((u_int32_t *)((hr->rb_txd) + ((sc->sc_tx_prod) * 8) + 0)))) : (*((u_int32_t *)((hr->rb_txd) + ((sc->sc_tx_prod) * 8) + 0)));
  flags |= 0x80000000;
  do { *((u_int32_t *)((hr->rb_txd) + ((sc->sc_tx_prod) * 8) + 0)) = ((sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(flags) ? (__uint32_t)(((__uint32_t)(flags) & 0xff) << 24 | ((__uint32_t)(flags) & 0xff00) << 8 | ((__uint32_t)(flags) & 0xff0000) >> 8 | ((__uint32_t)(flags) & 0xff000000) >> 24) : __swap32md(flags)) : (flags)); } while(0);
...
hme_tint(struct hme_softc *sc)
{
 ...
 for (;;) {
  if (cnt <= 0)
   break;
  txflags = (sc->sc_pci) ? (__uint32_t)(__builtin_constant_p(*((u_int32_t *)((sc->sc_rb.rb_txd) + ((ri) * 8) + 0))) ? (__uint32_t)(((__uint32_t)(*((u_int32_t *)((sc->sc_rb.rb_txd) + ((ri) * 8) + 0))) & 0xff) << 24 | ((__uint32_t)(*((u_int32_t *)((sc->sc_rb.rb_txd) + ((ri) * 8) + 0))) & 0xff00) << 8 | ((__uint32_t)(*((u_int32_t *)((sc->sc_rb.rb_txd) + ((ri) * 8) + 0))) & 0xff0000) >> 8 | ((__uint32_t)(*((u_int32_t *)((sc->sc_rb.rb_txd) + ((ri) * 8) + 0))) & 0xff000000) >> 24) : __swap32md(*((u_int32_t *)((sc->sc_rb.rb_txd) + ((ri) * 8) + 0)))) : (*((u_int32_t *)((sc->sc_rb.rb_txd) + ((ri) * 8) + 0)));
  if (txflags & 0x80000000)
   break;
  ifq_clr_oactive(&ifp->if_snd);
  if (sd->sd_mbuf != ((void *)0)) {
   bus_dmamap_sync(sc->sc_dmatag, sd->sd_map,
       0, sd->sd_map->dm_mapsize, 0x08);
...
hme_intr(void *v)
{
 ...
 u_int32_t status;
 int r = 0;
 status = bus_space_read_4(t, seb, (64*4));
 if (status == 0xffffffff)
  return (0);
 if ((status & (0x80000000 | 0x40000000 | 0x20000000 | 0x10000000 | 0x08000000 | 0x04000000 | 0x00400000 | 0x00200000 | 0x00100000 | 0x00080000 | 0x00040000 | 0x00020000 | 0x00008000 | 0x00004000 | 0x00002000 | 0x00001000 | 0x00000800 | 0x00000400| 0x00000200| 0x00000080 | 0x00000040 | 0x00000010 | 0x00000008| 0x00000004)) != 0)
  r |= hme_eint(sc, status);
 if ((status & (0x02000000 | 0x01000000)) != 0)
  r |= hme_tint(sc);
...
static int
hme_mii_readreg(struct device *self, int phy, int reg64)
{
 ...
 if (phy != 0 && phy != 1)
  return (0);
 v = mifi_cfg = bus_space_read_4(t, mif, (4*4));
 v &= ~0x00000001;
 if (phy == 0)
  v |= 0x00000001;
 bus_space_write_4(t, mif, (4*4), v);
 v = xif_cfg = bus_space_read_4(t, mac, (0*4));
 if (phy == 0)
  v |= 0x00000008;
 else
  v &= ~0x00000008;
 ...
 v = (0x01 << 30) |
     ...
     (phy << 23) |
     (reg64 << 18);
 bus_space_write_4(t, mif, (3*4), v);
 for (n = 0; n < 100; n++) {
  delay(1);
  v = bus_space_read_4(t, mif, (3*4));
  if (v & 0x00010000) {
   v &= 0x0000ffff;
   goto out;
  }
...
out:
 bus_space_write_4(t, mif, (4*4), mifi_cfg);
 bus_space_write_4(t, mac, (0*4), xif_cfg);
 return (v);
}
static void
hme_mii_writereg(struct device *self, int phy, int reg64, int val)
{
...
hme_mii_statchg(struct device *dev)
{
 ...
 if ((((sc->sc_mii.mii_media_active) & (0x00000000ffff0000ULL|0x00ffff0000000000ULL)) & 0x0000010000000000ULL) != 0) {
  v |= 0x00000200;
  sc->sc_arpcom.ac_if.if_flags |= 0x800;
 } else {
  v &= ~0x00000200;
  sc->sc_arpcom.ac_if.if_flags &= ~0x800;
 }
...
hme_mediachange(struct ifnet *ifp)
{
 ...
 bus_space_handle_t mif = sc->sc_mif;
 bus_space_handle_t mac = sc->sc_mac;
 uint64_t instance = (((sc->sc_mii.mii_media.ifm_cur->ifm_media) & 0xff00000000000000ULL) >> 56);
 int phy = sc->sc_phys[instance];
 u_int32_t v;
 if (((sc->sc_mii.mii_media.ifm_media) & 0x000000000000ff00ULL) != 0x0000000000000100ULL)
  return (22);
 v = bus_space_read_4(t, mif, (4*4));
 v &= ~0x00000001;
 if (phy == 0)
...
hme_iff(struct hme_softc *sc)
{
 ...
 u_int32_t hash[4];
 u_int32_t rxcfg, crc;
 rxcfg = bus_space_read_4(t, mac, (195*4));
 rxcfg &= ~(0x00000800 | 0x00000040);
 ifp->if_flags &= ~0x200;
 ...
 bus_space_write_4(t, mac, (211*4), hash[0]);
 bus_space_write_4(t, mac, (210*4), hash[1]);
 bus_space_write_4(t, mac, (209*4), hash[2]);
 bus_space_write_4(t, mac, (208*4), hash[3]);
 bus_space_write_4(t, mac, (195*4), rxcfg);
}
void
...
hme_newbuf(struct hme_softc *sc, struct hme_sxd *d)
{
 ...
 if (bus_dmamap_load(sc->sc_dmatag, sc->sc_rxmap_spare,
     ((caddr_t)((m)->m_hdr.mh_data)), (1 << 11) - 2, ((void *)0),
     0x0001) != 0) {
  m_freem(m);
  return (55);
 }
