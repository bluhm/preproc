# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c"
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c"
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcomreg.h" 1
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcomreg.h"
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcomreg.h"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslhcom.c" 2
...
uslhcom_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(uslhcom_devs), sizeof (uslhcom_devs) / sizeof ((uslhcom_devs)[0]), sizeof ((uslhcom_devs)[0]), (uha->uaa->vendor), (uha->uaa->product)) != ((void *)0) ?
...
uslhcom_uart_endis(struct uslhcom_softc *sc, int enable)
{
 ...
 return uhidev_set_report(sc->sc_hdev.sc_parent, 0x03,
     0x41, &val, len) != len;
}
...
uslhcom_get_version(struct uslhcom_softc *sc, struct uslhcom_version_info *version)
{
 ...
 return uhidev_get_report(sc->sc_hdev.sc_parent, 0x03,
     0x46, version, len) < len;
}
...
uslhcom_create_config(struct uslhcom_uart_config *config, struct termios *t)
{
 ...
 if (((t->c_cflag) & (0x00010000)))
  config->data_control = 0x01;
 else
  config->data_control = 0x00;

 switch (((t->c_cflag) & (0x00000300))) {
 case 0x00000000:
  config->data_bits = 0x00;
  break;
 case 0x00000100:
  config->data_bits = 0x01;
  break;
 case 0x00000200:
  config->data_bits = 0x02;
  break;
 case 0x00000300:
  config->data_bits = 0x03;
  break;
 default:
  return 22;
 }
 ...
 if (((t->c_cflag) & (0x00000400)))
  config->stop_bits = 0x01;
 else
  config->stop_bits = 0x00;
...
uslhcom_setup(struct uslhcom_softc *sc, struct uslhcom_uart_config *config)
{
 ...
 if (uslhcom_uart_endis(sc, 0x00))
  return 5;

 if (uslhcom_set_config(sc, config))
  return 5;

 if (uslhcom_clear_fifo(sc, 0x01 | 0x02))
  return 5;

 if (uslhcom_get_uart_status(sc, &status))
  return 5;

 if (uslhcom_uart_endis(sc, 0x01))
  return 5;
...
void
uslhcom_set(void *arg, int portno, int reg64, int onoff)
{
 struct uslhcom_softc *sc = arg;
...
uslhcom_open(void *arg, int portno)
{
 ...
 sc->sc_ibuf = malloc(sc->sc_hdev.sc_isize, 102, 0x0001);
...
uslhcom_close(void *arg, int portno)
{
 ...
 if (sc->sc_ibuf != ((void *)0)) {
  free(sc->sc_ibuf, 102, sc->sc_hdev.sc_isize);
  sc->sc_ibuf = ((void *)0);
 }
 _splx(s);
}
...
{
 __builtin_bcopy((data), (&to[sizeof(u_char)]), (*cnt));
 to[0] = *cnt;
 *cnt += sizeof(u_char);
}
...
uslhcom_intr(struct uhidev *addr, void *ibuf, u_int len)
{
 ...
 s = _splraise(6);
 sc->sc_icnt = len;
 __builtin_bcopy((ibuf), (sc->sc_ibuf), (len));
