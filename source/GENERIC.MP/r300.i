# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm.h" 1
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r100_track.h" 1
# 13 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r100_track.h"
...
int r100_packet3_load_vbpntr(struct radeon_cs_parser *p,
        struct radeon_cs_packet *pkt,
        int idx);
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300d.h" 1
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rv350d.h" 1
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300_reg_safe.h" 1
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c" 2
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c"
...
void rv370_pcie_gart_tlb_flush(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < 2; i++) {
  tmp = rv370_pcie_rreg(rdev, (0x10));
  rv370_pcie_wreg(rdev, (0x10), (tmp | (1 << 8)));
  (void)rv370_pcie_rreg(rdev, (0x10));
  rv370_pcie_wreg(rdev, (0x10), (tmp));
 }
 __asm volatile("membar " "#Sync" ::: "memory");
}
...
int rv370_pcie_gart_init(struct radeon_device *rdev)
{
 ...
 if (r)
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to register debugfs file for PCIE gart !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
...
int rv370_pcie_gart_enable(struct radeon_device *rdev)
{
 ...
 tmp = (3 << 1);
 rv370_pcie_wreg(rdev, (0x10), (tmp));
 rv370_pcie_wreg(rdev, (0x14), (rdev->mc.gtt_start));
 tmp = rdev->mc.gtt_end & ~(4096 - 1);
 rv370_pcie_wreg(rdev, (0x16), (tmp));
 rv370_pcie_wreg(rdev, (0x15), (0));
 rv370_pcie_wreg(rdev, (0x17), (0));
 table_addr = rdev->gart.table_addr;
 rv370_pcie_wreg(rdev, (0x13), (table_addr));

 rv370_pcie_wreg(rdev, (0x11), (rdev->mc.vram_start));
 rv370_pcie_wreg(rdev, (0x12), (0));

 rv370_pcie_wreg(rdev, (0x18), (0));
 tmp = rv370_pcie_rreg(rdev, (0x10));
 tmp |= (1 << 0);
 tmp |= (3 << 1);
 rv370_pcie_wreg(rdev, (0x10), (tmp));
...
void rv370_pcie_gart_disable(struct radeon_device *rdev)
{
 ...
 rv370_pcie_wreg(rdev, (0x14), (0));
 rv370_pcie_wreg(rdev, (0x16), (0));
 rv370_pcie_wreg(rdev, (0x15), (0));
 rv370_pcie_wreg(rdev, (0x17), (0));
 tmp = rv370_pcie_rreg(rdev, (0x10));
 tmp |= (3 << 1);
 rv370_pcie_wreg(rdev, (0x10), (tmp & ~(1 << 0)));
     ...
     struct radeon_fence *fence)
{
 ...
 radeon_ring_write(ring, (0x00000000 | ((((0x43E0) >> 2) << 0) & (0x1ffff << 0)) | ((((0)) << 16) & (0x3fff << 16))));
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, (0x00000000 | ((((0x43E4) >> 2) << 0) & (0x1ffff << 0)) | ((((0)) << 16) & (0x3fff << 16))));
 radeon_ring_write(ring, 0);
 ...
 radeon_ring_write(ring, ((1 << 17) |
     (1 << 16) |
     (1 << 9)));
 radeon_ring_write(ring, (0x00000000 | ((((0x0130) >> 2) << 0) & (0x1ffff << 0)) | ((((0)) << 16) & (0x3fff << 16))));
 radeon_ring_write(ring, rdev->config.r300.hdp_cntl |
    (1 << 27));
 radeon_ring_write(ring, (0x00000000 | ((((0x0130) >> 2) << 0) & (0x1ffff << 0)) | ((((0)) << 16) & (0x3fff << 16))));
 radeon_ring_write(ring, rdev->config.r300.hdp_cntl);

 radeon_ring_write(ring, (0x00000000 | ((((rdev->fence_drv[fence->ring].scratch_reg) >> 2) << 0) & (0x1ffff << 0)) | ((((0)) << 16) & (0x3fff << 16))));
 radeon_ring_write(ring, fence->seq);
 radeon_ring_write(ring, (0x00000000 | ((((0x0044) >> 2) << 0) & (0x1ffff << 0)) | ((((0)) << 16) & (0x3fff << 16))));
 radeon_ring_write(ring, (1 << 26));
}
...
void r300_ring_start(struct radeon_device *rdev, struct radeon_ring *ring)
{
 ...
 radeon_ring_write(ring,
     ...
     (1 << 4) |
     (1 << 5));
 radeon_ring_write(ring, (0x00000000 | ((((0x4018) >> 2) << 0) & (0x1ffff << 0)) | ((((0)) << 16) & (0x3fff << 16))));
...
static void r300_errata(struct radeon_device *rdev)
{
 ...
 if (rdev->family == CHIP_R300 &&
     (r100_mm_rreg(rdev, (0x00e0), 0) & (0xf << 16)) == (0 << 16)) {
...
int r300_mc_wait_for_idle(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < rdev->usec_timeout; i++) {
  ...
  tmp = r100_mm_rreg(rdev, (0x0150), 0);
  if (tmp & (1 << 4)) {
   return 0;
  }
  delay(1);
...
static void r300_gpu_init(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x4018), (gb_tile_config), 0);

 if (r100_gui_wait_for_idle(rdev)) {
  printf("" "Failed to wait GUI idle while " "programming pipes. Bad things might happen.\n");

 }

 tmp = r100_mm_rreg(rdev, (0x170c), 0);
 r100_mm_wreg(rdev, (0x170c), (tmp | (1 << 31)), 0);

 r100_mm_wreg(rdev, (0x3428), ((1 << 8) | (1 << 17)), 0);
...
int r300_asic_reset(struct radeon_device *rdev)
{
 ...
 status = r100_mm_rreg(rdev, (0x000E40), 0);
 if (!(((status) >> 31) & 0x1)) {
  return 0;
 }
 ...
 r100_mm_wreg(rdev, (0x0740), (0), 0);
 tmp = r100_mm_rreg(rdev, (0x0704), 0);
 r100_mm_wreg(rdev, (0x0704), (tmp | (1 << 31)), 0);
 r100_mm_wreg(rdev, (0x071c), (0), 0);
 r100_mm_wreg(rdev, (0x0714), (0), 0);
 r100_mm_wreg(rdev, (0x0704), (tmp), 0);
 ...
 r100_mm_wreg(rdev, (0x0000F0), ((((1) & 0x1) << 2) | (((1) & 0x1) << 13)), 0);

 r100_mm_rreg(rdev, (0x0000F0), 0);
 mdelay(500);
 r100_mm_wreg(rdev, (0x0000F0), (0), 0);
 mdelay(1);
 status = r100_mm_rreg(rdev, (0x000E40), 0);
 do { } while(0);
 ...
 r100_mm_wreg(rdev, (0x0000F0), ((((1) & 0x1) << 0)), 0);
 r100_mm_rreg(rdev, (0x0000F0), 0);
 mdelay(500);
 r100_mm_wreg(rdev, (0x0000F0), (0), 0);
 mdelay(1);
 ...
 if ((((status) >> 26) & 0x1) || (((status) >> 20) & 0x1)) {
...
void r300_mc_init(struct radeon_device *rdev)
{
 ...
 tmp = r100_mm_rreg(rdev, (0x0140), 0);
 tmp &= 0x03;
 switch (tmp) {
 ...
 if (rdev->flags & RADEON_IS_IGP)
  base = (r100_mm_rreg(rdev, (0x15c), 0) & 0xffff) << 16;
...
void rv370_set_pcie_lanes(struct radeon_device *rdev, int lanes)
{
 ...
 link_width_cntl = rv370_pcie_rreg(rdev, (0xa2));
 ...
 rv370_pcie_wreg(rdev, (0xa2), (link_width_cntl));
 rv370_pcie_wreg(rdev, (0xa2), ((link_width_cntl | (1 << 8))));
...
# 590 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/r300.c"
static int rv370_debugfs_pcie_gart_info_init(struct radeon_device *rdev)
{
  ...
  unsigned idx, unsigned reg64)
{
 ...
 case 0x4540 +60:
  ...
  if (p->cs_flags & 0x01) {
   ...
   if (reloc->lobj.tiling_flags & 0x2)
    tile_flags |= (1 << 3);
   else if (reloc->lobj.tiling_flags & 0x20)
    tile_flags |= (2 << 3);
 ...
 case 0x4E00:
  ...
  if ((idx_value & (1 << 10)) &&
   ...
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Invalid RB3D_CCTL: Cannot enable CMASK.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
 ...
 case 0x4E44:
  ...
  case 5:
   if (p->rdev->family < CHIP_RV515) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Invalid color buffer format (%d)!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ((idx_value >> 21) & 0xF));
 ...
 case 0x4F10:
  ...
  case 2:
   ...
   break;
  default:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Invalid z buffer format (%d) !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , (idx_value & 0xF));
 ...
 case 0x44FC:
  ...
  case 0x1F:
   if (p->rdev->family < CHIP_R420) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Invalid texture format %u\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , (idx_value & 0x1F));
  ...
  case 0x11:
   track->textures[i].cpp = 1;
   track->textures[i].compress_format = 2;
   break;
  default:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Invalid texture format %u\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , (idx_value & 0x1F));
 ...
 case 0x453C:
  ...
  if (p->rdev->family >= CHIP_RV515) {
   ...
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Forbidden bit TXFORMAT_MSB\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  track->tex_dirty = 1;
  break;
 ...
 return 0;
fail:
 printf("" "Forbidden register 0x%04X in cs at %d (val=%08x)\n", reg64, idx, idx_value);
         ...
         struct radeon_cs_packet *pkt)
{
 ...
 case 0x29:
  ...
  if (((radeon_get_ib_value(p, idx + 1) >> 4) & 0x3) != 3) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "PRIM_WALK must be 3 for IMMD draw\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
...
void r300_set_reg_safe(struct radeon_device *rdev)
{
 ...
 rdev->config.r300.reg_safe_bm_size = (sizeof((r300_reg_safe_bm)) / sizeof((r300_reg_safe_bm)[0]));
}
...
void r300_mc_program(struct radeon_device *rdev)
{
 ...
 if (r) {
  printf("drm:pid%d:%s *ERROR* " "Failed to create r100_mc debugfs file.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 }


 r100_mc_stop(rdev, &save);
 if (rdev->flags & RADEON_IS_AGP) {
  r100_mm_wreg(rdev, (0x00014C), ((((rdev->mc.gtt_start >> 16) & 0xFFFF) << 0) | (((rdev->mc.gtt_end >> 16) & 0xFFFF) << 16)), 0);


  r100_mm_wreg(rdev, (0x000170), (((u32)(rdev->mc.agp_base))), 0);
  r100_mm_wreg(rdev, (0x00015C), (((u32)(((rdev->mc.agp_base) >> 16) >> 16)) & 0xff), 0);

 } else {
  r100_mm_wreg(rdev, (0x00014C), (0x0FFFFFFF), 0);
  r100_mm_wreg(rdev, (0x000170), (0), 0);
  r100_mm_wreg(rdev, (0x00015C), (0), 0);
 }

 if (r300_mc_wait_for_idle(rdev))
  do { } while( 0);

 r100_mm_wreg(rdev, (0x000148), ((((rdev->mc.vram_start >> 16) & 0xFFFF) << 0) | (((rdev->mc.vram_end >> 16) & 0xFFFF) << 16)), 0);
...
void r300_clock_startup(struct radeon_device *rdev)
{
 ...
 tmp = rdev->pll_rreg(rdev, (0x00000D));
 tmp |= (((1) & 0x1) << 16) | (((1) & 0x1) << 23);
 if ((rdev->family == CHIP_RV350) || (rdev->family == CHIP_RV380))
  tmp |= (((1) & 0x1) << 21);
 rdev->pll_wreg(rdev, (0x00000D), (tmp));
}
