# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c"
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c"
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../scsi/mpath_rdac.c"
...
rdac_match(struct device *parent, void *match, void *aux)
{
 ...
 for (i = 0; i < (sizeof((rdac_devices)) / sizeof((rdac_devices)[0])); i++) {
  s = &rdac_devices[i];
...
rdac_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 sc->sc_pg = dma_alloc(sizeof(*sc->sc_pg), 0x0001);
...
rdac_activate(struct device *self, int act)
{
 ...
 case 1:
  if (scsi_xsh_del(&sc->sc_xsh))
   mpath_path_status(&sc->sc_path, -1);
...
rdac_mpath_checksense(struct scsi_xfer *xs)
{
 ...
 if (skey == 0x05 && ((sense->add_sense_code << 8) | sense->add_sense_code_qual) == 0x9401)
  return (1);

 if (skey == 0x06 && ((sense->add_sense_code << 8) | sense->add_sense_code_qual) == 0x8b02)
  return (1);
...
rdac_status(struct scsi_xfer *xs)
{
 ...
 scsi_init_inquiry(xs, 0x01, 0xc9,
...
rdac_status_done(struct scsi_xfer *xs)
{
 ...
 if (xs->error == 0 &&
     _4btol(pg->pg_id) == 0x76616331) {
  status = (((pg->avtcvp) & (0x70)) ||
      ((pg->avtcvp) & (0x01))) ?
      0 : 1;
 }
...
rdac_extdevid(struct rdac_softc *sc)
{
 ...
 if (scsi_inquire_vpd(sc->sc_path.p_link, pg, sizeof(*pg),
     0xc8, scsi_autoconf) != 0) {
  printf("%s: unable to fetch extdevid vpd page\n", ((sc)->sc_dev.dv_xname));
  goto done;
 }

 if (_4btol(pg->pg_id) != 0x65646964) {
