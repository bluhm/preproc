# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/gmac.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/gmac.c"
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/gmac.c"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/gmac.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/gmac.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/gmac.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/gmac.h" 1
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/gmac.h"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/gmac.c" 2
...
ghash_gfmul(uint32_t *X, uint32_t *Y, uint32_t *product)
{
 ...
 product[0] = ((__uint32_t)(z[0]));
 product[1] = ((__uint32_t)(z[1]));
 product[2] = ((__uint32_t)(z[2]));
 product[3] = ((__uint32_t)(z[3]));
}
...
ghash_update_mi(GHASH_CTX *ctx, uint8_t *X, size_t len)
{
 ...
 __builtin_bcopy((ctx->S), (ctx->Z), (16));
}
...
AES_GMAC_Init(void *xctx)
{
 ...
 __builtin_bzero((ctx->ghash.H), (16));
 __builtin_bzero((ctx->ghash.S), (16));
 __builtin_bzero((ctx->ghash.Z), (16));
 __builtin_bzero((ctx->J), (16));
}
...
AES_GMAC_Setkey(void *xctx, const uint8_t *key, uint16_t klen)
{
 ...
 AES_Setkey(&ctx->K, key, klen - 4);

 __builtin_bcopy((key + klen - 4), (ctx->J), (4));
...
AES_GMAC_Reinit(void *xctx, const uint8_t *iv, uint16_t ivlen)
{
 ...
 __builtin_bcopy((iv), (ctx->J + 4), (ivlen));
}
 ...
 if (len > 0) {
  ...
  if (len >= 16)
   (*ghash_update)(&ctx->ghash, (uint8_t *)data,
       len - plen);
  if (plen) {
   __builtin_memcpy(((uint8_t *)blk), ((uint8_t *)data + (len - plen)), (plen));
...
void
AES_GMAC_Final(uint8_t digest[16], void *xctx)
{
 AES_GMAC_CTX *ctx = xctx;
