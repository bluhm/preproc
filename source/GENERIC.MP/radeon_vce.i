...
int radeon_vce_init(struct radeon_device *rdev)
{
 ...
 r = radeon_bo_create(rdev, size, (1 << 13), 1,
        0x4, 0, ((void *)0), ((void *)0),
        &rdev->vce.vcpu_bo);
 if (r) {
  printf("drm:pid%d:%s *ERROR* " "(%d) failed to allocate VCE bo\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 r = radeon_bo_reserve(rdev->vce.vcpu_bo, 0);
 if (r) {
  radeon_bo_unref(&rdev->vce.vcpu_bo);
  printf("drm:pid%d:%s *ERROR* " "(%d) failed to reserve VCE bo\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 r = radeon_bo_pin(rdev->vce.vcpu_bo, 0x4,
     &rdev->vce.gpu_addr);
 radeon_bo_unreserve(rdev->vce.vcpu_bo);
 if (r) {
  radeon_bo_unref(&rdev->vce.vcpu_bo);
  printf("drm:pid%d:%s *ERROR* " "(%d) VCE bo pin failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 for (i = 0; i < 16; ++i) {
  (*(&rdev->vce.handles[i]) = (0));
...
int radeon_vce_resume(struct radeon_device *rdev)
{
 ...
 if (r) {
  radeon_bo_unreserve(rdev->vce.vcpu_bo);
  printf("drm:pid%d:%s *ERROR* " "(%d) VCE map failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 __builtin_memset((cpu_addr), (0), (radeon_bo_size(rdev->vce.vcpu_bo)));
 if (rdev->family < CHIP_BONAIRE)
  r = vce_v1_0_load_fw(rdev, cpu_addr);
 else
  __builtin_memcpy((cpu_addr), (rdev->vce_fw->data), (rdev->vce_fw->size));
...
{
 struct radeon_device *rdev =
  ({ const __typeof( ((struct radeon_device *)0)->vce.idle_work.work ) *__mptr = (work); (struct radeon_device *)( (char *)__mptr - __builtin_offsetof(struct radeon_device, vce.idle_work.work) );});
 if ((radeon_fence_count_emitted(rdev, 6) == 0) &&
     (radeon_fence_count_emitted(rdev, 7) == 0)) {
  if ((rdev->pm.pm_method == PM_METHOD_DPM) && rdev->pm.dpm_enabled) {
   radeon_dpm_enable_vce(rdev, 0);
  } else {
   (rdev)->asic->pm.set_vce_clocks((rdev), (0), (0));
  }
 } else {
...
void radeon_vce_note_usage(struct radeon_device *rdev)
{
 ...
 _Bool set_clocks = !cancel_delayed_work_sync(&rdev->vce.idle_work);
 ...
 if (set_clocks || streams_changed) {
  if ((rdev->pm.pm_method == PM_METHOD_DPM) && rdev->pm.dpm_enabled) {
   ...
   (rdev)->asic->pm.set_vce_clocks((rdev), (53300), (40000));
  }
 }
}
void radeon_vce_free_handles(struct radeon_device *rdev, struct drm_file *filp)
{
 int i, r;
 for (i = 0; i < 16; ++i) {
  uint32_t handle = (*(&rdev->vce.handles[i]));
  if (!handle || rdev->vce.filp[i] != filp)
   continue;
  radeon_vce_note_usage(rdev);
  r = radeon_vce_get_destroy_msg(rdev, 6,
            handle, ((void *)0));
  if (r)
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Error destroying VCE handle (%d)!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  rdev->vce.filp[i] = ((void *)0);
  (*(&rdev->vce.handles[i]) = (0));
 }
}
         ...
         uint32_t handle, struct radeon_fence **fence)
{
 ...
 ib.length_dw = 0;
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x0000000c) ? (__uint32_t)(((__uint32_t)(0x0000000c) & 0xff) << 24 | ((__uint32_t)(0x0000000c) & 0xff00) << 8 | ((__uint32_t)(0x0000000c) & 0xff0000) >> 8 | ((__uint32_t)(0x0000000c) & 0xff000000) >> 24) : __swap32md(0x0000000c));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000001) ? (__uint32_t)(((__uint32_t)(0x00000001) & 0xff) << 24 | ((__uint32_t)(0x00000001) & 0xff00) << 8 | ((__uint32_t)(0x00000001) & 0xff0000) >> 8 | ((__uint32_t)(0x00000001) & 0xff000000) >> 24) : __swap32md(0x00000001));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(handle) ? (__uint32_t)(((__uint32_t)(handle) & 0xff) << 24 | ((__uint32_t)(handle) & 0xff00) << 8 | ((__uint32_t)(handle) & 0xff0000) >> 8 | ((__uint32_t)(handle) & 0xff000000) >> 24) : __swap32md(handle));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000030) ? (__uint32_t)(((__uint32_t)(0x00000030) & 0xff) << 24 | ((__uint32_t)(0x00000030) & 0xff00) << 8 | ((__uint32_t)(0x00000030) & 0xff0000) >> 8 | ((__uint32_t)(0x00000030) & 0xff000000) >> 24) : __swap32md(0x00000030));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x01000001) ? (__uint32_t)(((__uint32_t)(0x01000001) & 0xff) << 24 | ((__uint32_t)(0x01000001) & 0xff00) << 8 | ((__uint32_t)(0x01000001) & 0xff0000) >> 8 | ((__uint32_t)(0x01000001) & 0xff000000) >> 24) : __swap32md(0x01000001));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000000) ? (__uint32_t)(((__uint32_t)(0x00000000) & 0xff) << 24 | ((__uint32_t)(0x00000000) & 0xff00) << 8 | ((__uint32_t)(0x00000000) & 0xff0000) >> 8 | ((__uint32_t)(0x00000000) & 0xff000000) >> 24) : __swap32md(0x00000000));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000042) ? (__uint32_t)(((__uint32_t)(0x00000042) & 0xff) << 24 | ((__uint32_t)(0x00000042) & 0xff00) << 8 | ((__uint32_t)(0x00000042) & 0xff0000) >> 8 | ((__uint32_t)(0x00000042) & 0xff000000) >> 24) : __swap32md(0x00000042));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x0000000a) ? (__uint32_t)(((__uint32_t)(0x0000000a) & 0xff) << 24 | ((__uint32_t)(0x0000000a) & 0xff00) << 8 | ((__uint32_t)(0x0000000a) & 0xff0000) >> 8 | ((__uint32_t)(0x0000000a) & 0xff000000) >> 24) : __swap32md(0x0000000a));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000001) ? (__uint32_t)(((__uint32_t)(0x00000001) & 0xff) << 24 | ((__uint32_t)(0x00000001) & 0xff00) << 8 | ((__uint32_t)(0x00000001) & 0xff0000) >> 8 | ((__uint32_t)(0x00000001) & 0xff000000) >> 24) : __swap32md(0x00000001));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000080) ? (__uint32_t)(((__uint32_t)(0x00000080) & 0xff) << 24 | ((__uint32_t)(0x00000080) & 0xff00) << 8 | ((__uint32_t)(0x00000080) & 0xff0000) >> 8 | ((__uint32_t)(0x00000080) & 0xff000000) >> 24) : __swap32md(0x00000080));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000060) ? (__uint32_t)(((__uint32_t)(0x00000060) & 0xff) << 24 | ((__uint32_t)(0x00000060) & 0xff00) << 8 | ((__uint32_t)(0x00000060) & 0xff0000) >> 8 | ((__uint32_t)(0x00000060) & 0xff000000) >> 24) : __swap32md(0x00000060));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000100) ? (__uint32_t)(((__uint32_t)(0x00000100) & 0xff) << 24 | ((__uint32_t)(0x00000100) & 0xff00) << 8 | ((__uint32_t)(0x00000100) & 0xff0000) >> 8 | ((__uint32_t)(0x00000100) & 0xff000000) >> 24) : __swap32md(0x00000100));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000100) ? (__uint32_t)(((__uint32_t)(0x00000100) & 0xff) << 24 | ((__uint32_t)(0x00000100) & 0xff00) << 8 | ((__uint32_t)(0x00000100) & 0xff0000) >> 8 | ((__uint32_t)(0x00000100) & 0xff000000) >> 24) : __swap32md(0x00000100));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x0000000c) ? (__uint32_t)(((__uint32_t)(0x0000000c) & 0xff) << 24 | ((__uint32_t)(0x0000000c) & 0xff00) << 8 | ((__uint32_t)(0x0000000c) & 0xff0000) >> 8 | ((__uint32_t)(0x0000000c) & 0xff000000) >> 24) : __swap32md(0x0000000c));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000000) ? (__uint32_t)(((__uint32_t)(0x00000000) & 0xff) << 24 | ((__uint32_t)(0x00000000) & 0xff00) << 8 | ((__uint32_t)(0x00000000) & 0xff0000) >> 8 | ((__uint32_t)(0x00000000) & 0xff000000) >> 24) : __swap32md(0x00000000));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000014) ? (__uint32_t)(((__uint32_t)(0x00000014) & 0xff) << 24 | ((__uint32_t)(0x00000014) & 0xff00) << 8 | ((__uint32_t)(0x00000014) & 0xff0000) >> 8 | ((__uint32_t)(0x00000014) & 0xff000000) >> 24) : __swap32md(0x00000014));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x05000005) ? (__uint32_t)(((__uint32_t)(0x05000005) & 0xff) << 24 | ((__uint32_t)(0x05000005) & 0xff00) << 8 | ((__uint32_t)(0x05000005) & 0xff0000) >> 8 | ((__uint32_t)(0x05000005) & 0xff000000) >> 24) : __swap32md(0x05000005));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(((u32)(((dummy) >> 16) >> 16))) ? (__uint32_t)(((__uint32_t)(((u32)(((dummy) >> 16) >> 16))) & 0xff) << 24 | ((__uint32_t)(((u32)(((dummy) >> 16) >> 16))) & 0xff00) << 8 | ((__uint32_t)(((u32)(((dummy) >> 16) >> 16))) & 0xff0000) >> 8 | ((__uint32_t)(((u32)(((dummy) >> 16) >> 16))) & 0xff000000) >> 24) : __swap32md(((u32)(((dummy) >> 16) >> 16))));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(dummy) ? (__uint32_t)(((__uint32_t)(dummy) & 0xff) << 24 | ((__uint32_t)(dummy) & 0xff00) << 8 | ((__uint32_t)(dummy) & 0xff0000) >> 8 | ((__uint32_t)(dummy) & 0xff000000) >> 24) : __swap32md(dummy));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000001) ? (__uint32_t)(((__uint32_t)(0x00000001) & 0xff) << 24 | ((__uint32_t)(0x00000001) & 0xff00) << 8 | ((__uint32_t)(0x00000001) & 0xff0000) >> 8 | ((__uint32_t)(0x00000001) & 0xff000000) >> 24) : __swap32md(0x00000001));
 for (i = ib.length_dw; i < ib_size_dw; ++i)
  ib.ptr[i] = (__uint32_t)(__builtin_constant_p(0x0) ? (__uint32_t)(((__uint32_t)(0x0) & 0xff) << 24 | ((__uint32_t)(0x0) & 0xff00) << 8 | ((__uint32_t)(0x0) & 0xff0000) >> 8 | ((__uint32_t)(0x0) & 0xff000000) >> 24) : __swap32md(0x0));
          ...
          uint32_t handle, struct radeon_fence **fence)
{
 ...
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(dummy) ? (__uint32_t)(((__uint32_t)(dummy) & 0xff) << 24 | ((__uint32_t)(dummy) & 0xff00) << 8 | ((__uint32_t)(dummy) & 0xff0000) >> 8 | ((__uint32_t)(dummy) & 0xff000000) >> 24) : __swap32md(dummy));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000001) ? (__uint32_t)(((__uint32_t)(0x00000001) & 0xff) << 24 | ((__uint32_t)(0x00000001) & 0xff00) << 8 | ((__uint32_t)(0x00000001) & 0xff0000) >> 8 | ((__uint32_t)(0x00000001) & 0xff000000) >> 24) : __swap32md(0x00000001));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x00000008) ? (__uint32_t)(((__uint32_t)(0x00000008) & 0xff) << 24 | ((__uint32_t)(0x00000008) & 0xff00) << 8 | ((__uint32_t)(0x00000008) & 0xff0000) >> 8 | ((__uint32_t)(0x00000008) & 0xff000000) >> 24) : __swap32md(0x00000008));
 ib.ptr[ib.length_dw++] = (__uint32_t)(__builtin_constant_p(0x02000001) ? (__uint32_t)(((__uint32_t)(0x02000001) & 0xff) << 24 | ((__uint32_t)(0x02000001) & 0xff00) << 8 | ((__uint32_t)(0x02000001) & 0xff0000) >> 8 | ((__uint32_t)(0x02000001) & 0xff000000) >> 24) : __swap32md(0x02000001));
 for (i = ib.length_dw; i < ib_size_dw; ++i)
  ib.ptr[i] = (__uint32_t)(__builtin_constant_p(0x0) ? (__uint32_t)(((__uint32_t)(0x0) & 0xff) << 24 | ((__uint32_t)(0x0) & 0xff00) << 8 | ((__uint32_t)(0x0) & 0xff0000) >> 8 | ((__uint32_t)(0x0) & 0xff000000) >> 24) : __swap32md(0x0));
 r = radeon_ib_schedule(rdev, &ib, ((void *)0), 0);
 if (r) {
   ...
   unsigned size)
{
 ...
 if (end <= start) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "invalid reloc offset %llX!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , offset);
  return -22;
 }
 if ((end - start) < size) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "buffer to small (%d / %d)!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , (unsigned)(end - start), size);
  return -22;
 }
 return 0;
}
static int radeon_vce_validate_handle(struct radeon_cs_parser *p,
          uint32_t handle, _Bool *allocated)
{
 unsigned i;
 *allocated = 0;
 for (i = 0; i < 16; ++i) {
  if ((*(&p->rdev->vce.handles[i])) == handle) {
   if (p->rdev->vce.filp[i] != p->filp) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "VCE handle collision detected!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
   return i;
  }
 ...
 for (i = 0; i < 16; ++i) {
  if (!__sync_val_compare_and_swap(&p->rdev->vce.handles[i], 0, handle)) {
 ...
 printf("error: [" "drm" ":pid%d:%s] *ERROR* " "No more free VCE handles!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 return -22;
}
int radeon_vce_cs_parse(struct radeon_cs_parser *p)
{
 int session_idx = -1;
 _Bool destroyed = 0, created = 0, allocated = 0;
 ...
 while (p->idx < p->chunk_ib->length_dw) {
  ...
  if ((len < 8) || (len & 3)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "invalid VCE command length (%d)!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , len);
   r = -22;
   goto out;
  }
  if (destroyed) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "No other command allowed after destroy!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   r = -22;
   goto out;
  }
  switch (cmd) {
  ...
  case 0x01000001:
   created = 1;
   if (!allocated) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Handle already in use!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    r = -22;
    goto out;
   }
  ...
  case 0x05000005:
   ...
   break;
  default:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "invalid VCE command (0x%x)!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , cmd);
   r = -22;
   goto out;
  }
  if (session_idx == -1) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "no session command at start of IB\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   r = -22;
   goto out;
  }
  p->idx += len / 4;
 ...
 if (allocated && !created) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "New session without create command!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  r = -2;
 }
out:
 if ((!r && destroyed) || (r && allocated)) {
  for (i = 0; i < 16; ++i)
   __sync_val_compare_and_swap(&p->rdev->vce.handles[i], handle, 0);
 }
 return r;
}
_Bool radeon_vce_semaphore_emit(struct radeon_device *rdev,
          ...
          _Bool emit_wait)
{
 ...
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(0x00000006) ? (__uint32_t)(((__uint32_t)(0x00000006) & 0xff) << 24 | ((__uint32_t)(0x00000006) & 0xff00) << 8 | ((__uint32_t)(0x00000006) & 0xff0000) >> 8 | ((__uint32_t)(0x00000006) & 0xff000000) >> 24) : __swap32md(0x00000006)));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p((addr >> 3) & 0x000FFFFF) ? (__uint32_t)(((__uint32_t)((addr >> 3) & 0x000FFFFF) & 0xff) << 24 | ((__uint32_t)((addr >> 3) & 0x000FFFFF) & 0xff00) << 8 | ((__uint32_t)((addr >> 3) & 0x000FFFFF) & 0xff0000) >> 8 | ((__uint32_t)((addr >> 3) & 0x000FFFFF) & 0xff000000) >> 24) : __swap32md((addr >> 3) & 0x000FFFFF)));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p((addr >> 23) & 0x000FFFFF) ? (__uint32_t)(((__uint32_t)((addr >> 23) & 0x000FFFFF) & 0xff) << 24 | ((__uint32_t)((addr >> 23) & 0x000FFFFF) & 0xff00) << 8 | ((__uint32_t)((addr >> 23) & 0x000FFFFF) & 0xff0000) >> 8 | ((__uint32_t)((addr >> 23) & 0x000FFFFF) & 0xff000000) >> 24) : __swap32md((addr >> 23) & 0x000FFFFF)));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(0x01003000 | (emit_wait ? 1 : 0)) ? (__uint32_t)(((__uint32_t)(0x01003000 | (emit_wait ? 1 : 0)) & 0xff) << 24 | ((__uint32_t)(0x01003000 | (emit_wait ? 1 : 0)) & 0xff00) << 8 | ((__uint32_t)(0x01003000 | (emit_wait ? 1 : 0)) & 0xff0000) >> 8 | ((__uint32_t)(0x01003000 | (emit_wait ? 1 : 0)) & 0xff000000) >> 24) : __swap32md(0x01003000 | (emit_wait ? 1 : 0))));
 if (!emit_wait)
  radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(0x00000001) ? (__uint32_t)(((__uint32_t)(0x00000001) & 0xff) << 24 | ((__uint32_t)(0x00000001) & 0xff00) << 8 | ((__uint32_t)(0x00000001) & 0xff0000) >> 8 | ((__uint32_t)(0x00000001) & 0xff000000) >> 24) : __swap32md(0x00000001)));
 return 1;
}
void radeon_vce_ib_execute(struct radeon_device *rdev, struct radeon_ib *ib)
{
 struct radeon_ring *ring = &rdev->ring[ib->ring];
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(0x00000002) ? (__uint32_t)(((__uint32_t)(0x00000002) & 0xff) << 24 | ((__uint32_t)(0x00000002) & 0xff00) << 8 | ((__uint32_t)(0x00000002) & 0xff0000) >> 8 | ((__uint32_t)(0x00000002) & 0xff000000) >> 24) : __swap32md(0x00000002)));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(ib->gpu_addr) ? (__uint32_t)(((__uint32_t)(ib->gpu_addr) & 0xff) << 24 | ((__uint32_t)(ib->gpu_addr) & 0xff00) << 8 | ((__uint32_t)(ib->gpu_addr) & 0xff0000) >> 8 | ((__uint32_t)(ib->gpu_addr) & 0xff000000) >> 24) : __swap32md(ib->gpu_addr)));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(((u32)(((ib->gpu_addr) >> 16) >> 16))) ? (__uint32_t)(((__uint32_t)(((u32)(((ib->gpu_addr) >> 16) >> 16))) & 0xff) << 24 | ((__uint32_t)(((u32)(((ib->gpu_addr) >> 16) >> 16))) & 0xff00) << 8 | ((__uint32_t)(((u32)(((ib->gpu_addr) >> 16) >> 16))) & 0xff0000) >> 8 | ((__uint32_t)(((u32)(((ib->gpu_addr) >> 16) >> 16))) & 0xff000000) >> 24) : __swap32md(((u32)(((ib->gpu_addr) >> 16) >> 16)))));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(ib->length_dw) ? (__uint32_t)(((__uint32_t)(ib->length_dw) & 0xff) << 24 | ((__uint32_t)(ib->length_dw) & 0xff00) << 8 | ((__uint32_t)(ib->length_dw) & 0xff0000) >> 8 | ((__uint32_t)(ib->length_dw) & 0xff000000) >> 24) : __swap32md(ib->length_dw)));
}
void radeon_vce_fence_emit(struct radeon_device *rdev,
      struct radeon_fence *fence)
{
 ...
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(0x00000003) ? (__uint32_t)(((__uint32_t)(0x00000003) & 0xff) << 24 | ((__uint32_t)(0x00000003) & 0xff00) << 8 | ((__uint32_t)(0x00000003) & 0xff0000) >> 8 | ((__uint32_t)(0x00000003) & 0xff000000) >> 24) : __swap32md(0x00000003)));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(addr) ? (__uint32_t)(((__uint32_t)(addr) & 0xff) << 24 | ((__uint32_t)(addr) & 0xff00) << 8 | ((__uint32_t)(addr) & 0xff0000) >> 8 | ((__uint32_t)(addr) & 0xff000000) >> 24) : __swap32md(addr)));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(((u32)(((addr) >> 16) >> 16))) ? (__uint32_t)(((__uint32_t)(((u32)(((addr) >> 16) >> 16))) & 0xff) << 24 | ((__uint32_t)(((u32)(((addr) >> 16) >> 16))) & 0xff00) << 8 | ((__uint32_t)(((u32)(((addr) >> 16) >> 16))) & 0xff0000) >> 8 | ((__uint32_t)(((u32)(((addr) >> 16) >> 16))) & 0xff000000) >> 24) : __swap32md(((u32)(((addr) >> 16) >> 16)))));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(fence->seq) ? (__uint32_t)(((__uint32_t)(fence->seq) & 0xff) << 24 | ((__uint32_t)(fence->seq) & 0xff00) << 8 | ((__uint32_t)(fence->seq) & 0xff0000) >> 8 | ((__uint32_t)(fence->seq) & 0xff000000) >> 24) : __swap32md(fence->seq)));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(0x00000004) ? (__uint32_t)(((__uint32_t)(0x00000004) & 0xff) << 24 | ((__uint32_t)(0x00000004) & 0xff00) << 8 | ((__uint32_t)(0x00000004) & 0xff0000) >> 8 | ((__uint32_t)(0x00000004) & 0xff000000) >> 24) : __swap32md(0x00000004)));
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(0x00000001) ? (__uint32_t)(((__uint32_t)(0x00000001) & 0xff) << 24 | ((__uint32_t)(0x00000001) & 0xff00) << 8 | ((__uint32_t)(0x00000001) & 0xff0000) >> 8 | ((__uint32_t)(0x00000001) & 0xff000000) >> 24) : __swap32md(0x00000001)));
}
int radeon_vce_ring_test(struct radeon_device *rdev, struct radeon_ring *ring)
{
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: vce failed to lock ring %d (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ring->idx, r);
  return r;
 }
 radeon_ring_write(ring, (__uint32_t)(__builtin_constant_p(0x00000001) ? (__uint32_t)(((__uint32_t)(0x00000001) & 0xff) << 24 | ((__uint32_t)(0x00000001) & 0xff00) << 8 | ((__uint32_t)(0x00000001) & 0xff0000) >> 8 | ((__uint32_t)(0x00000001) & 0xff000000) >> 24) : __swap32md(0x00000001)));
 ...
 if (i < rdev->usec_timeout) {
         ...
         printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: ring %d test failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ring->idx);
         r = -60;
 }
 return r;
}
int radeon_vce_ib_test(struct radeon_device *rdev, struct radeon_ring *ring)
{
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: failed to get create msg (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  goto error;
 }
 r = radeon_vce_get_destroy_msg(rdev, ring->idx, 1, &fence);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: failed to get destroy ib (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  goto error;
 }
