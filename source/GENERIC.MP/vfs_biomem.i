# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c"
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c"
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c" 2

vaddr_t buf_kva_start, buf_kva_end;
int buf_needva;
struct { struct buf *tqh_first; struct buf **tqh_last; } buf_valist;

extern struct bcachestats bcstats;
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c"
...
{
 do { (&buf_valist)->tqh_first = ((void *)0); (&buf_valist)->tqh_last = &(&buf_valist)->tqh_first; } while (0);

 buf_kva_start = ((kernel_map)->min_offset);
 if (uvm_map(kernel_map, &buf_kva_start, size, ((void *)0),
     ((voff_t) -1), (1 << 13), ((0x00) | ((0x00) << 8) | ((2) << 4) | ((0) << 12) | (0))))

  panic("bufinit: can't reserve VM for buffers");
 buf_kva_end = buf_kva_start + size;


 bcstats.kvaslots = bcstats.kvaslots_avail = size / (64 * 1024);

 buf_object = &buf_object_store;

 uvm_objinit(buf_object, ((void *)0), 1);
}
...
{
 (((bp->b_flags & 0x00000010) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c", 76, "(bp->b_flags & B_BUSY) == 0"));
...
buf_acquire_nomap(struct buf *bp)
{
 ...
 ((bp->b_flags) |= (0x00000010));
 if (bp->b_data != ((void *)0)) {
  do { if (((bp)->b_valist.tqe_next) != ((void *)0)) (bp)->b_valist.tqe_next->b_valist.tqe_prev = (bp)->b_valist.tqe_prev; else (&buf_valist)->tqh_last = (bp)->b_valist.tqe_prev; *(bp)->b_valist.tqe_prev = (bp)->b_valist.tqe_next; ((bp)->b_valist.tqe_prev) = ((void *)-1); ((bp)->b_valist.tqe_next) = ((void *)-1); } while (0);
...
buf_map(struct buf *bp)
{
 ...
 if (bp->b_data == ((void *)0)) {
  ...
  if (buf_kva_start < buf_kva_end) {
   ...
   vbp = ((&buf_valist)->tqh_first);
   while (((__curcpu->ci_self)->ci_curproc != syncerproc &&
      (__curcpu->ci_self)->ci_curproc != cleanerproc &&
      bcstats.kvaslots_avail <= 4) ||
      vbp == ((void *)0)) {
    buf_needva++;
    tsleep(&buf_needva, 16, "buf_needva", 0);
    vbp = ((&buf_valist)->tqh_first);
   }
   va = buf_unmap(vbp);
  }
  ...
  for (i = 0; i < ((bp->b_bufsize) >> 13); i++) {
   ...
   ((pg != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c", 139, "pg != NULL"));

   pmap_kenter_pa(va + ((paddr_t)(i) << 13), ((pg)->phys_addr),
       0x01 | 0x02);
  }
  ;
...
buf_release(struct buf *bp)
{
 ...
 ((bp->b_flags & 0x00000010) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c", 158, "bp->b_flags & B_BUSY"));
 do { if (splassert_ctl > 0) { splassert_check(5, __func__); } } while (0);

 if (bp->b_data) {
  bcstats.busymapped--;
  do { (bp)->b_valist.tqe_next = ((void *)0); (bp)->b_valist.tqe_prev = (&buf_valist)->tqh_last; *(&buf_valist)->tqh_last = (bp); (&buf_valist)->tqh_last = &(bp)->b_valist.tqe_next; } while (0);
  bcstats.kvaslots_avail++;
  if (buf_needva) {
   buf_needva=0;
   wakeup(&buf_needva);
...
# 184 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c"
int
buf_dealloc_mem(struct buf *bp)
{
 ...
 ((bp->b_flags) |= (0x00400000));
 do { if (((bp)->b_valist.tqe_next = (&buf_valist)->tqh_first) != ((void *)0)) (&buf_valist)->tqh_first->b_valist.tqe_prev = &(bp)->b_valist.tqe_next; else (&buf_valist)->tqh_last = &(bp)->b_valist.tqe_next; (&buf_valist)->tqh_first = (bp); (bp)->b_valist.tqe_prev = &(&buf_valist)->tqh_first; } while (0);
 bcstats.kvaslots_avail++;
...
buf_unmap(struct buf *bp)
{
 ...
 (((bp->b_flags & 0x00000010) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c", 249, "(bp->b_flags & B_BUSY) == 0"));
 ((bp->b_data != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c", 250, "bp->b_data != NULL"));
 do { if (splassert_ctl > 0) { splassert_check(5, __func__); } } while (0);
...
buf_alloc_pages(struct buf *bp, vsize_t size)
{
 ...
 ((size == (((size) + ((1 << 13) - 1)) & ~((1 << 13) - 1))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c", 273, "size == round_page(size)"));
 ((bp->b_pobj == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c", 274, "bp->b_pobj == NULL"));
 ((bp->b_data == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c", 275, "bp->b_data == NULL"));
 do { if (splassert_ctl > 0) { splassert_check(5, __func__); } } while (0);

 offs = buf_page_offset;
 buf_page_offset += size;

 ((buf_page_offset > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c", 281, "buf_page_offset > 0"));
    ...
    int flags)
{
 ...
 do {
  r = uvm_pagerealloc_multi(bp->b_pobj, bp->b_poffs,
      bp->b_bufsize, 0x0002, where);
  if (r == 0)
   break;
 } while ((bufbackoff(where, ((bp->b_bufsize) >> 13)) == 0));
...
# 381 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_biomem.c"
 if (dma)
  bcstats.dmapages -= ((bp->b_bufsize) >> 13);
