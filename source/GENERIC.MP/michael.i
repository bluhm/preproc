# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/michael.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/michael.c"
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/michael.c"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/michael.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/michael.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/michael.c" 2
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/michael.c"
void
michael_init(MICHAEL_CTX *ctx)
{
 __builtin_bzero((ctx), (sizeof(MICHAEL_CTX)));
}
...
michael_update(MICHAEL_CTX *ctx, const u_int8_t *data, u_int len)
{
 ...
 for (i = 0; i < len; i++) {
  ...
  if (ctx->michael_count >= 4) {
   ctx->michael_l ^= ctx->michael_state;
   do { ctx->michael_r ^= (((ctx->michael_l) << (17)) | ((ctx->michael_l) >> (32 - (17)))); ctx->michael_l += ctx->michael_r; ctx->michael_r ^= (((ctx->michael_l) & 0xff00ff00UL) >> 8 | ((ctx->michael_l) & 0x00ff00ffUL) << 8); ctx->michael_l += ctx->michael_r; ctx->michael_r ^= (((ctx->michael_l) << (3)) | ((ctx->michael_l) >> (32 - (3)))); ctx->michael_l += ctx->michael_r; ctx->michael_r ^= (((ctx->michael_l) >> (2)) | ((ctx->michael_l) << (32 - (2)))); ctx->michael_l += ctx->michael_r; } while (0);
...
void
michael_final(u_int8_t digest[8], MICHAEL_CTX *ctx)
{
 ...
 ((digest)[0] = (u_int8_t)(ctx->michael_l), (digest)[1] = (u_int8_t)((ctx->michael_l) >> 8), (digest)[2] = (u_int8_t)((ctx->michael_l) >> 16), (digest)[3] = (u_int8_t)((ctx->michael_l) >> 24));
 ((digest + 4)[0] = (u_int8_t)(ctx->michael_r), (digest + 4)[1] = (u_int8_t)((ctx->michael_r) >> 8), (digest + 4)[2] = (u_int8_t)((ctx->michael_r) >> 16), (digest + 4)[3] = (u_int8_t)((ctx->michael_r) >> 24));
}
...
michael_key(const u_int8_t *key, MICHAEL_CTX *ctx)
{
 ...
 ctx->michael_r = ctx->michael_key[1] =
     ((key + 4)[0] | (key + 4)[1] << 8 | (key + 4)[2] << 16 | (key + 4)[3] << 24);
}
