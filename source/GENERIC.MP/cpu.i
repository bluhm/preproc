# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c"
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c"
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
void device_register(struct device *, void *);
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/trap.h" 1
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/starfire.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/starfire.h"
void starfire_pc_ittrans_init(int);
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c" 2
...
alloc_cpuinfo(struct mainbus_attach_args *ma)
{
 ...
 for (cpi = cpus; cpi != ((void *)0); cpi = cpi->ci_next)
  if (cpi->ci_upaid == portid)
   return cpi;

 va = uvm_km_valloc_align(kernel_map, sz, 8 * (1 << 13), 0);
 if (va == 0)
 ...
 for (pa = pa0; pa < cpu0paddr; pa += (1 << 13), va += (1 << 13))
  pmap_kenter_pa(va, pa, 0x01 | 0x02);

 ;

 cpi = (struct cpu_info *)(va0 + ( ( ( 0x0e0000000 + 8*8192) + 2*(2 * (1 << 13)))) - ( 0x0e0000000 + 8*8192));
 ...
 for (ci = cpus; ci->ci_next != ((void *)0); ci = ci->ci_next)
  ;
 ci->ci_next = cpi;
 return (cpi);
}
 ...
 void *aux;
{
 ...
 if (OF_getprop(ma->ma_node, "device_type", buf, sizeof(buf)) <= 0 ||
     strcmp(buf, "cpu") != 0)
  return (0);
# 229 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c"
 return (1);
}
 ...
 void *aux;
{
 ...
 if ((cputyp == 3) || (cputyp == 4))
  ver = getver();
 impl = ((((u_int64_t)(ver))&0x0000ffff00000000ULL) >> 32);
 vers = ((((u_int64_t)(ver))&0x00000000ff000000ULL) >> 24);
...
cpu_myid(void)
{
 ...
 if (OF_getprop(findroot(), "name", buf, sizeof(buf)) > 0 &&
  ...
  return (__builtin_constant_p(0x15) ? ({ u_int32_t __rlduwu_int32_t; if(0x15 == 0x80 || (sizeof(u_int32_t) == 1 && 0x15 == 0x88)) __rlduwu_int32_t = *((volatile u_int32_t *)(0x1fff40000d0UL)); else __asm volatile("lduwa" " [%1] " "0x15" ", %0" : "=r" (__rlduwu_int32_t) : "r" ((volatile u_int32_t *)(0x1fff40000d0UL)) : "%g0"); __rlduwu_int32_t; }) : lduwa_nc((0x1fff40000d0UL), 0x15));

 impl = (getver() & 0x0000ffff00000000ULL) >> 32;
 switch (impl) {
 case 0x06:
 case 0x07:
  return (((__builtin_constant_p(0x4a) ? ({ u_int64_t __rldxu_int64_t; if(0x4a == 0x80 || (sizeof(u_int64_t) == 1 && 0x4a == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0)); else __asm volatile("ldxa" " [%1] " "0x4a" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0), 0x4a))) & 0x3ff);
 case 0x14:
 case 0x15:
 case 0x18:
 case 0x19:
  return ((((__builtin_constant_p(0x4a) ? ({ u_int64_t __rldxu_int64_t; if(0x4a == 0x80 || (sizeof(u_int64_t) == 1 && 0x4a == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0)); else __asm volatile("ldxa" " [%1] " "0x4a" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0), 0x4a))) >> 17) & 0x3ff);
 default:
  return ((((__builtin_constant_p(0x4a) ? ({ u_int64_t __rldxu_int64_t; if(0x4a == 0x80 || (sizeof(u_int64_t) == 1 && 0x4a == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0)); else __asm volatile("ldxa" " [%1] " "0x4a" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0), 0x4a))) >> 17) & 0x1f);
 }
}
...
cpu_init(struct cpu_info *ci)
{
 ...
 pa += ( ( ( 0x0e0000000 + 8*8192) + 2*(2 * (1 << 13)))) - ( 0x0e0000000 + 8*8192);
 pa += (1 << 13);

 ci->ci_cpumq = pa;
 err = hv_cpu_qconf(0x3c, ci->ci_cpumq, 32);
 if (err != 0)
  panic("Unable to set cpu mondo queue: %d", err);
 pa += 32 * 64;

 ci->ci_devmq = pa;
 err = hv_cpu_qconf(0x3d, ci->ci_devmq, 32);
 if (err != 0)
...
# 505 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c"
int hummingbird_divisors[5];
...
hummingbird_enable_self_refresh(void)
{
 ...
 reg64 = (__builtin_constant_p(0x15) ? ({ u_int64_t __rldxu_int64_t; if(0x15 == 0x80 || (sizeof(u_int64_t) == 1 && 0x15 == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0x1fe0000f010ULL)); else __asm volatile("ldxa" " [%1] " "0x15" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0x1fe0000f010ULL)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0x1fe0000f010ULL), 0x15));
 reg64 |= 0x00010000;
 (__builtin_constant_p(0x15) ? ({ if((0x15) == 0x80 || (sizeof(u_int64_t) == 1 && (0x15) == 0x88)) *((volatile u_int64_t *)(0x1fe0000f010ULL)) = (reg64); else __asm volatile("stxa" " %0, [%1] " "(0x15)" : : "r" ((reg64)), "r" ((volatile u_int64_t *)(0x1fe0000f010ULL)) : "memory"); }) : stxa_nc((0x1fe0000f010ULL), 0x15, (reg64)));
 reg64 = (__builtin_constant_p(0x15) ? ({ u_int64_t __rldxu_int64_t; if(0x15 == 0x80 || (sizeof(u_int64_t) == 1 && 0x15 == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0x1fe0000f010ULL)); else __asm volatile("ldxa" " [%1] " "0x15" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0x1fe0000f010ULL)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0x1fe0000f010ULL), 0x15));
}
...
hummingbird_set_refresh_count(int div, int new_div)
{
 ...
 reg64 = (__builtin_constant_p(0x15) ? ({ u_int64_t __rldxu_int64_t; if(0x15 == 0x80 || (sizeof(u_int64_t) == 1 && 0x15 == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0x1fe0000f010ULL)); else __asm volatile("ldxa" " [%1] " "0x15" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0x1fe0000f010ULL)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0x1fe0000f010ULL), 0x15));
 count = (((reg64) & 0x00007f00) >> 8);
 new_count = (7800ULL * cpu_clockrate[0]) /
  (64ULL * new_div * 1000000000);
 reg64 &= ~0x00007f00;
 reg64 |= (new_count << 8);
 (__builtin_constant_p(0x15) ? ({ if((0x15) == 0x80 || (sizeof(u_int64_t) == 1 && (0x15) == 0x88)) *((volatile u_int64_t *)(0x1fe0000f010ULL)) = (reg64); else __asm volatile("stxa" " %0, [%1] " "(0x15)" : : "r" ((reg64)), "r" ((volatile u_int64_t *)(0x1fe0000f010ULL)) : "memory"); }) : stxa_nc((0x1fe0000f010ULL), 0x15, (reg64)));
 reg64 = (__builtin_constant_p(0x15) ? ({ u_int64_t __rldxu_int64_t; if(0x15 == 0x80 || (sizeof(u_int64_t) == 1 && 0x15 == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0x1fe0000f010ULL)); else __asm volatile("ldxa" " [%1] " "0x15" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0x1fe0000f010ULL)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0x1fe0000f010ULL), 0x15));

 if (new_div > div && (reg64 & 0x00010000) == 0) {
  delta = 64ULL *
...
hummingbird_setperf(int level)
{
 ...
 new_estar_mode = 0x00000000;
 for (i = 0; i < 5 && hummingbird_divisors[i]; i++) {
  if (level <= 100 / hummingbird_divisors[i])
   new_estar_mode =
       hummingbird_estar_mode(hummingbird_divisors[i]);
 }

 reg64 = (__builtin_constant_p(0x15) ? ({ u_int64_t __rldxu_int64_t; if(0x15 == 0x80 || (sizeof(u_int64_t) == 1 && 0x15 == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(0x1fe0000f080ULL)); else __asm volatile("ldxa" " [%1] " "0x15" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(0x1fe0000f080ULL)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((0x1fe0000f080ULL), 0x15));
 estar_mode = reg64 & 0x00000007;
 ...
 s = intr_disable();
 if (estar_mode == 0x00000000 &&
     new_estar_mode == 0x00000001) {
  hummingbird_set_refresh_count(1, 2);
  (__builtin_constant_p(0x15) ? ({ if((0x15) == 0x80 || (sizeof(u_int64_t) == 1 && (0x15) == 0x88)) *((volatile u_int64_t *)(0x1fe0000f080ULL)) = (reg64 | 0x00000001); else __asm volatile("stxa" " %0, [%1] " "(0x15)" : : "r" ((reg64 | 0x00000001)), "r" ((volatile u_int64_t *)(0x1fe0000f080ULL)) : "memory"); }) : stxa_nc((0x1fe0000f080ULL), 0x15, (reg64 | 0x00000001)));
  delay(1);
  hummingbird_enable_self_refresh();
 } else if (estar_mode == 0x00000001 &&
     new_estar_mode == 0x00000000) {
  hummingbird_disable_self_refresh();
  (__builtin_constant_p(0x15) ? ({ if((0x15) == 0x80 || (sizeof(u_int64_t) == 1 && (0x15) == 0x88)) *((volatile u_int64_t *)(0x1fe0000f080ULL)) = (reg64 | 0x00000000); else __asm volatile("stxa" " %0, [%1] " "(0x15)" : : "r" ((reg64 | 0x00000000)), "r" ((volatile u_int64_t *)(0x1fe0000f080ULL)) : "memory"); }) : stxa_nc((0x1fe0000f080ULL), 0x15, (reg64 | 0x00000000)));
  delay(1);
  hummingbird_set_refresh_count(2, 1);
 } else if (estar_mode == 0x00000000) {
  ...
  (__builtin_constant_p(0x15) ? ({ if((0x15) == 0x80 || (sizeof(u_int64_t) == 1 && (0x15) == 0x88)) *((volatile u_int64_t *)(0x1fe0000f080ULL)) = (reg64 | new_estar_mode); else __asm volatile("stxa" " %0, [%1] " "(0x15)" : : "r" ((reg64 | new_estar_mode)), "r" ((volatile u_int64_t *)(0x1fe0000f080ULL)) : "memory"); }) : stxa_nc((0x1fe0000f080ULL), 0x15, (reg64 | new_estar_mode)));
  delay(1);
 } else if (new_estar_mode == 0x00000000) {
...
cpu_boot_secondary_processors(void)
{
 ...
 if (OF_getprop(findroot(), "name", buf, sizeof(buf)) > 0 &&
  ...
  for (ci = cpus; ci != ((void *)0); ci = ci->ci_next)
   ci->ci_itid = (((ci->ci_upaid & 0x3c) << 1) | ((ci->ci_upaid & 0x40) >> 4) | (ci->ci_upaid & 0x3));
 } else {
  for (ci = cpus; ci != ((void *)0); ci = ci->ci_next)
...
cpu_hatch(void)
{
 ...
 cpu_switchto(((void *)0), sched_chooseproc());
}
...
# 772 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c"
void
cpu_idle_enter(void)
{
 if ((cputyp == 5)) {
  do { if (__builtin_constant_p(0)) __asm volatile("wrpr %%g0, %0, %%" "pstate" : : "rI" ((sparc_rdpr_pstate() & ~0x002) ^ (0)) : "%g0"); else __asm volatile("wrpr %0, %1, %%" "pstate" : : "r" (sparc_rdpr_pstate() & ~0x002), "rI" (0) : "%g0"); __asm volatile("" : : : "memory"); } while(0);
 }
}
...
# 797 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/cpu.c"
 __asm volatile(
  "999:	nop					\n"
