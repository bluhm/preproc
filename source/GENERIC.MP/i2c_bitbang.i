# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_bitbang.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_bitbang.c"
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_bitbang.c"
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_bitbang.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_bitbang.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_bitbang.h" 1
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_bitbang.h"
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_bitbang.c" 2
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/i2c_bitbang.c"
...
i2c_wait_for_scl(void *v, i2c_bitbang_ops_t ops)
{
 ...
 while(((ops->ibo_read_bits(v) & ops->ibo_bits[1]) == 0) && bail < 1000) {
  delay(1);
  bail++;
 }
 if (bail == 1000) {
...
i2c_bitbang_send_start(void *v, int flags, i2c_bitbang_ops_t ops)
{
 ...
 ops->ibo_set_dir(v, (ops->ibo_bits[2]));

 ops->ibo_set_bits(v, (ops->ibo_bits[0] | ops->ibo_bits[1]));
 delay(5);
 ops->ibo_set_bits(v, (ops->ibo_bits[1]));
 if (i2c_wait_for_scl(v, ops) != 0)
  return (5);
 delay(4);
 ops->ibo_set_bits(v, (0));
 delay(5);
    ...
    i2c_bitbang_ops_t ops)
{
 ...
 i2caddr = (addr << 1) | ((flags & 0x01) ? 1 : 0);

 (void) i2c_bitbang_send_start(v, flags, ops);
 return (i2c_bitbang_write_byte(v, i2caddr, flags & ~0x04, ops));
}
    ...
    i2c_bitbang_ops_t ops)
{
 ...
 ops->ibo_set_dir(v, (ops->ibo_bits[3]));
 ops->ibo_set_bits(v, (ops->ibo_bits[0]));
 ...
 for (i = 0; i < 8; i++) {
  ...
  if (i2c_wait_for_scl(v, ops) != 0)
   return (5);
  delay(4);
  if (ops->ibo_read_bits(v) & ops->ibo_bits[0])
   val |= 1;
  ops->ibo_set_bits(v, (ops->ibo_bits[0]));
  delay(5);
 }

 bit = (flags & 0x02) ? ops->ibo_bits[0] : 0;
 ops->ibo_set_dir(v, (ops->ibo_bits[2]));
 ops->ibo_set_bits(v, (bit));
 delay(1);
 ops->ibo_set_bits(v, (bit | ops->ibo_bits[1]));
 if (i2c_wait_for_scl(v, ops) != 0)
  return (5);
 delay(4);
 ops->ibo_set_bits(v, (bit));
    ...
    i2c_bitbang_ops_t ops)
{
 ...
 if (i2c_wait_for_scl(v, ops) != 0)
  return (5);
 delay(4);
 error = (ops->ibo_read_bits(v) & ops->ibo_bits[0]) ? 5 : 0;
 ops->ibo_set_bits(v, (ops->ibo_bits[0]));
 delay(5);
