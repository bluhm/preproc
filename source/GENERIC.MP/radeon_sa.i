         ...
         unsigned size, u32 align, u32 domain, u32 flags)
{
 ...
 if (r) {
  printf("drm:pid%d:%s *ERROR* " "(%d) failed to allocate bo for manager\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 return r;
}
          ...
          struct radeon_sa_manager *sa_manager)
{
 ...
 if (!list_empty(&sa_manager->olist)) {
  ...
  if (!list_empty(&sa_manager->olist)) {
   printf("drm:pid%d:%s *ERROR* " "sa_manager is not empty, clearing anyway\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  }
 }
 for (sa_bo = ({ const __typeof( ((__typeof(*sa_bo) *)0)->olist ) *__mptr = ((&sa_manager->olist)->next); (__typeof(*sa_bo) *)( (char *)__mptr - __builtin_offsetof(__typeof(*sa_bo), olist) );}), tmp = ({ const __typeof( ((__typeof(*sa_bo) *)0)->olist ) *__mptr = (sa_bo->olist.next); (__typeof(*sa_bo) *)( (char *)__mptr - __builtin_offsetof(__typeof(*sa_bo), olist) );}); &sa_bo->olist != (&sa_manager->olist); sa_bo = tmp, tmp = ({ const __typeof( ((__typeof(*tmp) *)0)->olist ) *__mptr = (tmp->olist.next); (__typeof(*tmp) *)( (char *)__mptr - __builtin_offsetof(__typeof(*tmp), olist) );})) {
          ...
          struct radeon_sa_manager *sa_manager)
{
 ...
 if (sa_manager->bo == ((void *)0)) {
  printf("drm:pid%d:%s *ERROR* " "no bo for sa manager\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -22;
 }
 r = radeon_bo_reserve(sa_manager->bo, 0);
 if (r) {
  printf("drm:pid%d:%s *ERROR* " "(%d) failed to reserve manager bo\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 r = radeon_bo_pin(sa_manager->bo, sa_manager->domain, &sa_manager->gpu_addr);
 if (r) {
  radeon_bo_unreserve(sa_manager->bo);
  printf("drm:pid%d:%s *ERROR* " "(%d) failed to pin manager bo\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
...
static void radeon_sa_bo_try_free(struct radeon_sa_manager *sa_manager)
{
 ...
 if (sa_manager->hole->next == &sa_manager->olist)
  return;
 sa_bo = ({ const __typeof( ((struct radeon_sa_bo *)0)->olist ) *__mptr = (sa_manager->hole->next); (struct radeon_sa_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_sa_bo, olist) );});
 for (tmp = ({ const __typeof( ((__typeof(*sa_bo) *)0)->olist ) *__mptr = (sa_bo->olist.next); (__typeof(*sa_bo) *)( (char *)__mptr - __builtin_offsetof(__typeof(*sa_bo), olist) );}); &sa_bo->olist != (&sa_manager->olist); sa_bo = tmp, tmp = ({ const __typeof( ((__typeof(*tmp) *)0)->olist ) *__mptr = (tmp->olist.next); (__typeof(*tmp) *)( (char *)__mptr - __builtin_offsetof(__typeof(*tmp), olist) );})) {
  if (sa_bo->fence == ((void *)0) || !radeon_fence_signaled(sa_bo->fence)) {
   return;
  }
  radeon_sa_bo_remove_locked(sa_bo);
 }
...
static inline unsigned radeon_sa_bo_hole_soffset(struct radeon_sa_manager *sa_manager)
{
 ...
 if (hole != &sa_manager->olist) {
  return ({ const __typeof( ((struct radeon_sa_bo *)0)->olist ) *__mptr = (hole); (struct radeon_sa_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_sa_bo, olist) );})->eoffset;
 }
 return 0;
}
static inline unsigned radeon_sa_bo_hole_eoffset(struct radeon_sa_manager *sa_manager)
{
 ...
 if (hole->next != &sa_manager->olist) {
  return ({ const __typeof( ((struct radeon_sa_bo *)0)->olist ) *__mptr = (hole->next); (struct radeon_sa_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_sa_bo, olist) );})->soffset;
 }
 return sa_manager->size;
}
static _Bool radeon_sa_bo_try_alloc(struct radeon_sa_manager *sa_manager,
       struct radeon_sa_bo *sa_bo,
       unsigned size, unsigned align)
{
...
static _Bool radeon_sa_event(struct radeon_sa_manager *sa_manager,
       unsigned size, unsigned align)
{
 unsigned soffset, eoffset, wasted;
 int i;
...
static _Bool radeon_sa_bo_next_hole(struct radeon_sa_manager *sa_manager,
       struct radeon_fence **fences,
       unsigned *tries)
{
 struct radeon_sa_bo *best_bo = ((void *)0);
 ...
 for (i = 0; i < 8; ++i) {
  ...
  sa_bo = ({ const __typeof( ((struct radeon_sa_bo *)0)->flist ) *__mptr = ((&sa_manager->flist[i])->next); (struct radeon_sa_bo *)( (char *)__mptr - __builtin_offsetof(struct radeon_sa_bo, flist) );});
...
int radeon_sa_bo_new(struct radeon_device *rdev,
       ...
       unsigned size, unsigned align)
{
 struct radeon_fence *fences[8];
 unsigned tries[8];
 int i, r;
 ((!(align > sa_manager->align)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_sa.c", 321, "!(align > sa_manager->align)"));
 ((!(size > sa_manager->size)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_sa.c", 322, "!(size > sa_manager->size)"));
 *sa_bo = kmalloc(sizeof(struct radeon_sa_bo), (0x0001 | 0x0004));
 if ((*sa_bo) == ((void *)0)) {
  return -12;
 }
 (*sa_bo)->manager = sa_manager;
 ...
 INIT_LIST_HEAD(&(*sa_bo)->flist);
 __mtx_enter(&sa_manager->wq.lock );
 do {
  for (i = 0; i < 8; ++i) {
   fences[i] = ((void *)0);
   tries[i] = 0;
  ...
  do {
   ...
   if (radeon_sa_bo_try_alloc(sa_manager, *sa_bo,
         size, align)) {
    __mtx_leave(&sa_manager->wq.lock );
    return 0;
   }
  ...
  __mtx_enter(&sa_manager->wq.lock );
  if (r == -2) {
   r = ({ int __ret = 0; if (!(radeon_sa_event(sa_manager, size, align))) __ret = ({ long ret = 0; do { int deadline, __error; ((!cold) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_sa.c", 365, "!cold")); __mtx_enter(&sch_mtx ); ((void)_atomic_add_int_nv((&(sa_manager->wq).count), 1)); deadline = ticks + ret; __error = msleep(&sa_manager->wq, &sch_mtx, 0x100, "drmweti", ret); ret = deadline - ticks; ((void)_atomic_sub_int_nv((&(sa_manager->wq).count), 1)); if (__error == -1 || __error == 4) { ret = -4; __mtx_leave(&sch_mtx ); break; } if (0 && (ret <= 0 || __error == 35)) { __mtx_leave(&sch_mtx ); ret = ((radeon_sa_event(sa_manager, size, align))) ? 1 : 0; break; } __mtx_leave(&sch_mtx ); } while (ret > 0 && !(radeon_sa_event(sa_manager, size, align))); ret; }); __ret; });
  }
 } while (!r);
 __mtx_leave(&sa_manager->wq.lock );
 kfree(*sa_bo);
