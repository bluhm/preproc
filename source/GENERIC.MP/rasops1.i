# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c" 2
...
# 104 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c"
...
rasops1_putchar8(void *cookie, int row, int col, u_int uc, long attr)
{
 ...
 ri = (struct rasops_info *)cookie;
# 248 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c"
...
rasops1_putchar16(void *cookie, int row, int col, u_int uc, long attr)
{
 ...
 ri = (struct rasops_info *)cookie;
# 311 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c"
 rp = ri->ri_bits + row * ri->ri_yscale + col * ri->ri_xscale;
 height = ri->ri_font->fontheight;
 rs = ri->ri_stride;
...
# 361 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops_bitops.h" 1
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops_bitops.h"
int
rasops1_erasecols(void *cookie, int row, int col, int num, long attr)
{
 ...
 ri = (struct rasops_info *)cookie;
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops_bitops.h"
 col *= ri->ri_font->fontwidth << 0;
 num *= ri->ri_font->fontwidth << 0;
 height = ri->ri_font->fontheight;
...
int
rasops1_do_cursor(struct rasops_info *ri)
{
 int lmask, rmask, height, row, col, num;
 int32_t *dp, *rp;

 row = ri->ri_crow;
 col = ri->ri_ccol * ri->ri_font->fontwidth << 0;
 height = ri->ri_font->fontheight;
 num = ri->ri_font->fontwidth << 0;
 rp = (int32_t *)(ri->ri_bits + row * ri->ri_yscale + ((col >> 3) & ~3));
...
int
rasops1_copycols(void *cookie, int row, int src, int dst, int num)
{
 ...
 ri = (struct rasops_info *)cookie;
# 194 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops_bitops.h"
 cnt = ri->ri_font->fontwidth << 0;
 src *= cnt;
 dst *= cnt;
 num *= cnt;
 row *= ri->ri_yscale;
 ...
 if (db + num <= 32) {
  ...
  while (height--) {
   do { tmp = (((sb)) > 31 ? 0 : (*(srp)) >> ((sb))); if (((sb) + (num)) > 32) tmp |= (((32 - (sb)) > 31 ? 0 : ((srp)[1]) << (32 - (sb)))); } while(0);;
   do { int n = (db) + (num) - 32; if (n <= 0) { n = rasops_pmask[db & 31][num & 31]; *(drp) = (*(drp) & ~n) | (((db) > 31 ? 0 : (tmp) << (db)) & n); } else { *(drp) = (*(drp) & rasops_rmask[db]) | (((db) > 31 ? 0 : ((tmp)) << (db))); (drp)[1] = ((drp)[1] & rasops_rmask[n]) | (((32-(db)) > 31 ? 0 : (tmp) >> (32-(db))) & rasops_lmask[n]); } } while(0);;
   ((srp) = (int32_t *)((caddr_t)(srp) + (ri->ri_stride)));
   ((drp) = (int32_t *)((caddr_t)(drp) + (ri->ri_stride)));
  }
 ...
 if (src < dst && src + num > dst) {
  ...
  while (height--) {
   ...
   if (db) {
    do { tmp = (((src)) > 31 ? 0 : (*(sp)) >> ((src))); if (((src) + (db)) > 32) tmp |= (((32 - (src)) > 31 ? 0 : ((sp)[1]) << (32 - (src)))); } while(0);;
    do { int n = (0) + (db) - 32; if (n <= 0) { n = rasops_pmask[0 & 31][db & 31]; *(dp) = (*(dp) & ~n) | (((0) > 31 ? 0 : (tmp) << (0)) & n); } else { *(dp) = (*(dp) & rasops_rmask[0]) | (((0) > 31 ? 0 : ((tmp)) << (0))); (dp)[1] = ((dp)[1] & rasops_rmask[n]) | (((32-(0)) > 31 ? 0 : (tmp) >> (32-(0))) & rasops_lmask[n]); } } while(0);;
    dp--;
    sp--;
   }
   ...
   for (cnt = full; cnt; cnt--, sp--) {
    do { tmp = (((src)) > 31 ? 0 : (*(sp)) >> ((src))); if (((src) + (32)) > 32) tmp |= (((32 - (src)) > 31 ? 0 : ((sp)[1]) << (32 - (src)))); } while(0);;
    *dp-- = tmp;
   }
   ...
   if (lmask) {
    ...
    do { tmp = (((sb)) > 31 ? 0 : (*(sp)) >> ((sb))); if (((sb) + (lnum)) > 32) tmp |= (((32 - (sb)) > 31 ? 0 : ((sp)[1]) << (32 - (sb)))); } while(0);;
    do { int n = (rnum) + (lnum) - 32; if (n <= 0) { n = rasops_pmask[rnum & 31][lnum & 31]; *(dp) = (*(dp) & ~n) | (((rnum) > 31 ? 0 : (tmp) << (rnum)) & n); } else { *(dp) = (*(dp) & rasops_rmask[rnum]) | (((rnum) > 31 ? 0 : ((tmp)) << (rnum))); (dp)[1] = ((dp)[1] & rasops_rmask[n]) | (((32-(rnum)) > 31 ? 0 : (tmp) >> (32-(rnum))) & rasops_lmask[n]); } } while(0);;
    }
   }
 } else {
  ...
  while (height--) {
   ...
   if (lmask) {
    do { tmp = (((sb)) > 31 ? 0 : (*(sp)) >> ((sb))); if (((sb) + (lnum)) > 32) tmp |= (((32 - (sb)) > 31 ? 0 : ((sp)[1]) << (32 - (sb)))); } while(0);;
    do { int n = (db) + (lnum) - 32; if (n <= 0) { n = rasops_pmask[db & 31][lnum & 31]; *(dp) = (*(dp) & ~n) | (((db) > 31 ? 0 : (tmp) << (db)) & n); } else { *(dp) = (*(dp) & rasops_rmask[db]) | (((db) > 31 ? 0 : ((tmp)) << (db))); (dp)[1] = ((dp)[1] & rasops_rmask[n]) | (((32-(db)) > 31 ? 0 : (tmp) >> (32-(db))) & rasops_lmask[n]); } } while(0);;
    dp++;
   ...
   for (cnt = full; cnt; cnt--, sp++) {
    do { tmp = (((sb)) > 31 ? 0 : (*(sp)) >> ((sb))); if (((sb) + (32)) > 32) tmp |= (((32 - (sb)) > 31 ? 0 : ((sp)[1]) << (32 - (sb)))); } while(0);;
    *dp++ = tmp;
   }

   if (rmask) {
    do { tmp = (((sb)) > 31 ? 0 : (*(sp)) >> ((sb))); if (((sb) + (rnum)) > 32) tmp |= (((32 - (sb)) > 31 ? 0 : ((sp)[1]) << (32 - (sb)))); } while(0);;
    do { int n = (0) + (rnum) - 32; if (n <= 0) { n = rasops_pmask[0 & 31][rnum & 31]; *(dp) = (*(dp) & ~n) | (((0) > 31 ? 0 : (tmp) << (0)) & n); } else { *(dp) = (*(dp) & rasops_rmask[0]) | (((0) > 31 ? 0 : ((tmp)) << (0))); (dp)[1] = ((dp)[1] & rasops_rmask[n]) | (((32-(0)) > 31 ? 0 : (tmp) >> (32-(0))) & rasops_lmask[n]); } } while(0);;
    }
   }
  }
...
# 361 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/rasops/rasops1.c" 2
