...
{
 if (ring->idx == 6)
  return r100_mm_rreg(rdev, (0x2018c), 0);
 else
  return r100_mm_rreg(rdev, (0x20178), 0);
}
uint32_t vce_v1_0_get_wptr(struct radeon_device *rdev,
      struct radeon_ring *ring)
{
 if (ring->idx == 6)
  return r100_mm_rreg(rdev, (0x20190), 0);
 else
  return r100_mm_rreg(rdev, (0x2017c), 0);
}
void vce_v1_0_set_wptr(struct radeon_device *rdev,
         struct radeon_ring *ring)
{
 if (ring->idx == 6)
  r100_mm_wreg(rdev, (0x20190), (ring->wptr), 0);
 else
  r100_mm_wreg(rdev, (0x2017c), (ring->wptr), 0);
}
void vce_v1_0_enable_mgcg(struct radeon_device *rdev, _Bool enable)
{
 u32 tmp;
 if (enable && (rdev->cg_flags & (1 << 14))) {
  tmp = r100_mm_rreg(rdev, (0x202f8), 0);
  tmp |= (1 << 16);
  r100_mm_wreg(rdev, (0x202f8), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x205bc), 0);
  tmp &= ~0x1ff000;
  tmp |= 0xff800000;
  r100_mm_wreg(rdev, (0x205bc), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x205c0), 0);
  tmp &= ~0x3ff;
  r100_mm_wreg(rdev, (0x205c0), (tmp), 0);
 } else {
  tmp = r100_mm_rreg(rdev, (0x202f8), 0);
  tmp &= ~(1 << 16);
  r100_mm_wreg(rdev, (0x202f8), (tmp), 0);
...
static void vce_v1_0_init_cg(struct radeon_device *rdev)
{
 ...
 tmp |= (1 << 16);
 r100_mm_wreg(rdev, (0x202f8), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x202fc), 0);
 tmp |= 0x1e;
 tmp &= ~0xe100e1;
 r100_mm_wreg(rdev, (0x202fc), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x205bc), 0);
 tmp &= ~0xff9ff000;
 r100_mm_wreg(rdev, (0x205bc), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x205c0), 0);
...
int vce_v1_0_load_fw(struct radeon_device *rdev, uint32_t *data)
{
 ...
 for (i = 0; i < (__uint32_t)(__builtin_constant_p(sign->num) ? (__uint32_t)(((__uint32_t)(sign->num) & 0xff) << 24 | ((__uint32_t)(sign->num) & 0xff00) << 8 | ((__uint32_t)(sign->num) & 0xff0000) >> 8 | ((__uint32_t)(sign->num) & 0xff000000) >> 24) : __swap32md(sign->num)); ++i) {
  if ((__uint32_t)(__builtin_constant_p(sign->val[i].chip_id) ? (__uint32_t)(((__uint32_t)(sign->val[i].chip_id) & 0xff) << 24 | ((__uint32_t)(sign->val[i].chip_id) & 0xff00) << 8 | ((__uint32_t)(sign->val[i].chip_id) & 0xff0000) >> 8 | ((__uint32_t)(sign->val[i].chip_id) & 0xff000000) >> 24) : __swap32md(sign->val[i].chip_id)) == chip_id)
   break;
 }
 if (i == (__uint32_t)(__builtin_constant_p(sign->num) ? (__uint32_t)(((__uint32_t)(sign->num) & 0xff) << 24 | ((__uint32_t)(sign->num) & 0xff00) << 8 | ((__uint32_t)(sign->num) & 0xff0000) >> 8 | ((__uint32_t)(sign->num) & 0xff000000) >> 24) : __swap32md(sign->num)))
  return -22;
 data += (256 - 64) / 4;
 ...
 data[4] = (__uint32_t)(__builtin_constant_p((__uint32_t)(__builtin_constant_p(sign->len) ? (__uint32_t)(((__uint32_t)(sign->len) & 0xff) << 24 | ((__uint32_t)(sign->len) & 0xff00) << 8 | ((__uint32_t)(sign->len) & 0xff0000) >> 8 | ((__uint32_t)(sign->len) & 0xff000000) >> 24) : __swap32md(sign->len)) + 64) ? (__uint32_t)(((__uint32_t)((__uint32_t)(__builtin_constant_p(sign->len) ? (__uint32_t)(((__uint32_t)(sign->len) & 0xff) << 24 | ((__uint32_t)(sign->len) & 0xff00) << 8 | ((__uint32_t)(sign->len) & 0xff0000) >> 8 | ((__uint32_t)(sign->len) & 0xff000000) >> 24) : __swap32md(sign->len)) + 64) & 0xff) << 24 | ((__uint32_t)((__uint32_t)(__builtin_constant_p(sign->len) ? (__uint32_t)(((__uint32_t)(sign->len) & 0xff) << 24 | ((__uint32_t)(sign->len) & 0xff00) << 8 | ((__uint32_t)(sign->len) & 0xff0000) >> 8 | ((__uint32_t)(sign->len) & 0xff000000) >> 24) : __swap32md(sign->len)) + 64) & 0xff00) << 8 | ((__uint32_t)((__uint32_t)(__builtin_constant_p(sign->len) ? (__uint32_t)(((__uint32_t)(sign->len) & 0xff) << 24 | ((__uint32_t)(sign->len) & 0xff00) << 8 | ((__uint32_t)(sign->len) & 0xff0000) >> 8 | ((__uint32_t)(sign->len) & 0xff000000) >> 24) : __swap32md(sign->len)) + 64) & 0xff0000) >> 8 | ((__uint32_t)((__uint32_t)(__builtin_constant_p(sign->len) ? (__uint32_t)(((__uint32_t)(sign->len) & 0xff) << 24 | ((__uint32_t)(sign->len) & 0xff00) << 8 | ((__uint32_t)(sign->len) & 0xff0000) >> 8 | ((__uint32_t)(sign->len) & 0xff000000) >> 24) : __swap32md(sign->len)) + 64) & 0xff000000) >> 24) : __swap32md((__uint32_t)(__builtin_constant_p(sign->len) ? (__uint32_t)(((__uint32_t)(sign->len) & 0xff) << 24 | ((__uint32_t)(sign->len) & 0xff00) << 8 | ((__uint32_t)(sign->len) & 0xff0000) >> 8 | ((__uint32_t)(sign->len) & 0xff000000) >> 24) : __swap32md(sign->len)) + 64));
 __builtin_memset((&data[5]), (0), (44));
 __builtin_memcpy((&data[16]), (&sign[1]), (rdev->vce_fw->size - sizeof(*sign)));
 data += (__uint32_t)(__builtin_constant_p(data[4]) ? (__uint32_t)(((__uint32_t)(data[4]) & 0xff) << 24 | ((__uint32_t)(data[4]) & 0xff00) << 8 | ((__uint32_t)(data[4]) & 0xff0000) >> 8 | ((__uint32_t)(data[4]) & 0xff000000) >> 24) : __swap32md(data[4])) / 4;
 data[0] = sign->val[i].sigval[0];
 data[1] = sign->val[i].sigval[1];
 data[2] = sign->val[i].sigval[2];
 data[3] = sign->val[i].sigval[3];
 rdev->vce.keyselect = (__uint32_t)(__builtin_constant_p(sign->val[i].keyselect) ? (__uint32_t)(((__uint32_t)(sign->val[i].keyselect) & 0xff) << 24 | ((__uint32_t)(sign->val[i].keyselect) & 0xff00) << 8 | ((__uint32_t)(sign->val[i].keyselect) & 0xff0000) >> 8 | ((__uint32_t)(sign->val[i].keyselect) & 0xff000000) >> 24) : __swap32md(sign->val[i].keyselect));
 return 0;
}
unsigned vce_v1_0_bo_size(struct radeon_device *rdev)
{
 ({ int __ret = !!((256 * 1024) < rdev->vce_fw->size); if (__ret) printf("WARNING %s failed at %s:%d\n", "(256 * 1024) < rdev->vce_fw->size", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/vce_v1_0.c", 211); __builtin_expect(!!(__ret), 0); });
 return (256 * 1024) + (64 * 1024) + (7808 * (16 + 1));
}
int vce_v1_0_resume(struct radeon_device *rdev)
{
 ...
 uint32_t size;
 int i;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x202f8), 0); tmp_ &= (~(1 << 16)); tmp_ |= ((0) & ~(~(1 << 16))); r100_mm_wreg(rdev, (0x202f8), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x205bc), 0); tmp_ &= (~0xFF9FF000); tmp_ |= ((0x1FF000) & ~(~0xFF9FF000)); r100_mm_wreg(rdev, (0x205bc), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x205c0), 0); tmp_ &= (~0x3F); tmp_ |= ((0x3F) & ~(~0x3F)); r100_mm_wreg(rdev, (0x205c0), (tmp_), 0); } while (0);
 r100_mm_wreg(rdev, (0x202fc), (0), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x20e20), 0); tmp_ &= (~0x4); tmp_ |= ((0x4) & ~(~0x4)); r100_mm_wreg(rdev, (0x20e20), (tmp_), 0); } while (0);
 r100_mm_wreg(rdev, (0x20e98), (0x00398000), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x20ef4), 0); tmp_ &= (~0x1); tmp_ |= ((0x0) & ~(~0x1)); r100_mm_wreg(rdev, (0x20ef4), (tmp_), 0); } while (0);
 r100_mm_wreg(rdev, (0x20eb4), (0), 0);
 r100_mm_wreg(rdev, (0x20eb8), (0), 0);
 r100_mm_wreg(rdev, (0x20ea0), (0), 0);
 r100_mm_wreg(rdev, (0x200dc), (16), 0);
 addr += 256;
 size = (256 * 1024);
 r100_mm_wreg(rdev, (0x20024), (addr & 0x7fffffff), 0);
 r100_mm_wreg(rdev, (0x20028), (size), 0);
 addr += size;
 size = (64 * 1024);
 r100_mm_wreg(rdev, (0x2002c), (addr & 0x7fffffff), 0);
 r100_mm_wreg(rdev, (0x20030), (size), 0);
 addr += size;
 size = (7808 * (16 + 1));
 r100_mm_wreg(rdev, (0x20034), (addr & 0x7fffffff), 0);
 r100_mm_wreg(rdev, (0x20038), (size), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x20e74), 0); tmp_ &= (~0x100); tmp_ |= ((0x0) & ~(~0x100)); r100_mm_wreg(rdev, (0x20e74), (tmp_), 0); } while (0);
 r100_mm_wreg(rdev, (0x20e18), (rdev->vce.keyselect), 0);
 for (i = 0; i < 10; ++i) {
  mdelay(10);
  if (r100_mm_rreg(rdev, (0x20e10), 0) & (1 << 11))
   break;
 }
 if (i == 10)
  return -60;
 if (!(r100_mm_rreg(rdev, (0x20e10), 0) & (1 << 3)))
  return -22;
 for (i = 0; i < 10; ++i) {
  mdelay(10);
  if (!(r100_mm_rreg(rdev, (0x20e10), 0) & (1 << 0)))
   break;
 }
 if (i == 10)
  return -60;
...
int vce_v1_0_start(struct radeon_device *rdev)
{
 struct radeon_ring *ring;
 int i, j, r;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x20004), 0); tmp_ &= (~1); tmp_ |= ((1) & ~(~1)); r100_mm_wreg(rdev, (0x20004), (tmp_), 0); } while (0);
 ring = &rdev->ring[6];
 r100_mm_wreg(rdev, (0x2018c), (ring->wptr), 0);
 r100_mm_wreg(rdev, (0x20190), (ring->wptr), 0);
 r100_mm_wreg(rdev, (0x20180), (ring->gpu_addr), 0);
 r100_mm_wreg(rdev, (0x20184), (((u32)(((ring->gpu_addr) >> 16) >> 16))), 0);
 r100_mm_wreg(rdev, (0x20188), (ring->ring_size / 4), 0);
 ring = &rdev->ring[7];
 r100_mm_wreg(rdev, (0x20178), (ring->wptr), 0);
 r100_mm_wreg(rdev, (0x2017c), (ring->wptr), 0);
 r100_mm_wreg(rdev, (0x2016c), (ring->gpu_addr), 0);
 r100_mm_wreg(rdev, (0x20170), (((u32)(((ring->gpu_addr) >> 16) >> 16))), 0);
 r100_mm_wreg(rdev, (0x20174), (ring->ring_size / 4), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x20014), 0); tmp_ &= (~(1 << 0)); tmp_ |= (((1 << 0)) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x20014), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x20120), 0); tmp_ &= (~( (1 << 0) | (1 << 2))); tmp_ |= (((1 << 0) | (1 << 2)) & ~(~( (1 << 0) | (1 << 2)))); r100_mm_wreg(rdev, (0x20120), (tmp_), 0); } while (0);
 mdelay(100);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x20120), 0); tmp_ &= (~( (1 << 0) | (1 << 2))); tmp_ |= ((0) & ~(~( (1 << 0) | (1 << 2)))); r100_mm_wreg(rdev, (0x20120), (tmp_), 0); } while (0);
 for (i = 0; i < 10; ++i) {
  uint32_t status;
  for (j = 0; j < 100; ++j) {
   status = r100_mm_rreg(rdev, (0x20004), 0);
   if (status & 2)
    break;
   mdelay(10);
  }
  ...
  if (status & 2)
   break;
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "VCE not responding, trying to reset the ECPU!!!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x20120), 0); tmp_ &= (~(1 << 0)); tmp_ |= (((1 << 0)) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x20120), (tmp_), 0); } while (0);
  mdelay(10);
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x20120), 0); tmp_ &= (~(1 << 0)); tmp_ |= ((0) & ~(~(1 << 0))); r100_mm_wreg(rdev, (0x20120), (tmp_), 0); } while (0);
  mdelay(10);
  r = -1;
 }
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x20004), 0); tmp_ &= (~1); tmp_ |= ((0) & ~(~1)); r100_mm_wreg(rdev, (0x20004), (tmp_), 0); } while (0);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "VCE not responding, giving up!!!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return r;
 }
 return 0;
}
int vce_v1_0_init(struct radeon_device *rdev)
{
 ...
 ring = &rdev->ring[6];
 ring->ready = 1;
 r = (rdev)->asic->ring[(6)]->ring_test((rdev), (ring));
 if (r) {
  ring->ready = 0;
  return r;
 }
 ring = &rdev->ring[7];
 ring->ready = 1;
 r = (rdev)->asic->ring[(7)]->ring_test((rdev), (ring));
 if (r) {
  ring->ready = 0;
  return r;
 }
