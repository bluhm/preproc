# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1021.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1021.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1021.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1021.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1021.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1021.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1021.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1021.c" 2
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1021.c"
...
admtemp_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 strlcpy(sc->sc_sensor[0].desc,
     xeon ? "Xeon" : "External",
     sizeof(sc->sc_sensor[0].desc));

 sc->sc_sensor[1].type = SENSOR_TEMP;
 strlcpy(sc->sc_sensor[1].desc,
     xeon ? "Xeon" : "Internal",
     sizeof(sc->sc_sensor[1].desc));

 if (sensor_task_register(sc, admtemp_refresh, 5) == ((void *)0)) {
  printf(", unable to register update task\n");
  return;
 }

 for (i = 0; i < (sc->sc_noexternal ? 1 : 2); i++)
...
admtemp_refresh(void *arg)
{
 ...
 if (sc->sc_noexternal == 0) {
  ...
  if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP, sc->sc_addr,
   ...
   if (sdata == 0x7f) {
    sc->sc_sensor[0].flags |= 0x0001;
   } else {
    sc->sc_sensor[0].value =
