# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c"
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c"
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c" 2
...
ext2fs_bmap(void *v)
{
 ...
 if (ap->a_vpp != ((void *)0))
  *ap->a_vpp = ((struct inode *)(ap->a_vp)->v_data)->i_ump->um_devvp;
 if (ap->a_bnp == ((void *)0))
  return (0);

 if (((struct inode *)(ap->a_vp)->v_data)->dinode_u.e2fs_din->e2di_flags & 0x00080000) {
  return (ext4_bmapext(ap->a_vp, ap->a_bn, ap->a_bnp, ((void *)0), ((void *)0),
      ap->a_runp));
 }
 return (ext2fs_bmaparray(ap->a_vp, ap->a_bn, ap->a_bnp, ((void *)0), ((void *)0),
  ap->a_runp));
}
...
ext4_bmapext(struct vnode *vp, daddr_t bn, daddr_t *bnp, struct indir *ap, int *nump, int *runp)
{
 ...
 if ((*bnp = ((pos) << (fs)->e2fs_fsbtodb)) == 0)
  *bnp = -1;
 return (0);
}
# 134 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ext2fs/ext2fs_bmap.c"
int
    ...
    struct indir *ap, int *nump, int *runp)
{
 ...
 if ((ap != ((void *)0) && nump == ((void *)0)) || (ap == ((void *)0) && nump != ((void *)0)))
  ...
  *runp = 0;
  maxrun = (64 * 1024) / mp->mnt_stat.f_iosize - 1;
 }
 ...
 for (bp = ((void *)0), ++xap; --num; ++xap) {
  ...
  if (bp->b_flags & (0x00000100 | 0x00000080)) {
   ...
   bp->b_blkno = ((daddr) << (ump)->um_bptrtodb);
  ...
  if (num == 1 && daddr && runp)
   for (bn = xap->in_off + 1;
       ...
       ((((u_int32_t *)bp->b_data)[bn]) == (((u_int32_t *)bp->b_data)[bn - 1]) + ump->um_seqinc);
