# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.h" 1
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c" 2
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
     ...
     enum drm_mm_allocator_flags flags)
{
 ...
 ((!(node->allocated)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 120, "!(node->allocated)"));
 ...
 if (alignment) {
  ...
  rem = ({ uint32_t __base = (alignment); uint32_t __rem = ((uint64_t)(tmp)) % __base; (tmp) = ((uint64_t)(tmp)) / __base; __rem; });
  if (rem) {
   if (flags & DRM_MM_CREATE_TOP)
    adj_start -= rem;
   else
 ...
 ((!(adj_start < hole_start)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 141, "!(adj_start < hole_start)"));
 ((!(adj_end > hole_end)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 142, "!(adj_end > hole_end)"));
 ...
 ((!(node->start + node->size > adj_end)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 158, "!(node->start + node->size > adj_end)"));
...
# 181 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
int drm_mm_reserve_node(struct drm_mm *mm, struct drm_mm_node *node)
{
 ...
 ((!(node == ((void *)0))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 188, "!(node == ((void *)0))"));

 end = node->start + node->size;


 for (hole = ({ __typeof( ((struct drm_mm_node *)0)->hole_stack ) *__mptr = ((0) ? (mm)->hole_stack.prev : (mm)->hole_stack.next); (struct drm_mm_node *)( (char *)__mptr - __builtin_offsetof(struct drm_mm_node, hole_stack) );}); &hole->hole_stack != &(mm)->hole_stack ? hole_start = drm_mm_hole_node_start(hole), hole_end = drm_mm_hole_node_end(hole), 1 : 0; hole = ({ __typeof( ((struct drm_mm_node *)0)->hole_stack ) *__mptr = ((0) ? hole->hole_stack.prev : hole->hole_stack.next); (struct drm_mm_node *)( (char *)__mptr - __builtin_offsetof(struct drm_mm_node, hole_stack) );})) {
...
;
# 236 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
           ...
           enum drm_mm_allocator_flags flags)
{
 ...
 ((!(!hole_node->hole_follows || node->allocated)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 267, "!(!hole_node->hole_follows || node->allocated)"));
 ...
 ((!(node->start < start)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 307, "!(node->start < start)"));
 ((!(node->start < adj_start)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 308, "!(node->start < adj_start)"));
 ((!(node->start + node->size > adj_end)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 309, "!(node->start + node->size > adj_end)"));
 ((!(node->start + node->size > end)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 310, "!(node->start + node->size > end)"));
...
# 336 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
...
;
# 366 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
void drm_mm_remove_node(struct drm_mm_node *node)
{
 struct drm_mm *mm = node->mm;
 struct drm_mm_node *prev_node;

 if (({ int __ret = !!(!node->allocated); if (__ret) printf("WARNING %s failed at %s:%d\n", "!node->allocated", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 371); __builtin_expect(!!(__ret), 0); }))
  return;

 ((!(node->scanned_block || node->scanned_prev_free || node->scanned_next_free)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 375, "!(node->scanned_block || node->scanned_prev_free || node->scanned_next_free)"));


 prev_node =
     ({ __typeof( ((struct drm_mm_node *)0)->node_list ) *__mptr = (node->node_list.prev); (struct drm_mm_node *)( (char *)__mptr - __builtin_offsetof(struct drm_mm_node, node_list) );});

 if (node->hole_follows) {
  ((!(__drm_mm_hole_node_start(node) == __drm_mm_hole_node_end(node))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 382, "!(__drm_mm_hole_node_start(node) == __drm_mm_hole_node_end(node))"));

  list_del(&node->hole_stack);
 } else
  ((!(__drm_mm_hole_node_start(node) != __drm_mm_hole_node_end(node))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 386, "!(__drm_mm_hole_node_start(node) != __drm_mm_hole_node_end(node))"));
            ...
            enum drm_mm_search_flags flags)
{
 ...
 ((!(mm->scanned_blocks)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 429, "!(mm->scanned_blocks)"));

 best = ((void *)0);
 best_size = ~0UL;

 for (entry = ({ __typeof( ((struct drm_mm_node *)0)->hole_stack ) *__mptr = ((flags & DRM_MM_SEARCH_BELOW) ? (mm)->hole_stack.prev : (mm)->hole_stack.next); (struct drm_mm_node *)( (char *)__mptr - __builtin_offsetof(struct drm_mm_node, hole_stack) );}); &entry->hole_stack != &(mm)->hole_stack ? adj_start = drm_mm_hole_node_start(entry), adj_end = drm_mm_hole_node_end(entry), 1 : 0; entry = ({ __typeof( ((struct drm_mm_node *)0)->hole_stack ) *__mptr = ((flags & DRM_MM_SEARCH_BELOW) ? entry->hole_stack.prev : entry->hole_stack.next); (struct drm_mm_node *)( (char *)__mptr - __builtin_offsetof(struct drm_mm_node, hole_stack) );})) {
       ...
       enum drm_mm_search_flags flags)
{
 ...
 ((!(mm->scanned_blocks)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 473, "!(mm->scanned_blocks)"));
...
# 517 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
void drm_mm_replace_node(struct drm_mm_node *old, struct drm_mm_node *new)
{
...
;
# 575 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
void drm_mm_init_scan(struct drm_mm *mm,
        u64 size,
        unsigned alignment,
        unsigned long color)
...
;
# 608 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
void drm_mm_init_scan_with_range(struct drm_mm *mm,
     u64 size,
     unsigned alignment,
     unsigned long color,
...
;
# 638 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
_Bool drm_mm_scan_add_block(struct drm_mm_node *node)
{
 struct drm_mm *mm = node->mm;
 struct drm_mm_node *prev_node;
 ...
 ((!(node->scanned_block)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 647, "!(node->scanned_block)"));
 node->scanned_block = 1;

 prev_node = ({ __typeof( ((struct drm_mm_node *)0)->node_list ) *__mptr = (node->node_list.prev); (struct drm_mm_node *)( (char *)__mptr - __builtin_offsetof(struct drm_mm_node, node_list) );});
...
;
# 701 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
_Bool drm_mm_scan_remove_block(struct drm_mm_node *node)
{
 struct drm_mm *mm = node->mm;
 struct drm_mm_node *prev_node;
 ...
 ((!(!node->scanned_block)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c", 708, "!(!node->scanned_block)"));
...
;
# 730 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
_Bool drm_mm_clean(struct drm_mm * mm)
{
...
;
# 746 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
...
;
# 774 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_mm.c"
void drm_mm_takedown(struct drm_mm * mm)
{
 ({ int __ret = !!(!list_empty(&mm->head_node.node_list)); if (__ret) printf("Memory manager not clean during takedown.\n"); __builtin_expect(!!(__ret), 0); });
