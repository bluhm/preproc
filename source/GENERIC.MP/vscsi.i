# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsivar.h" 1
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsivar.h"
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/vscsi.c" 2
...
struct vscsi_ccb {
 struct { struct vscsi_ccb *tqe_next; struct vscsi_ccb **tqe_prev; } ccb_entry;
 int ccb_tag;
 struct scsi_xfer *ccb_xs;
 size_t ccb_datalen;
};

struct vscsi_ccb_list { struct vscsi_ccb *tqh_first; struct vscsi_ccb **tqh_last; };
...
vscsi_cmd(struct scsi_xfer *xs)
{
 ...
 int polled = ((xs->flags) & (0x00002));
 int running = 0;

 if (((xs->flags) & (0x00002)) && ((xs->flags) & (0x00001))) {
...
{
 struct vscsi_softc *sc = ((struct vscsi_softc *)device_lookup(&vscsi_cd, ((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))));
 ...
 pool_init(&sc->sc_ccb_pool, sizeof(struct vscsi_ccb), 0, 5, 0,
     "vscsiccb", ((void *)0));
...
vscsiioctl(dev_t dev, u_long cmd, caddr_t addr, int flags, struct proc *p)
{
 ...
 _rw_enter_write(&sc->sc_ioc_lock );

 switch (cmd) {
 case ((unsigned long)0x40000000 | ((sizeof(struct vscsi_ioc_i2t) & 0x1fff) << 16) | ((('I')) << 8) | ((0))):
  err = vscsi_i2t(sc, (struct vscsi_ioc_i2t *)addr);
  break;

 case ((unsigned long)0x80000000 | ((sizeof(struct vscsi_ioc_data) & 0x1fff) << 16) | ((('I')) << 8) | ((1))):
  read = 1;
 case ((unsigned long)0x80000000 | ((sizeof(struct vscsi_ioc_data) & 0x1fff) << 16) | ((('I')) << 8) | ((2))):
  err = vscsi_data(sc, (struct vscsi_ioc_data *)addr, read);
  break;

 case ((unsigned long)0x80000000 | ((sizeof(struct vscsi_ioc_t2i) & 0x1fff) << 16) | ((('I')) << 8) | ((3))):
  err = vscsi_t2i(sc, (struct vscsi_ioc_t2i *)addr);
  break;

 case ((unsigned long)0x80000000 | ((sizeof(struct vscsi_ioc_devevent) & 0x1fff) << 16) | ((('I')) << 8) | ((4))):
 case ((unsigned long)0x80000000 | ((sizeof(struct vscsi_ioc_devevent) & 0x1fff) << 16) | ((('I')) << 8) | ((5))):
...
vscsi_i2t(struct vscsi_softc *sc, struct vscsi_ioc_i2t *i2t)
{
 ...
 i2t->lun = link->lun;
 __builtin_memcpy((&i2t->cmd), (xs->cmd), (xs->cmdlen));
 ...
 do { (ccb)->ccb_entry.tqe_next = ((void *)0); (ccb)->ccb_entry.tqe_prev = (&sc->sc_ccb_t2i)->tqh_last; *(&sc->sc_ccb_t2i)->tqh_last = (ccb); (&sc->sc_ccb_t2i)->tqh_last = &(ccb)->ccb_entry.tqe_next; } while (0);
...
vscsi_data(struct vscsi_softc *sc, struct vscsi_ioc_data *data, int read)
{
 ...
 for((ccb) = ((&sc->sc_ccb_t2i)->tqh_first); (ccb) != ((void *)0); (ccb) = ((ccb)->ccb_entry.tqe_next)) {
...
vscsi_t2i(struct vscsi_softc *sc, struct vscsi_ioc_t2i *t2i)
{
 ...
 case 1:
  xs->error = 1;
  __builtin_memcpy((&xs->sense), (&t2i->sense), (sizeof(xs->sense)));
  break;
 case 2:
  xs->error = 8;
  break;
    ...
    struct vscsi_ioc_devevent *de)
{
 ...
 dt = malloc(sizeof(*dt), 127, 0x0001 | 0x0004);
 if (dt == ((void *)0))
  return (12);
...
vscsiclose(dev_t dev, int flags, int mode, struct proc *p)
{
 ...
 while ((ccb = ((&sc->sc_ccb_i2t)->tqh_first)) != ((void *)0)) {
  do { if (((ccb)->ccb_entry.tqe_next) != ((void *)0)) (ccb)->ccb_entry.tqe_next->ccb_entry.tqe_prev = (ccb)->ccb_entry.tqe_prev; else (&sc->sc_ccb_i2t)->tqh_last = (ccb)->ccb_entry.tqe_prev; *(ccb)->ccb_entry.tqe_prev = (ccb)->ccb_entry.tqe_next; ((ccb)->ccb_entry.tqe_prev) = ((void *)-1); ((ccb)->ccb_entry.tqe_next) = ((void *)-1); } while (0);
  ccb->ccb_xs->error = 8;
  vscsi_done(sc, ccb);
 }
...
vscsi_ccb_get(void *cookie)
{
 ...
 struct vscsi_ccb *ccb = ((void *)0);

 ccb = pool_get(&sc->sc_ccb_pool, 0x0002);
 if (ccb != ((void *)0)) {
