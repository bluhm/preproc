# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
void device_register(struct device *, void *);
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
...
int ifb_ident(void *);
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c" 2
# 166 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/machfb.c"
...
machfb_putcmap(struct machfb_softc *sc, struct wsdisplay_cmap *cm)
{
 ...
 bus_space_write_1(sc->sc_regt, sc->sc_regh, 0x00c2, 0xff);
 bus_space_write_1(sc->sc_regt, sc->sc_regh, 0x00c0, index);
 for (i = 0; i < count; i++) {
...
machfb_setcolor(void *v, u_int index, u_int8_t r, u_int8_t g, u_int8_t b)
{
 ...
 bus_space_write_1(sc->sc_regt, sc->sc_regh, 0x00c2, 0xff);
 bus_space_write_1(sc->sc_regt, sc->sc_regh, 0x00c0, index);
 bus_space_write_1(sc->sc_regt, sc->sc_regh, 0x00c1, r);
 bus_space_write_1(sc->sc_regt, sc->sc_regh, 0x00c1, g);
 bus_space_write_1(sc->sc_regt, sc->sc_regh, 0x00c1, b);
}
...
machfb_init(struct machfb_softc *sc)
{
 ...
 reg64 = bus_space_read_4(sc->sc_regt, sc->sc_regh, 0x00d0);
 reg64 &= ~0x00000100;
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x00d0, reg64);
 ...
 reg64 = bus_space_read_4(sc->sc_regt, sc->sc_regh, 0x00a0);
 reg64 |= 0x00800000 | 0x00200000;
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x00a0, reg64);
 ...
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0100,
     (sc->sc_sunfb.sf_linebytes / 8) << 22);

 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x010c, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0114, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0124, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0128, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x012c, 0);

 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0130,
     0x00000020 | 0x00000001 |
     0x00000002);

 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0180,
     (sc->sc_sunfb.sf_linebytes / 8) << 22);

 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x018c, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x0198, 1);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x01a4, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x01b0, 1);

 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x01b4,
     0x00000010);

 machfb_wait_fifo(sc, 13);


 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0240, 0);


 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0280, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0284, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0288, 0);


 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x02a0, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x02ac, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x02b0,
     sc->sc_sunfb.sf_height - 1);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x02a4,
     sc->sc_sunfb.sf_linebytes - 1);

 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x02c0, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x02c4, 0xffffffff);
 bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x02c8, 0xffffffff);
 bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x02d4, (0x00000007 << 16) | 0x00000003);
 ...
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0300, 0);
 bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x0304, 0xffffffff);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0308, 0);

 machfb_wait_fifo(sc, 3);

 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x02d0,
     0x00020000 | 0x00000200 | 0x00000002);
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x02cc,
     0x00008080);

 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0330,
    ...
    int w, int h)
{
 ...
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0130, dest_ctl);

 bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x018c, ((sx << 16) | (sy)));
 bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x0190, w);
 bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x010c, ((dx << 16) | (dy)));
 bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x0118, ((w << 16) | (h)));
...
machfb_fillrect(struct machfb_softc *sc, int x, int y, int w, int h, int color)
{
 machfb_wait_fifo(sc, 11);
        ...
        bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x02c8, 0xff);
        bus_space_write_4(sc->sc_regt, sc->sc_regh, 0x02c4, color);
        bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x02d8, 0x00000100);
        bus_space_write_4(sc->sc_regt, sc->sc_regh,
     0x02d4, 0x00000007 << 16);
