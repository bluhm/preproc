# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c"
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c"
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/rpcv2.h" 1
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc.h" 1
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c" 2
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c"
struct auth_info {
 u_int32_t authtype;
 u_int32_t authlen;
};
...
# 147 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c"
int
krpc_portmap(struct sockaddr_in *sin, u_int prog, u_int vers, u_int16_t *portp)
{
 ...
 if (prog == 100000) {
  *portp = ((__uint16_t)(111));
  return 0;
 }

 m = m_get(0x0001, 1);
 sdata = ((struct sdata *)((m)->m_hdr.mh_data));
 m->m_hdr.mh_len = sizeof(*sdata);


 sdata->prog = (((__uint32_t)((int32_t)(prog))));
 sdata->vers = (((__uint32_t)((int32_t)(vers))));
 sdata->proto = (((__uint32_t)((int32_t)(17))));
 sdata->port = 0;

 sin->sin_port = ((__uint16_t)(111));
 error = krpc_call(sin, 100000, 2,
     3, &m, ((void *)0), -1);
 if (error)
  return error;

 if (m->m_hdr.mh_len < sizeof(*rdata)) {
...
# 204 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c"
int
 ...
 *ip = 0;
 ...
 __builtin_bcopy((sa), (sin), ((nam->m_hdr.mh_len = sa->sin_len)));




 mhead = m_gethdr(0x0001, 1);
 mhead->m_hdr.mh_next = *data;
 call = ((struct rpc_call *)((mhead)->m_hdr.mh_data));
 mhead->m_hdr.mh_len = sizeof(*call);
 __builtin_memset((call), (0), (sizeof(*call)));

 xid = krpc_get_xid();
 call->rp_xid = (((__uint32_t)((int32_t)(xid))));

 call->rp_rpcvers = (((__uint32_t)((int32_t)(2))));
 call->rp_prog = (((__uint32_t)((int32_t)(prog))));
 call->rp_vers = (((__uint32_t)((int32_t)(vers))));
 call->rp_proc = (((__uint32_t)((int32_t)(func))));

 call->rpc_auth.authtype = (((__uint32_t)((int32_t)(1))));
 call->rpc_auth.authlen = (((__uint32_t)((int32_t)(sizeof(struct auth_unix)))));
 ...
 mhead->M_dat.MH.MH_pkthdr.len = len;
 mhead->M_dat.MH.MH_pkthdr.ph_ifidx = 0;
 ...
 for (timo = 0; retries; retries--) {
  ...
  m = m_copym(mhead, 0, 1000000000, 0x0001);
  if (m == ((void *)0)) {
   error = 55;
   goto out;
  }
  error = sosend(so, nam, ((void *)0), m, ((void *)0), 0);
  if (error) {
  ...
  if (timo < 5)
   ...
   printf("RPC timeout for server %s (0x%x) prog %u\n",
       inet_ntop(2, &sin->sin_addr,
    addr, sizeof(addr)),
       ((__uint32_t)(sin->sin_addr.s_addr)), prog);
  ...
  while (secs > 0) {
   ...
   rcvflg = 0;
   error = soreceive(so, &from, &auio, &m, ((void *)0), &rcvflg,
       0);
   if (error == 35) {
    secs--;
    continue;
   ...
   if (len < 16)
    continue;
   if (m->m_hdr.mh_len < 16)
    continue;
   reply = ((struct rpc_reply *)((m)->m_hdr.mh_data));


   if (reply->rp_direction != (((__uint32_t)((int32_t)(1)))))
    continue;

   if (reply->rp_xid != (((__uint32_t)((int32_t)(xid)))))
    continue;


   if (reply->rp_astatus != 0) {
    error = ((u_int32_t)((__uint32_t)((int32_t)(reply->rp_u.rpu_errno))));
    printf("rpc denied, error=%d\n", error);
    continue;
   }


   if (reply->rp_u.rpu_rok.rok_status != 0) {
    error = ((u_int32_t)((__uint32_t)((int32_t)(reply->rp_u.rpu_rok.rok_status))));
 ...
 reply = ((struct rpc_reply *)((m)->m_hdr.mh_data));
 if (reply->rp_u.rpu_rok.rok_auth.authtype != 0) {
  len += ((u_int32_t)((__uint32_t)((int32_t)(reply->rp_u.rpu_rok.rok_auth.authlen))));
  len = (len + 3) & ~3;
 }
 m_adj(m, len);
...
# 468 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../nfs/krpc_subr.c"
struct xdr_string {
 u_int32_t len;
 char data[4];
...
xdr_string_encode(char *str, int len)
{
 ...
 m = m_get(0x0001, 1);
 if (mlen > (256 - sizeof(struct m_hdr))) {
 ...
 xs = ((struct xdr_string *)((m)->m_hdr.mh_data));
 m->m_hdr.mh_len = mlen;
 xs->len = (((__uint32_t)((int32_t)(len))));
 __builtin_bcopy((str), (xs->data), (len));
 return (m);
}
...
xdr_string_decode(struct mbuf *m, char *str, int *len_p)
{
 ...
 xs = ((struct xdr_string *)((m)->m_hdr.mh_data));
 slen = ((u_int32_t)((__uint32_t)((int32_t)(xs->len))));
 mlen = 4 + ((slen + 3) & ~3);

 if (slen > *len_p)
  slen = *len_p;
 if (slen > m->M_dat.MH.MH_pkthdr.len) {
  m_freem(m);
  return (((void *)0));
 }
...
xdr_inaddr_encode(struct in_addr *ia)
{
 ...
 m = m_get(0x0001, 1);
 xi = ((struct xdr_inaddr *)((m)->m_hdr.mh_data));
 m->m_hdr.mh_len = sizeof(*xi);
 xi->atype = (((__uint32_t)((int32_t)(1))));
 ip = xi->addr;
 cp = (u_int8_t *)&ia->s_addr;
 *ip++ = (((__uint32_t)((int32_t)(*cp++))));
 *ip++ = (((__uint32_t)((int32_t)(*cp++))));
 *ip++ = (((__uint32_t)((int32_t)(*cp++))));
 *ip++ = (((__uint32_t)((int32_t)(*cp++))));
...
xdr_inaddr_decode(struct mbuf *m, struct in_addr *ia)
{
 ...
 if (m->m_hdr.mh_len < sizeof(*xi)) {
  m = m_pullup(m, sizeof(*xi));
  if (m == ((void *)0))
   return (((void *)0));
 }
 xi = ((struct xdr_inaddr *)((m)->m_hdr.mh_data));
 if (xi->atype != (((__uint32_t)((int32_t)(1))))) {
  ia->s_addr = ((u_int32_t) ((__uint32_t)((u_int32_t)(0x00000000))));
  goto out;
 }
 ip = xi->addr;
 cp = (u_int8_t *)&ia->s_addr;
 *cp++ = ((u_int8_t)((__uint32_t)((int32_t)(*ip++))));
 *cp++ = ((u_int8_t)((__uint32_t)((int32_t)(*ip++))));
 *cp++ = ((u_int8_t)((__uint32_t)((int32_t)(*ip++))));
 *cp++ = ((u_int8_t)((__uint32_t)((int32_t)(*ip++))));
