# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c" 2
...
# 109 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_init_ops_X550(struct ixgbe_hw *hw)
{
...
# 142 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_read_cs4227(struct ixgbe_hw *hw, uint16_t reg64, uint16_t *value)
{
 return hw->phy.ops.read_i2c_combined_unlocked(hw, 0xBE, reg64,
            value);
}
# 156 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_write_cs4227(struct ixgbe_hw *hw, uint16_t reg64, uint16_t value)
{
 return hw->phy.ops.write_i2c_combined_unlocked(hw, 0xBE, reg64,
             value);
}
# 170 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_read_pe(struct ixgbe_hw *hw, uint8_t reg64, uint8_t *value)
{
 int32_t status;

 status = hw->phy.ops.read_i2c_byte_unlocked(hw, reg64, 0xE0, value);
 if (status != 0)
  ;
 return status;
}
# 188 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_write_pe(struct ixgbe_hw *hw, uint8_t reg64, uint8_t value)
{
 int32_t status;

 status = hw->phy.ops.write_i2c_byte_unlocked(hw, reg64, 0xE0, value);
 if (status != 0)
  ;
 return status;
}
# 205 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_reset_cs4227(struct ixgbe_hw *hw)
{
 ...
 status = ixgbe_read_pe(hw, 1, &reg64);
 if (status != 0)
  return status;
 reg64 |= (1 << 1);
 status = ixgbe_write_pe(hw, 1, reg64);
 if (status != 0)
  return status;

 status = ixgbe_read_pe(hw, 3, &reg64);
 if (status != 0)
  return status;
 reg64 &= ~(1 << 1);
 status = ixgbe_write_pe(hw, 3, reg64);
 if (status != 0)
  return status;
 ...
 for (retry = 0; retry < 15; retry++) {
  status = ixgbe_read_cs4227(hw, 0x0181,
        &value);
  if (status == 0 &&
      value == 0x0001)
   break;
 ...
 status = ixgbe_read_cs4227(hw, 0x5001, &value);
 if (status != 0 ||
     !(value & 0x0001)) {
  ;
  return -3;
...
void ixgbe_check_cs4227(struct ixgbe_hw *hw)
{
 ...
 for (retry = 0; retry < 15; retry++) {
  ...
  status = ixgbe_read_cs4227(hw, 2, &value);
 ...
 status = ixgbe_write_cs4227(hw, 2,
  0x5AA5);
...
{
 uint32_t esdp = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00020);

 if (hw->bus.lan_id) {
  esdp &= ~(0x00020000 | 0x00000002);
  esdp |= 0x00000200;
 }
 esdp &= ~(0x00010000 | 0x00000100);
...
int32_t ixgbe_identify_phy_x550em(struct ixgbe_hw *hw)
{
 ...
 case 0x15AC:
  ...
  hw->phy.phy_semaphore_mask = 0x1806;
...
# 422 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_init_ops_X550EM(struct ixgbe_hw *hw)
{
 struct ixgbe_mac_info *mac = &hw->mac;
 struct ixgbe_eeprom_info *eeprom = &hw->eeprom;
...
# 441 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
...
# 492 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_init_eeprom_params_X550(struct ixgbe_hw *hw)
{
 struct ixgbe_eeprom_info *eeprom = &hw->eeprom;
 uint32_t eec;
...
# 526 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_iosf_wait(struct ixgbe_hw *hw, uint32_t *ctrl)
{
 ...
 for (i = 0; i < 100; i++) {
  command = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00011144);
  if ((command & (1 << 31)) == 0)
   break;
  delay(10);
 }
...
# 558 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_write_iosf_sb_reg_x550(struct ixgbe_hw *hw, uint32_t reg_addr,
         uint32_t device_type, uint32_t data)
{
 uint32_t gssr = 0x0004 | 0x0002;
 ...
 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00011144, command);


 bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00011148, data);

 ret = ixgbe_iosf_wait(hw, &command);

 if ((command & (0x3 << 18)) != 0) {
  error = (command & (0xFF << 20)) >>
    20;
  ;
  ret = -3;
 }
...
# 604 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_read_iosf_sb_reg_x550(struct ixgbe_hw *hw, uint32_t reg_addr,
        uint32_t device_type, uint32_t *data)
{
 uint32_t gssr = 0x0004 | 0x0002;
 ...
 if (ret == 0)
  *data = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00011148);
...
int32_t ixgbe_supported_sfp_modules_X550em(struct ixgbe_hw *hw, _Bool *linear)
{
 ;;
...
# 843 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_get_lasi_ext_t_x550em(struct ixgbe_hw *hw, _Bool *lsc)
{
 uint32_t status;
 uint16_t reg64;
 ...
 *lsc = 0;
 ...
 status = hw->phy.ops.read_reg(hw, 0xFC00,
          0x1E,
          &reg64);
 ...
 status = hw->phy.ops.read_reg(hw, 0xFC01,
          0x1E,
          &reg64);
 ...
 status = hw->phy.ops.read_reg(hw, 0xCC00,
          0x1E,
          &reg64);
 ...
 if (reg64 & 0x4000) {
  ...
  return -26;
 } else if (reg64 & 0x0010) {

  status = hw->phy.ops.read_reg(hw, 0xC850,
       0x1E,
       &reg64);
 ...
 status = hw->phy.ops.read_reg(hw, 0xCC01,
          0x7, &reg64);
...
# 930 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_enable_lasi_ext_t_x550em(struct ixgbe_hw *hw)
{
 ...
 status = hw->phy.ops.read_reg(hw, 0xD401,
          0x7, &reg64);
 ...
 status = hw->phy.ops.write_reg(hw, 0xD401,
           0x7, reg64);
 ...
 status = hw->phy.ops.read_reg(hw, 0xD400,
          0x1E,
          &reg64);
 ...
 status = hw->phy.ops.write_reg(hw, 0xD400,
           0x1E,
           reg64);
 ...
 status = hw->phy.ops.read_reg(hw, 0xFF01,
          0x1E,
          &reg64);
 ...
 status = hw->phy.ops.write_reg(hw, 0xFF01,
           0x1E,
           reg64);
 ...
 status = hw->phy.ops.read_reg(hw, 0xFF00,
          0x1E,
          &reg64);
 ...
 status = hw->phy.ops.write_reg(hw, 0xFF00,
           0x1E,
           reg64);

 return status;
}
# 1013 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
...
# 1054 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_init_phy_ops_X550em(struct ixgbe_hw *hw)
{
 struct ixgbe_phy_info *phy = &hw->phy;
 ixgbe_link_speed speed;
 ...
 if (hw->mac.ops.get_media_type(hw) == ixgbe_media_type_fiber) {
  phy->phy_semaphore_mask = 0x1806;
  ixgbe_setup_mux_ctl(hw);




  phy->nw_mng_if_sel = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x00011178);
  if (phy->nw_mng_if_sel & (1 << 24)) {
   speed = 0x0080 |
    0x0020;
  }
...
# 1136 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_reset_hw_X550em(struct ixgbe_hw *hw)
{
 ...
 if (hw->device_id == 0x15AD) {
  ...
  hlreg0 = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x04240);
  hlreg0 &= ~0x00010000;
  bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x04240, hlreg0);
 }
     ...
     _Bool autoneg_wait_to_complete)
{
 ...
 if (!(hw->phy.nw_mng_if_sel & (1 << 24))) {

  reg_slice = 0x12AD +
       (hw->bus.lan_id << 12);
  reg_val = 0;
  ret_val = hw->phy.ops.write_i2c_combined(hw, 0xBE,
        reg_slice, reg_val);

  reg_slice = 0x12B0 +
       (hw->bus.lan_id << 12);
  reg_val = (0x0004 << 1) | 0x1;
  ret_val = hw->phy.ops.write_i2c_combined(hw, 0xBE,
        reg_slice, reg_val);
...
# 1384 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_setup_ixfi_x550em(struct ixgbe_hw *hw, ixgbe_link_speed *speed)
{
 int32_t status;
 uint32_t reg_val;
...
# 1496 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_ext_phy_t_x550em_get_link(struct ixgbe_hw *hw, _Bool *link_up)
{
 uint32_t ret;
 ...
 *link_up = 0;
 ...
 ret = hw->phy.ops.read_reg(hw, 0x1,
       0x7,
       &autoneg_status);
 if (ret != 0)
  return ret;
 ...
 *link_up = !!(autoneg_status & 0x4);

 return 0;
}
# 1533 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_setup_internal_phy_t_x550em(struct ixgbe_hw *hw)
{
 ...
 status = hw->phy.ops.read_reg(hw, 0xC800,
          0x7,
          &speed);
 if (status != 0)
  return status;
...
# 1658 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_read_ee_hostif_data_X550(struct ixgbe_hw *hw, uint16_t offset,
           uint16_t *data)
{
 int32_t status;
 ...
 ;;
 buffer.hdr.req.cmd = 0x31;
 buffer.hdr.req.buf_lenh = 0;
 buffer.hdr.req.buf_lenl = 0x6;
 buffer.hdr.req.checksum = 0xFF;


 buffer.address = ((__uint32_t)(offset * 2));

 buffer.length = ((__uint16_t)(sizeof(uint16_t)));
 ...
 *data = (uint16_t)bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, (0x15800 + ((3) << 2)));


 return 0;
}
# 1696 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_read_ee_hostif_X550(struct ixgbe_hw *hw, uint16_t offset,
      uint16_t *data)
{
 int32_t status = 0;
...
# 1723 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_read_ee_hostif_buffer_X550(struct ixgbe_hw *hw,
      uint16_t offset, uint16_t words,
      uint16_t *data)
{
 ...
 status = hw->mac.ops.acquire_swfw_sync(hw, 0x0001);
 if (status) {
  ;
  return status;
 }
 while (words) {
  ...
  buffer.address = ((__uint32_t)((offset + current_word) * 2));
  buffer.length = ((__uint16_t)(words_to_read * 2));
  ...
  for (i = 0; i < words_to_read; i++) {
   uint32_t reg64 = 0x15800 + (3 << 2) +
      2 * i;
   uint32_t value = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, reg64);
...
# 1796 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_write_ee_hostif_data_X550(struct ixgbe_hw *hw, uint16_t offset,
     uint16_t data)
{
 int32_t status;
 ...
 buffer.hdr.req.cmd = 0x33;
 buffer.hdr.req.buf_lenh = 0;
 buffer.hdr.req.buf_lenl = 0xA;
 buffer.hdr.req.checksum = 0xFF;
...
# 1829 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_write_ee_hostif_X550(struct ixgbe_hw *hw, uint16_t offset,
       uint16_t data)
{
 int32_t status = 0;
...
# 1857 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
...
# 1926 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_calc_checksum_X550(struct ixgbe_hw *hw, uint16_t *buffer,
     uint32_t buffer_size)
{
 uint16_t eeprom_ptrs[0x41 + 1];
 uint16_t *local_buffer;
 int32_t status;
 uint16_t checksum = 0;
...
# 2021 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_validate_eeprom_checksum_X550(struct ixgbe_hw *hw, uint16_t *checksum_val)
{
 ...
 status = ixgbe_read_ee_hostif_X550(hw, 0x3F,
        &read_checksum);
 if (status)
  return status;
...
# 2073 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_update_eeprom_checksum_X550(struct ixgbe_hw *hw)
{
 int32_t status;
 uint16_t checksum = 0;
 ...
 status = ixgbe_write_ee_hostif_X550(hw, 0x3F,
         checksum);
 if (status)
  return status;
...
int32_t ixgbe_update_flash_X550(struct ixgbe_hw *hw)
{
 ...
 buffer.req.buf_lenl = 0;
 buffer.req.checksum = 0xFF;
...
# 2181 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_get_bus_info_X550em(struct ixgbe_hw *hw)
{
...
void ixgbe_disable_rx_x550(struct ixgbe_hw *hw)
{
 ...
 rxctrl = bus_space_read_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x03000);
 if (rxctrl & 0x00000001) {
  fw_cmd.hdr.cmd = 0xDE;
  fw_cmd.hdr.buf_len = 0x1;
  fw_cmd.hdr.checksum = 0xFF;
  ...
  if (status) {
   ...
   if (rxctrl & 0x00000001) {
    rxctrl &= ~0x00000001;
    bus_space_write_4(((struct ixgbe_osdep *)(hw)->back)->os_memt, ((struct ixgbe_osdep *)(hw)->back)->os_memh, 0x03000, rxctrl);
   }
  }
 }
}
# 2236 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_get_lcd_t_x550em(struct ixgbe_hw *hw, ixgbe_link_speed *lcd_speed)
{
 ...
 *lcd_speed = 0;
 ...
 status = hw->phy.ops.read_reg(hw, 0xE820,
          0x7,
          &an_lp_status);
 ...
 if (an_lp_status & 0x8000) {
  *lcd_speed = 0x0020;
  return status;
 }


 if ((hw->bus.lan_id && (word & 0x100)) ||
     (word & 0x40))
  return status;
...
# 2312 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
 case ixgbe_fc_full:
  pause = 1;
  asm_dir = 1;
  break;
 ...
 if (hw->device_id == 0x15AB) {
  ret_val = ixgbe_read_iosf_sb_reg_x550(hw,
   ((hw->bus.lan_id) ? 0x822C : 0x422C),
   0, &reg_val);
  if (ret_val != 0)
   goto out;
  reg_val &= ~((1 << 28) |
...
# 2373 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_acquire_swfw_sync_X550em(struct ixgbe_hw *hw, uint32_t mask)
{
 int32_t status;
...
# 2396 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
void ixgbe_release_swfw_sync_X550em(struct ixgbe_hw *hw, uint32_t mask)
{
 ;;
...
# 2417 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_handle_lasi_ext_t_x550em(struct ixgbe_hw *hw)
{
 _Bool lsc;
 uint32_t status;
...
# 2444 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_setup_mac_link_t_X550em(struct ixgbe_hw *hw,
          ixgbe_link_speed speed,
          _Bool autoneg_wait_to_complete)
{
...
# 2481 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ixgbe_x550.c"
int32_t ixgbe_check_link_t_X550em(struct ixgbe_hw *hw, ixgbe_link_speed *speed,
      _Bool *link_up, _Bool link_up_wait_to_complete)
{
 uint32_t status;
 ...
 status = hw->phy.ops.read_reg(hw, 0x1,
          0x7,
          &autoneg_status);
...
int32_t ixgbe_led_on_t_X550em(struct ixgbe_hw *hw, uint32_t led_idx)
{
 ...
 hw->phy.ops.read_reg(hw, 0xC430 + led_idx,
        0x1E, &phy_data);
 phy_data |= (1 << 8);
 hw->phy.ops.write_reg(hw, 0xC430 + led_idx,
         0x1E, phy_data);
