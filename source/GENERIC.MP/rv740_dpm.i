...
u32 rv740_get_decoded_reference_divider(u32 encoded_ref)
{
 ...
 switch (encoded_ref) {
  ...
  break;
        default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Invalid encoded Reference Divider\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  ref = 0;
  break;
 }
 return ref;
...
void rv740_read_clock_registers(struct radeon_device *rdev)
{
 ...
 pi->clk_regs.rv770.mpll_ss1 = r100_mm_rreg(rdev, (0x85c), 0);
 pi->clk_regs.rv770.mpll_ss2 = r100_mm_rreg(rdev, (0x860), 0);
}
int rv740_populate_smc_acpi_state(struct radeon_device *rdev,
      RV770_SMC_STATETABLE *table)
{
 ...
 mpll_dq_func_cntl_2 |= (1 << 19) | (1 << 24) | (1 << 25);
