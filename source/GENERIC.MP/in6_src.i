# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c"
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c"
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
int doaccept(struct proc *, int, struct sockaddr *, socklen_t *, int,
     register_t *);
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c" 2
...
{
 struct ip6_moptions *mopts = inp->inp_mou.mou_mo6;
 struct route_in6 *ro = &inp->inp_ru.ru_route6;
 struct in6_addr *laddr = &inp->inp_laddru.iau_addr6;
 ...
 if (opts && (pi = opts->ip6po_pktinfo) &&
  ...
  if (ifp && (((((&sa6.sin6_addr)->__u6_addr.__u6_addr8[0] == 0xfe) && (((&sa6.sin6_addr)->__u6_addr.__u6_addr8[1] & 0xc0) == 0x80))) || ((((&sa6.sin6_addr)->__u6_addr.__u6_addr8[0] == 0xff) && (((&sa6.sin6_addr)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x02))) || ((((&sa6.sin6_addr)->__u6_addr.__u6_addr8[0] == 0xff) && (((&sa6.sin6_addr)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x01)))))
   sa6.sin6_addr.__u6_addr.__u6_addr16[1] = ((__uint16_t)(ifp->if_index));
  if_put(ifp);

  ia6 = ifatoia6(ifa_ifwithaddr(sin6tosa(&sa6), rtableid));
  if (ia6 == ((void *)0) || (ia6->ia6_flags &
       (0x01|0x02|0x04)))
   return (49);

  pi->ipi6_addr = sa6.sin6_addr;
 ...
 if (!rtisvalid(ro->ro_rt) || (ro->ro_tableid != rtableid) ||
     !(__builtin_memcmp((&(&ro->ro_dst.sin6_addr)->__u6_addr.__u6_addr8[0]), (&(dst)->__u6_addr.__u6_addr8[0]), (sizeof(struct in6_addr))) == 0)) {
  rtfree(ro->ro_rt);
  ro->ro_rt = ((void *)0);
 }
 if (ro->ro_rt == ((void *)0)) {
  ...
  __builtin_bzero((&ro->ro_dst), (sizeof(struct sockaddr_in6)));
...
# 209 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c"
 if (ro->ro_rt) {
    ...
    struct ip6_moptions *mopts, unsigned int rtableid)
{
 ...
 dst = &dstsock->sin6_addr;
# 250 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c"
 if (((((dst)->__u6_addr.__u6_addr8[0] == 0xfe) && (((dst)->__u6_addr.__u6_addr8[1] & 0xc0) == 0x80)) || (((dst)->__u6_addr.__u6_addr8[0] == 0xff) && (((dst)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x02)) ||
      (((dst)->__u6_addr.__u6_addr8[0] == 0xff) && (((dst)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x01))) && dstsock->sin6_scope_id) {
...
# 273 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c"
 if (((dst)->__u6_addr.__u6_addr8[0] == 0xff)) {
  ifp = mopts ? if_get(mopts->im6o_ifidx) : ((void *)0);

  if (!ifp && dstsock->sin6_scope_id)
   ifp = if_get(((__uint16_t)(dstsock->sin6_scope_id)));
    ...
    struct route_in6 *ro, unsigned int rtableid)
{
 ...
 if (ro) {
  if (rtisvalid(ro->ro_rt))
   ((sin6tosa(&ro->ro_dst)->sa_family == 24) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c", 308, "sin6tosa(&ro->ro_dst)->sa_family == AF_INET6"));
  if (!rtisvalid(ro->ro_rt) ||
      !(__builtin_memcmp((&(&ro->ro_dst.sin6_addr)->__u6_addr.__u6_addr8[0]), (&(dst)->__u6_addr.__u6_addr8[0]), (sizeof(struct in6_addr))) == 0)) {
   rtfree(ro->ro_rt);
   ro->ro_rt = ((void *)0);
   ...
   *sa6 = *dstsock;
   ...
   ro->ro_rt = rtalloc_mpath(sin6tosa(&ro->ro_dst),
       ((void *)0), ro->ro_tableid);
  }
# 335 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c"
  if (opts && opts->ip6po_pktinfo &&
      opts->ip6po_pktinfo->ipi6_ifindex) {
   if (ro->ro_rt != ((void *)0) &&
       !((ro->ro_rt->rt_flags) & (0x200000)) &&
       ro->ro_rt->rt_ifidx !=
       opts->ip6po_pktinfo->ipi6_ifindex) {
        return (((void *)0));
   }
    ...
    u_int rtableid)
{
 ...
 if (((&dstsock->sin6_addr)->__u6_addr.__u6_addr8[0] == 0xff) &&
     mopts != ((void *)0) && (*retifp = if_get(mopts->im6o_ifidx)) != ((void *)0))
      return (0);

 rt = in6_selectroute(dstsock, opts, ro, rtableid);
 if (rt == ((void *)0))
  return (65);
# 395 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c"
 if (rt && (rt->rt_flags & (0x8 | 0x1000)))
  return (rt->rt_flags & 0x4 ? 65 : 51);
...
# 428 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c"
int
 ...
 *in6 = sin6->sin6_addr;
 ...
 if ((((((in6)->__u6_addr.__u6_addr8[0] == 0xfe) && (((in6)->__u6_addr.__u6_addr8[1] & 0xc0) == 0x80))) || ((((in6)->__u6_addr.__u6_addr8[0] == 0xff) && (((in6)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x02))) || ((((in6)->__u6_addr.__u6_addr8[0] == 0xff) && (((in6)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x01))))) {
  ...
  if (in6p && in6p->inp_outputopts6 &&
   ...
   if (ifp == ((void *)0))
    return 6;
   in6->__u6_addr.__u6_addr16[1] = ((__uint16_t)(pi->ipi6_ifindex));
  } else if (in6p && ((in6)->__u6_addr.__u6_addr8[0] == 0xff) &&
      in6p->inp_mou.mou_mo6 &&
      (ifp = if_get(in6p->inp_mou.mou_mo6->im6o_ifidx))) {
   in6->__u6_addr.__u6_addr16[1] = ((__uint16_t)(ifp->if_index));
  } else if (scopeid) {
   ifp = if_get(scopeid);
   if (ifp == ((void *)0))
    return 6;

   in6->__u6_addr.__u6_addr16[1] = ((__uint16_t)(scopeid & 0xffff));
  }
  if_put(ifp);
 }
...
# 481 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/in6_src.c"
void
in6_recoverscope(struct sockaddr_in6 *sin6, const struct in6_addr *in6)
{
 ...
 if ((((((in6)->__u6_addr.__u6_addr8[0] == 0xfe) && (((in6)->__u6_addr.__u6_addr8[1] & 0xc0) == 0x80))) || ((((in6)->__u6_addr.__u6_addr8[0] == 0xff) && (((in6)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x02))) || ((((in6)->__u6_addr.__u6_addr8[0] == 0xff) && (((in6)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x01))))) {
  ...
  scopeid = ((__uint16_t)(sin6->sin6_addr.__u6_addr.__u6_addr16[1]));
  if (scopeid) {
