# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-deflate.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-deflate.c"
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-deflate.c"
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-deflate.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-deflate.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-deflate.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_defs.h" 1
# 106 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_defs.h"
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-deflate.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-deflate.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-comp.h" 1
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-comp.h"
struct compressor {
 int compress_proto;
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-deflate.c" 2
    ...
    u_int items, size;
{
    ...
    ptr = mallocarray(items, size, 2, 0x0002);
    return ptr;
}
    ...
    int opt_len;
{
 ...
 return ((void *)0);
    ...
    state = malloc(sizeof(*state), 2, 0x0002);
    if (state == ((void *)0))
 return ((void *)0);
    ...
    if (deflateInit2_((&state->strm),((-1)),(8),(-w_size),(8), (0), "1.2.3", sizeof(z_stream)) != 0) {
 ...
 return ((void *)0);
    ...
    state->w_size = w_size;
    __builtin_bzero((&state->stats), (sizeof(state->stats)));
    return (void *) state;
}
    ...
    int opt_len;
{
 ...
 return ((void *)0);
    ...
    state->strm.zalloc = zcalloc;
    state->strm.zfree = zcfree;
    if (inflateInit2_((&state->strm), (-w_size), "1.2.3", sizeof(z_stream)) != 0) {
 free(state, 2, 0);
 return ((void *)0);
    }
...
# 477 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp-deflate.c"
int
    ...
    struct mbuf *mi, **mop;
{
 ...
 return 1;
    ...
    mo = m_gethdr((0x0002), (1));
    if (mo == ((void *)0))
 return 1;
    mo_head = mo;
    mo->m_hdr.mh_len = 0;
    mo->m_hdr.mh_next = ((void *)0);
    (void) m_clget((mo), (0x0002), (1 << 11));
 ...
 if (state->strm.avail_out == 0) {
  ...
  olen += ospace;
  mo->m_hdr.mh_next = m_get((0x0002), (1));
  mo = mo->m_hdr.mh_next;
  if (mo == ((void *)0)) {
      m_freem(mo_head);
      return 1;
    ...
    struct mbuf *mi;
{
 ...
 ++state->strm.avail_in;
    ...
    for (;;) {
 r = inflateInit_((&state->strm), "1.2.3", sizeof(z_stream));
 if (r != 0) {
