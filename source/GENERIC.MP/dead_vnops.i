# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/deadfs/dead_vnops.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/deadfs/dead_vnops.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/deadfs/dead_vnops.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/deadfs/dead_vnops.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/deadfs/dead_vnops.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/deadfs/dead_vnops.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/deadfs/dead_vnops.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/deadfs/dead_vnops.c" 2
...
dead_strategy(void *v)
{
 ...
 if (ap->a_bp->b_vp == ((void *)0) || !chkvnlock(ap->a_bp->b_vp)) {
  ap->a_bp->b_flags |= 0x00000400;
  s = _splraise(5);
  biodone(ap->a_bp);
  _splx(s);
  return (5);
...
dead_lock(void *v)
{
 ...
 if (ap->a_flags & 0x1000UL || !chkvnlock(vp))
  return (0);
...
chkvnlock(struct vnode *vp)
{
 ...
 while (vp->v_flag & 0x0100) {
  vp->v_flag |= 0x0200;
  tsleep(vp, 8, "chkvnlock", 0);
  locked = 1;
 }
 return (locked);
}
