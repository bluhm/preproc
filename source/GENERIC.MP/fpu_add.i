# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c"
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c"
...
struct tty;
struct uio;
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_arith.h" 1
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_extern.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_extern.h"
struct proc;
struct fpstate64;
struct trapframe64;
union instr;
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c" 2
 ...
 register struct fpemu *fe;
{
 ...
 register int rd;
# 90 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c"
 { if ((u_int)(x)->fp_class > (u_int)(y)->fp_class) { register struct fpn *swap; swap = (x), (x) = (y), (y) = swap; }; };
 if (((y)->fp_class < 0))
  return (y);
 if (((y)->fp_class == 2)) {
  if (((x)->fp_class == 2) && x->fp_sign != y->fp_sign)
   return (fpu_newnan(fe));
  return (y);
 }
 rd = ((fe->fe_fsr >> 30) & 0x03);
 if (((y)->fp_class == 0)) {
  if (rd != 3)
   y->fp_sign &= x->fp_sign;
  else
 ...
 if (x->fp_exp == y->fp_exp) {
  ...
  if (x->fp_exp < y->fp_exp) {
   ...
   { register struct fpn *swap; swap = (x), (x) = (y), (y) = swap; };
  }
...
# 143 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c"
  asm volatile("addcc %1,%2,%0" : "=r"(r->fp_mant[3]) : "r"(x->fp_mant[3]), "r"(y->fp_mant[3]));
  asm volatile("addxcc %1,%2,%0" : "=r"(r->fp_mant[2]) : "r"(x->fp_mant[2]), "r"(y->fp_mant[2]));
  asm volatile("addxcc %1,%2,%0" : "=r"(r->fp_mant[1]) : "r"(x->fp_mant[1]), "r"(y->fp_mant[1]));
  asm volatile("addx %1,%2,%0" : "=r"(r0) : "r"(x->fp_mant[0]), "r"(y->fp_mant[0]));
  if ((r->fp_mant[0] = r0) >= (1 << (((115 - 1) & 31) + 1))) {
   (void) fpu_shr(r, 1);
   r->fp_exp++;
  }
 } else {
 
# 175 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/fpu/fpu_add.c"
  asm volatile("addcc %0,-1,%%g0" : : "r"(y->fp_sticky));
  asm volatile("subxcc %1,%2,%0" : "=r"(r3) : "r"(x->fp_mant[3]), "r"(y->fp_mant[3]));
  asm volatile("subxcc %1,%2,%0" : "=r"(r2) : "r"(x->fp_mant[2]), "r"(y->fp_mant[2]));
  asm volatile("subxcc %1,%2,%0" : "=r"(r1) : "r"(x->fp_mant[1]), "r"(y->fp_mant[1]));
  asm volatile("subx %1,%2,%0" : "=r"(r0) : "r"(x->fp_mant[0]), "r"(y->fp_mant[0]));
  if (r0 < (1 << (((115 - 1) & 31) + 1))) {
   ...
   r->fp_sign = y->fp_sign;
   asm volatile("subcc %1,%2,%0" : "=r"(r3) : "r"(0), "r"(r3));
   asm volatile("subxcc %1,%2,%0" : "=r"(r2) : "r"(0), "r"(r2));
   asm volatile("subxcc %1,%2,%0" : "=r"(r1) : "r"(0), "r"(r1));
   asm volatile("subx %1,%2,%0" : "=r"(r0) : "r"(0), "r"(r0));
  }
  r->fp_mant[3] = r3;
  r->fp_mant[2] = r2;
  r->fp_mant[1] = r1;
