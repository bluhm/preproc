# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
...
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c" 2
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
int
msdosfs_lookup(void *v)
{
 ...
 dp = ((struct denode *)(vdp)->v_data);
 pmp = dp->de_pmp;
 *vpp = ((void *)0);
 lockparent = flags & 0x0008;
 wantparent = flags & (0x0008 | 0x0010);
# 136 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
 if ((dp->de_Attributes & 0x10) == 0)
  return (20);
 if ((error = VOP_ACCESS(vdp, 00100, cnp->cn_cred, cnp->cn_proc)) != 0)
  return (error);
# 148 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
 ...
 if ((vdp->v_flag & 0x0001) && cnp->cn_nameptr[0] == '.' &&
     (cnp->cn_namelen == 1 ||
 ...
 if ((nameiop == 1 || nameiop == 3) &&
     (flags & 0x008000))
  slotcount = 0;
# 214 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
 adjp = cnp->cn_nameptr;
...
# 254 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
   if (dep->deName[0] == 0x00 ||
       dep->deName[0] == 0xe5) {
    ...
    if (!chksum_ok
        && (!olddos || __builtin_bcmp((dosfilename), (dep->deName), (11)))) {
     chksum = -1;
     continue;
    }
# 318 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
    dp->de_fndoffset = diroff;
    if (chksum_ok && nameiop == 3) {
...
notfound:;
# 354 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
 if (!slotcount) {
  slotcount = 1;
  slotoffset = diroff;
 }
...
# 372 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
 if ((nameiop == 1 || nameiop == 3) &&
     (flags & 0x008000) && dp->de_refcnt != 0) {




  error = VOP_ACCESS(vdp, 00200, cnp->cn_cred, cnp->cn_proc);
  if (error)
   return (error);
  ...
  dp->de_fndcnt = wincnt - 1;
# 401 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
...
found:;
 ...
 isadir = dep->deAttributes & 0x10;
 scn = (((u_int8_t *)(dep->deStartCluster))[0] + (((u_int8_t *)(dep->deStartCluster))[1] << 8));
 if ((pmp->pm_fatmask == 0x0fffffff)) {
  scn |= (((u_int8_t *)(dep->deHighClust))[0] + (((u_int8_t *)(dep->deHighClust))[1] << 8)) << 16;
...
foundroot:;
 ...
 if ((pmp->pm_fatmask == 0x0fffffff) && scn == 0)
  scn = pmp->pm_rootdirblk;
# 467 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
 if (nameiop == 2 && (flags & 0x008000)) {



  if (blkoff == 0x1fffffff)
   return 30;
...
# 550 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
 pdp = vdp;
 if (flags & 0x002000) {
  VOP_UNLOCK(pdp, p);
  cnp->cn_flags |= 0x200000;
...
# 596 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
int
    ...
    struct componentname *cnp)
{
 ...
 daddr_t bn;
 int blsize;
# 621 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
 if (ddep->de_fndoffset >= ddep->de_FileSize) {
  diroffset = ddep->de_fndoffset + sizeof(struct direntry)
      - ddep->de_FileSize;
  dirclust = (((diroffset) + (pmp)->pm_bpcluster - 1) >> (pmp)->pm_cnshift);
  if ((error = extendfile(ddep, dirclust, 0, 0, 1)) != 0) {
   (void)detrunc(ddep, ddep->de_FileSize, 0, ((struct ucred *)-1), ((void *)0));
   return error;
  }
  ...
  ddep->de_FileSize += ((dirclust) << (pmp)->pm_cnshift);
 }
 ...
 error = pcbmap(ddep, ((ddep->de_fndoffset) >> (pmp)->pm_cnshift),
         &bn, &dirclust, &blsize);
 if (error)
  return error;
 ...
 ndep = ((struct direntry *)(((bp)->b_data) + ((ddep->de_fndoffset) & (pmp)->pm_crbomask)));

 (__builtin_bcopy(((dep)->de_Name), ((ndep)->deName), (8)), __builtin_bcopy(((dep)->de_Name + 8), ((ndep)->deExtension), (3)), (ndep)->deAttributes = (dep)->de_Attributes, (ndep)->deLowerCase = 0x08 | 0x10, (ndep)->deCTimeHundredth = (dep)->de_CTimeHundredth, (((u_int8_t *)((ndep)->deCTime))[0] = ((dep)->de_CTime), ((u_int8_t *)((ndep)->deCTime))[1] = ((dep)->de_CTime) >> 8), (((u_int8_t *)((ndep)->deCDate))[0] = ((dep)->de_CDate), ((u_int8_t *)((ndep)->deCDate))[1] = ((dep)->de_CDate) >> 8), (((u_int8_t *)((ndep)->deADate))[0] = ((dep)->de_ADate), ((u_int8_t *)((ndep)->deADate))[1] = ((dep)->de_ADate) >> 8), (((u_int8_t *)((ndep)->deMTime))[0] = ((dep)->de_MTime), ((u_int8_t *)((ndep)->deMTime))[1] = ((dep)->de_MTime) >> 8), (((u_int8_t *)((ndep)->deMDate))[0] = ((dep)->de_MDate), ((u_int8_t *)((ndep)->deMDate))[1] = ((dep)->de_MDate) >> 8), (((u_int8_t *)((ndep)->deStartCluster))[0] = ((dep)->de_StartCluster), ((u_int8_t *)((ndep)->deStartCluster))[1] = ((dep)->de_StartCluster) >> 8), (((u_int8_t *)((ndep)->deFileSize))[0] = (((dep)->de_Attributes & 0x10) ? 0 : (dep)->de_FileSize), ((u_int8_t *)((ndep)->deFileSize))[1] = (((dep)->de_Attributes & 0x10) ? 0 : (dep)->de_FileSize) >> 8, ((u_int8_t *)((ndep)->deFileSize))[2] = (((dep)->de_Attributes & 0x10) ? 0 : (dep)->de_FileSize) >> 16, ((u_int8_t *)((ndep)->deFileSize))[3] = (((dep)->de_Attributes & 0x10) ? 0 : (dep)->de_FileSize) >> 24), (((u_int8_t *)((ndep)->deHighClust))[0] = (((dep)->de_pmp->pm_fatmask == 0x0fffffff) ? (dep)->de_StartCluster >> 16 : 0), ((u_int8_t *)((ndep)->deHighClust))[1] = (((dep)->de_pmp->pm_fatmask == 0x0fffffff) ? (dep)->de_StartCluster >> 16 : 0) >> 8));
 ...
 if (ddep->de_fndcnt > 0) {
  ...
  while (--ddep->de_fndcnt >= 0) {
   if (!(ddep->de_fndoffset & pmp->pm_crbomask)) {
    ...
    error = pcbmap(ddep,
            ((ddep->de_fndoffset) >> (pmp)->pm_cnshift),
 ...
 if (depp) {
  if (dep->de_Attributes & 0x10) {
   ...
   if ((pmp->pm_fatmask == 0x0fffffff) && dirclust == pmp->pm_rootdirblk)
    dirclust = 0;
   if (dirclust == 0)
 ...
 for (cn = 0;; cn++) {
  ...
  for (dentp = (struct direntry *)bp->b_data;
   ...
   if (dentp->deName[0] != 0xe5 &&
    ...
    if (__builtin_bcmp((dentp->deName), (".          "), (11)) &&
        __builtin_bcmp((dentp->deName), ("..         "), (11))) {
     brelse(bp);
...
# 795 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
int
doscheckpath(struct denode *source, struct denode *target)
{
 ...
 dep = target;
 if ((target->de_Attributes & 0x10) == 0 ||
     (source->de_Attributes & 0x10) == 0) {
  error = 20;
  goto out;
 }
 ...
 if ((pmp->pm_fatmask == 0x0fffffff) && dep->de_StartCluster == pmp->pm_rootdirblk)
  goto out;
 ...
 for (;;) {
  ...
  error = bread(pmp->pm_devvp, ((((scn)-2) << (((pmp))->pm_cnshift - ((pmp))->pm_bnshift)) + (pmp)->pm_firstcluster),
         pmp->pm_bpcluster, &bp);
  if (error)
   break;

  ep = (struct direntry *) bp->b_data + 1;
  if ((ep->deAttributes & 0x10) == 0 ||
      __builtin_bcmp((ep->deName), ("..         "), (11)) != 0) {
   error = 20;
   break;
  }
  scn = (((u_int8_t *)(ep->deStartCluster))[0] + (((u_int8_t *)(ep->deStartCluster))[1] << 8));
  if ((pmp->pm_fatmask == 0x0fffffff))
   scn |= (((u_int8_t *)(ep->deHighClust))[0] + (((u_int8_t *)(ep->deHighClust))[1] << 8)) << 16;
  ...
  if (scn == 0)
   break;
  if ((pmp->pm_fatmask == 0x0fffffff) && scn == pmp->pm_rootdirblk) {
    ...
    struct buf **bpp, struct direntry **epp)
{
 ...
 if (dirclust == 0
     && ((((((diroffset + blsize)) >> ((pmp))->pm_cnshift)) << ((pmp)->pm_cnshift - (pmp)->pm_bnshift))) > pmp->pm_rootdirsize)
  blsize = ((pmp->pm_rootdirsize) << (pmp)->pm_bnshift) & pmp->pm_crbomask;
 bn = ((dirclust) == 0 ? (((((((((diroffset)))) >> ((((pmp))))->pm_cnshift)) << ((((pmp)))->pm_cnshift - (((pmp)))->pm_bnshift))) + ((pmp))->pm_rootdirblk) : (((((dirclust))-2) << ((((pmp)))->pm_cnshift - (((pmp)))->pm_bnshift)) + ((pmp))->pm_firstcluster));
 ...
 if (epp)
  *epp = ((struct direntry *)(((*bpp)->b_data) + ((diroffset) & (pmp)->pm_crbomask)));
 return (0);
}
...
# 929 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../msdosfs/msdosfs_lookup.c"
int
removede(struct denode *pdep, struct denode *dep)
{
 ...
 do {
  offset -= sizeof(struct direntry);
  error = pcbmap(pdep, ((offset) >> (pmp)->pm_cnshift), &bn, 0, &blsize);
  if (error)
   return error;
  error = bread(pmp->pm_devvp, bn, blsize, &bp);
  if (error) {
  ...
  ep = ((struct direntry *)(((bp)->b_data) + ((offset) & (pmp)->pm_crbomask)));





  if (ep->deAttributes != 0x0f
  ...
  while (1) {
   ...
   if ((pmp->pm_flags & 0x04)
       ...
       || ep->deAttributes != 0x0f)
    break;
  }
  if ((error = bwrite(bp)) != 0)
   return error;
 } while (!(pmp->pm_flags & 0x04)
     && !(offset & pmp->pm_crbomask)
     && offset);
 return 0;
}
  ...
  for (cn = error = 0; !error; cn++) {
   ...
   for (dentp = (struct direntry *)bp->b_data;
    ...
    if (dentp->deAttributes & 0x08)
     continue;
    if (!__builtin_bcmp((dentp->deName), (cp), (11))) {
     error = 17;
     break;
    }
   }
