# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
void iommu_dvmamem_free(bus_dma_tag_t, bus_dma_tag_t, bus_dma_segment_t *,
     int);
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
void device_register(struct device *, void *);
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c" 2
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
...
iommu_strbuf_flush(struct strbuf_ctl *sb, bus_addr_t va)
{
 ...
 bus_space_write_8(sb->sb_bustag, sb->sb_sb,
     (__builtin_offsetof(struct iommu_strbuf, strbuf_pgflush)), va);
}
# 127 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
void
iommu_init(char *name, struct iommu_state *is, int tsbsize, u_int32_t iovabase)
{
 ...
 struct vm_page *m;
 struct pglist mlist;
# 152 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 if (strncmp(name, "pyro", 4) == 0) {
  is->is_cr = bus_space_read_8((is)->is_bustag, (is)->is_iommu, (__builtin_offsetof(struct iommureg, iommu_cr)));
  is->is_cr &= ~0x000000000000000002LL;
  is->is_cr |= (0x000000000000000400LL | 0x000000000000000300LL |
      0x000000000000000001LL);
 } else
  is->is_cr = 0x000000000000000001LL;
 ...
 m = ((&mlist)->tqh_first);
 is->is_ptsb = ((m)->phys_addr);


 for (; m != ((void *)0); m = ((m)->pageq.tqe_next)) {
  pa = ((m)->phys_addr);
  pmap_enter((&kernel_pmap_), va, pa | 0x002,
      0x01 | 0x02,
      0x01 | 0x02 | 0x00000010);
  va += (1 << 13);
 }
 ;
 __builtin_memset((is->is_tsb), (0), (size));
...
# 228 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
...
iommu_reset(struct iommu_state *is)
{
 ...
 bus_space_write_8((is)->is_bustag, (is)->is_iommu, (__builtin_offsetof(struct iommureg, iommu_tsb)), (is->is_ptsb));


 bus_space_write_8((is)->is_bustag, (is)->is_iommu, (__builtin_offsetof(struct iommureg, iommu_cr)), (is->is_cr));
 ...
 if (is->is_flags & 0x00000001)
  bus_space_write_8((is)->is_bustag, (is)->is_iommu, (__builtin_offsetof(struct iommureg, iommu_cache_invalidate)), (-1ULL));
}
...
{
 if(sb->sb_flush == ((void *)0))
  return;

 bus_space_write_8(sb->sb_bustag, sb->sb_sb,
     (__builtin_offsetof(struct iommu_strbuf, strbuf_ctl)), 0x000000000000000001LL);

 __asm volatile("membar " "#Lookaside" ::: "memory");


 if (bus_space_read_8(sb->sb_bustag, sb->sb_sb,
     (__builtin_offsetof(struct iommu_strbuf, strbuf_ctl))) == 0) {
  sb->sb_flush = ((void *)0);
 } else {



  if (pmap_extract((&kernel_pmap_),
      (vaddr_t)sb->sb_flush, &sb->sb_flushpa) == 0)
   sb->sb_flush = ((void *)0);
  __mtx_init((&sb->sb_mtx), ((((15)) > 0 && ((15)) < 12) ? 12 : ((15))));
 }
}
...
{
 int64_t tte;
 volatile int64_t *tte_ptr = &is->is_tsb[((u_int)(((vaddr_t)(va))-(is->is_dvmabase))>>13)];
 ...
 tte = (((pa)&0x00007fffffffe000LL)|((!(flags & 0x0008))?0x0000000000000002LL:0)|((!(flags & 0x0010))?0x0000000000000010LL:0)|(((flags & 0x0100))?0x1000000000000000LL:0)|(0x8000000000000000LL|0x0000000000000000LL));
 ...
 *tte_ptr = tte;
# 364 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 bus_space_write_8((is)->is_bustag, (is)->is_iommu, (__builtin_offsetof(struct iommureg, iommu_flush)), (va));
...
# 381 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
void
iommu_remove(struct iommu_state *is, struct strbuf_ctl *sb, bus_addr_t va)
{
 int64_t *tte_ptr = &is->is_tsb[((u_int)(((vaddr_t)(va))-(is->is_dvmabase))>>13)];
 int64_t tte;
 ...
 *tte_ptr = tte & ~0x8000000000000000LL;
 ...
 if (sb && (tte & 0x1000000000000000LL))
...
iommu_extract(struct iommu_state *is, bus_addr_t dva)
{
 ...
 if (dva >= is->is_dvmabase && dva <= is->is_dvmaend)
  tte = is->is_tsb[((u_int)(((vaddr_t)(dva))-(is->is_dvmabase))>>13)];

 return (tte & 0x00007fffffffe000LL);
}
...
iommu_fetch_tte(struct iommu_state *is, paddr_t pa)
{
 ...
 if (pa >= is->is_ptsb && pa < is->is_ptsb +
     ((1 << 13) << is->is_tsbsize))
  tte = (__builtin_constant_p(0x14) ? ({ u_int64_t __rldxu_int64_t; if(0x14 == 0x80 || (sizeof(u_int64_t) == 1 && 0x14 == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(pa)); else __asm volatile("ldxa" " [%1] " "0x14" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(pa)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((pa), 0x14));
...
iommu_strbuf_flush_done(struct iommu_map_state *ims)
{
 ...
 __mtx_enter(&sb->sb_mtx);
# 525 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 (__builtin_constant_p(0x14) ? ({ if((0x14) == 0x80 || (sizeof(u_int64_t) == 1 && (0x14) == 0x88)) *((volatile u_int64_t *)(sf->sbf_flushpa)) = (0); else __asm volatile("stxa" " %0, [%1] " "(0x14)" : : "r" ((0)), "r" ((volatile u_int64_t *)(sf->sbf_flushpa)) : "memory"); }) : stxa_nc((sf->sbf_flushpa), 0x14, (0)));
 ...
 bus_space_write_8(sb->sb_bustag, sb->sb_sb,
      (__builtin_offsetof(struct iommu_strbuf, strbuf_flushsync)), sf->sbf_flushpa);

 ;



 __asm volatile("membar " "#StoreLoad | #Lookaside" ::: "memory");
 ...
 for(;;) {
  ...
  for (i = 0; i < 1000; ++i) {
   ...
   flush = (__builtin_constant_p(0x14) ? ({ u_int64_t __rldxu_int64_t; if(0x14 == 0x80 || (sizeof(u_int64_t) == 1 && 0x14 == 0x88)) __rldxu_int64_t = *((volatile u_int64_t *)(sf->sbf_flushpa)); else __asm volatile("ldxa" " [%1] " "0x14" ", %0" : "=r" (__rldxu_int64_t) : "r" ((volatile u_int64_t *)(sf->sbf_flushpa)) : "%g0"); __rldxu_int64_t; }) : ldxa_nc((sf->sbf_flushpa), 0x14));

   if (flush) {
    ;

    __mtx_leave(&sb->sb_mtx);
    return (0);
   }
  }
  ...
  if (timeout_started) {
   if ((((&cur)->tv_sec == (&flushtimeout)->tv_sec) ? ((&cur)->tv_usec > (&flushtimeout)->tv_usec) : ((&cur)->tv_sec > (&flushtimeout)->tv_sec)))
    panic("STC timeout at %lx (%lld)",
        sf->sbf_flushpa, flush);
  } else {
   do { (&flushtimeout)->tv_sec = (&cur)->tv_sec + (&to)->tv_sec; (&flushtimeout)->tv_usec = (&cur)->tv_usec + (&to)->tv_usec; if ((&flushtimeout)->tv_usec >= 1000000) { (&flushtimeout)->tv_sec++; (&flushtimeout)->tv_usec -= 1000000; } } while (0);
...
# 597 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
int
    ...
    int flags, bus_dmamap_t *dmamap)
{
 ...
 ims = iommu_iomap_create((((((size) + ((1 << 13) - 1)) & ~((1 << 13) - 1))) >> 13));
 ...
 if (ims->ims_sb == ((void *)0))
  panic("iommu_dvmamap_create: null sb");
 if (ims->ims_sb->sb_iommu == ((void *)0))
...
# 661 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
int
...
# 781 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 if (err != 0) {
  iommu_iomap_clear_pages(ims);
  return (err);
 }
...
# 850 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 if (err)
  iommu_dvmamap_unload(t, t0, map);

 return (err);
}
# 868 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
int
...
# 1004 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 map->_dm_dvmastart = dvmaddr;
 map->_dm_dvmasize = sgsize;
 ...
 if (segs[0]._ds_mlist)
  ...
  err = iommu_dvmamap_load_seg(t, is, map, segs, nsegs,
      flags, size, boundary);
# 1069 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 if (err)
  iommu_dvmamap_unload(t, t0, map);

 return (err);
}
# 1082 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
int
...
# 1120 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 if (i > 0) {
  seg = &map->dm_segs[i - 1];
...
# 1147 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 if (boundary != 0) {
  bd_mask = ~(boundary - 1);
    ...
    bus_size_t size, bus_size_t boundary)
{
 ...
 int left;
 int seg;
# 1213 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 left = size;
 seg = 0;
...
iommu_dvmamap_unload(bus_dma_tag_t t, bus_dma_tag_t t0, bus_dmamap_t map)
{
 ...
 int error;
# 1315 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
 is = ims->ims_sb->sb_iommu;
# 1335 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
...
# 1420 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/iommu.c"
void
 ...
 case 3:
  ...
  if (m->m_hdr.mh_flags & 0x0002)
   printf("source PKTHDR mbuf (%p) hdr len = %d/0x%x:\n",
       m, m->M_dat.MH.MH_pkthdr.len, m->M_dat.MH.MH_pkthdr.len);
  else
  ...
  for ( ; m; m = m->m_hdr.mh_next) {
   ...
   long len = m->m_hdr.mh_len;
   paddr_t pa;

   if (pmap_extract((&kernel_pmap_), vaddr, &pa))
 ...
 bus_addr_t offset, bus_size_t len, int ops)
{
 ...
 for (; len > 0 && i < map->dm_nsegs; i++) {
  count = (((map->dm_segs[i].ds_len - offset)<(len))?(map->dm_segs[i].ds_len - offset):(len));
...
iommu_dvmamap_sync_range(struct strbuf_ctl *sb, bus_addr_t va, bus_size_t len)
{
 ...
 if ((is->is_tsb[((u_int)(((vaddr_t)(va))-(is->is_dvmabase))>>13)] & 0x1000000000000000LL) == 0) {
...
iommu_iomap_create(int n)
{
 ...
 va &= ~0x3f;
 pmap_extract((&kernel_pmap_), va, &sbf->sbf_flushpa);
...
void iommu_page_tree_SPLAY(struct iommu_page_tree *, struct iommu_page_entry *); void iommu_page_tree_SPLAY_MINMAX(struct iommu_page_tree *, int); struct iommu_page_entry *iommu_page_tree_SPLAY_INSERT(struct iommu_page_tree *, struct iommu_page_entry *); struct iommu_page_entry *iommu_page_tree_SPLAY_REMOVE(struct iommu_page_tree *, struct iommu_page_entry *); static __inline struct iommu_page_entry * iommu_page_tree_SPLAY_FIND(struct iommu_page_tree *head, struct iommu_page_entry *elm) { if (((head)->sph_root == ((void *)0))) return(((void *)0)); iommu_page_tree_SPLAY(head, elm); if ((iomap_compare)(elm, (head)->sph_root) == 0) return (head->sph_root); return (((void *)0)); } static __inline struct iommu_page_entry * iommu_page_tree_SPLAY_NEXT(struct iommu_page_tree *head, struct iommu_page_entry *elm) { iommu_page_tree_SPLAY(head, elm); if ((elm)->ipe_node.spe_right != ((void *)0)) { elm = (elm)->ipe_node.spe_right; while ((elm)->ipe_node.spe_left != ((void *)0)) { elm = (elm)->ipe_node.spe_left; } } else elm = ((void *)0); return (elm); } static __inline struct iommu_page_entry * iommu_page_tree_SPLAY_MIN_MAX(struct iommu_page_tree *head, int val) { iommu_page_tree_SPLAY_MINMAX(head, val); return ((head)->sph_root); };

struct iommu_page_entry * iommu_page_tree_SPLAY_INSERT(struct iommu_page_tree *head, struct iommu_page_entry *elm) { if (((head)->sph_root == ((void *)0))) { (elm)->ipe_node.spe_left = (elm)->ipe_node.spe_right = ((void *)0); } else { int __comp; iommu_page_tree_SPLAY(head, elm); __comp = (iomap_compare)(elm, (head)->sph_root); if(__comp < 0) { (elm)->ipe_node.spe_left = ((head)->sph_root)->ipe_node.spe_left; (elm)->ipe_node.spe_right = (head)->sph_root; ((head)->sph_root)->ipe_node.spe_left = ((void *)0); } else if (__comp > 0) { (elm)->ipe_node.spe_right = ((head)->sph_root)->ipe_node.spe_right; (elm)->ipe_node.spe_left = (head)->sph_root; ((head)->sph_root)->ipe_node.spe_right = ((void *)0); } else return ((head)->sph_root); } (head)->sph_root = (elm); return (((void *)0)); } struct iommu_page_entry * iommu_page_tree_SPLAY_REMOVE(struct iommu_page_tree *head, struct iommu_page_entry *elm) { struct iommu_page_entry *__tmp; if (((head)->sph_root == ((void *)0))) return (((void *)0)); iommu_page_tree_SPLAY(head, elm); if ((iomap_compare)(elm, (head)->sph_root) == 0) { if (((head)->sph_root)->ipe_node.spe_left == ((void *)0)) { (head)->sph_root = ((head)->sph_root)->ipe_node.spe_right; } else { __tmp = ((head)->sph_root)->ipe_node.spe_right; (head)->sph_root = ((head)->sph_root)->ipe_node.spe_left; iommu_page_tree_SPLAY(head, elm); ((head)->sph_root)->ipe_node.spe_right = __tmp; } return (elm); } return (((void *)0)); } void iommu_page_tree_SPLAY(struct iommu_page_tree *head, struct iommu_page_entry *elm) { struct iommu_page_entry __node, *__left, *__right, *__tmp; int __comp; (&__node)->ipe_node.spe_left = (&__node)->ipe_node.spe_right = ((void *)0); __left = __right = &__node; while ((__comp = (iomap_compare)(elm, (head)->sph_root))) { if (__comp < 0) { __tmp = ((head)->sph_root)->ipe_node.spe_left; if (__tmp == ((void *)0)) break; if ((iomap_compare)(elm, __tmp) < 0){ do { ((head)->sph_root)->ipe_node.spe_left = (__tmp)->ipe_node.spe_right; (__tmp)->ipe_node.spe_right = (head)->sph_root; (head)->sph_root = __tmp; } while (0); if (((head)->sph_root)->ipe_node.spe_left == ((void *)0)) break; } do { (__right)->ipe_node.spe_left = (head)->sph_root; __right = (head)->sph_root; (head)->sph_root = ((head)->sph_root)->ipe_node.spe_left; } while (0); } else if (__comp > 0) { __tmp = ((head)->sph_root)->ipe_node.spe_right; if (__tmp == ((void *)0)) break; if ((iomap_compare)(elm, __tmp) > 0){ do { ((head)->sph_root)->ipe_node.spe_right = (__tmp)->ipe_node.spe_left; (__tmp)->ipe_node.spe_left = (head)->sph_root; (head)->sph_root = __tmp; } while (0); if (((head)->sph_root)->ipe_node.spe_right == ((void *)0)) break; } do { (__left)->ipe_node.spe_right = (head)->sph_root; __left = (head)->sph_root; (head)->sph_root = ((head)->sph_root)->ipe_node.spe_right; } while (0); } } do { (__left)->ipe_node.spe_right = ((head)->sph_root)->ipe_node.spe_left; (__right)->ipe_node.spe_left = ((head)->sph_root)->ipe_node.spe_right; ((head)->sph_root)->ipe_node.spe_left = (&__node)->ipe_node.spe_right; ((head)->sph_root)->ipe_node.spe_right = (&__node)->ipe_node.spe_left; } while (0); } void iommu_page_tree_SPLAY_MINMAX(struct iommu_page_tree *head, int __comp) { struct iommu_page_entry __node, *__left, *__right, *__tmp; (&__node)->ipe_node.spe_left = (&__node)->ipe_node.spe_right = ((void *)0); __left = __right = &__node; while (1) { if (__comp < 0) { __tmp = ((head)->sph_root)->ipe_node.spe_left; if (__tmp == ((void *)0)) break; if (__comp < 0){ do { ((head)->sph_root)->ipe_node.spe_left = (__tmp)->ipe_node.spe_right; (__tmp)->ipe_node.spe_right = (head)->sph_root; (head)->sph_root = __tmp; } while (0); if (((head)->sph_root)->ipe_node.spe_left == ((void *)0)) break; } do { (__right)->ipe_node.spe_left = (head)->sph_root; __right = (head)->sph_root; (head)->sph_root = ((head)->sph_root)->ipe_node.spe_left; } while (0); } else if (__comp > 0) { __tmp = ((head)->sph_root)->ipe_node.spe_right; if (__tmp == ((void *)0)) break; if (__comp > 0) { do { ((head)->sph_root)->ipe_node.spe_right = (__tmp)->ipe_node.spe_left; (__tmp)->ipe_node.spe_left = (head)->sph_root; (head)->sph_root = __tmp; } while (0); if (((head)->sph_root)->ipe_node.spe_right == ((void *)0)) break; } do { (__left)->ipe_node.spe_right = (head)->sph_root; __left = (head)->sph_root; (head)->sph_root = ((head)->sph_root)->ipe_node.spe_right; } while (0); } } do { (__left)->ipe_node.spe_right = ((head)->sph_root)->ipe_node.spe_left; (__right)->ipe_node.spe_left = ((head)->sph_root)->ipe_node.spe_right; ((head)->sph_root)->ipe_node.spe_left = (&__node)->ipe_node.spe_right; ((head)->sph_root)->ipe_node.spe_right = (&__node)->ipe_node.spe_left; } while (0); };
...
iommu_iomap_insert_page(struct iommu_map_state *ims, paddr_t pa)
{
 ...
 if (ipm->ipm_pagecnt >= ipm->ipm_maxpage) {
  ...
  ipe.ipe_pa = pa;
  if (iommu_page_tree_SPLAY_FIND(&ipm->ipm_tree, &ipe))
   return (0);
 ...
 e = iommu_page_tree_SPLAY_INSERT(&ipm->ipm_tree, e);
    ...
    bus_addr_t vmaddr, int flags)
{
 ...
 for (i = 0, e = ipm->ipm_map; i < ipm->ipm_pagecnt; ++i, ++e) {
  ...
  slot = ((u_int)(((vaddr_t)(e->ipe_va))-(is->is_dvmabase))>>13);
  if (is->is_flags & 0x00000001 &&
      (i == (ipm->ipm_pagecnt - 1) || (slot % 8) == 7))
   bus_space_write_8((is)->is_bustag, (is)->is_iommu, (__builtin_offsetof(struct iommureg, iommu_cache_flush)), (is->is_ptsb + slot * 8));
...
iommu_iomap_translate(struct iommu_map_state *ims, paddr_t pa)
{
 ...
 paddr_t offset = pa & ((1 << 13) - 1);

 pe.ipe_pa = ((pa) & ~((1 << 13) - 1));

 e = iommu_page_tree_SPLAY_FIND(&ipm->ipm_tree, &pe);
