# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c" 2
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c"
...
ehci_pci_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 s = splraise(5);
 sc->sc.sc_offs = bus_space_read_1((&sc->sc)->iot, (&sc->sc)->ioh, (0x00));
 ;
 bus_space_write_2((&sc->sc)->iot, (&sc->sc)->ioh, (&sc->sc)->sc_offs+(0x08), (0));


 switch ((((pa->pa_id) >> 0) & 0xffff)) {
 case 0x1002:
  if ((((pa->pa_id) >> 16) & 0xffff) == 0x4386 ||
      ((((pa->pa_id) >> 16) & 0xffff) == 0x4396 &&
       pci_find_device(((void *)0), ehci_sb700_match))) {
   pcireg_t value;
 ...
 case 0x1106:
  if ((((pa->pa_id) >> 16) & 0xffff) == 0x3104 &&
      ((((pa->pa_class) >> 0) & 0xff) & 0xf0) == 0x60) {
   pcireg_t value;
 ...
 sc->sc_ih = pci_intr_establish(pc, ih, 5 | 0x100,
...
# 259 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c"
 return (rv);
}
...
# 302 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/ehci_pci.c"
void
ehci_pci_takecontroller(struct ehci_pci_softc *sc, int silent)
{
 ...
 cparams = bus_space_read_4((&sc->sc)->iot, (&sc->sc)->ioh, (0x08));

 for (eecp = (((cparams) >> 8) & 0xff); eecp != 0;
     eecp = (((eec) >> 8) & 0xff)) {
  ...
  if (legsup & 0x00010000) {
   ...
   for (i = 0; i < 5000; i++) {
    legsup = pci_conf_read(sc->sc_pc, sc->sc_tag,
        eecp);
    if ((legsup & 0x00010000) == 0)
     break;
    delay(1000);
   }
   if (silent == 0 && (legsup & 0x00010000))
...
{
 if ((((pa->pa_id) >> 0) & 0xffff) == 0x1002 &&
     (((pa->pa_id) >> 16) & 0xffff) == 0x4385 &&
     ((((pa->pa_class) >> 0) & 0xff) == 0x3a ||
      (((pa->pa_class) >> 0) & 0xff) == 0x3b))
  return (1);
