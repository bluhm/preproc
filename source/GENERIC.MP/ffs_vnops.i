# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c" 2
...
ffs_read(void *v)
{
 ...
 if (vp->v_type == VLNK) {
  if ((((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_size : (ip)->dinode_u.ffs2_din->di_size) < ip->i_ump->um_maxsymlinklen ||
 ...
 for (error = 0, bp = ((void *)0); uio->uio_resid > 0; bp = ((void *)0)) {
  if ((bytesinfile = (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_size : (ip)->dinode_u.ffs2_din->di_size) - uio->uio_offset) <= 0)
   break;
  lbn = ((uio->uio_offset) >> (fs)->fs_bshift);
  nextlbn = lbn + 1;
  size = fs->fs_bsize;
  blkoffset = ((uio->uio_offset) & (fs)->fs_qbmask);
  ...
  if (((off_t)(nextlbn) << (fs)->fs_bshift) >= (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_size : (ip)->dinode_u.ffs2_din->di_size))
  ...
  if (error)
   break;
# 249 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c"
  size -= bp->b_resid;
  if (size < xfersize) {
   if (size == 0)
    break;
...
ffs_write(void *v)
{
 ...
 case VREG:
  if (ioflag & 0x02)
   uio->uio_offset = (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_size : (ip)->dinode_u.ffs2_din->di_size);
  if (((((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_flags : (ip)->dinode_u.ffs2_din->di_flags) & (0x00000004 | 0x00040000)) && uio->uio_offset != (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_size : (ip)->dinode_u.ffs2_din->di_size))
   return (1);
 ...
 resid = uio->uio_resid;
 osize = (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_size : (ip)->dinode_u.ffs2_din->di_size);
 ...
 for (error = 0; uio->uio_resid > 0;) {
  ...
  if ((error = ((ip)->i_vtbl->iv_buf_alloc)((ip), (uio->uio_offset), (xfersize), (ap->a_cred), (flags), (&bp))) != 0)

   break;
  if (uio->uio_offset + xfersize > (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_size : (ip)->dinode_u.ffs2_din->di_size)) {
   do { if ((ip)->i_ump->um_fstype == 1) (ip)->dinode_u.ffs1_din->di_size = (uio->uio_offset + xfersize); else (ip)->dinode_u.ffs2_din->di_size = (uio->uio_offset + xfersize); } while (0);
   uvm_vnp_setsize(vp, (((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_size : (ip)->dinode_u.ffs2_din->di_size));
   extended = 1;
  }
  (void)uvm_vnp_uncache(vp);

  size = (((lbn) >= 12 || ((((ip))->i_ump->um_fstype == 1) ? ((ip))->dinode_u.ffs1_din->di_size : ((ip))->dinode_u.ffs2_din->di_size) >= ((lbn) + 1) << (fs)->fs_bshift) ? (u_int64_t)(fs)->fs_bsize : ((((((((((ip))->i_ump->um_fstype == 1) ? ((ip))->dinode_u.ffs1_din->di_size : ((ip))->dinode_u.ffs2_din->di_size)) & (fs)->fs_qbmask)) + (fs)->fs_qfmask) & (fs)->fs_fmask))) - bp->b_resid;
  if (size < xfersize)
   xfersize = size;
 ...
 if (resid > uio->uio_resid && ap->a_cred && ap->a_cred->cr_uid != 0 &&
  ...
  do { if ((ip)->i_ump->um_fstype == 1) (ip)->dinode_u.ffs1_din->di_mode = ((((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_mode : (ip)->dinode_u.ffs2_din->di_mode) & ~(0004000 | 0002000)); else (ip)->dinode_u.ffs2_din->di_mode = ((((ip)->i_ump->um_fstype == 1) ? (ip)->dinode_u.ffs1_din->di_mode : (ip)->dinode_u.ffs2_din->di_mode) & ~(0004000 | 0002000)); } while (0);
 if (resid > uio->uio_resid)
  do { struct klist *list = (&vp->v_selectinfo.si_note); if ((list) != ((void *)0)) knote((list), ((0x0002 | (extended ? 0x0004 : 0)))); } while (0);
 if (error) {
  if (ioflag & 0x01) {
   (void)((ip)->i_vtbl->iv_truncate)((ip), (osize), (ioflag & 0x04), (ap->a_cred));

   uio->uio_offset -= resid - uio->uio_resid;
   uio->uio_resid = resid;
  }
 } else if (resid > uio->uio_resid && (ioflag & 0x04)) {
  error = ((ip)->i_vtbl->iv_update)((ip), (1));
 }
...
ffs_fsync(void *v)
{
 ...
 if (vp->v_type == VBLK &&
     vp->v_un.vu_specinfo->si_mountpoint != ((void *)0) &&
     (vp->v_un.vu_specinfo->si_mountpoint->mnt_flag & 0x04000000))
...
loop:
 for (bp = ((&vp->v_dirtyblkhd)->lh_first); bp;
  ...
  bp->b_flags &= ~0x00100000;
 for (bp = ((&vp->v_dirtyblkhd)->lh_first); bp; bp = nbp) {
  nbp = ((bp)->b_vnbufs.le_next);
# 443 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c"
  if (bp->b_flags & (0x00000010 | 0x00100000))
   continue;
  ...
  if (skipmeta && bp->b_lblkno < 0)
   continue;
  if (ap->a_waitfor != 1 &&
      ((&bp->b_dep)->lh_first) != ((void *)0) &&
      (bp->b_flags & 0x00080000) == 0 &&
...
# 501 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../ufs/ffs/ffs_vnops.c"
   if (passes > 0) {
    passes -= 1;
    goto loop;
   }
 ...
 _splx(s);
 return (((((struct inode *)(vp)->v_data))->i_vtbl->iv_update)((((struct inode *)(vp)->v_data)), (ap->a_waitfor == 1)));
}
...
ffs_reclaim(void *v)
{
 ...
 if (ip->dinode_u.ffs1_din != ((void *)0)) {

  if (ip->i_ump->um_fstype == 2)
   pool_put(&ffs_dinode2_pool, ip->dinode_u.ffs2_din);
  else

   pool_put(&ffs_dinode1_pool, ip->dinode_u.ffs1_din);
 }
