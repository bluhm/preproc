# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_kms.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_kms.c"
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_kms.c"
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_kms.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_kms.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_kms.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreend.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_kms.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_shaders.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_shaders.h"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_kms.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/cayman_blit_shaders.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/cayman_blit_shaders.h"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_kms.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_blit_common.h" 1
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_blit_kms.c" 2
    ...
    int w, int h, u64 gpu_addr)
{
 ...
 cb_color_info = ((format) << 2) |
  ((1) << 24) |
  ((2) << 8);
 pitch = (w / 8) - 1;
 slice = ((w * h) / 64) - 1;

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((15) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28c60 - 0x00028000) >> 2);
      ...
      u64 mc_addr)
{
 ...
 if (rdev->family >= CHIP_CAYMAN) {
  ...
  radeon_ring_write(ring, (0x85e8 - 0x00008000) >> 2);
  radeon_ring_write(ring, 0);
 }
...
set_shaders(struct radeon_device *rdev)
{
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((3) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x2885c - 0x00028000) >> 2);
 radeon_ring_write(ring, gpu_addr >> 8);
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((4) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28840 - 0x00028000) >> 2);
 radeon_ring_write(ring, gpu_addr >> 8);
 ...
 gpu_addr = rdev->r600_blit.shader_gpu_addr + rdev->r600_blit.vs_offset;
 cp_set_surface_sync(rdev, (1 << 27), 512, gpu_addr);
}
...
set_vtx_resource(struct radeon_device *rdev, u64 gpu_addr)
{
 ...
 sq_vtx_constant_word2 = ((((u32)(((gpu_addr) >> 16) >> 16)) & 0xff) << 0) |
  ((16) << 8);

 sq_vtx_constant_word2 |= ((2) << 30);


 sq_vtx_constant_word3 = ((0) << 3) |
  ((1) << 6) |
  ((2) << 9) |
  ((3) << 12);

 radeon_ring_write(ring, ((3 << 30) | (((0x6D) & 0xFF) << 8) | ((8) & 0x3FFF) << 16));
 ...
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, (((0x3) & 3) << 30));
      ...
      int x2, int y2)
{
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((2) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28030 - 0x00028000) >> 2);
 radeon_ring_write(ring, (x1 << 0) | (y1 << 16));
 radeon_ring_write(ring, (x2 << 0) | (y2 << 16));

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((2) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28240 - 0x00028000) >> 2);
 radeon_ring_write(ring, (x1 << 0) | (y1 << 16) | (1 << 31));
 radeon_ring_write(ring, (x2 << 0) | (y2 << 16));

 radeon_ring_write(ring, ((3 << 30) | (((0x69) & 0xFF) << 8) | ((2) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x28204 - 0x00028000) >> 2);
 radeon_ring_write(ring, (x1 << 0) | (y1 << 16) | (1 << 31));
 radeon_ring_write(ring, (x2 << 0) | (y2 << 16));
}
...
draw_auto(struct radeon_device *rdev)
{
 struct radeon_ring *ring = &rdev->ring[0];
 radeon_ring_write(ring, ((3 << 30) | (((0x68) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, (0x8958 - 0x00008000) >> 2);
 radeon_ring_write(ring, 0x11);

 radeon_ring_write(ring, ((3 << 30) | (((0x2A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16));
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x2F) & 0xFF) << 8) | ((0) & 0x3FFF) << 16));
 radeon_ring_write(ring, 1);

 radeon_ring_write(ring, ((3 << 30) | (((0x2D) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, 3);
 radeon_ring_write(ring, 0x2);
...
set_default_state(struct radeon_device *rdev)
{
 ...
 if (rdev->family < CHIP_CAYMAN) {
  ...
  sq_gpr_resource_mgmt_1 = (((num_ps_gprs) << 0) |
       ((num_vs_gprs) << 16) |
       ((num_temp_gprs) << 28));
  sq_gpr_resource_mgmt_2 = (((num_gs_gprs) << 0) |
       ((num_es_gprs) << 16));
  sq_gpr_resource_mgmt_3 = (((num_hs_gprs) << 0) |
       ((num_ls_gprs) << 16));
  sq_thread_resource_mgmt = (((num_ps_threads) << 0) |
        ((num_vs_threads) << 8) |
        ((num_gs_threads) << 16) |
        ((num_es_threads) << 24));
  sq_thread_resource_mgmt_2 = (((num_hs_threads) << 0) |
          ((num_ls_threads) << 8));
  sq_stack_resource_mgmt_1 = (((num_ps_stack_entries) << 0) |
         ((num_vs_stack_entries) << 16));
  sq_stack_resource_mgmt_2 = (((num_gs_stack_entries) << 0) |
         ((num_es_stack_entries) << 16));
  sq_stack_resource_mgmt_3 = (((num_hs_stack_entries) << 0) |
         ((num_ls_stack_entries) << 16));


  radeon_ring_write(ring, ((3 << 30) | (((0x68) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
  radeon_ring_write(ring, (0x8D8C - 0x00008000) >> 2);
  radeon_ring_write(ring, 0);


  radeon_ring_write(ring, ((3 << 30) | (((0x68) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
  radeon_ring_write(ring, (0x8E2C - 0x00008000) >> 2);
  radeon_ring_write(ring, 0x10001000);


  radeon_ring_write(ring, ((3 << 30) | (((0x68) & 0xFF) << 8) | ((11) & 0x3FFF) << 16));
  radeon_ring_write(ring, (0x8C00 - 0x00008000) >> 2);
...
int evergreen_blit_init(struct radeon_device *rdev)
{
 ...
 if (!rdev->r600_blit.shader_obj) {
  r = radeon_bo_create(rdev, obj_size, (1 << 13), 1,
         0x4,
         ((void *)0), &rdev->r600_blit.shader_obj);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "evergreen failed to allocate shader\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return r;
  }
  ...
  if (__builtin_expect(!!(r != 0), 0))
   return r;
  r = radeon_bo_pin(rdev->r600_blit.shader_obj, 0x4,
      &rdev->r600_blit.shader_gpu_addr);
  radeon_bo_unreserve(rdev->r600_blit.shader_obj);
  if (r) {
   printf("drm:pid%d:%s *ERROR* " "(%d) pin blit object failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   return r;
  }
 }
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "failed to map blit object %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }

 if (rdev->family < CHIP_CAYMAN) {
  __builtin_memcpy((ptr + rdev->r600_blit.state_offset), (evergreen_default_state), (rdev->r600_blit.state_len * 4));
