# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c"
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c"
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
int ddb_sysctl(int *, u_int, void *, size_t *, void *, size_t,
         struct proc *);
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
# 89 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/ns16550reg.h" 1
# 90 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c" 2
...
int comdefaultrate = (9600);

int comconsfreq;
int comconsrate = (9600);
bus_addr_t comconsaddr = 0;
int comconsattached;
bus_space_tag_t comconsiot;
bus_space_handle_t comconsioh;
int comconsunit;
tcflag_t comconscflag = (0x00000800 | 0x00000300 | 0x00004000);
...
comspeed(long freq, long speed)
{
 ...
 if (speed < 0)
  return -1;
 x = ((((freq / 16))*2/(speed)+1)/2);
 if (x <= 0)
  return -1;
 err = ((((quad_t)freq * 1000 / 16)*2/(speed * x)+1)/2) - 1000;
 if (err < 0)
  err = -err;
 if (err > 30)
  return -1;
...
comprobe1(bus_space_tag_t iot, bus_space_handle_t ioh)
{
 ...
 bus_space_write_1(iot, ioh, 3, 0);
 bus_space_write_1(iot, ioh, 2, 0);
 for (i = 0; i < 32; i++) {
  k = bus_space_read_1(iot, ioh, 2);
  if (k & 0x38) {
...
com_activate(struct device *self, int act)
{
 ...
 case 1:
  ...
  s = _splraise(6);
  if (sc->disable != ((void *)0) && sc->enabled != 0) {
   (*sc->disable)(sc);
   sc->enabled = 0;
  }
  _splx(s);
...
{
 int unit = (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x7f);
 struct com_softc *sc;
 bus_space_tag_t iot;
 ...
 if (!((tp->t_state) & (0x00020))) {
  ...
  if (((sc->sc_hwflags) & (0x40))) {
   tp->t_termios.c_cflag = comconscflag;
   tp->t_termios.c_ispeed = tp->t_termios.c_ospeed = comconsrate;
  } else

  {
   tp->t_termios.c_cflag = (0x00000800 | 0x00000300 | 0x00004000);
   tp->t_termios.c_ispeed = tp->t_termios.c_ospeed = comdefaultrate;
  }
  if (((sc->sc_swflags) & (0x02)))
   ((tp->t_termios.c_cflag) |= (0x00008000));
  if (((sc->sc_swflags) & (0x04)))
   ((tp->t_termios.c_cflag) |= (0x00010000));
  if (((sc->sc_swflags) & (0x08)))
  ...
  sc->sc_ibufhigh = sc->sc_ibuf + ((3 * (32 * 512)) / 4);
  sc->sc_ibufend = sc->sc_ibuf + (32 * 512);
  ...
  if (!((sc->sc_hwflags) & (0x40))) {
   ...
   case 0x05:
   case 0x06:
    bus_space_write_1(iot, ioh, 3, 0xbf);
    bus_space_write_1(iot, ioh, 2, 0x10);
  ...
  if (((sc->sc_hwflags) & (0x02))) {
   u_int8_t fifo = 0x01|0x02|0x04;
   u_int8_t lcr;

   if (tp->t_termios.c_ispeed <= 1200)
    fifo |= 0x00;
   else if (tp->t_termios.c_ispeed <= 38400)
    fifo |= 0x40;
   else
    fifo |= 0x80;
   if (sc->sc_uarttype == 0x07) {
    fifo |= 0x20;
    lcr = bus_space_read_1(iot, ioh, 3);
    bus_space_write_1(iot, ioh, 3,
        lcr | 0x80);
   }
# 345 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c"
   for (;;) {
    bus_space_write_1(iot, ioh, 2, 0);
    delay(100);
    (void) bus_space_read_1(iot, ioh, 0);
    bus_space_write_1(iot, ioh, 2, fifo |
        0x02 | 0x04);
    delay(100);
    if(!((bus_space_read_1(iot, ioh, 5)) & (0x01)))

     break;
   }
   if (sc->sc_uarttype == 0x07)
    bus_space_write_1(iot, ioh, 3, lcr);
  }


  while (((bus_space_read_1(iot, ioh, 5)) & (0x01)))
   (void) bus_space_read_1(iot, ioh, 0);
  ...
  if (!((sc->sc_hwflags) & (0x01)))
   ((sc->sc_mcr) |= (0x08));
  bus_space_write_1(iot, ioh, 4, sc->sc_mcr);
  sc->sc_ier = 0x1 | 0x4 | 0x8;
  bus_space_write_1(iot, ioh, 1, sc->sc_ier);

  sc->sc_msr = bus_space_read_1(iot, ioh, 6);
  if (((sc->sc_swflags) & (0x01)) || (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x80) ||
      ((sc->sc_msr) & (0x80)) || ((tp->t_termios.c_cflag) & (0x00100000)))
   ((tp->t_state) |= (0x00008));
  else
   ((tp->t_state) &= ~(0x00008));
 ...
 if ((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x80)) {
  ...
  if (((flag) & (0x0004))) {
   ...
   while (sc->sc_cua ||
    ...
    !((tp->t_state) & (0x00008)))) {
    ((tp->t_state) |= (0x00200));
    error = ttysleep(tp, &tp->t_rawq, 25 | 0x100, ttopen, 0);





    if (error && ((tp->t_state) & (0x00200))) {
     ((tp->t_state) &= ~(0x00200));
     if (!sc->sc_cua && !((tp->t_state) & (0x00020)))
      compwroff(sc);
     _splx(s);
     return error;
    }
...
comclose(dev_t dev, int flag, int mode, struct proc *p)
{
 ...
 if(sc->sc_swflags & 0x20)
  return 0;

 (*linesw[tp->t_line].l_close)(tp, flag, p);
 s = _splraise(6);
 if (((tp->t_state) & (0x00200))) {
 ...
 ((tp->t_state) &= ~(0x00004 | 0x00010));
 sc->sc_cua = 0;
 _splx(s);
 ttyclose(tp);
# 467 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c"
 return 0;
}
...
compwroff(struct com_softc *sc)
{
 ...
 ((sc->sc_lcr) &= ~(0x40));
 bus_space_write_1(iot, ioh, 3, sc->sc_lcr);
 bus_space_write_1(iot, ioh, 1, 0);
 ...
 if (!((sc->sc_hwflags) & (0x40))) {
  ...
  case 0x06:
   bus_space_write_1(iot, ioh, 3, 0xbf);
   bus_space_write_1(iot, ioh, 2, 0x10);
   bus_space_write_1(iot, ioh, 1, 0x10);
   bus_space_write_1(iot, ioh, 3, 0);
   break;
  case 0x07:
   bus_space_write_1(iot, ioh, 1, 0x10);
...
com_resume(struct com_softc *sc)
{
 ...
 ospeed = comspeed(sc->sc_frequency, tp->t_termios.c_ospeed);

 if (ospeed != 0) {
  bus_space_write_1(iot, ioh, 3, sc->sc_lcr | 0x80);
  bus_space_write_1(iot, ioh, 0, ospeed);
  bus_space_write_1(iot, ioh, 1, ospeed >> 8);
  bus_space_write_1(iot, ioh, 3, sc->sc_lcr);
 } else {
  bus_space_write_1(iot, ioh, 3, sc->sc_lcr);
 }
...
# 588 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c"
  for (;;) {
   bus_space_write_1(iot, ioh, 2, 0);
   delay(100);
   (void) bus_space_read_1(iot, ioh, 0);
...
com_raisedtr(void *arg)
{
 ...
 ((sc->sc_mcr) |= (0x01 | 0x02));
 bus_space_write_1(sc->sc_iot, sc->sc_ioh, 4, sc->sc_mcr);
}

int
comread(dev_t dev, struct uio *uio, int flag)
{
 struct com_softc *sc = com_cd.cd_devs[(((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) & 0x7f)];
 struct tty *tp = sc->sc_tty;
...
{
 struct com_softc *sc = com_cd.cd_devs[(((int32_t)((tp->t_dev) & 0xff) | (((tp->t_dev) & 0xffff0000) >> 8)) & 0x7f)];
 bus_space_tag_t iot = sc->sc_iot;
 bus_space_handle_t ioh = sc->sc_ioh;
 ...
 if (sc->sc_initialize || (tp->t_termios.c_ispeed != t->c_ispeed)) {
  sc->sc_initialize = 0;

  if (ospeed != 0) {
# 833 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c"
   while (((tp->t_state) & (0x00004))) {
    int error;
   ...
   bus_space_write_1(iot, ioh, 3, lcr | 0x80);
   bus_space_write_1(iot, ioh, 0, ospeed);
   bus_space_write_1(iot, ioh, 1, ospeed >> 8);
   bus_space_write_1(iot, ioh, 3, lcr);
   ((sc->sc_mcr) |= (0x01));
 ...
 if (!((sc->sc_msr) & (0x80)) &&
     !((sc->sc_swflags) & (0x01)) &&
     ((oldcflag) & (0x00100000)) != ((tp->t_termios.c_cflag) & (0x00100000)) &&
...
comstart(struct tty *tp)
{
 ...
 if (((tp->t_state) & (0x00004)))
  goto out;
 if (((tp->t_state) & (0x00080 | 0x00100)) || sc->sc_halt > 0)
  goto stopped;
 if (((tp->t_termios.c_cflag) & (0x00010000)) && !((sc->sc_msr) & (0x10)))
  goto stopped;
 ttwakeupwr(tp);
 if (tp->t_outq.c_cc == 0)
  goto stopped;
 ...
 if (((sc->sc_hwflags) & (0x02))) {
  ...
  for (i = 0; i < n; i++) {
   bus_space_write_1(iot, ioh, 0, buffer[i]);
  }
  __builtin_bzero((buffer), (n));
 } else if (tp->t_outq.c_cc != 0)
  bus_space_write_1(iot, ioh, 0, getc(&tp->t_outq));
out:
 _splx(s);
 return;
stopped:
...
comdiag(void *arg)
{
 ...
 sc->sc_floods = 0;
 _splx(s);
 log(4, "%s: %d silo overflow%s, %d ibuf overflow%s\n",
     sc->sc_dev.dv_xname,
...
comsoft(void *arg)
{
 ...
 if (sc == ((void *)0) || sc->sc_ibufp == sc->sc_ibuf)
  return;
 ...
 if (tp == ((void *)0) || !((tp->t_state) & (0x00020))) {
  _splx(s);
  return;
 }
 ...
 if (((tp->t_termios.c_cflag) & (0x00010000)) &&
  ...
  ((sc->sc_mcr) |= (0x02));
  bus_space_write_1(sc->sc_iot, sc->sc_ioh, 4,
      sc->sc_mcr);
 }
 ...
 while (ibufp < ibufend) {
  ...
  c |= lsrmap[(*ibufp++ & (0x10|0x08|0x04)) >> 2];
...
comintr(void *arg)
{
 ...
 if (((bus_space_read_1(iot, ioh, 2)) & (0x1)))
  return (0);

 tp = sc->sc_tty;

 for (;;) {
  lsr = bus_space_read_1(iot, ioh, 5);
  ...
  if (((lsr) & (0x01))) {
   ...
   do {
    data = bus_space_read_1(iot, ioh, 0);
    if (((lsr) & (0x10))) {
  ...
  msr = bus_space_read_1(iot, ioh, 6);

  if (msr != sc->sc_msr) {
   delta = msr ^ sc->sc_msr;

   ttytstamp(tp, sc->sc_msr & 0x10, msr & 0x10,
       sc->sc_msr & 0x80, msr & 0x80);

   sc->sc_msr = msr;
   if (((delta) & (0x80))) {
    if (!((sc->sc_swflags) & (0x01)) &&
        (*linesw[tp->t_line].l_modem)(tp, ((msr) & (0x80))) == 0) {
     ((sc->sc_mcr) &= ~(sc->sc_dtr));
     bus_space_write_1(iot, ioh, 4, sc->sc_mcr);
    }
   }
  ...
  if (((lsr) & (0x20)) && ((tp->t_state) & (0x00004))) {
   ((tp->t_state) &= ~(0x00004 | 0x00010));
   if (sc->sc_halt > 0)
    wakeup(&tp->t_outq);
   (*linesw[tp->t_line].l_start)(tp);
...
cominit(bus_space_tag_t iot, bus_space_handle_t ioh, int rate, int frequency)
{
 ...
 rate = comspeed(frequency, rate);
 bus_space_write_1(iot, ioh, 0, rate);
 bus_space_write_1(iot, ioh, 1, rate >> 8);
 bus_space_write_1(iot, ioh, 3, 0x03);
 bus_space_write_1(iot, ioh, 4, 0x01 | 0x02);
 bus_space_write_1(iot, ioh, 1, 0);
 bus_space_write_1(iot, ioh, 2,
     0x01 | 0x02 | 0x04 | 0x00);
 stat = bus_space_read_1(iot, ioh, 2);
...
comcnprobe(struct consdev *cp)
{
 ...
 if (bus_space_map(comconsiot, comconsaddr, 8, 0, &ioh))
  return;
 found = comprobe1(comconsiot, ioh);
 bus_space_unmap(comconsiot, ioh, 8);
 if (!found)
  return;
 ...
 cp->cn_dev = ((dev_t)((((commajor) & 0xff) << 8) | ((comconsunit) & 0xff) | (((comconsunit) & 0xffff00) << 8)));
 cp->cn_pri = 3;
}
...
{
 if (bus_space_map(comconsiot, comconsaddr, 8, 0, &comconsioh))
    ...
    int frequency, tcflag_t cflag)
{
 static struct consdev comcons = {
  ((void *)0), ((void *)0), comcngetc, comcnputc, comcnpollc, ((void *)0),
  (dev_t)(-1), 1
 };
...
com_attach_subr(struct com_softc *sc)
{
 ...
 bus_space_write_1(iot, ioh, 2, 0x01);
 delay(100);




 if (sc->sc_uarttype == 0x00) {
  switch (bus_space_read_1(iot, ioh, 2) >> 6) {
  case 0:
   sc->sc_uarttype = 0x02;
   break;
  case 2:
 ...
 if (probe && sc->sc_uarttype == 0x04) {
  bus_space_write_1(iot, ioh, 3, lcr | 0x80);
  if (bus_space_read_1(iot, ioh, 2) == 0) {
   bus_space_write_1(iot, ioh, 2, 0x80);
   if (bus_space_read_1(iot, ioh, 2) != 0)
    sc->sc_uarttype = 0x05;
   bus_space_write_1(iot, ioh, 2, 0);
  } else {
...
# 1420 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c"
 if (probe && sc->sc_uarttype == 0x04) {
  bus_space_write_1(iot, ioh, 3, lcr | 0x80);
  bus_space_write_1(iot, ioh, 2,
      0x01 | 0x20);
  if ((bus_space_read_1(iot, ioh, 2) >> 5) == 7) {
 ...
 if (probe && sc->sc_uarttype == 0x02) {
  u_int8_t scr0, scr1, scr2;

  scr0 = bus_space_read_1(iot, ioh, 7);
  bus_space_write_1(iot, ioh, 7, 0xa5);
  scr1 = bus_space_read_1(iot, ioh, 7);
  bus_space_write_1(iot, ioh, 7, 0x5a);
  scr2 = bus_space_read_1(iot, ioh, 7);
  bus_space_write_1(iot, ioh, 7, scr0);
 ...
 case 0x07:
  ...
  sc->sc_fifolen = 64;
  break;
# 1507 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/com.c"
 default:
 ...
 bus_space_write_1(iot, ioh, 2, 0x02 | 0x04);
 if (((bus_space_read_1(iot, ioh, 5)) & (0x01)))
  (void)bus_space_read_1(iot, ioh, 0);
 bus_space_write_1(iot, ioh, 2, 0);
 ...
 if (((sc->sc_hwflags) & (0x40))) {
  ...
  if (maj < nchrdev && cn_tab->cn_dev == (dev_t)(-1))
   cn_tab->cn_dev = ((dev_t)((((maj) & 0xff) << 8) | ((sc->sc_dev.dv_unit) & 0xff) | (((sc->sc_dev.dv_unit) & 0xffff00) << 8)));
 ...
 sc->sc_si = softintr_establish(6, comsoft, sc);
 if (sc->sc_si == ((void *)0))
...
com_fifo_probe(struct com_softc *sc)
{
 ...
 ier = 0;
 bus_space_write_1(iot, ioh, 1, ier);
 bus_space_write_1(iot, ioh, 3, 0x80);
 bus_space_write_1(iot, ioh, 0, 3);
 bus_space_write_1(iot, ioh, 1, 0);
 bus_space_write_1(iot, ioh, 3, 0x00 | 0x03);
 bus_space_write_1(iot, ioh, 4, 0x10);
 ...
 for (len = 0; len < 256; len++) {
  bus_space_write_1(iot, ioh, 0, (len + 1));
  timo = 2000;
  while (!((bus_space_read_1(iot, ioh, 5)) & (0x20)) && --timo)
 ...
 for (len = 0; len < 256; len++) {
  timo = 2000;
  while (!((bus_space_read_1(iot, ioh, 5)) & (0x01)) && --timo)

   delay(1);
  if (!timo || bus_space_read_1(iot, ioh, 0) != (len + 1))
   break;
 }
