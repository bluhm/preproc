# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/syslimits.h" 1
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c" 2
...
# 133 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c"
int
...
fail:
 ...
 if (((cnp->cn_proc)->p_p->ps_traceflag & (1<<(3)) && ((cnp->cn_proc)->p_flag & 0x00000001) == 0))
 ...
 if ((ndp->ni_rootdir = fdp->fd_rdir) == ((void *)0))
...
badlink:
  ...
  linklen = 1024 - auio.uio_resid;
  if (linklen == 0) {
   error = 2;
   goto badlink;
  }
  if (linklen + ndp->ni_pathlen >= 1024) {
   error = 63;
   goto badlink;
  }
  if (ndp->ni_pathlen > 1) {
   __builtin_memcpy((cp + linklen), (ndp->ni_next), (ndp->ni_pathlen));
   pool_put(&namei_pool, cnp->cn_pnbuf);
   cnp->cn_pnbuf = cp;
  } else
...
# 411 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c"
int
vfs_lookup(struct nameidata *ndp)
{
 ...
 if (*cp == '/') {
  ...
  if (cnp->cn_nameptr[0] == '\0') {
   if (ndp->ni_dvp == ((void *)0) && wantparent) {
    error = 21;
    goto bad;
   }
   ndp->ni_vp = dp;
   cnp->cn_flags |= 0x008000;
   goto terminal;
  }
 }

dirloop:
# 484 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c"
 cnp->cn_consume = 0;
 ...
 if (cnp->cn_namelen > 255) {
  error = 63;
  goto bad;
 }
# 505 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c"
 if (ndp->ni_p_path != ((void *)0))
 ...
 if (cnp->cn_namelen == 2 &&
  ...
  cnp->cn_flags |= 0x002000;
 else
  cnp->cn_flags &= ~0x002000;
# 557 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c"
 ...
 if ((error = VOP_LOOKUP(dp, &ndp->ni_vp, cnp)) != 0) {
  ...
  if (rdonly || (ndp->ni_dvp->v_mount->mnt_flag & 0x00000001)) {
   error = 30;
   goto bad;
  }
  ...
  if (cnp->cn_flags & 0x001000) {
   ndp->ni_startdir = ndp->ni_dvp;
   vref(ndp->ni_startdir);
  }
  return (0);
 }
# 635 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c"
 if (cnp->cn_consume > 0) {
 ...
 while (dp->v_type == VDIR && (mp = dp->v_un.vu_mountedhere) &&
 ...
 if ((dp->v_type == VLNK) && (cnp->cn_flags & (0x0040|0x080000))) {
  ndp->ni_pathlen += slashes;
  ndp->ni_next -= slashes;
  cnp->cn_flags |= 0x010000;
  if (ndp->ni_p_path != ((void *)0))
...
terminal:
 ...
 if (cnp->cn_nameiop == 2 || cnp->cn_nameiop == 3) {




  if (rdonly || (dp->v_mount->mnt_flag & 0x00000001) ||
      (wantparent &&
      (ndp->ni_dvp->v_mount->mnt_flag & 0x00000001))) {
   error = 30;
   goto bad2;
  }
 }
 if (ndp->ni_dvp != ((void *)0)) {
  if (cnp->cn_flags & 0x001000) {
   ndp->ni_startdir = ndp->ni_dvp;
   vref(ndp->ni_startdir);
  }
...
vfs_relookup(struct vnode *dvp, struct vnode **vpp, struct componentname *cnp)
{
 ...
 dp = dvp;
 vn_lock(dp, 0x0001UL | 0x2000UL, p);
# 801 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lookup.c"
 if (cnp->cn_nameptr[0] == '\0')
 ...
 if ((error = VOP_LOOKUP(dp, vpp, cnp)) != 0) {
  ...
  if (rdonly || (dvp->v_mount->mnt_flag & 0x00000001)) {
   error = 30;
   goto bad;
  }
 ...
 if (dp->v_type == VLNK && (cnp->cn_flags & 0x0040))
 ...
 if (cnp->cn_nameiop == 2 || cnp->cn_nameiop == 3) {
  ...
  if (rdonly || (dp->v_mount->mnt_flag & 0x00000001) ||
      (wantparent &&
      (dvp->v_mount->mnt_flag & 0x00000001))) {
   error = 30;
   goto bad2;
  }
 }
