# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c"
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c"
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600d.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600_reg_safe.h" 1
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c" 2
...
static _Bool avivo_is_in_vblank(struct radeon_device *rdev, int crtc)
{
 if (r100_mm_rreg(rdev, (0x609c + crtc_offsets[crtc]), 0) & (1 << 0))
  return 1;
 else
  return 0;
}

static _Bool avivo_is_counter_moving(struct radeon_device *rdev, int crtc)
{
 u32 pos1, pos2;

 pos1 = r100_mm_rreg(rdev, (0x60a0 + crtc_offsets[crtc]), 0);
 pos2 = r100_mm_rreg(rdev, (0x60a0 + crtc_offsets[crtc]), 0);
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c"
void avivo_wait_for_vblank(struct radeon_device *rdev, int crtc)
{
 ...
 if (!(r100_mm_rreg(rdev, (0x6080 + crtc_offsets[crtc]), 0) & (1 << 0)))
  return;
...
void rs600_pm_misc(struct radeon_device *rdev)
{
 ...
 if ((voltage->type == VOLTAGE_GPIO) && (voltage->gpio.valid)) {
  ...
  radeon_atom_set_voltage(rdev, voltage->vddc_id, 1);

 dyn_pwrmgt_sclk_length = rdev->pll_rreg(rdev, (0xc));
 dyn_pwrmgt_sclk_length &= ~((0xf) << 8);
 dyn_pwrmgt_sclk_length &= ~((0xf) << 12);
 if (ps->misc & 0x00000100L) {
  if (ps->misc & 0x00800000L) {
   dyn_pwrmgt_sclk_length |= ((2) << 8);
   dyn_pwrmgt_sclk_length |= ((2) << 12);
  } else if (ps->misc & 0x01000000L) {
   dyn_pwrmgt_sclk_length |= ((4) << 8);
   dyn_pwrmgt_sclk_length |= ((4) << 12);
  }
 } else {
  dyn_pwrmgt_sclk_length |= ((1) << 8);
  dyn_pwrmgt_sclk_length |= ((1) << 12);
 }
 rdev->pll_wreg(rdev, (0xc), (dyn_pwrmgt_sclk_length));

 dyn_sclk_vol_cntl = rdev->pll_rreg(rdev, (0xe));
 if (ps->misc & 0x00000200L) {
  dyn_sclk_vol_cntl |= (1 << 0);
  if (voltage->delay) {
   dyn_sclk_vol_cntl |= (1 << 2);
   dyn_sclk_vol_cntl |= ((voltage->delay) << 3);
  } else
   dyn_sclk_vol_cntl &= ~(1 << 2);
 } else
  dyn_sclk_vol_cntl &= ~(1 << 0);
 rdev->pll_wreg(rdev, (0xe), (dyn_sclk_vol_cntl));

 hdp_dyn_cntl = rdev->pll_rreg(rdev, (0x10));
 if (ps->misc & 0x02000000L)
  hdp_dyn_cntl &= ~(1 << 0);
 else
  hdp_dyn_cntl |= (1 << 0);
 rdev->pll_wreg(rdev, (0x10), (hdp_dyn_cntl));
# 232 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c"
 dyn_backbias_cntl = rdev->pll_rreg(rdev, (0x29));
 if (ps->misc & 0x00000004L)
  dyn_backbias_cntl |= (1 << 0);
 else
  dyn_backbias_cntl &= ~(1 << 0);
 rdev->pll_wreg(rdev, (0x29), (dyn_backbias_cntl));
...
void rs600_pm_prepare(struct radeon_device *rdev)
{
 ...
 for (crtc = ({ __typeof( ((__typeof(*crtc) *)0)->head ) *__mptr = ((&ddev->mode_config.crtc_list)->next); (__typeof(*crtc) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtc), head) );}); &crtc->head != (&ddev->mode_config.crtc_list); crtc = ({ __typeof( ((__typeof(*crtc) *)0)->head ) *__mptr = (crtc->head.next); (__typeof(*crtc) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtc), head) );})) {
  ...
  if (radeon_crtc->enabled) {
   tmp = r100_mm_rreg(rdev, (0x6080 + radeon_crtc->crtc_offset), 0);
   tmp |= (1 << 24);
   r100_mm_wreg(rdev, (0x6080 + radeon_crtc->crtc_offset), (tmp), 0);
  }
 }
}
...
_Bool rs600_hpd_sense(struct radeon_device *rdev, enum radeon_hpd_id hpd)
{
 ...
 switch (hpd) {
 case RADEON_HPD_1:
  tmp = r100_mm_rreg(rdev, (0x007D04), 0);
  if ((((tmp) >> 1) & 0x1))
   connected = 1;
  break;
 case RADEON_HPD_2:
  tmp = r100_mm_rreg(rdev, (0x007D14), 0);
  if ((((tmp) >> 1) & 0x1))
   connected = 1;
  break;
 default:
...
{
 u32 tmp;
 _Bool connected = rs600_hpd_sense(rdev, hpd);

 switch (hpd) {
 case RADEON_HPD_1:
  tmp = r100_mm_rreg(rdev, (0x007D08), 0);
  if (connected)
   tmp &= ~(((1) & 0x1) << 8);
  else
   tmp |= (((1) & 0x1) << 8);
  r100_mm_wreg(rdev, (0x007D08), (tmp), 0);
  break;
 case RADEON_HPD_2:
  tmp = r100_mm_rreg(rdev, (0x007D18), 0);
  if (connected)
   tmp &= ~(((1) & 0x1) << 8);
  else
   tmp |= (((1) & 0x1) << 8);
  r100_mm_wreg(rdev, (0x007D18), (tmp), 0);
  break;
 default:
  break;
 }
...
void rs600_hpd_init(struct radeon_device *rdev)
{
 ...
 for (connector = ({ __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = ((&dev->mode_config.connector_list)->next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );}); &connector->head != (&dev->mode_config.connector_list); connector = ({ __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = (connector->head.next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );})) {
  ...
  case RADEON_HPD_1:
   r100_mm_wreg(rdev, (0x007D00), ((((1) & 0x1) << 0)), 0);

   break;
  case RADEON_HPD_2:
   r100_mm_wreg(rdev, (0x007D10), ((((1) & 0x1) << 0)), 0);
...
void rs600_hpd_fini(struct radeon_device *rdev)
{
 ...
 for (connector = ({ __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = ((&dev->mode_config.connector_list)->next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );}); &connector->head != (&dev->mode_config.connector_list); connector = ({ __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = (connector->head.next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );})) {
  ...
  switch (radeon_connector->hpd.hpd) {
  case RADEON_HPD_1:
   r100_mm_wreg(rdev, (0x007D00), ((((0) & 0x1) << 0)), 0);

   break;
  case RADEON_HPD_2:
   r100_mm_wreg(rdev, (0x007D10), ((((0) & 0x1) << 0)), 0);
...
int rs600_asic_reset(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x0000F0), ((((1) & 0x1) << 8)), 0);
 r100_mm_rreg(rdev, (0x0000F0), 0);
 mdelay(500);
 r100_mm_wreg(rdev, (0x0000F0), (0), 0);
 mdelay(1);
...
void rs600_gart_tlb_flush(struct radeon_device *rdev)
{
 ...
 tmp = rdev->mc_rreg(rdev, (0x000100));
 tmp &= 0xEFFFFFFF & 0xDFFFFFFF;
 rdev->mc_wreg(rdev, (0x000100), (tmp));

 tmp = rdev->mc_rreg(rdev, (0x000100));
 tmp |= (((1) & 0x1) << 28) | (((1) & 0x1) << 29);
 rdev->mc_wreg(rdev, (0x000100), (tmp));
...
static int rs600_gart_enable(struct radeon_device *rdev)
{
 ...
 tmp = r100_mm_rreg(rdev, (0x0030), 0) & ~(1 << 14);
 r100_mm_wreg(rdev, (0x0030), (tmp), 0);

 rdev->mc_wreg(rdev, (0x000100), (((((6) & 0x7) << 15) | (((6) & 0x7) << 21))));



 for (i = 0; i < 19; i++) {
  rdev->mc_wreg(rdev, (0x00016C + i), ((((1) & 0x1) << 0) | (((3) & 0x3) << 8) | (((0) & 0x1) << 10) | (((3) & 0x7) << 11) | (((1) & 0x1) << 14) | (((3) & 0x7) << 15)));
# 524 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/rs600.c"
 }

 rdev->mc_wreg(rdev, (0x000102), ((((1) & 0x1) << 0) | (((0) & 0x3) << 1)));




 for (i = 1; i < 8; i++)
  rdev->mc_wreg(rdev, (0x000102 + i), (0));


 rdev->mc_wreg(rdev, (0x00012C), (rdev->gart.table_addr));

 rdev->mc_wreg(rdev, (0x00013C), (rdev->mc.gtt_start));
 rdev->mc_wreg(rdev, (0x00014C), (rdev->mc.gtt_end));
 rdev->mc_wreg(rdev, (0x00011C), (0));


 rdev->mc_wreg(rdev, (0x000112), (rdev->mc.vram_start));
 rdev->mc_wreg(rdev, (0x000114), (rdev->mc.vram_end));


 tmp = rdev->mc_rreg(rdev, (0x000100));
 rdev->mc_wreg(rdev, (0x000100), ((tmp | (((1) & 0x1) << 0))));
 tmp = rdev->mc_rreg(rdev, (0x000009));
 rdev->mc_wreg(rdev, (0x000009), ((tmp | (((1) & 0x1) << 26))));
...
static void rs600_gart_disable(struct radeon_device *rdev)
{
 ...
 rdev->mc_wreg(rdev, (0x000100), (0));
 tmp = rdev->mc_rreg(rdev, (0x000009));
 rdev->mc_wreg(rdev, (0x000009), (tmp & 0xFBFFFFFF));
...
int rs600_irq_set(struct radeon_device *rdev)
{
 uint32_t tmp = 0;
 uint32_t mode_int = 0;
 u32 hpd1 = r100_mm_rreg(rdev, (0x007D08), 0) &
  ~(((1) & 0x1) << 16);
 u32 hpd2 = r100_mm_rreg(rdev, (0x007D18), 0) &
  ~(((1) & 0x1) << 16);
 u32 hdmi0;
 if (((rdev->family == CHIP_RS600) || (rdev->family == CHIP_RS690) || (rdev->family == CHIP_RS740) || (rdev->family >= CHIP_R600)))
  hdmi0 = r100_mm_rreg(rdev, (0x007408), 0) &
   ~(((1) & 0x1) << 28);
 else
  hdmi0 = 0;
 ...
 r100_mm_wreg(rdev, (0x000040), (tmp), 0);
 r100_mm_wreg(rdev, (0x006540), (mode_int), 0);
 r100_mm_wreg(rdev, (0x007D08), (hpd1), 0);
 r100_mm_wreg(rdev, (0x007D18), (hpd2), 0);
 if (((rdev->family == CHIP_RS600) || (rdev->family == CHIP_RS690) || (rdev->family == CHIP_RS740) || (rdev->family >= CHIP_R600)))
  r100_mm_wreg(rdev, (0x007408), (hdmi0), 0);
 return 0;
}

static inline u32 rs600_irq_ack(struct radeon_device *rdev)
{
 uint32_t irqs = r100_mm_rreg(rdev, (0x000044), 0);
 uint32_t irq_mask = (((1) & 0x1) << 25);
 u32 tmp;

 if ((((irqs) >> 0) & 0x1)) {
  rdev->irq.stat_regs.r500.disp_int = r100_mm_rreg(rdev, (0x007EDC), 0);
  if ((((rdev->irq.stat_regs.r500.disp_int) >> 4) & 0x1)) {
   r100_mm_wreg(rdev, (0x006534), ((((1) & 0x1) << 4)), 0);

  }
  if ((((rdev->irq.stat_regs.r500.disp_int) >> 5) & 0x1)) {
   r100_mm_wreg(rdev, (0x006D34), ((((1) & 0x1) << 4)), 0);

  }
  if ((((rdev->irq.stat_regs.r500.disp_int) >> 18) & 0x1)) {
   tmp = r100_mm_rreg(rdev, (0x007D08), 0);
   tmp |= (((1) & 0x1) << 0);
   r100_mm_wreg(rdev, (0x007D08), (tmp), 0);
  }
  if ((((rdev->irq.stat_regs.r500.disp_int) >> 19) & 0x1)) {
   tmp = r100_mm_rreg(rdev, (0x007D18), 0);
   tmp |= (((1) & 0x1) << 0);
   r100_mm_wreg(rdev, (0x007D18), (tmp), 0);
  }
 ...
 if (((rdev->family == CHIP_RS600) || (rdev->family == CHIP_RS690) || (rdev->family == CHIP_RS740) || (rdev->family >= CHIP_R600))) {
  rdev->irq.stat_regs.r500.hdmi0_status = r100_mm_rreg(rdev, (0x007404), 0) &
   (((1) & 0x1) << 28);
  if ((((rdev->irq.stat_regs.r500.hdmi0_status) >> 28) & 0x1)) {
   tmp = r100_mm_rreg(rdev, (0x007408), 0);
   tmp |= (((1) & 0x1) << 29);
   r100_mm_wreg(rdev, (0x007408), (tmp), 0);
  }
 } else
  rdev->irq.stat_regs.r500.hdmi0_status = 0;

 if (irqs) {
  r100_mm_wreg(rdev, (0x000044), (irqs), 0);
 }
...
void rs600_irq_disable(struct radeon_device *rdev)
{
 u32 hdmi0 = r100_mm_rreg(rdev, (0x007408), 0) &
  ~(((1) & 0x1) << 28);
 r100_mm_wreg(rdev, (0x007408), (hdmi0), 0);
 r100_mm_wreg(rdev, (0x000040), (0), 0);
 r100_mm_wreg(rdev, (0x006540), (0), 0);
...
int rs600_irq_process(struct radeon_device *rdev)
{
 ...
 if (rdev->msi_enabled) {
  ...
  case CHIP_RS690:
  case CHIP_RS740:
   msi_rearm = r100_mm_rreg(rdev, (0x0030), 0) & ~(1 << 20);
   r100_mm_wreg(rdev, (0x0030), (msi_rearm), 0);
   r100_mm_wreg(rdev, (0x0030), (msi_rearm | (1 << 20)), 0);
   break;
  default:
...
{
 if (crtc == 0)
  return r100_mm_rreg(rdev, (0x0060A4), 0);
 else
  return r100_mm_rreg(rdev, (0x0068A4), 0);
}
...
int rs600_mc_wait_for_idle(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < rdev->usec_timeout; i++) {
  if ((((rdev->mc_rreg(rdev, (0x000000))) >> 0) & 0x1))
   return 0;
  udelay(1);
 }
 return -1;
...
static void rs600_mc_init(struct radeon_device *rdev)
{
 ...
 base = rdev->mc_rreg(rdev, (0x000004));
...
void rs600_bandwidth_update(struct radeon_device *rdev)
{
 ...
 if (rdev->disp_priority == 2) {
  d1mode_priority_a_cnt = r100_mm_rreg(rdev, (0x006548), 0);
  d2mode_priority_a_cnt = r100_mm_rreg(rdev, (0x006D48), 0);
...
uint32_t rs600_mc_rreg(struct radeon_device *rdev, uint32_t reg64)
{
 r100_mm_wreg(rdev, (0x000070), ((((reg64) & 0xFFFF) << 0) | (((1) & 0x1) << 21)), 0);

 return r100_mm_rreg(rdev, (0x000074), 0);
}

void rs600_mc_wreg(struct radeon_device *rdev, uint32_t reg64, uint32_t v)
{
 r100_mm_wreg(rdev, (0x000070), ((((reg64) & 0xFFFF) << 0) | (((1) & 0x1) << 21) | (((1) & 0x1) << 23)), 0);

 r100_mm_wreg(rdev, (0x000074), (v), 0);
}
...
void rs600_set_safe_registers(struct radeon_device *rdev)
{
 ...
 rdev->config.r300.reg_safe_bm_size = (sizeof((rs600_reg_safe_bm)) / sizeof((rs600_reg_safe_bm)[0]));
}
...
static void rs600_mc_program(struct radeon_device *rdev)
{
 ...
 rdev->mc_wreg(rdev, (0x000005), (0x0FFFFFFF));
