...
_Bool rs600_page_flip_pending(struct radeon_device *rdev, int crtc_id)
{
 struct radeon_crtc *radeon_crtc = rdev->mode_info.crtcs[crtc_id];
...
void avivo_program_fmt(struct drm_encoder *encoder)
{
 ...
 case 0x13:
  r100_mm_wreg(rdev, (0x7894), (tmp), 0);
  break;
 case 0x0F:
  r100_mm_wreg(rdev, (0x7a94), (tmp), 0);
  break;
 case 0x14:
  r100_mm_wreg(rdev, (0x7988), (tmp), 0);
  break;
 case 0x19:
  r100_mm_wreg(rdev, (0x7214), (tmp), 0);
  break;
 default:
  break;
 }
...
uint32_t rs600_mc_rreg(struct radeon_device *rdev, uint32_t reg64)
{
 ...
 r = r100_mm_rreg(rdev, (0x000074), 0);
