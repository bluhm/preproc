...
extern _Bool evergreen_is_display_hung(struct radeon_device *rdev);
...
extern void cik_sdma_enable(struct radeon_device *rdev, _Bool enable);
extern void cik_sdma_fini(struct radeon_device *rdev);
extern void vce_v2_0_enable_mgcg(struct radeon_device *rdev, _Bool enable);
...
u32 cik_didt_rreg(struct radeon_device *rdev, u32 reg64)
{
 unsigned long flags;
 u32 r;
 _spin_lock_irqsave(&rdev->didt_idx_lock, flags );
 r100_mm_wreg(rdev, (0xca00), ((reg64)), 0);
 r = r100_mm_rreg(rdev, (0xca04), 0);
 _spin_unlock_irqrestore(&rdev->didt_idx_lock, flags );
 return r;
}
void cik_didt_wreg(struct radeon_device *rdev, u32 reg64, u32 v)
{
...
int ci_get_temp(struct radeon_device *rdev)
{
 u32 temp;
 int actual_temp = 0;
 temp = (tn_smc_rreg(rdev, (0xC0300014)) & 0x0003fe00) >>
  9;
 if (temp & 0x200)
  actual_temp = 255;
 else
...
int kv_get_temp(struct radeon_device *rdev)
{
 u32 temp;
 int actual_temp = 0;
 temp = tn_smc_rreg(rdev, (0xC0300E0C));
 if (temp)
...
u32 cik_pciep_rreg(struct radeon_device *rdev, u32 reg64)
{
 unsigned long flags;
 u32 r;
 _spin_lock_irqsave(&rdev->pciep_idx_lock, flags );
 r100_mm_wreg(rdev, (0x38), (reg64), 0);
 (void)r100_mm_rreg(rdev, (0x38), 0);
 r = r100_mm_rreg(rdev, (0x3C), 0);
 _spin_unlock_irqrestore(&rdev->pciep_idx_lock, flags );
 return r;
}
void cik_pciep_wreg(struct radeon_device *rdev, u32 reg64, u32 v)
{
 unsigned long flags;
 _spin_lock_irqsave(&rdev->pciep_idx_lock, flags );
 r100_mm_wreg(rdev, (0x38), (reg64), 0);
 (void)r100_mm_rreg(rdev, (0x38), 0);
 r100_mm_wreg(rdev, (0x3C), (v), 0);
 (void)r100_mm_rreg(rdev, (0x3C), 0);
 _spin_unlock_irqrestore(&rdev->pciep_idx_lock, flags );
}
...
{
 _rw_enter_write(&rdev->grbm_idx_mutex );
 switch (rdev->family) {
 case CHIP_BONAIRE:
  radeon_program_register_sequence(rdev,
       bonaire_mgcg_cgcg_init,
       (const u32)(sizeof((bonaire_mgcg_cgcg_init)) / sizeof((bonaire_mgcg_cgcg_init)[0])));
  radeon_program_register_sequence(rdev,
       bonaire_golden_registers,
       (const u32)(sizeof((bonaire_golden_registers)) / sizeof((bonaire_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       bonaire_golden_common_registers,
       (const u32)(sizeof((bonaire_golden_common_registers)) / sizeof((bonaire_golden_common_registers)[0])));
  radeon_program_register_sequence(rdev,
       bonaire_golden_spm_registers,
       (const u32)(sizeof((bonaire_golden_spm_registers)) / sizeof((bonaire_golden_spm_registers)[0])));
  break;
 case CHIP_KABINI:
  radeon_program_register_sequence(rdev,
       kalindi_mgcg_cgcg_init,
       (const u32)(sizeof((kalindi_mgcg_cgcg_init)) / sizeof((kalindi_mgcg_cgcg_init)[0])));
  radeon_program_register_sequence(rdev,
       kalindi_golden_registers,
       (const u32)(sizeof((kalindi_golden_registers)) / sizeof((kalindi_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       kalindi_golden_common_registers,
       (const u32)(sizeof((kalindi_golden_common_registers)) / sizeof((kalindi_golden_common_registers)[0])));
  radeon_program_register_sequence(rdev,
       kalindi_golden_spm_registers,
       (const u32)(sizeof((kalindi_golden_spm_registers)) / sizeof((kalindi_golden_spm_registers)[0])));
  break;
 case CHIP_MULLINS:
  radeon_program_register_sequence(rdev,
       kalindi_mgcg_cgcg_init,
  ...
  radeon_program_register_sequence(rdev,
       ...
       (const u32)(sizeof((godavari_golden_registers)) / sizeof((godavari_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       kalindi_golden_common_registers,
       (const u32)(sizeof((kalindi_golden_common_registers)) / sizeof((kalindi_golden_common_registers)[0])));
  radeon_program_register_sequence(rdev,
 ...
 case CHIP_KAVERI:
  radeon_program_register_sequence(rdev,
       ...
       (const u32)(sizeof((spectre_mgcg_cgcg_init)) / sizeof((spectre_mgcg_cgcg_init)[0])));
  radeon_program_register_sequence(rdev,
       spectre_golden_registers,
       (const u32)(sizeof((spectre_golden_registers)) / sizeof((spectre_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       spectre_golden_common_registers,
       (const u32)(sizeof((spectre_golden_common_registers)) / sizeof((spectre_golden_common_registers)[0])));
  radeon_program_register_sequence(rdev,
       spectre_golden_spm_registers,
       (const u32)(sizeof((spectre_golden_spm_registers)) / sizeof((spectre_golden_spm_registers)[0])));
  break;
 case CHIP_HAWAII:
  radeon_program_register_sequence(rdev,
       hawaii_mgcg_cgcg_init,
       (const u32)(sizeof((hawaii_mgcg_cgcg_init)) / sizeof((hawaii_mgcg_cgcg_init)[0])));
  radeon_program_register_sequence(rdev,
       hawaii_golden_registers,
       (const u32)(sizeof((hawaii_golden_registers)) / sizeof((hawaii_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       hawaii_golden_common_registers,
       (const u32)(sizeof((hawaii_golden_common_registers)) / sizeof((hawaii_golden_common_registers)[0])));
  radeon_program_register_sequence(rdev,
       hawaii_golden_spm_registers,
       (const u32)(sizeof((hawaii_golden_spm_registers)) / sizeof((hawaii_golden_spm_registers)[0])));
  break;
 default:
  break;
 }
 _rw_exit_write(&rdev->grbm_idx_mutex );
}
u32 cik_get_xclk(struct radeon_device *rdev)
{
        u32 reference_clock = rdev->clock.spll.reference_freq;
 if (rdev->flags & RADEON_IS_IGP) {
  if (tn_smc_rreg(rdev, (0xC0200000)) & (1 << 15))
   return reference_clock / 2;
 } else {
  if (tn_smc_rreg(rdev, (0xC05001A0)) & (1 << 1))
...
u32 cik_mm_rdoorbell(struct radeon_device *rdev, u32 index)
{
 if (index < rdev->doorbell.num_doorbells) {
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "reading beyond doorbell aperture: 0x%08x!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , index);
  return 0;
 }
}
void cik_mm_wdoorbell(struct radeon_device *rdev, u32 index, u32 v)
{
 if (index < rdev->doorbell.num_doorbells) {
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "writing beyond doorbell aperture: 0x%08x!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , index);
 }
}
static const u32 bonaire_io_mc_regs[36][2] =
{
...
static const u32 hawaii_io_mc_regs[22][2] =
{
...
{
 u32 srbm_gfx_cntl = (((pipe & 0x3) << 0) |
        ((me & 0x3) << 2) |
        ((vmid & 0xf) << 4) |
        ((queue & 0x7) << 8));
 r100_mm_wreg(rdev, (0xE44), (srbm_gfx_cntl), 0);
}
int ci_mc_load_microcode(struct radeon_device *rdev)
{
 ...
 if (rdev->new_fw) {
  ...
  regs_size = (__uint32_t)(__builtin_constant_p(hdr->io_debug_size_bytes) ? (__uint32_t)(((__uint32_t)(hdr->io_debug_size_bytes) & 0xff) << 24 | ((__uint32_t)(hdr->io_debug_size_bytes) & 0xff00) << 8 | ((__uint32_t)(hdr->io_debug_size_bytes) & 0xff0000) >> 8 | ((__uint32_t)(hdr->io_debug_size_bytes) & 0xff000000) >> 24) : __swap32md(hdr->io_debug_size_bytes)) / (4 * 2);
  new_io_mc_regs = (const __le32 *)
   (rdev->mc_fw->data + (__uint32_t)(__builtin_constant_p(hdr->io_debug_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(hdr->io_debug_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(hdr->io_debug_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(hdr->io_debug_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(hdr->io_debug_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(hdr->io_debug_array_offset_bytes)));
 ...
 running = r100_mm_rreg(rdev, (0x28c8), 0) & (1 << 0);
 if (running == 0) {
  if (running) {
   blackout = r100_mm_rreg(rdev, (0x20ac), 0);
   r100_mm_wreg(rdev, (0x20ac), (blackout | 1), 0);
  }
  r100_mm_wreg(rdev, (0x28c8), (0x00000008), 0);
  r100_mm_wreg(rdev, (0x28c8), (0x00000010), 0);
  for (i = 0; i < regs_size; i++) {
   if (rdev->new_fw) {
    r100_mm_wreg(rdev, (0x2a44), (__mswap32(new_io_mc_regs++)), 0);
    r100_mm_wreg(rdev, (0x2a48), (__mswap32(new_io_mc_regs++)), 0);
   } else {
    r100_mm_wreg(rdev, (0x2a44), (io_mc_regs[(i << 1)]), 0);
    r100_mm_wreg(rdev, (0x2a48), (io_mc_regs[(i << 1) + 1]), 0);
   }
  }
  tmp = r100_mm_rreg(rdev, (0x2a00), 0);
  if ((rdev->pdev->device == 0x6649) && ((tmp & 0xff00) == 0x5600)) {
   r100_mm_wreg(rdev, (0x2a44), (5), 0);
   r100_mm_wreg(rdev, (0x2a48), (0x00000023), 0);
   r100_mm_wreg(rdev, (0x2a44), (9), 0);
   r100_mm_wreg(rdev, (0x2a48), (0x000001f0), 0);
  }
  for (i = 0; i < ucode_size; i++) {
   if (rdev->new_fw)
    r100_mm_wreg(rdev, (0x28cc), (__mswap32(new_fw_data++)), 0);
   else
    r100_mm_wreg(rdev, (0x28cc), (((__uint32_t)(*(__uint32_t *)(fw_data++)))), 0);
  }
  r100_mm_wreg(rdev, (0x28c8), (0x00000008), 0);
  r100_mm_wreg(rdev, (0x28c8), (0x00000004), 0);
  r100_mm_wreg(rdev, (0x28c8), (0x00000001), 0);
  for (i = 0; i < rdev->usec_timeout; i++) {
   if (r100_mm_rreg(rdev, (0x28e8), 0) & (1 << 30))
    break;
   udelay(1);
  }
  for (i = 0; i < rdev->usec_timeout; i++) {
   if (r100_mm_rreg(rdev, (0x28e8), 0) & (1 << 31))
    break;
   udelay(1);
  }
  if (running)
   r100_mm_wreg(rdev, (0x20ac), (blackout), 0);
 }
 return 0;
}
static int cik_init_microcode(struct radeon_device *rdev)
{
 ...
 case CHIP_BONAIRE:
  ...
  mc_req_size = 7866 * 4;
  mc2_req_size = 7948 * 4;
  sdma_req_size = 1050 * 4;
  smc_req_size = (((0x1FDEC)+((4)-1))&(~((4)-1)));
  num_fw = 8;
  break;
 case CHIP_HAWAII:
  chip_name = "HAWAII";
 ...
 case CHIP_MULLINS:
  ...
  num_fw = 6;
  break;
 default: do { panic("BUG at %s:%d", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/cik.c", 2055); } while (0);
 }
 do { } while( 0);
 ...
 if (err) {
  ...
  if (rdev->pfp_fw->size != pfp_req_size) {
   printf("" "cik_cp: Bogus length %zu in firmware \"%s\"\n", rdev->pfp_fw->size, fw_name);
   err = -22;
   goto out;
  }
 } else {
  ...
  if (err) {
   printf("" "cik_fw: validation failed for firmware \"%s\"\n", fw_name);
   goto out;
  } else {
   new_fw++;
  }
 ...
 if (err) {
  ...
  if (rdev->rlc_fw->size != rlc_req_size) {
   printf("" "cik_rlc: Bogus length %zu in firmware \"%s\"\n", rdev->rlc_fw->size, fw_name);
   err = -22;
  }
 } else {
 ...
 if (err) {
  ...
  if (rdev->sdma_fw->size != sdma_req_size) {
   printf("" "cik_sdma: Bogus length %zu in firmware \"%s\"\n", rdev->sdma_fw->size, fw_name);
   err = -22;
  }
 } else {
 ...
 if (!(rdev->flags & RADEON_IS_IGP)) {
  ...
  if (err) {
   ...
   if ((rdev->mc_fw->size != mc_req_size) &&
    ...
    printf("" "cik_mc: Bogus length %zu in firmware \"%s\"\n", rdev->mc_fw->size, fw_name);
    err = -22;
   }
   do { } while( 0);
  } else {
  ...
  if (err) {
   ...
   if (err) {
    ...
    printf("" "cik_smc: Bogus length %zu in firmware \"%s\"\n", rdev->smc_fw->size, fw_name);
    err = -22;
   }
  } else {
 ...
 if (new_fw == 0) {
  ...
  printf("" "ci_fw: mixing new and old firmware!\n");
  err = -22;
 } else {
  rdev->new_fw = 1;
 }
out:
 if (err) {
  if (err != -22)
   printf("" "cik_cp: Failed to load firmware \"%s\"\n", fw_name);
...
static void cik_tiling_mode_table_init(struct radeon_device *rdev)
{
 ...
 case 1:
  split_equal_to_row_size = 4;
  break;
 case 2:
 default:
  split_equal_to_row_size = 5;
  break;
 case 4:
  split_equal_to_row_size = 6;
  break;
 }
 ...
 if (num_pipe_configs == 16) {
  for (reg_offset = 0; reg_offset < num_tile_mode_states; reg_offset++) {
   ...
   r100_mm_wreg(rdev, (0x9910 + (reg_offset * 4)), (gb_tile_moden), 0);
  }
  for (reg_offset = 0; reg_offset < num_secondary_tile_mode_states; reg_offset++) {
   ...
   r100_mm_wreg(rdev, (0x9990 + (reg_offset * 4)), (gb_tile_moden), 0);
  }
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "unknown num pipe config: 0x%x\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , num_pipe_configs);
}
        ...
        u32 se_num, u32 sh_num)
{
 ...
 if ((se_num == 0xffffffff) && (sh_num == 0xffffffff))
  ...
  data |= ((sh_num) << 8) | ((se_num) << 16);
 r100_mm_wreg(rdev, (0x30800), (data), 0);
}
...
{
 u32 data, mask;
 data = r100_mm_rreg(rdev, (0x98F4), 0);
 if (data & 1)
  data &= 0x00FF0000;
 else
  data = 0;
 data |= r100_mm_rreg(rdev, (0x9B7C), 0);
 data >>= 16;
 ...
 for (i = 0; i < se_num; i++) {
  for (j = 0; j < sh_per_se; j++) {
   ...
   if (rdev->family == CHIP_HAWAII)
    disabled_rbs |= data << ((i * sh_per_se + j) * 4);
   else
 ...
 for (i = 0; i < se_num; i++) {
  ...
  for (j = 0; j < sh_per_se; j++) {
   ...
   case 0:
    ...
    break;
   case 1:
    data |= (0 << (i * sh_per_se + j) * 2);
    break;
   case 2:
    data |= (3 << (i * sh_per_se + j) * 2);
    break;
   case 3:
   default:
    data |= (2 << (i * sh_per_se + j) * 2);
    break;
   }
   enabled_rbs >>= 2;
  }
  r100_mm_wreg(rdev, (0x28350), (data), 0);
 }
 cik_select_se_sh(rdev, 0xffffffff, 0xffffffff);
 _rw_exit_write(&rdev->grbm_idx_mutex );
}
...
{
 u32 gb_addr_config = r100_mm_rreg(rdev, (0x98F8), 0);
 ...
 tmp = (mc_arb_ramcfg & 0x000000C0) >> 6;
 ...
 rdev->config.cik.tile_config |=
  ((mc_arb_ramcfg & 0x00000003) >> 0) << 4;
 rdev->config.cik.tile_config |=
  ((gb_addr_config & 0x00000070) >> 4) << 8;
 rdev->config.cik.tile_config |=
  ((gb_addr_config & 0x30000000) >> 28) << 12;
 r100_mm_wreg(rdev, (0x98F8), (gb_addr_config), 0);
 r100_mm_wreg(rdev, (0x2F48), (gb_addr_config), 0);
 r100_mm_wreg(rdev, (0xC00), (gb_addr_config), 0);
 r100_mm_wreg(rdev, (0xD018 + 0x0), (gb_addr_config & 0x70), 0);
 r100_mm_wreg(rdev, (0xD018 + 0x800), (gb_addr_config & 0x70), 0);
 ...
 r100_mm_wreg(rdev, (0x8764), (((0x30) << 0) | ((0x60) << 8)), 0);
 _rw_enter_write(&rdev->grbm_idx_mutex );
 cik_select_se_sh(rdev, 0xffffffff, 0xffffffff);
 r100_mm_wreg(rdev, (0x9060), (0x20), 0);
 r100_mm_wreg(rdev, (0x9508), (0x00010000), 0);
 tmp = r100_mm_rreg(rdev, (0x9100), 0);
 tmp |= 0x03000000;
 r100_mm_wreg(rdev, (0x9100), (tmp), 0);
 r100_mm_wreg(rdev, (0x8C00), (1), 0);
 r100_mm_wreg(rdev, (0x9830), (0), 0);
 tmp = r100_mm_rreg(rdev, (0x9834), 0) & ~0xf00fffff;
 tmp |= 0x00000400;
 r100_mm_wreg(rdev, (0x9834), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x9838), 0) & ~0x0002021c;
 tmp |= 0x00020200;
 r100_mm_wreg(rdev, (0x9838), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x9A10), 0) & ~0x00010000;
 tmp |= 0x00018208;
 r100_mm_wreg(rdev, (0x9A10), (tmp), 0);
 r100_mm_wreg(rdev, (0x913C), (((4) << 0)), 0);
 r100_mm_wreg(rdev, (0x8BCC), ((((rdev->config.cik.sc_prim_fifo_size_frontend) << 0) | ((rdev->config.cik.sc_prim_fifo_size_backend) << 6) | ((rdev->config.cik.sc_hiz_tile_fifo_size) << 15) | ((rdev->config.cik.sc_earlyz_tile_fifo_size) << 23))), 0);
 r100_mm_wreg(rdev, (0x30934), (1), 0);
 r100_mm_wreg(rdev, (0x36020), (0), 0);
 r100_mm_wreg(rdev, (0x8C00), (0), 0);
 r100_mm_wreg(rdev, (0x8B24), ((((4095) << 0) | ((255) << 16))), 0);
 r100_mm_wreg(rdev, (0x88C4), (((2) << 0) | ((3) << 6)), 0);
 r100_mm_wreg(rdev, (0x88D4), (16), 0);
 r100_mm_wreg(rdev, (0x30a04), (0), 0);
 ...
 r100_mm_wreg(rdev, (0x8BF0), ((1 << 0)), 0);
 _rw_exit_write(&rdev->grbm_idx_mutex );
 udelay(50);
}
...
int cik_ring_test(struct radeon_device *rdev, struct radeon_ring *ring)
{
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x79) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
 radeon_ring_write(ring, ((scratch - 0x00030000) >> 2));
           ...
           int ridx)
{
 ...
 default:
  switch (ring->me) {
  case 0:
   ref_and_mask = (1 << 2) << ring->pipe;
   break;
  case 1:
   ref_and_mask = (1 << 6) << ring->pipe;
   break;
  default:
   return;
  }
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x3C) & 0xFF) << 8) | ((5) & 0x3FFF) << 16));
 radeon_ring_write(ring, (((1) << 6) |
     ((3) << 0) |
     ((1) << 8)));
 radeon_ring_write(ring, 0x54DC >> 2);
 radeon_ring_write(ring, 0x54E0 >> 2);
        ...
        struct radeon_fence *fence)
{
 ...
 radeon_ring_write(ring, (((u32)(((addr) >> 16) >> 16)) & 0xffff) |
    ((1) << 29) | ((0) << 24));
 ...
 radeon_ring_write(ring, ((1 << 16) |
     ...
     ((5) << 8)));
 radeon_ring_write(ring, addr & 0xfffffffc);
 radeon_ring_write(ring, (((u32)(((addr) >> 16) >> 16)) & 0xffff) | ((1) << 29) | ((2) << 24));
     ...
     struct radeon_fence *fence)
{
 struct radeon_ring *ring = &rdev->ring[fence->ring];
 u64 addr = rdev->fence_drv[fence->ring].gpu_addr;
 radeon_ring_write(ring, ((3 << 30) | (((0x49) & 0xFF) << 8) | ((5) & 0x3FFF) << 16));
 radeon_ring_write(ring, ((1 << 16) |
     (1 << 17) |
     (((20 << 0)) << 0) |
     ((5) << 8)));
 radeon_ring_write(ring, ((1) << 29) | ((2) << 24));
 radeon_ring_write(ring, addr & 0xfffffffc);
 radeon_ring_write(ring, ((u32)(((addr) >> 16) >> 16)));
 radeon_ring_write(ring, fence->seq);
 radeon_ring_write(ring, 0);
}
_Bool cik_semaphore_ring_emit(struct radeon_device *rdev,
        ...
        _Bool emit_wait)
{
 ...
 radeon_ring_write(ring, (((u32)(((addr) >> 16) >> 16)) & 0xffff) | sel);
 if (emit_wait && ring->idx == 0) {
        ...
        struct reservation_object *resv)
{
 ...
 for (i = 0; i < num_loops; i++) {
  ...
  if (size_in_bytes == 0)
   control |= (1 << 31);
  radeon_ring_write(ring, ((3 << 30) | (((0x50) & 0xFF) << 8) | ((5) & 0x3FFF) << 16));
  radeon_ring_write(ring, control);
  radeon_ring_write(ring, ((u32)(src_offset)));
  radeon_ring_write(ring, ((u32)(((src_offset) >> 16) >> 16)));
  radeon_ring_write(ring, ((u32)(dst_offset)));
  radeon_ring_write(ring, ((u32)(((dst_offset) >> 16) >> 16)));
...
void cik_ring_ib_execute(struct radeon_device *rdev, struct radeon_ib *ib)
{
 ...
 u32 header, control = (1 << 23);
 if (ib->is_const_ib) {
  radeon_ring_write(ring, ((3 << 30) | (((0x8B) & 0xFF) << 8) | ((0) & 0x3FFF) << 16));
  radeon_ring_write(ring, 0);
  header = ((3 << 30) | (((0x33) & 0xFF) << 8) | ((2) & 0x3FFF) << 16);
 } else {
  u32 next_rptr;
  if (ring->rptr_save_reg) {
   ...
   radeon_ring_write(ring, ((3 << 30) | (((0x37) & 0xFF) << 8) | ((3) & 0x3FFF) << 16));
   radeon_ring_write(ring, ((1) << 8));
   radeon_ring_write(ring, ring->next_rptr_gpu_addr & 0xfffffffc);
   radeon_ring_write(ring, ((u32)(((ring->next_rptr_gpu_addr) >> 16) >> 16)));
   radeon_ring_write(ring, next_rptr);
  }
  header = ((3 << 30) | (((0x3F) & 0xFF) << 8) | ((2) & 0x3FFF) << 16);
 }
 control |= ib->length_dw | (vm_id << 24);
 radeon_ring_write(ring, header);
 radeon_ring_write(ring, (ib->gpu_addr & 0xFFFFFFFC));
 radeon_ring_write(ring, ((u32)(((ib->gpu_addr) >> 16) >> 16)) & 0xFFFF);
 radeon_ring_write(ring, control);
}
int cik_ib_test(struct radeon_device *rdev, struct radeon_ring *ring)
{
 ...
 ib.ptr[0] = ((3 << 30) | (((0x79) & 0xFF) << 8) | ((1) & 0x3FFF) << 16);
 ib.ptr[1] = ((scratch - 0x00030000) >> 2);
 ib.ptr[2] = 0xDEADBEEF;
 ib.length_dw = 3;
...
static void cik_cp_gfx_enable(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  r100_mm_wreg(rdev, (0x86D8), (0), 0);
 else {
  if (rdev->asic->copy.copy_ring_index == 0)
   radeon_ttm_set_active_vram_size(rdev, rdev->mc.visible_vram_size);
  r100_mm_wreg(rdev, (0x86D8), (((1 << 28) | (1 << 26) | (1 << 24))), 0);
  rdev->ring[0].ready = 0;
 }
 udelay(50);
}
static int cik_cp_gfx_load_microcode(struct radeon_device *rdev)
{
 ...
 if (rdev->new_fw) {
  ...
  fw_data = (const __le32 *)
   (rdev->pfp_fw->data + (__uint32_t)(__builtin_constant_p(pfp_hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(pfp_hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(pfp_hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(pfp_hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(pfp_hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(pfp_hdr->header.ucode_array_offset_bytes)));
  fw_size = (__uint32_t)(__builtin_constant_p(pfp_hdr->header.ucode_size_bytes) ? (__uint32_t)(((__uint32_t)(pfp_hdr->header.ucode_size_bytes) & 0xff) << 24 | ((__uint32_t)(pfp_hdr->header.ucode_size_bytes) & 0xff00) << 8 | ((__uint32_t)(pfp_hdr->header.ucode_size_bytes) & 0xff0000) >> 8 | ((__uint32_t)(pfp_hdr->header.ucode_size_bytes) & 0xff000000) >> 24) : __swap32md(pfp_hdr->header.ucode_size_bytes)) / 4;
  r100_mm_wreg(rdev, (0xC150), (0), 0);
  for (i = 0; i < fw_size; i++)
   r100_mm_wreg(rdev, (0xC154), (__mswap32(fw_data++)), 0);
  r100_mm_wreg(rdev, (0xC150), ((__uint32_t)(__builtin_constant_p(pfp_hdr->header.ucode_version) ? (__uint32_t)(((__uint32_t)(pfp_hdr->header.ucode_version) & 0xff) << 24 | ((__uint32_t)(pfp_hdr->header.ucode_version) & 0xff00) << 8 | ((__uint32_t)(pfp_hdr->header.ucode_version) & 0xff0000) >> 8 | ((__uint32_t)(pfp_hdr->header.ucode_version) & 0xff000000) >> 24) : __swap32md(pfp_hdr->header.ucode_version))), 0);
  fw_data = (const __le32 *)
   (rdev->ce_fw->data + (__uint32_t)(__builtin_constant_p(ce_hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(ce_hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(ce_hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(ce_hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(ce_hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(ce_hdr->header.ucode_array_offset_bytes)));
  fw_size = (__uint32_t)(__builtin_constant_p(ce_hdr->header.ucode_size_bytes) ? (__uint32_t)(((__uint32_t)(ce_hdr->header.ucode_size_bytes) & 0xff) << 24 | ((__uint32_t)(ce_hdr->header.ucode_size_bytes) & 0xff00) << 8 | ((__uint32_t)(ce_hdr->header.ucode_size_bytes) & 0xff0000) >> 8 | ((__uint32_t)(ce_hdr->header.ucode_size_bytes) & 0xff000000) >> 24) : __swap32md(ce_hdr->header.ucode_size_bytes)) / 4;
  r100_mm_wreg(rdev, (0xC168), (0), 0);
  for (i = 0; i < fw_size; i++)
   r100_mm_wreg(rdev, (0xC16C), (__mswap32(fw_data++)), 0);
  r100_mm_wreg(rdev, (0xC168), ((__uint32_t)(__builtin_constant_p(ce_hdr->header.ucode_version) ? (__uint32_t)(((__uint32_t)(ce_hdr->header.ucode_version) & 0xff) << 24 | ((__uint32_t)(ce_hdr->header.ucode_version) & 0xff00) << 8 | ((__uint32_t)(ce_hdr->header.ucode_version) & 0xff0000) >> 8 | ((__uint32_t)(ce_hdr->header.ucode_version) & 0xff000000) >> 24) : __swap32md(ce_hdr->header.ucode_version))), 0);
  fw_data = (const __be32 *)
   (rdev->me_fw->data + (__uint32_t)(__builtin_constant_p(me_hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(me_hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(me_hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(me_hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(me_hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(me_hdr->header.ucode_array_offset_bytes)));
  fw_size = (__uint32_t)(__builtin_constant_p(me_hdr->header.ucode_size_bytes) ? (__uint32_t)(((__uint32_t)(me_hdr->header.ucode_size_bytes) & 0xff) << 24 | ((__uint32_t)(me_hdr->header.ucode_size_bytes) & 0xff00) << 8 | ((__uint32_t)(me_hdr->header.ucode_size_bytes) & 0xff0000) >> 8 | ((__uint32_t)(me_hdr->header.ucode_size_bytes) & 0xff000000) >> 24) : __swap32md(me_hdr->header.ucode_size_bytes)) / 4;
  r100_mm_wreg(rdev, (0xC15C), (0), 0);
  for (i = 0; i < fw_size; i++)
   r100_mm_wreg(rdev, (0xC160), (__mswap32(fw_data++)), 0);
  r100_mm_wreg(rdev, (0xC15C), ((__uint32_t)(__builtin_constant_p(me_hdr->header.ucode_version) ? (__uint32_t)(((__uint32_t)(me_hdr->header.ucode_version) & 0xff) << 24 | ((__uint32_t)(me_hdr->header.ucode_version) & 0xff00) << 8 | ((__uint32_t)(me_hdr->header.ucode_version) & 0xff0000) >> 8 | ((__uint32_t)(me_hdr->header.ucode_version) & 0xff000000) >> 24) : __swap32md(me_hdr->header.ucode_version))), 0);
  r100_mm_wreg(rdev, (0xC158), ((__uint32_t)(__builtin_constant_p(me_hdr->header.ucode_version) ? (__uint32_t)(((__uint32_t)(me_hdr->header.ucode_version) & 0xff) << 24 | ((__uint32_t)(me_hdr->header.ucode_version) & 0xff00) << 8 | ((__uint32_t)(me_hdr->header.ucode_version) & 0xff0000) >> 8 | ((__uint32_t)(me_hdr->header.ucode_version) & 0xff000000) >> 24) : __swap32md(me_hdr->header.ucode_version))), 0);
 } else {
  ...
  r100_mm_wreg(rdev, (0xC168), (0), 0);
  for (i = 0; i < 2144; i++)
   r100_mm_wreg(rdev, (0xC16C), (((__uint32_t)(*(__uint32_t *)(fw_data++)))), 0);
  r100_mm_wreg(rdev, (0xC168), (0), 0);
...
static int cik_cp_gfx_start(struct radeon_device *rdev)
{
 ...
 int r, i;
 r100_mm_wreg(rdev, (0xC2B8), (rdev->config.cik.max_hw_contexts - 1), 0);
 r100_mm_wreg(rdev, (0xC140), (0), 0);
 r100_mm_wreg(rdev, (0xC12C), (1), 0);
 ...
 radeon_ring_write(ring, ((3 << 30) | (((0x11) & 0xFF) << 8) | ((2) & 0x3FFF) << 16));
 radeon_ring_write(ring, ((3) << 0));
 radeon_ring_write(ring, 0x8000);
 radeon_ring_write(ring, 0x8000);
 radeon_ring_write(ring, ((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16));
 radeon_ring_write(ring, (2 << 28));
 radeon_ring_write(ring, ((3 << 30) | (((0x28) & 0xFF) << 8) | ((1) & 0x3FFF) << 16));
...
{
 cik_cp_gfx_enable(rdev, 0);
 radeon_ring_fini(rdev, &rdev->ring[0]);
}
static int cik_cp_gfx_resume(struct radeon_device *rdev)
{
 ...
 u64 rb_addr;
 int r;
 r100_mm_wreg(rdev, (0x301BC), (0x0), 0);
 if (rdev->family != CHIP_HAWAII)
  r100_mm_wreg(rdev, (0x301C8), (0x0), 0);
 r100_mm_wreg(rdev, (0x8704), (0), 0);
 r100_mm_wreg(rdev, (0xC144), (0), 0);
 r100_mm_wreg(rdev, (0x30144), (((rdev->wb.gpu_addr + 0) >> 8) & 0xFFFFFFFF), 0);
 ring = &rdev->ring[0];
 ...
 r100_mm_wreg(rdev, (0x30140), (0), 0);
 if (!rdev->wb.enabled)
  tmp |= (1 << 27);
 mdelay(1);
 r100_mm_wreg(rdev, (0xC104), (tmp), 0);
 rb_addr = ring->gpu_addr >> 8;
 r100_mm_wreg(rdev, (0xC100), (rb_addr), 0);
 r100_mm_wreg(rdev, (0xC2C4), (((u32)(((rb_addr) >> 16) >> 16))), 0);
 cik_cp_gfx_start(rdev);
 rdev->ring[0].ready = 1;
 r = (rdev)->asic->ring[(0)]->ring_test((rdev), (&rdev->ring[0]));
 if (r) {
  rdev->ring[0].ready = 0;
  return r;
 }
    ...
    struct radeon_ring *ring)
{
 ...
 if (rdev->wb.enabled) {
  ...
  _rw_enter_write(&rdev->srbm_mutex );
  cik_srbm_select(rdev, ring->me, ring->pipe, ring->queue, 0);
  rptr = r100_mm_rreg(rdev, (0xC93C), 0);
  cik_srbm_select(rdev, 0, 0, 0, 0);
  _rw_exit_write(&rdev->srbm_mutex );
 }
 return rptr;
}
u32 cik_compute_get_wptr(struct radeon_device *rdev,
    struct radeon_ring *ring)
{
 ...
 if (rdev->wb.enabled) {
  ...
  _rw_enter_write(&rdev->srbm_mutex );
  cik_srbm_select(rdev, ring->me, ring->pipe, ring->queue, 0);
  wptr = r100_mm_rreg(rdev, (0xC954), 0);
  cik_srbm_select(rdev, 0, 0, 0, 0);
  _rw_exit_write(&rdev->srbm_mutex );
 }
 return wptr;
     ...
     struct radeon_ring *ring)
{
 ...
 cik_mm_wdoorbell(rdev, (ring->doorbell_index), (ring->wptr));
}
        ...
        struct radeon_ring *ring)
{
 u32 j, tmp;
 cik_srbm_select(rdev, ring->me, ring->pipe, ring->queue, 0);
 tmp = r100_mm_rreg(rdev, (0xC20C), 0);
 tmp &= ~(1 << 31);
 r100_mm_wreg(rdev, (0xC20C), (tmp), 0);
 if (r100_mm_rreg(rdev, (0xC91C), 0) & 1) {
  r100_mm_wreg(rdev, (0xC974), (1), 0);
  for (j = 0; j < rdev->usec_timeout; j++) {
   if (!(r100_mm_rreg(rdev, (0xC91C), 0) & 1))
    break;
   udelay(1);
  }
  r100_mm_wreg(rdev, (0xC974), (0), 0);
  r100_mm_wreg(rdev, (0xC93C), (0), 0);
  r100_mm_wreg(rdev, (0xC954), (0), 0);
 }
 cik_srbm_select(rdev, 0, 0, 0, 0);
}
static void cik_cp_compute_enable(struct radeon_device *rdev, _Bool enable)
{
 if (enable)
  r100_mm_wreg(rdev, (0x8234), (0), 0);
 else {
  _rw_enter_write(&rdev->srbm_mutex );
  cik_compute_stop(rdev,&rdev->ring[1]);
  cik_compute_stop(rdev,&rdev->ring[2]);
  _rw_exit_write(&rdev->srbm_mutex );
  r100_mm_wreg(rdev, (0x8234), (((1 << 30) | (1 << 28))), 0);
  rdev->ring[1].ready = 0;
  rdev->ring[2].ready = 0;
 }
 udelay(50);
...
static int cik_cp_compute_load_microcode(struct radeon_device *rdev)
{
 ...
 if (rdev->new_fw) {
  ...
  fw_data = (const __le32 *)
   (rdev->mec_fw->data + (__uint32_t)(__builtin_constant_p(mec_hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(mec_hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(mec_hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(mec_hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(mec_hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(mec_hdr->header.ucode_array_offset_bytes)));
  fw_size = (__uint32_t)(__builtin_constant_p(mec_hdr->header.ucode_size_bytes) ? (__uint32_t)(((__uint32_t)(mec_hdr->header.ucode_size_bytes) & 0xff) << 24 | ((__uint32_t)(mec_hdr->header.ucode_size_bytes) & 0xff00) << 8 | ((__uint32_t)(mec_hdr->header.ucode_size_bytes) & 0xff0000) >> 8 | ((__uint32_t)(mec_hdr->header.ucode_size_bytes) & 0xff000000) >> 24) : __swap32md(mec_hdr->header.ucode_size_bytes)) / 4;
  r100_mm_wreg(rdev, (0xC170), (0), 0);
  for (i = 0; i < fw_size; i++)
   r100_mm_wreg(rdev, (0xC174), (__mswap32(fw_data++)), 0);
  r100_mm_wreg(rdev, (0xC170), ((__uint32_t)(__builtin_constant_p(mec_hdr->header.ucode_version) ? (__uint32_t)(((__uint32_t)(mec_hdr->header.ucode_version) & 0xff) << 24 | ((__uint32_t)(mec_hdr->header.ucode_version) & 0xff00) << 8 | ((__uint32_t)(mec_hdr->header.ucode_version) & 0xff0000) >> 8 | ((__uint32_t)(mec_hdr->header.ucode_version) & 0xff000000) >> 24) : __swap32md(mec_hdr->header.ucode_version))), 0);
  if (rdev->family == CHIP_KAVERI) {
   const struct gfx_firmware_header_v1_0 *mec2_hdr =
    (const struct gfx_firmware_header_v1_0 *)rdev->mec2_fw->data;
   fw_data = (const __le32 *)
    (rdev->mec2_fw->data +
     (__uint32_t)(__builtin_constant_p(mec2_hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(mec2_hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(mec2_hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(mec2_hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(mec2_hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(mec2_hdr->header.ucode_array_offset_bytes)));
   fw_size = (__uint32_t)(__builtin_constant_p(mec2_hdr->header.ucode_size_bytes) ? (__uint32_t)(((__uint32_t)(mec2_hdr->header.ucode_size_bytes) & 0xff) << 24 | ((__uint32_t)(mec2_hdr->header.ucode_size_bytes) & 0xff00) << 8 | ((__uint32_t)(mec2_hdr->header.ucode_size_bytes) & 0xff0000) >> 8 | ((__uint32_t)(mec2_hdr->header.ucode_size_bytes) & 0xff000000) >> 24) : __swap32md(mec2_hdr->header.ucode_size_bytes)) / 4;
   r100_mm_wreg(rdev, (0xC178), (0), 0);
   for (i = 0; i < fw_size; i++)
    r100_mm_wreg(rdev, (0xC17C), (__mswap32(fw_data++)), 0);
   r100_mm_wreg(rdev, (0xC178), ((__uint32_t)(__builtin_constant_p(mec2_hdr->header.ucode_version) ? (__uint32_t)(((__uint32_t)(mec2_hdr->header.ucode_version) & 0xff) << 24 | ((__uint32_t)(mec2_hdr->header.ucode_version) & 0xff00) << 8 | ((__uint32_t)(mec2_hdr->header.ucode_version) & 0xff0000) >> 8 | ((__uint32_t)(mec2_hdr->header.ucode_version) & 0xff000000) >> 24) : __swap32md(mec2_hdr->header.ucode_version))), 0);
  }
 } else {
  const __be32 *fw_data;
  ...
  r100_mm_wreg(rdev, (0xC170), (0), 0);
  for (i = 0; i < 4192; i++)
   r100_mm_wreg(rdev, (0xC174), (((__uint32_t)(*(__uint32_t *)(fw_data++)))), 0);
  r100_mm_wreg(rdev, (0xC170), (0), 0);
  if (rdev->family == CHIP_KAVERI) {
   fw_data = (const __be32 *)rdev->mec_fw->data;
   r100_mm_wreg(rdev, (0xC178), (0), 0);
   for (i = 0; i < 4192; i++)
    r100_mm_wreg(rdev, (0xC17C), (((__uint32_t)(*(__uint32_t *)(fw_data++)))), 0);
   r100_mm_wreg(rdev, (0xC178), (0), 0);
  }
 }
 return 0;
...
static void cik_cp_compute_fini(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < 2; i++) {
  ...
  if (rdev->ring[idx].mqd_obj) {
   ...
   if (__builtin_expect(!!(r != 0), 0))
    printf("drm:pid%d:%s *WARNING* " "(%d) reserve MQD bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
...
static void cik_mec_fini(struct radeon_device *rdev)
{
 ...
 if (rdev->mec.hpd_eop_obj) {
  ...
  if (__builtin_expect(!!(r != 0), 0))
   printf("drm:pid%d:%s *WARNING* " "(%d) reserve HPD EOP bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
...
static int cik_mec_init(struct radeon_device *rdev)
{
 ...
 if (rdev->mec.hpd_eop_obj == ((void *)0)) {
  r = radeon_bo_create(rdev,
         rdev->mec.num_mec *rdev->mec.num_pipe * 2048 * 2,
         (1 << 13), 1,
         0x2, 0, ((void *)0), ((void *)0),
         &rdev->mec.hpd_eop_obj);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "(%d) create HDP EOP bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   return r;
  }
 }
 r = radeon_bo_reserve(rdev->mec.hpd_eop_obj, 0);
 ...
 r = radeon_bo_pin(rdev->mec.hpd_eop_obj, 0x2,
     &rdev->mec.hpd_eop_gpu_addr);
 if (r) {
  printf("drm:pid%d:%s *WARNING* " "(%d) pin HDP EOP bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  cik_mec_fini(rdev);
  return r;
 }
 r = radeon_bo_kmap(rdev->mec.hpd_eop_obj, (void **)&hpd);
 if (r) {
  printf("drm:pid%d:%s *WARNING* " "(%d) map HDP EOP bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  cik_mec_fini(rdev);
  return r;
 }
 __builtin_memset((hpd), (0), (rdev->mec.num_mec *rdev->mec.num_pipe * 2048 * 2));
...
static int cik_cp_compute_resume(struct radeon_device *rdev)
{
 ...
 if (r)
  return r;
 tmp = r100_mm_rreg(rdev, (0xC200), 0);
 tmp |= (1 << 23);
 r100_mm_wreg(rdev, (0xC200), (tmp), 0);
 _rw_enter_write(&rdev->srbm_mutex );
 eop_gpu_addr = rdev->mec.hpd_eop_gpu_addr;
 cik_srbm_select(rdev, 0, 0, 0, 0);
 r100_mm_wreg(rdev, (0xC904), (eop_gpu_addr >> 8), 0);
 r100_mm_wreg(rdev, (0xC908), (((u32)(((eop_gpu_addr) >> 16) >> 16)) >> 8), 0);
 r100_mm_wreg(rdev, (0xC90C), (0), 0);
 tmp = r100_mm_rreg(rdev, (0xC910), 0);
 tmp &= ~(0x3f << 0);
 tmp |= drm_order(2048 / 8);
 r100_mm_wreg(rdev, (0xC910), (tmp), 0);
 _rw_exit_write(&rdev->srbm_mutex );
 for (i = 0; i < 2; i++) {
  if (i == 0)
   idx = 1;
  ...
  if (rdev->ring[idx].mqd_obj == ((void *)0)) {
   ...
   if (r) {
    printf("drm:pid%d:%s *WARNING* " "(%d) create MQD bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
    return r;
   }
  }
  r = radeon_bo_reserve(rdev->ring[idx].mqd_obj, 0);
  ...
  r = radeon_bo_pin(rdev->ring[idx].mqd_obj, 0x2,
      &mqd_gpu_addr);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "(%d) pin MQD bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   cik_cp_compute_fini(rdev);
   return r;
  }
  r = radeon_bo_kmap(rdev->ring[idx].mqd_obj, (void **)&buf);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "(%d) map MQD bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   cik_cp_compute_fini(rdev);
   return r;
  }
  __builtin_memset((buf), (0), (sizeof(struct bonaire_mqd)));
  ...
  mqd->queue_state.cp_hqd_pq_doorbell_control =
   r100_mm_rreg(rdev, (0xC950), 0);
  if (use_doorbell)
   mqd->queue_state.cp_hqd_pq_doorbell_control |= (1 << 30);
  else
   mqd->queue_state.cp_hqd_pq_doorbell_control &= ~(1 << 30);
  r100_mm_wreg(rdev, (0xC950), (mqd->queue_state.cp_hqd_pq_doorbell_control), 0);
  ...
  if (r100_mm_rreg(rdev, (0xC91C), 0) & 1) {
   ...
   r100_mm_wreg(rdev, (0xC974), (mqd->queue_state.cp_hqd_dequeue_request), 0);
   r100_mm_wreg(rdev, (0xC93C), (mqd->queue_state.cp_hqd_pq_rptr), 0);
   r100_mm_wreg(rdev, (0xC954), (mqd->queue_state.cp_hqd_pq_wptr), 0);
  }
  mqd->queue_state.cp_mqd_base_addr = mqd_gpu_addr & 0xfffffffc;
  mqd->queue_state.cp_mqd_base_addr_hi = ((u32)(((mqd_gpu_addr) >> 16) >> 16));
  r100_mm_wreg(rdev, (0xC914), (mqd->queue_state.cp_mqd_base_addr), 0);
  r100_mm_wreg(rdev, (0xC918), (mqd->queue_state.cp_mqd_base_addr_hi), 0);
  mqd->queue_state.cp_mqd_control = r100_mm_rreg(rdev, (0xC99C), 0);
  mqd->queue_state.cp_mqd_control &= ~(0xf << 0);
  r100_mm_wreg(rdev, (0xC99C), (mqd->queue_state.cp_mqd_control), 0);
  hqd_gpu_addr = rdev->ring[idx].gpu_addr >> 8;
  mqd->queue_state.cp_hqd_pq_base = hqd_gpu_addr;
  mqd->queue_state.cp_hqd_pq_base_hi = ((u32)(((hqd_gpu_addr) >> 16) >> 16));
  r100_mm_wreg(rdev, (0xC934), (mqd->queue_state.cp_hqd_pq_base), 0);
  r100_mm_wreg(rdev, (0xC938), (mqd->queue_state.cp_hqd_pq_base_hi), 0);
  mqd->queue_state.cp_hqd_pq_control = r100_mm_rreg(rdev, (0xC958), 0);
  ...
  mqd->queue_state.cp_hqd_pq_control |=
   (drm_order(4096/8) << 8);
  mqd->queue_state.cp_hqd_pq_control |= (2 << 16);
  mqd->queue_state.cp_hqd_pq_control &=
   ~((1 << 28) | (1 << 29) | (1 << 26));
  mqd->queue_state.cp_hqd_pq_control |=
   (1 << 30) | (1 << 31);
  r100_mm_wreg(rdev, (0xC958), (mqd->queue_state.cp_hqd_pq_control), 0);
  if (i == 0)
   wb_gpu_addr = rdev->wb.gpu_addr + 3328;
  else
   wb_gpu_addr = rdev->wb.gpu_addr + 3584;
  mqd->queue_state.cp_hqd_pq_wptr_poll_addr = wb_gpu_addr & 0xfffffffc;
  mqd->queue_state.cp_hqd_pq_wptr_poll_addr_hi = ((u32)(((wb_gpu_addr) >> 16) >> 16)) & 0xffff;
  r100_mm_wreg(rdev, (0xC948), (mqd->queue_state.cp_hqd_pq_wptr_poll_addr), 0);
  r100_mm_wreg(rdev, (0xC94C), (mqd->queue_state.cp_hqd_pq_wptr_poll_addr_hi), 0);
  if (i == 0)
   wb_gpu_addr = rdev->wb.gpu_addr + 1280;
  else
   wb_gpu_addr = rdev->wb.gpu_addr + 1536;
  mqd->queue_state.cp_hqd_pq_rptr_report_addr = wb_gpu_addr & 0xfffffffc;
  mqd->queue_state.cp_hqd_pq_rptr_report_addr_hi =
   ((u32)(((wb_gpu_addr) >> 16) >> 16)) & 0xffff;
  r100_mm_wreg(rdev, (0xC940), (mqd->queue_state.cp_hqd_pq_rptr_report_addr), 0);
  r100_mm_wreg(rdev, (0xC944), (mqd->queue_state.cp_hqd_pq_rptr_report_addr_hi), 0);
  if (use_doorbell) {
   mqd->queue_state.cp_hqd_pq_doorbell_control =
    r100_mm_rreg(rdev, (0xC950), 0);
   mqd->queue_state.cp_hqd_pq_doorbell_control &= ~(0x1fffff << 2);
   mqd->queue_state.cp_hqd_pq_doorbell_control |=
    ((rdev->ring[idx].doorbell_index) << 2);
   mqd->queue_state.cp_hqd_pq_doorbell_control |= (1 << 30);
   mqd->queue_state.cp_hqd_pq_doorbell_control &=
    ~((1 << 28) | (1 << 31));
  } else {
  ...
  r100_mm_wreg(rdev, (0xC954), (mqd->queue_state.cp_hqd_pq_wptr), 0);
  mqd->queue_state.cp_hqd_pq_rptr = r100_mm_rreg(rdev, (0xC93C), 0);
  mqd->queue_state.cp_hqd_vmid = 0;
  r100_mm_wreg(rdev, (0xC920), (mqd->queue_state.cp_hqd_vmid), 0);
  mqd->queue_state.cp_hqd_active = 1;
  r100_mm_wreg(rdev, (0xC91C), (mqd->queue_state.cp_hqd_active), 0);
  cik_srbm_select(rdev, 0, 0, 0, 0);
  _rw_exit_write(&rdev->srbm_mutex );
  radeon_bo_kunmap(rdev->ring[idx].mqd_obj);
  radeon_bo_unreserve(rdev->ring[idx].mqd_obj);
  rdev->ring[idx].ready = 1;
  r = (rdev)->asic->ring[(idx)]->ring_test((rdev), (&rdev->ring[idx]));
  if (r)
   rdev->ring[idx].ready = 0;
 }
 return 0;
}
static void cik_cp_enable(struct radeon_device *rdev, _Bool enable)
{
...
u32 cik_gpu_check_soft_reset(struct radeon_device *rdev)
{
 ...
 if (tmp & ((1 << 29) | (1 << 28)))
  reset_mask |= (1 << 3);
 tmp = r100_mm_rreg(rdev, (0x8008), 0);
 if (tmp & (1 << 24))
  reset_mask |= (1 << 6);
 tmp = r100_mm_rreg(rdev, (0xd034 + 0x0), 0);
 if (!(tmp & (1 << 0)))
  reset_mask |= (1 << 2);
 tmp = r100_mm_rreg(rdev, (0xd034 + 0x800), 0);
 if (!(tmp & (1 << 0)))
  reset_mask |= (1 << 5);
 tmp = r100_mm_rreg(rdev, (0xE4C), 0);
 if (tmp & (1 << 5))
  reset_mask |= (1 << 2);
 if (tmp & (1 << 6))
  reset_mask |= (1 << 5);
 tmp = r100_mm_rreg(rdev, (0xE50), 0);
 if (tmp & (1 << 17))
  reset_mask |= (1 << 8);
 if (tmp & (1 << 14))
  reset_mask |= (1 << 7);
...
static void cik_gpu_soft_reset(struct radeon_device *rdev, u32 reset_mask)
{
 ...
 r100_mm_wreg(rdev, (0x8234), ((1 << 30) | (1 << 28)), 0);
 if (reset_mask & (1 << 2)) {
  tmp = r100_mm_rreg(rdev, (0xD048 + 0x0), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0xD048 + 0x0), (tmp), 0);
 }
 if (reset_mask & (1 << 5)) {
  tmp = r100_mm_rreg(rdev, (0xD048 + 0x800), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0xD048 + 0x800), (tmp), 0);
 }
 evergreen_mc_stop(rdev, &save);
 if (evergreen_mc_wait_for_idle(rdev)) {
  printf("drm:pid%d:%s *WARNING* " "Wait for MC idle timedout !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 }
 if (reset_mask & ((1 << 0) | (1 << 1) | (1 << 3)))
  grbm_soft_reset = (1 << 0) | (1 << 16);
 if (reset_mask & (1 << 3)) {
  grbm_soft_reset |= (1 << 0);
  srbm_soft_reset |= (1 << 8);
 }
...
{
 save->gmcon_reng_execute = r100_mm_rreg(rdev, (0x3508), 0);
 save->gmcon_misc = r100_mm_rreg(rdev, (0x350c), 0);
 save->gmcon_misc3 = r100_mm_rreg(rdev, (0x3544), 0);
 r100_mm_wreg(rdev, (0x3508), (save->gmcon_reng_execute & ~(1 << 0)), 0);
 r100_mm_wreg(rdev, (0x350c), (save->gmcon_misc & ~((1 << 11) | (1 << 16))), 0);
}
static void kv_restore_regs_for_reset(struct radeon_device *rdev,
          struct kv_reset_save_regs *save)
{
 int i;
 r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x3538), (0x200010ff), 0);
 for (i = 0; i < 5; i++)
  r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x3538), (0x300010ff), 0);
 for (i = 0; i < 5; i++)
  r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x353c), (0x210000), 0);
 r100_mm_wreg(rdev, (0x3538), (0xa00010ff), 0);
 for (i = 0; i < 5; i++)
  r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x353c), (0x21003), 0);
 r100_mm_wreg(rdev, (0x3538), (0xb00010ff), 0);
 for (i = 0; i < 5; i++)
  r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x353c), (0x2b00), 0);
 r100_mm_wreg(rdev, (0x3538), (0xc00010ff), 0);
 for (i = 0; i < 5; i++)
  r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x3538), (0xd00010ff), 0);
 for (i = 0; i < 5; i++)
  r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x353c), (0x420000), 0);
 r100_mm_wreg(rdev, (0x3538), (0x100010ff), 0);
 for (i = 0; i < 5; i++)
  r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x353c), (0x120202), 0);
 r100_mm_wreg(rdev, (0x3538), (0x500010ff), 0);
 for (i = 0; i < 5; i++)
  r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x353c), (0x3e3e36), 0);
 r100_mm_wreg(rdev, (0x3538), (0x600010ff), 0);
 for (i = 0; i < 5; i++)
  r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x353c), (0x373f3e), 0);
 r100_mm_wreg(rdev, (0x3538), (0x700010ff), 0);
 for (i = 0; i < 5; i++)
  r100_mm_wreg(rdev, (0x353c), (0), 0);
 r100_mm_wreg(rdev, (0x353c), (0x3e1332), 0);
 r100_mm_wreg(rdev, (0x3538), (0xe00010ff), 0);
 r100_mm_wreg(rdev, (0x3544), (save->gmcon_misc3), 0);
 r100_mm_wreg(rdev, (0x350c), (save->gmcon_misc), 0);
 r100_mm_wreg(rdev, (0x3508), (save->gmcon_reng_execute), 0);
}
...
_Bool cik_gfx_is_lockup(struct radeon_device *rdev, struct radeon_ring *ring)
{
...
static void cik_mc_program(struct radeon_device *rdev)
{
 ...
 evergreen_mc_stop(rdev, &save);
 if ((rdev)->asic->mc_wait_for_idle((rdev))) {
  printf("drm:pid%d:%s *WARNING* " "Wait for MC idle timedout !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 }
...
void cik_pcie_gart_tlb_flush(struct radeon_device *rdev)
{
 r100_mm_wreg(rdev, (0x5480), (0), 0);
 r100_mm_wreg(rdev, (0x1478), (0x1), 0);
}
static void cik_pcie_init_compute_vmid(struct radeon_device *rdev)
{
 ...
 for (i = 8; i < 16; i++) {
  ...
  r100_mm_wreg(rdev, (0x8C34), (sh_mem_config), 0);
  r100_mm_wreg(rdev, (0x8C2C), (1), 0);
  r100_mm_wreg(rdev, (0x8C30), (0), 0);
  r100_mm_wreg(rdev, (0x8C28), (sh_mem_bases), 0);
 }
 cik_srbm_select(rdev, 0, 0, 0, 0);
 _rw_exit_write(&rdev->srbm_mutex );
}
static int cik_pcie_gart_enable(struct radeon_device *rdev)
{
 ...
 if (r)
  return r;
 r100_mm_wreg(rdev, (0x2064), ((0xA << 7) | (1 << 0) | (1 << 1) | (3 << 3) | (1 << 6) | (0 << 5)), 0);
 r100_mm_wreg(rdev, (0x1400), ((1 << 0) | (1 << 1) | (1 << 9) | (1 << 10) | (((7) & 7) << 15) | (((1) & 3) << 19)), 0);
 r100_mm_wreg(rdev, (0x1404), ((1 << 0) | (1 << 1)), 0);
 r100_mm_wreg(rdev, (0x1408), ((1 << 20) | ((4) << 0) | ((4) << 15)), 0);
 ...
 r100_mm_wreg(rdev, (0x1430), (0), 0);
 r100_mm_wreg(rdev, (0x1410), (((1 << 0) | (((0) & 3) << 1) | (1 << 4))), 0);
 r100_mm_wreg(rdev, (0x15D4), (0), 0);
 r100_mm_wreg(rdev, (0x15D8), (0), 0);
 r100_mm_wreg(rdev, (0x15DC), (0), 0);
 r100_mm_wreg(rdev, (0x1560), (0), 0);
 r100_mm_wreg(rdev, (0x1580), (rdev->vm_manager.max_pfn - 1), 0);
 for (i = 1; i < 16; i++) {
  if (i < 8)
   r100_mm_wreg(rdev, (0x153c + (i << 2)), (rdev->vm_manager.saved_table_addr[i]), 0);
  else
   r100_mm_wreg(rdev, (0x1438 + ((i - 8) << 2)), (rdev->vm_manager.saved_table_addr[i]), 0);
 }
 r100_mm_wreg(rdev, (0x151c), ((u32)(rdev->dummy_page.addr >> 12)), 0);
 r100_mm_wreg(rdev, (0x1434), (4), 0);
 r100_mm_wreg(rdev, (0x1414), ((1 << 0) | (((1) & 3) << 1) | (((radeon_vm_block_size - 9) & 0xF) << 24) | (1 << 3) | (1 << 4) | (1 << 6) | (1 << 7) | (1 << 9) | (1 << 10) | (1 << 12) | (1 << 13) | (1 << 15) | (1 << 16) | (1 << 18) | (1 << 19)), 0);
 if (rdev->family == CHIP_KAVERI) {
  u32 tmp = r100_mm_rreg(rdev, (0x1864), 0);
  tmp &= ~(1 << 0);
  r100_mm_wreg(rdev, (0x1864), (tmp), 0);
 }
 _rw_enter_write(&rdev->srbm_mutex );
 for (i = 0; i < 16; i++) {
  cik_srbm_select(rdev, 0, 0, 0, i);
  r100_mm_wreg(rdev, (0x8C34), (0), 0);
  r100_mm_wreg(rdev, (0x8C2C), (1), 0);
  r100_mm_wreg(rdev, (0x8C30), (0), 0);
  r100_mm_wreg(rdev, (0x8C28), (0), 0);
  r100_mm_wreg(rdev, (0xD29C + 0x0), (0), 0);
  r100_mm_wreg(rdev, (0xD2A0 + 0x0), (0), 0);
  r100_mm_wreg(rdev, (0xD29C + 0x800), (0), 0);
  r100_mm_wreg(rdev, (0xD2A0 + 0x800), (0), 0);
 }
 cik_srbm_select(rdev, 0, 0, 0, 0);
 _rw_exit_write(&rdev->srbm_mutex );
...
static void cik_pcie_gart_disable(struct radeon_device *rdev)
{
 ...
 for (i = 1; i < 16; ++i) {
  ...
  if (i < 8)
   ...
   reg64 = 0x1438 + ((i - 8) << 2);
  rdev->vm_manager.saved_table_addr[i] = r100_mm_rreg(rdev, (reg64), 0);
 }
 r100_mm_wreg(rdev, (0x1410), (0), 0);
 r100_mm_wreg(rdev, (0x1414), (0), 0);
 r100_mm_wreg(rdev, (0x2064), ((3 << 3) | (0 << 5)), 0);
 r100_mm_wreg(rdev, (0x1400), ((1 << 1) | (1 << 9) | (1 << 10) | (((7) & 7) << 15) | (((1) & 3) << 19)), 0);
 r100_mm_wreg(rdev, (0x1404), (0), 0);
 r100_mm_wreg(rdev, (0x1408), ((1 << 20) | ((6) << 15)), 0);
...
int cik_vm_init(struct radeon_device *rdev)
{
 ...
 if (rdev->flags & RADEON_IS_IGP) {
  u64 tmp = r100_mm_rreg(rdev, (0x2068), 0);
  tmp <<= 22;
...
{
 u32 mc_id;
 u32 vmid = (status & (0xf << 25)) >> 25;
 u32 protections = (status & (0xf << 0)) >> 0;
 char block[5] = { mc_client >> 24, (mc_client >> 16) & 0xff,
  (mc_client >> 8) & 0xff, mc_client & 0xff, 0 };
 if (rdev->family == CHIP_HAWAII)
  mc_id = (status & (0x1ff << 12)) >> 12;
 else
  mc_id = (status & (0xff << 12)) >> 12;
 printf("VM fault (0x%02x, vmid %d) at page %u, %s from '%s' (0x%08x) (%d)\n", protections, vmid, addr, (status & (1 << 24)) ? "write" : "read", block, mc_client, mc_id);
}
void cik_vm_flush(struct radeon_device *rdev, struct radeon_ring *ring,
    unsigned vm_id, uint64_t pd_addr)
{
 int usepfp = (ring->idx == 0);
 radeon_ring_write(ring, ((3 << 30) | (((0x37) & 0xFF) << 8) | ((3) & 0x3FFF) << 16));
 radeon_ring_write(ring, (((usepfp) << 30) |
     ((0) << 8)));
 if (vm_id < 8) {
 ...
 radeon_ring_write(ring, (((usepfp) << 30) |
     ((0) << 8)));
 radeon_ring_write(ring, 0xE44 >> 2);
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, ((vm_id) << 4));
 radeon_ring_write(ring, ((3 << 30) | (((0x37) & 0xFF) << 8) | ((6) & 0x3FFF) << 16));
 radeon_ring_write(ring, (((usepfp) << 30) |
     ((0) << 8)));
 radeon_ring_write(ring, 0x8C28 >> 2);
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, 0);
 ...
 radeon_ring_write(ring, 0xE44 >> 2);
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, ((0) << 4));
 cik_hdp_flush_cp_ring_emit(rdev, ring->idx);
 radeon_ring_write(ring, ((3 << 30) | (((0x37) & 0xFF) << 8) | ((3) & 0x3FFF) << 16));
 radeon_ring_write(ring, (((usepfp) << 30) |
     ((0) << 8)));
 radeon_ring_write(ring, 0x1478 >> 2);
 radeon_ring_write(ring, 0);
 radeon_ring_write(ring, 1 << vm_id);
 radeon_ring_write(ring, ((3 << 30) | (((0x3C) & 0xFF) << 8) | ((5) & 0x3FFF) << 16));
 radeon_ring_write(ring, (((0) << 6) |
     ((0) << 0) |
     ((0) << 8)));
 radeon_ring_write(ring, 0x1478 >> 2);
 radeon_ring_write(ring, 0);
...
static void cik_enable_gui_idle_interrupt(struct radeon_device *rdev,
       _Bool enable)
{
 u32 tmp = r100_mm_rreg(rdev, (0xC1A8), 0);
 if (enable)
  tmp |= ((1 << 19) | (1 << 20));
 else
  tmp &= ~((1 << 19) | (1 << 20));
 r100_mm_wreg(rdev, (0xC1A8), (tmp), 0);
}
static void cik_enable_lbpw(struct radeon_device *rdev, _Bool enable)
{
 u32 tmp;
 tmp = r100_mm_rreg(rdev, (0xC364), 0);
 if (enable)
  tmp |= (1 << 0);
 else
  tmp &= ~(1 << 0);
 r100_mm_wreg(rdev, (0xC364), (tmp), 0);
}
static void cik_wait_for_rlc_serdes(struct radeon_device *rdev)
{
 ...
 for (i = 0; i < rdev->config.cik.max_shader_engines; i++) {
  for (j = 0; j < rdev->config.cik.max_sh_per_se; j++) {
   ...
   for (k = 0; k < rdev->usec_timeout; k++) {
    if (r100_mm_rreg(rdev, (0xC484), 0) == 0)
     break;
    udelay(1);
   }
  }
 ...
 cik_select_se_sh(rdev, 0xffffffff, 0xffffffff);
 _rw_exit_write(&rdev->grbm_idx_mutex );
 mask = 0x0000ffff | (1 << 16) | (1 << 17) | (1 << 18);
 for (k = 0; k < rdev->usec_timeout; k++) {
  if ((r100_mm_rreg(rdev, (0xC488), 0) & mask) == 0)
   break;
  udelay(1);
 }
}
...
{
 u32 tmp;
 tmp = r100_mm_rreg(rdev, (0xC300), 0);
 if (tmp != rlc)
  r100_mm_wreg(rdev, (0xC300), (rlc), 0);
}
static u32 cik_halt_rlc(struct radeon_device *rdev)
{
 u32 data, orig;
 orig = data = r100_mm_rreg(rdev, (0xC300), 0);
 if (data & (1 << 0)) {
  u32 i;
  data &= ~(1 << 0);
  r100_mm_wreg(rdev, (0xC300), (data), 0);
  for (i = 0; i < rdev->usec_timeout; i++) {
   if ((r100_mm_rreg(rdev, (0xC400), 0) & (1 << 0)) == 0)
    break;
   udelay(1);
  }
...
void cik_enter_rlc_safe_mode(struct radeon_device *rdev)
{
 u32 tmp, i, mask;
 tmp = 0x00000001 | ((1) << 1);
 r100_mm_wreg(rdev, (0xC4E8), (tmp), 0);
 mask = (1 << 1) | (1 << 2);
 for (i = 0; i < rdev->usec_timeout; i++) {
  if ((r100_mm_rreg(rdev, (0xC400), 0) & mask) == mask)
   break;
  udelay(1);
 }
 for (i = 0; i < rdev->usec_timeout; i++) {
  if ((r100_mm_rreg(rdev, (0xC4E8), 0) & 0x00000001) == 0)
   break;
  udelay(1);
 }
}
...
static void cik_rlc_stop(struct radeon_device *rdev)
{
 r100_mm_wreg(rdev, (0xC300), (0), 0);
 cik_enable_gui_idle_interrupt(rdev, 0);
 cik_wait_for_rlc_serdes(rdev);
}
static void cik_rlc_start(struct radeon_device *rdev)
{
 r100_mm_wreg(rdev, (0xC300), ((1 << 0)), 0);
 cik_enable_gui_idle_interrupt(rdev, 1);
 udelay(50);
}
static int cik_rlc_resume(struct radeon_device *rdev)
{
 ...
 if (!rdev->rlc_fw)
  return -22;
 cik_rlc_stop(rdev);
 tmp = r100_mm_rreg(rdev, (0xC424), 0) & 0xfffffffc;
 r100_mm_wreg(rdev, (0xC424), (tmp), 0);
 si_rlc_reset(rdev);
 cik_init_pg(rdev);
 cik_init_cg(rdev);
 r100_mm_wreg(rdev, (0xC36C), (0), 0);
 r100_mm_wreg(rdev, (0xC348), (0x00008000), 0);
 _rw_enter_write(&rdev->grbm_idx_mutex );
 cik_select_se_sh(rdev, 0xffffffff, 0xffffffff);
 r100_mm_wreg(rdev, (0xC43C), (0xffffffff), 0);
 r100_mm_wreg(rdev, (0xC444), (0x00600408), 0);
 r100_mm_wreg(rdev, (0xC364), (0x80000004), 0);
 _rw_exit_write(&rdev->grbm_idx_mutex );
 r100_mm_wreg(rdev, (0xC30C), (0), 0);
 r100_mm_wreg(rdev, (0xC39C), (0), 0);
 if (rdev->new_fw) {
  const struct rlc_firmware_header_v1_0 *hdr =
   (const struct rlc_firmware_header_v1_0 *)rdev->rlc_fw->data;
  const __le32 *fw_data = (const __le32 *)
   (rdev->rlc_fw->data + (__uint32_t)(__builtin_constant_p(hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(hdr->header.ucode_array_offset_bytes)));
  radeon_ucode_print_rlc_hdr(&hdr->header);
  size = (__uint32_t)(__builtin_constant_p(hdr->header.ucode_size_bytes) ? (__uint32_t)(((__uint32_t)(hdr->header.ucode_size_bytes) & 0xff) << 24 | ((__uint32_t)(hdr->header.ucode_size_bytes) & 0xff00) << 8 | ((__uint32_t)(hdr->header.ucode_size_bytes) & 0xff0000) >> 8 | ((__uint32_t)(hdr->header.ucode_size_bytes) & 0xff000000) >> 24) : __swap32md(hdr->header.ucode_size_bytes)) / 4;
  r100_mm_wreg(rdev, (0xC388), (0), 0);
  for (i = 0; i < size; i++)
   r100_mm_wreg(rdev, (0xC38C), (__mswap32(fw_data++)), 0);
  r100_mm_wreg(rdev, (0xC388), ((__uint32_t)(__builtin_constant_p(hdr->header.ucode_version) ? (__uint32_t)(((__uint32_t)(hdr->header.ucode_version) & 0xff) << 24 | ((__uint32_t)(hdr->header.ucode_version) & 0xff00) << 8 | ((__uint32_t)(hdr->header.ucode_version) & 0xff0000) >> 8 | ((__uint32_t)(hdr->header.ucode_version) & 0xff000000) >> 24) : __swap32md(hdr->header.ucode_version))), 0);
 } else {
  const __be32 *fw_data;
  switch (rdev->family) {
  case CHIP_BONAIRE:
  ...
  r100_mm_wreg(rdev, (0xC388), (0), 0);
  for (i = 0; i < size; i++)
   r100_mm_wreg(rdev, (0xC38C), (((__uint32_t)(*(__uint32_t *)(fw_data++)))), 0);
  r100_mm_wreg(rdev, (0xC388), (0), 0);
 }
 cik_enable_lbpw(rdev, 0);
 if (rdev->family == CHIP_BONAIRE)
  r100_mm_wreg(rdev, (0xC378), (0), 0);
 cik_rlc_start(rdev);
 return 0;
}
static void cik_enable_cgcg(struct radeon_device *rdev, _Bool enable)
{
 u32 data, orig, tmp, tmp2;
 orig = data = r100_mm_rreg(rdev, (0xC424), 0);
 if (enable && (rdev->cg_flags & (1 << 2))) {
  cik_enable_gui_idle_interrupt(rdev, 1);
  tmp = cik_halt_rlc(rdev);
  _rw_enter_write(&rdev->grbm_idx_mutex );
  cik_select_se_sh(rdev, 0xffffffff, 0xffffffff);
  r100_mm_wreg(rdev, (0xC474), (0xffffffff), 0);
  r100_mm_wreg(rdev, (0xC478), (0xffffffff), 0);
  tmp2 = (0xff << 0) | (1 << 20) | (1 << 16);
  r100_mm_wreg(rdev, (0xC47C), (tmp2), 0);
  _rw_exit_write(&rdev->grbm_idx_mutex );
  cik_update_rlc(rdev, tmp);
  data |= (1 << 0) | (1 << 1);
 } else {
  cik_enable_gui_idle_interrupt(rdev, 0);
  r100_mm_rreg(rdev, (0x3c2a0), 0);
  r100_mm_rreg(rdev, (0x3c2a0), 0);
  r100_mm_rreg(rdev, (0x3c2a0), 0);
  r100_mm_rreg(rdev, (0x3c2a0), 0);
  data &= ~((1 << 0) | (1 << 1));
 ...
 if (orig != data)
  r100_mm_wreg(rdev, (0xC424), (data), 0);
}
static void cik_enable_mgcg(struct radeon_device *rdev, _Bool enable)
{
 u32 data, orig, tmp = 0;
 if (enable && (rdev->cg_flags & (1 << 0))) {
  if (rdev->cg_flags & (1 << 1)) {
   if (rdev->cg_flags & (1 << 6)) {
    orig = data = r100_mm_rreg(rdev, (0xC1E4), 0);
    data |= (1 << 0);
    if (orig != data)
     r100_mm_wreg(rdev, (0xC1E4), (data), 0);
   }
  }
  orig = data = r100_mm_rreg(rdev, (0xC420), 0);
  data |= 0x00000001;
  data &= 0xfffffffd;
  if (orig != data)
   r100_mm_wreg(rdev, (0xC420), (data), 0);
  tmp = cik_halt_rlc(rdev);
  _rw_enter_write(&rdev->grbm_idx_mutex );
  cik_select_se_sh(rdev, 0xffffffff, 0xffffffff);
  r100_mm_wreg(rdev, (0xC474), (0xffffffff), 0);
  r100_mm_wreg(rdev, (0xC478), (0xffffffff), 0);
  data = (0xff << 0) | (1 << 22);
  r100_mm_wreg(rdev, (0xC47C), (data), 0);
  _rw_exit_write(&rdev->grbm_idx_mutex );
  cik_update_rlc(rdev, tmp);
  if (rdev->cg_flags & (1 << 4)) {
   orig = data = r100_mm_rreg(rdev, (0x3c000), 0);
   data &= ~(0x7 << 17);
   data |= ((0x2) << 17);
   data |= (1 << 20);
   data &= ~(1 << 21);
   ...
   data |= ((0x96) << 24);
   if (orig != data)
    r100_mm_wreg(rdev, (0x3c000), (data), 0);
  }
 } else {
  orig = data = r100_mm_rreg(rdev, (0xC420), 0);
  data |= 0x00000003;
  if (orig != data)
   r100_mm_wreg(rdev, (0xC420), (data), 0);
  data = r100_mm_rreg(rdev, (0xC318), 0);
  if (data & (1 << 0)) {
   data &= ~(1 << 0);
   r100_mm_wreg(rdev, (0xC318), (data), 0);
  }
  data = r100_mm_rreg(rdev, (0xC1E4), 0);
  if (data & (1 << 0)) {
   data &= ~(1 << 0);
   r100_mm_wreg(rdev, (0xC1E4), (data), 0);
  }
        ...
        _Bool enable)
{
 int i;
 u32 orig, data;
 for (i = 0; i < (sizeof((mc_cg_registers)) / sizeof((mc_cg_registers)[0])); i++) {
  orig = data = r100_mm_rreg(rdev, (mc_cg_registers[i]), 0);
  if (enable && (rdev->cg_flags & (1 << 8)))
   data |= (1 << 19);
  else
   data &= ~(1 << 19);
  if (data != orig)
   r100_mm_wreg(rdev, (mc_cg_registers[i]), (data), 0);
 }
}
...
{
 u32 orig, data;
 if (enable && (rdev->cg_flags & (1 << 11))) {
  r100_mm_wreg(rdev, (0xD00C + 0x0), (0x00000100), 0);
  r100_mm_wreg(rdev, (0xD00C + 0x800), (0x00000100), 0);
 } else {
  orig = data = r100_mm_rreg(rdev, (0xD00C + 0x0), 0);
  data |= 0xff000000;
  if (data != orig)
   r100_mm_wreg(rdev, (0xD00C + 0x0), (data), 0);
  orig = data = r100_mm_rreg(rdev, (0xD00C + 0x800), 0);
  data |= 0xff000000;
  if (data != orig)
   r100_mm_wreg(rdev, (0xD00C + 0x800), (data), 0);
 }
}
...
{
 u32 orig, data;
 if (enable && (rdev->cg_flags & (1 << 10))) {
  orig = data = r100_mm_rreg(rdev, (0xD008 + 0x0), 0);
  data |= 0x100;
  if (orig != data)
   r100_mm_wreg(rdev, (0xD008 + 0x0), (data), 0);
  orig = data = r100_mm_rreg(rdev, (0xD008 + 0x800), 0);
  data |= 0x100;
  if (orig != data)
   r100_mm_wreg(rdev, (0xD008 + 0x800), (data), 0);
 } else {
  orig = data = r100_mm_rreg(rdev, (0xD008 + 0x0), 0);
  data &= ~0x100;
  if (orig != data)
...
{
 u32 orig, data;
 if (enable && (rdev->cg_flags & (1 << 13))) {
  data = r600_uvd_ctx_rreg(rdev, (0xC0));
  data = 0xfff;
  r600_uvd_ctx_wreg(rdev, (0xC0), (data));
  orig = data = r100_mm_rreg(rdev, (0xF4B0), 0);
  data |= (1 << 0);
  if (orig != data)
   r100_mm_wreg(rdev, (0xF4B0), (data), 0);
 } else {
  data = r600_uvd_ctx_rreg(rdev, (0xC0));
  data &= ~0xfff;
  r600_uvd_ctx_wreg(rdev, (0xC0), (data));
...
{
 u32 orig, data;
 orig = data = rdev->pciep_rreg(rdev, (0x1001001c));
 if (enable && (rdev->cg_flags & (1 << 12)))
  data |= (1 << 16) | (1 << 18) |
   (1 << 19) | (1 << 17);
 else
  data &= ~((1 << 16) | (1 << 18) |
     (1 << 19) | (1 << 17));
 if (orig != data)
  rdev->pciep_wreg(rdev, (0x1001001c), (data));
}
static void cik_enable_hdp_mgcg(struct radeon_device *rdev,
    _Bool enable)
{
 u32 orig, data;
 orig = data = r100_mm_rreg(rdev, (0x2C00), 0);
 if (enable && (rdev->cg_flags & (1 << 16)))
  data &= ~(1 << 23);
 else
  data |= (1 << 23);
 if (orig != data)
  r100_mm_wreg(rdev, (0x2C00), (data), 0);
}
static void cik_enable_hdp_ls(struct radeon_device *rdev,
         _Bool enable)
{
 u32 orig, data;
 orig = data = r100_mm_rreg(rdev, (0x2F50), 0);
 if (enable && (rdev->cg_flags & (1 << 15)))
  data |= (1 << 0);
 else
  data &= ~(1 << 0);
 if (orig != data)
  r100_mm_wreg(rdev, (0x2F50), (data), 0);
}
...
static void cik_init_cg(struct radeon_device *rdev)
{
 cik_update_cg(rdev, (1 << 0), 1);
 if (rdev->has_uvd)
  si_init_uvd_internal_cg(rdev);
 cik_update_cg(rdev, ((1 << 1) |
        (1 << 2) |
        (1 << 6) |
        (1 << 3) |
        (1 << 5)), 1);
...
static void cik_fini_cg(struct radeon_device *rdev)
{
 cik_update_cg(rdev, ((1 << 1) |
        ...
        (1 << 3) |
        (1 << 5)), 0);
 cik_update_cg(rdev, (1 << 0), 0);
}
static void cik_enable_sck_slowdown_on_pu(struct radeon_device *rdev,
       _Bool enable)
{
 u32 data, orig;
 orig = data = r100_mm_rreg(rdev, (0xC40C), 0);
 if (enable && (rdev->pg_flags & (1 << 7)))
  data |= (1 << 17);
 else
  data &= ~(1 << 17);
 if (orig != data)
  r100_mm_wreg(rdev, (0xC40C), (data), 0);
}
...
static void cik_enable_cp_pg(struct radeon_device *rdev, _Bool enable)
{
 u32 data, orig;
 orig = data = r100_mm_rreg(rdev, (0xC40C), 0);
 if (enable && (rdev->pg_flags & (1 << 5)))
  data &= ~(1 << 15);
 else
  data |= (1 << 15);
 if (orig != data)
...
static void cik_enable_gds_pg(struct radeon_device *rdev, _Bool enable)
{
 u32 data, orig;
 orig = data = r100_mm_rreg(rdev, (0xC40C), 0);
 if (enable && (rdev->pg_flags & (1 << 6)))
  data &= ~(1 << 13);
 else
  data |= (1 << 13);
 if (orig != data)
 ...
 for (me = 0; me < max_me; me++) {
  if (rdev->new_fw) {
   ...
   if (me == 0) {
    ...
    fw_data = (const __le32 *)
     (rdev->ce_fw->data + (__uint32_t)(__builtin_constant_p(hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(hdr->header.ucode_array_offset_bytes)));
    table_offset = (__uint32_t)(__builtin_constant_p(hdr->jt_offset) ? (__uint32_t)(((__uint32_t)(hdr->jt_offset) & 0xff) << 24 | ((__uint32_t)(hdr->jt_offset) & 0xff00) << 8 | ((__uint32_t)(hdr->jt_offset) & 0xff0000) >> 8 | ((__uint32_t)(hdr->jt_offset) & 0xff000000) >> 24) : __swap32md(hdr->jt_offset));
    table_size = (__uint32_t)(__builtin_constant_p(hdr->jt_size) ? (__uint32_t)(((__uint32_t)(hdr->jt_size) & 0xff) << 24 | ((__uint32_t)(hdr->jt_size) & 0xff00) << 8 | ((__uint32_t)(hdr->jt_size) & 0xff0000) >> 8 | ((__uint32_t)(hdr->jt_size) & 0xff000000) >> 24) : __swap32md(hdr->jt_size));
   } else if (me == 1) {
    hdr = (const struct gfx_firmware_header_v1_0 *)rdev->pfp_fw->data;
    fw_data = (const __le32 *)
     (rdev->pfp_fw->data + (__uint32_t)(__builtin_constant_p(hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(hdr->header.ucode_array_offset_bytes)));
    table_offset = (__uint32_t)(__builtin_constant_p(hdr->jt_offset) ? (__uint32_t)(((__uint32_t)(hdr->jt_offset) & 0xff) << 24 | ((__uint32_t)(hdr->jt_offset) & 0xff00) << 8 | ((__uint32_t)(hdr->jt_offset) & 0xff0000) >> 8 | ((__uint32_t)(hdr->jt_offset) & 0xff000000) >> 24) : __swap32md(hdr->jt_offset));
    table_size = (__uint32_t)(__builtin_constant_p(hdr->jt_size) ? (__uint32_t)(((__uint32_t)(hdr->jt_size) & 0xff) << 24 | ((__uint32_t)(hdr->jt_size) & 0xff00) << 8 | ((__uint32_t)(hdr->jt_size) & 0xff0000) >> 8 | ((__uint32_t)(hdr->jt_size) & 0xff000000) >> 24) : __swap32md(hdr->jt_size));
   } else if (me == 2) {
    hdr = (const struct gfx_firmware_header_v1_0 *)rdev->me_fw->data;
    fw_data = (const __le32 *)
     (rdev->me_fw->data + (__uint32_t)(__builtin_constant_p(hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(hdr->header.ucode_array_offset_bytes)));
    table_offset = (__uint32_t)(__builtin_constant_p(hdr->jt_offset) ? (__uint32_t)(((__uint32_t)(hdr->jt_offset) & 0xff) << 24 | ((__uint32_t)(hdr->jt_offset) & 0xff00) << 8 | ((__uint32_t)(hdr->jt_offset) & 0xff0000) >> 8 | ((__uint32_t)(hdr->jt_offset) & 0xff000000) >> 24) : __swap32md(hdr->jt_offset));
    table_size = (__uint32_t)(__builtin_constant_p(hdr->jt_size) ? (__uint32_t)(((__uint32_t)(hdr->jt_size) & 0xff) << 24 | ((__uint32_t)(hdr->jt_size) & 0xff00) << 8 | ((__uint32_t)(hdr->jt_size) & 0xff0000) >> 8 | ((__uint32_t)(hdr->jt_size) & 0xff000000) >> 24) : __swap32md(hdr->jt_size));
   } else if (me == 3) {
    hdr = (const struct gfx_firmware_header_v1_0 *)rdev->mec_fw->data;
    fw_data = (const __le32 *)
     (rdev->mec_fw->data + (__uint32_t)(__builtin_constant_p(hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(hdr->header.ucode_array_offset_bytes)));
    table_offset = (__uint32_t)(__builtin_constant_p(hdr->jt_offset) ? (__uint32_t)(((__uint32_t)(hdr->jt_offset) & 0xff) << 24 | ((__uint32_t)(hdr->jt_offset) & 0xff00) << 8 | ((__uint32_t)(hdr->jt_offset) & 0xff0000) >> 8 | ((__uint32_t)(hdr->jt_offset) & 0xff000000) >> 24) : __swap32md(hdr->jt_offset));
    table_size = (__uint32_t)(__builtin_constant_p(hdr->jt_size) ? (__uint32_t)(((__uint32_t)(hdr->jt_size) & 0xff) << 24 | ((__uint32_t)(hdr->jt_size) & 0xff00) << 8 | ((__uint32_t)(hdr->jt_size) & 0xff0000) >> 8 | ((__uint32_t)(hdr->jt_size) & 0xff000000) >> 24) : __swap32md(hdr->jt_size));
   } else {
    hdr = (const struct gfx_firmware_header_v1_0 *)rdev->mec2_fw->data;
    fw_data = (const __le32 *)
     (rdev->mec2_fw->data + (__uint32_t)(__builtin_constant_p(hdr->header.ucode_array_offset_bytes) ? (__uint32_t)(((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff) << 24 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff00) << 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff0000) >> 8 | ((__uint32_t)(hdr->header.ucode_array_offset_bytes) & 0xff000000) >> 24) : __swap32md(hdr->header.ucode_array_offset_bytes)));
    table_offset = (__uint32_t)(__builtin_constant_p(hdr->jt_offset) ? (__uint32_t)(((__uint32_t)(hdr->jt_offset) & 0xff) << 24 | ((__uint32_t)(hdr->jt_offset) & 0xff00) << 8 | ((__uint32_t)(hdr->jt_offset) & 0xff0000) >> 8 | ((__uint32_t)(hdr->jt_offset) & 0xff000000) >> 24) : __swap32md(hdr->jt_offset));
    table_size = (__uint32_t)(__builtin_constant_p(hdr->jt_size) ? (__uint32_t)(((__uint32_t)(hdr->jt_size) & 0xff) << 24 | ((__uint32_t)(hdr->jt_size) & 0xff00) << 8 | ((__uint32_t)(hdr->jt_size) & 0xff0000) >> 8 | ((__uint32_t)(hdr->jt_size) & 0xff000000) >> 24) : __swap32md(hdr->jt_size));
   }
   for (i = 0; i < table_size; i ++) {
    dst_ptr[bo_offset + i] =
     (__uint32_t)(__builtin_constant_p((__uint32_t)(__builtin_constant_p(fw_data[table_offset + i]) ? (__uint32_t)(((__uint32_t)(fw_data[table_offset + i]) & 0xff) << 24 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff00) << 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff0000) >> 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff000000) >> 24) : __swap32md(fw_data[table_offset + i]))) ? (__uint32_t)(((__uint32_t)((__uint32_t)(__builtin_constant_p(fw_data[table_offset + i]) ? (__uint32_t)(((__uint32_t)(fw_data[table_offset + i]) & 0xff) << 24 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff00) << 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff0000) >> 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff000000) >> 24) : __swap32md(fw_data[table_offset + i]))) & 0xff) << 24 | ((__uint32_t)((__uint32_t)(__builtin_constant_p(fw_data[table_offset + i]) ? (__uint32_t)(((__uint32_t)(fw_data[table_offset + i]) & 0xff) << 24 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff00) << 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff0000) >> 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff000000) >> 24) : __swap32md(fw_data[table_offset + i]))) & 0xff00) << 8 | ((__uint32_t)((__uint32_t)(__builtin_constant_p(fw_data[table_offset + i]) ? (__uint32_t)(((__uint32_t)(fw_data[table_offset + i]) & 0xff) << 24 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff00) << 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff0000) >> 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff000000) >> 24) : __swap32md(fw_data[table_offset + i]))) & 0xff0000) >> 8 | ((__uint32_t)((__uint32_t)(__builtin_constant_p(fw_data[table_offset + i]) ? (__uint32_t)(((__uint32_t)(fw_data[table_offset + i]) & 0xff) << 24 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff00) << 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff0000) >> 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff000000) >> 24) : __swap32md(fw_data[table_offset + i]))) & 0xff000000) >> 24) : __swap32md((__uint32_t)(__builtin_constant_p(fw_data[table_offset + i]) ? (__uint32_t)(((__uint32_t)(fw_data[table_offset + i]) & 0xff) << 24 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff00) << 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff0000) >> 8 | ((__uint32_t)(fw_data[table_offset + i]) & 0xff000000) >> 24) : __swap32md(fw_data[table_offset + i]))));
   }
   ...
   for (i = 0; i < table_size; i ++) {
    dst_ptr[bo_offset + i] =
     (__uint32_t)(__builtin_constant_p(((__uint32_t)(fw_data[table_offset + i]))) ? (__uint32_t)(((__uint32_t)(((__uint32_t)(fw_data[table_offset + i]))) & 0xff) << 24 | ((__uint32_t)(((__uint32_t)(fw_data[table_offset + i]))) & 0xff00) << 8 | ((__uint32_t)(((__uint32_t)(fw_data[table_offset + i]))) & 0xff0000) >> 8 | ((__uint32_t)(((__uint32_t)(fw_data[table_offset + i]))) & 0xff000000) >> 24) : __swap32md(((__uint32_t)(fw_data[table_offset + i]))));
   }
   bo_offset += table_size;
  }
 }
...
{
 u32 data, orig;
 if (enable && (rdev->pg_flags & (1 << 0))) {
  orig = data = r100_mm_rreg(rdev, (0xC40C), 0);
  data |= (1 << 0);
  if (orig != data)
   r100_mm_wreg(rdev, (0xC40C), (data), 0);
  orig = data = r100_mm_rreg(rdev, (0xC454), 0);
  data |= (1 << 0);
  if (orig != data)
   r100_mm_wreg(rdev, (0xC454), (data), 0);
 } else {
  orig = data = r100_mm_rreg(rdev, (0xC40C), 0);
  data &= ~(1 << 0);
  if (orig != data)
  ...
  if (orig != data)
   r100_mm_wreg(rdev, (0xC454), (data), 0);
  data = r100_mm_rreg(rdev, (0x28000), 0);
 }
}
static u32 cik_get_cu_active_bitmap(struct radeon_device *rdev, u32 se, u32 sh)
{
 ...
 tmp = r100_mm_rreg(rdev, (0x89bc), 0);
 tmp1 = r100_mm_rreg(rdev, (0x89c0), 0);
 cik_select_se_sh(rdev, 0xffffffff, 0xffffffff);
 _rw_exit_write(&rdev->grbm_idx_mutex );
 tmp &= 0xffff0000;
 tmp |= tmp1;
...
static void cik_init_ao_cu_mask(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0xC44C), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0xC450), 0);
 tmp &= ~(0xff << 0);
 tmp |= ((active_cu_number) << 0);
 r100_mm_wreg(rdev, (0xC450), (tmp), 0);
}
...
static void cik_init_gfx_cgpg(struct radeon_device *rdev)
{
 ...
 u32 i;
 if (rdev->rlc.cs_data) {
  r100_mm_wreg(rdev, (0xC4B0), (0x3D), 0);
  r100_mm_wreg(rdev, (0xC4B4), (((u32)(((rdev->rlc.clear_state_gpu_addr) >> 16) >> 16))), 0);
  r100_mm_wreg(rdev, (0xC4B4), (((u32)(rdev->rlc.clear_state_gpu_addr))), 0);
  r100_mm_wreg(rdev, (0xC4B4), (rdev->rlc.clear_state_size), 0);
 } else {
  r100_mm_wreg(rdev, (0xC4B0), (0x3D), 0);
  for (i = 0; i < 3; i++)
   r100_mm_wreg(rdev, (0xC4B4), (0), 0);
 }
 if (rdev->rlc.reg_list) {
  r100_mm_wreg(rdev, (0xC4B0), (0x90), 0);
  for (i = 0; i < rdev->rlc.reg_list_size; i++)
   r100_mm_wreg(rdev, (0xC4B4), (rdev->rlc.reg_list[i]), 0);
 }
 orig = data = r100_mm_rreg(rdev, (0xC40C), 0);
 data |= (1 << 1);
 if (orig != data)
  r100_mm_wreg(rdev, (0xC40C), (data), 0);
 r100_mm_wreg(rdev, (0xC374), (rdev->rlc.save_restore_gpu_addr >> 8), 0);
 r100_mm_wreg(rdev, (0xC378), (rdev->rlc.cp_table_gpu_addr >> 8), 0);
 data = r100_mm_rreg(rdev, (0x8708), 0);
 data &= ~(0xffff << 16);
 data |= ((0x60) << 16);
 r100_mm_wreg(rdev, (0x8708), (data), 0);
 data = 0x10101010;
 r100_mm_wreg(rdev, (0xC434), (data), 0);
 data = r100_mm_rreg(rdev, (0xC37C), 0);
 data &= ~0xff;
 data |= 0x3;
 r100_mm_wreg(rdev, (0xC37C), (data), 0);
 data = r100_mm_rreg(rdev, (0xC454), 0);
 data &= ~(0xffff << 3);
 data |= ((0x700) << 3);
 r100_mm_wreg(rdev, (0xC454), (data), 0);
}
static void cik_update_gfx_pg(struct radeon_device *rdev, _Bool enable)
{
...
void cik_get_csb_buffer(struct radeon_device *rdev, volatile u32 *buffer)
{
 ...
 if (buffer == ((void *)0))
  return;
 buffer[count++] = (__uint32_t)(__builtin_constant_p(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) ? (__uint32_t)(((__uint32_t)(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff) << 24 | ((__uint32_t)(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff00) << 8 | ((__uint32_t)(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff0000) >> 8 | ((__uint32_t)(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff000000) >> 24) : __swap32md(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)));
 buffer[count++] = (__uint32_t)(__builtin_constant_p((2 << 28)) ? (__uint32_t)(((__uint32_t)((2 << 28)) & 0xff) << 24 | ((__uint32_t)((2 << 28)) & 0xff00) << 8 | ((__uint32_t)((2 << 28)) & 0xff0000) >> 8 | ((__uint32_t)((2 << 28)) & 0xff000000) >> 24) : __swap32md((2 << 28)));
 buffer[count++] = (__uint32_t)(__builtin_constant_p(((3 << 30) | (((0x28) & 0xFF) << 8) | ((1) & 0x3FFF) << 16)) ? (__uint32_t)(((__uint32_t)(((3 << 30) | (((0x28) & 0xFF) << 8) | ((1) & 0x3FFF) << 16)) & 0xff) << 24 | ((__uint32_t)(((3 << 30) | (((0x28) & 0xFF) << 8) | ((1) & 0x3FFF) << 16)) & 0xff00) << 8 | ((__uint32_t)(((3 << 30) | (((0x28) & 0xFF) << 8) | ((1) & 0x3FFF) << 16)) & 0xff0000) >> 8 | ((__uint32_t)(((3 << 30) | (((0x28) & 0xFF) << 8) | ((1) & 0x3FFF) << 16)) & 0xff000000) >> 24) : __swap32md(((3 << 30) | (((0x28) & 0xFF) << 8) | ((1) & 0x3FFF) << 16)));
 buffer[count++] = (__uint32_t)(__builtin_constant_p(0x80000000) ? (__uint32_t)(((__uint32_t)(0x80000000) & 0xff) << 24 | ((__uint32_t)(0x80000000) & 0xff00) << 8 | ((__uint32_t)(0x80000000) & 0xff0000) >> 8 | ((__uint32_t)(0x80000000) & 0xff000000) >> 24) : __swap32md(0x80000000));
 buffer[count++] = (__uint32_t)(__builtin_constant_p(0x80000000) ? (__uint32_t)(((__uint32_t)(0x80000000) & 0xff) << 24 | ((__uint32_t)(0x80000000) & 0xff00) << 8 | ((__uint32_t)(0x80000000) & 0xff0000) >> 8 | ((__uint32_t)(0x80000000) & 0xff000000) >> 24) : __swap32md(0x80000000));
 for (sect = rdev->rlc.cs_data; sect->section != ((void *)0); ++sect) {
  for (ext = sect->section; ext->extent != ((void *)0); ++ext) {
   if (sect->id == SECT_CONTEXT) {
    buffer[count++] =
     (__uint32_t)(__builtin_constant_p(((3 << 30) | (((0x69) & 0xFF) << 8) | ((ext->reg_count) & 0x3FFF) << 16)) ? (__uint32_t)(((__uint32_t)(((3 << 30) | (((0x69) & 0xFF) << 8) | ((ext->reg_count) & 0x3FFF) << 16)) & 0xff) << 24 | ((__uint32_t)(((3 << 30) | (((0x69) & 0xFF) << 8) | ((ext->reg_count) & 0x3FFF) << 16)) & 0xff00) << 8 | ((__uint32_t)(((3 << 30) | (((0x69) & 0xFF) << 8) | ((ext->reg_count) & 0x3FFF) << 16)) & 0xff0000) >> 8 | ((__uint32_t)(((3 << 30) | (((0x69) & 0xFF) << 8) | ((ext->reg_count) & 0x3FFF) << 16)) & 0xff000000) >> 24) : __swap32md(((3 << 30) | (((0x69) & 0xFF) << 8) | ((ext->reg_count) & 0x3FFF) << 16)));
    buffer[count++] = (__uint32_t)(__builtin_constant_p(ext->reg_index - 0xa000) ? (__uint32_t)(((__uint32_t)(ext->reg_index - 0xa000) & 0xff) << 24 | ((__uint32_t)(ext->reg_index - 0xa000) & 0xff00) << 8 | ((__uint32_t)(ext->reg_index - 0xa000) & 0xff0000) >> 8 | ((__uint32_t)(ext->reg_index - 0xa000) & 0xff000000) >> 24) : __swap32md(ext->reg_index - 0xa000));
    for (i = 0; i < ext->reg_count; i++)
     buffer[count++] = (__uint32_t)(__builtin_constant_p(ext->extent[i]) ? (__uint32_t)(((__uint32_t)(ext->extent[i]) & 0xff) << 24 | ((__uint32_t)(ext->extent[i]) & 0xff00) << 8 | ((__uint32_t)(ext->extent[i]) & 0xff0000) >> 8 | ((__uint32_t)(ext->extent[i]) & 0xff000000) >> 24) : __swap32md(ext->extent[i]));
   } else {
    return;
   }
  }
 }
 buffer[count++] = (__uint32_t)(__builtin_constant_p(((3 << 30) | (((0x69) & 0xFF) << 8) | ((2) & 0x3FFF) << 16)) ? (__uint32_t)(((__uint32_t)(((3 << 30) | (((0x69) & 0xFF) << 8) | ((2) & 0x3FFF) << 16)) & 0xff) << 24 | ((__uint32_t)(((3 << 30) | (((0x69) & 0xFF) << 8) | ((2) & 0x3FFF) << 16)) & 0xff00) << 8 | ((__uint32_t)(((3 << 30) | (((0x69) & 0xFF) << 8) | ((2) & 0x3FFF) << 16)) & 0xff0000) >> 8 | ((__uint32_t)(((3 << 30) | (((0x69) & 0xFF) << 8) | ((2) & 0x3FFF) << 16)) & 0xff000000) >> 24) : __swap32md(((3 << 30) | (((0x69) & 0xFF) << 8) | ((2) & 0x3FFF) << 16)));
 buffer[count++] = (__uint32_t)(__builtin_constant_p(0x28350 - 0x00028000) ? (__uint32_t)(((__uint32_t)(0x28350 - 0x00028000) & 0xff) << 24 | ((__uint32_t)(0x28350 - 0x00028000) & 0xff00) << 8 | ((__uint32_t)(0x28350 - 0x00028000) & 0xff0000) >> 8 | ((__uint32_t)(0x28350 - 0x00028000) & 0xff000000) >> 24) : __swap32md(0x28350 - 0x00028000));
 switch (rdev->family) {
 case CHIP_BONAIRE:
  buffer[count++] = (__uint32_t)(__builtin_constant_p(0x16000012) ? (__uint32_t)(((__uint32_t)(0x16000012) & 0xff) << 24 | ((__uint32_t)(0x16000012) & 0xff00) << 8 | ((__uint32_t)(0x16000012) & 0xff0000) >> 8 | ((__uint32_t)(0x16000012) & 0xff000000) >> 24) : __swap32md(0x16000012));
  buffer[count++] = (__uint32_t)(__builtin_constant_p(0x00000000) ? (__uint32_t)(((__uint32_t)(0x00000000) & 0xff) << 24 | ((__uint32_t)(0x00000000) & 0xff00) << 8 | ((__uint32_t)(0x00000000) & 0xff0000) >> 8 | ((__uint32_t)(0x00000000) & 0xff000000) >> 24) : __swap32md(0x00000000));
  break;
 case CHIP_KAVERI:
  buffer[count++] = (__uint32_t)(__builtin_constant_p(0x00000000) ? (__uint32_t)(((__uint32_t)(0x00000000) & 0xff) << 24 | ((__uint32_t)(0x00000000) & 0xff00) << 8 | ((__uint32_t)(0x00000000) & 0xff0000) >> 8 | ((__uint32_t)(0x00000000) & 0xff000000) >> 24) : __swap32md(0x00000000));
  buffer[count++] = (__uint32_t)(__builtin_constant_p(0x00000000) ? (__uint32_t)(((__uint32_t)(0x00000000) & 0xff) << 24 | ((__uint32_t)(0x00000000) & 0xff00) << 8 | ((__uint32_t)(0x00000000) & 0xff0000) >> 8 | ((__uint32_t)(0x00000000) & 0xff000000) >> 24) : __swap32md(0x00000000));
 ...
 case CHIP_MULLINS:
  ...
  break;
 case CHIP_HAWAII:
  buffer[count++] = (__uint32_t)(__builtin_constant_p(0x3a00161a) ? (__uint32_t)(((__uint32_t)(0x3a00161a) & 0xff) << 24 | ((__uint32_t)(0x3a00161a) & 0xff00) << 8 | ((__uint32_t)(0x3a00161a) & 0xff0000) >> 8 | ((__uint32_t)(0x3a00161a) & 0xff000000) >> 24) : __swap32md(0x3a00161a));
  buffer[count++] = (__uint32_t)(__builtin_constant_p(0x0000002e) ? (__uint32_t)(((__uint32_t)(0x0000002e) & 0xff) << 24 | ((__uint32_t)(0x0000002e) & 0xff00) << 8 | ((__uint32_t)(0x0000002e) & 0xff0000) >> 8 | ((__uint32_t)(0x0000002e) & 0xff000000) >> 24) : __swap32md(0x0000002e));
  break;
 default:
  buffer[count++] = (__uint32_t)(__builtin_constant_p(0x00000000) ? (__uint32_t)(((__uint32_t)(0x00000000) & 0xff) << 24 | ((__uint32_t)(0x00000000) & 0xff00) << 8 | ((__uint32_t)(0x00000000) & 0xff0000) >> 8 | ((__uint32_t)(0x00000000) & 0xff000000) >> 24) : __swap32md(0x00000000));
  buffer[count++] = (__uint32_t)(__builtin_constant_p(0x00000000) ? (__uint32_t)(((__uint32_t)(0x00000000) & 0xff) << 24 | ((__uint32_t)(0x00000000) & 0xff00) << 8 | ((__uint32_t)(0x00000000) & 0xff0000) >> 8 | ((__uint32_t)(0x00000000) & 0xff000000) >> 24) : __swap32md(0x00000000));
 ...
 buffer[count++] = (__uint32_t)(__builtin_constant_p(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) ? (__uint32_t)(((__uint32_t)(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff) << 24 | ((__uint32_t)(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff00) << 8 | ((__uint32_t)(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff0000) >> 8 | ((__uint32_t)(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff000000) >> 24) : __swap32md(((3 << 30) | (((0x4A) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)));
 buffer[count++] = (__uint32_t)(__builtin_constant_p((3 << 28)) ? (__uint32_t)(((__uint32_t)((3 << 28)) & 0xff) << 24 | ((__uint32_t)((3 << 28)) & 0xff00) << 8 | ((__uint32_t)((3 << 28)) & 0xff0000) >> 8 | ((__uint32_t)((3 << 28)) & 0xff000000) >> 24) : __swap32md((3 << 28)));
 buffer[count++] = (__uint32_t)(__builtin_constant_p(((3 << 30) | (((0x12) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) ? (__uint32_t)(((__uint32_t)(((3 << 30) | (((0x12) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff) << 24 | ((__uint32_t)(((3 << 30) | (((0x12) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff00) << 8 | ((__uint32_t)(((3 << 30) | (((0x12) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff0000) >> 8 | ((__uint32_t)(((3 << 30) | (((0x12) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)) & 0xff000000) >> 24) : __swap32md(((3 << 30) | (((0x12) & 0xFF) << 8) | ((0) & 0x3FFF) << 16)));
 buffer[count++] = (__uint32_t)(__builtin_constant_p(0) ? (__uint32_t)(((__uint32_t)(0) & 0xff) << 24 | ((__uint32_t)(0) & 0xff00) << 8 | ((__uint32_t)(0) & 0xff0000) >> 8 | ((__uint32_t)(0) & 0xff000000) >> 24) : __swap32md(0));
}
static void cik_init_pg(struct radeon_device *rdev)
{
 if (rdev->pg_flags) {
...
{
 u32 tmp;
 tmp = r100_mm_rreg(rdev, (0xC1A8), 0) &
  ((1 << 19) | (1 << 20));
 r100_mm_wreg(rdev, (0xC1A8), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0xD010 + 0x0), 0) & ~(1 << 0);
 r100_mm_wreg(rdev, (0xD010 + 0x0), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0xD010 + 0x800), 0) & ~(1 << 0);
 r100_mm_wreg(rdev, (0xD010 + 0x800), (tmp), 0);
 r100_mm_wreg(rdev, (0xC214), (0), 0);
 r100_mm_wreg(rdev, (0xC218), (0), 0);
 r100_mm_wreg(rdev, (0xC21C), (0), 0);
 r100_mm_wreg(rdev, (0xC220), (0), 0);
 r100_mm_wreg(rdev, (0xC224), (0), 0);
 r100_mm_wreg(rdev, (0xC228), (0), 0);
 r100_mm_wreg(rdev, (0xC22C), (0), 0);
 r100_mm_wreg(rdev, (0xC230), (0), 0);
 r100_mm_wreg(rdev, (0x8060), (0), 0);
 r100_mm_wreg(rdev, (0xEA0), (0), 0);
 r100_mm_wreg(rdev, (0x6b20 + (0x6df0 - 0x6df0)), (0), 0);
 r100_mm_wreg(rdev, (0x6b20 + (0x79f0 - 0x6df0)), (0), 0);
 if (rdev->num_crtc >= 4) {
  r100_mm_wreg(rdev, (0x6b20 + (0x105f0 - 0x6df0)), (0), 0);
  r100_mm_wreg(rdev, (0x6b20 + (0x111f0 - 0x6df0)), (0), 0);
 }
 if (rdev->num_crtc >= 6) {
  r100_mm_wreg(rdev, (0x6b20 + (0x11df0 - 0x6df0)), (0), 0);
  r100_mm_wreg(rdev, (0x6b20 + (0x129f0 - 0x6df0)), (0), 0);
 }
 if (rdev->num_crtc >= 2) {
...
int cik_irq_set(struct radeon_device *rdev)
{
 ...
 cp_int_cntl = r100_mm_rreg(rdev, (0xC1A8), 0) &
  ((1 << 19) | (1 << 20));
 cp_int_cntl |= (1 << 22) | (1 << 23);
 ...
 dma_cntl = r100_mm_rreg(rdev, (0xD010 + 0x0), 0) & ~(1 << 0);
 dma_cntl1 = r100_mm_rreg(rdev, (0xD010 + 0x800), 0) & ~(1 << 0);
 cp_m1p0 = r100_mm_rreg(rdev, (0xC214), 0) & ~(1 << 26);
 if ((*(&rdev->irq.ring_int[0]))) {
  do { } while( 0);
  cp_int_cntl |= (1 << 26);
 }
 if ((*(&rdev->irq.ring_int[1]))) {
  struct radeon_ring *ring = &rdev->ring[1];
  do { } while( 0);
  if (ring->me == 1) {
   switch (ring->pipe) {
   case 0:
 ...
 if ((*(&rdev->irq.ring_int[2]))) {
  struct radeon_ring *ring = &rdev->ring[2];
  do { } while( 0);
  if (ring->me == 1) {
   switch (ring->pipe) {
   case 0:
 ...
 r100_mm_wreg(rdev, (0xC1A8), (cp_int_cntl), 0);
 r100_mm_wreg(rdev, (0xD010 + 0x0), (dma_cntl), 0);
 r100_mm_wreg(rdev, (0xD010 + 0x800), (dma_cntl1), 0);
 r100_mm_wreg(rdev, (0xC214), (cp_m1p0), 0);
 r100_mm_wreg(rdev, (0x8060), (grbm_int_cntl), 0);
 r100_mm_wreg(rdev, (0x6b20 + (0x6df0 - 0x6df0)), (crtc1), 0);
 r100_mm_wreg(rdev, (0x6b20 + (0x79f0 - 0x6df0)), (crtc2), 0);
 if (rdev->num_crtc >= 4) {
  r100_mm_wreg(rdev, (0x6b20 + (0x105f0 - 0x6df0)), (crtc3), 0);
  r100_mm_wreg(rdev, (0x6b20 + (0x111f0 - 0x6df0)), (crtc4), 0);
 }
 if (rdev->num_crtc >= 6) {
  r100_mm_wreg(rdev, (0x6b20 + (0x11df0 - 0x6df0)), (crtc5), 0);
  r100_mm_wreg(rdev, (0x6b20 + (0x129f0 - 0x6df0)), (crtc6), 0);
 }
 if (rdev->num_crtc >= 2) {
 ...
 r100_mm_rreg(rdev, (0xE50), 0);
 return 0;
}
static inline void cik_irq_ack(struct radeon_device *rdev)
{
 u32 tmp;
 rdev->irq.stat_regs.cik.disp_int = r100_mm_rreg(rdev, (0x60f4), 0);
 rdev->irq.stat_regs.cik.disp_int_cont = r100_mm_rreg(rdev, (0x60f8), 0);
 rdev->irq.stat_regs.cik.disp_int_cont2 = r100_mm_rreg(rdev, (0x60fc), 0);
 rdev->irq.stat_regs.cik.disp_int_cont3 = r100_mm_rreg(rdev, (0x6100), 0);
 rdev->irq.stat_regs.cik.disp_int_cont4 = r100_mm_rreg(rdev, (0x614c), 0);
 rdev->irq.stat_regs.cik.disp_int_cont5 = r100_mm_rreg(rdev, (0x6150), 0);
 rdev->irq.stat_regs.cik.disp_int_cont6 = r100_mm_rreg(rdev, (0x6780), 0);
 rdev->irq.stat_regs.cik.d1grph_int = r100_mm_rreg(rdev, (0x6858 + (0x6df0 - 0x6df0)), 0);
 rdev->irq.stat_regs.cik.d2grph_int = r100_mm_rreg(rdev, (0x6858 + (0x79f0 - 0x6df0)), 0);
 if (rdev->num_crtc >= 4) {
  rdev->irq.stat_regs.cik.d3grph_int = r100_mm_rreg(rdev, (0x6858 + (0x105f0 - 0x6df0)), 0);
  rdev->irq.stat_regs.cik.d4grph_int = r100_mm_rreg(rdev, (0x6858 + (0x111f0 - 0x6df0)), 0);
 }
 if (rdev->num_crtc >= 6) {
  rdev->irq.stat_regs.cik.d5grph_int = r100_mm_rreg(rdev, (0x6858 + (0x11df0 - 0x6df0)), 0);
  rdev->irq.stat_regs.cik.d6grph_int = r100_mm_rreg(rdev, (0x6858 + (0x129f0 - 0x6df0)), 0);
 }
 if (rdev->irq.stat_regs.cik.d1grph_int & (1 << 0))
  r100_mm_wreg(rdev, (0x6858 + (0x6df0 - 0x6df0)), ((1 << 8)), 0);
 if (rdev->irq.stat_regs.cik.d2grph_int & (1 << 0))
  r100_mm_wreg(rdev, (0x6858 + (0x79f0 - 0x6df0)), ((1 << 8)), 0);
 if (rdev->irq.stat_regs.cik.disp_int & (1 << 3))
  r100_mm_wreg(rdev, (0x6b2c + (0x6df0 - 0x6df0)), ((1 << 4)), 0);
 if (rdev->irq.stat_regs.cik.disp_int & (1 << 2))
  r100_mm_wreg(rdev, (0x6b24 + (0x6df0 - 0x6df0)), ((1 << 4)), 0);
 if (rdev->irq.stat_regs.cik.disp_int_cont & (1 << 3))
  r100_mm_wreg(rdev, (0x6b2c + (0x79f0 - 0x6df0)), ((1 << 4)), 0);
 if (rdev->irq.stat_regs.cik.disp_int_cont & (1 << 2))
  r100_mm_wreg(rdev, (0x6b24 + (0x79f0 - 0x6df0)), ((1 << 4)), 0);
 if (rdev->num_crtc >= 4) {
  if (rdev->irq.stat_regs.cik.d3grph_int & (1 << 0))
   r100_mm_wreg(rdev, (0x6858 + (0x105f0 - 0x6df0)), ((1 << 8)), 0);
  if (rdev->irq.stat_regs.cik.d4grph_int & (1 << 0))
   r100_mm_wreg(rdev, (0x6858 + (0x111f0 - 0x6df0)), ((1 << 8)), 0);
  if (rdev->irq.stat_regs.cik.disp_int_cont2 & (1 << 3))
   r100_mm_wreg(rdev, (0x6b2c + (0x105f0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.cik.disp_int_cont2 & (1 << 2))
   r100_mm_wreg(rdev, (0x6b24 + (0x105f0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.cik.disp_int_cont3 & (1 << 3))
   r100_mm_wreg(rdev, (0x6b2c + (0x111f0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.cik.disp_int_cont3 & (1 << 2))
   r100_mm_wreg(rdev, (0x6b24 + (0x111f0 - 0x6df0)), ((1 << 4)), 0);
 }
 if (rdev->num_crtc >= 6) {
  if (rdev->irq.stat_regs.cik.d5grph_int & (1 << 0))
   r100_mm_wreg(rdev, (0x6858 + (0x11df0 - 0x6df0)), ((1 << 8)), 0);
  if (rdev->irq.stat_regs.cik.d6grph_int & (1 << 0))
   r100_mm_wreg(rdev, (0x6858 + (0x129f0 - 0x6df0)), ((1 << 8)), 0);
  if (rdev->irq.stat_regs.cik.disp_int_cont4 & (1 << 3))
   r100_mm_wreg(rdev, (0x6b2c + (0x11df0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.cik.disp_int_cont4 & (1 << 2))
   r100_mm_wreg(rdev, (0x6b24 + (0x11df0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.cik.disp_int_cont5 & (1 << 3))
   r100_mm_wreg(rdev, (0x6b2c + (0x129f0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.cik.disp_int_cont5 & (1 << 2))
   r100_mm_wreg(rdev, (0x6b24 + (0x129f0 - 0x6df0)), ((1 << 4)), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x6020), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x6020), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int_cont & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x602c), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x602c), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int_cont2 & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x6038), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x6038), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int_cont3 & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x6044), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x6044), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int_cont4 & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x6050), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x6050), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int_cont5 & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x605c), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x605c), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x6020), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x6020), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int_cont & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x602c), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x602c), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int_cont2 & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x6038), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x6038), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int_cont3 & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x6044), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x6044), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int_cont4 & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x6050), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x6050), (tmp), 0);
 }
 if (rdev->irq.stat_regs.cik.disp_int_cont5 & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x605c), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x605c), (tmp), 0);
 }
...
int cik_irq_process(struct radeon_device *rdev)
{
 struct radeon_ring *cp1_ring = &rdev->ring[1];
 struct radeon_ring *cp2_ring = &rdev->ring[2];
 u32 wptr;
 u32 rptr;
 ...
 while (rptr != wptr) {
  ...
  case 1:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.cik.disp_int &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.cik.disp_int & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 2:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.cik.disp_int_cont &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 3:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.cik.disp_int_cont2 &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont2 & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont2 &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 4:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.cik.disp_int_cont3 &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont3 & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont3 &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 5:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.cik.disp_int_cont4 &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont4 & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont4 &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 6:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.cik.disp_int_cont5 &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont5 & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont5 &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 42:
   ...
   case 0:
    if (!(rdev->irq.stat_regs.cik.disp_int & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 2:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont2 & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont2 &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 3:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont3 & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont3 &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 4:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont4 & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont4 &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 5:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont5 & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont5 &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 6:
    if (!(rdev->irq.stat_regs.cik.disp_int & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   case 7:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   case 8:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont2 & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont2 &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   case 9:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont3 & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont3 &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   case 10:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont4 & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont4 &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   case 11:
    if (!(rdev->irq.stat_regs.cik.disp_int_cont5 & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.cik.disp_int_cont5 &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   default:
  ...
  case 147:
   ...
   mc_client = r100_mm_rreg(rdev, (0x14E4), 0);
  ...
  case 167:
   ...
   switch (src_data) {
   case 0:
    radeon_fence_process(rdev, 6);
    break;
   case 1:
    radeon_fence_process(rdev, 7);
    break;
   default:
  ...
  case 181:
   ...
   break;
  case 184:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Illegal register access in command stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   me_id = (ring_id & 0x60) >> 5;
   pipe_id = (ring_id & 0x18) >> 3;
   queue_id = (ring_id & 0x7) >> 0;
   switch (me_id) {
   ...
   break;
  case 185:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Illegal instruction in command stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   me_id = (ring_id & 0x60) >> 5;
   pipe_id = (ring_id & 0x18) >> 3;
   queue_id = (ring_id & 0x7) >> 0;
   switch (me_id) {
  ...
  case 241:
  case 247:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Illegal instruction in SDMA command stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   me_id = (ring_id & 0x3) >> 0;
   queue_id = (ring_id & 0xc) >> 2;
   switch (me_id) {
   case 0:
...
static int cik_startup(struct radeon_device *rdev)
{
 ...
 if (rdev->flags & RADEON_IS_IGP) {
  if (rdev->family == CHIP_KAVERI) {
   ...
   rdev->rlc.reg_list_size =
    (u32)(sizeof((spectre_rlc_save_restore_register_list)) / sizeof((spectre_rlc_save_restore_register_list)[0]));
  } else {
   rdev->rlc.reg_list = kalindi_rlc_save_restore_register_list;
   rdev->rlc.reg_list_size =
    (u32)(sizeof((kalindi_rlc_save_restore_register_list)) / sizeof((kalindi_rlc_save_restore_register_list)[0]));
  }
 }
 rdev->rlc.cs_data = ci_cs_data;
 rdev->rlc.cp_table_size = 96 * 5 * 4;
 ...
 r = cik_mec_init(rdev);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to init MEC BOs!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return r;
 }
 ...
 r = radeon_fence_driver_start_ring(rdev, 1);
 if (r) {
  printf("drm:pid%d:%s *ERROR* " "failed initializing CP fences (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 r = radeon_fence_driver_start_ring(rdev, 2);
 if (r) {
  printf("drm:pid%d:%s *ERROR* " "failed initializing CP fences (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 ...
 r = radeon_fence_driver_start_ring(rdev, 4);
 if (r) {
  printf("drm:pid%d:%s *ERROR* " "failed initializing DMA fences (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 ...
 if (r) {
  printf("drm:pid%d:%s *ERROR* " "VCE init error (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  rdev->ring[6].ring_size = 0;
  rdev->ring[7].ring_size = 0;
 }
 if (!rdev->irq.installed) {
 ...
 if (rdev->family == CHIP_HAWAII) {
  if (rdev->new_fw)
   nop = ((3 << 30) | (((0x10) & 0xFF) << 8) | ((0x3FFF) & 0x3FFF) << 16);
  else
   nop = 0x80000000;
 } else {
  nop = ((3 << 30) | (((0x10) & 0xFF) << 8) | ((0x3FFF) & 0x3FFF) << 16);
 ...
 if (r)
  return r;
 ring = &rdev->ring[1];
 r = radeon_ring_init(rdev, ring, ring->ring_size, 1280,
        nop);
 if (r)
  return r;
 ring->me = 1;
 ...
 ring->wptr_offs = 3328;
 ring = &rdev->ring[2];
 r = radeon_ring_init(rdev, ring, ring->ring_size, 1536,
        nop);
 if (r)
  return r;
 ring->me = 1;
 ...
 r = radeon_ring_init(rdev, ring, ring->ring_size, 1792,
        ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((0) & 0xFF) << 0)));
 if (r)
  return r;
 ring = &rdev->ring[4];
 r = radeon_ring_init(rdev, ring, ring->ring_size, 2304,
        ((((0) & 0xFFFF) << 16) | (((0) & 0xFF) << 8) | (((0) & 0xFF) << 0)));
 if (r)
  return r;
 ...
 if (!r)
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: failed initializing VCE (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
 ...
 if (r) {
  printf("drm:pid%d:%s *ERROR* " "vm manager initialization failed (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
...
int cik_resume(struct radeon_device *rdev)
{
 ...
 r = cik_startup(rdev);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "cik startup failed on resume\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
       ...
       struct drm_display_mode *mode)
{
 ...
 r100_mm_wreg(rdev, (0x6b04 + radeon_crtc->crtc_offset), (((tmp) << 20) | ((0x6B0) << 0)), 0);
...
static u32 dce8_dmif_request_bandwidth(struct dce8_wm_params *wm)
{
 ...
 a.full = (u32)(((32) << 12));
 b.full = ((u64)((u64)(a).full * (disp_clk).full + 2048) >> 12);
 a.full = (u32)(((10) << 12));
 disp_clk_request_efficiency.full = (u32)(((8) << 12));
 disp_clk_request_efficiency.full = dfixed_div(disp_clk_request_efficiency, a);
 bandwidth.full = ((u64)((u64)(b).full * (disp_clk_request_efficiency).full + 2048) >> 12);
 return ((bandwidth).full >> 12);
}
...
static u32 dce8_latency_watermark(struct dce8_wm_params *wm)
{
 ...
 b.full = (u32)(((mc_latency + 512) << 12));
 c.full = (u32)(((wm->disp_clk) << 12));
 b.full = dfixed_div(b, c);
 c.full = (u32)(((dmif_size) << 12));
 b.full = dfixed_div(c, b);
 tmp = min(((a).full >> 12), ((b).full >> 12));
 b.full = (u32)(((1000) << 12));
 c.full = (u32)(((wm->disp_clk) << 12));
 b.full = dfixed_div(c, b);
 c.full = (u32)(((wm->bytes_per_pixel) << 12));
 b.full = ((u64)((u64)(b).full * (c).full + 2048) >> 12);
 lb_fill_bw = min(tmp, ((b).full >> 12));
...
static _Bool dce8_average_bandwidth_vs_dram_bandwidth_for_display(struct dce8_wm_params *wm)
{
...
static _Bool dce8_average_bandwidth_vs_available_bandwidth(struct dce8_wm_params *wm)
{
 if (dce8_average_bandwidth(wm) <=
...
static _Bool dce8_check_latency_hiding(struct dce8_wm_params *wm)
{
        ...
        u32 lb_size, u32 num_heads)
{
 ...
 wm_mask = r100_mm_rreg(rdev, (0x6cc8 + radeon_crtc->crtc_offset), 0);
 tmp = wm_mask;
 tmp &= ~((3) << 8);
 tmp |= ((1) << 8);
 r100_mm_wreg(rdev, (0x6cc8 + radeon_crtc->crtc_offset), (tmp), 0);
 r100_mm_wreg(rdev, (0x6ccc + radeon_crtc->crtc_offset), ((((latency_watermark_a) << 0) | ((line_time) << 16))), 0);
 tmp = r100_mm_rreg(rdev, (0x6cc8 + radeon_crtc->crtc_offset), 0);
 tmp &= ~((3) << 8);
 tmp |= ((2) << 8);
 r100_mm_wreg(rdev, (0x6cc8 + radeon_crtc->crtc_offset), (tmp), 0);
 r100_mm_wreg(rdev, (0x6ccc + radeon_crtc->crtc_offset), ((((latency_watermark_b) << 0) | ((line_time) << 16))), 0);
 r100_mm_wreg(rdev, (0x6cc8 + radeon_crtc->crtc_offset), (wm_mask), 0);
...
uint64_t cik_get_gpu_clock_counter(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0xC398), (1), 0);
 clock = (uint64_t)r100_mm_rreg(rdev, (0xC390), 0) |
         ((uint64_t)r100_mm_rreg(rdev, (0xC394), 0) << 32ULL);
                              ...
                              u32 cntl_reg, u32 status_reg)
{
 ...
 struct atom_clock_dividers dividers;
 uint32_t tmp;
 r = radeon_atom_get_clock_dividers(rdev, 0x00,
        clock, 0, &dividers);
 if (r)
  return r;
 tmp = tn_smc_rreg(rdev, (cntl_reg));
 tmp &= ~((1 << 8)|0x7f);
 tmp |= dividers.post_divider;
 tn_smc_wreg(rdev, (cntl_reg), (tmp));
 for (i = 0; i < 100; i++) {
  if (tn_smc_rreg(rdev, (status_reg)) & (1 << 0))
   break;
  mdelay(10);
 }
 if (i == 100)
...
{
 int r = 0;
 r = cik_set_uvd_clock(rdev, vclk, 0xC05000A4, 0xC05000A8);
 if (r)
  return r;
 r = cik_set_uvd_clock(rdev, dclk, 0xC050009C, 0xC05000A0);
 return r;
}
int cik_set_vce_clocks(struct radeon_device *rdev, u32 evclk, u32 ecclk)
{
 ...
 if (r)
  return r;
 for (i = 0; i < 100; i++) {
  if (tn_smc_rreg(rdev, (0xC05000B0)) & (1 << 0))
   break;
  mdelay(10);
 }
 if (i == 100)
  return -60;
 tmp = tn_smc_rreg(rdev, (0xC05000AC));
 tmp &= ~((1 << 8)|0x7f);
 tmp |= dividers.post_divider;
 tn_smc_wreg(rdev, (0xC05000AC), (tmp));
 for (i = 0; i < 100; i++) {
  if (tn_smc_rreg(rdev, (0xC05000B0)) & (1 << 0))
   break;
  mdelay(10);
...
static void cik_pcie_gen3_enable(struct radeon_device *rdev)
{
 ...
 if (!(mask & (2 | 4)))
  return;
 speed_cntl = rdev->pciep_rreg(rdev, (0x100100A4));
 current_data_rate = (speed_cntl & (0x3 << 13)) >>
  13;
 if (mask & 4) {
 ...
 if (mask & 4) {
  if (current_data_rate != 2) {
   ...
   pci_read_config_word(root, bridge_pos + 0x10, &bridge_cfg);
   pci_read_config_word(rdev->pdev, gpu_pos + 0x10, &gpu_cfg);
   tmp16 = bridge_cfg | 0x0200;
   pci_write_config_word(root, bridge_pos + 0x10, tmp16);
   tmp16 = gpu_cfg | 0x0200;
   pci_write_config_word(rdev->pdev, gpu_pos + 0x10, tmp16);
   tmp = rdev->pciep_rreg(rdev, (0x1400028));
   max_lw = (tmp & (0x7 << 5)) >> 5;
   current_lw = (tmp & (0x7 << 2)) >> 2;
   if (current_lw < max_lw) {
    tmp = rdev->pciep_rreg(rdev, (0x100100A2));
    if (tmp & (1 << 9)) {
     tmp &= ~(0x7 | (1 << 13));
     tmp |= (max_lw << 0);
     tmp |= (1 << 12) | (1 << 10) | (1 << 8);
     rdev->pciep_wreg(rdev, (0x100100A2), (tmp));
    }
   }
   for (i = 0; i < 10; i++) {
    pci_read_config_word(rdev->pdev, gpu_pos + 0x0a, &tmp16);
    if (tmp16 & 0x0020)
     break;
    pci_read_config_word(root, bridge_pos + 0x10, &bridge_cfg);
    pci_read_config_word(rdev->pdev, gpu_pos + 0x10, &gpu_cfg);
    pci_read_config_word(root, bridge_pos + 0x30, &bridge_cfg2);
    pci_read_config_word(rdev->pdev, gpu_pos + 0x30, &gpu_cfg2);
    tmp = rdev->pciep_rreg(rdev, (0x100100B6));
    tmp |= (1 << 13);
    rdev->pciep_wreg(rdev, (0x100100B6), (tmp));
    tmp = rdev->pciep_rreg(rdev, (0x100100B6));
    tmp |= (1 << 5);
    rdev->pciep_wreg(rdev, (0x100100B6), (tmp));
    mdelay(100);
    pci_read_config_word(root, bridge_pos + 0x10, &tmp16);
    tmp16 &= ~0x0200;
    tmp16 |= (bridge_cfg & 0x0200);
    pci_write_config_word(root, bridge_pos + 0x10, tmp16);
    pci_read_config_word(rdev->pdev, gpu_pos + 0x10, &tmp16);
    tmp16 &= ~0x0200;
    tmp16 |= (gpu_cfg & 0x0200);
    pci_write_config_word(rdev->pdev, gpu_pos + 0x10, tmp16);
    pci_read_config_word(root, bridge_pos + 0x30, &tmp16);
    tmp16 &= ~((1 << 4) | (7 << 9));
    tmp16 |= (bridge_cfg2 & ((1 << 4) | (7 << 9)));
    pci_write_config_word(root, bridge_pos + 0x30, tmp16);
    pci_read_config_word(rdev->pdev, gpu_pos + 0x30, &tmp16);
    tmp16 &= ~((1 << 4) | (7 << 9));
    tmp16 |= (gpu_cfg2 & ((1 << 4) | (7 << 9)));
    pci_write_config_word(rdev->pdev, gpu_pos + 0x30, tmp16);
    tmp = rdev->pciep_rreg(rdev, (0x100100B6));
    tmp &= ~(1 << 13);
    rdev->pciep_wreg(rdev, (0x100100B6), (tmp));
   }
 ...
 speed_cntl |= (1 << 5) | (1 << 8);
 speed_cntl &= ~(1 << 6);
 rdev->pciep_wreg(rdev, (0x100100A4), (speed_cntl));
 pci_read_config_word(rdev->pdev, gpu_pos + 0x30, &tmp16);
 tmp16 &= ~0xf;
 if (mask & 4)
  tmp16 |= 3;
...
{
 u32 data, orig;
 _Bool disable_l0s = 0, disable_l1 = 0, disable_plloff_in_l1 = 0;
 _Bool disable_clkreq = 0;
 if (radeon_aspm == 0)
  return;
 if (rdev->flags & RADEON_IS_IGP)
  return;
 if (!(rdev->flags & RADEON_IS_PCIE))
  return;
 orig = data = rdev->pciep_rreg(rdev, (0x100100a3));
 data &= ~(0xff << 0);
 data |= ((0x24) << 0) | (1 << 8);
 if (orig != data)
  rdev->pciep_wreg(rdev, (0x100100a3), (data));
 orig = data = rdev->pciep_rreg(rdev, (0x100100B5));
 data |= (1 << 30);
 if (orig != data)
  rdev->pciep_wreg(rdev, (0x100100B5), (data));
 orig = data = rdev->pciep_rreg(rdev, (0x1400040));
 data |= (1 << 6);
 if (orig != data)
  rdev->pciep_wreg(rdev, (0x1400040), (data));
 orig = data = rdev->pciep_rreg(rdev, (0x100100A0));
 data &= ~((0xf << 8) | (0xf << 12));
 data |= (1 << 16);
 if (!disable_l0s)
  data |= ((7) << 8);
 if (!disable_l1) {
  ...
  data &= ~(1 << 16);
  if (orig != data)
   rdev->pciep_wreg(rdev, (0x100100A0), (data));
  if (!disable_plloff_in_l1) {
   _Bool clk_req_support;
   orig = data = rdev->pciep_rreg(rdev, (0x1100012));
   data &= ~((0x7 << 10) | (0x7 << 7));
   data |= ((7) << 10) | ((7) << 7);
   if (orig != data)
    rdev->pciep_wreg(rdev, (0x1100012), (data));
   orig = data = rdev->pciep_rreg(rdev, (0x1100013));
   data &= ~((0x7 << 10) | (0x7 << 7));
   data |= ((7) << 10) | ((7) << 7);
   if (orig != data)
    rdev->pciep_wreg(rdev, (0x1100013), (data));
   orig = data = rdev->pciep_rreg(rdev, (0x2100012));
   data &= ~((0x7 << 10) | (0x7 << 7));
   data |= ((7) << 10) | ((7) << 7);
   if (orig != data)
    rdev->pciep_wreg(rdev, (0x2100012), (data));
   orig = data = rdev->pciep_rreg(rdev, (0x2100013));
   data &= ~((0x7 << 10) | (0x7 << 7));
   data |= ((7) << 10) | ((7) << 7);
   if (orig != data)
    rdev->pciep_wreg(rdev, (0x2100013), (data));
   orig = data = rdev->pciep_rreg(rdev, (0x100100A2));
   data &= ~(0x3 << 21);
   data |= ((3) << 21);
   if (orig != data)
    rdev->pciep_wreg(rdev, (0x100100A2), (data));
   if (!disable_clkreq &&
    ...
    root->tag = *rdev->ddev->bridgetag;
    clk_req_support = 0;
    pcie_capability_read_dword(root, 0x0c, &lnkcap);
    if (lnkcap & 0x00040000)
     clk_req_support = 1;
   } else {
    clk_req_support = 0;
   }
   if (clk_req_support) {
    orig = data = rdev->pciep_rreg(rdev, (0x100100B1));
    data |= (1 << 17) | (1 << 18);
    if (orig != data)
     rdev->pciep_wreg(rdev, (0x100100B1), (data));
    orig = data = tn_smc_rreg(rdev, (0xC05001A8));
    data &= ~(0xFF | 0xFF00);
    data |= ((1) << 0) | ((1) << 8);
    if (orig != data)
     tn_smc_wreg(rdev, (0xC05001A8), (data));
    orig = data = tn_smc_rreg(rdev, (0xC05001AC));
    data &= ~(0xFF | 0xFF00);
    data |= ((1) << 0) | ((1) << 8);
    if (orig != data)
     tn_smc_wreg(rdev, (0xC05001AC), (data));
    orig = data = tn_smc_rreg(rdev, (0xC05001A0));
    data &= ~(1 << 2);
    if (orig != data)
     tn_smc_wreg(rdev, (0xC05001A0), (data));
    orig = data = tn_smc_rreg(rdev, (0xC05001A4));
    data &= ~(1 << 3);
    if (orig != data)
     tn_smc_wreg(rdev, (0xC05001A4), (data));
    orig = data = tn_smc_rreg(rdev, (0xC050019C));
    data &= ~0xFF00;
    data |= ((4) << 8);
    if (orig != data)
     tn_smc_wreg(rdev, (0xC050019C), (data));
   }
  }
 } else {
  if (orig != data)
 ...
 if (orig != data)
  rdev->pciep_wreg(rdev, (0x1001001c), (data));
 if (!disable_l0s) {
  data = rdev->pciep_rreg(rdev, (0x100100a3));
  if((data & (0xff << 24)) == (0xff << 24)) {
   data = rdev->pciep_rreg(rdev, (0x1400028));
