# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_placement.h" 1
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c" 2
...
int ttm_bo_move_buffer(struct ttm_buffer_object *, struct ttm_placement *,
    _Bool, _Bool);
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
struct kobject *
ttm_get_kobj(void)
{
 return (((void *)0));
...
# 130 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
...
static void ttm_bo_release_list(struct kref *list_kref)
{
 ...
 ((!((*(&bo->kref.refcount)))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 151, "!((*(&bo->kref.refcount)))"));
 ((!((*(&bo->cpu_writers)))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 152, "!((*(&bo->cpu_writers)))"));
 ((!(bo->sync_obj != ((void *)0))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 153, "!(bo->sync_obj != ((void *)0))"));
...
int ttm_bo_wait_unreserved(struct ttm_buffer_object *bo, _Bool interruptible)
{
 int ret = 0;
 ...
 while (ret == 0) {
  ...
  ret = -tsleep(&bo->event_queue,
      22 | (interruptible ? 0x100 : 0), "ttmwt", 0);
...
void ttm_bo_add_to_lru(struct ttm_buffer_object *bo)
{
 ...
 ((!(!ttm_bo_is_reserved(bo))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 190, "!(!ttm_bo_is_reserved(bo))"));

 if (!(bo->mem.placement & (1 << 21))) {

  ((!(!list_empty(&bo->lru))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 194, "!(!list_empty(&bo->lru))"));
     ...
     _Bool no_wait, _Bool use_sequence, uint32_t sequence)
{
 ...
 while (__builtin_expect(!!((*(&bo->reserved)) != 0), 0)) {
  ...
  if (use_sequence && bo->seq_valid) {
   ...
   if (__builtin_expect(!!(sequence == bo->val_seq), 0))
    return -11;




   if (__builtin_expect(!!(sequence - bo->val_seq < (1 << 31)), 0))
    return -35;
  }
...
{
 do { panic("BUG at %s:%d", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 286); } while (0);
}
...
# 495 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
static void ttm_bo_cleanup_memtype_use(struct ttm_buffer_object *bo)
{
 ...
 (*(&bo->reserved) = (0));
 wakeup(&bo->event_queue);
# 517 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
 __asm volatile("membar " "#Sync" ::: "memory");
}
...
# 578 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
       ...
       _Bool no_wait_gpu)
{
 ...
 if (ret && !no_wait_gpu) {
  ...
  __mtx_enter(&glob->lru_lock);
  ret = ttm_bo_reserve_locked(bo, 0, 1, 0, 0);
# 633 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
  if (ret) {
   __mtx_leave(&glob->lru_lock);
   return 0;
  }
   ...
   _Bool no_wait_gpu)
{
 ...
 ((!(!ttm_bo_is_reserved(bo))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 781, "!(!ttm_bo_is_reserved(bo))"));
     ...
     uint32_t *masked_placement)
{
 ...
 if ((cur_flags & proposed_placement & 0x0000FFFF) == 0)
  return 0;
...
# 955 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
...
static _Bool ttm_bo_mem_compat(struct ttm_placement *placement,
         struct ttm_mem_reg *mem,
         uint32_t *new_flags)
{
 int i;
   ...
   _Bool no_wait_gpu)
{
 ...
 ((!(!ttm_bo_is_reserved(bo))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 1139, "!(!ttm_bo_is_reserved(bo))"));
...
int ttm_bo_check_placement(struct ttm_buffer_object *bo,
    struct ttm_placement *placement)
{
 ((!((placement->fpfn || placement->lpfn) && (bo->mem.num_pages > (placement->lpfn - placement->fpfn)))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 1177, "!((placement->fpfn || placement->lpfn) && (bo->mem.num_pages > (placement->lpfn - placement->fpfn)))"));
      ...
      unsigned struct_size)
{
 ...
 size += ttm_round_pot(struct_size);
 size += (((npages * sizeof(void *)) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
 size += (((npages * sizeof(bus_addr_t)) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
   ...
   unsigned long p_size)
{
 ...
 ((!(type >= 8)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 1420, "!(type >= 8)"));
 man = &bdev->man[type];
 ((!(man->has_type)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c", 1422, "!(man->has_type)"));
 man->io_reserve_fastpath = 1;
 man->use_io_reserve_lru = 0;
 _rw_init_flags(&man->io_reserve_mutex, "ttm_iores", 0, ((void *)0));
...
;
# 1668 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_bo.c"
static int ttm_bo_setup_vm(struct ttm_buffer_object *bo)
{
 struct ttm_bo_device *bdev = bo->bdev;
  ...
  _Bool lazy, _Bool interruptible, _Bool no_wait)
{
 ...
 if (__builtin_expect(!!(bo->sync_obj == ((void *)0)), 1))
  return 0;
