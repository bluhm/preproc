# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
void device_register(struct device *, void *);
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pcidevs.h" 1
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
...
int ifb_ident(void *);
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c" 2
# 96 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/gfxp.c"
...
gfxp_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 if (pci_mapreg_info(pa->pa_pc, pa->pa_tag, 0x14,
     0x00000000, &sc->sc_membase_le, &sc->sc_memsize_le, ((void *)0)))
  sc->sc_memsize_le = 0;
...
gfxp_setcolor(void *v, u_int index, u_int8_t r, u_int8_t g, u_int8_t b)
{
 ...
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh,
     0x4000, index);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4008, r);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4008, g);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4008, b);
}
...
gfxp_reinit(struct gfxp_softc *sc)
{
 ...
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh,
     0x8a80, sc->sc_read_mode);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh,
     0x8ad0, sc->sc_read_pixel);


 gfxp_indexed_write(sc, 0x0005, 0x10);


 for (i = 0; i < 1024; i++)
  gfxp_indexed_write(sc, 0x0400 + i, 0x00);
...
gfxp_indexed_write(struct gfxp_softc *sc, bus_size_t offset, uint32_t value)
{
 ...
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh,
     0x4020, offset & 0xff);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x4030, value);
}
...
gfxp_wait(struct gfxp_softc *sc)
{
 ...
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh,
     0x8c00, 0x00000400);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x8c40, 0);
    ...
    int w, int h)
{
 ...
 gfxp_wait_fifo(sc, 5);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x8d90,
     0x00000008 | 0x00000001);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x8d88,
     (((sy - dy) & 0xffff) << 16 | ((sx - dx) & 0xffff)));
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x80d0,
     ((dy) << 16 | (dx)));
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x80d8,
     ((h) << 16 | (w)));
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x8038,
     0x000000c0 | dir);
...
gfxp_fillrect(struct gfxp_softc *sc, int x, int y, int w, int h, int color)
{
 ...
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x80d8,
     ((h) << 16 | (w)));
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x8ac8,
     color);
 bus_space_write_4(sc->sc_mmiot, sc->sc_mmioh, 0x8038,
     0x000000c0 | 0x00000008);
