# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c"
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_types.h" 1
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c" 2
# 98 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c"
struct upl_softc;
...
struct upl_cdata {
 struct upl_chain upl_tx_chain[1];
 struct upl_chain upl_rx_chain[1];
 int upl_tx_prod;
 int upl_tx_cons;
 int upl_tx_cnt;
 int upl_rx_prod;
...
# 148 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/if_upl.c"
...
upl_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(upl_devs), sizeof (upl_devs) / sizeof ((upl_devs)[0]), sizeof ((upl_devs)[0]), (uaa->vendor), (uaa->product)) != ((void *)0) ?
     13 : 0);
}
...
upl_rx_list_init(struct upl_softc *sc)
{
 ...
 for (i = 0; i < 1; i++) {
  ...
  c->upl_sc = sc;
  c->upl_idx = i;
  if (upl_newbuf(sc, c, ((void *)0)) == 55)
   return (55);
  if (c->upl_xfer == ((void *)0)) {
   c->upl_xfer = usbd_alloc_xfer(sc->sc_udev);
   if (c->upl_xfer == ((void *)0))
    return (55);
   c->upl_buf = usbd_alloc_buffer(c->upl_xfer, 1024);
   if (c->upl_buf == ((void *)0)) {
...
upl_rxeof(struct usbd_xfer *xfer, void *priv, usbd_status status)
{
 ...
 m = c->upl_mbuf;
 __builtin_memcpy((((char *)((c->upl_mbuf)->m_hdr.mh_data))), (c->upl_buf), (total_len));
 ...
 usbd_setup_xfer(c->upl_xfer, sc->sc_ep[0x0],
     c, c->upl_buf, 1024, 0x04 | 0x01,
     0, upl_rxeof);
...
upl_send(struct upl_softc *sc, struct mbuf *m, int idx)
{
 ...
 m_copydata(m, 0, m->M_dat.MH.MH_pkthdr.len, c->upl_buf);
 c->upl_mbuf = m;
 ...
 usbd_setup_xfer(c->upl_xfer, sc->sc_ep[0x1],
     c, c->upl_buf, total_len, 0x01, 5000,
     upl_txeof);
...
upl_stop(struct upl_softc *sc)
{
 ...
 if (sc->sc_ep[0x0] != ((void *)0)) {
  ...
  err = usbd_close_pipe(sc->sc_ep[0x0]);
  if (err) {
 ...
 if (sc->sc_ep[0x1] != ((void *)0)) {
  ...
  err = usbd_close_pipe(sc->sc_ep[0x1]);
  if (err) {
 ...
 if (sc->sc_ep[0x2] != ((void *)0)) {
  ...
  err = usbd_close_pipe(sc->sc_ep[0x2]);
  if (err) {
 ...
 for (i = 0; i < 1; i++) {
  if (sc->sc_cdata.upl_rx_chain[i].upl_mbuf != ((void *)0)) {
   m_freem(sc->sc_cdata.upl_rx_chain[i].upl_mbuf);
   sc->sc_cdata.upl_rx_chain[i].upl_mbuf = ((void *)0);
  }
  if (sc->sc_cdata.upl_rx_chain[i].upl_xfer != ((void *)0)) {
   usbd_free_xfer(sc->sc_cdata.upl_rx_chain[i].upl_xfer);
   sc->sc_cdata.upl_rx_chain[i].upl_xfer = ((void *)0);
  }
 }


 for (i = 0; i < 1; i++) {
  if (sc->sc_cdata.upl_tx_chain[i].upl_mbuf != ((void *)0)) {
   m_freem(sc->sc_cdata.upl_tx_chain[i].upl_mbuf);
   sc->sc_cdata.upl_tx_chain[i].upl_mbuf = ((void *)0);
  }
  if (sc->sc_cdata.upl_tx_chain[i].upl_xfer != ((void *)0)) {
   usbd_free_xfer(sc->sc_cdata.upl_tx_chain[i].upl_xfer);
   sc->sc_cdata.upl_tx_chain[i].upl_xfer = ((void *)0);
  }
 }
}
