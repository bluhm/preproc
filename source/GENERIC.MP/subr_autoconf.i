# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/hotplug.h" 1
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/mpath.h" 1
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c" 2
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
...
int autoconf_verbose = 0;

static void mapply(struct matchinfo *, struct cfdata *);

struct deferred_config {
 struct { struct deferred_config *tqe_next; struct deferred_config **tqe_prev; } dc_queue;
 struct device *dc_dev;
 void (*dc_func)(struct device *);
};

struct { struct deferred_config *tqh_first; struct deferred_config **tqh_last; } deferred_config_queue;
struct { struct deferred_config *tqh_first; struct deferred_config **tqh_last; } mountroot_config_queue;
...
struct mutex autoconf_attdet_mtx = { ((void *)0), ((((15)) > 0 && ((15)) < 12) ? 12 : ((15))), 0 };
...
config_init(void)
{
 do { (&deferred_config_queue)->tqh_first = ((void *)0); (&deferred_config_queue)->tqh_last = &(&deferred_config_queue)->tqh_first; } while (0);
 do { (&mountroot_config_queue)->tqh_first = ((void *)0); (&mountroot_config_queue)->tqh_last = &(&mountroot_config_queue)->tqh_first; } while (0);
 do { (&alldevs)->tqh_first = ((void *)0); (&alldevs)->tqh_last = &(&alldevs)->tqh_first; } while (0);
}
...
mapply(struct matchinfo *m, struct cfdata *cf)
{
 ...
 if (m->fn != ((void *)0))
  pri = (*m->fn)(m->parent, match, m->aux);
         ...
         if (cf->cf_attach->ca_match == ((void *)0)) {
...
# 178 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
void *
...
# 230 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
void
...
# 304 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
struct device *
    ...
    cfmatch_t submatch)
{
 ...
 if ((match = config_search(submatch, parent, aux)) != ((void *)0))
...
config_rootfound(char *rootname, void *aux)
{
 ...
 if ((match = config_rootsearch((cfmatch_t)((void *)0), rootname, aux)) != ((void *)0))
  return (config_attach(((struct device *)((void *)0)), match, aux, (cfprint_t)((void *)0)));
...
config_attach(struct device *parent, void *match, void *aux, cfprint_t print)
{
 ...
 ((cd->cd_devs != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c", 360, "cd->cd_devs != NULL"));
 ((dev->dv_unit < cd->cd_ndevs) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c", 361, "dev->dv_unit < cd->cd_ndevs"));
 ((cd->cd_devs[dev->dv_unit] == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c", 362, "cd->cd_devs[dev->dv_unit] == NULL"));
 ...
 do { (dev)->dv_list.tqe_next = ((void *)0); (dev)->dv_list.tqe_prev = (&alldevs)->tqh_last; *(&alldevs)->tqh_last = (dev); (&alldevs)->tqh_last = &(dev)->dv_list.tqe_next; } while (0);
 device_ref(dev);

 if (parent == ((struct device *)((void *)0)))
  printf("%s at root", dev->dv_xname);
 else {
  printf("%s at %s", dev->dv_xname, parent->dv_xname);
  if (print)
   (void) (*print)(aux, ((void *)0));
 }
...
config_make_softc(struct device *parent, struct cfdata *cf)
{
 ...
 dev = malloc(ca->ca_devsize, 2, 0x0002|0x0008);
 if (dev == ((void *)0))
 ...
 if (dev->dv_unit >= cd->cd_ndevs) {
  ...
  while (new <= dev->dv_unit)
   new *= 2;
  cd->cd_ndevs = new;
  nsp = mallocarray(new, sizeof(void *), 2, 0x0002|0x0008);
  if (nsp == ((void *)0))
   panic("config_make_softc: %sing dev array",
       old != 0 ? "expand" : "creat");
  if (old != 0) {
   __builtin_bcopy((cd->cd_devs), (nsp), (old * sizeof(void *)));
   free(cd->cd_devs, 2, 0);
  }
  cd->cd_devs = nsp;
 }
...
# 495 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
int
...
# 565 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
 i = 0;
 for (d = ((dev)->dv_list.tqe_next); d != ((void *)0);
 ...
 do { if (((dev)->dv_list.tqe_next) != ((void *)0)) (dev)->dv_list.tqe_next->dv_list.tqe_prev = (dev)->dv_list.tqe_prev; else (&alldevs)->tqh_last = (dev)->dv_list.tqe_prev; *(dev)->dv_list.tqe_prev = (dev)->dv_list.tqe_next; ((dev)->dv_list.tqe_prev) = ((void *)-1); ((dev)->dv_list.tqe_next) = ((void *)-1); } while (0);
 device_unref(dev);
...
config_defer(struct device *dev, void (*func)(struct device *))
{
 ...
 if (dev->dv_parent == ((void *)0))
  panic("config_defer: can't defer config of a root device");


 for (dc = ((&deferred_config_queue)->tqh_first); dc != ((void *)0);
      dc = ((dc)->dc_queue.tqe_next)) {
  if (dc->dc_dev == dev)
   panic("config_defer: deferred twice");
 }


 if ((dc = malloc(sizeof(*dc), 2, 0x0002)) == ((void *)0))
  panic("config_defer: can't allocate defer structure");

 dc->dc_dev = dev;
 dc->dc_func = func;
 do { (dc)->dc_queue.tqe_next = ((void *)0); (dc)->dc_queue.tqe_prev = (&deferred_config_queue)->tqh_last; *(&deferred_config_queue)->tqh_last = (dc); (&deferred_config_queue)->tqh_last = &(dc)->dc_queue.tqe_next; } while (0);
 config_pending_incr();
}
...
config_mountroot(struct device *dev, void (*func)(struct device *))
{
 ...
 for (dc = ((&mountroot_config_queue)->tqh_first); dc != ((void *)0);
      dc = ((dc)->dc_queue.tqe_next)) {
  if (dc->dc_dev == dev)
 ...
 dc->dc_dev = dev;
 dc->dc_func = func;
 do { (dc)->dc_queue.tqe_next = ((void *)0); (dc)->dc_queue.tqe_prev = (&mountroot_config_queue)->tqh_last; *(&mountroot_config_queue)->tqh_last = (dc); (&mountroot_config_queue)->tqh_last = &(dc)->dc_queue.tqe_next; } while (0);
}
...
config_process_deferred_children(struct device *parent)
{
 ...
 for (dc = ((&deferred_config_queue)->tqh_first);
      dc != ((void *)0); dc = ndc) {
  ndc = ((dc)->dc_queue.tqe_next);
  if (dc->dc_dev->dv_parent == parent) {
   do { if (((dc)->dc_queue.tqe_next) != ((void *)0)) (dc)->dc_queue.tqe_next->dc_queue.tqe_prev = (dc)->dc_queue.tqe_prev; else (&deferred_config_queue)->tqh_last = (dc)->dc_queue.tqe_prev; *(dc)->dc_queue.tqe_prev = (dc)->dc_queue.tqe_next; ((dc)->dc_queue.tqe_prev) = ((void *)-1); ((dc)->dc_queue.tqe_next) = ((void *)-1); } while (0);
...
config_process_deferred_mountroot(void)
{
 ...
 while ((dc = ((&mountroot_config_queue)->tqh_first)) != ((void *)0)) {
  do { if (((dc)->dc_queue.tqe_next) != ((void *)0)) (dc)->dc_queue.tqe_next->dc_queue.tqe_prev = (dc)->dc_queue.tqe_prev; else (&mountroot_config_queue)->tqh_last = (dc)->dc_queue.tqe_prev; *(dc)->dc_queue.tqe_prev = (dc)->dc_queue.tqe_next; ((dc)->dc_queue.tqe_prev) = ((void *)-1); ((dc)->dc_queue.tqe_next) = ((void *)-1); } while (0);
  (*dc->dc_func)(dc->dc_dev);
  free(dc, 2, sizeof(*dc));
 }
}
...
config_detach_children(struct device *parent, int flags)
{
 ...
 int rv = 0;
# 791 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
 for (dev = (*(((struct devicelist *)((&alldevs)->tqh_last))->tqh_last));
     dev != ((void *)0); dev = next_dev) {
  if (dev->dv_parent == parent) {
   if ((rv = config_detach(dev, flags)) != 0)
    return (rv);
   next_dev = (*(((struct devicelist *)((&alldevs)->tqh_last))->tqh_last));
  } else {
   next_dev = (*(((struct devicelist *)((dev)->dv_list.tqe_prev))->tqh_last));
  }
 }
...
config_activate_children(struct device *parent, int act)
{
 ...
 for (d = ((parent)->dv_list.tqe_next); d != ((void *)0);
     d = ((d)->dv_list.tqe_next)) {
  ...
  d = (*(((struct devicelist *)((d)->dv_list.tqe_prev))->tqh_last));
  for (; d != ((void *)0) && d != parent;
      d = (*(((struct devicelist *)((d)->dv_list.tqe_prev))->tqh_last))) {
   if (d->dv_parent != parent)
    continue;
   printf("resume %s\n", d->dv_xname);
...
# 922 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
struct device *
device_lookup(struct cfdriver *cd, int unit)
{
 struct device *dv = ((void *)0);
...
{
 ((void)_atomic_add_int_nv((&dv->dv_ref), 1));
}
# 987 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_autoconf.c"
void
device_unref(struct device *dv)
{
 struct cfattach *ca;

 if (_atomic_sub_int_nv((&dv->dv_ref), 1) == 0) {
  ca = dv->dv_cfdata->cf_attach;
  free(dv, 2, ca->ca_devsize);
 }
}
