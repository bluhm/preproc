# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c"
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/ppp.h" 1
# 96 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 102 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 103 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 104 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 105 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 107 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 108 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 109 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 110 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 111 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 112 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 113 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 115 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 117 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 118 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 121 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 122 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 123 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 126 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
# 127 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
int pppoutput(struct ifnet *, struct mbuf *, struct sockaddr *,
     struct rtentry *);
void pppintr(void);
# 128 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
int pppoutput(struct ifnet *, struct mbuf *,
         struct sockaddr *, struct rtentry *);
# 129 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c" 2
...
struct rwlock ppp_pkt_init = { 0, "ppppktini" };
struct pool ppp_pkts;
# 163 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c"
int
pppopen(dev_t dev, struct tty *tp, struct proc *p)
{
 ...
 pool_set_constraints(&ppp_pkts, &kp_dma_contig);
    ...
    _rw_exit_write(&ppp_pkt_init );

    s = _splraise(6);

    if (tp->t_line == 5) {
 sc = (struct ppp_softc *) tp->t_sc;
 if (sc != ((void *)0) && sc->sc_devp == (void *) tp) {
     _splx(s);
     return (0);
 }
    }

    if ((sc = pppalloc(p->p_p->ps_pid)) == ((void *)0)) {
 _splx(s);
 return 6;
    }
 ...
 (*sc->sc_relinq)(sc);
    ...
    sc->sc_ilen = 0;
    sc->sc_pkt = ((void *)0);
    __builtin_bzero((sc->sc_asyncmap), (sizeof(sc->sc_asyncmap)));
...
pppread(struct tty *tp, struct uio *uio, int flag)
{
 ...
 error = ttysleep(tp, (caddr_t)&tp->t_rawq, 25|0x100, ttyin, 0);
 if (error) {
     _splx(s);
     return error;
 }
 ...
 *mp = m;
 ...
 m->m_hdr.mh_len = len;
    ...
    dst.sa_family = 0;
    __builtin_bcopy((((u_char *)((m0)->m_hdr.mh_data))), (dst.sa_data), (4));
    m0->m_hdr.mh_data += 4;
    m0->m_hdr.mh_len -= 4;
    return sc->sc_if.if_output(&sc->sc_if, m0, &dst, ((void *)0));
}
...
pppstart_internal(struct tty *tp, int force)
{
 ...
 (*tp->t_oproc)(tp);
    ...
    if ((((&tp->t_outq)->c_cc) < tp->t_lowat || force)
...
ppppkt(struct ppp_softc *sc)
{
    ...
    s = _splraise(6);
    pktp = &sc->sc_pkt;
    for (len = ((sc)->sc_mru + 4 + 2); len > 0; len -= sizeof(pkt->p_buf)) {
 pkt = *pktp;
 if (pkt == ((void *)0)) {
     pkt = pool_get(&ppp_pkts, 0x0002);
     if (pkt == ((void *)0))
  break;
     ((pkt)->p_hdr.ph_next) = ((void *)0);
     ((pkt)->p_hdr.ph_pkt) = *pktp;
     ((pkt)->p_hdr.ph_len) = 0;
     *pktp = pkt;
 }
 pktp = &((pkt)->p_hdr.ph_next);
    }
    _splx(s);
}
...
pppinput(int c, struct tty *tp)
{
 ...
 ilen -= 2;
 pkt = sc->sc_pktc;
 if (--((pkt)->p_hdr.ph_len) == 0) {
            pkt = ((pkt)->p_hdr.ph_pkt);
     sc->sc_pktc = pkt;
 }
 ((pkt)->p_hdr.ph_len)--;
 ...
 pkt = sc->sc_pkt;
 sc->sc_pkt = sc->sc_pktc = ((sc->sc_pktc)->p_hdr.ph_next);
 ((pkt)->p_hdr.ph_next) = ((void *)0);

 ppppktin(sc, pkt, sc->sc_flags & 0x20000000);
 ...
 return 0;
    ...
    _splx(s);
# 938 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/ppp_tty.c"
    if (sc->sc_ilen == 0) {
 ...
 *sc->sc_pktp++ = 0;
 ...
 goto flush;
    ...
    pkt = sc->sc_pktc;
    if (((pkt)->p_hdr.ph_len) >= sizeof(pkt->p_buf)) {
 if (((pkt)->p_hdr.ph_next) == ((void *)0)) {
     ppppkt(sc);
     if (((pkt)->p_hdr.ph_next) == ((void *)0)) {
  if (sc->sc_flags & 0x00010000)
 ...
 sc->sc_pktc = pkt = ((pkt)->p_hdr.ph_next);
 ((pkt)->p_hdr.ph_len) = 0;
 sc->sc_pktp = pkt->p_buf;
    }
    ...
    ++((pkt)->p_hdr.ph_len);
    *sc->sc_pktp++ = c;
    sc->sc_fcs = (((sc->sc_fcs) >> 8) ^ fcstab[((sc->sc_fcs) ^ (c)) & 0xff]);
    return 0;
