 ...
 if (atom_parse_data_header(mode_info->atom_context, index, &size,
  ...
  for (i = 0; i < num_indices; i++) {
   if (ss_info->asSS_Info[i].ucSS_Id == id) {
    ss->percentage =
     (__uint16_t)(__builtin_constant_p(ss_info->asSS_Info[i].usSpreadSpectrumPercentage) ? (__uint16_t)(((__uint16_t)(ss_info->asSS_Info[i].usSpreadSpectrumPercentage) & 0xffU) << 8 | ((__uint16_t)(ss_info->asSS_Info[i].usSpreadSpectrumPercentage) & 0xff00U) >> 8) : __swap16md(ss_info->asSS_Info[i].usSpreadSpectrumPercentage));
  ...
  case 1:
   ...
   for (i = 0; i < num_indices; i++) {
    if ((ss_info->info.asSpreadSpectrum[i].ucClockIndication == id) &&
        (clock <= (__uint32_t)(__builtin_constant_p(ss_info->info.asSpreadSpectrum[i].ulTargetClockRange) ? (__uint32_t)(((__uint32_t)(ss_info->info.asSpreadSpectrum[i].ulTargetClockRange) & 0xff) << 24 | ((__uint32_t)(ss_info->info.asSpreadSpectrum[i].ulTargetClockRange) & 0xff00) << 8 | ((__uint32_t)(ss_info->info.asSpreadSpectrum[i].ulTargetClockRange) & 0xff0000) >> 8 | ((__uint32_t)(ss_info->info.asSpreadSpectrum[i].ulTargetClockRange) & 0xff000000) >> 24) : __swap32md(ss_info->info.asSpreadSpectrum[i].ulTargetClockRange)))) {
     ss->percentage =
     ...
     ss->rate = (__uint16_t)(__builtin_constant_p(ss_info->info.asSpreadSpectrum[i].usSpreadRateInKhz) ? (__uint16_t)(((__uint16_t)(ss_info->info.asSpreadSpectrum[i].usSpreadRateInKhz) & 0xffU) << 8 | ((__uint16_t)(ss_info->info.asSpreadSpectrum[i].usSpreadRateInKhz) & 0xff00U) >> 8) : __swap16md(ss_info->info.asSpreadSpectrum[i].usSpreadRateInKhz));
     return 1;
    }
   }
   break;
  ...
  case 3:
   ...
   for (i = 0; i < num_indices; i++) {
    if ((ss_info->info_3.asSpreadSpectrum[i].ucClockIndication == id) &&
        (clock <= (__uint32_t)(__builtin_constant_p(ss_info->info_3.asSpreadSpectrum[i].ulTargetClockRange) ? (__uint32_t)(((__uint32_t)(ss_info->info_3.asSpreadSpectrum[i].ulTargetClockRange) & 0xff) << 24 | ((__uint32_t)(ss_info->info_3.asSpreadSpectrum[i].ulTargetClockRange) & 0xff00) << 8 | ((__uint32_t)(ss_info->info_3.asSpreadSpectrum[i].ulTargetClockRange) & 0xff0000) >> 8 | ((__uint32_t)(ss_info->info_3.asSpreadSpectrum[i].ulTargetClockRange) & 0xff000000) >> 24) : __swap32md(ss_info->info_3.asSpreadSpectrum[i].ulTargetClockRange)))) {
     ss->percentage =
      (__uint16_t)(__builtin_constant_p(ss_info->info_3.asSpreadSpectrum[i].usSpreadSpectrumPercentage) ? (__uint16_t)(((__uint16_t)(ss_info->info_3.asSpreadSpectrum[i].usSpreadSpectrumPercentage) & 0xffU) << 8 | ((__uint16_t)(ss_info->info_3.asSpreadSpectrum[i].usSpreadSpectrumPercentage) & 0xff00U) >> 8) : __swap16md(ss_info->info_3.asSpreadSpectrum[i].usSpreadSpectrumPercentage));
    ...
    struct drm_display_mode *mode)
{
 ...
 case 1:
  ...
  if (misc & 0x100)
   mode->flags |= (1<<5);
  mode->clock = (__uint16_t)(__builtin_constant_p(tv_info->aModeTimings[index].usPixelClock) ? (__uint16_t)(((__uint16_t)(tv_info->aModeTimings[index].usPixelClock) & 0xffU) << 8 | ((__uint16_t)(tv_info->aModeTimings[index].usPixelClock) & 0xff00U) >> 8) : __swap16md(tv_info->aModeTimings[index].usPixelClock)) * 10;
  if (index == 1) {
   mode->crtc_htotal -= 1;
   mode->crtc_vtotal -= 1;
  }
 ...
 case 2:
  ...
  if (misc & 0x100)
   mode->flags |= (1<<5);
  mode->clock = (__uint16_t)(__builtin_constant_p(dtd_timings->usPixClk) ? (__uint16_t)(((__uint16_t)(dtd_timings->usPixClk) & 0xffU) << 8 | ((__uint16_t)(dtd_timings->usPixClk) & 0xff00U) >> 8) : __swap16md(dtd_timings->usPixClk)) * 10;
  break;
 }
 return 1;
}
