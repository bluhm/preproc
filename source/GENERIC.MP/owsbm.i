# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c"
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c"
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewiredevs.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/onewirereg.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c" 2
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/onewire/owsbm.c"
struct owsbm_softc {
 ...
 struct ksensor sc_voltage_vdd;
 struct ksensor sc_voltage_vad;
 struct ksensor sc_voltage_cr;
...
{
 return (onewire_matchbyfam(aux, owsbm_fams, (sizeof((owsbm_fams)) / sizeof((owsbm_fams)[0]))));
}
...
owsbm_update(void *arg)
{
 ...
 onewire_matchrom(sc->sc_onewire, sc->sc_rom);
 onewire_write_byte(sc->sc_onewire, 0xb4);
 if (onewire_reset(sc->sc_onewire) != 0)
  goto done;

 onewire_matchrom(sc->sc_onewire, sc->sc_rom);

 onewire_write_byte(sc->sc_onewire, 0xb8);
 ...
 if (onewire_crc(data, 8) == data[8]) {
  sc->sc_temp.value = 273150000 +
       (int)(((u_int16_t)data[2] << 5) |
       ((u_int16_t)data[1] >> 3)) * 31250;
  sc->sc_voltage_vdd.value =
       (int)(((u_int16_t)data[4] << 8) |
       data[3]) * 10000;

  sc->sc_voltage_cr.value =
      (int)(((u_int16_t)data[6] << 8) |
      data[5]) * 244;
 }
 ...
 onewire_matchrom(sc->sc_onewire, sc->sc_rom);
 onewire_write_byte(sc->sc_onewire, 0x4e);
 onewire_write_byte(sc->sc_onewire, 0);
 onewire_write_byte(sc->sc_onewire, 0x7);
 ...
 onewire_write_byte(sc->sc_onewire, 0x4e);
 onewire_write_byte(sc->sc_onewire, 0);
 onewire_write_byte(sc->sc_onewire, 0xf);
