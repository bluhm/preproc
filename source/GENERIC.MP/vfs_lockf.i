# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c" 2
...
int maxlockdepth = 50;
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
void
lf_init(void)
{
 pool_init(&lockfpool, sizeof(struct lockf), 0, 0, 0x0001,
     "lockfpl", ((void *)0));
}

struct lockf *lf_alloc(uid_t, int);
void lf_free(struct lockf *);
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
    ...
    struct flock *fl, int flags)
{
 ...
 lock = lf_alloc(p->p_ucred->cr_uid, op == 8 ? 1 : 2);
 if (!lock)
  return (77);
 lock->lf_start = start;
 lock->lf_end = end;
 ...
 lock->lf_next = ((void *)0);
 do { (&lock->lf_blkhd)->tqh_first = ((void *)0); (&lock->lf_blkhd)->tqh_last = &(&lock->lf_blkhd)->tqh_first; } while (0);
 lock->lf_flags = flags;
 lock->lf_pid = (flags & 0x040) ? p->p_p->ps_pid : -1;
...
lf_setlock(struct lockf *lock)
{
 ...
 while ((block = lf_getblock(lock)) != ((void *)0)) {
  if ((lock->lf_flags & 0x010) == 0) {
   lf_free(lock);
   return (35);
  }
# 248 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
  if ((lock->lf_flags & 0x040) &&
      (block->lf_flags & 0x040)) {
   struct proc *wproc;
  ...
  if ((lock->lf_flags & 0x020) && lock->lf_type == 3) {
   lock->lf_type = 2;
  ...
  do { (lock)->lf_block.tqe_next = ((void *)0); (lock)->lf_block.tqe_prev = (&block->lf_blkhd)->tqh_last; *(&block->lf_blkhd)->tqh_last = (lock); (&block->lf_blkhd)->tqh_last = &(lock)->lf_block.tqe_next; } while (0);
  error = tsleep(lock, priority, lockstr, 0);
  if (lock->lf_next != ((void *)0)) {
   do { if (((lock)->lf_block.tqe_next) != ((void *)0)) (lock)->lf_block.tqe_next->lf_block.tqe_prev = (lock)->lf_block.tqe_prev; else (&lock->lf_next->lf_blkhd)->tqh_last = (lock)->lf_block.tqe_prev; *(lock)->lf_block.tqe_prev = (lock)->lf_block.tqe_next; ((lock)->lf_block.tqe_prev) = ((void *)-1); ((lock)->lf_block.tqe_next) = ((void *)-1); } while (0);
   lock->lf_next = ((void *)0);
  }
  if (error) {
   lf_free(lock);
...
# 311 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
 prev = head;
 block = *head;
 needtolink = 1;
 for (;;) {
  ovcase = lf_findoverlap(block, lock, 0x1, &prev, &overlap);
  if (ovcase)
   block = overlap->lf_next;
# 327 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
  switch (ovcase) {
  case 0:
   if (needtolink) {
    *prev = lock;
  ...
  case 3:
   ...
   if (lock->lf_type == 1 &&
    ...
    while ((ltmp =
     ...
     ltmp->lf_next = lock;
     do { (ltmp)->lf_block.tqe_next = ((void *)0); (ltmp)->lf_block.tqe_prev = (&lock->lf_blkhd)->tqh_last; *(&lock->lf_blkhd)->tqh_last = (ltmp); (&lock->lf_blkhd)->tqh_last = &(ltmp)->lf_block.tqe_next; } while (0);
...
lf_clearlock(struct lockf *lock)
{
 ...
 prev = head;
 while ((ovcase = lf_findoverlap(lf, lock, 0x1, &prev, &overlap))) {
  lf_wakelock(overlap);
...
lf_getlock(struct lockf *lock, struct flock *fl)
{
 ...
 if ((block = lf_getblock(lock)) != ((void *)0)) {
...
lf_getblock(struct lockf *lock)
{
 ...
 prev = lock->lf_head;
 lf = *prev;
 while (lf_findoverlap(lf, lock, 0x2, &prev, &overlap) != 0) {



  if ((lock->lf_type == 3 || overlap->lf_type == 3))
   return (overlap);
...
# 544 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
int
 ...
 *overlap = lf;
 ...
 while (lf != ((void *)0)) {
  if (((type & 0x1) && lf->lf_id != lock->lf_id) ||
      ((type & 0x2) && lf->lf_id == lock->lf_id)) {
   *prev = &lf->lf_next;
   *overlap = lf = lf->lf_next;
   continue;
  }
# 582 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
  if ((lf->lf_end != -1 && start > lf->lf_end) ||
      (end != -1 && lf->lf_start > end)) {
   ;
   if ((type & 0x1) && end != -1 && lf->lf_start > end)
    return (0);
   *prev = &lf->lf_next;
   *overlap = lf = lf->lf_next;
   continue;
...
# 644 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_lockf.c"
 ...
 __builtin_memcpy((splitlock), (lock1), (sizeof(*splitlock)));
 splitlock->lf_start = lock2->lf_end + 1;
 splitlock->lf_block.tqe_next = ((void *)0);
 do { (&splitlock->lf_blkhd)->tqh_first = ((void *)0); (&splitlock->lf_blkhd)->tqh_last = &(&splitlock->lf_blkhd)->tqh_first; } while (0);
 lock1->lf_end = lock2->lf_start - 1;
...
lf_wakelock(struct lockf *lock)
{
 ...
 while ((wakelock = ((&lock->lf_blkhd)->tqh_first))) {
  do { if (((wakelock)->lf_block.tqe_next) != ((void *)0)) (wakelock)->lf_block.tqe_next->lf_block.tqe_prev = (wakelock)->lf_block.tqe_prev; else (&lock->lf_blkhd)->tqh_last = (wakelock)->lf_block.tqe_prev; *(wakelock)->lf_block.tqe_prev = (wakelock)->lf_block.tqe_next; ((wakelock)->lf_block.tqe_prev) = ((void *)-1); ((wakelock)->lf_block.tqe_next) = ((void *)-1); } while (0);
  wakelock->lf_next = ((void *)0);
  wakeup_n((wakelock), 1);
 }
}
