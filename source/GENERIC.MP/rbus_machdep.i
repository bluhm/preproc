# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/pccbbreg.h" 1
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c" 2

struct rbustag rbus_null;
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/sparc64/rbus_machdep.c"
rbus_tag_t
rbus_pccbb_parent_mem(struct device *self, struct pci_attach_args *pa)
{
 ...
 int naddr, len, i;
 int space, reg64;
 int node = (int)(((pa->pa_tag)>>32)&0xffffffff);
 char buf[32];


 if (OF_getprop(node, "name", &buf, sizeof(buf)) > 0 &&
     strcmp(buf, "pcma") == 0) {
  len = OF_getprop((int)(((pa->pa_tag)>>32)&0xffffffff), "assigned-addresses",
      &addr, sizeof(addr));
  naddr = len / sizeof(struct ofw_pci_register);

  for (i = 0; i < naddr; i++) {
   space = addr[i].phys_hi & 0x03000000;
   if (space != 0x02000000)
    continue;
   reg64 = addr[i].phys_hi & 0x000000ff;
   if (reg64 < 0x1C || reg64 > 0x38)
    continue;
    ...
    struct pci_attach_args *pa)
{
 ...
 bir = pci_conf_read(pc, pa->pa_tag, 0x18);
 if (((bir >> 8) & 0xff) != 0)
  return;
 ...
 bir &= ~0x0000ff00;
 bir |= (bus << 8);
 pci_conf_write(pc, pa->pa_tag, 0x18, bir);
}
