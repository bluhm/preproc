# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c"
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
void device_register(struct device *, void *);
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c" 2
...
ebus_mainbus_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 for (node = firstchild(node); node; node = nextsibling(node)) {
  if (ebus_setup_attach_args(sc, node, &eba) != 0) {
   ...
   (void)config_found_sm((self), (&eba), (ebus_print), ((void *)0));
  }
    ...
    int level, int flags, int (*handler)(void *), void *arg, const char *what)
{
 ...
 if ((cputyp == 5)) {
  struct upa_reg reg64;
  u_int64_t devhandle, devino = ((ihandle)&0x00000003fLL);
  u_int64_t sysino;
  int node = -1;
  int i, err;
  ...
  if (OF_getprop(node, "reg", &reg64, sizeof(reg64)) != sizeof(reg64))
   return (((void *)0));
  devhandle = (reg64.ur_paddr >> 32) & 0x0fffffff;

  err = hv_intr_devino_to_sysino(devhandle, devino, &sysino);
  if (err != 0)
   return (((void *)0));

  ((sysino == ((sysino)&(0x0000007c0LL|0x00000003fLL))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/ebus_mainbus.c", 271, "sysino == INTVEC(sysino)"));
 ...
 if ((flags & 0x0002) == 0) {
  struct pyro_softc *psc = ((void *)0);
  u_int64_t *imap, *iclr;
  int i;

  for (i = 0; i < pyro_cd.cd_ndevs; i++) {
   psc = pyro_cd.cd_devs[i];
   if (psc && psc->sc_ign == ((ihandle)&0x0000007c0LL)) {
    break;
   }
  }
  if (psc == ((void *)0))
