# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c"
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c"
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
int shmctl1(struct proc *, int, int, caddr_t,
     ...
     int (*)(const void *, void *, size_t));
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/mman.h" 1
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c" 2
...
# 92 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/sysv_shm.c"
...
shm_find_segment_by_key(key_t key)
{
 ...
 for (i = 0; i < shminfo.shmmni; i++) {
  shmseg = shmsegs[i];
  if (shmseg != ((void *)0) && shmseg->shm_perm.key == key)
   return (i);
 }
 return (-1);
}
...
shm_find_segment_by_shmid(int shmid)
{
 ...
 if (segnum < 0 || segnum >= shminfo.shmmni ||
     (shmseg = shmsegs[segnum]) == ((void *)0) ||
     shmseg->shm_perm.seq != (((shmid) >> 16) & 0xffff))
  return (((void *)0));
 return (shmseg);
}
...
shm_deallocate_segment(struct shmid_ds *shmseg)
{
 ...
 size = (((shmseg->shm_segsz) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
 uao_detach(shm_handle->shm_object);
 pool_put(&shm_pool, shmseg);
 shm_committed -= ((size) >> 13);
 shm_nused--;
}
...
shm_delete_mapping(struct vmspace *vm, struct shmmap_state *shmmap_s)
{
 ...
 if ((--shmseg->shm_nattch <= 0) &&
     (shmseg->shm_perm.mode & 0x0200)) {
  shm_deallocate_segment(shmseg);
  shm_last_free = segnum;
  shmsegs[shm_last_free] = ((void *)0);
 }
 return (0);
}
...
sys_shmdt(struct proc *p, void *v, register_t *retval)
{
 ...
 for (i = 0, shmmap_s = shmmap_h->state; i < shmmap_h->shmseg;
     i++, shmmap_s++)
  if (shmmap_s->shmid != -1 &&
      shmmap_s->va == (vaddr_t)((uap)->shmaddr.be.datum))
   break;
...
sys_shmat(struct proc *p, void *v, register_t *retval)
{
 ...
 if (shmmap_h == ((void *)0)) {
  ...
  shmmap_h = malloc(size, 29, 0x0001);
 ...
 shmseg = shm_find_segment_by_shmid(((uap)->shmid.be.datum));
 if (shmseg == ((void *)0))
  return (22);
 error = ipcperm(cred, &shmseg->shm_perm,
      (((uap)->shmflg.be.datum) & 010000) ? 000400 : 000400|000200);
 if (error)
  return (error);
 ...
 size = (((shmseg->shm_segsz) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
 prot = 0x01;
 if ((((uap)->shmflg.be.datum) & 010000) == 0)
  prot |= 0x02;
 if (((uap)->shmaddr.be.datum)) {
  flags |= 0x0010000;
 ...
 error = uvm_map(&p->p_vmspace->vm_map, &attach_va, size,
     shm_handle->shm_object, 0, 0, ((prot) | ((prot) << 8) | ((0) << 4) | ((1) << 12) | (flags)));
 ...
 shmmap_s->shmid = ((uap)->shmid.be.datum);
...
{
 struct sys_shmctl_args *uap = v;





 return (shmctl1(p, ((uap)->shmid.be.datum), ((uap)->cmd.be.datum),
    ...
    int (*ds_copyout)(const void *, void *, size_t))
{
 ...
 switch (cmd) {
 case 2:
  if ((error = ipcperm(cred, &shmseg->shm_perm, 000400)) != 0)
   return (error);
  ...
  break;
 case 1:
  if ((error = ipcperm(cred, &shmseg->shm_perm, 010000)) != 0)
   return (error);
  ...
  shmseg->shm_perm.mode =
      (shmseg->shm_perm.mode & ~(0000700|0000070|0000007)) |
      (inbuf.shm_perm.mode & (0000700|0000070|0000007));
  shmseg->shm_ctime = time_second;
  break;
 case 0:
  if ((error = ipcperm(cred, &shmseg->shm_perm, 010000)) != 0)
   return (error);
  shmseg->shm_perm.key = (key_t)0;
  shmseg->shm_perm.mode |= 0x0200;
  if (shmseg->shm_nattch <= 0) {
   shm_deallocate_segment(shmseg);
   shm_last_free = ((shmid) & 0xffff);
   shmsegs[shm_last_free] = ((void *)0);
  }
  break;
 case 3:
 ...
 int mode, int segnum, register_t *retval)
{
 ...
 if ((error = ipcperm(cred, &shmseg->shm_perm, mode)) != 0)
  return (error);
 if (((uap)->size.be.datum) && ((uap)->size.be.datum) > shmseg->shm_segsz)
  return (22);
 if ((((uap)->shmflg.be.datum) & (001000 | 002000)) ==
     (001000 | 002000))
  return (17);
 *retval = (((shmseg->shm_perm.seq) << 16) | (segnum & 0xffff));
 return (0);
}
 ...
 int mode, register_t *retval)
{
 ...
 if (((uap)->size.be.datum) < shminfo.shmmin ||
     ((uap)->size.be.datum) > shminfo.shmmax)
  return (22);
 if (shm_nused >= shminfo.shmmni)
  return (28);
 size = (((((uap)->size.be.datum)) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
 if (shm_committed + ((size) >> 13) > shminfo.shmall)
  return (12);
 shm_nused++;
 shm_committed += ((size) >> 13);
 ...
 key = ((uap)->key.be.datum);
 shmseg = pool_get(&shm_pool, key == (key_t)0 ? 0x0001 :
     0x0002);
 if (shmseg == ((void *)0)) {
  shmseg = pool_get(&shm_pool, 0x0001);
 ...
 shmseg->shm_perm.mode = (mode & (0000700|0000070|0000007));
 shmseg->shm_perm.seq = shmseqs[segnum] = (shmseqs[segnum] + 1) & 0x7fff;
 shmseg->shm_perm.key = key;
 shmseg->shm_segsz = ((uap)->size.be.datum);
...
sys_shmget(struct proc *p, void *v, register_t *retval)
{
 ...
 mode = ((uap)->shmflg.be.datum) & (0000700|0000070|0000007);

 if (((uap)->key.be.datum) != (key_t)0) {
 again:
  segnum = shm_find_segment_by_key(((uap)->key.be.datum));
  if (segnum >= 0)
   return (shmget_existing(p, uap, mode, segnum, retval));
  if ((((uap)->shmflg.be.datum) & 001000) == 0)
   return (2);
 }
...
shmfork(struct vmspace *vm1, struct vmspace *vm2)
{
 ...
 vm2->vm_shm = malloc(size, 29, 0x0001);
 __builtin_memcpy((vm2->vm_shm), (vm1->vm_shm), (size));
 for (i = 0, shmmap_s = shmmap_h->state; i < shmmap_h->shmseg;
     i++, shmmap_s++) {
  if (shmmap_s->shmid != -1 &&
      (shmseg = shmsegs[((shmmap_s->shmid) & 0xffff)]) != ((void *)0))
   shmseg->shm_nattch++;
 }
}
 ...
 void *newp, size_t newlen)
{
 ...
 case 1:
  if ((error = sysctl_int(oldp, oldlenp, newp, newlen,
      &shminfo.shmmax)) || newp == ((void *)0))
   return (error);


  if ((((((shminfo.shmmax) + ((1 << 13) - 1)) & ~((1 << 13) - 1))) >> 13) > shminfo.shmall)
   shminfo.shmall = (((((shminfo.shmmax) + ((1 << 13) - 1)) & ~((1 << 13) - 1))) >> 13);
  return (0);
 case 2:
  val = shminfo.shmmin;
 ...
 case 3:
  ...
  newsegs = mallocarray(val, sizeof(struct shmid_ds *),
      29, 0x0001|0x0008);
  __builtin_memcpy((newsegs), (shmsegs), (shminfo.shmmni * sizeof(struct shmid_ds *)));

  free(shmsegs, 29, 0);
  shmsegs = newsegs;
  newseqs = mallocarray(val, sizeof(unsigned short), 29,
      0x0001|0x0008);
  __builtin_memcpy((newseqs), (shmseqs), (shminfo.shmmni * sizeof(unsigned short)));

  free(shmseqs, 29, shminfo.shmmni * sizeof(unsigned short));
  shmseqs = newseqs;
  shminfo.shmmni = val;
  return (0);
 case 4:
