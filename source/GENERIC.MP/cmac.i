# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/cmac.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/cmac.c"
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/cmac.c"
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/cmac.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/cmac.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/cmac.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/cmac.c" 2
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../crypto/cmac.c"
void
AES_CMAC_Init(AES_CMAC_CTX *ctx)
{
 __builtin_memset((ctx->X), (0), (sizeof ctx->X));
 ctx->M_n = 0;
}

void
AES_CMAC_SetKey(AES_CMAC_CTX *ctx, const u_int8_t key[16])
{
...
AES_CMAC_Update(AES_CMAC_CTX *ctx, const u_int8_t *data, u_int len)
{
 ...
 if (ctx->M_n > 0) {
  ...
  __builtin_memcpy((ctx->M_last + ctx->M_n), (data), (mlen));
  ctx->M_n += mlen;
  if (ctx->M_n < 16 || len == mlen)
   return;
  do { int i; for (i = 0; i < 16; i++) (ctx->X)[i] ^= (ctx->M_last)[i]; } while (0);
  AES_Encrypt(&ctx->aesctx, ctx->X, ctx->X);
  data += mlen;
  len -= mlen;
 }
 while (len > 16) {
  do { int i; for (i = 0; i < 16; i++) (ctx->X)[i] ^= (data)[i]; } while (0);
  AES_Encrypt(&ctx->aesctx, ctx->X, ctx->X);
  data += 16;
  len -= 16;
 }

 __builtin_memcpy((ctx->M_last), (data), (len));
 ctx->M_n = len;
}

void
AES_CMAC_Final(u_int8_t digest[16], AES_CMAC_CTX *ctx)
{
 u_int8_t K[16];
 ...
 if (ctx->M_n == 16) {
  ...
  do { int i; for (i = 0; i < 16; i++) (ctx->M_last)[i] ^= (K)[i]; } while (0);
 } else {
