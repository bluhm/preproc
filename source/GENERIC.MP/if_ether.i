# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c"
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/carp.h" 1
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_types.h" 1
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
void pipexintr(void);
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
int carp_lsdrop(struct mbuf *, sa_family_t, u_int32_t *,
       u_int32_t *, int);
# 65 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c" 2
...
arp_rtrequest(struct ifnet *ifp, int req, struct rtentry *rt)
{
 ...
 if (((rt->rt_flags) & (0x2|0x400000|0x200)))
  return;
 ...
 case 0x1:
  ...
  if (rt->rt_flags & (0x4000|0x200000))
   arprequest(ifp,
       &satosin(((rt)->rt_dest))->sin_addr.s_addr,
       &satosin(((rt)->rt_dest))->sin_addr.s_addr,
       (u_char *)((caddr_t)((satosdl(gate))->sdl_data + (satosdl(gate))->sdl_nlen)));
 ...
 case 0xb:
  ...
  la = pool_get(&arp_pool, 0x0002 | 0x0008);
  ...
  la->la_rt = rt;
  rt->rt_flags |= 0x400;
  do { if (((la)->la_list.le_next = (&arp_list)->lh_first) != ((void *)0)) (&arp_list)->lh_first->la_list.le_prev = &(la)->la_list.le_next; (&arp_list)->lh_first = (la); (la)->la_list.le_prev = &(&arp_list)->lh_first; } while (0);
 ...
 case 0x2:
  if (la == ((void *)0))
   break;
  do { if ((la)->la_list.le_next != ((void *)0)) (la)->la_list.le_next->la_list.le_prev = (la)->la_list.le_prev; *(la)->la_list.le_prev = (la)->la_list.le_next; ((la)->la_list.le_prev) = ((void *)-1); ((la)->la_list.le_next) = ((void *)-1); } while (0);
  rt->rt_llinfo = ((void *)0);
  rt->rt_flags &= ~0x400;
...
arprequest(struct ifnet *ifp, u_int32_t *sip, u_int32_t *tip, u_int8_t *enaddr)
{
 ...
 __builtin_memset((ea), (0), (sizeof(*ea)));
 __builtin_memcpy((eh->ether_dhost), (etherbroadcastaddr), (sizeof(eh->ether_dhost)));
 eh->ether_type = ((__uint16_t)(0x0806));
 ea->ea_hdr.ar_hrd = ((__uint16_t)(1));
 ea->ea_hdr.ar_pro = ((__uint16_t)(0x0800));
 ea->ea_hdr.ar_hln = sizeof(ea->arp_sha);
 ea->ea_hdr.ar_pln = sizeof(ea->arp_spa);
 ea->ea_hdr.ar_op = ((__uint16_t)(1));
 __builtin_memcpy((eh->ether_shost), (enaddr), (sizeof(eh->ether_shost)));
 __builtin_memcpy((ea->arp_sha), (enaddr), (sizeof(ea->arp_sha)));
 __builtin_memcpy((ea->arp_spa), (sip), (sizeof(ea->arp_spa)));
 __builtin_memcpy((ea->arp_tpa), (tip), (sizeof(ea->arp_tpa)));
 sa.sa_family = 31;
 sa.sa_len = sizeof(sa);
...
arpreply(struct ifnet *ifp, struct mbuf *m, struct in_addr *sip, uint8_t *eaddr)
{
 ...
 __builtin_memcpy((ea->arp_tha), (ea->arp_sha), (sizeof(ea->arp_sha)));
 __builtin_memcpy((ea->arp_tpa), (ea->arp_spa), (sizeof(ea->arp_spa)));

 __builtin_memcpy((ea->arp_sha), (eaddr), (sizeof(ea->arp_sha)));
 __builtin_memcpy((ea->arp_spa), (sip), (sizeof(ea->arp_spa)));

 eh = (struct ether_header *)sa.sa_data;
 __builtin_memcpy((eh->ether_dhost), (ea->arp_tha), (sizeof(eh->ether_dhost)));
 __builtin_memcpy((eh->ether_shost), (eaddr), (sizeof(eh->ether_shost)));
 eh->ether_type = ((__uint16_t)(0x0806));
 sa.sa_family = 31;
 sa.sa_len = sizeof(sa);
 ifp->if_output(ifp, m, &sa, ((void *)0));
}
# 307 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c"
int
arpresolve(struct ifnet *ifp, struct rtentry *rt0, struct mbuf *m,
    struct sockaddr *dst, u_char *desten)
{
 struct arpcom *ac = (struct arpcom *)ifp;
 struct llinfo_arp *la = ((void *)0);
 struct sockaddr_dl *sdl;
 struct rtentry *rt = ((void *)0);
 char addr[16];

 if (m->m_hdr.mh_flags & 0x0100) {
  __builtin_memcpy((desten), (etherbroadcastaddr), (sizeof(etherbroadcastaddr)));
  return (0);
 }
 if (m->m_hdr.mh_flags & 0x0200) {
  do { (desten)[0] = 0x01; (desten)[1] = 0x00; (desten)[2] = 0x5e; (desten)[3] = ((u_int8_t *)&satosin(dst)->sin_addr)[1] & 0x7f; (desten)[4] = ((u_int8_t *)&satosin(dst)->sin_addr)[2]; (desten)[5] = ((u_int8_t *)&satosin(dst)->sin_addr)[3]; } while ( 0);
  return (0);
 }
 ...
 if (!((rt->rt_flags) & (0x400))) {
  log(7, "%s: %s: route contains no arp information\n",
      __func__, inet_ntop(2, &satosin(((rt)->rt_dest))->sin_addr,
      addr, sizeof(addr)));
  m_freem(m);
  return (22);
 }
 ...
 if (sdl->sdl_alen > 0 && sdl->sdl_alen != 6) {
  log(7, "%s: %s: incorrect arp information\n", __func__,
      inet_ntop(2, &satosin(dst)->sin_addr,
   addr, sizeof(addr)));
  goto bad;
 }
 ...
 if ((rt->rt_rmx.rmx_expire == 0 || rt->rt_rmx.rmx_expire > time_uptime) &&
     sdl->sdl_family == 18 && sdl->sdl_alen != 0) {
 ...
 if (rt->rt_rmx.rmx_expire) {
  rt->rt_flags &= ~0x8;
  if (la->la_asked == 0 || rt->rt_rmx.rmx_expire != time_uptime) {
   rt->rt_rmx.rmx_expire = time_uptime;
   if (la->la_asked++ < arp_maxtries)
    ...
    rt->rt_flags |= 0x8;
    rt->rt_rmx.rmx_expire += arpt_down;
    la->la_asked = 0;
    la_hold_total -= ml_purge(&la->la_ml);
   }
  }
...
in_arpinput(struct ifnet *ifp, struct mbuf *m)
{
 ...
 rdomain = rtable_l2(m->M_dat.MH.MH_pkthdr.ph_rtableid);

 ea = ((struct ether_arp *)((m)->m_hdr.mh_data));
 op = ((__uint16_t)(ea->ea_hdr.ar_op));
 if ((op != 1) && (op != 2))
  goto out;

 __builtin_memcpy((&itaddr), (ea->arp_tpa), (sizeof(itaddr)));
 __builtin_memcpy((&isaddr), (ea->arp_spa), (sizeof(isaddr)));
 __builtin_memset((&sin), (0), (sizeof(sin)));
 sin.sin_len = sizeof(sin);
 sin.sin_family = 2;

 if ((*(&ea->arp_sha[0]) & 0x01) &&
     !__builtin_memcmp((ea->arp_sha), (etherbroadcastaddr), (sizeof(ea->arp_sha)))) {
  inet_ntop(2, &isaddr, addr, sizeof(addr));
  log(3, "arp: ether address is broadcast for IP address "
      "%s!\n", addr);
  goto out;
 }

 if (!__builtin_memcmp((ea->arp_sha), (((caddr_t)((ifp->if_sadl)->sdl_data + (ifp->if_sadl)->sdl_nlen))), (sizeof(ea->arp_sha))))
  goto out;
 ...
 if (target && op == 1 && ifp->if_data.ifi_type == 0xf7 &&
     !carp_iamatch(ifp))
  goto out;
 ...
 if (rtisvalid(rt) && ((rt->rt_flags) & (0x200000)) &&
     rt->rt_ifidx == ifp->if_index && isaddr.s_addr != ((u_int32_t) ((__uint32_t)((u_int32_t)(0x00000000))))) {
  inet_ntop(2, &isaddr, addr, sizeof(addr));
  log(3, "duplicate IP address %s sent from ethernet "
      "address %s\n", addr, ether_sprintf(ea->arp_sha));
  itaddr = isaddr;
 } else if (rt != ((void *)0)) {
  int error;

  _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c", 543);
 ...
 if (op == 1) {
  ...
  if (target) {
   ...
   eaddr = ((caddr_t)((ifp->if_sadl)->sdl_data + (ifp->if_sadl)->sdl_nlen));
  } else {
   rtfree(rt);
   rt = arplookup(&itaddr, 0, 1, rdomain);




   if ((rt == ((void *)0)) || (rt->rt_ifidx != ifp->if_index))
    goto out;
...
arpcache(struct ifnet *ifp, struct ether_arp *ea, struct rtentry *rt)
{
 ...
 ((_kernel_lock_held()) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c", 588, "_kernel_lock_held()"));
 ((sdl != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c", 589, "sdl != NULL"));
 ...
 if (sdl->sdl_alen > 0) {
  if (__builtin_memcmp((ea->arp_sha), (((caddr_t)((sdl)->sdl_data + (sdl)->sdl_nlen))), (sdl->sdl_alen))) {
   if (((rt->rt_flags) & (0x2000|0x200000))) {
    inet_ntop(2, spa, addr, sizeof(addr));
    log(4, "arp: attempt to overwrite "
...

    {
     ...
     if (rifp == ((void *)0))
      return (-1);
     inet_ntop(2, spa, addr,
         sizeof(addr));
     log(4, "arp: attempt to "
    ...
    inet_ntop(2, spa, addr, sizeof(addr));
    log(6, "arp info overwritten for %s by "
        "%s on %s\n", addr,
        ether_sprintf(ea->arp_sha), ifp->if_xname);
    rt->rt_rmx.rmx_expire = 1;
   }
   changed = 1;
  }
  ...
  if (rifp == ((void *)0))
   return (-1);
  inet_ntop(2, spa, addr, sizeof(addr));
  log(4, "arp: attempt to add entry for %s on %s by %s"
      " on %s\n", addr, rifp->if_xname,
      ether_sprintf(ea->arp_sha), ifp->if_xname);
  if_put(rifp);
  return (-1);
 ...
 __builtin_memcpy((((caddr_t)((sdl)->sdl_data + (sdl)->sdl_nlen))), (ea->arp_sha), (sizeof(ea->arp_sha)));
 if (rt->rt_rmx.rmx_expire)
 ...
 if (la->la_asked || changed) {
  _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c", 652);
  rtm_send(rt, 0xb, ifp->if_data.ifi_rdomain);
  _kernel_unlock();
 }

 la->la_asked = 0;
 while ((len = ((&la->la_ml)->ml_len)) != 0) {
  struct mbuf *mh;

  mh = ml_dequeue(&la->la_ml);
  la_hold_total--;

  ifp->if_output(ifp, mh, ((rt)->rt_dest), rt);

  if (((&la->la_ml)->ml_len) == len) {

   while ((mh = ml_dequeue(&la->la_ml)) != ((void *)0)) {
    la_hold_total--;
    m_freem(mh);
   }
   break;
...
arplookup(struct in_addr *inp, int create, int proxy, u_int tableid)
{
 ...
 if (proxy && !((rt->rt_flags) & (0x4000))) {

  while ((rt = rtable_iterate(rt)) != ((void *)0)) {
   if (((rt->rt_flags) & (0x4000))) {
    break;
   }
  }
...
arpproxy(struct in_addr in, unsigned int rtableid)
{
 ...
 if (!__builtin_memcmp((((caddr_t)((sdl)->sdl_data + (sdl)->sdl_nlen))), (((caddr_t)((ifp->if_sadl)->sdl_data + (ifp->if_sadl)->sdl_nlen))), (sdl->sdl_alen)))
  found = 1;
...
# 825 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet/if_ether.c"
void
in_revarpinput(struct ifnet *ifp, struct mbuf *m)
{
 ...
 ar = ((struct ether_arp *)((m)->m_hdr.mh_data));
 op = ((__uint16_t)(ar->ea_hdr.ar_op));
 switch (op) {
 case 1:
 case 2:
  niq_enqueue(&arpinq, m);
 ...
 if (revarp_ifidx == 0)
  goto out;
 if (revarp_ifidx != m->M_dat.MH.MH_pkthdr.ph_ifidx)
  goto out;
 if (revarp_finished)
  goto wake;
 if (__builtin_memcmp((ar->arp_tha), (((caddr_t)((ifp->if_sadl)->sdl_data + (ifp->if_sadl)->sdl_nlen))), (sizeof(ar->arp_tha))))
  goto out;
 __builtin_memcpy((&revarp_srvip), (ar->arp_spa), (sizeof(revarp_srvip)));
 __builtin_memcpy((&revarp_myip), (ar->arp_tpa), (sizeof(revarp_myip)));
 revarp_finished = 1;
wake:
...
revarprequest(struct ifnet *ifp)
{
 ...
 ea->ea_hdr.ar_hln = sizeof(ea->arp_sha);
 ea->ea_hdr.ar_pln = sizeof(ea->arp_spa);
 ea->ea_hdr.ar_op = ((__uint16_t)(3));
 __builtin_memcpy((eh->ether_shost), (ac->ac_enaddr), (sizeof(ea->arp_tha)));
 __builtin_memcpy((ea->arp_sha), (ac->ac_enaddr), (sizeof(ea->arp_sha)));
 __builtin_memcpy((ea->arp_tha), (ac->ac_enaddr), (sizeof(ea->arp_tha)));
 sa.sa_family = 31;
 sa.sa_len = sizeof(sa);
 m->m_hdr.mh_flags |= 0x0100;
 ifp->if_output(ifp, m, &sa, ((void *)0));
    ...
    struct in_addr *clnt_in)
{
 ...
 while (count--) {
  revarprequest(ifp);
  result = tsleep((caddr_t)&revarp_myip, 24, "revarp", hz/2);
  if (result != 35)
   break;
 }
 revarp_ifidx = 0;
 ...
 __builtin_memcpy((serv_in), (&revarp_srvip), (sizeof(*serv_in)));
 __builtin_memcpy((clnt_in), (&revarp_myip), (sizeof(*clnt_in)));
 return 0;
}
