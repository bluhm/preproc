# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1025.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1025.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1025.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1025.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1025.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1025.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1025.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1025.c" 2
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/i2c/adm1025.c"
struct admtm_softc {
 struct device sc_dev;
 i2c_tag_t sc_tag;
 i2c_addr_t sc_addr;

 struct ksensor sc_sensor[8 + 3];
...
admtm_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 strlcpy(sc->sc_sensor[4].desc, "3.3 V",
 ...
 strlcpy(sc->sc_sensor[7].desc, "Vcc",
     sizeof(sc->sc_sensor[7].desc));

 sc->sc_sensor[8].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[8].desc, "1.5 V",
     sizeof(sc->sc_sensor[8].desc));

 sc->sc_sensor[9].type = SENSOR_VOLTS_DC;
 strlcpy(sc->sc_sensor[9].desc, "1.8 V",
     sizeof(sc->sc_sensor[9].desc));

 sc->sc_sensor[10].type = SENSOR_TEMP;
 strlcpy(sc->sc_sensor[10].desc, "External",
     sizeof(sc->sc_sensor[10].desc));

 if (sensor_task_register(sc, admtm_refresh, 5) == ((void *)0)) {
...
admtm_refresh(void *arg)
{
 ...
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[7].value = 2249000 * data / 192;
 ...
 if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
     sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
  sc->sc_sensor[7].value = 3300000 * data / 192;

 if (sc->sc_model == 192) {
  cmd = 0x50;
  if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
      sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
   sc->sc_sensor[8].value = 1500000 * data / 192;

  cmd = 0x51;
  if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
      sc->sc_addr, &cmd, sizeof cmd, &data, sizeof data, 0) == 0)
   sc->sc_sensor[9].value = 1800000 * data / 192;

  cmd = 0x52;
  if (iic_exec(sc->sc_tag, I2C_OP_READ_WITH_STOP,
      sc->sc_addr, &cmd, sizeof cmd, &sdata, sizeof sdata,
      0) == 0)
   sc->sc_sensor[10].value = 273150000 + 1000000 * sdata;
