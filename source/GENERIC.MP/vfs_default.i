# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c"
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c"
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c" 2
...
vop_generic_revoke(void *v)
{
 ...
 if ((ap->a_flags & 0x0001) == 0)
  panic("vop_generic_revoke");


 vp = ap->a_vp;

 while (vp->v_type == VBLK && vp->v_un.vu_specinfo != ((void *)0) &&
     vp->v_un.vu_specinfo->si_mountpoint != ((void *)0)) {
  struct mount *mp = vp->v_un.vu_specinfo->si_mountpoint;
  ...
  if (!vfs_busy(mp, 0x02|0x08)) {
   dounmount(mp, 0x00080000 | 0x08000000, p);
   break;
  }
 }
 ...
 if (vp->v_flag & 0x0800) {
  ...
  if (vp->v_flag & 0x0100) {
   vp->v_flag |= 0x0200;
   tsleep(vp, 8, "vop_generic_revokeall", 0);
...
vop_generic_abortop(void *v)
{
 ...
 if ((ap->a_cnp->cn_flags & (0x000400 | 0x001000)) == 0x000400)
  pool_put(&namei_pool, ap->a_cnp->cn_pnbuf);

 return (0);
}
# 165 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_default.c"
int
...
struct filterops generic_filtops =
 { 1, ((void *)0), filt_generic_detach, filt_generic_readwrite };
