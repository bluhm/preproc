# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umass_quirks.c" 2
...
umass_lookup(u_int16_t vendor, u_int16_t product)
{
 return ((const struct umass_quirk *)
  usbd_match_device((const struct usb_devno *)(umass_quirks), sizeof (umass_quirks) / sizeof ((umass_quirks)[0]), sizeof ((umass_quirks)[0]), (vendor), (product)));
}
...
umass_init_shuttle(struct umass_softc *sc)
{
 ...
 ((req.wLength)[0] = (u_int8_t)(sizeof(status)), (req.wLength)[1] = (u_int8_t)((sizeof(status)) >> 8));
...
umass_fixup_sony(struct umass_softc *sc)
{
 ...
 if (id->bInterfaceSubClass == 0xff) {
  ...
  switch (((dd->bcdDevice)[0] | ((dd->bcdDevice)[1] << 8))) {
  case 0x611:
  case 0x600:
  case 0x500:
   sc->sc_cmd = 3;
...
umass_fixup_yedata(struct umass_softc *sc)
{
 ...
 if (((dd->bcdDevice)[0] | ((dd->bcdDevice)[1] << 8)) < 0x128)
  sc->sc_wire = 2;
 else
  sc->sc_wire = 3;
}
