# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c" 2
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
struct uvm_pseg {
...
struct uvm_pseg psegs[((16 * 1024 * 1024) / 16 / (64 * 1024))];
...
# 116 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
void
uvm_pseg_init(struct uvm_pseg *pseg)
{
 ((pseg->start == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c", 119, "pseg->start == 0"));
 ((pseg->use == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c", 120, "pseg->use == 0"));
 pseg->start = uvm_km_valloc_try(kernel_map, 16 * (64 * 1024));
}
# 131 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
vaddr_t
...
pager_seg_restart:
 ...
 for (pseg = &psegs[0]; pseg != &psegs[((16 * 1024 * 1024) / 16 / (64 * 1024))]; pseg++) {
  ...
  if (pseg == &psegs[0] && (__curcpu->ci_self)->ci_curproc != uvm.pagedaemon_proc)
   i = 1;
  else
   i = 0;
...
# 184 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
void
uvm_pseg_release(vaddr_t segaddr)
{
 ...
 for (pseg = &psegs[0]; pseg != &psegs[((16 * 1024 * 1024) / 16 / (64 * 1024))]; pseg++) {
  if (pseg->start <= segaddr &&
      segaddr < pseg->start + 16 * (64 * 1024))
   break;
 }
 ((pseg != &psegs[((16 * 1024 * 1024) / 16 / (64 * 1024))]) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c", 196, "pseg != &psegs[PSEG_NUMSEGS]"));
...
uvm_pagermapin(struct vm_page **pps, int npages, int flags)
{
 ...
 if (flags & 0x02)
  prot |= 0x02;
 size = ((paddr_t)(npages) << 13);

 ((size <= (64 * 1024)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c", 241, "size <= MAXBSIZE"));

 kva = uvm_pseg_get(flags);
 if (kva == 0)
  return 0;

 for (cva = kva ; size != 0 ; size -= (1 << 13), cva += (1 << 13)) {
  pp = *pps++;
  ((pp) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c", 249, "pp"));
  ((pp->pg_flags & 0x00000001) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c", 250, "pp->pg_flags & PG_BUSY"));

  if (pmap_enter((&kernel_pmap_), cva, ((pp)->phys_addr),
      prot, 0x00000010 | 0x00000020 | prot) != 0) {
   pmap_remove((&kernel_pmap_), kva, cva);
   ;
...
uvm_pagermapout(vaddr_t kva, int npages)
{
 ...
 pmap_remove((&kernel_pmap_), kva, kva + ((vsize_t)npages << 13));
 ;
 uvm_pseg_release(kva);

}
# 303 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
struct vm_page **
...
# 319 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
 ...
 center_idx = (center->offset - lo) >> 13;
 pps[center_idx] = center;
 ppsp = &pps[center_idx];
 *npages = 1;
# 347 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
 for (forward = 0 ; forward <= 1 ; forward++) {
  incr = forward ? (1 << 13) : -(1 << 13);
  curoff = center->offset + incr;
  for ( ;(forward == 0 && curoff >= lo) ||
         (forward && curoff < hi);
        curoff += incr) {

   pclust = uvm_pagelookup(uobj, curoff);
   if (pclust == ((void *)0)) {
    break;
   }


   if ((pclust->pg_flags & 0x00020000) == 0) {
    if ((flags & 0x020) == 0) {
    ...
    if ((pclust->pg_flags & 0x00000010) == 0) {
     if ((pclust->pg_flags & (0x00000008|0x00000001))
        == 0x00000008 &&
   ...
   if ((pclust->pg_flags & (0x00000008|0x00000001)) != 0) {
    break;
   }


   atomic_setbits_int(&pclust->pg_flags, 0x00000001);
   ;
   ...
   if ((flags & (0x008|0x002)) == 0x008)
    atomic_setbits_int(&pclust->pg_flags,
        0x00000020);


   pmap_page_protect(pclust, 0x01);
   if (!forward) {
    ppsp--;
    *ppsp = pclust;
   } else {
...
# 449 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
int
...
# 487 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
  swblk = start;
...
# 518 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
 if (result == 3 || result == 0) {
  if (result == 0 && (flags & 0x080)) {

   if (*npages > 1 || pg == ((void *)0))
 ...
 if (*npages > 1 || pg == ((void *)0)) {
  uvm_pager_dropcluster(uobj, pg, ppsp, npages, 0x100);
  ...
  if (uobj == ((void *)0) && pg != ((void *)0)) {

   int nswblk = (result == 5) ? swblk : 0;
...
# 609 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
void
    ...
    struct vm_page **ppsp, int *npages, int flags)
{
 ...
 for (lcv = 0 ; lcv < *npages ; lcv++) {
  ...
  if (ppsp[lcv] == pg || ppsp[lcv] == ((void *)0))
   continue;
  ...
  if (!uobj) {
   if (ppsp[lcv]->pg_flags & 0x00100000) {
    if (flags & 0x100)
    ...
    if (flags & 0x100)
     uao_set_swslot(ppsp[lcv]->uobject,
         ppsp[lcv]->offset >> 13, 0);
   }
  }


  if (ppsp[lcv]->pg_flags & 0x00000002) {
   wakeup(ppsp[lcv]);
  }


  if (ppsp[lcv]->pg_flags & 0x00000020 &&
      ppsp[lcv]->pg_flags & 0x00100000) {
   ...
   atomic_clearbits_int(&ppsp[lcv]->pg_flags,
       0x00000001|0x00000002|0x00000040|0x00000020);
   ;
  }
  ...
  if (flags & 0x080) {
   ...
   atomic_setbits_int(&ppsp[lcv]->pg_flags, 0x00000008);
  }
 }
}
# 684 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c"
void
...
{
 int npages = bp->b_bufsize >> 13;
 struct vm_page *pg, *pgs[(64 * 1024) >> 13];
 struct uvm_object *uobj;
 int i, error;
 boolean_t write, swap;

 ((npages <= (64 * 1024) >> 13) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c", 711, "npages <= MAXPHYS >> PAGE_SHIFT"));
 do { if (splassert_ctl > 0) { splassert_check(5, __func__); } } while (0);

 error = (bp->b_flags & 0x00000400) ? (bp->b_error ? bp->b_error : 5) : 0;
 write = (bp->b_flags & 0x00008000) == 0;
 ...
 for (i = 0; i < npages; i++) {
  ...
  if (i == 0) {
   swap = (pg->pg_flags & (0x00100000|0x00200000)) != 0;
   if (!swap) {
    uobj = pg->uobject;
   }
  }
  ((swap || pg->uobject == uobj) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c", 740, "swap || pg->uobject == uobj"));
  ...
  if (!write && error) {
   atomic_setbits_int(&pg->pg_flags, 0x00000020);
   continue;
  }
  ((!write || (pgs[i]->pg_flags & 0x00000040) == 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pager.c", 750, "!write || (pgs[i]->pg_flags & PG_FAKE) == 0"));
  ...
  if ((pgs[i]->pg_flags & 0x00000040) || (write && error != 12)) {
   pmap_clear_reference(pgs[i]);
   pmap_clear_modify(pgs[i]);
   atomic_setbits_int(&pgs[i]->pg_flags, 0x00000008);
   atomic_clearbits_int(&pgs[i]->pg_flags, 0x00000040);
  }
 }
