# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c" 2
...
int drm_mode_atomic_ioctl(struct drm_device *dev,
     void *data, struct drm_file *file_priv);
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c" 2
...
;
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
struct drm_display_mode *drm_mode_create(struct drm_device *dev)
{
 struct drm_display_mode *nmode;

 nmode = kzalloc(sizeof(struct drm_display_mode), (0x0001 | 0x0004));
 if (!nmode)
  return ((void *)0);

 if (drm_mode_object_get(dev, &nmode->base, 0xdededede)) {
  kfree(nmode);
  return ((void *)0);
 }
...
;
# 100 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
void drm_mode_destroy(struct drm_device *dev, struct drm_display_mode *mode)
{
 if (!mode)
  return;
...
;
# 120 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
void drm_mode_probed_add(struct drm_connector *connector,
    struct drm_display_mode *mode)
{
 ({ int __ret = !!(!(rw_status(&connector->dev->mode_config.mutex) == 0x0001UL)); if (__ret) printf("WARNING %s failed at %s:%d\n", "!(rw_status(&connector->dev->mode_config.mutex) == 0x0001UL)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c", 123); __builtin_expect(!!(__ret), 0); });

 list_add_tail(&mode->head, &connector->probed_modes);
}
;
# 153 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
struct drm_display_mode *drm_cvt_mode(struct drm_device *dev, int hdisplay,
          int vdisplay, int vrefresh,
          _Bool reduced, _Bool interlaced, _Bool margins)
{
# 168 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
...
# 277 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
...
# 305 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
  int vbilines;
  int tmp1, tmp2;
 ...
 drm_mode->clock = drm_mode->htotal * 1000 * 1000 / hperiod;
...
;
# 371 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
struct drm_display_mode *
drm_gtf_mode_complex(struct drm_device *dev, int hdisplay, int vdisplay,
       int vrefresh, _Bool interlaced, int margins,
       int GTF_M, int GTF_2C, int GTF_K, int GTF_2J)
{
# 390 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
 struct drm_display_mode *drm_mode;
 ...
 if (GTF_M == 600 && GTF_2C == 80 && GTF_K == 128 && GTF_2J == 40)
  drm_mode->flags = (1<<1) | (1<<2);
 else
  drm_mode->flags = (1<<0) | (1<<3);

 return drm_mode;
}
;
# 570 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
struct drm_display_mode *
...
;
# 705 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
void drm_mode_set_name(struct drm_display_mode *mode)
{
 _Bool interlaced = !!(mode->flags & (1<<4));

 snprintf(mode->name, 32, "%dx%d%s",
   mode->hdisplay, mode->vdisplay,
   interlaced ? "i" : "");
}
;
# 722 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
int drm_mode_hsync(const struct drm_display_mode *mode)
{
...
;
# 748 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
int drm_mode_vrefresh(const struct drm_display_mode *mode)
{
 int refresh = 0;
 unsigned int calc_val;
...
;
# 789 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
void drm_mode_set_crtcinfo(struct drm_display_mode *p, int adjust_flags)
{
 if ((p == ((void *)0)) || ((p->type & ((1<<2) | (1<<0))) == (1<<0)))
  return;
...
;
# 861 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
...
;
# 883 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
struct drm_display_mode *drm_mode_duplicate(struct drm_device *dev,
         const struct drm_display_mode *mode)
{
 struct drm_display_mode *nmode;
...
;
# 908 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
_Bool drm_mode_equal(const struct drm_display_mode *mode1, const struct drm_display_mode *mode2)
{
 if (!mode1 && !mode2)
  return 1;
 ...
 if (mode1->clock && mode2->clock) {
  if ((1000000000UL/(mode1->clock)) != (1000000000UL/(mode2->clock)))
   return 0;
 } else if (mode1->clock != mode2->clock)
  return 0;

 if ((mode1->flags & (0x1f<<14)) !=
     (mode2->flags & (0x1f<<14)))
  return 0;
...
;
# 943 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
_Bool drm_mode_equal_no_clocks_no_stereo(const struct drm_display_mode *mode1,
     const struct drm_display_mode *mode2)
{
...
;
# 974 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
enum drm_mode_status
...
;
# 1010 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
enum drm_mode_status
...
;
# 1095 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
void drm_mode_prune_invalid(struct drm_device *dev,
       struct list_head *mode_list, _Bool verbose)
{
 struct drm_display_mode *mode, *t;

 for (mode = ({ __typeof( ((__typeof(*mode) *)0)->head ) *__mptr = ((mode_list)->next); (__typeof(*mode) *)( (char *)__mptr - __builtin_offsetof(__typeof(*mode), head) );}), t = ({ __typeof( ((__typeof(*mode) *)0)->head ) *__mptr = (mode->head.next); (__typeof(*mode) *)( (char *)__mptr - __builtin_offsetof(__typeof(*mode), head) );}); &mode->head != (mode_list); mode = t, t = ({ __typeof( ((__typeof(*t) *)0)->head ) *__mptr = (t->head.next); (__typeof(*t) *)( (char *)__mptr - __builtin_offsetof(__typeof(*t), head) );})) {
...
;
# 1128 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
static int drm_mode_compare(void *priv, struct list_head *lh_a, struct list_head *lh_b)
{
 struct drm_display_mode *a = ({ __typeof( ((struct drm_display_mode *)0)->head ) *__mptr = (lh_a); (struct drm_display_mode *)( (char *)__mptr - __builtin_offsetof(struct drm_display_mode, head) );});
 struct drm_display_mode *b = ({ __typeof( ((struct drm_display_mode *)0)->head ) *__mptr = (lh_b); (struct drm_display_mode *)( (char *)__mptr - __builtin_offsetof(struct drm_display_mode, head) );});
 int diff;
...
;
# 1174 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
void drm_mode_connector_list_update(struct drm_connector *connector,
        _Bool merge_type_bits)
{
 struct drm_display_mode *mode;
 struct drm_display_mode *pmode, *pt;
 int found_it;

 ({ int __ret = !!(!(rw_status(&connector->dev->mode_config.mutex) == 0x0001UL)); if (__ret) printf("WARNING %s failed at %s:%d\n", "!(rw_status(&connector->dev->mode_config.mutex) == 0x0001UL)", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c", 1181); __builtin_expect(!!(__ret), 0); });

 for (pmode = ({ __typeof( ((__typeof(*pmode) *)0)->head ) *__mptr = ((&connector->probed_modes)->next); (__typeof(*pmode) *)( (char *)__mptr - __builtin_offsetof(__typeof(*pmode), head) );}), pt = ({ __typeof( ((__typeof(*pmode) *)0)->head ) *__mptr = (pmode->head.next); (__typeof(*pmode) *)( (char *)__mptr - __builtin_offsetof(__typeof(*pmode), head) );}); &pmode->head != (&connector->probed_modes); pmode = pt, pt = ({ __typeof( ((__typeof(*pt) *)0)->head ) *__mptr = (pt->head.next); (__typeof(*pt) *)( (char *)__mptr - __builtin_offsetof(__typeof(*pt), head) );})) {
...
;
# 1231 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
_Bool drm_mode_parse_command_line_for_connector(const char *mode_option,
            struct drm_connector *connector,
            struct drm_cmdline_mode *mode)
{
# 1381 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
 return 0;

}
;
# 1394 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
struct drm_display_mode *
drm_mode_create_from_cmdline_mode(struct drm_device *dev,
      struct drm_cmdline_mode *cmd)
{
...
;
# 1436 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
void drm_mode_convert_to_umode(struct drm_mode_modeinfo *out,
          const struct drm_display_mode *in)
{
 ({ int __ret = !!(in->hdisplay > 0xffff || in->hsync_start > 0xffff || in->hsync_end > 0xffff || in->htotal > 0xffff || in->hskew > 0xffff || in->vdisplay > 0xffff || in->vsync_start > 0xffff || in->vsync_end > 0xffff || in->vtotal > 0xffff || in->vscan > 0xffff); if (__ret) printf("timing values too large for mode info\n"); __builtin_expect(!!(__ret), 0); });
 ...
 out->flags = in->flags;
 out->type = in->type;
 strncpy(out->name, in->name, 32);
 out->name[32 -1] = 0;
}
# 1475 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_modes.c"
int drm_mode_convert_umode(struct drm_display_mode *out,
      const struct drm_mode_modeinfo *in)
{
 int ret = -22;

 if (in->clock > 0x7fffffff || in->vrefresh > 0x7fffffff) {
  ret = -34;
  goto out;
 }

 if ((in->flags & (0x1f<<14)) > (8<<14))
  goto out;
