# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_xxx.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_xxx.c"
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_xxx.c"
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_xxx.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_xxx.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_xxx.c" 2
...
{
 return (&bdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))]);
}

struct cdevsw *
cdevsw_lookup(dev_t dev)
{
 return (&cdevsw[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))]);
}
...
chrtoblk(dev_t dev)
{
 ...
 if (((int32_t)(((u_int32_t)(dev) >> 8) & 0xff)) >= nchrdev || ((int32_t)(((u_int32_t)(dev) >> 8) & 0xff)) >= nchrtoblktbl)
  return ((dev_t)(-1));
 blkmaj = chrtoblktbl[((int32_t)(((u_int32_t)(dev) >> 8) & 0xff))];
 if (blkmaj == (dev_t)(-1))
  return ((dev_t)(-1));
 return (((dev_t)((((blkmaj) & 0xff) << 8) | ((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))) & 0xff) | (((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))) & 0xffff00) << 8))));
}
...
blktochr(dev_t dev)
{
 int blkmaj = ((int32_t)(((u_int32_t)(dev) >> 8) & 0xff));
 int i;
 ...
 for (i = 0; i < nchrtoblktbl; i++)
  if (blkmaj == chrtoblktbl[i])
   return (((dev_t)((((i) & 0xff) << 8) | ((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))) & 0xff) | (((((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8))) & 0xffff00) << 8))));
 return ((dev_t)(-1));
}
