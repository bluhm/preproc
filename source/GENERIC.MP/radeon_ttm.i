# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/ttm/ttm_placement.h" 1
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon.h" 1
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon.h"
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c" 2
...
static struct radeon_device *radeon_get_rdev(struct ttm_bo_device *bdev)
{
 ...
 mman = ({ __typeof( ((struct radeon_mman *)0)->bdev ) *__mptr = (bdev); (struct radeon_mman *)( (char *)__mptr - __builtin_offsetof(struct radeon_mman, bdev) );});
 rdev = ({ __typeof( ((struct radeon_device *)0)->mman ) *__mptr = (mman); (struct radeon_device *)( (char *)__mptr - __builtin_offsetof(struct radeon_device, mman) );});
 return rdev;
}
...
static int radeon_ttm_global_init(struct radeon_device *rdev)
{
 ...
 if (r != 0) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed setting up TTM memory accounting " "subsystem.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 ...
 r = drm_global_item_ref(global_ref);
 if (r != 0) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed setting up TTM BO subsystem.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    ...
    struct ttm_mem_type_manager *man)
{
 ...
 case 0:
  ...
  man->flags = (1 << 1);
  man->available_caching = ((1 << 16) | (1 << 17) | (1 << 18));
  man->default_caching = (1 << 16);
  break;
 case 1:
  ...
  man->default_caching = (1 << 16);
  man->flags = (1 << 1) | (1 << 3);
# 157 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
  break;
 case 2:
  ...
  man->flags = (1 << 0) |
        (1 << 1);
  man->available_caching = (1 << 17) | (1 << 18);
  man->default_caching = (1 << 18);
  break;
 default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unsupported memory type %u\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , (unsigned)type);
  return -22;
 }
 return 0;
}
    ...
    struct ttm_placement *placement)
{
 ...
 static u32 placements = ((1 << 16) | (1 << 17) | (1 << 18)) | (1 << 0);
 ...
 case 2:
  if (rbo->rdev->ring[0].ready == 0)
   radeon_ttm_placement_from_domain(rbo, 0x1);
  else
        ...
        struct ttm_mem_reg *new_mem)
{
 ...
 ((!(old_mem->mm_node != ((void *)0))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c", 214, "!(old_mem->mm_node != ((void *)0))"));
 *old_mem = *new_mem;
   ...
   struct ttm_mem_reg *old_mem)
{
 ...
 ridx = (rdev)->asic->copy.copy_ring_index;
 old_start = old_mem->start << 13;
 new_start = new_mem->start << 13;
 ...
 case 1:
  ...
  break;
 default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown placement %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , old_mem->mem_type);
  return -22;
 }
 ...
 if (!rdev->ring[ridx].ready) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Trying to move memory with ring turned off.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -22;
 }

 extern char _ctassert[(!(((1 << 13) % 4096) != 0)) ? 1 : -1 ] __attribute__((__unused__));


 fence = bo->sync_obj;
 r = (rdev)->asic->copy.copy((rdev), (old_start), (new_start), (new_mem->num_pages * ((1 << 13) / 4096)), (&fence));
   ...
   struct ttm_mem_reg *new_mem)
{
 ...
 rdev = radeon_get_rdev(bo->bdev);
 if (old_mem->mem_type == 0 && bo->ttm == ((void *)0)) {
  radeon_move_null(bo, new_mem);
  return 0;
 }
 if ((old_mem->mem_type == 1 &&
      new_mem->mem_type == 0) ||
     (old_mem->mem_type == 0 &&
      new_mem->mem_type == 1)) {
 ...
 if (!rdev->ring[(rdev)->asic->copy.copy_ring_index].ready ||
     rdev->asic->copy.copy == ((void *)0)) {

  goto memcpy;
 }

 if (old_mem->mem_type == 2 &&
     new_mem->mem_type == 0) {
  r = radeon_move_vram_ram(bo, evict, interruptible,
     no_wait_gpu, new_mem);
 } else if (old_mem->mem_type == 0 &&
     new_mem->mem_type == 2) {
...
static int radeon_ttm_io_mem_reserve(struct ttm_bo_device *bdev, struct ttm_mem_reg *mem)
{
 ...
 case 0:
  ...
  return 0;
 case 1:
# 434 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
  break;
 case 2:
  mem->bus.offset = mem->start << 13;

  if ((mem->bus.offset + mem->bus.size) > rdev->mc.visible_vram_size)
   return -22;
  mem->bus.base = rdev->mc.aper_base;
  mem->bus.is_iomem = 1;
# 465 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
  break;
 default:
  return -22;
 }
...
static int radeon_sync_obj_wait(void *sync_obj, _Bool lazy, _Bool interruptible)
{
...
static _Bool radeon_sync_obj_signaled(void *sync_obj)
{
       ...
       struct ttm_mem_reg *bo_mem)
{
 ...
 gtt->offset = (unsigned long)(bo_mem->start << 13);
 if (!ttm->num_pages) {
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "failed to bind %lu pages at 0x%08X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , ttm->num_pages, (unsigned)gtt->offset);
        ...
        struct vm_page *dummy_read_page)
{
 ...
 gtt = kzalloc(sizeof(struct radeon_ttm_tt), (0x0001 | 0x0004));
 if (gtt == ((void *)0)) {
  return ((void *)0);
 }
 ...
 gtt->segs = mallocarray(gtt->ttm.ttm.num_pages,
     sizeof(bus_dma_segment_t), 145, 0x0001 | 0x0008);
...
static int radeon_ttm_tt_populate(struct ttm_tt *ttm)
{
 ...
 unsigned i;
 int r, seg;
 _Bool slave = !!(ttm->page_flags & (1 << 8));
...
# 630 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
 ...
 for (i = 0; i < ttm->num_pages; i++) {
  gtt->segs[i].ds_addr = ((ttm->pages[i])->phys_addr);
  gtt->segs[i].ds_len = (1 << 13);
 }

 if (bus_dmamap_load_raw(rdev->dmat, gtt->map, gtt->segs,
    ttm->num_pages,
    ttm->num_pages * (1 << 13), 0)) {
...
static void radeon_ttm_tt_unpopulate(struct ttm_tt *ttm)
{
 ...
 rdev = radeon_get_rdev(ttm->bdev);
# 686 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
...
int radeon_ttm_init(struct radeon_device *rdev)
{
 ...
 r = ttm_bo_device_init(&rdev->mman.bdev,
          ...
          &radeon_bo_driver, (0x100000000ULL >> 13),
          rdev->need_dma32);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "failed initializing buffer object driver(%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
  return r;
 }
 ...
 r = ttm_bo_init_mm(&rdev->mman.bdev, 2,
    rdev->mc.real_vram_size >> 13);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed initializing VRAM heap.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return r;
 }
 ...
 r = radeon_bo_create(rdev, rdev->fb_offset, (1 << 13), 1,
        0x4,
 ...
 if (r)
  return r;
 r = radeon_bo_pin(rdev->stollen_vga_memory, 0x4, ((void *)0));
 ...
 r = ttm_bo_init_mm(&rdev->mman.bdev, 1,
    rdev->mc.gtt_size >> 13);
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed initializing GTT heap.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return r;
 }
 do { } while( 0);
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to init debugfs\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return r;
 }
 return 0;
}
...
void radeon_ttm_fini(struct radeon_device *rdev)
{
 ...
 ttm_bo_clean_mm(&rdev->mman.bdev, 2);
 ttm_bo_clean_mm(&rdev->mman.bdev, 1);
...
void radeon_ttm_set_active_vram_size(struct radeon_device *rdev, u64 size)
{
 ...
 man = &rdev->mman.bdev.man[2];

 man->size = size >> 13;
}

static struct uvm_pagerops radeon_ttm_vm_ops;
static const struct uvm_pagerops *ttm_vm_ops = ((void *)0);
...
radeon_mmap(struct drm_device *dev, voff_t off, vsize_t size)
{
 ...
 if (__builtin_expect(!!(off < (0x100000000ULL >> 13)), 0))
  return ((void *)0);
# 860 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
 uobj = ttm_bo_mmap(off, size, &rdev->mman.bdev);
 if (__builtin_expect(!!(uobj == ((void *)0)), 0)) {
  return ((void *)0);
 }
 if (__builtin_expect(!!(ttm_vm_ops == ((void *)0)), 0)) {
...
# 893 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
static int radeon_ttm_debugfs_init(struct radeon_device *rdev)
{
# 932 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_ttm.c"
 return 0;
}
