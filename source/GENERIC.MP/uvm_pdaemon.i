# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c" 2
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c" 2
# 97 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
void uvmpd_scan(void);
boolean_t uvmpd_scan_inactive(struct pglist *);
void uvmpd_tune(void);
void uvmpd_drop(struct pglist *);
# 109 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
void
uvm_wait(const char *wmsg)
{
 ...
 if ((__curcpu->ci_self)->ci_curproc == uvm.pagedaemon_proc) {
  ...
  if (bufbackoff(((void *)0), 4) == 0)
   return;
# 136 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
...
# 156 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
void
uvmpd_tune(void)
{
 ...
 uvmexp.freemin = max(uvmexp.freemin, (16*1024) >> 13);
...
uvm_pageout(void *arg)
{
 ...
 for (;;) {
  ...
  if ((pma = ((&uvm.pmr_control.allocs)->tqh_first)) != ((void *)0)) {
   pma->pm_flags |= 0x02;
...
# 341 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
boolean_t
uvmpd_scan_inactive(struct pglist *pglst)
{
 ...
 int npages;
 struct vm_page *swpps[(64 * 1024) >> 13];
 ...
 vaddr_t start;
 int dirtyreacts;
# 370 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
 swslot = 0;
 swnpages = swcpages = 0;
 free = 0;
 dirtyreacts = 0;

 for (p = ((pglst)->tqh_first); p != ((void *)0) || swslot != 0; p = nextpg) {
...
# 418 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
   ...
   if (p->pg_flags & 0x00100000) {
    anon = p->uanon;
    ((anon != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c", 426, "anon != NULL"));
    if (p->pg_flags & 0x00000001) {
     uvmexp.pdbusy++;
    ...
    uobj = p->uobject;
    ((uobj != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c", 435, "uobj != NULL"));
    if (p->pg_flags & 0x00000001) {
     uvmexp.pdbusy++;
   ...
   if (p->pg_flags & 0x00000008) {
    if (p->pg_flags & (0x00100000|0x00200000)) {
    ...
    if (anon) {
     ...
     ((anon->an_swslot != 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c", 467, "anon->an_swslot != 0"));
   ...
   ((uvmexp.swpgonly <= uvmexp.swpages) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c", 489, "uvmexp.swpgonly <= uvmexp.swpages"));
   if ((p->pg_flags & (0x00100000|0x00200000)) &&
   ...
   ((uvmexp.swpginuse <= uvmexp.swpages) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c", 502, "uvmexp.swpginuse <= uvmexp.swpages"));
   if ((p->pg_flags & (0x00100000|0x00200000)) &&
    ...
    if (p->pg_flags & 0x00200000) {
     uao_dropswap(p->uobject,
           p->offset >> 13);
    }
   }
# 526 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
   swap_backed = ((p->pg_flags & (0x00100000|0x00200000)) != 0);
   atomic_setbits_int(&p->pg_flags, 0x00000001);
   ;
   pmap_page_protect(p, 0x01);
   uvmexp.pgswapout++;
...
# 589 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
  if (swap_backed) {
   if (p) {
...
# 635 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
  uvmexp.pdpageouts++;
  result = uvm_pager_put(swap_backed ? ((void *)0) : uobj, p,
      &ppsp, &npages, 0x010|0x080, start, 0);
  ...
  if (swap_backed)
   swslot = 0;
# 660 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
  if (result == 3) {
  ...
  if (p) {
# 700 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
   if (result == 6)
   ...
   if (p->pg_flags & 0x00000002)
    wakeup(p);

   atomic_clearbits_int(&p->pg_flags, 0x00000001|0x00000002);
   ;


   if (p->pg_flags & 0x00000020) {
    ((anon != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c", 714, "anon != NULL"));
...
# 757 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
   if (nextpg && (nextpg->pg_flags & 0x00020000) == 0) {
    nextpg = ((pglst)->tqh_first);
   }
  } else {
...
# 823 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c"
 got_it = 0;
 ...
 inactive_shortage = uvmexp.inactarg - uvmexp.inactive - (((bcstats.numcleanpages - buflowpages) < 0) ? 0 : bcstats.numcleanpages - buflowpages);
 ...
 for (p = ((&uvm.page_active)->tqh_first);
      p != ((void *)0) && (inactive_shortage > 0 || swap_shortage > 0);
      p = nextpg) {
  nextpg = ((p)->pageq.tqe_next);
  ...
  if (p->pg_flags & 0x00100000)
   ((p->uanon != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c", 861, "p->uanon != NULL"));
  else
   ((p->uobject != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_pdaemon.c", 863, "p->uobject != NULL"));
  ...
  if (swap_shortage > 0) {
   if ((p->pg_flags & 0x00100000) && p->uanon->an_swslot) {
    uvm_swap_free(p->uanon->an_swslot, 1);
    p->uanon->an_swslot = 0;
    atomic_clearbits_int(&p->pg_flags, 0x00000008);
    swap_shortage--;
   }
   if (p->pg_flags & 0x00200000) {
