# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.h" 1
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c" 2
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c"
struct umct_softc {
...
# 105 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/umct.c"
...
umct_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(umct_devs), sizeof (umct_devs) / sizeof ((umct_devs)[0]), sizeof ((umct_devs)[0]), (uaa->vendor), (uaa->product)) != ((void *)0) ?
     13 : 0);
}
...
umct_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 for (i = 0; i < id->bNumEndpoints; i++) {
  ...
  if (((ed->bEndpointAddress) & 0x80) == 0x80 &&
      ...
      ((ed->wMaxPacketSize)[0] | ((ed->wMaxPacketSize)[1] << 8)) != 0x2) {
...
void
umct_set(void *addr, int portno, int reg64, int onoff)
{
...
umct_break(struct umct_softc *sc, int onoff)
{
 ...
 umct_set_lcr(sc, onoff ? sc->last_lcr | 0x40 :
       sc->last_lcr);
}
...
umct_set_baudrate(struct umct_softc *sc, u_int rate, int cts)
{
 ...
 ((arate)[0] = (u_int8_t)(val), (arate)[1] = (u_int8_t)((val) >> 8), (arate)[2] = (u_int8_t)((val) >> 16), (arate)[3] = (u_int8_t)((val) >> 24));

        req.bmRequestType = 0x40;
        req.bRequest = 5;
        ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
        ((req.wIndex)[0] = (u_int8_t)(sc->sc_iface_number), (req.wIndex)[1] = (u_int8_t)((sc->sc_iface_number) >> 8));
        ((req.wLength)[0] = (u_int8_t)(4), (req.wLength)[1] = (u_int8_t)((4) >> 8));


        (void)usbd_do_request(sc->sc_udev, &req, arate);


 ((arate)[0] = (u_int8_t)(0), (arate)[1] = (u_int8_t)((0) >> 8), (arate)[2] = (u_int8_t)((0) >> 16), (arate)[3] = (u_int8_t)((0) >> 24));
 req.bmRequestType = 0x40;
 req.bRequest = 11;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(sc->sc_iface_number), (req.wIndex)[1] = (u_int8_t)((sc->sc_iface_number) >> 8));
 ...
 ((arate)[0] = (u_int8_t)(cts), (arate)[1] = (u_int8_t)((cts) >> 8), (arate)[2] = (u_int8_t)((cts) >> 16), (arate)[3] = (u_int8_t)((cts) >> 24));
 req.bmRequestType = 0x40;
 req.bRequest = 12;
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(sc->sc_iface_number), (req.wIndex)[1] = (u_int8_t)((sc->sc_iface_number) >> 8));
...
umct_init(struct umct_softc *sc)
{
 ...
 umct_set_lcr(sc, 0x03 | 0x00 | 0x00);
}
...
umct_param(void *addr, int portno, struct termios *t)
{
 ...
 umct_set_baudrate(sc, t->c_ospeed, ((t->c_cflag) & (0x00010000)));
