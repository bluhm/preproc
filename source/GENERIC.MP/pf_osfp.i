# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c"
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c"
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
void pf_send_tcp(const struct pf_rule *, sa_family_t,
       ...
       u_int8_t, u_int16_t, u_int16_t, u_int8_t, int,
       u_int16_t, u_int);
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c" 2


typedef struct pool pool_t;
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c"
struct pf_osfp_list { struct pf_os_fingerprint *slh_first; } pf_osfp_list;
...
pf_osfp_fingerprint(struct pf_pdesc *pd)
{
 ...
 switch (pd->af) {
 case 2:
  ip = ((struct ip *)((pd->m)->m_hdr.mh_data));
  break;
 case 24:
  ip6 = ((struct ip6_hdr *)((pd->m)->m_hdr.mh_data));
  break;
 }
 if (!pf_pull_hdr(pd->m, pd->off, hdr, th->th_off << 2, ((void *)0), ((void *)0),
     pd->af))
  return (((void *)0));
    ...
    const struct tcphdr *tcp)
{
 ...
 if ((tcp->th_flags & (0x02|0x10)) != 0x02)
  return (((void *)0));
 if (ip) {
  if ((ip->ip_off & ((__uint16_t)(0x1fff))) != 0)
   return (((void *)0));
 }
 ...
 if (ip) {
  ...
  fp.fp_psize = ((__uint16_t)(ip->ip_len));
  fp.fp_ttl = ip->ip_ttl;
  if (ip->ip_off & ((__uint16_t)(0x4000)))
   fp.fp_flags |= 0x1000;

  inet_ntop(2, &ip->ip_src, srcname, sizeof(srcname));
# 155 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c"
 }
  ...
  fp.fp_psize = sizeof(struct ip6_hdr) + ((__uint16_t)(ip6->ip6_ctlun.ip6_un1.ip6_un1_plen));
  fp.fp_ttl = ip6->ip6_ctlun.ip6_un1.ip6_un1_hlim;
  fp.fp_flags |= 0x1000;
  fp.fp_flags |= 0x4000;

  inet_ntop(24, &ip6->ip6_src, srcname, sizeof(srcname));
# 178 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c"
 }

 else
  return (((void *)0));
 fp.fp_wsize = ((__uint16_t)(tcp->th_win));
 ...
 for (; cnt > 0; cnt -= optlen, optp += optlen) {
  ...
  if (*optp == 1) {
   ...
   case 2:
    if (optlen >= 4)
     __builtin_memcpy((&fp.fp_mss), (&optp[2]), (sizeof(fp.fp_mss)));

    fp.fp_tcpopts = (fp.fp_tcpopts <<
        3) | 0x2;
    fp.fp_mss = ((__uint16_t)(fp.fp_mss));
    break;
   case 3:
    if (optlen >= 3)
     __builtin_memcpy((&fp.fp_wscale), (&optp[2]), (sizeof(fp.fp_wscale)));
   ...
   case 8:
    if (optlen >= 10) {
     u_int32_t ts;
     __builtin_memcpy((&ts), (&optp[2]), (sizeof(ts)));
     if (ts == 0)
      fp.fp_flags |= 0x2000;
 ...
 do { if (pf_status.debug >= (6)) { log(6, "pf: "); addlog("fingerprinted %s:%d  %d:%d:%d:%d:%llx (%d) " "(TS=%s,M=%s%d,W=%s%d)", srcname, ((__uint16_t)(tcp->th_sport)), fp.fp_wsize, fp.fp_ttl, (fp.fp_flags & 0x1000) != 0, fp.fp_psize, (long long int)fp.fp_tcpopts, fp.fp_optcnt, (fp.fp_flags & 0x2000) ? "0" : "", (fp.fp_flags & 0x0400) ? "%" : (fp.fp_flags & 0x0800) ? "*" : "", fp.fp_mss, (fp.fp_flags & 0x0080) ? "%" : (fp.fp_flags & 0x0100) ? "*" : "", fp.fp_wscale); addlog("\n"); } } while (0);
# 255 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c"
...
pf_osfp_match(struct pf_osfp_enlist *list, pf_osfp_t os)
{
 ...
 if (os == ((pf_osfp_t)0))
  return (1);
 if (list == ((void *)0)) {
  do { if (pf_status.debug >= (6)) { log(6, "pf: "); addlog("osfp no match against %x", os); addlog("\n"); } } while (0);
  return (os == ((pf_osfp_t)-1));
 }
 do { (os_class) = ((os) >> (10 +10)) & ((1 << 10) - 1); (os_version) = ((os) >> 10) & ((1 << 10) - 1); (os_subtype) = (os) & ((1 << 10) - 1); } while(0);
 for((entry) = ((list)->slh_first); (entry) != ((void *)0); (entry) = ((entry)->fp_entry.sle_next)) {
  ...
  if ((os_class == ((pf_osfp_t)0) || en_class == os_class) &&
   ...
   do { if (pf_status.debug >= (6)) { log(6, "pf: "); addlog("osfp matched %s %s %s  %x==%x", entry->fp_class_nm, entry->fp_version_nm, entry->fp_subtype_nm, os, entry->fp_os); addlog("\n"); } } while (0);
 ...
 do { if (pf_status.debug >= (6)) { log(6, "pf: "); addlog("fingerprint 0x%x didn't match", os); addlog("\n"); } } while (0);
 return (0);
}
...
pf_osfp_initialize(void)
{
 pool_init(&pf_osfp_entry_pl, sizeof(struct pf_osfp_entry), 0,
     0, 0x0001, "pfosfpen", ((void *)0));
 pool_init(&pf_osfp_pl, sizeof(struct pf_os_fingerprint), 0,
     0, 0x0001, "pfosfp", ((void *)0));
 { ((&pf_osfp_list)->slh_first) = ((void *)0); };
}
...
pf_osfp_flush(void)
{
 ...
 while ((fp = ((&pf_osfp_list)->slh_first))) {
  do { (&pf_osfp_list)->slh_first = (&pf_osfp_list)->slh_first->fp_next.sle_next; } while (0);
...
pf_osfp_add(struct pf_osfp_ioctl *fpioc)
{
 ...
 __builtin_memset((&fpadd), (0), (sizeof(fpadd)));
 ...
 do { if (pf_status.debug >= (7)) { log(7, "pf: "); addlog("adding osfp %s %s %s = %s%d:%d:%d:%s%d:0x%llx %d " "(TS=%s,M=%s%d,W=%s%d) %x", fpioc->fp_os.fp_class_nm, fpioc->fp_os.fp_version_nm, fpioc->fp_os.fp_subtype_nm, (fpadd.fp_flags & 0x0001) ? "%" : (fpadd.fp_flags & 0x0004) ? "S" : (fpadd.fp_flags & 0x0008) ? "T" : (fpadd.fp_flags & 0x0002) ? "*" : "", fpadd.fp_wsize, fpadd.fp_ttl, (fpadd.fp_flags & 0x1000) ? 1 : 0, (fpadd.fp_flags & 0x0010) ? "%" : (fpadd.fp_flags & 0x0020) ? "*" : "", fpadd.fp_psize, (long long int)fpadd.fp_tcpopts, fpadd.fp_optcnt, (fpadd.fp_flags & 0x2000) ? "0" : "", (fpadd.fp_flags & 0x0400) ? "%" : (fpadd.fp_flags & 0x0800) ? "*" : "", fpadd.fp_mss, (fpadd.fp_flags & 0x0080) ? "%" : (fpadd.fp_flags & 0x0100) ? "*" : "", fpadd.fp_wscale, fpioc->fp_os.fp_os); addlog("\n"); } } while (0);
# 363 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c"
 if ((fp = pf_osfp_find_exact(&pf_osfp_list, &fpadd))) {
   for((entry) = ((&fp->fp_oses)->slh_first); (entry) != ((void *)0); (entry) = ((entry)->fp_entry.sle_next)) {
   if (((entry)->fp_os == (&fpioc->fp_os)->fp_os && __builtin_memcmp(((entry)->fp_class_nm), ((&fpioc->fp_os)->fp_class_nm), (32)) == 0 && __builtin_memcmp(((entry)->fp_version_nm), ((&fpioc->fp_os)->fp_version_nm), (32)) == 0 && __builtin_memcmp(((entry)->fp_subtype_nm), ((&fpioc->fp_os)->fp_subtype_nm), (32)) == 0))
    return (17);
  }
  if ((entry = pool_get(&pf_osfp_entry_pl,
      0x0001|0x0004)) == ((void *)0))
   return (12);
 } else {
  if ((fp = pool_get(&pf_osfp_pl,
      0x0001|0x0008|0x0004)) == ((void *)0))
   return (12);
 ...
 __builtin_memcpy((entry), (&fpioc->fp_os), (sizeof(*entry)));
...
# 427 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c"
 for((f) = ((list)->slh_first); (f) != ((void *)0); (f) = ((f)->fp_next.sle_next)) {
...
{
 struct pf_os_fingerprint *f, *prev = ((void *)0);
...
pf_osfp_get(struct pf_osfp_ioctl *fpioc)
{
 ...
 __builtin_memset((fpioc), (0), (sizeof(*fpioc)));
 for((fp) = ((&pf_osfp_list)->slh_first); (fp) != ((void *)0); (fp) = ((fp)->fp_next.sle_next)) {
  for((entry) = ((&fp->fp_oses)->slh_first); (entry) != ((void *)0); (entry) = ((entry)->fp_entry.sle_next)) {
   if (i++ == num) {
    ...
    fpioc->fp_getnum = num;
    __builtin_memcpy((&fpioc->fp_os), (entry), (sizeof(fpioc->fp_os)));
...
pf_osfp_validate(void)
{
 ...
 for((f) = ((&pf_osfp_list)->slh_first); (f) != ((void *)0); (f) = ((f)->fp_next.sle_next)) {
  __builtin_memcpy((&find), (f), (sizeof(find)));
  ...
  if (f != (f2 = pf_osfp_find(&pf_osfp_list, &find, 0))) {
   if (f2)
    do { if (pf_status.debug >= (5)) { log(5, "pf: "); addlog("Found \"%s %s %s\" instead of " "\"%s %s %s\"\n", ((&f2->fp_oses)->slh_first)->fp_class_nm, ((&f2->fp_oses)->slh_first)->fp_version_nm, ((&f2->fp_oses)->slh_first)->fp_subtype_nm, ((&f->fp_oses)->slh_first)->fp_class_nm, ((&f->fp_oses)->slh_first)->fp_version_nm, ((&f->fp_oses)->slh_first)->fp_subtype_nm); addlog("\n"); } } while (0);
# 581 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/pf_osfp.c"
   else
    do { if (pf_status.debug >= (5)) { log(5, "pf: "); addlog("Couldn't find \"%s %s %s\"\n", ((&f->fp_oses)->slh_first)->fp_class_nm, ((&f->fp_oses)->slh_first)->fp_version_nm, ((&f->fp_oses)->slh_first)->fp_subtype_nm); addlog("\n"); } } while (0);
