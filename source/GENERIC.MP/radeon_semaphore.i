# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_semaphore.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_semaphore.c"
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_semaphore.c"
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_semaphore.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_semaphore.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_semaphore.c" 2
 ...
 *semaphore = kmalloc(sizeof(struct radeon_semaphore), (0x0001 | 0x0004));
 if (*semaphore == ((void *)0)) {
  return -12;
 }
             ...
             struct radeon_semaphore *semaphore)
{
 ...
 --semaphore->waiters;
 (rdev)->asic->ring[(ring)].emit_semaphore((rdev), (&rdev->ring[ring]), (semaphore), (0));
}
           ...
           struct radeon_semaphore *semaphore)
{
 ...
 ++semaphore->waiters;
 (rdev)->asic->ring[(ring)].emit_semaphore((rdev), (&rdev->ring[ring]), (semaphore), (1));
}
    ...
    int signaler, int waiter)
{
 ...
 if (!rdev->ring[signaler].ready) {
  printf("drm:pid%d:%s *ERROR* " "Trying to sync to a disabled ring!", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -22;
 }
      ...
      struct radeon_fence *fence)
{
 ...
 if ((*semaphore)->waiters > 0) {
  printf("drm:pid%d:%s *ERROR* " "semaphore %p has more waiters than signalers," " hardware lockup imminent!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , *semaphore);
