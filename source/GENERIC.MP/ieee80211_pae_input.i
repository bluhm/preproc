# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c"
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c"
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_pae_input.c" 2
    ...
    struct ieee80211_node *ni)
{
 ...
 if (m->M_dat.MH.MH_pkthdr.len < sizeof(*key))
  goto done;
 if (m->m_hdr.mh_len < sizeof(*key) &&
     (m = m_pullup(m, sizeof(*key))) == ((void *)0)) {
  ic->ic_stats.is_rx_nombuf++;
  goto done;
 }
 key = ((struct ieee80211_eapol_key *)((m)->m_hdr.mh_data));
 ...
 if (m->m_hdr.mh_len < totlen && (m = m_pullup(m, totlen)) == ((void *)0)) {
  ic->ic_stats.is_rx_nombuf++;
  goto done;
 }
 key = ((struct ieee80211_eapol_key *)((m)->m_hdr.mh_data));
    ...
    struct ieee80211_eapol_key *key, struct ieee80211_node *ni)
{
 ...
 if (ni->ni_replaycnt_ok &&
     ((u_int64_t)(key->replaycnt)[0] << 56 | (u_int64_t)(key->replaycnt)[1] << 48 | (u_int64_t)(key->replaycnt)[2] << 40 | (u_int64_t)(key->replaycnt)[3] << 32 | (u_int64_t)(key->replaycnt)[4] << 24 | (u_int64_t)(key->replaycnt)[5] << 16 | (u_int64_t)(key->replaycnt)[6] << 8 | (u_int64_t)(key->replaycnt)[7]) <= ni->ni_replaycnt) {
 ...
 efrm = frm + ((u_int16_t) ((((const u_int8_t *)(key->paylen))[0] << 8) | (((const u_int8_t *)(key->paylen))[1])));
 ...
 while (frm + 2 <= efrm) {
  ...
  case IEEE80211_ELEMID_VENDOR:
   if (frm[1] < 4)
    break;
   if (__builtin_memcmp((&frm[2]), (((const u_int8_t[]){ 0x00, 0x0f, 0xac })), (3)) == 0) {
    switch (frm[5]) {
 ...
 __builtin_memcpy((ni->ni_nonce), (key->nonce), (32));
    ...
    const u_int8_t *rsnie)
{
 ...
 __builtin_memcpy((&ni->ni_ptk), (&tptk), (sizeof(tptk)));





 if (ni->ni_rsnie == ((void *)0) || rsnie[1] != ni->ni_rsnie[1] ||
     __builtin_memcmp((rsnie), (ni->ni_rsnie), (2 + rsnie[1])) != 0) {
  ((*(ic)->ic_send_mgmt)(ic, ni, 0xc0, IEEE80211_REASON_RSN_DIFFERENT_IE, 0));
    ...
    struct ieee80211_eapol_key *key, struct ieee80211_node *ni)
{
 ...
 if (!(ni->ni_flags & 0x0100)) {
  ;

  return;
 }

 if (__builtin_memcmp((key->nonce), (ni->ni_nonce), (32)) != 0) {
  ;
  return;
 }
 ...
 while (frm + 2 <= efrm) {
  ...
  case IEEE80211_ELEMID_VENDOR:
   ...
   } else if (__builtin_memcmp((&frm[2]), (((const u_int8_t[]){ 0x00, 0x50, 0xf2 })), (3)) == 0) {
    switch (frm[5]) {
    case 1:
     if (ni->ni_rsnprotos !=
         (1 << 1))
 ...
 if (gtk != ((void *)0) && !(info & (1 << 12))) {
  ;
  return;
 }

 if (igtk != ((void *)0) && gtk == ((void *)0)) {
  ;
  return;
 }
 ...
 if (ni->ni_rsnie == ((void *)0) || rsnie1[1] != ni->ni_rsnie[1] ||
     __builtin_memcmp((rsnie1), (ni->ni_rsnie), (2 + rsnie1[1])) != 0) {
 ...
 ni->ni_replaycnt = ((u_int64_t)(key->replaycnt)[0] << 56 | (u_int64_t)(key->replaycnt)[1] << 48 | (u_int64_t)(key->replaycnt)[2] << 40 | (u_int64_t)(key->replaycnt)[3] << 32 | (u_int64_t)(key->replaycnt)[4] << 24 | (u_int64_t)(key->replaycnt)[5] << 16 | (u_int64_t)(key->replaycnt)[6] << 8 | (u_int64_t)(key->replaycnt)[7]);
 ni->ni_replaycnt_ok = 1;

 if (ic->ic_ac.ac_if.if_flags & 0x4)
  printf("%s: received msg %d/%d of the %s handshake from %s\n",
      ic->ic_ac.ac_if.if_xname, 3, 4, "4-way",
      ether_sprintf(ni->ni_macaddr));
 ...
 if (ni->ni_rsncipher != IEEE80211_CIPHER_USEGROUP) {
  ...
  prsc = (gtk == ((void *)0)) ? ((u_int64_t)(key->rsc)[5] << 40 | (u_int64_t)(key->rsc)[4] << 32 | (u_int64_t)(key->rsc)[3] << 24 | (u_int64_t)(key->rsc)[2] << 16 | (u_int64_t)(key->rsc)[1] << 8 | (u_int64_t)(key->rsc)[0]) : 0;
  ...
  k->k_rsc[0] = prsc;
  k->k_len = keylen;
  __builtin_memcpy((k->k_key), (ni->ni_ptk.tk), (k->k_len));
 ...
 if (igtk != ((void *)0)) {
  ...
  kid = ((u_int16_t) ((((const u_int8_t *)(&igtk[6]))[0]) | (((const u_int8_t *)(&igtk[6]))[1] << 8)));
  if (kid != 4 && kid != 5) {
   ;
   reason = IEEE80211_REASON_AUTH_LEAVE;
   goto deauth;
 ...
 if (info & (1 << 9)) {
...

  {
   ...
   ni->ni_port_valid = 1;
   ieee80211_set_link_state(ic, 4);
  }
 }
 deauth:
 if (reason != 0) {
  ((*(ic)->ic_send_mgmt)(ic, ni, 0xc0, reason, 0));
    ...
    struct ieee80211_eapol_key *key, struct ieee80211_node *ni)
{
 ...
 if (ni->ni_rsncipher != IEEE80211_CIPHER_USEGROUP) {
  ...
  if ((*ic->ic_set_key)(ic, ni, k) != 0) {
   ((*(ic)->ic_send_mgmt)(ic, ni, 0xc0, IEEE80211_REASON_ASSOC_TOOMANY, 0));
 ...
 if (ic->ic_ac.ac_if.if_flags & 0x4)
  printf("%s: received msg %d/%d of the %s handshake from %s\n",
      ic->ic_ac.ac_if.if_xname, 4, 4, "4-way",
      ether_sprintf(ni->ni_macaddr));


 if (ni->ni_rsnprotos == (1 << 1))
    ...
    struct ieee80211_eapol_key *key, struct ieee80211_node *ni)
{
 ...
 if (((u_int64_t)(key->replaycnt)[0] << 56 | (u_int64_t)(key->replaycnt)[1] << 48 | (u_int64_t)(key->replaycnt)[2] << 40 | (u_int64_t)(key->replaycnt)[3] << 32 | (u_int64_t)(key->replaycnt)[4] << 24 | (u_int64_t)(key->replaycnt)[5] << 16 | (u_int64_t)(key->replaycnt)[6] << 8 | (u_int64_t)(key->replaycnt)[7]) != ni->ni_replaycnt) {
  ic->ic_stats.is_rx_eapol_replay++;
  return;
 }
    ...
    struct ieee80211_eapol_key *key, struct ieee80211_node *ni)
{
 ...
 if (ic->ic_ac.ac_if.if_flags & 0x4)
  printf("%s: received msg %d/%d of the %s handshake from %s\n",
      ic->ic_ac.ac_if.if_xname, 1, 2, "group key",
      ether_sprintf(ni->ni_macaddr));


 (void)ieee80211_send_group_msg2(ic, ni, ((void *)0));
 return;
 deauth:
 ((*(ic)->ic_send_mgmt)(ic, ni, 0xc0, reason, 0));
 (((ic)->ic_newstate)((ic), (IEEE80211_S_SCAN), (-1)));
    ...
    struct ieee80211_eapol_key *key, struct ieee80211_node *ni)
{
 ...
 if (((u_int16_t) ((((const u_int8_t *)(key->paylen))[0] << 8) | (((const u_int8_t *)(key->paylen))[1]))) < keylen)
  return;
    ...
    struct ieee80211_eapol_key *key, struct ieee80211_node *ni)
{
 ...
 if (ic->ic_ac.ac_if.if_flags & 0x4)
  printf("%s: received msg %d/%d of the %s handshake from %s\n",
      ic->ic_ac.ac_if.if_xname, 2, 2, "group key",
      ether_sprintf(ni->ni_macaddr));
}
    ...
    struct ieee80211_eapol_key *key, struct ieee80211_node *ni)
{
 ...
 if (ni->ni_reqreplaycnt_ok &&
     ((u_int64_t)(key->replaycnt)[0] << 56 | (u_int64_t)(key->replaycnt)[1] << 48 | (u_int64_t)(key->replaycnt)[2] << 40 | (u_int64_t)(key->replaycnt)[3] << 32 | (u_int64_t)(key->replaycnt)[4] << 24 | (u_int64_t)(key->replaycnt)[5] << 16 | (u_int64_t)(key->replaycnt)[6] << 8 | (u_int64_t)(key->replaycnt)[7]) <= ni->ni_reqreplaycnt) {
  ic->ic_stats.is_rx_eapol_replay++;
  return;
 }
 info = ((u_int16_t) ((((const u_int8_t *)(key->info))[0] << 8) | (((const u_int8_t *)(key->info))[1])));
 ...
 ni->ni_reqreplaycnt = ((u_int64_t)(key->replaycnt)[0] << 56 | (u_int64_t)(key->replaycnt)[1] << 48 | (u_int64_t)(key->replaycnt)[2] << 40 | (u_int64_t)(key->replaycnt)[3] << 32 | (u_int64_t)(key->replaycnt)[4] << 24 | (u_int64_t)(key->replaycnt)[5] << 16 | (u_int64_t)(key->replaycnt)[6] << 8 | (u_int64_t)(key->replaycnt)[7]);
 ...
 if (info & (1 << 10)) {
  ...
  ieee80211_michael_mic_failure(ic, ((u_int64_t)(key->rsc)[5] << 40 | (u_int64_t)(key->rsc)[4] << 32 | (u_int64_t)(key->rsc)[3] << 24 | (u_int64_t)(key->rsc)[2] << 16 | (u_int64_t)(key->rsc)[1] << 8 | (u_int64_t)(key->rsc)[0]));
