# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c" 2
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/uslcom.c"
struct uslcom_softc {
...
uslcom_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(uslcom_devs), sizeof (uslcom_devs) / sizeof ((uslcom_devs)[0]), sizeof ((uslcom_devs)[0]), (uaa->vendor), (uaa->product)) != ((void *)0)) ?
     13 : 0;
}
...
uslcom_open(void *vsc, int portno)
{
 ...
 req.bRequest = 0x00;
 ((req.wValue)[0] = (u_int8_t)(0x01), (req.wValue)[1] = (u_int8_t)((0x01) >> 8));
...
uslcom_close(void *vsc, int portno)
{
 ...
 ((req.wIndex)[0] = (u_int8_t)(portno), (req.wIndex)[1] = (u_int8_t)((portno) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
 usbd_do_request(sc->sc_udev, &req, ((void *)0));
}

void
uslcom_set(void *vsc, int portno, int reg64, int onoff)
{
 struct uslcom_softc *sc = vsc;
 usb_device_request_t req;
 int ctl;
...
uslcom_param(void *vsc, int portno, struct termios *t)
{
 ...
 ((req.wIndex)[0] = (u_int8_t)(portno), (req.wIndex)[1] = (u_int8_t)((portno) >> 8));
 ((req.wLength)[0] = (u_int8_t)(sizeof(baudrate)), (req.wLength)[1] = (u_int8_t)((sizeof(baudrate)) >> 8));
 ...
 if (((t->c_cflag) & (0x00010000))) {
  ...
  flowctrl[0] = __extension__({ __uint32_t __swap32gen_x = (0x00000001 | 0x00000008); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
  flowctrl[1] = __extension__({ __uint32_t __swap32gen_x = (0x00000080); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
 } else {

  flowctrl[0] = __extension__({ __uint32_t __swap32gen_x = (0x00000001); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
  flowctrl[1] = __extension__({ __uint32_t __swap32gen_x = (0x00000040); (__uint32_t)((__swap32gen_x & 0xff) << 24 | (__swap32gen_x & 0xff00) << 8 | (__swap32gen_x & 0xff0000) >> 8 | (__swap32gen_x & 0xff000000) >> 24); });
 }
 flowctrl[2] = 0;
 flowctrl[3] = 0;
 ...
 ((req.wValue)[0] = (u_int8_t)(0), (req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(portno), (req.wIndex)[1] = (u_int8_t)((portno) >> 8));
 ((req.wLength)[0] = (u_int8_t)(sizeof(flowctrl)), (req.wLength)[1] = (u_int8_t)((sizeof(flowctrl)) >> 8));
...
uslcom_break(void *vsc, int portno, int onoff)
{
 struct uslcom_softc *sc = vsc;
 usb_device_request_t req;
 int brk = onoff ? 0x01 : 0x00;

 req.bmRequestType = 0x41;
 req.bRequest = 0x05;
 ((req.wValue)[0] = (u_int8_t)(brk), (req.wValue)[1] = (u_int8_t)((brk) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(portno), (req.wIndex)[1] = (u_int8_t)((portno) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
 usbd_do_request(sc->sc_udev, &req, ((void *)0));
}
