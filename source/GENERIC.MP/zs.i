# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
void device_register(struct device *, void *);
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
int bppopen(dev_t, int, int, struct proc *); int bppclose(dev_t, int, int, struct proc *); int bppread(dev_t, struct uio *, int); int bppwrite(dev_t, struct uio *, int); int bppioctl(dev_t, u_long, caddr_t, int, struct proc *); int bppstop(struct tty *, int); struct tty *bpptty(dev_t); int bpppoll(dev_t, int, struct proc *); paddr_t bppmmap(dev_t, off_t, int); int bppkqfilter(dev_t, struct knote *);
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/z8530var.h" 1
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/z8530var.h"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.h" 1
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.h"
struct zs_chanstate;
struct zsops {
...
struct zs_chanstate {
 ...
 volatile uint8_t *cs_reg_csr;
 volatile uint8_t *cs_reg_data;
 ...
 int cs_defspeed;
 int cs_defcflag;
# 95 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.h"
 uint8_t cs_creg[17];
 uint8_t cs_preg[17];
 int cs_heldchange;

 uint8_t cs_rr0;
 uint8_t cs_rr0_delta;
 uint8_t cs_rr0_mask;
 uint8_t cs_rr0_dcd;
 uint8_t cs_rr0_cts;
 uint8_t cs_rr0_pps;
...
# 148 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530sc.h"
...
extern int zs_major;
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/z8530var.h" 2

struct zsc_softc {
 struct device zsc_dev;
 bus_space_tag_t zsc_bustag;
 bus_dma_tag_t zsc_dmatag;
 struct zs_chanstate *zsc_cs[2];
...
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/machine/z8530var.h"
u_char zs_read_reg(struct zs_chanstate *cs, u_char reg64);
u_char zs_read_csr(struct zs_chanstate *cs);
u_char zs_read_data(struct zs_chanstate *cs);

void zs_write_reg(struct zs_chanstate *cs, u_char reg64, u_char val);
void zs_write_csr(struct zs_chanstate *cs, u_char val);
void zs_write_data(struct zs_chanstate *cs, u_char val);
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/z8530reg.h" 1
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhcvar.h" 1
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/fhcvar.h"
struct fhc_reg {
 u_int32_t fbr_slot;
...
struct fhc_softc {
 ...
 bus_space_handle_t sc_preg;
 bus_space_handle_t sc_ireg;
 bus_space_handle_t sc_freg;
 bus_space_handle_t sc_sreg;
 bus_space_handle_t sc_ureg;
 bus_space_handle_t sc_treg;
...
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/cons.h" 1
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/cons.h"
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c" 2
...
int zs_def_cflag = (0x00000800 | 0x00000300 | 0x00004000);
int zs_major = 12;
# 87 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
struct zschan {
 volatile u_char zc_csr;
 u_char zc_xxx0;
 volatile u_char zc_data;
 u_char zc_xxx1;
};
struct zsdevice {
...
# 230 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
  zsaddr = (struct zsdevice *)
      (unsigned long int)sa->sa_promvaddrs[0];
 } else {
  if (bus_space_map(sa->sa_bustag, ((((bus_addr_t)sa->sa_reg[0].sbr_slot)<<32)|(sa->sa_reg[0].sbr_offset)), sa->sa_reg[0].sbr_size, 0x0002, &kvaddr) != 0) {
 ...
 zs_attach(zsc, zsaddr, sa->sa_intr[0].sbi_pri);
}
...
# 283 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
  zsaddr = (struct zsdevice *)
      (unsigned long int)fa->fa_promvaddrs[0];
 } else {
  if (bus_space_map(fa->fa_bustag, ((((bus_addr_t)fa->fa_reg[0].fbr_slot)<<32)|(fa->fa_reg[0].fbr_offset)), fa->fa_reg[0].fbr_size, 0x0002, &kvaddr) != 0) {
 ...
 int pri;
{
 ...
 for (channel = 0; channel < 2; channel++) {
  ...
  if ((zsc_args.hwflags & 1) != 0) {
   zs_conschan_get = zc;
  }
  if ((zsc_args.hwflags & 2) != 0) {
   zs_conschan_put = zc;
  }
  ...
  __builtin_bcopy((zs_init_reg), (cs->cs_creg), (16));
  __builtin_bcopy((zs_init_reg), (cs->cs_preg), (16));
  ...
  if (!(child =
        config_found_sm((&zsc->zsc_dev), ((void *)&zsc_args), (zs_print), ((void *)0)))) {
 ...
 if (bus_intr_establish(zsc->zsc_bustag, pri, 12, 0, zshard,
     zsc, zsc->zsc_dev.dv_xname) == ((void *)0))
...
# 495 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
 _splx(s);
}
 ...
 struct zs_chanstate *cs;
{
 ...
 return (((cs->cs_brg_clk) / 2 / ((tconst) + 2)));
}
 ...
 int bps;
{
 ...
 tconst = ((((cs->cs_brg_clk) + (bps)) / (2 * (bps))) - 2);
 if (tconst < 0)
  return (22);


 real_bps = ((cs->cs_brg_clk) / 2 / ((tconst) + 2));
...
{
 int s;
# 563 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
 s = _splraise(12);
 cs->cs_rr0_pps = 0;
 if ((cflag & (0x00008000 | 0x00100000)) != 0) {
  cs->cs_rr0_dcd = 0;
  if ((cflag & 0x00100000) == 0)
   cs->cs_rr0_pps = 0x08;
 } else
  cs->cs_rr0_dcd = 0x08;
 if ((cflag & 0x00010000) != 0) {
  cs->cs_wr5_dtr = 0x80;
  cs->cs_wr5_rts = 0x02;
  cs->cs_rr0_cts = 0x20;
...
# 676 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
void
zs_abort(cs)
 struct zs_chanstate *cs;
{
...
# 759 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
 zc->zc_data = c;
 delay(2);

 _splx(s);
}
# 773 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../arch/sparc64/dev/zs.c"
static int
zscngetc(dev)
 dev_t dev;
{
