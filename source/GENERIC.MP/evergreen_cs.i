# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c"
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c"
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreend.h" 1
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_reg_safe.h" 1
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/cayman_reg_safe.h" 1
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c" 2
...
struct evergreen_cs_track {
 ...
 _Bool sx_misc_kill_all_prims;
 _Bool cb_dirty;
 _Bool db_dirty;
 _Bool streamout_dirty;
 u32 htile_offset;
 u32 htile_surface;
        ...
        const char *prefix)
{
 ...
 palign = (((64)>(track->group_size / surf->bpe))?(64):(track->group_size / surf->bpe));
 surf->layer_size = surf->nbx * surf->nby * surf->bpe * surf->nsamples;
 ...
 if (surf->nbx & (palign - 1)) {
  if (prefix) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d %s pitch %d invalid must be aligned with %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 215, prefix, surf->nbx, palign);
          ...
          const char *prefix)
{
 ...
 if ((surf->nbx & (palign - 1))) {
  if (prefix) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d %s pitch %d invalid must be aligned with %d (%d %d %d)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 239, prefix, surf->nbx, palign, track->group_size, surf->bpe, surf->nsamples);
 ...
 if ((surf->nby & (8 - 1))) {
  if (prefix) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d %s height %d invalid must be aligned with 8\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 246, prefix, surf->nby);
          ...
          const char *prefix)
{
 ...
 if ((surf->nbx & (palign - 1))) {
  if (prefix) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d %s pitch %d invalid must be aligned with %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 281, prefix, surf->nbx, palign);
 ...
 if ((surf->nby & (halign - 1))) {
  if (prefix) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d %s height %d invalid must be aligned with %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 288, prefix, surf->nby, halign);
       ...
       const char *prefix)
{
 ...
 default:
  printf("drm:pid%d:%s *WARNING* " "%s:%d %s invalid array mode %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 314, prefix, surf->mode);
           ...
           const char *prefix)
{
 ...
 case 2:
  return 0;
 default:
  printf("drm:pid%d:%s *WARNING* " "%s:%d %s invalid array mode %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 333, prefix, surf->mode);
 ...
 default:
  printf("drm:pid%d:%s *WARNING* " "%s:%d %s invalid number of banks %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 344, prefix, surf->nbanks);
 ...
 default:
  printf("drm:pid%d:%s *WARNING* " "%s:%d %s invalid bankw %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 354, prefix, surf->bankw);
 ...
 default:
  printf("drm:pid%d:%s *WARNING* " "%s:%d %s invalid bankh %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 364, prefix, surf->bankh);
 ...
 default:
  printf("drm:pid%d:%s *WARNING* " "%s:%d %s invalid macro tile aspect %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 374, prefix, surf->mtilea);
 ...
 default:
  printf("drm:pid%d:%s *WARNING* " "%s:%d %s invalid tile split %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 387, prefix, surf->tsplit);
...
static int evergreen_cs_track_validate_cb(struct radeon_cs_parser *p, unsigned id)
{
 ...
 mslice = (((track->cb_color_view[id]) >> 13) & 0x7FF) + 1;
 pitch = track->cb_color_pitch[id];
 slice = track->cb_color_slice[id];
 surf.nbx = (pitch + 1) * 8;
 surf.nby = ((slice + 1) * 64) / surf.nbx;
 surf.mode = (((track->cb_color_info[id]) >> 8) & 0xF);
 surf.format = (((track->cb_color_info[id]) >> 2) & 0x3F);
 surf.tsplit = (((track->cb_color_attrib[id]) >> 5) & 0xf);
 surf.nbanks = (((track->cb_color_attrib[id]) >> 10) & 0x3);
 surf.bankw = (((track->cb_color_attrib[id]) >> 13) & 0x3);
 surf.bankh = (((track->cb_color_attrib[id]) >> 16) & 0x3);
 surf.mtilea = (((track->cb_color_attrib[id]) >> 19) & 0x3);
 surf.nsamples = 1;

 if (!r600_fmt_is_valid_color(surf.format)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d cb invalid format %d for %d (0x%08x)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 418, surf.format, id, track->cb_color_info[id]);
 ...
 if (r) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d cb[%d] invalid (0x%08x 0x%08x 0x%08x 0x%08x)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 432, id, track->cb_color_pitch[id], track->cb_color_slice[id], track->cb_color_attrib[id], track->cb_color_info[id]);
 ...
 if (offset & (surf.base_align - 1)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d cb[%d] bo base %ld not aligned with %ld\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 439, id, offset, surf.base_align);
 ...
 if (offset > radeon_bo_size(track->cb_color_bo[id])) {
  ...
  printf("drm:pid%d:%s *WARNING* " "%s:%d cb[%d] bo too small (layer size %d, " "offset %d, max layer %d, bo size %ld, slice %d)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 482, id, surf.layer_size, track->cb_color_bo_offset[id] << 8, mslice, radeon_bo_size(track->cb_color_bo[id]), slice);




  printf("drm:pid%d:%s *WARNING* " "%s:%d problematic surf: (%d %d) (%d %d %d %d %d %d %d)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 487, surf.nbx, surf.nby, surf.mode, surf.bpe, surf.nsamples, surf.bankw, surf.bankh, surf.tsplit, surf.mtilea);
      ...
      unsigned nbx, unsigned nby)
{
 ...
 if (track->htile_bo == ((void *)0)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d htile enabled without htile surface 0x%08x\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 503, track->db_z_info);

  return -22;
 }

 if ((((track->htile_surface) >> 2) & 0x1)) {

  nbx = ((((nbx) + ((16 * 8) - 1)) / (16 * 8)) * (16 * 8));

  nby = ((((nby) + ((track->npipes * 8) - 1)) / (track->npipes * 8)) * (track->npipes * 8));
 } else {
  ...
  case 8:
   ...
   nbx = ((((nbx) + ((64 * 8) - 1)) / (64 * 8)) * (64 * 8));
   nby = ((((nby) + ((64 * 8) - 1)) / (64 * 8)) * (64 * 8));
   break;
  case 4:

   nbx = ((((nbx) + ((64 * 8) - 1)) / (64 * 8)) * (64 * 8));
   nby = ((((nby) + ((32 * 8) - 1)) / (32 * 8)) * (32 * 8));
   break;
  case 2:

   nbx = ((((nbx) + ((32 * 8) - 1)) / (32 * 8)) * (32 * 8));
   nby = ((((nby) + ((32 * 8) - 1)) / (32 * 8)) * (32 * 8));
   break;
  case 1:

   nbx = ((((nbx) + ((32 * 8) - 1)) / (32 * 8)) * (32 * 8));
   nby = ((((nby) + ((16 * 8) - 1)) / (16 * 8)) * (16 * 8));
   break;
  default:
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid num pipes %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 540, track->npipes);
 ...
 size = ((((nbx * nby * 4)+((track->npipes * (2 << 10))-1))/(track->npipes * (2 << 10)))*(track->npipes * (2 << 10)));
 size += track->htile_offset;

 if (size > radeon_bo_size(track->htile_bo)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d htile surface too small %ld for %ld (%d %d)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 554, radeon_bo_size(track->htile_bo), size, nbx, nby);
...
static int evergreen_cs_track_validate_stencil(struct radeon_cs_parser *p)
{
 ...
 mslice = (((track->db_depth_view) >> 13) & 0x7FF) + 1;
 pitch = (((track->db_depth_size) >> 0) & 0x7FF);
 slice = track->db_depth_slice;
 surf.nbx = (pitch + 1) * 8;
 surf.nby = ((slice + 1) * 64) / surf.nbx;
 surf.mode = (((track->db_z_info) >> 4) & 0xF);
 surf.format = (((track->db_s_info) >> 0) & 0x1);
 surf.tsplit = (((track->db_s_info) >> 8) & 0x7);
 surf.nbanks = (((track->db_z_info) >> 12) & 0x3);
 surf.bankw = (((track->db_z_info) >> 16) & 0x3);
 surf.bankh = (((track->db_z_info) >> 20) & 0x3);
 surf.mtilea = (((track->db_z_info) >> 24) & 0x3);
 surf.nsamples = 1;

 if (surf.format != 1) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d stencil invalid format %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 584, surf.format);

  return -22;
 }

 surf.format = 0x00000001;
 ...
 r = evergreen_surface_check(p, &surf, ((void *)0));
 if (r) {




  surf.format = 0x0000001A;
  r = evergreen_surface_check(p, &surf, "stencil");
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d stencil invalid (0x%08x 0x%08x 0x%08x 0x%08x)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 606, track->db_depth_size, track->db_depth_slice, track->db_s_info, track->db_z_info);
 ...
 if (offset & (surf.base_align - 1)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d stencil read bo base %ld not aligned with %ld\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 614, offset, surf.base_align);

  return -22;
 }
 offset += surf.layer_size * mslice;
 if (offset > radeon_bo_size(track->db_s_read_bo)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d stencil read bo too small (layer size %d, " "offset %ld, max layer %d, bo size %ld)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 623, surf.layer_size, (unsigned long)track->db_s_read_offset << 8, mslice, radeon_bo_size(track->db_s_read_bo));




  printf("drm:pid%d:%s *WARNING* " "%s:%d stencil invalid (0x%08x 0x%08x 0x%08x 0x%08x)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 626, track->db_depth_size, track->db_depth_slice, track->db_s_info, track->db_z_info);
 ...
 if (offset & (surf.base_align - 1)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d stencil write bo base %ld not aligned with %ld\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 633, offset, surf.base_align);

  return -22;
 }
 offset += surf.layer_size * mslice;
 if (offset > radeon_bo_size(track->db_s_write_bo)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d stencil write bo too small (layer size %d, " "offset %ld, max layer %d, bo size %ld)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 642, surf.layer_size, (unsigned long)track->db_s_write_offset << 8, mslice, radeon_bo_size(track->db_s_write_bo));
...
static int evergreen_cs_track_validate_depth(struct radeon_cs_parser *p)
{
 ...
 surf.nby = ((slice + 1) * 64) / surf.nbx;
 surf.mode = (((track->db_z_info) >> 4) & 0xF);
 surf.format = (((track->db_z_info) >> 0) & 0x3);
 surf.tsplit = (((track->db_z_info) >> 8) & 0x7);
 surf.nbanks = (((track->db_z_info) >> 12) & 0x3);
 surf.bankw = (((track->db_z_info) >> 16) & 0x3);
 surf.bankh = (((track->db_z_info) >> 20) & 0x3);
 surf.mtilea = (((track->db_z_info) >> 24) & 0x3);
 ...
 case 0x00000003:
  ...
  break;
 default:
  printf("drm:pid%d:%s *WARNING* " "%s:%d depth invalid format %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 689, surf.format);
 ...
 if (r) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d depth invalid (0x%08x 0x%08x 0x%08x)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 697, track->db_depth_size, track->db_depth_slice, track->db_z_info);
 ...
 if (r) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d depth invalid (0x%08x 0x%08x 0x%08x)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 705, track->db_depth_size, track->db_depth_slice, track->db_z_info);
 ...
 if (offset & (surf.base_align - 1)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d stencil read bo base %ld not aligned with %ld\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 712, offset, surf.base_align);

  return -22;
 }
 offset += surf.layer_size * mslice;
 if (offset > radeon_bo_size(track->db_z_read_bo)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d depth read bo too small (layer size %d, " "offset %ld, max layer %d, bo size %ld)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 721, surf.layer_size, (unsigned long)track->db_z_read_offset << 8, mslice, radeon_bo_size(track->db_z_read_bo));
 ...
 if (offset & (surf.base_align - 1)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d stencil write bo base %ld not aligned with %ld\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 728, offset, surf.base_align);

  return -22;
 }
 offset += surf.layer_size * mslice;
 if (offset > radeon_bo_size(track->db_z_write_bo)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d depth write bo too small (layer size %d, " "offset %ld, max layer %d, bo size %ld)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 737, surf.layer_size, (unsigned long)track->db_z_write_offset << 8, mslice, radeon_bo_size(track->db_z_write_bo));
            ...
            unsigned idx)
{
 ...
 dim = (((texdw[0]) >> 0) & 0x7);
 llevel = (((texdw[5]) >> 0) & 0xF);
 mslice = (((texdw[5]) >> 17) & 0x1FFF) + 1;
 width = (((texdw[0]) >> 18) & 0x3FFF) + 1;
 height = (((texdw[1]) >> 0) & 0x3FFF) + 1;
 depth = (((texdw[1]) >> 14) & 0x1FFF) + 1;
 surf.format = (((texdw[7]) >> 0) & 0x3F);
 surf.nbx = ((((texdw[0]) >> 6) & 0xFFF) + 1) * 8;
 surf.nbx = r600_fmt_get_nblocksx(surf.format, surf.nbx);
 surf.nby = r600_fmt_get_nblocksy(surf.format, height);
 surf.mode = (((texdw[1]) >> 28) & 0xF);
 surf.tsplit = (((texdw[6]) >> 29) & 0x7);
 surf.nbanks = (((texdw[7]) >> 16) & 0x3);
 surf.bankw = (((texdw[7]) >> 8) & 0x3);
 surf.bankh = (((texdw[7]) >> 10) & 0x3);
 surf.mtilea = (((texdw[7]) >> 6) & 0x3);
 surf.nsamples = 1;
 toffset = texdw[2] << 8;
 moffset = texdw[3] << 8;

 if (!r600_fmt_is_valid_texture(surf.format, p->family)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d texture invalid format %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 793, surf.format);
 ...
 case 0x00000002:
  break;
 default:
  printf("drm:pid%d:%s *WARNING* " "%s:%d texture invalid dimension %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 814, dim);
 ...
 evergreen_surface_check(p, &surf, ((void *)0));
 surf.nby = ((((surf.nby)+((surf.halign)-1))/(surf.halign))*(surf.halign));

 r = evergreen_surface_check(p, &surf, "texture");
 if (r) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d texture invalid 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x 0x%08x\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 831, texdw[0], texdw[1], texdw[4], texdw[5], texdw[6], texdw[7]);
 ...
 if (toffset & (surf.base_align - 1)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d texture bo base %ld not aligned with %ld\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 838, toffset, surf.base_align);

  return -22;
 }
 if (moffset & (surf.base_align - 1)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d mipmap bo base %ld not aligned with %ld\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 843, moffset, surf.base_align);
 ...
 if (toffset > radeon_bo_size(texture)) {
  printf("drm:pid%d:%s *WARNING* " "%s:%d texture bo too small (layer size %d, " "offset %ld, max layer %d, depth %d, bo size %ld) (%d %d)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 857, surf.layer_size, (unsigned long)texdw[2] << 8, mslice, depth, radeon_bo_size(texture), surf.nbx, surf.nby);
 ...
 if (!mipmap) {
  if (llevel) {
   printf("drm:pid%d:%s *WARNING* " "%s:%i got NULL MIP_ADDRESS relocation\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 864);
 ...
 for (i = 1; i <= llevel; i++) {
  ...
  case 2:
   break;
  default:
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid array mode %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 895, surf.mode);

   return -22;
  }
  surf.nbx = ((((surf.nbx)+((surf.palign)-1))/(surf.palign))*(surf.palign));
  surf.nby = ((((surf.nby)+((surf.halign)-1))/(surf.halign))*(surf.halign));
  ...
  if (moffset > radeon_bo_size(mipmap)) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d mipmap [%d] bo too small (layer size %d, " "offset %ld, coffset %ld, max layer %d, depth %d, " "bo size %ld) level0 (%d %d %d)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 918, i, surf.layer_size, (unsigned long)texdw[3] << 8, moffset, mslice, d, radeon_bo_size(mipmap), width, height, depth);
   ...
   printf("drm:pid%d:%s *WARNING* " "%s:%d problematic surf: (%d %d) (%d %d %d %d %d %d %d)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 923, surf.nbx, surf.nby, surf.mode, surf.bpe, surf.nsamples, surf.bankw, surf.bankh, surf.tsplit, surf.mtilea);
...
static int evergreen_cs_track_check(struct radeon_cs_parser *p)
{
   ...
   if (buffer_mask & (1 << i)) {
    if (track->vgt_strmout_bo[i]) {
     ...
     if (offset > radeon_bo_size(track->vgt_strmout_bo[i])) {
      printf("error: [" "drm" ":pid%d:%s] *ERROR* " "streamout %d bo too small: 0x%llx, 0x%lx\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i, offset, radeon_bo_size(track->vgt_strmout_bo[i]));


      return -22;
     }
    } else {
     printf("drm:pid%d:%s *WARNING* " "No buffer for streamout %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , i);
     return -22;
    }
   }
  }
  track->streamout_dirty = 0;
 }
 ...
 if (track->cb_dirty) {
  ...
  for (i = 0; i < 8; i++) {
   u32 format = (((track->cb_color_info[i]) >> 2) & 0x3F);

   if (format != 0x00000000 &&
       (tmp >> (i * 4)) & 0xF) {

    if (track->cb_color_bo[i] == ((void *)0)) {
     printf("drm:pid%d:%s *WARNING* " "%s:%d mask 0x%08X | 0x%08X no cb for %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 981, track->cb_target_mask, track->cb_shader_mask, i);
 ...
 if (track->db_dirty) {
  ...
  if ((((track->db_s_info) >> 0) & 0x1) != 0 &&
      (((track->db_depth_control) >> 0) & 0x1)) {
   r = evergreen_cs_track_validate_stencil(p);
   if (r)
    return r;
  }

  if ((((track->db_z_info) >> 0) & 0x3) != 0x00000000 &&
      (((track->db_depth_control) >> 1) & 0x1)) {
...
# 1023 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c"
         ...
         unsigned idx)
{
 ...
 if (idx >= ib_chunk->length_dw) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Can not parse packet at %d after CS end %d !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , idx, ib_chunk->length_dw);

  return -22;
 }
 header = radeon_get_ib_value(p, idx);
 pkt->idx = idx;
 pkt->type = (((header) >> 30) & 3);
 pkt->count = (((header) >> 16) & 0x3FFF);
 pkt->one_reg_wr = 0;
 switch (pkt->type) {
 case 0:
  pkt->reg64 = (((header) & 0xFFFF) << 2);
  break;
 case 3:
  pkt->opcode = (((header) >> 8) & 0xFF);
  break;
 case 2:
  pkt->count = -1;
  break;
 default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown packet type %d at %d !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , pkt->type, idx);
  return -22;
 }
 if ((pkt->count + 1 + pkt->idx) >= ib_chunk->length_dw) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Packet (%d:%d:%d) end after CS buffer (%d) !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , pkt->idx, pkt->type, pkt->count, ib_chunk->length_dw);

  return -22;
 }
 return 0;
}
# 1073 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c"
static int evergreen_cs_packet_next_reloc(struct radeon_cs_parser *p,
       struct radeon_cs_reloc **cs_reloc)
{
 ...
 *cs_reloc = ((void *)0);
 ...
 if (p3reloc.type != 3 || p3reloc.opcode != 0x10) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "No packet3 for relocation for packet at %d.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , p3reloc.idx);
...
static _Bool evergreen_cs_packet_next_is_pkt3_nop(struct radeon_cs_parser *p)
{
 struct radeon_cs_packet p3reloc;
 int r;
...
# 1143 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c"
static int evergreen_cs_packet_parse_vline(struct radeon_cs_parser *p)
{
 ...
 int crtc_id;
 int r;
 uint32_t header, h_idx, reg64, wait_reg_mem_info;
 ...
 if (wait_reg_mem.type != 3 ||
     wait_reg_mem.opcode != 0x3C) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "vline wait missing WAIT_REG_MEM segment\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -22;
 }
 ...
 if (wait_reg_mem_info & 0x10) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "vline WAIT_REG_MEM waiting on MEM rather than REG\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -22;
 }

 if ((wait_reg_mem_info & 0x7) != 0x3) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "vline WAIT_REG_MEM function not equal\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -22;
 }
 if ((radeon_get_ib_value(p, wait_reg_mem.idx + 2) << 2) != 0x6bb8) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "vline WAIT_REG_MEM bad reg\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -22;
 }

 if (radeon_get_ib_value(p, wait_reg_mem.idx + 5) != (1 << 12)) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "vline WAIT_REG_MEM bad bit mask\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  return -22;
 }
 ...
 reg64 = (((header) & 0xFFFF) << 2);
 obj = drm_mode_object_find(p->rdev->ddev, crtc_id, 0xcccccccc);
 if (!obj) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "cannot find crtc %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , crtc_id);
  return -22;
 }
 crtc = ({ __typeof( ((struct drm_crtc *)0)->base ) *__mptr = (obj); (struct drm_crtc *)( (char *)__mptr - __builtin_offsetof(struct drm_crtc, base) );});
 radeon_crtc = ({ __typeof( ((struct radeon_crtc *)0)->base ) *__mptr = (crtc); (struct radeon_crtc *)( (char *)__mptr - __builtin_offsetof(struct radeon_crtc, base) );});
 crtc_id = radeon_crtc->crtc_id;

 if (!crtc->enabled) {

  ib[h_idx + 2] = (0x80000000 | ((((0)) << 0) & (0x3fffffff << 0)));
  ib[h_idx + 3] = (0x80000000 | ((((0)) << 0) & (0x3fffffff << 0)));
  ib[h_idx + 4] = (0x80000000 | ((((0)) << 0) & (0x3fffffff << 0)));
  ib[h_idx + 5] = (0x80000000 | ((((0)) << 0) & (0x3fffffff << 0)));
  ib[h_idx + 6] = (0x80000000 | ((((0)) << 0) & (0x3fffffff << 0)));
  ib[h_idx + 7] = (0x80000000 | ((((0)) << 0) & (0x3fffffff << 0)));
  ib[h_idx + 8] = (0x80000000 | ((((0)) << 0) & (0x3fffffff << 0)));
 } else {
  switch (reg64) {
  case 0x6b08:
   header &= ~0x0000ffff;
   header |= (0x6b08 + radeon_crtc->crtc_offset) >> 2;
   ib[h_idx] = header;
   ib[h_idx + 4] = (0x6bb8 + radeon_crtc->crtc_offset) >> 2;
   break;
  default:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "unknown crtc reloc\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
 }
 return 0;
          ...
          struct radeon_cs_packet *pkt)
{
 ...
 idx = pkt->idx + 1;
 reg64 = pkt->reg64;
 for (i = 0; i <= pkt->count; i++, idx++, reg64 += 4) {
  r = evergreen_packet0_check(p, pkt, idx, reg64);
  if (r) {
   return r;
  }
 }
...
# 1286 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c"
static int evergreen_cs_check_reg(struct radeon_cs_parser *p, u32 reg64, u32 idx)
{
 ...
 if (p->rdev->family >= CHIP_CAYMAN)
  last_reg = (sizeof((cayman_reg_safe_bm)) / sizeof((cayman_reg_safe_bm)[0]));
 else
  last_reg = (sizeof((evergreen_reg_safe_bm)) / sizeof((evergreen_reg_safe_bm)[0]));

 i = (reg64 >> 7);
 if (i >= last_reg) {
  printf("drm:pid%d:%s *WARNING* " "forbidden register 0x%08x at %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , reg64, idx);
  return -22;
 }
 m = 1 << ((reg64 >> 2) & 31);
 if (p->rdev->family >= CHIP_CAYMAN) {
 ...
 case 0x8c60:
  ...
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "bad SET_CONTEXT_REG " "0x%04X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , reg64);
 ...
 case 0x28040:
  ...
  if (!(p->cs_flags & 0x01)) {
   ...
   ib[idx] &= ~((0xf) << 4);
   track->db_z_info &= ~((0xf) << 4);
   ib[idx] |= ((evergreen_cs_get_aray_mode(reloc->lobj.tiling_flags)) << 4);
   track->db_z_info |= ((evergreen_cs_get_aray_mode(reloc->lobj.tiling_flags)) << 4);
   if (reloc->lobj.tiling_flags & 0x1) {
    ...
    evergreen_tiling_fields(reloc->lobj.tiling_flags,
       ...
       &tile_split);
    ib[idx] |= (((evergreen_cs_get_num_banks(track->nbanks)) & 0x3) << 12);
    ib[idx] |= (((tile_split) & 0x7) << 8) |
      (((bankw) & 0x3) << 16) |
      (((bankh) & 0x3) << 20) |
      (((mtaspect) & 0x3) << 24);
   }
 ...
 case 0x85F8:
  r = evergreen_cs_packet_next_reloc(p, &reloc);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "missing reloc for CP_COHER_BASE " "0x%04X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , reg64);
 ...
 case 0x28C04:
  ...
  tmp = radeon_get_ib_value(p, idx) & 0x3;
 ...
 case 0x28BE0:
  ...
  tmp = radeon_get_ib_value(p, idx) & 0x7;
  track->nsamples = 1 << tmp;
  break;
 case 0x28c6c:
 case 0x28ca8:
 ...
 case 0x28e14:
  ...
  if (!(p->cs_flags & 0x01)) {
   ...
   ib[idx] |= ((evergreen_cs_get_aray_mode(reloc->lobj.tiling_flags)) << 8);
   track->cb_color_info[tmp] |= ((evergreen_cs_get_aray_mode(reloc->lobj.tiling_flags)) << 8);
  }
  track->cb_dirty = 1;
  break;
 case 0x28e50:
  ...
  if (!(p->cs_flags & 0x01)) {
   if (reloc->lobj.tiling_flags & 0x1) {
    ...
    evergreen_tiling_fields(reloc->lobj.tiling_flags,
       &bankw, &bankh, &mtaspect,
       &tile_split);
    ib[idx] |= (((evergreen_cs_get_num_banks(track->nbanks)) & 0x3) << 10);
    ib[idx] |= (((tile_split) & 0x7) << 5) |
        (((bankw) & 0x3) << 13) |
        (((bankh) & 0x3) << 16) |
        (((mtaspect) & 0x3) << 19);
   }
  }
  tmp = ((reg64 - 0x28c74) / 0x3c);
 ...
 case 0x28dec:
 case 0x28e28:
  tmp = (reg64 - 0x28c84) / 0x3c;
  r = evergreen_cs_packet_next_reloc(p, &reloc);
  if (r) {
   printf("drm:pid%d:%s *ERROR* " "bad SET_CONTEXT_REG 0x%04X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , reg64);
   return -22;
  }
  ib[idx] += (u32)((reloc->lobj.gpu_offset >> 8) & 0xffffffff);
 ...
 case 0x9010:
  if (p->rdev->family >= CHIP_CAYMAN) {
   printf("drm:pid%d:%s *WARNING* " "bad SET_CONFIG_REG " "0x%04X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , reg64);
...
static _Bool evergreen_is_safe_reg(struct radeon_cs_parser *p, u32 reg64, u32 idx)
{
 u32 last_reg, m, i;
       ...
       struct radeon_cs_packet *pkt)
{
 ...
 unsigned idx;
 unsigned i;
 unsigned start_reg, end_reg, reg64;
 int r;
 u32 idx_value;
 ...
 case 0x20:
 {
  ...
  if (pkt->count != 1) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET PREDICATION\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  ...
  if (pred_op > 2) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET PREDICATION operation %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , pred_op);
   return -22;
  }
  ...
  ib[idx + 0] = offset;
  ib[idx + 1] = (tmp & 0xffffff00) | (((u32)(((offset) >> 16) >> 16)) & 0xff);
 }
 break;
 case 0x28:
  if (pkt->count != 1) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad CONTEXT_CONTROL\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  break;
 case 0x2A:
 ...
 case 0x12:
  if (pkt->count) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad INDEX_TYPE/NUM_INSTANCES/CLEAR_STATE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  break;
 case 0x14:
  if (p->rdev->family < CHIP_CAYMAN) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad PACKET3_DEALLOC_STATE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  if (pkt->count) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad INDEX_TYPE/NUM_INSTANCES/CLEAR_STATE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 ...
 case 0x26:
 {
  ...
  if (pkt->count != 1) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad INDEX_BASE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_packet_next_reloc(p, &reloc);
  if (r) {
  ...
  ib[idx+0] = offset;
  ib[idx+1] = ((u32)(((offset) >> 16) >> 16)) & 0xff;

  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2086);
   return r;
  }
  break;
 }
 case 0x2B:
 {
  uint64_t offset;
  if (pkt->count != 3) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DRAW_INDEX\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_packet_next_reloc(p, &reloc);
  if (r) {
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2113);
   return r;
  }
  break;
 }
 case 0x27:
 {
  ...
  if (pkt->count != 4) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DRAW_INDEX_2\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_packet_next_reloc(p, &reloc);
  if (r) {
  ...
  ib[idx+1] = offset;
  ib[idx+2] = ((u32)(((offset) >> 16) >> 16)) & 0xff;

  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2141);
   return r;
  }
  break;
 }
 case 0x2D:
  if (pkt->count != 1) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DRAW_INDEX_AUTO\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2153, idx);
   return r;
  }
  break;
 case 0x30:
  if (pkt->count != 2) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DRAW_INDEX_MULTI_AUTO\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2164, idx);
   return r;
  }
  break;
 case 0x2E:
  if (pkt->count < 2) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DRAW_INDEX_IMMD\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2175);
   return r;
  }
  break;
 case 0x29:
  if (pkt->count != 2) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DRAW_INDEX_OFFSET\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2186);
   return r;
  }
  break;
 case 0x35:
  if (pkt->count != 3) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DRAW_INDEX_OFFSET_2\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2197);
   return r;
  }
  break;
 case 0x15:
  if (pkt->count != 3) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DISPATCH_DIRECT\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2208, idx);
   return r;
  }
  break;
 case 0x16:
  if (pkt->count != 1) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DISPATCH_INDIRECT\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_packet_next_reloc(p, &reloc);
  if (r) {
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2225);
   return r;
  }
  break;
 case 0x3C:
  if (pkt->count != 5) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad WAIT_REG_MEM\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
 ...
 case 0x41:
 {
  ...
  u64 offset, tmp;
  if (pkt->count != 4) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad CP DMA\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  ...
  if ((((info & 0x60000000) >> 29) != 0) ||
   ...
   if (size % 4) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "CP DMA command requires dw count alignment\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
  }
  if (command & (1 << 26)) {
   ...
   if (((info & 0x60000000) >> 29) != 1) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "CP DMA SAS not supported\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
  } else {
   if (command & (1 << 28)) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "CP DMA SAIC only supported for registers\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
   ...
   if (((info & 0x60000000) >> 29) == 0) {
    r = evergreen_cs_packet_next_reloc(p, &reloc);
    if (r) {
     printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad CP DMA SRC\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
     return -22;
    }
    ...
    if ((tmp + size) > radeon_bo_size(reloc->robj)) {
     printf("drm:pid%d:%s *WARNING* " "CP DMA src buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , tmp + size, radeon_bo_size(reloc->robj));

     return -22;
    }

    ib[idx] = offset;
    ib[idx+1] = (ib[idx+1] & 0xffffff00) | (((u32)(((offset) >> 16) >> 16)) & 0xff);
   } else if (((info & 0x60000000) >> 29) != 2) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad CP DMA SRC_SEL\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
  }
  if (command & (1 << 27)) {
   ...
   if (((info & 0x00300000) >> 20) != 1) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "CP DMA DAS not supported\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
  } else {

   if (command & (1 << 29)) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "CP DMA DAIC only supported for registers\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
   if (((info & 0x00300000) >> 20) == 0) {
    r = evergreen_cs_packet_next_reloc(p, &reloc);
    if (r) {
     printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad CP DMA DST\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
     return -22;
    }
    ...
    if ((tmp + size) > radeon_bo_size(reloc->robj)) {
     printf("drm:pid%d:%s *WARNING* " "CP DMA dst buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , tmp + size, radeon_bo_size(reloc->robj));

     return -22;
    }

    ib[idx+2] = offset;
    ib[idx+3] = ((u32)(((offset) >> 16) >> 16)) & 0xff;
   } else {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad CP DMA DST_SEL\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
  }
  break;
 ...
 case 0x43:
  if (pkt->count != 3) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SURFACE_SYNC\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
 ...
 case 0x46:
  if (pkt->count != 2 && pkt->count != 0) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad EVENT_WRITE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  if (pkt->count) {
   uint64_t offset;
 ...
 case 0x47:
 {
  ...
  if (pkt->count != 4) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad EVENT_WRITE_EOP\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_packet_next_reloc(p, &reloc);
  if (r) {
  ...
  ib[idx+2] = (ib[idx+2] & 0xffffff00) | (((u32)(((offset) >> 16) >> 16)) & 0xff);
  break;
 }
 case 0x48:
 {
  ...
  if (pkt->count != 3) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad EVENT_WRITE_EOS\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_packet_next_reloc(p, &reloc);
  if (r) {
 ...
 case 0x68:
  start_reg = (idx_value << 2) + 0x00008000;
  end_reg = 4 * pkt->count + start_reg - 4;
  if ((start_reg < 0x00008000) ||
      (start_reg >= 0x0000ac00) ||
      (end_reg >= 0x0000ac00)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad PACKET3_SET_CONFIG_REG\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  for (i = 0; i < pkt->count; i++) {
   reg64 = start_reg + (4 * i);
   r = evergreen_cs_check_reg(p, reg64, idx+1+i);
   if (r)
    return r;
  }
  break;
 case 0x69:
  start_reg = (idx_value << 2) + 0x00028000;
  end_reg = 4 * pkt->count + start_reg - 4;
  if ((start_reg < 0x00028000) ||
      (start_reg >= 0x00029000) ||
      (end_reg >= 0x00029000)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad PACKET3_SET_CONTEXT_REG\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  for (i = 0; i < pkt->count; i++) {
   reg64 = start_reg + (4 * i);
 ...
 case 0x6D:
  if (pkt->count % 8) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_RESOURCE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  start_reg = (idx_value << 2) + 0x00030000;
  end_reg = 4 * pkt->count + start_reg - 4;
  if ((start_reg < 0x00030000) ||
      (start_reg >= 0x00038000) ||
      (end_reg >= 0x00038000)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_RESOURCE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  for (i = 0; i < (pkt->count / 8); i++) {
   ...
   switch ((((radeon_get_ib_value(p, idx+1+(i*8)+7)) >> 30) & 3)) {
   case 0x2:

    r = evergreen_cs_packet_next_reloc(p, &reloc);
    if (r) {
     printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_RESOURCE (tex)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
     return -22;
    }
    if (!(p->cs_flags & 0x01)) {
     ib[idx+1+(i*8)+1] |=
      ((evergreen_cs_get_aray_mode(reloc->lobj.tiling_flags)) << 28);
     if (reloc->lobj.tiling_flags & 0x1) {
      unsigned bankw, bankh, mtaspect, tile_split;
      ...
      evergreen_tiling_fields(reloc->lobj.tiling_flags,
         &bankw, &bankh, &mtaspect,
         &tile_split);
      ib[idx+1+(i*8)+6] |= (((tile_split) & 0x7) << 29);
      ib[idx+1+(i*8)+7] |=
       (((bankw) & 0x3) << 8) |
       (((bankh) & 0x3) << 10) |
       (((mtaspect) & 0x3) << 6) |
       (((evergreen_cs_get_num_banks(track->nbanks)) & 0x3) << 16);
     }
    }
    texture = reloc->robj;
   ...
   case 0x3:
   {
    ...
    r = evergreen_cs_packet_next_reloc(p, &reloc);
    if (r) {
     printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_RESOURCE (vtx)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
     return -22;
    }
    ...
    if (p->rdev && (size + offset) > radeon_bo_size(reloc->robj)) {
     ...
     printf("drm:pid%d:%s *WARNING* " "vbo resource seems too big for the bo\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
 ...
 case 0x6A:
  ...
  break;
 case 0x6B:
  start_reg = (idx_value << 2) + 0x0003a500;
  end_reg = 4 * pkt->count + start_reg - 4;
  if ((start_reg < 0x0003a500) ||
      (start_reg >= 0x0003a518) ||
      (end_reg >= 0x0003a518)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_BOOL_CONST\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  break;
 case 0x6C:
  start_reg = (idx_value << 2) + 0x0003a200;
  end_reg = 4 * pkt->count + start_reg - 4;
  if ((start_reg < 0x0003a200) ||
      (start_reg >= 0x0003a500) ||
      (end_reg >= 0x0003a500)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_LOOP_CONST\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  break;
 case 0x6F:
  start_reg = (idx_value << 2) + 0x0003cff0;
  end_reg = 4 * pkt->count + start_reg - 4;
  if ((start_reg < 0x0003cff0) ||
      (start_reg >= 0x0003ff0c) ||
      (end_reg >= 0x0003ff0c)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_CTL_CONST\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  break;
 case 0x6E:
  if (pkt->count % 3) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_SAMPLER\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  start_reg = (idx_value << 2) + 0x0003c000;
  end_reg = 4 * pkt->count + start_reg - 4;
  if ((start_reg < 0x0003c000) ||
      (start_reg >= 0x0003c600) ||
      (end_reg >= 0x0003c600)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_SAMPLER\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
 ...
 case 0x34:
  if (pkt->count != 4) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad STRMOUT_BUFFER_UPDATE (invalid count)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  ...
  if (idx_value & 0x1) {
   ...
   r = evergreen_cs_packet_next_reloc(p, &reloc);
   if (r) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad STRMOUT_BUFFER_UPDATE (missing dst reloc)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
   offset = radeon_get_ib_value(p, idx+1);
   offset += ((u64)(radeon_get_ib_value(p, idx+2) & 0xff)) << 32;
   if ((offset + 4) > radeon_bo_size(reloc->robj)) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad STRMOUT_BUFFER_UPDATE dst bo too small: 0x%llx, 0x%lx\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , offset + 4, radeon_bo_size(reloc->robj));
  ...
  if (((idx_value >> 1) & 0x3) == 2) {
   ...
   r = evergreen_cs_packet_next_reloc(p, &reloc);
   if (r) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad STRMOUT_BUFFER_UPDATE (missing src reloc)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
   offset = radeon_get_ib_value(p, idx+3);
   offset += ((u64)(radeon_get_ib_value(p, idx+4) & 0xff)) << 32;
   if ((offset + 4) > radeon_bo_size(reloc->robj)) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad STRMOUT_BUFFER_UPDATE src bo too small: 0x%llx, 0x%lx\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , offset + 4, radeon_bo_size(reloc->robj));

    return -22;
   }
   offset += reloc->lobj.gpu_offset;
   ib[idx+3] = offset;
   ib[idx+4] = ((u32)(((offset) >> 16) >> 16)) & 0xff;
  }
  break;
 case 0x3D:
 {
  ...
  if (pkt->count != 3) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad MEM_WRITE (invalid count)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  r = evergreen_cs_packet_next_reloc(p, &reloc);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad MEM_WRITE (missing reloc)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  offset = radeon_get_ib_value(p, idx+0);
  offset += ((u64)(radeon_get_ib_value(p, idx+1) & 0xff)) << 32UL;
  if (offset & 0x7) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad MEM_WRITE (address not qwords aligned)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  if ((offset + 8) > radeon_bo_size(reloc->robj)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad MEM_WRITE bo too small: 0x%llx, 0x%lx\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , offset + 8, radeon_bo_size(reloc->robj));
 ...
 case 0x3B:
  if (pkt->count != 4) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad COPY_DW (invalid count)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  if (idx_value & 0x1) {
   u64 offset;
   ...
   r = evergreen_cs_packet_next_reloc(p, &reloc);
   if (r) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad COPY_DW (missing src reloc)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
   offset = radeon_get_ib_value(p, idx+1);
   offset += ((u64)(radeon_get_ib_value(p, idx+2) & 0xff)) << 32;
   if ((offset + 4) > radeon_bo_size(reloc->robj)) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad COPY_DW src bo too small: 0x%llx, 0x%lx\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , offset + 4, radeon_bo_size(reloc->robj));
   ...
   reg64 = radeon_get_ib_value(p, idx+1) << 2;
   if (!evergreen_is_safe_reg(p, reg64, idx+1))
    return -22;
  }
  if (idx_value & 0x2) {
   u64 offset;
   ...
   r = evergreen_cs_packet_next_reloc(p, &reloc);
   if (r) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad COPY_DW (missing dst reloc)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
   offset = radeon_get_ib_value(p, idx+3);
   offset += ((u64)(radeon_get_ib_value(p, idx+4) & 0xff)) << 32;
   if ((offset + 4) > radeon_bo_size(reloc->robj)) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad COPY_DW dst bo too small: 0x%llx, 0x%lx\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , offset + 4, radeon_bo_size(reloc->robj));
   ...
   reg64 = radeon_get_ib_value(p, idx+3) << 2;
   if (!evergreen_is_safe_reg(p, reg64, idx+3))
    return -22;
  }
  break;
 case 0x10:
  break;
 default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Packet3 opcode %x not supported\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , pkt->opcode);
  return -22;
 }
 return 0;
}
...
int evergreen_cs_parse(struct radeon_cs_parser *p)
{
 ...
 if (p->track == ((void *)0)) {
  ...
  track = kzalloc(sizeof(*track), (0x0001 | 0x0004));
  if (track == ((void *)0))
   return -12;
...
# 2884 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c"
int evergreen_dma_cs_parse(struct radeon_cs_parser *p)
{
 ...
 do {
  if (p->idx >= ib_chunk->length_dw) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Can not parse packet at %d after CS end %d !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , p->idx, ib_chunk->length_dw);

   return -22;
  }
  idx = p->idx;
  header = radeon_get_ib_value(p, idx);
  cmd = (((header) & 0xf0000000) >> 28);
  count = ((header) & 0x000fffff);
  tiled = (((header) & 0x00800000) >> 23);
  new_cmd = (((header) & 0x04000000) >> 26);
  misc = (((header) & 0x0700000) >> 20);

  switch (cmd) {
  case 0x2:
   r = r600_dma_cs_next_reloc(p, &dst_reloc);
   if (r) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DMA_PACKET_WRITE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
   if (tiled) {
    ...
    ib[idx+2] += ((u32)(((dst_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
    p->idx += count + 3;
   }
   if ((dst_offset + (count * 4)) > radeon_bo_size(dst_reloc->robj)) {
    printf("drm:pid%d:%s *WARNING* " "DMA write buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst_offset, radeon_bo_size(dst_reloc->robj));
  ...
  case 0x3:
   ...
   if (r) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DMA_PACKET_COPY\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
   r = r600_dma_cs_next_reloc(p, &dst_reloc);
   if (r) {
   ...
   if (tiled) {
    ...
    if (new_cmd) {
     ...
     case 0:
      ...
      if (idx_value & (1 << 31)) {
       printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad L2T, frame to fields DMA_PACKET_COPY\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
       return -22;
      }
      ...
      if ((src_offset + (count * 4)) > radeon_bo_size(src_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2T, frame to fields src buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , src_offset + (count * 4), radeon_bo_size(src_reloc->robj));

       return -22;
      }
      if ((dst_offset + (count * 4)) > radeon_bo_size(dst_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2T, frame to fields buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst_offset + (count * 4), radeon_bo_size(dst_reloc->robj));

       return -22;
      }
      if ((dst2_offset + (count * 4)) > radeon_bo_size(dst2_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2T, frame to fields buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst2_offset + (count * 4), radeon_bo_size(dst2_reloc->robj));
      ...
      ib[idx+9] += ((u32)(((src_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
      p->idx += 10;
      break;
     case 1:

      if (p->family < CHIP_CAYMAN) {
       printf("error: [" "drm" ":pid%d:%s] *ERROR* " "L2T, T2L Partial is cayman only !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
       return -22;
      }
      ...
      if (idx_value & (1 << 31)) {
       ...
       ib[idx+8] += ((u32)(((dst_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
      } else {

       ib[idx+7] += (u32)(src_reloc->lobj.gpu_offset & 0xfffffffc);
       ib[idx+8] += ((u32)(((src_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
     ...
     case 3:
      ...
      if (idx_value & (1 << 31)) {
       printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad L2T, broadcast DMA_PACKET_COPY\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
       return -22;
      }
      r = r600_dma_cs_next_reloc(p, &dst2_reloc);
      if (r) {
      ...
      src_offset |= ((u64)(radeon_get_ib_value(p, idx+9) & 0xff)) << 32;
      if ((src_offset + (count * 4)) > radeon_bo_size(src_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2T, broadcast src buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , src_offset + (count * 4), radeon_bo_size(src_reloc->robj));

       return -22;
      }
      if ((dst_offset + (count * 4)) > radeon_bo_size(dst_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2T, broadcast dst buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst_offset + (count * 4), radeon_bo_size(dst_reloc->robj));

       return -22;
      }
      if ((dst2_offset + (count * 4)) > radeon_bo_size(dst2_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2T, broadcast dst2 buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst2_offset + (count * 4), radeon_bo_size(dst2_reloc->robj));
     ...
     case 4:
      ...
      if ((src_offset + (count * 4)) > radeon_bo_size(src_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2T, T2L src buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , src_offset + (count * 4), radeon_bo_size(src_reloc->robj));

       return -22;
      }
      if ((dst_offset + (count * 4)) > radeon_bo_size(dst_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2T, T2L dst buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst_offset + (count * 4), radeon_bo_size(dst_reloc->robj));
     ...
     case 7:
      ...
      break;
     default:
      printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DMA_PACKET_COPY misc %u\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , misc);
      return -22;
     }
    } else {
     switch (misc) {
    ...
    if (new_cmd) {
     ...
     case 0:
      ...
      if ((src_offset + count) > radeon_bo_size(src_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2L, byte src buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , src_offset + count, radeon_bo_size(src_reloc->robj));

       return -22;
      }
      if ((dst_offset + count) > radeon_bo_size(dst_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2L, byte dst buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst_offset + count, radeon_bo_size(dst_reloc->robj));

       return -22;
      }
      ib[idx+1] += (u32)(dst_reloc->lobj.gpu_offset & 0xffffffff);
      ib[idx+2] += (u32)(src_reloc->lobj.gpu_offset & 0xffffffff);
      ib[idx+3] += ((u32)(((dst_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
      ib[idx+4] += ((u32)(((src_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
      p->idx += 5;
      break;
     case 1:

      if (p->family < CHIP_CAYMAN) {
       printf("error: [" "drm" ":pid%d:%s] *ERROR* " "L2L Partial is cayman only !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
       return -22;
      }
      ib[idx+1] += (u32)(src_reloc->lobj.gpu_offset & 0xffffffff);
      ib[idx+2] += ((u32)(((src_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
      ib[idx+4] += (u32)(dst_reloc->lobj.gpu_offset & 0xffffffff);
      ib[idx+5] += ((u32)(((dst_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
     ...
     case 4:
      ...
      r = r600_dma_cs_next_reloc(p, &dst2_reloc);
      if (r) {
       printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad L2L, dw, broadcast DMA_PACKET_COPY\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
       return -22;
      }
      dst_offset = radeon_get_ib_value(p, idx+1);
      ...
      if ((src_offset + (count * 4)) > radeon_bo_size(src_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2L, dw, broadcast src buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , src_offset + (count * 4), radeon_bo_size(src_reloc->robj));

       return -22;
      }
      if ((dst_offset + (count * 4)) > radeon_bo_size(dst_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2L, dw, broadcast dst buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst_offset + (count * 4), radeon_bo_size(dst_reloc->robj));

       return -22;
      }
      if ((dst2_offset + (count * 4)) > radeon_bo_size(dst2_reloc->robj)) {
       printf("drm:pid%d:%s *WARNING* " "DMA L2L, dw, broadcast dst2 buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst2_offset + (count * 4), radeon_bo_size(dst2_reloc->robj));
      ...
      ib[idx+4] += ((u32)(((dst_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
      ib[idx+5] += ((u32)(((dst2_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
      ib[idx+6] += ((u32)(((src_reloc->lobj.gpu_offset) >> 16) >> 16)) & 0xff;
      p->idx += 7;
      break;
     default:
      printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DMA_PACKET_COPY misc %u\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , misc);
     ...
     dst_offset |= ((u64)(radeon_get_ib_value(p, idx+3) & 0xff)) << 32;
     if ((src_offset + (count * 4)) > radeon_bo_size(src_reloc->robj)) {
      printf("drm:pid%d:%s *WARNING* " "DMA L2L, dw src buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , src_offset + (count * 4), radeon_bo_size(src_reloc->robj));

      return -22;
     }
     if ((dst_offset + (count * 4)) > radeon_bo_size(dst_reloc->robj)) {
      printf("drm:pid%d:%s *WARNING* " "DMA L2L, dw dst buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst_offset + (count * 4), radeon_bo_size(dst_reloc->robj));
  ...
  case 0xd:
   r = r600_dma_cs_next_reloc(p, &dst_reloc);
   if (r) {
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DMA_PACKET_CONSTANT_FILL\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
    return -22;
   }
   dst_offset = radeon_get_ib_value(p, idx+1);
   dst_offset |= ((u64)(radeon_get_ib_value(p, idx+3) & 0x00ff0000)) << 16;
   if ((dst_offset + (count * 4)) > radeon_bo_size(dst_reloc->robj)) {
    printf("drm:pid%d:%s *WARNING* " "DMA constant fill buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst_offset, radeon_bo_size(dst_reloc->robj));

    return -22;
   }
   ib[idx+1] += (u32)(dst_reloc->lobj.gpu_offset & 0xfffffffc);
   ib[idx+3] += (((u32)(((dst_reloc->lobj.gpu_offset) >> 16) >> 16)) << 16) & 0x00ff0000;
   p->idx += 4;
   break;
  case 0xf:
   p->idx += 1;
   break;
  default:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown packet type %d at %d !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , cmd, idx);
   return -22;
  }
 } while (p->idx < p->chunks[p->chunk_ib_idx].length_dw);
...
static _Bool evergreen_vm_reg_valid(u32 reg64)
{
 ...
 case 0x8E48:
  return 1;
 default:
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Invalid register 0x%x in CS\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , reg64);
  return 0;
 }
}
          ...
          u32 *ib, struct radeon_cs_packet *pkt)
{
 ...
 case 0x45:
  if (idx_value & 0x100) {
   reg64 = ib[idx + 5] * 4;
   if (!evergreen_vm_reg_valid(reg64))
    return -22;
  }
  break;
 case 0x3B:
  ...
  if (command & (1 << 26)) {
   ...
   if (((info & 0x60000000) >> 29) == 0) {
    ...
    if (command & (1 << 28)) {
     reg64 = start_reg;
     if (!evergreen_vm_reg_valid(reg64)) {
      printf("error: [" "drm" ":pid%d:%s] *ERROR* " "CP DMA Bad SRC register\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
      return -22;
     }
    } else {
  ...
  if (command & (1 << 27)) {
   ...
   if (((info & 0x00300000) >> 20) == 0) {
    ...
    if (command & (1 << 29)) {
     reg64 = start_reg;
     if (!evergreen_vm_reg_valid(reg64)) {
      printf("error: [" "drm" ":pid%d:%s] *ERROR* " "CP DMA Bad DST register\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
      return -22;
     }
    } else {
     for (i = 0; i < (command & 0x1fffff); i++) {
...
int evergreen_ib_parse(struct radeon_device *rdev, struct radeon_ib *ib)
{
 ...
 do {
  pkt.idx = idx;
  pkt.type = (((ib->ptr[idx]) >> 30) & 3);
  pkt.count = (((ib->ptr[idx]) >> 16) & 0x3FFF);
  pkt.one_reg_wr = 0;
  switch (pkt.type) {
  case 0:
  ...
  case 2:
   ...
   break;
  case 3:
   pkt.opcode = (((ib->ptr[idx]) >> 8) & 0xFF);
   ret = evergreen_vm_packet3_check(rdev, ib->ptr, &pkt);
   idx += pkt.count + 2;
   break;
  default:
   printf("drm:pid%d:%s *ERROR* " "Unknown packet type %d !\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , pkt.type);
   ret = -22;
   break;
  }
  if (ret)
...
# 3627 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/evergreen_cs.c"
