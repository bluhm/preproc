            ...
            unsigned idx)
{
 ...
 surf.nby = (((surf.nby)+((surf.halign)-1))&(~((surf.halign)-1)));
 ...
 for (i = 1; i <= llevel; i++) {
  ...
  surf.nbx = (((surf.nbx)+((surf.palign)-1))&(~((surf.palign)-1)));
  surf.nby = (((surf.nby)+((surf.halign)-1))&(~((surf.halign)-1)));
...
static int evergreen_cs_packet_parse_vline(struct radeon_cs_parser *p)
{
 static uint32_t vline_start_end[6] = {
  0x6b08 + (0x6df0 - 0x6df0),
  0x6b08 + (0x79f0 - 0x6df0),
  0x6b08 + (0x105f0 - 0x6df0),
  0x6b08 + (0x111f0 - 0x6df0),
  0x6b08 + (0x11df0 - 0x6df0),
  0x6b08 + (0x129f0 - 0x6df0)
 };
 static uint32_t vline_status[6] = {
  0x6bb8 + (0x6df0 - 0x6df0),
  0x6bb8 + (0x79f0 - 0x6df0),
  0x6bb8 + (0x105f0 - 0x6df0),
  0x6bb8 + (0x111f0 - 0x6df0),
  0x6bb8 + (0x11df0 - 0x6df0),
  0x6bb8 + (0x129f0 - 0x6df0)
 };
...
static int evergreen_cs_handle_reg(struct radeon_cs_parser *p, u32 reg64, u32 idx)
{
 ...
 case 0x28040:
  ...
  if (!(p->cs_flags & 0x01)) {
   ...
   ib[idx] |= ((evergreen_cs_get_aray_mode(reloc->tiling_flags)) << 4);
   track->db_z_info |= ((evergreen_cs_get_aray_mode(reloc->tiling_flags)) << 4);
   if (reloc->tiling_flags & 0x1) {
 ...
 case 0x28e14:
  ...
  if (!(p->cs_flags & 0x01)) {
   ...
   ib[idx] |= ((evergreen_cs_get_aray_mode(reloc->tiling_flags)) << 8);
   track->cb_color_info[tmp] |= ((evergreen_cs_get_aray_mode(reloc->tiling_flags)) << 8);
  }
  track->cb_dirty = 1;
  break;
 case 0x28e50:
...
static inline _Bool evergreen_is_safe_reg(struct radeon_cs_parser *p, u32 reg64)
{
 struct evergreen_cs_track *track = p->track;
 u32 m, i;
 i = (reg64 >> 7);
 if (__builtin_expect(!!(i >= (sizeof((evergreen_reg_safe_bm)) / sizeof((evergreen_reg_safe_bm)[0]))), 0)) {
  return 0;
 }
 m = 1 << ((reg64 >> 2) & 31);
       ...
       struct radeon_cs_packet *pkt)
{
 ...
 case 0x26:
 {
  ...
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 1873);
   return r;
  }
  break;
 }
 ...
 {
  if (pkt->count != 0) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad INDEX_BUFFER_SIZE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  break;
 }
 case 0x2B:
 {
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 1908);
   return r;
  }
  break;
 }
 case 0x27:
 {
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 1936);
   return r;
  }
  break;
 }
 case 0x2D:
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 1948, idx);
   return r;
  }
  break;
 case 0x30:
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 1959, idx);
   return r;
  }
  break;
 case 0x2E:
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 1970);
   return r;
  }
  break;
 case 0x29:
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 1981);
   return r;
  }
  break;
 case 0x35:
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 1992);
   return r;
  }
  break;
 case 0x11:
 {
  if (pkt->count != 2) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_BASE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  if (idx_value != 1) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_BASE\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  ...
  ib[idx+2] = ((u32)(((reloc->gpu_offset) >> 16) >> 16)) & 0xff;
  break;
 }
 case 0x24:
 case 0x25:
 {
  u64 size = pkt->opcode == 0x24 ? 16 : 20;
  if (pkt->count != 1) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DRAW_INDIRECT\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  if (idx_value + size > track->indirect_draw_buffer_size) {
   printf("drm:pid%d:%s *WARNING* " "DRAW_INDIRECT buffer too small %u + %llu > %lu\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , idx_value, size, track->indirect_draw_buffer_size);
   return -22;
  }
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2052);
   return r;
  }
  break;
 }
 case 0x15:
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2064, idx);
   return r;
  }
  break;
 case 0x16:
  ...
  r = evergreen_cs_track_check(p);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "%s:%d invalid cmd stream\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , __func__, 2081);
   return r;
  }
  break;
 case 0x3C:
  ...
  if (idx_value & 0x10) {
   ...
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "cannot use PFP on REG wait\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  break;
 case 0x41:
 ...
 case 0x68:
  ...
  for (reg64 = start_reg, idx++; reg64 <= end_reg; reg64 += 4, idx++) {
   if (evergreen_is_safe_reg(p, reg64))
    continue;
   r = evergreen_cs_handle_reg(p, reg64, idx);
   if (r)
    return r;
  }
  break;
 ...
 case 0x6D:
  ...
  for (i = 0; i < (pkt->count / 8); i++) {
   ...
   case 0x2:
    ...
    if (!(p->cs_flags & 0x01)) {
     ib[idx+1+(i*8)+1] |=
      ((evergreen_cs_get_aray_mode(reloc->tiling_flags)) << 28);
     if (reloc->tiling_flags & 0x1) {
      unsigned bankw, bankh, mtaspect, tile_split;
      evergreen_tiling_fields(reloc->tiling_flags,
         &bankw, &bankh, &mtaspect,
 ...
 case 0x3B:
  ...
  if (idx_value & 0x1) {
   ...
   if (!evergreen_is_safe_reg(p, reg64)) {
    printf("drm:pid%d:%s *WARNING* " "forbidden register 0x%08x at %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , reg64, idx + 1);
    return -22;
   }
  }
  if (idx_value & 0x2) {
   ...
   if (!evergreen_is_safe_reg(p, reg64)) {
    printf("drm:pid%d:%s *WARNING* " "forbidden register 0x%08x at %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , reg64, idx + 3);
    return -22;
   }
  }
  break;
...
int evergreen_cs_parse(struct radeon_cs_parser *p)
{
 ...
 if (p->track == ((void *)0)) {
  ...
  extern char _ctassert[(!((sizeof((cayman_reg_safe_bm)) / sizeof((cayman_reg_safe_bm)[0])) != (sizeof((evergreen_reg_safe_bm)) / sizeof((evergreen_reg_safe_bm)[0])))) ? 1 : -1 ] __attribute__((__unused__));
  extern char _ctassert[(!((sizeof((evergreen_reg_safe_bm)) / sizeof((evergreen_reg_safe_bm)[0])) != (sizeof((evergreen_reg_safe_bm)) / sizeof((evergreen_reg_safe_bm)[0])))) ? 1 : -1 ] __attribute__((__unused__));
  switch (tmp & 0xf) {
  case 0:
   track->npipes = 1;
   break;
 ...
 do {
  ...
  case 0x2:
   ...
   case 0:
    ...
    ib[idx+2] += ((u32)(((dst_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
    p->idx += count + 3;
    break;
   default:
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DMA_PACKET_WRITE [%6d] 0x%08x sub cmd is not 0 or 8\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , idx, header);
    return -22;
   }
  ...
  case 0x3:
   ...
   case 0x00:
    ...
    ib[idx+3] += ((u32)(((dst_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
    ib[idx+4] += ((u32)(((src_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
    p->idx += 5;
    break;
   case 0x08:
    if (radeon_get_ib_value(p, idx + 2) & (1 << 31)) {
     ...
     ib[idx+8] += ((u32)(((dst_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
    } else {
     src_offset = radeon_get_ib_value(p, idx+7);
     src_offset |= ((u64)(radeon_get_ib_value(p, idx+8) & 0xff)) << 32;
     ib[idx+7] += (u32)(src_reloc->gpu_offset & 0xfffffffc);
     ib[idx+8] += ((u32)(((src_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
     dst_offset = radeon_get_ib_value(p, idx+1);
     dst_offset <<= 8;
     ib[idx+1] += (u32)(dst_reloc->gpu_offset >> 8);
    }
    if ((src_offset + (count * 4)) > radeon_bo_size(src_reloc->robj)) {
     printf("drm:pid%d:%s *WARNING* " "DMA L2T, src buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , src_offset + (count * 4), radeon_bo_size(src_reloc->robj));
     return -22;
    }
    if ((dst_offset + (count * 4)) > radeon_bo_size(dst_reloc->robj)) {
     printf("drm:pid%d:%s *WARNING* " "DMA L2T, dst buffer too small (%llu %lu)\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dst_offset + (count * 4), radeon_bo_size(dst_reloc->robj));
     return -22;
    }
    p->idx += 9;
    break;
   ...
   case 0x41:
    ...
    ib[idx+2] += ((u32)(((src_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
    ib[idx+4] += (u32)(dst_reloc->gpu_offset & 0xffffffff);
    ib[idx+5] += ((u32)(((dst_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
    p->idx += 9;
    break;
   case 0x44:
    ...
    ib[idx+4] += ((u32)(((dst_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
    ib[idx+5] += ((u32)(((dst2_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
    ib[idx+6] += ((u32)(((src_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
    p->idx += 7;
    break;
   case 0x48:
    if (radeon_get_ib_value(p, idx + 2) & (1 << 31)) {
    ...
    ib[idx+9] += ((u32)(((src_reloc->gpu_offset) >> 16) >> 16)) & 0xff;
    p->idx += 10;
    break;
   case 0x49:
    if (p->family < CHIP_CAYMAN) {
   ...
   case 0x4f:
    ...
    break;
   default:
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DMA_PACKET_COPY [%6d] 0x%08x invalid sub cmd\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , idx, header);
    return -22;
   }
   break;
  case 0xd:
   ...
   ib[idx+1] += (u32)(dst_reloc->gpu_offset & 0xfffffffc);
   ib[idx+3] += (((u32)(((dst_reloc->gpu_offset) >> 16) >> 16)) << 16) & 0x00ff0000;
   p->idx += 4;
   break;
  case 0xf:
   p->idx += 1;
          ...
          u32 *ib, struct radeon_cs_packet *pkt)
{
 ...
 case 0x11:
  if (idx_value != 1) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad SET_BASE", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
  break;
 case 0x12:
 ...
 do {
  ...
  case 0x2:
   ...
   case 0:
    ...
    break;
   default:
    printf("error: [" "drm" ":pid%d:%s] *ERROR* " "bad DMA_PACKET_WRITE [%6d] 0x%08x sub cmd is not 0 or 8\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , idx, ib->ptr[idx]);
    return -22;
   }
   break;
  case 0x3:
