# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
void device_register(struct device *, void *);
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lancereg.h" 1
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 59 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c" 2
...
le_sbus_wrcsr(struct lance_softc *sc, uint16_t port, uint16_t val)
{
 ...
 bus_space_barrier(lesc->sc_bustag, lesc->sc_reg, 0, 2,
     0x02);
# 119 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/sbus/if_le.c"
}
...
leattach_sbus(struct device *parent, struct device *self, void *aux)
{
 ...
 if (lebuffer_cd.cd_ndevs != 0) {
  ...
  for (i = 0; i < lebuffer_cd.cd_ndevs; i++) {
   ...
   if (lebuf == ((void *)0) || lebuf->attached != 0)
    continue;
 ...
 if (sc->sc_mem == 0) {
  ...
  if ((error = bus_dmamap_create(dmatag, 0x4000, 1, 0x4000, 0,
       0x0001|0x0040, &lesc->sc_dmamap)) != 0) {
   printf(": DMA map create error %d\n", error);
   return;
  }


  if ((error = bus_dmamem_alloc(dmatag, 0x4000, 0, 0,
       &seg, 1, &rseg, 0x0001|0x0040)) != 0){
   printf(": DMA buffer allocation error %d\n", error);
   return;
  }


  if ((error = bus_dmamem_map(dmatag, &seg, rseg, 0x4000,
       (caddr_t *)&sc->sc_mem,
       0x0001|0x0004|0x0040)) != 0) {
  ...
  if ((error = bus_dmamap_load(dmatag, lesc->sc_dmamap, sc->sc_mem,
      0x4000, ((void *)0), 0x0001|0x0004|0x0040)) != 0) {
   printf(": DMA buffer map load error %d\n", error);
   bus_dmamem_free(dmatag, &seg, rseg);
   bus_dmamem_unmap(dmatag, sc->sc_mem, 0x4000);
   return;
  }

  sc->sc_addr = lesc->sc_dmamap->dm_segs[0].ds_addr & 0xffffff;
  sc->sc_memsize = 0x4000;
