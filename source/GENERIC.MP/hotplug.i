# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c"
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c"
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/hotplug.c" 2



static int opened;
static struct hotplug_event evqueue[64];
...
struct filterops hotplugread_filtops =
 { 1, ((void *)0), filt_hotplugrdetach, filt_hotplugread};
...
{
 if (evqueue_count == 64 && opened) {
  printf("hotplug: event lost, queue full\n");
  return (1);
 }

 evqueue[evqueue_head] = *he;
 evqueue_head = (evqueue_head == 64 - 1 ? 0 : evqueue_head + 1);
 if (evqueue_count == 64)
  evqueue_tail = (evqueue_tail == 64 - 1 ? 0 : evqueue_tail + 1);
 else
  evqueue_count++;
 wakeup(&evqueue);
...
{
 if (((int32_t)((dev) & 0xff) | (((dev) & 0xffff0000) >> 8)) != 0)
  return (6);
 if ((flag & 0x0002))
  return (1);
 if (opened)
...
again:
 ...
 error = tsleep(&evqueue, 16 | 0x100, "htplev", 0);
 if (error)
  return (error);
 goto again;
}
...
filt_hotplugrdetach(struct knote *kn)
{
 ...
 s = _splraise(5);
 do { if ((&hotplug_sel.si_note)->slh_first == (kn)) { do { ((&hotplug_sel.si_note))->slh_first = ((&hotplug_sel.si_note))->slh_first->kn_selnext.sle_next; } while (0); } else { struct knote *curelm = (&hotplug_sel.si_note)->slh_first; while (curelm->kn_selnext.sle_next != (kn)) curelm = curelm->kn_selnext.sle_next; curelm->kn_selnext.sle_next = curelm->kn_selnext.sle_next->kn_selnext.sle_next; } ((kn)->kn_selnext.sle_next) = ((void *)-1); } while (0);
 _splx(s);
}
...
{
 kn->kn_kevent.data = evqueue_count;
