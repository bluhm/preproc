# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c"
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c"
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c" 2
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c"
...
out:
# 131 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c"
 return rateidx;
}
...
ieee80211_rssadapt_updatestats(struct ieee80211_rssadapt *ra)
{
 ...
 interval = (((100000)>(10000000 / (((1)>(10 * ra->ra_pktrate))?(1):(10 * ra->ra_pktrate))))?(100000):(10000000 / (((1)>(10 * ra->ra_pktrate))?(1):(10 * ra->ra_pktrate))));
    ...
    const struct ieee80211_node *ni, struct ieee80211_rssadapt *ra, int rssi)
{
 ...
 ra->ra_avg_rssi = ((master_expavgctl.rc_avgrssi_old * (ra->ra_avg_rssi) + (master_expavgctl.rc_avgrssi_denom - master_expavgctl.rc_avgrssi_old) * ((rssi << 8))) / master_expavgctl.rc_avgrssi_denom);
    ...
    const struct ieee80211_rssdesc *id)
{
 ...
 ra->ra_rate_thresh[thridx][id->id_rateidx] =
     ((master_expavgctl.rc_thresh_old * (last_thr) + (master_expavgctl.rc_thresh_denom - master_expavgctl.rc_thresh_old) * ((id->id_rssi << 8))) / master_expavgctl.rc_thresh_denom);
...
{
 u_int16_t (*thrs)[8], newthr, oldthr;
 ...
 if (id->id_rateidx + 1 < rs->rs_nrates &&
  ...
  rate = (rs->rs_rates[id->id_rateidx + 1] & 0x7f);
  ...
  (*thrs)[id->id_rateidx + 1] =
      ((master_expavgctl.rc_decay_old * (oldthr) + (master_expavgctl.rc_decay_denom - master_expavgctl.rc_decay_old) * (newthr)) / master_expavgctl.rc_decay_denom);

  ;
 }
# 273 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_rssadapt.c"
}
