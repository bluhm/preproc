# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c"
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c"
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/param.h" 1
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/param.h"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/evcount.h"
struct evcount {
 u_int64_t ec_count;
 int ec_id;
 const char *ec_name;
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c" 2
...
int syncer_maxdelay = 32;
int syncdelay = 30;

int rushjob = 0;
int stat_rush_requests = 0;

int syncer_delayno = 0;
long syncer_mask;
struct synclist { struct vnode *lh_first; };
static struct synclist *syncer_workitem_pending;

struct proc *syncerproc;
# 103 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c"
void
vn_initialize_syncerd(void)
{
 syncer_workitem_pending = hashinit(syncer_maxdelay, 25, 0x0001,
     &syncer_mask);
...
vn_syncer_add_to_worklist(struct vnode *vp, int delay)
{
 ...
 vp->v_bioflag |= 0x0002;
 do { if (((vp)->v_synclist.le_next = (&syncer_workitem_pending[slot])->lh_first) != ((void *)0)) (&syncer_workitem_pending[slot])->lh_first->v_synclist.le_prev = &(vp)->v_synclist.le_next; (&syncer_workitem_pending[slot])->lh_first = (vp); (vp)->v_synclist.le_prev = &(&syncer_workitem_pending[slot])->lh_first; } while (0);
 _splx(s);
}
...
sched_sync(struct proc *p)
{
 ...
 syncerproc = (__curcpu->ci_self)->ci_curproc;
 ...
 for (;;) {
  ...
  while ((vp = ((slp)->lh_first)) != ((void *)0)) {
   ...
   _splx(s);
   (void) VOP_FSYNC(vp, p->p_ucred, 3, p);
   vput(vp);
   s = _splraise(5);
   if (((slp)->lh_first) == vp) {
  ...
  softdep_process_worklist(((void *)0));
# 220 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c"
  if (rushjob > 0) {
   rushjob -= 1;
   continue;
  }
# 232 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/vfs_sync.c"
  if (time_second == starttime)
   tsleep(&lbolt, 40, "syncer", 0);
 }
}
...
sync_fsync(void *v)
{
 ...
 if (vfs_busy(mp, 0x01|0x04) == 0) {
  asyncflag = mp->mnt_flag & 0x00000040;
  mp->mnt_flag &= ~0x00000040;
  (*(mp)->mnt_op->vfs_sync)(mp, 3, ap->a_cred, ap->a_p);
  if (asyncflag)
   mp->mnt_flag |= 0x00000040;
  vfs_unbusy(mp);
 }
