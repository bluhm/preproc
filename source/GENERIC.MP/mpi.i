...
mpi_cfg_spi_port(struct mpi_softc *sc)
{
 ...
 if (port.port_scsi_id == sc->sc_target &&
     port.port_resp_ids == (__uint16_t)(__builtin_constant_p(1 << sc->sc_target) ? (__uint16_t)(((__uint16_t)(1 << sc->sc_target) & 0xffU) << 8 | ((__uint16_t)(1 << sc->sc_target) & 0xff00U) >> 8) : __swap16md(1 << sc->sc_target)) &&
     port.on_bus_timer_value != (__uint32_t)(__builtin_constant_p(0x0) ? (__uint32_t)(((__uint32_t)(0x0) & 0xff) << 24 | ((__uint32_t)(0x0) & 0xff00) << 8 | ((__uint32_t)(0x0) & 0xff0000) >> 8 | ((__uint32_t)(0x0) & 0xff000000) >> 24) : __swap32md(0x0)))
  return (0);
 ;
 port.port_scsi_id = sc->sc_target;
 port.port_resp_ids = (__uint16_t)(__builtin_constant_p(1 << sc->sc_target) ? (__uint16_t)(((__uint16_t)(1 << sc->sc_target) & 0xffU) << 8 | ((__uint16_t)(1 << sc->sc_target) & 0xff00U) >> 8) : __swap16md(1 << sc->sc_target));
 port.on_bus_timer_value = (__uint32_t)(__builtin_constant_p(0x07000000) ? (__uint32_t)(((__uint32_t)(0x07000000) & 0xff) << 24 | ((__uint32_t)(0x07000000) & 0xff00) << 8 | ((__uint32_t)(0x07000000) & 0xff0000) >> 8 | ((__uint32_t)(0x07000000) & 0xff000000) >> 24) : __swap32md(0x07000000));
...
mpi_squash_ppr(struct mpi_softc *sc)
{
 ...
 for (i = 0; i < sc->sc_buswidth; i++) {
  ...
  page.configuration = (__uint32_t)(__builtin_constant_p(0x0) ? (__uint32_t)(((__uint32_t)(0x0) & 0xff) << 24 | ((__uint32_t)(0x0) & 0xff00) << 8 | ((__uint32_t)(0x0) & 0xff0000) >> 8 | ((__uint32_t)(0x0) & 0xff000000) >> 24) : __swap32md(0x0));
...
mpi_cfg_fc(struct mpi_softc *sc)
{
 ...
 ((pg1.flags) |= ((__uint32_t)(__builtin_constant_p((1<<26) | (1<<24)) ? (__uint32_t)(((__uint32_t)((1<<26) | (1<<24)) & 0xff) << 24 | ((__uint32_t)((1<<26) | (1<<24)) & 0xff00) << 8 | ((__uint32_t)((1<<26) | (1<<24)) & 0xff0000) >> 8 | ((__uint32_t)((1<<26) | (1<<24)) & 0xff000000) >> 24) : __swap32md((1<<26) | (1<<24)))));
...
mpi_load_xs(struct mpi_ccb *ccb)
{
 ...
 for (i = 0; i < dmap->dm_nsegs; i++) {
  if (nsge == ce) {
   nsge++;
   sge->sg_hdr |= (__uint32_t)(__builtin_constant_p((0x1<<31)) ? (__uint32_t)(((__uint32_t)((0x1<<31)) & 0xff) << 24 | ((__uint32_t)((0x1<<31)) & 0xff00) << 8 | ((__uint32_t)((0x1<<31)) & 0xff0000) >> 8 | ((__uint32_t)((0x1<<31)) & 0xff000000) >> 24) : __swap32md((0x1<<31)));
   ...
   ce->sg_hdr = (__uint32_t)(__builtin_constant_p((0x3<<28) | (0x1<<25) | addr) ? (__uint32_t)(((__uint32_t)((0x3<<28) | (0x1<<25) | addr) & 0xff) << 24 | ((__uint32_t)((0x3<<28) | (0x1<<25) | addr) & 0xff00) << 8 | ((__uint32_t)((0x3<<28) | (0x1<<25) | addr) & 0xff0000) >> 8 | ((__uint32_t)((0x3<<28) | (0x1<<25) | addr) & 0xff000000) >> 24) : __swap32md((0x3<<28) | (0x1<<25) | addr));
...
mpi_handshake_send(struct mpi_softc *sc, void *buf, size_t dwords)
{
 ...
 if (mpi_wait_eq((sc), 0x30, (1<<31), 0) != 0)
  return (1);
 for (i = 0; i < dwords; i++) {
  mpi_write((sc), 0x00, ((__uint32_t)(__builtin_constant_p(query[i]) ? (__uint32_t)(((__uint32_t)(query[i]) & 0xff) << 24 | ((__uint32_t)(query[i]) & 0xff00) << 8 | ((__uint32_t)(query[i]) & 0xff0000) >> 8 | ((__uint32_t)(query[i]) & 0xff000000) >> 24) : __swap32md(query[i]))));
  if (mpi_wait_eq((sc), 0x30, (1<<31), 0) != 0)
   return (1);
 }
 return (0);
...
mpi_handshake_recv_dword(struct mpi_softc *sc, u_int32_t *dword)
{
 ...
 for (i = 0; i < 2; i++) {
  if (mpi_wait_ne((sc), 0x30, (1<<0), 0) != 0)
   return (1);
  words[i] = (__uint16_t)(__builtin_constant_p(mpi_read((sc), 0x00) & 0xffff) ? (__uint16_t)(((__uint16_t)(mpi_read((sc), 0x00) & 0xffff) & 0xffU) << 8 | ((__uint16_t)(mpi_read((sc), 0x00) & 0xffff) & 0xff00U) >> 8) : __swap16md(mpi_read((sc), 0x00) & 0xffff));
  mpi_write((sc), 0x30, (0));
 }
 return (0);
}
...
mpi_iocfacts(struct mpi_softc *sc)
{
 ...
 ifq.chain_offset = 0;
 ifq.msg_flags = 0;
 ifq.msg_context = (__uint32_t)(__builtin_constant_p(0xdeadbeef) ? (__uint32_t)(((__uint32_t)(0xdeadbeef) & 0xff) << 24 | ((__uint32_t)(0xdeadbeef) & 0xff00) << 8 | ((__uint32_t)(0xdeadbeef) & 0xff0000) >> 8 | ((__uint32_t)(0xdeadbeef) & 0xff000000) >> 24) : __swap32md(0xdeadbeef));
...
mpi_iocinit(struct mpi_softc *sc)
{
 ...
 iiq.max_buses = 1;
 iiq.msg_context = (__uint32_t)(__builtin_constant_p(0xd00fd00f) ? (__uint32_t)(((__uint32_t)(0xd00fd00f) & 0xff) << 24 | ((__uint32_t)(0xd00fd00f) & 0xff00) << 8 | ((__uint32_t)(0xd00fd00f) & 0xff0000) >> 8 | ((__uint32_t)(0xd00fd00f) & 0xff000000) >> 24) : __swap32md(0xd00fd00f));
 iiq.reply_frame_size = (__uint16_t)(__builtin_constant_p(80) ? (__uint16_t)(((__uint16_t)(80) & 0xffU) << 8 | ((__uint16_t)(80) & 0xff00U) >> 8) : __swap16md(80));
...
mpi_cfg_coalescing(struct mpi_softc *sc)
{
 ...
 if (!((flags) & ((1<<0))))
  return (0);
 ((pg.flags) &= ~((__uint32_t)(__builtin_constant_p((1<<0)) ? (__uint32_t)(((__uint32_t)((1<<0)) & 0xff) << 24 | ((__uint32_t)((1<<0)) & 0xff00) << 8 | ((__uint32_t)((1<<0)) & 0xff0000) >> 8 | ((__uint32_t)((1<<0)) & 0xff000000) >> 24) : __swap32md((1<<0)))));
...
mpi_ioctl_cache(struct scsi_link *link, u_long cmd, struct dk_cache *dc)
{
 ...
 if (dc->wrcache) {
  ((settings.volume_settings) |= ((__uint16_t)(__builtin_constant_p((1<<0)) ? (__uint16_t)(((__uint16_t)((1<<0)) & 0xffU) << 8 | ((__uint16_t)((1<<0)) & 0xff00U) >> 8) : __swap16md((1<<0)))));
 } else {
  ((settings.volume_settings) &= ~((__uint16_t)(__builtin_constant_p((1<<0)) ? (__uint16_t)(((__uint16_t)((1<<0)) & 0xffU) << 8 | ((__uint16_t)((1<<0)) & 0xff00U) >> 8) : __swap16md((1<<0)))));
 }
 ccb = scsi_io_get(&sc->sc_iopool, 0x00001);
