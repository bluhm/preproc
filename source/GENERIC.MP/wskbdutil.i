# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wskbdutil.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wskbdutil.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wskbdutil.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wskbdutil.c" 2

# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wskbdutil.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wskbdutil.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wskbdutil.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsksymdef.h" 1
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wskbdutil.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wskbdutil.c" 2
...
wskbd_compose_value(keysym_t *compose_buf)
{
 ...
 if (!compose_tab_inorder) {
  ...
  for (i = 1; i < (sizeof((compose_tab)) / sizeof((compose_tab)[0])); i++) {
   v = compose_tab[i];
 ...
 for (j = 0, i = (sizeof((compose_tab)) / sizeof((compose_tab)[0])); i != 0; i /= 2) {
...
{
 if (ksym >= 0xf300 && ksym <= 0xf313)
  return(0xf340 - 0xf300 + ksym);

 if (((ksym) >= 0x0300 && (ksym) < 0x0370 ? 0xf801 : (((ksym) & 0xf000) == 0xe000 ? 0xf803 : (((ksym) & 0xf800) == 0xf000 ? ((ksym) & 0xff00) : 0xf802))) == 0xf802 && ksym <= 0xff &&
...
fillmapentry(const keysym_t *kp, int len, struct wscons_keymap *mapentry)
{
 switch (len) {
 case 0:
  mapentry->group1[0] = 0xf500;
  mapentry->group1[1] = 0xf500;
  mapentry->group2[0] = 0xf500;
  mapentry->group2[1] = 0xf500;
  break;
    ...
    struct wscons_keymap *mapentry)
{
 ...
 mapentry->command = 0xf500;
 mapentry->group1[0] = 0xf500;
 mapentry->group1[1] = 0xf500;
 mapentry->group2[0] = 0xf500;
 mapentry->group2[1] = 0xf500;

 for (cur = mapdata->layout & ~(0x00000020 | 0x80000000); cur != 0; ) {
  mp = mapdata->keydesc;
  while (mp->map_size > 0) {
   if (mp->name == cur)
    break;
  ...
  for (kp = mp->map; kp < mp->map + mp->map_size; kp++) {
   ksg = ((*kp) >= 0x0300 && (*kp) < 0x0370 ? 0xf801 : (((*kp) & 0xf000) == 0xe000 ? 0xf803 : (((*kp) & 0xf800) == 0xf000 ? ((*kp) & 0xff00) : 0xf802)));
   if (ksg == 0xf803 &&
       (((*kp) & 0xf000) == 0xe000 ? ((*kp) & 0x0fff) : (((*kp) & 0xf800) == 0xf000 ? ((*kp) & 0x00ff) : (*kp))) == kc) {

    kp++;
    if (((*kp) >= 0x0300 && (*kp) < 0x0370 ? 0xf801 : (((*kp) & 0xf000) == 0xe000 ? 0xf803 : (((*kp) & 0xf800) == 0xf000 ? ((*kp) & 0xff00) : 0xf802))) == 0xf400 ||
        *kp == 0xf10d || *kp == 0xf10e || *kp == 0xf10f)
     mapentry->command = *kp++;

    for (l = 0; kp + l < mp->map + mp->map_size;
        l++) {
     ksg = ((kp[l]) >= 0x0300 && (kp[l]) < 0x0370 ? 0xf801 : (((kp[l]) & 0xf000) == 0xe000 ? 0xf803 : (((kp[l]) & 0xf800) == 0xf000 ? ((kp[l]) & 0xff00) : 0xf802)));
     if (ksg == 0xf803)
      break;
    }
    if (l > 4)
...
wskbd_init_keymap(int newlen, struct wscons_keymap **map, int *maplen)
{
 ...
 for (i = 0; i < *maplen; i++) {
  (*map)[i].command = 0xf500;
  (*map)[i].group1[0] = 0xf500;
  (*map)[i].group1[1] = 0xf500;
  (*map)[i].group2[0] = 0xf500;
  (*map)[i].group2[1] = 0xf500;
 }
}
    ...
    struct wscons_keymap **map, int *maplen)
{
 ...
 for (cur = layout & ~(0x00000020 | 0x80000000), stack_ptr = 0;
      cur != 0; stack_ptr++) {
  mp = mapdata->keydesc;
  while (mp->map_size > 0) {
 ...
 for (i = 0, s = stack_ptr - 1; s >= 0; s--) {
  ...
  for (kp = mp->map; kp < mp->map + mp->map_size; kp++) {
   ksg = ((*kp) >= 0x0300 && (*kp) < 0x0370 ? 0xf801 : (((*kp) & 0xf000) == 0xe000 ? 0xf803 : (((*kp) & 0xf800) == 0xf000 ? ((*kp) & 0xff00) : 0xf802)));
   if (ksg == 0xf803 && (((*kp) & 0xf000) == 0xe000 ? ((*kp) & 0x0fff) : (((*kp) & 0xf800) == 0xf000 ? ((*kp) & 0x00ff) : (*kp))) > i)
    i = (((*kp) & 0xf000) == 0xe000 ? ((*kp) & 0x0fff) : (((*kp) & 0xf800) == 0xf000 ? ((*kp) & 0x00ff) : (*kp)));
  }
 }
 ...
 for (s = stack_ptr - 1; s >= 0; s--) {
  ...
  for (kp = mp->map; kp < mp->map + mp->map_size; ) {
   ...
   kc = (((*kp) & 0xf000) == 0xe000 ? ((*kp) & 0x0fff) : (((*kp) & 0xf800) == 0xf000 ? ((*kp) & 0x00ff) : (*kp)));
   kp++;
   ...
   for (i = 0; kp + i < mp->map + mp->map_size; i++) {
    ksg = ((kp[i]) >= 0x0300 && (kp[i]) < 0x0370 ? 0xf801 : (((kp[i]) & 0xf000) == 0xe000 ? 0xf803 : (((kp[i]) & 0xf800) == 0xf000 ? ((kp[i]) & 0xff00) : 0xf802)));
    if (ksg == 0xf803)
     break;
   }
