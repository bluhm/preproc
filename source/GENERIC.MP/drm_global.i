# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_global.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_global.c"
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_global.c"
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_global.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_global.c" 2
...
void drm_global_init(void)
{
 ...
 for (i = 0; i < DRM_GLOBAL_NUM; ++i) {
  ...
  _rw_init_flags(&item->mutex, "gblitm", 0, ((void *)0));
  item->object = ((void *)0);
  item->refcount = 0;
 }
}
...
void drm_global_release(void)
{
 ...
 for (i = 0; i < DRM_GLOBAL_NUM; ++i) {
  struct drm_global_item *item = &glob[i];
  ((!(item->object != ((void *)0))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_global.c", 61, "!(item->object != ((void *)0))"));
  ((!(item->refcount != 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_global.c", 62, "!(item->refcount != 0)"));
 }
}
...
int drm_global_item_ref(struct drm_global_reference *ref)
{
 ...
 _rw_enter_write(&item->mutex );
 if (item->refcount == 0) {
  item->object = kzalloc(ref->size, (0x0001 | 0x0004));
  if (__builtin_expect(!!(item->object == ((void *)0)), 0)) {
   ret = -12;
   goto out_err;
  }
...
void drm_global_item_unref(struct drm_global_reference *ref)
{
 ...
 _rw_enter_write(&item->mutex );
 ((!(item->refcount == 0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_global.c", 101, "!(item->refcount == 0)"));
 ((!(ref->object != item->object)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/drm_global.c", 102, "!(ref->object != item->object)"));
 if (--item->refcount == 0) {
  ref->release(ref);
  item->object = ((void *)0);
 }
