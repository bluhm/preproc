# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c"
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c"
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net80211/ieee80211_crypto_wep.c" 2
...
ieee80211_wep_delete_key(struct ieee80211com *ic, struct ieee80211_key *k)
{
 if (k->k_priv != ((void *)0)) {
  ...
  free(k->k_priv, 2, sizeof(struct ieee80211_wep_ctx));
 }
 k->k_priv = ((void *)0);
}
    ...
    struct ieee80211_key *k)
{
 ...
 if (m_dup_pkthdr(n0, m0, 0x0002))
  goto nospace;
 n0->M_dat.MH.MH_pkthdr.len += (3 + 1);
 n0->m_hdr.mh_len = ((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr));
 if (n0->M_dat.MH.MH_pkthdr.len >= (((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr)) + (256 - sizeof(struct m_hdr)) + 1) - 4) {
 ...
 __builtin_memcpy((wepseed), (ivp), (3));
 __builtin_memcpy((wepseed + 3), (k->k_key), (k->k_len));
 rc4_keysetup(&ctx->rc4, wepseed, 3 + k->k_len);
 ...
 while (left > 0) {
  ...
  if (noff == n->m_hdr.mh_len) {
   ...
   if (left >= (((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr)) + (256 - sizeof(struct m_hdr)) + 1) - 4) {
    ...
    struct ieee80211_key *k)
{
 ...
 if (m0->M_dat.MH.MH_pkthdr.len < hdrlen + (3 + 1 + 4)) {
  m_freem(m0);
  return ((void *)0);
 }
 ...
 if (m_dup_pkthdr(n0, m0, 0x0002))
  goto nospace;
 n0->M_dat.MH.MH_pkthdr.len -= (3 + 1 + 4);
 n0->m_hdr.mh_len = ((256 - sizeof(struct m_hdr)) - sizeof(struct pkthdr));
 ...
 m_copydata(m, moff, 4, (caddr_t)&crc0);
