# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_encoders.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_encoders.c"
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_encoders.c"
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_encoders.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_encoders.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_encoders.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_encoders.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_encoders.c" 2
...
static void radeon_legacy_lvds_update(struct drm_encoder *encoder, int mode)
{
 ...
 lvds_gen_cntl = r100_mm_rreg(rdev, (0x02d0), 0);
 backlight_level = (lvds_gen_cntl >> 8) & 0xff;
 ...
 switch (mode) {
 case 0:
  disp_pwr_man = r100_mm_rreg(rdev, (0x0d08), 0);
  disp_pwr_man |= (1 << 26);
  r100_mm_wreg(rdev, (0x0d08), (disp_pwr_man), 0);
  lvds_pll_cntl = r100_mm_rreg(rdev, (0x02d4), 0);
  lvds_pll_cntl |= (1 << 16);
  r100_mm_wreg(rdev, (0x02d4), (lvds_pll_cntl), 0);
  mdelay(1);
  ...
  lvds_gen_cntl &= ~((1 << 1) |
       (0xff << 8));
  lvds_gen_cntl |= ((1 << 0) | (1 << 7) |
      (1 << 18) | (1 << 19) |
      (backlight_level << 8));
  if (is_mac)
   lvds_gen_cntl |= (1 << 16);
  mdelay(panel_pwr_delay);
  r100_mm_wreg(rdev, (0x02d0), (lvds_gen_cntl), 0);
  break;
 case 1:
 case 2:
 case 3:
  pixclks_cntl = rdev->pll_rreg(rdev, (0x002d));
  do { uint32_t tmp_ = rdev->pll_rreg(rdev, (0x002d)); tmp_ &= (~(1 << 14)); tmp_ |= ((0) & ~(~(1 << 14))); rdev->pll_wreg(rdev, (0x002d), (tmp_)); } while (0);
  lvds_gen_cntl |= (1 << 1);
  if (is_mac) {
   lvds_gen_cntl &= ~(1 << 16);
   r100_mm_wreg(rdev, (0x02d0), (lvds_gen_cntl), 0);
   ...
   r100_mm_wreg(rdev, (0x02d0), (lvds_gen_cntl), 0);
   lvds_gen_cntl &= ~((1 << 0) | (1 << 19) | (1 << 7) | (1 << 18));
  }
  mdelay(panel_pwr_delay);
  r100_mm_wreg(rdev, (0x02d0), (lvds_gen_cntl), 0);
  rdev->pll_wreg(rdev, (0x002d), (pixclks_cntl));
  mdelay(panel_pwr_delay);
  break;
 }

 if (rdev->is_atom_bios)
  radeon_atombios_encoder_dpms_scratch_regs(encoder, (mode == 0) ? 1 : 0);
 else
  radeon_combios_encoder_dpms_scratch_regs(encoder, (mode == 0) ? 1 : 0);
...
static void radeon_legacy_lvds_prepare(struct drm_encoder *encoder)
{
 ...
 radeon_legacy_lvds_dpms(encoder, 3);
}
...
static void radeon_legacy_lvds_commit(struct drm_encoder *encoder)
{
 ...
 radeon_legacy_lvds_dpms(encoder, 0);
 if (rdev->is_atom_bios)
     ...
     struct drm_display_mode *adjusted_mode)
{
 ...
 lvds_ss_gen_cntl = r100_mm_rreg(rdev, (0x02ec), 0);
 if (rdev->is_atom_bios) {
  ...
  if (lvds) {
   ...
   lvds_ss_gen_cntl &= ~((0xf << 16) |
           (0xf << 20));
   lvds_ss_gen_cntl |= ((lvds->panel_digon_delay << 16) |
          (lvds->panel_blon_delay << 20));
  } else
   lvds_gen_cntl = r100_mm_rreg(rdev, (0x02d0), 0);
 }
 lvds_gen_cntl |= (1 << 1);
 ...
 r100_mm_wreg(rdev, (0x02d0), (lvds_gen_cntl), 0);
 r100_mm_wreg(rdev, (0x02d4), (lvds_pll_cntl), 0);
 r100_mm_wreg(rdev, (0x02ec), (lvds_ss_gen_cntl), 0);

 if (rdev->family == CHIP_RV410)
  r100_mm_wreg(rdev, (0x0008), (0), 0);
...
static _Bool radeon_legacy_mode_fixup(struct drm_encoder *encoder,
         const struct drm_display_mode *mode,
         struct drm_display_mode *adjusted_mode)
{
 struct radeon_encoder *radeon_encoder = ({ __typeof( ((struct radeon_encoder *)0)->base ) *__mptr = (encoder); (struct radeon_encoder *)( (char *)__mptr - __builtin_offsetof(struct radeon_encoder, base) );});
...
radeon_legacy_get_backlight_level(struct radeon_encoder *radeon_encoder)
{
 ...
 backlight_level = (r100_mm_rreg(rdev, (0x02d0), 0) >>
      8) & 0xff;
...
{
 struct radeon_backlight_privdata *pdata = (bd)->data;
 uint8_t level;


 if (bd->props.brightness < 0)
  level = 0;
 else if (bd->props.brightness > 0xFF)
  level = 0xFF;
 else
...
static int radeon_legacy_backlight_get_brightness(struct backlight_device *bd)
{
 ...
 return pdata->negative ? 0xFF - backlight_level : backlight_level;
}
      ...
      struct drm_connector *drm_connector)
{
 ...
 pdata = kmalloc(sizeof(struct radeon_backlight_privdata), (0x0001 | 0x0004));
 if (!pdata) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Memory allocation failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto error;
 }
 ...
 if (IS_ERR(bd)) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Backlight registration failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
  goto error;
 }
...
# 494 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/pci/drm/radeon/radeon_legacy_encoders.c"
...
static void radeon_legacy_primary_dac_dpms(struct drm_encoder *encoder, int mode)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 uint32_t crtc_ext_cntl = r100_mm_rreg(rdev, (0x0054), 0);
 uint32_t dac_cntl = r100_mm_rreg(rdev, (0x0058), 0);
 uint32_t dac_macro_cntl = r100_mm_rreg(rdev, (0x0d04), 0);
 ...
 if (!(rdev->flags & RADEON_SINGLE_CRTC))
  r100_mm_wreg(rdev, (0x0054), (crtc_ext_cntl), 0);
 r100_mm_wreg(rdev, (0x0058), (dac_cntl), 0);
 r100_mm_wreg(rdev, (0x0d04), (dac_macro_cntl), 0);
...
static void radeon_legacy_primary_dac_prepare(struct drm_encoder *encoder)
{
 ...
 if (rdev->is_atom_bios)
  ...
  radeon_combios_output_lock(encoder, 1);
 radeon_legacy_primary_dac_dpms(encoder, 3);
}
...
static void radeon_legacy_primary_dac_commit(struct drm_encoder *encoder)
{
 ...
 radeon_legacy_primary_dac_dpms(encoder, 0);
            ...
            struct drm_display_mode *adjusted_mode)
{
 ...
 if (radeon_crtc->crtc_id == 0) {
  if (rdev->family == CHIP_R200 || ((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480))) {
   disp_output_cntl = r100_mm_rreg(rdev, (0x0d64), 0) &
    ~(0x03);
   r100_mm_wreg(rdev, (0x0d64), (disp_output_cntl), 0);
  } else {
   dac2_cntl = r100_mm_rreg(rdev, (0x007c), 0) & ~((1 << 0));
   r100_mm_wreg(rdev, (0x007c), (dac2_cntl), 0);
  }
 } else {
  if (rdev->family == CHIP_R200 || ((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480))) {
   disp_output_cntl = r100_mm_rreg(rdev, (0x0d64), 0) &
    ~(0x03);
   disp_output_cntl |= 0x01;
   r100_mm_wreg(rdev, (0x0d64), (disp_output_cntl), 0);
  } else {
   dac2_cntl = r100_mm_rreg(rdev, (0x007c), 0) | (1 << 0);
   r100_mm_wreg(rdev, (0x007c), (dac2_cntl), 0);
 ...
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x0058), 0); tmp_ &= ((3 << 0) | (1 << 2)); tmp_ |= ((dac_cntl) & ~((3 << 0) | (1 << 2))); r100_mm_wreg(rdev, (0x0058), (tmp_), 0); } while (0);
 ...
 if (radeon_encoder->enc_priv) {
  ...
  dac_macro_cntl = r100_mm_rreg(rdev, (0x0d04), 0);
 dac_macro_cntl |= (1 << 16) | (1 << 17) | (1 << 18);
 r100_mm_wreg(rdev, (0x0d04), (dac_macro_cntl), 0);
          ...
          struct drm_connector *connector)
{
 ...
 if (((rdev->pdev->device == 0x515e) || (rdev->pdev->device == 0x5969))) {
  return connector_status_connected;
 }


 vclk_ecp_cntl = rdev->pll_rreg(rdev, (0x0008));
 crtc_ext_cntl = r100_mm_rreg(rdev, (0x0054), 0);
 dac_ext_cntl = r100_mm_rreg(rdev, (0x0280), 0);
 dac_cntl = r100_mm_rreg(rdev, (0x0058), 0);
 dac_macro_cntl = r100_mm_rreg(rdev, (0x0d04), 0);
 ...
 tmp = crtc_ext_cntl | (1 << 15);
 r100_mm_wreg(rdev, (0x0054), (tmp), 0);
 ...
 if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480)))
  tmp |= (0x1b6 << 8);
 else if (((rdev->family == CHIP_RV100) || (rdev->family == CHIP_RV200) || (rdev->family == CHIP_RS100) || (rdev->family == CHIP_RS200) || (rdev->family == CHIP_RV250) || (rdev->family == CHIP_RV280) || (rdev->family == CHIP_RS300)))
  tmp |= (0x1ac << 8);
 else
  tmp |= (0x180 << 8);

 r100_mm_wreg(rdev, (0x0280), (tmp), 0);

 tmp = dac_cntl & ~(0x03 | (1 << 15));
 tmp |= (2 << 0) | (1 << 3);
 r100_mm_wreg(rdev, (0x0058), (tmp), 0);
 ...
 r100_mm_wreg(rdev, (0x0d04), (tmp), 0);

 mdelay(2);

 if (r100_mm_rreg(rdev, (0x0058), 0) & (1 << 7))
  found = connector_status_connected;


 r100_mm_wreg(rdev, (0x0058), (dac_cntl), 0);
 r100_mm_wreg(rdev, (0x0d04), (dac_macro_cntl), 0);
 r100_mm_wreg(rdev, (0x0280), (dac_ext_cntl), 0);
 r100_mm_wreg(rdev, (0x0054), (crtc_ext_cntl), 0);
 rdev->pll_wreg(rdev, (0x0008), (vclk_ecp_cntl));
...
static void radeon_legacy_tmds_int_dpms(struct drm_encoder *encoder, int mode)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 uint32_t fp_gen_cntl = r100_mm_rreg(rdev, (0x0284), 0);
 do { } while( 0);
 ...
 r100_mm_wreg(rdev, (0x0284), (fp_gen_cntl), 0);
...
static void radeon_legacy_tmds_int_prepare(struct drm_encoder *encoder)
{
 ...
 if (rdev->is_atom_bios)
  ...
  radeon_combios_output_lock(encoder, 1);
 radeon_legacy_tmds_int_dpms(encoder, 3);
}
...
static void radeon_legacy_tmds_int_commit(struct drm_encoder *encoder)
{
 ...
 radeon_legacy_tmds_int_dpms(encoder, 0);
         ...
         struct drm_display_mode *adjusted_mode)
{
 ...
 tmp = tmds_pll_cntl = r100_mm_rreg(rdev, (0x02a8), 0);
 tmp &= 0xfffff;
 ...
 if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480)) || (rdev->family == CHIP_RV280)) {
  if (tmp & 0xfff00000)
   tmds_pll_cntl = tmp;
  else {
 ...
 tmds_transmitter_cntl = r100_mm_rreg(rdev, (0x02a4), 0) &
  ~(2);

    if (rdev->family == CHIP_R200 ||
 rdev->family == CHIP_R100 ||
 ((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480)))
     tmds_transmitter_cntl &= ~(1);
    else
     tmds_transmitter_cntl |= 1;

    fp_gen_cntl = (r100_mm_rreg(rdev, (0x0284), 0) |
     ((1 << 16) |
      (1 << 17)));
    ...
    if (radeon_crtc->crtc_id == 0) {
     if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480)) || rdev->family == CHIP_R200) {
      fp_gen_cntl &= ~(3 << 10);
      if (radeon_encoder->rmx_type != RMX_OFF)
       fp_gen_cntl |= (2 << 10);
      else
    ...
    r100_mm_wreg(rdev, (0x02a8), (tmds_pll_cntl), 0);
    r100_mm_wreg(rdev, (0x02a4), (tmds_transmitter_cntl), 0);
    r100_mm_wreg(rdev, (0x0284), (fp_gen_cntl), 0);
...
static void radeon_legacy_tmds_ext_dpms(struct drm_encoder *encoder, int mode)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 uint32_t fp2_gen_cntl = r100_mm_rreg(rdev, (0x0288), 0);
 do { } while( 0);

 switch (mode) {
 case 0:
  fp2_gen_cntl &= ~(1 << 1);
  fp2_gen_cntl |= ((1 << 2) | (1 << 25));
  break;
 case 1:
 case 2:
 case 3:
 ...
 r100_mm_wreg(rdev, (0x0288), (fp2_gen_cntl), 0);
...
static void radeon_legacy_tmds_ext_prepare(struct drm_encoder *encoder)
{
 ...
 if (rdev->is_atom_bios)
  ...
  radeon_combios_output_lock(encoder, 1);
 radeon_legacy_tmds_ext_dpms(encoder, 3);
}

static void radeon_legacy_tmds_ext_commit(struct drm_encoder *encoder)
{
 struct radeon_device *rdev = encoder->dev->dev_private;
 radeon_legacy_tmds_ext_dpms(encoder, 0);
         ...
         struct drm_display_mode *adjusted_mode)
{
 ...
 if (rdev->is_atom_bios) {
  radeon_encoder->pixel_clock = adjusted_mode->clock;
  atombios_dvo_setup(encoder, 1);
  fp2_gen_cntl = r100_mm_rreg(rdev, (0x0288), 0);
 } else {
  fp2_gen_cntl = r100_mm_rreg(rdev, (0x0288), 0);
...
static void radeon_legacy_tv_dac_dpms(struct drm_encoder *encoder, int mode)
{
 ...
 is_tv = radeon_encoder->active_device & ((0x1L << 0x00000002 )) ? 1 : 0;

 if (rdev->family == CHIP_R200)
  fp2_gen_cntl = r100_mm_rreg(rdev, (0x0288), 0);
 else {
  if (is_tv)
   tv_master_cntl = r100_mm_rreg(rdev, (0x0800), 0);
  else
   crtc2_gen_cntl = r100_mm_rreg(rdev, (0x03f8), 0);
  tv_dac_cntl = r100_mm_rreg(rdev, (0x088c), 0);
 }
 ...
 if (rdev->family == CHIP_R200) {
  ...
  if (is_tv)
   r100_mm_wreg(rdev, (0x0800), (tv_master_cntl), 0);

  else if (!(rdev->flags & RADEON_SINGLE_CRTC))
   r100_mm_wreg(rdev, (0x03f8), (crtc2_gen_cntl), 0);
  r100_mm_wreg(rdev, (0x088c), (tv_dac_cntl), 0);
 }
...
static void radeon_legacy_tv_dac_prepare(struct drm_encoder *encoder)
{
 ...
 if (rdev->is_atom_bios)
  ...
  radeon_combios_output_lock(encoder, 1);
 radeon_legacy_tv_dac_dpms(encoder, 3);
}
...
static void radeon_legacy_tv_dac_commit(struct drm_encoder *encoder)
{
 ...
 radeon_legacy_tv_dac_dpms(encoder, 0);
  ...
  struct drm_display_mode *adjusted_mode)
{
 ...
 if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480))) {
  gpiopad_a = r100_mm_rreg(rdev, (0x019c), 0) | 1;
  disp_output_cntl = r100_mm_rreg(rdev, (0x0d64), 0);
 } else if (rdev->family != CHIP_R200)
  disp_hw_debug = r100_mm_rreg(rdev, (0x0d14), 0);
 else if (rdev->family == CHIP_R200)
  fp2_gen_cntl = r100_mm_rreg(rdev, (0x0288), 0);

 if (rdev->family >= CHIP_R200)
  disp_tv_out_cntl = r100_mm_rreg(rdev, (0x0d6c), 0);
 ...
 if (is_tv) {
  ...
  dac2_cntl = r100_mm_rreg(rdev, (0x007c), 0) & ~(1 << 1);
  if (radeon_crtc->crtc_id == 0) {
   if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480))) {
    disp_output_cntl &= ~(0x03 << 2);
    disp_output_cntl |= (0x0 |
           (1 << 16));
   }
   if (rdev->family >= CHIP_R200) {
    disp_tv_out_cntl &= ~(1 << 16);
   } else {
    disp_hw_debug |= (1 << 5);
   }
  } else {
 ...
 if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480))) {
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x019c), 0); tmp_ &= (~1); tmp_ |= ((gpiopad_a) & ~(~1)); r100_mm_wreg(rdev, (0x019c), (tmp_), 0); } while (0);
  r100_mm_wreg(rdev, (0x0d64), (disp_output_cntl), 0);
 } else if (rdev->family != CHIP_R200)
  r100_mm_wreg(rdev, (0x0d14), (disp_hw_debug), 0);
 else if (rdev->family == CHIP_R200)
  r100_mm_wreg(rdev, (0x0288), (fp2_gen_cntl), 0);

 if (rdev->family >= CHIP_R200)
  r100_mm_wreg(rdev, (0x0d6c), (disp_tv_out_cntl), 0);
...
static _Bool r300_legacy_tv_detect(struct drm_encoder *encoder,
      struct drm_connector *connector)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 ...
 gpiopad_a = r100_mm_rreg(rdev, (0x019c), 0);
 dac_cntl2 = r100_mm_rreg(rdev, (0x007c), 0);
 crtc2_gen_cntl = r100_mm_rreg(rdev, (0x03f8), 0);
 dac_ext_cntl = r100_mm_rreg(rdev, (0x0280), 0);
 tv_dac_cntl = r100_mm_rreg(rdev, (0x088c), 0);
 disp_output_cntl = r100_mm_rreg(rdev, (0x0d64), 0);

 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x019c), 0); tmp_ &= (~1); tmp_ |= ((0) & ~(~1)); r100_mm_wreg(rdev, (0x019c), (tmp_), 0); } while (0);

 r100_mm_wreg(rdev, (0x007c), ((1 << 1)), 0);

 r100_mm_wreg(rdev, (0x03f8), ((1 << 7) | (1 << 6)), 0);


 tmp = disp_output_cntl & ~(0x03 << 2);
 tmp |= (0x01 << 2);
 r100_mm_wreg(rdev, (0x0d64), (tmp), 0);

 r100_mm_wreg(rdev, (0x0280), ((1 << 0) | (1 << 1) | (3 << 6) | (0xec << 8)), 0);





 r100_mm_wreg(rdev, (0x088c), ((1 << 8) | (8 << 16) | (6 << 20)), 0);




 r100_mm_rreg(rdev, (0x088c), 0);
 mdelay(4);

 r100_mm_wreg(rdev, (0x088c), ((1 << 0) | (1 << 1) | (1 << 4) | (1 << 8) | (8 << 16) | (6 << 20)), 0);
 ...
 tmp = r100_mm_rreg(rdev, (0x088c), 0);
 if ((tmp & (1 << 30)) != 0) {
  found = 1;
  do { } while( 0);
 } else if ((tmp & (1 << 31)) != 0) {
 ...
 r100_mm_wreg(rdev, (0x03f8), (crtc2_gen_cntl), 0);
 r100_mm_wreg(rdev, (0x0d64), (disp_output_cntl), 0);
 r100_mm_wreg(rdev, (0x007c), (dac_cntl2), 0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x019c), 0); tmp_ &= (~1); tmp_ |= ((gpiopad_a) & ~(~1)); r100_mm_wreg(rdev, (0x019c), (tmp_), 0); } while (0);
 return found;
}

static _Bool radeon_legacy_tv_detect(struct drm_encoder *encoder,
        struct drm_connector *connector)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 ...
 tv_master_cntl = r100_mm_rreg(rdev, (0x0800), 0);
 tv_dac_cntl = r100_mm_rreg(rdev, (0x088c), 0);
 config_cntl = r100_mm_rreg(rdev, (0x00e0), 0);
 tv_pre_dac_mux_cntl = r100_mm_rreg(rdev, (0x0888), 0);

 tmp = dac_cntl2 & ~(1 << 1);
 r100_mm_wreg(rdev, (0x007c), (tmp), 0);

 tmp = tv_master_cntl | (1 << 31);
 tmp &= ~((1 << 0) |
   (1 << 3) |
   (1 << 9) |
   (1 << 10) |
   (3 << 14));
 tmp |= (1 << 4) | (1 << 1);
 r100_mm_wreg(rdev, (0x0800), (tmp), 0);

 tmp = (1 << 0) | (1 << 1) |
  (1 << 4) | (1 << 8) |
  (8 << 16);

 if (config_cntl & (0xf << 16))
  tmp |= (4 << 20);
 else
  tmp |= (8 << 20);
 r100_mm_wreg(rdev, (0x088c), (tmp), 0);
 ...
 tmp = (1 << 1) | (1 << 2) |
  ...
  (6 << 12) |
  (0x109 << 16);
 r100_mm_wreg(rdev, (0x0888), (tmp), 0);
 ...
 r100_mm_wreg(rdev, (0x0888), (tv_pre_dac_mux_cntl), 0);
 r100_mm_wreg(rdev, (0x088c), (tv_dac_cntl), 0);
 r100_mm_wreg(rdev, (0x0800), (tv_master_cntl), 0);
 r100_mm_wreg(rdev, (0x007c), (dac_cntl2), 0);
 return found;
...
static _Bool radeon_legacy_ext_dac_detect(struct drm_encoder *encoder,
      struct drm_connector *connector)
{
 struct drm_device *dev = encoder->dev;
 struct radeon_device *rdev = dev->dev_private;
 ...
 gpio_monid = r100_mm_rreg(rdev, (0x0068), 0);
 fp2_gen_cntl = r100_mm_rreg(rdev, (0x0288), 0);
 disp_output_cntl = r100_mm_rreg(rdev, (0x0d64), 0);
 crtc2_gen_cntl = r100_mm_rreg(rdev, (0x03f8), 0);
 disp_lin_trans_grph_a = r100_mm_rreg(rdev, (0x0d80), 0);
 disp_lin_trans_grph_b = r100_mm_rreg(rdev, (0x0d84), 0);
 disp_lin_trans_grph_c = r100_mm_rreg(rdev, (0x0d88), 0);
 disp_lin_trans_grph_d = r100_mm_rreg(rdev, (0x0d8c), 0);
 disp_lin_trans_grph_e = r100_mm_rreg(rdev, (0x0d90), 0);
 disp_lin_trans_grph_f = r100_mm_rreg(rdev, (0x0d98), 0);
 crtc2_h_total_disp = r100_mm_rreg(rdev, (0x0300), 0);
 crtc2_v_total_disp = r100_mm_rreg(rdev, (0x0308), 0);
 crtc2_h_sync_strt_wid = r100_mm_rreg(rdev, (0x0304), 0);
 crtc2_v_sync_strt_wid = r100_mm_rreg(rdev, (0x030c), 0);

 tmp = r100_mm_rreg(rdev, (0x0068), 0);
 tmp &= ~(1 << 0);
 r100_mm_wreg(rdev, (0x0068), (tmp), 0);

 r100_mm_wreg(rdev, (0x0288), (((1 << 2) | (1 << 3) | (3 << 10) | (1 << 25) | (1 << 27))), 0);





 r100_mm_wreg(rdev, (0x0d64), ((0x02 | (0x01 << 4))), 0);


 r100_mm_wreg(rdev, (0x03f8), (((1 << 25) | (1 << 26))), 0);


 r100_mm_wreg(rdev, (0x0d80), (0x00000000), 0);
 r100_mm_wreg(rdev, (0x0d84), (0x000003f0), 0);
 r100_mm_wreg(rdev, (0x0d88), (0x00000000), 0);
 r100_mm_wreg(rdev, (0x0d8c), (0x000003f0), 0);
 r100_mm_wreg(rdev, (0x0d90), (0x00000000), 0);
 r100_mm_wreg(rdev, (0x0d98), (0x000003f0), 0);

 r100_mm_wreg(rdev, (0x0300), (0x01000008), 0);
 r100_mm_wreg(rdev, (0x0304), (0x00000800), 0);
 r100_mm_wreg(rdev, (0x0308), (0x00080001), 0);
 r100_mm_wreg(rdev, (0x030c), (0x00000080), 0);
 ...
 r100_mm_wreg(rdev, (0x0d80), (disp_lin_trans_grph_a), 0);
 r100_mm_wreg(rdev, (0x0d84), (disp_lin_trans_grph_b), 0);
 r100_mm_wreg(rdev, (0x0d88), (disp_lin_trans_grph_c), 0);
 r100_mm_wreg(rdev, (0x0d8c), (disp_lin_trans_grph_d), 0);
 r100_mm_wreg(rdev, (0x0d90), (disp_lin_trans_grph_e), 0);
 r100_mm_wreg(rdev, (0x0d98), (disp_lin_trans_grph_f), 0);
 r100_mm_wreg(rdev, (0x0300), (crtc2_h_total_disp), 0);
 r100_mm_wreg(rdev, (0x0308), (crtc2_v_total_disp), 0);
 r100_mm_wreg(rdev, (0x0304), (crtc2_h_sync_strt_wid), 0);
 r100_mm_wreg(rdev, (0x030c), (crtc2_v_sync_strt_wid), 0);
 r100_mm_wreg(rdev, (0x03f8), (crtc2_gen_cntl), 0);
 r100_mm_wreg(rdev, (0x0d64), (disp_output_cntl), 0);
 r100_mm_wreg(rdev, (0x0288), (fp2_gen_cntl), 0);
 r100_mm_wreg(rdev, (0x0068), (gpio_monid), 0);
            ...
            struct drm_connector *connector)
{
 ...
 if (connector->connector_type == 6 ||
     connector->connector_type == 5 ||
     connector->connector_type == 9) {
  _Bool tv_detect;

  if (radeon_encoder->active_device && !(radeon_encoder->active_device & ((0x1L << 0x00000002 ))))
   return connector_status_disconnected;
 ...
 if (radeon_encoder->active_device && !(radeon_encoder->active_device & ((0x1L << 0x00000000 ) | (0x1L << 0x00000004 )))) {
  do { } while( 0);
  return connector_status_disconnected;
 }
 ...
 if (rdev->flags & RADEON_SINGLE_CRTC) {
  ...
  tmp = crtc2_gen_cntl & ~(0xf << 8);
  tmp |= (1 << 7) |
   (2 << 8);
  r100_mm_wreg(rdev, (0x03f8), (tmp), 0);

  if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480))) {
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x019c), 0); tmp_ &= (~1); tmp_ |= ((1) & ~(~1)); r100_mm_wreg(rdev, (0x019c), (tmp_), 0); } while (0);
   tmp = disp_output_cntl & ~(0x03 << 2);
   tmp |= (0x01 << 2);
   r100_mm_wreg(rdev, (0x0d64), (tmp), 0);
  } else {
   tmp = disp_hw_debug & ~(1 << 5);
   r100_mm_wreg(rdev, (0x0d14), (tmp), 0);
  }
 }
 ...
 tmp = dac_cntl2 | (1 << 1) | (1 << 7);
 r100_mm_wreg(rdev, (0x007c), (tmp), 0);

 mdelay(10);

 if (((rdev->family == CHIP_R300) || (rdev->family == CHIP_RV350) || (rdev->family == CHIP_R350) || (rdev->family == CHIP_RV380) || (rdev->family == CHIP_R420) || (rdev->family == CHIP_R423) || (rdev->family == CHIP_RV410) || (rdev->family == CHIP_RS400) || (rdev->family == CHIP_RS480))) {
  if (r100_mm_rreg(rdev, (0x007c), 0) & (1 << 10))
   found = connector_status_connected;
 } else {
  if (r100_mm_rreg(rdev, (0x007c), 0) & (1 << 11))
   found = connector_status_connected;
 }
...
static struct radeon_encoder_int_tmds *radeon_legacy_get_tmds_info(struct radeon_encoder *encoder)
{
 ...
 tmds = kzalloc(sizeof(struct radeon_encoder_int_tmds), (0x0001 | 0x0004));
...
static struct radeon_encoder_ext_tmds *radeon_legacy_get_ext_tmds_info(struct radeon_encoder *encoder)
{
 ...
 tmds = kzalloc(sizeof(struct radeon_encoder_ext_tmds), (0x0001 | 0x0004));
...
radeon_add_legacy_encoder(struct drm_device *dev, uint32_t encoder_enum, uint32_t supported_device)
{
 ...
 radeon_encoder = kzalloc(sizeof(struct radeon_encoder), (0x0001 | 0x0004));
 if (!radeon_encoder)
  return;
 ...
 case 0x01:
  encoder->possible_crtcs = 0x1;
  drm_encoder_init(dev, encoder, &radeon_legacy_lvds_enc_funcs, 3);
  ...
  break;
 case 0x02:
  drm_encoder_init(dev, encoder, &radeon_legacy_tmds_int_enc_funcs, 2);
  drm_encoder_helper_add(encoder, &radeon_legacy_tmds_int_helper_funcs);
  radeon_encoder->enc_priv = radeon_legacy_get_tmds_info(radeon_encoder);
  break;
 case 0x04:
  drm_encoder_init(dev, encoder, &radeon_legacy_primary_dac_enc_funcs, 1);
  ...
  break;
 case 0x05:
  drm_encoder_init(dev, encoder, &radeon_legacy_tv_dac_enc_funcs, 4);
  ...
  break;
 case 0x0B:
  drm_encoder_init(dev, encoder, &radeon_legacy_tmds_ext_enc_funcs, 2);
