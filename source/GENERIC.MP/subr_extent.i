# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c" 2
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c" 2
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
...
static struct listhead { struct extent *lh_first; } ext_list;
...
extent_register(struct extent *ex)
{
 ...
 if (!initialized){
  do { ((&ext_list)->lh_first) = ((void *)0); } while (0);
  initialized = 1;
 }


 for((ep) = ((&ext_list)->lh_first); (ep)!= ((void *)0); (ep) = ((ep)->ex_link.le_next)) {
  if (ep == ex)
 ...
 do { if (((ex)->ex_link.le_next = (&ext_list)->lh_first) != ((void *)0)) (&ext_list)->lh_first->ex_link.le_prev = &(ex)->ex_link.le_next; (&ext_list)->lh_first = (ex); (ex)->ex_link.le_prev = &(&ext_list)->lh_first; } while (0);
}
    ...
    size_t storagesize, int flags)
{
 ...
 int fixed_extent = (storage != ((void *)0));
 ...
 if (fixed_extent == 0 && (storagesize != 0 || storage != ((void *)0)))
 ...
 if (fixed_extent) {
  ...
  __builtin_memset((storage), (0), (storagesize));
  ...
  cp += (((unsigned long)(sizeof(struct extent_fixed)) + 0xf) & ~0xf);
  sz -= (((unsigned long)(sizeof(struct extent_fixed)) + 0xf) & ~0xf);
  ...
  do { ((&fex->fex_freelist)->lh_first) = ((void *)0); } while (0);
  while (sz >= (((unsigned long)(sizeof(struct extent_region)) + 0xf) & ~0xf)) {
   rp = (struct extent_region *)cp;
   cp += (((unsigned long)(sizeof(struct extent_region)) + 0xf) & ~0xf);
   sz -= (((unsigned long)(sizeof(struct extent_region)) + 0xf) & ~0xf);
   do { if (((rp)->er_link.le_next = (&fex->fex_freelist)->lh_first) != ((void *)0)) (&fex->fex_freelist)->lh_first->er_link.le_prev = &(rp)->er_link.le_next; (&fex->fex_freelist)->lh_first = (rp); (rp)->er_link.le_prev = &(&fex->fex_freelist)->lh_first; } while (0);
  }
 } else {
  ex = (struct extent *)malloc(sizeof(struct extent),
      mtype, (flags & 0x0001) ? 0x0001 : 0x0002);
  if (ex == ((void *)0))
   return (((void *)0));
 }


 do { ((&ex->ex_regions)->lh_first) = ((void *)0); } while (0);
 ex->ex_name = name;
 ex->ex_start = start;
 ex->ex_end = end;
 ex->ex_mtype = mtype;
 ...
 if (flags & 0x0100) {
  ...
  rp->er_start = start;
  rp->er_end = end;
  do { if (((rp)->er_link.le_next = (&ex->ex_regions)->lh_first) != ((void *)0)) (&ex->ex_regions)->lh_first->er_link.le_prev = &(rp)->er_link.le_next; (&ex->ex_regions)->lh_first = (rp); (rp)->er_link.le_prev = &(&ex->ex_regions)->lh_first; } while (0);
 }
...
extent_destroy(struct extent *ex)
{
 ...
 for (rp = ((&ex->ex_regions)->lh_first); rp != ((void *)0); ) {
  orp = rp;
  rp = ((rp)->er_link.le_next);
  do { if ((orp)->er_link.le_next != ((void *)0)) (orp)->er_link.le_next->er_link.le_prev = (orp)->er_link.le_prev; *(orp)->er_link.le_prev = (orp)->er_link.le_next; ((orp)->er_link.le_prev) = ((void *)-1); ((orp)->er_link.le_next) = ((void *)-1); } while (0);
  extent_free_region_descriptor(ex, orp);
 }



 do { if ((ex)->ex_link.le_next != ((void *)0)) (ex)->ex_link.le_next->ex_link.le_prev = (ex)->ex_link.le_prev; *(ex)->ex_link.le_prev = (ex)->ex_link.le_next; ((ex)->ex_link.le_prev) = ((void *)-1); ((ex)->ex_link.le_next) = ((void *)-1); } while (0);



 if ((ex->ex_flags & 0x01) == 0)
  free(ex, ex->ex_mtype, sizeof(*ex));
}
# 295 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
static void
    ...
    struct extent_region *after, struct extent_region *rp)
{
 ...
 if (after == ((void *)0)) {
  ...
  if (((ex->ex_flags & 0x02) == 0) &&
      !(((&ex->ex_regions)->lh_first) == ((void *)0)) &&
 ...
 if (((after)->er_link.le_next) != ((void *)0) &&
  ...
  if (appended) {
   ...
   do { if ((nextr)->er_link.le_next != ((void *)0)) (nextr)->er_link.le_next->er_link.le_prev = (nextr)->er_link.le_prev; *(nextr)->er_link.le_prev = (nextr)->er_link.le_next; ((nextr)->er_link.le_prev) = ((void *)-1); ((nextr)->er_link.le_next) = ((void *)-1); } while (0);
 ...
 rp->er_start = start;
 rp->er_end = start + (size - 1);
 do { if (((rp)->er_link.le_next = (after)->er_link.le_next) != ((void *)0)) (after)->er_link.le_next->er_link.le_prev = &(rp)->er_link.le_next; (after)->er_link.le_next = (rp); (rp)->er_link.le_prev = &(after)->er_link.le_next; } while (0);
}
...
extent_alloc_region(struct extent *ex, u_long start, u_long size, int flags)
{
 ...
 alloc_start:
# 470 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
 last = ((void *)0);

 for((rp) = ((&ex->ex_regions)->lh_first); (rp)!= ((void *)0); (rp) = ((rp)->er_link.le_next)) {
  if (rp->er_start > end) {
  ...
  if (rp->er_end >= start) {
   ...
   if (flags & 0x0080) {
# 530 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
    if (rp->er_start <= start) {
     ...
     do { if ((rp)->er_link.le_next != ((void *)0)) (rp)->er_link.le_next->er_link.le_prev = (rp)->er_link.le_prev; *(rp)->er_link.le_prev = (rp)->er_link.le_next; ((rp)->er_link.le_prev) = ((void *)-1); ((rp)->er_link.le_next) = ((void *)-1); } while (0);
     extent_free_region_descriptor(ex, rp);
     goto alloc_start;
...
# 586 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
int
    ...
    struct extent_region *myrp, u_long *result)
{
 ...
 last = ((void *)0);
# 647 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
 bestovh = 0;
 beststart = 0;
 bestlast = ((void *)0);
 ...
 if (last != ((void *)0) && last->er_end >= newstart)
  newstart = extent_align((last->er_end + 1), alignment, skew);

 for (; rp != ((void *)0); rp = ((rp)->er_link.le_next)) {
  ...
  if (((((newstart) + (size)) >= (newstart)) && (((newstart) + (size)) <= (rp->er_start)))) {
   ...
   if (boundary) {
    ...
    dontcross = extent_align(newstart+1, boundary,
        (flags & 0x0040) ? 0 : ex->ex_start)
        - 1;
# 733 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
...
# 804 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
 if (((((newstart) + ((size - 1))) >= (newstart)) && (((newstart) + ((size - 1))) <= (subend)))) {
  ...
  if (boundary) {
   ...
   dontcross = extent_align(newstart+1, boundary,
       (flags & 0x0040) ? 0 : ex->ex_start)
       - 1;
# 828 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
   if (dontcross < ex->ex_start)
    dontcross = ex->ex_end;
   else if (newend > dontcross) {
 ...
 fail:
# 889 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
 if (((flags & 0x0002) == 0) && (bestovh != 0)) {
 ...
 if (flags & 0x0020) {
  ex->ex_flags |= 0x04;
  error = tsleep(ex,
      16 | ((flags & 0x0004) ? 0x100 : 0), "extnt", 0);
  if (error)
   return (error);
  goto alloc_start;
 }
...
{
 struct extent_region *rp, *nrp = ((void *)0);
 u_long end = start + (size - 1);
 int exflags;
...
# 995 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
 exflags = ex->ex_flags;
...
# 1022 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
 for((rp) = ((&ex->ex_regions)->lh_first); (rp)!= ((void *)0); (rp) = ((rp)->er_link.le_next)) {
  ...
  if ((start > rp->er_start) && (end < rp->er_end)) {
   ...
   do { if (((nrp)->er_link.le_next = (rp)->er_link.le_next) != ((void *)0)) (rp)->er_link.le_next->er_link.le_prev = &(nrp)->er_link.le_next; (rp)->er_link.le_next = (nrp); (nrp)->er_link.le_prev = &(rp)->er_link.le_next; } while (0);
...
extent_alloc_region_descriptor(struct extent *ex, int flags)
{
 ...
 if (ex->ex_flags & 0x01) {
  ...
  while ((((&fex->fex_freelist)->lh_first) == ((void *)0))) {
   if (flags & 0x0010)
    goto alloc;
  ...
  do { if ((rp)->er_link.le_next != ((void *)0)) (rp)->er_link.le_next->er_link.le_prev = (rp)->er_link.le_prev; *(rp)->er_link.le_prev = (rp)->er_link.le_next; ((rp)->er_link.le_prev) = ((void *)-1); ((rp)->er_link.le_next) = ((void *)-1); } while (0);
# 1131 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/subr_extent.c"
  return (rp);
 }

 alloc:
 rp = pool_get(&ex_region_pl, (flags & 0x0001) ? 0x0001 :
     0x0002);
 if (rp != ((void *)0))
  rp->er_flags = 0x01;
    ...
    int (*pr)(const char *, ...) __attribute__((__format__(__kprintf__,1,2))))
{
 ...
 (*pr)("extent `%s' (0x%lx - 0x%lx), flags=%b\n", ex->ex_name,
     ex->ex_start, ex->ex_end, ex->ex_flags, "\20\4FLWANTED\3WANTED\2NOCOALESCE\1FIXED");
