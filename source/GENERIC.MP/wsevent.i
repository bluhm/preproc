# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsevent.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsevent.c"
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsevent.c"
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsevent.c" 2
...
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsevent.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsevent.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsevent.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsevent.c" 2
...
# 86 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsevent.c" 2
...
# 87 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/wscons/wsevent.c" 2
...
wsevent_init(struct wseventvar *ev)
{
 ...
 ev->get = ev->put = 0;
 ev->q = malloc(256 * sizeof(struct wscons_event),
     2, 0x0001 | 0x0008);
}
...
wsevent_read(struct wseventvar *ev, struct uio *uio, int flags)
{
 ...
 if (ev->put < ev->get)
  ...
  cnt = ev->put - ev->get;
 _splx(s);
 n = (((uio->uio_resid) + ((sizeof(struct wscons_event)) - 1)) / (sizeof(struct wscons_event)));
 if (cnt > n)
  cnt = n;
...
filt_wseventread(struct knote *kn, long hint)
{
 ...
 if (ev->get < ev->put)
  kn->kn_kevent.data = ev->put - ev->get;
 else
  kn->kn_kevent.data = (256 - ev->get) + ev->put;
