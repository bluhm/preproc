# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
...
# 26 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
...
# 28 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
...
# 31 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
...
# 32 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
...
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/usbdevs.h" 1
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c" 2
# 60 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c"
struct udcf_softc {
 ...
 struct timeout sc_bv_to;
 struct timeout sc_db_to;
 struct timeout sc_mg_to;
 struct timeout sc_sl_to;
...
# 110 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c"
...
udcf_match(struct device *parent, void *match, void *aux)
{
 ...
 return (usbd_match_device((const struct usb_devno *)(udcf_devs), sizeof (udcf_devs) / sizeof ((udcf_devs)[0]), sizeof ((udcf_devs)[0]), (uaa->vendor), (uaa->product)) != ((void *)0) ?
     13 : 0);
}
...
udcf_attach(struct device *parent, struct device *self, void *aux)
{
 ...
 ((&sc->sc_task)->fun = (udcf_probe), (&sc->sc_task)->arg = (sc), (&sc->sc_task)->type = (0), (&sc->sc_task)->state = 0x0);
 ((&sc->sc_bv_task)->fun = (udcf_bv_probe), (&sc->sc_bv_task)->arg = (sc), (&sc->sc_bv_task)->type = (0), (&sc->sc_bv_task)->state = 0x0);
 ((&sc->sc_mg_task)->fun = (udcf_mg_probe), (&sc->sc_mg_task)->arg = (sc), (&sc->sc_mg_task)->type = (0), (&sc->sc_mg_task)->state = 0x0);
 ((&sc->sc_sl_task)->fun = (udcf_sl_probe), (&sc->sc_sl_task)->arg = (sc), (&sc->sc_sl_task)->type = (0), (&sc->sc_sl_task)->state = 0x0);
...
# 205 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/usb/udcf.c"
...
udcf_detach(struct device *self, int flags)
{
 ...
 if (((&sc->sc_to)->to_flags & 4))
  timeout_del(&sc->sc_to);
 if (((&sc->sc_bv_to)->to_flags & 4))
  timeout_del(&sc->sc_bv_to);
 if (((&sc->sc_mg_to)->to_flags & 4))
  timeout_del(&sc->sc_mg_to);
 if (((&sc->sc_sl_to)->to_flags & 4))
  timeout_del(&sc->sc_sl_to);
 if (((&sc->sc_it_to)->to_flags & 4))
...
udcf_nc_init_hw(struct udcf_softc *sc)
{
 ...
 sc->sc_req.bmRequestType = (0x80 | 0x40 | 0x00);
 sc->sc_req.bRequest = 1;
 ((sc->sc_req.wValue)[0] = (u_int8_t)(0), (sc->sc_req.wValue)[1] = (u_int8_t)((0) >> 8));
 ((sc->sc_req.wIndex)[0] = (u_int8_t)(0x1f), (sc->sc_req.wIndex)[1] = (u_int8_t)((0x1f) >> 8));
 ((sc->sc_req.wLength)[0] = (u_int8_t)(1), (sc->sc_req.wLength)[1] = (u_int8_t)((1) >> 8));
 ...
 req.bmRequestType = (0x00 | 0x40 | 0x00);
 req.bRequest = 0;
 ((req.wValue)[0] = (u_int8_t)(0x98), (req.wValue)[1] = (u_int8_t)((0x98) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0x33), (req.wIndex)[1] = (u_int8_t)((0x33) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
 if ((err = usbd_do_request_flags(sc->sc_udev, &req, &result,
     0x04, &actlen, 5000))) {
  ;
...
udcf_ft232r_init_hw(struct udcf_softc *sc)
{
 ...
 ((req.wValue)[0] = (u_int8_t)(0x00), (req.wValue)[1] = (u_int8_t)((0x00) >> 8));
 ((req.wIndex)[0] = (u_int8_t)(0), (req.wIndex)[1] = (u_int8_t)((0) >> 8));
 ((req.wLength)[0] = (u_int8_t)(0), (req.wLength)[1] = (u_int8_t)((0) >> 8));
...
udcf_probe(void *xsc)
{
 ...
 timeout_add(&sc->sc_mg_to, t_mg);
 timeout_add(&sc->sc_sl_to, t_sl);
}
...
udcf_mg_probe(void *xsc)
{
 ...
 if (m_bit == 0 && s_bit == 1 && p1 == p1_bit && p2 == p2_bit &&
  ...
  if ((ymdhm.dt_year = 2000 + (((year_bits) >> 4) * 10 + ((year_bits) & 0xf))) > 2037) {
   ;
   sc->sc_sync = 1;
   goto cleanbits;
  }
  ymdhm.dt_min = (((minute_bits) >> 4) * 10 + ((minute_bits) & 0xf));
  ymdhm.dt_hour = (((hour_bits) >> 4) * 10 + ((hour_bits) & 0xf));
  ymdhm.dt_day = (((day_bits) >> 4) * 10 + ((day_bits) & 0xf));
  ymdhm.dt_mon = (((month_bits) >> 4) * 10 + ((month_bits) & 0xf));
  ymdhm.dt_sec = 0;
  ...
  if (sc->sc_last) {
   ...
   if (skew && skew * 100LL / tdiff_local > 5) {
    ;
    goto cleanbits;
   } else {
    if (sc->sc_nrecv < 2) {
