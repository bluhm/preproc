# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c"
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c"
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c" 2
...
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/mman.h" 1
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c" 2
...
int fill_vmmap(struct process *, struct kinfo_vmentry *,
       size_t *);
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c" 2
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c"
void
vmcmdset_extend(struct exec_vmcmd_set *evsp)
{
 ...
 ocnt = evsp->evs_cnt;
 ((ocnt > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c", 88, "ocnt > 0"));

 evsp->evs_cnt += ocnt;


 nvcp = mallocarray(evsp->evs_cnt, sizeof(*nvcp), 63,
     0x0001);
 __builtin_memcpy((nvcp), (evsp->evs_cmds), (ocnt * sizeof(*nvcp)));
 if (evsp->evs_cmds != evsp->evs_start)
  free(evsp->evs_cmds, 63, ocnt * sizeof(*nvcp));
 evsp->evs_cmds = nvcp;
}
...
kill_vmcmds(struct exec_vmcmd_set *evsp)
{
 ...
 for (i = 0; i < evsp->evs_used; i++) {
  vcp = &evsp->evs_cmds[i];
  if (vcp->ev_vp != ((struct vnode *)((void *)0)))
   vrele(vcp->ev_vp);
 }
...
{
 struct exec_vmcmd *base_vc = ((void *)0);
 int error = 0;
 int i;
...
vmcmd_map_pagedvn(struct proc *p, struct exec_vmcmd *cmd)
{
 ...
 if (cmd->ev_len == 0)
  return (0);
 if (cmd->ev_offset & ((1 << 13) - 1))
  return (22);
 if (cmd->ev_addr & ((1 << 13) - 1))
  return (22);
 if (cmd->ev_len & ((1 << 13) - 1))
  return (22);
 ...
 uobj = uvn_attach(cmd->ev_vp, 0x01 | 0x04);
 if (uobj == ((void *)0))
  return (12);
 ...
 error = uvm_map(&p->p_vmspace->vm_map, &cmd->ev_addr, cmd->ev_len,
     ...
     ((cmd->ev_prot) | (((0x01 | 0x02 | 0x04)) << 8) | ((1) << 4) | ((0) << 12) | (0x0080000|0x0010000)));
...
# 223 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c"
int
vmcmd_map_readvn(struct proc *p, struct exec_vmcmd *cmd)
{
 ...
 error = uvm_map(&p->p_vmspace->vm_map, &cmd->ev_addr,
     ...
     ((prot | 0x02) | (((0x01 | 0x02 | 0x04)) << 8) | ((1) << 4) | ((0) << 12) | (0x0010000|0x0020000|0x0080000)));
 ...
 error = vn_rdwr(UIO_READ, cmd->ev_vp, (caddr_t)cmd->ev_addr,
     cmd->ev_len, cmd->ev_offset, UIO_USERSPACE, 0x01,
     p->p_ucred, ((void *)0), p);
 if (error)
  return (error);
 ...
 if ((prot & 0x02) == 0) {
  ...
  return (uvm_map_protect(&p->p_vmspace->vm_map,
      ((cmd->ev_addr) & ~((1 << 13) - 1)),
      (((cmd->ev_addr + cmd->ev_len) + ((1 << 13) - 1)) & ~((1 << 13) - 1)),
      prot, 0));
 }
 return (0);
}
...
# 334 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c"
int
exec_setup_stack(struct proc *p, struct exec_package *epp)
{
 ...
 epp->ep_maxsaddr = 0xffffffffffffe000L - (32L*1024*1024) - (1024 * 1024);
 epp->ep_minsaddr = 0xffffffffffffe000L;

 epp->ep_ssize = (((p->p_p->ps_limit->pl_rlimit[3].rlim_cur) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
...
# 380 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/exec_subr.c"
