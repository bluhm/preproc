# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c"
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c"
...
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
int if_rxr_ioctl(struct if_rxrinfo *, const char *, u_int,
     struct if_rxring *);
# 77 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 80 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 83 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.h" 1
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.h"
struct mldv2_query {
 struct icmp6_hdr mld_icmp6_hdr;
 struct in6_addr mld_addr;
 uint8_t mld_misc;
...
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.h"
struct mldv2_report {
 struct icmp6_hdr mld_icmp6_hdr;
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c" 2

static struct ip6_pktopts ip6_opts;
static int mld_timers_are_running;

static struct in6_addr mld_all_nodes_linklocal = {{{ 0xff, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 }}};
static struct in6_addr mld_all_routers_linklocal = {{{ 0xff, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02 }}};
...
mld6_init(void)
{
 ...
 u_int16_t rtalert_code = ((__uint16_t)((u_int16_t)0));
 ...
 hbh_buf[4] = 0x05;
 hbh_buf[5] = 4 - 2;
 __builtin_memcpy((&hbh_buf[6]), ((caddr_t)&rtalert_code), (sizeof(u_int16_t)));
...
mld6_start_listening(struct in6_multi *in6m)
{
 ...
 mld_all_nodes_linklocal.__u6_addr.__u6_addr16[1] = ((__uint16_t)(in6m->in6m_ifma.ifma_ifidx));
 if ((__builtin_memcmp((&(&in6m->in6m_sin.sin6_addr)->__u6_addr.__u6_addr8[0]), (&(&mld_all_nodes_linklocal)->__u6_addr.__u6_addr8[0]), (sizeof(struct in6_addr))) == 0) ||
     ((&in6m->in6m_sin.sin6_addr)->__u6_addr.__u6_addr8[1] & 0x0f) < 0x02) {
  in6m->in6m_timer = 0;
  in6m->in6m_state = 0;
 } else {
  mld6_sendpkt(in6m, 131, ((void *)0));
  in6m->in6m_timer =
      (arc4random_uniform(10 * 5) + 1);
...
{
 mld_all_nodes_linklocal.__u6_addr.__u6_addr16[1] = ((__uint16_t)(in6m->in6m_ifma.ifma_ifidx));
 mld_all_routers_linklocal.__u6_addr.__u6_addr16[1] =
     ((__uint16_t)(in6m->in6m_ifma.ifma_ifidx));

 if (in6m->in6m_state == 1 &&
     (!(__builtin_memcmp((&(&in6m->in6m_sin.sin6_addr)->__u6_addr.__u6_addr8[0]), (&(&mld_all_nodes_linklocal)->__u6_addr.__u6_addr8[0]), (sizeof(struct in6_addr))) == 0)) &&
     ((&in6m->in6m_sin.sin6_addr)->__u6_addr.__u6_addr8[1] & 0x0f) > 0x01)
...
mld6_input(struct mbuf *m, int off)
{
 ...
 do { struct mbuf *t; int tmp; if ((m)->m_hdr.mh_len >= (off) + (sizeof(*mldh))) (mldh) = (struct mld_hdr *)(((caddr_t)(((m))->m_hdr.mh_data)) + (off)); else { t = m_pulldown((m), (off), (sizeof(*mldh)), &tmp); if (t) { if (t->m_hdr.mh_len < tmp + (sizeof(*mldh))) panic("m_pulldown malfunction"); (mldh) = (struct mld_hdr *)(((caddr_t)((t)->m_hdr.mh_data)) + tmp); } else { (mldh) = (struct mld_hdr *)((void *)0); (m) = ((void *)0); } } } while ( 0);
 if (mldh == ((void *)0)) {
...
# 189 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c"
  m_freem(m);
  return;
 }
...
# 210 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c"
...
# 239 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c"
  timer = ((__uint16_t)(mldh->mld_icmp6_hdr.icmp6_dataun.icmp6_un_data16[0]))*5/1000;
  if (timer == 0 && mldh->mld_icmp6_hdr.icmp6_dataun.icmp6_un_data16[0])
   timer = 1;
  mld_all_nodes_linklocal.__u6_addr.__u6_addr16[1] =
   ((__uint16_t)(ifp->if_index));
  ...
  for((ifma) = ((&ifp->if_maddrlist)->tqh_first); (ifma) != ((void *)0); (ifma) = ((ifma)->ifma_list.tqe_next)) {
   ...
   if ((__builtin_memcmp((&(&in6m->in6m_sin.sin6_addr)->__u6_addr.__u6_addr8[0]), (&(&mld_all_nodes_linklocal)->__u6_addr.__u6_addr8[0]), (sizeof(struct in6_addr))) == 0) ||
       ...
       ((&in6m->in6m_sin.sin6_addr)->__u6_addr.__u6_addr8[1] & 0x0f) <
       0x02)
    continue;

   if (((*(const u_int32_t *)(const void *)(&(&mldh->mld_addr)->__u6_addr.__u6_addr8[0]) == 0) && (*(const u_int32_t *)(const void *)(&(&mldh->mld_addr)->__u6_addr.__u6_addr8[4]) == 0) && (*(const u_int32_t *)(const void *)(&(&mldh->mld_addr)->__u6_addr.__u6_addr8[8]) == 0) && (*(const u_int32_t *)(const void *)(&(&mldh->mld_addr)->__u6_addr.__u6_addr8[12]) == 0)) ||
       (__builtin_memcmp((&(&mldh->mld_addr)->__u6_addr.__u6_addr8[0]), (&(&in6m->in6m_sin.sin6_addr)->__u6_addr.__u6_addr8[0]), (sizeof(struct in6_addr))) == 0))
  ...
  break;
 case 131:
# 287 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c"
  ...
  do { struct ifmaddr *ifma; (in6m) = ((void *)0); for((ifma) = ((&(ifp)->if_maddrlist)->tqh_first); (ifma) != ((void *)0); (ifma) = ((ifma)->ifma_list.tqe_next)) if (ifma->ifma_addr->sa_family == 24 && (__builtin_memcmp((&(&ifmatoin6m(ifma)->in6m_sin.sin6_addr)->__u6_addr.__u6_addr8[0]), (&(&(mldh->mld_addr))->__u6_addr.__u6_addr8[0]), (sizeof(struct in6_addr))) == 0)) { (in6m) = ifmatoin6m(ifma); break; } } while ( 0);
  if (in6m) {
   in6m->in6m_timer = 0;
   in6m->in6m_state = 0;
  }
  ...
  break;
 default:
# 318 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/mld6.c"
  break;
 }
 if_put(ifp);
...
mld6_sendpkt(struct in6_multi *in6m, int type, const struct in6_addr *dst)
{
 ...
 ignflags = 0x04|0x01;
 if ((ia6 = in6ifa_ifpforlinklocal(ifp, ignflags)) == ((void *)0)) {
  if_put(ifp);
  return;
 }
 ...
 mh->M_dat.MH.MH_pkthdr.ph_ifidx = 0;
 mh->M_dat.MH.MH_pkthdr.ph_rtableid = ifp->if_data.ifi_rdomain;
 ...
 ip6->ip6_dst = dst ? *dst : in6m->in6m_sin.sin6_addr;
 ...
 mldh->mld_addr = in6m->in6m_sin.sin6_addr;
 if ((((&mldh->mld_addr)->__u6_addr.__u6_addr8[0] == 0xff) && (((&mldh->mld_addr)->__u6_addr.__u6_addr8[1] & 0x0f) == 0x02)))
  mldh->mld_addr.__u6_addr.__u6_addr16[1] = 0;
 mh->M_dat.MH.MH_pkthdr.csum_flags |= 0x0200;


 __builtin_bzero((&im6o), (sizeof(im6o)));
 ...
 im6o.im6o_loop = (ip6_mrouter[ifp->if_data.ifi_rdomain] != ((void *)0));

 if_put(ifp);

 icmp6stat_inc(icp6s_outhist + type);
 ip6_output(mh, &ip6_opts, ((void *)0), ia6 ? 0 : 0x01, &im6o,
     ((void *)0));
}
