# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c"
# 68 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 69 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 71 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 72 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 74 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 76 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 79 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 81 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 82 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 84 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 85 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 88 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lancereg.h" 1
# 91 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
...
# 92 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c" 2
# 101 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c"
...
# 130 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c"
...
ether_cmp(void *one, void *two)
{
 ...
 uint16_t diff;
# 152 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c"
 diff = (a[0] - b[0]) | (a[1] - b[1]) | (a[2] - b[2]);


 return (diff);
}
# 165 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c"
void
lance_config(struct lance_softc *sc)
{
 ...
 if (sc->sc_supmedia != ((void *)0)) {
  ...
  ifmedia_add(&sc->sc_ifmedia, 0x0000000000000100ULL|1ULL, 0, ((void *)0));
  ifmedia_set(&sc->sc_ifmedia, 0x0000000000000100ULL|1ULL);
 }
 ...
 sc->sc_rbufaddr = mallocarray(sc->sc_nrbuf, sizeof(int), 2,
     0x0001);
 sc->sc_tbufaddr = mallocarray(sc->sc_ntbuf, sizeof(int), 2,
     0x0001);
}
...
lance_init(struct lance_softc *sc)
{
 ...
 (*sc->sc_wrcsr)(sc, 0x0003, sc->sc_conf3);


 (*sc->sc_meminit)(sc);


 a = sc->sc_addr + (sc->sc_initaddr);
 (*sc->sc_wrcsr)(sc, 0x0001, a);
 (*sc->sc_wrcsr)(sc, 0x0002, a >> 16);


 delay(100);
 (*sc->sc_wrcsr)(sc, 0x0000, 0x0001);


 for (timo = 100000; timo; timo--)
  if ((*sc->sc_rdcsr)(sc, 0x0000) & 0x0100)
   break;

 if ((*sc->sc_rdcsr)(sc, 0x0000) & 0x0100) {

  (*sc->sc_wrcsr)(sc, 0x0000, 0x0040 | 0x0002);
  ifp->if_flags |= 0x40;
...
lance_put(struct lance_softc *sc, int boff, struct mbuf *m)
{
 ...
 for (; m; m = n) {
  ...
  (*sc->sc_copytobuf)(sc, ((void *)((m)->m_hdr.mh_data)), boff, len);
  boff += len;
  tlen += len;
  n = m_free(m);
 }
 if (tlen < 60) {
  (*sc->sc_zerobuf)(sc, boff, 60 - tlen);
  tlen = 60;
 }
 return (tlen);
}
...
lance_get(struct lance_softc *sc, int boff, int totlen)
{
 ...
 while (totlen > 0) {
  ...
  (*sc->sc_copyfrombuf)(sc, ((caddr_t)((m)->m_hdr.mh_data)), boff, len);
  boff += len;
  totlen -= len;
  *mp = m;
  mp = &m->m_hdr.mh_next;
...
lance_read(struct lance_softc *sc, int boff, int len)
{
 ...
 if (len <= sizeof(struct ether_header) ||
     len > ((ifp->if_data.ifi_capabilities & 0x00000010) ?
  4 + (1518 - ((6 * 2) + 2) - 4) + sizeof(struct ether_header) :
  (1518 - ((6 * 2) + 2) - 4) + sizeof(struct ether_header))) {
...
# 450 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c"
...
# 579 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c"
...
# 619 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../dev/ic/lance.c"
void
lance_copytobuf_contig(struct lance_softc *sc, void *from, int boff, int len)
{
 ...
 __builtin_memcpy((buf + boff), (from), (len));
}
...
lance_copyfrombuf_contig(struct lance_softc *sc, void *to, int boff, int len)
{
 ...
 __builtin_memcpy((to), (buf + boff), (len));
}
...
lance_zerobuf_contig(struct lance_softc *sc, int boff, int len)
{
 ...
 __builtin_memset((buf + boff), (0), (len));
}
