# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c"
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c"
...
# 41 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
int addlog(const char *, ...)
    __attribute__((__format__(__kprintf__,1,2)));
void logwakeup(void);
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 54 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 57 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 61 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_types.h" 1
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
void pipexintr(void);
# 63 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 64 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 66 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 67 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 70 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/bpfilter.h" 1
# 73 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2
...
# 75 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2


# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.h" 1
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.h"
struct tuninfo {
 u_int mtu;
 u_short type;
 u_short flags;
...
# 78 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c" 2

struct tun_softc {
 struct arpcom arpcom;
 struct selinfo tun_rsel;
 struct selinfo tun_wsel;
 struct { struct tun_softc *le_next; struct tun_softc **le_prev; } entry;
 int tun_unit;
 uid_t tun_siguid;
 uid_t tun_sigeuid;
 pid_t tun_pgid;
...
# 105 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c"
void tunattach(int);
...
struct filterops tunread_filtops =
 { 1, ((void *)0), filt_tunrdetach, filt_tunread};

struct filterops tunwrite_filtops =
 { 1, ((void *)0), filt_tunwdetach, filt_tunwrite};
...
tunattach(int n)
{
 do { ((&tun_softc_list)->lh_first) = ((void *)0); } while (0);
 do { ((&tap_softc_list)->lh_first) = ((void *)0); } while (0);
...
{
 return (tun_create(ifc, unit, 0x0800));
}
...
tun_create(struct if_clone *ifc, int unit, int flags)
{
 ...
 if ((flags & 0x0800) == 0) {
  ...
  do { if (((tp)->entry.le_next = (&tun_softc_list)->lh_first) != ((void *)0)) (&tun_softc_list)->lh_first->entry.le_prev = &(tp)->entry.le_next; (&tun_softc_list)->lh_first = (tp); (tp)->entry.le_prev = &(&tun_softc_list)->lh_first; } while (0);
 } else {
  tp->tun_flags |= 0x0800;
  ether_fakeaddr(ifp);
  ifp->if_flags =
  ...
  do { if (((tp)->entry.le_next = (&tap_softc_list)->lh_first) != ((void *)0)) (&tap_softc_list)->lh_first->entry.le_prev = &(tp)->entry.le_next; (&tap_softc_list)->lh_first = (tp); (tp)->entry.le_prev = &(&tap_softc_list)->lh_first; } while (0);
 }


 if ((tp->tun_flags & 0x0800) == 0)
...
tun_clone_destroy(struct ifnet *ifp)
{
 ...
 do { if ((tp)->entry.le_next != ((void *)0)) (tp)->entry.le_next->entry.le_prev = (tp)->entry.le_prev; *(tp)->entry.le_prev = (tp)->entry.le_next; ((tp)->entry.le_prev) = ((void *)-1); ((tp)->entry.le_next) = ((void *)-1); } while (0);

 if (tp->tun_flags & 0x0800)
  ether_ifdetach(ifp);
...
tun_lookup(int unit)
{
 ...
 for((tp) = ((&tun_softc_list)->lh_first); (tp)!= ((void *)0); (tp) = ((tp)->entry.le_next))
  if (tp->tun_unit == unit)
   return (tp);
 return (((void *)0));
}
...
tap_lookup(int unit)
{
 ...
 for((tp) = ((&tap_softc_list)->lh_first); (tp)!= ((void *)0); (tp) = ((tp)->entry.le_next))
  if (tp->tun_unit == unit)
   return (tp);
 return (((void *)0));
}
 ...
 for((ifa) = ((&ifp->if_addrlist)->tqh_first); (ifa) != ((void *)0); (ifa) = ((ifa)->ifa_list.tqe_next)) {
  ...
  if (ifa->ifa_addr->sa_family == 24) {
   ...
   if (ifp->if_flags & 0x10) {
    ...
    if (sin6 &&
        !((*(const u_int32_t *)(const void *)(&(&sin6->sin6_addr)->__u6_addr.__u6_addr8[0]) == 0) && (*(const u_int32_t *)(const void *)(&(&sin6->sin6_addr)->__u6_addr.__u6_addr8[4]) == 0) && (*(const u_int32_t *)(const void *)(&(&sin6->sin6_addr)->__u6_addr.__u6_addr8[8]) == 0) && (*(const u_int32_t *)(const void *)(&(&sin6->sin6_addr)->__u6_addr.__u6_addr8[12]) == 0)))
     tp->tun_flags |= 0x0010;
   } else
    tp->tun_flags &= ~0x0010;
  }
...
tun_ioctl(struct ifnet *ifp, u_long cmd, caddr_t data)
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((127))):
  if (ifr->ifr_ifru.ifru_metric < (64 - ((6 * 2) + 2) - 4) || ifr->ifr_ifru.ifru_metric > 16384)
   error = 22;
  else
    ...
    struct rtentry *rt)
{
 ...
 (m0) = m_prepend((m0), (sizeof(*af)), (0x0002));
 if (m0 == ((void *)0))
  return (55);
 af = ((u_int32_t *)((m0)->m_hdr.mh_data));
 *af = ((__uint32_t)(dst->sa_family));
 ...
 if (pipex_enable && (m0 = pipex_output(m0, dst->sa_family,
     sizeof(u_int32_t), &tp->pipex_iface)) == ((void *)0)) {
  return (0);
 }
    ...
    struct proc *p)
{
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct tuninfo) & 0x1fff) << 16) | ((('t')) << 8) | ((91))):
  ...
  if (tunp->mtu < (64 - ((6 * 2) + 2) - 4) || tunp->mtu > 16384)
   return (22);
  tp->arpcom.ac_if.if_data.ifi_mtu = tunp->mtu;
  tp->arpcom.ac_if.if_data.ifi_type = tunp->type;
  tp->arpcom.ac_if.if_flags =
      (tunp->flags & (0x1|0x10|0x8000|0x2)) |
      (tp->arpcom.ac_if.if_flags & ~(0x1|0x10|0x8000|0x2));
  tp->arpcom.ac_if.if_data.ifi_baudrate = tunp->baudrate;
  break;
 case ((unsigned long)0x40000000 | ((sizeof(struct tuninfo) & 0x1fff) << 16) | ((('t')) << 8) | ((92))):
  tunp = (struct tuninfo *)data;
  tunp->mtu = tp->arpcom.ac_if.if_data.ifi_mtu;
  tunp->type = tp->arpcom.ac_if.if_data.ifi_type;
  tunp->flags = tp->arpcom.ac_if.if_flags;
  tunp->baudrate = tp->arpcom.ac_if.if_data.ifi_baudrate;
  break;
# 649 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c"
 case ((unsigned long)0x80000000 | ((sizeof(int) & 0x1fff) << 16) | ((('t')) << 8) | ((93))):
  switch (*(int *)data & (0x10|0x2)) {
  case 0x10:
  case 0x2:
   tp->arpcom.ac_if.if_flags &= ~(0x1|0x10|0x8000|0x2);
   tp->arpcom.ac_if.if_flags |= *(int *)data & (0x1|0x10|0x8000|0x2);
   break;
  default:
   return (22);
  }
 ...
 case (((unsigned long)0x80000000|(unsigned long)0x40000000) | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((33))):
  if (!(tp->tun_flags & 0x0800))
   return (22);
  __builtin_bcopy((tp->arpcom.ac_enaddr), (data), (sizeof(tp->arpcom.ac_enaddr)));
 ...
 case ((unsigned long)0x80000000 | ((sizeof(struct ifreq) & 0x1fff) << 16) | ((('i')) << 8) | ((12))):
  if (!(tp->tun_flags & 0x0800))
   return (22);
  __builtin_bcopy((data), (tp->arpcom.ac_enaddr), (sizeof(tp->arpcom.ac_enaddr)));
...
tun_dev_read(struct tun_softc *tp, struct uio *uio, int ioflag)
{
 ...
 do {
  ...
  while ((tp->tun_flags & (0x0001 | 0x0002)) != (0x0001 | 0x0002)) {
   if ((error = tsleep((caddr_t)tp,
       (22 + 1)|0x100, "tunread", 0)) != 0)
    return (error);

   ifp1 = if_get(ifidx);
   destroyed = (ifp1 == ((void *)0));
   if_put(ifp1);
   if (destroyed)
    return (6);
  }
...
tun_dev_write(struct tun_softc *tp, struct uio *uio, int ioflag)
{
 ...
 if (uio->uio_resid == 0 || uio->uio_resid > ifp->if_data.ifi_mtu +
     (tp->tun_flags & 0x0800 ? ((6 * 2) + 2) : sizeof(*th))) {
  ;
  return (40);
 }
 tlen = uio->uio_resid;
 ...
 top->M_dat.MH.MH_pkthdr.ph_rtableid = ifp->if_data.ifi_rdomain;
...
# 1015 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/if_tun.c"
int
