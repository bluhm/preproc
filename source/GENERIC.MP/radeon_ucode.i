...
void radeon_ucode_print_mc_hdr(const struct common_firmware_header *hdr)
{
 uint16_t version_major = (__uint16_t)(__builtin_constant_p(hdr->header_version_major) ? (__uint16_t)(((__uint16_t)(hdr->header_version_major) & 0xffU) << 8 | ((__uint16_t)(hdr->header_version_major) & 0xff00U) >> 8) : __swap16md(hdr->header_version_major));
 uint16_t version_minor = (__uint16_t)(__builtin_constant_p(hdr->header_version_minor) ? (__uint16_t)(((__uint16_t)(hdr->header_version_minor) & 0xffU) << 8 | ((__uint16_t)(hdr->header_version_minor) & 0xff00U) >> 8) : __swap16md(hdr->header_version_minor));
 do { } while( 0);
 ...
 if (version_major == 1) {
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown MC ucode version: %u.%u\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , version_major, version_minor);
 }
}
void radeon_ucode_print_smc_hdr(const struct common_firmware_header *hdr)
{
 ...
 if (version_major == 1) {
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown SMC ucode version: %u.%u\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , version_major, version_minor);
 }
}
void radeon_ucode_print_gfx_hdr(const struct common_firmware_header *hdr)
{
 ...
 if (version_major == 1) {
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown GFX ucode version: %u.%u\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , version_major, version_minor);
 }
}
void radeon_ucode_print_rlc_hdr(const struct common_firmware_header *hdr)
{
 ...
 if (version_major == 1) {
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown RLC ucode version: %u.%u\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , version_major, version_minor);
 }
}
void radeon_ucode_print_sdma_hdr(const struct common_firmware_header *hdr)
{
 ...
 if (version_major == 1) {
  ...
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Unknown SDMA ucode version: %u.%u\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , version_major, version_minor);
 }
}
int radeon_ucode_validate(const struct firmware *fw)
{
 ...
 if (fw->size == (__uint32_t)(__builtin_constant_p(hdr->size_bytes) ? (__uint32_t)(((__uint32_t)(hdr->size_bytes) & 0xff) << 24 | ((__uint32_t)(hdr->size_bytes) & 0xff00) << 8 | ((__uint32_t)(hdr->size_bytes) & 0xff0000) >> 8 | ((__uint32_t)(hdr->size_bytes) & 0xff000000) >> 24) : __swap32md(hdr->size_bytes)))
  return 0;
 return -22;
}
