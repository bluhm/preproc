# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c"
# 33 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c"
...
# 34 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
# 35 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
# 36 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
# 37 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
# 38 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
# 39 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../sys/errno.h" 1
# 40 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
# 42 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
# 47 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../netinet6/dest6.c" 2
...
dest6_input(struct mbuf **mp, int *offp, int proto, int af)
{
 ...
 do { struct mbuf *t; int tmp; if ((m)->m_hdr.mh_len >= (off) + (sizeof(*dstopts))) (dstopts) = (struct ip6_dest *)(((caddr_t)(((m))->m_hdr.mh_data)) + (off)); else { t = m_pulldown((m), (off), (sizeof(*dstopts)), &tmp); if (t) { if (t->m_hdr.mh_len < tmp + (sizeof(*dstopts))) panic("m_pulldown malfunction"); (dstopts) = (struct ip6_dest *)(((caddr_t)((t)->m_hdr.mh_data)) + tmp); } else { (dstopts) = (struct ip6_dest *)((void *)0); (m) = ((void *)0); } } } while ( 0);
 if (dstopts == ((void *)0))
  return 257;
 dstoptlen = (dstopts->ip6d_len + 1) << 3;

 do { struct mbuf *t; int tmp; if ((m)->m_hdr.mh_len >= (off) + (dstoptlen)) (dstopts) = (struct ip6_dest *)(((caddr_t)(((m))->m_hdr.mh_data)) + (off)); else { t = m_pulldown((m), (off), (dstoptlen), &tmp); if (t) { if (t->m_hdr.mh_len < tmp + (dstoptlen)) panic("m_pulldown malfunction"); (dstopts) = (struct ip6_dest *)(((caddr_t)((t)->m_hdr.mh_data)) + tmp); } else { (dstopts) = (struct ip6_dest *)((void *)0); (m) = ((void *)0); } } } while ( 0);
 if (dstopts == ((void *)0))
  return 257;
 off += dstoptlen;
