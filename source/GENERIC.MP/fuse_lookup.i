# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c"
# 18 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c"
...
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c" 2
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c" 2
...
# 27 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c" 2
...
# 29 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c" 2
...
# 30 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../miscfs/fuse/fuse_lookup.c" 2
 ...
 *vpp = ((void *)0);
 vdp = ap->a_dvp;
 dp = ((struct fusefs_node *)(vdp)->v_data);
 ...
 if (cnp->cn_namelen == 1 && *(cnp->cn_nameptr) == '.') {
  ...
  nid = fbuf->FD.FD_attr.st_ino;
  nvtype = (iftovt_tab[((fbuf->FD.FD_attr.st_mode) & 0170000) >> 12]);
  fb_delete(fbuf);
 }
 ...
 if (flags & 0x002000) {
  ...
  if (error) {
   if (vn_lock(vdp, 0x0001UL | 0x2000UL, p) == 0)
    cnp->cn_flags &= ~0x200000;
  ...
  if (lockparent && (flags & 0x008000)) {
   if ((error = vn_lock(vdp, 0x0001UL, p))) {
    vput(tdp);
    return (error);
   }
   cnp->cn_flags &= ~0x200000;
...
reclaim:
 if (nid != dp->ufs_ino.i_number && nid != ((ino_t)1)) {
  fbuf = fb_setup(0, nid, 27, p);
