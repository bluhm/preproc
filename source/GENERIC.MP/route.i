...
rtisvalid(struct rtentry *rt)
{
 ...
 if (!((rt->rt_flags) & (0x1)))
  return (0);
 if (((rt->rt_flags) & (0x2))) {
  ((rt->RT_gw._nh != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 211, "rt->rt_gwroute != NULL"));
  ((!((rt->RT_gw._nh->rt_flags) & (0x2))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 212, "!ISSET(rt->rt_gwroute->rt_flags, RTF_GATEWAY)"));
...
rt_clone(struct rtentry **rtp, struct sockaddr *dst, unsigned int rtableid)
{
 ...
 info.rti_info[0] = dst;
 _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 257);
 error = rtrequest(0xb, &info, rt->rt_priority - 1, &rt,
     rtableid);
 if (error) {
  rtm_miss(0x7, &info, 0, 0, 0, error, rtableid);
 } else {
...
rt_setgwroute(struct rtentry *rt, u_int rtableid)
{
 ...
 rt_putgwroute(rt);
 ((rt->RT_gw._nh == ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 445, "rt->rt_gwroute == NULL"));
...
rt_putgwroute(struct rtentry *rt)
{
 ...
 if (!((rt->rt_flags) & (0x2)) || nhrt == ((void *)0))
  return;
 ((((nhrt->rt_flags) & (0x20000))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 481, "ISSET(nhrt->rt_flags, RTF_CACHED)"));
 ((nhrt->RT_gw._ref > 0) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 482, "nhrt->rt_cachecnt > 0"));
 --nhrt->RT_gw._ref;
...
rtfree(struct rtentry *rt)
{
 ...
 if (refcnt <= 0) {
  ((!((rt->rt_flags) & (0x1))) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 508, "!ISSET(rt->rt_flags, RTF_UP)"));
  ((!(0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 509, "!RT_ROOT(rt)"));
  ((void)_atomic_sub_int_nv((&rttrash), 1));
  if (refcnt < 0) {
   printf("rtfree: %p not freed (neg refs)\n", rt);
   return;
  }
  _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 516);
...
out:
 ...
 info.rti_info[1] = gateway;
 info.rti_info[6] = src;
 _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 658);
...
rtdeletemsg(struct rtentry *rt, struct ifnet *ifp, u_int tableid)
{
 ...
 struct rt_addrinfo info;
 struct sockaddr_in6 sa_mask;
 ((rt->rt_ifidx == ifp->if_index) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 673, "rt->rt_ifidx == ifp->if_index"));
 __builtin_memset((&info), (0), (sizeof(info)));
 ...
 _kernel_lock("/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 686);
...
rtflushclone1(struct rtentry *rt, void *arg, u_int id)
{
 ...
 if (!((rt->rt_flags) & (0x10000)))
  return 0;
 if (((rt->rt_flags) & (0x20000)) && (rt->rt_parent != cloningrt))
  return 0;
    ...
    struct rtentry **ret_nrt, u_int tableid)
{
 ...
 rt->rt_parent = ((void *)0);
 rt->rt_flags &= ~0x1;
 ((ifp->if_index == rt->rt_ifidx) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 797, "ifp->if_index == rt->rt_ifidx"));
    ...
    struct rtentry **ret_nrt, u_int tableid)
{
 ...
 case 0xb:
  ...
  if ((rt->rt_flags & 0x100) == 0)
   return (22);
  ((rt->rt_ifa->ifa_ifp != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 840, "rt->rt_ifa->ifa_ifp != NULL"));
 ...
 case 0x1:
  ...
  if (error != 0 &&
   ...
   if (((crt->rt_flags) & (0x10000))) {
    ...
    ((cifp != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 966, "cifp != NULL"));
...
rt_setgate(struct rtentry *rt, struct sockaddr *gate, u_int rtableid)
{
 ...
 if (rt->rt_gateway == ((void *)0) || glen != (rt->rt_gateway->sa_len>0 ? (1 + (((rt->rt_gateway->sa_len) - 1) | (sizeof(long) - 1))) : sizeof(long))) {
  ...
  if (rt->rt_gateway != ((void *)0)) {
   free(rt->rt_gateway, 5,
       (rt->rt_gateway->sa_len>0 ? (1 + (((rt->rt_gateway->sa_len) - 1) | (sizeof(long) - 1))) : sizeof(long)));
  }
  rt->rt_gateway = sa;
 }
...
{
 if (((rt->rt_flags) & (0x2))) {
  ((rt->RT_gw._nh != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 1033, "rt->rt_gwroute != NULL"));
  return (rt->RT_gw._nh);
 }
 return (rt);
}
...
rt_ifa_purge(struct ifaddr *ifa)
{
 ...
 int i;
 ((ifp != ((void *)0)) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 1273, "ifp != NULL"));
...
rt_plentosa(sa_family_t af, int plen, struct sockaddr_in6 *sa_mask)
{
 ...
 ((plen >= 0 || plen == -1) ? (void)0 : __assert("diagnostic ", "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/route.c", 1660, "plen >= 0 || plen == -1"));
 if (plen == -1)
  return (((void *)0));
