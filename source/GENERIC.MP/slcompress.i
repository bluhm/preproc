# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
# 43 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
...
# 44 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c" 2
...
# 45 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c" 2
...
# 46 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c" 2
...
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c" 2
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c" 2
# 62 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
void
sl_compress_init(struct slcompress *comp)
{
 ...
 __builtin_bzero(((char *)comp), (sizeof(*comp)));
 for (i = 16 - 1; i > 0; --i) {
  tstate[i].cs_id = i;
...
sl_compress_setup(struct slcompress *comp, int max_state)
{
 ...
 if (max_state == -1) {
  ...
  __builtin_bzero(((char *)comp->tstate), (sizeof(comp->tstate)));
  __builtin_bzero(((char *)comp->rstate), (sizeof(comp->rstate)));
 }
...
# 165 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
u_int
    ...
    int compress_cid)
{
 ...
 if ((ip->ip_off & ((__uint16_t)(0x3fff))) || m->m_hdr.mh_len < 40)
  return (0x40);
...
# 213 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
  struct cstate *lcs;
...
# 234 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
  ++comp->sls_misses;
  comp->last_cs = lcs;
  hlen += th->th_off;
  hlen <<= 2;
...
# 264 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
 ...
 if (((u_int16_t *)ip)[0] != ((u_int16_t *)&cs->slcs_u.csu_ip)[0] ||
     ...
     (deltaS > 5 &&
      __builtin_bcmp(((char *)(ip + 1)), ((char *)(&cs->slcs_u.csu_ip + 1)), ((int)((deltaS - 5) << 2)))) ||
     (th->th_off > 5 &&
      __builtin_bcmp(((char *)(th + 1)), ((char *)(oth + 1)), ((int)((th->th_off - 5) << 2)))))
  goto uncompressed;
 ...
 deltaS = (u_int16_t)(((__uint16_t)(th->th_win)) - ((__uint16_t)(oth->th_win)));
 if (deltaS) {
  { if ((u_int16_t)(deltaS) >= 256) { *cp++ = 0; cp[1] = (deltaS); cp[0] = (deltaS) >> 8; cp += 2; } else { *cp++ = (deltaS); } };
  changes |= 0x02;
 }

 deltaA = ((__uint32_t)(th->th_ack)) - ((__uint32_t)(oth->th_ack));
 if (deltaA) {
  if (deltaA > 0xffff)
   goto uncompressed;
 ...
 deltaS = ((__uint32_t)(th->th_seq)) - ((__uint32_t)(oth->th_seq));
 if (deltaS) {
  if (deltaS > 0xffff)
   goto uncompressed;
  { if ((u_int16_t)(deltaS) >= 256) { *cp++ = 0; cp[1] = (deltaS); cp[0] = (deltaS) >> 8; cp += 2; } else { *cp++ = (deltaS); } };
 ...
 case 0:
# 329 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
  if (ip->ip_len != cs->slcs_u.csu_ip.ip_len &&
      ((__uint16_t)(cs->slcs_u.csu_ip.ip_len)) == hlen)
   break;
 ...
 case 0x08|0x04:
  if (deltaS == deltaA &&
      deltaS == ((__uint16_t)(cs->slcs_u.csu_ip.ip_len)) - hlen) {
 ...
 case 0x08:
  if (deltaS == ((__uint16_t)(cs->slcs_u.csu_ip.ip_len)) - hlen) {
 ...
 deltaS = ((__uint16_t)(ip->ip_id)) - ((__uint16_t)(cs->slcs_u.csu_ip.ip_id));
 if (deltaS != 1) {
  { if ((u_int16_t)(deltaS) >= 256 || (u_int16_t)(deltaS) == 0) { *cp++ = 0; cp[1] = (deltaS); cp[0] = (deltaS) >> 8; cp += 2; } else { *cp++ = (deltaS); } };
  changes |= 0x20;
 }
 ...
 deltaA = ((__uint16_t)(th->th_sum));
 __builtin_bcopy(((char *)(ip)), ((char *)(&cs->slcs_u.csu_ip)), ((int)(hlen)));
# 384 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
 deltaS = cp - new_seq;
 cp = (u_char *)ip;
 ...
 *cp++ = deltaA >> 8;
 *cp++ = deltaA;
 __builtin_bcopy(((char *)(new_seq)), ((char *)(cp)), ((int)(deltaS)));
 ++comp->sls_compressed;
 return (0x80);
...
sl_uncompress_tcp(u_char **bufp, int len, u_int type, struct slcompress *comp)
{
 ...
 cp += vjlen;
 len -= vjlen;
# 442 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
 if ((long)cp & 3) {
  if (len > 0)
   (void) __builtin_memmove(((caddr_t)((long)cp &~ 3)), (cp), (len));
  cp = (u_char *)((long)cp &~ 3);
 }
 cp -= hlen;
 len += hlen;
 __builtin_bcopy(((char *)(hdr)), ((char *)(cp)), ((int)(hlen)));

 *bufp = cp;
 return (len);
}
# 462 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../net/slcompress.c"
int
    ...
    struct slcompress *comp, u_char **hdrp, u_int *hlenp)
{
 ...
 th->th_sum = ((__uint16_t)((*cp << 8) | cp[1]));
 cp += 2;
 if (changes & 0x10)
  th->th_flags |= 0x08;
 else
 ...
 case (0x08|0x02|0x01):
  {
  u_int i = ((__uint16_t)(cs->slcs_u.csu_ip.ip_len)) - cs->cs_hlen;
  th->th_ack = ((__uint32_t)(((__uint32_t)(th->th_ack)) + i));
  th->th_seq = ((__uint32_t)(((__uint32_t)(th->th_seq)) + i));
  }
  break;

 case (0x08|0x04|0x02|0x01):
  th->th_seq = ((__uint32_t)(((__uint32_t)(th->th_seq)) + ((__uint16_t)(cs->slcs_u.csu_ip.ip_len)) - cs->cs_hlen));
 ...
 default:
  if (changes & 0x01) {
   th->th_flags |= 0x20;
   { if (*cp == 0) { (th->th_urp) = ((__uint16_t)((cp[1] << 8) | cp[2])); cp += 3; } else { (th->th_urp) = ((__uint16_t)((u_int32_t)*cp++)); } }
  } else
   th->th_flags &=~ 0x20;
  if (changes & 0x02)
   { if (*cp == 0) { (th->th_win) = ((__uint16_t)(((__uint16_t)(th->th_win)) + ((cp[1] << 8) | cp[2]))); cp += 3; } else { (th->th_win) = ((__uint16_t)(((__uint16_t)(th->th_win)) + (u_int32_t)*cp++)); } }
  if (changes & 0x04)
   { if (*cp == 0) { (th->th_ack) = ((__uint32_t)(((__uint32_t)(th->th_ack)) + ((cp[1] << 8) | cp[2]))); cp += 3; } else { (th->th_ack) = ((__uint32_t)(((__uint32_t)(th->th_ack)) + (u_int32_t)*cp++)); } }
  if (changes & 0x08)
   { if (*cp == 0) { (th->th_seq) = ((__uint32_t)(((__uint32_t)(th->th_seq)) + ((cp[1] << 8) | cp[2]))); cp += 3; } else { (th->th_seq) = ((__uint32_t)(((__uint32_t)(th->th_seq)) + (u_int32_t)*cp++)); } }
  break;
 }
 if (changes & 0x20) {
  { if (*cp == 0) { (cs->slcs_u.csu_ip.ip_id) = ((__uint16_t)(((__uint16_t)(cs->slcs_u.csu_ip.ip_id)) + ((cp[1] << 8) | cp[2]))); cp += 3; } else { (cs->slcs_u.csu_ip.ip_id) = ((__uint16_t)(((__uint16_t)(cs->slcs_u.csu_ip.ip_id)) + (u_int32_t)*cp++)); } }
 } else
  cs->slcs_u.csu_ip.ip_id = ((__uint16_t)(((__uint16_t)(cs->slcs_u.csu_ip.ip_id)) + 1));
 ...
 cs->slcs_u.csu_ip.ip_len = ((__uint16_t)(total_len));
