# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c"
# 48 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c"
...
# 49 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c" 2
...
# 50 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c" 2
...
# 51 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c" 2
...
# 52 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c" 2
...
# 53 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c" 2
...
# 55 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c" 2
...
# 56 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c" 2
...
# 58 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c" 2
...
sys_obreak(struct proc *p, void *v, register_t *retval)
{
 ...
 new = ((((vaddr_t)((uap)->nsize.be.datum)) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
 if (new < base || (new - base) > p->p_p->ps_limit->pl_rlimit[2].rlim_cur)
  return (12);

 old = (((base + ((paddr_t)(vm->vm_dsize) << 13)) + ((1 << 13) - 1)) & ~((1 << 13) - 1));
 ...
 if (new > old) {
  error = uvm_map(&vm->vm_map, &old, new - old, ((void *)0),
      ((voff_t) -1), 0,
      ((0x01 | 0x02) | ((0x01 | 0x02 | 0x04) << 8) | ((1) << 4) | ((0) << 12) | (0x0010000|0x0080000)));
  ...
  vm->vm_dsize += ((new - old) >> 13);
 } else {
  uvm_deallocate(&vm->vm_map, new, old - new);
  vm->vm_dsize -= ((old - new) >> 13);
 }
...
uvm_grow(struct proc *p, vaddr_t sp)
{
 ...
 if (sp >= (vaddr_t)vm->vm_minsaddr - ((paddr_t)(vm->vm_ssize) << 13))
 ...
 si = (((vaddr_t)vm->vm_minsaddr - sp) >> 13) - vm->vm_ssize;

 if (vm->vm_ssize + si <= ((p->p_p->ps_limit->pl_rlimit[3].rlim_cur) >> 13))
  vm->vm_ssize += si;
}
# 158 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c"
int
uvm_coredump_walk_amap(struct vm_map_entry *entry, int *nsegmentp,
    uvm_coredump_walk_cb *walk, void *cookie)
{
 struct vm_anon *anons[32];
 ...
 nsegment = *nsegmentp;
 start = entry->start;
 entry_end = (((entry->end)<(((vaddr_t)-1)))?(entry->end):(((vaddr_t)-1)));

 absent = 0;
 for (pos = start; pos < entry_end; pos += npages << 13) {
  npages = (entry_end - pos) >> 13;
  if (npages > 32)
   npages = 32;
  amap_lookups(&entry->aref, pos - entry->start, anons, npages);
  for (i = 0; i < npages; i++) {
   if ((anons[i] == ((void *)0)) == absent)
    continue;
   if (!absent) {
...
{
 if (!(entry->protection & 0x02) &&
     entry->aref.ar_amap == ((void *)0) &&
     entry->start != p->p_p->ps_sigcode)
  return 0;
# 227 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c"
 if ((entry->protection & 0x01) == 0)
  return 0;


 if (entry->object.uvm_obj != ((void *)0) &&
     ((entry->object.uvm_obj)->pgops == &uvm_deviceops))
  return 0;

 if (entry->start >= ((vaddr_t)-1))
  return 0;
...
# 259 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c"
int
    ...
    uvm_coredump_walk_cb *walk, void *cookie)
{
 ...
 int refed_amaps = 0;
 int nsegment, error;
# 278 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../uvm/uvm_unix.c"
 nsegment = 0;
 ...
 nsegment = 0;
 for (; entry != ((void *)0); entry = uvm_map_addr_RBT_NEXT(entry)) {
  if (! uvm_should_coredump(p, entry))
   continue;
