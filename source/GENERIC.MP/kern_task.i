# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_task.c"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_task.c"
# 19 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_task.c"
...
# 20 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_task.c" 2
...
# 21 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_task.c" 2
...
# 22 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_task.c" 2
...
# 23 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_task.c" 2
...
# 24 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_task.c" 2
...
# 25 "/home/bluhm/github/preproc/openbsd/src/sys/arch/sparc64/compile/GENERIC.MP/obj/../../../../../kern/kern_task.c" 2
...
struct taskq taskq_sys = {
 ...
 { ((void *)0), &(taskq_sys.tq_worklist).tqh_first }
};
...
struct taskq taskq_sys_mp = {
 ...
 "systqmp",
 { ((void *)0), ((((15)) > 0 && ((15)) < 12) ? 12 : ((15))), 0 },
 { ((void *)0), &(taskq_sys_mp.tq_worklist).tqh_first }
};
...
{
 u_int *flags = &(__curcpu->ci_self)->ci_curproc->p_flag;
 int rv;

 atomic_clearbits_int(flags, 0x00000010);
 rv = msleep(ident, mtx, priority, wmesg, tmo);
 atomic_setbits_int(flags, 0x00000010);
...
taskq_next_work(struct taskq *tq, struct task *work, sleepfn tqsleep)
{
 ...
 do { if (((next)->t_entry.tqe_next) != ((void *)0)) (next)->t_entry.tqe_next->t_entry.tqe_prev = (next)->t_entry.tqe_prev; else (&tq->tq_worklist)->tqh_last = (next)->t_entry.tqe_prev; *(next)->t_entry.tqe_prev = (next)->t_entry.tqe_next; ((next)->t_entry.tqe_prev) = ((void *)-1); ((next)->t_entry.tqe_next) = ((void *)-1); } while (0);
 ((next->t_flags) &= ~(1));
...
taskq_thread(void *xtq)
{
 ...
 if (((tq->tq_flags) & ((1 << 1)))) {
  tqsleep = taskq_sleep;
  atomic_setbits_int(&(__curcpu->ci_self)->ci_curproc->p_flag, 0x00000010);
 }
