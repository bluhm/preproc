...
u32 eg_cg_rreg(struct radeon_device *rdev, u32 reg64)
{
 unsigned long flags;
 u32 r;
 _spin_lock_irqsave(&rdev->cg_idx_lock, flags );
 r100_mm_wreg(rdev, (0x8f8), (((reg64) & 0xffff)), 0);
 r = r100_mm_rreg(rdev, (0x8fc), 0);
 _spin_unlock_irqrestore(&rdev->cg_idx_lock, flags );
 return r;
}
void eg_cg_wreg(struct radeon_device *rdev, u32 reg64, u32 v)
{
...
u32 eg_pif_phy0_rreg(struct radeon_device *rdev, u32 reg64)
{
 unsigned long flags;
 u32 r;
 _spin_lock_irqsave(&rdev->pif_idx_lock, flags );
 r100_mm_wreg(rdev, (0x8), (((reg64) & 0xffff)), 0);
 r = r100_mm_rreg(rdev, (0xc), 0);
 _spin_unlock_irqrestore(&rdev->pif_idx_lock, flags );
 return r;
}
void eg_pif_phy0_wreg(struct radeon_device *rdev, u32 reg64, u32 v)
{
...
u32 eg_pif_phy1_rreg(struct radeon_device *rdev, u32 reg64)
{
 ...
 u32 r;
 _spin_lock_irqsave(&rdev->pif_idx_lock, flags );
 r100_mm_wreg(rdev, (0x10), (((reg64) & 0xffff)), 0);
 r = r100_mm_rreg(rdev, (0x14), 0);
 _spin_unlock_irqrestore(&rdev->pif_idx_lock, flags );
 return r;
}
void eg_pif_phy1_wreg(struct radeon_device *rdev, u32 reg64, u32 v)
...
static void evergreen_init_golden_registers(struct radeon_device *rdev)
{
 ...
 case CHIP_HEMLOCK:
  radeon_program_register_sequence(rdev,
       ...
       (const u32)(sizeof((evergreen_golden_registers)) / sizeof((evergreen_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       evergreen_golden_registers2,
       (const u32)(sizeof((evergreen_golden_registers2)) / sizeof((evergreen_golden_registers2)[0])));
  radeon_program_register_sequence(rdev,
       cypress_mgcg_init,
       (const u32)(sizeof((cypress_mgcg_init)) / sizeof((cypress_mgcg_init)[0])));
  break;
 case CHIP_JUNIPER:
  radeon_program_register_sequence(rdev,
       evergreen_golden_registers,
  ...
  radeon_program_register_sequence(rdev,
       juniper_mgcg_init,
       (const u32)(sizeof((juniper_mgcg_init)) / sizeof((juniper_mgcg_init)[0])));
  break;
 case CHIP_REDWOOD:
  radeon_program_register_sequence(rdev,
       evergreen_golden_registers,
  ...
  radeon_program_register_sequence(rdev,
       redwood_mgcg_init,
       (const u32)(sizeof((redwood_mgcg_init)) / sizeof((redwood_mgcg_init)[0])));
  break;
 case CHIP_CEDAR:
  radeon_program_register_sequence(rdev,
       cedar_golden_registers,
       (const u32)(sizeof((cedar_golden_registers)) / sizeof((cedar_golden_registers)[0])));
  radeon_program_register_sequence(rdev,
       evergreen_golden_registers2,
       (const u32)(sizeof((evergreen_golden_registers2)) / sizeof((evergreen_golden_registers2)[0])));
  radeon_program_register_sequence(rdev,
       cedar_mgcg_init,
       (const u32)(sizeof((cedar_mgcg_init)) / sizeof((cedar_mgcg_init)[0])));
  break;
 case CHIP_PALM:
  radeon_program_register_sequence(rdev,
       wrestler_golden_registers,
       (const u32)(sizeof((wrestler_golden_registers)) / sizeof((wrestler_golden_registers)[0])));
  break;
 case CHIP_SUMO:
  radeon_program_register_sequence(rdev,
       supersumo_golden_registers,
       (const u32)(sizeof((supersumo_golden_registers)) / sizeof((supersumo_golden_registers)[0])));
  break;
 case CHIP_SUMO2:
  radeon_program_register_sequence(rdev,
       supersumo_golden_registers,
  ...
  radeon_program_register_sequence(rdev,
       ...
       (const u32)(sizeof((sumo_golden_registers)) / sizeof((sumo_golden_registers)[0])));
  break;
 case CHIP_BARTS:
  radeon_program_register_sequence(rdev,
       barts_golden_registers,
       (const u32)(sizeof((barts_golden_registers)) / sizeof((barts_golden_registers)[0])));
  break;
 case CHIP_TURKS:
  radeon_program_register_sequence(rdev,
       turks_golden_registers,
       (const u32)(sizeof((turks_golden_registers)) / sizeof((turks_golden_registers)[0])));
  break;
 case CHIP_CAICOS:
  radeon_program_register_sequence(rdev,
       caicos_golden_registers,
       (const u32)(sizeof((caicos_golden_registers)) / sizeof((caicos_golden_registers)[0])));
  break;
 default:
  break;
 }
         ...
         u32 cntl_reg, u32 status_reg)
{
 ...
 if (r)
  return r;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (cntl_reg), 0); tmp_ &= (~((1 << 8)|0x7f)); tmp_ |= ((dividers.post_div) & ~(~((1 << 8)|0x7f))); r100_mm_wreg(rdev, (cntl_reg), (tmp_), 0); } while (0);
 for (i = 0; i < 100; i++) {
  if (r100_mm_rreg(rdev, (status_reg), 0) & (1 << 0))
   break;
  mdelay(10);
 }
 if (i == 100)
...
{
 int r = 0;
 u32 cg_scratch = r100_mm_rreg(rdev, (0x820), 0);
 ...
 r100_mm_wreg(rdev, (0x820), (cg_scratch), 0);
 return r;
}
int evergreen_set_uvd_clocks(struct radeon_device *rdev, u32 vclk, u32 dclk)
{
 ...
 if (r)
  return r;
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x00000200); tmp_ |= ((0x00000200) & ~(~0x00000200)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x00000002); tmp_ |= ((0x00000002) & ~(~0x00000002)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x00000002); tmp_ |= ((0) & ~(~0x00000002)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 ...
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x79c), 0); tmp_ &= (~0x00000001); tmp_ |= ((0) & ~(~0x00000001)); r100_mm_wreg(rdev, (0x79c), (tmp_), 0); } while (0);
 ...
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x003F0000); tmp_ |= ((0) & ~(~0x003F0000)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 if (fb_div < 307200)
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x854), 0); tmp_ &= (~0x00020000); tmp_ |= ((0) & ~(~0x00020000)); r100_mm_wreg(rdev, (0x854), (tmp_), 0); } while (0);
 else
  do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x854), 0); tmp_ &= (~0x00020000); tmp_ |= ((0x00020000) & ~(~0x00020000)); r100_mm_wreg(rdev, (0x854), (tmp_), 0); } while (0);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x71c), 0); tmp_ &= (~(0x0000007F | 0x00007F00)); tmp_ |= ((((vclk_div) << 0) | ((dclk_div) << 8)) & ~(~(0x0000007F | 0x00007F00))); r100_mm_wreg(rdev, (0x71c), (tmp_), 0); } while (0);
 mdelay(15);
 do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x718), 0); tmp_ &= (~0x00000001); tmp_ |= ((0) & ~(~0x00000001)); r100_mm_wreg(rdev, (0x718), (tmp_), 0); } while (0);
 mdelay(15);
...
void evergreen_fix_pci_max_read_req_size(struct radeon_device *rdev)
{
 pcireg_t ctl, v;
 int off;
 if (pci_get_capability(rdev->pc, rdev->pa_tag, 0x10,
          &off, &ctl) == 0)
  return;
 ctl = pci_conf_read(rdev->pc, rdev->pa_tag, off + 0x08);
 v = (ctl & 0x00007000) >> 12;
 if ((v == 0) || (v == 6) || (v == 7)) {
  ctl &= ~0x00007000;
  ctl |= (2 << 12);
  pci_conf_write(rdev->pc, rdev->pa_tag, off + 0x08, ctl);
 }
}
void dce4_program_fmt(struct drm_encoder *encoder)
{
 ...
 r100_mm_wreg(rdev, (0x6fc8 + radeon_crtc->crtc_offset), (tmp), 0);
}
static _Bool dce4_is_in_vblank(struct radeon_device *rdev, int crtc)
{
 if (r100_mm_rreg(rdev, (0x6e8c + crtc_offsets[crtc]), 0) & (1 << 0))
  return 1;
 else
  return 0;
}
static _Bool dce4_is_counter_moving(struct radeon_device *rdev, int crtc)
{
 u32 pos1, pos2;
 pos1 = r100_mm_rreg(rdev, (0x6e90 + crtc_offsets[crtc]), 0);
 pos2 = r100_mm_rreg(rdev, (0x6e90 + crtc_offsets[crtc]), 0);
 if (pos1 != pos2)
  return 1;
 else
  return 0;
...
void dce4_wait_for_vblank(struct radeon_device *rdev, int crtc)
{
 ...
 if (crtc >= rdev->num_crtc)
  return;
 if (!(r100_mm_rreg(rdev, (0x6e70 + crtc_offsets[crtc]), 0) & (1 << 0)))
  return;
...
void evergreen_page_flip(struct radeon_device *rdev, int crtc_id, u64 crtc_base)
{
 ...
 r100_mm_wreg(rdev, (0x681c + radeon_crtc->crtc_offset), (((u32)(((crtc_base) >> 16) >> 16))), 0);
 r100_mm_wreg(rdev, (0x6810 + radeon_crtc->crtc_offset), ((u32)crtc_base), 0);
 r100_mm_rreg(rdev, (0x6810 + radeon_crtc->crtc_offset), 0);
}
_Bool evergreen_page_flip_pending(struct radeon_device *rdev, int crtc_id)
{
 struct radeon_crtc *radeon_crtc = rdev->mode_info.crtcs[crtc_id];
 return !!(r100_mm_rreg(rdev, (0x6844 + radeon_crtc->crtc_offset), 0) &
  (1 << 2));
}
int evergreen_get_temp(struct radeon_device *rdev)
{
 ...
 if (rdev->family == CHIP_JUNIPER) {
  toffset = (r100_mm_rreg(rdev, (0x72c), 0) & 0x00003FE0) >>
   5;
  temp = (r100_mm_rreg(rdev, (0x760), 0) & 0x000003FF) >>
   0;
  if (toffset & 0x100)
  ...
  temp = (r100_mm_rreg(rdev, (0x740), 0) & 0x07FF0000) >>
   16;
  if (temp & 0x400)
   actual_temp = -256;
  else if (temp & 0x200)
...
int sumo_get_temp(struct radeon_device *rdev)
{
 u32 temp = r100_mm_rreg(rdev, (0x678), 0) & 0xff;
...
void evergreen_pm_prepare(struct radeon_device *rdev)
{
 ...
 for (crtc = ({ const __typeof( ((__typeof(*crtc) *)0)->head ) *__mptr = ((&ddev->mode_config.crtc_list)->next); (__typeof(*crtc) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtc), head) );}); &crtc->head != (&ddev->mode_config.crtc_list); crtc = ({ const __typeof( ((__typeof(*crtc) *)0)->head ) *__mptr = (crtc->head.next); (__typeof(*crtc) *)( (char *)__mptr - __builtin_offsetof(__typeof(*crtc), head) );})) {
  ...
  if (radeon_crtc->enabled) {
   tmp = r100_mm_rreg(rdev, (0x6e70 + radeon_crtc->crtc_offset), 0);
   tmp |= (1 << 24);
   r100_mm_wreg(rdev, (0x6e70 + radeon_crtc->crtc_offset), (tmp), 0);
  }
 }
}
...
_Bool evergreen_hpd_sense(struct radeon_device *rdev, enum radeon_hpd_id hpd)
{
 ...
 switch (hpd) {
 case RADEON_HPD_1:
  if (r100_mm_rreg(rdev, (0x601c), 0) & (1 << 1))
   connected = 1;
  break;
 case RADEON_HPD_2:
  if (r100_mm_rreg(rdev, (0x6028), 0) & (1 << 1))
   connected = 1;
  break;
 case RADEON_HPD_3:
  if (r100_mm_rreg(rdev, (0x6034), 0) & (1 << 1))
   connected = 1;
  break;
 case RADEON_HPD_4:
  if (r100_mm_rreg(rdev, (0x6040), 0) & (1 << 1))
   connected = 1;
  break;
 case RADEON_HPD_5:
  if (r100_mm_rreg(rdev, (0x604c), 0) & (1 << 1))
   connected = 1;
  break;
 case RADEON_HPD_6:
  if (r100_mm_rreg(rdev, (0x6058), 0) & (1 << 1))
   connected = 1;
  break;
 default:
  break;
...
{
 u32 tmp;
 _Bool connected = evergreen_hpd_sense(rdev, hpd);
 switch (hpd) {
 case RADEON_HPD_1:
  tmp = r100_mm_rreg(rdev, (0x6020), 0);
  if (connected)
   tmp &= ~(1 << 8);
  else
   tmp |= (1 << 8);
  r100_mm_wreg(rdev, (0x6020), (tmp), 0);
  break;
 case RADEON_HPD_2:
  tmp = r100_mm_rreg(rdev, (0x602c), 0);
  if (connected)
   tmp &= ~(1 << 8);
  else
   tmp |= (1 << 8);
  r100_mm_wreg(rdev, (0x602c), (tmp), 0);
  break;
 case RADEON_HPD_3:
  tmp = r100_mm_rreg(rdev, (0x6038), 0);
  if (connected)
   tmp &= ~(1 << 8);
  else
   tmp |= (1 << 8);
  r100_mm_wreg(rdev, (0x6038), (tmp), 0);
  break;
 case RADEON_HPD_4:
  tmp = r100_mm_rreg(rdev, (0x6044), 0);
  if (connected)
   tmp &= ~(1 << 8);
  else
   tmp |= (1 << 8);
  r100_mm_wreg(rdev, (0x6044), (tmp), 0);
  break;
 case RADEON_HPD_5:
  tmp = r100_mm_rreg(rdev, (0x6050), 0);
  if (connected)
   tmp &= ~(1 << 8);
  else
   tmp |= (1 << 8);
  r100_mm_wreg(rdev, (0x6050), (tmp), 0);
   break;
 case RADEON_HPD_6:
  tmp = r100_mm_rreg(rdev, (0x605c), 0);
  if (connected)
   tmp &= ~(1 << 8);
  else
   tmp |= (1 << 8);
  r100_mm_wreg(rdev, (0x605c), (tmp), 0);
  break;
 default:
  break;
 }
...
void evergreen_hpd_init(struct radeon_device *rdev)
{
 ...
 for (connector = ({ const __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = ((&dev->mode_config.connector_list)->next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );}); &connector->head != (&dev->mode_config.connector_list); connector = ({ const __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = (connector->head.next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );})) {
  ...
  case RADEON_HPD_1:
   r100_mm_wreg(rdev, (0x6024), (tmp), 0);
   break;
  case RADEON_HPD_2:
   r100_mm_wreg(rdev, (0x6030), (tmp), 0);
   break;
  case RADEON_HPD_3:
   r100_mm_wreg(rdev, (0x603c), (tmp), 0);
   break;
  case RADEON_HPD_4:
   r100_mm_wreg(rdev, (0x6048), (tmp), 0);
   break;
  case RADEON_HPD_5:
   r100_mm_wreg(rdev, (0x6054), (tmp), 0);
   break;
  case RADEON_HPD_6:
   r100_mm_wreg(rdev, (0x6060), (tmp), 0);
   break;
  default:
   break;
  }
...
void evergreen_hpd_fini(struct radeon_device *rdev)
{
 ...
 for (connector = ({ const __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = ((&dev->mode_config.connector_list)->next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );}); &connector->head != (&dev->mode_config.connector_list); connector = ({ const __typeof( ((__typeof(*connector) *)0)->head ) *__mptr = (connector->head.next); (__typeof(*connector) *)( (char *)__mptr - __builtin_offsetof(__typeof(*connector), head) );})) {
  ...
  switch (radeon_connector->hpd.hpd) {
  case RADEON_HPD_1:
   r100_mm_wreg(rdev, (0x6024), (0), 0);
   break;
  case RADEON_HPD_2:
   r100_mm_wreg(rdev, (0x6030), (0), 0);
   break;
  case RADEON_HPD_3:
   r100_mm_wreg(rdev, (0x603c), (0), 0);
   break;
  case RADEON_HPD_4:
   r100_mm_wreg(rdev, (0x6048), (0), 0);
   break;
  case RADEON_HPD_5:
   r100_mm_wreg(rdev, (0x6054), (0), 0);
   break;
  case RADEON_HPD_6:
   r100_mm_wreg(rdev, (0x6060), (0), 0);
   break;
  default:
   break;
  }
     ...
     struct drm_display_mode *other_mode)
{
 ...
 if (radeon_crtc->crtc_id % 2)
  tmp += 4;
 r100_mm_wreg(rdev, (0x6b0c + radeon_crtc->crtc_offset), (tmp), 0);
 if (((rdev->family >= CHIP_PALM) && (rdev->flags & RADEON_IS_IGP)) || ((rdev->family >= CHIP_BARTS))) {
  r100_mm_wreg(rdev, (0x0ca0 + pipe_offset), (((buffer_alloc) << 0)), 0);
  for (i = 0; i < rdev->usec_timeout; i++) {
   if (r100_mm_rreg(rdev, (0x0ca0 + pipe_offset), 0) &
       (1 << 4))
    break;
   udelay(1);
  }
...
{
 u32 tmp = r100_mm_rreg(rdev, (0x2004), 0);
...
static u32 evergreen_latency_watermark(struct evergreen_wm_params *wm)
{
 ...
 b.full = (u32)(((1000) << 12));
 c.full = (u32)(((wm->disp_clk) << 12));
 b.full = dfixed_div(c, b);
 c.full = (u32)(((wm->bytes_per_pixel) << 12));
 b.full = ((u64)((u64)(b).full * (c).full + 2048) >> 12);
 lb_fill_bw = min(((a).full >> 12), ((b).full >> 12));
...
static _Bool evergreen_average_bandwidth_vs_dram_bandwidth_for_display(struct evergreen_wm_params *wm)
{
...
static _Bool evergreen_average_bandwidth_vs_available_bandwidth(struct evergreen_wm_params *wm)
{
 if (evergreen_average_bandwidth(wm) <=
...
static _Bool evergreen_check_latency_hiding(struct evergreen_wm_params *wm)
{
      ...
      u32 lb_size, u32 num_heads)
{
 ...
 if (radeon_crtc->base.enabled && num_heads && mode) {
  ...
  if ((rdev->pm.pm_method == PM_METHOD_DPM) && rdev->pm.dpm_enabled) {
   wm_high.yclk =
    rdev->asic->dpm.get_mclk((rdev), (0)) * 10;
   wm_high.sclk =
    rdev->asic->dpm.get_sclk((rdev), (0)) * 10;
  } else {
  ...
  if ((rdev->pm.pm_method == PM_METHOD_DPM) && rdev->pm.dpm_enabled) {
   wm_low.yclk =
    rdev->asic->dpm.get_mclk((rdev), (1)) * 10;
   wm_low.sclk =
    rdev->asic->dpm.get_sclk((rdev), (1)) * 10;
  } else {
 ...
 arb_control3 = r100_mm_rreg(rdev, (0x0bf0 + pipe_offset), 0);
 tmp = arb_control3;
 tmp &= ~((3) << 16);
 tmp |= ((1) << 16);
 r100_mm_wreg(rdev, (0x0bf0 + pipe_offset), (tmp), 0);
 r100_mm_wreg(rdev, (0x0bf4 + pipe_offset), ((((latency_watermark_a) << 0) | ((line_time) << 16))), 0);
 tmp = r100_mm_rreg(rdev, (0x0bf0 + pipe_offset), 0);
 tmp &= ~((3) << 16);
 tmp |= ((2) << 16);
 r100_mm_wreg(rdev, (0x0bf0 + pipe_offset), (tmp), 0);
 r100_mm_wreg(rdev, (0x0bf4 + pipe_offset), ((((latency_watermark_b) << 0) | ((line_time) << 16))), 0);
 r100_mm_wreg(rdev, (0x0bf0 + pipe_offset), (arb_control3), 0);
 r100_mm_wreg(rdev, (0x6b18 + radeon_crtc->crtc_offset), (priority_a_cnt), 0);
 r100_mm_wreg(rdev, (0x6b1c + radeon_crtc->crtc_offset), (priority_b_cnt), 0);
...
int evergreen_mc_wait_for_idle(struct radeon_device *rdev)
{
 ...
 u32 tmp;
 for (i = 0; i < rdev->usec_timeout; i++) {
  tmp = r100_mm_rreg(rdev, (0x0E50), 0) & 0x1F00;
  if (!tmp)
   return 0;
  udelay(1);
 }
...
static int evergreen_pcie_gart_enable(struct radeon_device *rdev)
{
 ...
 if (rdev->flags & RADEON_IS_IGP) {
  ...
  r100_mm_wreg(rdev, (0x2660), (tmp), 0);
  r100_mm_wreg(rdev, (0x2664), (tmp), 0);
 } else {
...
static _Bool evergreen_is_dp_sst_stream_enabled(struct radeon_device *rdev,
            unsigned crtc_id, unsigned *ret_dig_fe)
{
 ...
 _Bool is_enabled = 0;
 _Bool found_crtc = 0;
 for (i = 0; i < (sizeof((ni_dig_offsets)) / sizeof((ni_dig_offsets)[0])); i++) {
  dig_fe = r100_mm_rreg(rdev, (0x7000 + ni_dig_offsets[i]), 0);
  if (dig_fe & (1<<24) &&
      crtc_id == ((dig_fe) & 0x3)) {
   found_crtc = 1;
   dig_fe_mask = 1 << i;
 ...
 if (found_crtc) {
  for (i = 0; i < (sizeof((ni_dig_offsets)) / sizeof((ni_dig_offsets)[0])); i++) {
   dig_be = r100_mm_rreg(rdev, (0x7140 + ni_dig_offsets[i]), 0);
   digs_fe_selected = (((dig_be) >> 8 ) & 0x3F);
   dig_be_mode = (((dig_be) >> 16) & 0x7 );
   if (dig_fe_mask & digs_fe_selected &&
       dig_be_mode == 0) {
    dig_en_be = r100_mm_rreg(rdev, (0x7144 + ni_dig_offsets[i]), 0);
    uniphy_pll = r100_mm_rreg(rdev, (0x6618 + ni_tx_offsets[i]), 0);
    if (dig_en_be & (1 << 0) &&
        dig_en_be & (1 << 8) &&
        uniphy_pll & (1 << 0)) {
     is_enabled = 1;
          ...
          unsigned dig_fe)
{
 ...
 unsigned fifo_ctrl;
 unsigned counter = 0;
 if (dig_fe >= (sizeof((evergreen_dp_offsets)) / sizeof((evergreen_dp_offsets)[0]))) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "invalid dig_fe %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dig_fe);
  return;
 }
 stream_ctrl = r100_mm_rreg(rdev, (0x730C + evergreen_dp_offsets[dig_fe]), 0);
 if (!(stream_ctrl & (1 << 0))) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "dig %d , should be enable\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , dig_fe);
  return;
 }
 stream_ctrl &=~(1 << 0);
 r100_mm_wreg(rdev, (0x730C + evergreen_dp_offsets[dig_fe]), (stream_ctrl), 0);
 stream_ctrl = r100_mm_rreg(rdev, (0x730C + evergreen_dp_offsets[dig_fe]), 0);
 ...
 if (counter >= 32 )
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "counter exceeds %d\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , counter);
 fifo_ctrl = r100_mm_rreg(rdev, (0x7310 + evergreen_dp_offsets[dig_fe]), 0);
 fifo_ctrl |= (1 << 0);
 r100_mm_wreg(rdev, (0x7310 + evergreen_dp_offsets[dig_fe]), (fifo_ctrl), 0);
}
void evergreen_mc_stop(struct radeon_device *rdev, struct evergreen_mc_save *save)
{
 ...
 if (!((rdev->family == CHIP_HAINAN))) {
  save->vga_render_control = r100_mm_rreg(rdev, (0x0300), 0);
  save->vga_hdp_control = r100_mm_rreg(rdev, (0x328), 0);
  r100_mm_wreg(rdev, (0x0300), (0), 0);
 }
 for (i = 0; i < rdev->num_crtc; i++) {
  crtc_enabled = r100_mm_rreg(rdev, (0x6e70 + crtc_offsets[i]), 0) & (1 << 0);
  if (crtc_enabled) {
   save->crtc_enabled[i] = 1;
   if (((rdev->family >= CHIP_ARUBA))) {
    tmp = r100_mm_rreg(rdev, (0x6e74 + crtc_offsets[i]), 0);
    if (!(tmp & (1 << 8))) {
     (rdev)->asic->display.wait_for_vblank((rdev), (i));
     r100_mm_wreg(rdev, (0x6ed4 + crtc_offsets[i]), (1), 0);
     tmp |= (1 << 8);
     r100_mm_wreg(rdev, (0x6e74 + crtc_offsets[i]), (tmp), 0);
     r100_mm_wreg(rdev, (0x6ed4 + crtc_offsets[i]), (0), 0);
    }
   } else {
    tmp = r100_mm_rreg(rdev, (0x6e70 + crtc_offsets[i]), 0);
    if (!(tmp & (1 << 24))) {
     (rdev)->asic->display.wait_for_vblank((rdev), (i));
     r100_mm_wreg(rdev, (0x6ed4 + crtc_offsets[i]), (1), 0);
     tmp |= (1 << 24);
     r100_mm_wreg(rdev, (0x6e70 + crtc_offsets[i]), (tmp), 0);
     r100_mm_wreg(rdev, (0x6ed4 + crtc_offsets[i]), (0), 0);
    }
   }
 ...
 blackout = r100_mm_rreg(rdev, (0x20ac), 0);
 if ((blackout & 0x00000007) != 1) {
  r100_mm_wreg(rdev, (0x5490), (0), 0);
  blackout &= ~0x00000007;
  r100_mm_wreg(rdev, (0x20ac), (blackout | 1), 0);
 }
 udelay(100);
 for (i = 0; i < rdev->num_crtc; i++) {
  if (save->crtc_enabled[i]) {
   tmp = r100_mm_rreg(rdev, (0x6844 + crtc_offsets[i]), 0);
   if (!(tmp & (1 << 16))) {
    tmp |= (1 << 16);
    r100_mm_wreg(rdev, (0x6844 + crtc_offsets[i]), (tmp), 0);
   }
   tmp = r100_mm_rreg(rdev, (0x6ef4 + crtc_offsets[i]), 0);
   if (!(tmp & 1)) {
    tmp |= 1;
    r100_mm_wreg(rdev, (0x6ef4 + crtc_offsets[i]), (tmp), 0);
   }
  }
 }
}
void evergreen_mc_resume(struct radeon_device *rdev, struct evergreen_mc_save *save)
{
 ...
 int i, j;
 for (i = 0; i < rdev->num_crtc; i++) {
  r100_mm_wreg(rdev, (0x681c + crtc_offsets[i]), (((u32)(((rdev->mc.vram_start) >> 16) >> 16))), 0);
  r100_mm_wreg(rdev, (0x6820 + crtc_offsets[i]), (((u32)(((rdev->mc.vram_start) >> 16) >> 16))), 0);
  r100_mm_wreg(rdev, (0x6810 + crtc_offsets[i]), ((u32)rdev->mc.vram_start), 0);
  r100_mm_wreg(rdev, (0x6814 + crtc_offsets[i]), ((u32)rdev->mc.vram_start), 0);
 }
 if (!((rdev->family == CHIP_HAINAN))) {
  r100_mm_wreg(rdev, (0x324), (((u32)(((rdev->mc.vram_start) >> 16) >> 16))), 0);
  r100_mm_wreg(rdev, (0x310), ((u32)rdev->mc.vram_start), 0);
 }
 for (i = 0; i < rdev->num_crtc; i++) {
  if (save->crtc_enabled[i]) {
   tmp = r100_mm_rreg(rdev, (0x6ef8 + crtc_offsets[i]), 0);
   if ((tmp & 0x7) != 3) {
    tmp &= ~0x7;
    tmp |= 0x3;
    r100_mm_wreg(rdev, (0x6ef8 + crtc_offsets[i]), (tmp), 0);
   }
   tmp = r100_mm_rreg(rdev, (0x6844 + crtc_offsets[i]), 0);
   if (tmp & (1 << 16)) {
    tmp &= ~(1 << 16);
 ...
 tmp = r100_mm_rreg(rdev, (0x20ac), 0);
 tmp &= ~0x00000007;
 r100_mm_wreg(rdev, (0x20ac), (tmp), 0);
 ...
 if (!((rdev->family == CHIP_HAINAN))) {
  r100_mm_wreg(rdev, (0x328), (save->vga_hdp_control), 0);
  mdelay(1);
  r100_mm_wreg(rdev, (0x0300), (save->vga_render_control), 0);
 }
}
void evergreen_mc_program(struct radeon_device *rdev)
{
 ...
 if ((rdev->family == CHIP_PALM) ||
  ...
  tmp = r100_mm_rreg(rdev, (0x2898), 0) & 0x000FFFFF;
  tmp |= ((rdev->mc.vram_end >> 20) & 0xF) << 24;
  tmp |= ((rdev->mc.vram_start >> 20) & 0xF) << 20;
  r100_mm_wreg(rdev, (0x2898), (tmp), 0);
 }
 tmp = ((rdev->mc.vram_end >> 24) & 0xFFFF) << 16;
 tmp |= ((rdev->mc.vram_start >> 24) & 0xFFFF);
 r100_mm_wreg(rdev, (0x2024), (tmp), 0);
 r100_mm_wreg(rdev, (0x2C04), ((rdev->mc.vram_start >> 8)), 0);
 r100_mm_wreg(rdev, (0x2C08), ((2 << 7) | (1 << 30)), 0);
...
static int evergreen_cp_resume(struct radeon_device *rdev)
{
 ...
 u32 rb_bufsz;
 int r;
 r100_mm_wreg(rdev, (0x8020), (((1 << 0) | (1 << 5) | (1 << 9) | (1 << 14) | (1 << 8) | (1 << 10))), 0);
 ...
 r100_mm_wreg(rdev, (0x85C8), (0x0), 0);
...
static void evergreen_gpu_init(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0xEA0), (0x1), 0);
 r100_mm_wreg(rdev, (0xEA8), (0x1), 0);
 evergreen_fix_pci_max_read_req_size(rdev);
 mc_shared_chmap = r100_mm_rreg(rdev, (0x2004), 0);
 if ((rdev->family == CHIP_PALM) ||
     (rdev->family == CHIP_SUMO) ||
     (rdev->family == CHIP_SUMO2))
  mc_arb_ramcfg = r100_mm_rreg(rdev, (0x2768), 0);
 else
 ...
 if ((rdev->family >= CHIP_CEDAR) && (rdev->family <= CHIP_HEMLOCK)) {
  ...
  for (i = (rdev->config.evergreen.num_ses - 1); i >= 0; i--) {
   ...
   r100_mm_wreg(rdev, (0x802C), ((1 << 30) | ((i) << 16)), 0);
   r100_mm_wreg(rdev, (0x3fC4), ((1 << 30) | ((i) << 16)), 0);
   rb_disable_bitmap = (r100_mm_rreg(rdev, (0x98F4), 0) & 0x00ff0000) >> 16;
   tmp <<= 4;
 ...
 for (i = 0; i < rdev->config.evergreen.num_ses; i++) {
  ...
  r100_mm_wreg(rdev, (0x802C), ((1 << 30) | ((i) << 16)), 0);
  r100_mm_wreg(rdev, (0x3fC4), ((1 << 30) | ((i) << 16)), 0);
  simd_disable_bitmap = (r100_mm_rreg(rdev, (0x8950), 0) & 0xffff0000) >> 16;
  simd_disable_bitmap |= 0xffffffff << rdev->config.evergreen.max_simds;
  tmp <<= 16;
  tmp |= simd_disable_bitmap;
 }
 rdev->config.evergreen.active_simds = hweight32(~tmp);
 r100_mm_wreg(rdev, (0x802C), ((1 << 30) | (1 << 31)), 0);
 r100_mm_wreg(rdev, (0x3fC4), ((1 << 30) | (1 << 31)), 0);
 r100_mm_wreg(rdev, (0x98F8), (gb_addr_config), 0);
 r100_mm_wreg(rdev, (0xBD4), (gb_addr_config), 0);
 r100_mm_wreg(rdev, (0x2F48), (gb_addr_config), 0);
 r100_mm_wreg(rdev, (0xD0B8), (gb_addr_config), 0);
 r100_mm_wreg(rdev, (0xef4c), (gb_addr_config), 0);
 r100_mm_wreg(rdev, (0xef50), (gb_addr_config), 0);
 r100_mm_wreg(rdev, (0xef54), (gb_addr_config), 0);
 ...
 r100_mm_wreg(rdev, (0x98FC), (tmp), 0);
 ...
 if (rdev->family <= CHIP_SUMO2)
  r100_mm_wreg(rdev, (0xA008), (0x00010000), 0);
 r100_mm_wreg(rdev, (0x900C), (((((rdev->config.evergreen.sx_max_export_size / 4) - 1) << 0) | (((rdev->config.evergreen.sx_max_export_pos_size / 4) - 1) << 8) | (((rdev->config.evergreen.sx_max_export_smx_size / 4) - 1) << 16))), 0);
 r100_mm_wreg(rdev, (0x8BCC), ((((rdev->config.evergreen.sc_prim_fifo_size) << 0) | ((rdev->config.evergreen.sc_hiz_tile_fifo_size) << 12) | ((rdev->config.evergreen.sc_earlyz_tile_fifo_size) << 20))), 0);
 r100_mm_wreg(rdev, (0x8974), (1), 0);
 r100_mm_wreg(rdev, (0x9100), (0), 0);
 r100_mm_wreg(rdev, (0x913C), (((4) << 0)), 0);
 r100_mm_wreg(rdev, (0x87FC), (0), 0);
 r100_mm_wreg(rdev, (0x8CF0), ((((16 * rdev->config.evergreen.sq_num_cf_insts) << 0) | ((0x4) << 8) | ((0xe0) << 16) | ((0x8) << 24))), 0);
 ...
 sq_lds_resource_mgmt = r100_mm_rreg(rdev, (0x8E2C), 0);
 ...
 r100_mm_wreg(rdev, (0x8C0C), (sq_gpr_resource_mgmt_3), 0);
 r100_mm_wreg(rdev, (0x8C18), (sq_thread_resource_mgmt), 0);
 r100_mm_wreg(rdev, (0x8C1C), (sq_thread_resource_mgmt_2), 0);
 r100_mm_wreg(rdev, (0x8C20), (sq_stack_resource_mgmt_1), 0);
 r100_mm_wreg(rdev, (0x8C24), (sq_stack_resource_mgmt_2), 0);
 r100_mm_wreg(rdev, (0x8C28), (sq_stack_resource_mgmt_3), 0);
 r100_mm_wreg(rdev, (0x8D8C), (0), 0);
 r100_mm_wreg(rdev, (0x8E2C), (sq_lds_resource_mgmt), 0);
 ...
 r100_mm_wreg(rdev, (0x88C4), (vgt_cache_invalidation), 0);
 r100_mm_wreg(rdev, (0x88D4), (16), 0);
 r100_mm_wreg(rdev, (0x8A60), (0), 0);
 r100_mm_wreg(rdev, (0x8B10), (0), 0);
 r100_mm_wreg(rdev, (0x28C58), (14), 0);
 r100_mm_wreg(rdev, (0x28C5C), (16), 0);
 r100_mm_wreg(rdev, (0x9A20), (0), 0);
 r100_mm_wreg(rdev, (0x9A24), (0), 0);
 r100_mm_wreg(rdev, (0x9A28), (0), 0);
 r100_mm_wreg(rdev, (0x9A2C), (0), 0);
 r100_mm_wreg(rdev, (0x9A30), (0), 0);
 r100_mm_wreg(rdev, (0x9A34), (0), 0);
 r100_mm_wreg(rdev, (0x9A38), (0), 0);
 r100_mm_wreg(rdev, (0x9A3C), (0), 0);
 r100_mm_wreg(rdev, (0x28c60), (0), 0);
 r100_mm_wreg(rdev, (0x28c9c), (0), 0);
 r100_mm_wreg(rdev, (0x28cd8), (0), 0);
 r100_mm_wreg(rdev, (0x28d14), (0), 0);
 r100_mm_wreg(rdev, (0x28d50), (0), 0);
 r100_mm_wreg(rdev, (0x28d8c), (0), 0);
 r100_mm_wreg(rdev, (0x28dc8), (0), 0);
 r100_mm_wreg(rdev, (0x28e04), (0), 0);
 r100_mm_wreg(rdev, (0x28e40), (0), 0);
 r100_mm_wreg(rdev, (0x28e5c), (0), 0);
 r100_mm_wreg(rdev, (0x28e78), (0), 0);
 r100_mm_wreg(rdev, (0x28e94), (0), 0);
 for (i = 0x28140; i < 0x28200; i += 4)
  r100_mm_wreg(rdev, (i), (0), 0);
 for (i = 0x28f80; i < 0x29000; i += 4)
  r100_mm_wreg(rdev, (i), (0), 0);
 tmp = r100_mm_rreg(rdev, (0x2F4C), 0);
 tmp |= (1 << 0);
 r100_mm_wreg(rdev, (0x2F4C), (tmp), 0);
...
int evergreen_mc_init(struct radeon_device *rdev)
{
 ...
 if ((rdev->family == CHIP_PALM) ||
     (rdev->family == CHIP_SUMO) ||
     (rdev->family == CHIP_SUMO2))
  tmp = r100_mm_rreg(rdev, (0x2768), 0);
 else
 ...
 if ((rdev->family == CHIP_PALM) ||
  ...
  rdev->mc.mc_vram_size = r100_mm_rreg(rdev, (0x5428), 0) * 1024ULL * 1024ULL;
  rdev->mc.real_vram_size = r100_mm_rreg(rdev, (0x5428), 0) * 1024ULL * 1024ULL;
 }
...
_Bool evergreen_is_display_hung(struct radeon_device *rdev)
{
 u32 crtc_hung = 0;
 u32 crtc_status[6];
 u32 i, j, tmp;
 for (i = 0; i < rdev->num_crtc; i++) {
  if (r100_mm_rreg(rdev, (0x6e70 + crtc_offsets[i]), 0) & (1 << 0)) {
   crtc_status[i] = r100_mm_rreg(rdev, (0x6ea0 + crtc_offsets[i]), 0);
   crtc_hung |= (1 << i);
  }
 }
 for (j = 0; j < 10; j++) {
  for (i = 0; i < rdev->num_crtc; i++) {
   if (crtc_hung & (1 << i)) {
    tmp = r100_mm_rreg(rdev, (0x6ea0 + crtc_offsets[i]), 0);
...
u32 evergreen_gpu_check_soft_reset(struct radeon_device *rdev)
{
 ...
 if (!(tmp & (1 << 0)))
  reset_mask |= (1 << 2);
 tmp = r100_mm_rreg(rdev, (0x0EC4), 0);
 if (tmp & (1 << 5))
  reset_mask |= (1 << 2);
 ...
 if (evergreen_is_display_hung(rdev))
  reset_mask |= (1 << 11);
 tmp = r100_mm_rreg(rdev, (0x140C), 0);
 if (tmp & (1 << 0))
  reset_mask |= (1 << 9);
 if (reset_mask & (1 << 10)) {
  do { } while( 0);
...
static void evergreen_gpu_soft_reset(struct radeon_device *rdev, u32 reset_mask)
{
 ...
 if (srbm_soft_reset) {
  tmp = r100_mm_rreg(rdev, (0x0E60), 0);
  tmp |= srbm_soft_reset;
  do { } while(0);
  r100_mm_wreg(rdev, (0x0E60), (tmp), 0);
  tmp = r100_mm_rreg(rdev, (0x0E60), 0);
  udelay(50);
  tmp &= ~srbm_soft_reset;
  r100_mm_wreg(rdev, (0x0E60), (tmp), 0);
...
_Bool evergreen_gfx_is_lockup(struct radeon_device *rdev, struct radeon_ring *ring)
{
...
void sumo_rlc_fini(struct radeon_device *rdev)
{
 ...
 if (rdev->rlc.save_restore_obj) {
  ...
  if (__builtin_expect(!!(r != 0), 0))
   printf("drm:pid%d:%s *WARNING* " "(%d) reserve RLC sr bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
 ...
 if (rdev->rlc.clear_state_obj) {
  ...
  if (__builtin_expect(!!(r != 0), 0))
   printf("drm:pid%d:%s *WARNING* " "(%d) reserve RLC c bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
 ...
 if (rdev->rlc.cp_table_obj) {
  ...
  if (__builtin_expect(!!(r != 0), 0))
   printf("drm:pid%d:%s *WARNING* " "(%d) reserve RLC cp table bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
...
int sumo_rlc_init(struct radeon_device *rdev)
{
 ...
 if (src_ptr) {
  if (rdev->rlc.save_restore_obj == ((void *)0)) {
   r = radeon_bo_create(rdev, dws * 4, (1 << 13), 1,
          0x4, 0, ((void *)0),
          ((void *)0), &rdev->rlc.save_restore_obj);
   if (r) {
    printf("drm:pid%d:%s *WARNING* " "(%d) create RLC sr bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
    return r;
   }
  }
  r = radeon_bo_reserve(rdev->rlc.save_restore_obj, 0);
  ...
  if (r) {
   radeon_bo_unreserve(rdev->rlc.save_restore_obj);
   printf("drm:pid%d:%s *WARNING* " "(%d) pin RLC sr bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   sumo_rlc_fini(rdev);
   return r;
  }
  r = radeon_bo_kmap(rdev->rlc.save_restore_obj, (void **)&rdev->rlc.sr_ptr);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "(%d) map RLC sr bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   sumo_rlc_fini(rdev);
   return r;
  }
  ...
  if (rdev->family >= CHIP_TAHITI) {
   for (i = 0; i < rdev->rlc.reg_list_size; i++)
    dst_ptr[i] = (__uint32_t)(__builtin_constant_p(src_ptr[i]) ? (__uint32_t)(((__uint32_t)(src_ptr[i]) & 0xff) << 24 | ((__uint32_t)(src_ptr[i]) & 0xff00) << 8 | ((__uint32_t)(src_ptr[i]) & 0xff0000) >> 8 | ((__uint32_t)(src_ptr[i]) & 0xff000000) >> 24) : __swap32md(src_ptr[i]));
  } else {
   for (i = 0; i < dws; i++) {
    data = src_ptr[i] >> 2;
    i++;
    if (i < dws)
     data |= (src_ptr[i] >> 2) << 16;
    j = (((i - 1) * 3) / 2);
    dst_ptr[j] = (__uint32_t)(__builtin_constant_p(data) ? (__uint32_t)(((__uint32_t)(data) & 0xff) << 24 | ((__uint32_t)(data) & 0xff00) << 8 | ((__uint32_t)(data) & 0xff0000) >> 8 | ((__uint32_t)(data) & 0xff000000) >> 24) : __swap32md(data));
   }
   j = ((i * 3) / 2);
   dst_ptr[j] = (__uint32_t)(__builtin_constant_p(0x00000000) ? (__uint32_t)(((__uint32_t)(0x00000000) & 0xff) << 24 | ((__uint32_t)(0x00000000) & 0xff00) << 8 | ((__uint32_t)(0x00000000) & 0xff0000) >> 8 | ((__uint32_t)(0x00000000) & 0xff000000) >> 24) : __swap32md(0x00000000));
  }
 ...
 if (cs_data) {
  ...
  if (rdev->rlc.clear_state_obj == ((void *)0)) {
   ...
   if (r) {
    printf("drm:pid%d:%s *WARNING* " "(%d) create RLC c bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
    sumo_rlc_fini(rdev);
    return r;
   }
  }
  ...
  if (r) {
   radeon_bo_unreserve(rdev->rlc.clear_state_obj);
   printf("drm:pid%d:%s *WARNING* " "(%d) pin RLC c bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   sumo_rlc_fini(rdev);
   return r;
  }
  r = radeon_bo_kmap(rdev->rlc.clear_state_obj, (void **)&rdev->rlc.cs_ptr);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "(%d) map RLC c bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   sumo_rlc_fini(rdev);
   return r;
  }
  ...
  if (rdev->family >= CHIP_BONAIRE) {
   ...
   dst_ptr[0] = (__uint32_t)(__builtin_constant_p(((u32)(((reg_list_mc_addr) >> 16) >> 16))) ? (__uint32_t)(((__uint32_t)(((u32)(((reg_list_mc_addr) >> 16) >> 16))) & 0xff) << 24 | ((__uint32_t)(((u32)(((reg_list_mc_addr) >> 16) >> 16))) & 0xff00) << 8 | ((__uint32_t)(((u32)(((reg_list_mc_addr) >> 16) >> 16))) & 0xff0000) >> 8 | ((__uint32_t)(((u32)(((reg_list_mc_addr) >> 16) >> 16))) & 0xff000000) >> 24) : __swap32md(((u32)(((reg_list_mc_addr) >> 16) >> 16))));
   dst_ptr[1] = (__uint32_t)(__builtin_constant_p(((u32)(reg_list_mc_addr))) ? (__uint32_t)(((__uint32_t)(((u32)(reg_list_mc_addr))) & 0xff) << 24 | ((__uint32_t)(((u32)(reg_list_mc_addr))) & 0xff00) << 8 | ((__uint32_t)(((u32)(reg_list_mc_addr))) & 0xff0000) >> 8 | ((__uint32_t)(((u32)(reg_list_mc_addr))) & 0xff000000) >> 24) : __swap32md(((u32)(reg_list_mc_addr))));
   dst_ptr[2] = (__uint32_t)(__builtin_constant_p(rdev->rlc.clear_state_size) ? (__uint32_t)(((__uint32_t)(rdev->rlc.clear_state_size) & 0xff) << 24 | ((__uint32_t)(rdev->rlc.clear_state_size) & 0xff00) << 8 | ((__uint32_t)(rdev->rlc.clear_state_size) & 0xff0000) >> 8 | ((__uint32_t)(rdev->rlc.clear_state_size) & 0xff000000) >> 24) : __swap32md(rdev->rlc.clear_state_size));
   si_get_csb_buffer(rdev, &dst_ptr[(256/4)]);
  } else {
   reg_list_hdr_blk_index = 0;
   reg_list_mc_addr = rdev->rlc.clear_state_gpu_addr + (reg_list_blk_index * 4);
   data = ((u32)(((reg_list_mc_addr) >> 16) >> 16));
   dst_ptr[reg_list_hdr_blk_index] = (__uint32_t)(__builtin_constant_p(data) ? (__uint32_t)(((__uint32_t)(data) & 0xff) << 24 | ((__uint32_t)(data) & 0xff00) << 8 | ((__uint32_t)(data) & 0xff0000) >> 8 | ((__uint32_t)(data) & 0xff000000) >> 24) : __swap32md(data));
   ...
   for (i = 0; cs_data[i].section != ((void *)0); i++) {
    for (j = 0; cs_data[i].section[j].extent != ((void *)0); j++) {
     ...
     for (k = 0; k < reg_num; k++) {
      ...
      dst_ptr[reg_list_blk_index + k] = (__uint32_t)(__builtin_constant_p(data) ? (__uint32_t)(((__uint32_t)(data) & 0xff) << 24 | ((__uint32_t)(data) & 0xff00) << 8 | ((__uint32_t)(data) & 0xff0000) >> 8 | ((__uint32_t)(data) & 0xff000000) >> 24) : __swap32md(data));
     }
     reg_list_mc_addr += reg_num * 4;
     reg_list_blk_index += reg_num;
    }
   }
   dst_ptr[reg_list_hdr_blk_index] = (__uint32_t)(__builtin_constant_p(0x00000001) ? (__uint32_t)(((__uint32_t)(0x00000001) & 0xff) << 24 | ((__uint32_t)(0x00000001) & 0xff00) << 8 | ((__uint32_t)(0x00000001) & 0xff0000) >> 8 | ((__uint32_t)(0x00000001) & 0xff000000) >> 24) : __swap32md(0x00000001));
  }
 ...
 if (rdev->rlc.cp_table_size) {
  if (rdev->rlc.cp_table_obj == ((void *)0)) {
   ...
   if (r) {
    printf("drm:pid%d:%s *WARNING* " "(%d) create RLC cp table bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
    sumo_rlc_fini(rdev);
    return r;
   }
  }
  ...
  if (r) {
   radeon_bo_unreserve(rdev->rlc.cp_table_obj);
   printf("drm:pid%d:%s *WARNING* " "(%d) pin RLC cp_table bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   sumo_rlc_fini(rdev);
   return r;
  }
  r = radeon_bo_kmap(rdev->rlc.cp_table_obj, (void **)&rdev->rlc.cp_table_ptr);
  if (r) {
   printf("drm:pid%d:%s *WARNING* " "(%d) map RLC cp table bo failed\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
   sumo_rlc_fini(rdev);
   return r;
  }
...
static void evergreen_rlc_start(struct radeon_device *rdev)
{
 ...
 r100_mm_wreg(rdev, (0x3f00), (mask), 0);
}
int evergreen_rlc_resume(struct radeon_device *rdev)
{
 ...
 if (rdev->flags & RADEON_IS_IGP) {
  if (rdev->family == CHIP_ARUBA) {
   ...
   u32 tmp = (r100_mm_rreg(rdev, (0x8950), 0) & 0xffff0000) >> 16;
   tmp |= 0xffffffff << rdev->config.cayman.max_simds_per_se;
   tmp = hweight32(~tmp);
   if (tmp == rdev->config.cayman.max_simds_per_se) {
    r100_mm_wreg(rdev, (0x3fe8), (always_on_bitmap), 0);
    r100_mm_wreg(rdev, (0x3fec), (0x00601004), 0);
    r100_mm_wreg(rdev, (0x3fe4), (0xffffffff), 0);
    r100_mm_wreg(rdev, (0x3f18), (0x00000000), 0);
    r100_mm_wreg(rdev, (0x3f14), (0x00002000), 0);
   }
  } else {
...
u32 evergreen_get_vblank_counter(struct radeon_device *rdev, int crtc)
{
 if (crtc >= rdev->num_crtc)
  ...
  return r100_mm_rreg(rdev, (0x6e98 + crtc_offsets[crtc]), 0);
}
void evergreen_disable_interrupt_state(struct radeon_device *rdev)
{
 u32 tmp;
 if (rdev->family >= CHIP_CAYMAN) {
  ...
  tmp = r100_mm_rreg(rdev, (0xd82c), 0) & ~(1 << 0);
  r100_mm_wreg(rdev, (0xd82c), (tmp), 0);
 } else
 ...
 r100_mm_wreg(rdev, (0xEA0), (0), 0);
 r100_mm_wreg(rdev, (0x6b40 + (0x6df0 - 0x6df0)), (0), 0);
 r100_mm_wreg(rdev, (0x6b40 + (0x79f0 - 0x6df0)), (0), 0);
 if (rdev->num_crtc >= 4) {
  r100_mm_wreg(rdev, (0x6b40 + (0x105f0 - 0x6df0)), (0), 0);
  r100_mm_wreg(rdev, (0x6b40 + (0x111f0 - 0x6df0)), (0), 0);
 }
 if (rdev->num_crtc >= 6) {
  r100_mm_wreg(rdev, (0x6b40 + (0x11df0 - 0x6df0)), (0), 0);
  r100_mm_wreg(rdev, (0x6b40 + (0x129f0 - 0x6df0)), (0), 0);
 }
 r100_mm_wreg(rdev, (0x685c + (0x6df0 - 0x6df0)), (0), 0);
 r100_mm_wreg(rdev, (0x685c + (0x79f0 - 0x6df0)), (0), 0);
 if (rdev->num_crtc >= 4) {
  r100_mm_wreg(rdev, (0x685c + (0x105f0 - 0x6df0)), (0), 0);
  r100_mm_wreg(rdev, (0x685c + (0x111f0 - 0x6df0)), (0), 0);
 }
 if (rdev->num_crtc >= 6) {
  r100_mm_wreg(rdev, (0x685c + (0x11df0 - 0x6df0)), (0), 0);
  r100_mm_wreg(rdev, (0x685c + (0x129f0 - 0x6df0)), (0), 0);
 }
 if (!((rdev->family >= CHIP_BARTS)))
  r100_mm_wreg(rdev, (0x66c8), (0), 0);
 r100_mm_wreg(rdev, (0x67c8), (0), 0);
 tmp = r100_mm_rreg(rdev, (0x6020), 0) & (1 << 8);
 r100_mm_wreg(rdev, (0x6020), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x602c), 0) & (1 << 8);
 r100_mm_wreg(rdev, (0x602c), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x6038), 0) & (1 << 8);
 r100_mm_wreg(rdev, (0x6038), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x6044), 0) & (1 << 8);
 r100_mm_wreg(rdev, (0x6044), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x6050), 0) & (1 << 8);
 r100_mm_wreg(rdev, (0x6050), (tmp), 0);
 tmp = r100_mm_rreg(rdev, (0x605c), 0) & (1 << 8);
 r100_mm_wreg(rdev, (0x605c), (tmp), 0);
}
int evergreen_irq_set(struct radeon_device *rdev)
{
 ...
 hpd1 = r100_mm_rreg(rdev, (0x6020), 0) & ~((1 << 16) | (1 << 24));
 hpd2 = r100_mm_rreg(rdev, (0x602c), 0) & ~((1 << 16) | (1 << 24));
 hpd3 = r100_mm_rreg(rdev, (0x6038), 0) & ~((1 << 16) | (1 << 24));
 hpd4 = r100_mm_rreg(rdev, (0x6044), 0) & ~((1 << 16) | (1 << 24));
 hpd5 = r100_mm_rreg(rdev, (0x6050), 0) & ~((1 << 16) | (1 << 24));
 hpd6 = r100_mm_rreg(rdev, (0x605c), 0) & ~((1 << 16) | (1 << 24));
 if (rdev->family == CHIP_ARUBA)
  thermal_int = r100_mm_rreg(rdev, (0x738), 0) &
   ~((1 << 24) | (1 << 25));
 else
  thermal_int = r100_mm_rreg(rdev, (0x734), 0) &
   ~((1 << 24) | (1 << 25));
 afmt1 = r100_mm_rreg(rdev, (0x712c + (0x6df0 - 0x6df0)), 0) & ~(1 << 28);
 afmt2 = r100_mm_rreg(rdev, (0x712c + (0x79f0 - 0x6df0)), 0) & ~(1 << 28);
 afmt3 = r100_mm_rreg(rdev, (0x712c + (0x105f0 - 0x6df0)), 0) & ~(1 << 28);
 afmt4 = r100_mm_rreg(rdev, (0x712c + (0x111f0 - 0x6df0)), 0) & ~(1 << 28);
 afmt5 = r100_mm_rreg(rdev, (0x712c + (0x11df0 - 0x6df0)), 0) & ~(1 << 28);
 afmt6 = r100_mm_rreg(rdev, (0x712c + (0x129f0 - 0x6df0)), 0) & ~(1 << 28);
 ...
 if (rdev->family >= CHIP_CAYMAN) {
  ...
  if ((*(&rdev->irq.ring_int[1]))) {
   do { } while( 0);
   cp_int_cntl1 |= (1 << 26);
  }
  if ((*(&rdev->irq.ring_int[2]))) {
   do { } while( 0);
   cp_int_cntl2 |= (1 << 26);
  }
 } else {
 ...
 if (rdev->family >= CHIP_CAYMAN) {
  dma_cntl1 = r100_mm_rreg(rdev, (0xd82c), 0) & ~(1 << 0);
  if ((*(&rdev->irq.ring_int[4]))) {
   do { } while( 0);
   dma_cntl1 |= (1 << 0);
  }
 }
 ...
 if (rdev->family >= CHIP_CAYMAN)
  r100_mm_wreg(rdev, (0xd82c), (dma_cntl1), 0);
 r100_mm_wreg(rdev, (0x8060), (grbm_int_cntl), 0);
 r100_mm_wreg(rdev, (0x6b40 + (0x6df0 - 0x6df0)), (crtc1), 0);
 r100_mm_wreg(rdev, (0x6b40 + (0x79f0 - 0x6df0)), (crtc2), 0);
 if (rdev->num_crtc >= 4) {
  r100_mm_wreg(rdev, (0x6b40 + (0x105f0 - 0x6df0)), (crtc3), 0);
  r100_mm_wreg(rdev, (0x6b40 + (0x111f0 - 0x6df0)), (crtc4), 0);
 }
 if (rdev->num_crtc >= 6) {
  r100_mm_wreg(rdev, (0x6b40 + (0x11df0 - 0x6df0)), (crtc5), 0);
  r100_mm_wreg(rdev, (0x6b40 + (0x129f0 - 0x6df0)), (crtc6), 0);
 }
 r100_mm_wreg(rdev, (0x685c + (0x6df0 - 0x6df0)), ((1 << 0)), 0);
 r100_mm_wreg(rdev, (0x685c + (0x79f0 - 0x6df0)), ((1 << 0)), 0);
 if (rdev->num_crtc >= 4) {
  r100_mm_wreg(rdev, (0x685c + (0x105f0 - 0x6df0)), ((1 << 0)), 0);
  r100_mm_wreg(rdev, (0x685c + (0x111f0 - 0x6df0)), ((1 << 0)), 0);
 }
 if (rdev->num_crtc >= 6) {
  r100_mm_wreg(rdev, (0x685c + (0x11df0 - 0x6df0)), ((1 << 0)), 0);
  r100_mm_wreg(rdev, (0x685c + (0x129f0 - 0x6df0)), ((1 << 0)), 0);
 }
 r100_mm_wreg(rdev, (0x6020), (hpd1), 0);
 r100_mm_wreg(rdev, (0x602c), (hpd2), 0);
 r100_mm_wreg(rdev, (0x6038), (hpd3), 0);
 r100_mm_wreg(rdev, (0x6044), (hpd4), 0);
 r100_mm_wreg(rdev, (0x6050), (hpd5), 0);
 r100_mm_wreg(rdev, (0x605c), (hpd6), 0);
 if (rdev->family == CHIP_ARUBA)
  r100_mm_wreg(rdev, (0x738), (thermal_int), 0);
 else
  r100_mm_wreg(rdev, (0x734), (thermal_int), 0);
 r100_mm_wreg(rdev, (0x712c + (0x6df0 - 0x6df0)), (afmt1), 0);
 r100_mm_wreg(rdev, (0x712c + (0x79f0 - 0x6df0)), (afmt2), 0);
 r100_mm_wreg(rdev, (0x712c + (0x105f0 - 0x6df0)), (afmt3), 0);
 r100_mm_wreg(rdev, (0x712c + (0x111f0 - 0x6df0)), (afmt4), 0);
 r100_mm_wreg(rdev, (0x712c + (0x11df0 - 0x6df0)), (afmt5), 0);
 r100_mm_wreg(rdev, (0x712c + (0x129f0 - 0x6df0)), (afmt6), 0);
...
{
 u32 tmp;
 rdev->irq.stat_regs.evergreen.disp_int = r100_mm_rreg(rdev, (0x60f4), 0);
 rdev->irq.stat_regs.evergreen.disp_int_cont = r100_mm_rreg(rdev, (0x60f8), 0);
 rdev->irq.stat_regs.evergreen.disp_int_cont2 = r100_mm_rreg(rdev, (0x60fc), 0);
 rdev->irq.stat_regs.evergreen.disp_int_cont3 = r100_mm_rreg(rdev, (0x6100), 0);
 rdev->irq.stat_regs.evergreen.disp_int_cont4 = r100_mm_rreg(rdev, (0x614c), 0);
 rdev->irq.stat_regs.evergreen.disp_int_cont5 = r100_mm_rreg(rdev, (0x6150), 0);
 rdev->irq.stat_regs.evergreen.d1grph_int = r100_mm_rreg(rdev, (0x6858 + (0x6df0 - 0x6df0)), 0);
 rdev->irq.stat_regs.evergreen.d2grph_int = r100_mm_rreg(rdev, (0x6858 + (0x79f0 - 0x6df0)), 0);
 if (rdev->num_crtc >= 4) {
  rdev->irq.stat_regs.evergreen.d3grph_int = r100_mm_rreg(rdev, (0x6858 + (0x105f0 - 0x6df0)), 0);
  rdev->irq.stat_regs.evergreen.d4grph_int = r100_mm_rreg(rdev, (0x6858 + (0x111f0 - 0x6df0)), 0);
 }
 if (rdev->num_crtc >= 6) {
  rdev->irq.stat_regs.evergreen.d5grph_int = r100_mm_rreg(rdev, (0x6858 + (0x11df0 - 0x6df0)), 0);
  rdev->irq.stat_regs.evergreen.d6grph_int = r100_mm_rreg(rdev, (0x6858 + (0x129f0 - 0x6df0)), 0);
 }
 rdev->irq.stat_regs.evergreen.afmt_status1 = r100_mm_rreg(rdev, (0x7128 + (0x6df0 - 0x6df0)), 0);
 rdev->irq.stat_regs.evergreen.afmt_status2 = r100_mm_rreg(rdev, (0x7128 + (0x79f0 - 0x6df0)), 0);
 rdev->irq.stat_regs.evergreen.afmt_status3 = r100_mm_rreg(rdev, (0x7128 + (0x105f0 - 0x6df0)), 0);
 rdev->irq.stat_regs.evergreen.afmt_status4 = r100_mm_rreg(rdev, (0x7128 + (0x111f0 - 0x6df0)), 0);
 rdev->irq.stat_regs.evergreen.afmt_status5 = r100_mm_rreg(rdev, (0x7128 + (0x11df0 - 0x6df0)), 0);
 rdev->irq.stat_regs.evergreen.afmt_status6 = r100_mm_rreg(rdev, (0x7128 + (0x129f0 - 0x6df0)), 0);
 if (rdev->irq.stat_regs.evergreen.d1grph_int & (1 << 0))
  r100_mm_wreg(rdev, (0x6858 + (0x6df0 - 0x6df0)), ((1 << 8)), 0);
 if (rdev->irq.stat_regs.evergreen.d2grph_int & (1 << 0))
  r100_mm_wreg(rdev, (0x6858 + (0x79f0 - 0x6df0)), ((1 << 8)), 0);
 if (rdev->irq.stat_regs.evergreen.disp_int & (1 << 3))
  r100_mm_wreg(rdev, (0x6bbc + (0x6df0 - 0x6df0)), ((1 << 4)), 0);
 if (rdev->irq.stat_regs.evergreen.disp_int & (1 << 2))
  r100_mm_wreg(rdev, (0x6bb8 + (0x6df0 - 0x6df0)), ((1 << 4)), 0);
 if (rdev->irq.stat_regs.evergreen.disp_int_cont & (1 << 3))
  r100_mm_wreg(rdev, (0x6bbc + (0x79f0 - 0x6df0)), ((1 << 4)), 0);
 if (rdev->irq.stat_regs.evergreen.disp_int_cont & (1 << 2))
  r100_mm_wreg(rdev, (0x6bb8 + (0x79f0 - 0x6df0)), ((1 << 4)), 0);
 if (rdev->num_crtc >= 4) {
  if (rdev->irq.stat_regs.evergreen.d3grph_int & (1 << 0))
   r100_mm_wreg(rdev, (0x6858 + (0x105f0 - 0x6df0)), ((1 << 8)), 0);
  if (rdev->irq.stat_regs.evergreen.d4grph_int & (1 << 0))
   r100_mm_wreg(rdev, (0x6858 + (0x111f0 - 0x6df0)), ((1 << 8)), 0);
  if (rdev->irq.stat_regs.evergreen.disp_int_cont2 & (1 << 3))
   r100_mm_wreg(rdev, (0x6bbc + (0x105f0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.evergreen.disp_int_cont2 & (1 << 2))
   r100_mm_wreg(rdev, (0x6bb8 + (0x105f0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.evergreen.disp_int_cont3 & (1 << 3))
   r100_mm_wreg(rdev, (0x6bbc + (0x111f0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.evergreen.disp_int_cont3 & (1 << 2))
   r100_mm_wreg(rdev, (0x6bb8 + (0x111f0 - 0x6df0)), ((1 << 4)), 0);
 }
 if (rdev->num_crtc >= 6) {
  if (rdev->irq.stat_regs.evergreen.d5grph_int & (1 << 0))
   r100_mm_wreg(rdev, (0x6858 + (0x11df0 - 0x6df0)), ((1 << 8)), 0);
  if (rdev->irq.stat_regs.evergreen.d6grph_int & (1 << 0))
   r100_mm_wreg(rdev, (0x6858 + (0x129f0 - 0x6df0)), ((1 << 8)), 0);
  if (rdev->irq.stat_regs.evergreen.disp_int_cont4 & (1 << 3))
   r100_mm_wreg(rdev, (0x6bbc + (0x11df0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.evergreen.disp_int_cont4 & (1 << 2))
   r100_mm_wreg(rdev, (0x6bb8 + (0x11df0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.evergreen.disp_int_cont5 & (1 << 3))
   r100_mm_wreg(rdev, (0x6bbc + (0x129f0 - 0x6df0)), ((1 << 4)), 0);
  if (rdev->irq.stat_regs.evergreen.disp_int_cont5 & (1 << 2))
   r100_mm_wreg(rdev, (0x6bb8 + (0x129f0 - 0x6df0)), ((1 << 4)), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x6020), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x6020), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int_cont & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x602c), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x602c), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int_cont2 & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x6038), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x6038), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int_cont3 & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x6044), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x6044), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int_cont4 & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x6050), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x6050), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int_cont5 & (1 << 17)) {
  tmp = r100_mm_rreg(rdev, (0x605c), 0);
  tmp |= (1 << 0);
  r100_mm_wreg(rdev, (0x605c), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x6020), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x6020), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int_cont & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x602c), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x602c), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int_cont2 & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x6038), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x6038), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int_cont3 & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x6044), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x6044), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int_cont4 & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x6050), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x6050), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.disp_int_cont5 & (1 << 18)) {
  tmp = r100_mm_rreg(rdev, (0x605c), 0);
  tmp |= (1 << 20);
  r100_mm_wreg(rdev, (0x605c), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.afmt_status1 & (1 << 28)) {
  tmp = r100_mm_rreg(rdev, (0x712c + (0x6df0 - 0x6df0)), 0);
  tmp |= (1 << 29);
  r100_mm_wreg(rdev, (0x712c + (0x6df0 - 0x6df0)), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.afmt_status2 & (1 << 28)) {
  tmp = r100_mm_rreg(rdev, (0x712c + (0x79f0 - 0x6df0)), 0);
  tmp |= (1 << 29);
  r100_mm_wreg(rdev, (0x712c + (0x79f0 - 0x6df0)), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.afmt_status3 & (1 << 28)) {
  tmp = r100_mm_rreg(rdev, (0x712c + (0x105f0 - 0x6df0)), 0);
  tmp |= (1 << 29);
  r100_mm_wreg(rdev, (0x712c + (0x105f0 - 0x6df0)), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.afmt_status4 & (1 << 28)) {
  tmp = r100_mm_rreg(rdev, (0x712c + (0x111f0 - 0x6df0)), 0);
  tmp |= (1 << 29);
  r100_mm_wreg(rdev, (0x712c + (0x111f0 - 0x6df0)), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.afmt_status5 & (1 << 28)) {
  tmp = r100_mm_rreg(rdev, (0x712c + (0x11df0 - 0x6df0)), 0);
  tmp |= (1 << 29);
  r100_mm_wreg(rdev, (0x712c + (0x11df0 - 0x6df0)), (tmp), 0);
 }
 if (rdev->irq.stat_regs.evergreen.afmt_status6 & (1 << 28)) {
  tmp = r100_mm_rreg(rdev, (0x712c + (0x129f0 - 0x6df0)), 0);
  tmp |= (1 << 29);
  r100_mm_wreg(rdev, (0x712c + (0x129f0 - 0x6df0)), (tmp), 0);
 }
}
 ...
 while (rptr != wptr) {
  ...
  case 1:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.evergreen.disp_int &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.evergreen.disp_int & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 2:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.evergreen.disp_int_cont &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 3:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.evergreen.disp_int_cont2 &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont2 & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont2 &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 4:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.evergreen.disp_int_cont3 &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont3 & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont3 &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 5:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.evergreen.disp_int_cont4 &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont4 & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont4 &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 6:
   ...
   case 0:
    ...
    rdev->irq.stat_regs.evergreen.disp_int_cont5 &= ~(1 << 3);
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont5 & (1 << 2)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont5 &= ~(1 << 2);
    do { } while( 0);
    break;
   default:
    do { } while( 0);
  ...
  case 42:
   ...
   case 0:
    if (!(rdev->irq.stat_regs.evergreen.disp_int & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 2:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont2 & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont2 &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 3:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont3 & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont3 &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 4:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont4 & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont4 &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 5:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont5 & (1 << 17)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont5 &= ~(1 << 17);
    queue_hotplug = 1;
    do { } while( 0);
    break;
   case 6:
    if (!(rdev->irq.stat_regs.evergreen.disp_int & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   case 7:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   case 8:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont2 & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont2 &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   case 9:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont3 & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont3 &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   case 10:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont4 & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont4 &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   case 11:
    if (!(rdev->irq.stat_regs.evergreen.disp_int_cont5 & (1 << 18)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.disp_int_cont5 &= ~(1 << 18);
    queue_dp = 1;
    do { } while( 0);
    break;
   default:
  ...
  case 44:
   ...
   case 0:
    if (!(rdev->irq.stat_regs.evergreen.afmt_status1 & (1 << 28)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.afmt_status1 &= ~(1 << 28);
    queue_hdmi = 1;
    do { } while( 0);
    break;
   case 1:
    if (!(rdev->irq.stat_regs.evergreen.afmt_status2 & (1 << 28)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.afmt_status2 &= ~(1 << 28);
    queue_hdmi = 1;
    do { } while( 0);
    break;
   case 2:
    if (!(rdev->irq.stat_regs.evergreen.afmt_status3 & (1 << 28)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.afmt_status3 &= ~(1 << 28);
    queue_hdmi = 1;
    do { } while( 0);
    break;
   case 3:
    if (!(rdev->irq.stat_regs.evergreen.afmt_status4 & (1 << 28)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.afmt_status4 &= ~(1 << 28);
    queue_hdmi = 1;
    do { } while( 0);
    break;
   case 4:
    if (!(rdev->irq.stat_regs.evergreen.afmt_status5 & (1 << 28)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.afmt_status5 &= ~(1 << 28);
    queue_hdmi = 1;
    do { } while( 0);
    break;
   case 5:
    if (!(rdev->irq.stat_regs.evergreen.afmt_status6 & (1 << 28)))
     do { } while( 0);
    rdev->irq.stat_regs.evergreen.afmt_status6 &= ~(1 << 28);
    queue_hdmi = 1;
    do { } while( 0);
    break;
   default:
  ...
  case 96:
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "SRBM_READ_ERROR: 0x%x\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r100_mm_rreg(rdev, (0xE98), 0));
   r100_mm_wreg(rdev, (0xEA8), (0x1), 0);
   break;
  case 124:
   do { } while( 0);
  ...
  case 146:
  case 147:
   addr = r100_mm_rreg(rdev, (0x14FC), 0);
   status = r100_mm_rreg(rdev, (0x14DC), 0);
   do { uint32_t tmp_ = r100_mm_rreg(rdev, (0x1434), 0); tmp_ &= (~1); tmp_ |= ((1) & ~(~1)); r100_mm_wreg(rdev, (0x1434), (tmp_), 0); } while (0);
   if (addr == 0x0 && status == 0x0)
    break;
   printf("drm:pid%d:%s *ERROR* " "GPU fault detected: %d 0x%08x\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , src_id, src_data);
   printf("drm:pid%d:%s *ERROR* " "  VM_CONTEXT1_PROTECTION_FAULT_ADDR   0x%08X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , addr);
   printf("drm:pid%d:%s *ERROR* " "  VM_CONTEXT1_PROTECTION_FAULT_STATUS 0x%08X\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , status);
...
static int evergreen_startup(struct radeon_device *rdev)
{
 ...
 if (rdev->flags & RADEON_IS_IGP) {
  ...
  rdev->rlc.reg_list_size =
   (u32)(sizeof((sumo_rlc_save_restore_register_list)) / sizeof((sumo_rlc_save_restore_register_list)[0]));
  rdev->rlc.cs_data = evergreen_cs_data;
  r = sumo_rlc_init(rdev);
  if (r) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "Failed to init rlc BOs!\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return r;
  }
 }
 ...
 if (ring->ring_size) {
  ...
  if (r)
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: error initializing UVD (%d).\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__ , r);
 }
...
int evergreen_resume(struct radeon_device *rdev)
{
 ...
 if (r) {
  printf("error: [" "drm" ":pid%d:%s] *ERROR* " "evergreen startup failed on resume\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
...
int evergreen_init(struct radeon_device *rdev)
{
 ...
 if (((rdev->family >= CHIP_BARTS))) {
  if (!rdev->mc_fw && !(rdev->flags & RADEON_IS_IGP)) {
   printf("error: [" "drm" ":pid%d:%s] *ERROR* " "radeon: MC ucode required for NI+.\n", (__curcpu->ci_self)->ci_curproc->p_p->ps_pid, __func__);
   return -22;
  }
 }
 return 0;
...
void evergreen_program_aspm(struct radeon_device *rdev)
{
 ...
 _Bool disable_l0s, disable_l1 = 0, disable_plloff_in_l1 = 0;
 _Bool fusion_platform = 0;
 if (radeon_aspm == 0)
  return;
 if (!(rdev->flags & RADEON_IS_PCIE))
  return;
